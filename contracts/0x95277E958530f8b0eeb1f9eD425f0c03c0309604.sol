            ...
            if stor3[address(ext_call.return_data[0])][address(arg2)]:
                ...
                if stor3[stor1][address(arg2)]:
                    ...
                    if _3793 - 1 >= _3793:
                        revert with 0, 50
                    if stor1 != address(ext_call.return_data[0]):
                        return mem[(32 * _3793 - 1) + (4 * ceil32(return_data.size)) + 288], Mask(255, 1, arg3)
            ...
            if not stor3[stor1][address(arg2)]:
                if stor3[address(ext_call.return_data[0])][address(arg2)]:
                    ...
                    if _3812 - 1 >= _3812:
                        revert with 0, 50
                    if stor1 != address(ext_call.return_data[0]):
                        return mem[(32 * _3812 - 1) + (4 * ceil32(return_data.size)) + 288], Mask(255, 1, arg3)
                ...
                if stor1 == ext_call.return_data[12 len 20]:
                    ...
                    if _3811 - 1 >= _3811:
                        revert with 0, 50
                    if stor1 != address(ext_call.return_data[0]):
                        return mem[(32 * _3811 - 1) + (4 * ceil32(return_data.size)) + 224], Mask(255, 1, arg3)
                    ...
                    if stor1 == stor1:
                        ...
                        if stor1 != ext_call.return_data[12 len 20]:
                            ...
                            if _3814 - 1 >= _3814:
                                revert with 0, 50
                            if stor1 != address(ext_call.return_data[0]):
                                return mem[(32 * _3814 - 1) + (4 * ceil32(return_data.size)) + 256], Mask(255, 1, arg3)
                    ...
                    if not stor3[stor1][address(arg2)]:
                        ...
                        if stor1 == stor1:
                            ...
                            if _3825 - 1 >= _3825:
                                revert with 0, 50
                            if stor1 != address(ext_call.return_data[0]):
                                return mem[(32 * _3825 - 1) + (4 * ceil32(return_data.size)) + 224], Mask(255, 1, arg3)
