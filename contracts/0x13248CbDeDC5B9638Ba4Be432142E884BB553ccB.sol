...
#
const name = 'REFLECTOR', 0

const decimals = 9

const symbol = 'REFLECTOR', 0
...
function launch() {
    if not stor1[address(msg.sender)]:
        revert with 0, '!AUTHORIZED'
    if launchedAt:
        revert with 0, 'Already launched bruh'
...
function getLiquidityBacking(uint256 arg1) {
    ...
    if not totalSupply - balanceOf[stor7] - balanceOf[stor8]:
        revert with 'NH{q', 18
    return (arg1 * 2 * balanceOf[stor30] / totalSupply - balanceOf[stor7] - balanceOf[stor8])
}
...
function isOverLiquified(uint256 arg1, uint256 arg2) {
    ...
    if not totalSupply - balanceOf[stor7] - balanceOf[stor8]:
        revert with 'NH{q', 18
    return (arg2 * 2 * balanceOf[stor30] / totalSupply - balanceOf[stor7] - balanceOf[stor8] > arg1)
}
