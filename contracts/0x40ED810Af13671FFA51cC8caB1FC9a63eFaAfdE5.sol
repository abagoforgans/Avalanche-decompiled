...
const getName = 'StrategyJoeAvaxTus'
...
uint256 poolId;
uint256 sub_129ee966;
address sub_ba3353f6Address;
...
function sub_ba3353f6(?) {
    return sub_ba3353f6Address
}
...
function getHarvestable() {
    ...
    require ext_code.size(0x188bed1968b795d5c9022f6a0bb5931ac4c18f00)
    staticcall 0x188bed1968b795d5c9022f6a0bb5931ac4c18f00.0xffcd4263 with:
            gas gas_remaining wei
           args poolId, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
