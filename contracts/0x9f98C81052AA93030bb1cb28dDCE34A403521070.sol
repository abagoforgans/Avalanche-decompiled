...
function sub_92da0fd2(?) {
    return bool(sub_92da0fd2)
}

function sub_96661bfa(?) {
    return bool(sub_96661bfa)
}
...
function sub_3d0a5946(?) {
    if not stor1[address(msg.sender)]:
        revert with 0, '!AUTHORIZED'
    stor46 = 0
}

function sub_b28b441c(?) {
    if not stor1[address(msg.sender)]:
        revert with 0, '!AUTHORIZED'
    stor38 = 0
}
...
function sub_80405bd2(?) {
    ...
    stor52 = arg4
    stor53 = block.number
    sub_96661bfa = uint8(bool(arg1))
    Mask(248, 0, stor48.field_8) = Mask(248, 0, bool(arg5))
    Mask(240, 0, stor48.field_16) = Mask(240, 16, bool(arg1)) >> 16
}
