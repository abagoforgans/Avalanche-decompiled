...
function sub_2b1dab80(?) {
    return sub_2b1dab80Address
}
...
function totalHoldings() {
    staticcall sub_2b1dab80Address.getUserInfo(address arg1, address arg2) with:
...
function emergencyRedeem(uint256 arg1) {
    ...
    if 0 == totalSupply:
        if not underlyingDecimal:
            if arg1 > -1:
                revert with 0, 17
            require ext_code.size(sub_2b1dab80Address)
            call sub_2b1dab80Address.0x2e1a7d4d with:
                 gas gas_remaining wei
                args (arg1 / 10^18)
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        ...
        if bool(bool(underlyingDecimal < 78)) or bool(bool(underlyingDecimal < 32)):
            ...
            call sub_2b1dab80Address.0x2e1a7d4d with:
                 gas gas_remaining wei
                args (10^underlyingDecimal * arg1 / 10^18)
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if balanceOf[address(msg.sender)] < arg1:
                revert with 0, 17
    ...
    call sub_2b1dab80Address.0x2e1a7d4d with:
         gas gas_remaining wei
        args (10^18 * ext_call.return_data[0] / totalSupply * arg1 / 10^18)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if balanceOf[address(msg.sender)] < arg1:
        revert with 0, 17
...
function sub_fac991cc(?) {
    ...
    if uint8(stor9.field_8):
        ...
        uint8(stor9.field_8) = 0
        emit 0x7f26b83f: 1
    sub_2b1dab80Address = address(arg8)
