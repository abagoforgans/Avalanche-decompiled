...
uint256 keepPNG;
address sub_0427282dAddress;
address sub_28f9f0acAddress;
address sub_361373bbAddress;

function sub_0427282d(?) {
    return sub_0427282dAddress
}
...
function sub_28f9f0ac(?) {
    return sub_28f9f0acAddress
}

function sub_361373bb(?) {
    return sub_361373bbAddress
}
...
function deposit() {
    ...
    if ext_call.return_data[0]:
        ...
        require ext_code.size(address(rewardsAddress))
        call address(rewardsAddress).0xa694fc3a with:
             gas gas_remaining wei
            args ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if not arg1:
            ...
            if not return_data.size:
                if not arg1:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 910 len 64] = unknown_0xa9059cbb(?????), address(ext_call.return_data[0]) << 64, 0, Mask(224, 32, arg1) >> 32
                    mem[(2 * ceil32(return_data.size)) + 974 len 0] = 0
                    call wantAddress with:
                         gas gas_remaining wei
                        args Mask(224, 32, arg1) << 224, mem[(2 * ceil32(return_data.size)) + 974 len 4]
                    if not return_data.size:
                        require not ext_call.success
                        revert with 'SafeMath: subtraction overflow'
                    ...
                    if return_data.size:
                        ...
                        if not mem[(2 * ceil32(return_data.size)) + 942]:
                            revert with 0, 
                                        ...
                                        42,
                                        0x825361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                        mem[ceil32(return_data.size) + (2 * ceil32(return_data.size)) + 1021 len 22]
                else:
                    if withdrawalTreasuryFee * arg1 / arg1 != withdrawalTreasuryFee:
                        revert with 0, 
                                    32,
            ...
            if not return_data.size:
                ...
                if not arg1:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 910 len 64] = unknown_0xa9059cbb(?????), address(ext_call.return_data[0]) << 64, 0, Mask(224, 32, arg1 - (withdrawalDevFundFee * arg1 / 100000)) >> 32
                    call wantAddress with:
                         gas gas_remaining wei
                        args Mask(224, 32, arg1 - (withdrawalDevFundFee * arg1 / 100000)) << 224, mem[(2 * ceil32(return_data.size)) + 974 len 4]
                    if not return_data.size:
                        require not ext_call.success
                        revert with 'SafeMath: subtraction overflow'
                    mem[(2 * ceil32(return_data.size)) + 942 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    if not ext_call.success:
                        ...
                        revert with 0, 
                                    'SafeERC20: low-level call failed',
                                    mem[ceil32(return_data.size) + (2 * ceil32(return_data.size)) + 1011 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                    if return_data.size:
                        require return_data.size >= 32
                        if not mem[(2 * ceil32(return_data.size)) + 942]:
                            revert with 0, 
                                        ...
                                        42,
                                        0x825361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                        mem[ceil32(return_data.size) + (2 * ceil32(return_data.size)) + 1021 len (2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 22]
                else:
                    if withdrawalTreasuryFee * arg1 / arg1 != withdrawalTreasuryFee:
                        revert with 0, 
                                    32,
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(2 * ceil32(return_data.size)) + 910 len 64] = unknown_0xa9059cbb(?????), address(ext_call.return_data[0]) << 64, 0, Mask(224, 32, arg1 - (withdrawalDevFundFee * arg1 / 100000) - (withdrawalTreasuryFee * arg1 / 100000)) >> 32
                        call wantAddress with:
                             gas gas_remaining wei
                            args Mask(224, 32, arg1 - (withdrawalDevFundFee * arg1 / 100000) - (withdrawalTreasuryFee * arg1 / 100000)) << 224, mem[(2 * ceil32(return_data.size)) + 974 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: subtraction overflow'
                        mem[(2 * ceil32(return_data.size)) + 942 len return_data.size] = ext_call.return_data[0 len return_data.size]
