...
uint256 poolId;
uint256 avax_pefi_poolId;
address joe_avax_pefi_lpAddress;
address pefiAddress;

function avax_pefi_poolId() {
    return avax_pefi_poolId
}
...
function joe_avax_pefi_lp() {
    return joe_avax_pefi_lpAddress
}
