...
function sub_bc157a5a(?) {
    ...
    call routerAddress.addLiquidityAVAX(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
       value stor8 wei
         gas gas_remaining wei
        args sub_405cf91dAddress, _44, 0, 0, address(this.address), block.timestamp
    ...
    require mem[_47 + 32] == mem[_47 + 32]
    require mem[_47 + 64] == mem[_47 + 64]
}
