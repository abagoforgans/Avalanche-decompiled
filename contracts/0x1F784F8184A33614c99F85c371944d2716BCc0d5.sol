...
function updateBalance() {
    ...
    call address(stor29).balanceOfUnderlying(address rg1) with:
...
function farm() {
    ...
    staticcall wantAddress.allowance(address rg1, address rg2) with:
            gas gas_remaining wei
           args address(this.address), address(stor29)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if ext_code.size(wantAddress) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor29), uint32(stor29), Mask(224, 31, ext_call.return_data[0]) >> 31
    mem[324 len 0] = 0
    ...
    if not return_data.size:
        if not ext_call.success:
            revert with approve(address rg1, uint256 rg2), Mask(224, 0, stor29), uint32(stor29), 2 * ext_call.return_data[0]
        if not approve(address rg1, uint256 rg2), Mask(224, 0, stor29):
            revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
    else:
        mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
        if not ext_call.success:
    ...
    if wbnbAddress != wantAddress:
        require ext_code.size(address(stor29))
        call address(stor29).mint(uint256 rg1) with:
             gas gas_remaining wei
    ...
    if not return_data.size:
        ...
        if wantLockedTotal <= 0:
            ...
            if not isAutoComp:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[456 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor29), uint32(stor29), Mask(224, 31, ext_call.return_data[0]) >> 31
                call wantAddress with:
                   funct uint32(stor29)
                     gas gas_remaining wei
        ...
        if not arg2:
            ...
            if not isAutoComp:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[584 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor29), uint32(stor29), Mask(224, 31, ext_call.return_data[0]) >> 31
                call wantAddress with:
                   funct uint32(stor29)
                     gas gas_remaining wei
        ...
        if return_data.size <= 0:
            if wantLockedTotal <= 0:
                ...
                if not isAutoComp:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 457 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor29), uint32(stor29), Mask(224, 31, ext_call.return_data[0]) >> 31
            ...
            if not arg2:
                ...
                if not isAutoComp:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 585 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor29), uint32(stor29), Mask(224, 31, ext_call.return_data[0]) >> 31
            ...
            if not arg2:
                ...
                if not isAutoComp:
                    ...
                    if not return_data.size:
                        ...
                        call address(stor29).balanceOfUnderlying(address rg1) with:
                             gas gas_remaining wei
                            args address(this.address), mem[(2 * ceil32(return_data.size)) + 622 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        wantLockedTotal = ext_call.return_data[0]
            ...
            if withdrawFeeFactor >= 10000:
                if not isAutoComp:
                    ...
                    if arg2 <= ext_call.return_data[0]:
                        mem[388 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, arg2) >> 32
                        call wantAddress with:
                           funct uint32(stor10)
                             gas gas_remaining wei
                            args Mask(224, 32, arg2) << 224, mem[452 len 4]
                    else:
                        mem[388 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor10), uint32(stor10), ext_call.return_data[0 len 28]
                        call wantAddress with:
                           funct uint32(stor10)
                             gas gas_remaining wei
                    ...
                    if wantLockedTotal >= arg2:
                        if not arg2:
                            ...
                            call farmContractAddress.claimReward(uint8 rg1, address rg2) with:
                                 gas gas_remaining wei
                                args 0, this.address
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            ...
                            require ext_code.size(address(stor29))
                            call address(stor29).redeemUnderlying(uint256 rg1) with:
                                 gas gas_remaining wei
                                args arg2
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                        ...
                        if not wantLockedTotal:
                            ...
                            if wantLockedTotal <= ext_call.return_data[0]:
                                mem[388 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor10), uint32(stor10), Mask(224, 0, stor14.field_32)
                                call wantAddress with:
                                   funct uint32(stor10)
                                     gas gas_remaining wei
                ...
                if not arg2:
                    if not isAutoComp:
                        ...
                        if 0 > ext_call.return_data[0]:
                            ...
                            mem[452 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor10), uint32(stor10), 0
                            mem[516 len 0] = 0
                            call wantAddress with:
                               funct uint32(stor10)
                                 gas gas_remaining wei
                                args Mask(480, -256, transfer(address rg1, uint256 rg2), Mask(224, 0, stor10), uint32(stor10), 0) << 256, mem[516 len 4]
                    else:
                        if wantLockedTotal >= 0:
                            require ext_code.size(farmContractAddress)
                            call farmContractAddress.claimReward(uint8 rg1, address rg2) with:
                    ...
                    if not isAutoComp:
                        ...
                        if arg2 * withdrawFeeFactor / 10000 <= ext_call.return_data[0]:
                            mem[452 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, arg2 * withdrawFeeFactor / 10000) >> 32
                            call wantAddress with:
                               funct uint32(stor10)
                                 gas gas_remaining wei
