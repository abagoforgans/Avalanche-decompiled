...
const mintAddress = 0x71a736e1a92e3decfc1857e6c5e25f8cfb2a9ed0

const DD = 0x71a736e1a92e3decfc1857e6c5e25f8cfb2a9ed0
...
function getReflectionBalance(uint256 arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require ext_code.size(0x71a736e1a92e3decfc1857e6c5e25f8cfb2a9ed0)
    staticcall 0x71a736e1a92e3decfc1857e6c5e25f8cfb2a9ed0.0x18160ddd with:
...
function setListing(uint256 arg1, uint256 arg2) {
    ...
    require arg2 == arg2
    require ext_code.size(0x71a736e1a92e3decfc1857e6c5e25f8cfb2a9ed0)
    staticcall 0x71a736e1a92e3decfc1857e6c5e25f8cfb2a9ed0.0x6352211e with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function getReflectionBalances(address arg1) {
    ...
    mem[100] = arg1
    require ext_code.size(0x71a736e1a92e3decfc1857e6c5e25f8cfb2a9ed0)
    staticcall 0x71a736e1a92e3decfc1857e6c5e25f8cfb2a9ed0.0x70a08231 with:
            gas gas_remaining wei
           args arg1
    ...
    while idx < ext_call.return_data[0]:
        ...
        mem[mem[64] + 36] = idx
        require ext_code.size(0x71a736e1a92e3decfc1857e6c5e25f8cfb2a9ed0)
        staticcall 0x71a736e1a92e3decfc1857e6c5e25f8cfb2a9ed0.0x2f745c59 with:
                gas gas_remaining wei
...
function buyListing(uint256 arg1) payable {
    ...
    require ext_code.size(0x71a736e1a92e3decfc1857e6c5e25f8cfb2a9ed0)
    call 0x71a736e1a92e3decfc1857e6c5e25f8cfb2a9ed0.0x23b872dd with:
         gas gas_remaining wei
...
function sub_4ff347ee(?) {
    ...
    if not arg2:
        ...
        while idx < arg1 + arg2:
            ...
            mem[mem[64] + 4] = forSale[idx]
            require ext_code.size(0x71a736e1a92e3decfc1857e6c5e25f8cfb2a9ed0)
            staticcall 0x71a736e1a92e3decfc1857e6c5e25f8cfb2a9ed0.getApproved(uint256 arg1) with:
                    gas gas_remaining wei
                   args forSale[idx]
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
            ...
            if mem[_76 + 12 len 20] == this.address:
                ...
                require ext_code.size(0x71a736e1a92e3decfc1857e6c5e25f8cfb2a9ed0)
                staticcall 0x71a736e1a92e3decfc1857e6c5e25f8cfb2a9ed0.0xe985e9c5 with:
                        gas gas_remaining wei
