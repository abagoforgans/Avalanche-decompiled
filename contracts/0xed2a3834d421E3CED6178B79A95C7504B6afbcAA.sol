    ...
    if not return_data.size:
        ...
        if eth.balance(this.address) >= stor6:
            ...
            call stor1.swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
               value stor6 wei
                 gas gas_remaining wei
                args stor7, Array(len=path.length, data=mem[ceil32(ceil32(arg2.length)) + 261 len 32 * path.length]), adminAddress, block.timestamp + 15
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
    else:
        ...
        if eth.balance(this.address) >= stor6:
            ...
            call stor1.swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
               value stor6 wei
                 gas gas_remaining wei
                args stor7, Array(len=path.length, data=mem[ceil32(ceil32(arg2.length)) + ceil32(return_data.size) + 262 len 32 * path.length]), adminAddress, block.timestamp + 15
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
}
        ...
        if unknown_0x8da5cb5b(?????) > uint32(call.func_hash) >> 224:
            if uint32(call.func_hash) >> 224 != unknown_0x0bd1caef(?????):
                if unknown_0x144fa6d7(?????) == uint32(call.func_hash) >> 224:
                    ...
                    if unknown_0x207add91(?????) == uint32(call.func_hash) >> 224:
                        require not msg.value
                        require calldata.size - 4 >= 64
                        if owner != msg.sender:
                            revert with 0, 'Caller is not the owner.'
                        ...
                        if uint32(call.func_hash) >> 224 != unknown_0x39cd523d(?????):
                            if uint32(call.func_hash) >> 224 != unknown_0x704b6c02(?????):
                                require unknown_0x73b295c2(?????) == uint32(call.func_hash) >> 224
                                require not msg.value
                                return WAVAXAddress
                            require not msg.value
                            require calldata.size - 4 >= 32
                ...
                if not return_data.size:
                    ...
                    if eth.balance(this.address) >= stor6:
                        ...
                        call stor1.swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
                           value stor6 wei
                             gas gas_remaining wei
                            args stor7, Array(len=path.length, data=mem[ceil32(ceil32(arg2.length)) + 293 len 32 * path.length]), adminAddress, block.timestamp + 15
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                else:
                    ...
                    if eth.balance(this.address) >= stor6:
                        ...
                        call stor1.swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
                           value stor6 wei
                             gas gas_remaining wei
                            args stor7, Array(len=path.length, data=mem[ceil32(ceil32(arg2.length)) + ceil32(return_data.size) + 294 len 32 * path.length]), adminAddress, block.timestamp + 15
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
        else:
