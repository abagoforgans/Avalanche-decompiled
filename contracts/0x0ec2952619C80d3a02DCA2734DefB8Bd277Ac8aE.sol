...
function futurUsePool() payable {
    return futurUsePoolAddress
}

function futurFee() payable {
    return futurFee
}
...
function updateRwSwapFee(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    stor17 = arg1
...
function updateFuturWall(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function updateRewardsWall(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function changeSwapLiquify(bool arg1) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    Mask(248, 0, stor18) = Mask(248, 0, arg1)
}
...
function getTotalStakedReward() payable {
...
function boostReward(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function updateFuturFee(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    futurFee = arg1
...
function getNodesRewards() payable {
    if not msg.sender:
        revert with 0, 'SENDER CAN'T BE ZERO'
    mem[100] = msg.sender
    staticcall nodeRewardManagerAddress.0x41ac82b0 with:
...
function cashoutReward(uint256 arg1) payable {
    ...
    if not uint8(stor18):
        ...
        if ext_call.return_data[0] > balanceOf[stor10]:
            revert with 0, 
                        32,
                        38,
                        0xfe45524332303a207472616e7366657220616d6f756e7420657863656564732062616c616e63, mem[ceil32(return_data.size) + 166 len 26] >> 48,
                        0
        if balanceOf[stor10] < ext_call.return_data[0]:
            revert with 0, 17
        balanceOf[stor10] -= ext_call.return_data[0]
            ...
            if not ext_call.return_data[0]:
                ...
                if not uniswapV2RouterAddress:
                    ...
                    revert with memory
                      from (2 * ceil32(return_data.size)) + 256
                       len ceil32(return_data.size) + 132
                allowance[address(this.address)][stor7] = 0
                ...
                if not uniswapV2RouterAddress:
                    ...
                    revert with memory
                      from (2 * ceil32(return_data.size)) + 256
                       len ceil32(return_data.size) + 132
                allowance[address(this.address)][stor7] = ext_call.return_data[0] * cashoutFee / 100
                ...
                if not msg.sender:
                    revert with 0, 'ERC20: transfer to the zero address'
                if ext_call.return_data[0] - (ext_call.return_data[0] * cashoutFee / 100) > balanceOf[stor10]:
                    revert with 0, 
                                32,
                                38,
                                0xfe45524332303a207472616e7366657220616d6f756e7420657863656564732062616c616e63, Mask(208, 32, block.timestamp) >> 32 >> 48,
                                0
                if balanceOf[stor10] < ext_call.return_data[0] - (ext_call.return_data[0] * cashoutFee / 100):
                    revert with 0, 17
                balanceOf[stor10] = balanceOf[stor10] - ext_call.return_data[0] + (ext_call.return_data[0] * cashoutFee / 100)
