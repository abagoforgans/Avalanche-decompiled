...
function fundContract() payable {
    ...
    stor1 = 2
    if True and not started and True:
...
function reInvest() {
    ...
    if userDepositInfo[msg.sender].field_1792 > !(s + userDepositInfo[address(msg.sender)].field_1280):
        revert with 0, 17
    userDepositInfo[msg.sender].field_2048 = userDepositInfo[msg.sender].field_1792 + s + userDepositInfo[address(msg.sender)].field_1280
...
function withdraw() {
    ...
    if userDepositInfo[msg.sender].field_2560 > 1:
        ...
        if sub_8a321b41 == -1:
            revert with 0, 17
        sub_8a321b41++
        if not userDepositInfo[msg.sender].field_2304:
