...
function startArbitrage(uint256 arg1, uint256 arg2) payable {
...
function joeCall(address arg1, uint256 arg2, uint256 arg3, bytes arg4) payable {
    ...
    if not arg3:
        ...
        if arg2:
            revert with 0, 'amount 0 is not 0'
        ...
        staticcall yAK_tokenAddress.0x70a08231 with:
                gas gas_remaining wei
               args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        mem[228] = (0 / (997 * Mask(112, 0, ext_call.return_data[0])) - (997 * arg3)) + 1
        ...
        call joeRouterAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
             gas gas_remaining wei
            args ext_call.return_data[0], (0 / (997 * Mask(112, 0, ext_call.return_data[0])) - (997 * arg3)) + 1, Array(len=2, data=mem[388 len 64]), address(this.address), block.timestamp + (240 * 24 * 3600)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[192 len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = ceil32(return_data.size) + 192
        require return_data.size >= 32
        _127 = mem[192 len 4], ext_call.return_data[0 len 28]
        ...
        mem[ceil32(return_data.size) + 224 len floor32(mem[_127 + 192])] = mem[_127 + 224 len floor32(mem[_127 + 192])]
        ...
        call WAVAXAddress.0xa9059cbb with:
             gas gas_remaining wei
            args tx.origin, mem[ceil32(return_data.size) + 256] + -(0 / (997 * Mask(112, 0, ext_call.return_data[0])) - (997 * arg3)) - 1
    else:
        require arg3
        ...
        mem[192] = 0x38ed173900000000000000000000000000000000000000000000000000000000
        mem[196] = ext_call.return_data[0]
        mem[228] = (1000 * Mask(112, 0, ext_call.return_data[32]) * arg3 / (997 * Mask(112, 0, ext_call.return_data[0])) - (997 * arg3)) + 1
        mem[292] = this.address
        mem[324] = block.timestamp + (240 * 24 * 3600)
        mem[260] = 160
        mem[356] = 2
        ...
        call joeRouterAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
             gas gas_remaining wei
            args ext_call.return_data[0], (1000 * Mask(112, 0, ext_call.return_data[32]) * arg3 / (997 * Mask(112, 0, ext_call.return_data[0])) - (997 * arg3)) + 1, Array(len=2, data=mem[388 len 64]), address(this.address), block.timestamp + (240 * 24 * 3600)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[192 len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = ceil32(return_data.size) + 192
        ...
        call WAVAXAddress.0xa9059cbb with:
             gas gas_remaining wei
            args tx.origin, mem[ceil32(return_data.size) + 256] + -(1000 * Mask(112, 0, ext_call.return_data[32]) * arg3 / (997 * Mask(112, 0, ext_call.return_data[0])) - (997 * arg3)) - 1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
}
