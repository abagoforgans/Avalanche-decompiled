...
const sub_5fd866df(?) = 0xe640fc3adcee36258215d02db8051fccaad8d3e9

const sub_c45a1ac1(?) = 0x78ea17559b3d2cf85a7f9c2c704eda119db5e6de

const Factory = 0xefa94de7a4656d787667c749f7e1223d71e9fd88

const sub_e5e22ce9(?) = 0xa5e59761ebd4436fa4d20e1a27cba29fb2471fc6
...
function sub_16aa53a4(?) payable {
    require ext_code.size(0xe640fc3adcee36258215d02db8051fccaad8d3e9)
    staticcall 0xe640fc3adcee36258215d02db8051fccaad8d3e9.0x72f702f3 with:
    ...
    require return_data.size >= 32
    require ext_code.size(0xe640fc3adcee36258215d02db8051fccaad8d3e9)
    staticcall 0xe640fc3adcee36258215d02db8051fccaad8d3e9.0x18160ddd with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(sha3(0, 17269419903419772280, sha3(8712802085545782520, 0xa5e59761ebd4436fa4d20e1a27cba29fb2471fc6), 0x40231f6b438bce0797c9ada29b718a87ea0a5cea3fe9a771abdd76bd41a3e545)))
    staticcall address(sha3(0, 17269419903419772280, sha3(8712802085545782520, 0xa5e59761ebd4436fa4d20e1a27cba29fb2471fc6), 0x40231f6b438bce0797c9ada29b718a87ea0a5cea3fe9a771abdd76bd41a3e545)).getReserves() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
