...
function allowPreTrading(address arg1, bool arg2) {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if bool(stor6[address(arg1)]) == arg2:
...
function balanceOf(address arg1) {
    ...
    if stor8 / 1000000 * 10^18 <= 0:
        revert with 0, 'SafeMath: division by zero', 0
    if not stor8 / 1000000 * 10^18:
        revert with 'NH{q', 18
    return (stor2[address(arg1)] / stor8 / 1000000 * 10^18)
}
...
function manualswap() {
    ...
    allowance[address(this.address)][stor18] = stor2[address(this.address)] / stor8 / 1000000 * 10^18
    emit Approval((stor2[address(this.address)] / stor8 / 1000000 * 10^18), this.address, uniswapV2RouterAddress);
    mem[ceil32(return_data.size) + 384] = 0x791ac94700000000000000000000000000000000000000000000000000000000
    mem[ceil32(return_data.size) + 388] = stor2[address(this.address)] / stor8 / 1000000 * 10^18
    idx = 0
    s = 320
    ...
    call uniswapV2RouterAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args stor2[address(this.address)] / stor8 / 1000000 * 10^18, 0, 160, address(this.address), block.timestamp, 2, mem[ceil32(return_data.size) + 580 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
