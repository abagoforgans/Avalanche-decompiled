...
function callReward() payable {
    ...
    if not ext_call.return_data[0]:
        return 0
    if ext_call.return_data[0] and 45 > -1 / ext_call.return_data[0]:
        revert with 'NH{q', 17
    if not ext_call.return_data[0]:
        revert with 'NH{q', 18
    ...
    if not 45 * ext_call.return_data[0] / 1000:
        return 0
    if 45 * ext_call.return_data[0] / 1000 and callFee > -1 / 45 * ext_call.return_data[0] / 1000:
        revert with 'NH{q', 17
    if not 45 * ext_call.return_data[0] / 1000:
        revert with 'NH{q', 18
...
function outputToNative() payable {
    ...
    if not outputToWantRoute.length:
        ...
        idx = 0
        s = 128
        t = (32 * outputToWantRoute.length) + 192
    ...
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            if uint8(stor0.field_160):
                ...
                mem[(4 * ceil32(return_data.size)) + 494] = 'Pausable: paused'
                revert with memory
                  from (4 * ceil32(return_data.size)) + 426
                   len (6 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 100
    ('iszero', ('type', 8, ('field', 160, ('stor', ('name', 'stor0', 0)))))
    require ext_code.size(wantAddress)
    staticcall wantAddress.0x70a08231 with:
            gas gas_remaining wei
           args this.address
