        ...
        if eth.balance(this.address) <= chainGasAmount:
            ...
            if not return_data.size:
                ...
                if ext_call.return_data[0] < arg8:
                    ...
                    mem[ceil32(return_data.size) + 129 len 4] = transfer(address arg1, uint256 arg2)
                    if eth.balance(this.address) < 0:
                        revert with 0, 
                                    32,
                                    38,
                    ...
                    if not ext_code.size(arg2):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 261 len 64] = transfer(address arg1, uint256 arg2), address(arg1) << 64, 0, Mask(224, 32, arg3 - arg4) >> 32
                    call arg2 with:
                         gas gas_remaining wei
                    ...
                    if not ext_code.size(arg2):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 261 len 64] = approve(address arg1, uint256 arg2), address(arg5) << 64, 0, Mask(224, 32, arg3 + ext_call.return_data[0]) >> 32
                    ...
                    if return_data.size:
                        ...
                        if not ext_call.success:
                            ...
                            if not ext_code.size(arg2):
                                revert with 0, 'Address: call to non-contract'
                            mem[(2 * ceil32(return_data.size)) + 426 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)] = transfer(address arg1, uint256 arg2), address(arg1) << 64, 0, Mask(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36, -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256, arg3 - arg4) >> -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256
                            call arg2 with:
                            ...
                            if WETH_ADDRESS != ext_call.return_data[12 len 20]:
                                ...
                                if not ext_code.size(address(ext_call.return_data[0])):
                                    revert with 0, 'Address: call to non-contract'
                                mem[(2 * ceil32(return_data.size)) + 426 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)] = transfer(address arg1, uint256 arg2), address(arg1) << 64, 0, ext_call.return_data[0 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36]
                                call address(ext_call.return_data[0]) with:
                                   funct Mask(8 * -floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) + 68, 224, 0) >> 224, mem[(2 * ceil32(return_data.size)) + 330 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 64]
                                     gas gas_remaining wei
