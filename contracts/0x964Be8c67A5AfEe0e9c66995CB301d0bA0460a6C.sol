...
function getAssetPrice(address arg1, uint256 arg2) payable {
    ...
    if not ext_call.return_data[25 len 1]:
        ...
        if ext_call.return_data[0] and arg2 > -1 / ext_call.return_data[0]:
            revert with 'NH{q', 17
        if ext_call.return_data[0] * arg2 > 0x6df37f675ef6eadf5ab9a2072d44268d97df837e6748956e5c6c2117:
            revert with 'NH{q', 17
        return (10^10 * ext_call.return_data[0] * arg2)
    if bool(bool(ext_call.return_data[25 len 1] < 78)) or bool(bool(ext_call.return_data[25 len 1] < 32)):
        ...
        if not 10^(Mask(8, 48, ext_call.return_data[0]) >> 48):
            revert with 'NH{q', 18
        if ext_call.return_data[0] * arg2 / 10^(Mask(8, 48, ext_call.return_data[0]) >> 48) > 0x6df37f675ef6eadf5ab9a2072d44268d97df837e6748956e5c6c2117:
            revert with 'NH{q', 17
        return (10^10 * ext_call.return_data[0] * arg2 / 10^(Mask(8, 48, ext_call.return_data[0]) >> 48))
    s = 10
    t = 1
    ...
    if not s * t:
        revert with 'NH{q', 18
    if ext_call.return_data[0] * arg2 / s * t > 0x6df37f675ef6eadf5ab9a2072d44268d97df837e6748956e5c6c2117:
        revert with 'NH{q', 17
    return (10^10 * ext_call.return_data[0] * arg2 / s * t)
}
