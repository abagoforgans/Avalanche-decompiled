...
function buy(uint256 arg1) payable {
    ...
    mem[64] = 192
    mem[96] = 41
    mem[128 len 41] = 0xfe4552433732313a206f776e657220717565727920666f72206e6f6e6578697374656e7420746f6b65
    if not stor5[arg1]:
        revert with 0, 
                    32,
                    41,
    ...
    if bazaar[arg1].field_256 < 0:
        ...
        while idx < persons.length:
            ...
            if persons[idx] != msg.sender:
                ...
                idx = idx + 1
                continue 
            if nbNFTHolders[address(msg.sender)] > -2:
                revert with 'NH{q', 17
            nbNFTHolders[address(msg.sender)]++
            if nbNFTHolders[stor4[stor5[arg1] - 1].field_256] != 1:
                if nbNFTHolders[stor4[stor5[arg1] - 1].field_256] < 1:
                    revert with 'NH{q', 17
                nbNFTHolders[stor4[stor5[arg1] - 1].field_256]--
            else:
                mem[0] = tokenByIndex[stor5[arg1] - 1].field_256
                mem[32] = 17
                nbNFTHolders[stor4[stor5[arg1] - 1].field_256] = 0
                idx = 0
                while idx < persons.length:
                    mem[0] = 15
                    if persons[idx] != tokenByIndex[stor5[arg1] - 1].field_256:
                        if idx == -1:
                            revert with 'NH{q', 17
                        idx = idx + 1
                        continue 
                    if persons.length < 1:
                        revert with 'NH{q', 17
                    if persons.length - 1 >= persons.length:
                        revert with 'NH{q', 50
                    if idx >= persons.length:
                        revert with 'NH{q', 50
                    persons[idx] = persons[persons.length]
                    if not persons.length:
                        revert with 'NH{q', 49
                    persons[persons.length] = 0
                    persons.length--
                    mem[224 len 41] = 0xfe4552433732313a206f776e657220717565727920666f72206e6f6e6578697374656e7420746f6b65
                    if not stor5[arg1]:
                        ...
                        while idx < 41:
                            ...
                            idx = idx + 32
                            continue 
                        revert with 0, 32, 41, mem[356 len 41], 0
                    if stor5[arg1] < 1:
                        revert with 'NH{q', 17
                    if stor5[arg1] - 1 >= tokenByIndex.length:
                        revert with 'NH{q', 50
                    mem[320 len 41] = 0xfe4552433732313a206f776e657220717565727920666f72206e6f6e6578697374656e7420746f6b65
                    if not stor5[arg1]:
                        ...
                        while idx < 41:
                            ...
                            idx = idx + 32
                            continue 
                        revert with 0, 32, 41, mem[452 len 41], 0
                    if stor5[arg1] < 1:
                        revert with 'NH{q', 17
                    if stor5[arg1] - 1 >= tokenByIndex.length:
                        revert with 'NH{q', 50
                    ...
                    if not msg.sender:
                        revert with 0, 'ERC721: transfer to the zero address'
                    approved[arg1] = 0
                    mem[416 len 41] = 0xfe4552433732313a206f776e657220717565727920666f72206e6f6e6578697374656e7420746f6b65
                    if not stor5[arg1]:
                        ...
                        while idx < 41:
                            ...
                            idx = idx + 32
                            continue 
                        revert with 0, 32, 41, mem[548 len 41], 0
                    if stor5[arg1] < 1:
                        revert with 'NH{q', 17
                    if stor5[arg1] - 1 >= tokenByIndex.length:
                        revert with 'NH{q', 50
                    ...
                    while idx < nftForSale.length:
                        ...
                        idx = 0
                        while idx < persons.length:
                            if nbNFTHolders[stor15[idx]] and 10000 > -1 / nbNFTHolders[stor15[idx]]:
                                revert with 'NH{q', 17
                            if not tokenByIndex.length:
                                revert with 'NH{q', 18
                            if 10000 * nbNFTHolders[stor15[idx]] / tokenByIndex.length and 0 > -1 / 10000 * nbNFTHolders[stor15[idx]] / tokenByIndex.length:
                                revert with 'NH{q', 17
                            if idx >= persons.length:
                                revert with 'NH{q', 50
                            mem[0] = persons[idx]
                            mem[32] = 18
                            if tokenGrant[stor15[idx]] > -1:
                                revert with 'NH{q', 17
                            if idx == -1:
                                revert with 'NH{q', 17
                            idx = idx + 1
            ...
            if nbNFTHolders[stor4[stor5[arg1] - 1].field_256] != 1:
                ...
                while idx < persons.length:
                    ...
                    while idx < nftForSale.length:
                        ...
                        nftForSale[nftForSale.length].field_0 = 0
                        nftForSale.length--
                        if stor14 > -(5 * msg.value / 100) - 1:
                            revert with 'NH{q', 17
                        stor14 += 5 * msg.value / 100
                        idx = 0
                        while idx < persons.length:
                            if nbNFTHolders[stor15[idx]] and 10000 > -1 / nbNFTHolders[stor15[idx]]:
                                revert with 'NH{q', 17
                            if not tokenByIndex.length:
                                revert with 'NH{q', 18
                            if 10000 * nbNFTHolders[stor15[idx]] / tokenByIndex.length and 5 * msg.value / 100 > -1 / 10000 * nbNFTHolders[stor15[idx]] / tokenByIndex.length:
                                revert with 'NH{q', 17
                            if idx >= persons.length:
                                revert with 'NH{q', 50
                            mem[0] = persons[idx]
                            mem[32] = 18
                            if tokenGrant[stor15[idx]] > -(10000 * nbNFTHolders[stor15[idx]] / tokenByIndex.length * 5 * msg.value / 100 / 10000) - 1:
                                revert with 'NH{q', 17
                            tokenGrant[stor15[idx]] += 10000 * nbNFTHolders[stor15[idx]] / tokenByIndex.length * 5 * msg.value / 100 / 10000
                            if idx == -1:
                                revert with 'NH{q', 17
                            idx = idx + 1
                            continue 
