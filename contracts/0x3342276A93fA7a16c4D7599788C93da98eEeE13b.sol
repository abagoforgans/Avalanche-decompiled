...
function cancelOffer(uint256 arg1) {
    ...
    if not sub_ebdfbce5[arg1][address(msg.sender)].field_0:
        revert with 0, 'AvaxApesMarket: offer does not exist or expired'
...
function createOffer(uint256 arg1, uint256 arg2, uint256 arg3) {
    ...
    if sub_ebdfbce5[arg1][address(msg.sender)].field_0:
        if sub_ebdfbce5[arg1][address(msg.sender)].field_512 > block.timestamp:
            revert with 0, 'AvaxApesMarket: offer already created'
    if uint8(stor2.field_0):
        revert with 0, 'Pausable: paused'
...
function buy(uint256 arg1) payable {
    ...
    require ext_code.size(address(stor2.field_8))
    staticcall address(stor2.field_8).tokenMinter(uint256 rg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if stor5 + stor6 > !stor7:
        revert with 0, 17
    if 100 < stor5 + stor6 + stor7:
        revert with 0, 17
    if msg.value and -stor5 + -stor6 + -stor7 + 100 > -1 / msg.value:
        revert with 0, 17
    call listings[arg1].field_0 with:
       value (100 * msg.value) - (stor5 * msg.value) - (stor6 * msg.value) - (stor7 * msg.value) / 100 wei
...
function acceptOffer(uint256 arg1, address arg2) {
    ...
    if 100 < stor5 + stor6 + stor7:
        revert with 0, 17
    if sub_ebdfbce5[arg1][address(arg2)].field_256 and -stor5 + -stor6 + -stor7 + 100 > -1 / sub_ebdfbce5[arg1][address(arg2)].field_256:
        revert with 0, 17
    call msg.sender with:
       value (100 * sub_ebdfbce5[arg1][address(arg2)].field_256) - (stor5 * sub_ebdfbce5[arg1][address(arg2)].field_256) - (stor6 * sub_ebdfbce5[arg1][address(arg2)].field_256) - (stor7 * sub_ebdfbce5[arg1][address(arg2)].field_256) / 100 wei
         gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
