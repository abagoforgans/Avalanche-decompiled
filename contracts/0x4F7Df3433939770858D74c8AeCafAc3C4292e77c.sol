...
#
const zap = 0x15399d45309f06225fff8743dfb42de318aca63e
...
function harvest() payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(0x15399d45309f06225fff8743dfb42de318aca63e)
    call 0x15399d45309f06225fff8743dfb42de318aca63e.zapInToken(address rg1, uint256 rg2, address rg3) with:
         gas gas_remaining wei
