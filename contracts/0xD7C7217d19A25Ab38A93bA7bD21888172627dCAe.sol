...
function start(uint256 arg1) payable {
    ...
    call sub_db2a4673Address.Stake(uint256 arg1) with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function stop() payable {
    ...
    require ext_code.size(sub_db2a4673Address)
    staticcall sub_db2a4673Address.showPendingReward() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    require ext_code.size(sub_db2a4673Address)
    staticcall sub_db2a4673Address.Balance() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    require ext_call.return_data[0] == ext_call.return_data[0]
    require ext_code.size(sub_db2a4673Address)
    call sub_db2a4673Address.UnStake(uint256 arg1) with:
         gas gas_remaining wei
        args -1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
