...
function swap(address arg1, address arg2, uint256 arg3, uint256 arg4, address arg5) payable {
    ...
    call arg1.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 0x7e2528476b14507f003ae9d123334977f5ad7b14, arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if arg1 == 0xc778417e063141139fce010982780140aa0cd5ab:
        ...
        mem[356] = 2
        mem[388 len 0] = None
        require ext_code.size(0x7e2528476b14507f003ae9d123334977f5ad7b14)
        call 0x7e2528476b14507f003ae9d123334977f5ad7b14.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
...
function getAmountOutMin(address arg1, address arg2, uint256 arg3) payable {
    ...
    if arg1 == 0xc778417e063141139fce010982780140aa0cd5ab:
        ...
        mem[292 len 0] = None
        require ext_code.size(0x7e2528476b14507f003ae9d123334977f5ad7b14)
        staticcall 0x7e2528476b14507f003ae9d123334977f5ad7b14.getAmountsOut(uint256 arg1, address[] arg2) with:
                gas gas_remaining wei
