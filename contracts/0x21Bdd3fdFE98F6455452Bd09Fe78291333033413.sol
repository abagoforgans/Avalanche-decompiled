        ...
        if block.timestamp < periodFinish:
            ...
            if not totalSupply:
                ...
                if eth.balance(this.address) < 0:
                    revert with 0, 32, 38, 0x74416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[622 len 26]
                if not ext_code.size(uniTokenAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[516 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, arg1) >> 32
                ...
                if block.timestamp < periodFinish:
                    ...
                    balanceOf[msg.sender] -= arg1
                    if eth.balance(this.address) < 0:
                        revert with 0, 32, 38, 0x74416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[750 len 26]
                    if not ext_code.size(uniTokenAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[644 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, arg1) >> 32
                else:
                    if lastUpdateTime > periodFinish:
                        revert with 0, 'SafeMath: subtraction overflow'
                    if not periodFinish - lastUpdateTime:
            ...
            if not periodFinish - lastUpdateTime:
                ...
                if block.timestamp < periodFinish:
                    ...
                    if not totalSupply:
                        ...
                        balanceOf[msg.sender] -= arg1
                        if eth.balance(this.address) < 0:
                            revert with 0, 32, 38, 0x74416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[878 len 26]
                        if not ext_code.size(uniTokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[772 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, arg1) >> 32
                        call uniTokenAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
