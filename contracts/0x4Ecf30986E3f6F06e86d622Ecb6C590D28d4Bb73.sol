...
function withdrawFees(address arg1, address arg2) {
    ...
    if paused:
        ...
        require roleAdmin[0x71840dc4906352362b0cdaf79870196c8e42acafade72d5d5a6d59291253ceb1][1][address(msg.sender)].field_0
        if not arg2:
            revert with 0, 'Address is 0x000'
        else:
            if not feeBalance[address(arg1)].field_0:
            else:
                if eth.balance(this.address) < 0:
...
function withdraw(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes32 arg5) {
    ...
    if WETH_ADDRESS != arg2:
        ...
        if WETH_ADDRESS:
            ...
            call WETH_ADDRESS.0x2e1a7d4d with:
                 gas gas_remaining wei
                args (arg3 - arg4)
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
