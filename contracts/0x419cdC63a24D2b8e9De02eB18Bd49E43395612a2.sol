...
function sub_074351a9(?) payable {
    ...
    mem[64] = floor32(('cd', 4).length) + 353
    ...
    staticcall 0x6ffb1bb6811b07aa326eecd1320a5a3297371de2.mem[mem[64] len 4] with:
           ...
           args mem[mem[64] + 4 len floor32(('cd', 4).length) + (32 * ('cd', 4).length) + (32 * mem[floor32(('cd', 4).length) + 225]) + -mem[64] + 577]
    ...
    while idx < _281:
        ...
        _426 = mem[_279 + _280 + _362 + mem[_279 + _280 + _362 + 128] + 32]
...
function swapExactETHForTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) payable {
    ...
    staticcall 0x6ffb1bb6811b07aa326eecd1320a5a3297371de2.0xaef022b8 with:
            gas gas_remaining wei
           args address(stor1), 160, 0, 0, (32 * arg2.length) + 192, arg2.length, mem[floor32(arg2.length) + 677 len (32 * arg2.length) + 128]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    _278 = mem[floor32(arg2.length) + 481 len 4], Mask(224, 0, stor1)
    require mem[floor32(arg2.length) + 481 len 4], Mask(224, 0, stor1) <= test266151307()
    require floor32(arg2.length) + mem[floor32(arg2.length) + 481 len 4], Mask(224, 0, stor1) + 512 < floor32(arg2.length) + return_data.size + 481
    _279 = mem[floor32(arg2.length) + mem[floor32(arg2.length) + 481 len 4], Mask(224, 0, stor1) + 481]
    if mem[floor32(arg2.length) + mem[floor32(arg2.length) + 481 len 4], Mask(224, 0, stor1) + 481] > test266151307():
        revert with 'NH{q', 65
    if floor32(arg2.length) + ceil32(return_data.size) + floor32(mem[floor32(arg2.length) + mem[floor32(arg2.length) + 481 len 4], Mask(224, 0, stor1) + 481]) + 482 > test266151307() or floor32(mem[floor32(arg2.length) + mem[floor32(arg2.length) + 481 len 4], Mask(224, 0, stor1) + 481]) + 1 < 0:
        revert with 'NH{q', 65
    mem[64] = floor32(arg2.length) + ceil32(return_data.size) + floor32(mem[floor32(arg2.length) + mem[floor32(arg2.length) + 481 len 4], Mask(224, 0, stor1) + 481]) + 482
    mem[floor32(arg2.length) + ceil32(return_data.size) + 481] = mem[floor32(arg2.length) + mem[floor32(arg2.length) + 481 len 4], Mask(224, 0, stor1) + 481]
    ...
    stor3 = mem[mem[floor32(arg2.length) + ceil32(return_data.size) + 513]]
    stor4 = mem[mem[floor32(arg2.length) + ceil32(return_data.size) + 513] + 32]
    stor5 = mem[mem[floor32(arg2.length) + ceil32(return_data.size) + 513] + 64]
...
function sub_d5ffafcc(?) payable {
    ...
    _1065 = mem[_1063 + mem[_1063]]
    if mem[_1063 + mem[_1063]] > test266151307():
        revert with 'NH{q', 65
    if _1063 + ceil32(return_data.size) + floor32(mem[_1063 + mem[_1063]]) + 1 > test266151307() or floor32(mem[_1063 + mem[_1063]]) + 1 < 0:
        revert with 'NH{q', 65
    mem[64] = _1063 + ceil32(return_data.size) + floor32(mem[_1063 + mem[_1063]]) + 1
    mem[_1063 + ceil32(return_data.size)] = _1065
    require _1064 + (32 * _1065) + 32 <= return_data.size
    idx = 0
    s = _1063 + _1064 + 32
    t = _1063 + ceil32(return_data.size) + 32
    while idx < _1065:
        _1408 = mem[s]
        require mem[s] <= test266151307()
        ...
        if mem[64] + 128 > test266151307() or mem[64] + 128 < mem[64]:
            revert with 'NH{q', 65
        mem[64] = mem[64] + 128
        require mem[_1063 + _1064 + _1408 + 32] == mem[_1063 + _1064 + _1408 + 32]
        mem[_1412] = mem[_1063 + _1064 + _1408 + 32]
        require mem[_1063 + _1064 + _1408 + 64] == mem[_1063 + _1064 + _1408 + 64]
        mem[_1412 + 32] = mem[_1063 + _1064 + _1408 + 64]
        require mem[_1063 + _1064 + _1408 + 96] == mem[_1063 + _1064 + _1408 + 96]
        mem[_1412 + 64] = mem[_1063 + _1064 + _1408 + 96]
        _1568 = mem[_1063 + _1064 + _1408 + 128]
        require mem[_1063 + _1064 + _1408 + 128] <= test266151307()
        require _1063 + _1064 + _1408 + mem[_1063 + _1064 + _1408 + 128] + 63 < _1063 + return_data.size
        _1615 = mem[_1063 + _1064 + _1408 + mem[_1063 + _1064 + _1408 + 128] + 32]
        if mem[_1063 + _1064 + _1408 + mem[_1063 + _1064 + _1408 + 128] + 32] > test266151307():
            revert with 'NH{q', 65
        _1677 = mem[64]
        if mem[64] + floor32(mem[_1063 + _1064 + _1408 + mem[_1063 + _1064 + _1408 + 128] + 32]) + 1 > test266151307() or mem[64] + floor32(mem[_1063 + _1064 + _1408 + mem[_1063 + _1064 + _1408 + 128] + 32]) + 1 < mem[64]:
            revert with 'NH{q', 65
        mem[64] = mem[64] + floor32(mem[_1063 + _1064 + _1408 + mem[_1063 + _1064 + _1408 + 128] + 32]) + 1
        mem[_1677] = _1615
        require _1064 + _1408 + _1568 + (192 * _1615) + 64 <= return_data.size
        u = 0
        v = _1063 + _1064 + _1408 + _1568 + 64
        w = _1677 + 32
        while u < _1615:
            require _1063 + return_data.size - v >= 192
            _1772 = mem[64]
            if mem[64] + 192 > test266151307() or mem[64] + 192 < mem[64]:
                revert with 'NH{q', 65
            mem[64] = mem[64] + 192
        ...
        continue 
    t = 0
    while t < mem[_1063 + ceil32(return_data.size)]:
        if t >= mem[_1063 + ceil32(return_data.size)]:
            revert with 'NH{q', 50
        if mem[mem[(32 * t) + _1063 + ceil32(return_data.size) + 32] + 64] > 0:
            if t >= mem[_1063 + ceil32(return_data.size)]:
                revert with 'NH{q', 50
        if t == -1:
            revert with 'NH{q', 17
        t = t + 1
        continue 
    if 0 >= mem[_1063 + ceil32(return_data.size)]:
        revert with 'NH{q', 50
    _1752 = mem[_1063 + ceil32(return_data.size) + 32]
    stor3 = mem[mem[_1063 + ceil32(return_data.size) + 32]]
    stor4 = mem[mem[_1063 + ceil32(return_data.size) + 32] + 32]
    stor5 = mem[mem[_1063 + ceil32(return_data.size) + 32] + 64]
    _2083 = mem[mem[mem[_1063 + ceil32(return_data.size) + 32] + 96]]
    t = 0
    while t < _2083:
        _2086 = mem[64]
        mem[64] = mem[64] + 192
