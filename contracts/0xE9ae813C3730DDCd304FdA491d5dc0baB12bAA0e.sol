...
function sub_d8ce4d99(?) payable {
    ...
    require ext_code.size(arg3)
    call arg3.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
...
function sub_81ce2e00(?) payable {
    ...
    call arg4.swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
       value msg.value wei
         gas gas_remaining wei
    ...
    require ext_code.size(arg4)
    call arg4.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
...
function sub_48727fd3(?) payable {
    ...
    if arg1 == stor3:
        ...
        idx = 0
        while idx < arg6:
            mem[384] = 0xb6f9de9500000000000000000000000000000000000000000000000000000000
            mem[388] = 0
            mem[452] = msg.sender
        ...
        idx = 0
        while idx < arg6:
            mem[416] = 0xb6f9de9500000000000000000000000000000000000000000000000000000000
            mem[420] = 0
            mem[484] = msg.sender
