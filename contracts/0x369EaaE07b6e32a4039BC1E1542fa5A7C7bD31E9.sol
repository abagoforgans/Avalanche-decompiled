...
function mint(uint256 arg1) payable {
    ...
    while idx < arg1:
        ...
        if ext_code.size(msg.sender) > 0:
            ...
            require return_data.size >= 32
            require mem[_107] == Mask(32, 224, mem[_107])
            if Mask(32, 224, mem[_107]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
    ...
    if addressMintedBalance[address(msg.sender)] > -arg1 - 1:
        revert with 'NH{q', 17
    addressMintedBalance[address(msg.sender)] += arg1
