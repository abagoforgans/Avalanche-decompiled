...
const sub_4e20a02c(?) = 4200 * 10^18

const sub_ffa8226e(?) = 4200 * 10^18
...
function sub_7b95ae04(?) payable {
    return sub_7b95ae04Address
}
...
function distributeReward(address arg1, address arg2) payable {
    ...
    if not arg1:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply > 0xffffffffffffffffffffffffffffffffffffffffffffff1c514a8c8dbf5fffff:
        revert with 0, 17
    if totalSupply + 4200 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 4200 * 10^18
    if balanceOf[address(arg1)] > 0xffffffffffffffffffffffffffffffffffffffffffffff1c514a8c8dbf5fffff:
        revert with 0, 17
    if balanceOf[address(arg1)] + 4200 * 10^18 < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 4200 * 10^18
    emit Transfer(4200 * 10^18, 0, arg1);
    if not arg2:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply > 0xffffffffffffffffffffffffffffffffffffffffffffff1c514a8c8dbf5fffff:
        revert with 0, 17
    if totalSupply + 4200 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 4200 * 10^18
    if balanceOf[address(arg2)] > 0xffffffffffffffffffffffffffffffffffffffffffffff1c514a8c8dbf5fffff:
        revert with 0, 17
    if balanceOf[address(arg2)] + 4200 * 10^18 < balanceOf[address(arg2)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg2)] += 4200 * 10^18
    emit Transfer(4200 * 10^18, 0, arg2);
}
