...
function payBackToken(uint256 arg1, uint256 arg2) payable {
    ...
    if not arg2:
        ...
        if (0 / 10000 * ext_call.return_data[0]) + vaultCollateral[stor19].field_0 < vaultCollateral[stor19].field_0:
            revert with 0, 'SafeMath: addition overflow'
        vaultCollateral[stor19].field_0 += 0 / 10000 * ext_call.return_data[0]
        ...
        if not closingFee * arg2:
            ...
            if (tokenPeg * closingFee * arg2 / 10000 * ext_call.return_data[0]) + vaultCollateral[stor19].field_0 < vaultCollateral[stor19].field_0:
                revert with 0, 'SafeMath: addition overflow'
            vaultCollateral[stor19].field_0 += tokenPeg * closingFee * arg2 / 10000 * ext_call.return_data[0]
            if arg2 > totalBorrowed:
                revert with 0, 'SafeMath: subtraction overflow'
            totalBorrowed -= arg2
