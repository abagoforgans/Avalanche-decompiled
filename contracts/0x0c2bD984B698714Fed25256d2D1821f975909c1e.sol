...
function sub_a017ad9b(?) payable {
    ...
    call stor1.withdraw(address arg1, uint256 arg2, address arg3) with:
         gas gas_remaining wei
        args address(arg1), arg2, address(arg3)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function depositDAI(uint256 arg1) payable {
    ...
    call stor1.deposit(address arg1, uint256 arg2, address arg3, uint16 arg4) with:
         gas gas_remaining wei
        args stor2, arg1, address(this.address), 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    emit Deposit(arg1, stor2, msg.sender);
    if sub_77b7dc5f[address(msg.sender)] > -arg1 - 1:
        revert with 'NH{q', 17
    sub_77b7dc5f[address(msg.sender)] += arg1
}
...
function depositUSDT(uint256 arg1) payable {
    ...
    call stor1.deposit(address arg1, uint256 arg2, address arg3, uint16 arg4) with:
         gas gas_remaining wei
        args stor3, arg1, address(this.address), 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    emit Deposit(arg1, stor3, msg.sender);
    if sub_60a6e624[address(msg.sender)] > -arg1 - 1:
        revert with 'NH{q', 17
    sub_60a6e624[address(msg.sender)] += arg1
}
...
function depositUSDC(uint256 arg1) payable {
    ...
    call stor1.deposit(address arg1, uint256 arg2, address arg3, uint16 arg4) with:
         gas gas_remaining wei
        args stor4, arg1, address(this.address), 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    emit Deposit(arg1, stor4, msg.sender);
    if sub_f9f5cc73[address(msg.sender)] > -arg1 - 1:
        revert with 'NH{q', 17
    sub_f9f5cc73[address(msg.sender)] += arg1
}
...
function withdrawDAI(address arg1, uint256 arg2) payable {
    ...
    if sub_77b7dc5f[address(msg.sender)] <= 0:
    ...
    if not sub_77b7dc5f[address(msg.sender)]:
        sub_77b7dc5f[address(msg.sender)] = 0
        call stor1.withdraw(address arg1, uint256 arg2, address arg3) with:
             gas gas_remaining wei
        ...
        if ext_call.return_data[0] < ext_call.return_data[0] * arg2 / 100:
            revert with 'NH{q', 17
        if ext_call.return_data[0] * arg2 / 100 > 0:
            ...
            if not ext_call.return_data[0]:
                revert with 0, 'Could not transfer tokens'
        if ext_call.return_data[0] - (ext_call.return_data[0] * arg2 / 100) > 0:
            call stor2.0xa9059cbb with:
                 gas gas_remaining wei
        ...
        if not ext_call.return_data[0]:
            ...
            if ext_call.return_data[0] < (ext_call.return_data[0] * arg2) - ((sub_77b7dc5f[address(msg.sender)] * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100:
                revert with 'NH{q', 17
            if (ext_call.return_data[0] * arg2) - ((sub_77b7dc5f[address(msg.sender)] * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100 > 0:
                call stor2.0xa9059cbb with:
                     gas gas_remaining wei
                ...
                if not ext_call.return_data[0]:
                    revert with 0, 'Could not transfer tokens'
            if ext_call.return_data[0] - ((ext_call.return_data[0] * arg2) - ((sub_77b7dc5f[address(msg.sender)] * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100) > 0:
                call stor2.0xa9059cbb with:
                     gas gas_remaining wei
...
function withdrawUSDT(address arg1, uint256 arg2) payable {
    ...
    if arg2 >= 100:
        revert with 0, 'Invalid percentage'
    if sub_60a6e624[address(msg.sender)] <= 0:
        revert with 0, 'Nothing to withdraw'
    staticcall stor1.getReserveNormalizedIncome(address arg1) with:
            gas gas_remaining wei
           args stor3
    ...
    if not sub_60a6e624[address(msg.sender)]:
        sub_60a6e624[address(msg.sender)] = 0
        call stor1.withdraw(address arg1, uint256 arg2, address arg3) with:
             gas gas_remaining wei
        ...
        if not ext_call.return_data[0]:
            ...
            if ext_call.return_data[0] < (ext_call.return_data[0] * arg2) - ((sub_60a6e624[address(msg.sender)] * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100:
                revert with 'NH{q', 17
            if (ext_call.return_data[0] * arg2) - ((sub_60a6e624[address(msg.sender)] * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100 > 0:
                call stor3.0xa9059cbb with:
                     gas gas_remaining wei
                ...
                if not ext_call.return_data[0]:
                    revert with 0, 'Could not transfer tokens'
            if ext_call.return_data[0] - ((ext_call.return_data[0] * arg2) - ((sub_60a6e624[address(msg.sender)] * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100) > 0:
                call stor3.0xa9059cbb with:
                     gas gas_remaining wei
...
function withdrawUSDC(address arg1, uint256 arg2) payable {
    ...
    if arg2 >= 100:
        revert with 0, 'Invalid percentage'
    if sub_f9f5cc73[address(msg.sender)] <= 0:
        revert with 0, 'Nothing to withdraw'
    staticcall stor1.getReserveNormalizedIncome(address arg1) with:
            gas gas_remaining wei
           args stor4
    ...
    if not sub_f9f5cc73[address(msg.sender)]:
        sub_f9f5cc73[address(msg.sender)] = 0
        call stor1.withdraw(address arg1, uint256 arg2, address arg3) with:
             gas gas_remaining wei
        ...
        if not ext_call.return_data[0]:
            ...
            if ext_call.return_data[0] < (ext_call.return_data[0] * arg2) - ((sub_f9f5cc73[address(msg.sender)] * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100:
                revert with 'NH{q', 17
            if (ext_call.return_data[0] * arg2) - ((sub_f9f5cc73[address(msg.sender)] * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100 > 0:
                call stor4.0xa9059cbb with:
                     gas gas_remaining wei
                ...
                if not ext_call.return_data[0]:
                    revert with 0, 'Could not transfer tokens'
            if ext_call.return_data[0] - ((ext_call.return_data[0] * arg2) - ((sub_f9f5cc73[address(msg.sender)] * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100) > 0:
                call stor4.0xa9059cbb with:
                     gas gas_remaining wei
