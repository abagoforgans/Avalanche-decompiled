...
#
const startBlock = 16884696

const ownerNATIVEReward = 1111

const NATIVEMaxSupply = 1690420 * 10^18

const NATIVEPerBlock = 107205733 * 10^9

const NATIVE = 0xe4faf95eeae77f9dbba122fe84c76b65f9278d3d
...
function getMultiplier(uint256 arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require ext_code.size(0xe4faf95eeae77f9dbba122fe84c76b65f9278d3d)
    staticcall 0xe4faf95eeae77f9dbba122fe84c76b65f9278d3d.0x18160ddd with:
...
function add(uint256 arg1, address arg2, address arg3) payable {
    ...
    if block.number > 16884696:
        poolInfo[poolInfo.length].field_512 = block.number
    else:
        poolInfo[poolInfo.length].field_512 = 16884696
...
function inCaseTokensGetStuck(address arg1, uint256 arg2) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 == 0xe4faf95eeae77f9dbba122fe84c76b65f9278d3d:
        revert with 0, '!safe'
                ...
                if block.number - poolInfo[arg1].field_512 > 0:
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        if not 0 / totalAllocPoint:
                            require ext_code.size(0xe4faf95eeae77f9dbba122fe84c76b65f9278d3d)
                            call 0xe4faf95eeae77f9dbba122fe84c76b65f9278d3d.0x40c10f19 with:
                                 gas gas_remaining wei
                                args owner, 0
                        else:
                        ...
                        if (107205733 * 10^9 * block.number) - (107205733 * 10^9 * poolInfo[arg1].field_512) / block.number - poolInfo[arg1].field_512 != 107205733 * 10^9:
                            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                        if not (107205733 * 10^9 * block.number) - (107205733 * 10^9 * poolInfo[arg1].field_512):
                            if totalAllocPoint <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require totalAllocPoint
                            if not 0 / totalAllocPoint:
                            ...
                            require (107205733 * 10^9 * block.number) - (107205733 * 10^9 * poolInfo[arg1].field_512)
                            if (107205733 * 10^9 * block.number * poolInfo[arg1].field_256) - (107205733 * 10^9 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / (107205733 * 10^9 * block.number) - (107205733 * 10^9 * poolInfo[arg1].field_512) != poolInfo[arg1].field_256:
                                revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                            if totalAllocPoint <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require totalAllocPoint
                            if not (107205733 * 10^9 * block.number * poolInfo[arg1].field_256) - (107205733 * 10^9 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint:
                                require ext_code.size(0xe4faf95eeae77f9dbba122fe84c76b65f9278d3d)
                                call 0xe4faf95eeae77f9dbba122fe84c76b65f9278d3d.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args owner, 0
                            else:
                                require (107205733 * 10^9 * block.number * poolInfo[arg1].field_256) - (107205733 * 10^9 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint
                                if 1111 * (107205733 * 10^9 * block.number * poolInfo[arg1].field_256) - (107205733 * 10^9 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / (107205733 * 10^9 * block.number * poolInfo[arg1].field_256) - (107205733 * 10^9 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint != 1111:
                                    revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                                require ext_code.size(0xe4faf95eeae77f9dbba122fe84c76b65f9278d3d)
                                call 0xe4faf95eeae77f9dbba122fe84c76b65f9278d3d.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args owner, 1111 * (107205733 * 10^9 * block.number * poolInfo[arg1].field_256) - (107205733 * 10^9 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / 10000
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(0xe4faf95eeae77f9dbba122fe84c76b65f9278d3d)
                            call 0xe4faf95eeae77f9dbba122fe84c76b65f9278d3d.0x40c10f19 with:
                                 gas gas_remaining wei
                                args address(this.address), (107205733 * 10^9 * block.number * poolInfo[arg1].field_256) - (107205733 * 10^9 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if not (107205733 * 10^9 * block.number * poolInfo[arg1].field_256) - (107205733 * 10^9 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint:
                                if ext_call.return_data[0] <= 0:
                                ...
                                require (107205733 * 10^9 * block.number * poolInfo[arg1].field_256) - (107205733 * 10^9 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint
                                if 10^12 * (107205733 * 10^9 * block.number * poolInfo[arg1].field_256) - (107205733 * 10^9 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / (107205733 * 10^9 * block.number * poolInfo[arg1].field_256) - (107205733 * 10^9 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                    revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                                if ext_call.return_data[0] <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_call.return_data[0]
                                if poolInfo[arg1].field_768 + (10^12 * (107205733 * 10^9 * block.number * poolInfo[arg1].field_256) - (107205733 * 10^9 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                poolInfo[arg1].field_768 += 10^12 * (107205733 * 10^9 * block.number * poolInfo[arg1].field_256) - (107205733 * 10^9 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
                    poolInfo[arg1].field_512 = block.number
}
...
function pendingNATIVE(uint256 arg1, address arg2) payable {
    ...
    if not userInfo[arg1][address(arg2)].field_0:
        ...
        return -userInfo[arg1][address(arg2)].field_256
    require userInfo[arg1][address(arg2)].field_0
    if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (107205733 * 10^9 * block.number * poolInfo[arg1].field_256) - (107205733 * 10^9 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != poolInfo[arg1].field_768 + (10^12 * (107205733 * 10^9 * block.number * poolInfo[arg1].field_256) - (107205733 * 10^9 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]):
        revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
    if userInfo[arg1][address(arg2)].field_256 > (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (107205733 * 10^9 * block.number * poolInfo[arg1].field_256) - (107205733 * 10^9 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12:
        revert with 0, 'SafeMath: subtraction overflow'
    return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (107205733 * 10^9 * block.number * poolInfo[arg1].field_256) - (107205733 * 10^9 * poolInfo[arg1].field_512 * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
}
