    ...
    if stor3[stor10]:
        ...
        if not ext_code.size(msg.sender):
            ...
            call msg.sender.0x80 with:
                 gas gas_remaining wei
                args 0, mem[ceil32(arg1.length) + 612 len 4]
            if not return_data.size:
                if not ext_call.success:
                    if arg1.length:
                ...
                if Mask(32, 224, mem[128]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                    revert with 0, 
                                ...
                                50,
                                0x734552433732313a207472616e7366657220746f206e6f6e20455243373231526563656976657220696d706c656d656e7465,
                                mem[ceil32(arg1.length) + 438 len 14]
                if not stor3[stor10]:
                    revert with 0, 
                                32,
                                44,
                                0x6e4552433732314d657461646174613a2055524920736574206f66206e6f6e6578697374656e7420746f6b65,
                                mem[ceil32(arg1.length) + 432 len 20]
            else:
        ...
        if not ext_code.size(msg.sender):
            ...
            call msg.sender.0x80 with:
                 gas gas_remaining wei
                args 0, mem[ceil32(arg1.length) + 676 len 4]
            if not return_data.size:
                if not ext_call.success:
                    if arg1.length:
                        revert with arg1[all]
                ...
                if Mask(32, 224, mem[128]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                    revert with 0, 
                                ...
                                50,
                                0x734552433732313a207472616e7366657220746f206e6f6e20455243373231526563656976657220696d706c656d656e7465,
                                mem[ceil32(arg1.length) + 502 len 14]
                if not stor3[stor10]:
                    revert with 0, 
                                32,
                                44,
                                0x6e4552433732314d657461646174613a2055524920736574206f66206e6f6e6578697374656e7420746f6b65,
                                mem[ceil32(arg1.length) + 496 len 20]
            else:
