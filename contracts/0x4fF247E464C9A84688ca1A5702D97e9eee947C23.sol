...
function createItem(string arg1) payable {
    require calldata.size - 4 >= 32
    ...
    mem[ceil32(ceil32(arg1.length)) + arg1.length + 97] = 9
    if stor[sha3(mem[ceil32(ceil32(arg1.length)) + 97 len arg1.length + 32])]:
        revert with 0, 'ERC721Metadata: URI token should be unique!'
    mem[ceil32(ceil32(arg1.length)) + 97 len ceil32(arg1.length)] = arg1[all], mem[arg1.length + 128 len ceil32(arg1.length) - arg1.length]
    mem[ceil32(ceil32(arg1.length)) + arg1.length + 97] = 9
    ...
    if bool(stor6[stor8].field_0):
        if bool(stor6[stor8].field_0) == uint255(stor6[stor8].field_1) < 32:
            revert with 'NH{q', 34
        if arg1.length:
            uint256(stor6[stor8][].field_0) = Array(len=arg1.length, data=arg1[all])
        else:
            uint256(stor6[stor8].field_0) = 0
            idx = 0
            while uint255(stor6[stor8].field_1) + 31 / 32 > idx:
                uint256(stor6[stor8][idx].field_0) = 0
                idx = idx + 1
                continue 
    else:
    ...
    if msg.sender == stor10:
        revert with 0, 'ERC721: approve to caller'
    stor5[address(msg.sender)][stor10] = 1
    emit ApprovalForAll(1, msg.sender, stor10);
    return stor8
}
