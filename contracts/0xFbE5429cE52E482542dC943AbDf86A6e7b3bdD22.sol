...
function getAvaxPrice() payable {
        ...
        if not 10^uint8(-ext_call.return_data[0] + 18):
            ...
            if ext_call.return_data[12 len 20] != wavaxAddress:
                ...
                if not 10^uint8(-ext_call.return_data[0] + 18):
                    ...
                    staticcall 0xa389f9430876455c36478deea9769b7ca4e3ddb1.0xd21220a7 with:
                            gas gas_remaining wei
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
            ...
            staticcall 0x87dee1cc9ffd464b79e058ba20387c1984aed86a.0xd21220a7 with:
                    gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
    ...
    staticcall 0xed8cbd9f0ce3c6986b22002f03c6475ceb7a6256.0xd21220a7 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
