...
function triggerRunChecks() payable {
    ...
    if sub_5e370784 >= 10^18:
        require ext_code.size(address(stor8.field_0))
        call address(stor8.field_0).createRandom(uint256 rg1, uint256 rg2) with:
...
function randomValueCreated(uint256 arg1, uint256 arg2) payable {
    ...
    if not arg2:
        ...
        pendingWithdrawAmount[stor0[arg1].field_0] += 25 * 10^13 * 3600
        emit 0xa4b93897: (25 * 10^13 * 3600), stor0[arg1].field_0, sub_9656b7d8, 0
        vaultAmount += 10^17
        sub_5e370784 = 0
        stor0.length = 0
        idx = 0
