...
const getName = 'StrategyPngAvaxTus'
...
const sub_4005760a(?) = 0x1f806f7c8ded893fd3cae279191ad7aa3798e928
...
uint256 poolId;
uint256 sub_d8102529;
address sub_6e60a3adAddress;
...
function sub_6b283a30(?) {
    return sub_6b283a30Address
}

function sub_6e60a3ad(?) {
    return sub_6e60a3adAddress
}
        ...
        if not arg1:
            ...
            if not return_data.size:
                if not arg1:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 846 len 64] = transfer(address arg1, uint256 arg2), address(ext_call.return_data[0]) << 64, 0, Mask(224, 32, arg1) >> 32
                    mem[(2 * ceil32(return_data.size)) + 910 len 0] = 0
                    call wantAddress with:
                         gas gas_remaining wei
                        args Mask(224, 32, arg1) << 224, mem[(2 * ceil32(return_data.size)) + 910 len 4]
                    if not return_data.size:
                        require not ext_call.success
                        revert with 'SafeMath: division by zero'
            ...
            if not return_data.size:
                if not arg1:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(2 * ceil32(return_data.size)) + 846 len 64] = transfer(address arg1, uint256 arg2), address(ext_call.return_data[0]) << 64, 0, Mask(224, 32, arg1 - (withdrawalDevFundFee * arg1 / 100000) - (withdrawalTreasuryFee * arg1 / 100000)) >> 32
                        call wantAddress with:
                             gas gas_remaining wei
        ...
        if not arg1:
            ...
            if not return_data.size:
                ...
                if arg1:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 910 len 64] = transfer(address arg1, uint256 arg2), address(ext_call.return_data[0]) << 64, 0, Mask(224, 32, arg1 - (withdrawalDevFundFee * arg1 / 100000)) >> 32
