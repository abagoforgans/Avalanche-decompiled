...
function pairFor(address arg1, address arg2) payable {
    ...
    if arg1 < arg2:
        ...
        return address(sha3(0, 11157320132538271434, sha3(arg1, arg2), 0xbbca9af0511ad1a1da383135cf3a8d2ac620e549ef9f6ae3a4c33c2fed0af91))
    if not arg2:
        revert with 0, 'ZERO_ADDRESS'
    return address(sha3(0, 11157320132538271434, sha3(arg2, arg1), 0xbbca9af0511ad1a1da383135cf3a8d2ac620e549ef9f6ae3a4c33c2fed0af91))
}
...
function getReserves(address arg1, address arg2) payable {
    ...
    if arg1 < arg2:
        ...
        if arg1 < arg2:
            if not arg1:
                revert with 0, 'ZERO_ADDRESS'
            require ext_code.size(address(sha3(0, 11157320132538271434, sha3(arg1, arg2), 0xbbca9af0511ad1a1da383135cf3a8d2ac620e549ef9f6ae3a4c33c2fed0af91)))
            staticcall address(sha3(0, 11157320132538271434, sha3(arg1, arg2), 0xbbca9af0511ad1a1da383135cf3a8d2ac620e549ef9f6ae3a4c33c2fed0af91)).getReserves() with:
                    gas gas_remaining wei
        else:
            if not arg2:
                revert with 0, 'ZERO_ADDRESS'
            require ext_code.size(address(sha3(0, 11157320132538271434, sha3(arg2, arg1), 0xbbca9af0511ad1a1da383135cf3a8d2ac620e549ef9f6ae3a4c33c2fed0af91)))
            staticcall address(sha3(0, 11157320132538271434, sha3(arg2, arg1), 0xbbca9af0511ad1a1da383135cf3a8d2ac620e549ef9f6ae3a4c33c2fed0af91)).getReserves() with:
                    gas gas_remaining wei
