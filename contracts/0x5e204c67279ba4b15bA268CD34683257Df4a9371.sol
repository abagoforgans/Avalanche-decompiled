...
function _fallback() payable {
    ...
    if unknown_0xc311d049(?????) <= uint32(call.func_hash) >> 224:
        if unknown_0xc311d049(?????) == uint32(call.func_hash) >> 224:
            ...
            while idx < ('cd', 36).length:
                if idx >= mem[128]:
                    revert with 0, 50
                _18889 = mem[(32 * idx) + 160]
                mem[mem[64] + 4] = this.address
                require ext_code.size(address(_18889))
                staticcall address(_18889).0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                ...
                if mem[_19428]:
                    if idx >= mem[128]:
                        revert with 0, 50
                    _22080 = mem[(32 * idx) + 160]
                    mem[mem[64] + 4] = address(cd[4])
                    mem[mem[64] + 36] = _20681
                    require ext_code.size(address(_22080))
                    call address(_22080).0xa9059cbb with:
                         gas gas_remaining wei
                        args address(cd[4]), _20681
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _22089 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    require mem[_22089] == bool(mem[_22089])
                if idx == -1:
                    revert with 0, 17
                idx = idx + 1
                continue 
            _22095 = mem[ceil32(32 * ('cd', 36).length) + 129]
            idx = 0
            while idx < _22095:
                if idx >= mem[ceil32(32 * ('cd', 36).length) + 129]:
                    revert with 0, 50
                _22100 = mem[(32 * idx) + ceil32(32 * ('cd', 36).length) + 161]
                mem[mem[64] + 4] = this.address
                require ext_code.size(address(_22100))
                staticcall address(_22100).0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                ...
                if mem[_22105]:
                    if idx >= mem[ceil32(32 * ('cd', 36).length) + 129]:
                        revert with 0, 50
                    _22110 = mem[(32 * idx) + ceil32(32 * ('cd', 36).length) + 161]
                    mem[mem[64] + 4] = address(cd[4])
                    mem[mem[64] + 36] = _22108
                    require ext_code.size(address(_22110))
                    call address(_22110).0xa9059cbb with:
                         gas gas_remaining wei
                        args address(cd[4]), _22108
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _22113 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    require mem[_22113] == bool(mem[_22113])
                if idx == -1:
                    revert with 0, 17
                _22095 = mem[ceil32(32 * ('cd', 36).length) + 129]
                idx = idx + 1
        ...
        if uint32(call.func_hash) >> 224 != unknown_0x5aeda7c1(?????):
            if unknown_0xbd5dec98(?????) == uint32(call.func_hash) >> 224:
                ...
                while idx < ('cd', 4).length:
                    if idx >= mem[128]:
                        revert with 0, 50
                    _18885 = mem[(32 * idx) + 160]
                    mem[mem[64] + 4] = this.address
                    require ext_code.size(address(_18885))
                    staticcall address(_18885).0x70a08231 with:
                            gas gas_remaining wei
                           args this.address
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                    ...
                    if mem[_19423]:
                        if idx >= mem[128]:
                            revert with 0, 50
                        _22079 = mem[(32 * idx) + 160]
                        mem[mem[64] + 4] = msg.sender
                        mem[mem[64] + 36] = _20677
                        require ext_code.size(address(_22079))
                        call address(_22079).0xa9059cbb with:
                             gas gas_remaining wei
                            args msg.sender, _20677
                        mem[mem[64]] = ext_call.return_data[0]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        _22090 = mem[64]
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_22090] == bool(mem[_22090])
                    if idx == -1:
                        revert with 0, 17
                    idx = idx + 1
                    continue 
    ...
    require return_data.size >= 32
    if ext_call.return_data[0] < 10^18:
        emit 0x2bedc616: 3241564613, 64, 32, ext_call.return_data[0]
    else:
        require ext_code.size(stor6)
        ...
        if ext_call.return_data[0] <= ext_call.return_data[0] * stor12 / 1000:
                ...
                if 10^18 * ext_call.return_data[0] / ext_call.return_data[0] <= ext_call.return_data[0]:
                    if not cd[4]:
                        if 10^18 * ext_call.return_data[0] / ext_call.return_data[0] >= 10^18:
                            ...
                            if ext_call.success:
                                emit 0x2bedc616: 2460453, 64, 32, 10^18 * ext_call.return_data[0] / ext_call.return_data[0]
                                return (10^18 * ext_call.return_data[0] / ext_call.return_data[0])
                            emit 0x2bedc616: 2460454, 64, 32, ext_call.return_data[0]
                            emit 0x2bedc616: 2460455, 64, 32, 10^18 * ext_call.return_data[0] / ext_call.return_data[0]
                else:
                    if not cd[4]:
                        if ext_call.return_data[0] >= 10^18:
                            require ext_code.size(stor6)
                            ...
                            if ext_call.success:
                                emit 0x2bedc616: 2460453, 64, 32, ext_call.return_data[0]
                                return ext_call.return_data[0]
                            emit 0x2bedc616: 2460454, 64, 32, ext_call.return_data[0]
                            emit 0x2bedc616: 2460455, 64, 32, ext_call.return_data[0]
            else:
                if 10^18 <= ext_call.return_data[0]:
                    if not cd[4]:
                        ...
                        call stor6.0xba560803 with:
                            ...
                            args 10^18
                        if ext_call.success:
                            emit 0x2bedc616: 2460453, 64, 32, 10^18
                            return 10^18
                        emit 0x2bedc616: 2460454, 64, 32, ext_call.return_data[0]
                        emit 0x2bedc616: 2460455, 64, 32, 10^18
                else:
                    if not cd[4]:
                        if ext_call.return_data[0] >= 10^18:
                            require ext_code.size(stor6)
            ...
            if ext_call.return_data[0] < ext_call.return_data[0]:
                emit 0x2bedc616: 6546724, 64, 32, ext_call.return_data[0]
                emit 0x2bedc616: 6546724, 64, 32, ext_call.return_data[0]
            else:
                if ext_call.return_data[0] > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
                    revert with 0, 17
