...
function sub_aa34511f(?) payable {
    ...
    if not arg1:
        ...
        call 0x7c347af74c8dfaf629e4e4d3343d6e6a6ecace80.createItem(address arg1, uint256 arg2) with:
             gas gas_remaining wei
        ...
        if arg1 == 1:
            ...
            require ext_call.return_data[0] == ext_call.return_data[0]
            if ext_call.return_data[0] != 1:
                revert with 0, 'research not done', mem[(6 * ceil32(return_data.size)) + 295 len 9 * ceil32(return_data.size)]
            require ext_code.size(0x7c347af74c8dfaf629e4e4d3343d6e6a6ecace80)
            call 0x7c347af74c8dfaf629e4e4d3343d6e6a6ecace80.createItem(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                    ...
                    if arg1 == 4:
                        ...
                        if arg1 == 5:
                            ...
                            if arg1 == 6:
                                ...
                                if arg1 == 7:
                                    mem[(4 * ceil32(return_data.size)) + 192] = 'r-'
                                    mem[(4 * ceil32(return_data.size)) + 194] = '5'
                                    mem[(4 * ceil32(return_data.size)) + 195] = 0x4994abe100000000000000000000000000000000000000000000000000000000
                                    mem[(4 * ceil32(return_data.size)) + 199] = arg2
                                    mem[(4 * ceil32(return_data.size)) + 231] = 64
                                    mem[(4 * ceil32(return_data.size)) + 263] = mem[(4 * ceil32(return_data.size)) + 160]
                                    ...
                                    if arg1 == 8:
                                        mem[(4 * ceil32(return_data.size)) + 192] = 'r-'
                                        mem[(4 * ceil32(return_data.size)) + 194] = '6'
                                        mem[(4 * ceil32(return_data.size)) + 195] = 0x4994abe100000000000000000000000000000000000000000000000000000000
                                        mem[(4 * ceil32(return_data.size)) + 199] = arg2
                                        mem[(4 * ceil32(return_data.size)) + 231] = 64
                                        mem[(4 * ceil32(return_data.size)) + 263] = mem[(4 * ceil32(return_data.size)) + 160]
                                        ...
                                        if arg1 == 9:
                                            mem[(4 * ceil32(return_data.size)) + 192] = 'r-'
                                            mem[(4 * ceil32(return_data.size)) + 194] = '7'
                                            mem[(4 * ceil32(return_data.size)) + 195] = 0x4994abe100000000000000000000000000000000000000000000000000000000
                                            mem[(4 * ceil32(return_data.size)) + 199] = arg2
                                            mem[(4 * ceil32(return_data.size)) + 231] = 64
                                            mem[(4 * ceil32(return_data.size)) + 263] = mem[(4 * ceil32(return_data.size)) + 160]
                                            ...
                                            if arg1 == 10:
                                                mem[(4 * ceil32(return_data.size)) + 192] = 'r-'
                                                mem[(4 * ceil32(return_data.size)) + 194] = '8'
                                                mem[(4 * ceil32(return_data.size)) + 195] = 0x4994abe100000000000000000000000000000000000000000000000000000000
                                                mem[(4 * ceil32(return_data.size)) + 199] = arg2
                                                mem[(4 * ceil32(return_data.size)) + 231] = 64
                                                mem[(4 * ceil32(return_data.size)) + 263] = mem[(4 * ceil32(return_data.size)) + 160]
                                                ...
                                                if arg1 == 11:
                                                    mem[(4 * ceil32(return_data.size)) + 192] = 'r-'
                                                    mem[(4 * ceil32(return_data.size)) + 194] = '9'
                                                    mem[(4 * ceil32(return_data.size)) + 195] = 0x4994abe100000000000000000000000000000000000000000000000000000000
                                                    mem[(4 * ceil32(return_data.size)) + 199] = arg2
                                                    mem[(4 * ceil32(return_data.size)) + 231] = 64
                                                    mem[(4 * ceil32(return_data.size)) + 263] = mem[(4 * ceil32(return_data.size)) + 160]
                                                    ...
                                                    mem[(4 * ceil32(return_data.size)) + 192] = 'r-'
                                                    mem[(4 * ceil32(return_data.size)) + 194] = '10'
                                                    mem[(4 * ceil32(return_data.size)) + 196] = 0x4994abe100000000000000000000000000000000000000000000000000000000
                                                    mem[(4 * ceil32(return_data.size)) + 200] = arg2
                                                    mem[(4 * ceil32(return_data.size)) + 232] = 64
                                                    mem[(4 * ceil32(return_data.size)) + 264] = mem[(4 * ceil32(return_data.size)) + 160]
                                                    mem[(4 * ceil32(return_data.size)) + 296 len ceil32(mem[(4 * ceil32(return_data.size)) + 160])] = mem[(4 * ceil32(return_data.size)) + 192 len ceil32(mem[(4 * ceil32(return_data.size)) + 160])]
                                                    if ceil32(mem[(4 * ceil32(return_data.size)) + 160]) > mem[(4 * ceil32(return_data.size)) + 160]:
                                                        mem[(4 * ceil32(return_data.size)) + mem[(4 * ceil32(return_data.size)) + 160] + 296] = 0
                                                    require ext_code.size(0xc3b29321611736341609022c23e981ac56e7f96)
                                                    staticcall 0xc3b29321611736341609022c23e981ac56e7f96.0x4994abe1 with:
                                                            gas gas_remaining wei
                                                           args arg2, Array(len=mem[(4 * ceil32(return_data.size)) + 160], data=mem[(4 * ceil32(return_data.size)) + 296 len ceil32(mem[(4 * ceil32(return_data.size)) + 160])])
                                                    if not ext_call.success:
                                                        revert with ext_call.return_data[0 len return_data.size]
                                                    require return_data.size >= 32
                                                    require ext_call.return_data[0] == ext_call.return_data[0]
                                                    if ext_call.return_data[0] != 1:
                                                        revert with 0, 'research not done', mem[(6 * ceil32(return_data.size)) + 296 len 9 * ceil32(return_data.size)]
                                                    require ext_code.size(0x7c347af74c8dfaf629e4e4d3343d6e6a6ecace80)
                                                    call 0x7c347af74c8dfaf629e4e4d3343d6e6a6ecace80.createItem(address arg1, uint256 arg2) with:
                                                         gas gas_remaining wei
                                                        args address(arg3), arg1, mem[(6 * ceil32(return_data.size)) + 264 len 9 * ceil32(return_data.size)]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
