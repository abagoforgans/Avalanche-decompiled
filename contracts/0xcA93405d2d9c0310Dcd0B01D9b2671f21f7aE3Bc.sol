...
function sub_b516f7b1(?) {
    ...
    if not stor371:
        ...
        mem[(2 * ceil32(return_data.size)) + 196] = balanceOf[address(arg1)].field_0
        ...
        staticcall address(ext_call.return_data[0]).getAmountsOut(uint256 arg1, address[] arg2) with:
                gas gas_remaining wei
               args balanceOf[address(arg1)].field_0, 64, mem[(2 * ceil32(return_data.size)) + 260 len (32 * mem[ceil32(return_data.size) + 96]) + 32]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[(2 * ceil32(return_data.size)) + 192 len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = (4 * ceil32(return_data.size)) + 192
        require return_data.size >= 32
        _108 = mem[(2 * ceil32(return_data.size)) + 192 len 4], balanceOf[address(arg1)].field_32
        require mem[(2 * ceil32(return_data.size)) + 192 len 4], balanceOf[address(arg1)].field_32 <= test266151307()
        require (2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], balanceOf[address(arg1)].field_32 + 223 < (2 * ceil32(return_data.size)) + return_data.size + 192
        _110 = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], balanceOf[address(arg1)].field_32 + 192]
        require mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], balanceOf[address(arg1)].field_32 + 192] <= test266151307()
        require (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], balanceOf[address(arg1)].field_32 + 192]) + 32 >= 0 and (4 * ceil32(return_data.size)) + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], balanceOf[address(arg1)].field_32 + 192]) + 224 <= test266151307()
        mem[64] = (4 * ceil32(return_data.size)) + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], balanceOf[address(arg1)].field_32 + 192]) + 224
        mem[(4 * ceil32(return_data.size)) + 192] = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], balanceOf[address(arg1)].field_32 + 192]
    ...
    mem[(2 * ceil32(return_data.size)) + 228] = balanceOf[address(arg1)].field_0
    ...
    staticcall address(ext_call.return_data[0]).getAmountsOut(uint256 arg1, address[] arg2) with:
            gas gas_remaining wei
           args balanceOf[address(arg1)].field_0, 64, mem[(2 * ceil32(return_data.size)) + 292 len (32 * mem[ceil32(return_data.size) + 96]) + 32]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    _107 = mem[(2 * ceil32(return_data.size)) + 224 len 4], balanceOf[address(arg1)].field_32
    require mem[(2 * ceil32(return_data.size)) + 224 len 4], balanceOf[address(arg1)].field_32 <= test266151307()
    require (2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 224 len 4], balanceOf[address(arg1)].field_32 + 255 < (2 * ceil32(return_data.size)) + return_data.size + 224
    _109 = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 224 len 4], balanceOf[address(arg1)].field_32 + 224]
    require mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 224 len 4], balanceOf[address(arg1)].field_32 + 224] <= test266151307()
    require (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 224 len 4], balanceOf[address(arg1)].field_32 + 224]) + 32 >= 0 and (4 * ceil32(return_data.size)) + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 224 len 4], balanceOf[address(arg1)].field_32 + 224]) + 256 <= test266151307()
    mem[64] = (4 * ceil32(return_data.size)) + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 224 len 4], balanceOf[address(arg1)].field_32 + 224]) + 256
...
function transfer(address arg1, uint256 arg2) {
            ...
            if not ext_call.return_data[0]:
                if not deposit[address(msg.sender)]:
                    if not loan[address(msg.sender)]:
                        ...
                        if not loan[address(msg.sender)]:
                            if not balanceOf[address(msg.sender)].field_0:
                                revert with 0, 'SafeMath: division by zero'
                            if 0 / balanceOf[address(msg.sender)].field_0 > loan[address(msg.sender)]:
                                revert with 0, 'SafeMath: subtraction overflow'
                            loan[address(msg.sender)] -= 0 / balanceOf[address(msg.sender)].field_0
                            if (0 / balanceOf[address(msg.sender)].field_0) + loan[arg1] < loan[arg1]:
                                revert with 0, 'SafeMath: addition overflow'
                            loan[address(arg1)] = (0 / balanceOf[address(msg.sender)].field_0) + loan[arg1]
                        else:
                            ...
                            if not balanceOf[address(msg.sender)].field_0:
                                revert with 0, 'SafeMath: division by zero'
                            if arg2 * loan[address(msg.sender)] / balanceOf[address(msg.sender)].field_0 > loan[address(msg.sender)]:
                                revert with 0, 'SafeMath: subtraction overflow'
                            loan[address(msg.sender)] -= arg2 * loan[address(msg.sender)] / balanceOf[address(msg.sender)].field_0
                            if (arg2 * loan[address(msg.sender)] / balanceOf[address(msg.sender)].field_0) + loan[arg1] < loan[arg1]:
                                revert with 0, 'SafeMath: addition overflow'
                            loan[address(arg1)] = (arg2 * loan[address(msg.sender)] / balanceOf[address(msg.sender)].field_0) + loan[arg1]
                        if arg2 > balanceOf[address(msg.sender)].field_0:
                            revert with 0, 
                                        32,
                                        38,
                    ...
                    if not deposit[address(msg.sender)]:
                        if not balanceOf[address(msg.sender)].field_0:
                            revert with 0, 'SafeMath: division by zero'
                        if 0 / balanceOf[address(msg.sender)].field_0 > deposit[address(msg.sender)]:
                            revert with 0, 'SafeMath: subtraction overflow'
                        deposit[address(msg.sender)] -= 0 / balanceOf[address(msg.sender)].field_0
                        if (0 / balanceOf[address(msg.sender)].field_0) + deposit[arg1] < deposit[arg1]:
                            revert with 0, 'SafeMath: addition overflow'
                        deposit[address(arg1)] = (0 / balanceOf[address(msg.sender)].field_0) + deposit[arg1]
                    else:
                        ...
                        if not balanceOf[address(msg.sender)].field_0:
                            revert with 0, 'SafeMath: division by zero'
                        if arg2 * deposit[address(msg.sender)] / balanceOf[address(msg.sender)].field_0 > deposit[address(msg.sender)]:
                            revert with 0, 'SafeMath: subtraction overflow'
                        deposit[address(msg.sender)] -= arg2 * deposit[address(msg.sender)] / balanceOf[address(msg.sender)].field_0
                        if (arg2 * deposit[address(msg.sender)] / balanceOf[address(msg.sender)].field_0) + deposit[arg1] < deposit[arg1]:
                            revert with 0, 'SafeMath: addition overflow'
                        deposit[address(arg1)] = (arg2 * deposit[address(msg.sender)] / balanceOf[address(msg.sender)].field_0) + deposit[arg1]
                    if not loan[address(msg.sender)]:
                        if arg2 > balanceOf[address(msg.sender)].field_0:
                            revert with 0, 
                                        32,
                ...
                if not ext_call.return_data[0]:
                    ...
                    mem[ceil32(return_data.size) + 260] = 0 / balanceOf[address(msg.sender)].field_0
                    require ext_code.size(reserveAddress)
                    call reserveAddress.0xfe37d7be with:
                         gas gas_remaining wei
                        args msg.sender, address(arg1), 0 / balanceOf[address(msg.sender)].field_0
                else:
                    if arg2 * ext_call.return_data[0] / ext_call.return_data[0] != arg2:
                        revert with 0, 
                                    ...
                                    mem[ceil32(return_data.size) + 293 len 31]
                    require balanceOf[address(msg.sender)].field_0
                    mem[ceil32(return_data.size) + 260] = arg2 * ext_call.return_data[0] / balanceOf[address(msg.sender)].field_0
                    require ext_code.size(reserveAddress)
                    call reserveAddress.0xfe37d7be with:
                         gas gas_remaining wei
                        args msg.sender, address(arg1), arg2 * ext_call.return_data[0] / balanceOf[address(msg.sender)].field_0
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
    ...
    ('le', ('param', 'arg2'), ('field', 0, ('stor', ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'balanceOf', 308)))))
    balanceOf[address(msg.sender)].field_0 -= arg2
    if arg2 + balanceOf[arg1].field_0 < balanceOf[arg1].field_0:
        revert with 0, 'SafeMath: addition overflow'
