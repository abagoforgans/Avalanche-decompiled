...
function sub_f974949d(?) payable {
    require calldata.size - 4 >= 96
    if not stor27[msg.sender]:
        revert with 0, 'dno access permission'
    sub_fecd1181 = uint8(arg1)
    sub_43e1be76 = uint8(arg2)
    Mask(80, 0, stor24.field_176) = Mask(80, 0, arg3)
    Mask(72, 0, stor24.field_184) = 0
    Mask(72, 0, stor24.field_184) = Mask(72, 24, arg1) >> 24
    Mask(72, 0, stor24.field_184) = Mask(72, 16, arg2) >> 16
    emit 0xfab9dd5e: arg1, arg2, arg3
}
...
function getClaimable() payable {
    ...
    if (player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 < player[address(msg.sender)].field_256 * sub_f87f87ac:
        revert with 0, 'SafeMath: multiple overflow'
    if player[address(msg.sender)].field_1024 > (player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9:
        revert with 0, 'SafeMath:OVERFLOW_SUB'
    return (((player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[address(msg.sender)].field_1024)
}
...
function sub_4b815897(?) payable {
    ...
    if not player[address(arg1)].field_256:
        if (10^9 * player[address(arg1)].field_256) + stor12 < 10^9 * player[address(arg1)].field_256:
            revert with 0, 'SafeMath: division internal'
        if sub_7145fd3e:
            return ((10^9 * player[address(arg1)].field_256) + stor12 / sub_7145fd3e)
    else:
    ...
    if not sub_a44f4556:
        if block.number > player[address(msg.sender)].field_768:
            ...
            if sub_7145fd3e > 0:
                if player[address(msg.sender)].field_1024 > (player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9:
                    revert with 0, 'SafeMath:OVERFLOW_SUB'
                if ((player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[address(msg.sender)].field_1024 > 0:
                    if sub_537b2398 >= ((player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[address(msg.sender)].field_1024:
                        require ext_code.size(sub_8cab0f99Address)
                        staticcall sub_8cab0f99Address.0x70a08231 with:
                                gas gas_remaining wei
                               args this.address
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        if ext_call.return_data[0] >= ((player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[address(msg.sender)].field_1024:
                            mem[196 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, ((player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[address(msg.sender)].field_1024) >> 32
                            call sub_8cab0f99Address with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(224, 32, ((player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[address(msg.sender)].field_1024) << 224, mem[260 len 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, 
                                                32,
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            if ext_call.return_data[0] > ((player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[address(msg.sender)].field_1024 - ext_call.return_data[0]:
                                require ext_code.size(address(sub_b9ec104bAddress))
                                call address(sub_b9ec104bAddress).unstake(uint256 arg1, bool arg2) with:
                                     gas gas_remaining wei
                                    args ((player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[address(msg.sender)].field_1024 - ext_call.return_data[0], 1
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                mem[196 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, ((player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[address(msg.sender)].field_1024) >> 32
                                call sub_8cab0f99Address with:
                                ...
                                call memoAddress with:
                                   funct uint32(stor18)
                                     gas gas_remaining wei
                                    args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor18), uint32(stor18), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[260 len 4]
                                if not return_data.size:
                                    if not ext_call.success:
                                        revert with 0, 32, 43, 0x645472616e7366657248656c7065723a3a73616665417070726f76653a20617070726f7665206661696c65, mem[307 len 21]
                                    if not approve(address arg1, uint256 arg2), Mask(224, 0, stor18):
                                    ...
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    mem[296 len 64] = 0, msg.sender, Mask(224, 32, ((player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[address(msg.sender)].field_1024) >> 32
                                    call sub_8cab0f99Address with:
                                       funct uint32(msg.sender)
                                         gas gas_remaining wei
                                        args ((player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[address(msg.sender)].field_1024, Mask(224, 32, 0, msg.sender, Mask(224, 32, ((player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[address(msg.sender)].field_1024) >> 32) >> 32, mem[360 len 4]
                                    if not return_data.size:
                                        if not ext_call.success:
                                            revert with 0, 
                                                        32,
                                    ...
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    mem[ceil32(return_data.size) + 297 len 64] = 0, msg.sender, Mask(224, 32, ((player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[address(msg.sender)].field_1024) >> 32
                                    call sub_8cab0f99Address with:
                                       funct uint32(msg.sender)
                                         gas gas_remaining wei
                                        args ((player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[address(msg.sender)].field_1024, Mask(224, 32, 0, msg.sender, Mask(224, 32, ((player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[address(msg.sender)].field_1024) >> 32) >> 32, mem[ceil32(return_data.size) + 361 len 4]
                                    if not return_data.size:
                                        if not ext_call.success:
                                            revert with 0, 
                                                        32,
                        ...
                        if ((player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[address(msg.sender)].field_1024 > sub_537b2398:
                            revert with 0, 'SafeMath:OVERFLOW_SUB'
                        sub_537b2398 = sub_537b2398 - ((player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) + player[address(msg.sender)].field_1024
