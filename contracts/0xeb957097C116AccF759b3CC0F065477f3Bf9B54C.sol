...
function getState(address arg1) payable {
    ...
    mem[mem[64] + 192 len 32 * _17] = mem[mem[128] + 32 len 32 * _17]
    mem[mem[64] + 96] = mem[160]
    return 32, mem[96], 128, mem[160], block.number, mem[mem[64] + 160 len (32 * _17) + 32]
}
...
function sub_9701eaa8(?) payable {
    ...
    mem[96] = 0xcfc37a6ab183dd4aed08c204d1c2773c0b1bdf46
    ...
    while idx < 4:
        ...
        mem[224] = 0xcfc37a6ab183dd4aed08c204d1c2773c0b1bdf46
