...
function sub_cbbaae7a(?) {
    ...
    while idx < ('cd', 4).length:
        ...
        call strategy[address(cd[((32 * idx) + cd[4] + 36)])].withdrawAll(address arg1) with:
             gas gas_remaining wei
        ...
        if not _833 + _839:
            if _833 <= 0:
                if _833 < 0:
                    ...
                    call address(stor[_825]).withdraw(address arg1, uint256 arg2) with:
                         gas gas_remaining wei
            ...
            if not _432 + _438:
                if _432 <= 0:
                    if _432 < 0:
                        ...
                        call address(stor[_424]).withdraw(address arg1, uint256 arg2) with:
                             gas gas_remaining wei
        ...
        if ext_call.return_data[0] < mem[352] * ext_call.return_data[0] / sub_10f485f5[address(mem[192])]:
            if strategy[address(mem[192])]:
                ...
                if not ext_call.return_data[0] - (mem[352] * ext_call.return_data[0] / sub_10f485f5[address(mem[192])]):
                    ...
                    call strategy[address(mem[192])].withdraw(address arg1, uint256 arg2) with:
                         gas gas_remaining wei
                ...
                if not ext_call.success:
                    require ext_code.size(strategy[address(mem[192])])
                    call strategy[address(mem[192])].deposit(address arg1, uint256 arg2) with:
                         gas gas_remaining wei
                        args mem[204 len 20], ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require ext_code.size(strategy[address(mem[192])])
                    call strategy[address(mem[192])].withdraw(address arg1, uint256 arg2) with:
    ...
    if ext_call.return_data[0] < (ext_call.return_data[0] * mem[352]) + (ext_call.return_data[0] * mem[352]) / sub_10f485f5[address(mem[192])]:
        if strategy[address(mem[192])]:
            ...
            if not ext_call.success:
                ...
                call strategy[address(mem[192])].withdraw(address arg1, uint256 arg2) with:
                     gas gas_remaining wei
                    args mem[204 len 20], 2 * ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
