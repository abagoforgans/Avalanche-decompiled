        ...
        if ext_call.return_data[0] - Mask(112, 0, ext_call.return_data[32]) > 0:
            if WETHAddress != address(ext_call.return_data[0]):
                ...
                call address(ext_call.return_data[0]).0xa9059cbb with:
                     gas gas_remaining wei
                    args address(arg1), ext_call.return_data[0] - Mask(112, 0, ext_call.return_data[32])
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                ...
                call address(arg1).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                     gas gas_remaining wei
                    args (997 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0])) - (997 * Mask(112, 0, ext_call.return_data[32]) * Mask(112, 0, ext_call.return_data[0])) / Mask(112, 0, 1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * ext_call.return_data[0]) - (997 * Mask(112, 0, ext_call.return_data[32])), 0, address(this.address), 128, 0
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
    else:
        if ext_call.return_data[0] < Mask(112, 0, ext_call.return_data[0]):
        ...
        if ext_call.return_data[0] <= Mask(112, 0, ext_call.return_data[32]):
            ...
            if Mask(144, 112, ext_call.return_data[0]) > 0:
                if WETHAddress != address(ext_call.return_data[0]):
                    ...
                    call address(ext_call.return_data[0]).0xa9059cbb with:
                         gas gas_remaining wei
                        args address(arg1), Mask(144, 112, ext_call.return_data[0])
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    ...
                    call address(arg1).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                         gas gas_remaining wei
                        args 0, (997 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32])) - (997 * Mask(112, 0, ext_call.return_data[0]) * Mask(112, 0, ext_call.return_data[32])) / Mask(112, 0, 1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * Mask(144, 112, ext_call.return_data[0])), address(this.address), 128, 0
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
        else:
            if ext_call.return_data[0] < Mask(112, 0, ext_call.return_data[32]):
                ...
                if not Mask(144, 112, ext_call.return_data[0]):
                    ...
                    if Mask(144, 112, ext_call.return_data[0]) <= 0:
                        ...
                        if WETHAddress == address(ext_call.return_data[0]):
                            ...
                            call address(arg1).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                 gas gas_remaining wei
                                args 0, (997 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32])) - (997 * Mask(112, 0, ext_call.return_data[0]) * Mask(112, 0, ext_call.return_data[32])) / Mask(112, 0, 1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * Mask(144, 112, ext_call.return_data[0])), address(this.address), 128, 0, None
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if ext_call.return_data[0] - Mask(112, 0, ext_call.return_data[32]) > 0:
                                if WETHAddress != address(ext_call.return_data[0]):
                                    ...
                                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                                    if ext_call.return_data[0] - Mask(112, 0, ext_call.return_data[32]) <= 0:
                                        revert with 0, 'Skim: INSUFFICIENT_INPUT_AMOUNT', mem[(10 * ceil32(return_data.size)) + 228 len 17 * ceil32(return_data.size)]
                                    if Mask(112, 0, ext_call.return_data[32]) <= 0:
                                        revert with 0, 'Skim: INSUFFICIENT_LIQUIDITY', mem[(10 * ceil32(return_data.size)) + 228 len 17 * ceil32(return_data.size)]
                                    if Mask(112, 0, ext_call.return_data[0]) <= 0:
                                        revert with 0, 'Skim: INSUFFICIENT_LIQUIDITY', mem[(10 * ceil32(return_data.size)) + 228 len 17 * ceil32(return_data.size)]
                                    if ext_call.return_data[0] - Mask(112, 0, ext_call.return_data[32]) > 0x41bbb2f80a4553f6c19ad51e8e40314cc63a07b3fef911341fd6eab024f994:
                                        revert with 0, 17
                            ...
                            if WETHAddress != address(ext_call.return_data[0]):
                                ...
                                if Mask(144, 112, ext_call.return_data[0]) <= 0:
                                    ...
                                    if WETHAddress == address(ext_call.return_data[0]):
                                        ...
                                        mem[(7 * ceil32(return_data.size)) + 132] = Mask(144, 112, ext_call.return_data[0])
                                        require ext_code.size(address(ext_call.return_data[0]))
                                        call address(ext_call.return_data[0]).0xa9059cbb with:
                                             gas gas_remaining wei
                                            args address(arg1), Mask(144, 112, ext_call.return_data[0])
                                        ...
                                        if ext_call.return_data[0] - Mask(112, 0, ext_call.return_data[32]) > 0:
                                            if WETHAddress != address(ext_call.return_data[0]):
                                                mem[(8 * ceil32(return_data.size)) + 132] = address(arg1)
                                                mem[(8 * ceil32(return_data.size)) + 164] = ext_call.return_data[0] - Mask(112, 0, ext_call.return_data[32])
                                                require ext_code.size(address(ext_call.return_data[0]))
                                                call address(ext_call.return_data[0]).0xa9059cbb with:
                                                     gas gas_remaining wei
                                                    args address(arg1), ext_call.return_data[0] - Mask(112, 0, ext_call.return_data[32])
                                                ...
                                                if not Mask(112, 0, 1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * ext_call.return_data[0]) - (997 * Mask(112, 0, ext_call.return_data[32])):
                                                    revert with 0, 18
                                                mem[(10 * ceil32(return_data.size)) + 160] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                                                mem[(10 * ceil32(return_data.size)) + 164] = (997 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0])) - (997 * Mask(112, 0, ext_call.return_data[32]) * Mask(112, 0, ext_call.return_data[0])) / Mask(112, 0, 1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * ext_call.return_data[0]) - (997 * Mask(112, 0, ext_call.return_data[32]))
                                                ...
                                                mem[(10 * ceil32(return_data.size)) + 292] = mem[(10 * ceil32(return_data.size)) + 128]
                                                mem[(10 * ceil32(return_data.size)) + 324 len ceil32(mem[(10 * ceil32(return_data.size)) + 128])] = mem[(10 * ceil32(return_data.size)) + 160 len ceil32(mem[(10 * ceil32(return_data.size)) + 128])]
                                                if ceil32(mem[(10 * ceil32(return_data.size)) + 128]) > mem[(10 * ceil32(return_data.size)) + 128]:
                                                    mem[(10 * ceil32(return_data.size)) + mem[(10 * ceil32(return_data.size)) + 128] + 324] = 0
                                                require ext_code.size(address(arg1))
                                                call address(arg1).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                                     gas gas_remaining wei
                                                    args (997 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0])) - (997 * Mask(112, 0, ext_call.return_data[32]) * Mask(112, 0, ext_call.return_data[0])) / Mask(112, 0, 1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * ext_call.return_data[0]) - (997 * Mask(112, 0, ext_call.return_data[32])), 0, address(this.address), 128, mem[(10 * ceil32(return_data.size)) + 128], mem[(10 * ceil32(return_data.size)) + 324 len ceil32(mem[(10 * ceil32(return_data.size)) + 128])]
                                                if not ext_call.success:
                                                    revert with ext_call.return_data[0 len return_data.size]
                    else:
                        if Mask(144, 112, ext_call.return_data[0]) <= 0:
