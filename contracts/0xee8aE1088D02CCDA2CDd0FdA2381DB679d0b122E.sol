...
function executeProposal(uint8 arg1, uint64 arg2, bytes arg3, bytes32 arg4) {
    ...
    call _resourceIDToHandler[stor11[uint64(arg2) << 8 or arg1][('map', ('stor', ('map', ('param', 'arg4'), ('name', '_resourceIDToHandler', 9))), ('call.data', ('add', 36, ('param', 'arg3')), ('cd', ('add', 4, ('param', 'arg3')))))].field_0].0xe248cff2 with:
         gas gas_remaining wei
