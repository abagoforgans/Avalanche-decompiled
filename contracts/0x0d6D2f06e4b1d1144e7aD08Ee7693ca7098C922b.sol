...
function sub_86128149(?) payable {
    require ext_code.size(treasuryAddress)
    staticcall treasuryAddress.0x86128149 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function earned(address arg1) payable {
    ...
    if ((rewardPerShare[rewardPerShare.length].field_0 * balanceOf[address(arg1)].field_0) - (rewardPerShare[stor7[address(arg1)].field_0].field_512 * balanceOf[address(arg1)].field_0) / 10^18) + members[address(arg1)].field_256 < (rewardPerShare[rewardPerShare.length].field_0 * balanceOf[address(arg1)].field_0) - (rewardPerShare[stor7[address(arg1)].field_0].field_512 * balanceOf[address(arg1)].field_0) / 10^18:
        revert with 0, 'SafeMath: addition overflow'
    return (((rewardPerShare[rewardPerShare.length].field_0 * balanceOf[address(arg1)].field_0) - (rewardPerShare[stor7[address(arg1)].field_0].field_512 * balanceOf[address(arg1)].field_0) / 10^18) + members[address(arg1)].field_256)
}
