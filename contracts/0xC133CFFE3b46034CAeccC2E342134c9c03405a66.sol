...
#  - _fallback()
#
const name = 'Black Shiba Doge', 0

const decimals = 6

const symbol = 'Black Shiba', 0
...
function getMultipliedFee() {
    ...
    if not stor33:
        revert with 0, 18
    if stor20 > !((stor32 * stor20 * stor30 / stor31) + (stor33 * stor20 * stor30 / stor31) - (block.timestamp * stor20 * stor30 / stor31) - (stor32 * stor20) - (stor33 * stor20) + (block.timestamp * stor20) / stor33):
        revert with 0, 17
