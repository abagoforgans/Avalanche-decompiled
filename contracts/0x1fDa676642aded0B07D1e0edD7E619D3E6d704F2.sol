...
function sub_012c366e(?) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    mem[floor32(('cd', 68).length) + 101] = address(cd[164])
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    mem[floor32(('cd', 68).length) + (2 * ceil32(return_data.size)) + 101] = 0x60ae616a2155ee3d9a68541ba4544862310933d4
    mem[floor32(('cd', 68).length) + (2 * ceil32(return_data.size)) + 133] = 200000000 * 10^18
    require ext_code.size(0xde9e52f1838951e4d2bb6c59723b003c353979b6)
