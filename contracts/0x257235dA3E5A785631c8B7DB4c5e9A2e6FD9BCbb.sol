    ...
    if not arg1.length:
        ...
        while idx < arg1.length:
            if cEtherAddress == address(cd[((32 * idx) + arg1 + 36)]):
                ...
                mem[mem[64]] = 4
                mem[64] = mem[64] + 36
                mem[_176 + 32] = 0x182df0f500000000000000000000000000000000000000000000000000000000 or mem[_176 + 36 len 28]
                _179 = mem[_176]
                t = _176 + 32
                u = mem[64]
                s = mem[_176]
                ...
                staticcall address(cd[((32 * idx) + arg1 + 36)]).mem[mem[64] len 4] with:
                        gas gas_remaining wei
                       args mem[mem[64] + 4 len _179 + _176 + -mem[64] + 32]
                if return_data.size:
                    _346 = mem[64]
        ...
        while idx < arg1.length:
            if cEtherAddress == address(cd[((32 * idx) + arg1 + 36)]):
                ...
                mem[mem[64]] = 4
                mem[64] = mem[64] + 36
                mem[_182 + 32] = 0x182df0f500000000000000000000000000000000000000000000000000000000 or mem[_182 + 36 len 28]
                _185 = mem[_182]
                t = _182 + 32
                u = mem[64]
                s = mem[_182]
                while s >= 32:
                    ...
                    s = s - 32
                    continue 
                mem[mem[64] + floor32(mem[_182])] = mem[_182 + floor32(mem[_182]) + -(mem[_182] % 32) + 64 len mem[_182] % 32] or Mask(8 * -(mem[_182] % 32) + 32, -(8 * -(mem[_182] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_182])])
                staticcall address(cd[((32 * idx) + arg1 + 36)]).mem[mem[64] len 4] with:
                        gas gas_remaining wei
                       args mem[mem[64] + 4 len _185 + _182 + -mem[64] + 32]
                if return_data.size:
                    _347 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size) + 1
