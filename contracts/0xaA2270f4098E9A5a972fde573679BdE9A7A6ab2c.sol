...
mapping of uint256 sub_783efb25;
...
function sub_4946e9cb(?) payable {
    ...
    require not sub_783efb25[arg2][1]
    sub_783efb25[arg2][1] = arg5 or sub_783efb25[arg2][1]
    ...
    if not uint8(stor201[arg2].field_16):
        ...
        return 0, 
               ...
               0,
               uint16((1000 * uint8(stor201[arg2].field_16) / 10) + 1000),
    ...
    if not (10 * uint8(stor201[arg2].field_16)) + 1000:
        return 0, uint32(stor201[arg2].field_32), 0, uint8(stor201[arg2].field_24)
    ...
    return 0, 
           uint32(stor201[arg2].field_32),
           0,
           uint16((10 * uint8(stor201[arg2].field_16)) + (1000 * uint8(stor201[arg2].field_16) / 10) + (10 * uint8(stor201[arg2].field_16) * uint8(stor201[arg2].field_16) / 10) + 1000),
           uint8(stor201[arg2].field_24)
}
...
function processRaidParticipation(uint256 arg1, bool arg2, uint16 arg3) payable {
    ...
    if not arg2:
        ...
        require not sub_783efb25[arg1][1]
        require arg1 < stor201.length
        mem[0] = 201
        if uint8(stor201[arg1].field_16) < 255:
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    require not sub_783efb25[arg3][1]
...
function sub_a4646669(?) payable {
    ...
    if not tokenOfOwnerByIndex[address(arg1)]:
        ...
        while idx < tokenOfOwnerByIndex[address(arg1)]:
            ...
            if sub_783efb25[mem[(32 * idx) + 128]][1] != 0:
                idx = idx + 1
                s = s
                continue 
            idx = idx + 1
...
function mint(address arg1, uint256 arg2) payable {
    ...
    if 57005 == arg1:
        ...
        require not sub_783efb25[stor201.length][1]
        require ext_code.size(promosAddress)
        staticcall promosAddress.0xbf2a28cf with:
                gas gas_remaining wei
        if not ext_call.success:
