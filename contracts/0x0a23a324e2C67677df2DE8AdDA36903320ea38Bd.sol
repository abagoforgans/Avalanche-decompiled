...
const INIT_CODE_PAIR_HASH = sha3(code.data[3596 len 15392], mem[30976 len 15], Mask(16, 120, code.data[19003 len 2]) >> 120)
...
function setFeeTo(address arg1) payable {
    ...
    if feeToSetterAddress != msg.sender:
        revert with 0, 'SnowTrade: FORBIDDEN'
    feeToAddress = arg1
}
...
function createPair(address arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    if arg1 == arg2:
        revert with 0, 'SnowTrade: IDENTICAL_ADDRESSES'
    if arg1 < arg2:
        if not arg1:
            revert with 0, 'SnowTrade: ZERO_ADDRESS'
        if pair[address(arg1)][address(arg2)]:
            revert with 0, 'SnowTrade: PAIR_EXISTS'
        create2 contract with 0 wei
                        salt: sha3(arg1, arg2)
                        code: code.data[3596 len 15409]
