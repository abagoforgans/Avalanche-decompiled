...
function sub_ccce7685(?) {
    ...
    call address(_447).0x23b872dd with:
         gas gas_remaining wei
    ...
    if bool(stor154[mem[140 len 20]]) == 1:
        ...
        while uint8(idx) < ('cd', 132).length:
            ...
            if mem[(32 * uint8(idx)) + floor32(('cd', 36).length) + 129] < 0 / mem[floor32(('cd', 36).length) + 97]:
                revert with 'NH{q', 17
            if mem[(32 * uint8(idx)) + floor32(('cd', 36).length) + floor32(('cd', 68).length) + 142 len 20] == stor152:
                if 0 >= mem[96]:
                    revert with 'NH{q', 50
                if 1 >= mem[96]:
                    revert with 'NH{q', 50
                ...
                require ext_code.size(address(_890))
                call address(_890).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args _925 - (0 / _891), 0, 160, address(this.address), block.timestamp + 120, mem[mem[64] + 164 len (32 * mem[96]) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _1219 = mem[64]
        ...
        call address(_985).0xa9059cbb with:
             gas gas_remaining wei
        ...
        if bool(stor154[mem[172 len 20]]) == 1:
            ...
            staticcall address(_463).0x70a08231 with:
                    gas gas_remaining wei
                   args address(this.address)
            mem[floor32(('cd', 36).length) + floor32(('cd', 68).length) + floor32(('cd', 132).length) + ceil32(return_data.size) + 99] = ext_call.return_data[0]
            if not ext_call.success:
            ...
            while uint8(idx) < ('cd', 132).length:
                ...
                if mem[(32 * uint8(idx)) + floor32(('cd', 36).length) + floor32(('cd', 68).length) + 142 len 20] == stor152:
                    ...
                    mem[mem[64] + 132] = block.timestamp + 120
                    require ext_code.size(address(_905))
                    call address(_905).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args _930 - (0 / _906), 0, 160, address(this.address), block.timestamp + 120, mem[mem[64] + 164 len (32 * mem[96]) + 32]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1224 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            call address(_990).0xa9059cbb with:
                 gas gas_remaining wei
                ...
                if not cd[100] * sub_947646e0 / 10000:
                    ...
                    while uint8(idx) < ('cd', 132).length:
                        ...
                        if mem[(32 * uint8(idx)) + floor32(('cd', 36).length) + floor32(('cd', 68).length) + 142 len 20] == stor152:
                            ...
                            mem[mem[64] + 132] = block.timestamp + 120
                            require ext_code.size(address(_893))
                            call address(_893).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                 gas gas_remaining wei
                                args _926 - (cd[100] * sub_947646e0 / 10000 / _894), 0, 160, address(this.address), block.timestamp + 120, mem[mem[64] + 164 len (32 * mem[96]) + 32]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            _1220 = mem[64]
                            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                    ...
                    staticcall address(_892).0x70a08231 with:
                            gas gas_remaining wei
                           args address(this.address)
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                    ...
                    call address(_986).0xa9059cbb with:
                         gas gas_remaining wei
                    ...
                    if 0 >= ('cd', 36).length:
                        revert with 'NH{q', 50
                    _473 = mem[128]
                    mem[floor32(('cd', 36).length) + floor32(('cd', 68).length) + floor32(('cd', 132).length) + ceil32(return_data.size) + 103] = stor151
                    ...
                    call address(_473).0xa9059cbb with:
                         gas gas_remaining wei
                        args stor151, cd[100] * sub_947646e0 / 10000
                    mem[floor32(('cd', 36).length) + floor32(('cd', 68).length) + floor32(('cd', 132).length) + ceil32(return_data.size) + 99] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    ...
                    staticcall address(_540).0x70a08231 with:
                            gas gas_remaining wei
                           args address(this.address)
                    ...
                    staticcall address(_895).0x70a08231 with:
                            gas gas_remaining wei
                           args address(this.address)
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                    ...
                    call address(_987).0xa9059cbb with:
                         gas gas_remaining wei
                ...
                if not cd[100] * uint16(cd[228]) / 10000:
                    ...
                    while uint8(idx) < ('cd', 132).length:
                        ...
                        if mem[(32 * uint8(idx)) + floor32(('cd', 36).length) + floor32(('cd', 68).length) + 142 len 20] == stor152:
                            ...
                            mem[mem[64] + 132] = block.timestamp + 120
                            require ext_code.size(address(_899))
                            call address(_899).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                 gas gas_remaining wei
                                args _928 - (cd[100] * uint16(cd[228]) / 10000 / _900), 0, 160, address(this.address), block.timestamp + 120, mem[mem[64] + 164 len (32 * mem[96]) + 32]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            _1222 = mem[64]
                            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                    ...
                    call address(_988).0xa9059cbb with:
                         gas gas_remaining wei
                    ...
                    call address(_474).0xa9059cbb with:
                         gas gas_remaining wei
                        args stor151, cd[100] * uint16(cd[228]) / 10000
                    mem[floor32(('cd', 36).length) + floor32(('cd', 68).length) + floor32(('cd', 132).length) + ceil32(return_data.size) + 99] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    ...
                    while uint8(idx) < ('cd', 132).length:
                        ...
                        if mem[(32 * uint8(idx)) + floor32(('cd', 36).length) + floor32(('cd', 68).length) + 142 len 20] == stor152:
                            ...
                            mem[mem[64] + 132] = block.timestamp + 120
                            require ext_code.size(address(_902))
                            call address(_902).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                 gas gas_remaining wei
                                args _929 - (cd[100] * uint16(cd[228]) / 10000 / _903), 0, 160, address(this.address), block.timestamp + 120, mem[mem[64] + 164 len (32 * mem[96]) + 32]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            _1223 = mem[64]
                            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                    ...
                    staticcall address(_901).0x70a08231 with:
                            gas gas_remaining wei
                           args address(this.address)
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                    ...
                    call address(_989).0xa9059cbb with:
                         gas gas_remaining wei
