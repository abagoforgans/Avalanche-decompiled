...
function sub_f026d37e(?) payable {
    ...
    if WAVAXAddress < rewardTokenAddress:
        ...
        if WAVAXAddress < rewardTokenAddress:
            if not WAVAXAddress:
                revert with 0, 'AMMLibrary: ZERO_ADDRESS'
            require ext_code.size(address(sha3(0, factoryAddress, sha3(WAVAXAddress, rewardTokenAddress), 0xb7145948956af92afd2ae97eff039ada60998237282c1687ca23ce1ad5e1d282)))
            staticcall address(sha3(0, factoryAddress, sha3(WAVAXAddress, rewardTokenAddress), 0xb7145948956af92afd2ae97eff039ada60998237282c1687ca23ce1ad5e1d282)).getReserves() with:
                    gas gas_remaining wei
        else:
            if not rewardTokenAddress:
                revert with 0, 'AMMLibrary: ZERO_ADDRESS'
            require ext_code.size(address(sha3(0, factoryAddress, sha3(rewardTokenAddress, WAVAXAddress), 0xb7145948956af92afd2ae97eff039ada60998237282c1687ca23ce1ad5e1d282)))
            staticcall address(sha3(0, factoryAddress, sha3(rewardTokenAddress, WAVAXAddress), 0xb7145948956af92afd2ae97eff039ada60998237282c1687ca23ce1ad5e1d282)).getReserves() with:
                    gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
