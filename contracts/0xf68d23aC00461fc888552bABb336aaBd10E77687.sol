...
function supportsInterface(bytes4 arg1) payable {
    ...
    if Mask(32, 224, arg1) == 0xa09b15e200000000000000000000000000000000000000000000000000000000:
        return True
    if Mask(32, 224, arg1) == 0xb4446f200000000000000000000000000000000000000000000000000000000:
        return True
...
function sub_efe210ba(?) payable {
    ...
    mem[ceil32(ceil32(arg1.length)) + arg1.length + 97] = 162
...
function sub_255904ce(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if bool(stor161[arg1].field_0):
        if bool(stor161[arg1].field_0) == uint255(stor161[arg1].field_1) < 32:
            revert with 'NH{q', 34
        if bool(stor161[arg1].field_0):
            if bool(stor161[arg1].field_0) == uint255(stor161[arg1].field_1) < 32:
                revert with 'NH{q', 34
            if uint255(stor161[arg1].field_1):
                if 31 < uint255(stor161[arg1].field_1):
                    mem[128] = stor161[arg1].field_0
                    idx = 128
                    s = 0
                    while uint255(stor161[arg1].field_1) + 96 > idx:
                        mem[idx + 32] = stor161[arg1][s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    return Array(len=2 * Mask(256, -1, uint255(stor161[arg1].field_1)), data=mem[128 len ceil32(uint255(stor161[arg1].field_1))])
                mem[128] = 256 * Mask(248, 0, stor161[arg1].field_8)
        else:
            if bool(stor161[arg1].field_0) == stor161[arg1].field_1 % 128 < 32:
                revert with 'NH{q', 34
            if stor161[arg1].field_1 % 128:
                if 31 < stor161[arg1].field_1 % 128:
                    mem[128] = stor161[arg1].field_0
                    idx = 128
                    s = 0
                    while stor161[arg1].field_1 % 128 + 96 > idx:
                        mem[idx + 32] = stor161[arg1][s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    return Array(len=2 * Mask(256, -1, uint255(stor161[arg1].field_1)), data=mem[128 len ceil32(uint255(stor161[arg1].field_1))])
                mem[128] = 256 * Mask(248, 0, stor161[arg1].field_8)
        mem[ceil32(uint255(stor161[arg1].field_1)) + 192 len ceil32(uint255(stor161[arg1].field_1))] = mem[128 len ceil32(uint255(stor161[arg1].field_1))]
        if ceil32(uint255(stor161[arg1].field_1)) > uint255(stor161[arg1].field_1):
            mem[ceil32(uint255(stor161[arg1].field_1)) + uint255(stor161[arg1].field_1) + 192] = 0
        return Array(len=2 * Mask(256, -1, uint255(stor161[arg1].field_1)), data=mem[128 len ceil32(uint255(stor161[arg1].field_1))], mem[(2 * ceil32(uint255(stor161[arg1].field_1))) + 192 len 2 * ceil32(uint255(stor161[arg1].field_1))]), 
    if bool(stor161[arg1].field_0) == stor161[arg1].field_1 % 128 < 32:
        revert with 'NH{q', 34
    if bool(stor161[arg1].field_0):
        if bool(stor161[arg1].field_0) == uint255(stor161[arg1].field_1) < 32:
        ...
        if uint255(stor161[arg1].field_1):
            if 31 < uint255(stor161[arg1].field_1):
                ...
                while uint255(stor161[arg1].field_1) + 96 > idx:
                    ...
                    s = s + 1
                    continue 
                return Array(len=stor161[arg1].field_0 % 128, data=mem[128 len ceil32(stor161[arg1].field_1 % 128)])
            mem[128] = 256 * Mask(248, 0, stor161[arg1].field_8)
    else:
        if bool(stor161[arg1].field_0) == stor161[arg1].field_1 % 128 < 32:
            revert with 'NH{q', 34
        if stor161[arg1].field_1 % 128:
            if 31 < stor161[arg1].field_1 % 128:
                ...
                return Array(len=stor161[arg1].field_0 % 128, data=mem[128 len ceil32(stor161[arg1].field_1 % 128)])
            mem[128] = 256 * Mask(248, 0, stor161[arg1].field_8)
    mem[ceil32(stor161[arg1].field_1 % 128) + 192 len ceil32(stor161[arg1].field_1 % 128)] = mem[128 len ceil32(stor161[arg1].field_1 % 128)]
    if ceil32(stor161[arg1].field_1 % 128) > stor161[arg1].field_1 % 128:
        mem[ceil32(stor161[arg1].field_1 % 128) + stor161[arg1].field_1 % 128 + 192] = 0
    return Array(len=stor161[arg1].field_0 % 128, data=mem[128 len ceil32(stor161[arg1].field_1 % 128)], mem[(2 * ceil32(stor161[arg1].field_1 % 128)) + 192 len 2 * ceil32(stor161[arg1].field_1 % 128)]), 
}

function sub_5fe82ca5(?) payable {
    require calldata.size - 4 >= 32
    ...
    if cd[(cd[4] + ('cd', 4).length + 4)] > test266151307():
        revert with 'NH{q', 65
    if ceil32(ceil32(cd[(cd[4] + ('cd', 4).length + 4)])) + 225 > test266151307() or ceil32(ceil32(cd[(cd[4] + ('cd', 4).length + 4)])) + 225 < 224:
        revert with 'NH{q', 65
    ...
    if cd[(cd[4] + ('cd', 4)[0] + 4)] > test266151307():
        revert with 'NH{q', 65
    if ceil32(ceil32(cd[(cd[4] + ('cd', 4).length + 4)])) + ceil32(ceil32(cd[(cd[4] + ('cd', 4)[0] + 4)])) + 226 > test266151307() or ceil32(ceil32(cd[(cd[4] + ('cd', 4)[0] + 4)])) + 226 < 225:
        revert with 'NH{q', 65
    ...
    if cd[(cd[4] + ('cd', 4)[1] + 4)] > test266151307():
        revert with 'NH{q', 65
    if ceil32(ceil32(cd[(cd[4] + ('cd', 4).length + 4)])) + ceil32(ceil32(cd[(cd[4] + ('cd', 4)[0] + 4)])) + ceil32(ceil32(cd[(cd[4] + ('cd', 4)[1] + 4)])) + 227 > test266151307() or ceil32(ceil32(cd[(cd[4] + ('cd', 4)[1] + 4)])) + 227 < 226:
        revert with 'NH{q', 65
    ...
    if bool(stor156.length):
        ...
        if cd[(cd[4] + ('cd', 4).length + 4)]:
            ...
            while stor156.length.field_1 % 128 + 31 / 32 > idx:
                ...
                idx = idx + 1
                continue 
    if bool(stor157.length):
        if bool(stor157.length) == uint255(stor157.length.field_1) < 32:
            revert with 'NH{q', 34
        if cd[(cd[4] + ('cd', 4)[0] + 4)]:
            stor157[].field_0 = Array(len=cd[(cd[4] + ('cd', 4)[0] + 4)], data=call.data[cd[4] + ('cd', 4)[0] + 36 len cd[(cd[4] + ('cd', 4)[0] + 4)]])
        else:
            stor157.length = 0
            idx = 0
            while uint255(stor157.length.field_1) + 31 / 32 > idx:
                stor157[idx].field_0 = 0
                idx = idx + 1
                continue 
    else:
        if bool(stor157.length) == stor157.length.field_1 % 128 < 32:
            revert with 'NH{q', 34
        if cd[(cd[4] + ('cd', 4)[0] + 4)]:
            stor157[].field_0 = Array(len=cd[(cd[4] + ('cd', 4)[0] + 4)], data=call.data[cd[4] + ('cd', 4)[0] + 36 len cd[(cd[4] + ('cd', 4)[0] + 4)]])
        else:
            stor157.length = 0
            idx = 0
            while stor157.length.field_1 % 128 + 31 / 32 > idx:
                stor157[idx].field_0 = 0
                idx = idx + 1
                continue 
    if bool(stor158.length):
        if bool(stor158.length) == uint255(stor158.length.field_1) < 32:
            revert with 'NH{q', 34
        if cd[(cd[4] + ('cd', 4)[1] + 4)]:
            stor158[].field_0 = Array(len=cd[(cd[4] + ('cd', 4)[1] + 4)], data=call.data[cd[4] + ('cd', 4)[1] + 36 len cd[(cd[4] + ('cd', 4)[1] + 4)]])
        else:
            stor158.length = 0
            idx = 0
            while uint255(stor158.length.field_1) + 31 / 32 > idx:
                stor158[idx].field_0 = 0
                idx = idx + 1
                continue 
    else:
        if bool(stor158.length) == stor158.length.field_1 % 128 < 32:
            revert with 'NH{q', 34
        if cd[(cd[4] + ('cd', 4)[1] + 4)]:
            stor158[].field_0 = Array(len=cd[(cd[4] + ('cd', 4)[1] + 4)], data=call.data[cd[4] + ('cd', 4)[1] + 36 len cd[(cd[4] + ('cd', 4)[1] + 4)]])
        else:
            stor158.length = 0
            idx = 0
            while stor158.length.field_1 % 128 + 31 / 32 > idx:
                stor158[idx].field_0 = 0
                idx = idx + 1
                continue 
    stor159 = address(('cd', 4)[2])
}
