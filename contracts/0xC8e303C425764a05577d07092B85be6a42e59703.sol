...
function tokenURI(uint256 arg1) {
    ...
    if stor17[arg1] == 2:
        ...
        if not s:
            ...
            if not bool(stor14.length):
                ...
                if ceil32(mem[96]) <= mem[96]:
                    _1803 = mem[64]
                    mem[64] = mem[64] + stor14.length.field_1 + mem[96] + 50
                    mem[_1072 + stor14.length.field_1 + mem[96] + 50] = 32
                    _1902 = mem[_1803]
        ...
        if not bool(stor14.length):
            ...
            if ceil32(mem[96]) <= mem[96]:
                _1809 = mem[64]
                mem[64] = mem[64] + stor14.length.field_1 + mem[96] + 50
                mem[_1073 + stor14.length.field_1 + mem[96] + 50] = 32
                _1906 = mem[_1809]
    ...
    if stor17[arg1] != 1:
        ...
        if not s:
            ...
            if not bool(stor14.length):
                ...
                if ceil32(mem[96]) <= mem[96]:
                    _1779 = mem[64]
                    mem[64] = mem[64] + stor14.length.field_1 + mem[96] + 42
                    mem[_1068 + stor14.length.field_1 + mem[96] + 42] = 32
                    _1886 = mem[_1779]
        ...
        if not bool(stor14.length):
            ...
            if ceil32(mem[96]) <= mem[96]:
                _1785 = mem[64]
                mem[64] = mem[64] + stor14.length.field_1 + mem[96] + 42
                mem[_1069 + stor14.length.field_1 + mem[96] + 42] = 32
                _1890 = mem[_1785]
    ...
    if not s:
        ...
        if not bool(stor14.length):
            ...
            if ceil32(mem[96]) <= mem[96]:
                _1791 = mem[64]
                mem[64] = mem[64] + stor14.length.field_1 + mem[96] + 47
                mem[_1070 + stor14.length.field_1 + mem[96] + 47] = 32
                _1894 = mem[_1791]
    ...
    if not bool(stor14.length):
        ...
        if ceil32(mem[96]) <= mem[96]:
            _1797 = mem[64]
            mem[64] = mem[64] + stor14.length.field_1 + mem[96] + 47
            mem[_1071 + stor14.length.field_1 + mem[96] + 47] = 32
            _1898 = mem[_1797]
