...
function getPairAddress(address arg1, address arg2) {
    ...
    staticcall address(ext_call.return_data[0]).pairCodeHash() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if ext_call.return_data[12 len 20] < arg2:
        ...
        return address(sha3(0, address(ext_call.return_data[0]), sha3(address(ext_call.return_data[0]), arg2), ext_call.return_data[0]))
    if not arg2:
        revert with 0, 'JoeLibrary: ZERO_ADDRESS'
    return address(sha3(0, address(ext_call.return_data[0]), sha3(arg2, address(ext_call.return_data[0])), ext_call.return_data[0]))
}
...
function sub_ce434861(?) payable {
    ...
    if ext_call.return_data[0] * arg3 / arg4 < msg.value:
        ...
        if ext_call.return_data[0] * arg3 / arg4 != msg.value:
            if msg.value < ext_call.return_data[0] * arg3 / arg4:
                revert with 'NH{q', 17
            call msg.sender with:
               value msg.value - (ext_call.return_data[0] * arg3 / arg4) wei
