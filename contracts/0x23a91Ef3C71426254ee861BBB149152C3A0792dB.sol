...
function sub_a1b84602(?) payable {
    ...
    if not ext_call.return_data[18 len 14]:
        revert with 'NH{q', 18
    return (ext_call.return_data[50 len 14] * stor0 / ext_call.return_data[18 len 14])
}
...
function sub_26e01154(?) payable {
    ...
    if 2 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0] and ext_call.return_data[0] > -1 / 2 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0]:
        revert with 'NH{q', 17
    return (2 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0] * ext_call.return_data[0])
}
...
function getAPR() payable {
    ...
    if ext_call.return_data[0] and Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]) > -1 / ext_call.return_data[0]:
        revert with 'NH{q', 17
    if ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]) and 5256 * 24 * 3600 > -1 / ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]):
        revert with 'NH{q', 17
    if 5256 * 24 * 3600 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]) and 100 > -1 / 5256 * 24 * 3600 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]):
        revert with 'NH{q', 17
    if not 2 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0] * ext_call.return_data[0]:
        revert with 'NH{q', 18
    return (146 * 3600 * 24 * 3600 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]) / 2 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0] * ext_call.return_data[0])
}
