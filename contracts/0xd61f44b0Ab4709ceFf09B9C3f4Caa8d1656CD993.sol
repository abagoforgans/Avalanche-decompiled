...
function claimProcess() {
    ...
    call stor39.process(uint256 rg1) with:
...
function purgeBeforeSwitch() {
    if owner != msg.sender:
        revert with 0, '!OWNER'
    require ext_code.size(stor39)
    call stor39.purge(address rg1) with:
         gas gas_remaining wei
        args msg.sender
...
function ___claimRewards() {
    require ext_code.size(stor39)
    call stor39.claimDividend() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(stor39)
...
function switchToken(address arg1) {
    ...
    create contract with 0 wei
                    code: code.data[11978 len 4618], routerAddress, arg1
    if not create.new_address:
        revert with ext_call.return_data[0 len return_data.size]
    stor39 = address(create.new_address)
}
...
function setIsDividendExempt(address arg1, bool arg2) {
    ...
    require ext_code.size(stor39)
    if not arg2:
        call stor39.setShare(address rg1, uint256 rg2) with:
             gas gas_remaining wei
