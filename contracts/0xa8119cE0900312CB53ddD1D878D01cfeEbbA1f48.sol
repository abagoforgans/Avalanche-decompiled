...
function sub_4ebe0a80(?) payable {
    ...
    if 3 >= arg1.length:
        revert with 0, 'Garages: Name size invalid'
    if arg1.length >= 32:
        revert with 0, 'Garages: Name size invalid'
    if arg2 < creationMinPrice:
        revert with 0, 'Garages: Garage value set below creationMinPrice'
    if not msg.sender:
        revert with 0, 'ERC721: balance query for the zero address'
    mem[0] = msg.sender
    mem[32] = 104
    ...
    if not balanceOf[address(msg.sender)]:
        ...
        while idx < _6980:
            ...
            if bool(stor1[_6985].field_0):
                ...
                if sha3(mem[128 len mem[96]]) == sha3(mem[_7021 + 32 len uint255(stor1[_6985].field_0) * 0.5]):
                    revert with 0, 'Garages: Name not available'
            else:
                if bool(stor1[_6985].field_0) == stor1[_6985].field_1 % 128 < 32:
                    revert with 0, 34
                _7024 = mem[64]
        ...
        staticcall sub_f8a5e660Address.0x70a08231 with:
                gas gas_remaining wei
               args msg.sender
        ...
        if mem[_7002] < creationMinPrice:
            revert with 0, 'Garages: Balance too low for creation'
        mem[mem[64] + 36] = arg2
        require ext_code.size(sub_f8a5e660Address)
        call sub_f8a5e660Address.accountBurn(address arg1, uint256 arg2) with:
             gas gas_remaining wei
