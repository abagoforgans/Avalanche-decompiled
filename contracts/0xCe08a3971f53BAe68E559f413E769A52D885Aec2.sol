...
function sub_1eac74b3(?) {
    ...
    while idx < mem[ceil32(return_data.size) + 96]:
        ...
        require return_data.size >= 32
        _70 = mem[(32 * _9) + ceil32(return_data.size) + 128]
        ...
        require mem[mem[(32 * _9) + ceil32(return_data.size) + 128] + (32 * _9) + ceil32(return_data.size) + 128] <= 4294967296 and mem[(32 * _9) + ceil32(return_data.size) + 128] + (32 * mem[mem[(32 * _9) + ceil32(return_data.size) + 128] + (32 * _9) + ceil32(return_data.size) + 128]) + 32 <= return_data.size
        mem[(32 * _9) + (2 * ceil32(return_data.size)) + 128] = mem[mem[(32 * _9) + ceil32(return_data.size) + 128] + (32 * _9) + ceil32(return_data.size) + 128]
        _73 = mem[_70 + (32 * _9) + ceil32(return_data.size) + 128]
        idx = 0
        while idx < 32 * _73:
            mem[(32 * _9) + (2 * ceil32(return_data.size)) + idx + 160] = mem[_70 + (32 * _9) + ceil32(return_data.size) + idx + 160]
            idx = idx + 32
            continue 
        mem[64] = (32 * _73) + (32 * _9) + (2 * ceil32(return_data.size)) + 160
        idx = 0
...
function isAvailableToken(address arg1) {
    ...
    mem[(32 * _7) + ceil32(return_data.size) + 128] = 0xee8c24b800000000000000000000000000000000000000000000000000000000
    require ext_code.size(0xaea2e71b631fa93683bcf256a8689dfa0e094fcd)
    staticcall 0xaea2e71b631fa93683bcf256a8689dfa0e094fcd.getTokenAddresses() with:
            gas gas_remaining wei
    if not ext_call.success:
    ...
    require return_data.size >= 32
    _34 = mem[(32 * _7) + ceil32(return_data.size) + 128]
    require mem[(32 * _7) + ceil32(return_data.size) + 128] <= 4294967296
    require mem[(32 * _7) + ceil32(return_data.size) + 128] + 32 <= return_data.size
    require mem[mem[(32 * _7) + ceil32(return_data.size) + 128] + (32 * _7) + ceil32(return_data.size) + 128] <= 4294967296 and mem[(32 * _7) + ceil32(return_data.size) + 128] + (32 * mem[mem[(32 * _7) + ceil32(return_data.size) + 128] + (32 * _7) + ceil32(return_data.size) + 128]) + 32 <= return_data.size
    mem[(32 * _7) + (2 * ceil32(return_data.size)) + 128] = mem[mem[(32 * _7) + ceil32(return_data.size) + 128] + (32 * _7) + ceil32(return_data.size) + 128]
    _37 = mem[_34 + (32 * _7) + ceil32(return_data.size) + 128]
    mem[(32 * _7) + (2 * ceil32(return_data.size)) + 160 len floor32(mem[_34 + (32 * _7) + ceil32(return_data.size) + 128])] = mem[_34 + (32 * _7) + ceil32(return_data.size) + 160 len floor32(mem[_34 + (32 * _7) + ceil32(return_data.size) + 128])]
    idx = 0
    while idx < mem[(32 * _7) + (2 * ceil32(return_data.size)) + 128]:
        require idx < mem[(32 * _7) + (2 * ceil32(return_data.size)) + 128]
        if arg1 != mem[(32 * idx) + (32 * _7) + (2 * ceil32(return_data.size)) + 172 len 20]:
            idx = idx + 1
            continue 
        mem[(32 * _37) + (32 * _7) + (2 * ceil32(return_data.size)) + 160] = 1
        mem[(32 * _37) + (32 * _7) + (2 * ceil32(return_data.size)) + 192] = 64
        mem[(32 * _37) + (32 * _7) + (2 * ceil32(return_data.size)) + 224] = mem[ceil32(return_data.size) + 96]
        _76 = mem[ceil32(return_data.size) + 96]
        idx = 0
        while idx < 32 * mem[ceil32(return_data.size) + 96]:
            mem[(32 * _37) + (32 * _7) + (2 * ceil32(return_data.size)) + idx + 256] = mem[ceil32(return_data.size) + idx + 128]
            idx = idx + 32
            continue 
        return 1, 64, mem[(32 * _37) + (32 * _7) + (2 * ceil32(return_data.size)) + 224 len (32 * _76) + 32]
    mem[(32 * _37) + (32 * _7) + (2 * ceil32(return_data.size)) + 160] = 0
    mem[(32 * _37) + (32 * _7) + (2 * ceil32(return_data.size)) + 192] = 64
    mem[(32 * _37) + (32 * _7) + (2 * ceil32(return_data.size)) + 224] = mem[ceil32(return_data.size) + 96]
    mem[(32 * _37) + (32 * _7) + (2 * ceil32(return_data.size)) + 256 len floor32(mem[ceil32(return_data.size) + 96])] = mem[ceil32(return_data.size) + 128 len floor32(mem[ceil32(return_data.size) + 96])]
    return 0, 
           64,
           mem[(32 * _37) + (32 * _7) + (2 * ceil32(return_data.size)) + 224 len (32 * mem[ceil32(return_data.size) + 96]) + 32]
}
    ...
    if not return_data.size:
        ...
        if not arg3:
            ...
            if not return_data.size:
                ...
                call 0xaea2e71b631fa93683bcf256a8689dfa0e094fcd.swap(address arg1, address arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
                     gas gas_remaining wei
                    args address(arg1), address(arg2), arg3, 0, address(this.address), -1
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 64
                require ext_code.size(arg2)
                ...
                if not ext_code.hash(arg2):
                    revert with 0, 'SafeERC20: call to non-contract'
                mem[492 len 64] = unknown_0xa9059cbb(?????), msg.sender, 0
                call arg2 with:
                   funct uint32(msg.sender)
                     gas gas_remaining wei
                    args Mask(480, -256, unknown_0xa9059cbb(?????), msg.sender, 0) << 256, mem[556 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with 0, 'SafeERC20: low-level call failed'
                    if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
        ...
        if return_data.size <= 0:
            ...
            if not return_data.size:
                ...
                call 0xaea2e71b631fa93683bcf256a8689dfa0e094fcd.swap(address arg1, address arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
                     gas gas_remaining wei
                    args address(arg1), address(arg2), arg3, 0, address(this.address), -1, mem[(2 * ceil32(return_data.size)) + 526 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 64
                require ext_code.size(arg2)
                staticcall arg2.0x70a08231 with:
                        gas gas_remaining wei
                       args address(this.address), mem[(2 * ceil32(return_data.size)) + 366 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                if ext_call.return_data[0] > ext_call.return_data[0]:
