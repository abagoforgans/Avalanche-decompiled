    ...
    if not return_data.size:
        ...
        if eth.balance(this.address) >= stor7:
            ...
            call stor1.swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
               value stor7 wei
                 gas gas_remaining wei
                args stor8, Array(len=path.length, data=mem[ceil32(ceil32(arg2.length)) + 261 len 32 * path.length]), adminAddress, block.timestamp + 15
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
    else:
        ...
        if eth.balance(this.address) >= stor7:
            ...
            call stor1.swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
               value stor7 wei
                 gas gas_remaining wei
                args stor8, Array(len=path.length, data=mem[ceil32(ceil32(arg2.length)) + ceil32(return_data.size) + 262 len 32 * path.length]), adminAddress, block.timestamp + 15
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
}
                    ...
                    if not return_data.size:
                        ...
                        if eth.balance(this.address) >= stor7:
                            ...
                            call stor1.swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
                               value stor7 wei
                                 gas gas_remaining wei
                                args stor8, Array(len=path.length, data=mem[ceil32(ceil32(arg2.length)) + 293 len 32 * path.length]), adminAddress, block.timestamp + 15
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                    else:
                        ...
                        if eth.balance(this.address) >= stor7:
                            ...
                            call stor1.swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
                               value stor7 wei
                                 gas gas_remaining wei
                                args stor8, Array(len=path.length, data=mem[ceil32(ceil32(arg2.length)) + ceil32(return_data.size) + 294 len 32 * path.length]), adminAddress, block.timestamp + 15
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
        else:
