...
const sub_5fd866df(?) = 0x96cb1a24cb5fbc7b9b65d4b52333403cb0158694
...
function sub_cf42ee60(?) payable {
    require ext_code.size(0x96cb1a24cb5fbc7b9b65d4b52333403cb0158694)
    staticcall 0x96cb1a24cb5fbc7b9b65d4b52333403cb0158694.0x72f702f3 with:
    ...
    require return_data.size >= 32
    require ext_code.size(0x96cb1a24cb5fbc7b9b65d4b52333403cb0158694)
    staticcall 0x96cb1a24cb5fbc7b9b65d4b52333403cb0158694.0x18160ddd with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
