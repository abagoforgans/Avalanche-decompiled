...
function sub_0cd37e06(?) {
    ...
    mem[64] = ceil32(return_data.size) + 192
    require return_data.size >= 32
    _41 = mem[192 len 4], Mask(224, 32, arg2) >> 32
    ...
    _44 = mem[_41 + 192]
    mem[ceil32(return_data.size) + 224 len floor32(mem[_41 + 192])] = mem[_41 + 224 len floor32(mem[_41 + 192])]
    require 1 < mem[ceil32(return_data.size) + 192]
    _71 = mem[ceil32(return_data.size) + 256]
    if not mem[ceil32(return_data.size) + 256]:
        revert with 0, 'Router 1 non darebbe output'
    mem[(32 * _44) + ceil32(return_data.size) + 224] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
    mem[(32 * _44) + ceil32(return_data.size) + 228] = _71
    mem[(32 * _44) + ceil32(return_data.size) + 260] = 64
    mem[(32 * _44) + ceil32(return_data.size) + 292] = 2
    mem[(32 * _44) + ceil32(return_data.size) + 324 len 0] = None
    require ext_code.size(arg4)
    staticcall arg4.getAmountsOut(uint256 arg1, address[] arg2) with:
            gas gas_remaining wei
           args _71, Array(len=2, data=mem[(32 * _44) + ceil32(return_data.size) + 324 len 64])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(32 * _44) + ceil32(return_data.size) + 224 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = (32 * _44) + (2 * ceil32(return_data.size)) + 224
    require return_data.size >= 32
    _96 = mem[(32 * _44) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, _71) >> 32
    require mem[(32 * _44) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, _71) >> 32 <= 4294967296
    require mem[(32 * _44) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, _71) >> 32 + 32 <= return_data.size
    require mem[mem[(32 * _44) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, _71) >> 32 + (32 * _44) + ceil32(return_data.size) + 224] <= 4294967296 and mem[(32 * _44) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, _71) >> 32 + (32 * mem[mem[(32 * _44) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, _71) >> 32 + (32 * _44) + ceil32(return_data.size) + 224]) + 32 <= return_data.size
    mem[(32 * _44) + (2 * ceil32(return_data.size)) + 224] = mem[mem[(32 * _44) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, _71) >> 32 + (32 * _44) + ceil32(return_data.size) + 224]
    _99 = mem[_96 + (32 * _44) + ceil32(return_data.size) + 224]
    mem[(32 * _44) + (2 * ceil32(return_data.size)) + 256 len floor32(mem[_96 + (32 * _44) + ceil32(return_data.size) + 224])] = mem[_96 + (32 * _44) + ceil32(return_data.size) + 256 len floor32(mem[_96 + (32 * _44) + ceil32(return_data.size) + 224])]
    require 1 < mem[(32 * _44) + (2 * ceil32(return_data.size)) + 224]
    if not mem[(32 * _44) + (2 * ceil32(return_data.size)) + 288]:
        revert with 0, 'Router 2 non darebbe output'
    mem[(32 * _99) + (32 * _44) + (2 * ceil32(return_data.size)) + 256] = mem[(32 * _44) + (2 * ceil32(return_data.size)) + 288] - arg2
    return memory
      from (32 * _99) + (32 * _44) + (2 * ceil32(return_data.size)) + 256
       len 32
}
...
function executeOperation(address[] arg1, uint256[] arg2, uint256[] arg3, address arg4, bytes arg5) {
    ...
    mem[(32 * _240) + (32 * _91) + (2 * ceil32(return_data.size)) + 288] = stor13
    mem[(32 * _240) + (32 * _91) + (2 * ceil32(return_data.size)) + 320] = stor14
