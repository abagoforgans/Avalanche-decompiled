...
function royaltyInfo(uint256 arg1, uint256 arg2) payable {
    ...
    if arg2 and 1000 > -1 / arg2:
        revert with 'NH{q', 17
    return address(this.address), 1000 * arg2 / 10000
}
...
function mint(uint256 arg1) payable {
    ...
    if totalSupply + arg1 < 1:
        revert with 'NH{q', 17
    if totalSupply + arg1 - 1 >= 10000:
        revert with 0, 'Exceeds max supply'
    if arg1 > 20:
        revert with 0, 'Mint at most 20 at a time'
    idx = 0
    while idx < arg1:
        if not msg.sender:
