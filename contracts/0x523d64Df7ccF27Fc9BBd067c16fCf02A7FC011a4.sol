...
function mintPresaleTokens(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    if not stor8[msg.sender]:
        revert with 0, 'User is not on whitelist'
    if arg1 > stor9:
        revert with 0, 'Cannot mint more than max'
    if arg1 <= 0:
        revert with 0, 'Cannot mint zero'
    if not stor10:
        revert with 0, 18
    call stor5.0xa9059cbb with:
         gas gas_remaining wei
        args stor6, arg1 / stor10
