    ...
    if msg.sender == stor6:
        ...
        if stor4 == address(arg1):
            ...
            if not arg6:
                ...
                call stor2.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len 96], stor8, block.timestamp + 15, mem[mem[64] + 164 len (32 * _2656) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
        ...
        if stor4 == address(arg1):
            ...
            if not arg6:
                ...
                call stor2.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len 96], stor8, block.timestamp + 15, mem[mem[64] + 164 len (32 * _2660) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
        ...
        if stor4 == address(arg1):
            ...
            if not arg7:
                ...
                while idx < arg3:
                    ...
                    staticcall stor2.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len (32 * _760) + 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1376 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                call stor2.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len 96], stor8, block.timestamp + 15, mem[mem[64] + 164 len (32 * _2928) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                while idx < arg3:
                    ...
                    staticcall stor2.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len (32 * _3416) + 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _3592 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if not arg7:
                ...
                while idx < arg3:
                    ...
                    staticcall stor2.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len (32 * _757) + 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1373 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                while idx < arg3:
                    ...
                    staticcall stor2.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len (32 * _3414) + 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _3590 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        if stor4 != address(arg1):
            ...
            if not arg7:
                ...
                while idx < arg3:
                    ...
                    staticcall stor2.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len _751 + (32 * _763) + -mem[64] + 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1379 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if not arg7:
                ...
                while idx < arg3:
                    ...
                    staticcall stor2.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len (32 * _3420) + 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _3596 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
