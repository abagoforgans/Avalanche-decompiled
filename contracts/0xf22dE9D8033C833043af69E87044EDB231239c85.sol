...
uint256 sub_540ba552;
uint256 buyLiquidityFee;
uint256 sellTotalFees;
uint256 sellBuybackFee;
uint256 sellLiquidityFee;
uint256 sub_d4090d2a;
...
function updateBuyFees(uint256 arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    if owner != msg.sender:
    ...
    if sub_540ba552 > -buyLiquidityFee - 1:
        revert with 'NH{q', 17
    buyTotalFees = sub_540ba552 + buyLiquidityFee
}

function updateSellFees(uint256 arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    if owner != msg.sender:
    ...
    if sellBuybackFee > -sellLiquidityFee - 1:
        revert with 'NH{q', 17
