                                            ...
                                            if not balanceOf[this.address]:
                                                ...
                                                if not balanceOf[this.address]:
                                                    ...
                                                    if not msg.sender:
                                                        revert with 0, 
                                                                    ...
                                                                    mem[_1974 + (6 * ceil32(return_data.size)) + 900 len 9 * ceil32(return_data.size)]
                                                    if not this.address:
                                                        revert with 0, 
                                                    ...
                                                    if ext_call.return_data[0] > balanceOf[address(msg.sender)]:
                                                        mem[_1974 + (6 * ceil32(return_data.size)) + 970] = 0
                                                        revert with 0, 
                                                                    32,
                                                                    38,
                                                                    0xfe45524332303a207472616e7366657220616d6f756e7420657863656564732062616c616e63, 0 >> 48,
                                                                    mem[_1974 + (6 * ceil32(return_data.size)) + 970 len (9 * ceil32(return_data.size)) + 26]
                                                    if balanceOf[address(msg.sender)] < ext_call.return_data[0]:
                                                        revert with 0, 17
                                                    balanceOf[address(msg.sender)] -= ext_call.return_data[0]
                                                    if balanceOf[this.address] > !ext_call.return_data[0]:
                                                        revert with 0, 17
                                                    if balanceOf[this.address] + ext_call.return_data[0] < balanceOf[this.address]:
                                                        revert with 0, 'SafeMath: addition overflow', mem[_1974 + (6 * ceil32(return_data.size)) + 964 len 9 * ceil32(return_data.size)]
                                                    balanceOf[address(this.address)] = balanceOf[this.address] + ext_call.return_data[0]
                                                    emit Transfer(ext_call.return_data[0], msg.sender, this.address);
                                                    ...
                                                    call nodeRewardManagerAddress.createNode(address arg1, string arg2) with:
                                                         gas gas_remaining wei
                                                        args msg.sender, Array(len=mem[128], data=mem[_1974 + (6 * ceil32(return_data.size)) + 964 len (9 * ceil32(return_data.size)) + ceil32(mem[128])])
                                                else:
                                                    ...
                                                    if balanceOf[this.address] * rewardsFee / 100:
                                                        ...
                                                        if balanceOf[this.address]:
                                                            ...
                                                            if not ext_call.success:
                                                                revert with ext_call.return_data[0 len return_data.size]
                                                            mem[64] = _2007 + (6 * ceil32(return_data.size)) + 768
                                                            require return_data.size >= 32
                                                            require ext_call.return_data[0] == ext_call.return_data[12 len 20]
                                                            ...
                                                            mem[_2007 + (6 * ceil32(return_data.size)) + 804] = 0
                                                            ...
                                                            while idx < mem[_2007 + (4 * ceil32(return_data.size)) + 672]:
                                                                mem[s] = mem[t + 12 len 20]
                                                                idx = idx + 1
                                                                s = s + 32
                                                                t = t + 32
                                                                continue 
                                                            mem[_2007 + (6 * ceil32(return_data.size)) + 868] = this.address
                                                            mem[_2007 + (6 * ceil32(return_data.size)) + 900] = block.timestamp
                                                            require ext_code.size(uniswapV2RouterAddress)
                                                            call uniswapV2RouterAddress.mem[mem[64] len 4] with:
                                                                 gas gas_remaining wei
                                                                args mem[mem[64] + 4 len _2007 + (6 * ceil32(return_data.size)) + (32 * mem[_2007 + (4 * ceil32(return_data.size)) + 672]) + -mem[64] + 960]
                                                            if not ext_call.success:
                                                                revert with ext_call.return_data[0 len return_data.size]
                                                            uint8(stor25.field_0) = 0
                                                            if not msg.sender:
                                                        ...
                                                        if not balanceOf[this.address]:
                                                            ...
                                                            if not ext_call.success:
                                                                revert with ext_call.return_data[0 len return_data.size]
                                                            mem[64] = _1992 + (2 * ceil32(return_data.size)) + 608
                                                            require return_data.size >= 32
                                                            require ext_call.return_data[0] == ext_call.return_data[12 len 20]
                                                            ...
                                                            call uniswapV2RouterAddress.mem[mem[64] len 4] with:
                                                                 gas gas_remaining wei
                                                                args mem[mem[64] + 4 len _1992 + (2 * ceil32(return_data.size)) + (32 * mem[_1992 + ceil32(return_data.size) + 512]) + -mem[64] + 800]
                                                            if not ext_call.success:
                                                                revert with ext_call.return_data[0 len return_data.size]
                                                            _4515 = mem[64]
                                                            mem[64] = mem[64] + 64
                                                ...
                                                if not balanceOf[this.address]:
                                                    ...
                                                    if not balanceOf[this.address]:
                                                        ...
                                                        call uniswapV2RouterAddress.mem[mem[64] len 4] with:
                                                             gas gas_remaining wei
                                                            args mem[mem[64] + 4 len _3385 + (4 * ceil32(return_data.size)) + (32 * mem[_3385 + (2 * ceil32(return_data.size)) + 160]) + -mem[64] + 448]
                                                        if not ext_call.success:
                                                            revert with ext_call.return_data[0 len return_data.size]
                                                        uint8(stor25.field_0) = 0
                                                        if not msg.sender:
                                                        ...
                                                        call uniswapV2RouterAddress.mem[mem[64] len 4] with:
                                                             gas gas_remaining wei
                                                            args mem[mem[64] + 4 len _3436 + (4 * ceil32(return_data.size)) + (32 * mem[_3436 + (2 * ceil32(return_data.size)) + 160]) + -mem[64] + 448]
                                                        if not ext_call.success:
                                                            revert with ext_call.return_data[0 len return_data.size]
                                                        uint8(stor25.field_0) = 0
                                                        if not msg.sender:
                                                    ...
                                                    if not balanceOf[this.address] * rewardsFee / 100:
                                                        ...
                                                        if not balanceOf[this.address]:
                                                            ...
                                                            if not ext_call.success:
                                                                revert with ext_call.return_data[0 len return_data.size]
                                                            require return_data.size >= 96
                                                            mem[_1990 + (4 * ceil32(return_data.size)) + 672] = 0
                                                            mem[_1990 + (4 * ceil32(return_data.size)) + 704] = 0
                                                            mem[_1990 + (4 * ceil32(return_data.size)) + 736] = 0
                                                            emit SwapAndLiquify(uint256 arg1, uint256 arg2, uint256 arg3):
                                                            ...
                                                            while idx < mem[_1990 + (4 * ceil32(return_data.size)) + 672]:
                                                                ...
                                                                t = t + 32
                                                                continue 
                                                            mem[_1990 + (6 * ceil32(return_data.size)) + 868] = this.address
                                                            mem[_1990 + (6 * ceil32(return_data.size)) + 900] = block.timestamp
                                                            require ext_code.size(uniswapV2RouterAddress)
                                                            call uniswapV2RouterAddress.mem[mem[64] len 4] with:
                                                                 gas gas_remaining wei
                                                                args mem[mem[64] + 4 len _1990 + (6 * ceil32(return_data.size)) + (32 * mem[_1990 + (4 * ceil32(return_data.size)) + 672]) + -mem[64] + 960]
                                                            if not ext_call.success:
                                                                revert with ext_call.return_data[0 len return_data.size]
                                                            uint8(stor25.field_0) = 0
                                                            if not msg.sender:
                                                        ...
                                                        if balanceOf[this.address]:
                                                            ...
                                                            call uniswapV2RouterAddress.mem[mem[64] len 4] with:
                                                                 gas gas_remaining wei
                                                                args mem[mem[64] + 4 len _3432 + (4 * ceil32(return_data.size)) + (32 * mem[_3432 + (2 * ceil32(return_data.size)) + 160]) + -mem[64] + 448]
                                                            if not ext_call.success:
                                                                revert with ext_call.return_data[0 len return_data.size]
                                                            uint8(stor25.field_0) = 0
                                                            if not msg.sender:
                                                            ...
                                                            call uniswapV2RouterAddress.swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                                                 gas gas_remaining wei
                                                                args balanceOf[this.address], 0, 160, address(this.address), block.timestamp, mem[_4784 + ceil32(return_data.size) + 260 len (32 * mem[_4784]) + 32]
                                                            if not ext_call.success:
                                                                revert with ext_call.return_data[0 len return_data.size]
                                                            uint8(stor25.field_0) = 0
                                                            if not msg.sender:
                                                            ...
                                                            if not this.address:
                                                                revert with 0, 'ERC20: transfer to the zero address'
                                                            mem[_4784 + ceil32(return_data.size) + 96] = 38
                                                            mem[_4784 + ceil32(return_data.size) + 128 len 38] = 0xfe45524332303a207472616e7366657220616d6f756e7420657863656564732062616c616e63
                                                            if ext_call.return_data[0] > balanceOf[address(msg.sender)]:
                                                            ...
                                                            balanceOf[address(this.address)] = balanceOf[this.address] + ext_call.return_data[0]
                                                            emit Transfer(ext_call.return_data[0], msg.sender, this.address);
                                                            mem[_4784 + ceil32(return_data.size) + 192] = 0x12b8603f00000000000000000000000000000000000000000000000000000000
                                                            mem[_4784 + ceil32(return_data.size) + 196] = msg.sender
                                                            mem[_4784 + ceil32(return_data.size) + 228] = 64
                                                            mem[_4784 + ceil32(return_data.size) + 260] = mem[128]
                                                            mem[_4784 + ceil32(return_data.size) + 292 len ceil32(mem[128])] = mem[160 len ceil32(mem[128])]
                                                            if ceil32(mem[128]) > mem[128]:
                                                                mem[mem[128] + _4784 + ceil32(return_data.size) + 292] = 0
                                                            require ext_code.size(nodeRewardManagerAddress)
                                                            call nodeRewardManagerAddress.createNode(address arg1, string arg2) with:
                                                                 gas gas_remaining wei
                                                                args msg.sender, Array(len=mem[128], data=mem[_4784 + ceil32(return_data.size) + 292 len ceil32(mem[128])])
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
}
