...
function aggregate(address arg1, bytes[] arg2) payable {
    ...
    while idx < arg1.length:
        ...
        mem[cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)] + _83 + 32] = 0
        mem[_56 + 32] = _83
        mem[t] = _56
        idx = idx + 1
        s = s + 32
    ...
    if not _54:
        ...
        s = mem[64] + 96
        t = mem[64] + (32 * _112) + 96
        while arg1.length < _112:
            mem[s] = t + -_108 - 96
            _155 = mem[arg1 + (32 * arg1.length) + 36]
            _156 = mem[mem[arg1 + (32 * arg1.length) + 36]]
            mem[t] = mem[mem[arg1 + (32 * arg1.length) + 36]]
            idx = 0
            while idx < _156:
                mem[idx + t + 32] = mem[idx + _155 + 32]
                idx = idx + 32
                continue 
            if ceil32(_156) > _156:
                mem[t + _156 + 32] = 0
    ...
    while idx < _154:
        ...
        s = 0
        while arg1.length < _170:
            mem[arg1.length + _167] = mem[arg1.length + _166 + 32]
            _154 = mem[96]
            s = arg1.length + 32
            continue 
        if arg1.length <= _170:
