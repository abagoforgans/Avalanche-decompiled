...
function sub_d7112f4f(?) payable {
    require ext_code.size(treasuryAddress)
    staticcall treasuryAddress.0xd7112f4f with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function initialize(address arg1, address arg2, address arg3) payable {
    ...
    sub_6a6adeb3Address = arg1
    sub_4701b606Address = arg2
...
function stake(uint256 arg1) payable {
    ...
    if not msg.sender:
        ...
        if ext_code.size(sub_4701b606Address) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[292 len 96] = unknown_0x23b872dd(?????), msg.sender, address(this.address), Mask(224, 32, arg1) >> 32
        mem[416 len 4] = 0
        mem[388 len 0] = 0
        call sub_4701b606Address with:
             gas gas_remaining wei
