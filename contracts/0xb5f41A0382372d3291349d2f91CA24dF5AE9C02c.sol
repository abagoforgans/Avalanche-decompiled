...
function sub_3e3ab282(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
    if address(stor2.field_16) != address(arg1):
        if arg2 and uint16(stor2.field_0) > -1 / arg2:
            revert with 0, 17
        return (arg2 * uint16(stor2.field_0) / 10000)
    if 2 > !stor1:
        revert with 0, 17
    if block.number > stor1 + 2:
        if arg2 and uint16(stor2.field_0) > -1 / arg2:
            revert with 0, 17
        return (arg2 * uint16(stor2.field_0) / 10000)
    if arg2 > 0x7482296a44b8c66dae88fd0ab1f2cd414ef6371185933a7b55c9d77ebf9a0:
        revert with 0, 17
    return (9000 * arg2 / 10000)
}
