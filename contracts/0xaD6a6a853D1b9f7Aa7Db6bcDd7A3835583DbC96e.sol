...
function safeMint(address arg1, string arg2) payable {
    ...
    if stor12 > maxNumber:
        if maxNumber:
            revert with 0, 'IMEShip: token hit max number'
    stor12++
    if not arg1:
...
function sub_1fb8a363(?) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if not address(arg1):
        revert with 0, 'IMEShip: zero address'
    if stor12 <= maxNumber:
        if arg2 <= 0:
            revert with 0, 'IMEShip: invalid count'
        if stor12 > -arg2 - 1:
            revert with 'NH{q', 17
        if stor12 + arg2 < 1:
            revert with 'NH{q', 17
        if stor12 + arg2 - 1 <= maxNumber:
            idx = 0
            while idx < arg2:
                stor12++
                _367 = mem[64]
                ...
                if address(arg1):
                    ...
                    if ext_code.size(address(arg1)) > 0:
                        ...
                        s = 0
                        while s < 0:
                            mem[mem[64] + s + 164] = mem[_367 + s + 32]
                            s = s + 32
                            continue 
                        ...
                        require return_data.size >= 32
                        require mem[_743] == Mask(32, 224, mem[_743])
                        if Mask(32, 224, mem[_743]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                else:
                    if tokenByIndex.length < 1:
                        revert with 'NH{q', 17
                    ...
                    if ext_code.size(address(arg1)) > 0:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_744] == Mask(32, 224, mem[_744])
                        if Mask(32, 224, mem[_744]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                if idx == -1:
                    revert with 'NH{q', 17
                idx = idx + 1
            ...
            if maxNumber:
                revert with 0, 'IMEShip: max supply exceeded'
            idx = 0
            while idx < arg2:
                stor12++
                _368 = mem[64]
                ...
                if address(arg1):
                    ...
                    if ext_code.size(address(arg1)) > 0:
                        ...
                        s = 0
                        while s < 0:
                            mem[mem[64] + s + 164] = mem[_368 + s + 32]
                            s = s + 32
                            continue 
                        require ext_code.size(address(arg1))
                        call address(arg1).onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_745] == Mask(32, 224, mem[_745])
                        if Mask(32, 224, mem[_745]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                else:
                    if tokenByIndex.length < 1:
                        revert with 'NH{q', 17
                    ...
                    if ext_code.size(address(arg1)) > 0:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_746] == Mask(32, 224, mem[_746])
                        if Mask(32, 224, mem[_746]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                if idx == -1:
                    revert with 'NH{q', 17
                idx = idx + 1
            ...
            while idx < arg2:
                ...
                if address(arg1):
                    ...
                    if ext_code.size(address(arg1)) > 0:
                        ...
                        s = 0
                        while s < 0:
                            mem[mem[64] + s + 164] = mem[_369 + s + 32]
                            s = s + 32
                            continue 
                        require ext_code.size(address(arg1))
                        call address(arg1).onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_747] == Mask(32, 224, mem[_747])
                        if Mask(32, 224, mem[_747]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                else:
                    if tokenByIndex.length < 1:
                        revert with 'NH{q', 17
                    ...
                    if ext_code.size(address(arg1)) > 0:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_748] == Mask(32, 224, mem[_748])
                        if Mask(32, 224, mem[_748]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                if idx == -1:
                    revert with 'NH{q', 17
                idx = idx + 1
            ...
            while idx < arg2:
                ...
                if address(arg1):
                    ...
                    if ext_code.size(address(arg1)) > 0:
                        ...
                        s = 0
                        while s < 0:
                            mem[mem[64] + s + 164] = mem[_370 + s + 32]
                            s = s + 32
                            continue 
                        require ext_code.size(address(arg1))
                        call address(arg1).onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
