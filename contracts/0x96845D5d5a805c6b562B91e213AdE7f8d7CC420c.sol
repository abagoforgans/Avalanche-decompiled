                            ...
                            if ext_call.return_data[0] >= ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024:
                                ...
                                if ext_call.return_data[0] > ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024 - ext_call.return_data[0]:
                                    ...
                                    if not return_data.size:
                                        ...
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        mem[296 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024) >> 32
                                        call sub_8cab0f99Address with:
                                           funct uint32(msg.sender)
                                             gas gas_remaining wei
                                            args Mask(224, 32, ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024) << 224, mem[360 len 4]
                                        if not return_data.size:
                                            if not ext_call.success:
                                                revert with 0, 
                                                            32,
                                        ...
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        mem[ceil32(return_data.size) + 297 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024) >> 32
                                        call sub_8cab0f99Address with:
                                           funct uint32(msg.sender)
                                             gas gas_remaining wei
                                            args Mask(224, 32, ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024) << 224, mem[ceil32(return_data.size) + 361 len 4]
                                        if not return_data.size:
                                            if not ext_call.success:
                                                revert with 0, 
                                                            32,
                                            ...
                                            if not return_data.size:
                                                ...
                                                if (player[address(msg.sender)].field_256 * sub_f87f87ac) + 500 * 10^6 < player[address(msg.sender)].field_256 * sub_f87f87ac:
                                                    revert with 0, 
                                                                'SafeMath: multiple overflow',
                                                                mem[(2 * ceil32(return_data.size)) + 398 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
            ('ge', ('add', 500000000, ('mul', ('field', 256, ('stor', ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'player', 26)))), ('stor', ('name', 'sub_f87f87ac', 2)))), ('mul', ('field', 256, ('stor', ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'player', 26)))), ('stor', ('name', 'sub_f87f87ac', 2))))
