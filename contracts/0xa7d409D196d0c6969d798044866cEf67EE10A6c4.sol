...
function sub_fa194dcb(?) payable {
    ...
    if not sub_cba8b48c.length:
        ...
        call routerAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args 0, ext_call.return_data[28 len 4], 0, 160, owner, block.timestamp, sub_cba8b48c.length
    else:
        mem[0] = 8
        ...
        call routerAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args 0, ext_call.return_data[28 len 4], 0, 160, owner, block.timestamp, sub_cba8b48c.length, mem[292 len 32 * sub_cba8b48c.length]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_ddf367fc(?) payable {
    ...
    if not sub_c791ab03.length:
        ...
        call routerAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args 0, ext_call.return_data[28 len 4], 0, 160, owner, block.timestamp, sub_c791ab03.length
    else:
        mem[0] = 7
        ...
        call routerAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args 0, ext_call.return_data[28 len 4], 0, 160, owner, block.timestamp, sub_c791ab03.length, mem[292 len 32 * sub_c791ab03.length]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[96 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = ceil32(return_data.size) + 96
