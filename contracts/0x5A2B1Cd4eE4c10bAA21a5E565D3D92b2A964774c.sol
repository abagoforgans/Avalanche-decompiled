...
function updateOwner(address arg1) {
    ...
    require arg1 == arg1
    if stor0 != msg.sender:
        if 0x33a3cd4e5f7753796528ce7343e1f2b3c3af0c9d != msg.sender:
...
function sub_3c65c509(?) {
    ...
    while idx:
        ...
        if ext_call.return_data[0] * cd[132] / sub_524f2ce5 > idx:
            mem[mem[64] + 68] = idx
            require ext_code.size(address(('cd', 100)[0]))
            ...
            idx = 0
            continue 
        mem[mem[64] + 68] = ext_call.return_data[0] * cd[132] / sub_524f2ce5
        require ext_code.size(address(('cd', 100)[0]))
        call address(('cd', 100)[0]).0x23b872dd with:
             gas gas_remaining wei
            args address(cd[36]), this.address, ext_call.return_data[0] * cd[132] / sub_524f2ce5
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _75 = mem[64]
        ...
        if idx < ext_call.return_data[0] * cd[132] / sub_524f2ce5:
            revert with 0, 17
        idx = idx - (ext_call.return_data[0] * cd[132] / sub_524f2ce5)
        continue 
    if 0 >= ('cd', 100).length:
        revert with 0, 50
    require ('cd', 100)[0] == address(('cd', 100)[0])
    ...
    mem[64] = mem[64] + 64
    mem[_71] = _68
    mem[_71 + 32] = ext_call.return_data[0] * cd[132] / sub_524f2ce5
    if not _68:
