...
function tend() payable {
    ...
    if not emergencyExit:
        ...
        if ext_call.return_data[0] >= ext_call.return_data[0] / 10^12:
            ...
            if ext_call.return_data[0] > ext_call.return_data[0] / 10^12:
                revert with 0, 'SafeMath: subtraction overflow', 0
            if (ext_call.return_data[0] / 10^12) - ext_call.return_data[0] >= stor17:
                require ext_code.size(gaugeAddress)
                staticcall gaugeAddress.userInfo(uint256 arg1, address arg2) with:
                        gas gas_remaining wei
                       args uint16(stor16.field_0), this.address
                ...
                if ext_call.return_data[0]:
                    ...
                    call gaugeAddress.withdraw(uint256 arg1, uint256 arg2) with:
                         gas gas_remaining wei
                        args uint16(stor16.field_0), (ext_call.return_data[0] / 10^12) - ext_call.return_data[0] / ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require ext_code.size(poolAddress)
                    staticcall poolAddress.balanceOf(address arg1) with:
                    ...
                    call sub_e956dcd7Address.0xc4de93a5 with:
                         gas gas_remaining wei
                        args uint16(stor16.field_0), (ext_call.return_data[0] / 10^12) - ext_call.return_data[0] / ext_call.return_data[0], this.address
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
}
...
function withdraw(uint256 arg1) payable {
    ...
    if arg1 <= 2 * ext_call.return_data[0]:
        if not arg1:
            ...
            if not ext_code.hash(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(4 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), msg.sender, arg1, 0
            ...
            if arg1 < stor17:
                ...
                if not ext_call.return_data[0]:
                    ...
                    mem[(7 * ceil32(return_data.size)) + 164] = arg1
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(7 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), msg.sender, arg1, 0
                    ...
                    mem[(11 * ceil32(return_data.size)) + 196] = arg1 / ext_call.return_data[0]
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[(12 * ceil32(return_data.size)) + 196] = msg.sender
                    mem[(12 * ceil32(return_data.size)) + 228] = arg1
                    mem[(12 * ceil32(return_data.size)) + 160] = 68
                    mem[(12 * ceil32(return_data.size)) + 196 len 28] = Mask(224, 32, msg.sender) >> 32
                    mem[(12 * ceil32(return_data.size)) + 192 len 4] = transfer(address arg1, uint256 arg2)
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(12 * ceil32(return_data.size)) + 324 len 96] = transfer(address arg1, uint256 arg2), msg.sender, arg1, 0
    ...
    if not arg1:
        ...
        if arg1 < stor17:
            ...
            if not ext_call.return_data[0]:
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(7 * ceil32(return_data.size)) + 324 len 96] = transfer(address arg1, uint256 arg2), msg.sender, arg1, 0
                ...
                mem[(11 * ceil32(return_data.size)) + 260] = arg1 / ext_call.return_data[0]
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[(12 * ceil32(return_data.size)) + 260] = msg.sender
                mem[(12 * ceil32(return_data.size)) + 292] = arg1
                mem[(12 * ceil32(return_data.size)) + 224] = 68
                mem[(12 * ceil32(return_data.size)) + 260 len 28] = Mask(224, 32, msg.sender) >> 32
                mem[(12 * ceil32(return_data.size)) + 256 len 4] = transfer(address arg1, uint256 arg2)
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(12 * ceil32(return_data.size)) + 388 len 96] = transfer(address arg1, uint256 arg2), msg.sender, arg1, 0
