...
function sub_d6bc8480(?) {
    ...
    call address(_64).0x23b872dd with:
         gas gas_remaining wei
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[64] = floor32(('cd', 36).length) + floor32(('cd', 68).length) + floor32(('cd', 132).length) + ceil32(return_data.size) + 99
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    if 0 >= ('cd', 132).length:
        revert with 'NH{q', 50
    _70 = mem[floor32(('cd', 36).length) + floor32(('cd', 68).length) + 130]
    if 0 >= ('cd', 68).length:
        revert with 'NH{q', 50
    _72 = mem[floor32(('cd', 36).length) + 129]
    if block.timestamp > -121:
        revert with 'NH{q', 17
    mem[floor32(('cd', 36).length) + floor32(('cd', 68).length) + floor32(('cd', 132).length) + ceil32(return_data.size) + 99] = 0x38ed173900000000000000000000000000000000000000000000000000000000
    mem[floor32(('cd', 36).length) + floor32(('cd', 68).length) + floor32(('cd', 132).length) + ceil32(return_data.size) + 103] = _72
    mem[floor32(('cd', 36).length) + floor32(('cd', 68).length) + floor32(('cd', 132).length) + ceil32(return_data.size) + 135] = 0
    mem[floor32(('cd', 36).length) + floor32(('cd', 68).length) + floor32(('cd', 132).length) + ceil32(return_data.size) + 167] = 160
    mem[floor32(('cd', 36).length) + floor32(('cd', 68).length) + floor32(('cd', 132).length) + ceil32(return_data.size) + 263] = ('cd', 36).length
    idx = 0
    s = 128
    t = mem[64] + 196
    while idx < ('cd', 36).length:
        ...
        t = t + 32
        continue 
    mem[floor32(('cd', 36).length) + floor32(('cd', 68).length) + floor32(('cd', 132).length) + ceil32(return_data.size) + 199] = this.address
    mem[floor32(('cd', 36).length) + floor32(('cd', 68).length) + floor32(('cd', 132).length) + ceil32(return_data.size) + 231] = block.timestamp + 120
    require ext_code.size(address(_70))
    call address(_70).mem[mem[64] len 4] with:
         gas gas_remaining wei
        args mem[mem[64] + 4 len floor32(('cd', 36).length) + floor32(('cd', 68).length) + floor32(('cd', 132).length) + ceil32(return_data.size) + (32 * ('cd', 36).length) + -mem[64] + 291]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _84 = mem[64]
    ...
    if mem[_84 + mem[_84]] > test266151307():
        revert with 'NH{q', 65
    if _84 + ceil32(return_data.size) + floor32(mem[_84 + mem[_84]]) + 1 > test266151307() or floor32(mem[_84 + mem[_84]]) + 1 < 0:
        revert with 'NH{q', 65
    mem[64] = _84 + ceil32(return_data.size) + floor32(mem[_84 + mem[_84]]) + 1
