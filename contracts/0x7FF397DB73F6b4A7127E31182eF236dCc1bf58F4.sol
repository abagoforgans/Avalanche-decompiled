...
function harvest(address arg1, uint256 arg2) {
...
function sub_1642c5de(?) {
    ...
    if arg3 > 0:
        ...
        if ext_call.return_data[0] > arg3:
            revert with 0, 'expired'
    call address(arg1).harvestWithCallFeeRecipient(address arg1) with:
         gas gas_remaining wei
        args address(arg2)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_ca6750a4(?) {
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    if eth.balance(msg.sender) > -ext_call.return_data[0] - 1:
        revert with 'NH{q', 17
    if eth.balance(this.address) + ext_call.return_data[0] > -eth.balance(msg.sender) + -ext_call.return_data[0] - 1:
        revert with 'NH{q', 17
    require ext_code.size(address(arg1))
