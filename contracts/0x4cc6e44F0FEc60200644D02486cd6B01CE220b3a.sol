...
function sub_5f5d217d(?) payable {
    ...
    while idx < tranches.length:
        ...
        if sub_70907ef0[address(msg.sender)][idx].field_0 < cycle:
            if sub_70907ef0[address(msg.sender)][idx].field_256:
                ...
                _135 = mem[64]
                mem[64] = mem[64] + 256
                mem[_135] = sub_ae4f9c74[stor13[address(msg.sender)][idx].field_0][idx].field_0
                mem[_135 + 32] = sub_ae4f9c74[stor13[address(msg.sender)][idx].field_0][idx].field_256
                mem[_135 + 64] = sub_ae4f9c74[stor13[address(msg.sender)][idx].field_0][idx].field_512
                mem[_135 + 96] = sub_ae4f9c74[stor13[address(msg.sender)][idx].field_0][idx].field_768
                mem[_135 + 128] = sub_ae4f9c74[stor13[address(msg.sender)][idx].field_0][idx].field_1024
                mem[_135 + 160] = sub_ae4f9c74[stor13[address(msg.sender)][idx].field_0][idx].field_1280
                mem[_135 + 192] = sub_ae4f9c74[stor13[address(msg.sender)][idx].field_0][idx].field_1536
                mem[_135 + 224] = sub_ae4f9c74[stor13[address(msg.sender)][idx].field_0][idx].field_1792
                if not sub_70907ef0[address(msg.sender)][idx].field_256:
                    if userInfo[address(msg.sender)] < userInfo[address(msg.sender)]:
                        revert with 0, 'SafeMath: addition overflow'
                    sub_70907ef0[address(msg.sender)][idx].field_256 = 0
    ...
    mem[mem[64] + 32] = arg1
    mem[mem[64] + 64] = cycle
    mem[mem[64] + 96] = sub_70907ef0[msg.sender][arg1].field_256
    emit Redeem(msg.sender, arg1, cycle, sub_70907ef0[msg.sender][arg1].field_256);
    mem[0] = msg.sender
    mem[32] = 12
    if sub_70907ef0[msg.sender][arg1].field_256 > userInfo[msg.sender]:
        revert with 0, 'SafeMath: subtraction overflow'
    userInfo[msg.sender] -= sub_70907ef0[msg.sender][arg1].field_256
    _161 = mem[64]
    mem[mem[64] + 36] = msg.sender
    mem[mem[64] + 68] = sub_70907ef0[msg.sender][arg1].field_256
    _164 = mem[64]
    mem[mem[64]] = 68
    mem[mem[64] + 32 len 4] = unknown_0xa9059cbb(?????)
    mem[64] = mem[64] + 164
    mem[_161 + 100] = 32
    mem[_161 + 132] = 'SafeERC20: low-level call failed'
    if eth.balance(this.address) < 0:
        revert with 0, 'Address: insufficient balance for call'
    if not ext_code.size(currencyAddress):
        revert with 0, 'Address: call to non-contract'
    _171 = mem[_164]
    mem[_161 + 164 len ceil32(mem[_164])] = mem[_164 + 32 len ceil32(mem[_164])]
    if ceil32(_171) > _171:
        mem[_171 + _161 + 164] = 0
    call currencyAddress with:
         gas gas_remaining wei
        args mem[_161 + 168 len _171 - 4]
    if not return_data.size:
        if not ext_call.success:
            if mem[96]:
                revert with memory
        ...
        mem[_161 + 196 len return_data.size] = ext_call.return_data[0 len return_data.size]
        if not ext_call.success:
            if return_data.size:
                revert with ext_call.return_data[0 len return_data.size]
            revert with 0, 'SafeERC20: low-level call failed'
        if return_data.size:
            require return_data.size >= 32
            require mem[_161 + 196] == bool(mem[_161 + 196])
            if not mem[_161 + 196]:
                revert with 0, 'SafeERC20: ERC20 operation did not succeed'
    emit Withdraw(msg.sender, sub_70907ef0[msg.sender][arg1].field_256);
    stor1 = 1
}
