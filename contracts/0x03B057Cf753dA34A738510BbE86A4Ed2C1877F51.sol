...
function uniswapV2Call(address arg1, uint256 arg2, uint256 arg3, bytes arg4) payable {
    ...
    if not arg2:
        ...
        while idx < stor4.length:
            ...
            if idx != 1:
                require ext_code.size(stor4[idx].field_0)
                staticcall stor4[idx].field_0.token0() with:
                        gas gas_remaining wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                else:
                    ...
                    mem[0] = 7
                    if stor5[idx] == address(ext_call.return_data[0]):
                        if idx < stor4.length - 1:
                            ...
                            mem[_127 + 36] = 0
                            mem[_127 + 68] = stor7[idx]
                            mem[_127 + 100] = stor4[idx].field_256
                            mem[_127 + 132] = 128
                            ...
                            if not mem[_127] % 32:
                                require ext_code.size(stor4[idx].field_0)
                                call stor4[idx].field_0.mem[mem[64] len 4] with:
                                     gas gas_remaining wei
                            ...
                            if not mem[_116] % 32:
                                ...
                                call stor4[idx].field_0.mem[mem[64] len 4] with:
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4 len mem[_116] + _116 + -mem[64] + 192]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                else:
                                    idx = idx + 1
                                ...
                                call stor4[idx].field_0.mem[mem[64] len 4] with:
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4 len floor32(mem[_116]) + _116 + -mem[64] + 224]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                else:
                                    idx = idx + 1
                        ...
                        if idx < stor4.length - 1:
                            ...
                            mem[_129 + 36] = stor7[idx]
                            mem[_129 + 68] = 0
                            mem[_129 + 100] = stor4[idx].field_256
                            mem[_129 + 132] = 128
                            ...
                            if not mem[_129] % 32:
                                require ext_code.size(stor4[idx].field_0)
                                call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                     gas gas_remaining wei
                                    args stor7[idx], 0, stor4[idx].field_256, 128, mem[_129 + 164 len mem[_129] + 32]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                else:
                                    idx = idx + 1
                                ...
                                call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                     gas gas_remaining wei
                                    args stor7[idx], 0, stor4[idx].field_256, 128, mem[_129], mem[_129 + 196 len floor32(mem[_129]) + 32]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                else:
                                    idx = idx + 1
                ...
                call stor5[idx].0xa9059cbb with:
                     gas gas_remaining wei
                    args stor4[idx].field_0, stor7
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                else:
                    require return_data.size >= 32
                    ...
                    if not ext_call.success:
                        ...
                        if stor5[idx] == address(ext_call.return_data[0]):
                            if idx < stor4.length - 1:
                                ...
                                mem[_179 + 36] = 0
                                mem[_179 + 68] = stor7[idx]
                                mem[_179 + 100] = stor4[idx].field_256
                                mem[_179 + 132] = 128
                                ...
                                if not mem[_179] % 32:
                                    ...
                                    call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                         gas gas_remaining wei
                                        args 0, stor7[idx], stor4[idx].field_256, 128, mem[_179 + 164 len mem[_179] + 32]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    else:
                                        idx = idx + 1
                                    ...
                                    call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                         gas gas_remaining wei
                                        args 0, stor7[idx], stor4[idx].field_256, 128, mem[_179], mem[_179 + 196 len floor32(mem[_179]) + 32]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    else:
                                        idx = idx + 1
                                ...
                                if not mem[_166] % 32:
                                    ...
                                    call stor4[idx].field_0.mem[mem[64] len 4] with:
                                         gas gas_remaining wei
                                        args mem[mem[64] + 4 len mem[_166] + _166 + -mem[64] + 192]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    else:
                                        idx = idx + 1
                                    ...
                                    call stor4[idx].field_0.mem[mem[64] len 4] with:
                                         gas gas_remaining wei
                                        args mem[mem[64] + 4 len floor32(mem[_166]) + _166 + -mem[64] + 224]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    else:
                                        idx = idx + 1
                            ...
                            if idx < stor4.length - 1:
                                ...
                                mem[_181 + 36] = stor7[idx]
                                mem[_181 + 68] = 0
                                mem[_181 + 100] = stor4[idx].field_256
                                mem[_181 + 132] = 128
                                ...
                                if not mem[_181] % 32:
                                    ...
                                    call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                         gas gas_remaining wei
                                        args stor7[idx], 0, stor4[idx].field_256, 128, mem[_181 + 164 len mem[_181] + 32]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    else:
                                        idx = idx + 1
                                    ...
                                    call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                         gas gas_remaining wei
                                        args stor7[idx], 0, stor4[idx].field_256, 128, mem[_181], mem[_181 + 196 len floor32(mem[_181]) + 32]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    else:
                                        idx = idx + 1
                                ...
                                if not mem[_169] % 32:
                                    ...
                                    call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                         gas gas_remaining wei
                                        args stor7[idx], 0, address(msg.sender), 128, mem[_169 + 164 len mem[_169] + 32]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    else:
                                        idx = idx + 1
                                    ...
                                    call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                         gas gas_remaining wei
                                        args stor7[idx], 0, address(msg.sender), 128, mem[_169], mem[_169 + 196 len floor32(mem[_169]) + 32]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    else:
                                        idx = idx + 1
                ...
                if stor5[idx] == address(ext_call.return_data[0]):
                    if idx >= stor4.length - 1:
                        ...
                        if not mem[_122] % 32:
                            ...
                            call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                 gas gas_remaining wei
                                args 0, stor7[idx], address(msg.sender), 128, mem[_122 + 164 len mem[_122] + 32]
                        else:
                            mem[floor32(mem[_122]) + _122 + 196] = mem[floor32(mem[_122]) + _122 + -(mem[_122] % 32) + 228 len mem[_122] % 32]
                            require ext_code.size(stor4[idx].field_0)
                            call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                 gas gas_remaining wei
                                args 0, stor7[idx], address(msg.sender), 128, mem[_122], mem[_122 + 196 len floor32(mem[_122]) + 32]
                    else:
                        require idx + 1 < stor4.length
                        mem[0] = 4
                        _131 = mem[64]
                        ...
                        mem[_131 + 36] = 0
                        mem[_131 + 68] = stor7[idx]
                        mem[_131 + 100] = stor4[idx].field_256
                        mem[_131 + 132] = 128
                        ...
                        if not mem[_131] % 32:
                            ...
                            call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                 gas gas_remaining wei
                                args 0, stor7[idx], stor4[idx].field_256, 128, mem[_131 + 164 len mem[_131] + 32]
                        else:
                            mem[floor32(mem[_131]) + _131 + 196] = mem[floor32(mem[_131]) + _131 + -(mem[_131] % 32) + 228 len mem[_131] % 32]
                            require ext_code.size(stor4[idx].field_0)
                            call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                 gas gas_remaining wei
                                args 0, stor7[idx], stor4[idx].field_256, 128, mem[_131], mem[_131 + 196 len floor32(mem[_131]) + 32]
                else:
                    if idx >= stor4.length - 1:
                        _125 = mem[64]
                        mem[mem[64]] = 0
                        ...
                        if not mem[_125] % 32:
                            ...
                            call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                 gas gas_remaining wei
                                args stor7[idx], 0, address(msg.sender), 128, mem[_125 + 164 len mem[_125] + 32]
                        else:
                            mem[floor32(mem[_125]) + _125 + 196] = mem[floor32(mem[_125]) + _125 + -(mem[_125] % 32) + 228 len mem[_125] % 32]
                            require ext_code.size(stor4[idx].field_0)
                            call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                 gas gas_remaining wei
                                args stor7[idx], 0, address(msg.sender), 128, mem[_125], mem[_125 + 196 len floor32(mem[_125]) + 32]
                    else:
                        require idx + 1 < stor4.length
                        mem[0] = 4
                        _133 = mem[64]
                        ...
                        mem[_133 + 36] = stor7[idx]
                        mem[_133 + 68] = 0
                        mem[_133 + 100] = stor4[idx].field_256
                        mem[_133 + 132] = 128
                        ...
                        if not mem[_133] % 32:
                            ...
                            call stor4[idx].field_0.mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len mem[_133] + _133 + -mem[64] + 192]
                        else:
                            mem[floor32(mem[_133]) + _133 + 196] = mem[floor32(mem[_133]) + _133 + -(mem[_133] % 32) + 228 len mem[_133] % 32]
                            require ext_code.size(stor4[idx].field_0)
                            call stor4[idx].field_0.mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len floor32(mem[_133]) + _133 + -mem[64] + 224]
            else:
                require 1 < stor7.length
                mem[mem[64] + 4] = stor4[idx].field_0
                mem[mem[64] + 36] = stor7
                ...
                if stor5[idx] == address(ext_call.return_data[0]):
                    if idx >= stor4.length - 1:
                        ...
                        if not mem[_174] % 32:
                            ...
                            call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                 gas gas_remaining wei
                                args 0, stor7[idx], address(msg.sender), 128, mem[_174 + 164 len mem[_174] + 32]
                        else:
                            mem[floor32(mem[_174]) + _174 + 196] = mem[floor32(mem[_174]) + _174 + -(mem[_174] % 32) + 228 len mem[_174] % 32]
                            require ext_code.size(stor4[idx].field_0)
                            call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                 gas gas_remaining wei
                                args 0, stor7[idx], address(msg.sender), 128, mem[_174], mem[_174 + 196 len floor32(mem[_174]) + 32]
                    else:
                        require idx + 1 < stor4.length
                        mem[0] = 4
                        _183 = mem[64]
                        ...
                        mem[_183 + 36] = 0
                        mem[_183 + 68] = stor7[idx]
                        mem[_183 + 100] = stor4[idx].field_256
                        mem[_183 + 132] = 128
                        ...
                        if not mem[_183] % 32:
                            ...
                            call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                 gas gas_remaining wei
                                args 0, stor7[idx], stor4[idx].field_256, 128, mem[_183 + 164 len mem[_183] + 32]
                        else:
                            mem[floor32(mem[_183]) + _183 + 196] = mem[floor32(mem[_183]) + _183 + -(mem[_183] % 32) + 228 len mem[_183] % 32]
                            require ext_code.size(stor4[idx].field_0)
                            call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                 gas gas_remaining wei
                                args 0, stor7[idx], stor4[idx].field_256, 128, mem[_183], mem[_183 + 196 len floor32(mem[_183]) + 32]
                else:
                    if idx >= stor4.length - 1:
                        _177 = mem[64]
                        mem[mem[64]] = 0
                        ...
                        if not mem[_177] % 32:
                            ...
                            call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                 gas gas_remaining wei
                                args stor7[idx], 0, address(msg.sender), 128, mem[_177 + 164 len mem[_177] + 32]
                        else:
                            mem[floor32(mem[_177]) + _177 + 196] = mem[floor32(mem[_177]) + _177 + -(mem[_177] % 32) + 228 len mem[_177] % 32]
                            require ext_code.size(stor4[idx].field_0)
                            call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                 gas gas_remaining wei
                                args stor7[idx], 0, address(msg.sender), 128, mem[_177], mem[_177 + 196 len floor32(mem[_177]) + 32]
                    else:
                        require idx + 1 < stor4.length
                        mem[0] = 4
                        _185 = mem[64]
                        ...
                        mem[_185 + 36] = stor7[idx]
                        mem[_185 + 68] = 0
                        mem[_185 + 100] = stor4[idx].field_256
                        mem[_185 + 132] = 128
                        ...
                        if not mem[_185] % 32:
                            ...
                            call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                 gas gas_remaining wei
                                args stor7[idx], 0, stor4[idx].field_256, 128, mem[_185 + 164 len mem[_185] + 32]
                        else:
                            mem[floor32(mem[_185]) + _185 + 196] = mem[floor32(mem[_185]) + _185 + -(mem[_185] % 32) + 228 len mem[_185] % 32]
                            require ext_code.size(stor4[idx].field_0)
                            call stor4[idx].field_0.swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                                 gas gas_remaining wei
                                args stor7[idx], 0, stor4[idx].field_256, 128, mem[_185], mem[_185 + 196 len floor32(mem[_185]) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            idx = idx + 1
            s = stor7[idx]
