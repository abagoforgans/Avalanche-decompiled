...
uint256 sub_8858ee14;
big736 stor8;
uint256 stor9; offset 32
uint256 sub_aca6b219;
...
function sub_86552f22(?) payable {
    return sub_86552f22Address
}

function sub_8858ee14(?) payable {
    return sub_8858ee14
}
...
function sub_e14063aa(?) payable {
    ...
    require ext_code.size(sub_86552f22Address)
    staticcall sub_86552f22Address.0x70a08231 with:
    ...
    require ext_code.size(sub_86552f22Address)
    call sub_86552f22Address.0x42966c68 with:
         gas gas_remaining wei
...
function sub_8d4264a5(?) payable {
    ...
    if not return_data.size:
        if not ext_call.success:
            revert with unknown_0x23b872dd(?????), msg.sender, address(sub_bffe0ed3Address), sub_8858ee14
        if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
            revert with 0, 
                        ...
                        0,
                        mem[420 len 4]
        if not ext_code.size(sub_86552f22Address):
            revert with 0, 'Address: call to non-contract'
        mem[456 len 64] = 0, msg.sender, stor9
        call sub_86552f22Address with:
           funct uint32(msg.sender)
             gas gas_remaining wei
            args sub_aca6b219, mem[392 len 24], 0, mem[520 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with unknown_0x23b872dd(?????), msg.sender, address(sub_bffe0ed3Address), sub_8858ee14
            if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
        ...
        if not ext_code.size(sub_86552f22Address):
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 457 len 64] = 0, msg.sender, stor9
        call sub_86552f22Address with:
           funct uint32(msg.sender)
             gas gas_remaining wei
            args sub_aca6b219, mem[ceil32(return_data.size) + 393 len 28], mem[ceil32(return_data.size) + 521 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with unknown_0x23b872dd(?????), msg.sender, address(sub_bffe0ed3Address), sub_8858ee14
            if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
...
function sub_56c8d809(?) payable {
    ...
    if block.timestamp >= endOfSale:
        revert with 0, 'Sale over'
    stor10[msg.sender] = 1
    if not ext_code.size(sub_439d7319Address):
        revert with 0, 'Address: call to non-contract'
