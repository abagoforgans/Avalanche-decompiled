...
function unstakeAndSellSnowBank() payable {
    ...
    require return_data.size >= 32
    require ext_code.size(0xe9eb40d52ce4744322204d4a29af63c30f0260a4)
    staticcall 0xe9eb40d52ce4744322204d4a29af63c30f0260a4.balanceOf(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function buyAndStakeSnowBank() payable {
    ...
    mem[64] = ceil32(return_data.size) + 192
    require return_data.size >= 32
    _60 = mem[192 len 4], ext_call.return_data[0 len 28]
    ...
    require 1 < mem[ceil32(return_data.size) + 192]
    mem[(32 * _63) + ceil32(return_data.size) + 288] = 0x7d1232b90d3f809a54eeaeebc639c62df8a8942f
    mem[(32 * _63) + ceil32(return_data.size) + 320] = 0x38ed173900000000000000000000000000000000000000000000000000000000
    mem[(32 * _63) + ceil32(return_data.size) + 324] = ext_call.return_data[0]
    mem[(32 * _63) + ceil32(return_data.size) + 356] = 100 * mem[ceil32(return_data.size) + 256] / 105
    mem[(32 * _63) + ceil32(return_data.size) + 420] = this.address
    mem[(32 * _63) + ceil32(return_data.size) + 452] = block.timestamp
    ...
    call 0x60ae616a2155ee3d9a68541ba4544862310933d4.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args ext_call.return_data[0], 100 * mem[ceil32(return_data.size) + 256] / 105, Array(len=2, data=mem[(32 * _63) + ceil32(return_data.size) + 516 len 64]), address(this.address), block.timestamp
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    _137 = mem[(32 * _63) + ceil32(return_data.size) + 320 len 4], ext_call.return_data[0 len 28]
    require mem[(32 * _63) + ceil32(return_data.size) + 320 len 4], ext_call.return_data[0 len 28] <= 4294967296
    require mem[(32 * _63) + ceil32(return_data.size) + 320 len 4], ext_call.return_data[0 len 28] + 32 <= return_data.size
    require mem[mem[(32 * _63) + ceil32(return_data.size) + 320 len 4], ext_call.return_data[0 len 28] + (32 * _63) + ceil32(return_data.size) + 320] <= 4294967296 and mem[(32 * _63) + ceil32(return_data.size) + 320 len 4], ext_call.return_data[0 len 28] + (32 * mem[mem[(32 * _63) + ceil32(return_data.size) + 320 len 4], ext_call.return_data[0 len 28] + (32 * _63) + ceil32(return_data.size) + 320]) + 32 <= return_data.size
    mem[(32 * _63) + (2 * ceil32(return_data.size)) + 320] = mem[mem[(32 * _63) + ceil32(return_data.size) + 320 len 4], ext_call.return_data[0 len 28] + (32 * _63) + ceil32(return_data.size) + 320]
    mem[(32 * _63) + (2 * ceil32(return_data.size)) + 352 len floor32(mem[_137 + (32 * _63) + ceil32(return_data.size) + 320])] = mem[_137 + (32 * _63) + ceil32(return_data.size) + 352 len floor32(mem[_137 + (32 * _63) + ceil32(return_data.size) + 320])]
    require 1 < mem[(32 * _63) + (2 * ceil32(return_data.size)) + 320]
    ...
    call 0x85784d5e2ccae89bcb39ebf0ac6cdc93d42d99ad.stake(uint256 arg1, address arg2) with:
         gas gas_remaining wei
        args mem[(32 * _63) + (2 * ceil32(return_data.size)) + 384], this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
}
