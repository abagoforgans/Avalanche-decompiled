...
#
const name = 'Red Nose Pitty'

const decimals = 9

const symbol = 'REDNOSE'
...
function setDistributionCriteria(uint256 arg1, uint256 arg2) {
    ...
    if not stor1[address(msg.sender)]:
        revert with 0, '!AUTHORIZED'
    require ext_code.size(address(stor27.field_8))
    call address(stor27.field_8).0x2d48e896 with:
...
function setFees(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4) {
    ...
    uint256(stor19.field_0) = arg4
    require totalFee < Mask(254, 0, stor19.field_2)
}
...
function setIsDividendExempt(address arg1, bool arg2) {
    ...
    require ext_code.size(address(stor27.field_8))
    if not arg2:
        call address(stor27.field_8).setShare(address arg1, uint256 arg2) with:
             gas gas_remaining wei
