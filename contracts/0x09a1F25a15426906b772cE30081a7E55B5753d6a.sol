...
function sub_553500b4(?) {
    ...
    if ('cd', 36).length != ('cd', 4).length:
        revert with 0, 'wrong'
    if sub_cd86f262Address:
        idx = 0
        while idx < ('cd', 36).length:
            require idx < ('cd', 4).length
            _166 = mem[(32 * idx) + 128]
            require idx < ('cd', 36).length
            _171 = mem[(32 * idx) + (32 * ('cd', 4).length) + 160]
            if stor0 != msg.sender:
                revert with 0, 'No authority'
            mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 160] = 0x8d7d3eea00000000000000000000000000000000000000000000000000000000
            mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 164] = address(_166)
            mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 196] = sub_cd86f262Address
            mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 228] = stor0
            mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 260] = _171
            mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 292] = 0
            mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 324] = 0
            mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 356] = 0
            mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 388] = 0
            mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 420] = 56
            require ext_code.size(stor1)
            call stor1.anySwapOutUnderlyingWithPermit(address arg1, address arg2, address arg3, uint256 arg4, uint256 arg5, uint8 arg6, bytes32 arg7, bytes32 arg8, uint256 arg9) with:
                 gas gas_remaining wei
                args address(_166), sub_cd86f262Address, stor0, _171, 0, 0, 0, 0, 56
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            idx = idx + 1
            continue 
        ...
        while idx < ('cd', 36).length:
            ...
            mem[floor32((32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 1273) + 100] = _173
            ...
            call stor1.anySwapOutUnderlyingWithPermit(address arg1, address arg2, address arg3, uint256 arg4, uint256 arg5, uint8 arg6, bytes32 arg7, bytes32 arg8, uint256 arg9) with:
                 gas gas_remaining wei
                args address(_168), sub_cd86f262Address, stor0, _173, 0, 0, 0, 0, 56
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            idx = idx + 1
            continue 
