...
function mintBatch(uint256 arg1) {
    ...
    mem[(4 * ceil32(return_data.size)) + 96] = 0x6352211e00000000000000000000000000000000000000000000000000000000
    mem[var158003] = _tokenIdTracker
    require ext_code.size(oldContractAddress)
    staticcall oldContractAddress.mem[var164003 len 4] with:
            gas gas_remaining wei
