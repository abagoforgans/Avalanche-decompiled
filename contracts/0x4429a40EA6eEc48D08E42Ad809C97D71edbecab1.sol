...
function setAddressAsProxy(bytes32 arg1, address arg2) payable {
    ...
    if lendingPool[arg1]:
        ...
        call lendingPool[arg1].upgradeToAndCall(address arg1, bytes arg2) with:
             gas gas_remaining wei
            args address(arg2), 64, 36, initialize(address arg1), this.address, 0, address(arg2) << 32, 0
...
function setLendingPoolImpl(address arg1) payable {
    ...
    if lendingPool[0x4c454e44494e475f504f4f4c0000000000000000000000000000000000000000]:
        ...
        call lendingPool[0x4c454e44494e475f504f4f4c0000000000000000000000000000000000000000].upgradeToAndCall(address arg1, bytes arg2) with:
             gas gas_remaining wei
...
function setLendingPoolConfiguratorImpl(address arg1) payable {
    ...
    if lendingPool[0x4c454e44494e475f504f4f4c5f434f4e464947555241544f5200000000000000]:
        ...
        call lendingPool[0x4c454e44494e475f504f4f4c5f434f4e464947555241544f5200000000000000].upgradeToAndCall(address arg1, bytes arg2) with:
             gas gas_remaining wei
            args address(arg1), 64, 36, initialize(address arg1), this.address, 0, address(arg1) << 32, 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
