...
function tokenURI(uint256 arg1) payable {
    ...
    if stor8[arg1].length > 0:
        if not bool(baseURI.length):
            ...
            return 32, mem[ceil32(stor8[arg1].length) + baseURI.length.field_1 % 128 + stor8[arg1].length + 192 len ceil32(mem[ceil32(stor8[arg1].length) + 128]) + 32], 
        if bool(baseURI.length) == 1:
            ...
            return 32, mem[ceil32(stor8[arg1].length) + uint255(baseURI.length.field_1) + stor8[arg1].length + 192 len ceil32(mem[ceil32(stor8[arg1].length) + 128]) + 32], 
