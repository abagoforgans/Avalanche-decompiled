...
function getData() payable {
    ...
    if not ext_call.return_data[18 len 14]:
        revert with 'NH{q', 18
    require ext_code.size(lpAddress)
    staticcall lpAddress.totalSupply() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if ext_call.return_data[0] and Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]) > -1 / ext_call.return_data[0]:
        revert with 'NH{q', 17
    if ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]) and 51840 > -1 / ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]):
        revert with 'NH{q', 17
    if 51840 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]) and 100 > -1 / 51840 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]):
        revert with 'NH{q', 17
    if 1440 * 24 * 3600 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]) and stor0 > -1 / 1440 * 24 * 3600 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]):
        revert with 'NH{q', 17
    if not 2 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0] * ext_call.return_data[0]:
        revert with 'NH{q', 18
    require ext_code.size(sub_2edab015Address)
    staticcall sub_2edab015Address.totalSupply() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    if ext_call.return_data[0] and 6 > -1 / ext_call.return_data[0]:
        revert with 'NH{q', 17
    require ext_code.size(sub_2edab015Address)
    staticcall sub_2edab015Address.0x70a08231 with:
            gas gas_remaining wei
    ...
    return ext_call.return_data[0], 
           ...
           6 * ext_call.return_data[0] / 10,
           1440 * 24 * 3600 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]) * stor0 / 2 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) * stor0 / Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0] * ext_call.return_data[0],
