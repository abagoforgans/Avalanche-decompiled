...
function cashoutAll() {
    ...
    if not cashoutFee:
        ...
        if rewardsPoolAddress != sub_f764bfb5Address:
            if stor221[stor209]:
                revert with 0, 'ERC20: Blacklisted address'
            if stor221[address(stor223.field_0)]:
                revert with 0, 'ERC20: Blacklisted address'
            if not rewardsPoolAddress:
                revert with 0, 'ERC20: transfer from the zero address'
            ...
            if balanceOf[stor209] < ext_call.return_data[0]:
                revert with 0, 'ERC20: transfer amount exceeds balance'
            balanceOf[stor209] -= ext_call.return_data[0]
            if balanceOf[address(stor223.field_16)] > !ext_call.return_data[0]:
                revert with 0, 17
            balanceOf[address(stor223.field_16)] += ext_call.return_data[0]
            emit Transfer(ext_call.return_data[0], rewardsPoolAddress, sub_f764bfb5Address);
    ...
    if not cashoutFee:
        ...
        if not sub_0db92449:
            if rewardsPoolAddress != sub_f764bfb5Address:
                ...
                emit Transfer((ext_call.return_data[0] * cashoutFee / 100), msg.sender, sub_f764bfb5Address);
        else:
            if not msg.sender:
                revert with 0, 'ERC20: transfer from the zero address'
            if not sub_82a8ebadAddress:
            ...
            emit Transfer((ext_call.return_data[0] * cashoutFee / 100), msg.sender, sub_82a8ebadAddress);
            require ext_code.size(sub_82a8ebadAddress)
            call sub_82a8ebadAddress.0x88e5249f with:
                 gas gas_remaining wei
