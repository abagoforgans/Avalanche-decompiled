...
function sub_47f8ac21(?) payable {
    require ext_code.size(treasuryAddress)
    staticcall treasuryAddress.0x47f8ac21 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function allocateSeigniorage(uint256 arg1) payable {
    ...
    if not arg1:
        ...
        if 10^18 * arg1 / arg1 != 10^18:
            revert with 0, 32, 33, 0x72536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
        if not totalSupply:
            revert with 0, 'SafeMath: division by zero'
...
function stake(uint256 arg1) payable {
    ...
    if not msg.sender:
        ...
        if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(shareAddress):
            revert with 0, 'Address: call to non-contract'
        if not ext_code.hash(shareAddress):
            revert with 0, 'Address: call to non-contract'
    ...
    if not msg.sender:
        ...
        if not msg.sender:
            if not lastSnapshotIndexOf[msg.sender].field_256:
                ...
                if not return_data.size:
                    ...
                    if not ext_code.hash(shareAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[552 len 64] = unknown_0xa9059cbb(?????), msg.sender, balanceOf[address(msg.sender)].field_32
                    call shareAddress with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                        args balanceOf[address(msg.sender)].field_0, mem[616 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with unknown_0xa9059cbb(?????), msg.sender, lastSnapshotIndexOf[msg.sender].field_256
                        if not unknown_0xa9059cbb(?????), Mask(224, 32, msg.sender) >> 32:
                            revert with 0, 32, 42, 0x705361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[662 len 22]
                    else:
                    ...
                    if not ext_code.hash(shareAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 553 len 64] = unknown_0xa9059cbb(?????), msg.sender, balanceOf[address(msg.sender)].field_32
                    mem[ceil32(return_data.size) + 645 len 4] = 0
                    call shareAddress with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                        args balanceOf[address(msg.sender)].field_0, mem[ceil32(return_data.size) + 617 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with unknown_0xa9059cbb(?????), msg.sender, lastSnapshotIndexOf[msg.sender].field_256
                        if not unknown_0xa9059cbb(?????), Mask(224, 32, msg.sender) >> 32:
                    ...
                    if not return_data.size:
                        ...
                        if balanceOf[msg.sender].field_0 < balanceOf[address(msg.sender)].field_0:
                            revert with 0, 
                                        ...
                                        52,
                                        0x304d61736f6e72793a20776974686472617720726571756573742067726561746572207468616e207374616b656420616d6f756e,
                                        mem[ceil32(return_data.size) + 1213 len 12]
                        if balanceOf[address(msg.sender)].field_0 > totalSupply:
                            revert with 0, 'SafeMath: subtraction overflow'
                        totalSupply -= balanceOf[address(msg.sender)].field_0
                        if balanceOf[address(msg.sender)].field_0 > balanceOf[msg.sender].field_0:
        ...
        if not balanceOf[address(msg.sender)].field_0:
            ...
            if withdrawLockupEpochs + lastSnapshotIndexOf[msg.sender].field_512 < lastSnapshotIndexOf[msg.sender].field_512:
                revert with 0, 'SafeMath: addition overflow'
            if withdrawLockupEpochs + lastSnapshotIndexOf[msg.sender].field_512 > ext_call.return_data[0]:
                revert with 0, 32, 33, 0x744d61736f6e72793a207374696c6c20696e207769746864726177206c6f636b75, mem[1029 len 31]
            if not msg.sender:
                if not lastSnapshotIndexOf[msg.sender].field_256:
                    if balanceOf[msg.sender].field_0 < balanceOf[address(msg.sender)].field_0:
                        revert with 0, 
                ...
                if not balanceOf[address(msg.sender)].field_0:
                        ...
                        if not return_data.size:
                            ...
                            if balanceOf[msg.sender].field_0 < balanceOf[address(msg.sender)].field_0:
                                revert with 0, 
                                            ...
                                            52,
                                            0x304d61736f6e72793a20776974686472617720726571756573742067726561746572207468616e207374616b656420616d6f756e,
                                            mem[ceil32(return_data.size) + 2045 len 12]
                            if balanceOf[address(msg.sender)].field_0 > totalSupply:
                                revert with 0, 'SafeMath: subtraction overflow'
                            totalSupply -= balanceOf[address(msg.sender)].field_0
                            if balanceOf[address(msg.sender)].field_0 > balanceOf[msg.sender].field_0:
                    ...
                    if (rewardPerShare[rewardPerShare.length].field_0 * balanceOf[address(msg.sender)].field_0) - (rewardPerShare[stor7[address(msg.sender)].field_0].field_512 * balanceOf[address(msg.sender)].field_0) / balanceOf[address(msg.sender)].field_0 != rewardPerShare[rewardPerShare.length].field_0 - rewardPerShare[stor7[address(msg.sender)].field_0].field_512:
                        revert with 0, 32, 33, 0x72536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[1733 len 31]
                    if lastSnapshotIndexOf[address(msg.sender)].field_256 + ((rewardPerShare[rewardPerShare.length].field_0 * balanceOf[address(msg.sender)].field_0) - (rewardPerShare[stor7[address(msg.sender)].field_0].field_512 * balanceOf[address(msg.sender)].field_0) / 10^18) < (rewardPerShare[rewardPerShare.length].field_0 * balanceOf[address(msg.sender)].field_0) - (rewardPerShare[stor7[address(msg.sender)].field_0].field_512 * balanceOf[address(msg.sender)].field_0) / 10^18:
                        revert with 0, 'SafeMath: addition overflow'
                    if 1 > rewardPerShare.length:
                        revert with 0, 'SafeMath: subtraction overflow'
        ...
        if not msg.sender:
            if not lastSnapshotIndexOf[msg.sender].field_256:
                ...
                if not return_data.size:
                    ...
                    if not ext_code.hash(shareAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[552 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, arg1) >> 32
                    call shareAddress with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                        args Mask(224, 32, arg1) << 224, mem[616 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with unknown_0xa9059cbb(?????), msg.sender, lastSnapshotIndexOf[msg.sender].field_256
                        if not unknown_0xa9059cbb(?????), Mask(224, 32, msg.sender) >> 32:
                    ...
                    if not ext_code.hash(shareAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 553 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, arg1) >> 32
                    mem[ceil32(return_data.size) + 645 len 4] = 0
                    call shareAddress with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
            ...
            if not balanceOf[address(msg.sender)].field_0:
                ...
                if not lastSnapshotIndexOf[msg.sender].field_256:
                    ...
                    if not ext_code.hash(shareAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[1220 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, arg1) >> 32
                    call shareAddress with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                        args Mask(224, 32, arg1) << 224, mem[1284 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with 0, 'SafeERC20: low-level call failed'
                    else:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.hash(shareAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[1384 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, arg1) >> 32
                        call shareAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args Mask(224, 32, arg1) << 224, mem[1448 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0, 'SafeERC20: low-level call failed'
                        else:
                        ...
                        if not ext_code.hash(shareAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 1385 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, arg1) >> 32
                        mem[ceil32(return_data.size) + 1477 len 4] = 0
                        call shareAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args Mask(224, 32, arg1) << 224, mem[ceil32(return_data.size) + 1449 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0, 'SafeERC20: low-level call failed'
                            emit Withdrawn(arg1, msg.sender);
            ...
            if not msg.sender:
                ...
                if not balanceOf[address(msg.sender)].field_0:
                    ...
                    if not lastSnapshotIndexOf[msg.sender].field_256:
                        ...
                        if not ext_code.hash(shareAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[2052 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, arg1) >> 32
                        call shareAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args Mask(224, 32, arg1) << 224, mem[2116 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0, 'SafeERC20: low-level call failed'
                        else:
                        ...
                        if not return_data.size:
                            ...
                            if not ext_code.hash(shareAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[2216 len 64] = 0, msg.sender, Mask(224, 32, arg1) >> 32
                            call shareAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args arg1, mem[2152 len 28], mem[2280 len 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, 'SafeERC20: low-level call failed'
                            else:
                            ...
                            if not return_data.size:
                                ...
                                if not ext_code.hash(shareAddress):
                                    revert with 0, 'Address: call to non-contract'
                                mem[ceil32(return_data.size) + 2217 len 64] = 0, msg.sender, Mask(224, 32, arg1) >> 32
                                call shareAddress with:
                                   funct uint32(msg.sender)
                                     gas gas_remaining wei
                                    args arg1, mem[ceil32(return_data.size) + 2153 len 28], mem[ceil32(return_data.size) + 2281 len 4]
                                if not return_data.size:
                                    if not ext_call.success:
                                        revert with 0, 'SafeERC20: low-level call failed'
                                else:
                    ...
                    if not lastSnapshotIndexOf[msg.sender].field_256:
                        ...
                        if not return_data.size:
                            ...
                            if not ext_code.hash(shareAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[2216 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, arg1) >> 32
                            call shareAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(224, 32, arg1) << 224, mem[2280 len 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, 'SafeERC20: low-level call failed'
                            else:
                            ...
                            if not ext_code.hash(shareAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 2217 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, arg1) >> 32
                            mem[ceil32(return_data.size) + 2309 len 4] = 0
                            call shareAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(224, 32, arg1) << 224, mem[ceil32(return_data.size) + 2281 len 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, 'SafeERC20: low-level call failed'
                                emit Withdrawn(arg1, msg.sender);
