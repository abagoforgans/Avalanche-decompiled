...
const getName = 'StrategyAaveWavaxV3'
    ...
    if ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            call 0x4f01aed16d97e3ab5ab2b501154dc9bb0f1a5a2c.deposit(address rg1, uint256 rg2, address rg3, uint16 rg4) with:
                 gas gas_remaining wei
                args 0x77000000000000000000000000b31f66aa3c1e785363f0875a1b74e27b85fd66, ext_call.return_data[0], this.address, 170
        else:
            mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
                if return_data.size:
            ...
            if not return_data.size:
                ...
                call 0x4f01aed16d97e3ab5ab2b501154dc9bb0f1a5a2c.deposit(address rg1, uint256 rg2, address rg3, uint16 rg4) with:
                     gas gas_remaining wei
                    args 0x77000000000000000000000000b31f66aa3c1e785363f0875a1b74e27b85fd66, ext_call.return_data[0], this.address, 170, mem[(2 * ceil32(return_data.size)) + 558 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
}
