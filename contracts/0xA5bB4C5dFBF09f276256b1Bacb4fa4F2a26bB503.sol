                    ...
                    if not isAutoComp:
                        ...
                        if 0 <= ext_call.return_data[0]:
                            if wantLockedTotal >= 0:
                                ...
                                if ext_code.size(wantAddress) <= 0:
                                    revert with 0, 'Address: call to non-contract'
                                mem[516 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor10), uint32(stor10), Mask(224, 0, stor14.field_32)
                                call wantAddress with:
                                   funct uint32(stor10)
                                     gas gas_remaining wei
                    ...
                    if not isAutoComp:
                        ...
                        if arg2 * withdrawFeeFactor / 10000 > ext_call.return_data[0]:
                            ...
                            if wantLockedTotal >= arg2 * withdrawFeeFactor / 10000:
                                ...
                                if ext_code.size(wantAddress) <= 0:
                                    revert with 0, 'Address: call to non-contract'
                                mem[516 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, arg2 * withdrawFeeFactor / 10000) >> 32
                                call wantAddress with:
                                   funct uint32(stor10)
                                     gas gas_remaining wei
