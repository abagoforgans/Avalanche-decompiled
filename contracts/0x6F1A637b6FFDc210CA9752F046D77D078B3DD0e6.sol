...
function sub_f5390162(?) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(0x5114f275f53149bbfc271575263689b516f70826)
    call 0x5114f275f53149bbfc271575263689b516f70826.0x23b872dd with:
...
function sub_339bdbe9(?) payable {
    ...
    if block.timestamp >= stor8[address(msg.sender)] + (720 * 24 * 3600):
        call 0x5114f275f53149bbfc271575263689b516f70826.0xa9059cbb with:
             gas gas_remaining wei
...
function sub_258bc95e(?) payable {
    require ext_code.size(0x5114f275f53149bbfc271575263689b516f70826)
    staticcall 0x5114f275f53149bbfc271575263689b516f70826.0x70a08231 with:
            gas gas_remaining wei
           args msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
