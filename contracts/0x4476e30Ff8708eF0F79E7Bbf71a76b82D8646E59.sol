    ...
    if not ext_call.return_data[0]:
        ...
        if ext_call.return_data[0]:
            ...
            if ext_call.return_data[0]:
                ...
                call joeV2RouterAddress.swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args ext_call.return_data[0] * treasuryRate / 100, 0, 160, address(this.address), block.timestamp, mem[(6 * ceil32(return_data.size)) + 996 len (32 * mem[(4 * ceil32(return_data.size)) + 736]) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                mem[(6 * ceil32(return_data.size)) + 832] = 30
                mem[(6 * ceil32(return_data.size)) + 864] = 'SafeMath: subtraction overflow'
                if eth.balance(this.address) > eth.balance(this.address):
                    mem[(6 * ceil32(return_data.size)) + 994] = 0
                    revert with 0, 'SafeMath: subtraction overflow', mem[(6 * ceil32(return_data.size)) + 994 len (9 * ceil32(return_data.size)) + 2]
                if eth.balance(this.address) < eth.balance(this.address):
                    revert with 0, 17
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                mem[(6 * ceil32(return_data.size)) + 896] = 26
                mem[(6 * ceil32(return_data.size)) + 928] = 'SafeMath: division by zero'
                mem[(6 * ceil32(return_data.size)) + 960] = 30
                mem[(6 * ceil32(return_data.size)) + 992] = 'SafeMath: subtraction overflow'
                if ext_call.return_data[0] - (ext_call.return_data[0] * teamRate / 100) - (ext_call.return_data[0] * treasuryRate / 100) / 2 > ext_call.return_data[0] - (ext_call.return_data[0] * teamRate / 100) - (ext_call.return_data[0] * treasuryRate / 100):
                    mem[(6 * ceil32(return_data.size)) + 1122] = 0
                    revert with 0, 'SafeMath: subtraction overflow', mem[(6 * ceil32(return_data.size)) + 1122 len (9 * ceil32(return_data.size)) + 2]
                if ext_call.return_data[0] - (ext_call.return_data[0] * teamRate / 100) - (ext_call.return_data[0] * treasuryRate / 100) < ext_call.return_data[0] - (ext_call.return_data[0] * teamRate / 100) - (ext_call.return_data[0] * treasuryRate / 100) / 2:
                    revert with 0, 17
                mem[(6 * ceil32(return_data.size)) + 1024] = 2
                mem[(6 * ceil32(return_data.size)) + 1056] = this.address
                require ext_code.size(joeV2RouterAddress)
                staticcall joeV2RouterAddress.WAVAX() with:
                        gas gas_remaining wei
                ...
                require return_data.size >= 32
                require ext_call.return_data[0] == ext_call.return_data[12 len 20]
                mem[(6 * ceil32(return_data.size)) + 1088] = ext_call.return_data[12 len 20]
                ...
                mem[(7 * ceil32(return_data.size)) + 1120] = 0x762b156200000000000000000000000000000000000000000000000000000000
                mem[(7 * ceil32(return_data.size)) + 1124] = ext_call.return_data[0] - (ext_call.return_data[0] * teamRate / 100) - (ext_call.return_data[0] * treasuryRate / 100) / 2
                mem[(7 * ceil32(return_data.size)) + 1156] = 0
                mem[(7 * ceil32(return_data.size)) + 1188] = 160
                mem[(7 * ceil32(return_data.size)) + 1284] = 2
                idx = 0
                s = (7 * ceil32(return_data.size)) + 1316
                t = (6 * ceil32(return_data.size)) + 1056
                while idx < mem[(6 * ceil32(return_data.size)) + 1024]:
                    mem[s] = mem[t + 12 len 20]
                    idx = idx + 1
                    s = s + 32
                    t = t + 32
                    continue 
                mem[(7 * ceil32(return_data.size)) + 1220] = this.address
                mem[(7 * ceil32(return_data.size)) + 1252] = block.timestamp
                require ext_code.size(joeV2RouterAddress)
                call joeV2RouterAddress.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len (7 * ceil32(return_data.size)) + (32 * mem[(6 * ceil32(return_data.size)) + 1024]) + -mem[64] + 1312]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if eth.balance(this.address) > eth.balance(this.address):
                    revert with 0, 'SafeMath: subtraction overflow', 0
                ...
                call joeV2RouterAddress.swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args Mask(255, 1, ext_call.return_data[0] - (ext_call.return_data[0] * teamRate / 100)), 0, 160, address(this.address), block.timestamp, mem[_1756 + ceil32(return_data.size) + 260 len (32 * mem[_1756]) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if eth.balance(this.address) > eth.balance(this.address):
                    revert with 0, 'SafeMath: subtraction overflow', 0
            ...
            if not ext_call.return_data[0]:
                ...
                while idx < mem[_1759]:
                    ...
                    t = t + 32
                    continue 
                mem[_1759 + ceil32(return_data.size) + 196] = this.address
                mem[_1759 + ceil32(return_data.size) + 228] = block.timestamp
                require ext_code.size(joeV2RouterAddress)
                call joeV2RouterAddress.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _1759 + ceil32(return_data.size) + (32 * mem[_1759]) + -mem[64] + 288]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if eth.balance(this.address) > eth.balance(this.address):
                    revert with 0, 'SafeMath: subtraction overflow', 0
        ...
        if not ext_call.return_data[0]:
            ...
            if not ext_call.return_data[0]:
                ...
                call joeV2RouterAddress.swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args Mask(255, 1, ext_call.return_data[0] - (ext_call.return_data[0] * sub_366d5ada / 100)), 0, 160, address(this.address), block.timestamp, mem[_1750 + ceil32(return_data.size) + 260 len (32 * mem[_1750]) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if eth.balance(this.address) > eth.balance(this.address):
                    revert with 0, 'SafeMath: subtraction overflow', 0
            ...
            if not ext_call.return_data[0]:
                ...
                call joeV2RouterAddress.swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args 0, 0, 160, address(this.address), block.timestamp, mem[(6 * ceil32(return_data.size)) + 996 len (32 * mem[(4 * ceil32(return_data.size)) + 736]) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                mem[(6 * ceil32(return_data.size)) + 832] = 30
                mem[(6 * ceil32(return_data.size)) + 864] = 'SafeMath: subtraction overflow'
                ...
                mem[(7 * ceil32(return_data.size)) + 1120] = 0x762b156200000000000000000000000000000000000000000000000000000000
                mem[(7 * ceil32(return_data.size)) + 1124] = ext_call.return_data[0] - (ext_call.return_data[0] * teamRate / 100) - (ext_call.return_data[0] * sub_366d5ada / 100) / 2
                mem[(7 * ceil32(return_data.size)) + 1156] = 0
                mem[(7 * ceil32(return_data.size)) + 1188] = 160
                mem[(7 * ceil32(return_data.size)) + 1284] = 2
                idx = 0
