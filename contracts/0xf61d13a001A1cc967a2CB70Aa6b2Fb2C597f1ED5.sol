                            ...
                            if arg2:
                                if arg1:
                                    ...
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    require return_data.size >= 32
                                    staticcall liquidityPoolManagerImplementationAddress.0xf3d7d282 with:
                                            gas gas_remaining wei
                                           args msg.sender
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    ...
                                    if ext_call.return_data[0] > 0:
                                        if not ext_call.return_data[0]:
                                            staticcall liquidityPoolManagerImplementationAddress.0x370b1bd5 with:
                                                    gas gas_remaining wei
                                                   args arg3, sub_2115ec8e, 0, msg.sender
                                        else:
                                            staticcall liquidityPoolManagerImplementationAddress.0xe5e31b13 with:
                                                    gas gas_remaining wei
                                                   args arg2
                                            if not ext_call.success:
                                                revert with ext_call.return_data[0 len return_data.size]
                                            ...
                                            if not ext_call.return_data[0]:
                                                ...
                                                staticcall liquidityPoolManagerImplementationAddress.0x370b1bd5 with:
                                                        gas gas_remaining wei
                                                       args arg3, sub_fa130fdf, 1, msg.sender
                                    else:
                                        if not ext_call.return_data[0]:
                                            staticcall liquidityPoolManagerImplementationAddress.0x370b1bd5 with:
                                                    gas gas_remaining wei
                                                   args arg3, sub_eaf447d4, 0, msg.sender
                                        else:
                                            staticcall liquidityPoolManagerImplementationAddress.0xe5e31b13 with:
                                                    gas gas_remaining wei
                                                   args arg2
                                            ...
                                            if not ext_call.return_data[0]:
                                                ...
                                                staticcall liquidityPoolManagerImplementationAddress.0x370b1bd5 with:
                                                        gas gas_remaining wei
                                                       args arg3, sub_6a9c5462, 1, msg.sender
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    require return_data.size >= 64
                                    if sub_5ae60c12:
                                        if ext_call.return_data[32] > sub_5ae60c12:
                                            revert with 0, 'USDC amount exceeds max USDC limit'
                                    if sub_817ca11a > !ext_call.return_data[0]:
                                        revert with 0, 17
                                    sub_817ca11a += ext_call.return_data[0]
                                    stor415 = 0
                            if liquidityPoolManagerImplementationAddress:
                                call liquidityPoolManagerImplementationAddress.0xf3988ce with:
                                     gas gas_remaining wei
