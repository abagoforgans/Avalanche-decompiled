...
function sub_72897e08(?) payable {
    ...
    call sub_e189e5dfAddress.mem[mem[64] len 4] with:
       value msg.value wei
         gas gas_remaining wei
        args mem[mem[64] + 4 len floor32(('cd', 36).length) + floor32(('cd', 68).length) + (32 * ('cd', 36).length) + -mem[64] + 258]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _80 = mem[64]
    ...
    mem[mem[64] + 68] = 160
    _111 = mem[floor32(('cd', 36).length) + 97]
    ...
    while idx < _111:
        ...
        t = t + 32
        continue 
    mem[_109 + 100] = msg.sender
    mem[_109 + 132] = block.timestamp + 900
    require ext_code.size(sub_d5dfff78Address)
    call sub_d5dfff78Address.mem[mem[64] len 4] with:
         gas gas_remaining wei
        args mem[mem[64] + 4 len _109 + (32 * _111) + -mem[64] + 192]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
