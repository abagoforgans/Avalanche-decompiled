...
function _fallback() payable {
    if calldata.size < 4:
        ...
        if unknown_0x83a317c1(?????) > uint32(call.func_hash) >> 224:
            if unknown_0x5caed029(?????) <= uint32(call.func_hash) >> 224:
                ...
                if unknown_0x6691461a(?????) == uint32(call.func_hash) >> 224:
                    ...
                    if uint32(call.func_hash) >> 224 != unknown_0x676c0d77(?????):
                        require unknown_0x7cc3ae8c(?????) == uint32(call.func_hash) >> 224
                        require not msg.value
                        return endAt
                    require not msg.value
                    require calldata.size - 4 >= 32
            ...
            if unknown_0xb2bdfa7b(?????) <= uint32(call.func_hash) >> 224:
                ...
                if uint32(call.func_hash) >> 224 != unknown_0x83a317c1(?????):
                    ...
                    if unknown_0x9b814944(?????) == uint32(call.func_hash) >> 224:
                        require not msg.value
                        return avaxDecimal
                    require unknown_0x9e1a4d19(?????) == uint32(call.func_hash) >> 224
                    require not msg.value
                    require ext_code.size(tokenAddr)
                    staticcall tokenAddr.0x70a08231 with:
                            gas gas_remaining wei
