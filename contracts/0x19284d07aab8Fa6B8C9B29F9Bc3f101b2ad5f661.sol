...
#
const name = 'Ground Beef Brigade', 0
...
uint8 emergencyExit;
address sub_8c3a573eAddress; offset 8
...
function sub_8c3a573e(?) payable {
    return sub_8c3a573eAddress
}
...
function balanceOfVault() payable {
    require ext_code.size(sub_8c3a573eAddress)
    staticcall sub_8c3a573eAddress.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function estimatedTotalAssets() payable {
    ...
    require return_data.size >= 32
    require ext_code.size(sub_8c3a573eAddress)
    staticcall sub_8c3a573eAddress.getPricePerFullShare() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if ext_call.return_data[0] + (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) < ext_call.return_data[0] * ext_call.return_data[0] / 10^18:
        revert with 0, 'SafeMath: addition overflow'
...
function isActive() payable {
    ...
    if ext_call.return_data[0] + (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) < ext_call.return_data[0] * ext_call.return_data[0] / 10^18:
        revert with 0, 'SafeMath: addition overflow'
    return (ext_call.return_data[0] + (ext_call.return_data[0] * ext_call.return_data[0] / 10^18) > 0)
}
...
function tend() payable {
    ...
    if not emergencyExit:
        ...
        if ext_call.return_data[0]:
            require ext_code.size(sub_8c3a573eAddress)
            call sub_8c3a573eAddress.deposit(uint256 arg1) with:
                 gas gas_remaining wei
...
function migrate(address arg1) payable {
    ...
    require ext_code.size(sub_8c3a573eAddress)
    call sub_8c3a573eAddress.withdrawAll() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sweep(address arg1) payable {
    ...
    mem[ceil32(return_data.size) + 128] = sub_8c3a573eAddress
    idx = 0
    while idx < 1:
        require idx < 1
...
function withdraw(uint256 arg1) payable {
    ...
    if not ext_call.return_data[0]:
        ...
        if 0 < arg1 - ext_call.return_data[0]:
            ...
            require ext_code.size(sub_8c3a573eAddress)
            call sub_8c3a573eAddress.0x2e1a7d4d with:
                 gas gas_remaining wei
            ...
            if not arg1 - ext_call.return_data[0]:
                ...
                if (10^18 * arg1) - (10^18 * ext_call.return_data[0]) / arg1 - ext_call.return_data[0] != 10^18:
                    revert with 0, 'SafeMath: multiplication overflow'
                mem[(6 * ceil32(return_data.size)) + 224] = 26
                mem[(6 * ceil32(return_data.size)) + 256] = 'SafeMath: division by zero'
                if not ext_call.return_data[0]:
                ...
                call sub_8c3a573eAddress.0x2e1a7d4d with:
                     gas gas_remaining wei
                    args ((10^18 * arg1) - (10^18 * ext_call.return_data[0]) / ext_call.return_data[0])
    else:
        if ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] != ext_call.return_data[0]:
            revert with 0, 'SafeMath: multiplication overflow'
        mem[(4 * ceil32(return_data.size)) + 96] = 26
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if ext_call.return_data[0] * ext_call.return_data[0] / 10^18 >= arg1 - ext_call.return_data[0]:
            if not arg1 - ext_call.return_data[0]:
                mem[(6 * ceil32(return_data.size)) + 224] = 26
                mem[(6 * ceil32(return_data.size)) + 256] = 'SafeMath: division by zero'
                if not ext_call.return_data[0]:
            ...
            if not ext_call.return_data[0] * ext_call.return_data[0] / 10^18:
                ...
                call sub_8c3a573eAddress.0x2e1a7d4d with:
                     gas gas_remaining wei
                    args (10^18 * ext_call.return_data[0] * ext_call.return_data[0] / 10^18 / ext_call.return_data[0])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if ext_call.return_data[0] >= arg1:
        ...
        if not ext_code.hash(wantAddress):
            revert with 0, 'Address: call to non-contract'
        mem[(7 * ceil32(return_data.size)) + 452 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg1, 0
        ...
        if not return_data.size:
            ...
            if return_data.size:
                ...
                if not mem[(7 * ceil32(return_data.size)) + 484]:
                    revert with 0, 'SafeERC20: ERC20 operation did not succeed'
        return 0
    mem[(7 * ceil32(return_data.size)) + 288] = 30
    mem[(7 * ceil32(return_data.size)) + 320] = 'SafeMath: subtraction overflow'
    if ext_call.return_data[0] > arg1:
        revert with 0, 'SafeMath: subtraction overflow', 0
    mem[(7 * ceil32(return_data.size)) + 388] = msg.sender
    mem[(7 * ceil32(return_data.size)) + 420] = ext_call.return_data[0]
    mem[(7 * ceil32(return_data.size)) + 352] = 68
    mem[(7 * ceil32(return_data.size)) + 388 len 28] = Mask(224, 32, msg.sender) >> 32
    ...
    if not ext_code.hash(wantAddress):
        revert with 0, 'Address: call to non-contract'
    mem[(7 * ceil32(return_data.size)) + 516 len 96] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0], 0
