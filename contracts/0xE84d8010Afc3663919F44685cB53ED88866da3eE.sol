...
function getTokensPrices(address arg1, address[] arg2) payable {
    ...
    if not _118:
        ...
        while idx < _118:
            ...
            if not _168:
                ...
                require _168
                if mem[(32 * idx) + (32 * arg2.length) + (2 * ceil32(return_data.size)) + 160] * _168 / _168 != mem[(32 * idx) + (32 * arg2.length) + (2 * ceil32(return_data.size)) + 160]:
                    revert with 0, 'math-not-safe'
                if (mem[(32 * idx) + (32 * arg2.length) + (2 * ceil32(return_data.size)) + 160] * _168) + 5 * 10^17 < mem[(32 * idx) + (32 * arg2.length) + (2 * ceil32(return_data.size)) + 160] * _168:
                    revert with 0, 'math-not-safe'
                mem[_209 + 32] = (mem[(32 * idx) + (32 * arg2.length) + (2 * ceil32(return_data.size)) + 160] * _168) + 5 * 10^17 / 10^18
    ...
    while idx < _268:
        ...
        if not _168:
            ...
            if (mem[(32 * idx) + (32 * arg2.length) + (2 * ceil32(return_data.size)) + 160] * _168) + 5 * 10^17 < mem[(32 * idx) + (32 * arg2.length) + (2 * ceil32(return_data.size)) + 160] * _168:
                revert with 0, 'math-not-safe'
            mem[_269 + 32] = (mem[(32 * idx) + (32 * arg2.length) + (2 * ceil32(return_data.size)) + 160] * _168) + 5 * 10^17 / 10^18
        require idx < mem[_170]
