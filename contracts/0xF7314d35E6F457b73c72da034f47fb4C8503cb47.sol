...
function addClaim(address arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    if owner != msg.sender:
    ...
    sub_8bb4acb8[address(arg1)] = arg2
}
...
function sub_c0f6dc7a(?) {
    ...
    while idx < ('cd', 4).length:
        ...
        mem[32] = 8
        sub_8bb4acb8[mem[(32 * idx) + 140 len 20]] = mem[(32 * idx) + (32 * ('cd', 4).length) + 160]
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
