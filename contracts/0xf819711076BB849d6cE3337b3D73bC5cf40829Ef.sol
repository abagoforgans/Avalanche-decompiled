...
function sub_cb08056a(?) {
    ...
    if bool(stor3[mem[140 len 20]]) == 1:
        ...
        while uint8(idx) < ('cd', 132).length:
            ...
            call address(_906).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args _912, 0, 160, address(this.address), block.timestamp + 120, mem[mem[64] + 164 len (32 * mem[96]) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _1187 = mem[64]
        ...
        if bool(stor3[mem[172 len 20]]) == 1:
            ...
            while uint8(idx) < ('cd', 132).length:
                ...
                call address(_909).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args _915, 0, 160, address(this.address), block.timestamp + 120, mem[mem[64] + 164 len (32 * mem[96]) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _1188 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if uint8(cd[228]) == 1:
                ...
                if not cd[100] * sub_b029d6e8 / 10000:
                    ...
                    while uint8(idx) < ('cd', 132).length:
                        ...
                        call address(_1140).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args _1158, 0, 160, address(this.address), block.timestamp + 120, mem[mem[64] + 164 len (32 * mem[96]) + 32]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        _1421 = mem[64]
                        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                if uint8(cd[228]) == 2:
                    ...
                    if not cd[100] * sub_947646e0 / 10000:
                        ...
                        while uint8(idx) < ('cd', 132).length:
                            ...
                            call address(_1134).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                 gas gas_remaining wei
                                args _1154, 0, 160, address(this.address), block.timestamp + 120, mem[mem[64] + 164 len (32 * mem[96]) + 32]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            _1419 = mem[64]
                            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                        ...
                        while uint8(idx) < ('cd', 132).length:
                            ...
                            call address(_1137).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                 gas gas_remaining wei
                                args _1156, 0, 160, address(this.address), block.timestamp + 120, mem[mem[64] + 164 len (32 * mem[96]) + 32]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            _1420 = mem[64]
                            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                    ...
                    if uint8(cd[228]) != 3:
                        ...
                        if not cd[100] * sub_947646e0 / 10000:
                            ...
                            while uint8(idx) < ('cd', 132).length:
                                ...
                                call address(_1122).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                     gas gas_remaining wei
                                    args _1146, 0, 160, address(this.address), block.timestamp + 120, mem[mem[64] + 164 len (32 * mem[96]) + 32]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _1415 = mem[64]
                                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                            ...
                            while uint8(idx) < ('cd', 132).length:
                                ...
                                call address(_1125).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                     gas gas_remaining wei
                                    args _1148, 0, 160, address(this.address), block.timestamp + 120, mem[mem[64] + 164 len (32 * mem[96]) + 32]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _1416 = mem[64]
                                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                        ...
                        if not cd[100] * sub_c6357133 / 10000:
                            ...
                            while uint8(idx) < ('cd', 132).length:
                                ...
                                call address(_1128).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                     gas gas_remaining wei
                                    args _1150, 0, 160, address(this.address), block.timestamp + 120, mem[mem[64] + 164 len (32 * mem[96]) + 32]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _1417 = mem[64]
                                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                            ...
                            while uint8(idx) < ('cd', 132).length:
                                ...
                                call address(_1131).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                     gas gas_remaining wei
                                    args _1152, 0, 160, address(this.address), block.timestamp + 120, mem[mem[64] + 164 len (32 * mem[96]) + 32]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _1418 = mem[64]
                                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
