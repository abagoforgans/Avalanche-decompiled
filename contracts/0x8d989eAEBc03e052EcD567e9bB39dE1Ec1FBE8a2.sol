...
function presaleWallets(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    return bool(stor21[arg1])
}

function sub_343365f6(?) {
    return sub_343365f6
}
...
function addPresaleUser(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function removePresaleUser(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function add100PresaleUsers(address[100] arg1) {
    require calldata.size - 4 >= 3200
    require 35 < calldata.size
    require 3204 <= calldata.size
    idx = 0
    s = 4
    t = 96
    while idx < 100:
    ...
    while idx < 2:
        ...
        mem[32] = 21
        stor21[mem[(32 * idx) + 108 len 20]] = 1
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
...
function mint(address arg1, uint256 arg2) payable {
    ...
    if msg.sender == owner:
        ...
        if bool(stor20[address(msg.sender)]) == 1:
            require arg2 <= sub_343365f6
            if whitelistCost and arg2 > -1 / whitelistCost:
                revert with 'NH{q', 17
            require msg.value >= whitelistCost * arg2
            idx = 1
            while idx <= arg2:
                if tokenByIndex.length > -idx - 1:
                    revert with 'NH{q', 17
            ...
            if bool(stor21[address(msg.sender)]) == 1:
                if presaleCost and arg2 > -1 / presaleCost:
                    revert with 'NH{q', 17
                require msg.value >= presaleCost * arg2
                idx = 1
                while idx <= arg2:
                    if tokenByIndex.length > -idx - 1:
                        revert with 'NH{q', 17
