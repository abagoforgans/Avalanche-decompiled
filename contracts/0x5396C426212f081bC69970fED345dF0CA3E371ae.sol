...
function getMultipliedFee() {
    ...
    if stor31 + stor32 < block.timestamp:
        revert with 0, 17
    if stor18 and stor29 > -1 / stor18:
        revert with 0, 17
    if not stor30:
        revert with 0, 18
    if stor18 * stor29 / stor30 < stor18:
        revert with 0, 17
    if (stor18 * stor29 / stor30) - stor18 and stor31 + stor32 - block.timestamp > -1 / (stor18 * stor29 / stor30) - stor18:
        revert with 0, 17
    if not stor32:
        revert with 0, 18
    if stor18 > !((stor31 * stor18 * stor29 / stor30) + (stor32 * stor18 * stor29 / stor30) - (block.timestamp * stor18 * stor29 / stor30) - (stor31 * stor18) - (stor32 * stor18) + (block.timestamp * stor18) / stor32):
        revert with 0, 17
    return (stor18 + ((stor31 * stor18 * stor29 / stor30) + (stor32 * stor18 * stor29 / stor30) - (block.timestamp * stor18 * stor29 / stor30) - (stor31 * stor18) - (stor32 * stor18) + (block.timestamp * stor18) / stor32))
}
...
function triggerZeusBuyback(uint256 arg1, bool arg2) {
    ...
    call routerAddress.swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
       value arg1 wei
         gas gas_remaining wei
        args 0, 128, stor2, block.timestamp, 2, mem[ceil32(return_data.size) + 356 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    stor45 = 0
    if arg2:
