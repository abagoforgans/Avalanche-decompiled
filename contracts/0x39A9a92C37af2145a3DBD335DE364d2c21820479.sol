...
function sub_19150cb5(?) payable {
    ...
    while idx < username.length:
        ...
        mem[_84] = stor[(5 * idx) + ('name', 'username', 8) + 4].length
        mem[0] = (5 * idx) + sha3(8) + 4
        mem[_84 + 32] = stor[sha3((5 * idx) + ('name', 'username', 8) + 4)].field_0
        s = _84 + 32
        t = sha3(mem[0])
        while _84 + stor[(5 * idx) + ('name', 'username', 8) + 4].length > s:
            mem[s + 32] = stor1[t]
            s = s + 32
            t = t + 1
            continue 
        mem[512] = _84
        mem[mem[64]] = bool(mem[448])
        return memory
          from mem[64]
           len 32
    return 0
...
function sub_989e5ea9(?) payable {
    ...
    while idx < username.length:
        ...
        while idx < _743:
            ...
            continue 
        if ceil32(_743) <= _743:
            mem[_710 + 96] = mem[396 len 20]
            mem[_710 + 128] = bool(mem[416])
            mem[_710 + 160] = bool(mem[448])
            mem[_710 + 192] = mem[480]
            _858 = mem[512]
            mem[_710 + 224] = ceil32(_743) + 256
            _860 = mem[_858]
            mem[_710 + ceil32(_743) + 288] = mem[_858]
            idx = 0
            while idx < _860:
                mem[_710 + ceil32(_743) + idx + 320] = mem[_858 + idx + 32]
                idx = idx + 32
                continue 
            if ceil32(_860) > _860:
        ...
        mem[_710 + 224] = ceil32(_743) + 256
        _861 = mem[_859]
        mem[_710 + ceil32(_743) + 288] = mem[_859]
        idx = 0
        while idx < _861:
            mem[_710 + ceil32(_743) + idx + 320] = mem[_859 + idx + 32]
            idx = idx + 32
            continue 
        if ceil32(_861) > _861:
...
function sub_f74d4c30(?) payable {
    ...
    while idx < username.length:
        ...
        if ceil32(_6532) <= _6532:
            mem[_6398 + 96] = mem[_4339 + 76 len 20]
            mem[_6398 + 128] = bool(mem[_4339 + 96])
            mem[_6398 + 160] = bool(mem[_4339 + 128])
            mem[_6398 + 192] = mem[_4339 + 160]
            _6846 = mem[_4339 + 192]
            mem[_6398 + 224] = ceil32(_6532) + 256
            _6850 = mem[_6846]
            mem[_6398 + ceil32(_6532) + 288] = mem[_6846]
            idx = 0
            while idx < _6850:
                mem[_6398 + ceil32(_6532) + idx + 320] = mem[_6846 + idx + 32]
                idx = idx + 32
                continue 
        ...
        mem[_6398 + 224] = ceil32(_6532) + 256
        _6852 = mem[_6848]
        mem[_6398 + ceil32(_6532) + 288] = mem[_6848]
        idx = 0
        while idx < _6852:
            mem[_6398 + ceil32(_6532) + idx + 320] = mem[_6848 + idx + 32]
            idx = idx + 32
            continue 
