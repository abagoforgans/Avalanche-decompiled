...
address sub_8161fcbaAddress;
address treasuryAddress;
address keeperAddress;
array of address currencies;
mapping of uint8 stor7;
mapping of address pool;
mapping of uint256 sub_5658a383;
mapping of uint256 poolShare;
mapping of uint256 sub_327d9bee;
mapping of address poolRewards;
mapping of address sub_978d12ae;

function sub_327d9bee(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    return sub_327d9bee[address(arg1)]
}
...
function sub_5658a383(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    return sub_5658a383[address(arg1)]
}
...
function sub_8161fcba(?) payable {
    return sub_8161fcbaAddress
}
...
function sub_978d12ae(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    return sub_978d12ae[address(arg1)]
}
...
function sub_751d8e7f(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, '!owner'
    sub_327d9bee[address(arg1)] = arg2
}

function sub_ef965c9f(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, '!owner'
    sub_5658a383[address(arg1)] = arg2
}
...
function sub_b55d578a(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
    require arg2 == address(arg2)
    if owner != msg.sender:
        revert with 0, '!owner'
    sub_978d12ae[address(arg1)] = address(arg2)
}
