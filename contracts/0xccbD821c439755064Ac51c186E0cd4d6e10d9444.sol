...
function buy(uint256 arg1) payable {
    ...
    if not sub_a5496921:
        ...
        if not arg1 / 10^18 / tokenPrice:
            ...
            if arg1 / 10^18 / tokenPrice and 1 > -1 / arg1 / 10^18 / tokenPrice:
                revert with 'NH{q', 17
            if not arg1 / 10^18 / tokenPrice:
                revert with 'NH{q', 18
            if arg1 / 10^18 / tokenPrice / arg1 / 10^18 / tokenPrice != 1:
                revert with 'NH{q', 1
            if not arg1 / 10^18 / tokenPrice:
                require ext_code.size(sub_cf3085f6Address)
                staticcall sub_cf3085f6Address.0x70a08231 with:
                ...
                if arg1 / 10^18 / tokenPrice and 10^9 > -1 / arg1 / 10^18 / tokenPrice:
                    revert with 'NH{q', 17
                if not arg1 / 10^18 / tokenPrice:
                    revert with 'NH{q', 18
                if 10^9 * arg1 / 10^18 / tokenPrice / arg1 / 10^18 / tokenPrice != 10^9:
                    revert with 'NH{q', 1
                require ext_code.size(sub_cf3085f6Address)
                staticcall sub_cf3085f6Address.0x70a08231 with:
                        gas gas_remaining wei
                ...
                stor15[address(msg.sender)] += arg1
                stor14[address(msg.sender)] = 1
                if tokenSold > (-1 * 10^9 * arg1 / 10^18 / tokenPrice) - 1:
                    revert with 'NH{q', 17
        ...
        if bool(bool(sub_a5496921 < 78)) or bool(bool(sub_a5496921 < 32)):
            ...
            if not arg1 / 10^18 / tokenPrice:
                ...
                if arg1 / 10^18 / tokenPrice and 10^sub_a5496921 > -1 / arg1 / 10^18 / tokenPrice:
                    revert with 'NH{q', 17
                if not arg1 / 10^18 / tokenPrice:
                    revert with 'NH{q', 18
                if arg1 / 10^18 / tokenPrice * 10^sub_a5496921 / arg1 / 10^18 / tokenPrice != 10^sub_a5496921:
                    revert with 'NH{q', 1
                if not arg1 / 10^18 / tokenPrice * 10^sub_a5496921:
                    require ext_code.size(sub_cf3085f6Address)
                    staticcall sub_cf3085f6Address.0x70a08231 with:
                            gas gas_remaining wei
                           args this.address
                    ...
                    if arg1 / 10^18 / tokenPrice * 10^sub_a5496921 and 10^9 > -1 / arg1 / 10^18 / tokenPrice * 10^sub_a5496921:
                        revert with 'NH{q', 17
                    if not arg1 / 10^18 / tokenPrice * 10^sub_a5496921:
                        revert with 'NH{q', 18
                    if 10^9 * arg1 / 10^18 / tokenPrice * 10^sub_a5496921 / arg1 / 10^18 / tokenPrice * 10^sub_a5496921 != 10^9:
                        revert with 'NH{q', 1
                    require ext_code.size(sub_cf3085f6Address)
                    staticcall sub_cf3085f6Address.0x70a08231 with:
                            gas gas_remaining wei
                    ...
                    require return_data.size >= 32
                    require ext_call.return_data[0] == ext_call.return_data[0]
                    if 10^9 * arg1 / 10^18 / tokenPrice * 10^sub_a5496921 > ext_call.return_data[0]:
                        revert with 0, 'Insufficient balance'
                    require ext_code.size(sub_cf3085f6Address)
                    call sub_cf3085f6Address.0xa9059cbb with:
                         gas gas_remaining wei
                        args msg.sender, 10^9 * arg1 / 10^18 / tokenPrice * 10^sub_a5496921
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    ...
                    stor15[address(msg.sender)] += arg1
                    stor14[address(msg.sender)] = 1
                    if tokenSold > (-1 * 10^9 * arg1 / 10^18 / tokenPrice * 10^sub_a5496921) - 1:
                        revert with 'NH{q', 17
                    tokenSold += 10^9 * arg1 / 10^18 / tokenPrice * 10^sub_a5496921
        else:
            s = 10
            t = 1
            idx = sub_a5496921
            ...
            if not arg1 / 10^18 / tokenPrice:
                ...
                if arg1 / 10^18 / tokenPrice and t * s > -1 / arg1 / 10^18 / tokenPrice:
                    revert with 'NH{q', 17
                if not arg1 / 10^18 / tokenPrice:
                    revert with 'NH{q', 18
                if arg1 / 10^18 / tokenPrice * t * s / arg1 / 10^18 / tokenPrice != t * s:
                    revert with 'NH{q', 1
                if not arg1 / 10^18 / tokenPrice * t * s:
                    require ext_code.size(sub_cf3085f6Address)
                    staticcall sub_cf3085f6Address.0x70a08231 with:
                            gas gas_remaining wei
                           args this.address
                    ...
                    if arg1 / 10^18 / tokenPrice * t * s and 10^9 > -1 / arg1 / 10^18 / tokenPrice * t * s:
                        revert with 'NH{q', 17
                    if not arg1 / 10^18 / tokenPrice * t * s:
                        revert with 'NH{q', 18
                    if 10^9 * arg1 / 10^18 / tokenPrice * t * s / arg1 / 10^18 / tokenPrice * t * s != 10^9:
                        revert with 'NH{q', 1
                    require ext_code.size(sub_cf3085f6Address)
                    staticcall sub_cf3085f6Address.0x70a08231 with:
                            gas gas_remaining wei
                    ...
                    require return_data.size >= 32
                    require ext_call.return_data[0] == ext_call.return_data[0]
                    if 10^9 * arg1 / 10^18 / tokenPrice * t * s > ext_call.return_data[0]:
                        revert with 0, 'Insufficient balance'
                    require ext_code.size(sub_cf3085f6Address)
                    call sub_cf3085f6Address.0xa9059cbb with:
                         gas gas_remaining wei
                        args msg.sender, 10^9 * arg1 / 10^18 / tokenPrice * t * s
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    ...
                    stor15[address(msg.sender)] += arg1
                    stor14[address(msg.sender)] = 1
                    if tokenSold > (-1 * 10^9 * arg1 / 10^18 / tokenPrice * t * s) - 1:
                        revert with 'NH{q', 17
                    tokenSold += 10^9 * arg1 / 10^18 / tokenPrice * t * s
