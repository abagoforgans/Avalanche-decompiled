...
array of uint256 tName;
address accounts;
uint256 _taxFee;

function name() payable {
    return tName[0 len tName.length]
}
...
function decimalNum() payable {
    return decimalNum
}

function tName() payable {
    return tName[0 len tName.length]
}
...
function autoBurn() payable {
    ...
    totalSupply -= 10^6
    emit Transfer((totalSupply - 10^6), msg.sender, 0);
}
...
function burnFrom(address arg1, uint256 arg2) payable {
    ...
    totalSupply -= arg2
    emit Transfer((totalSupply - arg2), arg1, 0);
}
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if arg2 / 100 * _taxFee > totalSupply:
        revert with 0, 'SafeMath: subtraction overflow'
    totalSupply += -1 * arg2 / 100 * _taxFee
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if arg3 / 100 * _taxFee > totalSupply:
        revert with 0, 'SafeMath: subtraction overflow'
    totalSupply += -1 * arg3 / 100 * _taxFee
