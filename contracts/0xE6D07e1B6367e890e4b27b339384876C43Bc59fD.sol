...
function mint(address arg1, string arg2) payable {
    ...
    if not roleAdmin[0x9f2df0fed2c77648de5860a4cc508cd0818c85b8b8a1ab4ceeef8d981c8956a6][1][address(msg.sender)].field_0:
        revert with 0, 
                    ...
                    61,
                    0x644552433732315072657365744d696e7465725061757365724175746f49643a206d7573742068617665206d696e74657220726f6c6520746f206d696e,
                    mem[ceil32(arg2.length) + 257 len 3]
    if not arg1:
        revert with 0, 'ERC721: mint to the zero address'
    if stor4[stor12]:
        revert with 0, 'ERC721: token already minted'
    ...
    ('bool', ('stor', ('map', ('stor', ('name', 'stor13', 13)), ('name', 'stor4', 4))))
    if arg2.length:
        uint256(stor9[stor13][]) = Array(len=arg2.length, data=arg2[all])
    else:
        uint256(stor9[stor13]) = 0
        idx = 0
        while stor9[stor13].length + 31 / 32 > idx:
            uint256(stor9[stor13][idx]) = 0
            idx = idx + 1
            continue 
}
