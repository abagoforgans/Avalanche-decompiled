    ...
    while idx <= 0:
        ...
        if stor2[idx].field_1792:
            ...
            if 31 >= stor2[idx].field_1793:
                ...
                while idx < _536:
                    ...
                    continue 
                if ceil32(_536) > _536:
                    mem[mem[64] + _536 + 320] = 0
                return 32, mem[mem[64] + 32 len 224], 256, _536, mem[mem[64] + 320 len ceil32(_536)]
            mem[0] = (8 * idx) + sha3(2) + 7
            mem[_448 + 32] = stor[sha3((8 * idx) + ('name', 'stor2', 2) + 7)].field_0
            s = _448 + 32
            t = sha3(mem[0])
            ...
            if ceil32(_969) <= _969:
                ...
                while idx < _969:
                    ...
                    continue 
                if ceil32(_969) > _969:
                    mem[mem[64] + _969 + 320] = 0
                return 32, mem[mem[64] + 32 len 224], 256, _969, mem[mem[64] + 320 len ceil32(_969)]
        ...
        if stor2[idx].field_1792:
            ...
            if ceil32(_970) <= _970:
                ...
                while idx < _970:
                    ...
                    continue 
                if ceil32(_970) > _970:
                    mem[mem[64] + _970 + 320] = 0
                return 32, mem[mem[64] + 32 len 224], 256, _970, mem[mem[64] + 320 len ceil32(_970)]
        ...
        if not stor2[idx].field_1793:
            ...
            while idx < _534:
                ...
                continue 
            if ceil32(_534) > _534:
                mem[mem[64] + _534 + 320] = 0
            return 32, mem[mem[64] + 32 len 224], 256, _534, mem[mem[64] + 320 len ceil32(_534)]
        if 31 >= stor2[idx].field_1793:
            mem[_449 + 32] = 256 * stor2[idx].field_1800
            mem[_446 + 224] = _449
            if arg1 != stor2[idx].field_512:
