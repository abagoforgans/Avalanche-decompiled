...
function sub_4b007dbb(?) payable {
    ...
    if not return_data.size:
        ...
        mem[ceil32(return_data.size) + 260 len 4] = approve(address arg1, uint256 arg2)
    ...
    mem[ceil32(return_data.size) + ceil32(return_data.size) + 261 len 4] = approve(address arg1, uint256 arg2)
