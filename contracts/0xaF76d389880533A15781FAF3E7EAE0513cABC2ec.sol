...
const sub_7123979c(?) = 0x1d7c28fbb0f8dcb4e5622afc63de55d21ebcd1f4

const sub_72402378(?) = 100

const sub_756059bd(?) = 50 * 10^18

const sub_88522783(?) = 0x19983b1b05eb4aa0d5d0d35b5e3239c9e7d1e402

const sub_aed58f4f(?) = 0x7ecc2e9f9fc8c1dcb2ed69f8b18df74b02cffdfe

const sub_bb6e6a9c(?) = 5 * 10^18

const sub_c20550a5(?) = 0x6e9036af9e98b15b70197aefa47053f43b01b7db
...
function withdraw() payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if eth.balance(this.address) and 6 > -1 / eth.balance(this.address):
        revert with 'NH{q', 17
    if eth.balance(this.address) < eth.balance(this.address) / 10:
        revert with 'NH{q', 17
    if eth.balance(this.address) - (eth.balance(this.address) / 10) < 6 * eth.balance(this.address) / 10:
        revert with 'NH{q', 17
    if eth.balance(this.address) - (eth.balance(this.address) / 10) - (6 * eth.balance(this.address) / 10) < eth.balance(this.address) / 5:
        revert with 'NH{q', 17
    ...
    call 0x7ecc2e9f9fc8c1dcb2ed69f8b18df74b02cffdfe with:
       value eth.balance(this.address) / 10 wei
         gas 2300 * is_zero(value) wei
    call 0x19983b1b05eb4aa0d5d0d35b5e3239c9e7d1e402 with:
       value eth.balance(this.address) / 5 wei
         gas 2300 * is_zero(value) wei
    call 0x6e9036af9e98b15b70197aefa47053f43b01b7db with:
       value eth.balance(this.address) - (eth.balance(this.address) / 10) - (6 * eth.balance(this.address) / 10) - (eth.balance(this.address) / 5) wei
         gas 2300 * is_zero(value) wei
}
                ...
                if not s:
                    ...
                    if bool(stor11.length):
                        ...
                        if not bool(stor11.length):
                            ...
                            mem[64] = ceil32(uint255(stor19[arg1].field_1)) + ceil32(s) + uint255(stor11.length.field_1) + mem[ceil32(uint255(stor19[arg1].field_1)) + 192] + 256
                    ...
                    if not bool(stor11.length):
                        ...
                        mem[64] = ceil32(uint255(stor19[arg1].field_1)) + ceil32(s) + stor11.length.field_1 % 128 + mem[ceil32(uint255(stor19[arg1].field_1)) + 192] + 256
