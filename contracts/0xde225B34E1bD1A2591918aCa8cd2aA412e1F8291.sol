...
function redeem(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    mem[96] = 0xc72e481500000000000000000000000000000000000000000000000000000000
    mem[100] = arg1
    require ext_code.size(sub_d460cb94Address)
    staticcall sub_d460cb94Address.0xc72e4815 with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if mem[mem[192] + 96] > test266151307():
        revert with 0, 65
    if ceil32(32 * mem[mem[192] + 96]) + 1 < 0 or ceil32(return_data.size) + ceil32(32 * mem[mem[192] + 96]) + 97 > test266151307():
        revert with 0, 65
    mem[64] = ceil32(return_data.size) + ceil32(32 * mem[mem[192] + 96]) + 97
    ...
    if 0 >= _8:
        revert with 0, 50
    require mem[ceil32(return_data.size) + 140 len 20]
    ...
    require return_data.size >= 32
    _244 = mem[_243]
    if mem[_243] and fee > -1 / mem[_243]:
        revert with 0, 17
    if mem[_243] < mem[_243] * fee / 10000:
        revert with 0, 17
    if bonds[address(arg1)].field_0 < mem[_243]:
        revert with 0, 17
    bonds[address(arg1)].field_0 -= mem[_243]
    mem[0] = arg1
    mem[32] = 12
    if block.timestamp < bonds[address(arg1)].field_512:
        _247 = mem[64]
        mem[mem[64] + 36] = sub_38cdba25Address
        mem[mem[64] + 68] = _244 * fee / 10000
        _249 = mem[64]
        mem[mem[64]] = 68
        ...
        if not ext_code.size(sub_7f216af3Address):
            revert with 0, 'Address: call to non-contract'
        _261 = mem[_249]
        mem[_247 + 164 len ceil32(mem[_249])] = mem[_249 + 32 len ceil32(mem[_249])]
        if ceil32(_261) > _261:
            mem[_261 + _247 + 164] = 0
        call sub_7f216af3Address with:
             gas gas_remaining wei
            args mem[_247 + 168 len _261 - 4]
        if not return_data.size:
            if not ext_call.success:
                if mem[96]:
                    revert with memory
        ...
        while idx < sub_821de0af.length:
            ...
            mem[mem[64]] = 68
            mem[64] = mem[64] + 100
            mem[_506 + 32] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000 or mem[_506 + 36 len 28]
            mem[64] = _501 + 164
            mem[_501 + 100] = 32
            ...
            idx = 0
            while idx < _542:
                mem[idx + _501 + 164] = mem[idx + _506 + 32]
                idx = idx + 32
                continue 
            if ceil32(_542) > _542:
                mem[_542 + _501 + 164] = 0
            call sub_7f216af3Address.mem[_501 + 164 len 4] with:
                 gas gas_remaining wei
                args mem[_501 + 168 len _542 - 4]
            if not return_data.size:
                if not ext_call.success:
                    if mem[96]:
                        revert with memory
                ...
                if return_data.size:
                    ...
                    if not mem[_501 + 196]:
                        revert with 0, 'SafeERC20: ERC20 operation did not succeed'
            emit 0xbbb59c50: arg1, _244 - (_244 * fee / 10000)
        _468 = mem[64]
        mem[mem[64] + 36] = sub_38cdba25Address
        mem[mem[64] + 68] = _244 * fee / 10000
        _471 = mem[64]
        ...
        mem[64] = mem[64] + 164
        mem[_468 + 100] = 32
        mem[_468 + 132] = 'SafeERC20: low-level call failed'
        if eth.balance(this.address) < 0:
            revert with 0, 'Address: insufficient balance for call'
        if not ext_code.size(sub_7f216af3Address):
            revert with 0, 'Address: call to non-contract'
        _499 = mem[_471]
        mem[_468 + 164 len ceil32(mem[_471])] = mem[_471 + 32 len ceil32(mem[_471])]
        if ceil32(_499) > _499:
            mem[_499 + _468 + 164] = 0
        call sub_7f216af3Address with:
             gas gas_remaining wei
            args mem[_468 + 168 len _499 - 4]
        if not return_data.size:
            if not ext_call.success:
                if mem[96]:
                    revert with memory
            ...
            mem[_468 + 196 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
                if return_data.size:
                    revert with ext_call.return_data[0 len return_data.size]
                revert with 0, 'SafeERC20: low-level call failed'
            if return_data.size:
                require return_data.size >= 32
                require mem[_468 + 196] == bool(mem[_468 + 196])
                if not mem[_468 + 196]:
                    revert with 0, 'SafeERC20: ERC20 operation did not succeed'
    emit 0xbbb59c50: arg1, _244 - (_244 * fee / 10000)
}
