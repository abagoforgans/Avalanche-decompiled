...
const DEV_FUND_POOL_ALLOCATION = 4000 * 10^18
...
function distributeReward(address arg1) payable {
    ...
    if totalSupply + 55000 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 55000 * 10^18
    if balanceOf[address(arg1)] + 55000 * 10^18 < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
            ...
            if block.timestamp - devFundLastClaimed:
                ...
                if (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) > 0:
                    if devFundAddress:
                        ...
                        if (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) + balanceOf[stor10] < balanceOf[stor10]:
                            revert with 0, 'SafeMath: addition overflow'
                        balanceOf[stor10] = (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) + balanceOf[stor10]
                        ...
                        if (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) + totalSupply < totalSupply:
                            revert with 0, 'SafeMath: addition overflow'
                        totalSupply = (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) + totalSupply
                        if (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) + balanceOf[address(stor12.field_0)] < balanceOf[address(stor12.field_0)]:
                            revert with 0, 'SafeMath: addition overflow'
                        balanceOf[address(stor12.field_0)] = (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) + balanceOf[address(stor12.field_0)]
                        emit Transfer(((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate)), 0, address(stor12.field_8));
            ...
            if endTime - devFundLastClaimed:
                ...
                if (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) > 0:
                    if devFundAddress:
                        ...
                        if (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) + balanceOf[stor10] < balanceOf[stor10]:
                            revert with 0, 'SafeMath: addition overflow'
                        balanceOf[stor10] = (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) + balanceOf[stor10]
                        ...
                        if (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) + totalSupply < totalSupply:
                            revert with 0, 'SafeMath: addition overflow'
                        totalSupply = (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) + totalSupply
                        if (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) + balanceOf[address(stor12.field_0)] < balanceOf[address(stor12.field_0)]:
                            revert with 0, 'SafeMath: addition overflow'
                        balanceOf[address(stor12.field_0)] = (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) + balanceOf[address(stor12.field_0)]
                        emit Transfer(((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate)), 0, address(stor12.field_8));
                        devFundLastClaimed = block.timestamp
}
