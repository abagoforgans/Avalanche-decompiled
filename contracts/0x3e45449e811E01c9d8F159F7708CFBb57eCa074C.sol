...
#  - burn(address arg1)
#
const name = 'Joe LP Token'

const decimals = 18

const symbol = 'JLP'

const PERMIT_TYPEHASH = 0x6e71edae12b1b97f4d1f60370fef10105fa3faae0126114a169c64845d6126c9
...
function permit(address arg1, address arg2, uint256 arg3, uint256 arg4, uint8 arg5, bytes32 arg6, bytes32 arg7) payable {
    ...
    if arg4 < block.timestamp:
        revert with 0, 'Joe: EXPIRED'
    nonces[address(arg1)]++
    signer = erecover(sha3(0, DOMAIN_SEPARATOR, sha3(0x6e71edae12b1b97f4d1f60370fef10105fa3faae0126114a169c64845d6126c9, address(arg1), address(arg2), arg3, nonces[address(arg1)], arg4)), arg5 << 248, arg6, arg7) 
    if not erecover.result:
        revert with ext_call.return_data[0 len return_data.size]
    if not address(signer):
        revert with 0, 'Joe: INVALID_SIGNATURE'
...
function sync() payable {
    ...
    emit Sync(Mask(112, 0, stor8.field_0), Mask(112, 0, stor8.field_112));
    stor12 = 1
}
...
function skim(address arg1) payable {
    ...
    if ext_call.return_data[0] - Mask(112, 0, stor8.field_0) > ext_call.return_data[0]:
        revert with 0, 'ds-math-sub-underflow'
    mem[260 len 64] = Mask(32, 224, sha3('transfer(address,uint256)')) >> 224, address(arg1) << 64, 0, Mask(224, 32, ext_call.return_data[0] - Mask(112, 0, stor8.field_0)) >> 32
    call token0Address with:
         gas gas_remaining wei
        args Mask(224, 32, ext_call.return_data[0] - Mask(112, 0, stor8.field_0)) << 224, mem[324 len 4]
    if not return_data.size:
        require not ext_call.success
        revert with 0, 'Joe: TRANSFER_FAILED'
    ...
    if ext_call.return_data[0] - Mask(112, 0, stor8.field_112) > ext_call.return_data[0]:
        revert with 0, 'ds-math-sub-underflow'
    mem[ceil32(return_data.size) + 425 len 64] = Mask(32, 224, sha3('transfer(address,uint256)')) >> 224, address(arg1) << 64, 0, Mask(224, 32, ext_call.return_data[0] - Mask(112, 0, stor8.field_112)) >> 32
    call token1Address with:
         gas gas_remaining wei
        args Mask(224, 32, ext_call.return_data[0] - Mask(112, 0, stor8.field_112)) << 224, mem[ceil32(return_data.size) + 489 len 4]
    if not return_data.size:
        require not ext_call.success
        revert with 0, 'Joe: TRANSFER_FAILED'
