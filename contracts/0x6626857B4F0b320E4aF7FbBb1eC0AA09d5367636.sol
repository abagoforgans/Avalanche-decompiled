...
function sub_2d664ca2(?) payable {
    ...
    if ext_call.return_data[31 len 1] <= 0:
        revert with 0, 'INVALID_DECIMALS'
    if 1000000000000000000 * 10^18 > !(ext_call.return_data[32] / 2):
        revert with 0, 17
    if not ext_call.return_data[32]:
        revert with 0, 18
    if (ext_call.return_data[32] / 2) + 1000000000000000000 * 10^18 / ext_call.return_data[32] <= 0:
        revert with 0, 'INVALID_PRICE'
    return ((ext_call.return_data[32] / 2) + 1000000000000000000 * 10^18 / ext_call.return_data[32])
}
