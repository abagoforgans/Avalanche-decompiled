...
address burnAddress;
uint256 stor4;
address sub_330cefedAddress;
uint8 saleActive; offset 160
uint8 isPublic; offset 168
...
function sub_330cefed(?) payable {
    return sub_330cefedAddress
}
...
function sub_16907e9c(?) payable {
    require ext_code.size(sub_330cefedAddress)
    staticcall sub_330cefedAddress.0x70a08231 with:
    ...
    if bool(stor3[address(msg.sender)]) == 1:
        ...
        if not arg1:
            ...
            if not return_data.size:
                ...
                if ext_code.size(sub_330cefedAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[456 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, arg1 * sub_3549756a / 10^6) >> 32
                mem[520 len 0] = 0
                call sub_330cefedAddress with:
                   funct uint32(msg.sender)
                     gas gas_remaining wei
                ...
                if return_data.size <= 0:
                    ...
                    if ext_code.size(sub_330cefedAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 457 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, arg1 * sub_3549756a / 10^6) >> 32
