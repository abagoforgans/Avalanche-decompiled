...
function mintTo(address arg1) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if stor8 > 1000:
        revert with 0, 'Total Supply Reached'
    if not arg1:
...
function tokenURI(uint256 arg1) payable {
    ...
    if not s:
        ...
        if not bool(stor7.length):
            ...
            if ceil32(_397) <= _397:
                ...
                return 32, mem[_356 + stor7.length.field_1 + _397 + 64 len ceil32(_630) + 32]
            mem[_356 + stor7.length.field_1 + _397 + 32] = 0
            _601 = mem[64]
            mem[64] = _356 + stor7.length.field_1 + _397 + 32
            mem[_356 + stor7.length.field_1 + _397 + 32] = 32
            _638 = mem[_601]
    ...
    if not bool(stor7.length):
        ...
        if ceil32(_399) <= _399:
            ...
            return 32, mem[_357 + stor7.length.field_1 + _399 + 64 len ceil32(_634) + 32]
        mem[_357 + stor7.length.field_1 + _399 + 32] = 0
        _609 = mem[64]
        mem[64] = _357 + stor7.length.field_1 + _399 + 32
        mem[_357 + stor7.length.field_1 + _399 + 32] = 32
        _642 = mem[_609]
