...
function giveAway(address arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if stor13 < 1:
    ...
    if stor3[arg2]:
        revert with 0, 'ERC721: token already minted'
    if tokenOfOwnerByIndex[address(arg1)][1][arg2]:
        if stor3[arg2]:
            require stor3[arg2] - 1 < tokenByIndex.length
            ...
            if ext_code.size(arg1) > 0:
                ...
                call arg1.0x80 with:
                     gas gas_remaining wei
                    args Mask(1248, -1024, onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, arg2, 128, 0) << 1024, mem[644 len 4]
                if not return_data.size:
                    require not ext_call.success
                    revert with 0, 
                                32,
