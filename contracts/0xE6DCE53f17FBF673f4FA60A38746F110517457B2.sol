...
function unstake(uint256 arg1) {
    ...
    if block.number <= uint256(poolInfo.field_512):
        if arg1 > totalStaked:
            revert with 0, 'SafeMath: subtraction overflow'
        totalStaked -= arg1
        if arg1 > uint256(userInfo[0][msg.sender].field_0):
        ...
        if not uint256(userInfo[0][msg.sender].field_0):
            ...
            if uint256(poolInfo.field_1024) * uint256(userInfo[0][msg.sender].field_0) / uint256(userInfo[0][msg.sender].field_0) != uint256(poolInfo.field_1024):
                revert with 0, 32, 33, 0x25536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[581 len 31]
            uint256(userInfo[0][msg.sender].field_256) = uint256(poolInfo.field_1024) * uint256(userInfo[0][msg.sender].field_0) / 10^12
    else:
        if not totalStaked:
            ...
            if not uint256(userInfo[0][msg.sender].field_0):
                ...
                if uint256(poolInfo.field_1024) * uint256(userInfo[0][msg.sender].field_0) / uint256(userInfo[0][msg.sender].field_0) != uint256(poolInfo.field_1024):
                    revert with 0, 32, 33, 0x25536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[773 len 31]
                uint256(userInfo[0][msg.sender].field_256) = uint256(poolInfo.field_1024) * uint256(userInfo[0][msg.sender].field_0) / 10^12
    require ext_code.size(libAddress)
    staticcall libAddress.0x70a08231 with:
            gas gas_remaining wei
