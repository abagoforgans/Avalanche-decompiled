...
function harvest() payable {
    ...
    call 0x830a966b9b447c9b15ab24c0369c4018e75f31c9.getreward() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
...
function balanceOf() payable {
    require ext_code.size(0x830a966b9b447c9b15ab24c0369c4018e75f31c9)
    staticcall 0x830a966b9b447c9b15ab24c0369c4018e75f31c9.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if ext_call.return_data[0] >= arg1:
        if ext_call.return_data[0] <= arg1:
            if not ext_call.return_data[0]:
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[324 len 64] = unknown_0xa9059cbb(?????), 0x3bdf76dc9ab46955a003a15e, 0, 0
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[324 len 64] = unknown_0xa9059cbb(?????), 0x3bdf76dc9ab46955a003a15e, 0, Mask(224, 32, 50 * ext_call.return_data[0] / 10000) >> 32
                call lpPairAddress.0x59e4befd with:
                     gas gas_remaining wei
            ...
            if not arg1:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[324 len 64] = unknown_0xa9059cbb(?????), 0x3bdf76dc9ab46955a003a15e, 0, Mask(224, 32, 50 * arg1 / 10000) >> 32
                call lpPairAddress.0x59e4befd with:
                     gas gas_remaining wei
        ...
        if ext_call.return_data[0] > arg1:
            if not arg1:
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = unknown_0xa9059cbb(?????), 0x3bdf76dc9ab46955a003a15e, 0, 0
                call lpPairAddress.0x59e4befd with:
                     gas gas_remaining wei
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = unknown_0xa9059cbb(?????), 0x3bdf76dc9ab46955a003a15e, 0, Mask(224, 32, 50 * arg1 / 10000) >> 32
                call lpPairAddress.0x59e4befd with:
                     gas gas_remaining wei
            ...
            if not ext_call.return_data[0]:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[388 len 64] = unknown_0xa9059cbb(?????), 0x3bdf76dc9ab46955a003a15e, 0, Mask(224, 32, 50 * ext_call.return_data[0] / 10000) >> 32
                mem[452 len 0] = 0
                call lpPairAddress.0x59e4befd with:
                     gas gas_remaining wei
