...
function withdraw() {
    require msg.sender == 0x7d7e74467f813ea09b44fa43781f761ef6317751
    call 0x7d7e74467f813ea09b44fa43781f761ef6317751 with:
...
function sub_36bb99dd(?) payable {
    ...
    call 0x53f7c5869a859f0aec3d334ee8b4cf01e3492f21.0x23b872dd with:
         gas gas_remaining wei
        args 0x78bc7ba11f17d0db3cbedd2565cab6da01060b6b, 0x7d7e74467f813ea09b44fa43781f761ef6317751, arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(0x53f7c5869a859f0aec3d334ee8b4cf01e3492f21)
