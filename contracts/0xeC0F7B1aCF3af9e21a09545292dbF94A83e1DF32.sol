                    ...
                    if owner == msg.sender:
                        ...
                        if owner == arg1:
                            ...
                            while idx < mem[_3169]:
                                ...
                                t = t + 32
                                continue 
                            mem[_3169 + ceil32(return_data.size) + 228] = this.address
                            mem[_3169 + ceil32(return_data.size) + 260] = block.timestamp
                            require ext_code.size(uniswapV2RouterAddress)
                            call uniswapV2RouterAddress.mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _3169 + ceil32(return_data.size) + (32 * mem[_3169]) + -mem[64] + 320]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            mem[mem[64] + 4] = this.address
                            require ext_code.size(rewardTokenAddress)
                        ...
                        if not stor18[address(cd[4])]:
                            if owner != address(cd[4]):
                                if owner != address(cd[36]):
                                    ...
                                    call uniswapV2RouterAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                         gas gas_remaining wei
                                        args balanceOf[this.address], 0, 160, address(this.address), block.timestamp, mem[_11725 + ceil32(return_data.size) + 292 len (32 * mem[_11725]) + 32]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    require ext_code.size(rewardTokenAddress)
                                    staticcall rewardTokenAddress.0x70a08231 with:
