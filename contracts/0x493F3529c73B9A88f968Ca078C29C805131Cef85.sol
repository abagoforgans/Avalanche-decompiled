...
#
#  - settlePayoutFromPremium(address arg1, uint256 arg2, address arg3)
#
uint8 stor0;
...
array of address sub_589b7a64;
mapping of uint8 stor203;
mapping of uint256 sub_34619521;
...
function sub_34619521(?) {
    require calldata.size - 4 >= 32
    return sub_34619521[arg1]
}
...
function sub_589b7a64(?) {
    require calldata.size - 4 >= 32
    require arg1 < sub_589b7a64.length
    return sub_589b7a64[arg1]
}

function sub_5968680c(?) {
    require calldata.size - 4 >= 32
...
function addPremiumAmount(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    ...
    if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == arg1:
        if arg2 != msg.value:
            revert with 0, 'APA:1'
    if not stor203[address(arg1)]:
        sub_589b7a64.length++
        stor42D7[stor202.length] = arg1
        stor203[address(arg1)] = 1
    if arg2 + sub_34619521[address(arg1)] < sub_34619521[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    sub_34619521[address(arg1)] += arg2
}

function getPremiumPoolAmtInPaymentToken(address arg1) {
    require calldata.size - 4 >= 32
    require ext_code.size(sub_b870029cAddress)
    staticcall sub_b870029cAddress.0x2a1450ea with:
            gas gas_remaining wei
    ...
    if not ext_call.return_data[0]:
        if owner != msg.sender:
            revert with 0, 'allowedCaller'
    idx = 0
    while idx < sub_589b7a64.length:
        mem[0] = sub_589b7a64[idx]
        mem[32] = 204
        if sub_34619521[stor202[idx]]:
            if sub_589b7a64[idx] == arg1:
                if sub_34619521[stor202[idx]] < 0:
                    revert with 0, 'SafeMath: addition overflow'
            else:
                mem[100] = sub_589b7a64[idx]
                mem[132] = arg1
                mem[164] = sub_34619521[stor202[idx]]
                ...
                staticcall exchangeRateAddress.getTokenToTokenAmount(address rg1, address rg2, uint256 rg3) with:
                        gas gas_remaining wei
                       args sub_589b7a64[idx], address(arg1), sub_34619521[stor202[idx]]
