...
const MAXIMUS_POOL = 0xe9c71863b2271aa4f8db45e4bcc2169b126e88fe
...
function shouldMarketBuy() {
    ...
    staticcall 0x3a78d8b375e5df255eb27abceecf42ebfe6bc73e.0xaa17c423 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(0x3a78d8b375e5df255eb27abceecf42ebfe6bc73e)
    staticcall 0x3a78d8b375e5df255eb27abceecf42ebfe6bc73e.0xb61d8c00 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function mintGov(uint256 arg1) {
    ...
    if arg1:
        ...
        if 0xf80633724f03dd47d708bde889a283233f2121c1 != this.address:
            require ext_code.size(0x964ddc3f274e425c6f257c046161f956d8fa2652)
            call 0x964ddc3f274e425c6f257c046161f956d8fa2652.transfer(address rg1, uint256 rg2) with:
                 gas gas_remaining wei
...
function initialize() {
    ...
    call 0x964ddc3f274e425c6f257c046161f956d8fa2652.approve(address rg1, uint256 rg2) with:
         gas gas_remaining wei
        args 0xe9c71863b2271aa4f8db45e4bcc2169b126e88fe, -1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
