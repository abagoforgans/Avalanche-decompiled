    ...
    if not sub_a44f4556:
        if block.number > player[address(msg.sender)].field_768:
            if sub_7145fd3e > 0:
                ...
                if player[msg.sender].field_1024 > (player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9:
                    revert with 0, 'SafeMath:OVERFLOW_SUB'
                if ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024 > 0:
                    if sub_537b2398 >= ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024:
                        require ext_code.size(sub_8cab0f99Address)
                        staticcall sub_8cab0f99Address.0x70a08231 with:
                                gas gas_remaining wei
                               args this.address
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        if ext_call.return_data[0] >= ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024:
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            if ext_call.return_data[0] > ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024 - ext_call.return_data[0]:
                                require ext_code.size(address(sub_b9ec104bAddress))
                                call address(sub_b9ec104bAddress).unstake(uint256 arg1, bool arg2) with:
                                     gas gas_remaining wei
                                    args ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024 - ext_call.return_data[0], 1
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                mem[196 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024) >> 32
                                call sub_8cab0f99Address with:
                                ...
                                if not return_data.size:
                                    ...
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    mem[296 len 64] = 0, msg.sender, Mask(224, 32, ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024) >> 32
                                    call sub_8cab0f99Address with:
                                       funct uint32(msg.sender)
                                         gas gas_remaining wei
                                        args ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024, Mask(224, 32, 0, msg.sender, Mask(224, 32, ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024) >> 32) >> 32, mem[360 len 4]
                                    if not return_data.size:
                                        if not ext_call.success:
                                            revert with 0, 
                                                        32,
                                    ...
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    mem[ceil32(return_data.size) + 297 len 64] = 0, msg.sender, Mask(224, 32, ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024) >> 32
                                    call sub_8cab0f99Address with:
                                       funct uint32(msg.sender)
                                         gas gas_remaining wei
                                        args ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024, Mask(224, 32, 0, msg.sender, Mask(224, 32, ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024) >> 32) >> 32, mem[ceil32(return_data.size) + 361 len 4]
                                    if not return_data.size:
                                        if not ext_call.success:
                                            revert with 0, 
                                                        32,
                        ...
                        if ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) - player[msg.sender].field_1024 > sub_537b2398:
                            revert with 0, 'SafeMath:OVERFLOW_SUB'
                        sub_537b2398 = sub_537b2398 - ((player[msg.sender].field_256 * sub_f87f87ac) + 500 * 10^6 / 10^9) + player[msg.sender].field_1024
            if sub_f87f87ac:
                require sub_f87f87ac
