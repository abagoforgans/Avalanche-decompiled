                    ...
                    if ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * 0 / totalSupply / 10^18:
                        ...
                        if sub_ea3460cc * ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * 0 / totalSupply / 10^18 / 10^18:
                            ...
                            if not ext_code.size(meltAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 521 len 96] = 0, msg.sender, 1, Mask(224, 32, sub_ea3460cc * ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * 0 / totalSupply / 10^18 / 10^18) >> 32
                            mem[ceil32(return_data.size) + 645 len 4] = 0
                            call meltAddress.0x1 with:
                                 gas gas_remaining wei
                                args sub_ea3460cc * ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * 0 / totalSupply / 10^18 / 10^18, mem[ceil32(return_data.size) + 457 len 60], mem[ceil32(return_data.size) + 617 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                ...
                if ext_call.return_data[0] * arg1 / totalSupply:
                    ...
                    if ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * ext_call.return_data[0] * arg1 / totalSupply / 10^18:
                        ...
                        if sub_ea3460cc * ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * ext_call.return_data[0] * arg1 / totalSupply / 10^18 / 10^18:
                            ...
                            if not ext_code.size(meltAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 521 len 96] = 0, msg.sender, 1, Mask(224, 32, sub_ea3460cc * ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * ext_call.return_data[0] * arg1 / totalSupply / 10^18 / 10^18) >> 32
                            mem[ceil32(return_data.size) + 645 len 4] = 0
                            call meltAddress.0x1 with:
                                 gas gas_remaining wei
                                args sub_ea3460cc * ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * ext_call.return_data[0] * arg1 / totalSupply / 10^18 / 10^18, mem[ceil32(return_data.size) + 457 len 60], mem[ceil32(return_data.size) + 617 len 4]
                            if not return_data.size:
                                require not ext_call.success
                                revert with 'SafeMath: division by zero'
                            mem[ceil32(return_data.size) + 553 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    ...
                    if arg1:
                        ...
                        if ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * arg1 / 10^18:
                            ...
                            if sub_0bb52153 * ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * arg1 / 10^18 / 10^18:
                                ...
                                if not ext_code.size(meltAddress):
                                    revert with 0, 'Address: call to non-contract'
                                mem[488 len 96] = 0, msg.sender, 1, Mask(224, 32, sub_0bb52153 * ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * arg1 / 10^18 / 10^18) >> 32
                                mem[612 len 4] = 0
                                call meltAddress.0x1 with:
                                     gas gas_remaining wei
                                    args sub_0bb52153 * ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * arg1 / 10^18 / 10^18, mem[424 len 60], mem[584 len 4]
                                if not return_data.size:
                                    if not ext_call.success:
                                        revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), arg1
                                    if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
                    ...
                    if arg1:
                        ...
                        if ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * arg1 / 10^18:
                            ...
                            if sub_0bb52153 * ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * arg1 / 10^18 / 10^18:
                                ...
                                if not ext_code.size(meltAddress):
                                    revert with 0, 'Address: call to non-contract'
                                mem[ceil32(return_data.size) + 489 len 96] = 0, msg.sender, 1, Mask(224, 32, sub_0bb52153 * ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * arg1 / 10^18 / 10^18) >> 32
                                mem[ceil32(return_data.size) + 613 len 4] = 0
                                call meltAddress.0x1 with:
                                     gas gas_remaining wei
                                    args sub_0bb52153 * ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * arg1 / 10^18 / 10^18, mem[ceil32(return_data.size) + 425 len 60], mem[ceil32(return_data.size) + 585 len 4]
                                if not return_data.size:
                                    if not ext_call.success:
                                        revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), arg1
                                    if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
                    ...
                    if arg1:
                        ...
                        if ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * arg1 / 10^18:
                            ...
                            if sub_0bb52153 * ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * arg1 / 10^18 / 10^18:
                                ...
                                if not ext_code.size(meltAddress):
                                    revert with 0, 'Address: call to non-contract'
                                mem[ceil32(return_data.size) + 553 len 96] = 0, msg.sender, 1, Mask(224, 32, sub_0bb52153 * ext_call.return_data[0] * ext_call.return_data[32] / 10^18 * arg1 / 10^18 / 10^18) >> 32
