...
function sub_eff6cafb(?) {
    ...
    if stor1 == address(cd[68]):
        mem[floor32(('cd', 100).length) + 97] = 2
        mem[64] = floor32(('cd', 100).length) + 193
        mem[floor32(('cd', 100).length) + 129] = address(cd[36])
        mem[floor32(('cd', 100).length) + 161] = stor1
        idx = 0
        while idx < ('cd', 100).length:
            if idx >= mem[96]:
                revert with 'NH{q', 50
            ...
            call address(cd[36]).0x23b872dd with:
                 gas gas_remaining wei
                args address(_134), address(this.address), _145
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _151 = mem[64]
            ...
            mem[mem[64] + 36] = 1
            mem[mem[64] + 68] = 160
            _177 = mem[floor32(('cd', 100).length) + 97]
            mem[mem[64] + 164] = mem[floor32(('cd', 100).length) + 97]
            s = 0
            ...
            call address(cd[4]).swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args _161, 1, 160, address(_174), block.timestamp, mem[mem[64] + 164 len (32 * _177) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if idx == -1:
                revert with 'NH{q', 17
        ...
        mem[floor32(('cd', 100).length) + 97] = 3
        mem[64] = floor32(('cd', 100).length) + 225
        mem[floor32(('cd', 100).length) + 129] = address(cd[36])
        mem[floor32(('cd', 100).length) + 161] = address(cd[68])
        mem[floor32(('cd', 100).length) + 193] = stor1
        idx = 0
        while idx < ('cd', 100).length:
            if idx >= mem[96]:
                revert with 'NH{q', 50
            ...
            mem[mem[64] + 4] = address(_132)
            mem[mem[64] + 36] = this.address
            mem[mem[64] + 68] = _144
            require ext_code.size(address(cd[36]))
            call address(cd[36]).0x23b872dd with:
                 gas gas_remaining wei
                args address(_132), address(this.address), _144
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _150 = mem[64]
            ...
            mem[mem[64] + 36] = 1
            mem[mem[64] + 68] = 160
            _176 = mem[floor32(('cd', 100).length) + 97]
            mem[mem[64] + 164] = mem[floor32(('cd', 100).length) + 97]
            s = 0
            t = floor32(('cd', 100).length) + 129
            u = mem[64] + 196
            while s < _176:
                ...
                u = u + 32
                continue 
            mem[_173 + 100] = address(_172)
            mem[_173 + 132] = block.timestamp
            require ext_code.size(address(cd[4]))
            call address(cd[4]).mem[mem[64] len 4] with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len _173 + (32 * _176) + -mem[64] + 192]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if idx == -1:
                revert with 'NH{q', 17
...
function sub_b680a32c(?) {
    ...
    if stor1 != address(arg3):
        ...
        mem[(4 * ceil32(return_data.size)) + 224] = _63
        ...
        if uint8(var301002) < var301001:
            ...
            staticcall address(arg1).mem[mem[64] len 4] with:
                    gas gas_remaining wei
                   args mem[mem[64] + 4 len _921 + (32 * _924) + -mem[64] + 96]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _1043 = mem[64]
            ...
            while idx < _1213:
                ...
                continue 
            mem[_1207 + 100] = owner
            mem[_1207 + 132] = block.timestamp
            require ext_code.size(address(arg1))
            call address(arg1).mem[mem[64] len 4] with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len _1207 + (32 * _1213) + -mem[64] + 192]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[mem[64] + 4] = owner
            require ext_code.size(stor1)
        ...
        mem[(4 * ceil32(return_data.size)) + 192] = _64
        ...
        while idx < _164:
            ...
            t = t + 32
            continue 
        mem[_162 + 100] = this.address
        mem[_162 + 132] = block.timestamp
        require ext_code.size(address(arg1))
        call address(arg1).mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _162 + (32 * _164) + -mem[64] + 192]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64] + 4] = this.address
        require ext_code.size(address(arg2))
        ...
        if uint8(var300002) < var300001:
            ...
            staticcall address(arg1).mem[mem[64] len 4] with:
                    gas gas_remaining wei
                   args mem[mem[64] + 4 len _922 + (32 * _926) + -mem[64] + 96]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _1044 = mem[64]
            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            while idx < _1215:
                ...
                continue 
            mem[_1208 + 100] = owner
            mem[_1208 + 132] = block.timestamp
            require ext_code.size(address(arg1))
            call address(arg1).mem[mem[64] len 4] with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len _1208 + (32 * _1215) + -mem[64] + 192]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[mem[64] + 4] = owner
            require ext_code.size(stor1)
