...
function withdrawAll() {
    ...
    emit WithdrawAll(msg.sender, ext_call.return_data[0]);
}
...
function sub_2c10e156(?) {
    ...
    if 1 >= _25:
        revert with 0, 50
    if mem[(2 * ceil32(return_data.size)) + 256] / 10^6 > 0x10c6f7a0b5ed8d36b4c7f34938583621fafc8b0079a2834d26fa3fcc9ea9:
        revert with 0, 17
    mem[mem[64]] = 10^6 * mem[(2 * ceil32(return_data.size)) + 256] / 10^6
    return memory
      from mem[64]
       len 32
}
...
function sub_5e256286(?) payable {
    ...
    if not sub_cdac724d:
        revert with 0, 18
    if 10^6 * mem[(2 * ceil32(return_data.size)) + 256] / 10^6 / sub_cdac724d > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
        revert with 0, 17
    mem[0] = msg.sender
    mem[32] = 10
    if sub_f85ffe77[msg.sender] > !(10^6 * mem[(2 * ceil32(return_data.size)) + 256] / 10^6):
        revert with 0, 17
    if sub_f85ffe77[msg.sender] + (10^6 * mem[(2 * ceil32(return_data.size)) + 256] / 10^6) < sub_95f26ce2:
        revert with 0, 'PresaleFactory: The price is not allowed for presale.'
    if sub_f85ffe77[msg.sender] > !(10^6 * mem[(2 * ceil32(return_data.size)) + 256] / 10^6):
        revert with 0, 17
    if sub_f85ffe77[msg.sender] + (10^6 * mem[(2 * ceil32(return_data.size)) + 256] / 10^6) > sub_1c5aeef7:
        revert with 0, 'PresaleFactory: The price is not allowed for presale.'
    call stor9 with:
       value msg.value wei
    ...
    mem[mem[64] + 36] = 10^18 * 10^6 * _62 / 10^6 / sub_cdac724d
    require ext_code.size(stor1)
    call stor1.0xa9059cbb with:
         gas gas_remaining wei
        args msg.sender, 10^18 * 10^6 * _62 / 10^6 / sub_cdac724d
    ...
    if sub_f85ffe77[msg.sender] > !(10^6 * _62 / 10^6):
        revert with 0, 17
    sub_f85ffe77[msg.sender] += 10^6 * _62 / 10^6
    emit 0x591accc0: this.address, msg.sender, 10^18 * 10^6 * _62 / 10^6 / sub_cdac724d
}
...
function _fallback() payable {
    if calldata.size >= 4:
        if unknown_0x853828b6(?????) <= uint32(call.func_hash) >> 224:
            ...
            if unknown_0x5e256286(?????) > uint32(call.func_hash) >> 224:
                ...
                require return_data.size >= 32
                _147 = mem[ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32
                ...
                _149 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32 + 224]
                ...
                mem[(2 * ceil32(return_data.size)) + 224] = _149
                require return_data.size >= _147 + (32 * _149) + 32
                mem[(2 * ceil32(return_data.size)) + 256 len 32 * _149] = mem[ceil32(return_data.size) + _147 + 256 len 32 * _149]
                if 1 >= _149:
                    revert with 0, 50
                if mem[(2 * ceil32(return_data.size)) + 288] / 10^6 > 0x10c6f7a0b5ed8d36b4c7f34938583621fafc8b0079a2834d26fa3fcc9ea9:
                    revert with 0, 17
                mem[mem[64]] = 10^6 * mem[(2 * ceil32(return_data.size)) + 288] / 10^6
                return memory
                  from mem[64]
                   len 32
            if uint32(call.func_hash) >> 224 != unknown_0x5e256286(?????):
                if unknown_0x60d22cd5(?????) == uint32(call.func_hash) >> 224:
                    ...
                    if uint32(call.func_hash) >> 224 != unknown_0x611ef887(?????):
                        if uint32(call.func_hash) >> 224 != unknown_0x715018a6(?????):
                            if uint32(call.func_hash) >> 224 != unknown_0x834ee417(?????):
                            require not msg.value
                            return start_time
                        require not msg.value
                        if owner != msg.sender:
                ...
                mem[64] = (2 * ceil32(return_data.size)) + 224
                require return_data.size >= 32
                _148 = mem[ceil32(return_data.size) + 224 len 4], Mask(224, 32, msg.value) >> 32
                ...
                _150 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 224 len 4], Mask(224, 32, msg.value) >> 32 + 224]
                ...
                mem[(2 * ceil32(return_data.size)) + 224] = _150
                require return_data.size >= _148 + (32 * _150) + 32
                mem[(2 * ceil32(return_data.size)) + 256 len 32 * _150] = mem[ceil32(return_data.size) + _148 + 256 len 32 * _150]
                if 1 >= _150:
                    revert with 0, 50
                _179 = mem[(2 * ceil32(return_data.size)) + 288]
                if mem[(2 * ceil32(return_data.size)) + 288] / 10^6 > 0x10c6f7a0b5ed8d36b4c7f34938583621fafc8b0079a2834d26fa3fcc9ea9:
                    revert with 0, 17
                if not sub_cdac724d:
                    revert with 0, 18
                if 10^6 * mem[(2 * ceil32(return_data.size)) + 288] / 10^6 / sub_cdac724d > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
                    revert with 0, 17
                mem[0] = msg.sender
                mem[32] = 10
                if sub_f85ffe77[msg.sender] > !(10^6 * mem[(2 * ceil32(return_data.size)) + 288] / 10^6):
                    revert with 0, 17
                if sub_f85ffe77[msg.sender] + (10^6 * mem[(2 * ceil32(return_data.size)) + 288] / 10^6) < sub_95f26ce2:
                    revert with 0, 'PresaleFactory: The price is not allowed for presale.'
                if sub_f85ffe77[msg.sender] > !(10^6 * mem[(2 * ceil32(return_data.size)) + 288] / 10^6):
                    revert with 0, 17
                if sub_f85ffe77[msg.sender] + (10^6 * mem[(2 * ceil32(return_data.size)) + 288] / 10^6) > sub_1c5aeef7:
                    revert with 0, 'PresaleFactory: The price is not allowed for presale.'
                call stor9 with:
                   value msg.value wei
                     gas 2300 * is_zero(value) wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                mem[mem[64] + 4] = msg.sender
                mem[mem[64] + 36] = 10^18 * 10^6 * _179 / 10^6 / sub_cdac724d
                require ext_code.size(stor1)
                call stor1.0xa9059cbb with:
                     gas gas_remaining wei
                    args msg.sender, 10^18 * 10^6 * _179 / 10^6 / sub_cdac724d
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _190 = mem[64]
                ...
                if sub_f85ffe77[msg.sender] > !(10^6 * _179 / 10^6):
                    revert with 0, 17
                sub_f85ffe77[msg.sender] += 10^6 * _179 / 10^6
                emit 0x591accc0: this.address, msg.sender, 10^18 * 10^6 * _179 / 10^6 / sub_cdac724d
}
