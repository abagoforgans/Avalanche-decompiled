...
#  - _fallback()
#
const name = 'Black Friday Sale', 0
...
function getLiquidityBacking(uint256 arg1) {
    ...
    if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
        revert with 0, 18
    return (arg1 * 2 * balanceOf[stor23] / totalSupply - balanceOf[stor3] - balanceOf[stor4])
}
...
function isOverLiquified(uint256 arg1, uint256 arg2) {
    ...
    if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
        revert with 0, 18
    return (arg2 * 2 * balanceOf[stor23] / totalSupply - balanceOf[stor3] - balanceOf[stor4] > arg1)
}
