...
function sub_93bcd4d4(?) {
    require calldata.size - 4 >= 32
    if stor24[arg1].field_512:
        if not stor24[arg1].field_512 - (uint255(stor24[arg1].field_512) * 0.5 < 32):
            revert with 0, 34
        if stor24[arg1].field_512:
            if not stor24[arg1].field_512 - (uint255(stor24[arg1].field_512) * 0.5 < 32):
                revert with 0, 34
            if Mask(256, -1, stor24[arg1].field_512):
                if 31 >= uint255(stor24[arg1].field_512) * 0.5:
                    mem[128] = 256 * stor24[arg1].field_520
                else:
            ...
            if not stor24[arg1].field_512 - (stor24[arg1].field_513 < 32):
                revert with 0, 34
            if stor24[arg1].field_513:
                if 31 >= stor24[arg1].field_513:
                    mem[128] = 256 * stor24[arg1].field_520
                else:
                    mem[128] = stor24[arg1][2].field_0
                    idx = 128
                    s = 0
                    while stor24[arg1].field_513 + 96 > idx:
                        mem[idx + 32] = stor24[arg1][s + 2].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
        if stor24[arg1].field_16 >= 3:
            revert with 0, 33
        return bool(stor24[arg1].field_0), 
               bool(stor24[arg1].field_8),
               stor24[arg1].field_0,
    ...
    return bool(stor24[arg1].field_0), 
           ...
           stor24[arg1].field_0,
           stor24[arg1].field_256,
           Array(len=stor24[arg1].field_512, data=mem[128 len ceil32(stor24[arg1].field_513)]),
           stor24[arg1].field_768
}
...
function sub_8997ce4e(?) {
    if bool(stor22.length):
        ...
        if bool(stor22.length):
            ...
            if not bool(stor22.length) - (stor22.length.field_1 < 32):
                revert with 0, 34
...
function sub_a2b450a0(?) {
    ...
    if arg2 > 2:
        revert with 0, 33
    stor24[arg1].field_0 = 1
    stor24[arg1].field_8 = 0
    stor24[arg1].field_16 = 0
    if arg2 > 2:
        revert with 0, 33
    stor24[arg1].field_0 = 1
    stor24[arg1].field_8 = 0
    stor24[arg1].field_16 = Mask(240, 0, arg2)
    stor24[arg1].field_24 = 0
    stor24[arg1].field_24 = 0
    ...
    if stor24[arg1].field_512:
        ...
        if arg4.length:
            ...
            stor24[arg1].field_512 = 0
            idx = 0
            while stor24[arg1].field_513 + 31 / 32 > idx:
                stor24[arg1][idx + 2].field_0 = 0
                idx = idx + 1
                continue 
...
function sub_fbe14ce9(?) {
    ...
    if not uint8(assetType[arg1]):
        ...
        call stor20.withdraw(address arg1, uint256 arg2, address arg3) with:
             gas gas_remaining wei
            args stor14, 10^18 * price, this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if price > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
...
function sub_fbccfe03(?) {
    ...
    if not arg1:
        ...
        call stor20.deposit(address arg1, uint256 arg2, address arg3, uint16 arg4) with:
             gas gas_remaining wei
            args stor14, 10^18 * price, address(this.address), 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if stor33 > -2:
            revert with 0, 17
