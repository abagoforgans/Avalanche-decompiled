    ...
    if ext_call.return_data[0] >= arg4:
        ...
        if not stor16.length:
            ...
            call arg3.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, uint32(arg4), 0, 160, address(this.address), block.timestamp + 600, stor16.length
        else:
            mem[356] = address(stor16.field_0)
            idx = 356
            s = 0
            while (32 * stor16.length) + 356 > idx + 32:
            ...
            call arg3.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, uint32(arg4), 0, 160, address(this.address), block.timestamp + 600, stor16.length, mem[356 len 32 * stor16.length]
    else:
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                if not stor16.length:
                    ...
                    call arg3.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor16.length
                else:
                    mem[684] = address(stor16.field_0)
                    idx = 684
                    s = 0
                    while (32 * stor16.length) + 684 > idx + 32:
                        mem[idx + 32] = stor16[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    call arg3.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor16.length, mem[684 len 32 * stor16.length]
            else:
                mem[456 len return_data.size] = ext_call.return_data[0 len return_data.size]
                if not ext_call.success:
                    if return_data.size:
                ...
                if not stor16.length:
                    ...
                    mem[ceil32(return_data.size) + 685] = address(stor16.field_0)
                    idx = ceil32(return_data.size) + 685
                    s = 0
                    while ceil32(return_data.size) + (32 * stor16.length) + 685 > idx + 32:
                        mem[idx + 32] = stor16[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    call arg3.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor16.length, mem[ceil32(return_data.size) + 685 len 32 * stor16.length]
        else:
            mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
                if return_data.size:
            ...
            if not return_data.size:
                ...
                if not stor16.length:
                    ...
                    mem[(2 * ceil32(return_data.size)) + 686] = address(stor16.field_0)
                    idx = (2 * ceil32(return_data.size)) + 686
                    s = 0
                    while (2 * ceil32(return_data.size)) + (32 * stor16.length) + 686 > idx + 32:
                        mem[idx + 32] = stor16[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    call arg3.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor16.length, mem[(2 * ceil32(return_data.size)) + 686 len 32 * stor16.length]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
