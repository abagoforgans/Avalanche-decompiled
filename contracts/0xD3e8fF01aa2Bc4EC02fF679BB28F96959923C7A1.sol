...
function sub_68715111(?) payable {
    ...
    staticcall 0xa184ae1a71ecad20e822cb965b99c287590c4ffe.payoutFor(uint256 rg1) with:
            gas gas_remaining wei
...
function sub_a2a7b241(?) payable {
    ...
    staticcall 0xc26850686ce755ffb8690ea156e5a6cf03dcbde1.payoutFor(uint256 rg1) with:
            gas gas_remaining wei
           args ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_f23c0b0a(?) payable {
    ...
    staticcall 0x694738e0a438d90487b4a549b201142c1a97b556.payoutFor(uint256 rg1) with:
            gas gas_remaining wei
           args ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_275bc608(?) payable {
    ...
    require ext_code.size(0xb129e02d02eb6493d363fa1056500ec56ebe4de1)
    delegate 0xb129e02d02eb6493d363fa1056500ec56ebe4de1.0xcdf00d3b with:
         gas gas_remaining wei
