...
function getLiquidityBacking(uint256 arg1) {
    ...
    if totalSupply - balanceOf[stor4] < balanceOf[stor5]:
        revert with 0, 17
    if balanceOf[stor32] and 2 > -1 / balanceOf[stor32]:
        revert with 0, 17
    if arg1 and 2 * balanceOf[stor32] > -1 / arg1:
        revert with 0, 17
    if not totalSupply - balanceOf[stor4] - balanceOf[stor5]:
        revert with 0, 18
    return (arg1 * 2 * balanceOf[stor32] / totalSupply - balanceOf[stor4] - balanceOf[stor5])
}
...
function isOverLiquified(uint256 arg1, uint256 arg2) {
    ...
    if not totalSupply - balanceOf[stor4] - balanceOf[stor5]:
        revert with 0, 18
    return (arg2 * 2 * balanceOf[stor32] / totalSupply - balanceOf[stor4] - balanceOf[stor5] > arg1)
}
