...
function sub_72ba0ebb(?) payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6)
    call 0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6.forfeit() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[100] = this.address
    require ext_code.size(0x4fb8ec7e0ea19100b2fbd24f58454421f9764529)
    staticcall 0x4fb8ec7e0ea19100b2fbd24f58454421f9764529.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    mem[ceil32(return_data.size) + 100] = 0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6
    mem[ceil32(return_data.size) + 132] = ext_call.return_data[0]
    require ext_code.size(0x4fb8ec7e0ea19100b2fbd24f58454421f9764529)
    call 0x4fb8ec7e0ea19100b2fbd24f58454421f9764529.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6, ext_call.return_data[0]
    ...
    require ext_code.size(0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6)
    call 0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6.unstake(uint256 arg1, bool arg2) with:
         gas gas_remaining wei
        args ext_call.return_data[0], 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(2 * ceil32(return_data.size)) + 100] = this.address
    require ext_code.size(0xa5b0f5ef809fd04c9d4320211c711cb34ef812dd)
    staticcall 0xa5b0f5ef809fd04c9d4320211c711cb34ef812dd.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    mem[(4 * ceil32(return_data.size)) + 128] = 0xa5b0f5ef809fd04c9d4320211c711cb34ef812dd
    ...
    require ext_code.size(0xa5b0f5ef809fd04c9d4320211c711cb34ef812dd)
    call 0xa5b0f5ef809fd04c9d4320211c711cb34ef812dd.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
    ...
    require ext_code.size(0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6)
    call 0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6.epoch() with:
         gas gas_remaining wei
...
function sub_792e9e61(?) payable {
    ...
    require ext_code.size(0x72f95da8d7a9b405191cae0fc31711d575044efb)
    staticcall 0x72f95da8d7a9b405191cae0fc31711d575044efb.token0() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    require ext_code.size(0x72f95da8d7a9b405191cae0fc31711d575044efb)
    staticcall 0x72f95da8d7a9b405191cae0fc31711d575044efb.getReserves() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
...
function sub_8fdadfc1(?) payable {
    require ext_code.size(0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6)
    staticcall 0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6.0xdeac361a with:
            gas gas_remaining wei
    mem[96] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if uint8(stor1.field_160):
        ...
        if block.timestamp < uint128(stor1.field_0):
            revert with 0, '1e'
        require ext_code.size(0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6)
        call 0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6.rebase() with:
             gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6)
        call 0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6.claim(address arg1) with:
             gas gas_remaining wei
            args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[0]
        mem[(4 * ceil32(return_data.size)) + 100] = 0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6
        ...
        mem[(7 * ceil32(return_data.size)) + 128] = 0xa5b0f5ef809fd04c9d4320211c711cb34ef812dd
        ...
        mem[(4 * ceil32(return_data.size)) + 160] = 0xa5b0f5ef809fd04c9d4320211c711cb34ef812dd
        require ext_code.size(0x72f95da8d7a9b405191cae0fc31711d575044efb)
        staticcall 0x72f95da8d7a9b405191cae0fc31711d575044efb.token0() with:
                gas gas_remaining wei
        mem[(4 * ceil32(return_data.size)) + 192] = ext_call.return_data[0]
        ...
        if address(ext_call.return_data[0]) == 0x130966628846bfd36ff31a822705796e8cb8c18d:
            ...
            mem[mem[64] + 4] = 0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6
            mem[mem[64] + 36] = _200
            require ext_code.size(0xa5b0f5ef809fd04c9d4320211c711cb34ef812dd)
            call 0xa5b0f5ef809fd04c9d4320211c711cb34ef812dd.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args 0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6, _200
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _206 = mem[64]
            ...
            require ext_code.size(0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6)
            call 0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6.stake(uint256 arg1, address arg2) with:
                 gas gas_remaining wei
            ...
            call 0xa5b0f5ef809fd04c9d4320211c711cb34ef812dd.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args 0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6, _201
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _207 = mem[64]
