...
function tokenURI(uint256 arg1) payable {
    ...
    if stor9[arg1].length > 0:
        ...
        mem[64] = stor9[arg1].length + baseURI.length + ceil32(stor9[arg1].length) + ceil32(baseURI.length) + 192
        ...
        return 32, mem[stor9[arg1].length + baseURI.length + ceil32(stor9[arg1].length) + ceil32(baseURI.length) + 224 len floor32(mem[ceil32(stor9[arg1].length) + ceil32(baseURI.length) + 160]) + 64], 
    if not arg1:
        ...
        var33001 = ceil32(stor9[arg1].length) + floor32(baseURI.length) + 160
        ...
        mem[64] = baseURI.length + ceil32(stor9[arg1].length) + ceil32(baseURI.length) + 257
        ...
        return 32, mem[baseURI.length + ceil32(stor9[arg1].length) + ceil32(baseURI.length) + 289 len floor32(mem[ceil32(stor9[arg1].length) + ceil32(baseURI.length) + 224]) + 64], 
    s = 0
    idx = arg1
    while idx:
        s = s + 1
    ...
    if s:
        mem[ceil32(stor9[arg1].length) + ceil32(baseURI.length) + 192 len s] = code.data[15704 len s]
    t = s - 1
    idx = arg1
    while idx:
        require t < s
    ...
    mem[64] = s + baseURI.length + ceil32(stor9[arg1].length) + ceil32(baseURI.length) + ceil32(s) + 224
