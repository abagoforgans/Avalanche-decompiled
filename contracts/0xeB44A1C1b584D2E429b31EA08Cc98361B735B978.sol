            ...
            if not 0 / ext_call.return_data[0]:
                ...
                if not arg1:
                    ...
                    if not ext_code.size(sub_10bac359Address):
                        revert with 0, 'Address: call to non-contract'
                    mem[292 len 96] = transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(daoAddress), Mask(224, 32, arg1) >> 32
                    mem[416 len 4] = 0
                    mem[388 len 0] = 0
                    ...
                    if not return_data.size:
                        if not ext_call.success:
                            revert with transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(daoAddress), arg1
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(sub_f6a1b34bAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[456 len 64] = 0, msg.sender, Mask(224, 32, 0 / 0 / ext_call.return_data[0] * arg1 / 10^18) >> 32
                        call sub_f6a1b34bAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args 0 / 0 / ext_call.return_data[0] * arg1 / 10^18, mem[392 len 24], 0, mem[520 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(daoAddress), arg1
                            if not transferFrom(address arg1, address arg2, uint256 arg3), Mask(224, 32, msg.sender) >> 32:
                        ...
                        if not return_data.size:
                            ...
                            if not ext_code.size(sub_f6a1b34bAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 457 len 64] = 0, msg.sender, Mask(224, 32, 0 / 0 / ext_call.return_data[0] * arg1 / 10^18) >> 32
                            call sub_f6a1b34bAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args 0 / 0 / ext_call.return_data[0] * arg1 / 10^18, mem[ceil32(return_data.size) + 393 len 28], mem[ceil32(return_data.size) + 521 len 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(daoAddress), arg1
                                if not transferFrom(address arg1, address arg2, uint256 arg3), Mask(224, 32, msg.sender) >> 32:
                ...
                if not arg1:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(sub_f6a1b34bAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[456 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, 10^18 * 0 / ext_call.return_data[0] / 0 / ext_call.return_data[0] * arg1 / 10^18) >> 32
                        mem[520 len 0] = 0
                        call sub_f6a1b34bAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                        ...
                        if not ext_code.size(sub_f6a1b34bAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 457 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, 10^18 * 0 / ext_call.return_data[0] / 0 / ext_call.return_data[0] * arg1 / 10^18) >> 32
            ...
            if not 0 / ext_call.return_data[0]:
                ...
                if not arg1:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(sub_f6a1b34bAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[456 len 64] = 0, msg.sender, Mask(224, 32, 0 / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * arg1 / 10^18) >> 32
                        call sub_f6a1b34bAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args 0 / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * arg1 / 10^18, mem[392 len 24], 0, mem[520 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(daoAddress), arg1
                            if not transferFrom(address arg1, address arg2, uint256 arg3), Mask(224, 32, msg.sender) >> 32:
                        ...
                        if not return_data.size:
                            ...
                            if not ext_code.size(sub_f6a1b34bAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 457 len 64] = 0, msg.sender, Mask(224, 32, 0 / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * arg1 / 10^18) >> 32
                            call sub_f6a1b34bAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args 0 / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * arg1 / 10^18, mem[ceil32(return_data.size) + 393 len 28], mem[ceil32(return_data.size) + 521 len 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(daoAddress), arg1
                                if not transferFrom(address arg1, address arg2, uint256 arg3), Mask(224, 32, msg.sender) >> 32:
                ...
                if not arg1:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(sub_f6a1b34bAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[456 len 64] = transfer(address arg1, uint256 arg2), msg.sender, 0
                        mem[520 len 0] = 0
                        call sub_f6a1b34bAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args Mask(480, -256, transfer(address arg1, uint256 arg2), msg.sender, 0) << 256, mem[520 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(daoAddress), arg1
                            if not transferFrom(address arg1, address arg2, uint256 arg3), Mask(224, 32, msg.sender) >> 32:
                        ...
                        if not return_data.size:
                            ...
                            if not ext_code.size(sub_f6a1b34bAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 457 len 64] = transfer(address arg1, uint256 arg2), msg.sender, 0
                            ...
                            call sub_f6a1b34bAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                                args Mask(480, -256, transfer(address arg1, uint256 arg2), msg.sender, 0) << 256, mem[ceil32(return_data.size) + 521 len 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(daoAddress), arg1
                                if not transferFrom(address arg1, address arg2, uint256 arg3), Mask(224, 32, msg.sender) >> 32:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(sub_f6a1b34bAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[456 len 64] = 0, msg.sender, Mask(224, 32, 10^18 * 0 / ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * arg1 / 10^18) >> 32
                        call sub_f6a1b34bAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args 10^18 * 0 / ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * arg1 / 10^18, mem[392 len 24], 0, mem[520 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(daoAddress), arg1
                            if not transferFrom(address arg1, address arg2, uint256 arg3), Mask(224, 32, msg.sender) >> 32:
                        ...
                        if not ext_code.size(sub_f6a1b34bAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 457 len 64] = 0, msg.sender, Mask(224, 32, 10^18 * 0 / ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * arg1 / 10^18) >> 32
                        call sub_f6a1b34bAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args 10^18 * 0 / ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * arg1 / 10^18, mem[ceil32(return_data.size) + 393 len 28], mem[ceil32(return_data.size) + 521 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(daoAddress), arg1
                            if not transferFrom(address arg1, address arg2, uint256 arg3), Mask(224, 32, msg.sender) >> 32:
            ...
            if not 10^18 * ext_call.return_data[0] / ext_call.return_data[0]:
                ...
                if not arg1:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(sub_f6a1b34bAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[456 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, 0 / 0 / ext_call.return_data[0] * arg1 / 10^18) >> 32
                        mem[520 len 0] = 0
                        call sub_f6a1b34bAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                        ...
                        if not ext_code.size(sub_f6a1b34bAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 457 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, 0 / 0 / ext_call.return_data[0] * arg1 / 10^18) >> 32
                        mem[ceil32(return_data.size) + 521 len 0] = 0
                        call sub_f6a1b34bAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                ...
                if not arg1:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(sub_f6a1b34bAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[456 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, 10^18 * 10^18 * ext_call.return_data[0] / ext_call.return_data[0] / 0 / ext_call.return_data[0] * arg1 / 10^18) >> 32
                        call sub_f6a1b34bAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                        ...
                        if not ext_code.size(sub_f6a1b34bAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 457 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, 10^18 * 10^18 * ext_call.return_data[0] / ext_call.return_data[0] / 0 / ext_call.return_data[0] * arg1 / 10^18) >> 32
                        mem[ceil32(return_data.size) + 521 len 0] = 0
                        call sub_f6a1b34bAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
            ...
            if not 10^18 * ext_call.return_data[0] / ext_call.return_data[0]:
                ...
                if not arg1:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(sub_f6a1b34bAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[456 len 64] = 0, msg.sender, Mask(224, 32, 10^18 * 10^18 * ext_call.return_data[0] / ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * arg1 / 10^18) >> 32
                        call sub_f6a1b34bAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args 10^18 * 10^18 * ext_call.return_data[0] / ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * arg1 / 10^18, mem[392 len 24], 0, mem[520 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(daoAddress), arg1
                            if not transferFrom(address arg1, address arg2, uint256 arg3), Mask(224, 32, msg.sender) >> 32:
                        ...
                        if not ext_code.size(sub_f6a1b34bAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 457 len 64] = 0, msg.sender, Mask(224, 32, 10^18 * 10^18 * ext_call.return_data[0] / ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * arg1 / 10^18) >> 32
                        call sub_f6a1b34bAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                            args 10^18 * 10^18 * ext_call.return_data[0] / ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * arg1 / 10^18, mem[ceil32(return_data.size) + 393 len 28], mem[ceil32(return_data.size) + 521 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(daoAddress), arg1
                            if not transferFrom(address arg1, address arg2, uint256 arg3), Mask(224, 32, msg.sender) >> 32:
