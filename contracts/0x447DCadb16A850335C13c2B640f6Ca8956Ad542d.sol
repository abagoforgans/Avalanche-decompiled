...
function getAllocation(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if not stor116[address(arg1)]:
        return maximumPurchase
    return stor117[address(arg1)]
}
...
function addWhitelist(address arg1) payable {
    ...
    stor117[address(arg1)] = maximumPurchase
    ...
    while idx < arg1.length:
        ...
        if not stor116[mem[(32 * idx) + 140 len 20]]:
            ...
            if idx >= mem[96]:
                revert with 0, 50
            mem[32] = 117
            stor117[mem[(32 * idx) + 140 len 20]] = maximumPurchase
            mem[0] = mem[(32 * idx) + 140 len 20]
            if idx >= mem[96]:
                revert with 0, 50
...
function buyTokens(uint256 arg1) payable {
    ...
    if not stor116[msg.sender]:
        ...
        stor117[msg.sender] = maximumPurchase
    if arg1 > stor117[msg.sender]:
    ...
    if stor117[msg.sender] < arg1:
        revert with 0, 17
    stor117[msg.sender] -= arg1
    if 7500000 * 10^18 < tokensSold:
        revert with 0, 17
