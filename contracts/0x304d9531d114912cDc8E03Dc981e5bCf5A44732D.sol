...
mapping of uint256 existingCombinations;
...
function getTokenTraits(uint256 arg1) {
    ...
    return bool(tokenTraits[arg1].field_0), 
           ...
           tokenTraits[arg1].field_0,
           tokenTraits[arg1].field_0,
           tokenTraits[arg1].field_48
}

function existingCombinations(uint256 arg1) {
    require calldata.size - 4 >= 32
    return existingCombinations[arg1]
}
