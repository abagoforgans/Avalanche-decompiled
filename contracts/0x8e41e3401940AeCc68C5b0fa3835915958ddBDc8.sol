...
function sub_25c373d1(?) {
    ...
    uint8(stor15.field_0) = uint8(bool(arg1))
}
...
function sub_0161a290(?) {
    ...
    stor5 = 1
    mem[64] = (6 * ceil32(return_data.size)) + (32 * stor16.length) + 128
    mem[(6 * ceil32(return_data.size)) + 96] = stor16.length
    if not stor16.length:
        mem[(6 * ceil32(return_data.size)) + (32 * stor16.length) + 128] = 32
        mem[(6 * ceil32(return_data.size)) + (32 * stor16.length) + 160] = stor16.length
        idx = 0
        s = (6 * ceil32(return_data.size)) + 128
        t = (6 * ceil32(return_data.size)) + (32 * stor16.length) + 192
        while idx < stor16.length:
            ...
            continue 
        return memory
          from (6 * ceil32(return_data.size)) + (32 * stor16.length) + 128
           len (96 * stor16.length) + 64
    mem[(6 * ceil32(return_data.size)) + 128] = address(stor16.field_0)
    idx = (6 * ceil32(return_data.size)) + 128
    s = 0
    while (6 * ceil32(return_data.size)) + (32 * stor16.length) + 96 > idx:
    ...
    return memory
      from mem[64]
       len (6 * ceil32(return_data.size)) + (64 * stor16.length) + -mem[64] + 192
}
...
function swapBack() {
    ...
    if not (ext_call.return_data[0] * liquidityFee / 100 / 2) + (ext_call.return_data[0] * treasuryFee / 100) + (ext_call.return_data[0] * utilityFee / 100):
        ...
        if stor11 > !treasuryFee:
            revert with 0, 17
        if stor11 + treasuryFee > !utilityFee:
            revert with 0, 17
        if stor11 + treasuryFee + utilityFee > 0x1999999999999999999999999999999999999999999999999999999999999999:
            revert with 0, 17
        if liquidityFee > 0x4b8ed0283a6d3df769fb7e0b75e52f01a33f7668a62f547:
            revert with 0, 17
        if not (10 * stor11) + (10 * treasuryFee) + (10 * utilityFee):
            revert with 0, 18
        if treasuryFee > 0x119799812dea11197f27f0f6e885c8ba7eb31f476caf7411a863387:
            revert with 0, 17
        if not (10 * stor11) + (10 * treasuryFee) + (10 * utilityFee):
            revert with 0, 18
        if False and 1000 * 10^18 * liquidityFee / 2 / (10 * stor11) + (10 * treasuryFee) + (10 * utilityFee) > 0:
            revert with 0, 17
        if False and 10^12 * treasuryFee / (10 * stor11) + (10 * treasuryFee) + (10 * utilityFee) > 0:
            revert with 0, 17
        staticcall sub_82d90f68Address.0x70a08231 with:
                gas gas_remaining wei
               args this.address
        ...
        _57 = mem[_56]
        if not mem[_56]:
            emit 0xc20fef04: ext_call.return_data[0], ext_call.return_data[0] * treasuryFee / 100, ext_call.return_data[0] * utilityFee / 100, ext_call.return_data[0] * liquidityFee / 100, mem[_56]
        else:
            mem[mem[64] + 4] = 57005
            mem[mem[64] + 36] = _57
            call sub_82d90f68Address.0xa9059cbb with:
            ...
            emit 0xc20fef04: ext_call.return_data[0], ext_call.return_data[0] * treasuryFee / 100, ext_call.return_data[0] * utilityFee / 100, ext_call.return_data[0] * liquidityFee / 100, _57
        ...
        if unknown_0x8f32d59b(?????) <= uint32(call.func_hash) >> 224:
            ...
            if unknown_0x6ddd1713(?????) <= uint32(call.func_hash) >> 224:
                ...
                if unknown_0x40b2f5b5(?????) > uint32(call.func_hash) >> 224:
                    ...
                    stor16[stor16.length].field_0 = pairAddress
                    stor5 = 1
                    mem[64] = (6 * ceil32(return_data.size)) + (32 * stor16.length) + 160
                    mem[(6 * ceil32(return_data.size)) + 128] = stor16.length
                    if not stor16.length:
                        mem[(6 * ceil32(return_data.size)) + (32 * stor16.length) + 160] = 32
                        mem[(6 * ceil32(return_data.size)) + (32 * stor16.length) + 192] = stor16.length
                        idx = 0
                        s = (6 * ceil32(return_data.size)) + 160
                        t = (6 * ceil32(return_data.size)) + (32 * stor16.length) + 224
                        while idx < stor16.length:
                            mem[t] = mem[s + 12 len 20]
                            idx = idx + 1
                            s = s + 32
                            ...
                            continue 
                        return memory
                          from (6 * ceil32(return_data.size)) + (32 * stor16.length) + 160
                           len (96 * stor16.length) + 64
                    mem[(6 * ceil32(return_data.size)) + 160] = address(stor16.field_0)
                    idx = (6 * ceil32(return_data.size)) + 160
                    s = 0
                    while (6 * ceil32(return_data.size)) + (32 * stor16.length) + 128 > idx:
                        mem[idx + 32] = stor16[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    return memory
                      from mem[64]
                       len (6 * ceil32(return_data.size)) + (64 * stor16.length) + -mem[64] + 224
                if unknown_0x40b2f5b5(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    return sub_40b2f5b5Address
                ...
                if not (ext_call.return_data[0] * liquidityFee / 100 / 2) + (ext_call.return_data[0] * treasuryFee / 100) + (ext_call.return_data[0] * utilityFee / 100):
                    ...
                    _283 = mem[_282]
                    if not mem[_282]:
                        emit 0xc20fef04: ext_call.return_data[0], ext_call.return_data[0] * treasuryFee / 100, ext_call.return_data[0] * utilityFee / 100, ext_call.return_data[0] * liquidityFee / 100, mem[_282]
                    else:
                        mem[mem[64] + 4] = 57005
                        mem[mem[64] + 36] = _283
                        call sub_82d90f68Address.0xa9059cbb with:
                        ...
                        emit 0xc20fef04: ext_call.return_data[0], ext_call.return_data[0] * treasuryFee / 100, ext_call.return_data[0] * utilityFee / 100, ext_call.return_data[0] * liquidityFee / 100, _283
                uint8(stor13.field_0) = 0
}
