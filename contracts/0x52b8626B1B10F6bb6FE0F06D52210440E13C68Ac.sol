...
function sub_33735760(?) payable {
    ...
    staticcall stor2.power(uint256 arg1, uint256 arg2, uint32 arg3, uint32 arg4) with:
            gas gas_remaining wei
...
function sub_ef73b47d(?) payable {
    ...
    if sub_2cec0982[delegate.return_data[0]].field_512:
        if not sub_2cec0982[delegate.return_data[0]].field_1024:
            ...
            mem[(6 * ceil32(return_data.size)) + (32 * sub_2cec0982[delegate.return_data[0]].field_1024) + 576] = uint16(sub_2cec0982[delegate.return_data[0]].field_8)
        else:
    ...
    if not sub_2cec0982[delegate.return_data[0]].field_1024:
        ...
        mem[(6 * ceil32(return_data.size)) + (32 * sub_2cec0982[delegate.return_data[0]].field_1024) + 1312] = uint16(sub_2cec0982[delegate.return_data[0]].field_8)
    else:
