...
function withdraw() payable {
    ...
    if eth.balance(this.address) and 5 > -1 / eth.balance(this.address):
        revert with 'NH{q', 17
    call 0x74ed471d7c89e5d77e955e36266543fc2d70bc2a with:
...
function sub_44799d6c(?) payable {
    ...
    while idx <= arg1:
        ...
        mem[64] = mem[64] + 32
        mem[_93] = 0
        if not address(whitelisted[idx]):
        ...
        if address(whitelisted[idx]):
            tokenOfOwnerByIndex[address(stor19[idx])][stor3[address(stor19[idx])]] = tokenByIndex.length + idx
            stor7[stor8.length + idx] = balanceOf[address(stor19[idx])]
            if balanceOf[address(stor19[idx])] > -2:
                revert with 'NH{q', 17
            balanceOf[address(stor19[idx])]++
            mem[0] = tokenByIndex.length + idx
            mem[32] = 2
            ownerOf[stor8.length + idx] = address(whitelisted[idx])
            emit Transfer(0, address(whitelisted[idx]), tokenByIndex.length + idx);
            if ext_code.size(address(whitelisted[idx])) > 0:
                ...
                while s < 0:
                    ...
                    s = s + 32
                    continue 
                require ext_code.size(address(whitelisted[idx]))
                call address(whitelisted[idx]).0x150b7a02 with:
                     gas gas_remaining wei
    ...
    if msg.sender == owner:
        ...
        while idx <= arg1:
            ...
            if msg.sender:
                ...
                if ext_code.size(msg.sender) > 0:
                    ...
                    s = 0
                    while s < 0:
                        mem[mem[64] + s + 164] = mem[_275 + s + 32]
                        s = s + 32
                        continue 
        ...
        if bool(onlyWhitelisted) == 1:
            ...
            while idx < whitelisted.length:
                ...
                mem[0] = msg.sender
                mem[32] = 3
                require balanceOf[address(msg.sender)] < nftPerAddressLimit
                ...
                while idx <= arg1:
                    ...
                    if msg.sender:
                        ...
                        if ext_code.size(msg.sender) > 0:
                            ...
                            s = 0
                            while s < 0:
                                mem[mem[64] + s + 164] = mem[_557 + s + 32]
                                s = s + 32
                                continue 
                            require ext_code.size(msg.sender)
                            call msg.sender.0x150b7a02 with:
        ...
        while idx <= arg1:
            ...
            if msg.sender:
                ...
                if ext_code.size(msg.sender) > 0:
                    ...
                    s = 0
                    while s < 0:
                        mem[mem[64] + s + 164] = mem[_276 + s + 32]
                        s = s + 32
                        continue 
                    require ext_code.size(msg.sender)
                    call msg.sender.0x150b7a02 with:
                    ...
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    require mem[_555] == Mask(32, 224, mem[_555])
                    if Mask(32, 224, mem[_555]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                        revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
            else:
                if tokenByIndex.length < 1:
                    revert with 'NH{q', 17
