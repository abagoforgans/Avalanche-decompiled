...
function sub_e577940d(?) payable {
    ...
    mem[floor32(('cd', 4).length) + 133] = this.address
    mem[floor32(('cd', 4).length) + 165] = 10000 * ('cd', 4).length
    require ext_code.size(sub_ec04327aAddress)
    call sub_ec04327aAddress.0x23b872dd with:
         gas gas_remaining wei
        args msg.sender, address(this.address), 10000 * ('cd', 4).length
...
function depositsOf(address arg1) {
    ...
    if not stor5[address(arg1)].field_0:
        ...
        if var48002 >= stor5[address(arg1)].field_0:
            mem[(32 * stor5[address(arg1)].field_0) + 128] = 32
            mem[(32 * stor5[address(arg1)].field_0) + 160] = stor5[address(arg1)].field_0
            ...
            return memory
              from (32 * stor5[address(arg1)].field_0) + 128
               len (96 * stor5[address(arg1)].field_0) + 64
        if var54001 >= stor5[address(arg1)].field_0:
            revert with 'NH{q', 50
        mem[0] = sha3(address(arg1), 5)
        if var60002 >= stor5[address(arg1)].field_0:
            revert with 'NH{q', 50
        mem[(32 * var60002) + 128] = var60001
        s = var60002
        t = var60001
        idx = var60002
        while idx != -1:
...
function sub_b97e439a(?) {
    ...
    while idx < ('cd', 4).length:
        ...
        mem[0] = cd[((32 * idx) + cd[4] + 36)]
        mem[32] = sha3(address(msg.sender), 5) + 1
        if not stor5[address(msg.sender)][1][cd[((32 * idx) + cd[4] + 36)]].field_0:
            stor5[address(msg.sender)].field_0++
            stor5[address(msg.sender)][stor5[address(msg.sender)].field_0].field_0 = cd[((32 * idx) + cd[4] + 36)]
            mem[0] = cd[((32 * idx) + cd[4] + 36)]
            mem[32] = sha3(address(msg.sender), 5) + 1
            stor5[address(msg.sender)][1][cd[((32 * idx) + cd[4] + 36)]].field_0 = stor5[address(msg.sender)].field_0
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
