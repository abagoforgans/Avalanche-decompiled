...
function sub_14b0750b(?) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_d539fe4b = arg1
    emit 0x4812bd1a: arg1
}
...
function sub_358d6a04(?) {
    ...
    if not ext_call.return_data[32] * sub_d539fe4b / 10^18:
        revert with 0, 18
    if stor15 < (10000 * ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0]) + (ext_call.return_data[32] * sub_d539fe4b / 10^18 * ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0]) / ext_call.return_data[32] * sub_d539fe4b / 10^18:
        return stor15
...
function sub_b580a128(?) {
    staticcall stor24.userInfo(uint256 arg1, address arg2) with:
            gas gas_remaining wei
           args stor28, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
