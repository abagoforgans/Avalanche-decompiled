...
function setDev(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    sub_6af65929Address = arg1
}

function sub_7801ed1b(?) {
    require calldata.size - 4 >= 32
    require arg1 == bool(arg1)
    sub_9f02979b = uint8(bool(arg1))
}
...
function sub_7bbbf58b(?) {
    ...
    emit 0xfeddf252: balanceOf[address(arg1)], 0, address(arg2)
    if not address(arg1):
        revert with 0, '3'
    if totalSupply < balanceOf[address(arg1)]:
        revert with 0, 17
    ...
    emit 0xfeddf252: balanceOf[address(arg1)], address(arg1), 0
}
...
function initialize(address arg1) {
    ...
    _taxFee = 10
    stor109 = 100
    uint256(stor110.field_0) = msg.sender or Mask(96, 160, uint256(stor110.field_0))
...
function transfer(address arg1, uint256 arg2) {
    ...
    if uint8(stor110.field_160):
        ...
        balanceOf[address(msg.sender)] -= arg2
        if balanceOf[this.address] >= stor107:
            uint8(stor110.field_160) = 1
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            call sub_6af65929Address with:
               value eth.balance(this.address) wei
                 gas 3 * 10^6 wei
            if not ext_call.success:
                revert with 0, 'receiver rejected ETH transfer'
            uint8(stor110.field_160) = 0
        if stor104[address(msg.sender)]:
            ...
            if stor104[address(arg1)]:
                ...
                if not sub_9f02979b:
                    ...
                    if not stor109:
                        revert with 0, 18
                    if balanceOf[this.address] > !(arg2 * _taxFee / stor109):
                        revert with 0, 17
                    balanceOf[this.address] += arg2 * _taxFee / stor109
                    emit 0xfeddf252: (arg2 * _taxFee / stor109), msg.sender, this.address
                    if not this.address:
                        revert with 0, '3'
                    if totalSupply < arg2 * _taxFee / stor109 / 2:
                        revert with 0, 17
                    totalSupply -= arg2 * _taxFee / stor109 / 2
                    if balanceOf[address(this.address)] < arg2 * _taxFee / stor109 / 2:
                        revert with 0, 17
                    balanceOf[address(this.address)] -= arg2 * _taxFee / stor109 / 2
                    emit 0xfeddf252: (arg2 * _taxFee / stor109 / 2), this.address, 0
                    if arg2 < arg2 * _taxFee / stor109:
                        revert with 0, 17
                    if balanceOf[address(arg1)] > !(arg2 - (arg2 * _taxFee / stor109)):
                        revert with 0, 17
                    balanceOf[address(arg1)] = balanceOf[address(arg1)] + arg2 - (arg2 * _taxFee / stor109)
                    emit 0xfeddf252: (arg2 - (arg2 * _taxFee / stor109)), msg.sender, arg1
    return 1
}
        ...
        if stor104[address(arg1)]:
            ...
            if stor104[address(arg2)]:
                ...
                if not sub_9f02979b:
                    ...
                    if not stor109:
                        revert with 0, 18
                    if balanceOf[this.address] > !(arg3 * _taxFee / stor109):
                        revert with 0, 17
                    balanceOf[this.address] += arg3 * _taxFee / stor109
                    emit 0xfeddf252: (arg3 * _taxFee / stor109), arg1, this.address
                    if not this.address:
                        revert with 0, '3'
                    if totalSupply < arg3 * _taxFee / stor109 / 2:
                        revert with 0, 17
                    totalSupply -= arg3 * _taxFee / stor109 / 2
                    if balanceOf[address(this.address)] < arg3 * _taxFee / stor109 / 2:
                        revert with 0, 17
                    balanceOf[address(this.address)] -= arg3 * _taxFee / stor109 / 2
                    emit 0xfeddf252: (arg3 * _taxFee / stor109 / 2), this.address, 0
                    if arg3 < arg3 * _taxFee / stor109:
                        revert with 0, 17
                    if balanceOf[address(arg2)] > !(arg3 - (arg3 * _taxFee / stor109)):
                        revert with 0, 17
                    balanceOf[address(arg2)] = balanceOf[address(arg2)] + arg3 - (arg3 * _taxFee / stor109)
                    emit 0xfeddf252: (arg3 - (arg3 * _taxFee / stor109)), arg1, arg2
...
function _fallback() payable {
    ...
    if unknown_0x7bbbf58b(?????) <= uint32(call.func_hash) >> 224:
        if unknown_0xa9059cbb(?????) > uint32(call.func_hash) >> 224:
            if unknown_0x960bfe04(?????) <= uint32(call.func_hash) >> 224:
                if unknown_0x960bfe04(?????) == uint32(call.func_hash) >> 224:
                ...
                return 1
            if uint32(call.func_hash) >> 224 != unknown_0x7bbbf58b(?????):
            ...
            if not address(cd[36]):
                revert with 0, '2'
            if totalSupply > !balanceOf[address(cd[4])]:
                revert with 0, 17
            totalSupply += balanceOf[address(cd[4])]
            if balanceOf[address(cd[36])] > !balanceOf[address(cd[4])]:
                revert with 0, 17
            balanceOf[address(cd[36])] += balanceOf[address(cd[4])]
            emit 0xfeddf252: balanceOf[address(cd[4])], 0, address(cd[36])
            if not address(cd[4]):
                revert with 0, '3'
            if totalSupply < balanceOf[address(cd[4])]:
                revert with 0, 17
            ...
            if balanceOf[address(cd[4])] < balanceOf[address(cd[4])]:
                revert with 0, 17
            balanceOf[address(cd[4])] = 0
            emit 0xfeddf252: balanceOf[address(cd[4])], address(cd[4]), 0
        ...
        if uint32(call.func_hash) >> 224 != unknown_0xa9059cbb(?????):
            if unknown_0xc4081a4c(?????) == uint32(call.func_hash) >> 224:
                ...
                if uint32(call.func_hash) >> 224 != unknown_0xc4d66de8(?????):
                    require unknown_0xd477f05f(?????) == uint32(call.func_hash) >> 224
                    require not msg.value
                    require calldata.size - 4 >= 32
                    require cd[4] == address(cd[4])
                    sub_6af65929Address = address(cd[4])
                else:
                    require not msg.value
                    require calldata.size - 4 >= 32
                    require cd[4] == address(cd[4])
            ...
            if stor104[address(msg.sender)]:
                ...
                if stor104[address(cd[4])]:
                    ...
                    if not sub_9f02979b:
                        ...
                        if not stor109:
                            revert with 0, 18
                        if balanceOf[this.address] > !(cd[36] * _taxFee / stor109):
                            revert with 0, 17
                        balanceOf[this.address] += cd[36] * _taxFee / stor109
                        emit 0xfeddf252: (cd[36] * _taxFee / stor109), msg.sender, this.address
                        if not this.address:
                            revert with 0, '3'
                        if totalSupply < cd[36] * _taxFee / stor109 / 2:
                            revert with 0, 17
                        totalSupply -= cd[36] * _taxFee / stor109 / 2
                        if balanceOf[address(this.address)] < cd[36] * _taxFee / stor109 / 2:
                            revert with 0, 17
                        balanceOf[address(this.address)] -= cd[36] * _taxFee / stor109 / 2
                        emit 0xfeddf252: (cd[36] * _taxFee / stor109 / 2), this.address, 0
                        if cd[36] < cd[36] * _taxFee / stor109:
                            revert with 0, 17
                        if balanceOf[address(cd[4])] > !(cd[36] - (cd[36] * _taxFee / stor109)):
                            revert with 0, 17
                        balanceOf[address(cd[4])] = balanceOf[address(cd[4])] + cd[36] - (cd[36] * _taxFee / stor109)
                        emit 0xfeddf252: (cd[36] - (cd[36] * _taxFee / stor109)), msg.sender, address(cd[4])
    else:
        if unknown_0x332402f8(?????) <= uint32(call.func_hash) >> 224:
            if unknown_0x70a08231(?????) > uint32(call.func_hash) >> 224:
                ...
                if uint32(call.func_hash) >> 224 != unknown_0x39509351(?????):
                    if unknown_0x3b124fe7(?????) == uint32(call.func_hash) >> 224:
                        require not msg.value
                        return _taxFee
                    require unknown_0x6af65929(?????) == uint32(call.func_hash) >> 224
                    require not msg.value
                    return sub_6af65929Address
                require not msg.value
                require calldata.size - 4 >= 64
                ...
                if unknown_0x7801ed1b(?????) == uint32(call.func_hash) >> 224:
                    ...
                    sub_9f02979b = uint8(bool(cd[4]))
                require unknown_0x7b9417c8(?????) == uint32(call.func_hash) >> 224
                require not msg.value
                require calldata.size - 4 >= 32
                require cd[4] == address(cd[4])
                if owner != msg.sender:
                    ...
                    if stor104[address(cd[4])]:
                        ...
                        if stor104[address(cd[36])]:
                            ...
                            if not sub_9f02979b:
                                ...
                                if not stor109:
                                    revert with 0, 18
                                if balanceOf[this.address] > !(cd[68] * _taxFee / stor109):
                                    revert with 0, 17
                                balanceOf[this.address] += cd[68] * _taxFee / stor109
                                emit 0xfeddf252: (cd[68] * _taxFee / stor109), address(cd[4]), this.address
                                if not this.address:
                                    revert with 0, '3'
                                if totalSupply < cd[68] * _taxFee / stor109 / 2:
                                    revert with 0, 17
                                totalSupply -= cd[68] * _taxFee / stor109 / 2
                                if balanceOf[address(this.address)] < cd[68] * _taxFee / stor109 / 2:
                                    revert with 0, 17
                                balanceOf[address(this.address)] -= cd[68] * _taxFee / stor109 / 2
                                emit 0xfeddf252: (cd[68] * _taxFee / stor109 / 2), this.address, 0
                                if cd[68] < cd[68] * _taxFee / stor109:
                                    revert with 0, 17
                                if balanceOf[address(cd[36])] > !(cd[68] - (cd[68] * _taxFee / stor109)):
                                    revert with 0, 17
                                balanceOf[address(cd[36])] = balanceOf[address(cd[36])] + cd[68] - (cd[68] * _taxFee / stor109)
                                emit 0xfeddf252: (cd[68] - (cd[68] * _taxFee / stor109)), address(cd[4]), address(cd[36])
