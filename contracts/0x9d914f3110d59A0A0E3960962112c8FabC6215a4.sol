...
function sub_3d11c00d(?) payable {
    ...
    if not arg2:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply + 4000 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 4000 * 10^18
    if balanceOf[address(arg2)] + 4000 * 10^18 < balanceOf[address(arg2)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg2)] += 4000 * 10^18
    emit Transfer(4000 * 10^18, 0, arg2);
}
