...
function setReferrers(address arg1) payable {
    require calldata.size - 4 >= 32
    require not referral[address(msg.sender)]
    referral[address(msg.sender)] = arg1
}
...
function setRefBonus(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require arg1 > 0
