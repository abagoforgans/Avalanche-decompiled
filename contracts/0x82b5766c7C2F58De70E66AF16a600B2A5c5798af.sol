    ...
    if not ext_call.return_data[0]:
        ...
        if not ext_call.return_data[0]:
            ...
            if not return_data.size:
                ...
                if ext_code.size(arg1) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 552 len 96] = 0, 0x60ae616a2155ee3d9a68541ba4544862310933d4, 0, 0
                mem[(2 * ceil32(return_data.size)) + 620] = 0
                call arg1 with:
                   funct Mask(32, 224, 0, 0x60ae616a2155ee3d9a68541ba4544862310933d4, 0, 0) >> 224
                     gas gas_remaining wei
                    args (Mask(512, -288, 0, 0x60ae616a2155ee3d9a68541ba4544862310933d4, 0, 0) << 288)
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0] > 0:
                            revert with memory
                ...
                if ext_code.size(arg1) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 553 len 96] = 0, 0x60ae616a2155ee3d9a68541ba4544862310933d4, 0, 0
