...
function setResource(bytes32 arg1, address arg2, bytes4 arg3, bytes4 arg4) payable {
    ...
    uint256(_contract[address(arg2)]) = Mask(224, 32, uint256(_contract[address(arg2)])) or uint32(arg3) >> 224
    uint256(_contract[address(arg2)]) = Mask(224, 32, uint256(_contract[address(arg2)])) or uint32(arg4) >> 224
...
function executeProposal(bytes32 arg1, bytes arg2) payable {
    ...
    if Mask(32, 224, uint32(_contract[stor2[arg1]])):
        ...
        if ceil32(mem[96]) > mem[96]:
            mem[mem[96] + cd[100] + 228] = 0
        mem[mem[96] + cd[100] + 228 len floor32(mem[96] + 35)] = 0, mem[cd[100] + 228 len floor32(mem[96] + 35) - 4]
        if floor32(mem[96] + 35) > mem[96] + 4:
            mem[(2 * mem[96]) + cd[100] + 232] = 0
        call _resourceIDToContract[arg1].mem[mem[96] + cd[100] + 228 len 4] with:
             gas gas_remaining wei
            args mem[mem[96] + cd[100] + 232 len mem[96]]
...
function deposit(bytes32 arg1, uint8 arg2, uint64 arg3, address arg4, bytes arg5) payable {
    ...
    if not Mask(32, 224, uint32(_contract[stor2[arg1]])):
        ...
        if ceil32(mem[96]) > mem[96]:
            mem[mem[96] + cd[196] + 164] = 0
        mem[cd[196] + 128] = mem[96] + 4
        mem[mem[96] + cd[196] + 164 len floor32(mem[96] + 35)] = 0, mem[cd[196] + 164 len floor32(mem[96] + 35) - 4]
        if floor32(mem[96] + 35) > mem[96] + 4:
            mem[(2 * mem[96]) + cd[196] + 168] = 0
        call _resourceIDToContract[arg1].mem[mem[96] + cd[196] + 164 len 4] with:
             gas gas_remaining wei
            args mem[mem[96] + cd[196] + 168 len mem[96]]
        if not ext_call.success:
            revert with 0, 'delegatecall to contractAddress failed'
