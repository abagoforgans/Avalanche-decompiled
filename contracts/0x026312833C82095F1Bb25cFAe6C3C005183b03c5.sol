...
#
#  - initialize(string arg1, string arg2, uint256 arg3)
#
const decimals = 18
...
function name() payable {
    if bool(stor204.length):
        ...
        if ceil32(stor204.length.field_1) > stor204.length.field_1:
            mem[ceil32(stor204.length.field_1) + stor204.length.field_1 + 192] = 0
...
function symbol() payable {
    if bool(stor205.length):
        ...
        if ceil32(stor205.length.field_1) > stor205.length.field_1:
            mem[ceil32(stor205.length.field_1) + stor205.length.field_1 + 192] = 0
