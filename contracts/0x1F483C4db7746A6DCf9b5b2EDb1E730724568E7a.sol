...
function emergencyRedeem(uint256 arg1) {
    ...
    if 0 == totalSupply:
        ...
        if bool(bool(underlyingDecimal < 78)) or bool(bool(underlyingDecimal < 32)):
            ...
            call masterChefAddress.withdraw(uint256 arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args PID, 10^underlyingDecimal * arg1 / 10^18
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if balanceOf[address(msg.sender)] < arg1:
                revert with 0, 17
    ...
    call masterChefAddress.withdraw(uint256 arg1, uint256 arg2) with:
         gas gas_remaining wei
        args PID, 10^18 * ext_call.return_data[0] / totalSupply * arg1 / 10^18
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if balanceOf[address(msg.sender)] < arg1:
        revert with 0, 17
...
function sub_a8df1896(?) {
    ...
    if uint8(stor9.field_8):
        ...
        uint8(stor9.field_8) = 0
        emit 0x7f26b83f: 1
    masterChefAddress = address(arg8)
    PID = arg9
