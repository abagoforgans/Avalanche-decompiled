...
function sub_d9ca3c9c(?) payable {
    ...
    require (7 * ceil32(return_data.size)) + ceil32(mem[(6 * ceil32(return_data.size)) + mem[(6 * ceil32(return_data.size)) + 1504] + 1504]) + 1536 <= test266151307() and ceil32(mem[(6 * ceil32(return_data.size)) + mem[(6 * ceil32(return_data.size)) + 1504] + 1504]) + 32 >= 0
    ...
    if ceil32(_25) <= _25:
        ...
        mem[_1442] = sub_7fedad55.length
        mem[0] = 0
        mem[_1442 + 32] = uint256(sub_7fedad55.field_0)
        idx = _1442 + 32
        s = 0
        while _1442 + sub_7fedad55.length > idx:
            mem[idx + 32] = sub_7fedad55[s].field_256
            idx = idx + 32
            s = s + 1
            continue 
        _6022 = mem[64]
        mem[mem[64] + 32 len ceil32(sub_7fedad55.length)] = mem[_1442 + 32 len ceil32(sub_7fedad55.length)]
        if ceil32(sub_7fedad55.length) <= sub_7fedad55.length:
            _10846 = mem[64]
            mem[mem[64]] = sub_7fedad55.length
            mem[64] = mem[64] + sub_7fedad55.length + 32
            _10848 = sha3(mem[_10846 + 32 len mem[_10846]])
            _10924 = mem[(7 * ceil32(return_data.size)) + 1504]
            mem[_6022 + sub_7fedad55.length + 64 len ceil32(mem[(7 * ceil32(return_data.size)) + 1504])] = mem[(7 * ceil32(return_data.size)) + 1536 len ceil32(mem[(7 * ceil32(return_data.size)) + 1504])]
            mem[64] = _6022 + sub_7fedad55.length + _10924 + 64
            if sha3(mem[_6022 + sub_7fedad55.length + 64 len _10924]) == _10848:
            ...
            mem[mem[64] + sub_7fedad55.length + 32] = 0
            _10878 = mem[64]
            mem[mem[64]] = sub_7fedad55.length
            mem[64] = mem[64] + sub_7fedad55.length + 32
            _10880 = sha3(mem[_10878 + 32 len mem[_10878]])
            _10940 = mem[(7 * ceil32(return_data.size)) + 1504]
            mem[_6022 + sub_7fedad55.length + 64 len ceil32(mem[(7 * ceil32(return_data.size)) + 1504])] = mem[(7 * ceil32(return_data.size)) + 1536 len ceil32(mem[(7 * ceil32(return_data.size)) + 1504])]
            mem[64] = _6022 + sub_7fedad55.length + _10940 + 64
            if sha3(mem[_6022 + sub_7fedad55.length + 64 len _10940]) == _10880:
                if ext_call.return_data[64] <= 2:
                    require ext_code.size(address(arg1))
                    if ext_call.return_data[64] != 1:
                        staticcall address(arg1).supplyRatePerSecond() with:
        ...
        mem[(7 * ceil32(return_data.size)) + _25 + 1536] = 0
        _1443 = mem[64]
        mem[64] = mem[64] + ceil32(sub_7fedad55.length) + 32
        mem[_1443] = sub_7fedad55.length
        mem[0] = 0
        mem[_1443 + 32] = uint256(sub_7fedad55.field_0)
        idx = _1443 + 32
        s = 0
        while _1443 + sub_7fedad55.length > idx:
            mem[idx + 32] = sub_7fedad55[s].field_256
            idx = idx + 32
            s = s + 1
            continue 
        _6023 = mem[64]
        mem[mem[64] + 32 len ceil32(sub_7fedad55.length)] = mem[_1443 + 32 len ceil32(sub_7fedad55.length)]
        if ceil32(sub_7fedad55.length) <= sub_7fedad55.length:
            _10862 = mem[64]
            mem[mem[64]] = sub_7fedad55.length
            mem[64] = mem[64] + sub_7fedad55.length + 32
            _10864 = sha3(mem[_10862 + 32 len mem[_10862]])
            _10933 = mem[(7 * ceil32(return_data.size)) + 1504]
            mem[_6023 + sub_7fedad55.length + 64 len ceil32(mem[(7 * ceil32(return_data.size)) + 1504])] = mem[(7 * ceil32(return_data.size)) + 1536 len ceil32(mem[(7 * ceil32(return_data.size)) + 1504])]
            mem[64] = _6023 + sub_7fedad55.length + _10933 + 64
            if sha3(mem[_6023 + sub_7fedad55.length + 64 len _10933]) == _10864:
                if ext_call.return_data[64] <= 2:
                    require ext_code.size(address(arg1))
                    if ext_call.return_data[64] != 1:
                        staticcall address(arg1).supplyRatePerSecond() with:
            ...
            mem[mem[64]] = sub_7fedad55.length
            mem[64] = mem[64] + sub_7fedad55.length + 32
            _10896 = sha3(mem[_10894 + 32 len mem[_10894]])
            _10945 = mem[(7 * ceil32(return_data.size)) + 1504]
            mem[_6023 + sub_7fedad55.length + 64 len ceil32(mem[(7 * ceil32(return_data.size)) + 1504])] = mem[(7 * ceil32(return_data.size)) + 1536 len ceil32(mem[(7 * ceil32(return_data.size)) + 1504])]
            mem[64] = _6023 + sub_7fedad55.length + _10945 + 64
            if sha3(mem[_6023 + sub_7fedad55.length + 64 len _10945]) == _10896:
                if ext_call.return_data[64] <= 2:
                    require ext_code.size(address(arg1))
                    if ext_call.return_data[64] != 1:
                        staticcall address(arg1).supplyRatePerSecond() with:
