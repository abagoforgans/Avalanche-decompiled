...
function callReward() payable {
    ...
    if not outputToNativeRoute.length:
        ...
        mem[64] = (32 * _20) + ceil32(return_data.size) + 128
        require mem[ceil32(return_data.size) + 96] - 1 < mem[ceil32(return_data.size) + 96]
        if ext_call.return_data[0] + mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128] < ext_call.return_data[0]:
            revert with 0, 'SafeMath: addition overflow'
        if not ext_call.return_data[0] + mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128]:
            return 0
        require ext_call.return_data[0] + mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128]
        if (45 * ext_call.return_data[0]) + (45 * mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128]) / ext_call.return_data[0] + mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128] != 45:
            revert with 0, 
                        32,
                        33,
                        0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                        mem[(32 * _20) + ceil32(return_data.size) + 229 len 31]
        if not (45 * ext_call.return_data[0]) + (45 * mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128]) / 1000:
            return 0
        require (45 * ext_call.return_data[0]) + (45 * mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128]) / 1000
        if (45 * ext_call.return_data[0]) + (45 * mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128]) / 1000 * callFee / (45 * ext_call.return_data[0]) + (45 * mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128]) / 1000 != callFee:
            revert with 0, 
                        32,
                        33,
                        0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                        mem[(32 * _20) + ceil32(return_data.size) + 229 len 31]
        mem[(32 * _20) + ceil32(return_data.size) + 128] = (45 * ext_call.return_data[0]) + (45 * mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128]) / 1000 * callFee / 1000
        return memory
          from (32 * _20) + ceil32(return_data.size) + 128
           len 32
    mem[0] = 19
    ...
    mem[64] = (32 * _76) + ceil32(return_data.size) + 128
    require mem[ceil32(return_data.size) + 96] - 1 < mem[ceil32(return_data.size) + 96]
    if ext_call.return_data[0] + mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128] < ext_call.return_data[0]:
        revert with 0, 'SafeMath: addition overflow'
    if not ext_call.return_data[0] + mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128]:
    ...
    if (45 * ext_call.return_data[0]) + (45 * mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128]) / ext_call.return_data[0] + mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128] != 45:
        revert with 0, 
                    ...
                    33,
                    0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                    mem[(32 * _76) + ceil32(return_data.size) + 229 len 31]
    if not (45 * ext_call.return_data[0]) + (45 * mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128]) / 1000:
        return 0
    require (45 * ext_call.return_data[0]) + (45 * mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128]) / 1000
    if (45 * ext_call.return_data[0]) + (45 * mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128]) / 1000 * callFee / (45 * ext_call.return_data[0]) + (45 * mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128]) / 1000 != callFee:
        revert with 0, 
                    ...
                    0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                    mem[(32 * _76) + ceil32(return_data.size) + 229 len 31]
    mem[(32 * _76) + ceil32(return_data.size) + 128] = (45 * ext_call.return_data[0]) + (45 * mem[(32 * mem[ceil32(return_data.size) + 96] - 1) + ceil32(return_data.size) + 128]) / 1000 * callFee / 1000
    return memory
      from (32 * _76) + ceil32(return_data.size) + 128
       len 32
}
