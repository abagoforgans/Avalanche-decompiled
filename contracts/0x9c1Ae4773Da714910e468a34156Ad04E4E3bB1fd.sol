...
function sub_02f935c9(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if posters[address(arg1)].field_0 <= 0:
        return 0
    if not sub_a87f7fb9:
        revert with 'NH{q', 18
    if block.number < posters[address(arg1)].field_128:
        revert with 'NH{q', 17
    if block.number - posters[address(arg1)].field_128 and 124 * 10^14 / sub_a87f7fb9 > -1 / block.number - posters[address(arg1)].field_128:
        revert with 'NH{q', 17
    if (block.number * 124 * 10^14 / sub_a87f7fb9) - (posters[address(arg1)].field_128 * 124 * 10^14 / sub_a87f7fb9) <= posters[address(arg1)].field_0:
        return ((block.number * 124 * 10^14 / sub_a87f7fb9) - (posters[address(arg1)].field_128 * 124 * 10^14 / sub_a87f7fb9))
    return posters[address(arg1)].field_0
}
...
function sub_281d7c48(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if airdrops[address(arg1)].field_0 >= 100 * 10^18:
        if not totalAirdrops:
            revert with 'NH{q', 18
        if block.number < airdrops[address(arg1)].field_128:
            revert with 'NH{q', 17
        if 124 * 10^14 / totalAirdrops <= 62 * 10^13:
            if block.number - airdrops[address(arg1)].field_128 and 124 * 10^14 / totalAirdrops > -1 / block.number - airdrops[address(arg1)].field_128:
                revert with 'NH{q', 17
            if (block.number * 124 * 10^14 / totalAirdrops) - (airdrops[address(arg1)].field_128 * 124 * 10^14 / totalAirdrops) <= airdrops[address(arg1)].field_0:
                return ((block.number * 124 * 10^14 / totalAirdrops) - (airdrops[address(arg1)].field_128 * 124 * 10^14 / totalAirdrops))
        else:
            if block.number - airdrops[address(arg1)].field_128 and 62 * 10^13 > -1 / block.number - airdrops[address(arg1)].field_128:
                revert with 'NH{q', 17
            if (62 * 10^13 * block.number) - (62 * 10^13 * airdrops[address(arg1)].field_128) <= airdrops[address(arg1)].field_0:
                return ((62 * 10^13 * block.number) - (62 * 10^13 * airdrops[address(arg1)].field_128))
    return airdrops[address(arg1)].field_0
}
    ...
    if sub_c1493a31 <= airdrops[address(msg.sender)].field_128:
        ...
        if airdrops[address(msg.sender)].field_0 < 100 * 10^18:
            ...
            if block.number < airdrops[address(msg.sender)].field_128:
                revert with 'NH{q', 17
            if 124 * 10^14 / totalAirdrops <= 62 * 10^13:
                if block.number - airdrops[address(msg.sender)].field_128 and 124 * 10^14 / totalAirdrops > -1 / block.number - airdrops[address(msg.sender)].field_128:
                    revert with 'NH{q', 17
                require ext_code.size(stor2)
                staticcall stor2.0x70a08231 with:
                        gas gas_remaining wei
                ...
                require return_data.size >= 32
                require ext_call.return_data[0] == ext_call.return_data[0]
                if (block.number * 124 * 10^14 / totalAirdrops) - (airdrops[address(msg.sender)].field_128 * 124 * 10^14 / totalAirdrops) <= airdrops[address(msg.sender)].field_0:
                    if (block.number * 124 * 10^14 / totalAirdrops) - (airdrops[address(msg.sender)].field_128 * 124 * 10^14 / totalAirdrops) <= ext_call.return_data[0]:
                        if airdrops[address(msg.sender)].field_0 < uint128((block.number * 124 * 10^14 / totalAirdrops) - (airdrops[address(msg.sender)].field_128 * 124 * 10^14 / totalAirdrops)):
                            revert with 'NH{q', 17
                        airdrops[address(msg.sender)].field_0 = uint128(airdrops[address(msg.sender)].field_0 - uint128((block.number * 124 * 10^14 / totalAirdrops) - (airdrops[address(msg.sender)].field_128 * 124 * 10^14 / totalAirdrops)))
                        if airdrops[address(msg.sender)].field_0 < 100 * 10^18:
                            if totalAirdrops < 1:
                                revert with 'NH{q', 17
                            totalAirdrops--
                        ...
                        call stor2.0xa9059cbb with:
                             gas gas_remaining wei
                            args msg.sender, (block.number * 124 * 10^14 / totalAirdrops) - (airdrops[address(msg.sender)].field_128 * 124 * 10^14 / totalAirdrops)
                    else:
                        require ext_code.size(stor2)
                        staticcall stor2.0x70a08231 with:
                                gas gas_remaining wei
                ...
                if block.number - airdrops[address(msg.sender)].field_128 and 62 * 10^13 > -1 / block.number - airdrops[address(msg.sender)].field_128:
                    revert with 'NH{q', 17
                require ext_code.size(stor2)
                staticcall stor2.0x70a08231 with:
                        gas gas_remaining wei
                ...
                require return_data.size >= 32
                require ext_call.return_data[0] == ext_call.return_data[0]
                if (62 * 10^13 * block.number) - (62 * 10^13 * airdrops[address(msg.sender)].field_128) <= airdrops[address(msg.sender)].field_0:
                    if (62 * 10^13 * block.number) - (62 * 10^13 * airdrops[address(msg.sender)].field_128) <= ext_call.return_data[0]:
                        if airdrops[address(msg.sender)].field_0 < uint128((62 * 10^13 * block.number) - (62 * 10^13 * airdrops[address(msg.sender)].field_128)):
                            revert with 'NH{q', 17
                        airdrops[address(msg.sender)].field_0 = uint128(airdrops[address(msg.sender)].field_0 - uint128((62 * 10^13 * block.number) - (62 * 10^13 * airdrops[address(msg.sender)].field_128)))
                        if airdrops[address(msg.sender)].field_0 < 100 * 10^18:
                            if totalAirdrops < 1:
                                revert with 'NH{q', 17
                            totalAirdrops--
                        ...
                        call stor2.0xa9059cbb with:
                             gas gas_remaining wei
                            args msg.sender, (62 * 10^13 * block.number) - (62 * 10^13 * airdrops[address(msg.sender)].field_128)
                    else:
                        require ext_code.size(stor2)
                        staticcall stor2.0x70a08231 with:
                                gas gas_remaining wei
        ...
        if airdrops[address(msg.sender)].field_0 < 100 * 10^18:
            ...
            if block.number < sub_c1493a31:
                revert with 'NH{q', 17
            if 124 * 10^14 / totalAirdrops <= 62 * 10^13:
                if block.number - sub_c1493a31 and 124 * 10^14 / totalAirdrops > -1 / block.number - sub_c1493a31:
                    revert with 'NH{q', 17
                require ext_code.size(stor2)
                staticcall stor2.0x70a08231 with:
                        gas gas_remaining wei
                ...
                require return_data.size >= 32
                require ext_call.return_data[0] == ext_call.return_data[0]
                if (block.number * 124 * 10^14 / totalAirdrops) - (sub_c1493a31 * 124 * 10^14 / totalAirdrops) <= airdrops[address(msg.sender)].field_0:
                    if (block.number * 124 * 10^14 / totalAirdrops) - (sub_c1493a31 * 124 * 10^14 / totalAirdrops) <= ext_call.return_data[0]:
                        if airdrops[address(msg.sender)].field_0 < uint128((block.number * 124 * 10^14 / totalAirdrops) - (sub_c1493a31 * 124 * 10^14 / totalAirdrops)):
                            revert with 'NH{q', 17
                        airdrops[address(msg.sender)].field_0 = uint128(airdrops[address(msg.sender)].field_0 - uint128((block.number * 124 * 10^14 / totalAirdrops) - (sub_c1493a31 * 124 * 10^14 / totalAirdrops)))
                        if airdrops[address(msg.sender)].field_0 < 100 * 10^18:
                            if totalAirdrops < 1:
                                revert with 'NH{q', 17
                            totalAirdrops--
                        ...
                        call stor2.0xa9059cbb with:
                             gas gas_remaining wei
                            args msg.sender, (block.number * 124 * 10^14 / totalAirdrops) - (sub_c1493a31 * 124 * 10^14 / totalAirdrops)
                    else:
                        require ext_code.size(stor2)
                        staticcall stor2.0x70a08231 with:
                                gas gas_remaining wei
                ...
                if block.number - sub_c1493a31 and 62 * 10^13 > -1 / block.number - sub_c1493a31:
                    revert with 'NH{q', 17
                require ext_code.size(stor2)
                staticcall stor2.0x70a08231 with:
                        gas gas_remaining wei
                ...
                require return_data.size >= 32
                require ext_call.return_data[0] == ext_call.return_data[0]
                if (62 * 10^13 * block.number) - (62 * 10^13 * sub_c1493a31) <= airdrops[address(msg.sender)].field_0:
                    if (62 * 10^13 * block.number) - (62 * 10^13 * sub_c1493a31) <= ext_call.return_data[0]:
                        if airdrops[address(msg.sender)].field_0 < uint128((62 * 10^13 * block.number) - (62 * 10^13 * sub_c1493a31)):
                            revert with 'NH{q', 17
                        airdrops[address(msg.sender)].field_0 = uint128(airdrops[address(msg.sender)].field_0 - uint128((62 * 10^13 * block.number) - (62 * 10^13 * sub_c1493a31)))
                        if airdrops[address(msg.sender)].field_0 < 100 * 10^18:
                            if totalAirdrops < 1:
                                revert with 'NH{q', 17
                            totalAirdrops--
                        ...
                        call stor2.0xa9059cbb with:
                             gas gas_remaining wei
                            args msg.sender, (62 * 10^13 * block.number) - (62 * 10^13 * sub_c1493a31)
                    else:
                        require ext_code.size(stor2)
                        staticcall stor2.0x70a08231 with:
                                gas gas_remaining wei
