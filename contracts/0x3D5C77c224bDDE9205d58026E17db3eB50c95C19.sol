        ...
        if not ('cd', 68).length:
            ...
            if cd[100]:
                ...
                while idx < tokens.length - 1:
                    ...
                    require return_data.size >= 32
                    _906 = mem[_899]
                    require mem[_899] <= 4294967296
                    require mem[_899] + 32 <= return_data.size
                    require mem[mem[_899] + _899] <= 4294967296 and mem[_899] + (32 * mem[mem[_899] + _899]) + 32 <= return_data.size
                    mem[_899 + ceil32(return_data.size)] = mem[mem[_899] + _899]
                    _930 = mem[_906 + _899]
                    s = 0
                    while s < 32 * _930:
                        mem[_899 + ceil32(return_data.size) + s + 32] = mem[_906 + _899 + s + 32]
                        s = s + 32
                        continue 
                    mem[64] = (32 * _930) + _899 + ceil32(return_data.size) + 32
                    if 1 < mem[_899 + ceil32(return_data.size)]:
                        idx = idx + 1
                        s = mem[_899 + ceil32(return_data.size) + 64]
                        continue 
                    revert
        else:
            s = 0
            ...
            if not cd[100]:
                ...
                while idx < tokens.length - 1:
                    ...
                    require return_data.size >= 32
                    _998 = mem[_995]
                    require mem[_995] <= 4294967296
                    require mem[_995] + 32 <= return_data.size
                    require mem[mem[_995] + _995] <= 4294967296 and mem[_995] + (32 * mem[mem[_995] + _995]) + 32 <= return_data.size
                    mem[_995 + ceil32(return_data.size)] = mem[mem[_995] + _995]
                    _1010 = mem[_998 + _995]
                    s = 0
                    while s < 32 * _1010:
                        mem[_995 + ceil32(return_data.size) + s + 32] = mem[_998 + _995 + s + 32]
                        s = s + 32
                        continue 
                    mem[64] = (32 * _1010) + _995 + ceil32(return_data.size) + 32
                    if 1 < mem[_995 + ceil32(return_data.size)]:
                        idx = idx + 1
                        s = mem[_995 + ceil32(return_data.size) + 64]
                        continue 
                    revert
            else:
                var41001 = 32
        ...
        if not ('cd', 68).length:
            ...
            if cd[100]:
                ...
                while idx < tokens.length - 1:
                    ...
                    require return_data.size >= 32
                    _1000 = mem[_996]
                    require mem[_996] <= 4294967296
                    require mem[_996] + 32 <= return_data.size
                    require mem[mem[_996] + _996] <= 4294967296 and mem[_996] + (32 * mem[mem[_996] + _996]) + 32 <= return_data.size
                    mem[_996 + ceil32(return_data.size)] = mem[mem[_996] + _996]
                    _1011 = mem[_1000 + _996]
                    s = 0
                    while s < 32 * _1011:
                        mem[_996 + ceil32(return_data.size) + s + 32] = mem[_1000 + _996 + s + 32]
                        s = s + 32
                        continue 
                    mem[64] = (32 * _1011) + _996 + ceil32(return_data.size) + 32
                    if 1 < mem[_996 + ceil32(return_data.size)]:
                        idx = idx + 1
                        s = mem[_996 + ceil32(return_data.size) + 64]
                        continue 
                    revert
        else:
            s = 0
            ...
            if not cd[100]:
                ...
                while idx < tokens.length - 1:
                    ...
                    require return_data.size >= 32
                    _1037 = mem[_1036]
                    require mem[_1036] <= 4294967296
                    require mem[_1036] + 32 <= return_data.size
                    require mem[mem[_1036] + _1036] <= 4294967296 and mem[_1036] + (32 * mem[mem[_1036] + _1036]) + 32 <= return_data.size
                    mem[_1036 + ceil32(return_data.size)] = mem[mem[_1036] + _1036]
                    _1040 = mem[_1037 + _1036]
                    s = 0
                    while s < 32 * _1040:
                        mem[_1036 + ceil32(return_data.size) + s + 32] = mem[_1037 + _1036 + s + 32]
                        s = s + 32
                        continue 
                    mem[64] = (32 * _1040) + _1036 + ceil32(return_data.size) + 32
                    if 1 < mem[_1036 + ceil32(return_data.size)]:
                        idx = idx + 1
                        s = mem[_1036 + ceil32(return_data.size) + 64]
                        continue 
                    revert
            else:
                var45001 = 32
    ...
    if arg2:
        ...
        if not arg2:
            ...
            while idx < tokens.length - 1:
                ...
                t = 0
                while t < 32 * _6844:
                    mem[mem[64] + t + 196] = mem[t + 356]
                    t = t + 32
                    continue 
                require ext_code.size(address(sub_6338a7c0[idx]))
                call address(sub_6338a7c0[idx]).swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                     gas gas_remaining wei
                    args s, 1, 160, address(this.address), block.timestamp, mem[mem[64] + 164 len (32 * _6844) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _10329 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        if not arg2:
            ...
            while idx < tokens.length - 1:
                ...
                call address(sub_6338a7c0[idx]).swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                     gas gas_remaining wei
                    args s, 1, 160, address(this.address), block.timestamp, mem[mem[64] + 164 len (32 * _6832) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _10308 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
