...
uint16 stor4;
address stakingAddress; offset 16
...
function initialize(address arg1, address arg2, address arg3) payable {
    ...
    mem[ceil32(return_data.size) + 260 len 96] = approve(address rg1, uint256 rg2), address(arg1) << 64, 0, -1, 0
