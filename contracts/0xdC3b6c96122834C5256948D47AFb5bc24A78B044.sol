...
function invested() payable {
    ...
    staticcall stor4.invested(address arg1) with:
...
function claimed() payable {
    require ext_code.size(stor4)
    staticcall stor4.claimed(address arg1) with:
            gas gas_remaining wei
           args msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_72f4300b(?) payable {
    ...
    staticcall stor3.getNodeNumberOf(address arg1) with:
            gas gas_remaining wei
           args msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_4b16cc65(?) payable {
    require ext_code.size(stor3)
    staticcall stor3.getRewardAmountOf(address arg1) with:
            gas gas_remaining wei
           args msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
