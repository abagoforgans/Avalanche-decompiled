...
function sub_63e349d3(?) payable {
    ...
    if arg1 == arg4:
        ...
        mem[64] = 452
        mem[228 len 28] = 0
        mem[224 len 4] = swapExactETHForTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4)
        idx = 0
        while not idx:
            _56 = mem[64]
            _57 = mem[192]
        ...
        mem[64] = 516
        mem[260 len 28] = 0
        mem[256 len 4] = swapExactETHForTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4)
        idx = 0
        while not idx:
            _54 = mem[64]
            _55 = mem[224]
