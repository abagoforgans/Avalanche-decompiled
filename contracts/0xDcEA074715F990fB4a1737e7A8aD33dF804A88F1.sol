...
function togglePause() payable {
    ...
    uint256(stor5.field_0) = not bool(isPaused) or Mask(248, 8, uint256(stor5.field_0))
}
...
function updatePauser(address arg1) payable {
    ...
    if minterAddress != msg.sender:
        revert with 0, 'Only pauser'
    emit 0xce932f99: pauserAddress, arg1
    pauserAddress = arg1
}
...
function updateMinter(address arg1) payable {
    ...
    emit NewMinter(address(stor5.field_0), arg1);
    minterAddress = arg1
}
