...
function royaltyInfo(uint256 arg1, uint256 arg2) {
    ...
    require arg1 == arg1
    require arg2 == arg2
    if arg2 / 10000 and stor12.field_160 % 16777216 > -1 / arg2 / 10000:
        revert with 'NH{q', 17
    return address(stor12.field_0), arg2 / 10000 * stor12.field_160 % 16777216
}
...
function setRoyalties(address arg1, uint256 arg2) {
    ...
    stor12.field_160 % 16777216 = arg2 % 16777216
}
...
function withdraw() {
    ...
    if eth.balance(this.address) / 100 and stor19 > -1 / eth.balance(this.address) / 100:
        revert with 'NH{q', 17
    call stor21 with:
       value eth.balance(this.address) / 100 * stor19 wei
         gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if eth.balance(this.address) / 100 and stor20 > -1 / eth.balance(this.address) / 100:
        revert with 'NH{q', 17
    call stor22 with:
       value eth.balance(this.address) / 100 * stor20 wei
         gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if eth.balance(this.address) > 0:
...
function mint(uint256 arg1) payable {
    ...
    if msg.sender == owner:
        ...
        if itemFee and arg1 > -1 / itemFee:
            revert with 'NH{q', 17
        if msg.value < itemFee * arg1:
