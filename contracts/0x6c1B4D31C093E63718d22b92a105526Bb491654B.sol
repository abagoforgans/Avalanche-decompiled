...
function sub_34b20598(?) {
    ...
    mem[(32 * _43) + ceil32(return_data.size) + 224] = 2
    mem[(32 * _43) + ceil32(return_data.size) + 256] = target_token_address
    ...
    call stor3.0xa9059cbb with:
         gas gas_remaining wei
        args address(this.address), mem[(32 * _43) + (2 * ceil32(return_data.size)) + 384]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
}
