...
const sub_31c3c7a0(?) = 125 * 10^16

const MINT_PRICE = 15 * 10^17
...
uint256 PAID_TOKENS;
uint16 minted;
uint16 sub_794622f6; offset 16
uint16 sub_f3067eec; offset 32
uint256 startTimestamp;
uint256 endTimestamp;
mapping of struct tokenTraits;
mapping of uint8 stor19;
mapping of address ownerOf;
mapping of uint256 sub_82e1945a;
array of uint256 stor21;
mapping of uint256 balanceOf;
array of uint256 stor33;
mapping of address approved;
address barnAddress;
address gemAddress;
address traitsAddress;
address randomSourceAddress;
...
function sub_82e1945a(?) {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    return sub_82e1945a[arg1]
}
...
function getTokenTraits(uint256 arg1) {
    require calldata.size - 4 >= 32
    return bool(tokenTraits[arg1].field_0), 
           tokenTraits[arg1].field_0,
           tokenTraits[arg1].field_0,
           tokenTraits[arg1].field_0,
           tokenTraits[arg1].field_0,
           tokenTraits[arg1].field_0,
...
function tokenTraits(uint256 arg1) {
    require calldata.size - 4 >= 32
    return bool(tokenTraits[arg1].field_0), 
           tokenTraits[arg1].field_0,
           tokenTraits[arg1].field_0,
           tokenTraits[arg1].field_0,
           tokenTraits[arg1].field_32,
           tokenTraits[arg1].field_0,
           tokenTraits[arg1].field_0,
           tokenTraits[arg1].field_0,
           tokenTraits[arg1].field_64
...
function sub_6f4f7366(?) {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    traitsAddress = address(arg1)
}
...
function sub_d773826d(?) {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    randomSourceAddress = address(arg1)
}
