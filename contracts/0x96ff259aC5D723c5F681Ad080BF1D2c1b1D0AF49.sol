...
address owner;
address horusAddress;
address devaddr;
uint256 horusPerBlock;
address feeAddress;
...
function horusPerBlock() payable {
    return horusPerBlock
}
        ...
        if ext_call.return_data[0]:
            if poolInfo[arg1].field_256:
                ...
                if not block.number - poolInfo[arg1].field_512:
                    ...
                    require ext_code.size(horusAddress)
                    call horusAddress.0x40c10f19 with:
                         gas gas_remaining wei
                    ...
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        require block.number - poolInfo[arg1].field_512
                        if (block.number * horusPerBlock) - (poolInfo[arg1].field_512 * horusPerBlock) / block.number - poolInfo[arg1].field_512 != horusPerBlock:
                            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                        if not (block.number * horusPerBlock) - (poolInfo[arg1].field_512 * horusPerBlock):
                            if totalAllocPoint <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require totalAllocPoint
                            require ext_code.size(horusAddress)
                            ...
                            require (block.number * horusPerBlock) - (poolInfo[arg1].field_512 * horusPerBlock)
                            if (block.number * horusPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * horusPerBlock * poolInfo[arg1].field_256) / (block.number * horusPerBlock) - (poolInfo[arg1].field_512 * horusPerBlock) != poolInfo[arg1].field_256:
                                revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                            if totalAllocPoint <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require totalAllocPoint
                            ...
                            call horusAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args devaddr, (block.number * horusPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * horusPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(horusAddress)
                            call horusAddress.0x40c10f19 with:
                                 gas gas_remaining wei
                                args address(this.address), (block.number * horusPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * horusPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if not (block.number * horusPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * horusPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                                if ext_call.return_data[0] <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_call.return_data[0]
                                if poolInfo[arg1].field_768 + (0 / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                ...
                                require (block.number * horusPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * horusPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                                if 10^12 * (block.number * horusPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * horusPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * horusPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * horusPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^12:
                                    revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                                if ext_call.return_data[0] <= 0:
                                    revert with 0, 'SafeMath: division by zero'
                                require ext_call.return_data[0]
                                if poolInfo[arg1].field_768 + (10^12 * (block.number * horusPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * horusPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                poolInfo[arg1].field_768 += 10^12 * (block.number * horusPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * horusPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
        poolInfo[arg1].field_512 = block.number
}

function pendinghorus(uint256 arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 < poolInfo.length
    require ext_code.size(poolInfo[arg1].field_0)
    staticcall poolInfo[arg1].field_0.0x70a08231 with:
    ...
    if not userInfo[arg1][address(arg2)].field_0:
        ...
        return -userInfo[arg1][address(arg2)].field_256
    require userInfo[arg1][address(arg2)].field_0
    if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * horusPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * horusPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != poolInfo[arg1].field_768 + (10^12 * (block.number * horusPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * horusPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]):
        revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
    if userInfo[arg1][address(arg2)].field_256 > (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * horusPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * horusPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12:
        revert with 0, 'SafeMath: subtraction overflow'
    return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (block.number * horusPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * horusPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
}
...
function massUpdatePools() payable {
    ...
    while idx < poolInfo.length:
        ...
        if not block.number - poolInfo[idx].field_512:
            ...
            revert with memory
              from mem[64]
               len _261 + -mem[64] + 100
        require block.number - poolInfo[idx].field_512
        if (block.number * horusPerBlock) - (poolInfo[idx].field_512 * horusPerBlock) / block.number - poolInfo[idx].field_512 != horusPerBlock:
            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        if not (block.number * horusPerBlock) - (poolInfo[idx].field_512 * horusPerBlock):
            _184 = mem[64]
            mem[64] = mem[64] + 64
            mem[_184] = 26
            ...
            revert with memory
              from mem[64]
               len _277 + -mem[64] + 100
        require (block.number * horusPerBlock) - (poolInfo[idx].field_512 * horusPerBlock)
        if (block.number * horusPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * horusPerBlock * poolInfo[idx].field_256) / (block.number * horusPerBlock) - (poolInfo[idx].field_512 * horusPerBlock) != poolInfo[idx].field_256:
            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _191 = mem[64]
        mem[64] = mem[64] + 64
        mem[_191] = 26
        ...
        call horusAddress.0x40c10f19 with:
             gas gas_remaining wei
            args devaddr, (block.number * horusPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * horusPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = this.address
        mem[mem[64] + 36] = (block.number * horusPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * horusPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        require ext_code.size(horusAddress)
        call horusAddress.0x40c10f19 with:
             gas gas_remaining wei
            args address(this.address), (block.number * horusPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * horusPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if not (block.number * horusPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * horusPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
            _256 = mem[64]
            mem[64] = mem[64] + 64
            mem[_256] = 26
            ...
            revert with memory
              from mem[64]
               len _274 + -mem[64] + 100
        require (block.number * horusPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * horusPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        if 10^12 * (block.number * horusPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * horusPerBlock * poolInfo[idx].field_256) / totalAllocPoint / (block.number * horusPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * horusPerBlock * poolInfo[idx].field_256) / totalAllocPoint != 10^12:
            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _273 = mem[64]
        mem[64] = mem[64] + 64
        mem[_273] = 26
        ...
        if ext_call.return_data[0] > 0:
            require ext_call.return_data[0]
            if poolInfo[idx].field_768 + (10^12 * (block.number * horusPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * horusPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[idx].field_768:
                revert with 0, 'SafeMath: addition overflow'
            poolInfo[idx].field_768 += 10^12 * (block.number * horusPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * horusPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
            poolInfo[idx].field_512 = block.number
            idx = idx + 1
            continue 
        _292 = mem[64]
        ...
        while idx < poolInfo.length:
            ...
            if not block.number - poolInfo[idx].field_512:
                ...
                if totalAllocPoint <= 0:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_240 + idx + 68] = mem[_238 + idx + 32]
                        idx = idx + 32
                        continue 
                    mem[_240 + 68] = mem[_240 + 74 len 26]
                    revert with memory
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_299 + idx + 68] = mem[_294 + idx + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[_309 + idx + 68] = mem[_298 + idx + 32]
                    idx = idx + 32
                    continue 
            ...
            if not block.number - poolInfo[idx].field_512:
                ...
                if totalAllocPoint <= 0:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_246 + idx + 68] = mem[_239 + idx + 32]
                        idx = idx + 32
                        continue 
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_306 + idx + 68] = mem[_297 + idx + 32]
                        idx = idx + 32
                        continue 
                ...
                idx = 0
                while idx < 26:
                    mem[_322 + idx + 68] = mem[_305 + idx + 32]
                    idx = idx + 32
                    continue 
            ...
            if not (block.number * horusPerBlock) - (poolInfo[idx].field_512 * horusPerBlock):
                ...
                if totalAllocPoint <= 0:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_253 + idx + 68] = mem[_245 + idx + 32]
                        idx = idx + 32
                        continue 
                ...
                if not 0 / totalAllocPoint:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_319 + idx + 68] = mem[_304 + idx + 32]
                        idx = idx + 32
                        continue 
            ...
            if not (block.number * horusPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * horusPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
                ...
                idx = 0
                while idx < 26:
                    mem[_335 + idx + 68] = mem[_317 + idx + 32]
                    idx = idx + 32
                    continue 
            ...
            idx = 0
            while idx < 26:
                mem[_353 + idx + 68] = mem[_334 + idx + 32]
                idx = idx + 32
                continue 
...
function withdraw(uint256 arg1, uint256 arg2) payable {
    ...
    if block.number <= poolInfo[arg1].field_512:
        if not userInfo[arg1][address(msg.sender)].field_0:
            ...
            if -userInfo[arg1][address(msg.sender)].field_256 > 0:
                require ext_code.size(horusAddress)
                staticcall horusAddress.0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if -userInfo[arg1][address(msg.sender)].field_256 <= ext_call.return_data[0]:
                    call horusAddress.0xa9059cbb with:
                         gas gas_remaining wei
