...
function sub_931a6758(?) payable {
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    if Mask(112, 0, ext_call.return_data[32]) and 10 > -1 / Mask(112, 0, ext_call.return_data[32]):
        revert with 'NH{q', 17
    if 10 * Mask(112, 0, ext_call.return_data[32]) and 18 > -1 / 10 * Mask(112, 0, ext_call.return_data[32]):
        revert with 'NH{q', 17
    ...
    return 0xfacb3892f9a8d55eb50fdeee00f2b3fa8a85ded5, 
           ...
           180 * Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0]),
