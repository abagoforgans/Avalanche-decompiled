...
function massUpdatePools() payable {
    ...
    while idx < poolInfo.length:
        ...
        if block.number <= bonusEndBlock:
            ...
            if not block.number - poolInfo[idx].field_512:
                ...
                if not 0 / stor7:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_234 + idx + 68] = mem[_227 + idx + 32]
                        idx = idx + 32
                        continue 
                    mem[_234 + 94] = 0
                    revert with memory
            ...
            if not (block.number * rewardPerBlock) - (poolInfo[idx].field_512 * rewardPerBlock):
                ...
                if stor7 <= 0:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_230 + idx + 68] = mem[_224 + idx + 32]
                        idx = idx + 32
                        continue 
                    mem[_230 + 94] = 0
                    revert with memory
                ...
                if not 0 / stor7:
                    ...
                    idx = 0
                    while idx < 26:
                        mem[_270 + idx + 68] = mem[_261 + idx + 32]
                        idx = idx + 32
                        continue 
                    mem[_270 + 94] = 0
                    revert with memory
            ...
            if stor7 <= 0:
                ...
                idx = 0
                while idx < 26:
                    mem[_265 + idx + 68] = mem[_257 + idx + 32]
                    idx = idx + 32
                    continue 
                mem[_265 + 94] = 0
                revert with memory
            ...
            if not (block.number * rewardPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * rewardPerBlock * poolInfo[idx].field_256) / stor7:
                ...
                idx = 0
                while idx < 26:
                    mem[_311 + idx + 68] = mem[_305 + idx + 32]
                    idx = idx + 32
                    continue 
                mem[_311 + 94] = 0
                revert with memory
        ...
        if not bonusEndBlock - poolInfo[idx].field_512:
            ...
            idx = 0
            while idx < 26:
                mem[_277 + idx + 68] = mem[_264 + idx + 32]
                idx = idx + 32
                continue 
            mem[_277 + 94] = 0
            revert with memory
        ...
        if not (bonusEndBlock * rewardPerBlock) - (poolInfo[idx].field_512 * rewardPerBlock):
            ...
            idx = 0
            while idx < 26:
                mem[_318 + idx + 68] = mem[_308 + idx + 32]
                idx = idx + 32
                continue 
            mem[_318 + 94] = 0
            revert with memory
