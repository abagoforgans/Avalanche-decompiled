...
function viewInfo(uint256 arg1) {
    require calldata.size - 4 >= 32
    require arg1 < viewInfo.length
    return viewInfo[arg1].field_0, viewInfo[arg1].field_256, viewInfo[arg1].field_512
}
...
function mintWithUsdc(string arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    ...
    call stor11.0x23b872dd with:
        ...
        args msg.sender, address(this.address), 16 * 10^6 * arg2
    ...
    if stor3[stor2.length]:
        ...
        if ext_code.size(msg.sender):
            ...
            mem[ceil32(arg1.length) + ceil32(return_data.size) + 452 len 192] = onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, tokenByIndex.length, 128, 0, 0
            call msg.sender with:
               funct Mask(32, 224, onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, tokenByIndex.length, 128, 0, 0) >> 224
                 gas gas_remaining wei
                args (Mask(1280, -1056, onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, tokenByIndex.length, 128, 0, 0) << 1056)
            if not return_data.size:
                if not ext_call.success:
                    ...
                    revert with 0, 
                                32,
                                50,
                                0xfe4552433732313a207472616e7366657220746f206e6f6e20455243373231526563656976657220696d706c656d656e7465, mem[ceil32(arg1.length) + ceil32(return_data.size) + 438 len 14] >> 144,
                                0
                ...
                mem[ceil32(arg1.length) + ceil32(return_data.size) + 484 len return_data.size] = ext_call.return_data[0 len return_data.size]
                if not ext_call.success:
                    if return_data.size:
                        revert with ext_call.return_data[0 len return_data.size]
                    revert with 0, 
                                ...
                                0
                require return_data.size >= 32
                require mem[ceil32(arg1.length) + ceil32(return_data.size) + 484] == Mask(32, 224, mem[ceil32(arg1.length) + ceil32(return_data.size) + 484])
                if Mask(32, 224, mem[ceil32(arg1.length) + ceil32(return_data.size) + 484]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                    revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
    else:
        tokenByIndex.length++
        ...
        if ext_code.size(msg.sender):
            if not ext_code.size(msg.sender):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(arg1.length) + ceil32(return_data.size) + 516 len 192] = onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, tokenByIndex.length, 128, 0, 0
            call msg.sender with:
               funct Mask(32, 224, onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, tokenByIndex.length, 128, 0, 0) >> 224
                 gas gas_remaining wei
                args (Mask(1280, -1056, onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, tokenByIndex.length, 128, 0, 0) << 1056)
            if not return_data.size:
                if not ext_call.success:
                    ...
                    revert with 0, 
                                32,
                                50,
                                0xfe4552433732313a207472616e7366657220746f206e6f6e20455243373231526563656976657220696d706c656d656e7465, mem[ceil32(arg1.length) + ceil32(return_data.size) + 502 len 14] >> 144,
                                0
                require arg1.length >= 32
                require mem[128] == Mask(32, 224, mem[128])
                if Mask(32, 224, mem[128]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                ...
                mem[ceil32(arg1.length) + ceil32(return_data.size) + 548 len return_data.size] = ext_call.return_data[0 len return_data.size]
                if not ext_call.success:
                    if return_data.size:
                        revert with ext_call.return_data[0 len return_data.size]
                    revert with 0, 
                                ...
                                0
                require return_data.size >= 32
                require mem[ceil32(arg1.length) + ceil32(return_data.size) + 548] == Mask(32, 224, mem[ceil32(arg1.length) + ceil32(return_data.size) + 548])
                if Mask(32, 224, mem[ceil32(arg1.length) + ceil32(return_data.size) + 548]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                    revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
    if not stor3[stor2.length]:
        revert with 0, 'ERC721Metadata: URI set of nonexistent token'
    if arg1.length:
        stor8[stor2.length][].field_0 = Array(len=arg1.length, data=arg1[all])
    else:
        stor8[stor2.length].field_0 = 0
        idx = 0
        while stor8[stor2.length].length + 31 / 32 > idx:
            stor8[stor2.length][idx].field_0 = 0
            idx = idx + 1
            continue 
    viewInfo.length++
    viewInfo[viewInfo.length].field_0 = arg2
    storBB7B[stor14.length] = block.timestamp
    storBB7B[stor14.length] = msg.sender
}

function mintWithUsdt(string arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    require arg1 <= test266151307()
    require calldata.size > arg1 + 35
    require arg1.length <= test266151307()
...
function withdrawCrypto() {
    ...
    if not return_data.size:
        ...
        if not ext_code.size(stor12):
            revert with 0, 'Address: call to non-contract'
        mem[(2 * ceil32(return_data.size)) + 424 len 96] = 0, msg.sender, ext_call.return_data[0], 0
    ...
    if not ext_code.size(stor12):
        revert with 0, 'Address: call to non-contract'
    mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 425 len 96] = 0, msg.sender, ext_call.return_data[0], 0
...
function mintWithNative(string arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 <= test266151307()
    require calldata.size > arg1 + 35
    require arg1.length <= test266151307()
    ...
    mem[128 len arg1.length] = arg1[all]
    mem[arg1.length + 128] = 0
    mem[ceil32(arg1.length) + 128] = 2
    mem[ceil32(arg1.length) + 160 len 64] = call.data[calldata.size len 64]
    require ext_code.size(stor13)
    staticcall stor13.0x73b295c2 with:
            gas gas_remaining wei
    ...
    mem[ceil32(arg1.length) + 160] = ext_call.return_data[12 len 20]
    require 1 < Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[arg1.length + 160 len -arg1.length + ceil32(arg1.length)]
    mem[ceil32(arg1.length) + 192] = 0xa7d7079b0fead91f3e65f86e8915cb59c1a4c664
    mem[ceil32(arg1.length) + ceil32(return_data.size) + 224] = 0xc57559dd00000000000000000000000000000000000000000000000000000000
    mem[ceil32(arg1.length) + ceil32(return_data.size) + 228] = 16 * 10^6 * arg2
    mem[ceil32(arg1.length) + ceil32(return_data.size) + 260] = 128
    mem[ceil32(arg1.length) + ceil32(return_data.size) + 356] = Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[arg1.length + 160 len -arg1.length + ceil32(arg1.length)]
    idx = 0
    s = ceil32(arg1.length) + ceil32(return_data.size) + 388
    ...
    while idx < Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[arg1.length + 160 len -arg1.length + ceil32(arg1.length)]:
        ...
        t = t + 32
        continue 
    mem[ceil32(arg1.length) + ceil32(return_data.size) + 292] = this.address
    mem[ceil32(arg1.length) + ceil32(return_data.size) + 324] = block.timestamp + 5
    require ext_code.size(stor13)
    call stor13.mem[mem[64] len 4] with:
       value msg.value wei
         gas gas_remaining wei
        args mem[mem[64] + 4 len ceil32(arg1.length) + ceil32(return_data.size) + (32 * Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[arg1.length + 160 len -arg1.length + ceil32(arg1.length)]) + -mem[64] + 384]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _1655 = mem[64]
    mem[64] = mem[64] + 32
    ...
    if tokenOfOwnerByIndex[address(msg.sender)][1][stor2.length]:
        ...
        if stor3[stor2.length]:
            ...
            if ext_code.size(msg.sender):
                ...
                _3351 = mem[64]
                mem[mem[64]] = 164
                mem[mem[64] + 32 len 4] = onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4)
                mem[64] = mem[64] + 292
                mem[_1685 + 196] = 50
                mem[_1685 + 228 len 50] = 0xfe4552433732313a207472616e7366657220746f206e6f6e20455243373231526563656976657220696d706c656d656e7465
                if not ext_code.size(msg.sender):
                    revert with 0, 'Address: call to non-contract'
                _3435 = mem[_3351]
                mem[_1685 + 292 len ceil32(mem[_3351])] = mem[_3351 + 32 len ceil32(mem[_3351])]
                var92001 = ceil32(_3435)
                if ceil32(_3435) > _3435:
                    mem[_3435 + _1685 + 292] = 0
                call msg.sender with:
                     gas gas_remaining wei
                    args mem[_1685 + 296 len _3435 - 4]
                if not return_data.size:
                    if not ext_call.success:
                        if arg1.length:
                            revert with arg1[all]
                        revert with 0, 
                                    32,
                                    50,
                                    0xfe4552433732313a207472616e7366657220746f206e6f6e20455243373231526563656976657220696d706c656d656e7465, mem[_1685 + 278 len 14] >> 144,
                                    0
                    require arg1.length >= 32
                    require mem[128] == Mask(32, 224, mem[128])
                    if Mask(32, 224, mem[128]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                    ...
                    mem[_1685 + 292] = return_data.size
                    mem[_1685 + 324 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    if not ext_call.success:
                        if return_data.size:
                            revert with ext_call.return_data[0 len return_data.size]
                        revert with 0, 
                                    ...
                                    0
                    require return_data.size >= 32
                    require mem[_1685 + 324] == Mask(32, 224, mem[_1685 + 324])
                    if Mask(32, 224, mem[_1685 + 324]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                        revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
        else:
            _1667 = mem[64]
            mem[64] = mem[64] + 64
            mem[_1667] = tokenByIndex.length
            mem[_1667 + 32] = msg.sender
            tokenByIndex.length++
            tokenByIndex[tokenByIndex.length].field_0 = tokenByIndex.length
            tokenByIndex[tokenByIndex.length].field_256 = msg.sender
            tokenByIndex[tokenByIndex.length].field_416 = 0
            ...
            if ext_code.size(msg.sender):
                ...
                mem[64] = mem[64] + 292
                mem[_1683 + 196] = 50
                mem[_1683 + 228 len 50] = 0xfe4552433732313a207472616e7366657220746f206e6f6e20455243373231526563656976657220696d706c656d656e7465
                if not ext_code.size(msg.sender):
                    revert with 0, 'Address: call to non-contract'
                _3438 = mem[_3360]
                mem[_1683 + 292 len ceil32(mem[_3360])] = mem[_3360 + 32 len ceil32(mem[_3360])]
                var91001 = ceil32(_3438)
                if ceil32(_3438) > _3438:
                    mem[_3438 + _1683 + 292] = 0
                call msg.sender with:
                     gas gas_remaining wei
                    args mem[_1683 + 296 len _3438 - 4]
                if not return_data.size:
                    if not ext_call.success:
                        if arg1.length:
                            revert with arg1[all]
                        revert with 0, 
                                    32,
                                    50,
                                    0xfe4552433732313a207472616e7366657220746f206e6f6e20455243373231526563656976657220696d706c656d656e7465, mem[_1683 + 278 len 14] >> 144,
                                    0
                    require arg1.length >= 32
                    require mem[128] == Mask(32, 224, mem[128])
                    if Mask(32, 224, mem[128]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                    ...
                    mem[_1683 + 292] = return_data.size
                    mem[_1683 + 324 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    if not ext_call.success:
                        if return_data.size:
                            revert with ext_call.return_data[0 len return_data.size]
                        revert with 0, 
                                    ...
                                    0
                    require return_data.size >= 32
                    require mem[_1683 + 324] == Mask(32, 224, mem[_1683 + 324])
                    if Mask(32, 224, mem[_1683 + 324]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                        revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
    else:
        tokenOfOwnerByIndex[address(msg.sender)]++
        tokenOfOwnerByIndex[address(msg.sender)][tokenOfOwnerByIndex[address(msg.sender)]] = tokenByIndex.length
        ...
        if stor3[stor2.length]:
            ...
            if ext_code.size(msg.sender):
                ...
                mem[64] = mem[64] + 292
                mem[_1686 + 196] = 50
                mem[_1686 + 228 len 50] = 0xfe4552433732313a207472616e7366657220746f206e6f6e20455243373231526563656976657220696d706c656d656e7465
                if not ext_code.size(msg.sender):
                    revert with 0, 'Address: call to non-contract'
                _3441 = mem[_3369]
                mem[_1686 + 292 len ceil32(mem[_3369])] = mem[_3369 + 32 len ceil32(mem[_3369])]
                var92001 = ceil32(_3441)
                if ceil32(_3441) > _3441:
                    mem[_3441 + _1686 + 292] = 0
                call msg.sender with:
                     gas gas_remaining wei
                    args mem[_1686 + 296 len _3441 - 4]
                if not return_data.size:
                    if not ext_call.success:
                        if arg1.length:
                            revert with arg1[all]
                        revert with 0, 
                                    32,
                                    50,
                                    0xfe4552433732313a207472616e7366657220746f206e6f6e20455243373231526563656976657220696d706c656d656e7465, mem[_1686 + 278 len 14] >> 144,
                                    0
                    require arg1.length >= 32
                    require mem[128] == Mask(32, 224, mem[128])
                    if Mask(32, 224, mem[128]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                    ...
                    mem[_1686 + 292] = return_data.size
                    mem[_1686 + 324 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    if not ext_call.success:
                        if return_data.size:
                            revert with ext_call.return_data[0 len return_data.size]
                        revert with 0, 
                                    ...
                                    0
                    require return_data.size >= 32
                    require mem[_1686 + 324] == Mask(32, 224, mem[_1686 + 324])
                    if Mask(32, 224, mem[_1686 + 324]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                        revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
        else:
            _1672 = mem[64]
            mem[64] = mem[64] + 64
            mem[_1672] = tokenByIndex.length
            mem[_1672 + 32] = msg.sender
            tokenByIndex.length++
            tokenByIndex[tokenByIndex.length].field_0 = tokenByIndex.length
            tokenByIndex[tokenByIndex.length].field_256 = msg.sender
            tokenByIndex[tokenByIndex.length].field_416 = 0
            ...
            if ext_code.size(msg.sender):
                ...
                mem[64] = mem[64] + 292
                mem[_1684 + 196] = 50
                mem[_1684 + 228 len 50] = 0xfe4552433732313a207472616e7366657220746f206e6f6e20455243373231526563656976657220696d706c656d656e7465
                if not ext_code.size(msg.sender):
                    revert with 0, 'Address: call to non-contract'
                _3444 = mem[_3378]
                mem[_1684 + 292 len ceil32(mem[_3378])] = mem[_3378 + 32 len ceil32(mem[_3378])]
                var91001 = ceil32(_3444)
                if ceil32(_3444) > _3444:
                    mem[_3444 + _1684 + 292] = 0
                call msg.sender with:
                     gas gas_remaining wei
                    args mem[_1684 + 296 len _3444 - 4]
                if not return_data.size:
                    if not ext_call.success:
                        if arg1.length:
                            revert with arg1[all]
                        revert with 0, 
                                    32,
                                    50,
                                    0xfe4552433732313a207472616e7366657220746f206e6f6e20455243373231526563656976657220696d706c656d656e7465, mem[_1684 + 278 len 14] >> 144,
                                    0
                    require arg1.length >= 32
                    require mem[128] == Mask(32, 224, mem[128])
                    if Mask(32, 224, mem[128]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                    ...
                    mem[_1684 + 292] = return_data.size
                    mem[_1684 + 324 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    if not ext_call.success:
                        if return_data.size:
                            revert with ext_call.return_data[0 len return_data.size]
                        revert with 0, 
                                    ...
                                    0
                    require return_data.size >= 32
                    require mem[_1684 + 324] == Mask(32, 224, mem[_1684 + 324])
                    if Mask(32, 224, mem[_1684 + 324]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                        revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
    if not stor3[stor2.length]:
        revert with 0, 'ERC721Metadata: URI set of nonexistent token'
    if arg1.length:
        stor8[stor2.length][].field_0 = Array(len=arg1.length, data=mem[128 len arg1.length])
    else:
        stor8[stor2.length].field_0 = 0
        idx = 0
        while stor8[stor2.length].length + 31 / 32 > idx:
