...
function sub_8ee05396(?) {
    ...
    require block.timestamp >= startTimestamp
    require sub_0d2cb02a
    if sub_a402c1bf[address(arg1)] <= (block.timestamp - startTimestamp / sub_0d2cb02a) + 1:
        return 0
    return (sub_a402c1bf[address(arg1)] + -(block.timestamp - startTimestamp / sub_0d2cb02a) - 1)
}
...
function sub_13ae9059(?) {
    ...
    require block.timestamp >= startTimestamp
    require sub_0d2cb02a
    sub_a402c1bf[address(arg1)] = (block.timestamp - startTimestamp / sub_0d2cb02a) + sub_14e31e4e[stor15[address(arg1)]] + 1
...
function sub_6d658624(?) {
    ...
    require block.timestamp >= startTimestamp
    require sub_0d2cb02a
    require sub_a402c1bf[address(arg1)] > (block.timestamp - startTimestamp / sub_0d2cb02a) + 1
    ...
    require sub_0d2cb02a
    if sub_a402c1bf[address(arg1)] <= (block.timestamp - startTimestamp / sub_0d2cb02a) + 1:
        sub_a402c1bf[address(arg1)] = (block.timestamp - startTimestamp / sub_0d2cb02a) + 1
    else:
        sub_a402c1bf[address(arg1)] = (block.timestamp - startTimestamp / sub_0d2cb02a) + (sub_a402c1bf[address(arg1)] + -(block.timestamp - startTimestamp / sub_0d2cb02a) - 1 / 2) + 1
}
