...
#  - sub_3943e736(?)
#
const sub_0de8b9c0(?) = 0xe54ca86531e17ef3616d22ca28b0d458b6c89106
...
function sub_879e3512(?) payable {
    ...
    call 0xe54ca86531e17ef3616d22ca28b0d458b6c89106.swapExactAVAXForTokens(uint256 rg1, address[] rg2, address rg3, uint256 rg4) with:
       value arg2 wei
         gas gas_remaining wei
        args arg3, Array(len=2, data=mem[356 len 64]), address(this.address), block.timestamp
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[192 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = ceil32(return_data.size) + 192
    require return_data.size >= 32
    _20 = mem[192 len 4], Mask(224, 32, arg3) >> 32
    ...
    _21 = mem[mem[192 len 4], Mask(224, 32, arg3) >> 32 + 192]
...
function sub_0ff37091(?) payable {
    ...
    if not roleAdmin[0x7b765e0e932d348852a6f810bfa1ab891e259123f02db8cdcde614c570223357][address(msg.sender)].field_0:
        revert with 0, '403'
    mem[100] = 0xe54ca86531e17ef3616d22ca28b0d458b6c89106
    mem[132] = arg2
    ...
    call 0xe54ca86531e17ef3616d22ca28b0d458b6c89106.swapExactTokensForAVAX(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
         gas gas_remaining wei
        args arg2, arg3, Array(len=2, data=mem[ceil32(return_data.size) + 388 len 64]), sub_b9d54cd5Address, block.timestamp
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
