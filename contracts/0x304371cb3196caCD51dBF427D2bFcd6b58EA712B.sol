...
const sub_31b91016(?) = 0x4f01aed16d97e3ab5ab2b501154dc9bb0f1a5a2c

const sub_435d0307(?) = 0x794a61358d6845594f94dc1db02a252b5b4814ad

const instaList = 0x9926955e0dd681dc303370c52f4ad0a4dd061687

const getRoutes = Array(len=2, data=mem[256 len 64])

const sub_8966fb80(?) = 5

const sub_b9c51d54(?) = 0x4f01aed16d97e3ab5ab2b501154dc9bb0f1a5a2c

const sub_df1ab623(?) = 0x794a61358d6845594f94dc1db02a252b5b4814ad
...
function sub_426bfa4d(?) payable {
    ...
    if 1 == arg1:
        ...
        require ext_code.size(0x794a61358d6845594f94dc1db02a252b5b4814ad)
        staticcall 0x794a61358d6845594f94dc1db02a252b5b4814ad.FLASHLOAN_PREMIUM_TOTAL() with:
                gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[16 len 16]
        if ext_call.return_data[16 len 16] >= 5:
            return ext_call.return_data[16 len 16]
    return 5
}

function sub_f495962c(?) payable {
    require calldata.size - 4 >= 32
