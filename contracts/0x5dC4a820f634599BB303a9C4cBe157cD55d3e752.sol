...
function sub_80610936(?) payable {
    ...
    if arg4 == mem[140 len 20]:
        ...
        if arg4 == mem[140 len 20]:
            ...
            mem[(32 * arg5.length) + (32 * arg6.length) + 160] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
            mem[(32 * arg5.length) + (32 * arg6.length) + 164] = 0
            mem[(32 * arg5.length) + (32 * arg6.length) + 196] = arg3
            require ext_code.size(address(_45))
            call address(_45).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                 gas gas_remaining wei
                args 0, arg3, address(_53), 128, 0, mem[(32 * arg5.length) + (32 * arg6.length) + 324]
            if not ext_call.success:
                revert with 0, '2'
            require 1 < arg6.length
            require ext_code.size(mem[(32 * arg5.length) + 204 len 20])
            call mem[(32 * arg5.length) + 204 len 20].swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                 gas gas_remaining wei
                args arg2, 0, this.address, 128, 0, mem[(32 * arg5.length) + (32 * arg6.length) + 324]
            if not ext_call.success:
                revert with 0, '4'
        else:
            ...
            call address(_51).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                 gas gas_remaining wei
                args arg3, 0, address(_59), 128, 0, mem[(32 * arg5.length) + (32 * arg6.length) + 324]
            if not ext_call.success:
                revert with 0, '3'
            require 1 < arg6.length
            require ext_code.size(mem[(32 * arg5.length) + 204 len 20])
            call mem[(32 * arg5.length) + 204 len 20].swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                 gas gas_remaining wei
                args 0, arg2, this.address, 128, 0, mem[(32 * arg5.length) + (32 * arg6.length) + 324]
            if not ext_call.success:
                revert with 0, '5'
    else:
        ...
        if arg4 == mem[140 len 20]:
            ...
            call address(_57).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                 gas gas_remaining wei
                args 0, arg3, address(_64), 128, 0, mem[(32 * arg5.length) + (32 * arg6.length) + 324]
            if not ext_call.success:
                revert with 0, '2'
            require 1 < arg6.length
            require ext_code.size(mem[(32 * arg5.length) + 204 len 20])
            ...
            call address(_63).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                 gas gas_remaining wei
                args arg3, 0, address(_70), 128, 0, mem[(32 * arg5.length) + (32 * arg6.length) + 324]
            if not ext_call.success:
                revert with 0, '3'
            require 1 < arg6.length
            require ext_code.size(mem[(32 * arg5.length) + 204 len 20])
