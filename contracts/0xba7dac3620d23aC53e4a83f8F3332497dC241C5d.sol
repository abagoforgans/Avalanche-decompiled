                ...
                if not return_data.size:
                    ...
                    if not ext_call.success:
                        ...
                        revert with 0, 
                                    ...
                                    Mask(144, -256, mem[arg4.length + ceil32(arg4.length) + 694 len 14]) << 256
                    require return_data.size >= 32
                    require Mask(32, 224, mem[arg4.length + ceil32(arg4.length) + 740]) == 0x150b7a0200000000000000000000000000000000000000000000000000000000
            else:
                ...
                if not return_data.size:
                    ...
                    if not ext_call.success:
                        ...
                        revert with 0, 
                                    ...
                                    Mask(144, -256, mem[floor32(arg4.length) + ceil32(arg4.length) + 726 len 14]) << 256
                    require return_data.size >= 32
                    require Mask(32, 224, mem[floor32(arg4.length) + ceil32(arg4.length) + 772]) == 0x150b7a0200000000000000000000000000000000000000000000000000000000
    else:
        tokenByIndex.length++
        tokenByIndex[tokenByIndex.length].field_0 = arg3
        address(tokenByIndex[tokenByIndex.length].field_256) = arg2
                ...
                if not return_data.size:
                    ...
                    if not ext_call.success:
                        ...
                        revert with 0, 
                                    ...
                                    Mask(144, -256, mem[arg4.length + ceil32(arg4.length) + 758 len 14]) << 256
                    require return_data.size >= 32
                    require Mask(32, 224, mem[arg4.length + ceil32(arg4.length) + 804]) == 0x150b7a0200000000000000000000000000000000000000000000000000000000
            else:
                ...
                if not return_data.size:
                    ...
                    if not ext_call.success:
                        ...
                        revert with 0, 
                                    ...
                                    Mask(144, -256, mem[floor32(arg4.length) + ceil32(arg4.length) + 790 len 14]) << 256
                    require return_data.size >= 32
                    require Mask(32, 224, mem[floor32(arg4.length) + ceil32(arg4.length) + 836]) == 0x150b7a0200000000000000000000000000000000000000000000000000000000
}
...
function sub_8f63e06a(?) payable {
    ...
    if not arg2:
        ...
        require 4 * 10^17 * arg1 == msg.value
        idx = 0
        while idx < arg1:
            _1995 = mem[64]
            mem[64] = mem[64] + 32
        ...
        if arg2 == 1:
            if 6 * 10^17 * arg1 / 6 * 10^17 != arg1:
                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[ceil32(arg3.length) + 229 len 31]
            require 6 * 10^17 * arg1 == msg.value
            idx = 0
            while idx < arg1:
                _1994 = mem[64]
                mem[64] = mem[64] + 32
            ...
            if arg2 != 2:
                ...
                if 8 * 10^17 * arg1 / 8 * 10^17 != arg1:
                    revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[ceil32(arg3.length) + 229 len 31]
                require 8 * 10^17 * arg1 == msg.value
                idx = 0
                while idx < arg1:
                    _1993 = mem[64]
                    mem[64] = mem[64] + 32
