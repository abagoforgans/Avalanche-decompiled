            ...
            if address(cd[((32 * idx) + cd[36] + 36)]):
                if address(cd[((32 * idx + 1) + cd[36] + 36)]):
                    if not ('cd', 68).length:
                        ...
                        staticcall pools[address(cd[((32 * idx) + cd[36] + 36)])][address(cd[((32 * idx + 1) + cd[36] + 36)])].0x47326cbb with:
                                gas gas_remaining wei
                               args s, address(cd[((32 * idx) + cd[36] + 36)]), address(cd[((32 * idx + 1) + cd[36] + 36)]), cd[((32 * idx) + cd[68] + 36)]
                else:
                    if not ('cd', 68).length:
                        mem[100] = s
                        mem[132] = address(cd[((32 * idx) + cd[36] + 36)])
                        ...
                        staticcall pools[address(cd[((32 * idx) + cd[36] + 36)])][address(cd[((32 * idx + 1) + cd[36] + 36)])].0x47326cbb with:
                                gas gas_remaining wei
                               args s, address(cd[((32 * idx) + cd[36] + 36)]), wNativeAddress, cd[((32 * idx) + cd[68] + 36)]
            else:
                if address(cd[((32 * idx + 1) + cd[36] + 36)]):
                    if not ('cd', 68).length:
                        mem[100] = s
                        ...
                        staticcall pools[address(cd[((32 * idx) + cd[36] + 36)])][address(cd[((32 * idx + 1) + cd[36] + 36)])].0x47326cbb with:
                                gas gas_remaining wei
                               args s, wNativeAddress, address(cd[((32 * idx + 1) + cd[36] + 36)]), cd[((32 * idx) + cd[68] + 36)]
                else:
                    if not ('cd', 68).length:
                        mem[100] = s
                        mem[132] = wNativeAddress
                        ...
                        staticcall pools[address(cd[((32 * idx) + cd[36] + 36)])][address(cd[((32 * idx + 1) + cd[36] + 36)])].0x47326cbb with:
                                gas gas_remaining wei
                               args s, wNativeAddress, wNativeAddress, cd[((32 * idx) + cd[68] + 36)]
        else:
            if not defaultPoolAddress:
