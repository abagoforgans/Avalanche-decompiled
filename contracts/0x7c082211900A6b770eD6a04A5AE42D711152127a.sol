...
function sub_4e331483(?) payable {
    ...
    call address(arg3).swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
         gas gas_remaining wei
        args arg4, 0, 160, stor0, block.timestamp + 120, show.length, mem[292 len 32 * show.length]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
...
function sub_035a9c7c(?) payable {
    ...
    require return_data.size >= 32
    _11 = mem[96 len 4], Mask(224, 32, arg4) >> 32
    require mem[96 len 4], Mask(224, 32, arg4) >> 32 <= test266151307()
    require mem[96 len 4], Mask(224, 32, arg4) >> 32 + 127 < return_data.size + 96
    _12 = mem[mem[96 len 4], Mask(224, 32, arg4) >> 32 + 96]
    if mem[mem[96 len 4], Mask(224, 32, arg4) >> 32 + 96] > test266151307():
        revert with 'NH{q', 65
    if ceil32(return_data.size) + floor32(mem[mem[96 len 4], Mask(224, 32, arg4) >> 32 + 96]) + 97 > test266151307() or floor32(mem[mem[96 len 4], Mask(224, 32, arg4) >> 32 + 96]) + 1 < 0:
        revert with 'NH{q', 65
    mem[64] = ceil32(return_data.size) + floor32(mem[mem[96 len 4], Mask(224, 32, arg4) >> 32 + 96]) + 97
