...
function sub_91056f1f(?) payable {
    ...
    _74 = mem[ceil32(return_data.size) + 256]
    ...
    mem[(32 * _49) + ceil32(return_data.size) + 260] = 99 * _74 / 100
    ...
    call traderJoeRouterAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args ext_call.return_data[0], 99 * _74 / 100, Array(len=2, data=mem[(32 * _49) + ceil32(return_data.size) + 420 len 64]), address(this.address), block.timestamp + 60
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_f5a85a10(?) payable {
    ...
    mem[(32 * _53) + ceil32(return_data.size) + 224] = 0x38ed173900000000000000000000000000000000000000000000000000000000
    mem[(32 * _53) + ceil32(return_data.size) + 228] = ext_call.return_data[0]
    mem[(32 * _53) + ceil32(return_data.size) + 260] = 99 * _76 / 100
    mem[(32 * _53) + ceil32(return_data.size) + 324] = this.address
    mem[(32 * _53) + ceil32(return_data.size) + 356] = block.timestamp + 60
    mem[(32 * _53) + ceil32(return_data.size) + 292] = 160
    mem[(32 * _53) + ceil32(return_data.size) + 388] = 2
    mem[(32 * _53) + ceil32(return_data.size) + 420 len 0] = None
    require ext_code.size(traderJoeRouterAddress)
    call traderJoeRouterAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args ext_call.return_data[0], 99 * _76 / 100, Array(len=2, data=mem[(32 * _53) + ceil32(return_data.size) + 420 len 64]), address(this.address), block.timestamp + 60
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(32 * _53) + ceil32(return_data.size) + 224 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = (32 * _53) + (2 * ceil32(return_data.size)) + 224
    require return_data.size >= 32
    require mem[(32 * _53) + ceil32(return_data.size) + 224 len 4], ext_call.return_data[0 len 28] <= 4294967296
    require mem[(32 * _53) + ceil32(return_data.size) + 224 len 4], ext_call.return_data[0 len 28] + 32 <= return_data.size
    require mem[(32 * _53) + ceil32(return_data.size) + mem[(32 * _53) + ceil32(return_data.size) + 224 len 4], ext_call.return_data[0 len 28] + 224] <= 4294967296 and mem[(32 * _53) + ceil32(return_data.size) + 224 len 4], ext_call.return_data[0 len 28] + (32 * mem[(32 * _53) + ceil32(return_data.size) + mem[(32 * _53) + ceil32(return_data.size) + 224 len 4], ext_call.return_data[0 len 28] + 224]) + 32 <= return_data.size
    require ext_code.size(sub_b328f1ecAddress)
    staticcall sub_b328f1ecAddress.0x70a08231 with:
            gas gas_remaining wei
           args this.address
