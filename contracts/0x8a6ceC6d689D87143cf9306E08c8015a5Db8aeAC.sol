...
function sub_c9e3b802(?) {
    ...
    mem[ceil32(return_data.size) + 196 len 96] = unknown_0xa9059cbb(?????), address(arg3) << 64, 0, ext_call.return_data[0] - 1, mem[ceil32(return_data.size) + 196 len 28]
...
function sub_fa7d3744(?) {
    ...
    mem[(4 * ceil32(return_data.size)) + 196 len 96] = unknown_0xa9059cbb(?????), address(arg3) << 64, 0, ext_call.return_data[0] - 1, mem[(4 * ceil32(return_data.size)) + 196 len 28]
    ...
    if address(arg1) < address(arg2):
        if address(arg1) == address(arg1):
            if not arg4:
                ...
                mem[(2 * ceil32(return_data.size)) + 196 len 96] = unknown_0xa9059cbb(?????), address(arg3) << 64, 0, arg4, mem[(2 * ceil32(return_data.size)) + 196 len 28]
    ...
    if arg1 < arg2:
        if arg1 == arg1:
            if not ext_call.return_data[0] - 1:
                ...
                mem[(2 * ceil32(return_data.size)) + 132 len 28] = address(arg3) << 64
                mem[(2 * ceil32(return_data.size)) + 128 len 4] = unknown_0xa9059cbb(?????)
                mem[(2 * ceil32(return_data.size)) + 196 len 96] = unknown_0xa9059cbb(?????), address(arg3) << 64, 0, ext_call.return_data[0] - 1, mem[(2 * ceil32(return_data.size)) + 196 len 28]
