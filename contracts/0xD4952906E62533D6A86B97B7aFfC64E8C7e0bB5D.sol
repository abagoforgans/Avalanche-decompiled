...
function retireStrat() payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0xc1a97bcbacf0566fc8c40291ffe7e634964b0446)
    call 0xc1a97bcbacf0566fc8c40291ffe7e634964b0446.emergencyWithdraw(uint256 rg1) with:
         gas gas_remaining wei
        args 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if not return_data.size:
        ...
        if return_data.size <= 0:
            ...
            if not return_data.size:
                ...
                if ext_code.size(0x6afd5a1ea4b793cc1526d6dc7e99a608b356ef7b) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 590 len 64] = approve(address rg1, uint256 rg2), 0xc1a97bcbacf0566fc8c40291, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                mem[(2 * ceil32(return_data.size)) + 654 len 0] = 0
                call 0x6afd5a1ea4b793cc1526d6dc7e99a608b356ef7b.0x964b0446 with:
                     gas gas_remaining wei
                    args Mask(480, -256, approve(address rg1, uint256 rg2), 0xc1a97bcbacf0566fc8c40291, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[(2 * ceil32(return_data.size)) + 654 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with approve(address rg1, uint256 rg2), 0xe54ca86531e17ef3616d22ca, 0, -1
                    if not approve(address rg1, uint256 rg2), 0xe54ca86531e17ef3616d22ca:
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] >= arg1:
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if ext_code.size(0x6afd5a1ea4b793cc1526d6dc7e99a608b356ef7b) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 553 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor1), uint32(stor1), ext_call.return_data[0 len 28]
                    ...
                    if ext_code.size(0x6afd5a1ea4b793cc1526d6dc7e99a608b356ef7b) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 553 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor1), uint32(stor1), Mask(224, 32, ext_call.return_data[0] - (50 * ext_call.return_data[0] / 10000)) >> 32
                    mem[ceil32(return_data.size) + 617 len 0] = 0
                    call 0x6afd5a1ea4b793cc1526d6dc7e99a608b356ef7b with:
                       funct uint32(stor1)
                         gas gas_remaining wei
        ...
        if ext_call.return_data[0] > arg1:
            revert with 0, 'SafeMath: subtraction overflow'
        require ext_code.size(0xc1a97bcbacf0566fc8c40291ffe7e634964b0446)
        call 0xc1a97bcbacf0566fc8c40291ffe7e634964b0446.withdraw(uint256 rg1, uint256 rg2) with:
             gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if return_data.size <= 0:
                        ...
                        if ext_code.size(0x6afd5a1ea4b793cc1526d6dc7e99a608b356ef7b) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 617 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor1), uint32(stor1), ext_call.return_data[0 len 28]
                    ...
                    if return_data.size <= 0:
                        ...
                        if ext_code.size(0x6afd5a1ea4b793cc1526d6dc7e99a608b356ef7b) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 617 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor1), uint32(stor1), Mask(224, 32, ext_call.return_data[0] - (50 * ext_call.return_data[0] / 10000)) >> 32
                        call 0x6afd5a1ea4b793cc1526d6dc7e99a608b356ef7b with:
                           funct uint32(stor1)
                             gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if not arg1:
                    ...
                    if return_data.size <= 0:
                        ...
                        if ext_code.size(0x6afd5a1ea4b793cc1526d6dc7e99a608b356ef7b) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 617 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor1), uint32(stor1), Mask(224, 32, arg1) >> 32
                        call 0x6afd5a1ea4b793cc1526d6dc7e99a608b356ef7b with:
                           funct uint32(stor1)
                             gas gas_remaining wei
