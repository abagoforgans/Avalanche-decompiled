...
function sub_47ffd897(?) payable {
    ...
    if sub_60b663bb.length <= 0:
        ...
        mem[192] = owner
        mem[224 len 14252] = code.data[5975 len 14252]
        idx = 0
        s = 96
        t = 14636
        while idx < 4:
        ...
        create contract with 0 wei
                        code: code.data[5975 len 14252], sub_acab85ae, sub_eead113b, arg1, sub_2716a509, sub_af6bf70c, mem[14636 len 128], 640, mem[14796 len 288], bool(sub_13c9c43e), sub_1f5cb64b.length, mem[15148 len 32 * sub_1f5cb64b.length]
    else:
        if sub_60b663bb.length < 1:
            revert with 0, 17
        if sub_60b663bb.length - 1 >= sub_60b663bb.length:
        ...
        mem[ceil32(return_data.size) + 224 len 14252] = code.data[5975 len 14252]
        idx = 0
        s = ceil32(return_data.size) + 96
        t = ceil32(return_data.size) + 14636
        while idx < 4:
            mem[t] = mem[s + 12 len 20]
            idx = idx + 1
            s = s + 32
        ...
        idx = 0
        s = 0
        t = ceil32(return_data.size) + 15148
        while idx < sub_1f5cb64b.length:
            mem[t] = sub_1f5cb64b[s]
            idx = idx + 1
            s = s + 1
        ...
        idx = 0
        s = 7
        t = ceil32(return_data.size) + 14796
        while idx < 3:
            mem[t] = stor[s]
            idx = idx + 1
            s = s + 1
        ...
        idx = 0
        s = 10
        t = ceil32(return_data.size) + 14892
        while idx < 6:
            mem[t] = stor[s]
            idx = idx + 1
            s = s + 1
            ...
            continue 
        create contract with 0 wei
                        code: code.data[5975 len 14252], sub_acab85ae, sub_eead113b, arg1, sub_2716a509, sub_af6bf70c, mem[ceil32(return_data.size) + 14636 len 128], 640, mem[ceil32(return_data.size) + 14796 len 288], bool(sub_13c9c43e), sub_1f5cb64b.length, mem[ceil32(return_data.size) + 15148 len 32 * sub_1f5cb64b.length]
