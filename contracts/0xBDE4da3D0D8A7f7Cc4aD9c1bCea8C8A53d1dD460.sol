...
function pendingToken(uint256 arg1, address arg2) payable {
    ...
    if block.number <= bonusEndBlock:
        if block.number < startBlock:
            ...
            if 10^12 * bonusMultiplier >= 10^12:
                ...
                if poolInfo[arg1].field_768 > -(10^12 * (10^12 * block.number * bonusMultiplier * tokenPerBlock) - (10^12 * poolInfo[arg1].field_512 * bonusMultiplier * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0]) - 1:
                    revert with 'NH{q', 17
                if userInfo[arg1][address(arg2)].field_0 and poolInfo[arg1].field_768 + (10^12 * (10^12 * block.number * bonusMultiplier * tokenPerBlock) - (10^12 * poolInfo[arg1].field_512 * bonusMultiplier * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0]) > -1 / userInfo[arg1][address(arg2)].field_0:
                    revert with 'NH{q', 17
                if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (10^12 * block.number * bonusMultiplier * tokenPerBlock) - (10^12 * poolInfo[arg1].field_512 * bonusMultiplier * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12 < userInfo[arg1][address(arg2)].field_256:
                    revert with 'NH{q', 17
                return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (10^12 * block.number * bonusMultiplier * tokenPerBlock) - (10^12 * poolInfo[arg1].field_512 * bonusMultiplier * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
        else:
            if bonusEndBlock < startBlock:
                if bonusMultiplier and 10^12 > -1 / bonusMultiplier:
                    revert with 'NH{q', 17
                ...
                if 10^12 < (10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock:
                    ...
                    if (10^12 * bonusMultiplier) - ((10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock * bonusMultiplier) >= 10^12:
                        ...
                        if poolInfo[arg1].field_768 > -(10^12 * (10^12 * bonusMultiplier * block.number * tokenPerBlock) - ((10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock * bonusMultiplier * block.number * tokenPerBlock) - (10^12 * bonusMultiplier * poolInfo[arg1].field_512 * tokenPerBlock) + ((10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock * bonusMultiplier * poolInfo[arg1].field_512 * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0]) - 1:
                            revert with 'NH{q', 17
                        if userInfo[arg1][address(arg2)].field_0 and poolInfo[arg1].field_768 + (10^12 * (10^12 * bonusMultiplier * block.number * tokenPerBlock) - ((10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock * bonusMultiplier * block.number * tokenPerBlock) - (10^12 * bonusMultiplier * poolInfo[arg1].field_512 * tokenPerBlock) + ((10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock * bonusMultiplier * poolInfo[arg1].field_512 * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0]) > -1 / userInfo[arg1][address(arg2)].field_0:
                            revert with 'NH{q', 17
                        if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (10^12 * bonusMultiplier * block.number * tokenPerBlock) - ((10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock * bonusMultiplier * block.number * tokenPerBlock) - (10^12 * bonusMultiplier * poolInfo[arg1].field_512 * tokenPerBlock) + ((10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock * bonusMultiplier * poolInfo[arg1].field_512 * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12 < userInfo[arg1][address(arg2)].field_256:
                            revert with 'NH{q', 17
                        return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (10^12 * bonusMultiplier * block.number * tokenPerBlock) - ((10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock * bonusMultiplier * block.number * tokenPerBlock) - (10^12 * bonusMultiplier * poolInfo[arg1].field_512 * tokenPerBlock) + ((10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock * bonusMultiplier * poolInfo[arg1].field_512 * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
        if block.number < poolInfo[arg1].field_512:
            revert with 'NH{q', 17
        ...
        if poolInfo[arg1].field_768 > -(10^12 * (10^12 * block.number * tokenPerBlock) - (10^12 * poolInfo[arg1].field_512 * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0]) - 1:
            revert with 'NH{q', 17
        if userInfo[arg1][address(arg2)].field_0 and poolInfo[arg1].field_768 + (10^12 * (10^12 * block.number * tokenPerBlock) - (10^12 * poolInfo[arg1].field_512 * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0]) > -1 / userInfo[arg1][address(arg2)].field_0:
            revert with 'NH{q', 17
        if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (10^12 * block.number * tokenPerBlock) - (10^12 * poolInfo[arg1].field_512 * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12 < userInfo[arg1][address(arg2)].field_256:
            revert with 'NH{q', 17
        return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (10^12 * block.number * tokenPerBlock) - (10^12 * poolInfo[arg1].field_512 * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
    ...
    if block.number < startBlock:
        ...
        if 10^12 * bonusMultiplier >= 10^12:
            ...
            if poolInfo[arg1].field_768 > -(10^12 * (10^12 * bonusEndBlock * bonusMultiplier * tokenPerBlock) - (10^12 * poolInfo[arg1].field_512 * bonusMultiplier * tokenPerBlock) + (10^12 * block.number * tokenPerBlock) - (10^12 * bonusEndBlock * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0]) - 1:
                revert with 'NH{q', 17
            if userInfo[arg1][address(arg2)].field_0 and poolInfo[arg1].field_768 + (10^12 * (10^12 * bonusEndBlock * bonusMultiplier * tokenPerBlock) - (10^12 * poolInfo[arg1].field_512 * bonusMultiplier * tokenPerBlock) + (10^12 * block.number * tokenPerBlock) - (10^12 * bonusEndBlock * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0]) > -1 / userInfo[arg1][address(arg2)].field_0:
                revert with 'NH{q', 17
            if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (10^12 * bonusEndBlock * bonusMultiplier * tokenPerBlock) - (10^12 * poolInfo[arg1].field_512 * bonusMultiplier * tokenPerBlock) + (10^12 * block.number * tokenPerBlock) - (10^12 * bonusEndBlock * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12 < userInfo[arg1][address(arg2)].field_256:
                revert with 'NH{q', 17
            return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (10^12 * bonusEndBlock * bonusMultiplier * tokenPerBlock) - (10^12 * poolInfo[arg1].field_512 * bonusMultiplier * tokenPerBlock) + (10^12 * block.number * tokenPerBlock) - (10^12 * bonusEndBlock * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
    else:
        if bonusEndBlock < startBlock:
            if bonusMultiplier and 10^12 > -1 / bonusMultiplier:
                revert with 'NH{q', 17
            ...
            if 10^12 < (10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock:
                ...
                if (10^12 * bonusMultiplier) - ((10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock * bonusMultiplier) >= 10^12:
                    ...
                    if poolInfo[arg1].field_768 > -(10^12 * (10^12 * bonusMultiplier * bonusEndBlock * tokenPerBlock) - ((10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock * bonusMultiplier * bonusEndBlock * tokenPerBlock) - (10^12 * bonusMultiplier * poolInfo[arg1].field_512 * tokenPerBlock) + ((10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock * bonusMultiplier * poolInfo[arg1].field_512 * tokenPerBlock) + (10^12 * block.number * tokenPerBlock) - (10^12 * bonusEndBlock * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0]) - 1:
                        revert with 'NH{q', 17
                    if userInfo[arg1][address(arg2)].field_0 and poolInfo[arg1].field_768 + (10^12 * (10^12 * bonusMultiplier * bonusEndBlock * tokenPerBlock) - ((10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock * bonusMultiplier * bonusEndBlock * tokenPerBlock) - (10^12 * bonusMultiplier * poolInfo[arg1].field_512 * tokenPerBlock) + ((10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock * bonusMultiplier * poolInfo[arg1].field_512 * tokenPerBlock) + (10^12 * block.number * tokenPerBlock) - (10^12 * bonusEndBlock * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0]) > -1 / userInfo[arg1][address(arg2)].field_0:
                        revert with 'NH{q', 17
                    if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (10^12 * bonusMultiplier * bonusEndBlock * tokenPerBlock) - ((10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock * bonusMultiplier * bonusEndBlock * tokenPerBlock) - (10^12 * bonusMultiplier * poolInfo[arg1].field_512 * tokenPerBlock) + ((10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock * bonusMultiplier * poolInfo[arg1].field_512 * tokenPerBlock) + (10^12 * block.number * tokenPerBlock) - (10^12 * bonusEndBlock * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12 < userInfo[arg1][address(arg2)].field_256:
                        revert with 'NH{q', 17
                    return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (10^12 * bonusMultiplier * bonusEndBlock * tokenPerBlock) - ((10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock * bonusMultiplier * bonusEndBlock * tokenPerBlock) - (10^12 * bonusMultiplier * poolInfo[arg1].field_512 * tokenPerBlock) + ((10^12 * block.number) - (10^12 * startBlock) / bonusEndBlock - startBlock * bonusMultiplier * poolInfo[arg1].field_512 * tokenPerBlock) + (10^12 * block.number * tokenPerBlock) - (10^12 * bonusEndBlock * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
    if block.number < bonusEndBlock:
        revert with 'NH{q', 17
    if block.number - bonusEndBlock and 10^12 > -1 / block.number - bonusEndBlock:
        revert with 'NH{q', 17
    ...
    if poolInfo[arg1].field_768 > -(10^12 * (-1 * 10^12 * poolInfo[arg1].field_512 * tokenPerBlock) + (10^12 * block.number * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0]) - 1:
        revert with 'NH{q', 17
    if userInfo[arg1][address(arg2)].field_0 and poolInfo[arg1].field_768 + (10^12 * (-1 * 10^12 * poolInfo[arg1].field_512 * tokenPerBlock) + (10^12 * block.number * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0]) > -1 / userInfo[arg1][address(arg2)].field_0:
        revert with 'NH{q', 17
    if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (-1 * 10^12 * poolInfo[arg1].field_512 * tokenPerBlock) + (10^12 * block.number * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12 < userInfo[arg1][address(arg2)].field_256:
        revert with 'NH{q', 17
    return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^12 * (-1 * 10^12 * poolInfo[arg1].field_512 * tokenPerBlock) + (10^12 * block.number * tokenPerBlock) / 10^12 * poolInfo[arg1].field_256 / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^12) - userInfo[arg1][address(arg2)].field_256)
}
