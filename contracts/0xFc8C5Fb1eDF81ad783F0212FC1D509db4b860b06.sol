...
function withdraw(uint256 arg1) payable {
    ...
    if not ext_call.return_data[0]:
        ...
        if ext_call.return_data[0] > ext_call.return_data[0]:
            revert with 0, 'SafeMath: subtraction overflow', 0
        mem[(7 * ceil32(return_data.size)) + 452] = msg.sender
        mem[(7 * ceil32(return_data.size)) + 484] = 0
        mem[(7 * ceil32(return_data.size)) + 416] = 68
        mem[(7 * ceil32(return_data.size)) + 452 len 28] = Mask(224, 32, msg.sender) >> 32
        mem[(7 * ceil32(return_data.size)) + 448 len 4] = unknown_0xa9059cbb(?????)
        ...
        if not ext_code.hash(0x6e84a6216ea6dacc71ee8e6b0a5b7322eebc0f):
            revert with 0, 'Address: call to non-contract'
        mem[(7 * ceil32(return_data.size)) + 580 len 96] = unknown_0xa9059cbb(?????), msg.sender, 0, 0
