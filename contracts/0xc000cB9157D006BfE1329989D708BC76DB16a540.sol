...
function sub_f1d387c9(?) payable {
    ...
    if arg1 >= stor17:
        ...
        call sub_e956dcd7Address.addLiquidity(uint256 arg1, uint256 arg2, address arg3) with:
             gas gas_remaining wei
            args uint16(stor16.field_0), arg1, this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(poolAddress)
    ...
    if arg1 >= stor17:
        ...
        if ext_call.return_data[0]:
            ...
            if not arg1:
                ...
                call gaugeAddress.0x441a3e70 with:
                     gas gas_remaining wei
                    args uint16(stor16.field_160) - 1 << 240, 10^6 * arg1 / ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require ext_code.size(poolAddress)
            staticcall poolAddress.0x70a08231 with:
...
function withdraw(uint256 arg1) payable {
        ...
        if not arg1:
            ...
            if arg1 < stor17:
                ...
                if not ext_call.return_data[0]:
                    ...
                    mem[(8 * ceil32(return_data.size)) + 164] = arg1
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(8 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg1, 0
                    ...
                    if not arg1:
                        ...
                        if not ext_call.return_data[0]:
                            revert with 0, 'SafeMath: division by zero', 0
                        mem[(8 * ceil32(return_data.size)) + 196] = 0 / ext_call.return_data[0]
                        require ext_code.size(gaugeAddress)
                        call gaugeAddress.0x441a3e70 with:
                             gas gas_remaining wei
                            args uint16(stor16.field_160) - 1 << 240, 0 / ext_call.return_data[0]
                        ...
                        if not ext_call.return_data[0]:
                            revert with 0, 'SafeMath: division by zero', 0
                        mem[(8 * ceil32(return_data.size)) + 196] = 10^6 * arg1 / ext_call.return_data[0]
                        require ext_code.size(gaugeAddress)
                        call gaugeAddress.0x441a3e70 with:
                             gas gas_remaining wei
                            args uint16(stor16.field_160) - 1 << 240, 10^6 * arg1 / ext_call.return_data[0]
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(13 * ceil32(return_data.size)) + 324 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg1, 0
    ...
    if not arg1:
        ...
        if not ext_code.hash(wantAddress):
            revert with 0, 'Address: call to non-contract'
        mem[(6 * ceil32(return_data.size)) + 324 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg1, 0
        ...
        if arg1 < stor17:
            ...
            if not ext_call.return_data[0]:
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(8 * ceil32(return_data.size)) + 324 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg1, 0
                ...
                if not arg1:
                    ...
                    if not ext_call.return_data[0]:
                        revert with 0, 'SafeMath: division by zero', 0
                    mem[(8 * ceil32(return_data.size)) + 260] = 10^6 * arg1 / ext_call.return_data[0]
                    require ext_code.size(gaugeAddress)
                    call gaugeAddress.0x441a3e70 with:
                         gas gas_remaining wei
                        args uint16(stor16.field_160) - 1 << 240, 10^6 * arg1 / ext_call.return_data[0]
                ...
                mem[(13 * ceil32(return_data.size)) + 292] = arg1
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(13 * ceil32(return_data.size)) + 388 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg1, 0
