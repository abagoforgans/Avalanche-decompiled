...
function changePatron(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
...
function changeURLBase(string arg1) payable {
    require calldata.size - 4 >= 32
...
function changeFileFormat(string arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 <= test266151307()
    require arg1 + 35 < calldata.size
    if arg1.length > test266151307():
