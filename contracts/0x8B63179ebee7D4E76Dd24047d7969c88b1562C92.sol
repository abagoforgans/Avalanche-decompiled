...
function sub_8ee05396(?) {
    ...
    require block.timestamp >= startTimestamp
    require sub_0d2cb02a
    if sub_4e5c9bde[address(arg1)] <= (block.timestamp - startTimestamp / sub_0d2cb02a) + 1:
        return 0
    return (sub_4e5c9bde[address(arg1)] + -(block.timestamp - startTimestamp / sub_0d2cb02a) - 1)
}
...
function sub_13ae9059(?) {
    ...
    require block.timestamp >= startTimestamp
    require sub_0d2cb02a
    sub_4e5c9bde[address(arg1)] = (block.timestamp - startTimestamp / sub_0d2cb02a) + sub_14e31e4e[stor15[address(arg1)]] + 1
...
function withdrawERC20() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(sub_9de2e1cbAddress)
    staticcall sub_9de2e1cbAddress.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_6d658624(?) payable {
    ...
    require block.timestamp >= startTimestamp
    require sub_0d2cb02a
    require sub_4e5c9bde[address(arg1)] > (block.timestamp - startTimestamp / sub_0d2cb02a) + 1
    ...
    require sub_0d2cb02a
    if sub_4e5c9bde[address(arg1)] <= (block.timestamp - startTimestamp / sub_0d2cb02a) + 1:
        sub_4e5c9bde[address(arg1)] = (block.timestamp - startTimestamp / sub_0d2cb02a) + 1
    else:
        sub_4e5c9bde[address(arg1)] = (block.timestamp - startTimestamp / sub_0d2cb02a) + (sub_4e5c9bde[address(arg1)] + -(block.timestamp - startTimestamp / sub_0d2cb02a) - 1 / 2) + 1
}
