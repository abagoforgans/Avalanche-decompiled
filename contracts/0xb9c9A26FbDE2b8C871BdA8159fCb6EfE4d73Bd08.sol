...
function convert(address arg1, address arg2, uint256 arg3, address arg4, address arg5) {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if sub_c1814d87[address(arg1)].field_0:
        staticcall sub_c1814d87[address(arg1)].field_8.balanceOf(address arg1) with:
                gas gas_remaining wei
               args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        staticcall sub_c1814d87[address(arg1)].field_8.balanceOf(address arg1) with:
               ...
               args this.address
    require return_data.size >= 32
    call sub_c1814d87[address(arg1)].field_8.transfer(address arg1, uint256 arg2) with:
         gas gas_remaining wei
...
function _fallback() payable {
    ...
    if unknown_0xe418405a(?????) > uint32(call.func_hash) >> 224:
        if unknown_0xd109be9c(?????) == uint32(call.func_hash) >> 224:
            ...
            require arg1 == address(arg1)
            return 0, sub_c1814d87[address(arg1)].field_8
        require unknown_0xe1b4989d(?????) == uint32(call.func_hash) >> 224
        require not msg.value
        require calldata.size - 4 >= 128
        require arg1 == address(arg1)
        require arg2 == address(arg2)
