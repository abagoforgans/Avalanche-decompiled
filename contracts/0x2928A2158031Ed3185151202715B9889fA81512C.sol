            ...
            while idx < ('cd', 4).length:
                ...
                if mem[_556 + 12 len 20] != stor5:
                    ...
                    if not stor2[cd[((32 * idx) + cd[4] + 36)] << 240]:
                        ...
                        mem[0] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        mem[32] = 8
                        levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] = uint8(_590)
                        mem[mem[64] + 4] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        ...
                        sub_fe8ff146[cd[((32 * idx) + cd[4] + 36)] << 240] = mem[_614]
                    ...
                    if not stor2[cd[((32 * idx) + cd[4] + 36)] << 240]:
                        ...
                        mem[0] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        mem[32] = 8
                        levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] = uint8(_630)
                        mem[mem[64] + 4] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        staticcall sub_6d4ede93Address.0xfe8ff146 with:
                                gas gas_remaining wei
                               args (cd[((32 * idx) + cd[4] + 36)] << 240)
                        ...
                        sub_fe8ff146[cd[((32 * idx) + cd[4] + 36)] << 240] = mem[_657]
                        stor2[cd[((32 * idx) + cd[4] + 36)] << 240] = 1
                if levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] >= 50:
                    revert with 0, 'Reached latest level'
                if levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] and 3600 > 65535 / levelOf[cd[((32 * idx) + cd[4] + 36)] << 240]:
                    revert with 'NH{q', 17
                if block.timestamp < sub_fe8ff146[cd[((32 * idx) + cd[4] + 36)] << 240]:
                    revert with 'NH{q', 17
                if block.timestamp - sub_fe8ff146[cd[((32 * idx) + cd[4] + 36)] << 240] <= uint16(3600 * levelOf[cd[((32 * idx) + cd[4] + 36)] << 240]):
                    revert with 0, 'Still need time before upgrading'
                if levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] >= sub_e0b05c26.length:
                    revert with 'NH{q', 50
                if s > -sub_e0b05c26[stor8[cd[((32 * idx) + cd[4] + 36)] << 240]] - 1:
                    revert with 'NH{q', 17
                if levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] > 254:
                    revert with 'NH{q', 17
                levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] = uint8(levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] + 1)
                mem[0] = uint16(cd[((32 * idx) + cd[4] + 36)])
                mem[32] = 9
                sub_fe8ff146[cd[((32 * idx) + cd[4] + 36)] << 240] = block.timestamp
                if idx >= ('cd', 4).length:
                    revert with 'NH{q', 50
                require cd[((32 * idx) + cd[4] + 36)] == uint16(cd[((32 * idx) + cd[4] + 36)])
                if levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] > 254:
                ...
                mem[mem[64] + 64] = uint8(levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] + 1)
                emit 0x68d3fd0f: msg.sender, cd[((32 * idx) + cd[4] + 36)] << 240, uint8(levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] + 1)
                if idx == -1:
                    revert with 'NH{q', 17
                idx = idx + 1
            ...
            while idx < ('cd', 4).length:
                ...
                if mem[_756 + 12 len 20] != stor5:
                    ...
                    if not stor2[cd[((32 * idx) + cd[4] + 36)] << 240]:
                        ...
                        mem[0] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        mem[32] = 8
                        levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] = uint8(_790)
                        mem[mem[64] + 4] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        staticcall sub_6d4ede93Address.0xfe8ff146 with:
                                gas gas_remaining wei
                               args (cd[((32 * idx) + cd[4] + 36)] << 240)
                        ...
                        sub_fe8ff146[cd[((32 * idx) + cd[4] + 36)] << 240] = mem[_814]
                        stor2[cd[((32 * idx) + cd[4] + 36)] << 240] = 1
                else:
                    mem[mem[64] + 4] = uint16(cd[((32 * idx) + cd[4] + 36)])
                    staticcall stor5.0x94edf9d4 with:
                    ...
                    if not stor2[cd[((32 * idx) + cd[4] + 36)] << 240]:
                        ...
                        mem[0] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        mem[32] = 8
                        levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] = uint8(_830)
                        mem[mem[64] + 4] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        staticcall sub_6d4ede93Address.0xfe8ff146 with:
                                gas gas_remaining wei
                               args (cd[((32 * idx) + cd[4] + 36)] << 240)
                        ...
                        sub_fe8ff146[cd[((32 * idx) + cd[4] + 36)] << 240] = mem[_857]
                        stor2[cd[((32 * idx) + cd[4] + 36)] << 240] = 1
                if levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] >= 50:
                    revert with 0, 'Reached latest level'
                if levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] and 3600 > 65535 / levelOf[cd[((32 * idx) + cd[4] + 36)] << 240]:
            ...
            while idx < ('cd', 4).length:
                ...
                if mem[_558 + 12 len 20] != stor5:
                    ...
                    if not stor2[cd[((32 * idx) + cd[4] + 36)] << 240]:
                        ...
                        mem[0] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        mem[32] = 8
                        levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] = uint8(_591)
                        mem[mem[64] + 4] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        staticcall sub_6d4ede93Address.0xfe8ff146 with:
                                gas gas_remaining wei
                               args (cd[((32 * idx) + cd[4] + 36)] << 240)
                        ...
                        sub_fe8ff146[cd[((32 * idx) + cd[4] + 36)] << 240] = mem[_617]
                        stor2[cd[((32 * idx) + cd[4] + 36)] << 240] = 1
                else:
                    mem[mem[64] + 4] = uint16(cd[((32 * idx) + cd[4] + 36)])
                    staticcall stor5.0x94edf9d4 with:
                    ...
                    if not stor2[cd[((32 * idx) + cd[4] + 36)] << 240]:
                        ...
                        mem[0] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        mem[32] = 8
                        levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] = uint8(_631)
                        mem[mem[64] + 4] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        staticcall sub_6d4ede93Address.0xfe8ff146 with:
                                gas gas_remaining wei
                               args (cd[((32 * idx) + cd[4] + 36)] << 240)
                        ...
                        sub_fe8ff146[cd[((32 * idx) + cd[4] + 36)] << 240] = mem[_661]
                        stor2[cd[((32 * idx) + cd[4] + 36)] << 240] = 1
                if levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] >= 50:
                    revert with 0, 'Reached latest level'
                if levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] and 3600 > 65535 / levelOf[cd[((32 * idx) + cd[4] + 36)] << 240]:
            ...
            while idx < ('cd', 4).length:
                ...
                if mem[_758 + 12 len 20] != stor5:
                    ...
                    if not stor2[cd[((32 * idx) + cd[4] + 36)] << 240]:
                        ...
                        mem[0] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        mem[32] = 8
                        levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] = uint8(_791)
                        mem[mem[64] + 4] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        staticcall sub_6d4ede93Address.0xfe8ff146 with:
                                gas gas_remaining wei
                               args (cd[((32 * idx) + cd[4] + 36)] << 240)
                        ...
                        sub_fe8ff146[cd[((32 * idx) + cd[4] + 36)] << 240] = mem[_817]
                        stor2[cd[((32 * idx) + cd[4] + 36)] << 240] = 1
                else:
                    mem[mem[64] + 4] = uint16(cd[((32 * idx) + cd[4] + 36)])
                    staticcall stor5.0x94edf9d4 with:
                    ...
                    if not stor2[cd[((32 * idx) + cd[4] + 36)] << 240]:
                        ...
                        mem[0] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        mem[32] = 8
                        levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] = uint8(_831)
                        mem[mem[64] + 4] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        staticcall sub_6d4ede93Address.0xfe8ff146 with:
                                gas gas_remaining wei
                               args (cd[((32 * idx) + cd[4] + 36)] << 240)
                        ...
                        sub_fe8ff146[cd[((32 * idx) + cd[4] + 36)] << 240] = mem[_861]
                        stor2[cd[((32 * idx) + cd[4] + 36)] << 240] = 1
                if levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] >= 50:
                    revert with 0, 'Reached latest level'
                if levelOf[cd[((32 * idx) + cd[4] + 36)] << 240] and 3600 > 65535 / levelOf[cd[((32 * idx) + cd[4] + 36)] << 240]:
