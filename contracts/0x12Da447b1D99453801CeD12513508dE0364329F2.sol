...
function sub_f87f7144(?) payable {
    ...
    create contract with 0 wei
                    code: code.data[14049 len 7760], address(arg1), arg2, ext_call.return_data[0], stor1, arg4, arg5, bool(arg6), sub_e3ec3c5f
...
function sub_dbc50686(?) payable {
    ...
    require return_data.size >= 32
    create contract with 0 wei
                    code: code.data[5583 len 8466], address(arg1), address(arg2), arg3, ext_call.return_data[0], stor1, arg5, arg6, bool(arg7), sub_e3ec3c5f
    if not create.new_address:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(address(arg1))
    call address(arg1).0x23b872dd with:
