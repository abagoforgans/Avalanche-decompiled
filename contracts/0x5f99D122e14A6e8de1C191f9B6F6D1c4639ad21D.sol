...
function sub_9e19916d(?) {
    return sub_9e19916dAddress
}

function sub_aa576350(?) {
    return sub_aa576350Address
}

function sub_c497bc4c(?) {
    return teams.length
}
...
function removeOwner(address arg1) {
    ...
    if not stor0[address(msg.sender)]:
        revert with 0, 'MultiOwnable: NOT OWNER'
...
function addOwner(address arg1) {
    ...
    if stor0[address(arg1)]:
        revert with 0, 'MultiOwnable: ALREADY OWNER'
...
function sub_3dc8d5ce(?) {
    ...
    if not stor0[address(msg.sender)]:
        revert with 0, 'MultiOwnable: NOT OWNER'
    require ext_code.size(sub_aa576350Address)
    call sub_aa576350Address.0x3dc8d5ce with:
         gas gas_remaining wei
        args arg1, arg2, arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function withdrawERC721(address arg1, address arg2, uint256 arg3) {
    require calldata.size - 4 >= 96
    require arg1 == arg1
    require arg2 == arg2
    require arg3 == arg3
