...
address sub_b1494df2Address; offset 16
...
function sub_76aad803(?) payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    staticcall sub_b1494df2Address.0x607af397 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    lastClaimTimestamp = ext_call.return_data[0]
    staticcall sub_b1494df2Address.0x1e1d8cf8 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    sub_1e1d8cf8 = ext_call.return_data[0]
}
...
function sub_fd851931(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if swapperAddress != msg.sender:
        revert with 0, 'only swpr'
    staticcall stor1.tokenTraits(uint256 arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
    ...
    require ext_call.return_data[32] == ext_call.return_data[54 len 10]
    require ext_call.return_data[64] == ext_call.return_data[76 len 20]
    if ext_call.return_data[0]:
        uint16(sub_771f2476[arg1].field_0) = uint16(arg1)
        Mask(80, 0, sub_771f2476[arg1].field_16) = Mask(80, 0, ext_call.return_data[32])
        address(sub_771f2476[arg1].field_96) = address(ext_call.return_data[64])
        if sub_457e5789 > -2:
            revert with 'NH{q', 17
        sub_457e5789++
        emit TokenStaked(address(ext_call.return_data[64]), arg1, Mask(80, 0, ext_call.return_data[32]));
    else:
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[0]
        if 8 < uint8(ext_call.return_data[256]):
            revert with 'NH{q', 17
        staticcall sub_b1494df2Address.0xdd55fcb3 with:
                gas gas_remaining wei
               args -uint8(ext_call.return_data[256]) + 8 << 248, ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 96
        if not bool((6 * ceil32(return_data.size)) + 192 <= test266151307()):
            revert with 'NH{q', 65
        require ext_call.return_data[0] == ext_call.return_data[30 len 2]
        require ext_call.return_data[32] == ext_call.return_data[54 len 10]
        require ext_call.return_data[64] == ext_call.return_data[76 len 20]
        if ext_call.return_data[30 len 2] != arg1:
            revert with 0, 'token id is not same'
        staticcall stor1.tokenTraits(uint256 arg1) with:
                gas gas_remaining wei
               args arg1
        if not ext_call.success:
        ...
        address(pack[-ext_call.return_data[287 len 1] + 8 << 248][uint256(pack[-ext_call.return_data[287 len 1] + 8 << 248].field_0)].field_96) = address(ext_call.return_data[64])
        emit TokenStaked(address(ext_call.return_data[64]), arg1, uint256(sub_7bde72dc));
}
