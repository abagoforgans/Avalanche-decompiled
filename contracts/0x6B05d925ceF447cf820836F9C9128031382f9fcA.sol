...
function sub_d7328527(?) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    mem[128] = code.data[16097 len 32]
    idx = 0
    while idx < 32:
        require idx < 32
...
function initialize(address arg1) {
    ...
    owner['receiverAddress'] = arg1
    require msg.sender == stor2[('name', 'stor6F77', 478745093490)]
    stor0[('name', 'stor7478', 500234085733)] = 10^18
    require msg.sender == stor2[('name', 'stor6F77', 478745093490)]
    stor0[('name', 'stor7669', 130195227305317)] = 100 * 10^18
    require msg.sender == stor2[('name', 'stor6F77', 478745093490)]
    referrerFee['referrerFee'] = 2 * 10^17
...
function sub_f14d7006(?) payable {
    ...
    if not ('cd', 4).length:
        ...
        mem[128 len 32 * ('cd', 4).length] = code.data[16097 len 32 * ('cd', 4).length]
        mem[(32 * ('cd', 4).length) + 128] = ('cd', 4).length
        mem[64] = (64 * ('cd', 4).length) + 160
        mem[(32 * ('cd', 4).length) + 160 len 32 * ('cd', 4).length] = code.data[16097 len 32 * ('cd', 4).length]
    idx = 0
...
function sub_2cfbb7de(?) {
    ...
    while stor1[('name', 'stor4549', 101262158169634702401520904603314992747418992333640)].length + 31 / 32 > idx:
        ...
        idx = idx + 1
        continue 
    mem[192] = code.data[16097 len 32]
    idx = 0
    while idx < 32:
        require idx < 32
...
function sub_723685a6(?) {
    ...
    mem[ceil32(arg1.length) + ceil32(arg2.length) + ceil32(stor1[('name', 'stor4549', 101262158169634702401520904603314992747418992333640)].length) + 544] = code.data[16097 len 32]
    idx = 0
    while idx < 32:
        require idx < 32
    ...
    if stor4[0][msg.sender][cd[100]]:
        ...
        if msg.sender == stor2[('name', 'stor6F77', 478745093490)]:
            ...
            while idx < ('cd', 36).length:
                ...
                call address(cd[4]).transferFrom(address rg1, address rg2, uint256 rg3) with:
                     gas gas_remaining wei
...
function sub_788ab883(?) payable {
    ...
    mem[128 len 32 * ('cd', 36).length] = code.data[16097 len 32 * ('cd', 36).length]
    mem[(32 * ('cd', 36).length) + 128] = ('cd', 36).length
    mem[(32 * ('cd', 36).length) + 160 len 32 * ('cd', 36).length] = code.data[16097 len 32 * ('cd', 36).length]
    mem[(64 * ('cd', 36).length) + 160] = ('cd', 36).length
    mem[64] = (98 * ('cd', 36).length) + 192
    mem[(64 * ('cd', 36).length) + 192 len 32 * ('cd', 36).length] = code.data[16097 len 32 * ('cd', 36).length]
    idx = 0
    while idx < ('cd', 36).length:
        mem[mem[64] + 32] = ',uint256,uint256,bytes)'
        require cd[((32 * idx) + cd[36] + 36)] == address(cd[((32 * idx) + cd[36] + 36)])
        ...
        if msg.sender == stor2[('name', 'stor6F77', 478745093490)]:
            ...
            if stor4[0][msg.sender]:
                ...
                while idx < ('cd', 36).length:
                    ...
                    _371 = mem[(32 * idx) + 128]
                    require idx < ('cd', 68).length
                    _381 = mem[(32 * idx) + (32 * ('cd', 36).length) + 160]
                    mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 399] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                    mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 403] = address(_371)
                    mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 435] = _381
                    require ext_code.size(address(cd[4]))
                    call address(cd[4]).transfer(address rg1, uint256 rg2) with:
                         gas gas_remaining wei
                        args address(_371), _381
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    idx = idx + 1
                    continue 
                ...
                if not address(cd[132]):
                    ...
                    while idx < ('cd', 36).length:
                        ...
                        _373 = mem[(32 * idx) + 128]
                        require idx < ('cd', 68).length
                        _383 = mem[(32 * idx) + (32 * ('cd', 36).length) + 160]
                        mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 399] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                        mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 403] = address(_373)
                        mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 435] = _383
                        require ext_code.size(address(cd[4]))
                        call address(cd[4]).transfer(address rg1, uint256 rg2) with:
                             gas gas_remaining wei
                            args address(_373), _383
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        idx = idx + 1
                        continue 
                    ...
                    if not referrerFee['referrerFee']:
                        ...
                        while idx < ('cd', 36).length:
                            ...
                            _375 = mem[(32 * idx) + 128]
                            require idx < ('cd', 68).length
                            _385 = mem[(32 * idx) + (32 * ('cd', 36).length) + 160]
                            mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 399] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                            mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 403] = address(_375)
                            mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 435] = _385
                            require ext_code.size(address(cd[4]))
                            call address(cd[4]).transfer(address rg1, uint256 rg2) with:
                                 gas gas_remaining wei
                                args address(_375), _385
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            idx = idx + 1
                            continue 
                        ...
                        while idx < ('cd', 36).length:
                            ...
                            _377 = mem[(32 * idx) + 128]
                            require idx < ('cd', 68).length
                            _387 = mem[(32 * idx) + (32 * ('cd', 36).length) + 160]
                            mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 399] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
                            mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 403] = address(_377)
                            mem[(32 * ('cd', 36).length) + (32 * ('cd', 68).length) + 435] = _387
                            require ext_code.size(address(cd[4]))
                            call address(cd[4]).transfer(address rg1, uint256 rg2) with:
                                 gas gas_remaining wei
                                args address(_377), _387
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            idx = idx + 1
                            continue 
...
function sub_35fdf13a(?) payable {
    ...
    if not ('cd', 36).length:
        ...
        mem[(64 * ('cd', 36).length) + 192 len 4] = transferFrom(address rg1, address rg2, uint256 rg3)
        mem[(64 * ('cd', 36).length) + 292 len floor32((127 * ('cd', 36).length) + 131)] = transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), cd[100], mem[(64 * ('cd', 36).length) + 292 len floor32((127 * ('cd', 36).length) + 131) - 100]
            ...
            if cd[132] != 2:
                if msg.sender == stor2[('name', 'stor6F77', 478745093490)]:
                    ...
                    while idx < ('cd', 36).length:
                        ...
                        require ext_code.size(address(cd[4]))
                        call address(cd[4]).safeTransferFrom(address rg1, address rg2, uint256 rg3) with:
                             gas gas_remaining wei
                ...
                if msg.sender == stor2[('name', 'stor6F77', 478745093490)]:
                    ...
                    while idx < ('cd', 36).length:
                        ...
                        require ext_code.size(address(cd[4]))
                        call address(cd[4]).safeTransferFrom(address rg1, address rg2, uint256 rg3, uint256 rg4, bytes rg5) with:
                             gas gas_remaining wei
