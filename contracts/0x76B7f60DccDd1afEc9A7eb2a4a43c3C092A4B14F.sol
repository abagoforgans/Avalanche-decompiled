...
function depositAll() payable {
        ...
        if not msg.sender:
            ...
            if 0 == balance:
                ...
                if not sharesOf[address(msg.sender)]:
                    ...
                    if (rewardPerTokenStored * sharesOf[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sharesOf[address(msg.sender)]) / sharesOf[address(msg.sender)] != rewardPerTokenStored - userRewardPerTokenPaid[address(msg.sender)]:
                        revert with 0, 'SafeMath: multiplication overflow'
                    mem[ceil32(return_data.size) + 160] = 26
                    mem[ceil32(return_data.size) + 192] = 'SafeMath: division by zero'
                    if rewards[address(msg.sender)] + ((rewardPerTokenStored * sharesOf[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sharesOf[address(msg.sender)]) / 10^18) < (rewardPerTokenStored * sharesOf[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sharesOf[address(msg.sender)]) / 10^18:
                        revert with 0, 'SafeMath: addition overflow'
                    rewards[address(msg.sender)] += (rewardPerTokenStored * sharesOf[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sharesOf[address(msg.sender)]) / 10^18
                ...
                if block.timestamp < periodFinish:
                    ...
                    if not block.timestamp - lastUpdateTime:
                        ...
                        if not sharesOf[address(msg.sender)]:
                            ...
                            if (0 / balance * sharesOf[address(msg.sender)]) + (rewardPerTokenStored * sharesOf[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sharesOf[address(msg.sender)]) / sharesOf[address(msg.sender)] != (0 / balance) + rewardPerTokenStored - userRewardPerTokenPaid[address(msg.sender)]:
                                revert with 0, 'SafeMath: multiplication overflow'
                            mem[ceil32(return_data.size) + 288] = 26
                            mem[ceil32(return_data.size) + 320] = 'SafeMath: division by zero'
                            if rewards[address(msg.sender)] + ((0 / balance * sharesOf[address(msg.sender)]) + (rewardPerTokenStored * sharesOf[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sharesOf[address(msg.sender)]) / 10^18) < (0 / balance * sharesOf[address(msg.sender)]) + (rewardPerTokenStored * sharesOf[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sharesOf[address(msg.sender)]) / 10^18:
                                revert with 0, 'SafeMath: addition overflow'
                            rewards[address(msg.sender)] += (0 / balance * sharesOf[address(msg.sender)]) + (rewardPerTokenStored * sharesOf[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sharesOf[address(msg.sender)]) / 10^18
                    else:
                        if (block.timestamp * rewardRate) - (lastUpdateTime * rewardRate) / block.timestamp - lastUpdateTime != rewardRate:
                            revert with 0, 'SafeMath: multiplication overflow'
                        if not (block.timestamp * rewardRate) - (lastUpdateTime * rewardRate):
                            ...
                            if not sharesOf[address(msg.sender)]:
                                ...
                                if ((10^18 * block.timestamp * rewardRate) - (10^18 * lastUpdateTime * rewardRate) / balance * sharesOf[address(msg.sender)]) + (rewardPerTokenStored * sharesOf[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sharesOf[address(msg.sender)]) / sharesOf[address(msg.sender)] != ((10^18 * block.timestamp * rewardRate) - (10^18 * lastUpdateTime * rewardRate) / balance) + rewardPerTokenStored - userRewardPerTokenPaid[address(msg.sender)]:
                                    revert with 0, 'SafeMath: multiplication overflow'
                                mem[ceil32(return_data.size) + 288] = 26
                                mem[ceil32(return_data.size) + 320] = 'SafeMath: division by zero'
                                if rewards[address(msg.sender)] + (((10^18 * block.timestamp * rewardRate) - (10^18 * lastUpdateTime * rewardRate) / balance * sharesOf[address(msg.sender)]) + (rewardPerTokenStored * sharesOf[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sharesOf[address(msg.sender)]) / 10^18) < ((10^18 * block.timestamp * rewardRate) - (10^18 * lastUpdateTime * rewardRate) / balance * sharesOf[address(msg.sender)]) + (rewardPerTokenStored * sharesOf[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sharesOf[address(msg.sender)]) / 10^18:
                                    revert with 0, 'SafeMath: addition overflow'
                                rewards[address(msg.sender)] += ((10^18 * block.timestamp * rewardRate) - (10^18 * lastUpdateTime * rewardRate) / balance * sharesOf[address(msg.sender)]) + (rewardPerTokenStored * sharesOf[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sharesOf[address(msg.sender)]) / 10^18
                else:
                    if lastUpdateTime > periodFinish:
                        revert with 0, 'SafeMath: subtraction overflow', 0
                    if not periodFinish - lastUpdateTime:
                        ...
                        if not (periodFinish * rewardRate) - (lastUpdateTime * rewardRate):
                            ...
                            if not sharesOf[address(msg.sender)]:
                                ...
                                if ((10^18 * periodFinish * rewardRate) - (10^18 * lastUpdateTime * rewardRate) / balance * sharesOf[address(msg.sender)]) + (rewardPerTokenStored * sharesOf[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sharesOf[address(msg.sender)]) / sharesOf[address(msg.sender)] != ((10^18 * periodFinish * rewardRate) - (10^18 * lastUpdateTime * rewardRate) / balance) + rewardPerTokenStored - userRewardPerTokenPaid[address(msg.sender)]:
                                    revert with 0, 'SafeMath: multiplication overflow'
                                mem[ceil32(return_data.size) + 288] = 26
                                mem[ceil32(return_data.size) + 320] = 'SafeMath: division by zero'
                                if rewards[address(msg.sender)] + (((10^18 * periodFinish * rewardRate) - (10^18 * lastUpdateTime * rewardRate) / balance * sharesOf[address(msg.sender)]) + (rewardPerTokenStored * sharesOf[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sharesOf[address(msg.sender)]) / 10^18) < ((10^18 * periodFinish * rewardRate) - (10^18 * lastUpdateTime * rewardRate) / balance * sharesOf[address(msg.sender)]) + (rewardPerTokenStored * sharesOf[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sharesOf[address(msg.sender)]) / 10^18:
                                    revert with 0, 'SafeMath: addition overflow'
                                rewards[address(msg.sender)] += ((10^18 * periodFinish * rewardRate) - (10^18 * lastUpdateTime * rewardRate) / balance * sharesOf[address(msg.sender)]) + (rewardPerTokenStored * sharesOf[address(msg.sender)]) - (userRewardPerTokenPaid[address(msg.sender)] * sharesOf[address(msg.sender)]) / 10^18
                userRewardPerTokenPaid[address(msg.sender)] = rewardPerTokenStored
                if ext_call.return_data[0] <= 0:
                    revert with 0, 'VaultFlipToLyd: amount must be greater than zero'
                if ext_call.return_data[0] + balance < balance:
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    emit Deposited(ext_call.return_data[0], msg.sender);
    stor308 = 1
}
