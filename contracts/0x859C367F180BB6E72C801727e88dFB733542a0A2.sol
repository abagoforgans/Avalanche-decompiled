...
function sub_7532ee60(?) payable {
    mem[64] = 96
    require not msg.value
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    idx = 0
    while idx < MAX_SUPPLY:
        mem[mem[64] + 4] = idx
...
function _fallback() payable {
    mem[64] = 128
    if calldata.size >= 4:
        if unknown_0x86478122(?????) > uint32(call.func_hash) >> 224:
            if unknown_0x438534ad(?????) <= uint32(call.func_hash) >> 224:
                if unknown_0x6352211e(?????) > uint32(call.func_hash) >> 224:
                    ...
                    if unknown_0x715018a6(?????) == uint32(call.func_hash) >> 224:
                        ...
                        if unknown_0x7532ee60(?????) == uint32(call.func_hash) >> 224:
                            require not msg.value
                            if owner != msg.sender:
                                revert with 0, 'Ownable: caller is not the owner'
                            idx = 0
                            while idx < MAX_SUPPLY:
                                ...
                                if mem[_10837 + 12 len 20]:
                                    ...
                                    require return_data.size >= 32
                                    _13443 = mem[_12645]
                                    require mem[_12645] == mem[_12645 + 12 len 20]
                                    mem[0] = idx
                                    mem[32] = 358
                                    if sub_c1608d6b[idx]:
                                        if sub_c1608d6b[stor352 + -stor356 - 1]:
                                            ...
                                            mem[64] = mem[64] + ceil32(return_data.size)
                                            require return_data.size >= 32
                                            require mem[_14859] == bool(mem[_14859])
                                            if mem[_14859]:
                                                stor359[stor358[idx]] = 1
                                        else:
                                            sub_c1608d6b[idx] = MAX_SUPPLY + -sub_5b449c4e - 1
                                        ...
                                        if address(_13443):
                                            if address(_13443):
                                                if not address(_13443):
                                                    revert with 0, 'ERC721: balance query for the zero address'
                                                tokenOfOwnerByIndex[address(_13443)][stor154[address(_13443)]] = sub_c1608d6b[idx]
                                                stor202[stor358[idx]] = balanceOf[address(_13443)]
                                        else:
                                            if tokenByIndex.length < 1:
                                                revert with 0, 17
                                            if tokenByIndex.length - 1 >= tokenByIndex.length:
                                            ...
                                            tokenByIndex[tokenByIndex.length] = 0
                                            tokenByIndex.length--
                                        if balanceOf[address(_13443)] > -2:
                                            revert with 0, 17
                                        balanceOf[address(_13443)]++
                                        mem[0] = sub_c1608d6b[idx]
                                        mem[32] = 153
                                        ownerOf[stor358[idx]] = address(_13443)
                                        emit Transfer(0, address(_13443), sub_c1608d6b[idx]);
                                    else:
                                        if sub_c1608d6b[stor352 + -stor356 - 1]:
                                            sub_c1608d6b[idx] = sub_c1608d6b[stor352 + -stor356 - 1]
                                            mem[mem[64] + 4] = idx
                                            ...
                                            mem[64] = mem[64] + ceil32(return_data.size)
                                            require return_data.size >= 32
                                            require mem[_15214] == bool(mem[_15214])
                                            if mem[_15214]:
                                                stor359[idx] = 1
                                        else:
                                            sub_c1608d6b[idx] = MAX_SUPPLY + -sub_5b449c4e - 1
                                            ...
                                            mem[64] = mem[64] + ceil32(return_data.size)
                                            require return_data.size >= 32
                                            require mem[_15215] == bool(mem[_15215])
                                            if mem[_15215]:
                                                stor359[idx] = 1
                                        if not address(_13443):
                                            revert with 0, 'ERC721: mint to the zero address'
                                        ...
                                        if address(_13443):
                                            if address(_13443):
                                                if not address(_13443):
                                                    revert with 0, 'ERC721: balance query for the zero address'
                                                tokenOfOwnerByIndex[address(_13443)][stor154[address(_13443)]] = idx
                                                stor202[idx] = balanceOf[address(_13443)]
                                        else:
                                            if tokenByIndex.length < 1:
                                                revert with 0, 17
                                            if tokenByIndex.length - 1 >= tokenByIndex.length:
                                        ...
                                        mem[0] = idx
                                        mem[32] = 153
                                        ownerOf[idx] = address(_13443)
                                        emit Transfer(0, address(_13443), idx);
                                    mem[mem[64]] = 0x438534ad00000000000000000000000000000000000000000000000000000000
                                    mem[mem[64] + 4] = idx
                                    require ext_code.size(sub_ac7b1c0aAddress)
                                    call sub_ac7b1c0aAddress.0x438534ad with:
            ...
            if unknown_0xc56eb1dc(?????) <= uint32(call.func_hash) >> 224:
                if unknown_0xe59b625f(?????) > uint32(call.func_hash) >> 224:
                    ...
                    if not s:
                        ...
                        if bool(stor364.length):
                            ...
                            if not bool(stor364.length):
                                ...
                                if ceil32(_20206) <= _20206:
                                    if bool(stor366.length):
                                        if bool(stor366.length) == uint255(stor366.length) * 0.5 < 32:
                                            revert with 0, 34
                                        if not bool(stor366.length):
                                            mem[mem[64] + (uint255(stor364.length) * 0.5) + _20206 + 32] = Mask(248, 8, stor366.length)
                                            _24310 = mem[64]
                                ...
                                mem[_20206 + mem[64] + (uint255(stor364.length) * 0.5) + 32] = 0
                                if bool(stor366.length):
                                    if bool(stor366.length) == uint255(stor366.length) * 0.5 < 32:
                                        revert with 0, 34
                                    if not bool(stor366.length):
                    ...
                    if bool(stor364.length):
                        ...
                        if not bool(stor364.length):
                            ...
                            if ceil32(_20208) <= _20208:
                                if bool(stor366.length):
                                    if bool(stor366.length) == uint255(stor366.length) * 0.5 < 32:
                                        revert with 0, 34
                                    if not bool(stor366.length):
                                        mem[mem[64] + (uint255(stor364.length) * 0.5) + _20208 + 32] = Mask(248, 8, stor366.length)
                                        _24318 = mem[64]
                            ...
                            mem[_20208 + mem[64] + (uint255(stor364.length) * 0.5) + 32] = 0
                            if bool(stor366.length):
                                if bool(stor366.length) == uint255(stor366.length) * 0.5 < 32:
                                    revert with 0, 34
                                if not bool(stor366.length):
                ...
                if unknown_0xb8746e73(?????) > uint32(call.func_hash) >> 224:
                    if unknown_0x9ef122ae(?????) > uint32(call.func_hash) >> 224:
                        if unknown_0x86478122(?????) == uint32(call.func_hash) >> 224:
                            require not msg.value
                            return mintTime
