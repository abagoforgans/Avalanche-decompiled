...
const INIT_CODE_PAIR_HASH = sha3(code.data[1963 len 9280], mem[18752 len 6], Mask(160, 48, code.data[11249 len 20]) >> 48)
...
function setCharity(address arg1) payable {
    require calldata.size - 4 >= 32
    if feeToSetterAddress != msg.sender:
        revert with 0, 'UniswapV2: FORBIDDEN'
    charityAddress = arg1
