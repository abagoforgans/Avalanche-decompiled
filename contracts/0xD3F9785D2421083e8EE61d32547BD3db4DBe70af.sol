...
const TIME = address(code.data[18597 len 32])
...
function totalTime() payable {
    ...
    require ext_code.size(code.data[18597 len 32])
    staticcall code.data[18597 len 32].0x70a08231 with:
            gas gas_remaining wei
           args owner
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function stake(uint256 arg1) payable {
    ...
    create contract with 0 wei
                    code: code.data[15727 len 2870], arg1
...
function sub_85e78423(?) payable {
    ...
    if sub_88bde76d >= mem[_97] - ext_call.return_data[0]:
        ...
        if mem[_97] - ext_call.return_data[0]:
            ...
            require ext_code.size(code.data[18597 len 32])
            call code.data[18597 len 32].0xa9059cbb with:
                 gas gas_remaining wei
...
function sub_3ead9f34(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        call sub_334d22d5[_91].0x4e71d92d with:
             gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if idx >= mem[96]:
...
function sub_1c623d4c(?) payable {
    ...
    while idx:
        ...
        mem[64] = mem[64] + ceil32(return_data.size)
        require return_data.size >= 32
        if mem[_431] < ext_call.return_data[0]:
            revert with 0, 17
        if sub_c978b3a7 > !s:
            revert with 0, 17
        if mem[_431] - ext_call.return_data[0] < arg1:
        ...
        require return_data.size >= 32
        _447 = mem[_446]
        if mem[_446] < ext_call.return_data[0]:
            revert with 0, 17
        if sub_b4d077cb >= mem[_446] - ext_call.return_data[0]:
            sub_b4d077cb = sub_b4d077cb - mem[_446] + ext_call.return_data[0]
            if not mem[_446] - ext_call.return_data[0]:
                mem[mem[64]] = mem[_446] - ext_call.return_data[0]
                return memory
                  from mem[64]
                   len 32
            mem[mem[64] + 4] = owner
            mem[mem[64] + 36] = _447 - ext_call.return_data[0]
            require ext_code.size(code.data[18597 len 32])
            call code.data[18597 len 32].0xa9059cbb with:
                 gas gas_remaining wei
                args owner, _447 - ext_call.return_data[0]
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _481 = mem[64]
        ...
        return (_447 - ext_call.return_data[0])
    if sub_c978b3a7 > !s:
        revert with 0, 17
    sub_c978b3a7 += s
    mem[mem[64] + 4] = this.address
    ...
    require return_data.size >= 32
    _438 = mem[_437]
    if mem[_437] < ext_call.return_data[0]:
        revert with 0, 17
    if sub_b4d077cb >= mem[_437] - ext_call.return_data[0]:
        sub_b4d077cb = sub_b4d077cb - mem[_437] + ext_call.return_data[0]
        if not mem[_437] - ext_call.return_data[0]:
            mem[mem[64]] = mem[_437] - ext_call.return_data[0]
            return memory
              from mem[64]
               len 32
        mem[mem[64] + 4] = owner
        mem[mem[64] + 36] = _438 - ext_call.return_data[0]
        require ext_code.size(code.data[18597 len 32])
        call code.data[18597 len 32].0xa9059cbb with:
             gas gas_remaining wei
            args owner, _438 - ext_call.return_data[0]
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _461 = mem[64]
    ...
    return (_438 - ext_call.return_data[0])
}
    ...
    if var50002 >= sub_7d57c52f:
        ...
        while idx:
            ...
            if mem[_259]:
                ...
                call stor[('name', 'sub_334d22d5', 6) + stor2 + t].0x4e71d92d with:
                     gas gas_remaining wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if sub_c978b3a7 > !t:
