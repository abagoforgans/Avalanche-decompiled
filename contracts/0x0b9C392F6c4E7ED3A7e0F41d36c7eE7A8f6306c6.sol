...
function sub_5f53a042(?) payable {
    ...
    staticcall stor2.getAmountsIn(uint256 arg1, address[] arg2) with:
            gas gas_remaining wei
           args uint256(stor3.field_0), Array(len=2, data=mem[292 len 64])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[192 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = ceil32(return_data.size) + 192
    require return_data.size >= 32
    require mem[192 len 4], Mask(224, 0, stor3.field_32) <= 4294967296
    require mem[192 len 4], Mask(224, 0, stor3.field_32) + 32 <= return_data.size
    require mem[mem[192 len 4], Mask(224, 0, stor3.field_32) + 192] <= 4294967296 and mem[192 len 4], Mask(224, 0, stor3.field_32) + (32 * mem[mem[192 len 4], Mask(224, 0, stor3.field_32) + 192]) + 32 <= return_data.size
}
