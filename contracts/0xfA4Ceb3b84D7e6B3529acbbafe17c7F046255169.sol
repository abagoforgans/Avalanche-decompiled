...
function burnActive() payable {
    return bool(burnActive)
}
...
function setBurnActive(bool arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if arg1 == 57005:
        ...
        if not burnActive:
            ...
            if arg2 != arg2:
                revert with 0, 32, 38, 0x7354455354467567753a3a7472616e736665723a204275726e2076616c756520696e76616c69, mem[266 len 26]
            if not msg.sender:
                revert with 0, 32, 37, 0xfe42455032303a207472616e736665722066726f6d20746865207a65726f20616464726573, mem[265 len 27]
            if not arg1:
                revert with 0, 32, 35, 0x6542455032303a207472616e7366657220746f20746865207a65726f20616464726573, mem[263 len 29]
            if arg2 > balanceOf[address(msg.sender)]:
                revert with 0, 
                            32,
                            38,
            ...
            if not arg2:
                if 0 > arg2:
                    revert with 0, 'SafeMath: subtraction overflow'
                if arg2 != arg2:
                    revert with 0, 32, 38, 0x7354455354467567753a3a7472616e736665723a204275726e2076616c756520696e76616c69, mem[330 len 26]
                if not msg.sender:
                ...
                if arg2 / 100 <= 0:
                    ...
                    if balanceOf[57005] + (arg2 / 100) < balanceOf[57005]:
                        revert with 0, 'SafeMath: addition overflow'
                    balanceOf[57005] += arg2 / 100
                    emit Transfer((arg2 / 100), msg.sender, 57005);
                    if not msg.sender:
                        revert with 0, 32, 37, 0xfe42455032303a207472616e736665722066726f6d20746865207a65726f20616464726573, mem[425 len 27]
                    if not arg1:
                    ...
                    if arg2 - (arg2 / 100) > balanceOf[address(msg.sender)]:
                        revert with 0, 
                                    ...
                                    mem[390 len 26],
                                    mem[442 len 6]
                ('le', ('add', ('param', 'arg2'), ('mul', -1, ('div', ('param', 'arg2'), 100))), ('stor', ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'balanceOf', 1))))
        ...
        if not burnActive:
            ...
            if not arg3:
                ...
                if arg3 / 100 <= 0:
                    ...
                    if balanceOf[address(arg2)] + arg3 - (arg3 / 100) < balanceOf[address(arg2)]:
                        revert with 0, 'SafeMath: addition overflow'
                    ...
                    if balanceOf[57005] + (arg3 / 100) < balanceOf[57005]:
                        revert with 0, 'SafeMath: addition overflow'
                    balanceOf[57005] += arg3 / 100
                    emit Transfer((arg3 / 100), arg1, 57005);
                    if not arg1:
                        revert with 0, 32, 37, 0xfe42455032303a207472616e736665722066726f6d20746865207a65726f20616464726573, mem[425 len 27]
                    if not arg2:
                        revert with 0, 32, 35, 0x6542455032303a207472616e7366657220746f20746865207a65726f20616464726573, mem[423 len 29]
