...
uint256 keepPNG;
address png_sherpa_png_lp_rewardsAddress;
address png_sherpa_png_lpAddress;
address sherpaAddress;

function png_sherpa_png_lp() {
    return png_sherpa_png_lpAddress
}
...
function png_sherpa_png_lp_rewards() {
    return png_sherpa_png_lp_rewardsAddress
}
