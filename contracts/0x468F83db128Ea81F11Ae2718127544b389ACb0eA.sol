...
function changeOperator(address arg1) {
    ...
    emit OperatorChanged(address(stor2), msg.sender);
    stor1 = 1
}
...
function sub_684d7bfb(?) payable {
    ...
    if msg.value < msg.value * ext_call.return_data[0] / 100:
        revert with 0, 17
    if msg.value - (msg.value * ext_call.return_data[0] / 100) < msg.value * stor3 / 100:
        revert with 0, 17
    if sub_4b5822b1[stor5[arg1].field_0] > !(msg.value - (msg.value * ext_call.return_data[0] / 100) - (msg.value * stor3 / 100)):
        revert with 0, 17
    sub_4b5822b1[stor5[arg1].field_0] = sub_4b5822b1[stor5[arg1].field_0] + msg.value - (msg.value * ext_call.return_data[0] / 100) - (msg.value * stor3 / 100)
    if sub_4b5822b1[address(stor2)] > !(msg.value * stor3 / 100):
        revert with 0, 17
    sub_4b5822b1[address(stor2)] += msg.value * stor3 / 100
    require ext_code.size(sub_ec7bca54[arg1].field_256)
...
function sub_2bc77fc9(?) {
    ...
    mem[180] = arg3
    mem[96] = 84
    sub_ec7bca54[stor4][address(arg2)][arg3].field_0 = address(arg1)
    sub_ec7bca54[stor4][address(arg2)][arg3].field_256 = address(arg2)
    sub_ec7bca54[stor4][address(arg2)][arg3].field_512 = arg3
    sub_ec7bca54[stor4][address(arg2)][arg3].field_768 = arg4
    if stor4 > -2:
        revert with 0, 17
    stor4++
    mem[0] = sha3(stor4, address(arg2), arg3)
    mem[32] = 5
    mem[212] = 0xc87b56dd00000000000000000000000000000000000000000000000000000000
    mem[216] = arg3
    require ext_code.size(sub_ec7bca54[stor4][address(arg2)][arg3].field_256)
    staticcall sub_ec7bca54[stor4][address(arg2)][arg3].field_256.0xc87b56dd with:
            gas gas_remaining wei
           args arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    emit 0xedb9bcc5: arg3, arg4, Array(len=_15, data=mem[mem[64] + 128 len ceil32(_15)]), sha3(stor4, address(arg2), arg3), address(arg2), address(arg1)
    stor1 = 1
    return sha3(stor4, address(arg2), arg3)
}
...
function sub_08ecda28(?) {
    ...
    if ext_call.return_data[0] < ext_call.return_data[0] * ext_call.return_data[0] / 100:
        revert with 0, 17
    if ext_call.return_data[0] - (ext_call.return_data[0] * ext_call.return_data[0] / 100) < ext_call.return_data[0] * stor3 / 100:
        revert with 0, 17
    if sub_4b5822b1[stor5[arg1].field_0] > !(ext_call.return_data[0] - (ext_call.return_data[0] * ext_call.return_data[0] / 100) - (ext_call.return_data[0] * stor3 / 100)):
        revert with 0, 17
    sub_4b5822b1[stor5[arg1].field_0] = sub_4b5822b1[stor5[arg1].field_0] + ext_call.return_data[0] - (ext_call.return_data[0] * ext_call.return_data[0] / 100) - (ext_call.return_data[0] * stor3 / 100)
    if sub_4b5822b1[address(stor2)] > !(ext_call.return_data[0] * stor3 / 100):
        revert with 0, 17
    sub_4b5822b1[address(stor2)] += ext_call.return_data[0] * stor3 / 100
    require ext_code.size(sub_ec7bca54[arg1].field_256)
    staticcall sub_ec7bca54[arg1].field_256.0x8da5cb5b with:
            gas gas_remaining wei
    if not ext_call.success:
...
function sub_188071e6(?) {
    ...
    mem[0] = sha3(stor4, address(arg1), arg2)
    mem[32] = 5
    sub_ec7bca54[stor4][address(arg1)][arg2].field_0 = address(ext_call.return_data[0])
    sub_ec7bca54[stor4][address(arg1)][arg2].field_256 = address(arg1)
    sub_ec7bca54[stor4][address(arg1)][arg2].field_512 = arg2
    sub_ec7bca54[stor4][address(arg1)][arg2].field_768 = arg3
    if stor4 > -2:
        revert with 0, 17
    stor4++
    ...
    emit 0xedb9bcc5: arg2, arg3, Array(len=_18, data=mem[mem[64] + 128 len ceil32(_18)]), sha3(stor4, address(arg1), arg2), address(arg1), address(ext_call.return_data[0])
    stor1 = 1
    return sha3(stor4, address(arg1), arg2)
}
