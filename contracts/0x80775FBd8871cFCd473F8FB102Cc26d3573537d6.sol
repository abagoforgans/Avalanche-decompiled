...
function setFeeTo(address arg1) payable {
    ...
    if feeToSetterAddress != msg.sender:
        revert with 0, 'setFeeTo: FORBIDDEN'
    feeToAddress = arg1
}
...
function setFeeToSetter(address arg1) payable {
    ...
    require arg1 == arg1
    if feeToSetterAddress != msg.sender:
        revert with 0, 'setFeeToSetter: FORBIDDEN'
...
function createPair(address arg1, address arg2) payable {
    ...
    require arg2 == arg2
    if arg1 == arg2:
        revert with 0, 'createPair: IDENTICAL_ADDRESSES'
    if arg1 < arg2:
        if not arg1:
            revert with 0, 'createPair: ZERO_ADDRESS'
        if pair[address(arg1)][address(arg2)]:
            revert with 0, 'PAIR already exists!'
        create2 contract with 0 wei
                        salt: sha3(arg1, arg2)
                        code: code.data[1791 len 10014]
