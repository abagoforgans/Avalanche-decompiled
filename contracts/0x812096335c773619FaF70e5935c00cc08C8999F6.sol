...
function sub_91065106(?) payable {
    return sub_91065106Address
}
...
function sub_20041f3a(?) payable {
    ...
    if invested[msg.sender]:
        require ext_code.size(sub_91065106Address)
        call sub_91065106Address.0xa9059cbb with:
