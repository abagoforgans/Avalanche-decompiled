...
function sub_fdfaaa05(?) payable {
    ...
    while idx < uint256(sub_0a3b7e31[msg.sender][address(arg1)].field_0):
        ...
        if uint32(block.timestamp) >= uint64(sub_0a3b7e31[msg.sender][address(arg1)][1][idx].field_64):
    ...
    if not ('cd', 4).length:
        if 0 < ('cd', 4).length:
            ...
            while idx < uint256(sub_0a3b7e31[msg.sender][address(('cd', 4)[0])].field_0):
                ...
                if uint32(block.timestamp) >= uint64(sub_0a3b7e31[msg.sender][address(('cd', 4)[0])][1][idx].field_64):
...
function sub_0f5636c3(?) {
    ...
    while idx < ('cd', 36).length:
        ...
        if uint32(block.timestamp) >= uint64(stor[_165].field_64):
            ...
            if uint32(block.timestamp) > mem[_166 + 24 len 8]:
                _175 = mem[_166]
                if mem[_166 + 24 len 8] > uint64(stor[_165].field_64):
                    revert with 0, 'SafeMath: subtraction overflow'
                _179 = mem[_166]
                if not uint32(block.timestamp) - mem[_166 + 24 len 8]:
                    ...
                    if (uint32(block.timestamp) * uint128(stor[_165].field_128)) - (mem[_166 + 24 len 8] * uint128(stor[_165].field_128)) / uint32(block.timestamp) - mem[_166 + 24 len 8] != uint128(stor[_165].field_128):
                        revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
                    if uint64(stor[_165].field_64) - mem[_166 + 24 len 8] <= 0:
                        revert with 0, 'SafeMath: division by zero'
                    require uint64(stor[_165].field_64) - mem[_166 + 24 len 8]
                    if uint128(stor1[_165]) > (uint32(block.timestamp) * uint128(stor[_165].field_0)) - (mem[_166 + 24 len 8] * uint128(stor[_165].field_0)) / uint64(stor[_165].field_64) - mem[_166 + 24 len 8]:
                        revert with 0, 'SafeMath: subtraction overflow'
                    if ((uint32(block.timestamp) * uint128(stor[_165].field_0)) - (mem[_166 + 24 len 8] * uint128(stor[_165].field_0)) / uint64(stor[_165].field_64) - mem[_166 + 24 len 8]) - uint128(stor1[_165]):
                        if (uint32(block.timestamp) * uint128(stor[_165].field_0)) - (mem[_166 + 24 len 8] * uint128(stor[_165].field_0)) / uint64(stor[_165].field_64) - mem[_166 + 24 len 8] < uint128(stor1[_165]):
                            revert with 0, 'SafeMath: addition overflow'
                        if (uint32(block.timestamp) * uint128(stor[_165].field_0)) - (mem[_166 + 24 len 8] * uint128(stor[_165].field_0)) / uint64(stor[_165].field_64) - mem[_166 + 24 len 8] >= 0x100000000000000000000000000000000:
                            revert with 0, 32, 39, 0x7353616665436173743a2076616c756520646f65736e27742066697420696e2031323820626974, mem[mem[64] + 107 len 25]
                        require idx < mem[96]
                        mem[0] = mem[(32 * idx) + 128]
                        mem[32] = sha3(address(cd[4]), sha3(msg.sender, 3)) + 1
                        uint128(sub_0a3b7e31[msg.sender][address(cd[4])][1][mem[(32 * idx) + 128]].field_256) = uint128((uint32(block.timestamp) * uint128(stor[_165].field_128)) - (uint64(_179) * uint128(stor[_165].field_128)) / uint64(stor[_165].field_64) - uint64(_175))
                        if ((uint32(block.timestamp) * uint128(stor[_165].field_128)) - (uint64(_179) * uint128(stor[_165].field_128)) / uint64(stor[_165].field_64) - uint64(_175)) - uint128(stor1[_165]) < 0:
                            revert with 0, 'SafeMath: addition overflow'
                        require idx < mem[96]
                        _230 = mem[(32 * idx) + 128]
                        mem[mem[64]] = ((uint32(block.timestamp) * uint128(stor[_165].field_128)) - (uint64(_179) * uint128(stor[_165].field_128)) / uint64(stor[_165].field_64) - uint64(_175)) - uint128(stor1[_165])
                        mem[mem[64] + 32] = _230
                        emit Vested(((uint32(block.timestamp) * uint128(stor[_165].field_128)) - (uint64(_179) * uint128(stor[_165].field_128)) / uint64(stor[_165].field_64) - uint64(_175)) - uint128(stor1[_165]), _230, address(cd[4]), msg.sender);
        idx = idx + 1
        continue 
    revert with 0, '0 vesting amount'
}
...
function sub_c33fddf8(?) {
    ...
    if not arg3 + -arg2 + 1:
        ...
        while idx < _320:
            ...
            if uint32(block.timestamp) >= uint64(stor[_333].field_64):
                ...
                if uint32(block.timestamp) > mem[_334 + 24 len 8]:
                    _354 = mem[_334]
                    if mem[_334 + 24 len 8] > uint64(stor[_333].field_64):
                        revert with 0, 'SafeMath: subtraction overflow'
                    _362 = mem[_334]
                    if not uint32(block.timestamp) - mem[_334 + 24 len 8]:
                        ...
                        if (uint32(block.timestamp) * uint128(stor[_333].field_128)) - (mem[_334 + 24 len 8] * uint128(stor[_333].field_128)) / uint32(block.timestamp) - mem[_334 + 24 len 8] != uint128(stor[_333].field_128):
                            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
                        if uint64(stor[_333].field_64) - mem[_334 + 24 len 8] <= 0:
                            revert with 0, 'SafeMath: division by zero'
                        require uint64(stor[_333].field_64) - mem[_334 + 24 len 8]
                        if uint128(stor1[_333]) > (uint32(block.timestamp) * uint128(stor[_333].field_0)) - (mem[_334 + 24 len 8] * uint128(stor[_333].field_0)) / uint64(stor[_333].field_64) - mem[_334 + 24 len 8]:
                            revert with 0, 'SafeMath: subtraction overflow'
                        if ((uint32(block.timestamp) * uint128(stor[_333].field_0)) - (mem[_334 + 24 len 8] * uint128(stor[_333].field_0)) / uint64(stor[_333].field_64) - mem[_334 + 24 len 8]) - uint128(stor1[_333]):
                            if (uint32(block.timestamp) * uint128(stor[_333].field_0)) - (mem[_334 + 24 len 8] * uint128(stor[_333].field_0)) / uint64(stor[_333].field_64) - mem[_334 + 24 len 8] < uint128(stor1[_333]):
                                revert with 0, 'SafeMath: addition overflow'
                            if (uint32(block.timestamp) * uint128(stor[_333].field_0)) - (mem[_334 + 24 len 8] * uint128(stor[_333].field_0)) / uint64(stor[_333].field_64) - mem[_334 + 24 len 8] >= 0x100000000000000000000000000000000:
                                revert with 0, 32, 39, 0x7353616665436173743a2076616c756520646f65736e27742066697420696e2031323820626974, mem[mem[64] + 107 len 25]
                            require idx < mem[96]
                            mem[0] = mem[(32 * idx) + 128]
                            mem[32] = sha3(address(arg1), sha3(msg.sender, 3)) + 1
                            uint128(sub_0a3b7e31[msg.sender][address(arg1)][1][mem[(32 * idx) + 128]].field_256) = uint128((uint32(block.timestamp) * uint128(stor[_333].field_128)) - (uint64(_362) * uint128(stor[_333].field_128)) / uint64(stor[_333].field_64) - uint64(_354))
                            if ((uint32(block.timestamp) * uint128(stor[_333].field_128)) - (uint64(_362) * uint128(stor[_333].field_128)) / uint64(stor[_333].field_64) - uint64(_354)) - uint128(stor1[_333]) < 0:
                                revert with 0, 'SafeMath: addition overflow'
                            require idx < mem[96]
                            _464 = mem[(32 * idx) + 128]
                            mem[mem[64]] = ((uint32(block.timestamp) * uint128(stor[_333].field_128)) - (uint64(_362) * uint128(stor[_333].field_128)) / uint64(stor[_333].field_64) - uint64(_354)) - uint128(stor1[_333])
                            mem[mem[64] + 32] = _464
                            emit Vested(((uint32(block.timestamp) * uint128(stor[_333].field_128)) - (uint64(_362) * uint128(stor[_333].field_128)) / uint64(stor[_333].field_64) - uint64(_354)) - uint128(stor1[_333]), _464, address(arg1), msg.sender);
            _320 = mem[96]
            idx = idx + 1
            continue 
    else:
        ...
        while idx < _321:
            ...
            if uint32(block.timestamp) >= uint64(stor[_336].field_64):
                ...
                if uint32(block.timestamp) > mem[_337 + 24 len 8]:
                    _356 = mem[_337]
                    if mem[_337 + 24 len 8] > uint64(stor[_336].field_64):
                        revert with 0, 'SafeMath: subtraction overflow'
                    _364 = mem[_337]
                    if not uint32(block.timestamp) - mem[_337 + 24 len 8]:
                        ...
                        if (uint32(block.timestamp) * uint128(stor[_336].field_128)) - (mem[_337 + 24 len 8] * uint128(stor[_336].field_128)) / uint32(block.timestamp) - mem[_337 + 24 len 8] != uint128(stor[_336].field_128):
                            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
                        if uint64(stor[_336].field_64) - mem[_337 + 24 len 8] <= 0:
                            revert with 0, 'SafeMath: division by zero'
                        require uint64(stor[_336].field_64) - mem[_337 + 24 len 8]
                        if uint128(stor1[_336]) > (uint32(block.timestamp) * uint128(stor[_336].field_0)) - (mem[_337 + 24 len 8] * uint128(stor[_336].field_0)) / uint64(stor[_336].field_64) - mem[_337 + 24 len 8]:
                            revert with 0, 'SafeMath: subtraction overflow'
                        if ((uint32(block.timestamp) * uint128(stor[_336].field_0)) - (mem[_337 + 24 len 8] * uint128(stor[_336].field_0)) / uint64(stor[_336].field_64) - mem[_337 + 24 len 8]) - uint128(stor1[_336]):
                            if (uint32(block.timestamp) * uint128(stor[_336].field_0)) - (mem[_337 + 24 len 8] * uint128(stor[_336].field_0)) / uint64(stor[_336].field_64) - mem[_337 + 24 len 8] < uint128(stor1[_336]):
                                revert with 0, 'SafeMath: addition overflow'
                            if (uint32(block.timestamp) * uint128(stor[_336].field_0)) - (mem[_337 + 24 len 8] * uint128(stor[_336].field_0)) / uint64(stor[_336].field_64) - mem[_337 + 24 len 8] >= 0x100000000000000000000000000000000:
                                revert with 0, 32, 39, 0x7353616665436173743a2076616c756520646f65736e27742066697420696e2031323820626974, mem[mem[64] + 107 len 25]
                            require idx < mem[96]
                            mem[0] = mem[(32 * idx) + 128]
                            mem[32] = sha3(address(arg1), sha3(msg.sender, 3)) + 1
                            uint128(sub_0a3b7e31[msg.sender][address(arg1)][1][mem[(32 * idx) + 128]].field_256) = uint128((uint32(block.timestamp) * uint128(stor[_336].field_128)) - (uint64(_364) * uint128(stor[_336].field_128)) / uint64(stor[_336].field_64) - uint64(_356))
                            if ((uint32(block.timestamp) * uint128(stor[_336].field_128)) - (uint64(_364) * uint128(stor[_336].field_128)) / uint64(stor[_336].field_64) - uint64(_356)) - uint128(stor1[_336]) < 0:
                                revert with 0, 'SafeMath: addition overflow'
                            require idx < mem[96]
                            _466 = mem[(32 * idx) + 128]
                            mem[mem[64]] = ((uint32(block.timestamp) * uint128(stor[_336].field_128)) - (uint64(_364) * uint128(stor[_336].field_128)) / uint64(stor[_336].field_64) - uint64(_356)) - uint128(stor1[_336])
                            mem[mem[64] + 32] = _466
                            emit Vested(((uint32(block.timestamp) * uint128(stor[_336].field_128)) - (uint64(_364) * uint128(stor[_336].field_128)) / uint64(stor[_336].field_64) - uint64(_356)) - uint128(stor1[_336]), _466, address(arg1), msg.sender);
            _321 = mem[96]
            idx = idx + 1
            continue 
    revert with 0, '0 vesting amount'
...
function sub_4d4f3d93(?) {
    ...
    if not ('cd', 4).length:
        ...
        while idx < cd[(cd[36] + ('cd', 36)[0] + 36)]:
            ...
            if uint32(block.timestamp) >= uint64(stor[_187].field_64):
                ...
                if uint32(block.timestamp) > mem[_188 + 24 len 8]:
                    _208 = mem[_188]
                    if mem[_188 + 24 len 8] > uint64(stor[_187].field_64):
                        revert with 0, 'SafeMath: subtraction overflow'
                    _216 = mem[_188]
                    if not uint32(block.timestamp) - mem[_188 + 24 len 8]:
                        ...
                        if (uint32(block.timestamp) * uint128(stor[_187].field_128)) - (mem[_188 + 24 len 8] * uint128(stor[_187].field_128)) / uint32(block.timestamp) - mem[_188 + 24 len 8] != uint128(stor[_187].field_128):
                            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
                        if uint64(stor[_187].field_64) - mem[_188 + 24 len 8] <= 0:
                            revert with 0, 'SafeMath: division by zero'
                        require uint64(stor[_187].field_64) - mem[_188 + 24 len 8]
                        if uint128(stor1[_187]) > (uint32(block.timestamp) * uint128(stor[_187].field_0)) - (mem[_188 + 24 len 8] * uint128(stor[_187].field_0)) / uint64(stor[_187].field_64) - mem[_188 + 24 len 8]:
                            revert with 0, 'SafeMath: subtraction overflow'
                        if ((uint32(block.timestamp) * uint128(stor[_187].field_0)) - (mem[_188 + 24 len 8] * uint128(stor[_187].field_0)) / uint64(stor[_187].field_64) - mem[_188 + 24 len 8]) - uint128(stor1[_187]):
                            if (uint32(block.timestamp) * uint128(stor[_187].field_0)) - (mem[_188 + 24 len 8] * uint128(stor[_187].field_0)) / uint64(stor[_187].field_64) - mem[_188 + 24 len 8] < uint128(stor1[_187]):
                                revert with 0, 'SafeMath: addition overflow'
                            if (uint32(block.timestamp) * uint128(stor[_187].field_0)) - (mem[_188 + 24 len 8] * uint128(stor[_187].field_0)) / uint64(stor[_187].field_64) - mem[_188 + 24 len 8] >= 0x100000000000000000000000000000000:
                                revert with 0, 32, 39, 0x7353616665436173743a2076616c756520646f65736e27742066697420696e2031323820626974, mem[mem[64] + 107 len 25]
                            require idx < mem[(32 * ('cd', 4).length) + 128]
                            mem[0] = mem[(32 * idx) + (32 * ('cd', 4).length) + 160]
                            mem[32] = sha3(address(('cd', 4)[0]), sha3(msg.sender, 3)) + 1
                            uint128(sub_0a3b7e31[msg.sender][address(('cd', 4)[0])][1][mem[(32 * idx) + (32 * ('cd', 4).length) + 160]].field_256) = uint128((uint32(block.timestamp) * uint128(stor[_187].field_128)) - (uint64(_216) * uint128(stor[_187].field_128)) / uint64(stor[_187].field_64) - uint64(_208))
                            if ((uint32(block.timestamp) * uint128(stor[_187].field_128)) - (uint64(_216) * uint128(stor[_187].field_128)) / uint64(stor[_187].field_64) - uint64(_208)) - uint128(stor1[_187]) < 0:
                                revert with 0, 'SafeMath: addition overflow'
                            require idx < mem[(32 * ('cd', 4).length) + 128]
                            _318 = mem[(32 * idx) + (32 * ('cd', 4).length) + 160]
                            mem[mem[64]] = ((uint32(block.timestamp) * uint128(stor[_187].field_128)) - (uint64(_216) * uint128(stor[_187].field_128)) / uint64(stor[_187].field_64) - uint64(_208)) - uint128(stor1[_187])
                            mem[mem[64] + 32] = _318
                            emit Vested(((uint32(block.timestamp) * uint128(stor[_187].field_128)) - (uint64(_216) * uint128(stor[_187].field_128)) / uint64(stor[_187].field_64) - uint64(_208)) - uint128(stor1[_187]), _318, address(('cd', 4)[0]), msg.sender);
            idx = idx + 1
            continue 
    else:
        mem[128 len 32 * ('cd', 4).length] = call.data[calldata.size len 32 * ('cd', 4).length]
        ...
        while idx < cd[(cd[36] + ('cd', 36)[0] + 36)]:
            ...
            if uint32(block.timestamp) >= uint64(stor[_190].field_64):
                ...
                if uint32(block.timestamp) > mem[_191 + 24 len 8]:
                    _210 = mem[_191]
                    if mem[_191 + 24 len 8] > uint64(stor[_190].field_64):
                        revert with 0, 'SafeMath: subtraction overflow'
                    _218 = mem[_191]
                    if not uint32(block.timestamp) - mem[_191 + 24 len 8]:
                        ...
                        if (uint32(block.timestamp) * uint128(stor[_190].field_128)) - (mem[_191 + 24 len 8] * uint128(stor[_190].field_128)) / uint32(block.timestamp) - mem[_191 + 24 len 8] != uint128(stor[_190].field_128):
                            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
                        if uint64(stor[_190].field_64) - mem[_191 + 24 len 8] <= 0:
                            revert with 0, 'SafeMath: division by zero'
                        require uint64(stor[_190].field_64) - mem[_191 + 24 len 8]
                        if uint128(stor1[_190]) > (uint32(block.timestamp) * uint128(stor[_190].field_0)) - (mem[_191 + 24 len 8] * uint128(stor[_190].field_0)) / uint64(stor[_190].field_64) - mem[_191 + 24 len 8]:
                            revert with 0, 'SafeMath: subtraction overflow'
                        if ((uint32(block.timestamp) * uint128(stor[_190].field_0)) - (mem[_191 + 24 len 8] * uint128(stor[_190].field_0)) / uint64(stor[_190].field_64) - mem[_191 + 24 len 8]) - uint128(stor1[_190]):
                            if (uint32(block.timestamp) * uint128(stor[_190].field_0)) - (mem[_191 + 24 len 8] * uint128(stor[_190].field_0)) / uint64(stor[_190].field_64) - mem[_191 + 24 len 8] < uint128(stor1[_190]):
                                revert with 0, 'SafeMath: addition overflow'
                            if (uint32(block.timestamp) * uint128(stor[_190].field_0)) - (mem[_191 + 24 len 8] * uint128(stor[_190].field_0)) / uint64(stor[_190].field_64) - mem[_191 + 24 len 8] >= 0x100000000000000000000000000000000:
                                revert with 0, 32, 39, 0x7353616665436173743a2076616c756520646f65736e27742066697420696e2031323820626974, mem[mem[64] + 107 len 25]
                            require idx < mem[(32 * ('cd', 4).length) + 128]
                            mem[0] = mem[(32 * idx) + (32 * ('cd', 4).length) + 160]
                            mem[32] = sha3(address(('cd', 4)[0]), sha3(msg.sender, 3)) + 1
                            uint128(sub_0a3b7e31[msg.sender][address(('cd', 4)[0])][1][mem[(32 * idx) + (32 * ('cd', 4).length) + 160]].field_256) = uint128((uint32(block.timestamp) * uint128(stor[_190].field_128)) - (uint64(_218) * uint128(stor[_190].field_128)) / uint64(stor[_190].field_64) - uint64(_210))
                            if ((uint32(block.timestamp) * uint128(stor[_190].field_128)) - (uint64(_218) * uint128(stor[_190].field_128)) / uint64(stor[_190].field_64) - uint64(_210)) - uint128(stor1[_190]) < 0:
                                revert with 0, 'SafeMath: addition overflow'
                            require idx < mem[(32 * ('cd', 4).length) + 128]
                            _320 = mem[(32 * idx) + (32 * ('cd', 4).length) + 160]
                            mem[mem[64]] = ((uint32(block.timestamp) * uint128(stor[_190].field_128)) - (uint64(_218) * uint128(stor[_190].field_128)) / uint64(stor[_190].field_64) - uint64(_210)) - uint128(stor1[_190])
                            mem[mem[64] + 32] = _320
                            emit Vested(((uint32(block.timestamp) * uint128(stor[_190].field_128)) - (uint64(_218) * uint128(stor[_190].field_128)) / uint64(stor[_190].field_64) - uint64(_210)) - uint128(stor1[_190]), _320, address(('cd', 4)[0]), msg.sender);
            idx = idx + 1
            continue 
    revert with 0, '0 vesting amount'
}

function sub_ff4931d3(?) payable {
    ...
    if not address(arg1):
        ...
        if not uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0):
            ...
            if uint32(arg5) + arg4 >= 18446744073709551616:
                revert with 0, 32, 38, 0x7753616665436173743a2076616c756520646f65736e27742066697420696e20363420626974, mem[330 len 26]
            ...
            uint64(sub_0a3b7e31[address(arg2)][address(arg1)][1][uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0)].field_64) = uint64(uint32(arg5) + arg4)
            ...
            emit 0xfb1fd0fe: arg4, uint32(arg5) + arg4, arg3, uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0), address(arg1), address(arg2)
        else:
            if arg4 != uint64(sub_0a3b7e31[address(arg2)][address(arg1)][1][uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0) - 1].field_0):
                ...
                if uint32(arg5) + arg4 == uint64(sub_0a3b7e31[address(arg2)][address(arg1)][1][uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0) - 1].field_64):
                    ...
                    if arg3 + sub_6e732b70[address(arg2)][address(arg1)] < sub_6e732b70[address(arg2)][address(arg1)]:
                        revert with 0, 'SafeMath: addition overflow'
                    sub_6e732b70[address(arg2)][address(arg1)] += arg3
                    emit 0xa6fd3a57: arg3, uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0) - 1, address(arg1), address(arg2)
                else:
                    if arg4 >= 18446744073709551616:
                        revert with 0, 32, 38, 0x7753616665436173743a2076616c756520646f65736e27742066697420696e20363420626974, mem[330 len 26]
                    if uint32(arg5) + arg4 >= 18446744073709551616:
...
function sub_1e2fabb6(?) payable {
    ...
    if not address(arg1):
        if arg3 != msg.value:
            revert with 0, 'Invalid msg.value'
        if uint32(arg4) + uint32(block.timestamp) < uint32(block.timestamp):
            revert with 0, 'SafeMath: addition overflow'
        if not uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0):
            if uint32(block.timestamp) >= 18446744073709551616:
                revert with 0, 32, 38, 0x7753616665436173743a2076616c756520646f65736e27742066697420696e20363420626974, mem[330 len 26]
            if uint32(arg4) + uint32(block.timestamp) >= 18446744073709551616:
                revert with 0, 32, 38, 0x7753616665436173743a2076616c756520646f65736e27742066697420696e20363420626974, mem[330 len 26]
            if arg3 >= 0x100000000000000000000000000000000:
                revert with 0, 32, 39, 0x7353616665436173743a2076616c756520646f65736e27742066697420696e2031323820626974, mem[331 len 25]
            uint32(sub_0a3b7e31[address(arg2)][address(arg1)][1][uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0)].field_0) = uint32(block.timestamp)
            uint32(sub_0a3b7e31[address(arg2)][address(arg1)][1][uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0)].field_32) = 0
            uint64(sub_0a3b7e31[address(arg2)][address(arg1)][1][uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0)].field_64) = uint64(uint32(arg4) + uint32(block.timestamp))
            uint128(sub_0a3b7e31[address(arg2)][address(arg1)][1][uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0)].field_128) = uint128(arg3)
            uint128(sub_0a3b7e31[address(arg2)][address(arg1)][1][uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0)].field_256) = 0
            uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0)++
            if arg3 + sub_6e732b70[address(arg2)][address(arg1)] < sub_6e732b70[address(arg2)][address(arg1)]:
                revert with 0, 'SafeMath: addition overflow'
            sub_6e732b70[address(arg2)][address(arg1)] += arg3
            emit 0xfb1fd0fe: block.timestamp << 224, uint32(arg4) + uint32(block.timestamp), arg3, uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0), address(arg1), address(arg2)
        else:
            if uint32(block.timestamp) != uint64(sub_0a3b7e31[address(arg2)][address(arg1)][1][uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0) - 1].field_0):
                if uint32(block.timestamp) >= 18446744073709551616:
                    revert with 0, 32, 38, 0x7753616665436173743a2076616c756520646f65736e27742066697420696e20363420626974, mem[330 len 26]
                if uint32(arg4) + uint32(block.timestamp) >= 18446744073709551616:
                    revert with 0, 32, 38, 0x7753616665436173743a2076616c756520646f65736e27742066697420696e20363420626974, mem[330 len 26]
                ...
                if uint32(arg4) + uint32(block.timestamp) == uint64(sub_0a3b7e31[address(arg2)][address(arg1)][1][uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0) - 1].field_64):
                    if arg3 + uint128(sub_0a3b7e31[address(arg2)][address(arg1)][1][uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0) - 1].field_128) < uint128(sub_0a3b7e31[address(arg2)][address(arg1)][1][uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0) - 1].field_128):
                        revert with 0, 'SafeMath: addition overflow'
                    if arg3 + uint128(sub_0a3b7e31[address(arg2)][address(arg1)][1][uint256(sub_0a3b7e31[address(arg2)][address(arg1)].field_0) - 1].field_128) >= 0x100000000000000000000000000000000:
                        revert with 0x8c379a000000000000000000000000000000000000000000000000000000000, 
