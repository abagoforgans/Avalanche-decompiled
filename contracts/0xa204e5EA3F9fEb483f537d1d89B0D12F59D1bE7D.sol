...
function earn() {
    ...
    staticcall earnedAddress.balanceOf(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function withdraw(uint256 arg1) {
    ...
    if not isCompound:
        ...
        if arg1 <= ext_call.return_data[0]:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[260 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), Mask(224, 0, stor10.field_32)
            call wantAddress with:
               funct uint32(stor6)
                 gas gas_remaining wei
            ...
            if not return_data.size:
                if not ext_call.success:
                    revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor6), uint32(stor6), wantLockedTotal
                if not transfer(address arg1, uint256 arg2), Mask(224, 0, stor6):
                    revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                if isCompound:
                    if not isCompound:
                    ...
                    if not ext_code.size(earnedAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[424 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), ext_call.return_data[0 len 28]
                    call earnedAddress with:
                       funct uint32(stor8)
                         gas gas_remaining wei
            ...
            if not ext_code.size(earnedAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 425 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), ext_call.return_data[0 len 28]
