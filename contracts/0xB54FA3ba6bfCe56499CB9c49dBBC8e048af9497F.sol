        ...
        if sub_26cc55b7[stor13].field_8 <= 0:
            ...
            if sub_a193d669 % 100 < stor14:
                ...
                if sub_a193d669 % 100 > stor14 + 15:
                    ...
                    stor4.length++
                    stor4[stor4.length] = sub_a193d669
                    stor5.length++
...
function sub_a52b64c5(?) {
    require msg.sender == address(stor17.field_8)
        ...
        if stor5.length > 0:
            ...
            while idx < stor5.length:
                ...
                if balanceOf[address(this.address)] < 1:
                    revert with 'NH{q', 17
                balanceOf[address(this.address)]--
                if balanceOf[address(stor17.field_0)] > -2:
                    revert with 'NH{q', 17
                balanceOf[address(stor17.field_0)]++
                mem[32] = 8
                ownerOf[stor5[idx]] = address(stor17.field_8)
                emit Transfer(this.address, address(stor17.field_8), stor5[idx]);
                if idx >= stor5.length:
                    revert with 'NH{q', 50
                mem[0] = 5
                if idx >= stor5.length:
