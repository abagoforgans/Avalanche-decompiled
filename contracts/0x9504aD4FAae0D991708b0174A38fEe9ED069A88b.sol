    ...
    if not return_data.size:
        ...
        if eth.balance(this.address) >= stor7:
            ...
            call stor1.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args stor7, stor8, Array(len=path.length, data=mem[ceil32(ceil32(arg2.length)) + 293 len 32 * path.length]), adminAddress, block.timestamp + 15
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
    else:
        ...
        if eth.balance(this.address) >= stor7:
            ...
            call stor1.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args stor7, stor8, Array(len=path.length, data=mem[ceil32(ceil32(arg2.length)) + ceil32(return_data.size) + 294 len 32 * path.length]), adminAddress, block.timestamp + 15
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
}
    ...
    if calldata.size < 4:
        ...
        if unknown_0xaf6d1fe4(?????) > uint32(call.func_hash) >> 224:
            if unknown_0x39cd523d(?????) <= uint32(call.func_hash) >> 224:
                if uint32(call.func_hash) >> 224 != unknown_0x39cd523d(?????):
                    if uint32(call.func_hash) >> 224 != unknown_0x704b6c02(?????):
                ...
                if uint32(call.func_hash) >> 224 != unknown_0x0bd1caef(?????):
                    if uint32(call.func_hash) >> 224 != unknown_0x144fa6d7(?????):
                        require unknown_0x207add91(?????) == uint32(call.func_hash) >> 224
                        require not msg.value
                        require calldata.size - 4 >= 64
                        if owner != msg.sender:
                            revert with 0, 'Caller is not the owner.'
                    ...
                    if not return_data.size:
                        ...
                        if eth.balance(this.address) >= stor7:
                            if 15 > !block.timestamp:
                                revert with 0, 17
                            idx = 0
                            s = ceil32(ceil32(arg2.length)) + 325
                            t = 0
                            while idx < path.length:
                                mem[s] = path[t]
                                idx = idx + 1
                            ...
                            call stor1.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                 gas gas_remaining wei
                                args stor7, stor8, Array(len=path.length, data=mem[ceil32(ceil32(arg2.length)) + 325 len 32 * path.length]), adminAddress, block.timestamp + 15
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                    else:
                        ...
                        if eth.balance(this.address) >= stor7:
                            if 15 > !block.timestamp:
                                revert with 0, 17
                            idx = 0
                            s = ceil32(ceil32(arg2.length)) + ceil32(return_data.size) + 326
                            t = 0
                            while idx < path.length:
                                mem[s] = path[t]
                                idx = idx + 1
                            ...
                            call stor1.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                 gas gas_remaining wei
                                args stor7, stor8, Array(len=path.length, data=mem[ceil32(ceil32(arg2.length)) + ceil32(return_data.size) + 326 len 32 * path.length]), adminAddress, block.timestamp + 15
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
        else:
            if unknown_0xe086e5ec(?????) > uint32(call.func_hash) >> 224:
                if unknown_0xaf6d1fe4(?????) == uint32(call.func_hash) >> 224:
                    ...
                    require arg1 < path.length
                    return path[arg1]
                if uint32(call.func_hash) >> 224 != unknown_0xc0d78655(?????):
                    require unknown_0xc54e44eb(?????) == uint32(call.func_hash) >> 224
                    require not msg.value
                    return USDTAddress
                require not msg.value
                require calldata.size - 4 >= 32
