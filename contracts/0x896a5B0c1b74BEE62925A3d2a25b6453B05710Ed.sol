...
function sub_792e9e61(?) payable {
    ...
    require ext_code.size(0x3f0de4ec592e4376aa6925c3b3dc33d5ffbcdcc3)
    staticcall 0x3f0de4ec592e4376aa6925c3b3dc33d5ffbcdcc3.token0() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    require ext_code.size(0x3f0de4ec592e4376aa6925c3b3dc33d5ffbcdcc3)
    staticcall 0x3f0de4ec592e4376aa6925c3b3dc33d5ffbcdcc3.getReserves() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
...
function sub_8fdadfc1(?) payable {
    ...
    if uint8(stor1.field_160):
        ...
        call 0x5b92738b2de8331bee366378f27d146dcbad85c5.rebase() with:
             gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[0]
        mem[(2 * ceil32(return_data.size)) + 100] = 0x5b92738b2de8331bee366378f27d146dcbad85c5
        mem[(2 * ceil32(return_data.size)) + 132] = ext_call.return_data[0]
        require ext_code.size(0x2ac4ccbc98a6680bbd9dd0a2eafbb13becf09644)
        call 0x2ac4ccbc98a6680bbd9dd0a2eafbb13becf09644.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
        ...
        require ext_code.size(0x5b92738b2de8331bee366378f27d146dcbad85c5)
        call 0x5b92738b2de8331bee366378f27d146dcbad85c5.unstake(uint256 arg1, bool arg2) with:
             gas gas_remaining wei
        ...
        mem[(6 * ceil32(return_data.size)) + 128] = 0xed46443c18e38064523180fc364c6180b35803d3
        ...
        require ext_code.size(0x5b92738b2de8331bee366378f27d146dcbad85c5)
        call 0x5b92738b2de8331bee366378f27d146dcbad85c5.epoch() with:
             gas gas_remaining wei
        ...
        mem[(2 * ceil32(return_data.size)) + 160] = 0xed46443c18e38064523180fc364c6180b35803d3
        require ext_code.size(0x3f0de4ec592e4376aa6925c3b3dc33d5ffbcdcc3)
        staticcall 0x3f0de4ec592e4376aa6925c3b3dc33d5ffbcdcc3.token0() with:
                gas gas_remaining wei
        ...
        if address(ext_call.return_data[0]) == 0x130966628846bfd36ff31a822705796e8cb8c18d:
            ...
            mem[mem[64] + 4] = 0x5b92738b2de8331bee366378f27d146dcbad85c5
            mem[mem[64] + 36] = _198
            require ext_code.size(0xed46443c18e38064523180fc364c6180b35803d3)
            call 0xed46443c18e38064523180fc364c6180b35803d3.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args 0x5b92738b2de8331bee366378f27d146dcbad85c5, _198
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _204 = mem[64]
            ...
            require ext_code.size(0x5b92738b2de8331bee366378f27d146dcbad85c5)
            call 0x5b92738b2de8331bee366378f27d146dcbad85c5.stake(uint256 arg1, address arg2) with:
                 gas gas_remaining wei
            ...
            call 0xed46443c18e38064523180fc364c6180b35803d3.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args 0x5b92738b2de8331bee366378f27d146dcbad85c5, _199
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _205 = mem[64]
        ...
        require ext_code.size(0x5b92738b2de8331bee366378f27d146dcbad85c5)
        call 0x5b92738b2de8331bee366378f27d146dcbad85c5.claim(address arg1) with:
             gas gas_remaining wei
            args address(this.address)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
