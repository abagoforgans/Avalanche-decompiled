...
function claimExpRewards() payable {
    require ext_code.size(gaugeAddress)
    call gaugeAddress.getRewardFor(address rg1) with:
...
function pendingExpRewards(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require ext_code.size(gaugeAddress)
    staticcall gaugeAddress.earned(address rg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function setGauge(address arg1) payable {
    ...
    call stakingTokenAddress.approve(address rg1, uint256 rg2) with:
         gas gas_remaining wei
        args gaugeAddress, -1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if msg.sender:
        if arg1:
            require ext_code.size(gaugeAddress)
            call gaugeAddress.withdrawFor(uint256 rg1, address rg2) with:
                 gas gas_remaining wei
                args arg2, msg.sender
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require ext_code.size(gaugeAddress)
            call gaugeAddress.depositFor(uint256 rg1, address rg2) with:
                 gas gas_remaining wei
                args arg2, arg1
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
...
function earn() payable {
    ...
    if not ext_call.return_data[0]:
        ...
        mem[ceil32(return_data.size) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), 0, 0
        mem[ceil32(return_data.size) + 328] = 0
        call tokenAddress with:
           funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), 0, 0) >> 224
             gas gas_remaining wei
            args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), 0, 0) << 288)
        ...
        if ext_code.size(tokenAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0] * min / 10000, 0
        mem[ceil32(return_data.size) + 328] = 0
        call tokenAddress with:
           funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0] * min / 10000, 0) >> 224
             gas gas_remaining wei
            args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor9), uint32(stor9), ext_call.return_data[0] * min / 10000, 0) << 288)
        if not return_data.size:
            if not ext_call.success:
                if ext_call.return_data[0] > 0:
                    revert with memory
...
function deposit(uint256 arg1) payable {
    ...
    if not totalSupply:
        ...
        require ext_code.size(stakingTokenAddress)
        call stakingTokenAddress.0x40c10f19 with:
             gas gas_remaining wei
        ...
        call stakingTokenAddress.0x40c10f19 with:
             gas gas_remaining wei
            args address(this.address), 0 / 2 * ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(gaugeAddress)
        call gaugeAddress.depositFor(uint256 rg1, address rg2) with:
    ...
    if not uint255(ext_call.return_data[0]):
        ...
        if ext_call.return_data[0] >= 0 / totalSupply:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require ext_code.size(stakingTokenAddress)
            call stakingTokenAddress.burn(address rg1, uint256 rg2) with:
                 gas gas_remaining wei
...
function withdrawAll() payable {
    ...
    if not uint255(ext_call.return_data[0]):
        ...
        if ext_call.return_data[0] >= 0 / totalSupply:
            ...
            call stakingTokenAddress.burn(address rg1, uint256 rg2) with:
                 gas gas_remaining wei
                args address(this.address), balanceOf[address(msg.sender)]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if not totalSupply:
