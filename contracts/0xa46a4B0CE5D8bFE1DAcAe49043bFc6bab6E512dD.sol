...
function BuyToken(address arg1, address arg2, uint256 arg3) payable {
    ...
    mem[(32 * _47) + ceil32(return_data.size) + 452] = mem[ceil32(return_data.size) + 352]
    ...
    call 0x60ae616a2155ee3d9a68541ba4544862310933d4.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args arg3, mem[ceil32(return_data.size) + 352], Array(len=2, data=mem[(32 * _47) + ceil32(return_data.size) + 612 len 64]), address(this.address), block.timestamp + 15
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function BuyMaxToken(address arg1, address arg2) payable {
    ...
    mem[(32 * _51) + ceil32(return_data.size) + 452] = mem[ceil32(return_data.size) + 352]
    ...
    call 0x60ae616a2155ee3d9a68541ba4544862310933d4.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args ext_call.return_data[0], mem[ceil32(return_data.size) + 352], Array(len=2, data=mem[(32 * _51) + ceil32(return_data.size) + 612 len 64]), address(this.address), block.timestamp + 15
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
