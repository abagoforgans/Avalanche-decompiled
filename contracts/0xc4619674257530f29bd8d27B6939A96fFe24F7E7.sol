        ...
        if bool(stor15[stor10 + 1].field_1792):
            ...
            if not ('cd', 100).length:
                ...
                if not ('cd', 100).length:
                    ...
                    mem[_3802 + 96] = 1
                    mem[32] = sha3(cd[36], 0)
                    if balanceOf[cd[36]][address(msg.sender)] > -2:
                        revert with 0, 17
                    balanceOf[cd[36]][address(msg.sender)]++
                    mem[_3802 + 128] = cd[36]
                    mem[_3802 + 160] = 1
                    emit TransferSingle(cd[36], 1, msg.sender, 0, msg.sender);
                    ...
                    emit URI(mem[mem[64] len ceil32(('cd', 100).length) + _3773 + -mem[64] + 64], stor10 + 1);
                    _3805 = mem[64]
                    mem[64] = mem[64] + 32
                    mem[_3805] = 0
                    if not msg.sender:
                ...
                if not ('cd', 100).length:
                    ...
                    mem[mem[64] + 64 len ('cd', 100).length] = call.data[cd[100] + 36 len ('cd', 100).length]
                    mem[('cd', 100).length + mem[64] + 64] = 0
                    emit URI(mem[mem[64] len ceil32(('cd', 100).length) + _5065 + -mem[64] + 64], stor10 + 1);
                    _5121 = mem[64]
                    mem[64] = mem[64] + 32
                    mem[_5121] = 0
                    if not msg.sender:
            ...
            if not ('cd', 100).length:
                ...
                if not ('cd', 100).length:
                    ...
                    mem[mem[64] + 64 len ('cd', 100).length] = call.data[cd[100] + 36 len ('cd', 100).length]
                    mem[('cd', 100).length + mem[64] + 64] = 0
                    emit URI(mem[mem[64] len ceil32(('cd', 100).length) + _3779 + -mem[64] + 64], stor10 + 1);
                    _3819 = mem[64]
                    mem[64] = mem[64] + 32
                    mem[_3819] = 0
                    if not msg.sender:
                ...
                if not ('cd', 100).length:
                    ...
                    mem[mem[64] + 64 len ('cd', 100).length] = call.data[cd[100] + 36 len ('cd', 100).length]
                    mem[('cd', 100).length + mem[64] + 64] = 0
                    emit URI(mem[mem[64] len ceil32(('cd', 100).length) + _5073 + -mem[64] + 64], stor10 + 1);
                    _5125 = mem[64]
                    mem[64] = mem[64] + 32
                    mem[_5125] = 0
                    if not msg.sender:
