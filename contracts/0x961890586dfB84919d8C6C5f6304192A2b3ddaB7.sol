...
const getName = 'StrategyPngAvaxUsdtLp'
...
uint256 keepPNG;
address sub_b9d2afffAddress;
address sub_445f06a5Address;
address usdtAddress;
...
function sub_445f06a5(?) {
    return sub_445f06a5Address
}
...
function sub_b9d2afff(?) {
    return sub_b9d2afffAddress
}
