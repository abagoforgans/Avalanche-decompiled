...
function sub_b33c690c(?) payable {
    ...
    call splitterAddress.split(uint256 arg1) with:
         gas gas_remaining wei
        args msg.value
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
        ...
        if msg.sender:
            if not msg.sender:
                ...
                if not ext_code.size(msg.sender):
                    ...
                    call sub_3bc9c8dcAddress.random(address arg1) with:
                         gas gas_remaining wei
                        args tx.origin
                    ...
                    s = 0
                    while s < 0:
                        mem[s + mem[64] + 164] = mem[s + _369 + 32]
                        s = s + 32
                        continue 
...
function sub_238aa9cd(?) payable {
    ...
    if arg2 == 1:
        ...
        while idx < arg1:
            ...
            if address(arg3):
                if not address(arg3):
                    ...
                    mem[0] = sub_d3f4f1e0
                    mem[32] = 2
                    ownerOf[stor37] = address(arg3)
                    emit Transfer(0, address(arg3), sub_d3f4f1e0);
                    if not ext_code.size(address(arg3)):
                        ...
                        s = 0
                        while s < 0:
                            mem[s + mem[64] + 164] = mem[s + _723 + 32]
                            s = s + 32
                            continue 
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_1435] == Mask(32, 224, mem[_1435])
                        if Mask(32, 224, mem[_1435]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                        mem[mem[64] + 4] = tx.origin
                        call sub_3bc9c8dcAddress.random(address arg1) with:
                             gas gas_remaining wei
                    ...
                    if not address(arg3):
                        revert with 0, 'ERC721: balance query for the zero address'
                    tokenOfOwnerByIndex[address(arg3)][stor3[address(arg3)]] = sub_d3f4f1e0
                    stor7[stor37] = balanceOf[address(arg3)]
                    if balanceOf[address(arg3)] > -2:
                        revert with 0, 17
                    balanceOf[address(arg3)]++
                    mem[0] = sub_d3f4f1e0
                    ...
                    if not ext_code.size(address(arg3)):
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_1437] == Mask(32, 224, mem[_1437])
                        if Mask(32, 224, mem[_1437]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                        mem[mem[64] + 4] = tx.origin
                        call sub_3bc9c8dcAddress.random(address arg1) with:
                             gas gas_remaining wei
                ...
                if not ext_code.size(address(arg3)):
                    ...
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    require mem[_1439] == Mask(32, 224, mem[_1439])
                    if Mask(32, 224, mem[_1439]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                        revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                    mem[mem[64] + 4] = tx.origin
                    call sub_3bc9c8dcAddress.random(address arg1) with:
                         gas gas_remaining wei
        ...
        if arg2 != 2:
            revert with 0, 'invalid farmers type'
        idx = 0
        while idx < arg1:
            if sub_d3f4f1e0 > -2:
                revert with 0, 17
            ...
            if address(arg3):
                if not address(arg3):
                    ...
                    if not ext_code.size(address(arg3)):
                        ...
                        s = 0
                        while s < 0:
                            mem[s + mem[64] + 164] = mem[s + _725 + 32]
                            s = s + 32
                            continue 
                        call address(arg3).onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                             gas gas_remaining wei
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_1441] == Mask(32, 224, mem[_1441])
                        if Mask(32, 224, mem[_1441]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                        mem[mem[64] + 4] = tx.origin
                        call sub_3bc9c8dcAddress.random(address arg1) with:
                             gas gas_remaining wei
                    ...
                    if not ext_code.size(address(arg3)):
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_1443] == Mask(32, 224, mem[_1443])
                        if Mask(32, 224, mem[_1443]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                        mem[mem[64] + 4] = tx.origin
                        call sub_3bc9c8dcAddress.random(address arg1) with:
                             gas gas_remaining wei
                ...
                if not ext_code.size(address(arg3)):
                    ...
                    if Mask(32, 224, mem[_1445]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                        revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                    mem[mem[64] + 4] = tx.origin
                    call sub_3bc9c8dcAddress.random(address arg1) with:
                         gas gas_remaining wei
            ...
            if msg.sender:
                if not msg.sender:
                    ...
                    if not ext_code.size(msg.sender):
                        ...
                        s = 0
                        while s < 0:
                            mem[s + mem[64] + 164] = mem[s + _1074 + 32]
                            s = s + 32
                            continue 
                        call msg.sender.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                             gas gas_remaining wei
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_2142] == Mask(32, 224, mem[_2142])
                        if Mask(32, 224, mem[_2142]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                        mem[mem[64] + 4] = tx.origin
                        call sub_3bc9c8dcAddress.random(address arg1) with:
                             gas gas_remaining wei
                    ...
                    if not ext_code.size(msg.sender):
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_2144] == Mask(32, 224, mem[_2144])
                        if Mask(32, 224, mem[_2144]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                        mem[mem[64] + 4] = tx.origin
                        call sub_3bc9c8dcAddress.random(address arg1) with:
                             gas gas_remaining wei
                ...
                if not ext_code.size(msg.sender):
                    ...
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    require mem[_2146] == Mask(32, 224, mem[_2146])
                    if Mask(32, 224, mem[_2146]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                        revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                    mem[mem[64] + 4] = tx.origin
                    call sub_3bc9c8dcAddress.random(address arg1) with:
                         gas gas_remaining wei
                ...
                if msg.sender:
                    if not msg.sender:
                        ...
                        if not ext_code.size(msg.sender):
                            ...
                            s = 0
                            while s < 0:
                                mem[s + mem[64] + 164] = mem[s + _1076 + 32]
                                s = s + 32
                                continue 
                            call msg.sender.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                                 gas gas_remaining wei
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_2148] == Mask(32, 224, mem[_2148])
                            if Mask(32, 224, mem[_2148]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                                revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                            mem[mem[64] + 4] = tx.origin
                            call sub_3bc9c8dcAddress.random(address arg1) with:
                                 gas gas_remaining wei
                        ...
                        if not ext_code.size(msg.sender):
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_2150] == Mask(32, 224, mem[_2150])
                            if Mask(32, 224, mem[_2150]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                                revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                            mem[mem[64] + 4] = tx.origin
                            call sub_3bc9c8dcAddress.random(address arg1) with:
                                 gas gas_remaining wei
                    ...
                    if not ext_code.size(msg.sender):
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_2152] == Mask(32, 224, mem[_2152])
                        if Mask(32, 224, mem[_2152]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                        mem[mem[64] + 4] = tx.origin
                        call sub_3bc9c8dcAddress.random(address arg1) with:
                             gas gas_remaining wei
                ...
                if msg.sender:
                    if not msg.sender:
                        ...
                        if not ext_code.size(msg.sender):
                            ...
                            s = 0
                            while s < 0:
                                mem[s + mem[64] + 164] = mem[s + _1078 + 32]
                                s = s + 32
                                continue 
                            call msg.sender.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                                 gas gas_remaining wei
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_2154] == Mask(32, 224, mem[_2154])
                            if Mask(32, 224, mem[_2154]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                                revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                            mem[mem[64] + 4] = tx.origin
                            call sub_3bc9c8dcAddress.random(address arg1) with:
                                 gas gas_remaining wei
                        ...
                        if not ext_code.size(msg.sender):
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_2156] == Mask(32, 224, mem[_2156])
                            if Mask(32, 224, mem[_2156]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                                revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                            mem[mem[64] + 4] = tx.origin
                            call sub_3bc9c8dcAddress.random(address arg1) with:
                                 gas gas_remaining wei
                    ...
                    if not ext_code.size(msg.sender):
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_2158] == Mask(32, 224, mem[_2158])
                        if Mask(32, 224, mem[_2158]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                        mem[mem[64] + 4] = tx.origin
                        call sub_3bc9c8dcAddress.random(address arg1) with:
                             gas gas_remaining wei
