...
address sub_1c286cacAddress;

function totalSupply() payable {
    return totalSupply
}

function sub_1c286cac(?) payable {
    return sub_1c286cacAddress
}
...
function leave(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(sub_1c286cacAddress)
    staticcall sub_1c286cacAddress.0x70a08231 with:
    ...
    require ext_code.size(sub_1c286cacAddress)
    call sub_1c286cacAddress.0xa9059cbb with:
         gas gas_remaining wei
...
function enter(uint256 arg1) payable {
    ...
    require ext_code.size(sub_1c286cacAddress)
    call sub_1c286cacAddress.0x23b872dd with:
         gas gas_remaining wei
