...
function getSharePrice() payable {
    ...
    staticcall sub_b831a63dAddress.0x3ddac953 with:
...
function totalGlobalSynthValue() payable {
    ...
    while idx < sub_fb54fbb3.length:
        ...
        if sub_fb54fbb3[idx]:
            ...
            mem[0] = 109
            require ext_code.size(sub_fb54fbb3[idx])
            staticcall sub_fb54fbb3[idx].0xc6320ab9 with:
                    gas gas_remaining wei
...
function globalCollateralValue() payable {
    ...
    while idx < sub_16b64135.length:
        ...
        if sub_16b64135[idx]:
            ...
            staticcall oracleOf[stor102[idx]].0x3ddac953 with:
                    gas gas_remaining wei
    ...
    while idx < vaults.length:
        ...
        if address(vaults[idx]):
            ...
            staticcall oracleOf[address(ext_call.return_data[0])].0x3ddac953 with:
                    gas gas_remaining wei
...
function recollateralizeShare(address arg1, uint256 arg2, uint256 arg3) payable {
    ...
    staticcall oracleOf[address(arg1)].0x3ddac953 with:
            gas gas_remaining wei
    ...
    if sub_fa2caf31:
        ...
        if ext_call.return_data[0] * sub_fa2caf31 / 10^18:
            ...
            if not ext_code.hash(address(ext_call.return_data[0])):
                revert with 0, 'SafeERC20: call to non-contract'
            mem[260 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, vaults[arg1]), uint32(vaults[arg1]), 0
            ...
            if not return_data.size:
                ...
                if not ext_code.hash(address(ext_call.return_data[0])):
                    revert with 0, 'SafeERC20: call to non-contract'
                mem[ceil32(return_data.size) + 361 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, vaults[arg1]), uint32(vaults[arg1]), Mask(224, 32, ext_call.return_data[0] * sub_fa2caf31 / 10^18) >> 32
                call address(ext_call.return_data[0]) with:
                   funct uint32(vaults[arg1])
                     gas gas_remaining wei
                    args Mask(224, 32, ext_call.return_data[0] * sub_fa2caf31 / 10^18) << 224, mem[ceil32(return_data.size) + 425 len 4]
                if not return_data.size:
                    require not ext_call.success
                    revert with 0, 'SafeERC20: low-level call failed'
                ...
                require ext_code.size(address(vaults[arg1]))
                call address(vaults[arg1]).0xb6b55f25 with:
                     gas gas_remaining wei
                ...
                if not ext_call.return_data[0] * sub_fa2caf31 / 10^18:
                    if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(address(ext_call.return_data[0])):
                        revert with 0, 'SafeERC20: call to non-contract'
                    if not ext_code.hash(address(ext_call.return_data[0])):
                        revert with 0, 'SafeERC20: call to non-contract'
                    mem[ceil32(return_data.size) + 361 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, vaults[arg1]), uint32(vaults[arg1]), Mask(224, 32, ext_call.return_data[0] * sub_fa2caf31 / 10^18) >> 32
                    mem[ceil32(return_data.size) + 453 len 4] = Mask(32, 64, ext_call.return_data[0] * sub_fa2caf31 / 10^18) >> 64
                    call address(ext_call.return_data[0]) with:
                       funct uint32(vaults[arg1])
                         gas gas_remaining wei
                        args Mask(224, 32, ext_call.return_data[0] * sub_fa2caf31 / 10^18) << 224, mem[ceil32(return_data.size) + 425 len 4]
                    ...
                    call address(vaults[arg1]).0xb6b55f25 with:
                         gas gas_remaining wei
                        args ext_call.return_data[0] * sub_fa2caf31 / 10^18, mem[(2 * ceil32(return_data.size)) + 398 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                else:
                    require ext_code.size(address(ext_call.return_data[0]))
                    staticcall address(ext_call.return_data[0]).0xdd62ed3e with:
                            gas gas_remaining wei
