...
function setPassword(uint256 arg1) {
...
function getCurrencyList() {
    ...
    if not stor2.length:
        ...
        if not stor2.length:
            if stor2.length > test266151307():
                revert with 'NH{q', 65
            mem[_865 + (32 * stor2.length) + 32] = stor2.length
            mem[64] = _865 + (64 * stor2.length) + 64
            if not stor2.length:
                idx = 0
                while idx < stor2.length:
                    mem[0] = 2
                ...
                _1639 = mem[64]
                mem[mem[64]] = 128
                _1687 = mem[_865 + (32 * stor2.length) + 32]
            ...
            _1643 = mem[64]
            mem[mem[64]] = 128
            _1688 = mem[_865 + (32 * stor2.length) + 32]
            mem[mem[64] + 128] = mem[_865 + (32 * stor2.length) + 32]
            idx = 0
            s = _865 + (32 * stor2.length) + 64
            t = mem[64] + 160
        ...
        mem[_865 + 32 len 32 * stor2.length] = call.data[calldata.size len 32 * stor2.length]
        if stor2.length > test266151307():
            revert with 'NH{q', 65
        mem[_865 + (32 * stor2.length) + 32] = stor2.length
        mem[64] = _865 + (64 * stor2.length) + 64
    ...
    if not stor2.length:
        if stor2.length > test266151307():
            revert with 'NH{q', 65
        mem[_848 + (64 * stor2.length) + 64] = stor2.length
        mem[64] = _848 + (98 * stor2.length) + 96
        if not stor2.length:
            idx = 0
            while idx < stor2.length:
                mem[0] = 2
        ...
        while idx < _1692:
            ...
            t = t + 32
            continue 
        mem[_1659 + 32] = (32 * _1692) + 160
        _2396 = mem[96]
        mem[_1659 + (32 * _1692) + 160] = mem[96]
        idx = 0
        s = 128
        t = _1659 + (32 * _1692) + (32 * mem[96]) + 192
        u = _1659 + (32 * _1692) + 192
        while idx < _2396:
    ...
    mem[_848 + (32 * stor2.length) + 64 len 32 * stor2.length] = call.data[calldata.size len 32 * stor2.length]
    if stor2.length > test266151307():
        revert with 'NH{q', 65
    mem[_848 + (64 * stor2.length) + 64] = stor2.length
    mem[64] = _848 + (98 * stor2.length) + 96
    if not stor2.length:
        ...
        while idx < _1693:
            ...
            t = t + 32
            continue 
        mem[_1663 + 32] = (32 * _1693) + 160
        _2397 = mem[96]
        mem[_1663 + (32 * _1693) + 160] = mem[96]
        idx = 0
        s = 128
        t = _1663 + (32 * _1693) + (32 * mem[96]) + 192
        u = _1663 + (32 * _1693) + 192
        while idx < _2397:
    ...
    while idx < _1694:
        ...
        t = t + 32
        continue 
    mem[_1667 + 32] = (32 * _1694) + 160
    _2398 = mem[96]
    mem[_1667 + (32 * _1694) + 160] = mem[96]
    idx = 0
    s = 128
    t = _1667 + (32 * _1694) + (32 * mem[96]) + 192
    u = _1667 + (32 * _1694) + 192
    while idx < _2398:
