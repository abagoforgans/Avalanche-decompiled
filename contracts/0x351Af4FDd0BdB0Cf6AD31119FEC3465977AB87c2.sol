...
function deposit() {
    ...
    if ext_call.return_data[0]:
        if not ext_code.size(wantAddress):
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = approve(address arg1, uint256 arg2), 0x958c0d0baa8f220846d39667, 3696530387, 0
        call wantAddress.0xdc5493d3 with:
             gas gas_remaining wei
            args 0, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address arg1, uint256 arg2), 0x958c0d0baa8f220846d39667, 3696530387, 0
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = approve(address arg1, uint256 arg2), 0x958c0d0baa8f220846d39667, 3696530387, ext_call.return_data[0 len 28]
            call wantAddress.0xdc5493d3 with:
                 gas gas_remaining wei
