...
function upgradeStrat() payable {
    ...
    if approvalDelay + stor7 < stor7:
        revert with 0, 'SafeMath: addition overflow'
    if approvalDelay + stor7 >= block.timestamp:
        revert with 0, 'Delay has not passed'
    emit UpgradeStrat(stor6);
    require ext_code.size(address(strategyAddress))
    call address(strategyAddress).retireStrat() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    address(strategyAddress) = stor6
    stor6 = 0
    stor7 = 5 * 10^9
    require ext_code.size(tokenAddress)
    staticcall tokenAddress.0x70a08231 with:
...
function deposit(uint256 arg1) payable {
    ...
    if not return_data.size:
        ...
        if not totalSupply:
            ...
            if not ext_code.size(tokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[520 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), ext_call.return_data[0 len 28]
            mem[584 len 0] = 0
            call tokenAddress with:
               funct uint32(stor8)
                 gas gas_remaining wei
            ...
            if not ext_code.size(tokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[584 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), ext_call.return_data[0 len 28]
            mem[648 len 0] = 0
            call tokenAddress with:
               funct uint32(stor8)
                 gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            if not totalSupply:
                ...
                if not ext_code.size(tokenAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 521 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), ext_call.return_data[0 len 28]
                call tokenAddress with:
                   funct uint32(stor8)
                     gas gas_remaining wei
                ...
                if not ext_code.size(tokenAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 585 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), ext_call.return_data[0 len 28]
                call tokenAddress with:
                   funct uint32(stor8)
                     gas gas_remaining wei
