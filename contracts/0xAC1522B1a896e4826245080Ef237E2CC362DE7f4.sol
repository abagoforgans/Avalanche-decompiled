...
function sub_f81f601a(?) {
    ...
    if ceil32(_5) <= _5:
        ...
        if _97 > 0x41bbb2f80a4553f6c19ad51e8e40314cc63a07b3fef911341fd6eab024f994:
            revert with 0, 17
        if address(arg3) == address(_116):
            if 997 * _97 and mem[_126 + 50 len 14] > -1 / 997 * _97:
                revert with 0, 17
            if mem[_126 + 18 len 14] > 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5604189374bc6a7:
                revert with 0, 17
            if 1000 * mem[_126 + 18 len 14] > !(997 * _97):
                revert with 0, 17
            if not (1000 * mem[_126 + 18 len 14]) + (997 * _97):
                revert with 0, 18
            _137 = mem[64]
            mem[mem[64]] = 128
            mem[mem[64] + 128] = _5
            ...
            if ceil32(_5) <= _5:
                mem[mem[64] + 64] = address(_105)
                mem[mem[64] + 96] = 997 * _97 * Mask(112, 0, _133) / (1000 * Mask(112, 0, _131)) + (997 * _97)
                return Array(len=_5, data=mem[mem[64] + 160 len ceil32(_5)]), 
                       _89 << 248,
                       address(_105),
                       997 * _97 * Mask(112, 0, _133) / (1000 * Mask(112, 0, _131)) + (997 * _97)
            mem[mem[64] + _5 + 160] = 0
            mem[mem[64] + 32] = uint8(_89)
            mem[_137 + 64] = address(_105)
            mem[_137 + 96] = 997 * _97 * Mask(112, 0, _133) / (1000 * Mask(112, 0, _131)) + (997 * _97)
            return memory
              from mem[64]
               len ceil32(_5) + _137 + -mem[64] + 160
        if 997 * _97 and mem[_126 + 18 len 14] > -1 / 997 * _97:
            revert with 0, 17
        if mem[_126 + 50 len 14] > 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5604189374bc6a7:
            revert with 0, 17
        if 1000 * mem[_126 + 50 len 14] > !(997 * _97):
            revert with 0, 17
        if not (1000 * mem[_126 + 50 len 14]) + (997 * _97):
            revert with 0, 18
        _138 = mem[64]
        mem[mem[64]] = 128
        mem[mem[64] + 128] = _5
        ...
        if ceil32(_5) <= _5:
            mem[mem[64] + 64] = address(_105)
            mem[mem[64] + 96] = 997 * _97 * Mask(112, 0, _131) / (1000 * Mask(112, 0, _133)) + (997 * _97)
            return Array(len=_5, data=mem[mem[64] + 160 len ceil32(_5)]), 
                   _89 << 248,
                   address(_105),
                   997 * _97 * Mask(112, 0, _131) / (1000 * Mask(112, 0, _133)) + (997 * _97)
        mem[mem[64] + _5 + 160] = 0
        mem[mem[64] + 32] = uint8(_89)
        mem[_138 + 64] = address(_105)
        mem[_138 + 96] = 997 * _97 * Mask(112, 0, _131) / (1000 * Mask(112, 0, _133)) + (997 * _97)
        return memory
          from mem[64]
    ...
    if _100 > 0x41bbb2f80a4553f6c19ad51e8e40314cc63a07b3fef911341fd6eab024f994:
        revert with 0, 17
    if address(arg3) == address(_118):
        if 997 * _100 and mem[_129 + 50 len 14] > -1 / 997 * _100:
            revert with 0, 17
        if mem[_129 + 18 len 14] > 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5604189374bc6a7:
            revert with 0, 17
        if 1000 * mem[_129 + 18 len 14] > !(997 * _100):
            revert with 0, 17
        if not (1000 * mem[_129 + 18 len 14]) + (997 * _100):
            revert with 0, 18
        _139 = mem[64]
        mem[mem[64]] = 128
        mem[mem[64] + 128] = _5
        ...
        if ceil32(_5) <= _5:
            mem[mem[64] + 64] = address(_106)
            mem[mem[64] + 96] = 997 * _100 * Mask(112, 0, _134) / (1000 * Mask(112, 0, _132)) + (997 * _100)
            return Array(len=_5, data=mem[mem[64] + 160 len ceil32(_5)]), 
                   _90 << 248,
                   address(_106),
                   997 * _100 * Mask(112, 0, _134) / (1000 * Mask(112, 0, _132)) + (997 * _100)
        mem[mem[64] + _5 + 160] = 0
        mem[mem[64] + 32] = uint8(_90)
        mem[_139 + 64] = address(_106)
        mem[_139 + 96] = 997 * _100 * Mask(112, 0, _134) / (1000 * Mask(112, 0, _132)) + (997 * _100)
        return memory
          from mem[64]
           len ceil32(_5) + _139 + -mem[64] + 160
    if 997 * _100 and mem[_129 + 18 len 14] > -1 / 997 * _100:
        revert with 0, 17
    if mem[_129 + 50 len 14] > 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5604189374bc6a7:
        revert with 0, 17
    if 1000 * mem[_129 + 50 len 14] > !(997 * _100):
        revert with 0, 17
    if not (1000 * mem[_129 + 50 len 14]) + (997 * _100):
        revert with 0, 18
    _140 = mem[64]
    mem[mem[64]] = 128
    mem[mem[64] + 128] = _5
    ...
    if ceil32(_5) <= _5:
        mem[mem[64] + 64] = address(_106)
        mem[mem[64] + 96] = 997 * _100 * Mask(112, 0, _132) / (1000 * Mask(112, 0, _134)) + (997 * _100)
        return Array(len=_5, data=mem[mem[64] + 160 len ceil32(_5)]), 
               _90 << 248,
               address(_106),
               997 * _100 * Mask(112, 0, _132) / (1000 * Mask(112, 0, _134)) + (997 * _100)
    mem[mem[64] + _5 + 160] = 0
    mem[mem[64] + 32] = uint8(_90)
    mem[_140 + 64] = address(_106)
    mem[_140 + 96] = 997 * _100 * Mask(112, 0, _132) / (1000 * Mask(112, 0, _134)) + (997 * _100)
    return memory
      from mem[64]
