...
function sub_223e0902(?) {
    ...
    if not ('cd', 4).length:
        ...
        staticcall swapRouterAddress.getAmountsIn(uint256 rg1, address[] rg2) with:
                gas gas_remaining wei
               args mem[(64 * ('cd', 4).length) + 164 len (161 * ('cd', 4).length) + 96]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        mem[(64 * ('cd', 4).length) + ceil32(return_data.size) + 160] = mem[(64 * ('cd', 4).length) + mem[(64 * ('cd', 4).length) + 160 len 4], Mask(224, 32, cd[36]) >> 32 + 160]
            ...
            if ('cd', 4).length:
                if 0 < ('cd', 36).length:
                    ...
                    if not address(ext_call.return_data[0]):
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        mem[64] = (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (4 * ceil32(return_data.size)) + 160
                        require return_data.size >= 128
                        if ('cd', 4).length <= 1:
                            if ('cd', 36).length <= 1:
                            ...
                            if ext_call.return_data[32] < 0:
                                ...
                                while idx < ('cd', 36).length:
                                    ...
                                    continue 
                                require ext_code.size(swapRouterAddress)
                                staticcall swapRouterAddress.mem[mem[64] len 4] with:
                                        gas gas_remaining wei
                                       args mem[mem[64] + 4 len (32 * ('cd', 4).length) + (64 * ('cd', 36).length) + (4 * ceil32(return_data.size)) + -mem[64] + 256]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _2206 = mem[64]
                                ...
                                require _2206 + return_data.size > _2206 + mem[_2206] + 31
                                _2242 = mem[_2206 + mem[_2206]]
                                require mem[_2206 + mem[_2206]] <= test266151307()
                                require (32 * mem[_2206 + mem[_2206]]) + 32 >= 0 and _2206 + ceil32(return_data.size) + (32 * mem[_2206 + mem[_2206]]) + 32 <= test266151307()
                                mem[64] = _2206 + ceil32(return_data.size) + (32 * mem[_2206 + mem[_2206]]) + 32
                                mem[_2206 + ceil32(return_data.size)] = _2242
                                require return_data.size >= _2224 + (32 * _2242) + 32
                                mem[_2206 + ceil32(return_data.size) + 32 len 32 * _2242] = mem[_2206 + _2224 + 32 len 32 * _2242]
                                var96001 = _2206 + _2224 + (32 * _2242) + 32
                                if mem[(32 * ('cd', 4).length) + 128] - 1 < _2242:
                                    return ext_call.return_data[0], 
                                           -mem[(32 * mem[(32 * ('cd', 4).length) + 128] - 1) + _2206 + ceil32(return_data.size) + 32],
                                           ext_call.return_data[64],
                                           ext_call.return_data[96]
                            else:
                                if ext_call.return_data[32] <= 0:
                                ...
                                if not ('cd', 36).length:
                                    ...
                                    mem[64] = (32 * ('cd', 4).length) + (64 * ('cd', 36).length) + (6 * ceil32(return_data.size)) + (32 * mem[(32 * ('cd', 4).length) + (64 * ('cd', 36).length) + (4 * ceil32(return_data.size)) + mem[(32 * ('cd', 4).length) + (64 * ('cd', 36).length) + (4 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[32 len 28] + 192]) + 224
                            ...
                            if ext_call.return_data[0] < 0:
                                ...
                                require _2208 + return_data.size > _2208 + mem[_2208] + 31
                                _2244 = mem[_2208 + mem[_2208]]
                                require mem[_2208 + mem[_2208]] <= test266151307()
                                require (32 * mem[_2208 + mem[_2208]]) + 32 >= 0 and _2208 + ceil32(return_data.size) + (32 * mem[_2208 + mem[_2208]]) + 32 <= test266151307()
                                mem[64] = _2208 + ceil32(return_data.size) + (32 * mem[_2208 + mem[_2208]]) + 32
                                mem[_2208 + ceil32(return_data.size)] = _2244
                                require return_data.size >= _2226 + (32 * _2244) + 32
                                mem[_2208 + ceil32(return_data.size) + 32 len 32 * _2244] = mem[_2208 + _2226 + 32 len 32 * _2244]
                                if mem[96] - 1 < _2244:
                                    _2766 = mem[(32 * mem[96] - 1) + _2208 + ceil32(return_data.size) + 32]
                                    if mem[(32 * ('cd', 4).length) + 128] <= 1:
                                        mem[mem[64]] = -mem[(32 * mem[96] - 1) + _2208 + ceil32(return_data.size) + 32]
                                    ...
                                    if ext_call.return_data[32] < 0:
                                        ...
                                        staticcall swapRouterAddress.getAmountsOut(uint256 rg1, address[] rg2) with:
                                                gas gas_remaining wei
                                               args -ext_call.return_data[32], 64, mem[mem[64] + 68 len (32 * _2826) + 32]
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        _3294 = mem[64]
                                        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                                        ...
                                        if ext_call.return_data[32] <= 0:
                                            ...
                                            mem[mem[64] + 96] = ext_call.return_data[96]
                                            return mem[mem[64]], ext_call.return_data[32], ext_call.return_data[64], ext_call.return_data[96]
                                        _2825 = mem[(32 * ('cd', 4).length) + 128]
                                        require mem[(32 * ('cd', 4).length) + 128] <= test266151307()
                                        _2830 = mem[64]
                                        mem[mem[64]] = mem[(32 * ('cd', 4).length) + 128]
                                        mem[64] = mem[64] + (32 * _2825) + 32
                                        if not _2825:
                                            _3226 = mem[(32 * ('cd', 4).length) + 128]
                                            idx = 0
                                            while idx < _3226:
                                            ...
                                            staticcall swapRouterAddress.mem[mem[64] len 4] with:
                                                    gas gas_remaining wei
                                                   args mem[mem[64] + 4 len _3258 + (32 * _3290) + -mem[64] + 96]
                                            if not ext_call.success:
                                                revert with ext_call.return_data[0 len return_data.size]
                                            _3684 = mem[64]
                                            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                                            ...
                                            mem[_2830 + 32 len 32 * _2825] = call.data[calldata.size len 32 * _2825]
                                            _3227 = mem[(32 * ('cd', 4).length) + 128]
                                            idx = 0
                                            while idx < _3227:
                                                require mem[(32 * ('cd', 4).length) + 128] + -idx - 1 < mem[(32 * ('cd', 4).length) + 128]
                                                require idx < mem[_2830]
                                ...
                                if ext_call.return_data[0] <= 0:
                                    ...
                                    if ext_call.return_data[32] < 0:
                                        ...
                                        _2243 = mem[_2207 + mem[_2207]]
                                        require mem[_2207 + mem[_2207]] <= test266151307()
                                        require (32 * mem[_2207 + mem[_2207]]) + 32 >= 0 and _2207 + ceil32(return_data.size) + (32 * mem[_2207 + mem[_2207]]) + 32 <= test266151307()
                                        mem[64] = _2207 + ceil32(return_data.size) + (32 * mem[_2207 + mem[_2207]]) + 32
                                        mem[_2207 + ceil32(return_data.size)] = _2243
                                        require return_data.size >= _2225 + (32 * _2243) + 32
                                        mem[_2207 + ceil32(return_data.size) + 32 len 32 * _2243] = mem[_2207 + _2225 + 32 len 32 * _2243]
                                        var98001 = _2207 + _2225 + (32 * _2243) + 32
                                        if mem[(32 * ('cd', 4).length) + 128] - 1 < _2243:
                                            return ext_call.return_data[0], 
                                                   -mem[(32 * mem[(32 * ('cd', 4).length) + 128] - 1) + _2207 + ceil32(return_data.size) + 32],
                                                   ext_call.return_data[64],
                                                   ext_call.return_data[96]
                                    else:
                                        if ext_call.return_data[32] <= 0:
                                        ...
                                        require ('cd', 36).length <= test266151307()
                                        mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (4 * ceil32(return_data.size)) + 160] = ('cd', 36).length
                                        mem[64] = (32 * ('cd', 4).length) + (64 * ('cd', 36).length) + (4 * ceil32(return_data.size)) + 192
                                        if not ('cd', 36).length:
                                            idx = 0
                                            while idx < ('cd', 36).length:
                                                require ('cd', 36).length + -idx - 1 < ('cd', 36).length
                                            ...
                                            staticcall swapRouterAddress.mem[mem[64] len 4] with:
                                                    gas gas_remaining wei
                                                   args mem[mem[64] + 4 len (32 * ('cd', 4).length) + (98 * ('cd', 36).length) + (4 * ceil32(return_data.size)) + -mem[64] + 288]
                                            if not ext_call.success:
                                                revert with ext_call.return_data[0 len return_data.size]
                                            _2778 = mem[64]
                                            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                                            ...
                                            mem[_2778 + ceil32(return_data.size)] = _2814
                                            require return_data.size >= _2796 + (32 * _2814) + 32
                                            mem[_2778 + ceil32(return_data.size) + 32 len 32 * _2814] = mem[_2778 + _2796 + 32 len 32 * _2814]
                                            if 0 < _2814:
                                                return ext_call.return_data[0], mem[_2778 + ceil32(return_data.size) + 32], ext_call.return_data[64], ext_call.return_data[96]
                                        else:
                                            mem[(32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (4 * ceil32(return_data.size)) + 192 len 32 * ('cd', 36).length] = call.data[calldata.size len 32 * ('cd', 36).length]
                                            idx = 0
                                            while idx < ('cd', 36).length:
                                    ...
                                    if not ('cd', 4).length:
                                        ...
                                        staticcall swapRouterAddress.getAmountsIn(uint256 rg1, address[] rg2) with:
                                                gas gas_remaining wei
                                               args mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + (4 * ceil32(return_data.size)) + 196 len (161 * ('cd', 4).length) + 96]
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        ...
                                        mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + (6 * ceil32(return_data.size)) + 192] = mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + (4 * ceil32(return_data.size)) + mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + (4 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[0 len 28] + 192]
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        mem[64] = (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + (7 * ceil32(return_data.size)) + 160
                        require return_data.size >= 128
                        if ('cd', 4).length <= 1:
                            if ('cd', 36).length <= 1:
                                return ext_call.return_data[0], ext_call.return_data[32], ext_call.return_data[64], ext_call.return_data[96]
                            if ext_call.return_data[32] < 0:
                                ...
                                staticcall swapRouterAddress.mem[mem[64] len 4] with:
                                        gas gas_remaining wei
                                       args mem[mem[64] + 4 len (32 * ('cd', 4).length) + (64 * ('cd', 36).length) + (7 * ceil32(return_data.size)) + -mem[64] + 256]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _2209 = mem[64]
                                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                                ...
                                require _2209 + return_data.size > _2209 + mem[_2209] + 31
                                _2245 = mem[_2209 + mem[_2209]]
                                require mem[_2209 + mem[_2209]] <= test266151307()
                                require (32 * mem[_2209 + mem[_2209]]) + 32 >= 0 and _2209 + ceil32(return_data.size) + (32 * mem[_2209 + mem[_2209]]) + 32 <= test266151307()
                                mem[64] = _2209 + ceil32(return_data.size) + (32 * mem[_2209 + mem[_2209]]) + 32
                                mem[_2209 + ceil32(return_data.size)] = _2245
                                require return_data.size >= _2227 + (32 * _2245) + 32
                                mem[_2209 + ceil32(return_data.size) + 32 len 32 * _2245] = mem[_2209 + _2227 + 32 len 32 * _2245]
                                if mem[(32 * ('cd', 4).length) + 128] - 1 < _2245:
                                    return ext_call.return_data[0], 
                                           -mem[(32 * mem[(32 * ('cd', 4).length) + 128] - 1) + _2209 + ceil32(return_data.size) + 32],
                                           ext_call.return_data[64],
                                           ext_call.return_data[96]
                            else:
                                if ext_call.return_data[32] <= 0:
                            ...
                            if ext_call.return_data[0] < 0:
                                ...
                                require _2211 + return_data.size > _2211 + mem[_2211] + 31
                                _2247 = mem[_2211 + mem[_2211]]
                                require mem[_2211 + mem[_2211]] <= test266151307()
                                require (32 * mem[_2211 + mem[_2211]]) + 32 >= 0 and _2211 + ceil32(return_data.size) + (32 * mem[_2211 + mem[_2211]]) + 32 <= test266151307()
                                mem[64] = _2211 + ceil32(return_data.size) + (32 * mem[_2211 + mem[_2211]]) + 32
                                mem[_2211 + ceil32(return_data.size)] = _2247
                                require return_data.size >= _2229 + (32 * _2247) + 32
                                mem[_2211 + ceil32(return_data.size) + 32 len 32 * _2247] = mem[_2211 + _2229 + 32 len 32 * _2247]
                                if mem[96] - 1 < _2247:
                                    _2775 = mem[(32 * mem[96] - 1) + _2211 + ceil32(return_data.size) + 32]
                                    if mem[(32 * ('cd', 4).length) + 128] <= 1:
                                        mem[mem[64]] = -mem[(32 * mem[96] - 1) + _2211 + ceil32(return_data.size) + 32]
                                        mem[mem[64] + 64] = ext_call.return_data[64]
                                        mem[mem[64] + 96] = ext_call.return_data[96]
                                        return mem[mem[64]], ext_call.return_data[32], ext_call.return_data[64], ext_call.return_data[96]
                                    if ext_call.return_data[32] < 0:
                                        ...
                                        staticcall swapRouterAddress.getAmountsOut(uint256 rg1, address[] rg2) with:
                                                gas gas_remaining wei
                                               args -ext_call.return_data[32], 64, mem[mem[64] + 68 len (32 * _2829) + 32]
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        _3295 = mem[64]
                                        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                                        ...
                                        if ext_call.return_data[32] <= 0:
                                            ...
                                            mem[mem[64] + 96] = ext_call.return_data[96]
                                            return mem[mem[64]], ext_call.return_data[32], ext_call.return_data[64], ext_call.return_data[96]
                                        _2828 = mem[(32 * ('cd', 4).length) + 128]
                                        require mem[(32 * ('cd', 4).length) + 128] <= test266151307()
                                        _2831 = mem[64]
                                        mem[mem[64]] = mem[(32 * ('cd', 4).length) + 128]
                                        mem[64] = mem[64] + (32 * _2828) + 32
                                        if not _2828:
                                            _3228 = mem[(32 * ('cd', 4).length) + 128]
                                            idx = 0
                                            while idx < _3228:
                                                require mem[(32 * ('cd', 4).length) + 128] + -idx - 1 < mem[(32 * ('cd', 4).length) + 128]
                                            ...
                                            mem[_2831 + 32 len 32 * _2828] = call.data[calldata.size len 32 * _2828]
                                            _3229 = mem[(32 * ('cd', 4).length) + 128]
                                            idx = 0
                                            while idx < _3229:
                                                require mem[(32 * ('cd', 4).length) + 128] + -idx - 1 < mem[(32 * ('cd', 4).length) + 128]
                                                require idx < mem[_2831]
                                ...
                                if ext_call.return_data[0] <= 0:
                                    ...
                                    if ext_call.return_data[32] < 0:
                                        ...
                                        require _2210 + return_data.size > _2210 + mem[_2210] + 31
                                        _2246 = mem[_2210 + mem[_2210]]
                                        require mem[_2210 + mem[_2210]] <= test266151307()
                                        require (32 * mem[_2210 + mem[_2210]]) + 32 >= 0 and _2210 + ceil32(return_data.size) + (32 * mem[_2210 + mem[_2210]]) + 32 <= test266151307()
                                        mem[64] = _2210 + ceil32(return_data.size) + (32 * mem[_2210 + mem[_2210]]) + 32
                                        mem[_2210 + ceil32(return_data.size)] = _2246
                                        require return_data.size >= _2228 + (32 * _2246) + 32
                                        mem[_2210 + ceil32(return_data.size) + 32 len 32 * _2246] = mem[_2210 + _2228 + 32 len 32 * _2246]
                                        var109001 = _2210 + _2228 + (32 * _2246) + 32
                                        if mem[(32 * ('cd', 4).length) + 128] - 1 < _2246:
                                            return ext_call.return_data[0], 
                                                   -mem[(32 * mem[(32 * ('cd', 4).length) + 128] - 1) + _2210 + ceil32(return_data.size) + 32],
                                                   ext_call.return_data[64],
                                                   ext_call.return_data[96]
                                    else:
                                        if ext_call.return_data[32] <= 0:
                                    ...
                                    if not ('cd', 4).length:
                                        ...
                                        mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + (8 * ceil32(return_data.size)) + 192] = mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + (7 * ceil32(return_data.size)) + mem[(64 * ('cd', 4).length) + (32 * ('cd', 36).length) + (7 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[0 len 28] + 192]
                                        ...
                                        if 0 < _2823:
                                            ...
                                            if ext_call.return_data[32] < 0:
                                                ...
                                                staticcall swapRouterAddress.mem[mem[64] len 4] with:
                                                        gas gas_remaining wei
                                                       args mem[mem[64] + 4 len _3327 + (32 * _3345) + -mem[64] + 96]
                                                if not ext_call.success:
                                                    revert with ext_call.return_data[0 len return_data.size]
                                                _3687 = mem[64]
                                                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
