...
function sub_0d3e057b(?) payable {
    ...
    if account[address(arg1)].field_0:
        if not arg4:
            ...
            if arg3 < 100 * 10^6:
                revert with 0, 'You must provide at least 100 DAI for the LP token'
            if account[address(arg1)].field_256 == -1:
                revert with 'NH{q', 17
            if totalNodes == -1:
                revert with 'NH{q', 17
            ...
            if arg4 == 1:
                ...
                if arg3 < 250 * 10^6:
                    revert with 0, 'You must provide at least 250 DAI for the LP token'
                if account[address(arg1)].field_512 == -1:
                    revert with 'NH{q', 17
                if totalNodes == -1:
                    revert with 'NH{q', 17
                ...
                if arg4 == 2:
                    if arg2 < 500 * 10^18:
                        revert with 0, 'You must provide at least 500 CUBO for the LP token'
                    if arg3 < 500 * 10^6:
                        revert with 0, 'You must provide at least 500 DAI for the LP token'
                    if account[address(arg1)].field_768 == -1:
                        revert with 'NH{q', 17
                    if totalNodes == -1:
                        revert with 'NH{q', 17
                    ...
                    if arg4 == 3:
                        ...
                        if arg3 < 10^9:
                            revert with 0, 'You must provide at least 1000 DAI for the LP token'
                        if account[address(arg1)].field_1024 == -1:
                            revert with 'NH{q', 17
                        if totalNodes == -1:
                            revert with 'NH{q', 17
                        ...
                        if arg4 != 4:
                            ...
                            if arg3 < 5 * 10^9:
                                revert with 0, 'You must provide at least 5000 DAI for the LP token'
                            if account[address(arg1)].field_1280 == -1:
                                revert with 'NH{q', 17
                            if totalNodes == -1:
                                revert with 'NH{q', 17
