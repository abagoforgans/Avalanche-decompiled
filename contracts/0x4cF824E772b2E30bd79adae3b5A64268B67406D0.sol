...
function sub_e39ee9db(?) payable {
    ...
    if bool(arg3) == 1:
        if arg1 > arg1 * arg2 / 100:
            ...
            require return_data.size >= 32
            _28 = mem[192 len 4], Mask(224, 32, arg1 - (arg1 * arg2 / 100)) >> 32
            ...
            _29 = mem[mem[192 len 4], Mask(224, 32, arg1 - (arg1 * arg2 / 100)) >> 32 + 192]
            ...
            mem[ceil32(return_data.size) + 224 len ceil32(32 * _29)] = mem[_28 + 224 len ceil32(32 * _29)]
            if arg5:
                if 1 >= _29:
                    revert with 0, 50
                if mem[ceil32(return_data.size) + 256] > arg5:
                    revert with 0, 'maximum USDC amount exceeds upper bound'
