...
function tend() payable {
    ...
    if not uint8(stor10.field_0):
        ...
        if ext_call.return_data[0] >= ext_call.return_data[0]:
            if ext_call.return_data[0] / 10^12 > ext_call.return_data[0]:
                revert with 0, 'SafeMath: subtraction overflow', 0
            if ext_call.return_data[0] - (ext_call.return_data[0] / 10^12) < stor19:
                if ext_call.return_data[0] - (ext_call.return_data[0] / 10^12) >= stor17:
                    require ext_code.size(stor14)
                    call stor14.approve(address arg1, uint256 arg2) with:
                         gas gas_remaining wei
                        args sub_e956dcd7Address, ext_call.return_data[0] - (ext_call.return_data[0] / 10^12)
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    ...
                    call sub_e956dcd7Address.addLiquidity(uint256 arg1, uint256 arg2, address arg3) with:
                         gas gas_remaining wei
                        args uint16(stor16.field_0), ext_call.return_data[0] - (ext_call.return_data[0] / 10^12), this.address
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require ext_code.size(poolAddress)
        ...
        if not arg1:
            ...
            if arg1 < stor17:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[(4 * ceil32(return_data.size)) + 164] = sub_e956dcd7Address
                ...
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                mem[(6 * ceil32(return_data.size)) + 164] = uint16(stor16.field_160)
                mem[(6 * ceil32(return_data.size)) + 196] = arg1 / ext_call.return_data[0]
    ...
    if not arg1:
        ...
        if arg1 < stor17:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(4 * ceil32(return_data.size)) + 228] = sub_e956dcd7Address
            ...
            require return_data.size >= 32
            require ext_call.return_data[0] == bool(ext_call.return_data[0])
            mem[(6 * ceil32(return_data.size)) + 228] = uint16(stor16.field_160)
            mem[(6 * ceil32(return_data.size)) + 260] = arg1 / ext_call.return_data[0]
            ...
            if not ext_code.hash(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(7 * ceil32(return_data.size)) + 388 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg1, 0
