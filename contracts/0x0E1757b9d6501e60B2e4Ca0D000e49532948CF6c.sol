        ...
        if 0 < balanceOf[address(arg1)]:
            ...
            if stor152 * balanceOf[address(arg1)] < 0:
                ...
                if stor153[address(arg1)] + (stor152 * balanceOf[address(arg1)]) < stor153[address(arg1)]:
                    ...
                    require stor153[address(arg1)] + (stor152 * balanceOf[address(arg1)]) < stor153[address(arg1)]
            stor153[address(arg1)] += stor152 * balanceOf[address(arg1)]
    require ext_code.size(0xfec8b7ee9c14424f71b30dac7c1cfe054b6771)
    delegate 0xfec8b7ee9c14424f71b30dac7c1cfe054b6771.0x4c60db9c with:
         gas gas_remaining wei
        args 156, arg1
...
function setBalance(address arg1, uint256 arg2) payable {
    ...
    if not stor161[address(arg1)]:
        if arg2 < minimumTokenBalanceForDividends:
            ...
            require ext_code.size(0xfec8b7ee9c14424f71b30dac7c1cfe054b6771)
            delegate 0xfec8b7ee9c14424f71b30dac7c1cfe054b6771.0xbc2b405c with:
                 gas gas_remaining wei
...
function getAccount(address arg1) payable {
    ...
    require arg1 == arg1
    require ext_code.size(0xfec8b7ee9c14424f71b30dac7c1cfe054b6771)
    delegate 0xfec8b7ee9c14424f71b30dac7c1cfe054b6771.0x17e142d1 with:
         gas gas_remaining wei
        args 156, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function getAccountAtIndex(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(0xfec8b7ee9c14424f71b30dac7c1cfe054b6771)
    delegate 0xfec8b7ee9c14424f71b30dac7c1cfe054b6771.0xdeb3d896 with:
         gas gas_remaining wei
        args 156
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(0xfec8b7ee9c14424f71b30dac7c1cfe054b6771)
    delegate 0xfec8b7ee9c14424f71b30dac7c1cfe054b6771.0xd1aa9e7e with:
         gas gas_remaining wei
        args 156, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
