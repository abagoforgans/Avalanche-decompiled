...
function sub_449d46c0(?) payable {
    ...
    if sub_a42a4663[address(msg.sender)] > -181:
        revert with 'NH{q', 17
    if sub_a42a4663[address(msg.sender)] + 180 >= block.timestamp:
        revert with 0, 'Wait 3 minutes'
    ...
    if stor1.length <= 15:
        if 10^16 > eth.balance(this.address):
