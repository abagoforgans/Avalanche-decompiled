...
#  - _fallback()
#
const name = 'MemeNodeCapitalDAO', 0
...
function sub_f33dfea0(?) {
    return sub_f33dfea0Address
}
...
function setFeeReceivers(address arg1, address arg2) {
    ...
    sub_f33dfea0Address = arg2
}

function sub_12fbc425(?) {
    if owner != msg.sender:
        revert with 0, '!OWNER'
