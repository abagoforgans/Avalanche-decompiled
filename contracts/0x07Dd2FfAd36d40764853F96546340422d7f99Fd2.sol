...
function _getNodeNumberOf(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require ext_code.size(0x99f9a4a924bc0d00eb869580d9ffc6c9bff9fcf2)
    delegate 0x99f9a4a924bc0d00eb869580d9ffc6c9bff9fcf2.0x732a2ccf with:
...
function _getNodesNames(address arg1) payable {
    ...
    while idx < stor4[address(arg1)].field_0:
        ...
        _67 = mem[64]
        mem[64] = mem[64] + ceil32(stor4[address(arg1)][idx].field_1) + 32
        mem[_67] = stor4[address(arg1)][idx].field_1
        if stor4[address(arg1)][idx].field_0:
            if stor4[address(arg1)][idx].field_0 == stor4[address(arg1)][idx].field_1 < 32:
                revert with 0, 34
            if not stor4[address(arg1)][idx].field_1:
                ...
                continue 
            if 31 >= stor4[address(arg1)][idx].field_1:
                mem[_67 + 32] = 256 * stor4[address(arg1)][idx].field_8
                mem[_57] = _67
                mem[_57 + 32] = stor4[address(arg1)][idx].field_256
                mem[_57 + 64] = stor4[address(arg1)][idx].field_512
                mem[_57 + 96] = stor4[address(arg1)][idx].field_768
                ...
                continue 
            mem[0] = (4 * idx) + sha3(sha3(address(arg1), 4))
            mem[_67 + 32] = stor4[address(arg1)][idx].field_0
            t = _67 + 32
            u = sha3(mem[0])
            while _67 + stor4[address(arg1)][u].field_1 > t:
                mem[t + 32] = stor1[u]
                t = t + 32
                u = u + 1
                continue 
        ...
        if stor4[address(arg1)][idx].field_1:
            if 31 >= stor4[address(arg1)][idx].field_1:
                ...
                t = _67 + 32
                u = sha3(mem[0])
                while _67 + stor4[address(arg1)][idx].field_1 > t:
                    mem[t + 32] = stor1[u]
                    t = t + 32
                    u = u + 1
                    continue 
...
function _getNodesRewardAvailable(address arg1) payable {
    ...
    if not mem[mem[ceil32(return_data.size) + 128] + 96]:
        ...
        while idx < _56:
            if idx >= mem[ceil32(return_data.size) + 96]:
                revert with 0, 50
            _105 = mem[(32 * idx) + ceil32(return_data.size) + 128]
            _106 = mem[mem[(32 * idx) + ceil32(return_data.size) + 128] + 96]
    ...
    if not u:
        ...
        while idx < _56:
            if idx >= mem[ceil32(return_data.size) + 96]:
                revert with 0, 50
            _349 = mem[(32 * idx) + ceil32(return_data.size) + 128]
            _350 = mem[mem[(32 * idx) + ceil32(return_data.size) + 128] + 96]
            if not mem[mem[(32 * idx) + ceil32(return_data.size) + 128] + 96]:
                _362 = mem[64]
                mem[64] = mem[64] + 64
                mem[_362] = 1
    ...
    while idx < _56:
        if idx >= mem[ceil32(return_data.size) + 96]:
            revert with 0, 50
        _351 = mem[(32 * idx) + ceil32(return_data.size) + 128]
        _352 = mem[mem[(32 * idx) + ceil32(return_data.size) + 128] + 96]
        if not mem[mem[(32 * idx) + ceil32(return_data.size) + 128] + 96]:
            _364 = mem[64]
            mem[64] = mem[64] + 64
            mem[_364] = 1
