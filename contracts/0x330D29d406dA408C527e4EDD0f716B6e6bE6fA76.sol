...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        ...
        call lpPairAddress.0xf385f829 with:
             gas gas_remaining wei
            args Mask(480, -256, approve(address rg1, uint256 rg2), 0x574d3245e36cf8c9dc86430e, 0, 0) << 256, mem[324 len 4]
        if not return_data.size:
            ...
            if ext_code.size(lpPairAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = 0, 0x574d3245e36cf8c9dc86430eadb0fdb2f385f829, ext_call.return_data[0 len 28]
            call lpPairAddress.0xf385f829 with:
                 gas gas_remaining wei
            ...
            if ext_code.size(lpPairAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 425 len 64] = 0, 0x574d3245e36cf8c9dc86430eadb0fdb2f385f829, ext_call.return_data[0 len 28]
            call lpPairAddress.0xf385f829 with:
                 gas gas_remaining wei
