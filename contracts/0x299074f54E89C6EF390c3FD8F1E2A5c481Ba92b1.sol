...
function sub_4f735832(?) {
    require calldata.size - 4 >= 96
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 >= sub_3b707478.length:
        revert with 'NH{q', 50
    sub_3b707478[arg1].field_1536 = arg2
    sub_3b707478[arg1].field_1792 = arg3
}
...
function sub_538249a6(?) {
    ...
    storB10E[stor1.length] = arg9
}

function sub_cecbd199(?) {
    ...
    storB10E[stor1.length] = arg8
    storB10E[stor1.length] = arg9
    storB10E[stor1.length] = arg10
}

function sub_2f30ce21(?) {
    ...
    if arg1 >= sub_3b707478.length:
        revert with 'NH{q', 50
    sub_3b707478[arg1].field_0 = address(arg2)
    sub_3b707478[arg1].field_256 = address(arg3)
    sub_3b707478[arg1].field_512 = address(arg4)
    sub_3b707478[arg1].field_768 = address(arg5)
    sub_3b707478[arg1].field_1024 = address(arg6)
    sub_3b707478[arg1].field_1280 = address(arg7)
    sub_3b707478[arg1].field_1440 = Mask(96, 0, bool(arg8))
    sub_3b707478[arg1].field_1536 = arg9
    sub_3b707478[arg1].field_1792 = arg10
    sub_3b707478[arg1].field_2048 = arg11
    sub_3b707478[arg1].field_2304 = arg12
}
...
function _fallback() payable {
    if calldata.size < 4:
        ...
        if unknown_0x77233e90(?????) <= uint32(call.func_hash) >> 224:
            if unknown_0xcecbd199(?????) <= uint32(call.func_hash) >> 224:
                if unknown_0xe8a379b2(?????) > uint32(call.func_hash) >> 224:
                    if unknown_0xcecbd199(?????) == uint32(call.func_hash) >> 224:
                        ...
                        require unknown_0xd8b08ce4(?????) == uint32(call.func_hash) >> 224
                        require not msg.value
                        require calldata.size - 4 >= 32
                        if owner != msg.sender:
                            revert with 0, 'Ownable: caller is not the owner'
                ...
                if ext_call.return_data[0] >= sub_3b707478[arg1].field_1792:
                    ...
                    if ext_call.return_data[0] >= sub_3b707478[arg1].field_1792:
                        ...
                        if ext_call.return_data[0] >= sub_3b707478[arg1].field_1792:
                            return ext_call.return_data[0], 0, bool(ext_call.return_data[0])
            return ext_call.return_data[0], 1, bool(ext_call.return_data[0])
        if unknown_0x4f735832(?????) <= uint32(call.func_hash) >> 224:
            if unknown_0x4f735832(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
                require calldata.size - 4 >= 96
                if owner != msg.sender:
                ...
                if unknown_0x538249a6(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    require calldata.size - 4 >= 288
                    require arg1 == address(arg1)
                    require arg2 == address(arg2)
            ...
            if uint32(call.func_hash) >> 224 != unknown_0x1611d864(?????):
                if uint32(call.func_hash) >> 224 != unknown_0x2f30ce21(?????):
