...
function _fallback() payable {
    ...
    require code.data[12473 len 20]
    require code.data[12493 len 32] > 0
    create contract with 0 wei
                    code: code.data[8316 len 4145]
    require create.new_address
    stor1 = address(create.new_address)
    stor2 = code.data[12473 len 20]
    stor5 = code.data[12525 len 32]
    stor4 = 10^18 * code.data[12493 len 32]
    return code.data[465 len 7851]
}
