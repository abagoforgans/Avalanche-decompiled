...
function devMint(uint8 arg1) payable {
    ...
    while idx < arg1:
        ...
        if ext_code.size(msg.sender):
            ...
            require return_data.size >= 32
            require mem[_88] == Mask(32, 224, mem[_88])
            if Mask(32, 224, mem[_88]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
        if idx == -1:
            revert with 0, 17
        idx = idx + 1
...
function mint(uint8 arg1) payable {
    ...
    require arg1 == arg1
    if arg1 >= 2:
        revert with 0, 'GG: Max 1 NFT per transaction'
    if bool(saleStart) != 1:
