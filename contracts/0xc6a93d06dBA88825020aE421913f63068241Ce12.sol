...
function receiveApproval() payable {
    revert
}
...
function getAirdrop(address arg1) {
    ...
    if arg1 != msg.sender:
        if balanceOf[address(arg1)]:
            if arg1:
                require stor12 <= balanceOf[address(this.address)]
                balanceOf[address(this.address)] -= stor12
                require balanceOf[address(arg1)] + stor12 >= balanceOf[address(arg1)]
                balanceOf[address(arg1)] += stor12
                emit Transfer(stor12, this.address, arg1);
...
function tokenSale(address arg1) payable {
    ...
    if not sChunk:
        if arg1 != msg.sender:
            if balanceOf[address(arg1)]:
                if arg1:
                    require msg.value / sPrice / 4 <= balanceOf[address(this.address)]
                    balanceOf[address(this.address)] -= msg.value / sPrice / 4
                    require balanceOf[address(arg1)] + (msg.value / sPrice / 4) >= balanceOf[address(arg1)]
                    balanceOf[address(arg1)] += msg.value / sPrice / 4
                    emit Transfer((msg.value / sPrice / 4), this.address, arg1);
        ...
        if arg1 != msg.sender:
            if balanceOf[address(arg1)]:
                if arg1:
                    require sChunk * msg.value / sPrice / 4 <= balanceOf[address(this.address)]
                    balanceOf[address(this.address)] -= sChunk * msg.value / sPrice / 4
                    require balanceOf[address(arg1)] + (sChunk * msg.value / sPrice / 4) >= balanceOf[address(arg1)]
                    balanceOf[address(arg1)] += sChunk * msg.value / sPrice / 4
                    emit Transfer((sChunk * msg.value / sPrice / 4), this.address, arg1);
