...
function _getNodeNumberOf(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require ext_code.size(0x7fcb51e915ea699b241ba2b774780b5717e1ed9f)
    delegate 0x7fcb51e915ea699b241ba2b774780b5717e1ed9f.0x732a2ccf with:
...
function _cashoutAllNodesReward(address arg1) payable {
    ...
    while idx < stor4[address(arg1)].field_0:
        ...
        if s > !stor4[address(arg1)][idx].field_1024:
            revert with 0, 17
        stor4[address(arg1)][idx].field_1024 = 0
        if idx == -1:
            revert with 0, 17
        idx = idx + 1
        s = s + stor4[address(arg1)][idx].field_1024
        t = (5 * idx) + sha3(sha3(address(arg1), 4))
        continue 
            ...
            if stor4[address(arg1)][idx].field_0:
                ...
                if Mask(256, -1, stor4[address(arg1)][idx].field_0):
                    if 31 >= uint255(stor4[address(arg1)][idx].field_0) * 0.5:
                        ...
                        mem[0] = (5 * idx) + sha3(sha3(address(arg1), 4))
...
function _getNodesCreationTime(address arg1) payable {
    ...
    while idx < stor4[address(arg1)].field_0:
        ...
        if stor4[address(arg1)][idx].field_0:
            ...
            t = _65 + 32
            u = sha3(mem[0])
            while _65 + (uint255(stor4[address(arg1)][u].field_0) * 0.5) > t:
                mem[t + 32] = stor1[u]
                t = t + 32
                u = u + 1
                continue 
