    ...
    if not arg1:
        ...
        if block.timestamp >= unlockDate:
            ...
            if not 0 / totalSupply:
                ...
                if 0 / totalSupply * earlyWithdrawalFee / 0 / totalSupply != earlyWithdrawalFee:
                    revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[293 len 31]
                if 0 / totalSupply * earlyWithdrawalFee / 10000 > 0 / totalSupply:
                    revert with 0, 'SafeMath: subtraction overflow'
                require ext_code.size(pefiAddress)
                call pefiAddress.0xa9059cbb with:
                     gas gas_remaining wei
                    args msg.sender, (0 / totalSupply) - (0 / totalSupply * earlyWithdrawalFee / 10000)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_code.size(pefiAddress)
                call pefiAddress.0xdd7f92d2 with:
                     gas gas_remaining wei
                    args (0 / totalSupply * earlyWithdrawalFee / 10000)
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
    else:
        require arg1
        ...
        if block.timestamp >= unlockDate:
            ...
            if not arg1 * ext_call.return_data[0] / totalSupply:
                ...
                if arg1 * ext_call.return_data[0] / totalSupply * earlyWithdrawalFee / arg1 * ext_call.return_data[0] / totalSupply != earlyWithdrawalFee:
                    revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[293 len 31]
                if arg1 * ext_call.return_data[0] / totalSupply * earlyWithdrawalFee / 10000 > arg1 * ext_call.return_data[0] / totalSupply:
                    revert with 0, 'SafeMath: subtraction overflow'
                require ext_code.size(pefiAddress)
                call pefiAddress.0xa9059cbb with:
                     gas gas_remaining wei
                    args msg.sender, (arg1 * ext_call.return_data[0] / totalSupply) - (arg1 * ext_call.return_data[0] / totalSupply * earlyWithdrawalFee / 10000)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_code.size(pefiAddress)
                call pefiAddress.0xdd7f92d2 with:
                     gas gas_remaining wei
                    args (arg1 * ext_call.return_data[0] / totalSupply * earlyWithdrawalFee / 10000)
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
}
