...
function rewardsAvailable() payable {
    ...
    require return_data.size >= 64
    _16 = mem[(2 * ceil32(return_data.size)) + 96 len 4], stor15
    require mem[(2 * ceil32(return_data.size)) + 96 len 4], stor15 <= test266151307()
    require (2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor15 + 127 < (2 * ceil32(return_data.size)) + return_data.size + 96
    _17 = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor15 + 96]
    require mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor15 + 96] <= test266151307()
    require (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor15 + 96]) + 32 >= 0 and (4 * ceil32(return_data.size)) + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor15 + 96]) + 128 <= test266151307()
    mem[64] = (4 * ceil32(return_data.size)) + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor15 + 96]) + 128
            ...
            if not return_data.size:
                ...
                if return_data.size:
                    ...
                    if not mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 488]:
                        revert with 0, 'SafeERC20: ERC20 operation did not succeed'
            stor21.length++
            stor55F4[stor21.length] = ('cd', 4).length
            if not ('cd', 4).length:
                idx = 0
                while stor55F4[stor21.length] > idx:
                    stor[idx + sha3(stor21.length + 0x55f448fdea98c4d29eb340757ef0a66cd03dbb9538908a6a81d96026b71ec475)] = 0
                    idx = idx + 1
                    continue 
            else:
                s = 0
                ...
                while (32 * ('cd', 4).length) + 128 > idx:
                    stor[s + sha3(stor21.length + 0x55f448fdea98c4d29eb340757ef0a66cd03dbb9538908a6a81d96026b71ec475)] = mem[idx + 12 len 20]
                    s = s + 1
                    idx = idx + 32
                    continue 
...
function callReward() payable {
    ...
    if not ext_call.return_data[12 len 20]:
        ...
        if not ext_call.success:
            ...
            mem[(4 * ceil32(return_data.size)) + 96] = _198
        ...
        mem[64] = (4 * ceil32(return_data.size)) + 96
        require return_data.size >= 64
        _14 = mem[(2 * ceil32(return_data.size)) + 96 len 4], stor15
        require mem[(2 * ceil32(return_data.size)) + 96 len 4], stor15 <= test266151307()
        require (2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor15 + 127 < (2 * ceil32(return_data.size)) + return_data.size + 96
        _16 = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor15 + 96]
        require mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor15 + 96] <= test266151307()
        require (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor15 + 96]) + 32 >= 0 and (4 * ceil32(return_data.size)) + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor15 + 96]) + 128 <= test266151307()
        mem[64] = (4 * ceil32(return_data.size)) + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor15 + 96]) + 128
        ...
        require mem[64] + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 128] + 96]) + 32 >= mem[64] and mem[64] + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 128] + 96]) + 32 <= test266151307()
        mem[64] = mem[64] + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 128] + 96]) + 32
        mem[_196] = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 128] + 96]
