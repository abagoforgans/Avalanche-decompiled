    ...
    if block.timestamp > poolInfo[arg1].field_512:
        if totalStaked:
            if block.timestamp <= bonusEndTimestamp:
                ...
                if not totalStaked:
                    revert with 0, 18
                if poolInfo[arg1].field_768 > !(1000000000000 * 10^18 * (block.timestamp * rewardPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * rewardPerSecond * poolInfo[arg1].field_256) / stor7 / totalStaked):
                    revert with 0, 17
                ...
                if poolInfo[arg1].field_512 >= bonusEndTimestamp:
                    ...
                    if not totalStaked:
                        revert with 0, 18
                    if poolInfo[arg1].field_768 > !(1000000000000 * 10^18 * 0 / stor7 / totalStaked):
                        revert with 0, 17
                    ...
                    if not totalStaked:
                        revert with 0, 18
                    if poolInfo[arg1].field_768 > !(1000000000000 * 10^18 * (bonusEndTimestamp * rewardPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * rewardPerSecond * poolInfo[arg1].field_256) / stor7 / totalStaked):
                        revert with 0, 17
        ...
        if block.timestamp > poolInfo[idx].field_512:
            if totalStaked:
                if block.timestamp <= bonusEndTimestamp:
                    ...
                    if not totalStaked:
                        revert with 0, 18
                    if poolInfo[idx].field_768 > !(1000000000000 * 10^18 * (block.timestamp * rewardPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * rewardPerSecond * poolInfo[idx].field_256) / stor7 / totalStaked):
                        revert with 0, 17
                    ...
                    if poolInfo[idx].field_512 >= bonusEndTimestamp:
                        ...
                        if not totalStaked:
                            revert with 0, 18
                        if poolInfo[idx].field_768 > !(1000000000000 * 10^18 * 0 / stor7 / totalStaked):
                            revert with 0, 17
                        ...
                        if not totalStaked:
                            revert with 0, 18
                        if poolInfo[idx].field_768 > !(1000000000000 * 10^18 * (bonusEndTimestamp * rewardPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * rewardPerSecond * poolInfo[idx].field_256) / stor7 / totalStaked):
                            revert with 0, 17
...
function pendingReward(address arg1) payable {
    ...
    if block.timestamp <= bonusEndTimestamp:
        ...
        if not totalStaked:
            revert with 0, 18
        if uint256(poolInfo.field_768) > !(1000000000000 * 10^18 * (block.timestamp * rewardPerSecond * uint256(poolInfo.field_256)) - (uint256(poolInfo.field_512) * rewardPerSecond * uint256(poolInfo.field_256)) / stor7 / totalStaked):
            revert with 0, 17
    ...
    if uint256(poolInfo.field_512) >= bonusEndTimestamp:
        ...
        if not totalStaked:
            revert with 0, 18
        if uint256(poolInfo.field_768) > !(1000000000000 * 10^18 * 0 / stor7 / totalStaked):
            revert with 0, 17
    ...
    if not totalStaked:
        revert with 0, 18
    if uint256(poolInfo.field_768) > !(1000000000000 * 10^18 * (bonusEndTimestamp * rewardPerSecond * uint256(poolInfo.field_256)) - (uint256(poolInfo.field_512) * rewardPerSecond * uint256(poolInfo.field_256)) / stor7 / totalStaked):
        revert with 0, 17
...
function deposit(uint256 arg1) payable {
    ...
    if not userInfo[msg.sender].field_0:
        ...
        if userInfo[msg.sender].field_0 and uint256(poolInfo.field_768) > -1 / userInfo[msg.sender].field_0:
            revert with 0, 17
        if userInfo[msg.sender].field_0 * uint256(poolInfo.field_768) / 1000000000000 * 10^18 < userInfo[msg.sender].field_256:
            revert with 0, 17
        if not (userInfo[msg.sender].field_0 * uint256(poolInfo.field_768) / 1000000000000 * 10^18) - userInfo[msg.sender].field_256:
            if arg1:
                mem[100] = this.address
                require ext_code.size(stakeTokenAddress)
                staticcall stakeTokenAddress.0x70a08231 with:
            ...
            if not ext_call.return_data[0]:
                ...
                mem[ceil32(return_data.size) + 132] = msg.sender
                if (userInfo[msg.sender].field_0 * uint256(poolInfo.field_768) / 1000000000000 * 10^18) - userInfo[msg.sender].field_256 <= ext_call.return_data[0]:
                    mem[ceil32(return_data.size) + 164] = (userInfo[msg.sender].field_0 * uint256(poolInfo.field_768) / 1000000000000 * 10^18) - userInfo[msg.sender].field_256
                    mem[ceil32(return_data.size) + 96] = 68
                    mem[ceil32(return_data.size) + 132 len 28] = Mask(224, 32, msg.sender) >> 32
                    mem[ceil32(return_data.size) + 128 len 4] = unknown_0xa9059cbb(?????)
                    mem[ceil32(return_data.size) + 196] = 32
                    ...
                    if not ext_code.size(rewardTokenAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, (userInfo[msg.sender].field_0 * uint256(poolInfo.field_768) / 1000000000000 * 10^18) - userInfo[msg.sender].field_256, 0
                    mem[ceil32(return_data.size) + 328] = 0
                    call rewardTokenAddress with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, (userInfo[msg.sender].field_0 * uint256(poolInfo.field_768) / 1000000000000 * 10^18) - userInfo[msg.sender].field_256, 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, unknown_0xa9059cbb(?????), msg.sender, (userInfo[msg.sender].field_0 * uint256(poolInfo.field_768) / 1000000000000 * 10^18) - userInfo[msg.sender].field_256, 0) << 288)
                else:
    ...
    if userInfo[msg.sender].field_0 and uint256(poolInfo.field_768) > -1 / userInfo[msg.sender].field_0:
        revert with 0, 17
    userInfo[msg.sender].field_256 = userInfo[msg.sender].field_0 * uint256(poolInfo.field_768) / 1000000000000 * 10^18
