...
function sub_e9dd4ce5(?) payable {
    ...
    if not stor9[address(arg1)]:
        if not stor7[address(arg1)]:
            revert with 0, 'invalid depositor'
    require ext_code.size(address(arg1))
    staticcall address(arg1).bondPriceInUSD() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if tokenAddress != address(ext_call.return_data[0]):
        if not ext_call.return_data[31 len 1]:
            ...
            if not Mask(112, 0, ext_call.return_data[32]):
                revert with 0, 18
            if Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[32]) < ext_call.return_data[0]:
                revert with 0, 17
            if (Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[32])) - ext_call.return_data[0] and 10000 > -1 / (Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[32])) - ext_call.return_data[0]:
                revert with 0, 17
        else:
            if bool(bool(ext_call.return_data[31 len 1] < 78)) or bool(bool(ext_call.return_data[31 len 1] < 32)):
                if Mask(112, 0, ext_call.return_data[0]) and 10^ext_call.return_data[31 len 1] > -1 / Mask(112, 0, ext_call.return_data[0]):
                ...
                if not Mask(112, 0, ext_call.return_data[32]):
                    revert with 0, 18
                if Mask(112, 0, ext_call.return_data[0]) * 10^ext_call.return_data[31 len 1] / Mask(112, 0, ext_call.return_data[32]) < ext_call.return_data[0]:
                    revert with 0, 17
                if (Mask(112, 0, ext_call.return_data[0]) * 10^ext_call.return_data[31 len 1] / Mask(112, 0, ext_call.return_data[32])) - ext_call.return_data[0] and 10000 > -1 / (Mask(112, 0, ext_call.return_data[0]) * 10^ext_call.return_data[31 len 1] / Mask(112, 0, ext_call.return_data[32])) - ext_call.return_data[0]:
                    revert with 0, 17
            else:
                s = 10
                t = 1
                ...
                if not Mask(112, 0, ext_call.return_data[32]):
                    revert with 0, 18
                if Mask(112, 0, ext_call.return_data[0]) * s * t / Mask(112, 0, ext_call.return_data[32]) < ext_call.return_data[0]:
                    revert with 0, 17
                if (Mask(112, 0, ext_call.return_data[0]) * s * t / Mask(112, 0, ext_call.return_data[32])) - ext_call.return_data[0] and 10000 > -1 / (Mask(112, 0, ext_call.return_data[0]) * s * t / Mask(112, 0, ext_call.return_data[32])) - ext_call.return_data[0]:
                    revert with 0, 17
    else:
        if not ext_call.return_data[31 len 1]:
            if Mask(112, 0, ext_call.return_data[32]) and 1 > -1 / Mask(112, 0, ext_call.return_data[32]):
            ...
            if not Mask(112, 0, ext_call.return_data[0]):
                revert with 0, 18
            if Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0]) < ext_call.return_data[0]:
                revert with 0, 17
            if (Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0])) - ext_call.return_data[0] and 10000 > -1 / (Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0])) - ext_call.return_data[0]:
                revert with 0, 17
        else:
            if bool(bool(ext_call.return_data[31 len 1] < 78)) or bool(bool(ext_call.return_data[31 len 1] < 32)):
                if Mask(112, 0, ext_call.return_data[32]) and 10^ext_call.return_data[31 len 1] > -1 / Mask(112, 0, ext_call.return_data[32]):
                ...
                if not Mask(112, 0, ext_call.return_data[0]):
                    revert with 0, 18
                if Mask(112, 0, ext_call.return_data[32]) * 10^ext_call.return_data[31 len 1] / Mask(112, 0, ext_call.return_data[0]) < ext_call.return_data[0]:
                    revert with 0, 17
                if (Mask(112, 0, ext_call.return_data[32]) * 10^ext_call.return_data[31 len 1] / Mask(112, 0, ext_call.return_data[0])) - ext_call.return_data[0] and 10000 > -1 / (Mask(112, 0, ext_call.return_data[32]) * 10^ext_call.return_data[31 len 1] / Mask(112, 0, ext_call.return_data[0])) - ext_call.return_data[0]:
                    revert with 0, 17
            else:
                s = 10
                t = 1
                ...
                if not Mask(112, 0, ext_call.return_data[0]):
                    revert with 0, 18
                if Mask(112, 0, ext_call.return_data[32]) * s * t / Mask(112, 0, ext_call.return_data[0]) < ext_call.return_data[0]:
                    revert with 0, 17
                if (Mask(112, 0, ext_call.return_data[32]) * s * t / Mask(112, 0, ext_call.return_data[0])) - ext_call.return_data[0] and 10000 > -1 / (Mask(112, 0, ext_call.return_data[32]) * s * t / Mask(112, 0, ext_call.return_data[0])) - ext_call.return_data[0]:
                    revert with 0, 17
