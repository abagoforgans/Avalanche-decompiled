...
function sub_0f5b4433(?) {
    ...
    while idx < cd[4]:
        ...
        s = s + mem[(32 * idx) + 128]
        continue 
    if s * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] * cd[4] != 10000:
        revert with 0, 'bad JACKPOT_SPLIT input'
    sub_af6bf70c = cd[4]
    sub_1f5cb64b.length = ('cd', 36).length
    if not ('cd', 36).length:
        s = sha3(17)
        while sha3(17) + sub_1f5cb64b.length > cd[4]:
            stor[cd[4]] = 0
            s = cd[4] + 1
            continue 
    else:
        ...
        while (32 * ('cd', 36).length) + 128 > idx:
            sub_1f5cb64b[s] = mem[idx]
            s = s + 1
            idx = idx + 32
            continue 
        idx = Mask(251, 0, (32 * ('cd', 36).length) + 31) >> 5
        while sub_1f5cb64b.length > idx:
            sub_1f5cb64b[idx] = 0
            idx = idx + 1
            continue 
}
...
function sub_47ffd897(?) {
    ...
    if sub_60b663bb.length <= 0:
        ...
        mem[288 len 15201] = code.data[8135 len 15201]
        idx = 0
        s = 96
        t = 15649
        while idx < 4:
        ...
        create contract with 0 wei
                        code: code.data[8135 len 15201], sub_acab85ae, sub_eead113b, arg1, sub_2716a509, sub_af6bf70c, mem[15649 len 128], 704, mem[15809 len 352], sub_16520ded, sub_1f5cb64b.length, mem[16225 len 32 * sub_1f5cb64b.length]
    else:
        if sub_60b663bb.length < 1:
            revert with 0, 17
        if sub_60b663bb.length - 1 >= sub_60b663bb.length:
        ...
        mem[ceil32(return_data.size) + 288 len 15201] = code.data[8135 len 15201]
        idx = 0
        ...
        while idx < 2:
            ...
            continue 
        create contract with 0 wei
                        code: code.data[8135 len 15201], sub_acab85ae, sub_eead113b, arg1, sub_2716a509, sub_af6bf70c, mem[ceil32(return_data.size) + 15649 len 128], 704, mem[ceil32(return_data.size) + 15809 len 352], sub_16520ded, sub_1f5cb64b.length, mem[ceil32(return_data.size) + 16225 len 32 * sub_1f5cb64b.length]
...
function _fallback() payable {
    ...
    if unknown_0x1f5cb64b(?????) > uint32(call.func_hash) >> 224:
        if unknown_0x142e7e3f(?????) <= uint32(call.func_hash) >> 224:
            ...
            if changeStartDate(uint256 arg1) == uint32(call.func_hash) >> 224:
                ...
                if uint32(call.func_hash) >> 224 != unknown_0x0f5b4433(?????):
    ...
    if sub_60b663bb.length <= 0:
        ...
        mem[320 len 15201] = code.data[8135 len 15201]
        idx = 0
        s = 128
        t = 15681
        while idx < 4:
        ...
        while idx < 2:
            ...
            continue 
        create contract with 0 wei
                        code: code.data[8135 len 15201], sub_acab85ae, sub_eead113b, cd[4], sub_2716a509, sub_af6bf70c, mem[15681 len 128], 704, mem[15841 len 352], sub_16520ded, sub_1f5cb64b.length, mem[16257 len 32 * sub_1f5cb64b.length]
    else:
        if sub_60b663bb.length < 1:
            revert with 0, 17
        if sub_60b663bb.length - 1 >= sub_60b663bb.length:
        ...
        mem[ceil32(return_data.size) + 320 len 15201] = code.data[8135 len 15201]
        idx = 0
        ...
        while idx < 2:
            ...
            continue 
        create contract with 0 wei
                        code: code.data[8135 len 15201], sub_acab85ae, sub_eead113b, cd[4], sub_2716a509, sub_af6bf70c, mem[ceil32(return_data.size) + 15681 len 128], 704, mem[ceil32(return_data.size) + 15841 len 352], sub_16520ded, sub_1f5cb64b.length, mem[ceil32(return_data.size) + 16257 len 32 * sub_1f5cb64b.length]
    if not create.new_address:
        revert with ext_call.return_data[0 len return_data.size]
    sub_60b663bb.length++
    sub_60b663bb[sub_60b663bb.length] = address(create.new_address)
