...
function getCurrentTokens() {
    ...
    while idx < stor19.length:
        ...
        if stor18[stor19[idx]]:
            ...
            mem[64] = mem[64] + 64
            mem[_25] = 16
            mem[_25 + 32] = 0x3031323334353637383961626364656600000000000000000000000000000000
            _26 = mem[64]
            mem[mem[64]] = 51
            mem[64] = mem[64] + 96
            mem[_26 + 32 len 51] = call.data[calldata.size len 51]
            if 0 >= mem[_26]:
                revert with 0, 50
            mem[_26 + 32 len 8] = Mask(8, -(2713877091499598330239944961141122840311015265600950719674787125185463975936, 0) + 256, 0) << (2713877091499598330239944961141122840311015265600950719674787125185463975936, 0) - 256
            if 1 >= mem[_26]:
                revert with 0, 50
            mem[_26 + 33 len 8] = Mask(8, -(6784692728748995825599862402852807100777538164002376799186967812963659939840, 0) + 256, 0) << (6784692728748995825599862402852807100777538164002376799186967812963659939840, 0) - 256
            s = 0
            while s < 20:
                if 12 > !s:
                    revert with 0, 17
                ...
                if (2 * s) + 2 >= mem[_26]:
                    revert with 0, 50
                mem[(2 * s) + _26 + 34 len 8] = Mask(8, -(('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 32, ('var', '_25')), 32))), 0) + 256, 0) << (('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 32, ('var', '_25')), 32))), 0) - 256
                if 12 > !s:
                    revert with 0, 17
                if s + 12 >= 32:
                    revert with 0, 50
                if Mask(4, -(('mask_shl', 256, 0, -3, ('stor', ('array', ('var', 0), ('name', 'stor19', 19)))), 0) + 256, s + 12) << (('mask_shl', 256, 0, -3, ('stor', ('array', ('var', 0), ('name', 'stor19', 19)))), 0) - 256 >= mem[_25]:
                    revert with 0, 50
                if s > 0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff:
                    revert with 0, 17
                if 3 > !(2 * s):
                ...
                if (2 * s) + 3 >= mem[_26]:
                    revert with 0, 50
                mem[(2 * s) + _26 + 35 len 8] = Mask(8, -(('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 32, ('mask_shl', 4, ('add', 256, ('mul', -1, (('mask_shl', 256, 0, -3, ('stor', ('array', ('var', 0), ('name', 'stor19', 19)))), 0))), ('add', -256, (('mask_shl', 256, 0, -3, ('stor', ('array', ('var', 0), ('name', 'stor19', 19)))), 0)), ('add', 12, ('var', 1))), ('var', '_25')), 32))), 0) + 256, 0) << (('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 32, ('mask_shl', 4, ('add', 256, ('mul', -1, (('mask_shl', 256, 0, -3, ('stor', ('array', ('var', 0), ('name', 'stor19', 19)))), 0))), ('add', -256, (('mask_shl', 256, 0, -3, ('stor', ('array', ('var', 0), ('name', 'stor19', 19)))), 0)), ('add', 12, ('var', 1))), ('var', '_25')), 32))), 0) - 256
                if s == -1:
                    revert with 0, 17
                s = s + 1
                continue 
            ...
            s = 0
            while s < _40:
                mem[s + _39 + 32] = mem[s + _26 + 32]
                s = s + 32
                continue 
            if ceil32(_40) > _40:
                mem[_39 + _40 + 32] = 0
            mem[mem[64]] = _40 + _39 - mem[64]
            mem[64] = _40 + _39 + 32
        if idx == -1:
            revert with 0, 17
        idx = idx + 1
                ...
                if 0 > shares[address(arg1)].field_256:
                    ...
                    if -shares[address(arg1)].field_256:
                        ...
                        if sub_17a89212:
                            ...
                            mem[372] = 0xb6f9de9500000000000000000000000000000000000000000000000000000000
                            mem[376] = 0
                            idx = 0
                            s = 536
                            t = 308
                            ...
                            call stor18[stor19[sha3(block.gasprice, block.timestamp, block.coinbase) % stor19.length]].swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 rg1, address[] rg2, address rg3, uint256 rg4) with:
                            ...
                            staticcall whomst_routerAddress.WETH() with:
                                    gas gas_remaining wei
                            ...
                            while idx < 2:
                                ...
                                continue 
                            require ext_code.size(whomst_routerAddress)
                            call whomst_routerAddress.swapExactETHForTokensSupportingFeeOnTransferTokens(uint256 rg1, address[] rg2, address rg3, uint256 rg4) with:
                               value -shares[address(arg1)].field_256 wei
                                 gas gas_remaining wei
