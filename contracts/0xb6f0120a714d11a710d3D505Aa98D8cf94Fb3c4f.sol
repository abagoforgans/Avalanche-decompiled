...
#  - queue(uint256 arg1)
#
const votingPeriod = (168 * 24 * 3600)
...
const proposalThreshold = 5280000 * 10^18
    ...
    while idx < receipt[arg1].field_768:
        ...
        if not bool(receipt[arg1][idx + 5].field_0):
            ...
            if not bool(receipt[arg1][idx + 6].field_0):
                ...
                if bool(receipt[arg1][idx + 6].field_0) != 1:
                    ...
                    call address(timelockAddress).mem[mem[64] len 4] with:
                       value receipt[arg1][idx + 4].field_0 wei
                         gas gas_remaining wei
                        args mem[mem[64] + 4 len _99 + s + -mem[64] + 256]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _166 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if bool(receipt[arg1][idx + 5].field_0) != 1:
                ...
                mem[_99 + 100] = s + 192
                if not bool(receipt[arg1][idx + 6].field_0):
                    mem[_99 + s + 196] = receipt[arg1][idx + 6].field_1 % 128
                    mem[_99 + s + 228] = Mask(248, 8, receipt[arg1][idx + 6].field_0)
                    mem[_99 + 132] = receipt[arg1].field_512
                    require ext_code.size(address(timelockAddress))
                    call address(timelockAddress).mem[mem[64] len 4] with:
                       value receipt[arg1][idx + 4].field_0 wei
                    ...
                    if bool(receipt[arg1][idx + 6].field_0) != 1:
                        ...
                        call address(timelockAddress).mem[mem[64] len 4] with:
                           value receipt[arg1][idx + 4].field_0 wei
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _99 + s + t + -mem[64] + 224]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        _199 = mem[64]
                        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
...
function cancel(uint256 arg1) {
    ...
    if uint8(receipt[arg1].field_2816):
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[20 len 12]
        if ext_call.return_data[20 len 12] >= 5280000 * 10^18:
            ...
            if not bool(receipt[arg1][idx + 5].field_0):
                ...
                if not bool(receipt[arg1][idx + 6].field_0):
                    ...
                    if bool(receipt[arg1][idx + 6].field_0) != 1:
                        ...
                        call address(timelockAddress).mem[mem[64] len 4] with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _258 + s + -mem[64] + 256]
            else:
                if bool(receipt[arg1][idx + 5].field_0) != 1:
                    mem[mem[64] + 100] = -mem[64] - 4
                    if not bool(receipt[arg1][idx + 6].field_0):
                    ...
                    mem[_258 + 100] = s + 192
                    if not bool(receipt[arg1][idx + 6].field_0):
                        mem[_258 + s + 196] = receipt[arg1][idx + 6].field_1 % 128
                        mem[_258 + s + 228] = Mask(248, 8, receipt[arg1][idx + 6].field_0)
                        mem[_258 + 132] = receipt[arg1].field_512
                        require ext_code.size(address(timelockAddress))
                        call address(timelockAddress).mem[mem[64] len 4] with:
                             gas gas_remaining wei
                        ...
                        if bool(receipt[arg1][idx + 6].field_0) != 1:
                            ...
                            mem[_258 + s + 196] = uint255(receipt[arg1][idx + 6].field_1)
                            mem[0] = sha3(sha3(arg1, 4) + 6) + idx
                            t = 0
                            u = sha3(sha3(sha3(arg1, 4) + 6) + idx)
                            while t < uint255(receipt[arg1][idx + 6].field_1):
                                mem[_258 + s + t + 228] = stor[u]
                                t = t + 32
                                u = u + 1
                                continue 
                            mem[_258 + 132] = receipt[arg1].field_512
                            ...
                            call address(timelockAddress).mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _258 + s + t + -mem[64] + 224]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            idx = idx + 1
            continue 
                ...
                if not bool(receipt[arg1][idx + 5].field_0):
                    ...
                    if not bool(receipt[arg1][idx + 6].field_0):
                        ...
                        if bool(receipt[arg1][idx + 6].field_0) != 1:
                            ...
                            call address(timelockAddress).mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _256 + s + -mem[64] + 256]
                else:
                    if bool(receipt[arg1][idx + 5].field_0) != 1:
                        mem[mem[64] + 100] = -mem[64] - 4
                        if not bool(receipt[arg1][idx + 6].field_0):
                        ...
                        mem[_256 + 100] = s + 192
                        if not bool(receipt[arg1][idx + 6].field_0):
                            mem[_256 + s + 196] = receipt[arg1][idx + 6].field_1 % 128
                            mem[_256 + s + 228] = Mask(248, 8, receipt[arg1][idx + 6].field_0)
                            mem[_256 + 132] = receipt[arg1].field_512
                            require ext_code.size(address(timelockAddress))
                            call address(timelockAddress).mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                            ...
                            if bool(receipt[arg1][idx + 6].field_0) != 1:
                                ...
                                mem[_256 + s + 196] = uint255(receipt[arg1][idx + 6].field_1)
                                mem[0] = sha3(sha3(arg1, 4) + 6) + idx
                                t = 0
                                u = sha3(sha3(sha3(arg1, 4) + 6) + idx)
                                while t < uint255(receipt[arg1][idx + 6].field_1):
                                    mem[_256 + s + t + 228] = stor[u]
                                    t = t + 32
                                    u = u + 1
                                    continue 
                                mem[_256 + 132] = receipt[arg1].field_512
                                ...
                                call address(timelockAddress).mem[mem[64] len 4] with:
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4 len _256 + s + t + -mem[64] + 224]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                idx = idx + 1
                continue 
                    ...
                    if not bool(receipt[arg1][idx + 5].field_0):
                        ...
                        if not bool(receipt[arg1][idx + 6].field_0):
                            ...
                            if bool(receipt[arg1][idx + 6].field_0) != 1:
                                ...
                                call address(timelockAddress).mem[mem[64] len 4] with:
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4 len _254 + s + -mem[64] + 256]
                    else:
                        if bool(receipt[arg1][idx + 5].field_0) != 1:
                            mem[mem[64] + 100] = -mem[64] - 4
                            if not bool(receipt[arg1][idx + 6].field_0):
                            ...
                            mem[_254 + 100] = s + 192
                            if not bool(receipt[arg1][idx + 6].field_0):
                                mem[_254 + s + 196] = receipt[arg1][idx + 6].field_1 % 128
                                mem[_254 + s + 228] = Mask(248, 8, receipt[arg1][idx + 6].field_0)
                                mem[_254 + 132] = receipt[arg1].field_512
                                require ext_code.size(address(timelockAddress))
                                call address(timelockAddress).mem[mem[64] len 4] with:
                                     gas gas_remaining wei
                                ...
                                if bool(receipt[arg1][idx + 6].field_0) != 1:
                                    ...
                                    mem[_254 + s + 196] = uint255(receipt[arg1][idx + 6].field_1)
                                    mem[0] = sha3(sha3(arg1, 4) + 6) + idx
                                    t = 0
                                    u = sha3(sha3(sha3(arg1, 4) + 6) + idx)
                                    while t < uint255(receipt[arg1][idx + 6].field_1):
                                        mem[_254 + s + t + 228] = stor[u]
                                        t = t + 32
                                        u = u + 1
                                        continue 
                                    mem[_254 + 132] = receipt[arg1].field_512
                                    ...
                                    call address(timelockAddress).mem[mem[64] len 4] with:
                                         gas gas_remaining wei
                                        args mem[mem[64] + 4 len _254 + s + t + -mem[64] + 224]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    idx = idx + 1
                    continue 
                        ...
                        if not bool(receipt[arg1][idx + 5].field_0):
                            ...
                            if not bool(receipt[arg1][idx + 6].field_0):
                                ...
                                if bool(receipt[arg1][idx + 6].field_0) != 1:
                                    ...
                                    call address(timelockAddress).mem[mem[64] len 4] with:
                                         gas gas_remaining wei
                                        args mem[mem[64] + 4 len _252 + s + -mem[64] + 256]
                        else:
                            if bool(receipt[arg1][idx + 5].field_0) != 1:
                                mem[mem[64] + 100] = -mem[64] - 4
                                if not bool(receipt[arg1][idx + 6].field_0):
                                ...
                                mem[_252 + 100] = s + 192
                                if not bool(receipt[arg1][idx + 6].field_0):
                                    mem[_252 + s + 196] = receipt[arg1][idx + 6].field_1 % 128
                                    mem[_252 + s + 228] = Mask(248, 8, receipt[arg1][idx + 6].field_0)
                                    mem[_252 + 132] = receipt[arg1].field_512
                                    require ext_code.size(address(timelockAddress))
                                    call address(timelockAddress).mem[mem[64] len 4] with:
                                         gas gas_remaining wei
                                    ...
                                    if bool(receipt[arg1][idx + 6].field_0) != 1:
                                        ...
                                        mem[_252 + s + 196] = uint255(receipt[arg1][idx + 6].field_1)
                                        mem[0] = sha3(sha3(arg1, 4) + 6) + idx
                                        t = 0
                                        u = sha3(sha3(sha3(arg1, 4) + 6) + idx)
                                        while t < uint255(receipt[arg1][idx + 6].field_1):
                                            mem[_252 + s + t + 228] = stor[u]
                                            t = t + 32
                                            u = u + 1
                                            continue 
                                        mem[_252 + 132] = receipt[arg1].field_512
                                        ...
                                        call address(timelockAddress).mem[mem[64] len 4] with:
                                             gas gas_remaining wei
                                            args mem[mem[64] + 4 len _252 + s + t + -mem[64] + 224]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        idx = idx + 1
                        continue 
                            ...
                            if not bool(receipt[arg1][idx + 5].field_0):
                                ...
                                if not bool(receipt[arg1][idx + 6].field_0):
                                    ...
                                    if bool(receipt[arg1][idx + 6].field_0) != 1:
                                        ...
                                        call address(timelockAddress).mem[mem[64] len 4] with:
                                             gas gas_remaining wei
                                            args mem[mem[64] + 4 len _250 + s + -mem[64] + 256]
                            else:
                                if bool(receipt[arg1][idx + 5].field_0) != 1:
                                    mem[mem[64] + 100] = -mem[64] - 4
                                    if not bool(receipt[arg1][idx + 6].field_0):
                                    ...
                                    mem[_250 + 100] = s + 192
                                    if not bool(receipt[arg1][idx + 6].field_0):
                                        mem[_250 + s + 196] = receipt[arg1][idx + 6].field_1 % 128
                                        mem[_250 + s + 228] = Mask(248, 8, receipt[arg1][idx + 6].field_0)
                                        mem[_250 + 132] = receipt[arg1].field_512
                                        require ext_code.size(address(timelockAddress))
                                        call address(timelockAddress).mem[mem[64] len 4] with:
                                             gas gas_remaining wei
                                        ...
                                        if bool(receipt[arg1][idx + 6].field_0) != 1:
                                            ...
                                            mem[_250 + s + 196] = uint255(receipt[arg1][idx + 6].field_1)
                                            mem[0] = sha3(sha3(arg1, 4) + 6) + idx
                                            t = 0
                                            u = sha3(sha3(sha3(arg1, 4) + 6) + idx)
                                            while t < uint255(receipt[arg1][idx + 6].field_1):
                                                mem[_250 + s + t + 228] = stor[u]
                                                t = t + 32
                                                u = u + 1
                                                continue 
                                            mem[_250 + 132] = receipt[arg1].field_512
                                            ...
                                            call address(timelockAddress).mem[mem[64] len 4] with:
                                                 gas gas_remaining wei
                                                args mem[mem[64] + 4 len _250 + s + t + -mem[64] + 224]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            idx = idx + 1
                            continue 
                                ...
                                if not bool(receipt[arg1][idx + 5].field_0):
                                    ...
                                    if not bool(receipt[arg1][idx + 6].field_0):
                                        ...
                                        if bool(receipt[arg1][idx + 6].field_0) != 1:
                                            ...
                                            call address(timelockAddress).mem[mem[64] len 4] with:
                                                 gas gas_remaining wei
                                                args mem[mem[64] + 4 len _246 + s + -mem[64] + 256]
                                else:
                                    if bool(receipt[arg1][idx + 5].field_0) != 1:
                                        mem[mem[64] + 100] = -mem[64] - 4
                                        if not bool(receipt[arg1][idx + 6].field_0):
                                        ...
                                        mem[_246 + 100] = s + 192
                                        if not bool(receipt[arg1][idx + 6].field_0):
                                            mem[_246 + s + 196] = receipt[arg1][idx + 6].field_1 % 128
                                            mem[_246 + s + 228] = Mask(248, 8, receipt[arg1][idx + 6].field_0)
                                            mem[_246 + 132] = receipt[arg1].field_512
                                            require ext_code.size(address(timelockAddress))
                                            call address(timelockAddress).mem[mem[64] len 4] with:
                                                 gas gas_remaining wei
                                            ...
                                            if bool(receipt[arg1][idx + 6].field_0) != 1:
                                                ...
                                                mem[_246 + s + 196] = uint255(receipt[arg1][idx + 6].field_1)
                                                mem[0] = sha3(sha3(arg1, 4) + 6) + idx
                                                t = 0
                                                u = sha3(sha3(sha3(arg1, 4) + 6) + idx)
                                                while t < uint255(receipt[arg1][idx + 6].field_1):
                                                    mem[_246 + s + t + 228] = stor[u]
                                                    t = t + 32
                                                    u = u + 1
                                                    continue 
                                                mem[_246 + 132] = receipt[arg1].field_512
                                                ...
                                                call address(timelockAddress).mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len _246 + s + t + -mem[64] + 224]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                idx = idx + 1
                                continue 
                                ...
                                if not bool(receipt[arg1][idx + 5].field_0):
                                    ...
                                    if not bool(receipt[arg1][idx + 6].field_0):
                                        ...
                                        if bool(receipt[arg1][idx + 6].field_0) != 1:
                                            ...
                                            call address(timelockAddress).mem[mem[64] len 4] with:
                                                 gas gas_remaining wei
                                                args mem[mem[64] + 4 len _248 + s + -mem[64] + 256]
                                else:
                                    if bool(receipt[arg1][idx + 5].field_0) != 1:
                                        mem[mem[64] + 100] = -mem[64] - 4
                                        if not bool(receipt[arg1][idx + 6].field_0):
                                        ...
                                        mem[_248 + 100] = s + 192
                                        if not bool(receipt[arg1][idx + 6].field_0):
                                            mem[_248 + s + 196] = receipt[arg1][idx + 6].field_1 % 128
                                            mem[_248 + s + 228] = Mask(248, 8, receipt[arg1][idx + 6].field_0)
                                            mem[_248 + 132] = receipt[arg1].field_512
                                            require ext_code.size(address(timelockAddress))
                                            call address(timelockAddress).mem[mem[64] len 4] with:
                                                 gas gas_remaining wei
                                            ...
                                            if bool(receipt[arg1][idx + 6].field_0) != 1:
                                                ...
                                                mem[_248 + s + 196] = uint255(receipt[arg1][idx + 6].field_1)
                                                mem[0] = sha3(sha3(arg1, 4) + 6) + idx
                                                t = 0
                                                u = sha3(sha3(sha3(arg1, 4) + 6) + idx)
                                                while t < uint255(receipt[arg1][idx + 6].field_1):
                                                    mem[_248 + s + t + 228] = stor[u]
                                                    t = t + 32
                                                    u = u + 1
                                                    continue 
                                                mem[_248 + 132] = receipt[arg1].field_512
                                                ...
                                                call address(timelockAddress).mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len _248 + s + t + -mem[64] + 224]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                idx = idx + 1
                                continue 
