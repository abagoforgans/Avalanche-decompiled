...
const getName = 'StrategyAaveDaiV3'
...
const sub_a450a384(?) = 0x47afa96cdc9fab46904a55a6ad4bf6660b53c38a

const lendingPool = 0x4f01aed16d97e3ab5ab2b501154dc9bb0f1a5a2c

const sub_acda9371(?) = 0x1852dc24d1a8956a0b356aa18ede954c7a0ca5ae
    ...
    if ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            call 0x4f01aed16d97e3ab5ab2b501154dc9bb0f1a5a2c.deposit(address rg1, uint256 rg2, address rg3, uint16 rg4) with:
                 gas gas_remaining wei
                args 0xd586e7f844cea2f87f50152665bcbc2c279d8d70, ext_call.return_data[0], this.address, 170
        else:
            mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
                if return_data.size:
            ...
            if not return_data.size:
                ...
                call 0x4f01aed16d97e3ab5ab2b501154dc9bb0f1a5a2c.deposit(address rg1, uint256 rg2, address rg3, uint16 rg4) with:
                     gas gas_remaining wei
                    args 0xd586e7f844cea2f87f50152665bcbc2c279d8d70, ext_call.return_data[0], this.address, 170, mem[(2 * ceil32(return_data.size)) + 558 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
}
