...
const trustedStakingContractAddress = 0x1ca9fc98f3b997e08bc04691414e33b1835aa7e5
...
const disburseAmount = 660000 * 10^18
...
function getPendingDisbursement() payable {
    ...
    if block.timestamp <= contractDeployTime + (8760 * 24 * 3600):
        ...
        if lastDisburseTime > block.timestamp:
            revert with 0, 'SafeMath: subtraction overflow'
        if (6600000000 * 10^18 * block.timestamp) - (6600000000 * 10^18 * lastDisburseTime) / 6600000000 * 10^18 != block.timestamp - lastDisburseTime:
            revert with 0, 32, 33, 0x21536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
        return ((6600000000 * 10^18 * block.timestamp) - (6600000000 * 10^18 * lastDisburseTime) / 8760 * 24 * 3600 / 10000)
    if lastDisburseTime >= contractDeployTime + (8760 * 24 * 3600):
        return 0
    if lastDisburseTime > contractDeployTime + (8760 * 24 * 3600):
        revert with 0, 'SafeMath: subtraction overflow'
    if (6600000000 * 10^18 * contractDeployTime) + (-6600000000 * 10^18 * lastDisburseTime) + (16060000000 * 10^18 * 3600 * 24 * 3600) / 6600000000 * 10^18 != contractDeployTime + -lastDisburseTime + (8760 * 24 * 3600):
        revert with 0, 32, 33, 0x21536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
    return ((6600000000 * 10^18 * contractDeployTime) + (-6600000000 * 10^18 * lastDisburseTime) + (16060000000 * 10^18 * 3600 * 24 * 3600) / 8760 * 24 * 3600 / 10000)
}
