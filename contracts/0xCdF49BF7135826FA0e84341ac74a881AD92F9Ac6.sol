...
function sub_fc123602(?) payable {
    ...
    while idx < ('cd', 4).length:
        mem[96 len 10601] = code.data[2245 len 10601]
        create contract with 0 wei
                        code: code.data[2245 len 10601]
        ...
        require idx < ('cd', 4).length
        require idx < ('cd', 4).length
        mem[96 len 4027] = code.data[12846 len 4027]
        mem[4123] = stor2
        ...
        create contract with 0 wei
                        code: code.data[12846 len 4027], stor2, cd[((224 * idx) + cd[4] + 68)], cd[((224 * idx) + cd[4] + 100)], cd[((224 * idx) + cd[4] + 132)], cd[((224 * idx) + cd[4] + 164)], cd[((224 * idx) + cd[4] + 196)], cd[((224 * idx) + cd[4] + 228)]
        if not create.new_address:
            revert with ext_call.return_data[0 len return_data.size]
