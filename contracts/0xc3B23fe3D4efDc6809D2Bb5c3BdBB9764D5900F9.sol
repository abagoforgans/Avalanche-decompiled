...
function sub_052cdc0c(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    voterAddress = address(arg1)
}

function sub_448cbf02(?) payable {
    require calldata.size - 4 >= 32
...
function deposit(uint256 arg1) payable {
    ...
    if bool(uint8(stor6.field_160)) != 1:
        revert with 0, 'JoeZapper:deposits disabled'
    require ext_code.size(0x6e84a6216ea6dacc71ee8e6b0a5b7322eebc0fdd)
    call 0x6e84a6216ea6dacc71ee8e6b0a5b7322eebc0fdd.0x23b872dd with:
         gas gas_remaining wei
        args msg.sender, voterAddress, arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    if not ext_call.return_data[0]:
        revert with 0, 'JoeZapper:transfer failed'
    require ext_code.size(voterAddress)
    call voterAddress.0x27201bac with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    emit 0xae898cd5: arg1, msg.sender
}
