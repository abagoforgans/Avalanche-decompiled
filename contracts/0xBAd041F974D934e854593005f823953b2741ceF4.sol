...
function _getNodeNumberOf(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require ext_code.size(0xaaf115998e69223563b3e693a55dd628bbf9795f)
    delegate 0xaaf115998e69223563b3e693a55dd628bbf9795f.0x732a2ccf with:
...
function _migrateNodes(address arg1, string[] arg2, uint256[] arg3, uint256[] arg4, uint256[] arg5) payable {
    ...
    if msg.sender == tokenAddress:
        ...
        while idx < _456:
            ...
            continue 
    require ext_code.size(0xaaf115998e69223563b3e693a55dd628bbf9795f)
    delegate 0xaaf115998e69223563b3e693a55dd628bbf9795f.0xbc2b405c with:
         gas gas_remaining wei
