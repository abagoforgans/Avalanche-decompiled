...
function userInfoList(address arg1) payable {
    ...
    return userInfoList[arg1].field_0, 
           ...
           address(userInfoList[arg1].field_512),
           bool(uint8(userInfoList[arg1].field_672))
}
...
function userInfo(uint256 arg1) payable {
    ...
    return userInfo[arg1].field_0, 
           ...
           address(userInfo[arg1].field_512),
           bool(uint8(userInfo[arg1].field_672))
}
...
function didWon(address arg1) payable {
    require calldata.size - 4 >= 32
    return bool(uint8(userInfoList[address(arg1)].field_672))
}
...
function emergencyWithdraw() payable {
    ...
    mem[260 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 0, userInfoList[address(msg.sender)].field_32)
    call stor4 with:
       funct uint32(msg.sender)
         gas gas_remaining wei
        args Mask(480, 0, userInfoList[address(msg.sender)].field_0), mem[324 len 4]
...
function withdraw(uint256 arg1) payable {
    ...
    if not uint8(userInfoList[address(msg.sender)].field_672):
            ...
            if return_data.size > 0:
                ...
                if not mem[292]:
                    revert with 0, 
                                ...
                                0x735361666542455032303a204245503230206f7065726174696f6e20646964206e6f7420737563636565,
                                mem[ceil32(return_data.size) + 371 len 22]
        Mask(96, 0, userInfoList[address(msg.sender)].field_672) = 0
...
function sub_864a0d0a(?) payable {
    ...
    address(stor2[('map', ('mask_shl', ('mul', 8, ('add', 32, ('mul', -1, ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1')))))), ('cd', ('add', 4, ('param', 'arg1'))))), 0, 0, 0), ('mem', ('range', ('add', 288, ('cd', ('add', 4, ('param', 'arg1')))), ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1'))))))))].field_0) = arg2
    ...
    userInfoList[address(arg2)].field_0 = stor[mem[arg1.length + 288 len ceil32(arg1.length)]][Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0)]
    if 31 >= stor[mem[arg1.length + 288 len ceil32(arg1.length)]][Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0)][1].length:
        userInfoList[address(arg2)].field_256 = uint256(stor1[('map', ('mask_shl', ('mul', 8, ('add', 32, ('mul', -1, ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1')))))), ('cd', ('add', 4, ('param', 'arg1'))))), 0, 0, 0), ('mem', ('range', ('add', 288, ('cd', ('add', 4, ('param', 'arg1')))), ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1'))))))))])
        idx = 0
        while userInfoList[address(arg2)][1].length + 31 / 32 > idx:
            userInfoList[address(arg2)][idx + 1].field_0 = 0
            idx = idx + 1
            continue 
        address(userInfoList[address(arg2)].field_512) = address(stor2[('map', ('mask_shl', ('mul', 8, ('add', 32, ('mul', -1, ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1')))))), ('cd', ('add', 4, ('param', 'arg1'))))), 0, 0, 0), ('mem', ('range', ('add', 288, ('cd', ('add', 4, ('param', 'arg1')))), ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1'))))))))].field_0)
        Mask(96, 0, userInfoList[address(arg2)].field_672) = Mask(96, 0, bool(uint8(stor2[('map', ('mask_shl', ('mul', 8, ('add', 32, ('mul', -1, ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1')))))), ('cd', ('add', 4, ('param', 'arg1'))))), 0, 0, 0), ('mem', ('range', ('add', 288, ('cd', ('add', 4, ('param', 'arg1')))), ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1'))))))))].field_160)))
        userInfo.length++
        userInfo[userInfo.length].field_0 = userInfoList[address(arg2)].field_0
        if 31 >= userInfoList[address(arg2)][1].length:
            userInfo[userInfo.length].field_256 = userInfoList[address(arg2)].field_256
            idx = 0
            while stor[(3 * userInfo.length) + ('name', 'userInfo', 10) + 1].length + 31 / 32 > idx:
                stor[idx + sha3((3 * userInfo.length) + ('name', 'userInfo', 10) + 1)].field_0 = 0
                idx = idx + 1
                continue 
        else:
            userInfo[userInfo.length].field_256 = Mask(255, 1, (256 * not bool(userInfoList[address(arg2)].field_256)) - 1 and userInfoList[address(arg2)].field_256) + 1
            if not Mask(255, 1, (256 * not bool(userInfoList[address(arg2)].field_256)) - 1 and userInfoList[address(arg2)].field_256):
                idx = 0
                while stor[(3 * userInfo.length) + ('name', 'userInfo', 10) + 1].length + 31 / 32 > idx:
                    stor[idx + sha3((3 * userInfo.length) + ('name', 'userInfo', 10) + 1)].field_0 = 0
                    idx = idx + 1
        ...
        if not Mask(255, 1, (256 * not bool(stor1[('map', ('mask_shl', ('mul', 8, ('add', 32, ('mul', -1, ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1')))))), ('cd', ('add', 4, ('param', 'arg1'))))), 0, 0, 0), ('mem', ('range', ('add', 288, ('cd', ('add', 4, ('param', 'arg1')))), ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1'))))))))])) - 1 and uint256(stor1[('map', ('mask_shl', ('mul', 8, ('add', 32, ('mul', -1, ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1')))))), ('cd', ('add', 4, ('param', 'arg1'))))), 0, 0, 0), ('mem', ('range', ('add', 288, ('cd', ('add', 4, ('param', 'arg1')))), ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1'))))))))])):
            ...
            while stor[mem[arg1.length + 288 len ceil32(arg1.length)]][Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0)][1].length + 31 / 32 > idx:
                userInfoList[address(arg2)][s + 1].field_0 = stor[mem[arg1.length + 288 len ceil32(arg1.length)]][Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0)][idx + 1]
                s = s + 1
                idx = idx + 1
                continue 
        ...
        if 31 >= userInfoList[address(arg2)][1].length:
            ...
            if not Mask(255, 1, (256 * not bool(userInfoList[address(arg2)].field_256)) - 1 and userInfoList[address(arg2)].field_256):
                ...
                while stor[(3 * userInfo.length) + ('name', 'userInfo', 10) + 1].length + 31 / 32 > idx:
                    ...
                    idx = idx + 1
                    continue 
    address(userInfo[userInfo.length].field_512) = address(userInfoList[address(arg2)].field_512)
    Mask(96, 0, userInfo[userInfo.length].field_672) = Mask(96, 0, bool(uint8(userInfoList[address(arg2)].field_672)))
