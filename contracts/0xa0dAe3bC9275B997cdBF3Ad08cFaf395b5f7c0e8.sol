...
function sub_6458f34d(?) payable {
    require calldata.size - 4 >= 64
    if arg1 == arg2:
        revert with 0, 32, 36, 0xfe50616e676f6c696e4c6962726172793a204944454e544943414c5f4144445245535345, mem[296 len 28]
    if arg1 < arg2:
        if not arg1:
    ...
    return Array(len=2, data=ext_call.return_data[64], mem[477])
}
...
function getAllReserves(address[] arg1) payable {
    ...
    if not arg1.length - 2:
        ...
        while idx < arg1.length - 1:
            ...
            if mem[(32 * idx) + 140 len 20] == mem[(32 * idx + 1) + 140 len 20]:
                revert with 0, 32, 36, 0xfe50616e676f6c696e4c6962726172793a204944454e544943414c5f4144445245535345, mem[mem[64] + 104 len 28]
            if mem[(32 * idx) + 140 len 20] < mem[(32 * idx + 1) + 140 len 20]:
    ...
    mem[(32 * arg1.length) + 160 len 32 * arg1.length - 2] = code.data[2284 len 32 * arg1.length - 2]
    idx = 0
    while idx < arg1.length - 1:
        require idx < mem[96]
        _219 = mem[(32 * idx) + 128]
