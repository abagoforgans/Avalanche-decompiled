...
function sub_0bf5d35e(?) payable {
    ...
    call address(arg1).burn(uint256 rg1) with:
       value arg2 wei
...
function sub_8790a079(?) payable {
    ...
    require return_data.size >= 32
    _40 = mem[192 len 4], Mask(224, 32, arg3) >> 32
    ...
    _41 = mem[mem[192 len 4], Mask(224, 32, arg3) >> 32 + 192]
