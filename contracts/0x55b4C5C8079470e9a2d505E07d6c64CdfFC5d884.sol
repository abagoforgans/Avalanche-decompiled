...
function sub_a1731eca(?) payable {
    ...
    mem[(7 * ceil32(return_data.size)) + 228] = sub_8a14c2fdAddress
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[64] = (9 * ceil32(return_data.size)) + 224
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    ...
    mem[(9 * ceil32(return_data.size)) + 260] = 0
    mem[(9 * ceil32(return_data.size)) + 292] = 160
    mem[(9 * ceil32(return_data.size)) + 388] = 3
    idx = 0
    ...
    while idx < mem[(6 * ceil32(return_data.size)) + 96]:
        ...
        t = t + 32
        continue 
    mem[(9 * ceil32(return_data.size)) + 324] = msg.sender
    mem[(9 * ceil32(return_data.size)) + 356] = block.timestamp
    require ext_code.size(sub_8a14c2fdAddress)
    call sub_8a14c2fdAddress.mem[mem[64] len 4] with:
         gas gas_remaining wei
        args mem[mem[64] + 4 len (9 * ceil32(return_data.size)) + -mem[64] + 512]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
