        ...
        if not arg1:
            ...
            if arg1 < stor17:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(7 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg1, 0
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(12 * ceil32(return_data.size)) + 324 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg1, 0
    ...
    if not arg1:
        ...
        if arg1 < stor17:
            ...
            if not ext_call.return_data[0]:
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(12 * ceil32(return_data.size)) + 388 len 96] = unknown_0xa9059cbb(?????), msg.sender, arg1, 0
