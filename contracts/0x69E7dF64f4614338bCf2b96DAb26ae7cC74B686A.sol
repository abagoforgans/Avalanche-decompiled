...
function RewardAvax() {
    return rewardAvaxAddress
}

function sub_684fc33b(?) {
...
function getAutoLiquifySettings() {
    return bool(uint8(stor15.field_16)), stor17, stor43
}
