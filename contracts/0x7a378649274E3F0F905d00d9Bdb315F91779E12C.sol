...
function sub_31455e86(?) payable {
    ...
    if stor11:
        ...
        mem[ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 97] = _159
        ...
        if _159 - 1 >= _159:
            revert with 0, 50
        _213 = mem[(32 * _159 - 1) + ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 129]
        ...
        call address(cd[68]).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args cd[100], (10000 * _213) - (cd[132] * _213) / 10000, Array(len=('cd', 164).length, data=mem[mem[64] + 196 len 32 * ('cd', 164).length]), address(this.address), block.timestamp + 60
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _255 = mem[64]
    ...
    if ceil32(32 * mem[ceil32(32 * ('cd', 164).length) + mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 + 97]) + 1 < 0 or ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + ceil32(32 * mem[ceil32(32 * ('cd', 164).length) + mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 + 97]) + 98 > test266151307():
        revert with 0, 65
    mem[64] = ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + ceil32(32 * mem[ceil32(32 * ('cd', 164).length) + mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 + 97]) + 98
    mem[ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 97] = _158
    ...
    if _158 - 1 >= _158:
        revert with 0, 50
    _212 = mem[(32 * _158 - 1) + ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 129]
    ...
    call address(cd[68]).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args cd[100], (10000 * _212) - (cd[132] * _212) / 10000, Array(len=('cd', 164).length, data=mem[mem[64] + 196 len 32 * ('cd', 164).length]), address(this.address), block.timestamp + 60
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _254 = mem[64]
    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
