...
const sub_4e20a02c(?) = 1200 * 10^18

const sub_b61ac6a2(?) = (3 * 10^18 * 24 * 3600)

const sub_ffa8226e(?) = 500 * 10^18
...
function distributeReward(address arg1, address arg2, address arg3) payable {
    ...
    if not arg2:
        revert with 0, '!_sdollarPool'
    if not arg3:
        revert with 0, '!_airdropWallet'
    stor6 = 1
    if not arg1:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply + 1200 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 1200 * 10^18
    if balanceOf[address(arg1)] + 1200 * 10^18 < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 1200 * 10^18
    emit Transfer(1200 * 10^18, 0, arg1);
    if not arg2:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply + (3 * 10^18 * 24 * 3600) < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 3 * 10^18 * 24 * 3600
    if balanceOf[address(arg2)] + (3 * 10^18 * 24 * 3600) < balanceOf[address(arg2)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg2)] += 3 * 10^18 * 24 * 3600
    emit Transfer((3 * 10^18 * 24 * 3600), 0, arg2);
    if not arg3:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply + 500 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 500 * 10^18
    if balanceOf[address(arg3)] + 500 * 10^18 < balanceOf[address(arg3)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg3)] += 500 * 10^18
    emit Transfer(500 * 10^18, 0, arg3);
}
