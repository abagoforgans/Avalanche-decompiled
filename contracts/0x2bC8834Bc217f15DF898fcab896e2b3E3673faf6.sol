...
function sub_1d59866d(?) payable {
    ...
    if stor3[address(arg1)]:
        revert with 0, 'ALREADY_WHITELISTED'
    stor3[address(arg1)] = 1
    return 1
}

function sub_085b0db6(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'INVALID_ADMIN'
    if 0 == arg1:
    ...
    if bool(stor3[address(arg1)]) != 1:
        revert with 0, 'ALREADY_NOT_WHITELISTED'
...
function sub_29cd0b6f(?) payable {
    ...
    while idx < ('cd', 4).length:
        if 0 == address(cd[((32 * idx) + cd[4] + 36)]):
            revert with 0, 'INVALID_ADDRESS'
...
function burn(uint256 arg1) payable {
    ...
    if arg1 > balanceOf[address(msg.sender)]:
        revert with 0, 32, 34, 0x7341524332303a206275726e20616d6f756e7420657863656564732062616c616e63, mem[162 len 30], mem[222 len 2]
    balanceOf[address(msg.sender)] -= arg1
    if arg1 > totalSupply:
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if bool(stor3[address(msg.sender)]) != 1:
        revert with 0, 'NOT_WHITELISTED_ADDRESS'
    if bool(stor3[address(arg1)]) != 1:
        revert with 0, 'NOT_WHITELISTED_ADDRESS'
    if not msg.sender:
        revert with 0x8c379a000000000000000000000000000000000000000000000000000000000, 
