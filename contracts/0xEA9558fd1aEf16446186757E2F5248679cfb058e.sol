...
function sub_7a342664(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_7a342664.length
    return sub_7a342664[arg1].field_0
}
...
function sub_0c3ce7e0(?) payable {
    ...
    stor15 = arg1
    stor16 = arg2
    sub_a99f8971[stor12 + 1].field_0 = stor12 + 1
...
function sub_dcaf098f(?) payable {
    if sub_7a342664.length:
        mem[128] = uint256(sub_7a342664.field_0)
        idx = 128
        s = 0
        while (32 * sub_7a342664.length) + 96 > idx:
            mem[idx + 32] = sub_7a342664[s].field_256
            idx = idx + 32
            s = s + 1
            continue 
        return Array(len=sub_7a342664.length, data=mem[128 len 32 * sub_7a342664.length])
    mem[(32 * sub_7a342664.length) + 128] = 32
    mem[(32 * sub_7a342664.length) + 160] = sub_7a342664.length
    mem[(32 * sub_7a342664.length) + 192 len 32 * sub_7a342664.length] = mem[128 len 32 * sub_7a342664.length]
    return memory
      from (32 * sub_7a342664.length) + 128
       len (96 * sub_7a342664.length) + 64
}
...
function setTotalSupply() payable {
    ...
    while idx <= numContracts:
        ...
        staticcall stor1[idx].0x18160ddd with:
...
function sub_30a27228(?) payable {
    ...
    if not sub_a99f8971[stor12].field_768:
        ...
        while idx < stor16:
            ...
            idx = idx + 1
            continue 
    sub_7a342664.length = mem[96]
    mem[0] = 9
    if not mem[96]:
        idx = 0
        while sub_7a342664.length > idx:
            sub_7a342664[idx].field_0 = 0
            idx = idx + 1
            continue 
    else:
        s = 0
        ...
        while (32 * mem[96]) + 128 > idx:
            sub_7a342664[s].field_0 = mem[idx]
            s = s + 1
            idx = idx + 32
            continue 
