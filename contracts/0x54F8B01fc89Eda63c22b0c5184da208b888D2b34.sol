...
address owner;
address sub_046bd081Address;
address oracleTokenAddress;
address shareAddress;

function sub_046bd081(?) payable {
    return sub_046bd081Address
}
...
function sub_52b4251e(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_046bd081Address = address(arg1)
}
...
function consult() payable {
    require ext_code.size(sub_046bd081Address)
    staticcall sub_046bd081Address.consult(address arg1, uint256 arg2) with:
            gas gas_remaining wei
           args shareAddress, 10^6
