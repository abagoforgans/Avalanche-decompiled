...
function sub_fe0ab9e0(?) payable {
    ...
    while idx < ('cd', 68).length:
        if not idx:
            ...
            mem[0] = sha3(cd[4], 3) + 1
            stor[(2 * campaigns[cd[4]].field_256) + ('array', 1, ('map', ('cd', 4), ('name', 'campaigns', 3)))].field_0 = mem[_90]
            stor[(2 * campaigns[cd[4]].field_256) + ('array', 1, ('map', ('cd', 4), ('name', 'campaigns', 3)))].field_256 = mem[_90 + 32]
        else:
            if idx < 1:
                revert with 0, 17
            if idx - 1 >= mem[96]:
            ...
            campaigns[cd[4]].field_256++
            mem[0] = sha3(cd[4], 3) + 1
            stor[(2 * campaigns[cd[4]].field_256) + ('array', 1, ('map', ('cd', 4), ('name', 'campaigns', 3)))].field_0 = mem[_105]
            stor[(2 * campaigns[cd[4]].field_256) + ('array', 1, ('map', ('cd', 4), ('name', 'campaigns', 3)))].field_256 = mem[_105 + 32]
        if idx == -1:
            revert with 0, 17
        idx = idx + 1
        continue 
