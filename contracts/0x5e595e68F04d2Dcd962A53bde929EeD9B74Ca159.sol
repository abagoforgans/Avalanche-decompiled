...
const sub_33623794(?) = 0x61dd6ee90228693ce09924588bdc9b94881bb69a
...
function getUSDTstaked() payable {
    require ext_code.size(0x61dd6ee90228693ce09924588bdc9b94881bb69a)
    staticcall 0x61dd6ee90228693ce09924588bdc9b94881bb69a.0x72f702f3 with:
    ...
    require return_data.size >= 32
    require ext_code.size(0x61dd6ee90228693ce09924588bdc9b94881bb69a)
    staticcall 0x61dd6ee90228693ce09924588bdc9b94881bb69a.0x18160ddd with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(sha3(0, 17269419903419772280, sha3(8712802085545782520, 0xc7198437980c041c805a1edcba50c1ce5db95118), 0x40231f6b438bce0797c9ada29b718a87ea0a5cea3fe9a771abdd76bd41a3e545)))
    staticcall address(sha3(0, 17269419903419772280, sha3(8712802085545782520, 0xc7198437980c041c805a1edcba50c1ce5db95118), 0x40231f6b438bce0797c9ada29b718a87ea0a5cea3fe9a771abdd76bd41a3e545)).getReserves() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
