...
function sub_654fcc33(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if sub_654fcc33[arg1] >= 3:
        revert with 'NH{q', 33
    return sub_654fcc33[arg1]
}
...
function sub_98db7108(?) payable {
    return sub_98db7108Address
}
...
function timeToUnstake(address arg1) payable {
    ...
    if not timeStaked[address(arg1)]:
        return 0
    if timeStaked[address(arg1)] > -stakingDuration - 1:
        revert with 'NH{q', 17
...
function amountNeededForNextTier(address arg1) payable {
    ...
    if amountStaked[address(arg1)] >= stor9:
        return 0
    if sub_654fcc33[address(arg1)] > 2:
        revert with 'NH{q', 33
    if sub_654fcc33[address(arg1)] + 1 >= 3:
        revert with 'NH{q', 50
