...
function sub_792e9e61(?) payable {
    ...
    require ext_code.size(0x24bd0f349da6afe313a5abffd45fc4d107700adb)
    staticcall 0x24bd0f349da6afe313a5abffd45fc4d107700adb.token0() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    require ext_code.size(0x24bd0f349da6afe313a5abffd45fc4d107700adb)
    staticcall 0x24bd0f349da6afe313a5abffd45fc4d107700adb.getReserves() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
...
function sub_72ba0ebb(?) payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0x47953c729a571ef331e92d537adc45985976c756)
    call 0x47953c729a571ef331e92d537adc45985976c756.forfeit() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[100] = this.address
    require ext_code.size(0xf3caa368b06033a83a49317549b3c1b47e7d5f8f)
    staticcall 0xf3caa368b06033a83a49317549b3c1b47e7d5f8f.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    mem[ceil32(return_data.size) + 100] = 0x47953c729a571ef331e92d537adc45985976c756
    mem[ceil32(return_data.size) + 132] = ext_call.return_data[0]
    require ext_code.size(0xf3caa368b06033a83a49317549b3c1b47e7d5f8f)
    call 0xf3caa368b06033a83a49317549b3c1b47e7d5f8f.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 0x47953c729a571ef331e92d537adc45985976c756, ext_call.return_data[0]
    ...
    require ext_code.size(0x47953c729a571ef331e92d537adc45985976c756)
    call 0x47953c729a571ef331e92d537adc45985976c756.unstake(uint256 arg1, bool arg2) with:
         gas gas_remaining wei
        args ext_call.return_data[0], 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(2 * ceil32(return_data.size)) + 100] = this.address
    require ext_code.size(0xb8ef3a190b68175000b74b4160d325fd5024760e)
    ...
    mem[(4 * ceil32(return_data.size)) + 128] = 0xb8ef3a190b68175000b74b4160d325fd5024760e
    mem[(4 * ceil32(return_data.size)) + 160] = 0xa7d7079b0fead91f3e65f86e8915cb59c1a4c664
    mem[(4 * ceil32(return_data.size)) + 196] = 0x479a682f5873c3331452e675fa6356c00068ab7c
    mem[(4 * ceil32(return_data.size)) + 228] = ext_call.return_data[0]
    require ext_code.size(0xb8ef3a190b68175000b74b4160d325fd5024760e)
    call 0xb8ef3a190b68175000b74b4160d325fd5024760e.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 0x479a682f5873c3331452e675fa6356c00068ab7c, ext_call.return_data[0]
    ...
    require ext_code.size(0x479a682f5873c3331452e675fa6356c00068ab7c)
    call 0x479a682f5873c3331452e675fa6356c00068ab7c.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args ext_call.return_data[0], 0, 160, address(this.address), 3 * 10^10, 2, mem[(6 * ceil32(return_data.size)) + 388 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    mem[(7 * ceil32(return_data.size)) + 192] = _46
    ...
    require ext_code.size(0x47953c729a571ef331e92d537adc45985976c756)
    call 0x47953c729a571ef331e92d537adc45985976c756.0x900cf0cf with:
         gas gas_remaining wei
...
function sub_8fdadfc1(?) payable {
    require ext_code.size(0x47953c729a571ef331e92d537adc45985976c756)
    staticcall 0x47953c729a571ef331e92d537adc45985976c756.0xdeac361a with:
            gas gas_remaining wei
    mem[96] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if uint8(stor1.field_160):
        ...
        if block.timestamp < uint128(stor1.field_0):
            revert with 0, '1e'
        require ext_code.size(0x47953c729a571ef331e92d537adc45985976c756)
        call 0x47953c729a571ef331e92d537adc45985976c756.rebase() with:
             gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(0x47953c729a571ef331e92d537adc45985976c756)
        call 0x47953c729a571ef331e92d537adc45985976c756.claim(address arg1) with:
             gas gas_remaining wei
            args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[0]
        mem[(4 * ceil32(return_data.size)) + 100] = 0x47953c729a571ef331e92d537adc45985976c756
        ...
        mem[(7 * ceil32(return_data.size)) + 128] = 0xb8ef3a190b68175000b74b4160d325fd5024760e
        mem[(7 * ceil32(return_data.size)) + 160] = 0xa7d7079b0fead91f3e65f86e8915cb59c1a4c664
        mem[(7 * ceil32(return_data.size)) + 196] = 0x479a682f5873c3331452e675fa6356c00068ab7c
        ...
        require ext_code.size(0x479a682f5873c3331452e675fa6356c00068ab7c)
        call 0x479a682f5873c3331452e675fa6356c00068ab7c.mem[mem[64] len 4] with:
             gas gas_remaining wei
        ...
        mem[(4 * ceil32(return_data.size)) + 160] = 0xb8ef3a190b68175000b74b4160d325fd5024760e
        require ext_code.size(0x24bd0f349da6afe313a5abffd45fc4d107700adb)
        staticcall 0x24bd0f349da6afe313a5abffd45fc4d107700adb.token0() with:
                gas gas_remaining wei
        mem[(4 * ceil32(return_data.size)) + 192] = ext_call.return_data[0]
        ...
        if address(ext_call.return_data[0]) == 0xa7d7079b0fead91f3e65f86e8915cb59c1a4c664:
            ...
            if Mask(192, 0, ext_call.return_data[18 len 14] + Mask(192, 0, ext_call.return_data[0])) and Mask(192, 0, ext_call.return_data[50 len 14] - Mask(192, 0, Mask(192, 0, Mask(192, 0, uint32(-stor0 + 10000) * Mask(192, 0, ext_call.return_data[0])) * ext_call.return_data[50 len 14]) / Mask(192, 0, Mask(112, 0, 10000 * ext_call.return_data[18 len 14]) + Mask(192, 0, uint32(-stor0 + 10000) * Mask(192, 0, ext_call.return_data[0]))))) > 0xffffffffffffffffffffffffffffffffffffffffffffffff / Mask(192, 0, ext_call.return_data[18 len 14] + Mask(192, 0, ext_call.return_data[0])):
                revert with 'NH{q', 17
            mem[(8 * ceil32(return_data.size)) + 196] = 0x479a682f5873c3331452e675fa6356c00068ab7c
            ...
            call 0x479a682f5873c3331452e675fa6356c00068ab7c.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args ext_call.return_data[0], Mask(192, 0, Mask(192, 0, Mask(192, 0, Mask(192, 0, uint32(-stor0 + 10000) * Mask(192, 0, ext_call.return_data[0])) * Mask(112, 0, ext_call.return_data[32])) / Mask(192, 0, Mask(112, 0, 10000 * Mask(112, 0, ext_call.return_data[0])) + Mask(192, 0, uint32(-stor0 + 10000) * Mask(192, 0, ext_call.return_data[0])))) * uint32(-uint32(stor2.field_112) + 10000)) / 10000 << 64, 160, address(this.address), 3 * 10^10, mem[(8 * ceil32(return_data.size)) + 356 len (32 * mem[(4 * ceil32(return_data.size)) + 96]) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            require return_data.size >= 32
            _154 = mem[(8 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[0 len 28]
            ...
            _156 = mem[(8 * ceil32(return_data.size)) + mem[(8 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[0 len 28] + 192]
            ...
            mem[(10 * ceil32(return_data.size)) + 192] = _156
            require _154 + (32 * _156) + 32 <= return_data.size
            idx = 0
            s = (8 * ceil32(return_data.size)) + _154 + 224
            ...
            mem[mem[64] + 4] = 0x47953c729a571ef331e92d537adc45985976c756
            mem[mem[64] + 36] = _200
            require ext_code.size(0xb8ef3a190b68175000b74b4160d325fd5024760e)
            call 0xb8ef3a190b68175000b74b4160d325fd5024760e.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args 0x47953c729a571ef331e92d537adc45985976c756, _200
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _206 = mem[64]
            ...
            require ext_code.size(0x47953c729a571ef331e92d537adc45985976c756)
            call 0x47953c729a571ef331e92d537adc45985976c756.stake(uint256 arg1, address arg2) with:
                 gas gas_remaining wei
            ...
            call 0x479a682f5873c3331452e675fa6356c00068ab7c.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args ext_call.return_data[0], Mask(192, 0, Mask(192, 0, Mask(192, 0, Mask(192, 0, uint32(-stor0 + 10000) * Mask(192, 0, ext_call.return_data[0])) * Mask(112, 0, ext_call.return_data[0])) / Mask(192, 0, Mask(112, 0, 10000 * Mask(112, 0, ext_call.return_data[32])) + Mask(192, 0, uint32(-stor0 + 10000) * Mask(192, 0, ext_call.return_data[0])))) * uint32(-uint32(stor2.field_112) + 10000)) / 10000 << 64, 160, address(this.address), 3 * 10^10, mem[(8 * ceil32(return_data.size)) + 356 len (32 * mem[(4 * ceil32(return_data.size)) + 96]) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[(8 * ceil32(return_data.size)) + 192 len return_data.size] = ext_call.return_data[0 len return_data.size]
            mem[64] = (10 * ceil32(return_data.size)) + 192
            require return_data.size >= 32
            _155 = mem[(8 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[0 len 28]
            require mem[(8 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[0 len 28] <= test266151307()
            require (8 * ceil32(return_data.size)) + mem[(8 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[0 len 28] + 223 < (8 * ceil32(return_data.size)) + return_data.size + 192
            _157 = mem[(8 * ceil32(return_data.size)) + mem[(8 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[0 len 28] + 192]
            if mem[(8 * ceil32(return_data.size)) + mem[(8 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[0 len 28] + 192] > test266151307():
                revert with 'NH{q', 65
            if (10 * ceil32(return_data.size)) + floor32(mem[(8 * ceil32(return_data.size)) + mem[(8 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[0 len 28] + 192]) + 193 > test266151307() or floor32(mem[(8 * ceil32(return_data.size)) + mem[(8 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[0 len 28] + 192]) + 1 < 0:
                revert with 'NH{q', 65
            ...
            idx = 0
            s = (8 * ceil32(return_data.size)) + _155 + 224
            t = (10 * ceil32(return_data.size)) + 224
            while idx < _157:
                require mem[s] == mem[s]
                mem[t] = mem[s]
            ...
            call 0xb8ef3a190b68175000b74b4160d325fd5024760e.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args 0x47953c729a571ef331e92d537adc45985976c756, _201
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _207 = mem[64]
