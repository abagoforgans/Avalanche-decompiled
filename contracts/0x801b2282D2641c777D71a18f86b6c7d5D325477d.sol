...
function sub_d2d61594(?) payable {
    ...
    if not sub_2d49c359[arg1][arg2]:
        if not sub_2d49c359[arg1][arg2]:
            ...
            if block.timestamp - sub_2d49c359[arg1][arg2] and sub_1ec1e0c8 > -1 / block.timestamp - sub_2d49c359[arg1][arg2]:
                revert with 'NH{q', 17
            if (block.timestamp * sub_1ec1e0c8) - (sub_2d49c359[arg1][arg2] * sub_1ec1e0c8) < 0:
                revert with 'NH{q', 17
            require ext_code.size(landAddress)
            call landAddress.0xeaa6920 with:
                 gas gas_remaining wei
        ...
        if block.timestamp - sub_2d49c359[arg1][arg2] and sub_f277e411 > -1 / block.timestamp - sub_2d49c359[arg1][arg2]:
            revert with 'NH{q', 17
        if not sub_2d49c359[arg1][arg2]:
            if 0 < (block.timestamp * sub_f277e411) - (sub_2d49c359[arg1][arg2] * sub_f277e411):
                revert with 'NH{q', 17
            require ext_code.size(landAddress)
            call landAddress.0xeaa6920 with:
                 gas gas_remaining wei
                args (-1 * block.timestamp * sub_f277e411) + (sub_2d49c359[arg1][arg2] * sub_f277e411), yieldTokenAddress, msg.sender
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            sub_2d49c359[arg1][arg2] = block.timestamp
            emit 0x4d907f49: 0, msg.sender, arg1, arg2
            ...
            if block.timestamp - sub_2d49c359[arg1][arg2] and sub_1ec1e0c8 > -1 / block.timestamp - sub_2d49c359[arg1][arg2]:
                revert with 'NH{q', 17
            if (block.timestamp * sub_1ec1e0c8) - (sub_2d49c359[arg1][arg2] * sub_1ec1e0c8) < (block.timestamp * sub_f277e411) - (sub_2d49c359[arg1][arg2] * sub_f277e411):
                revert with 'NH{q', 17
            require ext_code.size(landAddress)
            call landAddress.0xeaa6920 with:
                 gas gas_remaining wei
                args (block.timestamp * sub_1ec1e0c8) - (sub_2d49c359[arg1][arg2] * sub_1ec1e0c8) - (block.timestamp * sub_f277e411) + (sub_2d49c359[arg1][arg2] * sub_f277e411), yieldTokenAddress, msg.sender
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            sub_2d49c359[arg1][arg2] = block.timestamp
            emit 0x4d907f49: ((block.timestamp * sub_1ec1e0c8) - (sub_2d49c359[arg1][arg2] * sub_1ec1e0c8)), msg.sender, arg1, arg2
