...
function buyTokens(uint256 arg1) payable {
    ...
    if arg1 + sub_9eb9efcf <= hardCap:
        ...
        if not ext_code.size(subjectAddress):
            revert with 0, 'Address: call to non-contract'
        _309 = mem[_296]
        mem[_292 + 196 len ceil32(mem[_296])] = mem[_296 + 32 len ceil32(mem[_296])]
        if ceil32(_309) > _309:
            mem[_309 + _292 + 196] = 0
        call subjectAddress with:
             gas gas_remaining wei
            args mem[_292 + 200 len _309 - 4]
        if not return_data.size:
            if not ext_call.success:
        ...
        if not ext_code.size(subjectAddress):
            revert with 0, 'Address: call to non-contract'
        _313 = mem[_300]
        mem[_295 + 196 len ceil32(mem[_300])] = mem[_300 + 32 len ceil32(mem[_300])]
        if ceil32(_313) > _313:
            mem[_313 + _295 + 196] = 0
        call subjectAddress with:
             gas gas_remaining wei
