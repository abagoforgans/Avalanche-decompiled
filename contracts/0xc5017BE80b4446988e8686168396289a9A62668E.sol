    ...
    if not roleAdmin[1][address(msg.sender)].field_0:
        if not roleAdmin[0x6597667070c54ef182b0f5858b034beac1b6f3089aa2d3188bb1e8929f4fa9b9][1][address(msg.sender)].field_0:
            revert with 0, 
                        32,
                        42,
                        0xa64d61784c6973742e736574506f696e74733a2053656e646572206d757374206265206f70657261746f,
                        mem[(32 * arg1.length) + (32 * arg2.length) + 270 len 22]
    require 1 == arg2.length
    require 0 < arg2.length
    sub_9a65e3eb = mem[(32 * arg1.length) + 160]
    require 0 < arg2.length
    emit 0x2a4f386d: sub_9a65e3eb, mem[(32 * arg1.length) + 160]
}
