...
#  - _fallback()
#
const name = 'Ava Cadabra', 0

const decimals = 9

const symbol = 'AVACADABRA', 0
...
function setSwapBackSettings(bool arg1, uint256 arg2, uint256 arg3) {
    ...
    if totalSupply / 1000 and arg2 > -1 / totalSupply / 1000:
        revert with 0, 17
    swapThreshold = totalSupply / 1000 * arg2
    if totalSupply / 1000 and arg3 > -1 / totalSupply / 1000:
        revert with 0, 17
    maxSwapSize = totalSupply / 1000 * arg3
}
