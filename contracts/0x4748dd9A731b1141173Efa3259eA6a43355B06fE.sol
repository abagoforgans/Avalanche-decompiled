...
function skim(address arg1) payable {
    ...
    if ext_call.return_data[0] - Mask(112, 0, stor8.field_112) > ext_call.return_data[0]:
        revert with 0, 'ds-math-sub-underflow'
    mem[ceil32(return_data.size) + 425 len 64] = Mask(32, 224, sha3('transfer(address,uint256)')) >> 224, address(arg1), Mask(224, 32, ext_call.return_data[0] - Mask(112, 0, stor8.field_112)) >> 32
