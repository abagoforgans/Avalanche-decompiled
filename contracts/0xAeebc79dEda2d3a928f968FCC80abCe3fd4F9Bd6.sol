...
function epoch() {
    ...
    staticcall address(masterChefAddress).0x900cf0cf with:
...
function nextEpochPoint() {
    require ext_code.size(address(masterChefAddress))
    staticcall address(masterChefAddress).0xc5967c26 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function withdrawLockupEpochs() {
    require ext_code.size(address(masterChefAddress))
    staticcall address(masterChefAddress).0x1e85cd65 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function setLockDuration(uint256 arg1) {
    require calldata.size - 4 >= 32
...
function depositOpen() {
    ...
    if not ext_call.return_data[0]:
        revert with 0, 18
    return (ext_call.return_data[0] % ext_call.return_data[0] == pid)
}
...
function totalStakeTokens() {
    ...
    if emergencyWithdrawn:
        return ext_call.return_data[0]
    require ext_code.size(address(masterChefAddress))
    staticcall address(masterChefAddress).0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function emergencyWithdraw() {
    ...
    require ext_code.size(address(masterChefAddress))
    call address(masterChefAddress).exit() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function setPid(uint256 arg1) {
    ...
    if arg1 >= ext_call.return_data[0]:
        revert with 0, 'setPid: OUT_OF_BOUNDS'
    pid = arg1
    emit 0xd850297b: arg1
}
...
function sub_302b260e(?) {
    ...
    if not ext_call.return_data[0]:
        revert with 0, 18
    if ext_call.return_data[0] % ext_call.return_data[0] != pid:
        return (ext_call.return_data[0] % ext_call.return_data[0] == pid)
    require ext_code.size(address(masterChefAddress))
    staticcall address(masterChefAddress).0xc5967c26 with:
            gas gas_remaining wei
    ...
    if block.timestamp > !lockDuration:
        revert with 0, 17
    return (block.timestamp + lockDuration < ext_call.return_data[0])
}
...
function deposit(uint256 arg1) {
    ...
    if not ext_call.return_data[0]:
        revert with 0, 18
    if ext_call.return_data[0] % ext_call.return_data[0] != pid:
        revert with 0, 'deposit: NOT_OPEN'
    require ext_code.size(yieldWolfAddress)
    ...
    if not arg1 * ext_call.return_data[0] / 10000:
        ...
        require return_data.size >= 32
        if emergencyWithdrawn:
            if ext_call.return_data[0] < arg1 - (arg1 * ext_call.return_data[0] / 10000):
                revert with 0, 17
            require ext_code.size(address(masterChefAddress))
            staticcall address(masterChefAddress).0xc5967c26 with:
                    gas gas_remaining wei
            ...
            if block.timestamp > !lockDuration:
                revert with 0, 17
            if block.timestamp + lockDuration >= ext_call.return_data[0]:
                ...
                mem[(8 * ceil32(return_data.size)) + 132] = address(masterChefAddress)
                require ext_code.size(stakeTokenAddress)
                ...
                if ext_call.return_data[0] > !ext_call.return_data[0]:
                    revert with 0, 17
                mem[(10 * ceil32(return_data.size)) + 132] = address(masterChefAddress)
                mem[(10 * ceil32(return_data.size)) + 164] = 2 * ext_call.return_data[0]
                mem[(10 * ceil32(return_data.size)) + 96] = 68
                mem[(10 * ceil32(return_data.size)) + 132 len 28] = Mask(224, 0, stor3)
                ...
                mem[(10 * ceil32(return_data.size)) + 260 len 96] = approve(address arg1, uint256 arg2), Mask(224, 0, stor3), uint32(stor3), 2 * ext_call.return_data[0], 0
                ...
                if not return_data.size:
                    ...
                    if return_data.size:
                        ...
                        if not mem[(10 * ceil32(return_data.size)) + 292]:
                            revert with 0, 'SafeERC20: ERC20 operation did not succeed'
                require ext_code.size(address(masterChefAddress))
                call address(masterChefAddress).stake(uint256 arg1) with:
                     gas gas_remaining wei
                    args ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            if not ext_call.return_data[0] - arg1 + (arg1 * ext_call.return_data[0] / 10000):
            ...
            if not ext_call.return_data[0] - arg1 + (arg1 * ext_call.return_data[0] / 10000):
                revert with 0, 18
            if sharesTotal > !((arg1 * sharesTotal) - (arg1 * ext_call.return_data[0] / 10000 * sharesTotal) / ext_call.return_data[0] - arg1 + (arg1 * ext_call.return_data[0] / 10000)):
                revert with 0, 17
            sharesTotal += (arg1 * sharesTotal) - (arg1 * ext_call.return_data[0] / 10000 * sharesTotal) / ext_call.return_data[0] - arg1 + (arg1 * ext_call.return_data[0] / 10000)
            stor1 = 1
            return ((arg1 * sharesTotal) - (arg1 * ext_call.return_data[0] / 10000 * sharesTotal) / ext_call.return_data[0] - arg1 + (arg1 * ext_call.return_data[0] / 10000))
        ...
        if block.timestamp + lockDuration >= ext_call.return_data[0]:
            ...
            if ext_call.return_data[0] > !ext_call.return_data[0]:
                revert with 0, 17
            mem[(11 * ceil32(return_data.size)) + 132] = address(masterChefAddress)
            mem[(11 * ceil32(return_data.size)) + 164] = 2 * ext_call.return_data[0]
            mem[(11 * ceil32(return_data.size)) + 96] = 68
            mem[(11 * ceil32(return_data.size)) + 132 len 28] = Mask(224, 0, stor3)
            mem[(11 * ceil32(return_data.size)) + 128 len 4] = approve(address arg1, uint256 arg2)
            ...
            if not ext_code.size(stakeTokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(11 * ceil32(return_data.size)) + 260 len 96] = approve(address arg1, uint256 arg2), Mask(224, 0, stor3), uint32(stor3), 2 * ext_call.return_data[0], 0
        ...
        mem[(6 * ceil32(return_data.size)) + 164] = arg1 * ext_call.return_data[0] / 10000
        ...
        if not ext_code.size(stakeTokenAddress):
            revert with 0, 'Address: call to non-contract'
        mem[(6 * ceil32(return_data.size)) + 260 len 96] = 0, ext_call.return_data[12 len 20], arg1 * ext_call.return_data[0] / 10000, 0
        ...
        if not return_data.size:
            ...
            if emergencyWithdrawn:
                ...
                if block.timestamp > !lockDuration:
                    revert with 0, 17
                if block.timestamp + lockDuration >= ext_call.return_data[0]:
                    mem[(8 * ceil32(return_data.size)) + 264] = this.address
                    require ext_code.size(stakeTokenAddress)
                    staticcall stakeTokenAddress.0x70a08231 with:
                            gas gas_remaining wei
                           args this.address
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[(10 * ceil32(return_data.size)) + 264] = this.address
                    mem[(10 * ceil32(return_data.size)) + 296] = address(masterChefAddress)
                    require ext_code.size(stakeTokenAddress)
                    staticcall stakeTokenAddress.0xdd62ed3e with:
                            gas gas_remaining wei
                           args this.address, address(masterChefAddress)
                    ...
                    if ext_call.return_data[0] > !ext_call.return_data[0]:
                        revert with 0, 17
                    mem[(11 * ceil32(return_data.size)) + 296] = address(masterChefAddress)
                    mem[(11 * ceil32(return_data.size)) + 328] = 2 * ext_call.return_data[0]
                    mem[(11 * ceil32(return_data.size)) + 260] = 68
                    mem[(11 * ceil32(return_data.size)) + 292 len 4] = approve(address arg1, uint256 arg2)
                    ...
                    if not ext_code.size(stakeTokenAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(11 * ceil32(return_data.size)) + 424 len 96] = 0, address(masterChefAddress), 2 * ext_call.return_data[0], 0
            ...
            if block.timestamp + lockDuration >= ext_call.return_data[0]:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[(11 * ceil32(return_data.size)) + 264] = this.address
                mem[(11 * ceil32(return_data.size)) + 296] = address(masterChefAddress)
                require ext_code.size(stakeTokenAddress)
                staticcall stakeTokenAddress.0xdd62ed3e with:
                        gas gas_remaining wei
                ...
                if ext_call.return_data[0] > !ext_call.return_data[0]:
                    revert with 0, 17
                mem[(12 * ceil32(return_data.size)) + 296] = address(masterChefAddress)
                mem[(12 * ceil32(return_data.size)) + 328] = 2 * ext_call.return_data[0]
                mem[(12 * ceil32(return_data.size)) + 260] = 68
                mem[(12 * ceil32(return_data.size)) + 292 len 4] = approve(address arg1, uint256 arg2)
                ...
                if not ext_code.size(stakeTokenAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(12 * ceil32(return_data.size)) + 424 len 96] = 0, address(masterChefAddress), 2 * ext_call.return_data[0], 0
            ...
            if emergencyWithdrawn:
                ...
                if block.timestamp > !lockDuration:
                    revert with 0, 17
                if block.timestamp + lockDuration >= ext_call.return_data[0]:
                    mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 265] = this.address
                    require ext_code.size(stakeTokenAddress)
                    staticcall stakeTokenAddress.0x70a08231 with:
                            gas gas_remaining wei
                           args this.address
                    mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 261] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 265] = this.address
                    mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 297] = address(masterChefAddress)
                    require ext_code.size(stakeTokenAddress)
                    staticcall stakeTokenAddress.0xdd62ed3e with:
                            gas gas_remaining wei
                           args this.address, address(masterChefAddress)
                    mem[(10 * ceil32(return_data.size)) + ceil32(return_data.size) + 261] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    if ext_call.return_data[0] > !ext_call.return_data[0]:
                        revert with 0, 17
                    mem[(11 * ceil32(return_data.size)) + ceil32(return_data.size) + 297] = address(masterChefAddress)
                    mem[(11 * ceil32(return_data.size)) + ceil32(return_data.size) + 329] = 2 * ext_call.return_data[0]
                    mem[(11 * ceil32(return_data.size)) + ceil32(return_data.size) + 261] = 68
                    mem[(11 * ceil32(return_data.size)) + ceil32(return_data.size) + 293 len 4] = approve(address arg1, uint256 arg2)
                    ...
                    if not ext_code.size(stakeTokenAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(11 * ceil32(return_data.size)) + ceil32(return_data.size) + 425 len 96] = 0, address(masterChefAddress), 2 * ext_call.return_data[0], 0
            ...
            if block.timestamp + lockDuration >= ext_call.return_data[0]:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[(11 * ceil32(return_data.size)) + ceil32(return_data.size) + 265] = this.address
                mem[(11 * ceil32(return_data.size)) + ceil32(return_data.size) + 297] = address(masterChefAddress)
                require ext_code.size(stakeTokenAddress)
                staticcall stakeTokenAddress.0xdd62ed3e with:
                        gas gas_remaining wei
                       args this.address, address(masterChefAddress)
                mem[(11 * ceil32(return_data.size)) + ceil32(return_data.size) + 261] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                if ext_call.return_data[0] > !ext_call.return_data[0]:
                    revert with 0, 17
                mem[(12 * ceil32(return_data.size)) + ceil32(return_data.size) + 297] = address(masterChefAddress)
                mem[(12 * ceil32(return_data.size)) + ceil32(return_data.size) + 329] = 2 * ext_call.return_data[0]
                mem[(12 * ceil32(return_data.size)) + ceil32(return_data.size) + 261] = 68
                mem[(12 * ceil32(return_data.size)) + ceil32(return_data.size) + 293 len 4] = approve(address arg1, uint256 arg2)
                ...
                if not ext_code.size(stakeTokenAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(12 * ceil32(return_data.size)) + ceil32(return_data.size) + 425 len 96] = 0, address(masterChefAddress), 2 * ext_call.return_data[0], 0
    ...
    if not (2 * ext_call.return_data[0]) - arg1 + (arg1 * ext_call.return_data[0] / 10000):
        revert with 0, 18
    if sharesTotal > !((arg1 * sharesTotal) - (arg1 * ext_call.return_data[0] / 10000 * sharesTotal) / (2 * ext_call.return_data[0]) - arg1 + (arg1 * ext_call.return_data[0] / 10000)):
        revert with 0, 17
    sharesTotal += (arg1 * sharesTotal) - (arg1 * ext_call.return_data[0] / 10000 * sharesTotal) / (2 * ext_call.return_data[0]) - arg1 + (arg1 * ext_call.return_data[0] / 10000)
    stor1 = 1
    return ((arg1 * sharesTotal) - (arg1 * ext_call.return_data[0] / 10000 * sharesTotal) / (2 * ext_call.return_data[0]) - arg1 + (arg1 * ext_call.return_data[0] / 10000))
}
