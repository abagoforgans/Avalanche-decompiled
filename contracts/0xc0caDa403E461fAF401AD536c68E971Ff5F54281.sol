            ...
            if not stor29:
                if owner != msg.sender:
                    if not stor31[address(msg.sender)]:
                        stor29 = 1
                        if balanceOf[this.address] and stor19 > -1 / balanceOf[this.address]:
                            revert with 0, 17
                        mem[ceil32(return_data.size) + 96] = 2
                        mem[ceil32(return_data.size) + 128] = this.address
                        require ext_code.size(joeRouterAddress)
                        ...
                        mem[0] = joeRouterAddress
                        mem[32] = sha3(address(this.address), 1)
                        allowance[address(this.address)][address(stor26.field_0)].field_0 = balanceOf[this.address] * stor19 / 100
                        mem[(2 * ceil32(return_data.size)) + 192] = balanceOf[this.address] * stor19 / 100
                        emit Approval(mem[(2 * ceil32(return_data.size)) + 192 len ceil32(return_data.size) + 32], this.address, joeRouterAddress);
                        mem[(2 * ceil32(return_data.size)) + 192] = 0x762b156200000000000000000000000000000000000000000000000000000000
                        mem[(2 * ceil32(return_data.size)) + 196] = balanceOf[this.address] * stor19 / 100
                        mem[(2 * ceil32(return_data.size)) + 228] = 0
                        mem[(2 * ceil32(return_data.size)) + 260] = 160
                        mem[(2 * ceil32(return_data.size)) + 356] = 2
                        idx = 0
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if balanceOf[this.address] and stor17 > -1 / balanceOf[this.address]:
                            revert with 0, 17
                        if balanceOf[this.address] * stor17 / 100 and stor28 > -1 / balanceOf[this.address] * stor17 / 100:
                            revert with 0, 17
                        _188 = mem[64]
                        mem[mem[64]] = 2
                        mem[64] = mem[64] + 96
                        ...
                        mem[0] = joeRouterAddress
                        mem[32] = sha3(address(this.address), 1)
                        allowance[address(this.address)][address(stor26.field_0)].field_0 = balanceOf[this.address] * stor17 / 100 * stor28 / 100
                        emit Approval((balanceOf[this.address] * stor17 / 100 * stor28 / 100), this.address, joeRouterAddress);
                        mem[_188 + ceil32(return_data.size) + 96] = 0x762b156200000000000000000000000000000000000000000000000000000000
                        mem[_188 + ceil32(return_data.size) + 100] = balanceOf[this.address] * stor17 / 100 * stor28 / 100
                        ...
                        call joeRouterAddress.mem[mem[64] len 4] with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _188 + ceil32(return_data.size) + (32 * mem[_188]) + -mem[64] + 288]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if eth.balance(this.address) < eth.balance(this.address):
                            revert with 0, 17
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if balanceOf[this.address] * stor17 / 100 < balanceOf[this.address] * stor17 / 100 * stor28 / 100:
                            revert with 0, 17
                        if not this.address:
                            revert with 0, 'ERC20: transfer from the zero address'
                        if not rewardsPoolAddress:
                            revert with 0, 'ERC20: transfer to the zero address'
                        if balanceOf[address(this.address)] < (balanceOf[this.address] * stor17 / 100) - (balanceOf[this.address] * stor17 / 100 * stor28 / 100):
                            revert with 0, 'ERC20: transfer amount exceeds balance'
                        mem[32] = 0
                        balanceOf[address(this.address)] = balanceOf[address(this.address)] - (balanceOf[this.address] * stor17 / 100) + (balanceOf[this.address] * stor17 / 100 * stor28 / 100)
                        mem[0] = rewardsPoolAddress
                        if balanceOf[stor16] > !((balanceOf[this.address] * stor17 / 100) - (balanceOf[this.address] * stor17 / 100 * stor28 / 100)):
                            revert with 0, 17
                        balanceOf[stor16] = balanceOf[stor16] + (balanceOf[this.address] * stor17 / 100) - (balanceOf[this.address] * stor17 / 100 * stor28 / 100)
                        emit Transfer(((balanceOf[this.address] * stor17 / 100) - (balanceOf[this.address] * stor17 / 100 * stor28 / 100)), this.address, rewardsPoolAddress);
                        if balanceOf[this.address] and stor18 > -1 / balanceOf[this.address]:
                            revert with 0, 17
                        if balanceOf[this.address] * stor18 / 100 < balanceOf[this.address] * stor18 / 100 / 2:
                            revert with 0, 17
                        _303 = mem[64]
                        mem[mem[64]] = 2
                        mem[64] = mem[64] + 96
                        ...
                        mem[0] = joeRouterAddress
                        mem[32] = sha3(address(this.address), 1)
                        allowance[address(this.address)][address(stor26.field_0)].field_0 = balanceOf[this.address] * stor18 / 100 / 2
                        allowance[address(this.address)][address(stor26.field_0)].field_255 = 0
                        emit Approval((balanceOf[this.address] * stor18 / 100 / 2), this.address, joeRouterAddress);
                        mem[_303 + ceil32(return_data.size) + 96] = 0x762b156200000000000000000000000000000000000000000000000000000000
                        mem[_303 + ceil32(return_data.size) + 100] = balanceOf[this.address] * stor18 / 100 / 2
                        ...
                        call joeRouterAddress.swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args Mask(255, 1, balanceOf[this.address] * stor18 / 100), 0, 160, address(this.address), block.timestamp, mem[_303 + ceil32(return_data.size) + 260 len (32 * mem[_303]) + 32]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if eth.balance(this.address) < eth.balance(this.address):
                            revert with 0, 17
                        ...
                        if not joeRouterAddress:
                            revert with 0, 'ERC20: approve to the zero address'
                        allowance[address(this.address)][address(stor26.field_0)].field_0 = (balanceOf[this.address] * stor18 / 100) - (balanceOf[this.address] * stor18 / 100 / 2)
                        emit Approval(((balanceOf[this.address] * stor18 / 100) - (balanceOf[this.address] * stor18 / 100 / 2)), this.address, joeRouterAddress);
                        mem[_303 + ceil32(return_data.size) + 164] = 0
                        mem[_303 + ceil32(return_data.size) + 196] = 0
                        mem[_303 + ceil32(return_data.size) + 228] = rewardsPoolAddress
                        mem[_303 + ceil32(return_data.size) + 260] = block.timestamp
                        require ext_code.size(joeRouterAddress)
                        call joeRouterAddress.addLiquidityAVAX(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
                             gas gas_remaining wei
                            args this.address, (balanceOf[this.address] * stor18 / 100) - (balanceOf[this.address] * stor18 / 100 / 2), 0, 0, rewardsPoolAddress, block.timestamp
                        mem[_303 + ceil32(return_data.size) + 96 len 96] = ext_call.return_data[0 len 96]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 96
                        emit SwapAndLiquify(Mask(255, 1, balanceOf[this.address] * stor18 / 100), 0, (balanceOf[this.address] * stor18 / 100) - (balanceOf[this.address] * stor18 / 100 / 2));
                        ...
                        mem[0] = joeRouterAddress
                        mem[32] = sha3(address(this.address), 1)
                        allowance[address(this.address)][address(stor26.field_0)].field_0 = balanceOf[this.address]
