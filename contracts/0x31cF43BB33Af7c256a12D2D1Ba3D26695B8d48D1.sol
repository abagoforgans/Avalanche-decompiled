...
const SecondTeamWallet = 0x33f8368bf2da60a3aad41cf15ea745edba6b035c
...
const TeamWallet = 0x102bb1b362add81f3544cc231ea32c82f248f47b
...
function SetupEnableTrading() {
    if owner != msg.sender:
        if 0x102bb1b362add81f3544cc231ea32c82f248f47b != msg.sender:
            if 0x33f8368bf2da60a3aad41cf15ea745edba6b035c != msg.sender:
    ...
    if owner != msg.sender:
        if 0x102bb1b362add81f3544cc231ea32c82f248f47b != msg.sender:
            if 0x33f8368bf2da60a3aad41cf15ea745edba6b035c != msg.sender:
                revert with 0, 'Caller not in Team'
    marketingBalance = 0
    call 0x33f8368bf2da60a3aad41cf15ea745edba6b035c with:
...
function TeamSetTaxes(uint8 arg1, uint8 arg2, uint8 arg3, uint8 arg4, uint8 arg5, uint8 arg6) {
    ...
    if arg6 > 95:
        revert with 0, 'taxes higher than max tax'
    uint8(stor20.field_32) = arg1
    uint8(stor20.field_40) = arg2
...
function TeamDistributePresale(uint256 arg1, address[] arg2) {
    ...
    if msg.sender == owner:
        ...
        while idx < arg2.length:
            ...
            if idx >= mem[96]:
                revert with 'NH{q', 50
            if balanceOf[mem[(32 * idx) + 140 len 20]] > (-1 * 10^9 * arg1) - 1:
                revert with 'NH{q', 17
            ...
            mem[0] = this.address
            mem[32] = 1
            if balanceOf[address(this.address)] < 10^9 * arg1:
                revert with 'NH{q', 17
            balanceOf[address(this.address)] += -1 * 10^9 * arg1
            if idx >= mem[96]:
                revert with 'NH{q', 50
            _78 = mem[(32 * idx) + 128]
            if arg1 and 10^9 > -1 / arg1:
                revert with 'NH{q', 17
            mem[floor32(arg2.length) + 97] = 10^9 * arg1
            emit Transfer((10^9 * arg1), this.address, address(_78));
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
            continue 
    else:
        if msg.sender == 0x102bb1b362add81f3544cc231ea32c82f248f47b:
            idx = 0
            while idx < arg2.length:
                if arg1 and 10^9 > -1 / arg1:
                    revert with 'NH{q', 17
                ...
                if arg1 and 10^9 > -1 / arg1:
                    revert with 'NH{q', 17
                mem[floor32(arg2.length) + 97] = 10^9 * arg1
                emit Transfer((10^9 * arg1), this.address, address(_79));
                if idx == -1:
                    revert with 'NH{q', 17
                idx = idx + 1
                continue 
            ...
            while idx < arg2.length:
                ...
                if arg1 and 10^9 > -1 / arg1:
                    revert with 'NH{q', 17
                mem[floor32(arg2.length) + 97] = 10^9 * arg1
                emit Transfer((10^9 * arg1), this.address, address(_80));
                if idx == -1:
                    revert with 'NH{q', 17
                idx = idx + 1
                continue 
...
function TeamManualGenerateTokenSwapBalance(uint256 arg1) {
    ...
    if uint8(stor20.field_40) > -uint8(stor20.field_48) + 255:
        revert with 'NH{q', 17
    if stor13 <= 10^9 * arg1:
        if balanceOf[address(this.address)] >= stor13:
            if uint8(uint8(stor20.field_40) + uint8(stor20.field_48)):
                if stor13 and uint8(stor20.field_40) > -1 / stor13:
                    revert with 'NH{q', 17
                if not uint8(uint8(stor20.field_40) + uint8(stor20.field_48)):
                    revert with 'NH{q', 18
                if stor13 < stor13 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)):
                    revert with 'NH{q', 17
                if stor13 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) < stor13 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2:
                    revert with 'NH{q', 17
                if -stor13 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2 > -stor13 - 1:
                    revert with 'NH{q', 17
                if not this.address:
                    revert with 0, 'Approve from zero'
                if not stor21:
                    revert with 0, 'Approve to zero'
                allowance[address(this.address)][stor21].field_0 = -(stor13 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2) + stor13
                emit Approval((-(stor13 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2) + stor13), this.address, stor21);
                ...
                mem[ceil32(return_data.size) + 196] = -(stor13 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2) + stor13
                idx = 0
                s = 128
                ...
                call stor21.swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args -(stor13 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2) + stor13, 0, 160, address(this.address), block.timestamp, 2, mem[ceil32(return_data.size) + 388 len 64]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if eth.balance(this.address) < eth.balance(this.address):
                    revert with 'NH{q', 17
                if False and (stor13 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48))) - (stor13 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2) > 0:
                    revert with 'NH{q', 17
                if not -(stor13 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2) + stor13:
                    revert with 'NH{q', 18
                if totalLPAVAX > -(0 / -(stor13 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2) + stor13) - 1:
                    revert with 'NH{q', 17
                totalLPAVAX += 0 / -(stor13 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2) + stor13
                if not this.address:
                    revert with 0, 'Approve from zero'
                if not stor21:
                    revert with 0, 'Approve to zero'
                allowance[address(this.address)][stor21].field_0 = stor13 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2
                allowance[address(this.address)][stor21].field_255 = 0
                emit Approval((stor13 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2), this.address, stor21);
                require ext_code.size(stor21)
                call stor21.addLiquidityAVAX(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
                   value 0 / -(stor13 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2) + stor13 wei
                     gas gas_remaining wei
                    args address(this.address), Mask(255, 1, stor13 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48))), 0, 0, address(this.address), block.timestamp
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
        ...
        if not stor14:
            ...
            if balanceOf[address(this.address)] >= 10^9 * arg1:
                if uint8(uint8(stor20.field_40) + uint8(stor20.field_48)):
                    ...
                    if not uint8(uint8(stor20.field_40) + uint8(stor20.field_48)):
                        revert with 'NH{q', 18
                    if 10^9 * arg1 < 10^9 * arg1 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)):
                        revert with 'NH{q', 17
                    if 10^9 * arg1 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) < 10^9 * arg1 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2:
                        revert with 'NH{q', 17
                    if -10^9 * arg1 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2 > (-1 * 10^9 * arg1) - 1:
                        revert with 'NH{q', 17
                    if not this.address:
                        revert with 0, 'Approve from zero'
                    if not stor21:
                        revert with 0, 'Approve to zero'
                    allowance[address(this.address)][stor21].field_0 = -(10^9 * arg1 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2) + (10^9 * arg1)
                    emit Approval((-(10^9 * arg1 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2) + (10^9 * arg1)), this.address, stor21);
                    mem[128] = this.address
                    require ext_code.size(stor21)
                    staticcall stor21.0x73b295c2 with:
                            gas gas_remaining wei
                    ...
                    mem[160] = ext_call.return_data[12 len 20]
                    mem[ceil32(return_data.size) + 192] = 0x762b156200000000000000000000000000000000000000000000000000000000
                    mem[ceil32(return_data.size) + 196] = -(10^9 * arg1 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2) + (10^9 * arg1)
                    idx = 0
                    s = 128
                    t = ceil32(return_data.size) + 388
                    while idx < 2:
                    ...
                    call stor21.swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args -(10^9 * arg1 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2) + (10^9 * arg1), 0, 160, address(this.address), block.timestamp, 2, mem[ceil32(return_data.size) + 388 len 64]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    if eth.balance(this.address) < eth.balance(this.address):
                        revert with 'NH{q', 17
                    if False and (10^9 * arg1 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48))) - (10^9 * arg1 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2) > 0:
                        revert with 'NH{q', 17
                    if not -(10^9 * arg1 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2) + (10^9 * arg1):
                        revert with 'NH{q', 18
                    if totalLPAVAX > -(0 / -(10^9 * arg1 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2) + (10^9 * arg1)) - 1:
                        revert with 'NH{q', 17
                    totalLPAVAX += 0 / -(10^9 * arg1 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2) + (10^9 * arg1)
                    if not this.address:
                        revert with 0, 'Approve from zero'
                    if not stor21:
                        revert with 0, 'Approve to zero'
                    allowance[address(this.address)][stor21].field_0 = 10^9 * arg1 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2
                    allowance[address(this.address)][stor21].field_255 = 0
                    emit Approval((10^9 * arg1 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2), this.address, stor21);
                    require ext_code.size(stor21)
                    call stor21.addLiquidityAVAX(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
                       value 0 / -(10^9 * arg1 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48)) / 2) + (10^9 * arg1) wei
                         gas gas_remaining wei
                        args address(this.address), Mask(255, 1, 10^9 * arg1 * uint8(stor20.field_40) / uint8(uint8(stor20.field_40) + uint8(stor20.field_48))), 0, 0, address(this.address), block.timestamp
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 96
                    require ext_call.return_data[0] == ext_call.return_data[0]
