...
function calculateTotalDailyEmission() payable {
    ...
    while idx < stor554.length:
        ...
        if 457093 * 3600 > block.timestamp:
            ...
            continue 
        if stor553[stor554[idx]].field_0 >= tierLevel.length.field_96 % 16777216:
            if stor553[stor554[idx]].field_256 > 0x775f978c5b65300775f978c5b65300775f978c5b65300775f978c5b6530077:
                revert with 0, 17
            if s > !(549 * stor553[stor554[idx]].field_256 / 100000):
                revert with 0, 17
            if idx == -1:
                revert with 0, 17
            idx = idx + 1
            s = s + (549 * stor553[stor554[idx]].field_256 / 100000)
            continue 
        if stor553[stor554[idx]].field_0 >= tierLevel.length.field_72 % 16777216:
            if stor553[stor554[idx]].field_256 > 0x7be2f6ce27aeb30e08b5f55a7eca4896fc9ccb405cea391a9dc3064a868878:
                revert with 0, 17
            if s > !(529 * stor553[stor554[idx]].field_256 / 100000):
                revert with 0, 17
            if idx == -1:
                revert with 0, 17
            idx = idx + 1
            s = s + (529 * stor553[stor554[idx]].field_256 / 100000)
            continue 
        if stor553[stor554[idx]].field_0 >= tierLevel.length.field_48 % 16777216:
            if stor553[stor554[idx]].field_256 > 0x80808080808080808080808080808080808080808080808080808080808080:
                revert with 0, 17
            ...
            continue 
        if stor553[stor554[idx]].field_0 >= tierLevel.length.field_24 % 16777216:
            if stor553[stor554[idx]].field_256 > 0x1d77b654b82c33917f14424d5a3e9e6374075ded952e0b0ce45fc51093568fa:
                revert with 0, 17
            if s > !(139 * stor553[stor554[idx]].field_256 / 100000):
                revert with 0, 17
            if idx == -1:
                revert with 0, 17
            idx = idx + 1
            s = s + (139 * stor553[stor554[idx]].field_256 / 100000)
            continue 
        if stor553[stor554[idx]].field_0 <= tierLevel.length:
            if stor553[stor554[idx]].field_256 > 0x2f149902f149902f149902f149902f149902f149902f149902f149902f14990:
                revert with 0, 17
            if s > !(87 * stor553[stor554[idx]].field_256 / 100000):
                revert with 0, 17
            if idx == -1:
                revert with 0, 17
            idx = idx + 1
            s = s + (87 * stor553[stor554[idx]].field_256 / 100000)
            continue 
        if stor553[stor554[idx]].field_256 > 0x239e0d5b450239e0d5b450239e0d5b450239e0d5b450239e0d5b450239e0d5b:
            revert with 0, 17
        if s > !(115 * stor553[stor554[idx]].field_256 / 100000):
            revert with 0, 17
        if idx == -1:
            revert with 0, 17
        idx = idx + 1
        s = s + (115 * stor553[stor554[idx]].field_256 / 100000)
        continue 
    return s
}
