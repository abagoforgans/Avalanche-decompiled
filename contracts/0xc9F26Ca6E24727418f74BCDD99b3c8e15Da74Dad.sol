...
function getLiquidityBacking(uint256 arg1) {
    ...
    if totalSupply - balanceOf[stor3] < balanceOf[stor4]:
        revert with 0, 17
    if not balanceOf[address(stor25.field_0)]:
        if arg1:
    ...
    if balanceOf[address(stor25.field_0)] and 2 > -1 / balanceOf[address(stor25.field_0)]:
        revert with 0, 17
    if not balanceOf[address(stor25.field_0)]:
        revert with 0, 18
    if 2 * balanceOf[address(stor25.field_0)] / balanceOf[address(stor25.field_0)] != 2:
        revert with 0, 'SafeMath: multiplication overflow'
    if not arg1:
        if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
            revert with 0, 'SafeMath: division by zero', 0
        return (0 / totalSupply - balanceOf[stor3] - balanceOf[stor4])
    if arg1 and 2 * balanceOf[address(stor25.field_0)] > -1 / arg1:
        revert with 0, 17
    if not arg1:
        revert with 0, 18
    if arg1 * 2 * balanceOf[address(stor25.field_0)] / arg1 != 2 * balanceOf[address(stor25.field_0)]:
        revert with 0, 'SafeMath: multiplication overflow'
    if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
        revert with 0, 'SafeMath: division by zero', 0
    return (arg1 * 2 * balanceOf[address(stor25.field_0)] / totalSupply - balanceOf[stor3] - balanceOf[stor4])
}
...
function isOverLiquified(uint256 arg1, uint256 arg2) {
    ...
    if not arg2:
        if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
            revert with 0, 'SafeMath: division by zero', 0
        return (0 / totalSupply - balanceOf[stor3] - balanceOf[stor4] > arg1)
    if arg2 and 2 * balanceOf[address(stor25.field_0)] > -1 / arg2:
        revert with 0, 17
    if not arg2:
        revert with 0, 18
    if arg2 * 2 * balanceOf[address(stor25.field_0)] / arg2 != 2 * balanceOf[address(stor25.field_0)]:
        revert with 0, 'SafeMath: multiplication overflow'
    if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
        revert with 0, 'SafeMath: division by zero', 0
    return (arg2 * 2 * balanceOf[address(stor25.field_0)] / totalSupply - balanceOf[stor3] - balanceOf[stor4] > arg1)
}
