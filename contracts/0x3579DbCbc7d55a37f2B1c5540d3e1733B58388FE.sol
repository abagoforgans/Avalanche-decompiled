...
const COMMUNITY_FUND_POOL_ALLOCATION = 7000 * 10^18

const VESTING_DURATION = (3600 * 24 * 3600)

const DEV_FUND_POOL_ALLOCATION = 3500 * 10^18

const FARMING_POOL_REWARD_ALLOCATION = 70000 * 10^18
...
function sub_55a71544(?) payable {
    return sub_55a71544Address
}
...
function setTreasuryFund(address arg1) payable {
    require calldata.size - 4 >= 32
    if sub_6dc651d9Address != msg.sender:
        revert with 0, '!dev'
    if sub_117effebAddress != msg.sender:
        revert with 0, '!dev'
    if sub_ca9ab2eeAddress != msg.sender:
        revert with 0, '!dev'
    if sub_6beec71aAddress != msg.sender:
        revert with 0, '!dev'
    if sub_55a71544Address != msg.sender:
        revert with 0, '!dev'
...
function sub_387e1faf(?) payable {
    require calldata.size - 4 >= 64
    if not arg2:
        revert with 0, 'zero'
    if arg1 == 1:
        sub_6dc651d9Address = arg2
    else:
        if arg1 == 2:
            sub_117effebAddress = arg2
        else:
            if arg1 == 3:
                sub_ca9ab2eeAddress = arg2
            else:
                if arg1 == 4:
                    sub_6beec71aAddress = arg2
                else:
                    if arg1 == 5:
                        sub_55a71544Address = arg2
}
...
function distributeReward(address arg1) payable {
    ...
    if totalSupply + 70000 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 70000 * 10^18
    if balanceOf[address(arg1)] + 70000 * 10^18 < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 70000 * 10^18
    emit Transfer(70000 * 10^18, 0, arg1);
}
        ...
        if devFundLastClaimed < block.timestamp:
            ...
            if block.timestamp - devFundLastClaimed:
                ...
                if (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) > 0:
                    if sub_6dc651d9Address:
                        if sub_117effebAddress:
                            if sub_ca9ab2eeAddress:
                                if sub_6beec71aAddress:
                                    if sub_55a71544Address:
                                        if not sub_6dc651d9Address:
                                            revert with 0, 'ERC20: mint to the zero address'
                                        if totalSupply + ((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < totalSupply:
                                            revert with 0, 'SafeMath: addition overflow'
                                        totalSupply += (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        if balanceOf[stor12] + ((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < balanceOf[stor12]:
                                            revert with 0, 'SafeMath: addition overflow'
                                        balanceOf[stor12] += (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        emit Transfer(((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5), 0, sub_6dc651d9Address);
                                        if not sub_117effebAddress:
                                            revert with 0, 'ERC20: mint to the zero address'
                                        if totalSupply + ((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < totalSupply:
                                            revert with 0, 'SafeMath: addition overflow'
                                        totalSupply += (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        if balanceOf[stor13] + ((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < balanceOf[stor13]:
                                            revert with 0, 'SafeMath: addition overflow'
                                        balanceOf[stor13] += (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        emit Transfer(((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5), 0, sub_117effebAddress);
                                        if not sub_ca9ab2eeAddress:
                                            revert with 0, 'ERC20: mint to the zero address'
                                        if totalSupply + ((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < totalSupply:
                                            revert with 0, 'SafeMath: addition overflow'
                                        totalSupply += (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        if balanceOf[stor14] + ((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < balanceOf[stor14]:
                                            revert with 0, 'SafeMath: addition overflow'
                                        balanceOf[stor14] += (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        emit Transfer(((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5), 0, sub_ca9ab2eeAddress);
                                        if not sub_6beec71aAddress:
                                            revert with 0, 'ERC20: mint to the zero address'
                                        if totalSupply + ((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < totalSupply:
                                            revert with 0, 'SafeMath: addition overflow'
                                        totalSupply += (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        if balanceOf[stor15] + ((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < balanceOf[stor15]:
                                            revert with 0, 'SafeMath: addition overflow'
                                        balanceOf[stor15] += (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        emit Transfer(((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5), 0, sub_6beec71aAddress);
                                        if not sub_55a71544Address:
                                            revert with 0, 'ERC20: mint to the zero address'
                                        if totalSupply + ((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < totalSupply:
                                            revert with 0, 'SafeMath: addition overflow'
                                        totalSupply += (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        if balanceOf[stor16] + ((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < balanceOf[stor16]:
                                            revert with 0, 'SafeMath: addition overflow'
                                        balanceOf[stor16] += (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        emit Transfer(((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5), 0, sub_55a71544Address);
                            ...
                            if sub_ca9ab2eeAddress:
                                if sub_6beec71aAddress:
                                    if sub_55a71544Address:
                                        if not sub_6dc651d9Address:
                                            revert with 0, 'ERC20: mint to the zero address'
                                        if totalSupply + ((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < totalSupply:
                                            revert with 0, 'SafeMath: addition overflow'
                                        totalSupply += (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        if balanceOf[stor12] + ((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < balanceOf[stor12]:
                                            revert with 0, 'SafeMath: addition overflow'
                                        balanceOf[stor12] += (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        emit Transfer(((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5), 0, sub_6dc651d9Address);
                                        if not sub_117effebAddress:
                                            revert with 0, 'ERC20: mint to the zero address'
                                        if totalSupply + ((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < totalSupply:
                                            revert with 0, 'SafeMath: addition overflow'
                                        totalSupply += (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        if balanceOf[stor13] + ((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < balanceOf[stor13]:
                                            revert with 0, 'SafeMath: addition overflow'
                                        balanceOf[stor13] += (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        emit Transfer(((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5), 0, sub_117effebAddress);
                                        if not sub_ca9ab2eeAddress:
                                            revert with 0, 'ERC20: mint to the zero address'
                                        if totalSupply + ((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < totalSupply:
                                            revert with 0, 'SafeMath: addition overflow'
                                        totalSupply += (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        if balanceOf[stor14] + ((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < balanceOf[stor14]:
                                            revert with 0, 'SafeMath: addition overflow'
                                        balanceOf[stor14] += (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        emit Transfer(((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5), 0, sub_ca9ab2eeAddress);
                                        if not sub_6beec71aAddress:
                                            revert with 0, 'ERC20: mint to the zero address'
                                        if totalSupply + ((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < totalSupply:
                                            revert with 0, 'SafeMath: addition overflow'
                                        totalSupply += (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        if balanceOf[stor15] + ((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < balanceOf[stor15]:
                                            revert with 0, 'SafeMath: addition overflow'
                                        balanceOf[stor15] += (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        emit Transfer(((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5), 0, sub_6beec71aAddress);
                                        if not sub_55a71544Address:
                                            revert with 0, 'ERC20: mint to the zero address'
                                        if totalSupply + ((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < totalSupply:
                                            revert with 0, 'SafeMath: addition overflow'
                                        totalSupply += (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        if balanceOf[stor16] + ((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5) < balanceOf[stor16]:
                                            revert with 0, 'SafeMath: addition overflow'
                                        balanceOf[stor16] += (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5
                                        emit Transfer(((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 5), 0, sub_55a71544Address);
                                        devFundLastClaimed = block.timestamp
}
