...
function tokenURI(uint256 arg1) payable {
    ...
    if stor7[arg1].length > 0:
        ...
        return Array(len=mem[ceil32(stor7[arg1].length) + 192], data=mem[stor7[arg1].length + ceil32(stor7[arg1].length) + 309 len floor32(mem[ceil32(stor7[arg1].length) + 192]) + 32]), 
    if not ownerOf[arg1]:
        revert with 0, 
                    32,
                    47,
