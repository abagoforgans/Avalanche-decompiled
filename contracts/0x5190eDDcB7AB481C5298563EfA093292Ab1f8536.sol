...
function sub_cf66260d(?) {
    ...
    require arg1 == arg1
    require arg2 == arg2
    require ext_code.size(0x35ab59fe26c0d24fd8db6728045694bb46279191)
    staticcall 0x35ab59fe26c0d24fd8db6728045694bb46279191.0xac8932b5 with:
...
function mintToken(uint256 arg1, uint256 arg2, address arg3) payable {
    ...
    if not arg1:
        require ext_code.size(0x18ee22b3d1ca40364b0f698c0026f5c71d1d885d)
        call 0x18ee22b3d1ca40364b0f698c0026f5c71d1d885d.0x40c10f19 with:
             gas gas_remaining wei
            args address(arg3), arg2
    else:
        require ext_code.size(0x87267cc17d252317cb94a92478f5abdf2341bc75)
        call 0x87267cc17d252317cb94a92478f5abdf2341bc75.0x40c10f19 with:
             gas gas_remaining wei
            args address(arg3), arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_cde99193(?) payable {
    ...
    if msg.sender == address(ext_call.return_data[0]):
        ...
        while idx < ('cd', 4).length:
            ...
            require ext_code.size(0x47a2b264649540fe4f1ea56c53892c471126ec98)
            call 0x47a2b264649540fe4f1ea56c53892c471126ec98.burnItem(uint256 arg1) with:
                 gas gas_remaining wei
                args _42
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
...
function sub_7e794819(?) payable {
    ...
    if msg.sender == address(ext_call.return_data[0]):
        ...
        require ext_code.size(0x18ee22b3d1ca40364b0f698c0026f5c71d1d885d)
        call 0x18ee22b3d1ca40364b0f698c0026f5c71d1d885d.0x9dc29fac with:
             gas gas_remaining wei
        ...
        require ext_code.size(0x87267cc17d252317cb94a92478f5abdf2341bc75)
        call 0x87267cc17d252317cb94a92478f5abdf2341bc75.0x9dc29fac with:
             gas gas_remaining wei
...
function sub_898ac941(?) payable {
    ...
    require ext_code.size(0x18ee22b3d1ca40364b0f698c0026f5c71d1d885d)
    staticcall 0x18ee22b3d1ca40364b0f698c0026f5c71d1d885d.0x70a08231 with:
            gas gas_remaining wei
           args msg.sender
...
function sub_bef77a95(?) {
    ...
    while idx < ('cd', 4).length:
        ...
        mem[_537 + 80] = 0
        require ext_code.size(0x35ab59fe26c0d24fd8db6728045694bb46279191)
        staticcall 0x35ab59fe26c0d24fd8db6728045694bb46279191.mem[mem[64] len 4] with:
                gas gas_remaining wei
...
function sub_2aabff15(?) {
    ...
    while idx < ('cd', 4).length:
        ...
        require ext_code.size(0x1211ea19db5ea8f8ba89ba9182e1d122dfb5947f)
        staticcall 0x1211ea19db5ea8f8ba89ba9182e1d122dfb5947f.0x6352211e with:
                gas gas_remaining wei
               args _968
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
    ...
    while idx < _2389:
        ...
        require ext_code.size(0x1211ea19db5ea8f8ba89ba9182e1d122dfb5947f)
        staticcall 0x1211ea19db5ea8f8ba89ba9182e1d122dfb5947f.0x4994abe1 with:
                gas gas_remaining wei
