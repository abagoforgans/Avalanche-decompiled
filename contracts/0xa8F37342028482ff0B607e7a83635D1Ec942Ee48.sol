...
function test(address arg1, address arg2) payable {
    ...
    if not ext_call.return_data[18 len 14]:
        revert with 'NH{q', 18
    emit 0xdde878be: Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0]) << 144, Mask(112, 0, Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0]))
}
