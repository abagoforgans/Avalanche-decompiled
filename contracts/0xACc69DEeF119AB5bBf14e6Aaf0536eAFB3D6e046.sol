...
function revokeStrategy(address arg1, address arg2) payable {
    ...
    if governanceAddress != msg.sender:
        revert with 0, '!governance'
    if address(strategies[address(arg1)]) == arg2:
...
function getExpectedReturn(address arg1, address arg2, uint256 arg3) payable {
    ...
    _12 = mem[(2 * ceil32(return_data.size)) + 96 len 4], address(arg2) << 64
    require mem[(2 * ceil32(return_data.size)) + 96 len 4], address(arg2) << 64 == mem[(2 * ceil32(return_data.size)) + 96 len 4], address(arg2) << 64
    ...
    _14 = mem[(2 * ceil32(return_data.size)) + 0, address(ext_call.return_data[0]) << 64 + 96]
    require mem[(2 * ceil32(return_data.size)) + 0, address(ext_call.return_data[0]) << 64 + 96] <= test266151307()
    require (4 * ceil32(return_data.size)) + (32 * mem[(2 * ceil32(return_data.size)) + 0, address(ext_call.return_data[0]) << 64 + 96]) + 128 <= test266151307() and (32 * mem[(2 * ceil32(return_data.size)) + 0, address(ext_call.return_data[0]) << 64 + 96]) + 32 >= 0
    mem[64] = (4 * ceil32(return_data.size)) + (32 * mem[(2 * ceil32(return_data.size)) + 0, address(ext_call.return_data[0]) << 64 + 96]) + 128
    mem[(4 * ceil32(return_data.size)) + 96] = _14
    require 0, address(ext_call.return_data[0]) << 64 + (32 * _14) + 32 <= return_data.size
    idx = 0
    s = (2 * ceil32(return_data.size)) + 0, address(ext_call.return_data[0]) << 64 + 128
...
function earn(address arg1, uint256 arg2) payable {
    ...
    if ext_call.return_data[12 len 20] == arg1:
        ...
        mem[ceil32(return_data.size) + 260 len 96] = transfer(address rg1, uint256 rg2), Mask(224, 0, strategies[address(arg1)]), uint32(strategies[address(arg1)]), arg2, 0
        mem[ceil32(return_data.size) + 328] = 0
        call arg1 with:
           funct Mask(32, 224, transfer(address rg1, uint256 rg2), Mask(224, 0, strategies[address(arg1)]), uint32(strategies[address(arg1)]), arg2, 0) >> 224
             gas gas_remaining wei
            args (Mask(512, -288, transfer(address rg1, uint256 rg2), Mask(224, 0, strategies[address(arg1)]), uint32(strategies[address(arg1)]), arg2, 0) << 288)
    ...
    if ext_code.size(arg1) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[ceil32(return_data.size) + 260 len 96] = transfer(address rg1, uint256 rg2), Mask(224, 0, converters[address(arg1)][address(ext_call.return_data[0])]), uint32(converters[address(arg1)][address(ext_call.return_data[0])]), arg2, 0
    mem[ceil32(return_data.size) + 328] = 0
    call arg1 with:
       funct Mask(32, 224, transfer(address rg1, uint256 rg2), Mask(224, 0, converters[address(arg1)][address(ext_call.return_data[0])]), uint32(converters[address(arg1)][address(ext_call.return_data[0])]), arg2, 0) >> 224
         gas gas_remaining wei
        args (Mask(512, -288, transfer(address rg1, uint256 rg2), Mask(224, 0, converters[address(arg1)][address(ext_call.return_data[0])]), uint32(converters[address(arg1)][address(ext_call.return_data[0])]), arg2, 0) << 288)
    if not return_data.size:
        if not ext_call.success:
            if ext_call.return_data[0] > 0:
                revert with memory
        ...
        mem[(2 * ceil32(return_data.size)) + 292 len 4] = transfer(address rg1, uint256 rg2)
    ...
    mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 293 len 4] = transfer(address rg1, uint256 rg2)
