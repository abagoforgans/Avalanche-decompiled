...
function convertDustToEarned() payable {
    ...
    staticcall token0Address.balanceOf(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if token0Address != earnedAddress:
        if ext_call.return_data[0] > 0:
            require ext_code.size(token0Address)
            staticcall token0Address.allowance(address arg1, address arg2) with:
                    gas gas_remaining wei
    ...
    if not return_data.size:
        ...
        if return_data.size <= 0:
            ...
            if not arg2 * sharesTotal:
                ...
                stor1 = 1
                return (0 / wantLockedTotal / 10000)
        ('iszero', ('iszero', ('mul', ('param', 'arg2'), ('stor', ('name', 'sharesTotal', 12)))))
        require arg2 * sharesTotal
        if arg2 * sharesTotal * entranceFeeFactor / arg2 * sharesTotal != entranceFeeFactor:
            revert with 0, 
                        32,
                ...
                if not isAutoComp:
                    ...
                    if arg2 <= ext_call.return_data[0]:
                        if wantLockedTotal >= arg2:
                            ...
                            if ext_code.size(wantAddress) <= 0:
                                revert with 0, 'Address: call to non-contract'
                            mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), Mask(224, 32, arg2) >> 32
                            call wantAddress with:
                               funct uint32(stor8)
                                 gas gas_remaining wei
                            ...
                            if ext_code.size(wantAddress) <= 0:
                                revert with 0, 'Address: call to non-contract'
                            mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), Mask(224, 0, stor11.field_32)
                            mem[516 len 0] = 0
                            call wantAddress with:
                               funct uint32(stor8)
                                 gas gas_remaining wei
                        ...
                        if wantLockedTotal >= ext_call.return_data[0]:
                            ...
                            if ext_code.size(wantAddress) <= 0:
                                revert with 0, 'Address: call to non-contract'
                            mem[452 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), ext_call.return_data[0 len 28]
                            mem[516 len 0] = 0
                            call wantAddress with:
                               funct uint32(stor8)
                                 gas gas_remaining wei
                    ...
                    if not isAutoComp:
                        ...
                        if 0 <= ext_call.return_data[0]:
                            if wantLockedTotal >= 0:
                                ...
                                if ext_code.size(wantAddress) <= 0:
                                    revert with 0, 'Address: call to non-contract'
                                mem[516 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0
                                mem[580 len 0] = 0
                                call wantAddress with:
                                   funct uint32(stor8)
                                     gas gas_remaining wei
                                    args Mask(480, -256, transfer(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0) << 256, mem[580 len 4]
                            else:
                                if wantLockedTotal > wantLockedTotal:
                                    revert with 0, 'SafeMath: subtraction overflow'
                                wantLockedTotal = 0
                                ...
                                if ext_code.size(wantAddress) <= 0:
                                    revert with 0, 'Address: call to non-contract'
                                mem[516 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), Mask(224, 0, stor11.field_32)
                                mem[580 len 0] = 0
                                call wantAddress with:
                                   funct uint32(stor8)
                                     gas gas_remaining wei
                            ...
                            if wantLockedTotal < ext_call.return_data[0]:
                                ...
                                if ext_code.size(wantAddress) <= 0:
                                    revert with 0, 'Address: call to non-contract'
                                mem[516 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), ext_call.return_data[0 len 28]
                                mem[580 len 0] = 0
                                call wantAddress with:
                                   funct uint32(stor8)
                                     gas gas_remaining wei
                    ...
                    if not isAutoComp:
                        ...
                        if arg2 * withdrawFeeFactor / 10000 <= ext_call.return_data[0]:
                            if wantLockedTotal >= arg2 * withdrawFeeFactor / 10000:
                                ...
                                if ext_code.size(wantAddress) <= 0:
                                    revert with 0, 'Address: call to non-contract'
                                mem[516 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), Mask(224, 32, arg2 * withdrawFeeFactor / 10000) >> 32
                                call wantAddress with:
                                   funct uint32(stor8)
                                     gas gas_remaining wei
