...
function getReserves(address[] arg1) {
        ...
        while idx < arg1.length:
            ...
            if ext_call.success:
                ...
                if 2 * idx >= mem[floor32(arg1.length) + 97]:
                    revert with 'NH{q', 50
                mem[(64 * idx) + floor32(arg1.length) + 129] = mem[_78 + 18 len 14]
                if idx and 2 > -1 / idx:
                    revert with 'NH{q', 17
                if 2 * idx > -2:
                    revert with 'NH{q', 17
                if (2 * idx) + 1 >= mem[floor32(arg1.length) + 97]:
                    revert with 'NH{q', 50
                mem[(32 * (2 * idx) + 1) + floor32(arg1.length) + 129] = Mask(112, 0, _87)
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
            continue 
        mem[mem[64]] = 32
        _80 = mem[floor32(arg1.length) + 97]
        mem[mem[64] + 32] = mem[floor32(arg1.length) + 97]
        mem[mem[64] + 64 len 32 * _80] = mem[floor32(arg1.length) + 129 len 32 * _80]
    ...
    while idx < arg1.length:
        ...
        if ext_call.success:
            ...
            if 2 * idx >= mem[floor32(arg1.length) + 97]:
                revert with 'NH{q', 50
            mem[(64 * idx) + floor32(arg1.length) + 129] = mem[_79 + 18 len 14]
            if idx and 2 > -1 / idx:
                revert with 'NH{q', 17
            if 2 * idx > -2:
                revert with 'NH{q', 17
            if (2 * idx) + 1 >= mem[floor32(arg1.length) + 97]:
                revert with 'NH{q', 50
            mem[(32 * (2 * idx) + 1) + floor32(arg1.length) + 129] = Mask(112, 0, _89)
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
    mem[mem[64]] = 32
    _81 = mem[floor32(arg1.length) + 97]
    mem[mem[64] + 32] = mem[floor32(arg1.length) + 97]
    mem[mem[64] + 64 len 32 * _81] = mem[floor32(arg1.length) + 129 len 32 * _81]
...
function sub_bf081e60(?) payable {
    ...
    while idx < ('cd', 68).length:
        ...
        staticcall address(_100).getAmountsOut(uint256 arg1, address[] arg2) with:
                gas gas_remaining wei
               args _272, 64, mem[mem[64] + 68 len (32 * _280) + 32]
        if not ext_call.success:
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
