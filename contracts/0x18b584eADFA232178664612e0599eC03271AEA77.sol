                        ...
                        if block.timestamp < sub_6e271dd5:
                            if block.timestamp <= poolStartTime:
                                ...
                                if poolInfo[idx].field_512 > poolStartTime:
                                    if block.timestamp < poolInfo[idx].field_512:
                                        revert with 'NH{q', 17
                                    if block.timestamp - poolInfo[idx].field_512 and sub_b7e3170d > -1 / block.timestamp - poolInfo[idx].field_512:
                                        revert with 'NH{q', 17
                                    if (block.timestamp * sub_b7e3170d) - (poolInfo[idx].field_512 * sub_b7e3170d) and poolInfo[idx].field_256 > -1 / (block.timestamp * sub_b7e3170d) - (poolInfo[idx].field_512 * sub_b7e3170d):
                                        revert with 'NH{q', 17
                                    if not totalAllocPoint:
                                        revert with 'NH{q', 18
                                    if (block.timestamp * sub_b7e3170d * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint and 10^18 > -1 / (block.timestamp * sub_b7e3170d * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint:
                                        revert with 'NH{q', 17
                                    if not mem[_9]:
                                        revert with 'NH{q', 18
                                    if poolInfo[idx].field_768 > -(10^18 * (block.timestamp * sub_b7e3170d * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_9]) - 1:
                                        revert with 'NH{q', 17
                                    poolInfo[idx].field_768 += 10^18 * (block.timestamp * sub_b7e3170d * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_9]
                                else:
                                    if block.timestamp < poolStartTime:
                                        revert with 'NH{q', 17
                                    if block.timestamp - poolStartTime and sub_b7e3170d > -1 / block.timestamp - poolStartTime:
                                        revert with 'NH{q', 17
                                    if (block.timestamp * sub_b7e3170d) - (poolStartTime * sub_b7e3170d) and poolInfo[idx].field_256 > -1 / (block.timestamp * sub_b7e3170d) - (poolStartTime * sub_b7e3170d):
                                        revert with 'NH{q', 17
                                    if not totalAllocPoint:
                                        revert with 'NH{q', 18
                                    if (block.timestamp * sub_b7e3170d * poolInfo[idx].field_256) - (poolStartTime * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint and 10^18 > -1 / (block.timestamp * sub_b7e3170d * poolInfo[idx].field_256) - (poolStartTime * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint:
                                        revert with 'NH{q', 17
                                    if not mem[_9]:
                                        revert with 'NH{q', 18
                                    if poolInfo[idx].field_768 > -(10^18 * (block.timestamp * sub_b7e3170d * poolInfo[idx].field_256) - (poolStartTime * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_9]) - 1:
                                        revert with 'NH{q', 17
                                    poolInfo[idx].field_768 += 10^18 * (block.timestamp * sub_b7e3170d * poolInfo[idx].field_256) - (poolStartTime * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_9]
                        else:
                            if poolInfo[idx].field_512 >= sub_6e271dd5:
                                ...
                                if poolInfo[idx].field_512 > poolStartTime:
                                    if sub_6e271dd5 < poolInfo[idx].field_512:
                                        revert with 'NH{q', 17
                                    if sub_6e271dd5 - poolInfo[idx].field_512 and sub_b7e3170d > -1 / sub_6e271dd5 - poolInfo[idx].field_512:
                                        revert with 'NH{q', 17
                                    if (sub_6e271dd5 * sub_b7e3170d) - (poolInfo[idx].field_512 * sub_b7e3170d) and poolInfo[idx].field_256 > -1 / (sub_6e271dd5 * sub_b7e3170d) - (poolInfo[idx].field_512 * sub_b7e3170d):
                                        revert with 'NH{q', 17
                                    if not totalAllocPoint:
                                        revert with 'NH{q', 18
                                    if (sub_6e271dd5 * sub_b7e3170d * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint and 10^18 > -1 / (sub_6e271dd5 * sub_b7e3170d * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint:
                                        revert with 'NH{q', 17
                                    if not mem[_9]:
                                        revert with 'NH{q', 18
                                    if poolInfo[idx].field_768 > -(10^18 * (sub_6e271dd5 * sub_b7e3170d * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_9]) - 1:
                                        revert with 'NH{q', 17
                                    poolInfo[idx].field_768 += 10^18 * (sub_6e271dd5 * sub_b7e3170d * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_9]
                                else:
                                    if sub_6e271dd5 < poolStartTime:
                                        revert with 'NH{q', 17
                                    if sub_6e271dd5 - poolStartTime and sub_b7e3170d > -1 / sub_6e271dd5 - poolStartTime:
                                        revert with 'NH{q', 17
                                    if (sub_6e271dd5 * sub_b7e3170d) - (poolStartTime * sub_b7e3170d) and poolInfo[idx].field_256 > -1 / (sub_6e271dd5 * sub_b7e3170d) - (poolStartTime * sub_b7e3170d):
                                        revert with 'NH{q', 17
                                    if not totalAllocPoint:
                                        revert with 'NH{q', 18
                                    if (sub_6e271dd5 * sub_b7e3170d * poolInfo[idx].field_256) - (poolStartTime * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint and 10^18 > -1 / (sub_6e271dd5 * sub_b7e3170d * poolInfo[idx].field_256) - (poolStartTime * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint:
                                        revert with 'NH{q', 17
                                    if not mem[_9]:
                                        revert with 'NH{q', 18
                                    if poolInfo[idx].field_768 > -(10^18 * (sub_6e271dd5 * sub_b7e3170d * poolInfo[idx].field_256) - (poolStartTime * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_9]) - 1:
                                        revert with 'NH{q', 17
                                    poolInfo[idx].field_768 += 10^18 * (sub_6e271dd5 * sub_b7e3170d * poolInfo[idx].field_256) - (poolStartTime * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_9]
                        ...
                        if block.timestamp < sub_6e271dd5:
                            if block.timestamp <= poolStartTime:
                                ...
                                if poolInfo[idx].field_512 > poolStartTime:
                                    ...
                                    if not mem[_13]:
                                        revert with 'NH{q', 18
                                    if poolInfo[idx].field_768 > -(10^18 * (block.timestamp * sub_b7e3170d * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_13]) - 1:
                                        revert with 'NH{q', 17
                                    poolInfo[idx].field_768 += 10^18 * (block.timestamp * sub_b7e3170d * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_13]
                                else:
                                    if block.timestamp < poolStartTime:
                                        revert with 'NH{q', 17
                                    if block.timestamp - poolStartTime and sub_b7e3170d > -1 / block.timestamp - poolStartTime:
                                    ...
                                    if not mem[_13]:
                                        revert with 'NH{q', 18
                                    if poolInfo[idx].field_768 > -(10^18 * (block.timestamp * sub_b7e3170d * poolInfo[idx].field_256) - (poolStartTime * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_13]) - 1:
                                        revert with 'NH{q', 17
                                    poolInfo[idx].field_768 += 10^18 * (block.timestamp * sub_b7e3170d * poolInfo[idx].field_256) - (poolStartTime * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_13]
                        else:
                            if poolInfo[idx].field_512 >= sub_6e271dd5:
                                if False and poolInfo[idx].field_256 > 0:
                                    revert with 'NH{q', 17
                                ...
                                if poolInfo[idx].field_512 > poolStartTime:
                                    ...
                                    if not mem[_13]:
                                        revert with 'NH{q', 18
                                    if poolInfo[idx].field_768 > -(10^18 * (sub_6e271dd5 * sub_b7e3170d * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_13]) - 1:
                                        revert with 'NH{q', 17
                                    poolInfo[idx].field_768 += 10^18 * (sub_6e271dd5 * sub_b7e3170d * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_13]
                                else:
                                    if sub_6e271dd5 < poolStartTime:
                                        revert with 'NH{q', 17
                                    if sub_6e271dd5 - poolStartTime and sub_b7e3170d > -1 / sub_6e271dd5 - poolStartTime:
                                    ...
                                    if not mem[_13]:
                                        revert with 'NH{q', 18
                                    if poolInfo[idx].field_768 > -(10^18 * (sub_6e271dd5 * sub_b7e3170d * poolInfo[idx].field_256) - (poolStartTime * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_13]) - 1:
                                        revert with 'NH{q', 17
                                    poolInfo[idx].field_768 += 10^18 * (sub_6e271dd5 * sub_b7e3170d * poolInfo[idx].field_256) - (poolStartTime * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_13]
            poolInfo[idx].field_512 = block.timestamp
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
...
function add(uint256 arg1, address arg2, bool arg3, uint256 arg4) payable {
    ...
    while idx < poolInfo.length:
        ...
        if poolInfo[idx].field_0 == arg2:
            revert with 0, 'CreamGenesisPool: existing pool?'
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
                            ...
                            if block.timestamp < sub_6e271dd5:
                                if block.timestamp <= poolStartTime:
                                    ...
                                    if poolInfo[idx].field_512 > poolStartTime:
                                        ...
                                        if not mem[_442]:
                                            revert with 'NH{q', 18
                                        if poolInfo[idx].field_768 > -(10^18 * (block.timestamp * sub_b7e3170d * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_442]) - 1:
                                            revert with 'NH{q', 17
                                        poolInfo[idx].field_768 += 10^18 * (block.timestamp * sub_b7e3170d * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_442]
                                    else:
                                        if block.timestamp < poolStartTime:
                                            revert with 'NH{q', 17
                                        if block.timestamp - poolStartTime and sub_b7e3170d > -1 / block.timestamp - poolStartTime:
                                        ...
                                        if not mem[_442]:
                                            revert with 'NH{q', 18
                                        if poolInfo[idx].field_768 > -(10^18 * (block.timestamp * sub_b7e3170d * poolInfo[idx].field_256) - (poolStartTime * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_442]) - 1:
                                            revert with 'NH{q', 17
                                        poolInfo[idx].field_768 += 10^18 * (block.timestamp * sub_b7e3170d * poolInfo[idx].field_256) - (poolStartTime * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_442]
                            else:
                                if poolInfo[idx].field_512 >= sub_6e271dd5:
                                    if False and poolInfo[idx].field_256 > 0:
                                        revert with 'NH{q', 17
                                    ...
                                    if poolInfo[idx].field_512 > poolStartTime:
                                        ...
                                        if not mem[_442]:
                                            revert with 'NH{q', 18
                                        if poolInfo[idx].field_768 > -(10^18 * (sub_6e271dd5 * sub_b7e3170d * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_442]) - 1:
                                            revert with 'NH{q', 17
                                        poolInfo[idx].field_768 += 10^18 * (sub_6e271dd5 * sub_b7e3170d * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_442]
                                    else:
                                        if sub_6e271dd5 < poolStartTime:
                                            revert with 'NH{q', 17
                                        if sub_6e271dd5 - poolStartTime and sub_b7e3170d > -1 / sub_6e271dd5 - poolStartTime:
                                        ...
                                        if not mem[_442]:
                                            revert with 'NH{q', 18
                                        if poolInfo[idx].field_768 > -(10^18 * (sub_6e271dd5 * sub_b7e3170d * poolInfo[idx].field_256) - (poolStartTime * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_442]) - 1:
                                            revert with 'NH{q', 17
                                        poolInfo[idx].field_768 += 10^18 * (sub_6e271dd5 * sub_b7e3170d * poolInfo[idx].field_256) - (poolStartTime * sub_b7e3170d * poolInfo[idx].field_256) / totalAllocPoint / mem[_442]
                poolInfo[idx].field_512 = block.timestamp
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
