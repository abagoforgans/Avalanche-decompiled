    ...
    if not arg1.length:
        ...
        while idx < arg1.length:
            ...
            while s >= 32:
                ...
                s = s - 32
                continue 
            mem[mem[64] + floor32(mem[_486])] = mem[_486 + floor32(mem[_486]) + -(mem[_486] % 32) + 64 len mem[_486] % 32] or Mask(8 * -(mem[_486] % 32) + 32, -(8 * -(mem[_486] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_486])])
            staticcall address(cd[((32 * idx) + arg1 + 36)]).mem[mem[64] len 4] with:
                    gas gas_remaining wei
                   args mem[mem[64] + 4 len _489 + _486 + -mem[64] + 32]
            if return_data.size:
                _966 = mem[64]
                mem[64] = mem[64] + ceil32(return_data.size) + 1
                mem[_966] = return_data.size
                mem[_966 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
