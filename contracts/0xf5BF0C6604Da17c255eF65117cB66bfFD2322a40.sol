...
const getName = 'StrategyJoeFraxgOhm'
...
uint256 poolId;
uint256 sub_07328a34;
address sub_d0ae6fecAddress;
...
function sub_d0ae6fec(?) {
    return sub_d0ae6fecAddress
}
...
function deposit() {
    ...
    if ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            require ext_code.size(0x188bed1968b795d5c9022f6a0bb5931ac4c18f00)
            call 0x188bed1968b795d5c9022f6a0bb5931ac4c18f00.0xe2bbb158 with:
                 gas gas_remaining wei
                args poolId, ext_call.return_data[0]
        else:
            mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
