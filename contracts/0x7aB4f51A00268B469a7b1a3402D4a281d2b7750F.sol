    ...
    if not arg4:
        ...
        if block.number > startBlock:
            ...
            call address(_15).approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args uniRouterAddress, 0x184f03e93ff9f4daa797ed6e38ed64bf6a1f010000000000000000
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            ...
            call address(_15).approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args sub_71663c8aAddress, 0x184f03e93ff9f4daa797ed6e38ed64bf6a1f010000000000000000
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require ext_code.size(address(_19))
        ...
        if block.number > startBlock:
            ...
            if address(ext_call.return_data[0]) != address(_734):
                ...
                mem[mem[64] + 36] = 0x184f03e93ff9f4daa797ed6e38ed64bf6a1f010000000000000000
                require ext_code.size(arg2)
                call arg2.approve(address arg1, uint256 arg2) with:
                     gas gas_remaining wei
                    args sub_71663c8aAddress, 0x184f03e93ff9f4daa797ed6e38ed64bf6a1f010000000000000000
