...
const name = 'Avaware NFT Marketplace', 0
...
function sub_4d292d57(?) payable {
    ...
    if feePercent <= 0:
        if arg1 >= listings.length:
            revert with 'NH{q', 50
        if listings[arg1].field_1536 and 1 > -1 / listings[arg1].field_1536:
            revert with 'NH{q', 17
        if arg1 >= listings.length:
            revert with 'NH{q', 50
        ...
        if listings[arg1].field_1536 and 1 > -1 / listings[arg1].field_1536:
            revert with 'NH{q', 17
        if listings[arg1].field_1536 and -feePercent + 100 > -1 / listings[arg1].field_1536:
            revert with 'NH{q', 17
        if arg1 >= listings.length:
            revert with 'NH{q', 50
        if not listings[arg1].field_1280:
...
function sub_094dabd4(?) payable {
    ...
    if feePercent <= 0:
        ...
        if listings[arg1].field_1536 and arg2 > -1 / listings[arg1].field_1536:
            revert with 'NH{q', 17
        if listings[arg1].field_1536 * arg2 and -feePercent + 100 > -1 / listings[arg1].field_1536 * arg2:
            revert with 'NH{q', 17
        if arg1 >= listings.length:
            revert with 'NH{q', 50
        if not listings[arg1].field_1280:
