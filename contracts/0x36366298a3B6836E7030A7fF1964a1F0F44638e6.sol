...
const name = 'TestPendle', 0

const decimals = 18

const isPendleToken = 1

const symbol = 'TESTPENDLE', 0
...
uint8 pendingIsBurningAllowed; offset 160
...
function pendingIsBurningAllowed() payable {
    return bool(pendingIsBurningAllowed)
}
...
function applyConfigChanges() payable {
    ...
    Mask(96, 0, stor6.field_160) = Mask(96, 0, bool(pendingIsBurningAllowed))
    Mask(88, 0, stor6.field_168) = 0
    configChangesInitiated = 0
    emit ConfigsChanged(pendingEmissionRateMultiplierNumerator, pendingTerminalInflationRateNumerator, pendingLiquidityIncentivesRecipientAddress, bool(0 or uint8(bool(pendingIsBurningAllowed))));
}
...
function delegateBySig(address arg1, uint256 arg2, uint256 arg3, uint8 arg4, bytes32 arg5, bytes32 arg6) payable {
    ...
    require arg1 == arg1
    require arg4 == arg4
    signer = erecover(sha3(0, sha3(0x8cad95687ba82c2ce50e74f7b754645e5117c3a5bec8151c0726d5857980a866, 0xe2e6d948f9c96cb36d86ae1bef6d1d49fe7bdea5f2ec4afa832370e972d1af3e, chainid, this.address), sha3(0xe48329057bfd03d55e49b547132e39cffd9c1820ad7b9d4c5307691425d15adf, address(arg1), arg2, arg3)), arg4 << 248, arg5, arg6) 
