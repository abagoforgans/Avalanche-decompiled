...
function incentivize(address arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    mem[228 len 96] = transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(stor57), Mask(224, 32, arg2) >> 32
...
function sub_f1b3f4d7(?) {
    ...
    mem[228 len 96] = transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(stor55), Mask(224, 32, arg2) >> 32
    mem[352 len 4] = uint32(arg2)
...
function depositETH(address arg1) payable {
    ...
    call address(WETHAddress).mem[ceil32(return_data.size) + 160 len 4] with:
         gas gas_remaining wei
        args Mask(224, 32, msg.value) << 224, mem[ceil32(return_data.size) + 260 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with 0, 
                        32,
...
function sub_9d200c3f(?) {
    ...
    mem[ceil32(return_data.size) + 228 len 96] = transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, ext_call.return_data[12 len 20], Mask(224, 32, arg2) >> 32
...
function withdrawETH(uint256 arg1, address arg2) {
    ...
    if arg1 != -1:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(address(WETHAddress))
        staticcall address(WETHAddress).balanceOf(address rg1) with:
                gas gas_remaining wei
               args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    ...
    if not arg17:
        ...
        if not arg17:
            ...
            if not address(arg6):
                ...
                require arg17 == bool(arg17)
                if not arg17:
                    mem[ceil32(return_data.size) + 292 len 96] = transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(ext_call.return_data[0]), Mask(224, 32, arg2) >> 32
                    ...
                    return memory
                      from (2 * ceil32(return_data.size)) + ceil32(return_data.size) + 293
                       len ceil32(return_data.size) + 32
                mem[ceil32(return_data.size) + 260 len 64] = transfer(address rg1, uint256 rg2), address(ext_call.return_data[0]) << 64, 0, Mask(224, 32, arg2) >> 32
                mem[ceil32(return_data.size) + 352 len 4] = uint32(arg2)
                call address(arg5) with:
                     gas gas_remaining wei
            ...
            if not address(arg6):
                if arg1:
                    ...
                    require arg17 == bool(arg17)
                    if arg17:
                        mem[ceil32(return_data.size) + 260 len 64] = transfer(address rg1, uint256 rg2), address(ext_call.return_data[0]) << 64, 0, Mask(224, 32, msg.value) >> 32
                        ...
                        require return_data.size >= 32
                        return ext_call.return_data[0]
                    mem[ceil32(return_data.size) + 292 len 96] = transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(ext_call.return_data[0]), Mask(224, 32, msg.value) >> 32
