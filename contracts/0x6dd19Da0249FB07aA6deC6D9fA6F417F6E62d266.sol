...
function estimatedTotalAssets() payable {
    ...
    staticcall gaugeAddress.0x93f1a40b with:
            gas gas_remaining wei
           args uint16(stor16.field_160) - 1 << 240, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function isActive() payable {
    require ext_code.size(address(vaultAddress))
    staticcall address(vaultAddress).0x39ebf823 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function priceCheck(address arg1, address arg2, uint256 arg3) payable {
    ...
    if stor14 == arg2:
        ...
        if stor14 == arg2:
            ...
            if _88 - 1 < _88:
                return memory
                  from (32 * _88 - 1) + ceil32(return_data.size) + 224
                   len 32
    else:
        ...
        if stor14 == arg2:
            ...
            if _90 - 1 < _90:
                return memory
                  from (32 * _90 - 1) + ceil32(return_data.size) + 256
                   len 32
        else:
            mem[192] = arg2
            mem[224] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
            ...
            if _89 - 1 < _89:
                return memory
                  from (32 * _89 - 1) + ceil32(return_data.size) + 256
                   len 32
    revert
}
...
function harvester() payable {
    mem[132] = 0
    require ext_code.size(gaugeAddress)
    call gaugeAddress.0xe2bbb158 with:
         gas gas_remaining wei
...
function harvestTrigger(uint256 arg1) payable {
    ...
    if stor14 == wantAddress:
        ...
        if stor14 == wantAddress:
            ...
            mem[mem[64] + 4] = address(vaultAddress)
            mem[mem[64] + 36] = this.address
            mem[mem[64] + 68] = mem[(32 * _114 - 1) + ceil32(return_data.size) + 256]
            mem[mem[64] + 100] = minReportDelay
            mem[mem[64] + 132] = maxReportDelay
            mem[mem[64] + 164] = debtThreshold
            mem[mem[64] + 196] = profitFactor
            ...
            delegate 0x89eccc61b2d35eacce08284cf22c2d6487b80a3a.0x4937cba9 with:
                 gas gas_remaining wei
                args address(vaultAddress), address(this.address), mem[(32 * _114 - 1) + ceil32(return_data.size) + 256], minReportDelay, maxReportDelay, debtThreshold, profitFactor
            mem[mem[64]] = delegate.return_data[0]
            if not delegate.return_code:
                revert with ext_call.return_data[0 len return_data.size]
            _186 = mem[64]
            ...
            mem[mem[64] + 4] = address(vaultAddress)
            mem[mem[64] + 36] = this.address
            mem[mem[64] + 68] = mem[(32 * _113 - 1) + ceil32(return_data.size) + 256]
            mem[mem[64] + 100] = minReportDelay
            mem[mem[64] + 132] = maxReportDelay
            mem[mem[64] + 164] = debtThreshold
            mem[mem[64] + 196] = profitFactor
            ...
            delegate 0x89eccc61b2d35eacce08284cf22c2d6487b80a3a.0x4937cba9 with:
                 gas gas_remaining wei
                args address(vaultAddress), address(this.address), mem[(32 * _113 - 1) + ceil32(return_data.size) + 256], minReportDelay, maxReportDelay, debtThreshold, profitFactor
            mem[mem[64]] = delegate.return_data[0]
            if not delegate.return_code:
                revert with ext_call.return_data[0 len return_data.size]
            _185 = mem[64]
                ...
                if 0 >= stor17:
                    ...
                    if ext_call.return_data[0]:
                        ...
                        if 1 > 0 / ext_call.return_data[0]:
                            revert with 0, 'SafeMath: subtraction overflow', 0
                        require ext_code.size(gaugeAddress)
                        call gaugeAddress.0x441a3e70 with:
                             gas gas_remaining wei
                            args uint16(stor16.field_160) - 1 << 240, (0 / ext_call.return_data[0]) - 1
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require ext_code.size(poolAddress)
                        staticcall poolAddress.0x70a08231 with:
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] < 0:
        revert with 0, 'SafeMath: addition overflow'
    if arg1 <= 3 * ext_call.return_data[0]:
        if not arg1:
            ...
            if not ext_code.hash(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(8 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0], 0
            ...
            if arg1 < stor17:
                ...
                if not ext_call.return_data[0]:
                    ...
                    mem[(10 * ceil32(return_data.size)) + 100] = 10^6
                    require ext_code.size(poolAddress)
                    staticcall poolAddress.0xf6cd35ee with:
                            gas gas_remaining wei
                           args 10^6
                    ...
                    require return_data.size >= 32
                    if not arg1:
                        mem[(11 * ceil32(return_data.size)) + 96] = 26
                        mem[(11 * ceil32(return_data.size)) + 128] = 'SafeMath: division by zero'
                        if not ext_call.return_data[0]:
                            revert with 0, 'SafeMath: division by zero', 0
                        mem[(11 * ceil32(return_data.size)) + 160] = 30
                        mem[(11 * ceil32(return_data.size)) + 192] = 'SafeMath: subtraction overflow'
                        if 1 > 0 / ext_call.return_data[0]:
                            revert with 0, 'SafeMath: subtraction overflow', 0
                        mem[(11 * ceil32(return_data.size)) + 260] = (0 / ext_call.return_data[0]) - 1
                        require ext_code.size(gaugeAddress)
                        call gaugeAddress.0x441a3e70 with:
                             gas gas_remaining wei
                            args uint16(stor16.field_160) - 1 << 240, (0 / ext_call.return_data[0]) - 1
                        ...
                        mem[(11 * ceil32(return_data.size)) + 160] = 30
                        mem[(11 * ceil32(return_data.size)) + 192] = 'SafeMath: subtraction overflow'
                        if 1 > 10^6 * arg1 / ext_call.return_data[0]:
                            revert with 0, 'SafeMath: subtraction overflow', 0
                        mem[(11 * ceil32(return_data.size)) + 260] = (10^6 * arg1 / ext_call.return_data[0]) - 1
                        require ext_code.size(gaugeAddress)
                        call gaugeAddress.0x441a3e70 with:
                             gas gas_remaining wei
                            args uint16(stor16.field_160) - 1 << 240, (10^6 * arg1 / ext_call.return_data[0]) - 1
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[(12 * ceil32(return_data.size)) + 228] = sub_e956dcd7Address
                    ...
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    mem[(13 * ceil32(return_data.size)) + 228] = uint16(stor16.field_160)
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[(15 * ceil32(return_data.size)) + 260] = msg.sender
                    mem[(15 * ceil32(return_data.size)) + 292] = ext_call.return_data[0]
                    mem[(15 * ceil32(return_data.size)) + 224] = 68
                    mem[(15 * ceil32(return_data.size)) + 260 len 28] = Mask(224, 32, msg.sender) >> 32
                    mem[(15 * ceil32(return_data.size)) + 256 len 4] = unknown_0xa9059cbb(?????)
                    mem[(15 * ceil32(return_data.size)) + 324] = 32
                    mem[(15 * ceil32(return_data.size)) + 356] = 'SafeERC20: low-level call failed'
                    if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(15 * ceil32(return_data.size)) + 388 len 96] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0], 0
                    mem[(15 * ceil32(return_data.size)) + 456] = 0
                    call wantAddress with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0], 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0], 0) << 288)
                    if not return_data.size:
                        ...
                        mem[(15 * ceil32(return_data.size)) + 420 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        if not ext_call.success:
                            if return_data.size:
                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 0, 'SafeERC20: low-level call failed'
                        if return_data.size:
                            require return_data.size >= 32
                            require mem[(15 * ceil32(return_data.size)) + 420] == bool(mem[(15 * ceil32(return_data.size)) + 420])
                            if not mem[(15 * ceil32(return_data.size)) + 420]:
                                revert with 0, 'SafeERC20: ERC20 operation did not succeed'
        return 0
    mem[(7 * ceil32(return_data.size)) + 96] = 30
    mem[(7 * ceil32(return_data.size)) + 128] = 'SafeMath: subtraction overflow'
    if 3 * ext_call.return_data[0] > arg1:
        revert with 0, 'SafeMath: subtraction overflow', 0
    if not arg1:
        ...
        if not ext_code.hash(wantAddress):
            revert with 0, 'Address: call to non-contract'
        mem[(8 * ceil32(return_data.size)) + 324 len 96] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0], 0
        ...
        if arg1 < stor17:
            ...
            staticcall gaugeAddress.0x93f1a40b with:
                    gas gas_remaining wei
                   args uint16(stor16.field_160) - 1 << 240, this.address
            mem[(7 * ceil32(return_data.size)) + 160 len 64] = ext_call.return_data[0 len 64]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 64
            mem[(8 * ceil32(return_data.size)) + 164] = ext_call.return_data[0]
            ...
            if not ext_call.return_data[0]:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[(11 * ceil32(return_data.size)) + 196] = msg.sender
                mem[(11 * ceil32(return_data.size)) + 228] = ext_call.return_data[0]
                mem[(11 * ceil32(return_data.size)) + 160] = 68
                mem[(11 * ceil32(return_data.size)) + 196 len 28] = Mask(224, 32, msg.sender) >> 32
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(11 * ceil32(return_data.size)) + 324 len 96] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0], 0
                ...
                mem[(10 * ceil32(return_data.size)) + 164] = 10^6
                require ext_code.size(poolAddress)
                staticcall poolAddress.0xf6cd35ee with:
                        gas gas_remaining wei
                       args 10^6
                ...
                if not arg1:
                    ...
                    if not ext_call.return_data[0]:
                        revert with 0, 'SafeMath: division by zero', 0
                    mem[(11 * ceil32(return_data.size)) + 224] = 30
                    mem[(11 * ceil32(return_data.size)) + 256] = 'SafeMath: subtraction overflow'
                    if 1 > 0 / ext_call.return_data[0]:
                        revert with 0, 'SafeMath: subtraction overflow', 0
                    mem[(11 * ceil32(return_data.size)) + 324] = (0 / ext_call.return_data[0]) - 1
                    require ext_code.size(gaugeAddress)
                    call gaugeAddress.0x441a3e70 with:
                         gas gas_remaining wei
                        args uint16(stor16.field_160) - 1 << 240, (0 / ext_call.return_data[0]) - 1
                    ...
                    if 1 > 10^6 * arg1 / ext_call.return_data[0]:
                        revert with 0, 'SafeMath: subtraction overflow', 0
                    mem[(11 * ceil32(return_data.size)) + 324] = (10^6 * arg1 / ext_call.return_data[0]) - 1
                    require ext_code.size(gaugeAddress)
                    call gaugeAddress.0x441a3e70 with:
                         gas gas_remaining wei
                        args uint16(stor16.field_160) - 1 << 240, (10^6 * arg1 / ext_call.return_data[0]) - 1
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[(12 * ceil32(return_data.size)) + 292] = sub_e956dcd7Address
                mem[(12 * ceil32(return_data.size)) + 324] = ext_call.return_data[0]
                require ext_code.size(poolAddress)
                call poolAddress.approve(address arg1, uint256 arg2) with:
                     gas gas_remaining wei
                    args sub_e956dcd7Address, ext_call.return_data[0]
                mem[(12 * ceil32(return_data.size)) + 288] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                mem[(13 * ceil32(return_data.size)) + 292] = uint16(stor16.field_160)
                mem[(13 * ceil32(return_data.size)) + 324] = ext_call.return_data[0]
                mem[(13 * ceil32(return_data.size)) + 356] = this.address
                require ext_code.size(sub_e956dcd7Address)
                call sub_e956dcd7Address.0xc4de93a5 with:
                     gas gas_remaining wei
                    args uint16(stor16.field_0), ext_call.return_data[0], this.address
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[(15 * ceil32(return_data.size)) + 324] = msg.sender
                mem[(15 * ceil32(return_data.size)) + 356] = ext_call.return_data[0]
                mem[(15 * ceil32(return_data.size)) + 288] = 68
                mem[(15 * ceil32(return_data.size)) + 324 len 28] = Mask(224, 32, msg.sender) >> 32
                mem[(15 * ceil32(return_data.size)) + 320 len 4] = unknown_0xa9059cbb(?????)
                mem[(15 * ceil32(return_data.size)) + 388] = 32
                mem[(15 * ceil32(return_data.size)) + 420] = 'SafeERC20: low-level call failed'
                if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(15 * ceil32(return_data.size)) + 452 len 96] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0], 0
                mem[(15 * ceil32(return_data.size)) + 520] = 0
                call wantAddress with:
                   funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0], 0) >> 224
                     gas gas_remaining wei
                    args (Mask(512, -288, unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0], 0) << 288)
                if not return_data.size:
                    ...
                    if return_data.size:
                        require return_data.size >= 32
                        require mem[(15 * ceil32(return_data.size)) + 484] == bool(mem[(15 * ceil32(return_data.size)) + 484])
                        if not mem[(15 * ceil32(return_data.size)) + 484]:
                            revert with 0, 'SafeERC20: ERC20 operation did not succeed'
    return (arg1 - (3 * ext_call.return_data[0]))
}
