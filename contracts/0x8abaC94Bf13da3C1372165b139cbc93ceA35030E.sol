...
function factory2() payable {
    return factory2Address
}
...
function sub_25181bb0(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        _54 = mem[(32 * idx) + 128]
        mem[mem[64] + 4] = mem[(32 * idx) + 140 len 20]
        require ext_code.size(factory2Address)
        staticcall factory2Address.0xc2a8a3cc with:
                gas gas_remaining wei
               args address(_54)
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
        ...
        if not mem[_57]:
            ...
            mem[mem[64]] = 68
            mem[64] = mem[64] + 100
            mem[_68 + 32] = mem[_68 + 36 len 28] or 0x1feed31f00000000000000000000000000000000000000000000000000000000
            mem[_66 + 100] = 0x3f579f4200000000000000000000000000000000000000000000000000000000
            mem[_66 + 104] = address(cd[36])
            mem[_66 + 136] = 0
            mem[_66 + 168] = 96
            _73 = mem[_68]
            mem[_66 + 200] = mem[_68]
            s = 0
            while s < _73:
                mem[_66 + s + 232] = mem[_68 + s + 32]
                s = s + 32
                continue 
            if ceil32(_73) > _73:
                mem[_66 + _73 + 232] = 0
            require ext_code.size(address(_63))
            call address(_63).0x3f579f42 with:
                 gas gas_remaining wei
                args address(cd[36]), 0, 96, mem[_66 + 200 len ceil32(_73) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        if idx == -1:
            revert with 'NH{q', 17
