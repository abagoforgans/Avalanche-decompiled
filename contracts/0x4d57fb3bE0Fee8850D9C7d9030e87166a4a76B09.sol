...
function sub_3bbe0b4c(?) payable {
    ...
    if not swapRouter:
        ...
        if _47 - 1 < _47:
            return memory
              from (32 * _47 - 1) + ceil32(return_data.size) + 224
               len 32
    else:
        ...
        if _48 - 1 < _48:
            return memory
              from (32 * _48 - 1) + ceil32(return_data.size) + 224
               len 32
    revert
}
...
function estimatedRewardsInWant() payable {
    ...
    if swapRouter <= 1:
        if swapRouter:
            ...
            mem[(4 * ceil32(return_data.size)) + 288] = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 288 len 4], Mask(224, 31, ext_call.return_data[0]) >> 31 + 288]
            ...
            if _111 - 1 < _111:
                return memory
                  from (32 * _111 - 1) + (4 * ceil32(return_data.size)) + 320
                   len 32
        else:
            ...
            if _110 - 1 < _110:
                return memory
                  from (32 * _110 - 1) + (4 * ceil32(return_data.size)) + 320
                   len 32
    revert
}
