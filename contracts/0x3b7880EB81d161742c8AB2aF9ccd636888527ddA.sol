...
address png_avax_shibx_lp_rewardsAddress;
address png_avax_shibx_lpAddress;
address shibxAddress;

function feeDistributor() {
    return feeDistributorAddress
}

function png_avax_shibx_lp_rewards() {
    return png_avax_shibx_lp_rewardsAddress
}

function png_avax_shibx_lp() {
    return png_avax_shibx_lpAddress
}
