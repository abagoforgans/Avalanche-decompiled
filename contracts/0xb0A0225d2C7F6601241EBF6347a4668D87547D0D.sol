...
#
const rewardsToken = 0xd500b1d8e8ef31e21c99d1db9a6444d3adf1270
...
uint256 totalShares;
uint256 totalSupply;
uint8 unlockedStakes; offset 160
...
function unlockStakes() payable {
    ...
    stor10 = Mask(96, 0, not unlockedStakes)
}
    ...
    if not userInfo[address(msg.sender)].field_0:
        ...
        if not userInfo[address(msg.sender)].field_0:
            ...
            if not -userInfo[address(msg.sender)].field_512:
                ...
                staticcall 0xd500b1d8e8ef31e21c99d1db9a6444d3adf1270.0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                ...
                if -userInfo[address(msg.sender)].field_512 <= ext_call.return_data[0]:
                    ...
                    if not ext_code.size(0xd500b1d8e8ef31e21c99d1db9a6444d3adf1270):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 260 len 96] = transfer(address rg1, uint256 rg2), msg.sender, -userInfo[address(msg.sender)].field_512, 0
                    mem[ceil32(return_data.size) + 328] = 0
                    call 0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270 with:
                       funct Mask(32, 224, transfer(address rg1, uint256 rg2), msg.sender, -userInfo[address(msg.sender)].field_512, 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, transfer(address rg1, uint256 rg2), msg.sender, -userInfo[address(msg.sender)].field_512, 0) << 288)
                else:
            ...
            if not (accRewardPerShare * userInfo[address(msg.sender)].field_0 / 10^12) - userInfo[address(msg.sender)].field_512:
                ...
                if (accRewardPerShare * userInfo[address(msg.sender)].field_0 / 10^12) - userInfo[address(msg.sender)].field_512 <= ext_call.return_data[0]:
                    ...
                    if not ext_code.size(0xd500b1d8e8ef31e21c99d1db9a6444d3adf1270):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 260 len 96] = transfer(address rg1, uint256 rg2), msg.sender, (accRewardPerShare * userInfo[address(msg.sender)].field_0 / 10^12) - userInfo[address(msg.sender)].field_512, 0
                    mem[ceil32(return_data.size) + 328] = 0
                    call 0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270 with:
                       funct Mask(32, 224, transfer(address rg1, uint256 rg2), msg.sender, (accRewardPerShare * userInfo[address(msg.sender)].field_0 / 10^12) - userInfo[address(msg.sender)].field_512, 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, transfer(address rg1, uint256 rg2), msg.sender, (accRewardPerShare * userInfo[address(msg.sender)].field_0 / 10^12) - userInfo[address(msg.sender)].field_512, 0) << 288)
                else:
                    mem[ceil32(return_data.size) + 164] = ext_call.return_data[0]
                    mem[ceil32(return_data.size) + 96] = 68
                    mem[ceil32(return_data.size) + 132 len 28] = Mask(224, 32, msg.sender) >> 32
...
function deposit(uint256 arg1, uint256 arg2) payable {
    ...
    if not ext_code.size(tokenAddress):
        revert with 0, 'Address: call to non-contract'
    mem[(4 * ceil32(return_data.size)) + 292 len 128] = transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg1, 0
    ...
    if not return_data.size:
        ...
        mem[(7 * ceil32(return_data.size)) + 324 len 4] = transfer(address rg1, uint256 rg2)
        ...
        mem[(7 * ceil32(return_data.size)) + ceil32(return_data.size) + 325 len 4] = transfer(address rg1, uint256 rg2)
