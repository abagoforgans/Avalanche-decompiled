...
address owner;
address sub_a5f35f24Address;
address sub_a5fe667fAddress;
...
function sub_a5f35f24(?) payable {
    return sub_a5f35f24Address
}

function sub_a5fe667f(?) payable {
    return sub_a5fe667fAddress
}
...
function sub_5e7f0583(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_a5f35f24Address = address(arg1)
}
...
function sub_cfec012f(?) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_a5fe667fAddress = address(arg1)
}
...
function sub_c7a54a97(?) payable {
    require ext_code.size(sub_a5fe667fAddress)
    staticcall sub_a5fe667fAddress.0x3ddac953 with:
            gas gas_remaining wei
           args sub_a5f35f24Address, 10^18
...
function getTokenPrice(address arg1) payable {
    ...
    if not assets[address(arg1)].field_672:
        require ext_code.size(assets[address(arg1)].field_512)
        staticcall assets[address(arg1)].field_512.0x3ddac953 with:
                gas gas_remaining wei
        ...
        require ext_call.return_data[0] == ext_call.return_data[14 len 18]
        return ext_call.return_data[14 len 18]
    require ext_code.size(assets[address(arg1)].field_768)
    ...
    require ext_code.size(assets[address(arg1)].field_768)
    staticcall assets[address(arg1)].field_768.0xd21220a7 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
                ...
                if vesting[address(msg.sender)].field_1024 < vesting[address(msg.sender)].field_512:
                    if block.timestamp > vesting[address(msg.sender)].field_512:
                        ...
                        if (vesting[address(msg.sender)].field_512 * vesting[address(msg.sender)].field_0) - (vesting[address(msg.sender)].field_1024 * vesting[address(msg.sender)].field_0) / vesting[address(msg.sender)].field_256:
                            ...
                            require ext_code.size(sub_a5f35f24Address)
                            call sub_a5f35f24Address.0xa9059cbb with:
                                 gas gas_remaining wei
    ...
    if not assets[address(arg1)].field_672:
        ...
        if ext_call.return_data[14 len 18] < 10^17:
            ...
            if not Mask(144, 0, ext_call.return_data[0]):
                revert with 0, 18
            require ext_code.size(sub_a5f35f24Address)
            staticcall sub_a5f35f24Address.0x70a08231 with:
                    gas gas_remaining wei
                   args this.address
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            if 10^6 * arg2 * Mask(144, 0, ext_call.return_data[0]) * assets[address(arg1)].field_256 / 10^12 / Mask(144, 0, ext_call.return_data[0]) > ext_call.return_data[0] - totalVested:
                revert with 0, 'RebateTreasury: insufficient santa balance'
