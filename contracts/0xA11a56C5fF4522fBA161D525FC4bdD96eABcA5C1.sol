...
function _getNodeNumberOf(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require ext_code.size(0x6774956e8b5c9dee667843f249c5cb9ac0b9dbfc)
    delegate 0x6774956e8b5c9dee667843f249c5cb9ac0b9dbfc.0x732a2ccf with:
    ...
    if not mem[mem[ceil32(return_data.size) + 128] + 96]:
        ...
        return memory
          from mem[64]
           len ceil32(_108) + _107 + -mem[64] + 64
    s = 0
    idx = mem[mem[ceil32(return_data.size) + 128] + 96]
    while idx:
        if s == -1:
            revert with 0, 17
        s = s + 1
