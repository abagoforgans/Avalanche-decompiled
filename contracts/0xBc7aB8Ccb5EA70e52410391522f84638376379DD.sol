...
function BuyToken(address arg1, address arg2, uint256 arg3) payable {
    ...
    require return_data.size >= 32
    _46 = mem[288 len 4], Mask(224, 32, arg3) >> 32
    ...
    _49 = mem[_46 + 288]
    mem[ceil32(return_data.size) + 320 len floor32(mem[_46 + 288])] = mem[_46 + 320 len floor32(mem[_46 + 288])]
    require 1 < mem[ceil32(return_data.size) + 288]
    _78 = mem[ceil32(return_data.size) + 352]
    require ext_code.size(arg1)
    call arg1.0x23b872dd with:
         gas gas_remaining wei
    ...
    mem[(32 * _49) + ceil32(return_data.size) + 324] = arg3
    mem[(32 * _49) + ceil32(return_data.size) + 356] = 100 * _78 / 101
    mem[(32 * _49) + ceil32(return_data.size) + 420] = this.address
    mem[(32 * _49) + ceil32(return_data.size) + 452] = block.timestamp + 15
    ...
    call 0x60ae616a2155ee3d9a68541ba4544862310933d4.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args arg3, 100 * _78 / 101, Array(len=2, data=mem[(32 * _49) + ceil32(return_data.size) + 516 len 64]), address(this.address), block.timestamp + 15
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    require mem[(32 * _49) + ceil32(return_data.size) + 320 len 4], Mask(224, 32, arg3) >> 32 <= 4294967296
    require mem[(32 * _49) + ceil32(return_data.size) + 320 len 4], Mask(224, 32, arg3) >> 32 + 32 <= return_data.size
    require mem[mem[(32 * _49) + ceil32(return_data.size) + 320 len 4], Mask(224, 32, arg3) >> 32 + (32 * _49) + ceil32(return_data.size) + 320] <= 4294967296 and mem[(32 * _49) + ceil32(return_data.size) + 320 len 4], Mask(224, 32, arg3) >> 32 + (32 * mem[mem[(32 * _49) + ceil32(return_data.size) + 320 len 4], Mask(224, 32, arg3) >> 32 + (32 * _49) + ceil32(return_data.size) + 320]) + 32 <= return_data.size
    require ext_code.size(this.address)
    staticcall this.address.0x70a08231 with:
            gas gas_remaining wei
           args arg2
