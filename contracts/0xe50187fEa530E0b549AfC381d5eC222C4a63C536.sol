...
function sub_b07a0792(?) payable {
    ...
    mem[128 len arg3.length] = arg3[all]
    mem[arg3.length + 128] = 0
    mem[ceil32(ceil32(arg3.length)) + 129] = address(arg1)
    mem[ceil32(ceil32(arg3.length)) + 149] = arg2
    mem[ceil32(ceil32(arg3.length)) + 181 len ceil32(arg3.length)] = arg3[all], mem[arg3.length + 128 len ceil32(arg3.length) - arg3.length]
    mem[ceil32(ceil32(arg3.length)) + arg3.length + 181] = arg4
    mem[ceil32(ceil32(arg3.length)) + arg3.length + 213] = 32
    mem[ceil32(ceil32(arg3.length)) + arg3.length + 245] = mem[ceil32(ceil32(arg3.length)) + 97 len arg3.length + -ceil32(ceil32(arg3.length)) + 31], 0
    mem[ceil32(ceil32(arg3.length)) + arg3.length + 277 len ceil32(mem[ceil32(ceil32(arg3.length)) + 97 len arg3.length + -ceil32(ceil32(arg3.length)) + 31], 0)] = mem[ceil32(ceil32(arg3.length)) + 129 len ceil32(mem[ceil32(ceil32(arg3.length)) + 97 len arg3.length + -ceil32(ceil32(arg3.length)) + 31], 0)]
    if ceil32(mem[ceil32(ceil32(arg3.length)) + 97 len arg3.length + -ceil32(ceil32(arg3.length)) + 31], 0) > mem[ceil32(ceil32(arg3.length)) + 97 len arg3.length + -ceil32(ceil32(arg3.length)) + 31], 0:
        mem[ceil32(ceil32(arg3.length)) + arg3.length + mem[ceil32(ceil32(arg3.length)) + 97 len arg3.length + -ceil32(ceil32(arg3.length)) + 31], 0 + 277] = 0
    return 32, mem[ceil32(ceil32(arg3.length)) + arg3.length + 245 len ceil32(mem[ceil32(ceil32(arg3.length)) + 97 len arg3.length + -ceil32(ceil32(arg3.length)) + 31], 0) + 32], 
}
