...
const InitialSupply = 10^15

const BalanceLimitDivider = 20

const decimals = 9

const MaxSellLockTime = 5

const MaxBuyLockTime = 5
...
function getBurnedTokens() {
    if 10^15 < totalSupply:
        revert with 0, 17
    return (-totalSupply + 10^15 / 10^9)
}
...
function TeamCreateLPandAVAX() {
    ...
    if uint8(stor19.field_32) > -uint8(stor19.field_40) + 255:
        revert with 0, 17
    if balanceOf[this.address] >= 25 * 10^11:
        if uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
            if uint8(stor19.field_32) > 0x709709a125da07099432d2f9035837dcc47a61c91dfc8071027b03:
                revert with 0, 17
            if not uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
                revert with 0, 18
            if 25 * 10^11 < 25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
                revert with 0, 17
            if 25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) < 25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2:
                revert with 0, 17
            if (25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))) - (25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) > !(-(25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))) + 25 * 10^11):
                revert with 0, 17
            if not this.address:
                revert with 0, 'Approve from zero'
            if not address(stor20.field_0):
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][address(stor20.field_0)].field_0 = -(25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 25 * 10^11
            emit Approval((-(25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 25 * 10^11), this.address, address(stor20.field_0));
            ...
            mem[ceil32(return_data.size) + 196] = -(25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 25 * 10^11
            idx = 0
            s = 128
            ...
            call address(stor20.field_0).swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                 gas gas_remaining wei
                args -(25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 25 * 10^11, 0, 160, address(this.address), block.timestamp, 2, mem[ceil32(return_data.size) + 388 len 64]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if eth.balance(this.address) < eth.balance(this.address):
                revert with 0, 17
            if False and (25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))) - (25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) > 0:
                revert with 0, 17
            if not -(25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 25 * 10^11:
                revert with 0, 18
            if totalLPAVAX > !(0 / -(25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 25 * 10^11):
                revert with 0, 17
            totalLPAVAX += 0 / -(25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 25 * 10^11
            if not this.address:
                revert with 0, 'Approve from zero'
            if not address(stor20.field_0):
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][address(stor20.field_0)].field_0 = 25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2
            allowance[address(this.address)][address(stor20.field_0)].field_255 = 0
            emit Approval((25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2), this.address, address(stor20.field_0));
            require ext_code.size(address(stor20.field_0))
            call address(stor20.field_0).addLiquidityAVAX(address rg1, uint256 rg2, uint256 rg3, uint256 rg4, address rg5, uint256 rg6) with:
               value 0 / -(25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 25 * 10^11 wei
                 gas gas_remaining wei
                args address(this.address), Mask(255, 1, 25 * 10^11 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))), 0, 0, address(this.address), block.timestamp
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
