...
mapping of uint256 sub_cb8a7b4d;
...
function sub_cb8a7b4d(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    return sub_cb8a7b4d[arg1]
}
...
function sub_efc9878a(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    stor8[address(arg1)] = 0
    sub_cb8a7b4d[address(arg1)] = 0
}
...
function royaltyInfo(uint256 arg1, uint256 arg2) payable {
    ...
    if arg2 and 500 > -1 / arg2:
        revert with 'NH{q', 17
    return address(this.address), 500 * arg2 / 10000
}

function sub_52d4b9fb(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
    require arg2 == arg2
    if owner != msg.sender:
    ...
    sub_cb8a7b4d[address(arg1)] = arg2
}
...
function removeFromWhiteList(address[] arg1) payable {
    ...
    while idx < arg1.length:
        ...
        mem[32] = 9
        sub_cb8a7b4d[address(cd[((32 * idx) + arg1 + 36)])] = 0
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
...
function sub_f48e0bcb(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        mem[32] = 9
        sub_cb8a7b4d[address(cd[((32 * idx) + cd[4] + 36)])] = mem[(32 * idx) + 128]
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
...
You need to get the keys first.'
    if totalSupply >= 111:
        revert with 0, 'Exceeds max supply'
    if not uint8(stor7.field_160):
        revert with 0, 'Allowlisted only. You need to find the keys.'
    if not stor8[address(msg.sender)]:
        revert with 0, 'You have not completed 
the steps needed to mint. 
You need to find the keys'
    if sub_cb8a7b4d[address(msg.sender)] <= 0:
        revert with 0, 'You have exceeded your allowlist minting allocation.'
    if sub_cb8a7b4d[address(msg.sender)] < 1:
        revert with 'NH{q', 17
    sub_cb8a7b4d[address(msg.sender)]--
    if not msg.sender:
