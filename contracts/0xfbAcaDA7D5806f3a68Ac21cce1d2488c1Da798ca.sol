...
function setFees(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint256 arg5) {
    ...
    uint256(stor21.field_0) = arg5
    require stor20 < Mask(254, 0, stor21.field_2)
}
...
function getMultipliedFee() {
    ...
    if launchedAtTimestamp + (24 * 3600) > block.timestamp:
        if stor20 and 15000 > -1 / stor20:
            revert with 'NH{q', 17
        if not uint256(stor21.field_0):
            revert with 'NH{q', 18
        return (15000 * stor20 / uint256(stor21.field_0))
    if stor32 > -stor33 - 1:
        revert with 'NH{q', 17
    if stor32 + stor33 <= block.timestamp:
        return stor20
    if stor32 > -stor33 - 1:
        revert with 'NH{q', 17
    if stor32 + stor33 < block.timestamp:
        revert with 'NH{q', 17
    if stor20 and stor30 > -1 / stor20:
        revert with 'NH{q', 17
    if not stor31:
        revert with 'NH{q', 18
    if stor20 * stor30 / stor31 < stor20:
        revert with 'NH{q', 17
    if (stor20 * stor30 / stor31) - stor20 and stor32 + stor33 - block.timestamp > -1 / (stor20 * stor30 / stor31) - stor20:
        revert with 'NH{q', 17
    if not stor33:
        revert with 'NH{q', 18
    if stor20 > -((stor32 * stor20 * stor30 / stor31) + (stor33 * stor20 * stor30 / stor31) - (block.timestamp * stor20 * stor30 / stor31) - (stor32 * stor20) - (stor33 * stor20) + (block.timestamp * stor20) / stor33) - 1:
        revert with 'NH{q', 17
    return (stor20 + ((stor32 * stor20 * stor30 / stor31) + (stor33 * stor20 * stor30 / stor31) - (block.timestamp * stor20 * stor30 / stor31) - (stor32 * stor20) - (stor33 * stor20) + (block.timestamp * stor20) / stor33))
}
