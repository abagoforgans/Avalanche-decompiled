...
function executeBatch(address[] arg1, uint256[] arg2, bytes[] arg3, bytes32 arg4, bytes32 arg5) payable {
    ...
    if roleAdmin[0xd8aa0f3194971a2a116679f7c2090f6939c8d4e01a2a8d7e41d55e5351469e63][0].field_0:
        ...
        mem[64] = (32 * arg1.length) + (32 * arg2.length) + (64 * arg3.length) + 384
        _212 = sha3(Array(len=arg1.length, data=mem[320 len (32 * arg1.length) + (32 * arg2.length) + (64 * arg3.length) + 64]), (32 * arg1.length) + 192, (32 * arg1.length) + (32 * arg2.length) + 224, arg4, arg5)
        mem[0] = sha3(Array(len=arg1.length, data=mem[320 len (32 * arg1.length) + (32 * arg2.length) + (64 * arg3.length) + 64]), (32 * arg1.length) + 192, (32 * arg1.length) + (32 * arg2.length) + 224, arg4, arg5)
        if timestamp[Array(len=arg1.length, data=mem[320 len (32 * arg1.length) + (32 * arg2.length) + (64 * arg3.length) + 64])][(32 * arg1.length) + 192][(32 * arg1.length) + (32 * arg2.length) + 224][arg4][arg5] <= 1:
            revert with 0, 'TimelockController: operation is not ready'
        if timestamp[Array(len=arg1.length, data=mem[320 len (32 * arg1.length) + (32 * arg2.length) + (64 * arg3.length) + 64])][(32 * arg1.length) + 192][(32 * arg1.length) + (32 * arg2.length) + 224][arg4][arg5] > block.timestamp:
            revert with 0, 'TimelockController: operation is not ready'
        if not arg4:
            idx = 0
            while idx < arg1.length:
                ...
                call address(cd[((32 * idx) + arg1 + 36)]).mem[mem[64] len 4] with:
                   value cd[((32 * idx) + arg2 + 36)] wei
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _359 + cd[(arg3 + cd[(arg3 + (32 * idx) + 36)] + 36)] + -mem[64] - 4]
                if return_data.size:
                    _379 = mem[64]
            ...
            while idx < arg1.length:
                ...
                call address(cd[((32 * idx) + arg1 + 36)]).mem[mem[64] len 4] with:
                   value cd[((32 * idx) + arg2 + 36)] wei
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _360 + cd[(arg3 + cd[(arg3 + (32 * idx) + 36)] + 36)] + -mem[64] - 4]
                if return_data.size:
                    _380 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size) + 1
        ...
        mem[96] = (32 * arg1.length) + (32 * arg2.length) + (64 * arg3.length) + 256
        mem[64] = (32 * arg1.length) + (32 * arg2.length) + (64 * arg3.length) + 384
        _215 = sha3(Array(len=arg1.length, data=mem[320 len (32 * arg1.length) + (32 * arg2.length) + (64 * arg3.length) + 64]), (32 * arg1.length) + 192, (32 * arg1.length) + (32 * arg2.length) + 224, arg4, arg5)
        mem[0] = sha3(Array(len=arg1.length, data=mem[320 len (32 * arg1.length) + (32 * arg2.length) + (64 * arg3.length) + 64]), (32 * arg1.length) + 192, (32 * arg1.length) + (32 * arg2.length) + 224, arg4, arg5)
        if timestamp[Array(len=arg1.length, data=mem[320 len (32 * arg1.length) + (32 * arg2.length) + (64 * arg3.length) + 64])][(32 * arg1.length) + 192][(32 * arg1.length) + (32 * arg2.length) + 224][arg4][arg5] <= 1:
            revert with 0, 'TimelockController: operation is not ready'
        if timestamp[Array(len=arg1.length, data=mem[320 len (32 * arg1.length) + (32 * arg2.length) + (64 * arg3.length) + 64])][(32 * arg1.length) + 192][(32 * arg1.length) + (32 * arg2.length) + 224][arg4][arg5] > block.timestamp:
        ...
        if not arg4:
            ...
            while idx < arg1.length:
                ...
                call address(cd[((32 * idx) + arg1 + 36)]).mem[mem[64] len 4] with:
                   value cd[((32 * idx) + arg2 + 36)] wei
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _361 + cd[(arg3 + cd[(arg3 + (32 * idx) + 36)] + 36)] + -mem[64] - 4]
                if return_data.size:
                    _381 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size) + 1
            ...
            while idx < arg1.length:
                ...
                call address(cd[((32 * idx) + arg1 + 36)]).mem[mem[64] len 4] with:
                   value cd[((32 * idx) + arg2 + 36)] wei
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _362 + cd[(arg3 + cd[(arg3 + (32 * idx) + 36)] + 36)] + -mem[64] - 4]
                if return_data.size:
                    _382 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size) + 1
