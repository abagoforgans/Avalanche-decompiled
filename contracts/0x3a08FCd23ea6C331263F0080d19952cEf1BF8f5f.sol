...
function sub_d3439f43(?) {
    ...
    mem[ceil32(return_data.size) + 192] = 0xa85e999c00000000000000000000000000000000000000000000000000000000
    mem[ceil32(return_data.size) + 196] = 0x10ed43c718714eb63d5aa57b78b54704e256024e
    mem[ceil32(return_data.size) + 228] = address(arg1)
    mem[ceil32(return_data.size) + 260] = arg4
    mem[ceil32(return_data.size) + 292] = arg5
    mem[ceil32(return_data.size) + 324] = 192
    ...
    require ext_code.size(this.address)
    call this.address.0xa85e999c with:
         gas gas_remaining wei
        args 0x10ed43c718714eb63d5aa57b78b54704e256024e, address(arg1), arg4, arg5, Array(len=2, data=mem[ceil32(return_data.size) + 420 len 64]), this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    mem[(4 * ceil32(return_data.size)) + 196] = 0x84fa354e65b521e6fb9d1602549cf8693cdb4f8
    mem[(4 * ceil32(return_data.size)) + 228] = -1
    require ext_code.size(address(arg2))
    call address(arg2).approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 0x84fa354e65b521e6fb9d1602549cf8693cdb4f8, -1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    require ext_code.size(0x84fa354e65b521e6fb9d1602549cf8693cdb4f8)
    call 0x084fa354e65b521e6fb9d1602549cf8693cdb4f8.migrate(uint256 arg1) with:
         gas gas_remaining wei
        args ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(6 * ceil32(return_data.size)) + 224] = address(arg3)
    mem[(6 * ceil32(return_data.size)) + 256] = 0xe9e7cea3dedca5984780bafc599bd69add087d56
    mem[(6 * ceil32(return_data.size)) + 288] = 0xa85e999c00000000000000000000000000000000000000000000000000000000
    mem[(6 * ceil32(return_data.size)) + 292] = 0x10ed43c718714eb63d5aa57b78b54704e256024e
    idx = 0
    ...
    call this.address.0xa85e999c with:
         gas gas_remaining wei
        args 0x10ed43c718714eb63d5aa57b78b54704e256024e, address(arg3), ext_call.return_data[0], arg6, Array(len=2, data=mem[(6 * ceil32(return_data.size)) + 516 len 64]), owner
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
...
function sub_1f65957b(?) {
    ...
    require ext_call.return_data[0] == ext_call.return_data[0]
    if ext_call.return_data[0] <= 0:
        revert with 0, 'fail balance zero'
    if not arg6:
        require ext_code.size(this.address)
        call this.address.0xd3b146f4 with:
             gas gas_remaining wei
    ...
    if arg6 == 1:
        ...
        call address(arg8).anySwapOutUnderlying(address arg1, address arg2, uint256 arg3, uint256 arg4) with:
             gas gas_remaining wei
            args address(arg3), owner, ext_call.return_data[0], arg7
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    return 1
}

function sub_d05c97e8(?) {
    require calldata.size - 4 >= 192
    require arg1 == address(arg1)
    require arg2 == address(arg2)
    require arg3 == address(arg3)
    ...
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    require ext_code.size(0x84fa354e65b521e6fb9d1602549cf8693cdb4f8)
    call 0x084fa354e65b521e6fb9d1602549cf8693cdb4f8.add(uint256 arg1) with:
         gas gas_remaining wei
        args ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(0x84fa354e65b521e6fb9d1602549cf8693cdb4f8)
    call 0x084fa354e65b521e6fb9d1602549cf8693cdb4f8.claim(uint256 arg1) with:
         gas gas_remaining wei
        args ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_a85e999c(?) {
    ...
    if block.timestamp > -301:
        revert with 'NH{q', 17
    mem[floor32(('cd', 132).length) + 101] = address(cd[4])
    mem[floor32(('cd', 132).length) + 133] = -1
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    mem[floor32(('cd', 132).length) + ceil32(return_data.size) + 97] = 0x38ed173900000000000000000000000000000000000000000000000000000000
    ...
    while idx < ('cd', 132).length:
        ...
        t = t + 32
        continue 
    mem[floor32(('cd', 132).length) + ceil32(return_data.size) + 197] = address(cd[164])
    mem[floor32(('cd', 132).length) + ceil32(return_data.size) + 229] = block.timestamp + 300
    require ext_code.size(address(cd[4]))
    call address(cd[4]).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args cd[68], cd[100], Array(len=('cd', 132).length, data=mem[floor32(('cd', 132).length) + ceil32(return_data.size) + 293 len 32 * ('cd', 132).length]), address(cd[164]), block.timestamp + 300
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[floor32(('cd', 132).length) + ceil32(return_data.size) + 97 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = floor32(('cd', 132).length) + (2 * ceil32(return_data.size)) + 97
    require return_data.size >= 32
    _35 = mem[floor32(('cd', 132).length) + ceil32(return_data.size) + 97 len 4], Mask(224, 32, cd[68]) >> 32
    require mem[floor32(('cd', 132).length) + ceil32(return_data.size) + 97 len 4], Mask(224, 32, cd[68]) >> 32 <= test266151307()
    require floor32(('cd', 132).length) + ceil32(return_data.size) + mem[floor32(('cd', 132).length) + ceil32(return_data.size) + 97 len 4], Mask(224, 32, cd[68]) >> 32 + 128 < floor32(('cd', 132).length) + ceil32(return_data.size) + return_data.size + 97
    _36 = mem[floor32(('cd', 132).length) + ceil32(return_data.size) + mem[floor32(('cd', 132).length) + ceil32(return_data.size) + 97 len 4], Mask(224, 32, cd[68]) >> 32 + 97]
    if mem[floor32(('cd', 132).length) + ceil32(return_data.size) + mem[floor32(('cd', 132).length) + ceil32(return_data.size) + 97 len 4], Mask(224, 32, cd[68]) >> 32 + 97] > test266151307():
        revert with 'NH{q', 65
    if floor32(('cd', 132).length) + (2 * ceil32(return_data.size)) + floor32(mem[floor32(('cd', 132).length) + ceil32(return_data.size) + mem[floor32(('cd', 132).length) + ceil32(return_data.size) + 97 len 4], Mask(224, 32, cd[68]) >> 32 + 97]) + 98 > test266151307() or floor32(mem[floor32(('cd', 132).length) + ceil32(return_data.size) + mem[floor32(('cd', 132).length) + ceil32(return_data.size) + 97 len 4], Mask(224, 32, cd[68]) >> 32 + 97]) + 1 < 0:
        revert with 'NH{q', 65
    mem[floor32(('cd', 132).length) + (2 * ceil32(return_data.size)) + 97] = mem[floor32(('cd', 132).length) + ceil32(return_data.size) + mem[floor32(('cd', 132).length) + ceil32(return_data.size) + 97 len 4], Mask(224, 32, cd[68]) >> 32 + 97]
    require _35 + (32 * _36) + 32 <= return_data.size
    idx = 0
    s = floor32(('cd', 132).length) + ceil32(return_data.size) + _35 + 129
    t = floor32(('cd', 132).length) + (2 * ceil32(return_data.size)) + 129
    while idx < _36:
        require mem[s] == mem[s]
        mem[t] = mem[s]
        idx = idx + 1
    ...
    if address(cd[4]) != 0x6a5f6a8121592becd6747a38d67451b310f7f156:
        ...
        if address(cd[4]) == 0xbe9e53fd7edac9f859882afdda116645287c629:
            ...
            while idx < ('cd', 100).length:
                ...
                continue 
            mem[_115 + 68] = owner
            mem[_115 + 100] = block.timestamp + 300
            require ext_code.size(0xfb76e9e7d88e308ab530330ed90e84a952570319)
            call 0xfb76e9e7d88e308ab530330ed90e84a952570319.mem[mem[64] len 4] with:
               value msg.value wei
                 gas gas_remaining wei
                args mem[mem[64] + 4 len _115 + (32 * ('cd', 100).length) + -mem[64] + 160]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _131 = mem[64]
...
function sub_5fc18492(?) {
    ...
    if ext_call.return_data[0] >= cd[100]:
        ...
        mem[floor32(('cd', 164).length) + (6 * ceil32(return_data.size)) + 97] = mem[floor32(('cd', 164).length) + (4 * ceil32(return_data.size)) + mem[floor32(('cd', 164).length) + (4 * ceil32(return_data.size)) + 97 len 4], Mask(224, 32, cd[100]) >> 32 + 97]
