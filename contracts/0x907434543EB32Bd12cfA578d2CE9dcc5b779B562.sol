    ...
    while idx < arg2.length:
        ...
        if ownerOf[mem[(32 * idx) + 128]] != msg.sender:
            ...
            if approved[mem[(32 * idx) + 128]] != msg.sender:
                if not stor6[stor3[mem[(32 * idx) + 128]]][address(msg.sender)]:
                    revert with 0, 'ERC721: transfer caller is not owner nor approved'
        if not ownerOf[mem[(32 * idx) + 128]]:
            revert with 0, 'ERC721: owner query for nonexistent token'
        if ownerOf[mem[(32 * idx) + 128]] != msg.sender:
        ...
        if not arg1:
            revert with 0, 'ERC721: transfer to the zero address'
        if not msg.sender:
            stor11[mem[(32 * idx) + 128]] = tokenByIndex.length
            tokenByIndex.length++
            ...
            if arg1 != msg.sender:
                ...
                if balanceOf[address(msg.sender)] < 1:
                    revert with 'NH{q', 17
                if stor8[mem[(32 * idx) + 128]] != balanceOf[address(msg.sender)] - 1:
                    tokenOfOwnerByIndex[address(msg.sender)][stor8[mem[(32 * idx) + 128]]] = tokenOfOwnerByIndex[address(msg.sender)][stor4[address(msg.sender)] - 1]
                    stor8[stor7[address(msg.sender)][stor4[address(msg.sender)] - 1]] = stor8[mem[(32 * idx) + 128]]
                stor8[mem[(32 * idx) + 128]] = 0
                tokenOfOwnerByIndex[address(msg.sender)][stor4[address(msg.sender)] - 1] = 0
        if arg1:
            if arg1 != msg.sender:
                if not arg1:
                    revert with 0, 'ERC721: balance query for the zero address'
                tokenOfOwnerByIndex[address(arg1)][stor4[address(arg1)]] = mem[(32 * idx) + 128]
                stor8[mem[(32 * idx) + 128]] = balanceOf[address(arg1)]
        else:
            if tokenByIndex.length < 1:
                revert with 'NH{q', 17
            if tokenByIndex.length - 1 >= tokenByIndex.length:
                revert with 'NH{q', 50
            if stor11[mem[(32 * idx) + 128]] >= tokenByIndex.length:
                revert with 'NH{q', 50
            tokenByIndex[stor11[mem[(32 * idx) + 128]]] = tokenByIndex[tokenByIndex.length]
            stor11[stor9[stor9.length]] = stor11[mem[(32 * idx) + 128]]
        ...
        mem[32] = 3
        ownerOf[mem[(32 * idx) + 128]] = arg1
        emit Transfer(msg.sender, arg1, mem[(32 * idx) + 128]);
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
