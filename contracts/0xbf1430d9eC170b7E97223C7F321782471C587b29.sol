...
function getCash() {
    ...
    mem[ceil32(calldata.size) + 196 len floor32(ceil32(calldata.size) + 68)] = delegateToImplementation(bytes arg1), 0, 32, calldata.size, mem[196 len floor32(ceil32(calldata.size) + 68) - 68]
...
function _setImplementation(address arg1, bool arg2, bytes arg3) {
    ...
    if not arg2:
        ...
        if return_data.size:
            ...
            if not arg3.length % 32:
                mem[arg3.length + ceil32(arg3.length) + ceil32(return_data.size) + 265 len floor32(arg3.length + 68)] = _becomeImplementation(bytes arg1), 0, 32, mem[ceil32(arg3.length) + ceil32(return_data.size) + 233 len floor32(arg3.length + 68) - 36]
                ...
                delegate implementationAddress with:
                   funct (Mask(32, 224, _becomeImplementation(bytes arg1), 0, 32, mem[ceil32(arg3.length) + ceil32(return_data.size) + 233 len floor32(arg3.length + 68) - 36]) >> 224)
                     gas gas_remaining wei
            ...
            if not arg3.length % 32:
                ...
                delegate implementationAddress with:
                   funct (Mask(32, 224, _becomeImplementation(bytes arg1), 0, 0, mem[ceil32(arg3.length) + 232 len floor32(arg3.length + 68) - 36]) >> 224)
                     gas gas_remaining wei
                ...
                mem[floor32(arg3.length) + ceil32(arg3.length) + floor32(floor32(arg3.length) + 100) + -(floor32(arg3.length) + 100 % 32) + 328 len floor32(arg3.length) + 100 % 32] = mem[ceil32(arg3.length) + (3 * floor32(floor32(arg3.length) + 100)) + (-2 * floor32(arg3.length)) - 4 len floor32(arg3.length) + -floor32(floor32(arg3.length) + 100) + 100]
                delegate implementationAddress with:
                   funct (Mask(32, 224, _becomeImplementation(bytes arg1), 0, 0, arg3.length, mem[ceil32(arg3.length) + 264 len floor32(floor32(arg3.length) + 100) - 68]) >> 224)
                     gas gas_remaining wei
