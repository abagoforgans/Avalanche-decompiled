...
function sub_77bb004e(?) payable {
    ...
    while idx < arg2.length:
        ...
        _46 = mem[(32 * arg2.length) + (32 * idx) + 160]
        require mem[(32 * arg2.length) + (32 * idx) + 160]
        if mem[(32 * arg2.length) + (32 * idx) + 160] + s < s:
            revert with 0, 'SafeMath: addition overflow'
        require mem[(32 * arg2.length) + (32 * idx) + 160] + s <= ext_call.return_data[0]
        require idx < mem[96]
        _51 = mem[64]
        mem[mem[64] + 36] = mem[(32 * idx) + 140 len 20]
        mem[mem[64] + 68] = _46
        ...
        while t >= 32:
            ...
            t = t - 32
            continue 
        mem[mem[64] + floor32(mem[_52])] = mem[_52 + floor32(mem[_52]) + -(mem[_52] % 32) + 64 len mem[_52] % 32] or Mask(8 * -(mem[_52] % 32) + 32, -(8 * -(mem[_52] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_52])])
        call arg1.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _57 + _51 + -mem[64] + 96]
        if not return_data.size:
            if not ext_call.success:
                revert with 0, 'SafeERC20: low-level call failed'
            if mem[96]:
...
function sub_f0558aa2(?) payable {
    ...
    while idx < arg2.length:
        require idx < mem[(32 * arg2.length) + 128]
        _47 = mem[(32 * arg2.length) + (32 * idx) + 160]
        require mem[(32 * arg2.length) + (32 * idx) + 160]
        if mem[(32 * arg2.length) + (32 * idx) + 160] + s < s:
            revert with 0, 'SafeMath: addition overflow'
        require mem[(32 * arg2.length) + (32 * idx) + 160] + s <= ext_call.return_data[0]
        ...
        while t >= 32:
            ...
            t = t - 32
            continue 
        mem[mem[64] + floor32(mem[_53])] = mem[_53 + floor32(mem[_53]) + -(mem[_53] % 32) + 64 len mem[_53] % 32] or Mask(8 * -(mem[_53] % 32) + 32, -(8 * -(mem[_53] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_53])])
        call arg1.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _58 + _52 + -mem[64] + 128]
        if not return_data.size:
            if not ext_call.success:
                revert with 0, 'SafeERC20: low-level call failed'
            if mem[96]:
