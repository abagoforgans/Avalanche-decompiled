...
function deposit() payable {
    ...
    if ext_call.return_data[0]:
        require ext_code.size(address(rewardPoolAddress))
        call address(rewardPoolAddress).0xabe50f19 with:
             gas gas_remaining wei
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] >= arg1:
        ...
        require ext_code.size(address(rewardPoolAddress))
        staticcall address(rewardPoolAddress).0x5e0fac2e with:
                gas gas_remaining wei
               args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if ext_call.return_data[0] >= arg1 - ext_call.return_data[0]:
            ...
            if not ext_call.return_data[0]:
                call address(rewardPoolAddress).0xa01c77bc with:
                     gas gas_remaining wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require ext_code.size(wantAddress)
                ...
                if arg1 - ext_call.return_data[0] > ext_call.return_data[0]:
                    revert with 0, 'SafeMath: subtraction overflow'
                if not (2 * ext_call.return_data[0]) - arg1:
                    if arg1 < arg1 - ext_call.return_data[0]:
                        revert with 0, 'SafeMath: addition overflow'
                    if eth.balance(this.address) < 0:
                        revert with 0, 32, 38, 0x73416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[366 len 26]
