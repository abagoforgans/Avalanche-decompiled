...
function mintPrice(uint256 arg1) {
    ...
    if totalSupply + arg1 <= stor11:
        if not stor13:
            revert with 'NH{q', 18
        if arg1 and nodePrice / stor13 > -1 / arg1:
            revert with 'NH{q', 17
        return (arg1 * nodePrice / stor13)
    if totalSupply + arg1 < stor11:
        revert with 'NH{q', 17
    if not stor13:
        revert with 'NH{q', 18
    if arg1 < totalSupply + arg1 - stor11:
        revert with 'NH{q', 17
    if -totalSupply + stor11 and nodePrice / stor13 > -1 / -totalSupply + stor11:
        revert with 'NH{q', 17
    if nodePrice > -stor9 - 1:
        revert with 'NH{q', 17
    if not stor13:
        revert with 'NH{q', 18
    if totalSupply + arg1 - stor11 and nodePrice + stor9 / stor13 > -1 / totalSupply + arg1 - stor11:
        revert with 'NH{q', 17
    if (totalSupply * nodePrice + stor9 / stor13) + (arg1 * nodePrice + stor9 / stor13) - (stor11 * nodePrice + stor9 / stor13) > (totalSupply * nodePrice / stor13) + (-1 * stor11 * nodePrice / stor13) - 1:
        revert with 'NH{q', 17
    return ((totalSupply * nodePrice + stor9 / stor13) + (arg1 * nodePrice + stor9 / stor13) - (stor11 * nodePrice + stor9 / stor13) - (totalSupply * nodePrice / stor13) + (stor11 * nodePrice / stor13))
}
...
function mint(uint256 arg1) payable {
    ...
    if totalSupply + arg1 <= stor11:
        ...
        if arg1 and nodePrice / stor13 > -1 / arg1:
            revert with 'NH{q', 17
        if arg1 * nodePrice / stor13 > msg.value:
        ...
        if (totalSupply * nodePrice + stor9 / stor13) + (arg1 * nodePrice + stor9 / stor13) - (stor11 * nodePrice + stor9 / stor13) > (totalSupply * nodePrice / stor13) + (-1 * stor11 * nodePrice / stor13) - 1:
            revert with 'NH{q', 17
        if (totalSupply * nodePrice + stor9 / stor13) + (arg1 * nodePrice + stor9 / stor13) - (stor11 * nodePrice + stor9 / stor13) - (totalSupply * nodePrice / stor13) + (stor11 * nodePrice / stor13) > msg.value:
            revert with 0, 'Value sent is not correct'
        idx = 0
        while idx < arg1:
            _104 = mem[64]
