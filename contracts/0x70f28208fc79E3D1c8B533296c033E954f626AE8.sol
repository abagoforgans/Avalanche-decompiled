...
function sub_3d67cebb(?) payable {
    ...
    if 300 * sub_1051acde / 100000 * 10^18 <= 100:
        if (block.number * voter[address(arg1)].field_0) - (voter[address(msg.sender)].field_128 * voter[address(arg1)].field_0) and 62 * 10^14 * 300 * sub_1051acde / 100000 * 10^18 / 100 > -1 / (block.number * voter[address(arg1)].field_0) - (voter[address(msg.sender)].field_128 * voter[address(arg1)].field_0):
            revert with 'NH{q', 17
        if not sub_1051acde:
            revert with 'NH{q', 18
        return ((block.number * voter[address(arg1)].field_0 * 62 * 10^14 * 300 * sub_1051acde / 100000 * 10^18 / 100) - (voter[address(msg.sender)].field_128 * voter[address(arg1)].field_0 * 62 * 10^14 * 300 * sub_1051acde / 100000 * 10^18 / 100) / sub_1051acde)
