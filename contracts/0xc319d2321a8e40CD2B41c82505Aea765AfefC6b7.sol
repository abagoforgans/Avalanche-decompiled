...
function transferOwnership(uint256 arg1) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function hatchEggs(address arg1) {
    ...
    if stor1 < block.timestamp - stor8[address(msg.sender)]:
        ...
        if stor7[stor9[msg.sender]] > !(stor7[address(msg.sender)] + (stor1 * sub_4b634b06[address(msg.sender)]) / 12):
            revert with 0, 17
        stor7[stor9[msg.sender]] += stor7[address(msg.sender)] + (stor1 * sub_4b634b06[address(msg.sender)]) / 12
        ...
        stor7[msg.sender] = 0
        stor8[msg.sender] = block.timestamp
        if stor7[stor9[msg.sender]] > !(stor7[address(msg.sender)] + (block.timestamp * sub_4b634b06[address(msg.sender)]) - (stor8[address(msg.sender)] * sub_4b634b06[address(msg.sender)]) / 12):
            revert with 0, 17
        stor7[stor9[msg.sender]] += stor7[address(msg.sender)] + (block.timestamp * sub_4b634b06[address(msg.sender)]) - (stor8[address(msg.sender)] * sub_4b634b06[address(msg.sender)]) / 12
...
function sub_a507abee(?) {
    ...
    if stor1 < block.timestamp - stor8[address(arg1)]:
        ...
        if stor3 and stor7[address(arg1)] + (stor1 * sub_4b634b06[address(arg1)]) > -1 / stor3:
            revert with 0, 17
        if stor2 * stor10 > !((stor7[address(arg1)] * stor3) + (stor1 * sub_4b634b06[address(arg1)] * stor3)):
            revert with 0, 17
        if not stor7[address(arg1)] + (stor1 * sub_4b634b06[address(arg1)]):
            revert with 0, 18
        if stor3 > !((stor2 * stor10) + (stor7[address(arg1)] * stor3) + (stor1 * sub_4b634b06[address(arg1)] * stor3) / stor7[address(arg1)] + (stor1 * sub_4b634b06[address(arg1)])):
            revert with 0, 17
    ...
    if stor3 and stor7[address(arg1)] + (block.timestamp * sub_4b634b06[address(arg1)]) - (stor8[address(arg1)] * sub_4b634b06[address(arg1)]) > -1 / stor3:
        revert with 0, 17
    if stor2 * stor10 > !((stor7[address(arg1)] * stor3) + (block.timestamp * sub_4b634b06[address(arg1)] * stor3) - (stor8[address(arg1)] * sub_4b634b06[address(arg1)] * stor3)):
        revert with 0, 17
    if not stor7[address(arg1)] + (block.timestamp * sub_4b634b06[address(arg1)]) - (stor8[address(arg1)] * sub_4b634b06[address(arg1)]):
        revert with 0, 18
    if stor3 > !((stor2 * stor10) + (stor7[address(arg1)] * stor3) + (block.timestamp * sub_4b634b06[address(arg1)] * stor3) - (stor8[address(arg1)] * sub_4b634b06[address(arg1)] * stor3) / stor7[address(arg1)] + (block.timestamp * sub_4b634b06[address(arg1)]) - (stor8[address(arg1)] * sub_4b634b06[address(arg1)])):
        revert with 0, 17
...
function sellEggs() {
    ...
    if stor1 < block.timestamp - stor8[address(msg.sender)]:
        ...
        if stor3 and stor7[address(msg.sender)] + (stor1 * sub_4b634b06[address(msg.sender)]) > -1 / stor3:
            revert with 0, 17
        if stor2 * stor10 > !((stor7[address(msg.sender)] * stor3) + (stor1 * sub_4b634b06[address(msg.sender)] * stor3)):
            revert with 0, 17
        if not stor7[address(msg.sender)] + (stor1 * sub_4b634b06[address(msg.sender)]):
            revert with 0, 18
        if stor3 > !((stor2 * stor10) + (stor7[address(msg.sender)] * stor3) + (stor1 * sub_4b634b06[address(msg.sender)] * stor3) / stor7[address(msg.sender)] + (stor1 * sub_4b634b06[address(msg.sender)])):
            revert with 0, 17
        ...
        if stor3 and stor7[address(msg.sender)] + (block.timestamp * sub_4b634b06[address(msg.sender)]) - (stor8[address(msg.sender)] * sub_4b634b06[address(msg.sender)]) > -1 / stor3:
            revert with 0, 17
        if stor2 * stor10 > !((stor7[address(msg.sender)] * stor3) + (block.timestamp * sub_4b634b06[address(msg.sender)] * stor3) - (stor8[address(msg.sender)] * sub_4b634b06[address(msg.sender)] * stor3)):
            revert with 0, 17
        if not stor7[address(msg.sender)] + (block.timestamp * sub_4b634b06[address(msg.sender)]) - (stor8[address(msg.sender)] * sub_4b634b06[address(msg.sender)]):
            revert with 0, 18
        if stor3 > !((stor2 * stor10) + (stor7[address(msg.sender)] * stor3) + (block.timestamp * sub_4b634b06[address(msg.sender)] * stor3) - (stor8[address(msg.sender)] * sub_4b634b06[address(msg.sender)] * stor3) / stor7[address(msg.sender)] + (block.timestamp * sub_4b634b06[address(msg.sender)]) - (stor8[address(msg.sender)] * sub_4b634b06[address(msg.sender)])):
            revert with 0, 17
