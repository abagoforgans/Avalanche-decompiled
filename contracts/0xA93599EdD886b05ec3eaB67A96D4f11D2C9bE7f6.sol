...
function sub_4ae0dbde(?) payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    address(stor7.field_0) = owner
    uint16(stor7.field_160) = 1000
    uint8(stor7.field_176) = 0
}

function royaltyInfo(uint256 arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    if arg2 and stor7.field_160 % 16777216 > -1 / arg2:
        revert with 0, 17
    return address(stor7.field_0), arg2 * stor7.field_160 % 16777216 / 10000
}
