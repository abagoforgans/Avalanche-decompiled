...
function sub_0161a290(?) {
    ...
    mem[ceil32(return_data.size) + 100] = stableCoinAddress
    mem[ceil32(return_data.size) + 132] = sub_3123f8c1Address
    call address(ext_call.return_data[0]).createPair(address arg1, address arg2) with:
         gas gas_remaining wei
        args stableCoinAddress, sub_3123f8c1Address
    ...
    mem[(2 * ceil32(return_data.size)) + 100] = routerAddr
    ...
    stor5 = 1
    mem[64] = (4 * ceil32(return_data.size)) + (32 * stor16.length) + 128
    mem[(4 * ceil32(return_data.size)) + 96] = stor16.length
    if not stor16.length:
        mem[(4 * ceil32(return_data.size)) + (32 * stor16.length) + 128] = 32
        mem[(4 * ceil32(return_data.size)) + (32 * stor16.length) + 160] = stor16.length
        idx = 0
        s = (4 * ceil32(return_data.size)) + 128
        t = (4 * ceil32(return_data.size)) + (32 * stor16.length) + 192
        while idx < stor16.length:
            ...
            continue 
        return memory
          from (4 * ceil32(return_data.size)) + (32 * stor16.length) + 128
           len (96 * stor16.length) + 64
    mem[(4 * ceil32(return_data.size)) + 128] = address(stor16.field_0)
    idx = (4 * ceil32(return_data.size)) + 128
    s = 0
    while (4 * ceil32(return_data.size)) + (32 * stor16.length) + 96 > idx:
    ...
    return memory
      from mem[64]
       len (4 * ceil32(return_data.size)) + (64 * stor16.length) + -mem[64] + 192
}
        ...
        if unknown_0x8f32d59b(?????) <= uint32(call.func_hash) >> 224:
            ...
            if unknown_0x6ddd1713(?????) <= uint32(call.func_hash) >> 224:
                ...
                if unknown_0x40b2f5b5(?????) > uint32(call.func_hash) >> 224:
                    ...
                    require return_data.size >= 32
                    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
                    mem[ceil32(return_data.size) + 132] = stableCoinAddress
                    mem[ceil32(return_data.size) + 164] = sub_3123f8c1Address
                    call address(ext_call.return_data[0]).createPair(address arg1, address arg2) with:
                         gas gas_remaining wei
                        args stableCoinAddress, sub_3123f8c1Address
                    ...
                    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
                    pairAddress = ext_call.return_data[12 len 20]
                    mem[(2 * ceil32(return_data.size)) + 132] = routerAddr
                    ...
                    stor16[stor16.length].field_0 = pairAddress
                    stor5 = 1
                    mem[64] = (4 * ceil32(return_data.size)) + (32 * stor16.length) + 160
                    mem[(4 * ceil32(return_data.size)) + 128] = stor16.length
                    if not stor16.length:
                        mem[(4 * ceil32(return_data.size)) + (32 * stor16.length) + 160] = 32
                        mem[(4 * ceil32(return_data.size)) + (32 * stor16.length) + 192] = stor16.length
                        idx = 0
                        s = (4 * ceil32(return_data.size)) + 160
                        t = (4 * ceil32(return_data.size)) + (32 * stor16.length) + 224
                        while idx < stor16.length:
                            mem[t] = mem[s + 12 len 20]
                            idx = idx + 1
                            s = s + 32
                            ...
                            continue 
                        return memory
                          from (4 * ceil32(return_data.size)) + (32 * stor16.length) + 160
                           len (96 * stor16.length) + 64
                    mem[(4 * ceil32(return_data.size)) + 160] = address(stor16.field_0)
                    idx = (4 * ceil32(return_data.size)) + 160
                    s = 0
                    while (4 * ceil32(return_data.size)) + (32 * stor16.length) + 128 > idx:
                        mem[idx + 32] = stor16[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    return memory
                      from mem[64]
                       len (4 * ceil32(return_data.size)) + (64 * stor16.length) + -mem[64] + 224
                if unknown_0x40b2f5b5(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    return address(sub_40b2f5b5Address)
                        ...
                        if not (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18:
                            ...
                            if not sub_8a9b9d1c:
                                ...
                                while idx < 2:
                                    ...
                                    t = t + 32
                                    continue 
                                mem[(6 * ceil32(return_data.size)) + 420] = address(treasuryAddress)
                                mem[(6 * ceil32(return_data.size)) + 452] = block.timestamp
                                require ext_code.size(routerAddress)
                                call routerAddress.swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                     gas gas_remaining wei
                                ...
                                if not -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18):
                                    ...
                                    if not sub_e70e298e:
                                        ...
                                        call stableCoinAddress with:
                                           funct uint32(0, address(sub_40b2f5b5Address), -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18))
                                             gas gas_remaining wei
                                            args Mask(512, 0, stor6), mem[(6 * ceil32(return_data.size)) + 488 len 9 * ceil32(return_data.size)]
                                        if not return_data.size:
                                            if not ext_call.success:
                                                revert with 0, 'TransferHelper: TRANSFER_FAILED', mem[(6 * ceil32(return_data.size)) + 520 len 9 * ceil32(return_data.size)]
                                            if mem[96]:
                                                require mem[96] >= 32
                                                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                                                if not ext_call.return_data[0]:
                                            ...
                                            if not ext_call.success:
                                                revert with 0, 
                                                            ...
                                                            mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 521 len 9 * ceil32(return_data.size)]
                                            if return_data.size:
                                                require return_data.size >= 32
                                    ...
                                    if not mem[96]:
                                        if not -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18):
                                            ...
                                            if sub_e70e298e:
                                                ...
                                                _20457 = mem[_20275]
                                                if not mem[_20275]:
                                                    emit 0xc20fef04: ext_call.return_data[0], ext_call.return_data[0] * treasuryFee / 100, ext_call.return_data[0] * utilityFee / 100, ext_call.return_data[0] * liquidityFee / 100, mem[_20275]
                                                else:
                                                    mem[mem[64] + 4] = 57005
                                                    mem[mem[64] + 36] = _20457
                                                    call sub_82d90f68Address.0xa9059cbb with:
                                                         gas gas_remaining wei
                                                        args 57005, _20457
                                                    mem[mem[64]] = ext_call.return_data[0]
                                                    ...
                                                    mem[64] = mem[64] + ceil32(return_data.size)
                                                    require return_data.size >= 32
                                                    require mem[_20835] == bool(mem[_20835])
                                                    emit 0xc20fef04: ext_call.return_data[0], ext_call.return_data[0] * treasuryFee / 100, ext_call.return_data[0] * utilityFee / 100, ext_call.return_data[0] * liquidityFee / 100, _20457
                                    else:
                                        require mem[96] >= 32
                                        require ext_call.return_data[0] == bool(ext_call.return_data[0])
                                        if not ext_call.return_data[0]:
                            ...
                            if sub_8a9b9d1c:
                                ...
                                if not -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18):
                                    ...
                                    if sub_e70e298e:
                                        ...
                                        require return_data.size >= 32
                                        if not ext_call.return_data[0]:
                                            emit 0xc20fef04: ext_call.return_data[0], ext_call.return_data[0] * treasuryFee / 100, ext_call.return_data[0] * utilityFee / 100, ext_call.return_data[0] * liquidityFee / 100, ext_call.return_data[0], mem[(10 * ceil32(return_data.size)) + 576 len 5 * ceil32(return_data.size)]
                                        else:
                                            call sub_82d90f68Address.0xa9059cbb with:
                                                 gas gas_remaining wei
                                                args 57005, ext_call.return_data[0], mem[(10 * ceil32(return_data.size)) + 484 len 5 * ceil32(return_data.size)]
                                            if not ext_call.success:
                                                revert with ext_call.return_data[0 len return_data.size]
                                            require return_data.size >= 32
                                            require ext_call.return_data[0] == bool(ext_call.return_data[0])
                                            emit 0xc20fef04: ext_call.return_data[0], ext_call.return_data[0] * treasuryFee / 100, ext_call.return_data[0] * utilityFee / 100, ext_call.return_data[0] * liquidityFee / 100, ext_call.return_data[0], mem[(12 * ceil32(return_data.size)) + 576 len 9 * ceil32(return_data.size)]
