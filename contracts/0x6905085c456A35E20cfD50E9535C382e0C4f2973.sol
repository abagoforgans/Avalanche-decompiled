...
function setOptions(address[] arg1, address[] arg2, uint256 arg3, uint256 arg4, uint256 arg5, bool arg6, bool arg7, bool arg8, bool arg9, uint256 arg10, uint256 arg11, uint256 arg12) {
    ...
    if not arg1.length:
        ...
        while (32 * arg1.length) + 128 > idx:
            address(stor3[s]) = mem[idx + 12 len 20]
            s = s + 1
            idx = idx + 32
            continue 
    ...
    if address(stor3[stor3.length]) == address(stor3[stor3.length]):
        revert with 0, 'BotLibrary: IDENTICAL_ADDRESSES'
    if address(stor3[stor3.length]) < address(stor3[stor3.length]):
        if not address(stor3[stor3.length]):
            revert with 0, 'BotLibrary: ZERO_ADDRESS'
        mem[(32 * arg1.length) + (32 * arg2.length) + 160] = 40
        address(stor15.field_0) = address(sha3(0, stor2, sha3(address(stor3[stor3.length]), uint64(stor3[stor3.length])), stor16))
    else:
        if not address(stor3[stor3.length]):
            revert with 0, 'BotLibrary: ZERO_ADDRESS'
        mem[(32 * arg1.length) + (32 * arg2.length) + 160] = 40
        address(stor15.field_0) = address(sha3(0, stor2, sha3(address(stor3[stor3.length]), uint64(stor3[stor3.length])), stor16))
    require stor3.length - 1 < stor3.length
    tokenAddress = address(stor3[stor3.length])
    require ext_code.size(address(stor3[stor3.length]))
    staticcall address(stor3[stor3.length]).0x70a08231 with:
            gas gas_remaining wei
    ...
    if stor9.length != arg2.length:
        ...
        if not arg2.length:
            ...
            while stor9.length > idx:
                ...
                continue 
    stor8 = arg5
    uint256(stor15.field_0) = 0xffffffffffff00ffff0000ffffffffffffffffffffffffffffffffffffffffff and Mask(32, 224, 0xffffffffffffffff00ffff00ffffffffffffffffffffffffffffffffffffffff and uint256(stor15.field_0)) or Mask(32, 40, arg6) << 184 or Mask(32, 32, arg7) << 192 or Mask(16, 200, 0xffffffffffffffff00ffff00ffffffffffffffffffffffffffffffffffffffff and uint256(stor15.field_0)) or Mask(16, 16, arg6) << 184 or Mask(192, 0, 0xffffffffffffffff00ffff00ffffffffffffffffffffffffffffffffffffffff and uint256(stor15.field_0)) or uint8(arg6) << 184 or arg7 % 16777216 << 192 or arg9 << 216 or arg8 << 200
    stor11 = arg10
    stor10 = 0
    stor13 = 0
    stor12 = arg11
