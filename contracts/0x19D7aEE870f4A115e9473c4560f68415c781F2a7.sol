...
function sub_63894dc7(?) payable {
    return sub_63894dc7
}

function sub_ecd30301(?) payable {
...
function sub_3a12580c(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if sub_ecd30301Address != msg.sender:
        revert with 0, 'Caller is not owner'
    require ext_code.size(0x5b5cfe992adac0c9d48e05854b2d91c73a003858)
    staticcall 0x5b5cfe992adac0c9d48e05854b2d91c73a003858.balanceOf(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_call.return_data[0] == ext_call.return_data[0]
    require ext_code.size(0x5b5cfe992adac0c9d48e05854b2d91c73a003858)
    call 0x5b5cfe992adac0c9d48e05854b2d91c73a003858.withdraw(uint256 rg1) with:
         gas gas_remaining wei
        args ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_207e2c53(?) payable {
    ...
    staticcall 0xd586e7f844cea2f87f50152665bcbc2c279d8d70.balanceOf(address rg1) with:
            gas gas_remaining wei
    ...
    staticcall 0xa7d7079b0fead91f3e65f86e8915cb59c1a4c664.balanceOf(address rg1) with:
            gas gas_remaining wei
           args address(this.address)
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    staticcall 0xc7198437980c041c805a1edcba50c1ce5db95118.balanceOf(address rg1) with:
            gas gas_remaining wei
           args address(this.address)
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    if not arg1:
        if arg2:
            ...
            if not arg3:
                ...
                if not arg4:
                    ...
                    mem[_214 + 64] = mem[_248]
                    mem[mem[64]] = 0x2b6e993a00000000000000000000000000000000000000000000000000000000
                    mem[mem[64] + 4 len 96] = mem[_214 len 96]
                    mem[mem[64] + 100] = 0
                    mem[mem[64] + 132] = 1
                    require ext_code.size(0x7f90122bf0700f9e7e1f688fe926940e8839f353)
                    call 0x7f90122bf0700f9e7e1f688fe926940e8839f353.add_liquidity(uint256[3] rg1, uint256 rg2, bool rg3) with:
        ...
        if arg2:
            ...
            if not arg3:
                ...
                mem[64] = (2 * ceil32(return_data.size)) + 96
                require return_data.size >= 32
                _151 = mem[ceil32(return_data.size) + 96 len 4], ext_call.return_data[0 len 28]
                require mem[ceil32(return_data.size) + 96 len 4], ext_call.return_data[0 len 28] <= test266151307()
                require ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], ext_call.return_data[0 len 28] + 127 < ceil32(return_data.size) + return_data.size + 96
                _155 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], ext_call.return_data[0 len 28] + 96]
                if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], ext_call.return_data[0 len 28] + 96] > test266151307():
                    revert with 'NH{q', 65
                if (2 * ceil32(return_data.size)) + floor32(mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], ext_call.return_data[0 len 28] + 96]) + 97 > test266151307() or floor32(mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], ext_call.return_data[0 len 28] + 96]) + 1 < 0:
                    revert with 'NH{q', 65
                ...
                idx = 0
                s = ceil32(return_data.size) + _151 + 128
                t = (2 * ceil32(return_data.size)) + 128
                while idx < _155:
                    require mem[s] == mem[s]
                    mem[t] = mem[s]
                ...
                if not arg4:
                    ...
                    mem[_216 + 64] = mem[_249]
                    mem[mem[64]] = 0x2b6e993a00000000000000000000000000000000000000000000000000000000
                    mem[mem[64] + 4 len 96] = mem[_216 len 96]
                    mem[mem[64] + 100] = 0
                    mem[mem[64] + 132] = 1
                    require ext_code.size(0x7f90122bf0700f9e7e1f688fe926940e8839f353)
                    call 0x7f90122bf0700f9e7e1f688fe926940e8839f353.add_liquidity(uint256[3] rg1, uint256 rg2, bool rg3) with:
