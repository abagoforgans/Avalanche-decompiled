...
function sub_dd15422b(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require arg1 < sub_dd15422b.length
    return sub_dd15422b[arg1]
}
...
function getMostRecentTokenID() payable {
    if sub_dd15422b.length < 1:
        revert with 'NH{q', 17
    return (sub_dd15422b.length - 1)
}
...
function mint() payable {
    ...
    emit Transfer(0, msg.sender, sub_dd15422b.length + 1);
    sub_dd15422b.length++
    sub_dd15422b[sub_dd15422b.length] = sub_dd15422b.length + 1
}
...
function mintTo(address arg1) payable {
    ...
    emit Transfer(0, arg1, sub_dd15422b.length + 1);
    sub_dd15422b.length++
    sub_dd15422b[sub_dd15422b.length] = sub_dd15422b.length + 1
}
...
function mintMany(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 > -sub_dd15422b.length - 1:
        revert with 'NH{q', 17
    if sub_dd15422b.length > -2:
        revert with 'NH{q', 17
    idx = sub_dd15422b.length + 1
    while idx <= arg1 + sub_dd15422b.length:
        if not msg.sender:
            revert with 0, 'ERC721: mint to the zero address'
        if ownerOf[idx]:
            revert with 0, 'ERC721: token already minted'
        ...
        sub_dd15422b.length++
        mem[0] = 8
        sub_dd15422b[sub_dd15422b.length] = idx
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
