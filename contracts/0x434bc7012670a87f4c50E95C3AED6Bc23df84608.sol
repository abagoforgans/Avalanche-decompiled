...
function swapBack() {
    ...
    if not (ext_call.return_data[0] * liquidityFee / 100 / 2) + (ext_call.return_data[0] * treasuryFee / 100) + (ext_call.return_data[0] * utilityFee / 100):
        ...
        if not (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee):
            revert with 0, 18
        if False and 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee) > 0:
            revert with 0, 17
        if False and 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee) > 0:
            revert with 0, 17
        staticcall sub_82d90f68Address.0x70a08231 with:
                gas gas_remaining wei
               args this.address
