...
function totalEarned() payable {
    ...
    staticcall sub_8a5fcf70Address.valueOfLP(address arg1, uint256 arg2) with:
            gas gas_remaining wei
...
function sub_23ef9abe(?) payable {
    ...
    if not ext_code.size(rewardTokenAddress):
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0
    mem[324 len 0] = 0
    call rewardTokenAddress with:
       funct uint32(stor8)
         gas gas_remaining wei
        args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0) << 256, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0
        ...
        if not sharesOf[address(msg.sender)]:
            ...
            if not -stor18[address(msg.sender)]:
                ...
                if sub_bd58bea0:
                    ...
                    call address(sub_7b805e03Address).vest(address arg1, uint256 arg2) with:
                         gas gas_remaining wei
            ...
            if stor18[address(msg.sender)] > accRewardPerShare * sharesOf[address(msg.sender)] / 10^12:
                revert with 0, 'SafeMath: subtraction overflow'
            if not (accRewardPerShare * sharesOf[address(msg.sender)] / 10^12) - stor18[address(msg.sender)]:
                if not sharesOf[msg.sender]:
                    stor18[msg.sender] = 0
                else:
                    if accRewardPerShare * sharesOf[msg.sender] / sharesOf[msg.sender] != accRewardPerShare:
...
function earned(address arg1) payable {
    ...
    if 0 == totalShares:
        ...
        if 0 == totalShares:
            ...
            require return_data.size >= 64
            require ext_code.size(sub_8a5fcf70Address)
            staticcall sub_8a5fcf70Address.priceOf(address arg1) with:
                    gas gas_remaining wei
