...
const sub_4e20a02c(?) = 23000 * 10^18

const sub_6ee421a6(?) = 0
...
function distributeReward(address arg1, address arg2) payable {
    ...
    if not arg2:
        revert with 0, '!_tornadoPool'
    stor6 = 1
    if not arg1:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply + 23000 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 23000 * 10^18
    if balanceOf[address(arg1)] + 23000 * 10^18 < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 23000 * 10^18
    emit Transfer(23000 * 10^18, 0, arg1);
    if not arg2:
        revert with 0, 'ERC20: mint to the zero address'
