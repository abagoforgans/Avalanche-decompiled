    ...
    if serviceAddress != msg.sender:
        if sub_a66e4e5fAddress != msg.sender:
            if owner != msg.sender:
                revert with 0, 'not service'
    require arg1 < poolInfo.length
    require ext_code.size(0x71efd9389aeef2d661448be11a5f4621469fea8e)
    delegate 0x71efd9389aeef2d661448be11a5f4621469fea8e.0x18f1f18b with:
...
function sub_f9c516ea(?) {
    ...
    require arg1 < poolInfo.length
    require ext_code.size(0x71efd9389aeef2d661448be11a5f4621469fea8e)
    delegate 0x71efd9389aeef2d661448be11a5f4621469fea8e.0x5bc609c6 with:
         gas gas_remaining wei
...
function sub_c0881f2a(?) {
    ...
    if arg4:
        require ext_code.size(0x71efd9389aeef2d661448be11a5f4621469fea8e)
        delegate 0x71efd9389aeef2d661448be11a5f4621469fea8e.0x3b2a018c with:
             gas gas_remaining wei
    ...
    if arg4:
        require arg1 < poolInfo.length
        require ext_code.size(0x71efd9389aeef2d661448be11a5f4621469fea8e)
        delegate 0x71efd9389aeef2d661448be11a5f4621469fea8e.0x434857c7 with:
             gas gas_remaining wei
            args poolInfo[arg1].field_0, poolInfo[arg1].field_256
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        require ext_code.size(0x71efd9389aeef2d661448be11a5f4621469fea8e)
        delegate 0x71efd9389aeef2d661448be11a5f4621469fea8e.0x7b0b708a with:
             gas gas_remaining wei
