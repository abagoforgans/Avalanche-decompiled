    ...
    while idx < _115:
        ...
        if mem[_236] >= _233:
            ...
            call arg2.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                 gas gas_remaining wei
                args _233, 0, 160, msg.sender, block.timestamp + 1, mem[mem[64] + 164 len (32 * _246) + 32]
        else:
            require 0 < mem[mem[(32 * idx) + 128]]
            ...
            if ceil32(_250) <= _250:
                ...
                if not return_data.size:
                    ...
                    if not mem[96]:
                        ...
                        call arg2.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                             gas gas_remaining wei
                            args _233, 0, 160, msg.sender, block.timestamp + 1, mem[mem[64] + 164 len (32 * _389) + 32]
                    else:
                        require mem[96] >= 32
                        require mem[128] == bool(mem[128])
                        if not mem[128]:
                ...
                if not return_data.size:
                    ...
                    if not mem[96]:
                        ...
                        call arg2.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                             gas gas_remaining wei
                            args _233, 0, 160, msg.sender, block.timestamp + 1, mem[mem[64] + 164 len (32 * _403) + 32]
                else:
                    _339 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size) + 1
                    ...
                    if not return_data.size:
                        ...
                        call arg2.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                             gas gas_remaining wei
                            args _233, 0, 160, msg.sender, block.timestamp + 1, mem[mem[64] + 164 len (32 * _394) + 32]
                    else:
                        require return_data.size >= 32
                ...
                if not return_data.size:
                    ...
                    if not mem[96]:
                        ...
                        if ceil32(_1064) <= _1064:
                            mem[mem[64] + 68] = mem[_1034 + 44 len 20]
                            mem[mem[64] + 100] = mem[_1034 + 64]
                            mem[mem[64] + 132] = mem[_1034 + 96]
                            mem[mem[64] + 164] = mem[_1034 + 128]
                            require ext_code.size(arg3)
                            call arg3.exactInput(bytes rg1, address rg2, uint256 rg3, uint256 rg4, uint256 rg5) with:
                                 gas gas_remaining wei
                                args 32, 160, mem[mem[64] + 68 len ceil32(_1064) + 160]
                            mem[mem[64]] = ext_call.return_data[0]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            _1276 = mem[64]
                ...
                if not return_data.size:
                    ...
                    if not return_data.size:
                        ...
                        if ceil32(_1074) <= _1074:
                            mem[_1053 + 68] = mem[_1047 + 44 len 20]
                            mem[_1053 + 100] = mem[_1047 + 64]
                            mem[_1053 + 132] = mem[_1047 + 96]
                            mem[_1053 + 164] = mem[_1047 + 128]
                            require ext_code.size(arg3)
                            call arg3.mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _1053 + ceil32(_1074) + -mem[64] + 224]
                            mem[mem[64]] = ext_call.return_data[0]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            _1282 = mem[64]
