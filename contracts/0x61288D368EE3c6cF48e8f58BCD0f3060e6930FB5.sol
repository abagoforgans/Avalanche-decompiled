...
function sub_99e793d9(?) payable {
    ...
    if ceil32(_33) <= _33:
        ...
        mem[_345] = mem[ceil32(arg4.length) + ceil32(return_data.size) + _29 + 480]
        mem[_345 + 32] = mem[ceil32(arg4.length) + ceil32(return_data.size) + _29 + 512]
        ...
        mem[_345 + 64] = mem[ceil32(arg4.length) + ceil32(return_data.size) + _29 + 544]
        mem[ceil32(arg4.length) + (2 * ceil32(return_data.size)) + 480] = _345
        ...
        if block.timestamp <= mem[_345 + 32]:
        ...
        if block.timestamp > !uint32(3600 * uint32(arg3)):
            revert with 0, 17
        mem[_345 + 32] = block.timestamp + uint32(3600 * uint32(arg3))
        mem[_345 + 64] = uint32(arg3)
        if mem[ceil32(arg4.length) + (2 * ceil32(return_data.size)) + 544] > 2:
            revert with 0, 33
        ...
        mem[64] = mem[64] + 96
        require mem[ceil32(arg4.length) + ceil32(return_data.size) + _29 + 480] == mem[ceil32(arg4.length) + ceil32(return_data.size) + _29 + 492 len 20]
        mem[_347] = mem[ceil32(arg4.length) + ceil32(return_data.size) + _29 + 480]
        mem[_347 + 32] = mem[ceil32(arg4.length) + ceil32(return_data.size) + _29 + 512]
        require mem[ceil32(arg4.length) + ceil32(return_data.size) + _29 + 544] == mem[ceil32(arg4.length) + ceil32(return_data.size) + _29 + 572 len 4]
        mem[_347 + 64] = mem[ceil32(arg4.length) + ceil32(return_data.size) + _29 + 544]
        mem[ceil32(arg4.length) + (2 * ceil32(return_data.size)) + 480] = _347
        mem[ceil32(arg4.length) + (2 * ceil32(return_data.size)) + 512] = mem[ceil32(arg4.length) + ceil32(return_data.size) + _29 + 576]
        require mem[ceil32(arg4.length) + ceil32(return_data.size) + _29 + 608] < 3
        mem[ceil32(arg4.length) + (2 * ceil32(return_data.size)) + 544] = mem[ceil32(arg4.length) + ceil32(return_data.size) + _29 + 608]
        mem[ceil32(arg4.length) + (2 * ceil32(return_data.size)) + 576] = mem[ceil32(arg4.length) + ceil32(return_data.size) + _29 + 640]
        ...
        require mem[ceil32(arg4.length) + ceil32(return_data.size) + _29 + 704] == mem[ceil32(arg4.length) + ceil32(return_data.size) + _29 + 735 len 1]
        mem[ceil32(arg4.length) + (2 * ceil32(return_data.size)) + 640] = mem[ceil32(arg4.length) + ceil32(return_data.size) + _29 + 704]
        if block.timestamp <= mem[_347 + 32]:
            revert with 0, 'NFT already rented'
        mem[mem[64] + 4] = msg.sender
        staticcall masterTokenAddress.0x70a08231 with:
                gas gas_remaining wei
        ...
        if block.timestamp > !uint32(3600 * uint32(arg3)):
            revert with 0, 17
        mem[_347 + 32] = block.timestamp + uint32(3600 * uint32(arg3))
        mem[_347 + 64] = uint32(arg3)
        if mem[ceil32(arg4.length) + (2 * ceil32(return_data.size)) + 544] > 2:
            revert with 0, 33
        if arg2 / 10000 and stor9 > -1 / arg2 / 10000:
            revert with 0, 17
    ...
    if mem[ceil32(arg4.length) + (2 * ceil32(return_data.size)) + 544] >= 3:
        revert with 0, 33
    mem[mem[64] + 324] = mem[ceil32(arg4.length) + (2 * ceil32(return_data.size)) + 544]
    ...
    call nFTContractAddress.0x29a90305 with:
         gas gas_remaining wei
        args arg1, 64, mem[mem[64] + 68], 384, mem[mem[64] + 132 len 64], msg.sender, block.timestamp + uint32(3600 * uint32(arg3)), 0, mem[mem[64] + 292 len 160], _33, mem[mem[64] + 484 len ceil32(_33)]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
