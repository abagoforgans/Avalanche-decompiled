                ...
                if not ext_call.success:
                    ...
                    if not return_data.size:
                        ...
                        if not stor0[address(ext_call.return_data[0])]:
                            ...
                            return (ext_call.return_data[0] * stor2[address(ext_call.return_data[0])] / 10^18)
                    ('bool', ('stor', ('map', ('mask_shl', 160, 0, 0, ('ext_call.return_data', 0, 32)), ('name', 'stor0', 0))))
                    require ext_code.size(stor0[address(ext_call.return_data[0])])
                    staticcall stor0[address(ext_call.return_data[0])].latestRoundData() with:
                            gas gas_remaining wei
                    if not ext_call.success:
            ...
            if address(ext_call.return_data[0]) != arg1:
                if not stor0[address(ext_call.return_data[0])]:
                    if not stor2[address(ext_call.return_data[0])]:
                        if Mask(112, 0, ext_call.return_data[32]):
                            ...
                            if not return_data.size:
                                if not ext_call.success:
                                    mem[168 len 28] = ext_call.return_data[72 len 24], mem[192 len 4]
                                    mem[168 len 0] = None
                                    staticcall arg1.mem[168 len 4] with:
                                            gas gas_remaining wei
                                    if not ext_call.success:
                                        ...
                                        if not stor0[address(ext_call.return_data[0])]:
                                            ...
                                            if ext_call.return_data[0] * stor2[address(ext_call.return_data[0])] / stor2[address(ext_call.return_data[0])] != ext_call.return_data[0]:
                                                revert with 0, 
                                                            ...
                                                            33,
                                                            0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                                            mem[(2 * ceil32(return_data.size)) + 271 len 31]
                                            return (ext_call.return_data[0] * stor2[address(ext_call.return_data[0])] / 10^18)
                                    ('bool', ('stor', ('map', ('mask_shl', 160, 0, 0, ('ext_call.return_data', 0, 32)), ('name', 'stor0', 0))))
                                    require ext_code.size(stor0[address(ext_call.return_data[0])])
                                    staticcall stor0[address(ext_call.return_data[0])].latestRoundData() with:
                        ...
                        if Mask(112, 0, ext_call.return_data[32]):
                            if stor2[address(ext_call.return_data[0])] * Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[32]):
                                return (stor2[address(ext_call.return_data[0])] * Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[32]))
                            staticcall arg1 with:
                                 funct ext_call.return_data[36 len 4]
                                    gas gas_remaining wei
                    ...
                    require return_data.size >= 160
                    if Mask(112, 0, ext_call.return_data[32]):
                        if 10^stor1[address(ext_call.return_data[0])].field_0 * ext_call.return_data[32] * Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[32]):
                            return (10^stor1[address(ext_call.return_data[0])].field_0 * ext_call.return_data[32] * Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[32]))
                        staticcall arg1 with:
                             funct ext_call.return_data[36 len 4]
                                gas gas_remaining wei
                        if not return_data.size:
                            if not ext_call.success:
                                staticcall arg1 with:
                                     funct ext_call.return_data[72 len 4]
                                        gas gas_remaining wei
                                if not ext_call.success:
                                    return 0
                                require ext_code.size(arg1)
                ...
                if not stor0[ext_call.return_data[12 len 20]]:
                    if not stor2[address(ext_call.return_data[0])]:
                        ...
                        if Mask(112, 0, ext_call.return_data[0]):
                            if stor2[address(ext_call.return_data[0])] * Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0]):
                                return (stor2[address(ext_call.return_data[0])] * Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0]))
                            staticcall arg1 with:
                                 funct Mask(32, 224, ext_call.return_data[60 len 4]) >> 224 or Mask(32, 192, ext_call.return_data[36 len 28]) >> 192
                                    gas gas_remaining wei
                            if not return_data.size:
                                if not ext_call.success:
                                    staticcall arg1 with:
                    ...
                    require return_data.size >= 160
                    if Mask(112, 0, ext_call.return_data[0]):
                        if 10^stor1[address(ext_call.return_data[0])].field_0 * ext_call.return_data[32] * Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0]):
                            return (10^stor1[address(ext_call.return_data[0])].field_0 * ext_call.return_data[32] * Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0]))
                        staticcall arg1 with:
                             funct Mask(32, 224, ext_call.return_data[60 len 4]) >> 224 or Mask(32, 192, ext_call.return_data[36 len 28]) >> 192
                                gas gas_remaining wei
            ...
            if address(ext_call.return_data[0]) != arg1:
                if not stor0[address(ext_call.return_data[0])]:
                    if not stor2[address(ext_call.return_data[0])]:
                        if Mask(112, 0, ext_call.return_data[32]):
                            if 0 / Mask(112, 0, ext_call.return_data[32]):
                                return 1, 0 / Mask(112, 0, ext_call.return_data[32])
                            staticcall arg1 with:
                                 funct ext_call.return_data[36 len 4]
                                    gas gas_remaining wei
                            if not return_data.size:
                        ...
                        if Mask(112, 0, ext_call.return_data[32]):
                            if stor2[address(ext_call.return_data[0])] * Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[32]):
                                return 1, 
                                       stor2[address(ext_call.return_data[0])] * Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[32])
                            staticcall arg1 with:
                                 funct ext_call.return_data[36 len 4]
                                    gas gas_remaining wei
                            if not return_data.size:
                    ...
                    if Mask(112, 0, ext_call.return_data[32]):
                        if 10^stor1[address(ext_call.return_data[0])].field_0 * ext_call.return_data[32] * Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[32]):
                            return 1, 
                                   10^stor1[address(ext_call.return_data[0])].field_0 * ext_call.return_data[32] * Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[32])
                        staticcall arg1 with:
                             funct ext_call.return_data[36 len 4]
                                gas gas_remaining wei
                        if not return_data.size:
                ...
                if not stor0[ext_call.return_data[12 len 20]]:
                    if not stor2[address(ext_call.return_data[0])]:
                        if Mask(112, 0, ext_call.return_data[0]):
                            if 0 / Mask(112, 0, ext_call.return_data[0]):
                                return 1, 0 / Mask(112, 0, ext_call.return_data[0])
                            staticcall arg1 with:
                                 funct Mask(32, 224, ext_call.return_data[60 len 4]) >> 224 or Mask(32, 192, ext_call.return_data[36 len 28]) >> 192
                                    gas gas_remaining wei
                            if not return_data.size:
                        ...
                        if Mask(112, 0, ext_call.return_data[0]):
                            if stor2[address(ext_call.return_data[0])] * Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0]):
                                return 1, 
                                       stor2[address(ext_call.return_data[0])] * Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0])
                            staticcall arg1 with:
                                 funct ext_call.return_data[36 len 4]
                                    gas gas_remaining wei
                            if not return_data.size:
                    ...
                    if Mask(112, 0, ext_call.return_data[0]):
                        if 10^stor1[address(ext_call.return_data[0])].field_0 * ext_call.return_data[32] * Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0]):
                            return 1, 
                                   10^stor1[address(ext_call.return_data[0])].field_0 * ext_call.return_data[32] * Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0])
                        staticcall arg1 with:
                             funct Mask(32, 224, ext_call.return_data[60 len 4]) >> 224 or Mask(32, 192, ext_call.return_data[36 len 28]) >> 192
                                gas gas_remaining wei
                        if not return_data.size:
