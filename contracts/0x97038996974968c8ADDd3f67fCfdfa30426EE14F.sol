...
function executeProposal(bytes32 arg1, bytes arg2) payable {
    ...
    if not stor4[stor1[arg1]]:
        ...
        call _resourceIDToTokenContract[arg1].0x23b872dd with:
             gas gas_remaining wei
        ...
        require ext_code.size(_resourceIDToTokenContract[arg1])
        call _resourceIDToTokenContract[arg1].0xd3fc9864 with:
             gas gas_remaining wei
...
function getDepositRecord(uint64 arg1, uint8 arg2) payable {
    ...
    require arg1 == arg1
    require arg2 == arg2
    mem[640] = stor5[arg2 << 248][arg1 << 192][2].field_0
    idx = 640
    s = 0
    while stor5[arg2 << 248][arg1 << 192][2].length + 608 > idx:
        mem[idx + 32] = stor5[arg2 << 248][arg1 << 192][s + 2].field_256
        idx = idx + 32
        s = s + 1
        continue 
    mem[ceil32(stor5[arg2 << 248][arg1 << 192][2].length) + 672] = stor5[arg2 << 248][arg1 << 192][5].field_0
    idx = ceil32(stor5[arg2 << 248][arg1 << 192][2].length) + 672
    s = 0
    while ceil32(stor5[arg2 << 248][arg1 << 192][2].length) + stor5[arg2 << 248][arg1 << 192][5].length + 640 > idx:
        mem[idx + 32] = stor5[arg2 << 248][arg1 << 192][s + 5].field_256
        idx = idx + 32
        s = s + 1
        continue 
    if ceil32(stor5[arg2 << 248][arg1 << 192][2].length) <= stor5[arg2 << 248][arg1 << 192][2].length:
        mem[(2 * ceil32(stor5[arg2 << 248][arg1 << 192][2].length)) + ceil32(stor5[arg2 << 248][arg1 << 192][5].length) + 992] = stor5[arg2 << 248][arg1 << 192][5].length
        mem[(2 * ceil32(stor5[arg2 << 248][arg1 << 192][2].length)) + ceil32(stor5[arg2 << 248][arg1 << 192][5].length) + 1024 len ceil32(stor5[arg2 << 248][arg1 << 192][5].length)] = mem[ceil32(stor5[arg2 << 248][arg1 << 192][2].length) + 672 len ceil32(stor5[arg2 << 248][arg1 << 192][5].length)]
        if ceil32(stor5[arg2 << 248][arg1 << 192][5].length) > stor5[arg2 << 248][arg1 << 192][5].length:
            mem[(2 * ceil32(stor5[arg2 << 248][arg1 << 192][2].length)) + ceil32(stor5[arg2 << 248][arg1 << 192][5].length) + stor5[arg2 << 248][arg1 << 192][5].length + 1024] = 0
        return 32, stor5[arg2 << 248][arg1 << 192].field_0, 
               ...
               ceil32(stor5[arg2 << 248][arg1 << 192][2].length) + 288,
               stor5[arg2 << 248][arg1 << 192][2].length,
               mem[640 len ceil32(stor5[arg2 << 248][arg1 << 192][2].length)],
               stor5[arg2 << 248][arg1 << 192][5].length,
               mem[ceil32(stor5[arg2 << 248][arg1 << 192][2].length) + 672 len ceil32(stor5[arg2 << 248][arg1 << 192][5].length)]
    mem[ceil32(stor5[arg2 << 248][arg1 << 192][2].length) + ceil32(stor5[arg2 << 248][arg1 << 192][5].length) + stor5[arg2 << 248][arg1 << 192][2].length + 992] = 0
    mem[(2 * ceil32(stor5[arg2 << 248][arg1 << 192][2].length)) + ceil32(stor5[arg2 << 248][arg1 << 192][5].length) + 992] = stor5[arg2 << 248][arg1 << 192][5].length
    mem[(2 * ceil32(stor5[arg2 << 248][arg1 << 192][2].length)) + ceil32(stor5[arg2 << 248][arg1 << 192][5].length) + 1024 len ceil32(stor5[arg2 << 248][arg1 << 192][5].length)] = mem[ceil32(stor5[arg2 << 248][arg1 << 192][2].length) + 672 len ceil32(stor5[arg2 << 248][arg1 << 192][5].length)]
    if ceil32(stor5[arg2 << 248][arg1 << 192][5].length) > stor5[arg2 << 248][arg1 << 192][5].length:
        mem[(2 * ceil32(stor5[arg2 << 248][arg1 << 192][2].length)) + ceil32(stor5[arg2 << 248][arg1 << 192][5].length) + stor5[arg2 << 248][arg1 << 192][5].length + 1024] = 0
    return 32, stor5[arg2 << 248][arg1 << 192].field_0, 
           ...
           ceil32(stor5[arg2 << 248][arg1 << 192][2].length) + 288,
           stor5[arg2 << 248][arg1 << 192][2].length,
           mem[640 len stor5[arg2 << 248][arg1 << 192][2].length],
           0,
           mem[ceil32(stor5[arg2 << 248][arg1 << 192][2].length) + ceil32(stor5[arg2 << 248][arg1 << 192][5].length) + stor5[arg2 << 248][arg1 << 192][2].length + 1024 len ceil32(stor5[arg2 << 248][arg1 << 192][2].length) + ceil32(stor5[arg2 << 248][arg1 << 192][5].length) - stor5[arg2 << 248][arg1 << 192][2].length]
}
