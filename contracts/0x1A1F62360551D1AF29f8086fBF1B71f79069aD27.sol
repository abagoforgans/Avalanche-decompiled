...
function sub_00d7fce0(?) payable {
    ...
    if not return_data.size:
        ...
        if ext_code.size(stor0) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = approve(address arg1, uint256 arg2), 0x4456b87af11e87e329ab7d7c, 0, ext_call.return_data[0 len 28]
        call stor0.0xac2168b9 with:
             gas gas_remaining wei
        ...
        if return_data.size <= 0:
            ...
            if not ext_call.return_data[0]:
                if ext_code.size(stor0) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 425 len 64] = approve(address arg1, uint256 arg2), 0x4456b87af11e87e329ab7d7c, 0, ext_call.return_data[0 len 28]
