    ...
    if not arg2:
        ...
        if ext_call.return_data[0] >= ext_call.return_data[0]:
            ...
            if mem[_603] < ext_call.return_data[0]:
                revert with 0, 17
            if mem[_603] - ext_call.return_data[0] < arg3:
            ...
            if mem[_604] < ext_call.return_data[0]:
                revert with 0, 17
            if mem[_604] - ext_call.return_data[0] < arg3:
                revert with 0, 'output not enough'
            if target[address(arg4)] < ext_call.return_data[0]:
                revert with 0, 17
            target[address(arg4)] -= ext_call.return_data[0]
        ...
        if ext_call.return_data[0] >= arg2:
            ...
            if ext_call.return_data[0] >= arg2:
                ...
                if mem[_599] < ext_call.return_data[0]:
                    revert with 0, 17
                if mem[_599] - ext_call.return_data[0] < arg3:
                    revert with 0, 'output not enough'
                ...
                if mem[_600] < ext_call.return_data[0]:
                    revert with 0, 17
                if mem[_600] - ext_call.return_data[0] < arg3:
                    revert with 0, 'output not enough'
                if target[address(arg4)] < arg2:
                    revert with 0, 17
                target[address(arg4)] -= arg2
            ...
            if ext_call.return_data[0] >= ext_call.return_data[0]:
                ...
                if mem[_601] < ext_call.return_data[0]:
                    revert with 0, 17
                if mem[_601] - ext_call.return_data[0] < arg3:
                    revert with 0, 'output not enough'
                if target[address(arg4)] < ext_call.return_data[0]:
                    revert with 0, 17
                target[address(arg4)] -= ext_call.return_data[0]
                ...
                if mem[_602] < ext_call.return_data[0]:
                    revert with 0, 17
                if mem[_602] - ext_call.return_data[0] < arg3:
                    revert with 0, 'output not enough'
                if target[address(arg4)] < ext_call.return_data[0]:
                    revert with 0, 17
                target[address(arg4)] -= ext_call.return_data[0]
                    ...
                    while idx <= stor3:
                        ...
                        if not mem[_557 + 31 len 1]:
                            ...
                            if mem[_631]:
                                ...
                                call tokenList[idx].0xa9059cbb with:
                                     gas gas_remaining wei
                                    args address(stor0.field_0), _639
                                mem[mem[64]] = ext_call.return_data[0]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _673 = mem[64]
                            ...
                            if bool(bool(mem[_557 + 31 len 1] < 78)) or bool(bool(mem[_557 + 31 len 1] < 32)):
                                if False and 10^mem[_557 + 31 len 1] > 0:
                                    revert with 0, 17
                                mem[mem[64] + 4] = this.address
                                require ext_code.size(tokenList[idx])
                                staticcall tokenList[idx].0x70a08231 with:
                                ...
                                if mem[_655]:
                                    ...
                                    call tokenList[idx].0xa9059cbb with:
                                         gas gas_remaining wei
                                        args address(stor0.field_0), _666
                                    mem[mem[64]] = ext_call.return_data[0]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    _708 = mem[64]
                                ...
                                if mem[_895]:
                                    ...
                                    call tokenList[idx].0xa9059cbb with:
                                         gas gas_remaining wei
                                        args address(stor0.field_0), _902
                                    mem[mem[64]] = ext_call.return_data[0]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    _935 = mem[64]
                    ...
                    if not arg2:
                        ...
                        if ext_call.return_data[0] >= ext_call.return_data[0]:
                            ...
                            if mem[_867] < ext_call.return_data[0]:
                                revert with 0, 17
                            if mem[_867] - ext_call.return_data[0] < arg3:
                                revert with 0, 'output not enough'
                            if target[address(arg4)] < ext_call.return_data[0]:
                                revert with 0, 17
                            target[address(arg4)] -= ext_call.return_data[0]
                            ...
                            if mem[_868] < ext_call.return_data[0]:
                                revert with 0, 17
                            if mem[_868] - ext_call.return_data[0] < arg3:
                                revert with 0, 'output not enough'
                            if target[address(arg4)] < ext_call.return_data[0]:
                                revert with 0, 17
                            target[address(arg4)] -= ext_call.return_data[0]
                        ...
                        if ext_call.return_data[0] >= arg2:
                            ...
                            if ext_call.return_data[0] >= arg2:
                                ...
                                mem[64] = (6 * ceil32(return_data.size)) + 224
                                require return_data.size >= 32
                                _565 = mem[(4 * ceil32(return_data.size)) + 224 len 4], Mask(224, 32, arg2) >> 32
                                ...
                                _571 = mem[(4 * ceil32(return_data.size)) + mem[(4 * ceil32(return_data.size)) + 224 len 4], Mask(224, 32, arg2) >> 32 + 224]
                                ...
                                mem[(6 * ceil32(return_data.size)) + 224] = _571
                                require return_data.size >= _565 + (32 * _571) + 32
                                mem[(6 * ceil32(return_data.size)) + 256 len 32 * _571] = mem[(4 * ceil32(return_data.size)) + _565 + 256 len 32 * _571]
                                mem[mem[64] + 4] = this.address
                                require ext_code.size(address(arg5))
                                staticcall address(arg5).0x70a08231 with:
                                        gas gas_remaining wei
                                ...
                                mem[64] = mem[64] + ceil32(return_data.size)
                                require return_data.size >= 32
                                if ext_call.return_data[0] > mem[_863]:
                                    revert with 0, 'SafeMath: subtraction overflow', 0
                                if mem[_863] < ext_call.return_data[0]:
                                    revert with 0, 17
                                if mem[_863] - ext_call.return_data[0] < arg3:
                                    revert with 0, 'output not enough'
                                if target[address(arg4)] < arg2:
                                    revert with 0, 17
                                target[address(arg4)] -= arg2
                                if arg6 <= mem[_863] - ext_call.return_data[0]:
                                    if target[address(arg5)] > !arg6:
                                        revert with 0, 17
                                    target[address(arg5)] += arg6
                                else:
                                    if target[address(arg5)] > !(mem[_863] - ext_call.return_data[0]):
                                        revert with 0, 17
                                    target[address(arg5)] = target[address(arg5)] + mem[_863] - ext_call.return_data[0]
                            else:
                                mem[(2 * ceil32(return_data.size)) + 132] = address(arg1)
                                mem[(2 * ceil32(return_data.size)) + 164] = test266151307()
                                require ext_code.size(address(arg4))
                                ...
                                mem[64] = (7 * ceil32(return_data.size)) + 224
                                require return_data.size >= 32
                                _566 = mem[(6 * ceil32(return_data.size)) + 224 len 4], Mask(224, 32, arg2) >> 32
                                ...
                                _572 = mem[(6 * ceil32(return_data.size)) + mem[(6 * ceil32(return_data.size)) + 224 len 4], Mask(224, 32, arg2) >> 32 + 224]
                                ...
                                require return_data.size >= _566 + (32 * _572) + 32
                                mem[(7 * ceil32(return_data.size)) + 256 len 32 * _572] = mem[(6 * ceil32(return_data.size)) + _566 + 256 len 32 * _572]
                                mem[mem[64] + 4] = this.address
                                require ext_code.size(address(arg5))
                                staticcall address(arg5).0x70a08231 with:
                                        gas gas_remaining wei
                                ...
                                mem[64] = mem[64] + ceil32(return_data.size)
                                require return_data.size >= 32
                                if ext_call.return_data[0] > mem[_864]:
                                    revert with 0, 'SafeMath: subtraction overflow', 0
                                if mem[_864] < ext_call.return_data[0]:
                                    revert with 0, 17
                                if mem[_864] - ext_call.return_data[0] < arg3:
                                    revert with 0, 'output not enough'
                                if target[address(arg4)] < arg2:
                                    revert with 0, 17
                                target[address(arg4)] -= arg2
                                if arg6 <= mem[_864] - ext_call.return_data[0]:
                                    if target[address(arg5)] > !arg6:
                                        revert with 0, 17
                                    target[address(arg5)] += arg6
                                else:
                                    if target[address(arg5)] > !(mem[_864] - ext_call.return_data[0]):
                                        revert with 0, 17
                                    target[address(arg5)] = target[address(arg5)] + mem[_864] - ext_call.return_data[0]
                        else:
                            if ext_call.return_data[0] > target[address(arg4)]:
                                revert with 0, 'target not enough'
                            if ext_call.return_data[0] <= 0:
                            ...
                            if ext_call.return_data[0] >= ext_call.return_data[0]:
                                ...
                                mem[64] = (6 * ceil32(return_data.size)) + 224
                                require return_data.size >= 32
                                _567 = mem[(4 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28]
                                require mem[(4 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28] <= test266151307()
                                require (4 * ceil32(return_data.size)) + mem[(4 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28] + 255 < (4 * ceil32(return_data.size)) + return_data.size + 224
                                _573 = mem[(4 * ceil32(return_data.size)) + mem[(4 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28] + 224]
                                if mem[(4 * ceil32(return_data.size)) + mem[(4 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28] + 224] > test266151307():
                                    revert with 0, 65
                                if (6 * ceil32(return_data.size)) + ceil32(32 * mem[(4 * ceil32(return_data.size)) + mem[(4 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28] + 224]) + 225 > test266151307() or ceil32(32 * mem[(4 * ceil32(return_data.size)) + mem[(4 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28] + 224]) + 1 < 0:
                                    revert with 0, 65
                                ...
                                if mem[_865] < ext_call.return_data[0]:
                                    revert with 0, 17
                                if mem[_865] - ext_call.return_data[0] < arg3:
                                    revert with 0, 'output not enough'
                                if target[address(arg4)] < ext_call.return_data[0]:
                                    revert with 0, 17
                                target[address(arg4)] -= ext_call.return_data[0]
                                ...
                                mem[64] = (7 * ceil32(return_data.size)) + 224
                                require return_data.size >= 32
                                _568 = mem[(6 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28]
                                require mem[(6 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28] <= test266151307()
                                require (6 * ceil32(return_data.size)) + mem[(6 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28] + 255 < (6 * ceil32(return_data.size)) + return_data.size + 224
                                _574 = mem[(6 * ceil32(return_data.size)) + mem[(6 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28] + 224]
                                if mem[(6 * ceil32(return_data.size)) + mem[(6 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28] + 224] > test266151307():
                                    revert with 0, 65
                                if (7 * ceil32(return_data.size)) + ceil32(32 * mem[(6 * ceil32(return_data.size)) + mem[(6 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28] + 224]) + 225 > test266151307() or ceil32(32 * mem[(6 * ceil32(return_data.size)) + mem[(6 * ceil32(return_data.size)) + 224 len 4], ext_call.return_data[0 len 28] + 224]) + 1 < 0:
                                    revert with 0, 65
                                ...
                                if mem[_866] < ext_call.return_data[0]:
                                    revert with 0, 17
                                if mem[_866] - ext_call.return_data[0] < arg3:
                                    revert with 0, 'output not enough'
                                if target[address(arg4)] < ext_call.return_data[0]:
                                    revert with 0, 17
                                target[address(arg4)] -= ext_call.return_data[0]
