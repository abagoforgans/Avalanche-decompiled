            ...
            if ext_call.return_data[0] * REINVEST_REWARD_BIPS / 10000 <= 0:
                ...
                if rewardTokenAddress == stor10:
                    ...
                    call routerAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                         gas gas_remaining wei
                        args Mask(255, 1, ext_call.return_data[0] - (ext_call.return_data[0] * REINVEST_REWARD_BIPS / 10000)), _2110, 160, address(this.address), block.timestamp, mem[mem[64] + 164 len (32 * _2134) + 32]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _2980 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                    ...
                    if mem[_3789 + 44 len 20] == stor11:
                        ...
                        call routerAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                             gas gas_remaining wei
                            args Mask(255, 1, ext_call.return_data[0] - (ext_call.return_data[0] * REINVEST_REWARD_BIPS / 10000)), _4888, 160, address(this.address), block.timestamp, mem[mem[64] + 164 len (32 * _4900) + 32]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        _5152 = mem[64]
                        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                if rewardTokenAddress == stor10:
                    ...
                    mem[_2115 + 132] = block.timestamp
                    require ext_code.size(routerAddress)
                    call routerAddress.mem[mem[64] len 4] with:
                         gas gas_remaining wei
                        args mem[mem[64] + 4 len _2115 + (32 * _2136) + -mem[64] + 192]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _2982 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                    ...
                    if mem[_3792 + 44 len 20] == stor11:
                        ...
                        call routerAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                             gas gas_remaining wei
                            args Mask(255, 1, ext_call.return_data[0] - (ext_call.return_data[0] * REINVEST_REWARD_BIPS / 10000)), _4890, 160, address(this.address), block.timestamp, mem[mem[64] + 164 len (32 * _4901) + 32]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        _5153 = mem[64]
                        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        if ext_call.return_data[0] * ADMIN_FEE_BIPS / 10000 <= 0:
            if not ext_call.return_data[0]:
                ...
                if rewardTokenAddress == stor10:
                    ...
                    call routerAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                         gas gas_remaining wei
                        args Mask(255, 1, ext_call.return_data[0] - (ext_call.return_data[0] * ADMIN_FEE_BIPS / 10000)), _2094, 160, address(this.address), block.timestamp, mem[mem[64] + 164 len (32 * _2126) + 32]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _2972 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                    ...
                    if mem[_3777 + 44 len 20] == stor11:
                        ...
                        mem[_4881 + 132] = block.timestamp
                        require ext_code.size(routerAddress)
                        call routerAddress.mem[mem[64] len 4] with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _4881 + (32 * _4896) + -mem[64] + 192]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        _5148 = mem[64]
                        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                if ext_call.return_data[0] * REINVEST_REWARD_BIPS / 10000 <= 0:
                    ...
                    if rewardTokenAddress == stor10:
                        ...
                        mem[_2089 + 132] = block.timestamp
                        require ext_code.size(routerAddress)
                        call routerAddress.mem[mem[64] len 4] with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _2089 + (32 * _2123) + -mem[64] + 192]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        _2969 = mem[64]
                        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                    ...
                    if rewardTokenAddress == stor10:
                        ...
                        mem[_2091 + 132] = block.timestamp
                        require ext_code.size(routerAddress)
                        call routerAddress.mem[mem[64] len 4] with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _2091 + (32 * _2124) + -mem[64] + 192]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        _2970 = mem[64]
                        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if not ext_call.return_data[0]:
                ...
                if ext_call.return_data[0] * REINVEST_REWARD_BIPS / 10000 <= 0:
                    ...
                    if rewardTokenAddress == stor10:
                        ...
                        call routerAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                             gas gas_remaining wei
                            args Mask(255, 1, ext_call.return_data[0] - (ext_call.return_data[0] * ADMIN_FEE_BIPS / 10000) - (ext_call.return_data[0] * REINVEST_REWARD_BIPS / 10000)), _2100, 160, address(this.address), block.timestamp, mem[mem[64] + 164 len (32 * _2129) + 32]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        _2975 = mem[64]
                        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                    ...
                    if rewardTokenAddress == stor10:
                        ...
                        if rewardTokenAddress == stor11:
                            ...
                            mem[(6 * ceil32(return_data.size)) + 608] = _1118
