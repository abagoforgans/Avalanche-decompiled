...
function _fallback() {
    mem[96 len -6805] = code.data[7395 len -6805]
    mem[64] = -6709
...
function confirmTransaction(uint256 arg1) {
    require stor2[address(msg.sender)]
    require address(stor0[arg1].field_0) != 0
...
function submitTransaction(address arg1, uint256 arg2, bytes arg3) {
    ...
    require stor2[address(msg.sender)]
    require address(stor0[stor5].field_0) != 0
