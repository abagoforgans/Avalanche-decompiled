    ...
    while idx < arg1:
        ...
        if msg.sender:
            ...
            if ext_code.size(msg.sender) > 0:
                ...
                require return_data.size >= 32
                require mem[_213] == Mask(32, 224, mem[_213])
                if Mask(32, 224, mem[_213]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                    revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
        else:
            if tokenByIndex.length < 1:
                revert with 'NH{q', 17
            ...
            if ext_code.size(msg.sender) > 0:
                ...
                mem[64] = mem[64] + ceil32(return_data.size)
                require return_data.size >= 32
                require mem[_214] == Mask(32, 224, mem[_214])
                if Mask(32, 224, mem[_214]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                    revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
        mem[mem[64]] = tokenByIndex.length
        mem[mem[64] + 32] = msg.sender
        emit 0x3eb4c124: tokenByIndex.length, msg.sender
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
