    ...
    if block.timestamp >= stor1[address(msg.sender)].field_1280:
        ...
        if not arg1:
            ...
            call stakingAddress.stake(uint256 arg1, address arg2) with:
                 gas gas_remaining wei
                args stor1[address(msg.sender)].field_256 - stor1[address(msg.sender)].field_512, msg.sender
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if not stor1[address(msg.sender)].field_256:
            ...
            if block.timestamp - stor1[address(msg.sender)].field_1536 / epochLength < 1:
                ...
                if not arg1:
                    ...
                    call stakingAddress.stake(uint256 arg1, address arg2) with:
                         gas gas_remaining wei
                        args -stor1[address(msg.sender)].field_512, msg.sender
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if not block.timestamp - stor1[address(msg.sender)].field_1536 / epochLength:
                    ...
                    if stor1[address(msg.sender)].field_512 + (block.timestamp - stor1[address(msg.sender)].field_1536 / epochLength * 0 / stor1[address(msg.sender)].field_1280 - stor1[address(msg.sender)].field_1024 / epochLength) <= 0:
                        ...
                        if not arg1:
                            call treasuryAddress.mintRewards(address arg1, uint256 arg2) with:
                                 gas gas_remaining wei
                                args msg.sender, block.timestamp - stor1[address(msg.sender)].field_1536 / epochLength * 0 / stor1[address(msg.sender)].field_1280 - stor1[address(msg.sender)].field_1024 / epochLength
                        else:
                            call treasuryAddress.mintRewards(address arg1, uint256 arg2) with:
                                 gas gas_remaining wei
                                args address(this.address), block.timestamp - stor1[address(msg.sender)].field_1536 / epochLength * 0 / stor1[address(msg.sender)].field_1280 - stor1[address(msg.sender)].field_1024 / epochLength
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(tokenAddress)
                            call tokenAddress.approve(address arg1, uint256 arg2) with:
                            ...
                            call stakingAddress.stake(uint256 arg1, address arg2) with:
                                 gas gas_remaining wei
                                args block.timestamp - stor1[address(msg.sender)].field_1536 / epochLength * 0 / stor1[address(msg.sender)].field_1280 - stor1[address(msg.sender)].field_1024 / epochLength, msg.sender
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if stor1[address(msg.sender)].field_512 > (-1 * block.timestamp - stor1[address(msg.sender)].field_1536 / epochLength * 0 / stor1[address(msg.sender)].field_1280 - stor1[address(msg.sender)].field_1024 / epochLength) - 1:
                            revert with 'NH{q', 17
            ...
            if block.timestamp - stor1[address(msg.sender)].field_1536 / epochLength < 1:
                ...
                if not arg1:
                    ...
                    call stakingAddress.stake(uint256 arg1, address arg2) with:
                         gas gas_remaining wei
                        args (stor1[address(msg.sender)].field_256 * rebaseRate / 10000) - stor1[address(msg.sender)].field_512, msg.sender
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if not block.timestamp - stor1[address(msg.sender)].field_1536 / epochLength:
                    ...
                    if stor1[address(msg.sender)].field_512 + (block.timestamp - stor1[address(msg.sender)].field_1536 / epochLength * stor1[address(msg.sender)].field_256 * rebaseRate / 10000 / stor1[address(msg.sender)].field_1280 - stor1[address(msg.sender)].field_1024 / epochLength) <= stor1[address(msg.sender)].field_256 * rebaseRate / 10000:
                        ...
                        if not arg1:
                            call treasuryAddress.mintRewards(address arg1, uint256 arg2) with:
                                 gas gas_remaining wei
                                args msg.sender, block.timestamp - stor1[address(msg.sender)].field_1536 / epochLength * stor1[address(msg.sender)].field_256 * rebaseRate / 10000 / stor1[address(msg.sender)].field_1280 - stor1[address(msg.sender)].field_1024 / epochLength
                        else:
                            call treasuryAddress.mintRewards(address arg1, uint256 arg2) with:
                                 gas gas_remaining wei
                                args address(this.address), block.timestamp - stor1[address(msg.sender)].field_1536 / epochLength * stor1[address(msg.sender)].field_256 * rebaseRate / 10000 / stor1[address(msg.sender)].field_1280 - stor1[address(msg.sender)].field_1024 / epochLength
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(tokenAddress)
                            call tokenAddress.approve(address arg1, uint256 arg2) with:
                            ...
                            call stakingAddress.stake(uint256 arg1, address arg2) with:
                                 gas gas_remaining wei
                                args block.timestamp - stor1[address(msg.sender)].field_1536 / epochLength * stor1[address(msg.sender)].field_256 * rebaseRate / 10000 / stor1[address(msg.sender)].field_1280 - stor1[address(msg.sender)].field_1024 / epochLength, msg.sender
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if stor1[address(msg.sender)].field_512 > (-1 * block.timestamp - stor1[address(msg.sender)].field_1536 / epochLength * stor1[address(msg.sender)].field_256 * rebaseRate / 10000 / stor1[address(msg.sender)].field_1280 - stor1[address(msg.sender)].field_1024 / epochLength) - 1:
                            revert with 'NH{q', 17
