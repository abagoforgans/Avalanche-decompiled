...
function draw() payable {
    ...
    if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(JGNAddress):
        revert with 0, 'SafeERC20: call to non-contract'
    ...
    call randomNumberConsumerAddress.requestRandom(uint256 arg1) with:
         gas gas_remaining wei
        args lotteryId
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
