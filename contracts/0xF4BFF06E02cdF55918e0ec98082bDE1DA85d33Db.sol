...
function getA() payable {
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0xb0a14cfc with:
...
function getAPrecise() payable {
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0xc9b64dcb with:
         gas gas_remaining wei
        args 2
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function getVirtualPrice() payable {
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0x71906c2c with:
         gas gas_remaining wei
        args 2
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function getAdminBalance(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0x7d048160 with:
         gas gas_remaining wei
        args 2, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function stopRampA() payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0xd76ddcf0f86a93a575fff0818b932a0c8f164698)
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0xf14e211e with:
         gas gas_remaining wei
        args 2
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function getDepositTimestamp(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0xe8c47a54 with:
         gas gas_remaining wei
        args 2, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function calculateCurrentWithdrawFee(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0x968e5594 with:
         gas gas_remaining wei
        args 2, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function withdrawAdminFees() payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0xd76ddcf0f86a93a575fff0818b932a0c8f164698)
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0x24c5c751 with:
         gas gas_remaining wei
        args 2, owner
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function setAdminFee(uint256 arg1) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0xd76ddcf0f86a93a575fff0818b932a0c8f164698)
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.'pFrv' with:
         gas gas_remaining wei
        args 2, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function setSwapFee(uint256 arg1) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0xd76ddcf0f86a93a575fff0818b932a0c8f164698)
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0x467e186c with:
         gas gas_remaining wei
        args 2, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function setDefaultDepositFee(uint256 arg1) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0xd76ddcf0f86a93a575fff0818b932a0c8f164698)
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0xd2a39487 with:
         gas gas_remaining wei
        args 2, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function setDefaultWithdrawFee(uint256 arg1) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0xd76ddcf0f86a93a575fff0818b932a0c8f164698)
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0x8ab7697e with:
         gas gas_remaining wei
        args 2, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function rampA(uint256 arg1, uint256 arg2) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0xd76ddcf0f86a93a575fff0818b932a0c8f164698)
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0x58fdd79b with:
         gas gas_remaining wei
        args 2, arg1, arg2
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function setDevAddress(address arg1) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0xd76ddcf0f86a93a575fff0818b932a0c8f164698)
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0x4386c7ce with:
         gas gas_remaining wei
        args 2, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function calculateSwap(uint8 arg1, uint8 arg2, uint256 arg3) payable {
    ...
    require arg1 == arg1
    require arg2 == arg2
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.'K#`<' with:
         gas gas_remaining wei
...
function calculateRemoveLiquidityOneToken(address arg1, uint256 arg2, uint8 arg3) payable {
    ...
    require arg1 == arg1
    require arg3 == arg3
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0xe4a9a0da with:
         gas gas_remaining wei
...
function updateUserWithdrawFee(address arg1, uint256 arg2) payable {
    ...
    require ext_code.size(0xd76ddcf0f86a93a575fff0818b932a0c8f164698)
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0xe9252d46 with:
         gas gas_remaining wei
...
function removeLiquidityOneToken(uint256 arg1, uint8 arg2, uint256 arg3, uint256 arg4) payable {
    ...
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0xe7a4db81 with:
         gas gas_remaining wei
...
function swap(uint8 arg1, uint8 arg2, uint256 arg3, uint256 arg4, uint256 arg5) payable {
    ...
    if block.timestamp > arg5:
        revert with 0, 'Deadline not met'
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0xa5397b22 with:
         gas gas_remaining wei
...
function calculateTokenAmount(address arg1, uint256[] arg2, bool arg3) payable {
    ...
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0x5e58579c with:
         gas gas_remaining wei
...
function addLiquidity(uint256[] arg1, uint256 arg2, uint256 arg3) payable {
    ...
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0x40370edf with:
         gas gas_remaining wei
...
function removeLiquidityImbalance(uint256[] arg1, uint256 arg2, uint256 arg3) payable {
    ...
    if block.timestamp > arg3:
        revert with 0, 'Deadline not met'
    require arg1.length <= 0x7ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0x41b91c26 with:
         gas gas_remaining wei
        args 0, 2, 96, arg2, arg1.length, call.data[arg1 + 36 len 32 * arg1.length]
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function calculateRemoveLiquidity(address arg1, uint256 arg2) payable {
    ...
    mem[132] = arg1
    mem[164] = arg2
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0xf967a81f with:
         gas gas_remaining wei
        args 2, address(arg1), arg2
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function removeLiquidity(uint256 arg1, uint256[] arg2, uint256 arg3) payable {
    ...
    delegate 0xd76ddcf0f86a93a575fff0818b932a0c8f164698.0x73fd6b3e with:
         gas gas_remaining wei
