...
function sub_78495d36(?) {
    ...
    mem[(2 * ceil32(return_data.size)) + 324] = ext_call.return_data[0] / 2
    ...
    staticcall stor1.getAmountsOut(uint256 arg1, address[] arg2) with:
            gas gas_remaining wei
           args Mask(255, 1, ext_call.return_data[0]), Array(len=2, data=mem[(2 * ceil32(return_data.size)) + 420 len 64])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    _46 = mem[(2 * ceil32(return_data.size)) + 320 len 4], Mask(224, 32, ext_call.return_data[0]) >> 32
    require mem[(2 * ceil32(return_data.size)) + 320 len 4], Mask(224, 32, ext_call.return_data[0]) >> 32 <= test266151307()
    require (2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 320 len 4], Mask(224, 32, ext_call.return_data[0]) >> 32 + 351 < (2 * ceil32(return_data.size)) + return_data.size + 320
    _47 = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 320 len 4], Mask(224, 32, ext_call.return_data[0]) >> 32 + 320]
    if mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 320 len 4], Mask(224, 32, ext_call.return_data[0]) >> 32 + 320] > test266151307():
        revert with 'NH{q', 65
    if (4 * ceil32(return_data.size)) + floor32(mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 320 len 4], Mask(224, 32, ext_call.return_data[0]) >> 32 + 320]) + 321 > test266151307() or floor32(mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 320 len 4], Mask(224, 32, ext_call.return_data[0]) >> 32 + 320]) + 1 < 0:
        revert with 'NH{q', 65
    mem[64] = (4 * ceil32(return_data.size)) + floor32(mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 320 len 4], Mask(224, 32, ext_call.return_data[0]) >> 32 + 320]) + 321
