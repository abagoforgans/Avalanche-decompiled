...
function buyAndStakeSnowBank() payable {
    ...
    mem[(32 * _61) + ceil32(return_data.size) + 356] = 100 * mem[ceil32(return_data.size) + 256] / 105
    ...
    call 0x60ae616a2155ee3d9a68541ba4544862310933d4.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args ext_call.return_data[0], 100 * mem[ceil32(return_data.size) + 256] / 105, Array(len=2, data=mem[(32 * _61) + ceil32(return_data.size) + 516 len 64]), address(this.address), block.timestamp
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
