...
function unpause() payable {
    ...
    require ext_code.size(address(wantAddress))
    staticcall address(wantAddress).allowance(address arg1, address arg2) with:
            gas gas_remaining wei
    ...
    if ext_call.return_data[0] - reserves >= arg1:
        if ext_call.return_data[0] - reserves <= arg1:
            if tx.origin == owner:
                ...
                if not ext_code.size(address(wantAddress)):
                    revert with 0, 'Address: call to non-contract'
                mem[260 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, ext_call.return_data[0] - reserves) >> 32
                mem[352 len 4] = 0
                call address(wantAddress) with:
                   funct uint32(stor3)
                     gas gas_remaining wei
                ...
                if not return_data.size:
                    if not ext_call.success:
                        revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor3), uint32(stor3), ext_call.return_data[0] - reserves
                ...
                if paused:
                    ...
                    if ext_call.return_data[0] - reserves:
                        ...
                        if not ext_code.size(address(wantAddress)):
                            revert with 0, 'Address: call to non-contract'
                        mem[260 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, ext_call.return_data[0] - reserves - ((ext_call.return_data[0] * withdrawalFee) - (reserves * withdrawalFee) / 10000)) >> 32
                        mem[352 len 4] = 0
                        call address(wantAddress) with:
                           funct uint32(stor3)
                             gas gas_remaining wei
            ...
            if tx.origin == owner:
                ...
                if paused:
                    ...
                    if not arg1:
                        ...
                        if not ext_code.size(address(wantAddress)):
                            revert with 0, 'Address: call to non-contract'
                        mem[260 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, arg1 - (withdrawalFee * arg1 / 10000)) >> 32
                        mem[352 len 4] = 0
                        call address(wantAddress) with:
                           funct uint32(stor3)
                             gas gas_remaining wei
                        ...
                        if not return_data.size:
                            if not ext_call.success:
                                revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor3), uint32(stor3), arg1 - (withdrawalFee * arg1 / 10000)
                            if not transfer(address arg1, uint256 arg2), Mask(224, 0, stor3):
                                revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                            if not paused:
                                require ext_code.size(address(wantAddress))
                ...
                if tx.origin == owner:
                    ...
                    if paused:
                        ...
                        if not arg1:
                            ...
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with transfer(address arg1, uint256 arg2), address(vaultAddress), arg1 - (withdrawalFee * arg1 / 10000)
                                if not uint32(this.address), Mask(224, 0, stor3):
                                    revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                                if not paused:
                                    require ext_code.size(address(wantAddress))
