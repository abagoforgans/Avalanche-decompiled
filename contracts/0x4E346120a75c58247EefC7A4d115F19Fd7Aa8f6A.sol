        ...
        if ext_call.return_data[0] <= 0:
                ...
                if ext_call.return_data[0] <= 0:
                    ...
                    if not ext_call.return_data[0]:
                        ...
                        if not ext_call.return_data[0]:
                            ...
                            staticcall 0x7f90122bf0700f9e7e1f688fe926940e8839f353.calc_token_amount(uint256[3] arg1, bool arg2) with:
                                    gas gas_remaining wei
                                   args 0, ext_call.return_data[0] + (ext_call.return_data[0] * 50 * ext_call.return_data[0] / 100 / 10^10), 0 >> 512, 0
        else:
            require ext_code.size(0x7f90122bf0700f9e7e1f688fe926940e8839f353)
            staticcall 0x7f90122bf0700f9e7e1f688fe926940e8839f353.calc_withdraw_one_coin(uint256 arg1, int128 arg2) with:
                    gas gas_remaining wei
            ...
            if not ext_call.return_data[0]:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if ext_call.return_data[0] + (ext_call.return_data[0] * 50 * ext_call.return_data[0] / 100 / 10^10) < ext_call.return_data[0]:
                        revert with 0, 'SafeMath: addition overflow'
                    if arg1 - ext_call.return_data[0] <= ext_call.return_data[0] + (ext_call.return_data[0] * 50 * ext_call.return_data[0] / 100 / 10^10):
                        require ext_code.size(0xa7d7079b0fead91f3e65f86e8915cb59c1a4c664)
                        staticcall 0xa7d7079b0fead91f3e65f86e8915cb59c1a4c664.0x70a08231 with:
                                gas gas_remaining wei
                               args this.address
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                call 0xa7d7079b0fead91f3e65f86e8915cb59c1a4c664.0x8839f353 with:
                     gas gas_remaining wei
                    args Mask(480, -256, approve(address arg1, uint256 arg2), 0x7f90122bf0700f9e7e1f688f, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[816 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), -1
                    if not approve(address arg1, uint256 arg2), Mask(224, 0, stor1):
                ...
                call 0xa7d7079b0fead91f3e65f86e8915cb59c1a4c664.0x8839f353 with:
                     gas gas_remaining wei
                    args Mask(480, -256, approve(address arg1, uint256 arg2), 0x7f90122bf0700f9e7e1f688f, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[ceil32(return_data.size) + 817 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), -1
                    if not approve(address arg1, uint256 arg2), Mask(224, 0, stor1):
            ...
            if return_data.size <= 0:
                ...
                call 0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7.0xb6c89106 with:
                     gas gas_remaining wei
                    args -1, 0, mem[ceil32(return_data.size) + 653 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor1), uint32(stor1), -1
                    if not approve(address arg1, uint256 arg2), Mask(224, 0, stor1):
