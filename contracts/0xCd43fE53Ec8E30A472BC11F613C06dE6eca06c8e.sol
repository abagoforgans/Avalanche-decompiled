...
uint256 sub_be419d32;
uint256 sub_040333f0;
uint8 stor8;
address badAddress; offset 88
address devAddr;
...
function sub_d9bd3a40(?) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return (sub_be419d32 * ext_call.return_data[0])
}
...
function sub_53b63393(?) payable {
    ...
    sub_be419d32 = 2 * 10^18 * ext_call.return_data[32] / 100 * 10^6 * Mask(112, 0, stor3.field_0) / ext_call.return_data[0]
    require Mask(112, 0, stor3.field_112)
    return sub_be419d32, 
           10^18 * Mask(112, 0, Mask(112, 0, stor3.field_0) / Mask(112, 0, stor3.field_112)) * ext_call.return_data[32] / 100 * 10^6
}
