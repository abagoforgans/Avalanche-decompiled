...
function sub_171c1fda(?) {
    ...
    if not ext_call.return_data[0]:
        revert with 1721067498
    mem[ceil32(return_data.size) + 96] = 68
    mem[ceil32(return_data.size) + 132 len 28] = address(arg2) << 64
    mem[ceil32(return_data.size) + 128 len 4] = unknown_0xa9059cbb(?????)
    mem[ceil32(return_data.size) + 196 len 96] = unknown_0xa9059cbb(?????), address(arg2) << 64, 0, ext_call.return_data[0], mem[ceil32(return_data.size) + 196 len 28]
    ...
    if not return_data.size:
        ...
        if return_data.size:
            ...
            if not mem[ceil32(return_data.size) + 228]:
                revert with 0, 'TF'
    emit 0xbac6da2f: address(arg1), address(arg2)
}
