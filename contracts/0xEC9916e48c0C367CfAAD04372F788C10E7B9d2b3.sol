...
function _getNodeNumberOf(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    delegate 0x65464f97f0a096ac41373aaf7e59adc328e1f46e.0x732a2ccf with:
...
function createNode(address arg1, string arg2) payable {
    ...
    require ext_code.size(0x65464f97f0a096ac41373aaf7e59adc328e1f46e)
    delegate 0x65464f97f0a096ac41373aaf7e59adc328e1f46e.0xbc2b405c with:
         gas gas_remaining wei
