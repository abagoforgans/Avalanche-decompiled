...
const getName = 'StrategyBenqiUsdcE'

const benqi = 0x8729438eb15e2c8b576fcc6aecda6a148776c0
...
const sub_3bc91d62(?) = 0xbeb5d47a3f720ec0a390d04b4d41ed7d9688bc7f
...
function deposit() {
    ...
    if ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            require ext_code.size(address(sub_462e4cdaAddress))
            call address(sub_462e4cdaAddress).0xa0712d68 with:
                 gas gas_remaining wei
