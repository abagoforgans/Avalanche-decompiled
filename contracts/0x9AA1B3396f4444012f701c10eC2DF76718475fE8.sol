...
function sub_792e9e61(?) payable {
    ...
    require ext_code.size(0x84d2fe6adace63407f4b6bd91ab9f782ba3cb420)
    staticcall 0x84d2fe6adace63407f4b6bd91ab9f782ba3cb420.token0() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    require ext_code.size(0x84d2fe6adace63407f4b6bd91ab9f782ba3cb420)
    staticcall 0x84d2fe6adace63407f4b6bd91ab9f782ba3cb420.getReserves() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
...
function sub_8fdadfc1(?) payable {
    ...
    require ext_code.size(0x1ba497712e20f8d629f16ca9e7e070a6f4779754)
    staticcall 0x1ba497712e20f8d629f16ca9e7e070a6f4779754.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    if uint8(stor1.field_160):
        ...
        if block.timestamp < uint128(stor1.field_0):
            revert with 0, '1e'
        require ext_code.size(0xa3e4200ca1ac92331d529327e82d89c149ccd81c)
        call 0xa3e4200ca1ac92331d529327e82d89c149ccd81c.rebase() with:
             gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[0]
        mem[(2 * ceil32(return_data.size)) + 100] = 0xa3e4200ca1ac92331d529327e82d89c149ccd81c
        mem[(2 * ceil32(return_data.size)) + 132] = ext_call.return_data[0]
        require ext_code.size(0x1ba497712e20f8d629f16ca9e7e070a6f4779754)
        call 0x1ba497712e20f8d629f16ca9e7e070a6f4779754.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args 0xa3e4200ca1ac92331d529327e82d89c149ccd81c, ext_call.return_data[0]
        ...
        require ext_code.size(0xa3e4200ca1ac92331d529327e82d89c149ccd81c)
        call 0xa3e4200ca1ac92331d529327e82d89c149ccd81c.unstake(uint256 arg1, bool arg2) with:
             gas gas_remaining wei
            args ext_call.return_data[0], 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[(4 * ceil32(return_data.size)) + 100] = this.address
        require ext_code.size(0x4eb49a2f9a79053866fae806fac95a3ef5b92c05)
        staticcall 0x4eb49a2f9a79053866fae806fac95a3ef5b92c05.0x70a08231 with:
                gas gas_remaining wei
               args this.address
        ...
        mem[(6 * ceil32(return_data.size)) + 128] = 0x4eb49a2f9a79053866fae806fac95a3ef5b92c05
        ...
        require ext_code.size(0x4eb49a2f9a79053866fae806fac95a3ef5b92c05)
        call 0x4eb49a2f9a79053866fae806fac95a3ef5b92c05.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
        ...
        require ext_code.size(0xa3e4200ca1ac92331d529327e82d89c149ccd81c)
        call 0xa3e4200ca1ac92331d529327e82d89c149ccd81c.epoch() with:
             gas gas_remaining wei
        ...
        mem[(2 * ceil32(return_data.size)) + 160] = 0x4eb49a2f9a79053866fae806fac95a3ef5b92c05
        require ext_code.size(0x84d2fe6adace63407f4b6bd91ab9f782ba3cb420)
        staticcall 0x84d2fe6adace63407f4b6bd91ab9f782ba3cb420.token0() with:
                gas gas_remaining wei
        ...
        if address(ext_call.return_data[0]) == 0x130966628846bfd36ff31a822705796e8cb8c18d:
            ...
            mem[mem[64] + 4] = 0xa3e4200ca1ac92331d529327e82d89c149ccd81c
            mem[mem[64] + 36] = _198
            require ext_code.size(0x4eb49a2f9a79053866fae806fac95a3ef5b92c05)
            call 0x4eb49a2f9a79053866fae806fac95a3ef5b92c05.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args 0xa3e4200ca1ac92331d529327e82d89c149ccd81c, _198
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _204 = mem[64]
            ...
            require ext_code.size(0xa3e4200ca1ac92331d529327e82d89c149ccd81c)
            call 0xa3e4200ca1ac92331d529327e82d89c149ccd81c.stake(uint256 arg1, address arg2) with:
                 gas gas_remaining wei
            ...
            call 0x4eb49a2f9a79053866fae806fac95a3ef5b92c05.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args 0xa3e4200ca1ac92331d529327e82d89c149ccd81c, _199
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _205 = mem[64]
        ...
        require ext_code.size(0xa3e4200ca1ac92331d529327e82d89c149ccd81c)
        call 0xa3e4200ca1ac92331d529327e82d89c149ccd81c.claim(address arg1) with:
             gas gas_remaining wei
            args address(this.address)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
