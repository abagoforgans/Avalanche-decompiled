...
function getNextUnwrapTimestamp(address arg1) payable {
    require calldata.size - 4 >= 32
    if stor8[address(arg1)] + (4320 * 24 * 3600) < stor8[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    return (stor8[address(arg1)] + (4320 * 24 * 3600))
}
...
function sub_339bdbe9(?) payable {
    ...
    if stor8[address(msg.sender)] + (4320 * 24 * 3600) < stor8[address(msg.sender)]:
        revert with 0, 'SafeMath: addition overflow'
    require ext_code.size(0xbe6d6323ea233fd1dbe1ff66c5252170c69fb6c7)
    if block.timestamp >= stor8[address(msg.sender)] + (4320 * 24 * 3600):
