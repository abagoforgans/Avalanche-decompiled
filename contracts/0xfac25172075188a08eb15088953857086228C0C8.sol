...
const entranceFeeFactorLL = 9000
    ...
    if not return_data.size:
            ...
            if not uint8(stor2.field_24):
                ...
                if not return_data.size:
                    if not ext_call.success:
                        revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), arg2
                    if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
                        revert with 0, 32, 42, 0x6e5361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[566 len 22]
                    require ext_code.size(farmContractAddress)
                    if not uint8(stor2.field_8):
                        call farmContractAddress.deposit(uint256 arg1, uint256 arg2) with:
                             gas gas_remaining wei
        ...
        if not arg2:
            ...
            if not uint8(stor2.field_24):
                if wantLockedTotal + arg2 < wantLockedTotal:
                    revert with 0, 'SafeMath: addition overflow'
                wantLockedTotal += arg2
                if 0 / wantLockedTotal / 10000 <= 1000:
                    revert with 0, 'deposit too small'
                stor1 = 1
                idx = 0
                while idx < rewarders.length:
                ...
                if not return_data.size:
                    if not ext_call.success:
                        revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), arg2
                    if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
                        revert with 0, 32, 42, 0x6e5361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[694 len 22]
                    require ext_code.size(farmContractAddress)
                    if not uint8(stor2.field_8):
                        call farmContractAddress.deposit(uint256 arg1, uint256 arg2) with:
                             gas gas_remaining wei
        ...
        if not uint8(stor2.field_24):
            if wantLockedTotal + arg2 < wantLockedTotal:
                revert with 0, 'SafeMath: addition overflow'
            wantLockedTotal += arg2
            if arg2 * sharesTotal * entranceFeeFactor / wantLockedTotal / 10000 <= 1000:
                revert with 0, 'deposit too small'
            stor1 = 1
            idx = 0
            while idx < rewarders.length:
...
function withdraw(address arg1, uint256 arg2) payable {
    ...
    if not arg2:
        ...
        if not 0 / wantLockedTotal:
                ...
                if withdrawFeeFactor >= 10000:
                    if not uint8(stor2.field_24):
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        if 0 / sharesTotal <= ext_call.return_data[0]:
                            if wantLockedTotal < 0 / sharesTotal:
                                ...
                                if 0 / sharesTotal > wantLockedTotal:
                                    revert with 0, 'SafeMath: subtraction overflow'
                                wantLockedTotal -= 0 / sharesTotal
                                if eth.balance(this.address) < 0:
                                    revert with 0, 32, 38, 0x73416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[622 len 26]
                                if ext_code.size(wantAddress) <= 0:
                                    revert with 0, 'Address: call to non-contract'
                                mem[516 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, 0 / sharesTotal) >> 32
                                mem[580 len 0] = 0
                                call wantAddress with:
                                   funct uint32(stor10)
                                     gas gas_remaining wei
                                    args Mask(224, 32, 0 / sharesTotal) << 224, mem[580 len 4]
                        else:
                    ...
                    if not 0 / sharesTotal:
                        if not uint8(stor2.field_24):
                            ...
                            if 0 <= ext_call.return_data[0]:
                                if wantLockedTotal >= 0:
                                    ...
                                    if ext_code.size(wantAddress) <= 0:
                                        revert with 0, 'Address: call to non-contract'
                                    mem[580 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor10), uint32(stor10), 0
                                    mem[644 len 0] = 0
                                    call wantAddress with:
                                       funct uint32(stor10)
                                         gas gas_remaining wei
                                        args Mask(480, -256, unknown_0xa9059cbb(?????), Mask(224, 0, stor10), uint32(stor10), 0) << 256, mem[644 len 4]
                                else:
                                    if wantLockedTotal > wantLockedTotal:
                                        revert with 0, 'SafeMath: subtraction overflow'
                                    wantLockedTotal = 0
                        ...
                        require 0 / sharesTotal
                        if 0 / sharesTotal * withdrawFeeFactor / 0 / sharesTotal != withdrawFeeFactor:
                        ...
                        if not uint8(stor2.field_24):
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            if 0 / sharesTotal * withdrawFeeFactor / 10000 <= ext_call.return_data[0]:
                                if wantLockedTotal >= 0 / sharesTotal * withdrawFeeFactor / 10000:
                                    if 0 / sharesTotal * withdrawFeeFactor / 10000 > wantLockedTotal:
                                        revert with 0, 'SafeMath: subtraction overflow'
                                    wantLockedTotal -= 0 / sharesTotal * withdrawFeeFactor / 10000
                                    if eth.balance(this.address) < 0:
                                        revert with 0, 32, 38, 0x73416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[686 len 26]
                                    if ext_code.size(wantAddress) <= 0:
                                        revert with 0, 'Address: call to non-contract'
                                    mem[580 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, 0 / sharesTotal * withdrawFeeFactor / 10000) >> 32
                                    mem[644 len 0] = 0
                                    call wantAddress with:
                                       funct uint32(stor10)
                                         gas gas_remaining wei
                                        args Mask(224, 32, 0 / sharesTotal * withdrawFeeFactor / 10000) << 224, mem[644 len 4]
                                else:
                                    if wantLockedTotal > wantLockedTotal:
                                        revert with 0, 'SafeMath: subtraction overflow'
                                    wantLockedTotal = 0
                            ...
                            if not uint8(stor2.field_8):
                                call farmContractAddress.withdraw(uint256 arg1, uint256 arg2) with:
                                     gas gas_remaining wei
                                    args pid, 0 / sharesTotal * withdrawFeeFactor / 10000
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require ext_code.size(wantAddress)
                                staticcall wantAddress.0x70a08231 with:
                                ...
                                call farmContractAddress.leaveStaking(uint256 arg1) with:
                                     gas gas_remaining wei
                                    args (0 / sharesTotal * withdrawFeeFactor / 10000)
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require ext_code.size(wantAddress)
                                staticcall wantAddress.0x70a08231 with:
                    ...
                    while idx < rewarders.length:
                        ...
                        if ext_code.size(rewarders[idx]) > 0:
                            require idx < rewarders.length
                            mem[0] = 28
                            mem[ceil32(return_data.size) + 581] = 0xacf5b26800000000000000000000000000000000000000000000000000000000
                            mem[ceil32(return_data.size) + 585] = arg1
                            mem[ceil32(return_data.size) + 617] = 0 / wantLockedTotal
                            mem[ceil32(return_data.size) + 649] = 1
                            require ext_code.size(rewarders[idx])
                            call rewarders[idx].0xacf5b268 with:
                                 gas gas_remaining wei
                                args address(arg1), 0 / wantLockedTotal, 1
            ...
            if withdrawFeeFactor >= 10000:
                ...
                while idx < rewarders.length:
                    ...
                    if ext_code.size(rewarders[idx]) > 0:
                        ...
                        mem[ceil32(return_data.size) + 581] = 0xacf5b26800000000000000000000000000000000000000000000000000000000
                        mem[ceil32(return_data.size) + 585] = arg1
                        mem[ceil32(return_data.size) + 617] = sharesTotal
                        mem[ceil32(return_data.size) + 649] = 1
                        require ext_code.size(rewarders[idx])
                        call rewarders[idx].0xacf5b268 with:
                             gas gas_remaining wei
            ...
            require 0 / wantLockedTotal
            if 0 / wantLockedTotal * wantLockedTotal / 0 / wantLockedTotal != wantLockedTotal:
                revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
            if sharesTotal <= 0:
                revert with 0, 'SafeMath: division by zero'
            require sharesTotal
            if 0 / wantLockedTotal * wantLockedTotal / sharesTotal <= 0:
                revert with 0, '_wantAmt <= 0'
            if 0 / wantLockedTotal <= sharesTotal:
                sharesTotal -= 0 / wantLockedTotal
                if withdrawFeeFactor >= 10000:
                    if not uint8(stor2.field_24):
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        if 0 / wantLockedTotal * wantLockedTotal / sharesTotal <= ext_call.return_data[0]:
                            if wantLockedTotal >= 0 / wantLockedTotal * wantLockedTotal / sharesTotal:
                                if 0 / wantLockedTotal * wantLockedTotal / sharesTotal > wantLockedTotal:
                                    revert with 0, 'SafeMath: subtraction overflow'
                                wantLockedTotal -= 0 / wantLockedTotal * wantLockedTotal / sharesTotal
                                if eth.balance(this.address) < 0:
                                    revert with 0, 32, 38, 0x73416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[622 len 26]
                                if ext_code.size(wantAddress) <= 0:
                                    revert with 0, 'Address: call to non-contract'
                                mem[516 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, 0 / wantLockedTotal * wantLockedTotal / sharesTotal) >> 32
                                call wantAddress with:
                                   funct uint32(stor10)
                                     gas gas_remaining wei
                                    args Mask(224, 32, 0 / wantLockedTotal * wantLockedTotal / sharesTotal) << 224, mem[580 len 4]
                            else:
                                if wantLockedTotal > wantLockedTotal:
                                    revert with 0, 'SafeMath: subtraction overflow'
                                wantLockedTotal = 0
                        ...
                        if not uint8(stor2.field_8):
                            call farmContractAddress.withdraw(uint256 arg1, uint256 arg2) with:
                                 gas gas_remaining wei
                                args pid, 0 / wantLockedTotal * wantLockedTotal / sharesTotal
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(wantAddress)
                            staticcall wantAddress.0x70a08231 with:
                            ...
                            call farmContractAddress.leaveStaking(uint256 arg1) with:
                                 gas gas_remaining wei
                                args (0 / wantLockedTotal * wantLockedTotal / sharesTotal)
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(wantAddress)
                            staticcall wantAddress.0x70a08231 with:
                    ...
                    if not 0 / wantLockedTotal * wantLockedTotal / sharesTotal:
                        if not uint8(stor2.field_24):
                            require ext_code.size(wantAddress)
                            staticcall wantAddress.0x70a08231 with:
                                    gas gas_remaining wei
                        ...
                        require 0 / wantLockedTotal * wantLockedTotal / sharesTotal
                        if 0 / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 0 / wantLockedTotal * wantLockedTotal / sharesTotal != withdrawFeeFactor:
                            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                        if not uint8(stor2.field_24):
                            require ext_code.size(wantAddress)
                            staticcall wantAddress.0x70a08231 with:
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            if 0 / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 10000 <= ext_call.return_data[0]:
                                if wantLockedTotal >= 0 / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 10000:
                                    if 0 / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 10000 > wantLockedTotal:
                                        revert with 0, 'SafeMath: subtraction overflow'
                                    wantLockedTotal -= 0 / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 10000
                                    if eth.balance(this.address) < 0:
                                        revert with 0, 32, 38, 0x73416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[686 len 26]
                                    if ext_code.size(wantAddress) <= 0:
                                        revert with 0, 'Address: call to non-contract'
                                    mem[580 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, 0 / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 10000) >> 32
                                    mem[644 len 0] = 0
                                    call wantAddress with:
                                       funct uint32(stor10)
                                         gas gas_remaining wei
                                        args Mask(224, 32, 0 / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 10000) << 224, mem[644 len 4]
                                else:
                                    if wantLockedTotal > wantLockedTotal:
                                        revert with 0, 'SafeMath: subtraction overflow'
                                    wantLockedTotal = 0
                            ...
                            if not uint8(stor2.field_8):
                                call farmContractAddress.withdraw(uint256 arg1, uint256 arg2) with:
                                     gas gas_remaining wei
                                    args pid, 0 / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 10000
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require ext_code.size(wantAddress)
                                staticcall wantAddress.0x70a08231 with:
                                ...
                                call farmContractAddress.leaveStaking(uint256 arg1) with:
                                     gas gas_remaining wei
                                    args (0 / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 10000)
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require ext_code.size(wantAddress)
                                staticcall wantAddress.0x70a08231 with:
        ...
        if wantLockedTotal <= 0:
            revert with 0, 'SafeMath: division by zero'
        require wantLockedTotal
        if not arg2 * sharesTotal / wantLockedTotal:
            if sharesTotal <= 0:
                revert with 0, 'SafeMath: division by zero'
            require sharesTotal
            if 0 / sharesTotal <= 0:
                ...
                if withdrawFeeFactor >= 10000:
                    ...
                    while idx < rewarders.length:
                        ...
                        if ext_code.size(rewarders[idx]) > 0:
                            ...
                            mem[ceil32(return_data.size) + 581] = 0xacf5b26800000000000000000000000000000000000000000000000000000000
                            mem[ceil32(return_data.size) + 585] = arg1
                            mem[ceil32(return_data.size) + 617] = arg2 * sharesTotal / wantLockedTotal
                            mem[ceil32(return_data.size) + 649] = 1
                            require ext_code.size(rewarders[idx])
                            call rewarders[idx].0xacf5b268 with:
                                 gas gas_remaining wei
            ...
            require arg2 * sharesTotal / wantLockedTotal
            if arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / arg2 * sharesTotal / wantLockedTotal != wantLockedTotal:
                revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
            if sharesTotal <= 0:
                revert with 0, 'SafeMath: division by zero'
            require sharesTotal
            if arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal <= 0:
                revert with 0, '_wantAmt <= 0'
            if arg2 * sharesTotal / wantLockedTotal <= sharesTotal:
                sharesTotal -= arg2 * sharesTotal / wantLockedTotal
                if withdrawFeeFactor >= 10000:
                    if not uint8(stor2.field_24):
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        if arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal <= ext_call.return_data[0]:
                            if wantLockedTotal < arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal:
                                if wantLockedTotal > wantLockedTotal:
                                    revert with 0, 'SafeMath: subtraction overflow'
                                wantLockedTotal = 0
                                if eth.balance(this.address) < 0:
                                ...
                                if arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal > wantLockedTotal:
                                    revert with 0, 'SafeMath: subtraction overflow'
                                wantLockedTotal -= arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal
                                if eth.balance(this.address) < 0:
                                    revert with 0, 32, 38, 0x73416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[622 len 26]
                                if ext_code.size(wantAddress) <= 0:
                                    revert with 0, 'Address: call to non-contract'
                                mem[516 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal) >> 32
                                mem[580 len 0] = 0
                                call wantAddress with:
                                   funct uint32(stor10)
                                     gas gas_remaining wei
                                    args Mask(224, 32, arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal) << 224, mem[580 len 4]
                        else:
                            if wantLockedTotal >= ext_call.return_data[0]:
                                if ext_call.return_data[0] > wantLockedTotal:
                                    revert with 0, 'SafeMath: subtraction overflow'
                        ...
                        if not uint8(stor2.field_8):
                            call farmContractAddress.withdraw(uint256 arg1, uint256 arg2) with:
                                 gas gas_remaining wei
                                args pid, arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(wantAddress)
                            staticcall wantAddress.0x70a08231 with:
                            ...
                            call farmContractAddress.leaveStaking(uint256 arg1) with:
                                 gas gas_remaining wei
                                args (arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal)
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(wantAddress)
                            staticcall wantAddress.0x70a08231 with:
                    ...
                    if not arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal:
                        if not uint8(stor2.field_24):
                            require ext_code.size(wantAddress)
                            staticcall wantAddress.0x70a08231 with:
                                    gas gas_remaining wei
                        ...
                        require arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal
                        if arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal != withdrawFeeFactor:
                            revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                        if not uint8(stor2.field_24):
                            require ext_code.size(wantAddress)
                            staticcall wantAddress.0x70a08231 with:
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            if arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 10000 <= ext_call.return_data[0]:
                                if wantLockedTotal >= arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 10000:
                                    if arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 10000 > wantLockedTotal:
                                        revert with 0, 'SafeMath: subtraction overflow'
                                    wantLockedTotal -= arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 10000
                                    if eth.balance(this.address) < 0:
                                        revert with 0, 32, 38, 0x73416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[686 len 26]
                                    if ext_code.size(wantAddress) <= 0:
                                        revert with 0, 'Address: call to non-contract'
                                    mem[580 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor10), uint32(stor10), Mask(224, 32, arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 10000) >> 32
                                    mem[644 len 0] = 0
                                    call wantAddress with:
                                       funct uint32(stor10)
                                         gas gas_remaining wei
                                        args Mask(224, 32, arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 10000) << 224, mem[644 len 4]
                                else:
                                    if wantLockedTotal > wantLockedTotal:
                                        revert with 0, 'SafeMath: subtraction overflow'
                                    wantLockedTotal = 0
                            ...
                            if not uint8(stor2.field_8):
                                call farmContractAddress.withdraw(uint256 arg1, uint256 arg2) with:
                                     gas gas_remaining wei
                                    args pid, arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 10000
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require ext_code.size(wantAddress)
                                staticcall wantAddress.0x70a08231 with:
                                ...
                                call farmContractAddress.leaveStaking(uint256 arg1) with:
                                     gas gas_remaining wei
                                    args (arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 10000)
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require ext_code.size(wantAddress)
                                staticcall wantAddress.0x70a08231 with:
