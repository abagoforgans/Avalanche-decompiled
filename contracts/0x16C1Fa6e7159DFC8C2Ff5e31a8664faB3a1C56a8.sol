...
function sub_8393ecad(?) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if block.timestamp >= arg1:
        require ext_code.size(0xc4593903d888d5cfdb30e759a09b283d96a9ee0)
        staticcall 0xc4593903d888d5cfdb30e759a09b283d96a9ee0.lastHarvest() with:
        ...
        if ext_call.return_data[0] < arg1:
            require ext_code.size(0xc4593903d888d5cfdb30e759a09b283d96a9ee0)
            call 0x0c4593903d888d5cfdb30e759a09b283d96a9ee0.0x4641257d with:
                 gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
}
