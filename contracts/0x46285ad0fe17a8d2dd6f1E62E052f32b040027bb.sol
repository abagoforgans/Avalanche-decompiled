...
function callFunction(address arg1, address arg2, uint256 arg3, bytes arg4) {
    ...
    while idx < _150:
        ...
        if mem[mem[(32 * idx) + ceil32(arg4.length) + 416]] == 2:
            ...
            mem[mem[64] + 100] = _160
            mem[mem[64] + 132] = _161
            require ext_code.size(0x75f7b02d89c848f5b211abcff5f224a58b975f7)
            delegate 0x75f7b02d89c848f5b211abcff5f224a58b975f7.0xe54cab13 with:
                 gas gas_remaining wei
        ...
        if not mem[mem[(32 * idx) + ceil32(arg4.length) + 416]]:
            ...
            mem[mem[64] + 164] = _168
            require ext_code.size(0x75f7b02d89c848f5b211abcff5f224a58b975f7)
            delegate 0x75f7b02d89c848f5b211abcff5f224a58b975f7.0xca255923 with:
                 gas gas_remaining wei
        ...
        if mem[mem[(32 * idx) + ceil32(arg4.length) + 416]] == 1:
            ...
            require ext_code.size(0x75f7b02d89c848f5b211abcff5f224a58b975f7)
            delegate 0x75f7b02d89c848f5b211abcff5f224a58b975f7.0x987037be with:
                 gas gas_remaining wei
        ...
        if mem[mem[(32 * idx) + ceil32(arg4.length) + 416]] != 4:
            ...
            require ext_code.size(0x75f7b02d89c848f5b211abcff5f224a58b975f7)
            delegate 0x75f7b02d89c848f5b211abcff5f224a58b975f7.0x8c69e858 with:
                 gas gas_remaining wei
        ...
        mem[mem[64] + 132] = _187
        require ext_code.size(0x75f7b02d89c848f5b211abcff5f224a58b975f7)
        delegate 0x75f7b02d89c848f5b211abcff5f224a58b975f7.0x5a9cfe23 with:
             gas gas_remaining wei
