...
function sub_7c42eda3(?) {
    ...
    while idx < ('cd', 4).length:
        ...
        if mem[_819 + 12 len 20] != address(cd[68]):
        ...
        s = s + 1278
        continue 
    _834 = mem[floor32(('cd', 4).length) + 97]
    idx = 0
    t = s
    while idx < _834:
        if idx >= mem[floor32(('cd', 4).length) + 97]:
            revert with 'NH{q', 50
        _836 = mem[(32 * idx) + floor32(('cd', 4).length) + 129]
        ...
        if mem[_851 + 12 len 20] != address(cd[68]):
    ...
    if 0 >= mem[_844]:
        revert with 'NH{q', 50
    mem[_844 + 32] = 100 * 10^18 * t
    if 1 >= mem[_844]:
        revert with 'NH{q', 50
    mem[_844 + 64] = 200 * 10^18 * t
    if 2 >= mem[_844]:
        revert with 'NH{q', 50
    mem[_844 + 96] = 10 * 10^18 * t
    mem[_844 + 128] = 32
    mem[_844 + 160] = mem[_844]
    mem[_844 + 192 len 32 * mem[_844]] = mem[_844 + 32 len 32 * mem[_844]]
    return memory
      from mem[64]
       len _844 + (32 * mem[_844]) + -mem[64] + 192
}
