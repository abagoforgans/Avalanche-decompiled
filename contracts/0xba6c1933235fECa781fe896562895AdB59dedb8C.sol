...
function sub_93f7e642(?) payable {
    ...
    require arg1 == address(arg1)
    require ext_code.size(address(arg1))
    staticcall address(arg1).0x5c975abb with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function sub_b4610769(?) payable {
    require calldata.size - 4 >= 128
    require arg2 == address(arg2)
    require arg1 == address(arg1)
    require ext_code.size(address(arg2))
    staticcall address(arg2).0xfa75d160 with:
            gas gas_remaining wei
           args address(arg1)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    mem[96] = ext_call.return_data[18 len 14]
    require arg2 == address(arg2)
    require arg1 == address(arg1)
    require ext_code.size(address(arg2))
    staticcall address(arg2).tokenInfo(address arg1) with:
            gas gas_remaining wei
           args address(arg1)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    staticcall address(arg3).timestamp() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    staticcall address(arg4).feeRate(address arg1) with:
            gas gas_remaining wei
           args address(arg1)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require arg1 == address(arg1)
    require ext_code.size(address(arg3))
    staticcall address(arg3).state(address arg1) with:
            gas gas_remaining wei
           args address(arg1)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if uint32(ext_call.return_data[64]) == ext_call.return_data[28 len 4]:
        return mem[114 len 14], 
               ext_call.return_data[0],
    ...
    if Mask(112, 0, ext_call.return_data[32]) > mem[114 len 14]:
        return mem[114 len 14], 
               ext_call.return_data[0],
               ext_call.return_data[96] << 192,
...
function balancerV2StablePoolState(address arg1, bytes32 arg2, address arg3) payable {
    ...
    while idx < _5:
        ...
        t = t + 32
        continue 
    mem[_75 + 32] = (32 * _5) + 192
    _82 = mem[_36]
    mem[_75 + (32 * _5) + 192] = mem[_36]
    mem[_75 + (32 * _5) + 224 len 32 * _82] = mem[_36 + 32 len 32 * _82]
    mem[_75 + 64] = _64
    mem[_75 + 96] = _68
    mem[_75 + 128] = _74
    return memory
      from mem[64]
       len _75 + (32 * _5) + (32 * _82) + -mem[64] + 224
}
...
function balancerV2WeightedPoolState(address arg1, bytes32 arg2, address arg3) payable {
    ...
    while idx < _5:
        ...
        t = t + 32
        continue 
    mem[_95 + 32] = (32 * _5) + 192
    _104 = mem[_39]
    mem[_95 + (32 * _5) + 192] = mem[_39]
    mem[_95 + (32 * _5) + 224 len 32 * _104] = mem[_39 + 32 len 32 * _104]
    mem[_95 + 64] = _70
    mem[_95 + 96] = (32 * _5) + (32 * _104) + 224
    _110 = mem[_73 + ceil32(return_data.size)]
    mem[_95 + (32 * _5) + (32 * _104) + 224] = mem[_73 + ceil32(return_data.size)]
    mem[_95 + (32 * _5) + (32 * _104) + 256 len 32 * _110] = mem[_73 + ceil32(return_data.size) + 32 len 32 * _110]
    mem[_95 + 128] = _94
    return memory
      from mem[64]
       len _95 + (32 * _5) + (32 * _104) + (32 * _110) + -mem[64] + 256
}
...
function sub_1001f934(?) payable {
    ...
    if not mem[192]:
        ...
        _4417 = mem[_1051]
        mem[_3512 + (32 * _3587) + (32 * _4045) + 224] = mem[_1051]
        mem[_3512 + (32 * _3587) + (32 * _4045) + 256 len 32 * _4417] = mem[_1051 + 32 len 32 * _4417]
        mem[_3512 + 96] = _3245
        mem[_3512 + 128] = _3456
        return memory
          from mem[64]
           len _3512 + (32 * _3587) + (32 * _4045) + (32 * _4417) + -mem[64] + 256
    _1054 = mem[224]
    _1055 = mem[256]
    ...
    if mem[159 len 1]:
        ...
        if mem[mem[256]] <= 0:
            ...
            _4425 = mem[_1051]
            mem[_3525 + (32 * _3599) + (32 * _4054) + 224] = mem[_1051]
            mem[_3525 + (32 * _3599) + (32 * _4054) + 256 len 32 * _4425] = mem[_1051 + 32 len 32 * _4425]
            mem[_3525 + 96] = _3257
            mem[_3525 + 128] = _3475
            return memory
              from mem[64]
               len _3525 + (32 * _3599) + (32 * _4054) + (32 * _4425) + -mem[64] + 256
        if mem[236 len 20]:
            _2101 = mem[128]
            idx = 0
    ...
    if mem[mem[256]] <= 0:
        ...
        _4419 = mem[_1051]
        mem[_3513 + (32 * _3588) + (32 * _4047) + 224] = mem[_1051]
        mem[_3513 + (32 * _3588) + (32 * _4047) + 256 len 32 * _4419] = mem[_1051 + 32 len 32 * _4419]
        mem[_3513 + 96] = _3246
        mem[_3513 + 128] = _3458
        return memory
          from mem[64]
           len _3513 + (32 * _3588) + (32 * _4047) + (32 * _4419) + -mem[64] + 256
    if mem[236 len 20]:
        _2098 = mem[128]
        idx = 0
        ...
        _4421 = mem[_1051]
        mem[_3518 + (32 * _3593) + (32 * _4049) + 224] = mem[_1051]
        mem[_3518 + (32 * _3593) + (32 * _4049) + 256 len 32 * _4421] = mem[_1051 + 32 len 32 * _4421]
        mem[_3518 + 96] = _3249
        mem[_3518 + 128] = _3464
        return memory
          from mem[64]
           len _3518 + (32 * _3593) + (32 * _4049) + (32 * _4421) + -mem[64] + 256
    _2099 = mem[128]
    idx = 0
    ...
    _4497 = mem[_1051]
    mem[_4270 + (32 * _4300) + (32 * _4423) + 224] = mem[_1051]
    mem[_4270 + (32 * _4300) + (32 * _4423) + 256 len 32 * _4497] = mem[_1051 + 32 len 32 * _4497]
    mem[_4270 + 96] = _4152
    mem[_4270 + 128] = _4251
    return memory
      from mem[64]
       len _4270 + (32 * _4300) + (32 * _4423) + (32 * _4497) + -mem[64] + 256
}
