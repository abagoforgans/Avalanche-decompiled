            ...
            if block.timestamp >= bonusEndTimestamp:
                ...
                if sub_ae3bc866 <= 0:
                    ...
                    if not userInfo[msg.sender].field_0:
                        ...
                        if not ext_code.size(stakedTokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[260 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor16.field_0), uint32(stor16.field_0), 0
                        call stakedTokenAddress with:
                        ...
                        if not return_data.size:
                            if not ext_call.success:
                                revert with transfer(address arg1, uint256 arg2), Mask(224, 0, stor16.field_0), uint32(stor16.field_0), 0
                            if not transfer(address arg1, uint256 arg2), Mask(224, 0, stor16.field_0):
                                revert with 0, 32, 42, 0xfe5361666542455032303a204245503230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                            if eth.balance(this.address) < 0:
                                revert with 0, 32, 38, 0x73416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[530 len 26]
                            if not ext_code.size(stakedTokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[424 len 64] = transfer(address arg1, uint256 arg2), msg.sender, userInfo[msg.sender].field_32
                            call stakedTokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                            ...
                            if not ext_code.size(stakedTokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 425 len 64] = transfer(address arg1, uint256 arg2), msg.sender, userInfo[msg.sender].field_32
                        ...
                        if not ext_code.size(stakedTokenAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[260 len 64] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor16.field_0), uint32(stor16.field_0), Mask(224, 32, sub_ae3bc866 * userInfo[msg.sender].field_0 / 10000) >> 32
                        call stakedTokenAddress with:
                           funct uint32(stor16.field_0)
                             gas gas_remaining wei
                        ...
                        if not return_data.size:
                            ...
                            if not ext_code.size(stakedTokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[424 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, userInfo[msg.sender].field_0 - (sub_ae3bc866 * userInfo[msg.sender].field_0 / 10000)) >> 32
                            call stakedTokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                            ...
                            if not ext_code.size(stakedTokenAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 425 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, userInfo[msg.sender].field_0 - (sub_ae3bc866 * userInfo[msg.sender].field_0 / 10000)) >> 32
                            mem[ceil32(return_data.size) + 517 len 4] = 0
                            call stakedTokenAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
