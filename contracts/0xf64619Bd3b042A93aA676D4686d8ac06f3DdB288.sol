...
function sub_806cc9f1(?) {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if USDCAddress != ext_call.return_data[12 len 20]:
        ...
        if ext_call.return_data[0]:
            ...
            call address(sub_413d823aAddress).0x9908fc8b with:
                 gas gas_remaining wei
                args 0, 0, USDCAddress, ext_call.return_data[0], 0, this.address, block.timestamp + 30
        else:
            require ext_code.size(address(ext_call.return_data[0]))
            staticcall address(ext_call.return_data[0]).0xdd62ed3e with:
                    gas gas_remaining wei
            ...
            call address(ext_call.return_data[0]) with:
               funct uint32(stor8)
                 gas gas_remaining wei
                args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[260 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 'SafeERC20: low-level call failed'
            ...
            call address(sub_413d823aAddress).0x9908fc8b with:
                 gas gas_remaining wei
                args address(ext_call.return_data[0]), USDCAddress, ext_call.return_data[0], 0, this.address, block.timestamp + 30
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 64
}

function sub_94e618cc(?) {
    require calldata.size - 4 >= 32
    require ext_code.size(arg1)
    call arg1.redeemUnderlying(uint256 arg1) with:
         gas gas_remaining wei
