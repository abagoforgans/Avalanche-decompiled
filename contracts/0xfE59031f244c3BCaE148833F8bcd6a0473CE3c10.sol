...
function sub_ef28fd9c(?) payable {
    ...
    if block.timestamp - lastSellTime[address(arg1)] <= stor7:
        ...
        if arg2 + sub_b42b3ae7[address(arg1)] <= ext_call.return_data[0]:
            ...
            mem[0] = address(arg1)
            mem[32] = 1
            lastSellTime[address(arg1)] = block.timestamp
            ...
            call sub_85adc8b0Address.0x91ef14b4 with:
                 gas gas_remaining wei
                args address(this.address), routerAddress, arg2, mem[(6 * ceil32(return_data.size)) + 292 len 9 * ceil32(return_data.size)]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            while idx < mem[(4 * ceil32(return_data.size)) + 96]:
                ...
                t = t + 32
                continue 
            mem[(6 * ceil32(return_data.size)) + 292] = address(arg1)
            ...
            if stor3[address(arg1)]:
                ...
                call sub_85adc8b0Address.0x23b872dd with:
                     gas gas_remaining wei
                    args address(arg1), address(stor4.field_0), arg2 * stor8 / stor9
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                ...
                call sub_85adc8b0Address.0x23b872dd with:
                     gas gas_remaining wei
                    args address(arg1), address(this.address), arg2 - (arg2 * stor8 / stor9)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                ...
                call sub_85adc8b0Address.0x91ef14b4 with:
                     gas gas_remaining wei
                    args address(this.address), routerAddress, arg2 - (arg2 * stor8 / stor9)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                call sub_85adc8b0Address.0x23b872dd with:
                     gas gas_remaining wei
                    args address(arg1), address(stor4.field_0), (arg2 * stor8) + (sub_b42b3ae7[address(arg1)] * stor8) - (ext_call.return_data[0] * stor8) / stor9
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                ...
                call sub_85adc8b0Address.0x23b872dd with:
                     gas gas_remaining wei
                    args address(arg1), address(this.address), arg2 - ((arg2 * stor8) + (sub_b42b3ae7[address(arg1)] * stor8) - (ext_call.return_data[0] * stor8) / stor9)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                ...
                call sub_85adc8b0Address.0x91ef14b4 with:
                     gas gas_remaining wei
                    args address(this.address), routerAddress, arg2 - ((arg2 * stor8) + (sub_b42b3ae7[address(arg1)] * stor8) - (ext_call.return_data[0] * stor8) / stor9)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                mem[(7 * ceil32(return_data.size)) + 192] = 0x762b156200000000000000000000000000000000000000000000000000000000
        ...
        if arg2 <= ext_call.return_data[0]:
            ...
            if stor3[address(arg1)]:
                ...
                call sub_85adc8b0Address.0x23b872dd with:
                     gas gas_remaining wei
                    args address(arg1), address(stor4.field_0), (arg2 * stor8) - (ext_call.return_data[0] * stor8) / stor9
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                ...
                call sub_85adc8b0Address.0x23b872dd with:
                     gas gas_remaining wei
                    args address(arg1), address(this.address), arg2 - ((arg2 * stor8) - (ext_call.return_data[0] * stor8) / stor9)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                ...
                call sub_85adc8b0Address.0x91ef14b4 with:
                     gas gas_remaining wei
                    args address(this.address), routerAddress, arg2 - ((arg2 * stor8) - (ext_call.return_data[0] * stor8) / stor9)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                mem[(7 * ceil32(return_data.size)) + 192] = 0x762b156200000000000000000000000000000000000000000000000000000000
