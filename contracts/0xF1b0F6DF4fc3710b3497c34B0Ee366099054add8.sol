...
const sub_7feb839d(?) = 3200 * 10^18

const maxSupply = 3200 * 10^18
...
function mint(address arg1, uint256 arg2) payable {
    ...
    if masterchefAddress != msg.sender:
        revert with 0, 'Caller is not the Masterchef'
    if not arg1:
        revert with 0, 'ERC20: mint to the zero address'
    if totalMinted + arg2 < totalMinted:
        revert with 0, 'SafeMath: addition overflow'
    if totalMinted + arg2 > 3200 * 10^18:
