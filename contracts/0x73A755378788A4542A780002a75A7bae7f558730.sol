...
function depositCollateral(uint256 arg1, uint256 arg2) payable {
    ...
    if arg2 + vaultCollateral[arg1] < vaultCollateral[arg1]:
        revert with 0, 'SafeMath: addition overflow'
    require arg2 + vaultCollateral[arg1] >= vaultCollateral[arg1]
...
function checkCollateralPercentage(uint256 arg1) payable {
    ...
    require return_data.size >= 32
    if not vaultCollateral[arg1]:
        require 0 >= vaultCollateral[arg1]
    ...
    if ext_call.return_data[0] * vaultCollateral[arg1] / vaultCollateral[arg1] != ext_call.return_data[0]:
        revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
    if not ext_call.return_data[0] * vaultCollateral[arg1]:
        require 0 >= vaultCollateral[arg1]
        require vaultDebt[arg1]
        require tokenPeg * vaultDebt[arg1] / vaultDebt[arg1] != tokenPeg
        revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
    if 10^0 * ext_call.return_data[0] * vaultCollateral[arg1] / ext_call.return_data[0] * vaultCollateral[arg1] != 10^0:
        revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
    require 10^0 * ext_call.return_data[0] * vaultCollateral[arg1] >= vaultCollateral[arg1]
    if not vaultDebt[arg1]:
        require 0 >= vaultDebt[arg1]
        if not 10^0 * ext_call.return_data[0] * vaultCollateral[arg1]:
            if 0 > 10^0 * ext_call.return_data[0] * vaultCollateral[arg1]:
                revert with 0, 'SafeMath: division by zero'
        else:
            if 100 * 10^0 * ext_call.return_data[0] * vaultCollateral[arg1] / 10^0 * ext_call.return_data[0] * vaultCollateral[arg1] != 100:
                revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
            if 100 * 10^0 * ext_call.return_data[0] * vaultCollateral[arg1] > 10^0 * ext_call.return_data[0] * vaultCollateral[arg1]:
                revert with 0, 'SafeMath: division by zero'
        revert
    ...
    if not 10^0 * ext_call.return_data[0] * vaultCollateral[arg1]:
        require 0 > 10^0 * ext_call.return_data[0] * vaultCollateral[arg1]
        if not tokenPeg * vaultDebt[arg1]:
            revert with 0, 'SafeMath: division by zero'
        return (0 / tokenPeg * vaultDebt[arg1])
    if 100 * 10^0 * ext_call.return_data[0] * vaultCollateral[arg1] / 10^0 * ext_call.return_data[0] * vaultCollateral[arg1] != 100:
        revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
    require 100 * 10^0 * ext_call.return_data[0] * vaultCollateral[arg1] > 10^0 * ext_call.return_data[0] * vaultCollateral[arg1]
    if not tokenPeg * vaultDebt[arg1]:
        revert with 0, 'SafeMath: division by zero'
    return (100 * ext_call.return_data[0] * vaultCollateral[arg1] / tokenPeg * vaultDebt[arg1])
}
...
function checkLiquidation(uint256 arg1) payable {
    ...
    if not 10^0 * ext_call.return_data[0] * vaultCollateral[arg1]:
        ...
        if not tokenPeg * vaultDebt[arg1]:
            revert with 0, 'SafeMath: division by zero'
        if 100 * 10^0 * ext_call.return_data[0] * vaultCollateral[arg1] / tokenPeg * vaultDebt[arg1] >= sub_e5f4dc92:
            return 0
    return 1
}
...
function borrowToken(uint256 arg1, uint256 arg2) payable {
    ...
    if not 10^0 * ext_call.return_data[0] * vaultCollateral[arg1]:
        ...
        if not (arg2 * tokenPeg) + (vaultDebt[arg1] * tokenPeg):
            revert with 0, 'SafeMath: division by zero'
        if sub_e5f4dc92 > 100 * 10^0 * ext_call.return_data[0] * vaultCollateral[arg1] / (arg2 * tokenPeg) + (vaultDebt[arg1] * tokenPeg):
            revert with 0, 
                        32,
                        58,
                        0x6e426f72726f7720776f756c6420707574207661756c742062656c6f77206d696e696d756d20636f6c6c61746572616c2070657263656e746167,
...
function payBackToken(uint256 arg1, uint256 arg2) payable {
    ...
    if not arg2:
        ...
        if arg2 > vaultDebt[arg1]:
            revert with 0, 'SafeMath: subtraction overflow'
        vaultDebt[arg1] -= arg2
        if 0 / 10000 * ext_call.return_data[0] > vaultCollateral[arg1]:
            revert with 0, 'SafeMath: subtraction overflow'
        vaultCollateral[arg1] -= 0 / 10000 * ext_call.return_data[0]
        if (0 / 10000 * ext_call.return_data[0]) + vaultCollateral[stor20] < vaultCollateral[stor20]:
            revert with 0, 'SafeMath: addition overflow'
        vaultCollateral[stor20] += 0 / 10000 * ext_call.return_data[0]
        ...
        if not closingFee * arg2:
            ...
            if arg2 > vaultDebt[arg1]:
                revert with 0, 'SafeMath: subtraction overflow'
            vaultDebt[arg1] -= arg2
            if tokenPeg * closingFee * arg2 / 10000 * ext_call.return_data[0] > vaultCollateral[arg1]:
                revert with 0, 'SafeMath: subtraction overflow'
            vaultCollateral[arg1] -= tokenPeg * closingFee * arg2 / 10000 * ext_call.return_data[0]
            if (tokenPeg * closingFee * arg2 / 10000 * ext_call.return_data[0]) + vaultCollateral[stor20] < vaultCollateral[stor20]:
                revert with 0, 'SafeMath: addition overflow'
            vaultCollateral[stor20] += tokenPeg * closingFee * arg2 / 10000 * ext_call.return_data[0]
            if arg2 > totalBorrowed:
                revert with 0, 'SafeMath: subtraction overflow'
            totalBorrowed -= arg2
...
function withdrawCollateral(uint256 arg1, uint256 arg2) payable {
    ...
    if not vaultDebt[arg1]:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if not vaultCollateral[arg1] - arg2:
            require 0 >= vaultCollateral[arg1] - arg2
            require vaultDebt[arg1]
            require tokenPeg * vaultDebt[arg1] / vaultDebt[arg1] != tokenPeg
            revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
        if (vaultCollateral[arg1] * ext_call.return_data[0]) - (arg2 * ext_call.return_data[0]) / vaultCollateral[arg1] - arg2 != ext_call.return_data[0]:
            revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
        if not (vaultCollateral[arg1] * ext_call.return_data[0]) - (arg2 * ext_call.return_data[0]):
            require 0 >= vaultCollateral[arg1] - arg2
            require vaultDebt[arg1]
            require tokenPeg * vaultDebt[arg1] / vaultDebt[arg1] != tokenPeg
            revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
        if (vaultCollateral[arg1] * ext_call.return_data[0] * 10^0) - (arg2 * ext_call.return_data[0] * 10^0) / (vaultCollateral[arg1] * ext_call.return_data[0]) - (arg2 * ext_call.return_data[0]) != 10^0:
            revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
        require (vaultCollateral[arg1] * ext_call.return_data[0] * 10^0) - (arg2 * ext_call.return_data[0] * 10^0) >= vaultCollateral[arg1] - arg2
        if not vaultDebt[arg1]:
            require 0 >= vaultDebt[arg1]
            if not (vaultCollateral[arg1] * ext_call.return_data[0] * 10^0) - (arg2 * ext_call.return_data[0] * 10^0):
                if 0 > (vaultCollateral[arg1] * ext_call.return_data[0] * 10^0) - (arg2 * ext_call.return_data[0] * 10^0):
                    revert with 0, 'SafeMath: division by zero'
            else:
                if (100 * vaultCollateral[arg1] * ext_call.return_data[0] * 10^0) - (100 * arg2 * ext_call.return_data[0] * 10^0) / (vaultCollateral[arg1] * ext_call.return_data[0] * 10^0) - (arg2 * ext_call.return_data[0] * 10^0) != 100:
                    revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
                if (100 * vaultCollateral[arg1] * ext_call.return_data[0] * 10^0) - (100 * arg2 * ext_call.return_data[0] * 10^0) > (vaultCollateral[arg1] * ext_call.return_data[0] * 10^0) - (arg2 * ext_call.return_data[0] * 10^0):
                    revert with 0, 'SafeMath: division by zero'
            revert
        if tokenPeg * vaultDebt[arg1] / vaultDebt[arg1] != tokenPeg:
            revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
        require tokenPeg * vaultDebt[arg1] >= vaultDebt[arg1]
        if not (vaultCollateral[arg1] * ext_call.return_data[0] * 10^0) - (arg2 * ext_call.return_data[0] * 10^0):
            require 0 > (vaultCollateral[arg1] * ext_call.return_data[0] * 10^0) - (arg2 * ext_call.return_data[0] * 10^0)
            if not tokenPeg * vaultDebt[arg1]:
                revert with 0, 'SafeMath: division by zero'
            ...
            if (100 * vaultCollateral[arg1] * ext_call.return_data[0] * 10^0) - (100 * arg2 * ext_call.return_data[0] * 10^0) / (vaultCollateral[arg1] * ext_call.return_data[0] * 10^0) - (arg2 * ext_call.return_data[0] * 10^0) != 100:
                revert with 0, 32, 33, 0x65536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[325 len 31]
            require (100 * vaultCollateral[arg1] * ext_call.return_data[0] * 10^0) - (100 * arg2 * ext_call.return_data[0] * 10^0) > (vaultCollateral[arg1] * ext_call.return_data[0] * 10^0) - (arg2 * ext_call.return_data[0] * 10^0)
            if not tokenPeg * vaultDebt[arg1]:
                revert with 0, 'SafeMath: division by zero'
            if sub_e5f4dc92 > (100 * vaultCollateral[arg1] * ext_call.return_data[0] * 10^0) - (100 * arg2 * ext_call.return_data[0] * 10^0) / tokenPeg * vaultDebt[arg1]:
                revert with 0, 
                            32,
                            62,
                            0x6e5769746864726177616c20776f756c6420707574207661756c742062656c6f77206d696e696d756d20636f6c6c61746572616c2070657263656e746167,
