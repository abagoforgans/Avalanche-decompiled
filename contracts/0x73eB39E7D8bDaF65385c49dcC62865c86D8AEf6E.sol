...
const SecondTeamWallet = 0x364d83baff8b01181a616359e9b720dfe8220209
...
const TeamWallet = 0x364d83baff8b01181a616359e9b720dfe8220209
...
function SetupEnableTrading() {
    if owner != msg.sender:
        if msg.sender != 0x364d83baff8b01181a616359e9b720dfe8220209:
...
function sub_2e2d5eb3(?) {
    if owner != msg.sender:
        if msg.sender != 0x364d83baff8b01181a616359e9b720dfe8220209:
            revert with 0, 'Caller not in Team'
    marketingBalance = 0
    call 0x364d83baff8b01181a616359e9b720dfe8220209 with:
