...
function withdrawDAI(address arg1, uint256 arg2) payable {
    ...
    if not sub_f9f5cc73[address(msg.sender)]:
        ...
        if not ext_call.return_data[0]:
            ...
            call stor1.withdraw(address arg1, uint256 arg2, address arg3) with:
                 gas gas_remaining wei
                args stor2, (sub_f9f5cc73[address(msg.sender)] * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18, this.address
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            ...
            if ext_call.return_data[0] - ((ext_call.return_data[0] * arg2) - ((sub_f9f5cc73[address(msg.sender)] * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100):
                ...
                if not ext_call.return_data[0]:
                    revert with 0, 'Could not transfer tokens'
            emit Withdrawal((sub_f9f5cc73[address(msg.sender)] * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18, stor2, address(arg1), arg2, ext_call.return_data[0], (ext_call.return_data[0] * arg2) - ((sub_f9f5cc73[address(msg.sender)] * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100, msg.sender);
}
...
function withdrawUSDT(address arg1, uint256 arg2) payable {
    ...
    if not sub_f9f5cc73[address(msg.sender)]:
        ...
        if not ext_call.return_data[0]:
            ...
            call stor1.withdraw(address arg1, uint256 arg2, address arg3) with:
                 gas gas_remaining wei
                args stor3, (sub_f9f5cc73[address(msg.sender)] * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18, this.address
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if ext_call.return_data[0] < (sub_f9f5cc73[address(msg.sender)] * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18:
            ...
            if ext_call.return_data[0] - ((ext_call.return_data[0] * arg2) - ((sub_f9f5cc73[address(msg.sender)] * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100):
                ...
                if not ext_call.return_data[0]:
                    revert with 0, 'Could not transfer tokens'
            emit Withdrawal((sub_f9f5cc73[address(msg.sender)] * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18, stor3, address(arg1), arg2, ext_call.return_data[0], (ext_call.return_data[0] * arg2) - ((sub_f9f5cc73[address(msg.sender)] * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100, msg.sender);
}
