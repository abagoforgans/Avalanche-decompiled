...
function triggerRunChecks() payable {
    ...
    if sPoolAmount >= 10 * 10^18:
        ...
        call address(stor16.field_0).createRandom(uint256 rg1, uint256 rg2) with:
...
function randomValueCreated(uint256 arg1, uint256 arg2) payable {
    ...
    require msg.sender == address(stor16.field_0)
    if not arg2:
        require arg1 < stor0.length
        pendingWithdrawAmount[stor0[arg1].field_0] += 8 * 10^18
        emit 0xd3bdb6cd: 8 * 10^18, stor0[arg1].field_0, sPoolNo, 0
        vaultAmount += 10^18
        mPoolAmount += 10^18
        sPoolAmount = 0
        stor0.length = 0
        ...
        if arg2 == 1:
            ...
            pendingWithdrawAmount[stor1[arg1].field_0] += 20 * 10^18
            emit 0xd3bdb6cd: 20 * 10^18, stor1[arg1].field_0, mPoolNo, 1
            lPoolAmount += 5 * 10^18
            mPoolAmount = 0
            stor1.length = 0
            idx = 0
            ...
            if arg2 != 2:
                if arg2 == 3:
                    ...
                    pendingWithdrawAmount[stor3[arg1].field_0] += 100 * 10^18
                    emit 0xd3bdb6cd: 100 * 10^18, stor3[arg1].field_0, xPoolNo, 3
                    xPoolAmount = 0
                    stor3.length = 0
                    idx = 0
                ...
                pendingWithdrawAmount[stor2[arg1].field_0] += 50 * 10^18
                emit 0xd3bdb6cd: 50 * 10^18, stor2[arg1].field_0, lPoolNo, 2
