...
function amIOwner() payable {
    return (msg.sender == owner)
}

function tokenExists(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    return not not stor3[arg1]
}

function sub_26ee19b9(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
...
function sub_9c91b00d(?) payable {
    require calldata.size - 4 >= 64
    if arg1 >= arg2:
        return ((arg1 * arg1) + arg1 + arg2)
    return (arg1 + (arg2 * arg2))
}

function setContractOwner(address arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Caller is not the owner'
    owner = arg1
...
function sub_9f776ada(?) payable {
    ...
    if arg1:
        if arg1 <= 175760000:
            ...
            if arg1 + (-1 * s * s) - 1 >= s:
                if s < 17576:
                    if arg1 + (-1 * s * s) + -s - 1 < 10000:
                        return 1, s, arg1 + (-1 * s * s) + -s - 1
            else:
                if arg1 + (-1 * s * s) - 1 < 17576:
                    if s < 10000:
                        return 1, arg1 + (-1 * s * s) - 1, s
            return 0
        else:
            return 0
    else:
...
function tokenURI(uint256 arg1) payable {
    ...
    if stor8[arg1].length > 0:
        ...
        if not _1077 % 32:
            return 32, mem[stor8[arg1].length + ceil32(stor8[arg1].length) + baseURI.length + 192 len _1077 + 32]
        mem[floor32(_1077) + stor8[arg1].length + ceil32(stor8[arg1].length) + baseURI.length + 224] = mem[floor32(_1077) + stor8[arg1].length + ceil32(stor8[arg1].length) + baseURI.length + -(_1077 % 32) + 256 len _1077 % 32]
        return 32, mem[stor8[arg1].length + ceil32(stor8[arg1].length) + baseURI.length + 192 len floor32(_1077) + 64]
    if not arg1:
