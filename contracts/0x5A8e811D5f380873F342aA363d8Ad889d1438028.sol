            ...
            if ext_call.return_data[0] > 0:
                if arg4:
                    ...
                    while idx < (ext_call.return_data[0] / arg4) + 1:
                        ...
                        if t <= arg4:
                            _132 = mem[64]
                            mem[mem[64]] = 0x2c0206db00000000000000000000000000000000000000000000000000000000
                            mem[mem[64] + 4] = t
                            mem[mem[64] + 36] = 0
                            mem[mem[64] + 68] = 160
                    ...
                    if 24 * 3600 > !block.timestamp:
                        revert with 0, 17
                    mem[(2 * ceil32(return_data.size)) + (32 * arg3.length) + 128] = 0x2c0206db00000000000000000000000000000000000000000000000000000000
                    ...
                    if arg4:
                        ...
                        while idx < (ext_call.return_data[0] / arg4) + 1:
                            ...
                            if t <= arg4:
                                ...
                                mem[_130 + 132] = block.timestamp + (24 * 3600)
                                require ext_code.size(arg2)
                                call arg2.mem[mem[64] len 4] with:
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4 len _130 + (32 * _138) + -mem[64] + 192]
                                if not ext_call.success:
                                    if arg6:
                                        if stor5 == -1:
                                            revert with 0, 17
                        ...
                        if 24 * 3600 > !block.timestamp:
                            revert with 0, 17
                        mem[(4 * ceil32(return_data.size)) + (32 * arg3.length) + 128] = 0x2c0206db00000000000000000000000000000000000000000000000000000000
