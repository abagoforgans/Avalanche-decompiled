        ...
        if not stor3:
            ...
            if not 0 / (0 / arg2) + stor3:
                ...
                if not arg2:
                    ...
                    call stor0.0xa9059cbb with:
                         gas gas_remaining wei
                        args address(stor4.field_0), (5 * arg2 / 100) - (5 * arg2 / 100 / 2)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
            ...
            if not stor2:
                if not stor3:
                    ...
                    if not 0 / (0 / claimedEggs[msg.sender]) + stor3:
                        ...
                        call stor0.0xa9059cbb with:
                             gas gas_remaining wei
                            args ceoAddress2, 5 * 0 / (0 / claimedEggs[msg.sender]) + stor3 / 100 / 2
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        require ext_code.size(stor0)
                        call stor0.0xa9059cbb with:
                             gas gas_remaining wei
                            args address(stor4.field_0), (5 * 0 / (0 / claimedEggs[msg.sender]) + stor3 / 100) - (5 * 0 / (0 / claimedEggs[msg.sender]) + stor3 / 100 / 2)
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                    ...
                    if not 0 / (claimedEggs[msg.sender] * stor3 / claimedEggs[msg.sender]) + stor3:
                        ...
                        call stor0.0xa9059cbb with:
                             gas gas_remaining wei
                            args ceoAddress2, 5 * 0 / (claimedEggs[msg.sender] * stor3 / claimedEggs[msg.sender]) + stor3 / 100 / 2
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        require ext_code.size(stor0)
                        call stor0.0xa9059cbb with:
                             gas gas_remaining wei
                            args address(stor4.field_0), (5 * 0 / (claimedEggs[msg.sender] * stor3 / claimedEggs[msg.sender]) + stor3 / 100) - (5 * 0 / (claimedEggs[msg.sender] * stor3 / claimedEggs[msg.sender]) + stor3 / 100 / 2)
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                ...
                if not stor2:
                    if not stor3:
                        ...
                        if not ext_call.return_data[0] * stor2 / (0 / claimedEggs[msg.sender]) + stor3:
                            ...
                            call stor0.0xa9059cbb with:
                                 gas gas_remaining wei
                                args ceoAddress2, 5 * ext_call.return_data[0] * stor2 / (0 / claimedEggs[msg.sender]) + stor3 / 100 / 2
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            require ext_code.size(stor0)
                            call stor0.0xa9059cbb with:
                                 gas gas_remaining wei
                                args address(stor4.field_0), (5 * ext_call.return_data[0] * stor2 / (0 / claimedEggs[msg.sender]) + stor3 / 100) - (5 * ext_call.return_data[0] * stor2 / (0 / claimedEggs[msg.sender]) + stor3 / 100 / 2)
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                        ...
                        if not ext_call.return_data[0] * stor2 / (claimedEggs[msg.sender] * stor3 / claimedEggs[msg.sender]) + stor3:
                            ...
                            call stor0.0xa9059cbb with:
                                 gas gas_remaining wei
                                args ceoAddress2, 5 * ext_call.return_data[0] * stor2 / (claimedEggs[msg.sender] * stor3 / claimedEggs[msg.sender]) + stor3 / 100 / 2
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            require ext_code.size(stor0)
                            call stor0.0xa9059cbb with:
                                 gas gas_remaining wei
                                args address(stor4.field_0), (5 * ext_call.return_data[0] * stor2 / (claimedEggs[msg.sender] * stor3 / claimedEggs[msg.sender]) + stor3 / 100) - (5 * ext_call.return_data[0] * stor2 / (claimedEggs[msg.sender] * stor3 / claimedEggs[msg.sender]) + stor3 / 100 / 2)
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                    ...
                    if not stor3:
                        ...
                        if not ext_call.return_data[0] * stor2 / (marketEggs * stor2 / claimedEggs[msg.sender]) + stor3:
                            ...
                            call stor0.0xa9059cbb with:
                                 gas gas_remaining wei
                                args ceoAddress2, 5 * ext_call.return_data[0] * stor2 / (marketEggs * stor2 / claimedEggs[msg.sender]) + stor3 / 100 / 2
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            require ext_code.size(stor0)
                            call stor0.0xa9059cbb with:
                                 gas gas_remaining wei
                                args address(stor4.field_0), (5 * ext_call.return_data[0] * stor2 / (marketEggs * stor2 / claimedEggs[msg.sender]) + stor3 / 100) - (5 * ext_call.return_data[0] * stor2 / (marketEggs * stor2 / claimedEggs[msg.sender]) + stor3 / 100 / 2)
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                        ...
                        if not ext_call.return_data[0] * stor2 / ((claimedEggs[msg.sender] * stor3) + (marketEggs * stor2) / claimedEggs[msg.sender]) + stor3:
                            ...
                            call stor0.0xa9059cbb with:
                                 gas gas_remaining wei
                                args ceoAddress2, 5 * ext_call.return_data[0] * stor2 / ((claimedEggs[msg.sender] * stor3) + (marketEggs * stor2) / claimedEggs[msg.sender]) + stor3 / 100 / 2
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            require ext_code.size(stor0)
                            call stor0.0xa9059cbb with:
                                 gas gas_remaining wei
                                args address(stor4.field_0), (5 * ext_call.return_data[0] * stor2 / ((claimedEggs[msg.sender] * stor3) + (marketEggs * stor2) / claimedEggs[msg.sender]) + stor3 / 100) - (5 * ext_call.return_data[0] * stor2 / ((claimedEggs[msg.sender] * stor3) + (marketEggs * stor2) / claimedEggs[msg.sender]) + stor3 / 100 / 2)
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
            ...
            if not stor2:
                if not stor3:
                    ...
                    if not 0 / (0 / (myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS) + claimedEggs[msg.sender]) + stor3:
                        ...
                        call stor0.0xa9059cbb with:
                             gas gas_remaining wei
                            args ceoAddress2, 5 * 0 / (0 / (myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS) + claimedEggs[msg.sender]) + stor3 / 100 / 2
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        require ext_code.size(stor0)
                        call stor0.0xa9059cbb with:
                             gas gas_remaining wei
                            args address(stor4.field_0), (5 * 0 / (0 / (myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS) + claimedEggs[msg.sender]) + stor3 / 100) - (5 * 0 / (0 / (myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS) + claimedEggs[msg.sender]) + stor3 / 100 / 2)
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                    ...
                    if not 0 / ((myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS * stor3) + (claimedEggs[msg.sender] * stor3) / (myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS) + claimedEggs[msg.sender]) + stor3:
                        ...
                        call stor0.0xa9059cbb with:
                             gas gas_remaining wei
                            args ceoAddress2, 5 * 0 / ((myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS * stor3) + (claimedEggs[msg.sender] * stor3) / (myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS) + claimedEggs[msg.sender]) + stor3 / 100 / 2
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        require ext_code.size(stor0)
                ...
                if not stor2:
                    if not stor3:
                        ...
                        if not ext_call.return_data[0] * stor2 / (0 / (myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS) + claimedEggs[msg.sender]) + stor3:
                            ...
                            call stor0.0xa9059cbb with:
                                 gas gas_remaining wei
                                args ceoAddress2, 5 * ext_call.return_data[0] * stor2 / (0 / (myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS) + claimedEggs[msg.sender]) + stor3 / 100 / 2
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            require ext_code.size(stor0)
                            call stor0.0xa9059cbb with:
                                 gas gas_remaining wei
                                args address(stor4.field_0), (5 * ext_call.return_data[0] * stor2 / (0 / (myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS) + claimedEggs[msg.sender]) + stor3 / 100) - (5 * ext_call.return_data[0] * stor2 / (0 / (myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS) + claimedEggs[msg.sender]) + stor3 / 100 / 2)
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                        ...
                        if not ext_call.return_data[0] * stor2 / ((myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS * stor3) + (claimedEggs[msg.sender] * stor3) / (myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS) + claimedEggs[msg.sender]) + stor3:
                            ...
                            call stor0.0xa9059cbb with:
                                 gas gas_remaining wei
                                args ceoAddress2, 5 * ext_call.return_data[0] * stor2 / ((myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS * stor3) + (claimedEggs[msg.sender] * stor3) / (myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS) + claimedEggs[msg.sender]) + stor3 / 100 / 2
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            require ext_code.size(stor0)
                    ...
                    if not stor3:
                        ...
                        if not ext_call.return_data[0] * stor2 / (marketEggs * stor2 / (myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS) + claimedEggs[msg.sender]) + stor3:
                            ...
                            call stor0.0xa9059cbb with:
                                 gas gas_remaining wei
                                args ceoAddress2, 5 * ext_call.return_data[0] * stor2 / (marketEggs * stor2 / (myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS) + claimedEggs[msg.sender]) + stor3 / 100 / 2
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            require ext_code.size(stor0)
                            call stor0.0xa9059cbb with:
                                 gas gas_remaining wei
                                args address(stor4.field_0), (5 * ext_call.return_data[0] * stor2 / (marketEggs * stor2 / (myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS) + claimedEggs[msg.sender]) + stor3 / 100) - (5 * ext_call.return_data[0] * stor2 / (marketEggs * stor2 / (myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS) + claimedEggs[msg.sender]) + stor3 / 100 / 2)
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                        ...
                        if not ext_call.return_data[0] * stor2 / ((myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS * stor3) + (claimedEggs[msg.sender] * stor3) + (marketEggs * stor2) / (myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS) + claimedEggs[msg.sender]) + stor3:
                            ...
                            call stor0.0xa9059cbb with:
                                 gas gas_remaining wei
                                args ceoAddress2, 5 * ext_call.return_data[0] * stor2 / ((myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS * stor3) + (claimedEggs[msg.sender] * stor3) + (marketEggs * stor2) / (myMiners[address(msg.sender)] * EGGS_TO_HATCH_1MINERS) + claimedEggs[msg.sender]) + stor3 / 100 / 2
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            require ext_code.size(stor0)
            ...
            if not stor2:
                if not stor3:
                    ...
                    if not 0 / (0 / (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) + claimedEggs[msg.sender]) + stor3:
                        ...
                        call stor0.0xa9059cbb with:
                             gas gas_remaining wei
                            args ceoAddress2, 5 * 0 / (0 / (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) + claimedEggs[msg.sender]) + stor3 / 100 / 2
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        require ext_code.size(stor0)
                        call stor0.0xa9059cbb with:
                             gas gas_remaining wei
                            args address(stor4.field_0), (5 * 0 / (0 / (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) + claimedEggs[msg.sender]) + stor3 / 100) - (5 * 0 / (0 / (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) + claimedEggs[msg.sender]) + stor3 / 100 / 2)
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                    ...
                    if not 0 / ((block.timestamp * myMiners[address(msg.sender)] * stor3) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor3) + (claimedEggs[msg.sender] * stor3) / (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) + claimedEggs[msg.sender]) + stor3:
                        ...
                        call stor0.0xa9059cbb with:
                             gas gas_remaining wei
                            args ceoAddress2, 5 * 0 / ((block.timestamp * myMiners[address(msg.sender)] * stor3) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor3) + (claimedEggs[msg.sender] * stor3) / (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) + claimedEggs[msg.sender]) + stor3 / 100 / 2
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        require ext_code.size(stor0)
                ...
                if not stor2:
                    if not stor3:
                        ...
                        if not ext_call.return_data[0] * stor2 / (0 / (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) + claimedEggs[msg.sender]) + stor3:
                            ...
                            call stor0.0xa9059cbb with:
                                 gas gas_remaining wei
                                args ceoAddress2, 5 * ext_call.return_data[0] * stor2 / (0 / (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) + claimedEggs[msg.sender]) + stor3 / 100 / 2
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            require ext_code.size(stor0)
                            call stor0.0xa9059cbb with:
                                 gas gas_remaining wei
                                args address(stor4.field_0), (5 * ext_call.return_data[0] * stor2 / (0 / (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) + claimedEggs[msg.sender]) + stor3 / 100) - (5 * ext_call.return_data[0] * stor2 / (0 / (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) + claimedEggs[msg.sender]) + stor3 / 100 / 2)
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                    ...
                    if not stor3:
                        ...
                        if not ext_call.return_data[0] * stor2 / (marketEggs * stor2 / (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) + claimedEggs[msg.sender]) + stor3:
                            ...
                            call stor0.0xa9059cbb with:
                                 gas gas_remaining wei
                                args ceoAddress2, 5 * ext_call.return_data[0] * stor2 / (marketEggs * stor2 / (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) + claimedEggs[msg.sender]) + stor3 / 100 / 2
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            require ext_code.size(stor0)
                            call stor0.0xa9059cbb with:
                                 gas gas_remaining wei
                                args address(stor4.field_0), (5 * ext_call.return_data[0] * stor2 / (marketEggs * stor2 / (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) + claimedEggs[msg.sender]) + stor3 / 100) - (5 * ext_call.return_data[0] * stor2 / (marketEggs * stor2 / (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) + claimedEggs[msg.sender]) + stor3 / 100 / 2)
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
