...
function sub_47ed4997(?) payable {
    ...
    while idx <= arg2:
        ...
        if mem[_15 + 64]:
            ...
            call pizzaAddress.mint(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
            ...
            call upgradeAddress.transferFrom(address arg1, address arg2, uint256 arg3) with:
                 gas gas_remaining wei
    ...
    while idx <= arg2:
        ...
        if not mem[_44 + 96]:
            ...
            if mem[_52 + 96]:
                ...
                call chefAddress.transferFrom(address arg1, address arg2, uint256 arg3) with:
                     gas gas_remaining wei
