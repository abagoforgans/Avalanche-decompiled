...
function sub_36393da3(?) {
    ...
    create contract with 0 wei
                    code: code.data[13031 len 4488], stor10
...
function sub_f3047945(?) {
    ...
    require totalTransferFee < stor36 / 3
}
...
function sub_954e7021(?) {
    ...
    if not stor1[address(msg.sender)]:
        revert with 0, '!AUTHORIZED'
    sub_96a8797eAddress = address(arg1)
    require ext_code.size(stor45)
...
function setIsDividendExempt(address arg1, bool arg2) {
    ...
    require ext_code.size(stor45)
    if not arg2:
        call stor45.setShare(address arg1, uint256 arg2) with:
             gas gas_remaining wei
