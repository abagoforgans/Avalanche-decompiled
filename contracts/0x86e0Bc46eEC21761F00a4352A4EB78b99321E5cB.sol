...
const sub_1e471e42(?) = (336 * 24 * 3600)

const sub_4139f4ea(?) = (96 * 24 * 3600)
...
function sub_6df5c63e(?) payable {
    return bool(sub_6df5c63e)
}
...
function sub_db731bcc(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'eOwnable: caller is not the owne'
    stor5 = Mask(88, 0, arg1)
}
...
function deposit(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    if sub_31fa95b8 + (96 * 24 * 3600) < sub_31fa95b8:
        revert with 0, 'SafeMath: addition overflow'
    if block.timestamp < sub_31fa95b8 + (96 * 24 * 3600):
        if not msg.sender:
...
function lost() payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] / stor9 > ext_call.return_data[0]:
        revert with 0, 'SafeMath: subtraction overflow'
    if 1 == bool(sub_6df5c63e):
        require ext_code.size(tokenAddress)
        call tokenAddress.0xa9059cbb with:
             gas gas_remaining wei
            args msg.sender, ext_call.return_data[0] / stor9
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_code.size(tokenAddress)
        call tokenAddress.0xa9059cbb with:
             gas gas_remaining wei
            args sub_ba9dcab9Address, ext_call.return_data[0] - (ext_call.return_data[0] / stor9)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
}
...
function claim(uint256 arg1) payable {
    ...
    if not arg1:
        if not totalSupply:
            revert with 0, 'SafeMath: division by zero'
        if sub_31fa95b8 + (336 * 24 * 3600) < sub_31fa95b8:
            revert with 0, 'SafeMath: addition overflow'
        if block.timestamp > sub_31fa95b8 + (336 * 24 * 3600):
            if not msg.sender:
