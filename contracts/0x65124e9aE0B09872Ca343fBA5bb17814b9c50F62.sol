...
uint256 poolId;
uint256 avax_gb_poolId;
address joe_avax_gb_lpAddress;
address gbAddress;
...
function joe_avax_gb_lp() {
    return joe_avax_gb_lpAddress
}
...
function avax_gb_poolId() {
    return avax_gb_poolId
}
...
function deposit() {
    ...
    if ext_call.return_data[0]:
        if not ext_code.size(wantAddress):
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = approve(address arg1, uint256 arg2), 0xd6a4f121ca35509af06a0be9, 0, 0
        call wantAddress.0x62f53052 with:
             gas gas_remaining wei
            args 0, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address arg1, uint256 arg2), 0xd6a4f121ca35509af06a0be9, 0, 0
            if not approve(address arg1, uint256 arg2), 0xd6a4f121ca35509af06a0be9:
                revert with 0, 32, 42, 0xc75361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
            if ext_call.return_data[0]:
                require ext_code.size(wantAddress)
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = approve(address arg1, uint256 arg2), 0xd6a4f121ca35509af06a0be9, 0, ext_call.return_data[0 len 28]
            mem[488 len 0] = 0
            call wantAddress.0x62f53052 with:
                 gas gas_remaining wei
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 425 len 64] = approve(address arg1, uint256 arg2), 0xd6a4f121ca35509af06a0be9, 0, ext_call.return_data[0 len 28]
