...
function increaseRewardDebt(address arg1, uint256 arg2) payable {
    ...
    if rewardTokensPerShare and arg2 > -1 / rewardTokensPerShare:
        revert with 0, 17
    if rewardDebt[address(arg1)] > !(rewardTokensPerShare * arg2):
        revert with 0, 17
    rewardDebt[address(arg1)] += rewardTokensPerShare * arg2
}
...
function decreaseRewardDebt(address arg1, uint256 arg2) payable {
    ...
    if rewardDebt[address(arg1)] < rewardTokensPerShare * arg2:
        revert with 0, 17
    rewardDebt[address(arg1)] += -1 * rewardTokensPerShare * arg2
}
