...
function sub_d04203a4(?) payable {
    ...
    if not _9:
        ...
        while idx < _9:
            ...
            staticcall address(_468).balanceOf(address rg1) with:
                    gas gas_remaining wei
                   args address(arg2)
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
    ...
    if not var36003 - 1:
        ...
        while idx < _9:
            ...
            staticcall address(_917).balanceOf(address rg1) with:
                    gas gas_remaining wei
                   args address(arg2)
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
    ...
    if not var40003 - 1:
        ...
        while idx < _9:
            ...
            staticcall address(_1361).balanceOf(address rg1) with:
                    gas gas_remaining wei
                   args address(arg2)
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
    ...
    if not var44003 - 1:
        ...
        while idx < _9:
            ...
            staticcall address(_1805).balanceOf(address rg1) with:
                    gas gas_remaining wei
                   args address(arg2)
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
    ...
    if not var48003 - 1:
        ...
        while idx < _9:
            ...
            staticcall address(_2249).balanceOf(address rg1) with:
                    gas gas_remaining wei
                   args address(arg2)
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
    ...
    if not var52003 - 1:
        ...
        while idx < _9:
            ...
            staticcall address(_2693).balanceOf(address rg1) with:
                    gas gas_remaining wei
                   args address(arg2)
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
    ...
    if not var56003 - 1:
        ...
        while idx < _9:
            ...
            staticcall address(_3137).balanceOf(address rg1) with:
                    gas gas_remaining wei
                   args address(arg2)
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
    ...
    if not var60003 - 1:
        ...
        while idx < _9:
            ...
            staticcall address(_3581).balanceOf(address rg1) with:
                    gas gas_remaining wei
                   args address(arg2)
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
    ...
    if var64003 - 1:
        ...
        while idx < _9:
            ...
            staticcall address(_4025).balanceOf(address rg1) with:
                    gas gas_remaining wei
                   args address(arg2)
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
