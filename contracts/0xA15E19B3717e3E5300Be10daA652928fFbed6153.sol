...
function safeBatchTransferFrom(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) payable {
    ...
    if arg1 == msg.sender:
        ...
        if not _7566 % 32:
            ...
            call arg2.0xbc197c81 with:
                 gas gas_remaining wei
                args msg.sender, address(arg1), Array(len=mem[96], data=mem[mem[64] + 196 len _7566 + (32 * _6419) + (32 * mem[96]) + 64]), (32 * mem[96]) + 192, (32 * _6419) + (32 * mem[96]) + 224
    ...
    while idx < allProxyRegistries.length:
        ...
        idx = 0
        while idx < 32 * _7575:
            mem[idx + (32 * _6465) + mem[64] + 228] = mem[idx + (32 * arg3.length) + 160]
            idx = idx + 32
            continue 
    ...
    if not _8499 % 32:
        ...
        call arg2.0xbc197c81 with:
             gas gas_remaining wei
            args msg.sender, address(arg1), Array(len=mem[96], data=mem[mem[64] + 196 len _8499 + (32 * _7570) + (32 * mem[96]) + 64]), (32 * mem[96]) + 192, (32 * _7570) + (32 * mem[96]) + 224
        mem[mem[64]] = ext_call.return_data[0]
        if ext_call.success:
            require return_data.size >= 32
            if Mask(32, 224, ext_call.return_data[0]) != 0xbc197c8100000000000000000000000000000000000000000000000000000000:
    ...
    call arg2.0xbc197c81 with:
         gas gas_remaining wei
        args msg.sender, address(arg1), Array(len=mem[96], data=mem[mem[64] + 196 len floor32(_8499) + (32 * _7570) + (32 * mem[96]) + 96]), (32 * mem[96]) + 192, (32 * _7570) + (32 * mem[96]) + 224
    mem[mem[64]] = ext_call.return_data[0]
    if ext_call.success:
        require return_data.size >= 32
        if Mask(32, 224, ext_call.return_data[0]) != 0xbc197c8100000000000000000000000000000000000000000000000000000000:
