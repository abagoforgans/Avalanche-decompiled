...
function ownerMint(address arg1) {
    ...
    if stor3[stor11]:
        ...
        if bool(stor15.length):
            ...
            if stor8[stor11].field_0:
                if stor8[stor11].field_0 == stor8[stor11].field_1 < 32:
                    revert with 'NH{q', 34
                if stor15.length.field_1:
                    stor8[stor11][].field_0 = Array(len=stor15.length.field_1, data=mem[128 len stor15.length.field_1])
                else:
                    stor8[stor11].field_0 = 0
                    idx = 0
                    while stor8[stor11].field_1 + 31 / 32 > idx:
                        stor8[stor11][idx].field_0 = 0
                        idx = idx + 1
                        continue 
            else:
                if stor8[stor11].field_0 == stor8[stor11].field_1 < 32:
        ...
        if bool(stor15.length):
            ...
            if bool(stor15.length):
                ...
                if stor15.length.field_1:
                    if 31 >= stor15.length.field_1:
                        mem[192] = 256 * stor15.length.field_8
                    else:
                        mem[192] = uint256(stor15.field_0)
                        idx = 192
                        s = 0
                        while stor15.length.field_1 + 160 > idx:
                            mem[idx + 32] = stor15[s].field_256
                            idx = idx + 32
                            s = s + 1
                            continue 
            ...
            if stor8[stor11].field_0:
                if stor8[stor11].field_0 == stor8[stor11].field_1 < 32:
                    revert with 'NH{q', 34
                if stor15.length.field_1:
                    stor8[stor11][].field_0 = Array(len=stor15.length.field_1, data=mem[192 len stor15.length.field_1])
                else:
                    stor8[stor11].field_0 = 0
                    idx = 0
                    while stor8[stor11].field_1 + 31 / 32 > idx:
