...
function setContractNFT(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require not sub_fcee510eAddress
    sub_fcee510eAddress = arg1
}
...
function unstake(uint256 arg1) {
    ...
    while idx < arg1:
        ...
        call sub_fcee510eAddress.transferFrom(address arg1, address arg2, uint256 arg3) with:
...
function stake(uint256[] arg1) {
    ...
    staticcall sub_fcee510eAddress.isApprovedForAll(address arg1, address arg2) with:
            gas gas_remaining wei
    ...
    while idx < arg1.length:
        ...
        staticcall sub_fcee510eAddress.ownerOf(uint256 arg1) with:
                gas gas_remaining wei
