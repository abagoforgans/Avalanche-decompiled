...
function sub_773dcbc8(?) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    mem[ceil32(arg5.length) + 128] = 0x8803dbee00000000000000000000000000000000000000000000000000000000
    ...
    call address(ext_call.return_data[0]).swapTokensForExactTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
...
function getAPY(address arg1) payable {
    ...
    ('iszero', ('stor', ('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'balanceLiquidity', 6))))
    revert
}
