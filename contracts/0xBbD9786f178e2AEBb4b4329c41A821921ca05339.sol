...
function flipPausedState() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    Mask(96, 0, stor7.field_160) = Mask(96, 0, not paused)
}

function sub_0798e5c9(?) {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    Mask(72, 0, stor7.field_184) = Mask(72, 0, not sub_4f8a1db5)
}

function sub_a17bd783(?) {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    Mask(80, 0, stor7.field_176) = Mask(80, 0, not sub_a0ba1bbf)
}
