...
function sub_ef2baef7(?) payable {
    ...
    if cd[(cd[4] + ('cd', 4)[4] + 4)] > test266151307():
        revert with 0, 65
    if ceil32(return_data.size) + ceil32(32 * cd[(cd[4] + ('cd', 4)[4] + 4)]) + 321 > test266151307() or ceil32(32 * cd[(cd[4] + ('cd', 4)[4] + 4)]) + 321 < 320:
        revert with 0, 65
    ...
    if cd[(cd[4] + ('cd', 4)[5] + 4)] > test266151307():
        revert with 0, 65
    if ceil32(return_data.size) + ceil32(32 * cd[(cd[4] + ('cd', 4)[4] + 4)]) + ceil32(32 * cd[(cd[4] + ('cd', 4)[5] + 4)]) + 322 > test266151307() or ceil32(32 * cd[(cd[4] + ('cd', 4)[5] + 4)]) + 322 < 321:
        revert with 0, 65
    ...
    while idx < ('cd', 4).length:
        ...
        if mem[_93 + 12 len 20] == address(cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + 100)]):
            ...
            if cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + 196)] + 36)] > test266151307():
                revert with 0, 65
            _97 = mem[64]
            if mem[64] + ceil32(32 * cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + 196)] + 36)]) + 1 > test266151307() or mem[64] + ceil32(32 * cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + 196)] + 36)]) + 1 < mem[64]:
                revert with 0, 65
            ...
            s = cd[(cd[4] + (32 * idx) + 36)] + cd[4] + cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + 196)] + 68
            t = _97 + 32
            while s < (32 * cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + 196)] + 36)]) + cd[(cd[4] + (32 * idx) + 36)] + cd[4] + cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + 196)] + 68:
            ...
            if cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + 228)] + 36)] > test266151307():
                revert with 0, 65
            _179 = mem[64]
            if mem[64] + ceil32(32 * cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + 228)] + 36)]) + 1 > test266151307() or mem[64] + ceil32(32 * cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + 228)] + 36)]) + 1 < mem[64]:
                revert with 0, 65
            ...
            s = cd[(cd[4] + (32 * idx) + 36)] + cd[4] + cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + 228)] + 68
            t = _179 + 32
            while s < (32 * cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + 228)] + 36)]) + cd[(cd[4] + (32 * idx) + 36)] + cd[4] + cd[(cd[(cd[4] + (32 * idx) + 36)] + cd[4] + 228)] + 68:
                require cd[s] == address(cd[s])
                mem[t] = cd[s]
                s = s + 32
                t = t + 32
