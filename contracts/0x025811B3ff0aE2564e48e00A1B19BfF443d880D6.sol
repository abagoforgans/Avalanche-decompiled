                ...
                if not s:
                    ...
                    if ceil32(stor9.length.field_1) <= stor9.length.field_1:
                        ...
                        if ceil32(mem[ceil32(stor9.length.field_1) + 128]) <= mem[ceil32(stor9.length.field_1) + 128]:
                            ...
                            mem[mem[ceil32(stor9.length.field_1) + 128] + ceil32(stor9.length.field_1) + ceil32(s) + stor9.length.field_1 + 256 len ceil32(mem[ceil32(stor9.length.field_1) + ceil32(s) + 160])] = mem[ceil32(stor9.length.field_1) + ceil32(s) + 192 len ceil32(mem[ceil32(stor9.length.field_1) + ceil32(s) + 160])]
                            if ceil32(mem[ceil32(stor9.length.field_1) + ceil32(s) + 160]) <= mem[ceil32(stor9.length.field_1) + ceil32(s) + 160]:
                                return Array(len=mem[ceil32(stor9.length.field_1) + ceil32(s) + 160], data=mem[mem[ceil32(stor9.length.field_1) + 128] + ceil32(stor9.length.field_1) + ceil32(s) + stor9.length.field_1 + 256 len ceil32(mem[ceil32(stor9.length.field_1) + ceil32(s) + 160])]), 
                            mem[mem[ceil32(stor9.length.field_1) + ceil32(s) + 160] + mem[ceil32(stor9.length.field_1) + 128] + ceil32(stor9.length.field_1) + ceil32(s) + stor9.length.field_1 + 256] = 0
                            return 32, mem[mem[ceil32(stor9.length.field_1) + 128] + ceil32(stor9.length.field_1) + ceil32(s) + stor9.length.field_1 + 224 len ceil32(mem[ceil32(stor9.length.field_1) + ceil32(s) + 160]) + 32], 
