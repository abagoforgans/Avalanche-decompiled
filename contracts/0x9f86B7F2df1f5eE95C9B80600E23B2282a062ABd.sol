...
function unwhitelist(address[] arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 <= test266151307()
    require arg1 + 35 < calldata.size
    require arg1.length <= test266151307()
...
function currentCap() payable {
    if block.timestamp <= startTime:
        if uint256(initialCap) and 1 > -1 / uint256(initialCap):
            revert with 0, 17
        if uint256(initialCap) <= maxCap:
            return uint256(initialCap)
    else:
        if block.timestamp < startTime:
            revert with 0, 17
        ...
        if block.timestamp - startTime / epochTime > 10:
            if uint256(initialCap) and 1024 > -1 / uint256(initialCap):
                revert with 0, 17
            if Mask(246, 0, stor6) <= maxCap:
                return Mask(246, 0, stor6)
        else:
            if not block.timestamp - startTime / epochTime:
                ...
                if block.timestamp - startTime / epochTime > 255:
                    revert with 0, 17
                if uint256(initialCap) and 1 << block.timestamp - startTime / epochTime > -1 / uint256(initialCap):
                    revert with 0, 17
                if uint256(initialCap) * 1 << block.timestamp - startTime / epochTime <= maxCap:
                    return (uint256(initialCap) * 1 << block.timestamp - startTime / epochTime)
    return maxCap
}
...
function invest(uint256 arg1) payable {
    ...
    if block.timestamp <= startTime:
        ...
        if sub_f703f36f[msg.sender].field_0 > !arg1:
            revert with 0, 17
        if sub_f703f36f[msg.sender].field_0 + arg1 < sub_bc284c5c:
            revert with 0, 'BELOW_INVEST_TOKEN_AMOUNT'
        if sub_f703f36f[msg.sender].field_0 > !arg1:
            revert with 0, 17
        if uint256(initialCap) <= maxCap:
            if sub_f703f36f[msg.sender].field_0 + arg1 > uint256(initialCap):
        ...
        if block.timestamp - startTime / epochTime > 10:
            ...
            if sub_f703f36f[msg.sender].field_0 > !arg1:
                revert with 0, 17
            if Mask(246, 0, stor6) <= maxCap:
                if sub_f703f36f[msg.sender].field_0 + arg1 > Mask(246, 0, stor6):
                    revert with 0, 'ABOVE_MAX_CONTRIBUTION'
            else:
                if sub_f703f36f[msg.sender].field_0 + arg1 > maxCap:
                    revert with 0, 'ABOVE_MAX_CONTRIBUTION'
            ...
            if not block.timestamp - startTime / epochTime:
                ...
                if sub_f703f36f[msg.sender].field_0 > !arg1:
                    revert with 0, 17
                if uint256(initialCap) * 1 << block.timestamp - startTime / epochTime <= maxCap:
                    if sub_f703f36f[msg.sender].field_0 + arg1 > uint256(initialCap) * 1 << block.timestamp - startTime / epochTime:
                        revert with 0, 'ABOVE_MAX_CONTRIBUTION'
                else:
                    if sub_f703f36f[msg.sender].field_0 + arg1 > maxCap:
                        revert with 0, 'ABOVE_MAX_CONTRIBUTION'
    ...
    if not ext_call.return_data[31 len 1]:
        ...
        if not ext_call.return_data[0]:
            ...
            if not price:
                revert with 0, 18
            require ext_code.size(eTokenAddress)
            call eTokenAddress.0x867904b4 with:
                 gas gas_remaining wei
