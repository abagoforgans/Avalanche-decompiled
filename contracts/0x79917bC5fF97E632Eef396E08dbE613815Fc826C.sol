...
function mint(string arg1) payable {
    ...
    tokenByIndex.length++
    tokenByIndex[tokenByIndex.length] = pos + 1
    if msg.sender:
        if msg.sender:
            if not msg.sender:
                revert with 0, 'ERC721: balance query for the zero address'
            tokenOfOwnerByIndex[address(msg.sender)][stor3[address(msg.sender)]] = pos + 1
            stor7[stor11 + 1] = balanceOf[address(msg.sender)]
    else:
        if tokenByIndex.length < 1:
            revert with 0, 17
        if tokenByIndex.length - 1 >= tokenByIndex.length:
    ...
    emit Transfer(0, msg.sender, pos + 1);
    if ext_code.size(msg.sender):
        require ext_code.size(msg.sender)
        call msg.sender.0x150b7a02 with:
             gas gas_remaining wei
            args msg.sender, 0, pos + 1, 128, 0
        ...
        if Mask(32, 224, ext_call.return_data[0]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
    if stor12[stor11].field_0:
        if stor12[stor11].field_0 == uint255(stor12[stor11].field_0) * 0.5 < 32:
            revert with 0, 34
        if arg1.length:
            stor12[stor11][].field_0 = Array(len=arg1.length, data=arg1[all])
        else:
            stor12[stor11].field_0 = 0
            idx = 0
            while (uint255(stor12[stor11].field_0) * 0.5) + 31 / 32 > idx:
                stor12[stor11][idx].field_0 = 0
                idx = idx + 1
                continue 
    else:
        if stor12[stor11].field_0 == stor12[stor11].field_1 < 32:
            revert with 0, 34
        if arg1.length:
            stor12[stor11][].field_0 = Array(len=arg1.length, data=arg1[all])
        else:
            stor12[stor11].field_0 = 0
            idx = 0
            while stor12[stor11].field_1 + 31 / 32 > idx:
                stor12[stor11][idx].field_0 = 0
                idx = idx + 1
                continue 
}
