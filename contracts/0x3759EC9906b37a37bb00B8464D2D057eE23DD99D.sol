...
function joeCall(address arg1, uint256 arg2, uint256 arg3, bytes arg4) payable {
    ...
    if not arg2:
        ...
        mem[228] = (0 / (997 * Mask(112, 0, ext_call.return_data[32])) - (997 * arg2)) + 1
        ...
        call joeRouterAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
             gas gas_remaining wei
            args ext_call.return_data[0], (0 / (997 * Mask(112, 0, ext_call.return_data[32])) - (997 * arg2)) + 1, Array(len=2, data=mem[388 len 64]), address(this.address), block.timestamp + (240 * 24 * 3600)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[192 len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = ceil32(return_data.size) + 192
        require return_data.size >= 32
        _110 = mem[192 len 4], ext_call.return_data[0 len 28]
        ...
        call WAVAXAddress.0xa9059cbb with:
             gas gas_remaining wei
            args tx.origin, mem[ceil32(return_data.size) + 256] + -(0 / (997 * Mask(112, 0, ext_call.return_data[32])) - (997 * arg2)) - 1
    else:
        require arg2
        ...
        mem[192] = 0x38ed173900000000000000000000000000000000000000000000000000000000
        mem[196] = ext_call.return_data[0]
        mem[228] = (1000 * Mask(112, 0, ext_call.return_data[0]) * arg2 / (997 * Mask(112, 0, ext_call.return_data[32])) - (997 * arg2)) + 1
        mem[292] = this.address
        mem[324] = block.timestamp + (240 * 24 * 3600)
        mem[260] = 160
        mem[356] = 2
        ...
        call joeRouterAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
             gas gas_remaining wei
            args ext_call.return_data[0], (1000 * Mask(112, 0, ext_call.return_data[0]) * arg2 / (997 * Mask(112, 0, ext_call.return_data[32])) - (997 * arg2)) + 1, Array(len=2, data=mem[388 len 64]), address(this.address), block.timestamp + (240 * 24 * 3600)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[192 len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = ceil32(return_data.size) + 192
        require return_data.size >= 32
        _112 = mem[192 len 4], ext_call.return_data[0 len 28]
        require mem[192 len 4], ext_call.return_data[0 len 28] <= 4294967296
        require mem[192 len 4], ext_call.return_data[0 len 28] + 32 <= return_data.size
        require mem[mem[192 len 4], ext_call.return_data[0 len 28] + 192] <= 4294967296 and mem[192 len 4], ext_call.return_data[0 len 28] + (32 * mem[mem[192 len 4], ext_call.return_data[0 len 28] + 192]) + 32 <= return_data.size
        mem[ceil32(return_data.size) + 192] = mem[mem[192 len 4], ext_call.return_data[0 len 28] + 192]
        ...
        call WAVAXAddress.0xa9059cbb with:
             gas gas_remaining wei
            args tx.origin, mem[ceil32(return_data.size) + 256] + -(1000 * Mask(112, 0, ext_call.return_data[0]) * arg2 / (997 * Mask(112, 0, ext_call.return_data[32])) - (997 * arg2)) - 1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
}
