...
function getAllPoolInUSD() payable {
    if not paused:
        require ext_code.size(strategyAddress)
        staticcall strategyAddress.0xbd244af4 with:
                gas gas_remaining wei
    else:
...
function releaseFees() payable {
    ...
    if not 10^18 * ext_call.return_data[0] / totalSupply:
        revert with 0, 18
    if 10^18 * fees / 10^18 * ext_call.return_data[0] / totalSupply > 0x3fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff:
        revert with 0, 17
    if not treasuryWalletAddress:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply > !(4 * 10^18 * fees / 10^18 * ext_call.return_data[0] / totalSupply / 5):
        revert with 0, 17
    totalSupply += 4 * 10^18 * fees / 10^18 * ext_call.return_data[0] / totalSupply / 5
    if balanceOf[stor253] > !(4 * 10^18 * fees / 10^18 * ext_call.return_data[0] / totalSupply / 5):
        revert with 0, 17
    balanceOf[stor253] += 4 * 10^18 * fees / 10^18 * ext_call.return_data[0] / totalSupply / 5
    emit Transfer((4 * 10^18 * fees / 10^18 * ext_call.return_data[0] / totalSupply / 5), 0, treasuryWalletAddress);
    if 10^18 * fees / 10^18 * ext_call.return_data[0] / totalSupply > -1:
        revert with 0, 17
    if not treasuryWalletAddress:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply > !(10^18 * fees / 10^18 * ext_call.return_data[0] / totalSupply / 5):
        revert with 0, 17
    totalSupply += 10^18 * fees / 10^18 * ext_call.return_data[0] / totalSupply / 5
    if balanceOf[stor253] > !(10^18 * fees / 10^18 * ext_call.return_data[0] / totalSupply / 5):
        revert with 0, 17
    balanceOf[stor253] += 10^18 * fees / 10^18 * ext_call.return_data[0] / totalSupply / 5
    emit Transfer((10^18 * fees / 10^18 * ext_call.return_data[0] / totalSupply / 5), 0, treasuryWalletAddress);
    fees = 0
}
