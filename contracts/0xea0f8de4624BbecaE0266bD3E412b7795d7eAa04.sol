...
const SecondTeamWallet = 0x63feec98b3a4a7def7d0c0695c8dd34f49dff765
...
const TeamWallet = 0x63feec98b3a4a7def7d0c0695c8dd34f49dff765
...
function SetupEnableTrading() {
    if owner != msg.sender:
        if msg.sender != 0x63feec98b3a4a7def7d0c0695c8dd34f49dff765:
...
function sub_2e2d5eb3(?) {
    if owner != msg.sender:
        if msg.sender != 0x63feec98b3a4a7def7d0c0695c8dd34f49dff765:
            revert with 0, 'Caller not in Team'
    marketingBalance = 0
    call 0x63feec98b3a4a7def7d0c0695c8dd34f49dff765 with:
