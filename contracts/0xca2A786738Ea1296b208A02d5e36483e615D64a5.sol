    ...
    if block.timestamp > poolInfo[arg1].field_512:
        ...
        if ext_call.return_data[0]:
            if poolInfo[arg1].field_256:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if (block.timestamp * tokenPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerSecond * poolInfo[arg1].field_256) / totalAllocPoint and burnRate > -1 / (block.timestamp * tokenPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerSecond * poolInfo[arg1].field_256) / totalAllocPoint:
                    revert with 'NH{q', 17
                require ext_code.size(tokenAddress)
                ...
                require ext_call.return_data[0] == ext_call.return_data[0]
                require ext_code.size(tokenAddress)
                if (block.timestamp * tokenPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerSecond * poolInfo[arg1].field_256) / totalAllocPoint * burnRate / 100 <= ext_call.return_data[0]:
                    call tokenAddress.transfer(address rg1, uint256 rg2) with:
                         gas gas_remaining wei
                        args 57005, (block.timestamp * tokenPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerSecond * poolInfo[arg1].field_256) / totalAllocPoint * burnRate / 100
                else:
                    call tokenAddress.transfer(address rg1, uint256 rg2) with:
                         gas gas_remaining wei
                ...
                if (block.timestamp * tokenPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerSecond * poolInfo[arg1].field_256) / totalAllocPoint < (block.timestamp * tokenPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerSecond * poolInfo[arg1].field_256) / totalAllocPoint * burnRate / 100:
                    revert with 'NH{q', 17
                if ((block.timestamp * tokenPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerSecond * poolInfo[arg1].field_256) / totalAllocPoint) - ((block.timestamp * tokenPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerSecond * poolInfo[arg1].field_256) / totalAllocPoint * burnRate / 100) and 10^12 > -1 / ((block.timestamp * tokenPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerSecond * poolInfo[arg1].field_256) / totalAllocPoint) - ((block.timestamp * tokenPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerSecond * poolInfo[arg1].field_256) / totalAllocPoint * burnRate / 100):
                    revert with 'NH{q', 17
                if not ext_call.return_data[0]:
                    revert with 'NH{q', 18
                if poolInfo[arg1].field_768 > -((10^12 * (block.timestamp * tokenPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerSecond * poolInfo[arg1].field_256) / totalAllocPoint) - (10^12 * (block.timestamp * tokenPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerSecond * poolInfo[arg1].field_256) / totalAllocPoint * burnRate / 100) / ext_call.return_data[0]) - 1:
                    revert with 'NH{q', 17
                poolInfo[arg1].field_768 += (10^12 * (block.timestamp * tokenPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerSecond * poolInfo[arg1].field_256) / totalAllocPoint) - (10^12 * (block.timestamp * tokenPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerSecond * poolInfo[arg1].field_256) / totalAllocPoint * burnRate / 100) / ext_call.return_data[0]
        ...
        if block.timestamp > poolInfo[idx].field_512:
            ...
            if mem[_29]:
                if poolInfo[idx].field_256:
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    if (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint and burnRate > -1 / (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint:
                        revert with 'NH{q', 17
                    mem[mem[64] + 4] = this.address
                    require ext_code.size(tokenAddress)
                    staticcall tokenAddress.balanceOf(address rg1) with:
                    ...
                    mem[mem[64] + 4] = 57005
                    if (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100 <= mem[_37]:
                        mem[mem[64] + 36] = (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100
                        require ext_code.size(tokenAddress)
                        call tokenAddress.transfer(address rg1, uint256 rg2) with:
                             gas gas_remaining wei
                            args 57005, (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100
                        mem[mem[64]] = ext_call.return_data[0]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        _43 = mem[64]
                        ...
                        if not mem[_44]:
                            revert with 0, 'safeTokenTransfer: transfer failed'
                    if (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint < (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100:
                        revert with 'NH{q', 17
                    if ((block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint) - ((block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100) and 10^12 > -1 / ((block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint) - ((block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100):
                        revert with 'NH{q', 17
                    if not _30:
                        revert with 'NH{q', 18
                    if poolInfo[idx].field_768 > -((10^12 * (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint) - (10^12 * (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100) / _30) - 1:
                        revert with 'NH{q', 17
                    poolInfo[idx].field_768 += (10^12 * (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint) - (10^12 * (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100) / _30
        ...
        if block.timestamp > poolInfo[idx].field_512:
            ...
            if mem[_37]:
                if poolInfo[idx].field_256:
                    ...
                    mem[mem[64] + 4] = 57005
                    if (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100 <= mem[_45]:
                        mem[mem[64] + 36] = (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100
                        require ext_code.size(tokenAddress)
                        call tokenAddress.transfer(address rg1, uint256 rg2) with:
                             gas gas_remaining wei
                    ...
                    if not _38:
                        revert with 'NH{q', 18
                    if poolInfo[idx].field_768 > -((10^12 * (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint) - (10^12 * (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100) / _38) - 1:
                        revert with 'NH{q', 17
                    poolInfo[idx].field_768 += (10^12 * (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint) - (10^12 * (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100) / _38
            poolInfo[idx].field_512 = block.timestamp
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
            ...
            if block.timestamp > poolInfo[idx].field_512:
                ...
                if mem[_38]:
                    if poolInfo[idx].field_256:
                        ...
                        mem[mem[64] + 4] = 57005
                        if (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100 <= mem[_50]:
                            mem[mem[64] + 36] = (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100
                            require ext_code.size(tokenAddress)
                            call tokenAddress.transfer(address rg1, uint256 rg2) with:
                                 gas gas_remaining wei
                        ...
                        if not _39:
                            revert with 'NH{q', 18
                        if poolInfo[idx].field_768 > -((10^12 * (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint) - (10^12 * (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100) / _39) - 1:
                            revert with 'NH{q', 17
                        poolInfo[idx].field_768 += (10^12 * (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint) - (10^12 * (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100) / _39
                poolInfo[idx].field_512 = block.timestamp
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
            ...
            if block.timestamp > poolInfo[idx].field_512:
                ...
                if mem[_77]:
                    if poolInfo[idx].field_256:
                        ...
                        mem[mem[64] + 4] = 57005
                        if (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100 <= mem[_106]:
                            mem[mem[64] + 36] = (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100
                            require ext_code.size(tokenAddress)
                            call tokenAddress.transfer(address rg1, uint256 rg2) with:
                                 gas gas_remaining wei
                        ...
                        if not _79:
                            revert with 'NH{q', 18
                        if poolInfo[idx].field_768 > -((10^12 * (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint) - (10^12 * (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100) / _79) - 1:
                            revert with 'NH{q', 17
                        poolInfo[idx].field_768 += (10^12 * (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint) - (10^12 * (block.timestamp * tokenPerSecond * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerSecond * poolInfo[idx].field_256) / totalAllocPoint * burnRate / 100) / _79
                poolInfo[idx].field_512 = block.timestamp
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
    ...
    if block.timestamp <= poolInfo[arg1].field_512:
        if userInfo[arg1][address(msg.sender)].field_0 <= 0:
            if arg2 > 0:
                ...
                mem[ceil32(return_data.size) + 292 len 128] = transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg2, 0
            ...
            if (userInfo[arg1][address(msg.sender)].field_0 * poolInfo[arg1].field_768 / 10^12) - userInfo[arg1][address(msg.sender)].field_256 <= 0:
                ...
                if arg2 > 0:
                    ...
                    if ext_code.size(poolInfo[arg1].field_0) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(4 * ceil32(return_data.size)) + 292 len 128] = transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg2, 0
        ...
        if not ext_call.return_data[0]:
            ...
            if userInfo[arg1][address(msg.sender)].field_0 <= 0:
                if arg2 > 0:
                    ...
                    if ext_code.size(poolInfo[arg1].field_0) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 292 len 128] = transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg2, 0
                ...
                if (userInfo[arg1][address(msg.sender)].field_0 * poolInfo[arg1].field_768 / 10^12) - userInfo[arg1][address(msg.sender)].field_256 <= 0:
                    ...
                    if arg2 > 0:
                        ...
                        mem[(6 * ceil32(return_data.size)) + 128 len 4] = transferFrom(address rg1, address rg2, uint256 rg3)
                        ...
                        if ext_code.size(poolInfo[arg1].field_0) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[(6 * ceil32(return_data.size)) + 292 len 128] = transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg2, 0
            ...
            if not poolInfo[arg1].field_256:
                ...
                if (block.timestamp * tokenPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerSecond * poolInfo[arg1].field_256) / totalAllocPoint * burnRate / 100 <= ext_call.return_data[0]:
                    mem[(2 * ceil32(return_data.size)) + 132] = (block.timestamp * tokenPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerSecond * poolInfo[arg1].field_256) / totalAllocPoint * burnRate / 100
                    require ext_code.size(tokenAddress)
                    call tokenAddress.transfer(address rg1, uint256 rg2) with:
                         gas gas_remaining wei
                        args 57005, (block.timestamp * tokenPerSecond * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerSecond * poolInfo[arg1].field_256) / totalAllocPoint * burnRate / 100
                ...
                if userInfo[arg1][address(msg.sender)].field_0 <= 0:
                    ...
                    if (userInfo[arg1][address(msg.sender)].field_0 * poolInfo[arg1].field_768 / 10^12) - userInfo[arg1][address(msg.sender)].field_256 <= 0:
                        ...
                        if arg2 > 0:
                            ...
                            mem[(8 * ceil32(return_data.size)) + 128 len 4] = transferFrom(address rg1, address rg2, uint256 rg3)
                            ...
                            if ext_code.size(poolInfo[arg1].field_0) <= 0:
                                revert with 0, 'Address: call to non-contract'
                            mem[(8 * ceil32(return_data.size)) + 292 len 128] = transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg2, 0
