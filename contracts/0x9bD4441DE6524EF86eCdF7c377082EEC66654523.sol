...
function balanceOfPool() {
    ...
    staticcall 0xe82aae7fc62547bdfc36689d0a83de36ff034a68.0x93f1a40b with:
            gas gas_remaining wei
...
function withdrawForSwap(uint256 arg1) {
    ...
    if address(controllerAddress) != msg.sender:
        revert with 0, '!controller'
    require ext_code.size(0xe82aae7fc62547bdfc36689d0a83de36ff034a68)
    call 0xe82aae7fc62547bdfc36689d0a83de36ff034a68.0x441a3e70 with:
         gas gas_remaining wei
        args poolId, arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit() {
    ...
    if ext_call.return_data[0] > 0:
        ...
        if not return_data.size:
            ...
            require ext_code.size(0xe82aae7fc62547bdfc36689d0a83de36ff034a68)
            call 0xe82aae7fc62547bdfc36689d0a83de36ff034a68.0xe2bbb158 with:
                 gas gas_remaining wei
                args poolId, ext_call.return_data[0]
        else:
            mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
