        ...
        if bool(stor10[arg1].field_0):
            ...
            if stor10[arg1].field_1 % 128:
                if 31 < stor10[arg1].field_1 % 128:
                    ...
                    return Array(len=2 * Mask(256, -1, stor10[arg1].field_0), data=mem[128 len ceil32(uint255(stor10[arg1].field_0) * 0.5)])
                mem[128] = 256 * Mask(248, 0, stor10[arg1].field_8)
        mem[ceil32(uint255(stor10[arg1].field_0) * 0.5) + 224 len ceil32(uint255(stor10[arg1].field_0) * 0.5)] = mem[128 len ceil32(uint255(stor10[arg1].field_0) * 0.5)]
        if ceil32(uint255(stor10[arg1].field_0) * 0.5) > uint255(stor10[arg1].field_0) * 0.5:
            mem[(uint255(stor10[arg1].field_0) * 0.5) + ceil32(uint255(stor10[arg1].field_0) * 0.5) + 224] = 0
        return Array(len=2 * Mask(256, -1, stor10[arg1].field_0), data=mem[128 len ceil32(uint255(stor10[arg1].field_0) * 0.5)], mem[(2 * ceil32(uint255(stor10[arg1].field_0) * 0.5)) + 224 len 2 * ceil32(uint255(stor10[arg1].field_0) * 0.5)]), 
    if bool(stor10[arg1].field_0) == stor10[arg1].field_1 % 128 < 32:
        revert with 0, 34
    if bool(stor10[arg1].field_0):
        if bool(stor10[arg1].field_0) == uint255(stor10[arg1].field_0) * 0.5 < 32:
