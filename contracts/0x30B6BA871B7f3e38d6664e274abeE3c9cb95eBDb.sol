...
function arfgkuyawegfuh(address arg1, address arg2, uint256 arg3) payable {
    require calldata.size - 4 >= 96
    ...
    mem[292 len 96] = unknown_0x23b872dd(?????), msg.sender, address(arg2), Mask(224, 32, arg3 * 10^uint8(ext_call.return_data[0])) >> 32
    mem[416 len 4] = 0
    mem[388 len 0] = 0
    call arg1 with:
         gas gas_remaining wei
        args Mask(224, 32, arg3 * 10^uint8(ext_call.return_data[0])) << 480, mem[388 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with unknown_0x23b872dd(?????), msg.sender, address(arg2), arg3 * 10^uint8(ext_call.return_data[0])
