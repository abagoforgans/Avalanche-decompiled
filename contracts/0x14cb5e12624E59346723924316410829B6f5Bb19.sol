...
address owner;
uint256 stor1;
address thenaAddress;
address devAddress;
address feeAddress;
uint256 thenaPerBlock;
...
function thenaPerBlock() payable {
    return thenaPerBlock
}
        ...
        if ext_call.return_data[0]:
            if poolInfo[arg1].field_256:
                ...
                if not block.number - poolInfo[arg1].field_512:
                    ...
                    require ext_code.size(thenaAddress)
                    call thenaAddress.mint(address rg1, uint256 rg2) with:
                         gas gas_remaining wei
                    ...
                    if (block.number * thenaPerBlock) - (poolInfo[arg1].field_512 * thenaPerBlock) / block.number - poolInfo[arg1].field_512 != thenaPerBlock:
                        revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                    if not (block.number * thenaPerBlock) - (poolInfo[arg1].field_512 * thenaPerBlock):
                        if totalAllocPoint <= 0:
                            revert with 0, 'SafeMath: division by zero'
                        require totalAllocPoint
                        require ext_code.size(thenaAddress)
                        ...
                        require (block.number * thenaPerBlock) - (poolInfo[arg1].field_512 * thenaPerBlock)
                        if (block.number * thenaPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * thenaPerBlock * poolInfo[arg1].field_256) / (block.number * thenaPerBlock) - (poolInfo[arg1].field_512 * thenaPerBlock) != poolInfo[arg1].field_256:
                            revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                        if totalAllocPoint <= 0:
                            revert with 0, 'SafeMath: division by zero'
                        require totalAllocPoint
                        ...
                        call thenaAddress.mint(address rg1, uint256 rg2) with:
                             gas gas_remaining wei
                            args devAddress, (block.number * thenaPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * thenaPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require ext_code.size(thenaAddress)
                        call thenaAddress.mint(address rg1, uint256 rg2) with:
                             gas gas_remaining wei
                            args address(this.address), (block.number * thenaPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * thenaPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if not (block.number * thenaPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * thenaPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                            if ext_call.return_data[0] <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require ext_call.return_data[0]
                            if poolInfo[arg1].field_768 + (0 / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                            ...
                            require (block.number * thenaPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * thenaPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                            if 10^18 * (block.number * thenaPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * thenaPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * thenaPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * thenaPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^18:
                                revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                            if ext_call.return_data[0] <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require ext_call.return_data[0]
                            if poolInfo[arg1].field_768 + (10^18 * (block.number * thenaPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * thenaPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                revert with 0, 'SafeMath: addition overflow'
                            poolInfo[arg1].field_768 += 10^18 * (block.number * thenaPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * thenaPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
        poolInfo[arg1].field_512 = block.number
}

function pendingThena(uint256 arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 < poolInfo.length
    require ext_code.size(poolInfo[arg1].field_0)
    staticcall poolInfo[arg1].field_0.0x70a08231 with:
    ...
    if not userInfo[arg1][address(arg2)].field_0:
        ...
        return -userInfo[arg1][address(arg2)].field_256
    require userInfo[arg1][address(arg2)].field_0
    if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^18 * (block.number * thenaPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * thenaPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != poolInfo[arg1].field_768 + (10^18 * (block.number * thenaPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * thenaPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]):
        revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
    if userInfo[arg1][address(arg2)].field_256 > (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^18 * (block.number * thenaPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * thenaPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^18:
        revert with 0, 'SafeMath: subtraction overflow'
    return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^18 * (block.number * thenaPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * thenaPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^18) - userInfo[arg1][address(arg2)].field_256)
}
...
function massUpdatePools() payable {
    ...
    while idx < poolInfo.length:
        ...
        if (block.number * thenaPerBlock) - (poolInfo[idx].field_512 * thenaPerBlock) / block.number - poolInfo[idx].field_512 != thenaPerBlock:
            revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        if not (block.number * thenaPerBlock) - (poolInfo[idx].field_512 * thenaPerBlock):
            _141 = mem[64]
            mem[64] = mem[64] + 64
            mem[_141] = 26
            ...
            revert with memory
              from mem[64]
               len _206 + -mem[64] + 100
        require (block.number * thenaPerBlock) - (poolInfo[idx].field_512 * thenaPerBlock)
        if (block.number * thenaPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * thenaPerBlock * poolInfo[idx].field_256) / (block.number * thenaPerBlock) - (poolInfo[idx].field_512 * thenaPerBlock) != poolInfo[idx].field_256:
            revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _145 = mem[64]
        mem[64] = mem[64] + 64
        mem[_145] = 26
        ...
        call thenaAddress.mint(address rg1, uint256 rg2) with:
             gas gas_remaining wei
            args devAddress, (block.number * thenaPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * thenaPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = this.address
        mem[mem[64] + 36] = (block.number * thenaPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * thenaPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        require ext_code.size(thenaAddress)
        call thenaAddress.mint(address rg1, uint256 rg2) with:
             gas gas_remaining wei
            args address(this.address), (block.number * thenaPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * thenaPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if not (block.number * thenaPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * thenaPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
            _191 = mem[64]
            mem[64] = mem[64] + 64
            mem[_191] = 26
            ...
            revert with memory
              from mem[64]
               len _203 + -mem[64] + 100
        require (block.number * thenaPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * thenaPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        if 10^18 * (block.number * thenaPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * thenaPerBlock * poolInfo[idx].field_256) / totalAllocPoint / (block.number * thenaPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * thenaPerBlock * poolInfo[idx].field_256) / totalAllocPoint != 10^18:
            revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _202 = mem[64]
        mem[64] = mem[64] + 64
        mem[_202] = 26
        ...
        if ext_call.return_data[0] > 0:
            require ext_call.return_data[0]
            if poolInfo[idx].field_768 + (10^18 * (block.number * thenaPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * thenaPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[idx].field_768:
                revert with 0, 'SafeMath: addition overflow'
            poolInfo[idx].field_768 += 10^18 * (block.number * thenaPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * thenaPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
            poolInfo[idx].field_512 = block.number
            idx = idx + 1
            continue 
        _218 = mem[64]
...
function withdraw(uint256 arg1, uint256 arg2) payable {
    ...
    if block.number <= poolInfo[arg1].field_512:
        if not userInfo[arg1][address(msg.sender)].field_0:
            ...
            if -userInfo[arg1][address(msg.sender)].field_256 > 0:
                require ext_code.size(thenaAddress)
                staticcall thenaAddress.0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if -userInfo[arg1][address(msg.sender)].field_256 <= ext_call.return_data[0]:
                    call thenaAddress.transfer(address rg1, uint256 rg2) with:
                         gas gas_remaining wei
                ...
                require return_data.size >= 32
                if not ext_call.return_data[0]:
                    revert with 0, 32, 34, 0x73736166655468656e615472616e736665723a205472616e73666572206661696c65, mem[326 len 30]
            if arg2 <= 0:
                if not userInfo[arg1][address(msg.sender)].field_0:
                    userInfo[arg1][address(msg.sender)].field_256 = 0
                else:
                        ...
                        if not userInfo[arg1][address(msg.sender)].field_0:
                            ...
                            if -userInfo[arg1][address(msg.sender)].field_256 <= 0:
                                ...
                                if -userInfo[arg1][address(msg.sender)].field_256 <= ext_call.return_data[0]:
                                    ...
                                    require return_data.size >= 32
                                    if not ext_call.return_data[0]:
                                        revert with 0, 32, 34, 0x73736166655468656e615472616e736665723a205472616e73666572206661696c65, mem[582 len 30]
                                    if arg2 <= 0:
                                        if not userInfo[arg1][address(msg.sender)].field_0:
                                            userInfo[arg1][address(msg.sender)].field_256 = 0
                                        else:
