    ...
    while idx < arg3:
        ...
        if not stor5.length:
            ...
            call stor1.length.swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args arg2, stor7, 160, destinationAddress, stor9, stor5.length
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            idx = idx + 1
            continue 
        ...
        call stor1.length.swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args arg2, stor7, Array(len=stor5.length, data=mem[mem[64] + 196 len 32 * stor5.length]), destinationAddress, stor9
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        s = mem[64] + floor32((32 * stor5.length) - 1) + 197
        continue 
}

function sub_a2ffbd6c(?) payable {
    mem[64] = 96
    require not msg.value
    require calldata.size - 4 >= 128
    require msg.sender == stor0
        ...
        while s < arg4:
            ...
            if not stor4.length:
                ...
                call stor1.length.swapAVAXForExactTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
                   value arg2 wei
                     gas gas_remaining wei
                    args arg3, 128, destinationAddress, stor9, stor4.length
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                s = s + 1
                continue 
            ...
            call stor1.length.mem[mem[64] len 4] with:
               value arg2 wei
                 gas gas_remaining wei
                args mem[mem[64] + 4 len _10 + (32 * stor4.length) + -mem[64] + 160]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            idx = _10 + floor32((32 * stor4.length) - 1) + 165
            continue 
        idx = idx + 1
        continue 
}

function sub_28bf4e16(?) payable {
    mem[64] = 96
    require not msg.value
        ...
        while s < arg3:
            ...
            if not stor6.length:
                ...
                call stor1.length.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args arg2, stor7, 160, destinationAddress, stor9, stor6.length
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                s = s + 1
                continue 
            ...
            call stor1.length.mem[mem[64] len 4] with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len _10 + (32 * stor6.length) + -mem[64] + 192]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            idx = _10 + floor32((32 * stor6.length) - 1) + 197
            continue 
        idx = idx + 1
        continue 
}

function sub_3169eba3(?) payable {
    mem[64] = 96
    require not msg.value
    require calldata.size - 4 >= 96
    require msg.sender == stor0
        ...
        while s < arg3:
            ...
            if not stor4.length:
                ...
                call stor1.length.swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
                   value arg2 wei
                     gas gas_remaining wei
                    args stor7, 128, destinationAddress, stor9, stor4.length
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                s = s + 1
                continue 
