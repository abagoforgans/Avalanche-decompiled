...
function sub_18bab15d(?) {
    ...
    mem[(32 * _7) + ceil32(return_data.size) + 196] = eth.balance(this.address)
    ...
    if not sub_4359ab5f.length:
        ...
        staticcall stor5.0xa8312b1d with:
                gas gas_remaining wei
               args eth.balance(this.address), 96, 160, 1, mem[(32 * _7) + ceil32(return_data.size) + 324], sub_4359ab5f.length
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        _56 = mem[(32 * _7) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, eth.balance(this.address)) >> 32
        require mem[(32 * _7) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, eth.balance(this.address)) >> 32 <= 4294967296
        require mem[(32 * _7) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, eth.balance(this.address)) >> 32 + 32 <= return_data.size
        require mem[mem[(32 * _7) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, eth.balance(this.address)) >> 32 + (32 * _7) + ceil32(return_data.size) + 192] <= 4294967296 and mem[(32 * _7) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, eth.balance(this.address)) >> 32 + (32 * mem[mem[(32 * _7) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, eth.balance(this.address)) >> 32 + (32 * _7) + ceil32(return_data.size) + 192]) + 32 <= return_data.size
        mem[(32 * _7) + (2 * ceil32(return_data.size)) + 192] = mem[mem[(32 * _7) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, eth.balance(this.address)) >> 32 + (32 * _7) + ceil32(return_data.size) + 192]
    ...
    staticcall stor5.0xa8312b1d with:
            gas gas_remaining wei
           args eth.balance(this.address), 96, 160, 1, mem[(32 * _7) + ceil32(return_data.size) + 324], sub_4359ab5f.length, mem[(32 * _7) + ceil32(return_data.size) + 388 len 32 * sub_4359ab5f.length]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(32 * _7) + ceil32(return_data.size) + 192 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = (32 * _7) + (2 * ceil32(return_data.size)) + 192
    require return_data.size >= 32
    _76 = mem[(32 * _7) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, eth.balance(this.address)) >> 32
    require mem[(32 * _7) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, eth.balance(this.address)) >> 32 <= 4294967296
    require mem[(32 * _7) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, eth.balance(this.address)) >> 32 + 32 <= return_data.size
    require mem[mem[(32 * _7) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, eth.balance(this.address)) >> 32 + (32 * _7) + ceil32(return_data.size) + 192] <= 4294967296 and mem[(32 * _7) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, eth.balance(this.address)) >> 32 + (32 * mem[mem[(32 * _7) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, eth.balance(this.address)) >> 32 + (32 * _7) + ceil32(return_data.size) + 192]) + 32 <= return_data.size
    mem[(32 * _7) + (2 * ceil32(return_data.size)) + 192] = mem[mem[(32 * _7) + ceil32(return_data.size) + 192 len 4], Mask(224, 32, eth.balance(this.address)) >> 32 + (32 * _7) + ceil32(return_data.size) + 192]
