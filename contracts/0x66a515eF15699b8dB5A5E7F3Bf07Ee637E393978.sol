...
function cancelListing(uint256 arg1) {
    ...
    if ext_call.return_data[12 len 20] != msg.sender:
        revert with 0, 'AvaxGuitarMarket: caller is not the owner of the token'
...
function createListing(uint256 arg1, uint256 arg2) {
    ...
    if ext_call.return_data[12 len 20] != this.address:
        revert with 0, 'AvaxPunksMarket: market must be approved to transfer punk'
...
function buy(uint256 arg1) payable {
    ...
    staticcall stor3.punkCreator(uint256 rg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
