...
function _getNodeNumberOf(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require ext_code.size(0xd1ff168b37deed81ff76347c300efd02d9fe6f96)
    delegate 0xd1ff168b37deed81ff76347c300efd02d9fe6f96.0x732a2ccf with:
...
function _getRewardAmountOf(address arg1) payable {
    ...
    while idx < stor4[address(arg1)].field_0:
        ...
        mem[64] = mem[64] + 64
        mem[_22] = 30
        mem[_22 + 32] = 'SafeMath: subtraction overflow'
        ...
        if block.timestamp < stor4[address(arg1)][idx].field_512:
            revert with 0, 17
        if block.timestamp - stor4[address(arg1)][idx].field_512:
            if block.timestamp - stor4[address(arg1)][idx].field_512 and rewardPerNode > -1 / block.timestamp - stor4[address(arg1)][idx].field_512:
                revert with 0, 17
            if not block.timestamp - stor4[address(arg1)][idx].field_512:
                revert with 0, 18
            if (block.timestamp * rewardPerNode) - (stor4[address(arg1)][idx].field_512 * rewardPerNode) / block.timestamp - stor4[address(arg1)][idx].field_512 != rewardPerNode:
                revert with 0, 'SafeMath: multiplication overflow'
            if 0 > !((block.timestamp * rewardPerNode) - (stor4[address(arg1)][idx].field_512 * rewardPerNode)):
                revert with 0, 17
        if idx == -1:
            revert with 0, 17
        idx = idx + 1
...
function _cashoutAllNodesReward(address arg1) payable {
    ...
    while idx < stor4[address(arg1)].field_0:
        ...
        if block.timestamp - stor4[address(arg1)][idx].field_512 and rewardPerNode > -1 / block.timestamp - stor4[address(arg1)][idx].field_512:
            revert with 0, 17
        if s > !((block.timestamp * rewardPerNode) - (stor4[address(arg1)][idx].field_512 * rewardPerNode)):
            revert with 0, 17
        ...
        if idx == -1:
            revert with 0, 17
        idx = idx + 1
        s = s + (block.timestamp * rewardPerNode) - (stor4[address(arg1)][idx].field_512 * rewardPerNode)
        t = (3 * idx) + sha3(sha3(address(arg1), 4))
        continue 
...
function createNode(address arg1, string arg2) payable {
    ...
    require ext_code.size(0xd1ff168b37deed81ff76347c300efd02d9fe6f96)
    delegate 0xd1ff168b37deed81ff76347c300efd02d9fe6f96.0xbc2b405c with:
         gas gas_remaining wei
