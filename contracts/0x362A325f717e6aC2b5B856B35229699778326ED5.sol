...
function approveToken() payable {
    ...
    while idx < strategies.length:
        ...
        call tokenAddress.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _65 + _56 + -mem[64] + 160]
        if not return_data.size:
            if ext_call.success:
                if mem[96]:
                    require mem[96] >= 32
            ...
            mem[mem[64] + 4] = 32
            mem[mem[64] + 36] = mem[_56 + 100]
            _110 = mem[_56 + 100]
            idx = 0
            while idx < _110:
                mem[idx + _108 + 68] = mem[idx + _56 + 132]
                idx = idx + 32
                continue 
            if not _110 % 32:
                revert with memory
        ...
        idx = 0
        while idx < _114:
            mem[idx + _112 + 68] = mem[idx + _56 + 132]
            idx = idx + 32
            continue 
        if not _114 % 32:
            revert with memory
              from mem[64]
               len _114 + _112 + -mem[64] + 68
        mem[floor32(_114) + _112 + 68] = mem[floor32(_114) + _112 + -(_114 % 32) + 100 len _114 % 32]
        revert with memory
          from mem[64]
           len floor32(_114) + _112 + -mem[64] + 100
}
