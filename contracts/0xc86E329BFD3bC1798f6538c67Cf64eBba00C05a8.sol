...
function acceptDebt(address arg1) payable {
    ...
    require ext_call.return_data[0] == ext_call.return_data[31 len 1]
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).get_dy(uint256 arg1, uint256 arg2, uint256 arg3) with:
            gas gas_remaining wei
...
function sub_29640e87(?) payable {
    ...
    require ext_call.return_data[0] == ext_call.return_data[31 len 1]
    require ext_code.size(address(arg3))
    staticcall address(arg3).get_dy(uint256 arg1, uint256 arg2, uint256 arg3) with:
            gas gas_remaining wei
           args arg1, arg2, 10^uint8(ext_call.return_data[0])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
