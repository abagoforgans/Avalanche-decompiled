...
const TRUSTED_TOKEN_ADDRESS = 0x961c8c0b1aad0c0b10a51fef6a867e3091bcef17
...
function deposit(uint256 arg1) payable {
    ...
    lastDepositIndex++
    if ext_code.size(0x961c8c0b1aad0c0b10a51fef6a867e3091bcef17) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[292 len 96] = unknown_0x23b872dd(?????), msg.sender, address(this.address), Mask(224, 32, arg1) >> 32
    mem[416 len 4] = 0
    call 0x961c8c0b1aad0c0b10a51fef6a867e3091bcef17 with:
         gas gas_remaining wei
