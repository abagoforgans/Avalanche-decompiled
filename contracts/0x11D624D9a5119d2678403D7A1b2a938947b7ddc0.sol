...
function _getNodeNumberOf(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    delegate 0xc25dff45c555614daad7b1fe798a146a0880ef91.0x732a2ccf with:
...
function createNode(address arg1, string arg2) payable {
    ...
    require ext_code.size(0xc25dff45c555614daad7b1fe798a146a0880ef91)
    delegate 0xc25dff45c555614daad7b1fe798a146a0880ef91.0xbc2b405c with:
         gas gas_remaining wei
