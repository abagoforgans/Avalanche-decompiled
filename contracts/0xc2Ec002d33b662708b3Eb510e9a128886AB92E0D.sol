...
function dutchPerBlock() payable {
    return dutchPerBlock
}
        ...
        if ext_call.return_data[0]:
            if poolInfo[arg1].field_256:
                ...
                if not block.number - poolInfo[arg1].field_512:
                    ...
                    require ext_code.size(dutchAddress)
                    call dutchAddress.0x40c10f19 with:
                         gas gas_remaining wei
                    ...
                    if (block.number * dutchPerBlock) - (poolInfo[arg1].field_512 * dutchPerBlock) / block.number - poolInfo[arg1].field_512 != dutchPerBlock:
                        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                    if not (block.number * dutchPerBlock) - (poolInfo[arg1].field_512 * dutchPerBlock):
                        if totalAllocPoint <= 0:
                            revert with 0, 'SafeMath: division by zero'
                        require totalAllocPoint
                        require ext_code.size(dutchAddress)
                        ...
                        require (block.number * dutchPerBlock) - (poolInfo[arg1].field_512 * dutchPerBlock)
                        if (block.number * dutchPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * dutchPerBlock * poolInfo[arg1].field_256) / (block.number * dutchPerBlock) - (poolInfo[arg1].field_512 * dutchPerBlock) != poolInfo[arg1].field_256:
                            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                        if totalAllocPoint <= 0:
                            revert with 0, 'SafeMath: division by zero'
                        require totalAllocPoint
                        ...
                        call dutchAddress.0x40c10f19 with:
                             gas gas_remaining wei
                            args devAddress, (block.number * dutchPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * dutchPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require ext_code.size(dutchAddress)
                        call dutchAddress.0x40c10f19 with:
                             gas gas_remaining wei
                            args address(this.address), (block.number * dutchPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * dutchPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if not (block.number * dutchPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * dutchPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                            if ext_call.return_data[0] <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require ext_call.return_data[0]
                            if poolInfo[arg1].field_768 + (0 / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                            ...
                            require (block.number * dutchPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * dutchPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                            if 10^18 * (block.number * dutchPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * dutchPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * dutchPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * dutchPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^18:
                                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                            if ext_call.return_data[0] <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require ext_call.return_data[0]
                            if poolInfo[arg1].field_768 + (10^18 * (block.number * dutchPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * dutchPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                revert with 0, 'SafeMath: addition overflow'
                            poolInfo[arg1].field_768 += 10^18 * (block.number * dutchPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * dutchPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
        poolInfo[arg1].field_512 = block.number
}

function pendingDutch(uint256 arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 < poolInfo.length
    require ext_code.size(poolInfo[arg1].field_0)
    staticcall poolInfo[arg1].field_0.0x70a08231 with:
    ...
    if not userInfo[arg1][address(arg2)].field_0:
        ...
        return -userInfo[arg1][address(arg2)].field_256
    require userInfo[arg1][address(arg2)].field_0
    if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^18 * (block.number * dutchPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * dutchPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != poolInfo[arg1].field_768 + (10^18 * (block.number * dutchPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * dutchPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]):
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
    if userInfo[arg1][address(arg2)].field_256 > (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^18 * (block.number * dutchPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * dutchPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^18:
        revert with 0, 'SafeMath: subtraction overflow'
    return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^18 * (block.number * dutchPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * dutchPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^18) - userInfo[arg1][address(arg2)].field_256)
}
...
function updateEmissionRate(uint256 arg1) payable {
    ...
    while idx < poolInfo.length:
        ...
        if (block.number * dutchPerBlock) - (poolInfo[idx].field_512 * dutchPerBlock) / block.number - poolInfo[idx].field_512 != dutchPerBlock:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        if not (block.number * dutchPerBlock) - (poolInfo[idx].field_512 * dutchPerBlock):
            _147 = mem[64]
            mem[64] = mem[64] + 64
            mem[_147] = 26
            ...
            revert with memory
              from mem[64]
               len _212 + -mem[64] + 100
        require (block.number * dutchPerBlock) - (poolInfo[idx].field_512 * dutchPerBlock)
        if (block.number * dutchPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * dutchPerBlock * poolInfo[idx].field_256) / (block.number * dutchPerBlock) - (poolInfo[idx].field_512 * dutchPerBlock) != poolInfo[idx].field_256:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _151 = mem[64]
        mem[64] = mem[64] + 64
        mem[_151] = 26
        ...
        call dutchAddress.0x40c10f19 with:
             gas gas_remaining wei
            args devAddress, (block.number * dutchPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * dutchPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = this.address
        mem[mem[64] + 36] = (block.number * dutchPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * dutchPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        require ext_code.size(dutchAddress)
        call dutchAddress.0x40c10f19 with:
             gas gas_remaining wei
            args address(this.address), (block.number * dutchPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * dutchPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if not (block.number * dutchPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * dutchPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
            _197 = mem[64]
            mem[64] = mem[64] + 64
            mem[_197] = 26
            ...
            revert with memory
              from mem[64]
               len _209 + -mem[64] + 100
        require (block.number * dutchPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * dutchPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        if 10^18 * (block.number * dutchPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * dutchPerBlock * poolInfo[idx].field_256) / totalAllocPoint / (block.number * dutchPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * dutchPerBlock * poolInfo[idx].field_256) / totalAllocPoint != 10^18:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _208 = mem[64]
        mem[64] = mem[64] + 64
        mem[_208] = 26
        ...
        if ext_call.return_data[0] > 0:
            require ext_call.return_data[0]
            if poolInfo[idx].field_768 + (10^18 * (block.number * dutchPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * dutchPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[idx].field_768:
                revert with 0, 'SafeMath: addition overflow'
            poolInfo[idx].field_768 += 10^18 * (block.number * dutchPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * dutchPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
            poolInfo[idx].field_512 = block.number
            idx = idx + 1
            continue 
        _224 = mem[64]
    ...
    if block.number <= poolInfo[arg1].field_512:
        if not userInfo[arg1][address(msg.sender)].field_0:
            ...
            if -userInfo[arg1][address(msg.sender)].field_256 <= 0:
                ...
                require ext_code.size(dutchAddress)
                staticcall dutchAddress.0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if -userInfo[arg1][address(msg.sender)].field_256 > ext_call.return_data[0]:
                    call dutchAddress.0xa9059cbb with:
                         gas gas_remaining wei
                    ...
                    require return_data.size >= 32
                    if not ext_call.return_data[0]:
                        revert with 0, 32, 34, 0x737361666544757463685472616e736665723a205472616e73666572206661696c65, mem[326 len 30]
                    if arg2 <= 0:
                        if not userInfo[arg1][address(msg.sender)].field_0:
                            userInfo[arg1][address(msg.sender)].field_256 = 0
                        else:
                    ...
                    if not 0 / totalAllocPoint:
                        ...
                        if not userInfo[arg1][address(msg.sender)].field_0:
                            ...
                            if -userInfo[arg1][address(msg.sender)].field_256 > 0:
                                ...
                                require return_data.size >= 32
                                if not ext_call.return_data[0]:
                                    revert with 0, 32, 34, 0x737361666544757463685472616e736665723a205472616e73666572206661696c65, mem[582 len 30]
                            if arg2 <= 0:
                                if not userInfo[arg1][address(msg.sender)].field_0:
                                    userInfo[arg1][address(msg.sender)].field_256 = 0
                                else:
