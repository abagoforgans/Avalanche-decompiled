...
function deposit() {
    ...
    if ext_call.return_data[0]:
        ...
        call wantAddress.0x757b0cd9 with:
             gas gas_remaining wei
            args Mask(480, -256, approve(address arg1, uint256 arg2), 64967568184676235568719747, 0, 0) << 256, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = 0, 0x35bd6aeda81a7e5fc7a7832490e71f757b0cd9, ext_call.return_data[0 len 28]
            call wantAddress.0x757b0cd9 with:
                 gas gas_remaining wei
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 425 len 64] = 0, 0x35bd6aeda81a7e5fc7a7832490e71f757b0cd9, ext_call.return_data[0 len 28]
            call wantAddress.0x757b0cd9 with:
                 gas gas_remaining wei
