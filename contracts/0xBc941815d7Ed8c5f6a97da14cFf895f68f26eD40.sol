        ...
        if not userInfo[msg.sender].field_0:
            ...
            if not userInfo[msg.sender].field_0:
                ...
                if not (uint256(poolInfo.field_768) * userInfo[msg.sender].field_0 / 1000 * 10^18) - userInfo[msg.sender].field_256:
                    ...
                    if not ext_code.size(rewardTokenAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[388 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, (uint256(poolInfo.field_768) * userInfo[msg.sender].field_0 / 1000 * 10^18) - userInfo[msg.sender].field_256) >> 32
                    call rewardTokenAddress with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                        ...
                        if not userInfo[msg.sender].field_0:
                            ...
                            if userInfo[msg.sender].field_0:
                                ...
                                if not (uint256(poolInfo.field_768) * userInfo[msg.sender].field_0 / 1000 * 10^18) - userInfo[msg.sender].field_256:
                                    ...
                                    if not ext_code.size(rewardTokenAddress):
                                        revert with 0, 'Address: call to non-contract'
                                    mem[580 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, (uint256(poolInfo.field_768) * userInfo[msg.sender].field_0 / 1000 * 10^18) - userInfo[msg.sender].field_256) >> 32
                                    call rewardTokenAddress with:
                                       funct uint32(msg.sender)
                                         gas gas_remaining wei
                        ...
                        if not userInfo[msg.sender].field_0:
                            ...
                            if userInfo[msg.sender].field_0:
                                ...
                                if not (uint256(poolInfo.field_768) * userInfo[msg.sender].field_0 / 1000 * 10^18) - userInfo[msg.sender].field_256:
                                    ...
                                    if not ext_code.size(rewardTokenAddress):
                                        revert with 0, 'Address: call to non-contract'
                                    mem[516 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, (uint256(poolInfo.field_768) * userInfo[msg.sender].field_0 / 1000 * 10^18) - userInfo[msg.sender].field_256) >> 32
                                    call rewardTokenAddress with:
                                       funct uint32(msg.sender)
                                         gas gas_remaining wei
