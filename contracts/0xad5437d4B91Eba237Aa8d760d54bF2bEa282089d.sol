...
function getCurrencyList() {
    ...
    if not stor2.length:
        ...
        while idx < _864:
            ...
            t = t + 32
            continue 
        mem[_844 + 32] = (32 * _864) + 160
        _1678 = mem[96]
        mem[_844 + (32 * _864) + 160] = mem[96]
        idx = 0
        s = 128
        t = _844 + (32 * _864) + (32 * mem[96]) + 192
        u = _844 + (32 * _864) + 192
        while idx < _1678:
    ...
    if not stor2.length:
        ...
        if not stor2.length:
            ...
            while idx < _1689:
                ...
                t = t + 32
                continue 
            mem[_1647 + 32] = (32 * _1689) + 160
            _2393 = mem[96]
            mem[_1647 + (32 * _1689) + 160] = mem[96]
            idx = 0
            s = 128
            t = _1647 + (32 * _1689) + (32 * mem[96]) + 192
            u = _1647 + (32 * _1689) + 192
            while idx < _2393:
