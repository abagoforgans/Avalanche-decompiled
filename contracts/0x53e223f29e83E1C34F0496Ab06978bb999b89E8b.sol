...
function sub_3a8a334c(?) payable {
    ...
    mem[(32 * cd[(('cd', 4)[4] + cd[4] + 4)]) + 388] = cd[(('cd', 4)[5] + cd[4] + 4)]
    idx = 0
    s = ('cd', 4)[5] + cd[4] + 36
    t = (32 * cd[(('cd', 4)[4] + cd[4] + 4)]) + 420
    ...
    call this.address.0xef2baef7 with:
         gas gas_remaining wei
        args 32, ('cd', 4).length, address(('cd', 4)[0]), address(('cd', 4)[1]), address(('cd', 4)[2]), address(('cd', 4)[3]), 224, (32 * cd[(('cd', 4)[4] + cd[4] + 4)]) + 256, cd[(('cd', 4)[4] + cd[4] + 4)], mem[388 len (32 * cd[(('cd', 4)[4] + cd[4] + 4)]) + (32 * cd[(('cd', 4)[5] + cd[4] + 4)]) + 32]
    if not ext_call.success:
            ...
            if uint32(mem[4 len 28]) >> 224 != Error(string arg1):
                ...
                if return_data.size < 68:
                    ...
                    if not bool(36 <= return_data.size):
                        ...
                        if unknown_0xef2baef7(?????), 0 > test266151307():
                            if not return_data.size:
                                emit 0xd5a827cf: ' '
                            else:
                                emit 0xd5a827cf: Array(len=return_data.size, data=ext_call.return_data[0 len return_data.size])
                        else:
                            if unknown_0xef2baef7(?????), 0 + 32 <= return_data.size - 4:
                                if ceil32(unknown_0xef2baef7(?????), 0) + 97 > test266151307() or ceil32(unknown_0xef2baef7(?????), 0) + 97 < 96:
                                    revert with 'NH{q', 65
                                emit 0x3f0c48ab: ''
                            else:
                                if not return_data.size:
    ...
    while idx < ('cd', 4).length:
        ...
        if mem[_69 + 12 len 20] == address(cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 100)]):
            ...
            if cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 196)] + 36)] > 18446744073709551616:
                revert with 'NH{q', 65
            stor6.length = cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 196)] + 36)]
            if cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 196)] + 36)] < stor6.length:
                s = sha3(6) + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 196)] + 36)]
                while s < sha3(6) + stor6.length:
                    uint256(stor[s]) = 0
                    s = s + 1
                    continue 
            s = 0
            ...
            if cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 228)] + 36)] > 18446744073709551616:
                revert with 'NH{q', 65
            stor7.length = cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 228)] + 36)]
            if cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 228)] + 36)] < stor7.length:
                s = sha3(7) + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + cd[(cd[4] + cd[(cd[4] + (32 * idx) + 36)] + 228)] + 36)]
                while s < sha3(7) + stor7.length:
                    uint256(stor[s]) = 0
                    s = s + 1
                    continue 
            mem[0] = 7
