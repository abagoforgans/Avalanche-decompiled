    ...
    if not arg1.length:
        ...
        while idx < _39:
            ...
            while u < 3:
                ...
                continue 
            u = 4
            w = mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[mem[w] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 96] + 128
            t = t + 96
            continue 
        mem[_38 + 32] = block.number
    else:
    ...
    if arg3 <= ext_call.return_data[0]:
        ...
        if not arg3 - arg2:
            ...
            while idx < arg3 - arg2:
                ...
                staticcall address(_125).0xd21220a7 with:
                        gas gas_remaining wei
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if idx >= mem[ceil32(return_data.size) + 96]:
                    revert with 0, 50
                mem[mem[(32 * idx) + ceil32(return_data.size) + 128] + 64] = address(_125)
                if idx == -1:
                    revert with 0, 17
                idx = idx + 1
                continue 
