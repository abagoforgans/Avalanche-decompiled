...
function sub_f14c71a4(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    sub_7b127752Address = address(arg1)
}
...
function sub_2f0a9ba0(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
    require arg2 == address(arg2)
    require msg.sender == stor2
    mem[96 len 2856] = code.data[3260 len 2856]
    create contract with 0 wei
                    code: code.data[3260 len 2856]
    ...
    call sub_7b127752Address.0xa9059cbb with:
         gas gas_remaining wei
        args address(ext_call.return_data[0]), 10^9
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[ceil32(return_data.size) + 100] = address(arg1)
    mem[ceil32(return_data.size) + 132] = address(arg2)
    mem[ceil32(return_data.size) + 164] = 0x4c2b19065fed9ab028dd67933fd64dce5435e342
    require ext_code.size(address(create.new_address))
    call address(create.new_address).0x98145d20 with:
         gas gas_remaining wei
        args address(arg1), address(arg2), 0x4c2b19065fed9ab028dd67933fd64dce5435e342
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    idx = 0
    while idx < 9:
        mem[mem[64] len 2856] = code.data[3260 len 2856]
        create contract with 0 wei
                        code: code.data[3260 len 2856]
        if not create.new_address:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        mem[mem[64] + 68] = stor3[idx]
        require ext_code.size(address(create.new_address))
        call address(create.new_address).0x98145d20 with:
             gas gas_remaining wei
            args address(arg1), address(arg2), stor3[idx]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
