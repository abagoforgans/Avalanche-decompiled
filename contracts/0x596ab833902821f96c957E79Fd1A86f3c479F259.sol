    ...
    if not ext_call.return_data[0]:
        ...
        if not ext_call.return_data[0]:
            ...
            if not ext_call.return_data[0]:
                return ''
            require ext_code.size(sub_8e2d7196Address)
            staticcall sub_8e2d7196Address.0x18160ddd with:
                    gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
...
function emergencyWithdraw() payable {
    ...
    require ext_code.size(sub_dbeee4aeAddress)
    call sub_dbeee4aeAddress.withdraw(uint256 arg1) with:
         gas gas_remaining wei
    ...
    mem[(6 * ceil32(return_data.size)) + 192] = _844
    ...
    require ext_code.size(sub_a3ba1798Address)
    call sub_a3ba1798Address.withdraw(uint256 arg1) with:
         gas gas_remaining wei
    ...
    require ext_code.size(sub_8e2d7196Address)
    call sub_8e2d7196Address.withdraw(uint256 arg1) with:
         gas gas_remaining wei
