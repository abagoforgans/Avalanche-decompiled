...
uint256 maxSupply;
uint8 paused;
address punks_paymentsAddress; offset 8
...
function punks_payments() {
    return punks_paymentsAddress
}
...
function withdraw() payable {
    ...
    call punks_paymentsAddress with:
...
function mint(uint256 arg1) payable {
    ...
    if msg.value < cost * arg1:
        revert with 0, 'Pay more to get nft.'
    require arg1 > 0
    if arg1 <= 1:
        ...
        while idx <= arg1:
            ...
            if msg.sender:
                ...
                if ext_code.size(msg.sender) > 0:
                    ...
                    s = 0
                    while s < 0:
                        mem[mem[64] + s + 164] = mem[_185 + s + 32]
                        s = s + 32
                        continue 
        ...
        while idx <= arg1:
            ...
            if msg.sender:
                ...
                if ext_code.size(msg.sender) > 0:
                    ...
                    s = 0
                    while s < 0:
                        mem[mem[64] + s + 164] = mem[_186 + s + 32]
                        s = s + 32
                        continue 
                    require ext_code.size(msg.sender)
                    call msg.sender.onERC721Received(address rg1, address rg2, uint256 rg3, bytes rg4) with:
