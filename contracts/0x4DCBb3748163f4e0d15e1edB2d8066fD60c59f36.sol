        ...
        if stor6[stor8].field_0:
            ...
            if arg2.length:
                ...
                while stor6[stor8].field_1 + 31 / 32 > idx:
                    ...
                    continue 
        totalSupply++
        mem[ceil32(arg2.length) + 160] = totalSupply
    ...
    if stor6[stor8].field_0:
        ...
        if arg2.length:
            ...
            while stor6[stor8].field_1 + 31 / 32 > idx:
                ...
                continue 
    totalSupply++
    mem[ceil32(return_data.size) + ceil32(arg2.length) + 160] = totalSupply
    return Mask(8 * -ceil32(arg2.length) + arg2.length + 32, 0, 0), 
           mem[ceil32(return_data.size) + arg2.length + 192 len -arg2.length + ceil32(arg2.length)]
}
