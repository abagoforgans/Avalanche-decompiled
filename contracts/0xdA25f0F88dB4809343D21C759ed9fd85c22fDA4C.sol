...
function giveAway(address arg1) {
    ...
    if stor3[stor2.length + 1]:
        revert with 0, 'ERC721: token already minted'
    if tokenOfOwnerByIndex[address(arg1)][1][stor2.length + 1]:
        if stor3[stor2.length + 1]:
            require stor3[stor2.length + 1] - 1 < tokenByIndex.length
            tokenByIndex[stor3[tokenByIndex.length + 1] - 1].field_256 = arg1
            tokenByIndex[stor3[tokenByIndex.length + 1] - 1].field_416 = 0
        ...
        tokenOfOwnerByIndex[address(arg1)][1][stor2.length + 1] = tokenOfOwnerByIndex[address(arg1)]
        if stor3[stor2.length + 1]:
            require stor3[stor2.length + 1] - 1 < tokenByIndex.length
            tokenByIndex[stor3[tokenByIndex.length + 1] - 1].field_256 = arg1
            tokenByIndex[stor3[tokenByIndex.length + 1] - 1].field_416 = 0
