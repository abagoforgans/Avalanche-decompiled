...
function sub_b4ee18ce(?) {
    return sub_b4ee18ceAddress
}
...
function tokenFallback(address arg1, uint256 arg2, bytes arg3) {
    ...
    mem[ceil32(arg3.length) + 128] = 0x42966c6800000000000000000000000000000000000000000000000000000000
    mem[ceil32(arg3.length) + 132] = arg2
    require ext_code.size(sub_b4ee18ceAddress)
    call sub_b4ee18ceAddress.0x42966c68 with:
    ...
    require arg2 / CLAIM_PRICE > 0
    require arg2 / CLAIM_PRICE <= 50
    require arg2 / CLAIM_PRICE <= -minted + 2500
    idx = 0
    while idx < arg2 / CLAIM_PRICE:
        minted++
        _100 = mem[64]
        mem[64] = mem[64] + 32
        mem[_100] = 0
        ...
        if arg1:
            tokenOfOwnerByIndex[address(arg1)][stor3[address(arg1)]] = minted
            stor7[stor13] = balanceOf[address(arg1)]
        else:
            require tokenByIndex.length - 1 < tokenByIndex.length
            require stor9[stor13] < tokenByIndex.length
...
function tokenURI(uint256 arg1) {
    ...
    if not mem[ceil32(stor19.length) + ceil32(s) + 160] % 32:
        return 32, mem[mem[ceil32(stor19.length) + 128] + stor19.length + ceil32(stor19.length) + ceil32(s) + 224 len mem[ceil32(stor19.length) + ceil32(s) + 160] + 32], 
    mem[floor32(mem[ceil32(stor19.length) + ceil32(s) + 160]) + mem[ceil32(stor19.length) + 128] + stor19.length + ceil32(stor19.length) + ceil32(s) + 256] = mem[floor32(mem[ceil32(stor19.length) + ceil32(s) + 160]) + mem[ceil32(stor19.length) + 128] + stor19.length + ceil32(stor19.length) + ceil32(s) + -(mem[ceil32(stor19.length) + ceil32(s) + 160] % 32) + 288 len mem[ceil32(stor19.length) + ceil32(s) + 160] % 32]
    return Array(len=mem[ceil32(stor19.length) + ceil32(s) + 160], data=mem[mem[ceil32(stor19.length) + 128] + stor19.length + ceil32(stor19.length) + ceil32(s) + 256 len floor32(mem[ceil32(stor19.length) + ceil32(s) + 160]) + 32]), 
}
