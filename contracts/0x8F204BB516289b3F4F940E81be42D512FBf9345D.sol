...
function multiBuy(uint256 arg1, uint8[4][] arg2) payable {
    ...
    mem[_323 + floor32(mem[_324]) + -(mem[_324] % 32) + 228 len mem[_324] % 32] = mem[_324 + -(mem[_324] % 32) + floor32(mem[_324]) + 64 len mem[_324] % 32]
    call stormAddress.mem[_323 + 196 len 4] with:
         gas gas_remaining wei
