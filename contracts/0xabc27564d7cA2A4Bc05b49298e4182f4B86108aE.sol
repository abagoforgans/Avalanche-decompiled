...
function getSupplied() {
    ...
    call sub_462e4cdaAddress.balanceOfUnderlying(address arg1) with:
         gas gas_remaining wei
        args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function getBorrowed() {
    require ext_code.size(sub_462e4cdaAddress)
    call sub_462e4cdaAddress.borrowBalanceCurrent(address arg1) with:
         gas gas_remaining wei
        args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function getBorrowedView() {
    require ext_code.size(sub_462e4cdaAddress)
    staticcall sub_462e4cdaAddress.borrowBalanceStored(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function getSuppliedView() {
    require ext_code.size(sub_462e4cdaAddress)
    staticcall sub_462e4cdaAddress.getAccountSnapshot(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
