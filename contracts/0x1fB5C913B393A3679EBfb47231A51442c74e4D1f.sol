...
function mint(string arg1) payable {
    ...
    tokenByIndex.length++
    tokenByIndex[tokenByIndex.length] = pos
    if msg.sender:
        tokenOfOwnerByIndex[address(msg.sender)][stor3[address(msg.sender)]] = pos
    ...
    emit Transfer(0, msg.sender, pos);
    if ext_code.size(msg.sender) > 0:
        require ext_code.size(msg.sender)
        call msg.sender.0x150b7a02 with:
             gas gas_remaining wei
            args msg.sender, 0, pos, 128, 0
