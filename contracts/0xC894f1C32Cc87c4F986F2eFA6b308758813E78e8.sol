...
function sub_f400d40a(?) {
    ...
    if not sub_be9e500e:
        revert with 0, 18
    return (ext_call.return_data[32] / sub_be9e500e)
}
...
function sub_1e4049a1(?) {
    ...
    if not sub_be9e500e:
        revert with 0, 18
    if not ext_call.return_data[32] / sub_be9e500e:
        revert with 0, 18
    if arg1 / ext_call.return_data[32] / sub_be9e500e and 10^18 > -1 / arg1 / ext_call.return_data[32] / sub_be9e500e:
        revert with 0, 17
    if distributed > !(10^18 * arg1 / ext_call.return_data[32] / sub_be9e500e):
        revert with 0, 17
    if distributed + (10^18 * arg1 / ext_call.return_data[32] / sub_be9e500e) < supply:
        return 10^18 * arg1 / ext_call.return_data[32] / sub_be9e500e, 0
    if 10^18 * arg1 / ext_call.return_data[32] / sub_be9e500e < distributed + (10^18 * arg1 / ext_call.return_data[32] / sub_be9e500e) - supply:
        revert with 0, 17
    if -distributed + supply and ext_call.return_data[32] / sub_be9e500e > -1 / -distributed + supply:
        revert with 0, 17
    if arg1 < (-1 * distributed * ext_call.return_data[32] / sub_be9e500e) + (supply * ext_call.return_data[32] / sub_be9e500e) / 10^18:
        revert with 0, 17
    if arg1 < arg1 - ((-1 * distributed * ext_call.return_data[32] / sub_be9e500e) + (supply * ext_call.return_data[32] / sub_be9e500e) / 10^18):
        revert with 0, 17
    return -distributed + supply, 
           (-1 * distributed * ext_call.return_data[32] / sub_be9e500e) + (supply * ext_call.return_data[32] / sub_be9e500e) / 10^18
}
...
function buy() payable {
    ...
    if not ext_call.return_data[32] / sub_be9e500e:
        revert with 0, 18
    if msg.value / ext_call.return_data[32] / sub_be9e500e and 10^18 > -1 / msg.value / ext_call.return_data[32] / sub_be9e500e:
        revert with 0, 17
    if distributed > !(10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e):
        revert with 0, 17
    if distributed + (10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e) < supply:
        if balance > !msg.value:
            revert with 0, 17
        balance += msg.value
        if distributed > !(10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e):
            revert with 0, 17
        distributed += 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e
        if supply < 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e:
            revert with 0, 17
        supply += -1 * 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e
        if 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e and 10 > -1 / 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e:
            revert with 0, 17
        if 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e and 10 > -1 / 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e:
            revert with 0, 17
        if 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e and 10 > -1 / 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e:
        ...
        if 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e and 10 > -1 / 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e:
            revert with 0, 17
        if 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e and 20 > -1 / 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e:
            revert with 0, 17
        if 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e and 20 > -1 / 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e:
            revert with 0, 17
        if sub_40615ffb > !(10 * 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e / 100):
            revert with 0, 17
        if sub_40615ffb + (10 * 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e / 100) > presaleSupply:
        ...
        sub_83f96dfc[address(msg.sender)][sub_83f96dfc[address(msg.sender)].field_0].field_0 = 10 * 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e / 100
        ...
        if sub_40615ffb > !(10 * 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e / 100):
            revert with 0, 17
        sub_40615ffb += 10 * 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e / 100
        emit Locked(msg.sender, 10 * 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e / 100);
        if sub_40615ffb + (10 * 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e / 100) > presaleSupply:
            revert with 0, 'Unable to lock the defined amount, cap exceeded'
        ...
        sub_40615ffb += 10 * 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e / 100
        emit Locked(msg.sender, 10 * 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e / 100);
        if sub_40615ffb > !(20 * 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e / 100):
            revert with 0, 17
        if sub_40615ffb + (20 * 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e / 100) > presaleSupply:
            revert with 0, 'Unable to lock the defined amount, cap exceeded'
        if block.timestamp > -38880001:
            revert with 0, 17
        sub_83f96dfc[address(msg.sender)].field_0++
        sub_83f96dfc[address(msg.sender)][sub_83f96dfc[address(msg.sender)].field_0].field_0 = 20 * 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e / 100
        sub_83f96dfc[address(msg.sender)][sub_83f96dfc[address(msg.sender)].field_0].field_256 = block.timestamp + (3 * 3600 * 24 * 3600)
        sub_83f96dfc[address(msg.sender)][sub_83f96dfc[address(msg.sender)].field_0].field_512 = 0
        if sub_40615ffb > !(20 * 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e / 100):
            revert with 0, 17
        sub_40615ffb += 20 * 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e / 100
        emit Locked(msg.sender, 20 * 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e / 100);
        if sub_40615ffb + (20 * 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e / 100) > presaleSupply:
            revert with 0, 'Unable to lock the defined amount, cap exceeded'
        ...
        if sub_68218a14[msg.sender] > !(10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e):
            revert with 0, 17
        sub_68218a14[msg.sender] += 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e
        emit Buy((10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e), msg.sender);
    else:
        if 10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e < distributed + (10^18 * msg.value / ext_call.return_data[32] / sub_be9e500e) - supply:
            revert with 0, 17
        if -distributed + supply and ext_call.return_data[32] / sub_be9e500e > -1 / -distributed + supply:
            revert with 0, 17
        if msg.value < (-1 * distributed * ext_call.return_data[32] / sub_be9e500e) + (supply * ext_call.return_data[32] / sub_be9e500e) / 10^18:
            revert with 0, 17
        if msg.value < msg.value - ((-1 * distributed * ext_call.return_data[32] / sub_be9e500e) + (supply * ext_call.return_data[32] / sub_be9e500e) / 10^18):
            revert with 0, 17
        if balance > !msg.value:
            revert with 0, 17
        balance += msg.value
        if (-1 * distributed * ext_call.return_data[32] / sub_be9e500e) + (supply * ext_call.return_data[32] / sub_be9e500e) / 10^18:
            if sub_ccc7139c[msg.sender] > !((-1 * distributed * ext_call.return_data[32] / sub_be9e500e) + (supply * ext_call.return_data[32] / sub_be9e500e) / 10^18):
                revert with 0, 17
            sub_ccc7139c[msg.sender] += (-1 * distributed * ext_call.return_data[32] / sub_be9e500e) + (supply * ext_call.return_data[32] / sub_be9e500e) / 10^18
