...
uint256 poolId;
uint256 sub_9567bb17;
address sub_1ce3525aAddress;

function feeDistributor() {
    return feeDistributorAddress
}

function sub_1ce3525a(?) {
    return sub_1ce3525aAddress
}
...
function deposit() {
    ...
    if ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = approve(address rg1, uint256 rg2), 0xd6a4f121ca35509af06a0be9, 1660235858, ext_call.return_data[0 len 28]
            call wantAddress.0x62f53052 with:
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 425 len 64] = approve(address rg1, uint256 rg2), 0xd6a4f121ca35509af06a0be9, 1660235858, ext_call.return_data[0 len 28]
