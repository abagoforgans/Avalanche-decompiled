...
function mint() payable {
    ...
    if tokenByIndex.length > -(msg.value / cost) - 1:
        revert with 'NH{q', 17
    require tokenByIndex.length + (msg.value / cost) <= maxSupply
    if not cost:
        revert with 'NH{q', 18
    require not msg.value % cost
    idx = 1
    while idx <= msg.value / cost:
        ...
        if msg.sender:
            ...
            if ext_code.size(msg.sender) > 0:
                ...
                require return_data.size >= 32
                require mem[_183] == Mask(32, 224, mem[_183])
                if Mask(32, 224, mem[_183]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                    revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
        else:
            if tokenByIndex.length < 1:
                revert with 'NH{q', 17
            ...
            if ext_code.size(msg.sender) > 0:
                ...
                mem[64] = mem[64] + ceil32(return_data.size)
                require return_data.size >= 32
                require mem[_184] == Mask(32, 224, mem[_184])
                if Mask(32, 224, mem[_184]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                    revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
