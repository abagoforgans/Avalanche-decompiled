    ...
    if cd[4] == cd[36] == 1:
        ...
        if cd[4] != ext_call.return_data[0]:
            return 32, 512, 
                   ...
                   mem[128],
                   mem[160],
                   mem[ceil32(32 * ('cd', 132).length) + ceil32(32 * ('cd', 164).length) + 98],
                   mem[ceil32(32 * ('cd', 132).length) + ceil32(32 * ('cd', 164).length) + 130],
                   0,
                   mem[ceil32(32 * ('cd', 132).length) + ceil32(32 * ('cd', 164).length) + 674]
        return 32, 512, 
               48346921041,
               0,
               this.address,
