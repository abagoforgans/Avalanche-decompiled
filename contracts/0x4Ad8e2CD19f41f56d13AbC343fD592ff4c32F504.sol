...
const output = 0xcc2f1d827b18321254223df4e84de399d9ff116c
...
function retireStrat() payable {
    if address(vaultAddress) != msg.sender:
        revert with 0, '!vault'
    require ext_code.size(0xa0488f956d7fe05b1798e9faf0ce5f1133d23822)
    call 0xa0488f956d7fe05b1798e9faf0ce5f1133d23822.emergencyWithdraw(uint256 rg1) with:
         gas gas_remaining wei
        args poolId
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function pause() payable {
    ...
    if ext_code.size(wantAddress) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = approve(address rg1, uint256 rg2), 0xa0488f956d7fe05b1798e9fa, 0, 0
    mem[324 len 0] = 0
    call wantAddress.0x33d23822 with:
         gas gas_remaining wei
        args Mask(480, -256, approve(address rg1, uint256 rg2), 0xa0488f956d7fe05b1798e9fa, 0, 0) << 256, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with approve(address rg1, uint256 rg2), 0xa0488f956d7fe05b1798e9fa, 0, 0
        if not approve(address rg1, uint256 rg2), 0xa0488f956d7fe05b1798e9fa:
            revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
        if ext_code.size(0xcc2f1d827b18321254223df4e84de399d9ff116c) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = 0, address(unirouterAddress), 0
        call 0xcc2f1d827b18321254223df4e84de399d9ff116c with:
           funct uint32(stor3)
             gas gas_remaining wei
