...
address sub_a22cf5beAddress;
uint256 mintPrice;
uint256 maxMintable;
mapping of uint256 sub_1aa5e872;
uint256 sub_01677661;

function sub_01677661(?) payable {
    return sub_01677661
}

function MAX_NFTS() payable {
    return MAX_NFTS
}

function sub_1aa5e872(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    return sub_1aa5e872[arg1]
}

function maxMintable() payable {
    return maxMintable
}
...
function sub_a22cf5be(?) payable {
    return sub_a22cf5beAddress
}
...
function setMaxMintable(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function setPayToken(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function sub_addaceb4(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_a22cf5beAddress = address(arg1)
}
