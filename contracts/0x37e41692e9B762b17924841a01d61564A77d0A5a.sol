                ...
                if uint32(call.func_hash) >> 224 != unknown_0x4116e06a(?????):
                    ...
                    while idx < (32 * ('cd', 4).length) + cd[4] + 36:
                        ...
                        if mem[64] + ceil32(ceil32(cd[(cd[4] + cd[idx] + 36)])) + 1 < mem[64] or mem[64] + ceil32(ceil32(cd[(cd[4] + cd[idx] + 36)])) + 1 > test266151307():
                            revert with 0, 65
                        mem[64] = mem[64] + ceil32(ceil32(cd[(cd[4] + cd[idx] + 36)])) + 1
                        mem[_67] = cd[(cd[4] + cd[idx] + 36)]
                        require cd[4] + cd[idx] + cd[(cd[4] + cd[idx] + 36)] + 68 <= calldata.size
                        mem[_67 + 32 len cd[(cd[4] + cd[idx] + 36)]] = call.data[cd[4] + cd[idx] + 68 len cd[(cd[4] + cd[idx] + 36)]]
                        mem[_67 + cd[(cd[4] + cd[idx] + 36)] + 32] = 0
                        mem[s] = _67
                        s = s + 32
                        idx = idx + 32
                        continue 
                    ...
                    while idx < (32 * ('cd', 4).length) + cd[4] + 36:
                        ...
                        if mem[64] + ceil32(ceil32(cd[(cd[4] + cd[idx] + 36)])) + 1 < mem[64] or mem[64] + ceil32(ceil32(cd[(cd[4] + cd[idx] + 36)])) + 1 > test266151307():
                            revert with 0, 65
                        mem[64] = mem[64] + ceil32(ceil32(cd[(cd[4] + cd[idx] + 36)])) + 1
                        mem[_66] = cd[(cd[4] + cd[idx] + 36)]
                        require cd[4] + cd[idx] + cd[(cd[4] + cd[idx] + 36)] + 68 <= calldata.size
                        mem[_66 + 32 len cd[(cd[4] + cd[idx] + 36)]] = call.data[cd[4] + cd[idx] + 68 len cd[(cd[4] + cd[idx] + 36)]]
                        mem[_66 + cd[(cd[4] + cd[idx] + 36)] + 32] = 0
                        mem[s] = _66
                        s = s + 32
                        idx = idx + 32
                        continue 
