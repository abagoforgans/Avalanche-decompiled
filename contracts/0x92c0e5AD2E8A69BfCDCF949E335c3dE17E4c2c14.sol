...
function sub_ec5199fc(?) {
    return bool(sub_ec5199fc)
}
...
function sub_86eb4c82(?) {
    require calldata.size - 4 >= 32
    require arg1 == bool(arg1)
    if not stor1[address(msg.sender)]:
        revert with 0, '!AUTHORIZED'
    stor32 = Mask(248, 0, bool(arg1))
}
...
function getLiquidityBacking(uint256 arg1) {
    ...
    if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
        revert with 0, 18
    return (arg1 * 2 * balanceOf[stor29] / totalSupply - balanceOf[stor3] - balanceOf[stor4])
}
...
function isOverLiquified(uint256 arg1, uint256 arg2) {
    ...
    if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
        revert with 0, 18
    return (arg2 * 2 * balanceOf[stor29] / totalSupply - balanceOf[stor3] - balanceOf[stor4] > arg1)
}
...
function triggerZeusBuyback(uint256 arg1, bool arg2) {
    ...
    if arg2:
        ...
        emit BuybackMultiplierActive(stor36);
}
