...
uint8 _active;
uint8 sub_381165f3; offset 8
uint8 sub_9e3669ee; offset 16
...
function sub_ab80d64d(?) payable {
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    emit 0x5fe9663c: stor10, stor9, sub_f76f8405, sub_34e14306, block.timestamp, ext_call.return_data[0], ext_call.return_data[0], ext_call.return_data[0], sub_1e51e6b6
}
        ...
        if block.timestamp >= sub_d64fe168:
            ...
            if ext_call.return_data[0] >= sub_1e51e6b6:
                ...
                if ext_call.return_data[0] >= sub_1e51e6b6:
                    ...
                    require return_data.size >= 32
                    require ext_call.return_data[0] == ext_call.return_data[0]
                    emit 0x9125f4e7: block.timestamp, ext_call.return_data[0], ext_call.return_data[0], ext_call.return_data[0], sub_1e51e6b6
}
