...
const sub_45fb7436(?) = 0x76ef5e2072113d27142b71cdb746a07b741f415c
...
function sub_0a5d48a9(?) payable {
    ...
    call sub_13b8beb7Address.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 0xa3e4200ca1ac92331d529327e82d89c149ccd81c, 10^18
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    call sub_13b8beb7Address.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 0x76ef5e2072113d27142b71cdb746a07b741f415c, 10^18
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(CAKEAddress)
...
function sub_47f4d98d(?) payable {
    ...
    require return_data.size >= 32
    require ext_code.size(CAKEAddress)
    call CAKEAddress.transferFrom(address arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
    ...
    require return_data.size >= 32
    require ext_code.size(sub_13b8beb7Address)
    call sub_13b8beb7Address.transferFrom(address arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
