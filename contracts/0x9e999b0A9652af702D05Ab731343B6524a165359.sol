    ...
    if serviceAddress != msg.sender:
        if sub_a66e4e5fAddress != msg.sender:
            if owner != msg.sender:
                revert with 0, 'not service'
    require arg1 < poolInfo.length
    require ext_code.size(0x98b1cf55177a188e6dbdce81a7d55007529f9753)
    delegate 0x98b1cf55177a188e6dbdce81a7d55007529f9753.0x18f1f18b with:
...
function sub_f9c516ea(?) {
    ...
    require arg1 < poolInfo.length
    require ext_code.size(0x98b1cf55177a188e6dbdce81a7d55007529f9753)
    delegate 0x98b1cf55177a188e6dbdce81a7d55007529f9753.0x5bc609c6 with:
         gas gas_remaining wei
...
function sub_7afec48b(?) {
    ...
    if arg5:
        require ext_code.size(0x98b1cf55177a188e6dbdce81a7d55007529f9753)
        delegate 0x98b1cf55177a188e6dbdce81a7d55007529f9753.0x3b2a018c with:
             gas gas_remaining wei
            args poolInfo[arg1].field_0, poolInfo[arg1].field_512, poolInfo[arg1].field_1280
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(0x98b1cf55177a188e6dbdce81a7d55007529f9753)
        delegate 0x98b1cf55177a188e6dbdce81a7d55007529f9753.0x434857c7 with:
             gas gas_remaining wei
        ...
        require return_data.size >= 32
        require ext_code.size(0x98b1cf55177a188e6dbdce81a7d55007529f9753)
        delegate 0x98b1cf55177a188e6dbdce81a7d55007529f9753.0x7b0b708a with:
             gas gas_remaining wei
...
function sub_d36303b2(?) {
    ...
    staticcall poolInfo[arg1].field_256.0xabb06b95 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
