...
function sub_71ec43ae(?) {
    ...
    if not stor6.length:
        ...
        call stor3.swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
           value arg2 wei
             gas gas_remaining wei
            args stor9, 128, address(mem[(32 * stor2) + 128]), stor10, stor6.length
    else:
        mem[(32 * arg4.length) + 292] = address(stor6.field_0)
        idx = (32 * arg4.length) + 292
        s = 0
        while (32 * arg4.length) + (32 * stor6.length) + 292 > idx + 32:
        ...
        call stor3.swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
           value arg2 wei
             gas gas_remaining wei
            args stor9, Array(len=stor6.length, data=mem[(32 * arg4.length) + 292 len 32 * stor6.length]), address(_11), stor10
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
