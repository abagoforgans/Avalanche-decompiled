...
function accrueAll(address[] arg1) {
    ...
    while idx < arg1.length:
        ...
        mem[32] = 141
        _85 = sha3(mem[(32 * idx) + 140 len 20], 141)
...
function addBank(address arg1) {
    ...
    if not return_data.size:
        ...
        if not ext_code.size(address(ext_call.return_data[0])):
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = approve(address rg1, uint256 rg2), address(ext_call.return_data[0]) << 64, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        call address(ext_call.return_data[0]) with:
             gas gas_remaining wei
        ...
        if not ext_code.size(address(ext_call.return_data[0])):
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 425 len 64] = approve(address rg1, uint256 rg2), address(ext_call.return_data[0]) << 64, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        ...
        if not return_data.size:
            ...
            allBanks.length++
            stor5F2F[stor140.length] = address(ext_call.return_data[0])
            emit AddBank(address rg1, address rg2):
...
function execute(uint256 arg1, address arg2, bytes arg3) payable {
    ...
    _GENERAL_LOCK = 2
    if not sub_d2ffc9f3:
        if not stor147[msg.sender]:
            if msg.sender != tx.origin:
                revert with 0, 'not eoa'
    if not stor146[address(arg2)]:
    ...
    if arg1:
        ...
        if not currentPositionInfo[arg1].field_768:
            ...
            while idx:
                ...
                if not currentPositionInfo[arg1][5][address(stor140[s])].field_0:
                    ...
                    mem[ceil32(arg3.length) + 164] = banks[address(stor140[s])].field_768 - 1 / banks[address(stor140[s])].field_768
                    ...
                    require banks[address(stor140[s])].field_768
                    mem[ceil32(arg3.length) + 132] = address(allBanks[s])
                    mem[ceil32(arg3.length) + 164] = banks[address(stor140[s])].field_768 + (banks[address(stor140[s])].field_512 * currentPositionInfo[arg1][5][address(stor140[s])].field_0) - 1 / banks[address(stor140[s])].field_768
                    mem[ceil32(arg3.length) + 196] = currentPositionInfo[arg1].field_0
                    require ext_code.size(oracleAddress)
                    staticcall oracleAddress.asETHBorrow(address rg1, uint256 rg2, address rg3) with:
                            gas gas_remaining wei
        ...
        return arg1
    nextPositionId++
    currentPositionInfo[stor139].field_0 = msg.sender or Mask(96, 160, currentPositionInfo[stor139].field_0)
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if not currentPositionInfo[stor139].field_768:
        ...
        while idx:
            ...
            mem[0] = address(allBanks[s])
            mem[32] = 141
            if not currentPositionInfo[stor139][5][address(stor140[s])].field_0:
                if banks[address(stor140[s])].field_768 < 0:
                    revert with 0, 'SafeMath: addition overflow'
                if 1 > banks[address(stor140[s])].field_768:
                    revert with 0, 'SafeMath: subtraction overflow'
                ...
                mem[ceil32(arg3.length) + 132] = address(allBanks[s])
                mem[ceil32(arg3.length) + 164] = banks[address(stor140[s])].field_768 - 1 / banks[address(stor140[s])].field_768
                mem[ceil32(arg3.length) + 196] = currentPositionInfo[stor139].field_0
                require ext_code.size(oracleAddress)
                staticcall oracleAddress.asETHBorrow(address rg1, uint256 rg2, address rg3) with:
                        gas gas_remaining wei
                       args address(allBanks[s]), banks[address(stor140[s])].field_768 - 1 / banks[address(stor140[s])].field_768, currentPositionInfo[stor139].field_0
            else:
                if banks[address(stor140[s])].field_512 * currentPositionInfo[stor139][5][address(stor140[s])].field_0 / currentPositionInfo[stor139][5][address(stor140[s])].field_0 != banks[address(stor140[s])].field_512:
                    revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[ceil32(arg3.length) + 229 len 31]
                if banks[address(stor140[s])].field_768 + (banks[address(stor140[s])].field_512 * currentPositionInfo[stor139][5][address(stor140[s])].field_0) < banks[address(stor140[s])].field_512 * currentPositionInfo[stor139][5][address(stor140[s])].field_0:
                    revert with 0, 'SafeMath: addition overflow'
                if 1 > banks[address(stor140[s])].field_768 + (banks[address(stor140[s])].field_512 * currentPositionInfo[stor139][5][address(stor140[s])].field_0):
                    revert with 0, 'SafeMath: subtraction overflow'
                if banks[address(stor140[s])].field_768 <= 0:
                    revert with 0, 'SafeMath: division by zero'
                require banks[address(stor140[s])].field_768
                mem[ceil32(arg3.length) + 132] = address(allBanks[s])
                mem[ceil32(arg3.length) + 164] = banks[address(stor140[s])].field_768 + (banks[address(stor140[s])].field_512 * currentPositionInfo[stor139][5][address(stor140[s])].field_0) - 1 / banks[address(stor140[s])].field_768
                mem[ceil32(arg3.length) + 196] = currentPositionInfo[stor139].field_0
                require ext_code.size(oracleAddress)
                staticcall oracleAddress.asETHBorrow(address rg1, uint256 rg2, address rg3) with:
                        gas gas_remaining wei
                       args address(allBanks[s]), banks[address(stor140[s])].field_768 + (banks[address(stor140[s])].field_512 * currentPositionInfo[stor139][5][address(stor140[s])].field_0) - 1 / banks[address(stor140[s])].field_768, currentPositionInfo[stor139].field_0
            mem[ceil32(arg3.length) + 128] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
        ...
        if not currentPositionInfo[stor139].field_256:
            revert with 0, 'bad collateral token'
        require ext_code.size(oracleAddress)
        staticcall oracleAddress.asETHCollateral(address rg1, uint256 rg2, uint256 rg3, address rg4) with:
                gas gas_remaining wei
               args currentPositionInfo[stor139].field_256, currentPositionInfo[stor139].field_512, currentPositionInfo[stor139].field_768, currentPositionInfo[stor139].field_0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        mem[0] = nextPositionId
        ...
        while idx:
            ...
            if not currentPositionInfo[stor139][5][address(stor140[s])].field_0:
                ...
                if banks[address(stor140[s])].field_512 * currentPositionInfo[stor139][5][address(stor140[s])].field_0 / currentPositionInfo[stor139][5][address(stor140[s])].field_0 != banks[address(stor140[s])].field_512:
                    revert with 0, 32, 33, 0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, currentPositionInfo[stor139].field_0
                if banks[address(stor140[s])].field_768 + (banks[address(stor140[s])].field_512 * currentPositionInfo[stor139][5][address(stor140[s])].field_0) < banks[address(stor140[s])].field_512 * currentPositionInfo[stor139][5][address(stor140[s])].field_0:
                    revert with 0, 'SafeMath: addition overflow'
                if 1 > banks[address(stor140[s])].field_768 + (banks[address(stor140[s])].field_512 * currentPositionInfo[stor139][5][address(stor140[s])].field_0):
                    revert with 0, 'SafeMath: subtraction overflow'
