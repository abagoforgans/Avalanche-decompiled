...
function deposit(uint256 arg1, uint256 arg2) payable {
    ...
    if arg1 > 0:
        if arg1 < stor2.length:
            ...
            staticcall stor2[arg1].balanceOf(address arg1) with:
            ...
            if ext_call.return_data[0] >= arg2:
                if arg1 >= stor2.length:
                    revert with 0, 50
                require ext_code.size(stor2[arg1])
                call stor2[arg1].transferFrom(address arg1, address arg2, uint256 arg3) with:
                     gas gas_remaining wei
        ...
        if arg1 >= stor2.length:
            ...
            if ext_call.return_data[0] >= arg2:
                if arg1 >= stor2.length:
                    revert with 0, 50
                require ext_code.size(stor2[arg1])
                call stor2[arg1].transfer(address arg1, uint256 arg2) with:
                     gas gas_remaining wei
            ...
            if not stor2.length:
                ...
                if not stor2.length:
                    ...
                    while idx < stor2.length:
                        ...
                        staticcall stor2[idx].symbol() with:
                                gas gas_remaining wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        _857 = mem[64]
                        ...
                        if ceil32(_909) <= _909:
                            ...
                            require ext_code.size(stor2[idx])
                            staticcall stor2[idx].balanceOf(address arg1) with:
                                    gas gas_remaining wei
                                   args this.address
                            ...
                            mem[0] = 2
                            require ext_code.size(stor2[idx])
                            staticcall stor2[idx].decimals() with:
                                    gas gas_remaining wei
                            mem[mem[64]] = ext_call.return_data[0]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
