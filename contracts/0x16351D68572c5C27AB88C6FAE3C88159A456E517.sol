...
function getProduct(bytes32 arg1) {
    ...
    return product[arg1].field_0, product[arg1].field_0, product[arg1].field_0, product[arg1].field_192
}
...
function sub_f8438203(?) {
    ...
    return bool(sub_f8438203[address(arg1)][arg3][address(arg2)][Mask(8, 248, bool(arg4)) >> 248].field_0), 
           ...
           sub_f8438203[address(arg1)][arg3][address(arg2)][Mask(8, 248, bool(arg4)) >> 248].field_72
}
...
function sub_0f1dfe87(?) {
    ...
    product[arg1].field_0 = 0xffffffffffffffff0000000000000000ffffffffffffffff and uint64(arg2) or 0xffffffffffffffff0000000000000000ffffffffffffffff0000000000000000 and product[arg1].field_0 or uint64(arg4) << 128 or arg5 << 192 or uint64(arg3) << 64
}
...
function sub_3d474866(?) {
    ...
    if not ('cd', 4).length:
        ...
        while idx < ('cd', 4).length:
            ...
            _25 = mem[64]
            mem[64] = mem[64] + 96
            mem[_25] = bool(sub_f8438203[cd[((32 * idx) + cd[4] + 36)]].field_0)
            mem[_25 + 32] = sub_f8438203[cd[((32 * idx) + cd[4] + 36)]].field_8
            mem[_25 + 64] = sub_f8438203[cd[((32 * idx) + cd[4] + 36)]].field_72
            if idx >= mem[96]:
                revert with 0, 50
            mem[(32 * idx) + 128] = _25
            if idx == -1:
        ...
        while idx < _28:
            ...
            mem[s + 32] = mem[_44 + 56 len 8]
            mem[s + 64] = mem[_44 + 88 len 8]
            idx = idx + 1
            s = s + 96
            t = t + 32
            continue 
    ...
    while idx < ('cd', 4).length:
        ...
        _50 = mem[64]
        mem[64] = mem[64] + 96
        mem[_50] = bool(sub_f8438203[cd[((32 * idx) + cd[4] + 36)]].field_0)
        mem[_50 + 32] = sub_f8438203[cd[((32 * idx) + cd[4] + 36)]].field_8
        mem[_50 + 64] = sub_f8438203[cd[((32 * idx) + cd[4] + 36)]].field_72
        if idx >= mem[96]:
            revert with 0, 50
        mem[(32 * idx) + 128] = _50
        if idx == -1:
