...
#  - queue(uint256 arg1)
#
const votingPeriod = (56 * 3600)

const name = 'Complus Network Governor Alpha', 0

const quorumVotes = (5000 * 10^18 * 3600)

const votingDelay = 1

const proposalMaxOperations = 10

const proposalThreshold = 6000000 * 10^18
...
function state(uint256 arg1) {
    ...
    if receipt[arg1].field_2304 <= receipt[arg1].field_2560:
        return 3
    if receipt[arg1].field_2304 < 5000 * 10^18 * 3600:
        return 3
    if not receipt[arg1].field_512:
        return 4
    if uint8(receipt[arg1].field_2824):
        return 7
    require ext_code.size(timelockAddress)
    staticcall timelockAddress.GRACE_PERIOD() with:
...
function castVoteBySig(uint256 arg1, bool arg2, uint8 arg3, bytes32 arg4, bytes32 arg5) {
    ...
    require arg4 == arg4
    require arg5 == arg5
    signer = erecover(sha3(0, sha3(sha3('EIP712Domain(string name,uint256', ' chainId,address verifyingContra', 'ct)'), sha3('Complus Network Governor Alpha'), chainid, this.address), sha3(sha3('Ballot(uint256 proposalId,bool s', 'upport)'), arg1, arg2)), arg3 << 248, arg4, arg5) 
    ...
    if not arg2:
        ...
        if receipt[arg1].field_2304 + ext_call.return_data[20 len 12] < receipt[arg1].field_2304:
            revert with 0, 'addition overflow'
        receipt[arg1].field_2304 += ext_call.return_data[20 len 12]
    uint8(receipt[arg1][12][address(signer)].field_0) = 1
    Mask(248, 0, receipt[arg1][12][address(signer)].field_8) = Mask(248, 0, arg2)
...
function castVote(uint256 arg1, bool arg2) {
    ...
    Mask(248, 0, receipt[arg1][12][address(msg.sender)].field_8) = Mask(248, 0, arg2)
    ...
    if not receipt[arg1].field_768:
        ...
        if not receipt[arg1].field_1024:
            ...
            while idx < _66:
                ...
                t = t + 32
                continue 
            mem[_55 + 32] = (32 * _66) + 160
            _125 = mem[(32 * receipt[arg1].field_768) + 128]
            mem[_55 + (32 * _66) + 160] = mem[(32 * receipt[arg1].field_768) + 128]
            mem[_55 + (32 * _66) + 192 len 32 * _125] = mem[(32 * receipt[arg1].field_768) + 160 len 32 * _125]
            mem[_55 + 64] = (32 * _66) + (32 * _125) + 192
            _179 = mem[(32 * receipt[arg1].field_768) + (32 * receipt[arg1].field_1024) + 160]
            mem[_55 + (32 * _66) + (32 * _125) + 192] = mem[(32 * receipt[arg1].field_768) + (32 * receipt[arg1].field_1024) + 160]
            idx = 0
            s = (32 * receipt[arg1].field_768) + (32 * receipt[arg1].field_1024) + 192
            t = _55 + (32 * _66) + (32 * _125) + (32 * _179) + 224
            u = _55 + (32 * _66) + (32 * _125) + 224
            while idx < _179:
            ...
            while idx < _183:
                ...
                t = t + 32
                continue 
            mem[_172 + 32] = (32 * _183) + 160
            _243 = mem[(32 * receipt[arg1].field_768) + 128]
            mem[_172 + (32 * _183) + 160] = mem[(32 * receipt[arg1].field_768) + 128]
            mem[_172 + (32 * _183) + 192 len 32 * _243] = mem[(32 * receipt[arg1].field_768) + 160 len 32 * _243]
            mem[_172 + 64] = (32 * _183) + (32 * _243) + 192
            _295 = mem[(32 * receipt[arg1].field_768) + (32 * receipt[arg1].field_1024) + 160]
            mem[_172 + (32 * _183) + (32 * _243) + 192] = mem[(32 * receipt[arg1].field_768) + (32 * receipt[arg1].field_1024) + 160]
            idx = 0
            s = (32 * receipt[arg1].field_768) + (32 * receipt[arg1].field_1024) + 192
            t = _172 + (32 * _183) + (32 * _243) + (32 * _295) + 224
            u = _172 + (32 * _183) + (32 * _243) + 224
            while idx < _295:
...
function execute(uint256 arg1) payable {
    ...
    mem[0] = arg1
    mem[32] = 3
    Mask(248, 0, receipt[arg1].field_2824) = 1
    idx = 0
    while idx < receipt[arg1].field_768:
        ...
        if not bool(receipt[arg1][idx + 5].field_0):
            ...
            if not bool(receipt[arg1][idx + 6].field_0):
                ...
                require ext_code.size(timelockAddress)
                call timelockAddress.executeTransaction(address rg1, uint256 rg2, string rg3, bytes rg4, uint256 rg5) with:
                ...
                require _114 + ceil32(return_data.size) + ceil32(mem[_114 + mem[_114]]) + 32 <= test266151307() and ceil32(mem[_114 + mem[_114]]) + 32 >= 0
                ...
                s = 0
                while s < _128:
                    mem[_114 + ceil32(return_data.size) + s + 32] = mem[_114 + _118 + s + 32]
                    s = s + 32
                    continue 
                if ceil32(_128) > _128:
                    mem[_114 + ceil32(return_data.size) + _128 + 32] = 0
            else:
                if bool(receipt[arg1][idx + 6].field_0) != 1:
                    ...
                    while s < _124:
                        ...
                        continue 
                    if ceil32(_124) > _124:
                        mem[_112 + ceil32(return_data.size) + _124 + 32] = 0
                else:
                    mem[mem[64] + 228] = uint255(receipt[arg1][idx + 6].field_1)
                    mem[0] = sha3(sha3(arg1, 3) + 6) + idx
                    s = 0
                    t = sha3(sha3(sha3(arg1, 3) + 6) + idx)
                    ...
                    require _168 + ceil32(return_data.size) + ceil32(mem[_168 + mem[_168]]) + 32 <= test266151307() and ceil32(mem[_168 + mem[_168]]) + 32 >= 0
                    ...
                    s = 0
                    while s < _174:
                        mem[_168 + ceil32(return_data.size) + s + 32] = mem[_168 + _170 + s + 32]
                        s = s + 32
                        continue 
                    if ceil32(_174) > _174:
                        mem[_168 + ceil32(return_data.size) + _174 + 32] = 0
        else:
            if bool(receipt[arg1][idx + 5].field_0) != 1:
                ...
                if not bool(receipt[arg1][idx + 6].field_0):
                    ...
                    require _113 + ceil32(return_data.size) + ceil32(mem[_113 + mem[_113]]) + 32 <= test266151307() and ceil32(mem[_113 + mem[_113]]) + 32 >= 0
                    ...
                    s = 0
                    while s < _126:
                        mem[_113 + ceil32(return_data.size) + s + 32] = mem[_113 + _117 + s + 32]
                        s = s + 32
                        continue 
                    if ceil32(_126) > _126:
                        mem[_113 + ceil32(return_data.size) + _126 + 32] = 0
                else:
                    if bool(receipt[arg1][idx + 6].field_0) != 1:
                        mem[mem[64] + 132] = receipt[arg1].field_512
                        require ext_code.size(timelockAddress)
                        ...
                        while s < _123:
                            ...
                            continue 
                        if ceil32(_123) > _123:
                            mem[_111 + ceil32(return_data.size) + _123 + 32] = 0
                    else:
                        mem[0] = sha3(sha3(arg1, 3) + 6) + idx
                        s = 0
                        t = sha3(mem[0])
                        ...
                        require ext_code.size(timelockAddress)
                        call timelockAddress.mem[mem[64] len 4] with:
                           value receipt[arg1][idx + 4].field_0 wei
                             gas gas_remaining wei
                        ...
                        require _169 + ceil32(return_data.size) + ceil32(mem[_169 + mem[_169]]) + 32 <= test266151307() and ceil32(mem[_169 + mem[_169]]) + 32 >= 0
                        ...
                        s = 0
                        while s < _176:
                            mem[_169 + ceil32(return_data.size) + s + 32] = mem[_169 + _171 + s + 32]
                            s = s + 32
                            continue 
                        if ceil32(_176) > _176:
                            mem[_169 + ceil32(return_data.size) + _176 + 32] = 0
            else:
                mem[mem[64] + 164] = uint255(receipt[arg1][idx + 5].field_1)
                mem[0] = sha3(sha3(arg1, 3) + 5) + idx
                s = 0
                t = sha3(sha3(sha3(arg1, 3) + 5) + idx)
                ...
                mem[_101 + 100] = s + 192
                if not bool(receipt[arg1][idx + 6].field_0):
                    mem[_101 + s + 196] = receipt[arg1][idx + 6].field_1 % 128
                    mem[_101 + s + 228] = Mask(248, 8, receipt[arg1][idx + 6].field_0)
                    mem[_101 + 132] = receipt[arg1].field_512
                    require ext_code.size(timelockAddress)
                    call timelockAddress.mem[mem[64] len 4] with:
                       value receipt[arg1][idx + 4].field_0 wei
                    ...
                    require _177 + ceil32(return_data.size) + ceil32(mem[_177 + mem[_177]]) + 32 <= test266151307() and ceil32(mem[_177 + mem[_177]]) + 32 >= 0
                    ...
                    s = 0
                    while s < _184:
                        mem[_177 + ceil32(return_data.size) + s + 32] = mem[_177 + _179 + s + 32]
                        s = s + 32
                        continue 
                    if ceil32(_184) > _184:
                        mem[_177 + ceil32(return_data.size) + _184 + 32] = 0
                else:
                    if bool(receipt[arg1][idx + 6].field_0) != 1:
                        mem[_101 + 132] = receipt[arg1].field_512
                        require ext_code.size(timelockAddress)
                        ...
                        s = 0
                        while s < _183:
                            mem[_175 + ceil32(return_data.size) + s + 32] = mem[_175 + _178 + s + 32]
                            s = s + 32
                            continue 
                        if ceil32(_183) > _183:
                            mem[_175 + ceil32(return_data.size) + _183 + 32] = 0
                    else:
                        mem[_101 + s + 196] = uint255(receipt[arg1][idx + 6].field_1)
                        mem[0] = sha3(sha3(arg1, 3) + 6) + idx
                        t = 0
                        u = sha3(sha3(sha3(arg1, 3) + 6) + idx)
                        while t < uint255(receipt[arg1][idx + 6].field_1):
                            mem[_101 + s + t + 228] = stor[u]
                            t = t + 32
                            u = u + 1
                            continue 
                        mem[_101 + 132] = receipt[arg1].field_512
                        ...
                        call timelockAddress.mem[mem[64] len 4] with:
                           value receipt[arg1][idx + 4].field_0 wei
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _101 + s + t + -mem[64] + 224]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        _201 = mem[64]
                        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                        ...
                        require _201 + ceil32(return_data.size) + ceil32(mem[_201 + mem[_201]]) + 32 <= test266151307() and ceil32(mem[_201 + mem[_201]]) + 32 >= 0
                        ...
                        s = 0
                        while s < _203:
                            mem[_201 + ceil32(return_data.size) + s + 32] = mem[_201 + _202 + s + 32]
                            s = s + 32
                            continue 
                        if ceil32(_203) > _203:
                            mem[_201 + ceil32(return_data.size) + _203 + 32] = 0
        idx = idx + 1
        continue 
...
function cancel(uint256 arg1) {
    ...
    if uint8(receipt[arg1].field_2816):
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[20 len 12]
        if ext_call.return_data[20 len 12] >= 6000000 * 10^18:
        ...
        while idx < receipt[arg1].field_768:
            ...
            if not bool(receipt[arg1][idx + 5].field_0):
                ...
                if not bool(receipt[arg1][idx + 6].field_0):
                    ...
                    mem[mem[64] + 132] = receipt[arg1].field_512
                    require ext_code.size(timelockAddress)
                    call timelockAddress.cancelTransaction(address rg1, uint256 rg2, string rg3, bytes rg4, uint256 rg5) with:
                         gas gas_remaining wei
                        args address(receipt[arg1][idx + 3].field_0), receipt[arg1][idx + 4].field_0, 160, 224, receipt[arg1].field_512, receipt[arg1][idx + 5].field_0 % 128, Mask(248, 8, receipt[arg1][idx + 5].field_0), receipt[arg1][idx + 6].field_0 % 128, Mask(248, 8, receipt[arg1][idx + 6].field_0)
                else:
                    if bool(receipt[arg1][idx + 6].field_0) != 1:
                ...
                if bool(receipt[arg1][idx + 5].field_0) != 1:
                    ...
                    if not bool(receipt[arg1][idx + 6].field_0):
                        ...
                        if bool(receipt[arg1][idx + 6].field_0) != 1:
                            ...
                            while s < uint255(receipt[arg1][idx + 6].field_1):
                                ...
                                t = t + 1
                                continue 
                            mem[_293 + 132] = receipt[arg1].field_512
                            require ext_code.size(timelockAddress)
                            call timelockAddress.mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len s + -mem[64] + 28]
                    ...
                    if not bool(receipt[arg1][idx + 6].field_0):
                        ...
                        if bool(receipt[arg1][idx + 6].field_0) != 1:
                            ...
                            call timelockAddress.mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _293 + s + t + -mem[64] + 224]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            idx = idx + 1
            continue 
                    ...
                    if not bool(receipt[arg1][idx + 6].field_0):
                        ...
                        if bool(receipt[arg1][idx + 6].field_0) != 1:
                            ...
                            while s < uint255(receipt[arg1][idx + 6].field_1):
                                ...
                                t = t + 1
                                continue 
                            mem[_291 + 132] = receipt[arg1].field_512
                            require ext_code.size(timelockAddress)
                            call timelockAddress.mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _291 + s + -mem[64] + 256]
                else:
                    if bool(receipt[arg1][idx + 5].field_0) != 1:
                        mem[mem[64] + 100] = -mem[64] - 4
                        if not bool(receipt[arg1][idx + 6].field_0):
                        ...
                        if not bool(receipt[arg1][idx + 6].field_0):
                            ...
                            if bool(receipt[arg1][idx + 6].field_0) != 1:
                                ...
                                call timelockAddress.mem[mem[64] len 4] with:
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4 len _291 + s + t + -mem[64] + 224]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                idx = idx + 1
                continue 
                        ...
                        if not bool(receipt[arg1][idx + 6].field_0):
                            ...
                            if bool(receipt[arg1][idx + 6].field_0) != 1:
                                ...
                                while s < uint255(receipt[arg1][idx + 6].field_1):
                                    ...
                                    t = t + 1
                                    continue 
                                mem[_289 + 132] = receipt[arg1].field_512
                                require ext_code.size(timelockAddress)
                                call timelockAddress.mem[mem[64] len 4] with:
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4 len _289 + s + -mem[64] + 256]
                    else:
                        if bool(receipt[arg1][idx + 5].field_0) != 1:
                            mem[mem[64] + 100] = -mem[64] - 4
                            if not bool(receipt[arg1][idx + 6].field_0):
                    ...
                    while idx < receipt[arg1].field_768:
                        ...
                        if not bool(receipt[arg1][idx + 5].field_0):
                            ...
                            if bool(receipt[arg1][idx + 5].field_0) != 1:
                                ...
                                if not bool(receipt[arg1][idx + 6].field_0):
                                    ...
                                    if bool(receipt[arg1][idx + 6].field_0) != 1:
                                        ...
                                        while s < uint255(receipt[arg1][idx + 6].field_1):
                                            ...
                                            t = t + 1
                                            continue 
                                        mem[_279 + 132] = receipt[arg1].field_512
                                        require ext_code.size(timelockAddress)
                                        call timelockAddress.mem[mem[64] len 4] with:
                                             gas gas_remaining wei
                                            args mem[mem[64] + 4 len s + -mem[64] + 28]
                                ...
                                mem[_279 + 100] = s + 192
                                if not bool(receipt[arg1][idx + 6].field_0):
                                    mem[_279 + s + 196] = receipt[arg1][idx + 6].field_1 % 128
                                    mem[_279 + s + 228] = Mask(248, 8, receipt[arg1][idx + 6].field_0)
                                    mem[_279 + 132] = receipt[arg1].field_512
                                    require ext_code.size(timelockAddress)
                                    call timelockAddress.mem[mem[64] len 4] with:
                                         gas gas_remaining wei
                                        args mem[mem[64] + 4 len _279 + s + -mem[64] + 256]
                                else:
                                    if bool(receipt[arg1][idx + 6].field_0) != 1:
                                        mem[_279 + 132] = receipt[arg1].field_512
                                        require ext_code.size(timelockAddress)
                                        ...
                                        mem[_279 + s + 196] = uint255(receipt[arg1][idx + 6].field_1)
                                        mem[0] = sha3(sha3(arg1, 3) + 6) + idx
                                        t = 0
                                        u = sha3(sha3(sha3(arg1, 3) + 6) + idx)
                                        while t < uint255(receipt[arg1][idx + 6].field_1):
                                            mem[_279 + s + t + 228] = stor[u]
                                            t = t + 32
                                            u = u + 1
                                            continue 
                                        mem[_279 + 132] = receipt[arg1].field_512
                                        ...
                                        call timelockAddress.mem[mem[64] len 4] with:
                                             gas gas_remaining wei
                                            args mem[mem[64] + 4 len _279 + s + t + -mem[64] + 224]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        idx = idx + 1
                        continue 
                                ...
                                if not bool(receipt[arg1][idx + 6].field_0):
                                    ...
                                    if bool(receipt[arg1][idx + 6].field_0) != 1:
                                        ...
                                        while s < uint255(receipt[arg1][idx + 6].field_1):
                                            ...
                                            t = t + 1
                                            continue 
                                        mem[_287 + 132] = receipt[arg1].field_512
                                        require ext_code.size(timelockAddress)
                                        call timelockAddress.mem[mem[64] len 4] with:
                                             gas gas_remaining wei
                                            args mem[mem[64] + 4 len _287 + s + -mem[64] + 256]
                            else:
                                if bool(receipt[arg1][idx + 5].field_0) != 1:
                                    mem[mem[64] + 100] = -mem[64] - 4
                                    if not bool(receipt[arg1][idx + 6].field_0):
                                    ...
                                    mem[_287 + 100] = s + 192
                                    if not bool(receipt[arg1][idx + 6].field_0):
                                        mem[_287 + s + 196] = receipt[arg1][idx + 6].field_1 % 128
                                        mem[_287 + s + 228] = Mask(248, 8, receipt[arg1][idx + 6].field_0)
                                        mem[_287 + 132] = receipt[arg1].field_512
                                        require ext_code.size(timelockAddress)
                                        call timelockAddress.mem[mem[64] len 4] with:
                                             gas gas_remaining wei
                                        ...
                                        if bool(receipt[arg1][idx + 6].field_0) != 1:
                                            ...
                                            mem[_287 + s + 196] = uint255(receipt[arg1][idx + 6].field_1)
                                            mem[0] = sha3(sha3(arg1, 3) + 6) + idx
                                            t = 0
                                            u = sha3(sha3(sha3(arg1, 3) + 6) + idx)
                                            while t < uint255(receipt[arg1][idx + 6].field_1):
                                                mem[_287 + s + t + 228] = stor[u]
                                                t = t + 32
                                                u = u + 1
                                                continue 
                                            mem[_287 + 132] = receipt[arg1].field_512
                                            ...
                                            call timelockAddress.mem[mem[64] len 4] with:
                                                 gas gas_remaining wei
                                                args mem[mem[64] + 4 len _287 + s + t + -mem[64] + 224]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            idx = idx + 1
                            continue 
                            ...
                            while idx < receipt[arg1].field_768:
                                ...
                                if not bool(receipt[arg1][idx + 5].field_0):
                                    ...
                                    if bool(receipt[arg1][idx + 5].field_0) != 1:
                                        ...
                                        if not bool(receipt[arg1][idx + 6].field_0):
                                            ...
                                            if bool(receipt[arg1][idx + 6].field_0) != 1:
                                                ...
                                                while s < uint255(receipt[arg1][idx + 6].field_1):
                                                    ...
                                                    t = t + 1
                                                    continue 
                                                mem[_285 + 132] = receipt[arg1].field_512
                                                require ext_code.size(timelockAddress)
                                                call timelockAddress.mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len s + -mem[64] + 28]
                                        ...
                                        mem[_285 + 100] = s + 192
                                        if not bool(receipt[arg1][idx + 6].field_0):
                                            mem[_285 + s + 196] = receipt[arg1][idx + 6].field_1 % 128
                                            mem[_285 + s + 228] = Mask(248, 8, receipt[arg1][idx + 6].field_0)
                                            mem[_285 + 132] = receipt[arg1].field_512
                                            require ext_code.size(timelockAddress)
                                            call timelockAddress.mem[mem[64] len 4] with:
                                                 gas gas_remaining wei
                                                args mem[mem[64] + 4 len _285 + s + -mem[64] + 256]
                                        else:
                                            if bool(receipt[arg1][idx + 6].field_0) != 1:
                                                mem[_285 + 132] = receipt[arg1].field_512
                                                require ext_code.size(timelockAddress)
                                                ...
                                                mem[_285 + s + 196] = uint255(receipt[arg1][idx + 6].field_1)
                                                mem[0] = sha3(sha3(arg1, 3) + 6) + idx
                                                t = 0
                                                u = sha3(sha3(sha3(arg1, 3) + 6) + idx)
                                                while t < uint255(receipt[arg1][idx + 6].field_1):
                                                    mem[_285 + s + t + 228] = stor[u]
                                                    t = t + 32
                                                    u = u + 1
                                                    continue 
                                                mem[_285 + 132] = receipt[arg1].field_512
                                                ...
                                                call timelockAddress.mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len _285 + s + t + -mem[64] + 224]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                idx = idx + 1
                                continue 
                                        ...
                                        if not bool(receipt[arg1][idx + 6].field_0):
                                            ...
                                            if bool(receipt[arg1][idx + 6].field_0) != 1:
                                                ...
                                                while s < uint255(receipt[arg1][idx + 6].field_1):
                                                    ...
                                                    t = t + 1
                                                    continue 
                                                mem[_281 + 132] = receipt[arg1].field_512
                                                require ext_code.size(timelockAddress)
                                                call timelockAddress.mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len _281 + s + -mem[64] + 256]
                                    else:
                                        if bool(receipt[arg1][idx + 5].field_0) != 1:
                                            mem[mem[64] + 100] = -mem[64] - 4
                                            if not bool(receipt[arg1][idx + 6].field_0):
                                            ...
                                            mem[_281 + 100] = s + 192
                                            if not bool(receipt[arg1][idx + 6].field_0):
                                                mem[_281 + s + 196] = receipt[arg1][idx + 6].field_1 % 128
                                                mem[_281 + s + 228] = Mask(248, 8, receipt[arg1][idx + 6].field_0)
                                                mem[_281 + 132] = receipt[arg1].field_512
                                                require ext_code.size(timelockAddress)
                                                call timelockAddress.mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                ...
                                                if bool(receipt[arg1][idx + 6].field_0) != 1:
                                                    ...
                                                    mem[_281 + s + 196] = uint255(receipt[arg1][idx + 6].field_1)
                                                    mem[0] = sha3(sha3(arg1, 3) + 6) + idx
                                                    t = 0
                                                    u = sha3(sha3(sha3(arg1, 3) + 6) + idx)
                                                    while t < uint255(receipt[arg1][idx + 6].field_1):
                                                        mem[_281 + s + t + 228] = stor[u]
                                                        t = t + 32
                                                        u = u + 1
                                                        continue 
                                                    mem[_281 + 132] = receipt[arg1].field_512
                                                    ...
                                                    call timelockAddress.mem[mem[64] len 4] with:
                                                         gas gas_remaining wei
                                                        args mem[mem[64] + 4 len _281 + s + t + -mem[64] + 224]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    idx = idx + 1
                                    continue 
                                        ...
                                        if not bool(receipt[arg1][idx + 6].field_0):
                                            ...
                                            if bool(receipt[arg1][idx + 6].field_0) != 1:
                                                ...
                                                while s < uint255(receipt[arg1][idx + 6].field_1):
                                                    ...
                                                    t = t + 1
                                                    continue 
                                                mem[_283 + 132] = receipt[arg1].field_512
                                                require ext_code.size(timelockAddress)
                                                call timelockAddress.mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len _283 + s + -mem[64] + 256]
                                    else:
                                        if bool(receipt[arg1][idx + 5].field_0) != 1:
                                            mem[mem[64] + 100] = -mem[64] - 4
                                            if not bool(receipt[arg1][idx + 6].field_0):
                                            ...
                                            mem[_283 + 100] = s + 192
                                            if not bool(receipt[arg1][idx + 6].field_0):
                                                mem[_283 + s + 196] = receipt[arg1][idx + 6].field_1 % 128
                                                mem[_283 + s + 228] = Mask(248, 8, receipt[arg1][idx + 6].field_0)
                                                mem[_283 + 132] = receipt[arg1].field_512
                                                require ext_code.size(timelockAddress)
                                                call timelockAddress.mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                ...
                                                if bool(receipt[arg1][idx + 6].field_0) != 1:
                                                    ...
                                                    mem[_283 + s + 196] = uint255(receipt[arg1][idx + 6].field_1)
                                                    mem[0] = sha3(sha3(arg1, 3) + 6) + idx
                                                    t = 0
                                                    u = sha3(sha3(sha3(arg1, 3) + 6) + idx)
                                                    while t < uint255(receipt[arg1][idx + 6].field_1):
                                                        mem[_283 + s + t + 228] = stor[u]
                                                        t = t + 32
                                                        u = u + 1
                                                        continue 
                                                    mem[_283 + 132] = receipt[arg1].field_512
                                                    ...
                                                    call timelockAddress.mem[mem[64] len 4] with:
                                                         gas gas_remaining wei
                                                        args mem[mem[64] + 4 len _283 + s + t + -mem[64] + 224]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    idx = idx + 1
                                    continue 
