...
function ClaimReward(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(0x8729438eb15e2c8b576fcc6aecda6a148776c0f5)
    staticcall 0x8729438eb15e2c8b576fcc6aecda6a148776c0f5.balanceOf(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function ClaimRewardTwo(string[] arg1, uint256 arg2) payable {
    ...
    if not arg1.length:
        ...
        while idx < arg1.length:
            ...
            require ext_code.size(0xe7a85d0addb972a4f0a4e57b698b37f171519e88)
            staticcall 0xe7a85d0addb972a4f0a4e57b698b37f171519e88.getMapping(string rg1) with:
                    gas gas_remaining wei
                   args mem[mem[64] + 4 len ceil32(cd[(arg1 + cd[(arg1 + (32 * idx) + 36)] + 36)]) + _117 + -mem[64] + 64]
        ...
        call 0x486af39519b4dc9a7fccd318217352830e8ad9b4.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _120 + (32 * _124) + -mem[64] + 128]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64] + 4] = this.address
        require ext_code.size(0x8729438eb15e2c8b576fcc6aecda6a148776c0f5)
    ...
    call 0x486af39519b4dc9a7fccd318217352830e8ad9b4.mem[mem[64] len 4] with:
         gas gas_remaining wei
        args mem[mem[64] + 4 len _121 + (32 * _125) + -mem[64] + 128]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[mem[64] + 4] = this.address
    require ext_code.size(0x8729438eb15e2c8b576fcc6aecda6a148776c0f5)
...
function ClaimRewardThree(string[] arg1, string[] arg2, uint256 arg3) payable {
    ...
    if not arg2.length + arg1.length:
        if not arg1.length:
            ...
            while idx < arg2.length:
                ...
                staticcall 0xe7a85d0addb972a4f0a4e57b698b37f171519e88.getMapping(string rg1) with:
                        gas gas_remaining wei
                       args mem[mem[64] + 4 len ceil32(cd[(arg2 + cd[(arg2 + (32 * idx) + 36)] + 36)]) + _469 + -mem[64] + 64]
                mem[mem[64] len 64] = ext_call.return_data[0 len 64]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _498 = mem[64]
            ...
            if not arg3:
                ...
                mem[_1325 + 128] = 160
                _1536 = mem[_1332]
                mem[_1325 + 256] = mem[_1332]
                mem[_1325 + 288 len ceil32(_1536)] = mem[_1332 + 32 len ceil32(_1536)]
                if ceil32(_1536) > _1536:
                    mem[_1325 + _1536 + 288] = 0
                return 64, 160, 33, mem[_1325 + 192 len 33], 0, mem[_1325 + 256 len ceil32(_1536) + 32]
            mem[mem[64]] = 0x61e3c94400000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = arg3
            require ext_code.size(0x3254ce8f5b1c82431b8f21df01918342215825c2)
            call 0x3254ce8f5b1c82431b8f21df01918342215825c2.setUint(uint256 rg1, uint256 rg2) with:
            ...
            mem[64] = mem[64] + 96
            mem[_1337] = 33
            mem[_1337 + 32 len 33] = 0xfe4c6f67436c61696d65645265776172642875696e743235362c75696e74323536
            _1338 = mem[64]
            mem[mem[64] + 32] = _1292 - ext_call.return_data[0]
            mem[mem[64] + 64] = arg3
            _1357 = mem[64]
            ...
            mem[_1338 + 96] = 64
            mem[_1338 + 160] = 33
            mem[_1338 + 192 len 64] = 0xfe4c6f67436c61696d65645265776172642875696e743235362c75696e74323536, mem[_1337 + 65 len 31]
            mem[_1338 + 225] = 0
            mem[_1338 + 128] = 160
            _1537 = mem[_1357]
            mem[_1338 + 256] = mem[_1357]
            mem[_1338 + 288 len ceil32(_1537)] = mem[_1357 + 32 len ceil32(_1537)]
            if ceil32(_1537) > _1537:
                mem[_1338 + _1537 + 288] = 0
            return 64, 160, 33, mem[_1338 + 192 len 33], 0, mem[_1338 + 256 len ceil32(_1537) + 32]
        idx = 0
        while idx < arg1.length:
            require cd[(arg1 + (32 * idx) + 36)] < calldata.size + -arg1 - 67
            require cd[(arg1 + cd[(arg1 + (32 * idx) + 36)] + 36)] <= test266151307()
        ...
        if arg2.length:
            ...
            while idx < arg2.length:
                ...
                staticcall 0xe7a85d0addb972a4f0a4e57b698b37f171519e88.getMapping(string rg1) with:
                        gas gas_remaining wei
                       args mem[mem[64] + 4 len ceil32(cd[(arg2 + cd[(arg2 + (32 * idx) + 36)] + 36)]) + _905 + -mem[64] + 64]
                mem[mem[64] len 64] = ext_call.return_data[0 len 64]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _926 = mem[64]
    ...
    if not arg1.length:
        ...
        while idx < arg2.length:
            ...
            staticcall 0xe7a85d0addb972a4f0a4e57b698b37f171519e88.getMapping(string rg1) with:
                    gas gas_remaining wei
                   args mem[mem[64] + 4 len ceil32(cd[(arg2 + cd[(arg2 + (32 * idx) + 36)] + 36)]) + _475 + -mem[64] + 64]
            mem[mem[64] len 64] = ext_call.return_data[0 len 64]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _504 = mem[64]
    ...
    while idx < arg2.length:
        ...
        staticcall 0xe7a85d0addb972a4f0a4e57b698b37f171519e88.getMapping(string rg1) with:
                gas gas_remaining wei
               args mem[mem[64] + 4 len ceil32(cd[(arg2 + cd[(arg2 + (32 * idx) + 36)] + 36)]) + _909 + -mem[64] + 64]
        mem[mem[64] len 64] = ext_call.return_data[0 len 64]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _931 = mem[64]
