                        ...
                        if mem[ceil32(return_data.size) + 140 len 20] != earnTokenAddress:
                            ...
                            if mem[ceil32(return_data.size) + 140 len 20] != stakeTokenAddress:
                                ...
                                if swapRouterEnabled:
                                    ...
                                    staticcall address(_43).allowance(address arg1, address arg2) with:
                                            gas gas_remaining wei
                                           args this.address, address(swapRouterAddress)
                                    ...
                                    staticcall address(_44).allowance(address arg1, address arg2) with:
                                            gas gas_remaining wei
                                           args this.address, address(liquidityRouterAddress)
                                    mem[ceil32(return_data.size) + (32 * swapPath[address(arg1)][stor8].field_0) + 128] = ext_call.return_data[0]
                                    if not ext_call.success:
                        ...
                        if mem[ceil32(return_data.size) + 140 len 20] != earnTokenAddress:
                            ...
                            if mem[ceil32(return_data.size) + 140 len 20] != stakeTokenAddress:
                                ...
                                if swapRouterEnabled:
                                    ...
                                    staticcall address(_1935).allowance(address arg1, address arg2) with:
                                            gas gas_remaining wei
                                           args this.address, address(swapRouterAddress)
                                    mem[ceil32(return_data.size) + (32 * swapPath[address(arg1)][stor8].field_0) + 128] = ext_call.return_data[0]
                                    if not ext_call.success:
                                    ...
                                    staticcall address(_1936).allowance(address arg1, address arg2) with:
                                            gas gas_remaining wei
                                           args this.address, address(liquidityRouterAddress)
                                    mem[ceil32(return_data.size) + (32 * swapPath[address(arg1)][stor8].field_0) + 128] = ext_call.return_data[0]
                                    if not ext_call.success:
                                    ...
                                    if swapRouterEnabled:
                                        ...
                                        if not return_data.size:
                                            ...
                                            call address(swapRouterAddress).mem[mem[64] len 4] with:
                                                 gas gas_remaining wei
                                                args mem[mem[64] + 4 len (2 * ceil32(return_data.size)) + (32 * swapPath[address(arg1)][stor8].field_0) + -mem[64] + 644]
                                        else:
                                            ...
                                            call address(swapRouterAddress).mem[mem[64] len 4] with:
                                                 gas gas_remaining wei
                                                args mem[mem[64] + 4 len (2 * ceil32(return_data.size)) + (32 * swapPath[address(arg1)][stor8].field_0) + ceil32(return_data.size) + -mem[64] + 645]
                                    else:
                                        mem[ceil32(return_data.size) + (32 * swapPath[address(arg1)][stor8].field_0) + 260] = address(liquidityRouterAddress)
                                        require ext_code.size(arg1)
                                        staticcall arg1.allowance(address arg1, address arg2) with:
                                ...
                                if arg1 != stakeTokenAddress:
                                    ...
                                    if swapRouterEnabled:
                                        ...
                                        if not return_data.size:
                                            ...
                                            call address(swapRouterAddress).mem[mem[64] len 4] with:
                                                 gas gas_remaining wei
                                                args mem[mem[64] + 4 len (2 * ceil32(return_data.size)) + (32 * swapPath[address(arg1)][stor8].field_0) + -mem[64] + 708]
                                        else:
                                            ...
                                            call address(swapRouterAddress).mem[mem[64] len 4] with:
                                                 gas gas_remaining wei
                                                args mem[mem[64] + 4 len (2 * ceil32(return_data.size)) + (32 * swapPath[address(arg1)][stor8].field_0) + ceil32(return_data.size) + -mem[64] + 709]
                                    else:
                                        mem[ceil32(return_data.size) + (32 * swapPath[address(arg1)][stor8].field_0) + 292] = address(liquidityRouterAddress)
                                        require ext_code.size(arg1)
                                        staticcall arg1.allowance(address arg1, address arg2) with:
