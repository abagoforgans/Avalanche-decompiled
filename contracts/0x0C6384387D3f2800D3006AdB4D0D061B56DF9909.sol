...
function getTvl() payable {
    ...
    if 100 * ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0] != 100:
        revert with 0, 32, 33, 0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
    if (100 * ext_call.return_data[0] * ext_call.return_data[0] / 1000000000000000000 * 10^18) + (100 * ext_call.return_data[0] / 10^18) < 100 * ext_call.return_data[0] / 10^18:
        revert with 0, 'SafeMath: addition overflow'
    return ((100 * ext_call.return_data[0] * ext_call.return_data[0] / 1000000000000000000 * 10^18) + (100 * ext_call.return_data[0] / 10^18))
}
