...
function _getNodeNumberOf(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    delegate 0x15d301e195a3c6ff1159e3a5c095a7a6deb0b3ae.0x732a2ccf with:
...
function createNode(address arg1, string arg2) payable {
    ...
    require ext_code.size(0x15d301e195a3c6ff1159e3a5c095a7a6deb0b3ae)
    delegate 0x15d301e195a3c6ff1159e3a5c095a7a6deb0b3ae.0xbc2b405c with:
         gas gas_remaining wei
