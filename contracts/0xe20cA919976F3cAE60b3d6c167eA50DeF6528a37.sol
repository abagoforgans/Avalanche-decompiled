...
function balanceOf(address arg1) {
    ...
    if not stor32:
        revert with 0, 'SafeMath: division by zero'
    return (stor34[address(arg1)] / stor32)
}
...
function shouldSwapBack() {
    if stor10[msg.sender]:
        return not bool(stor10[msg.sender])
    if stor30:
        return not bool(stor30)
    if not uint8(stor2.field_176):
        return bool(uint8(stor2.field_176))
    if totalSellFee + totalBuyFee < totalBuyFee:
        revert with 0, 'SafeMath: addition overflow'
    if totalSellFee + totalBuyFee <= 0:
        return (totalSellFee + totalBuyFee > 0)
    return stor34[this.address] >= stor33
}
...
function getCirculatingSupply() {
    if stor34[stor11] > 0xfffffffffffffffffffffffffffffffffffffffffe2d6fffbc6a148440000000:
        revert with 0, 'SafeMath: subtraction overflow'
    if stor34[stor12] > -stor34[stor11] - 564039457584007913129639936:
        revert with 0, 'SafeMath: subtraction overflow'
    if not stor32:
        revert with 0, 'SafeMath: division by zero'
    return (-stor34[stor11] + -stor34[stor12] - 564039457584007913129639936 / stor32)
}
...
function setSwapBackSettings(bool arg1, uint256 arg2, uint256 arg3) {
    ...
    if not 0xfffffffffffffffffffffffffffffffffffffffffe2d6fffbc6a148440000000 / arg3:
        ...
        stor33 = arg2 * 0xfffffffffffffffffffffffffffffffffffffffffe2d6fffbc6a148440000000 / arg3
}
...
function getLiquidityBacking(uint256 arg1) payable {
    ...
    while idx < sub_e1d5584c.length:
        ...
        if stor32:
            ...
            if stor34[stor9[idx]] / stor32 / 10^9 < 0:
                revert with 0, 'SafeMath: addition overflow'
            idx = idx + 1
            continue 
    ...
    if not -stor34[stor11] + -stor34[stor12] - 564039457584007913129639936 / stor32 / 10^9:
        revert with 0, 'SafeMath: division by zero'
    return (0 / -stor34[stor11] + -stor34[stor12] - 564039457584007913129639936 / stor32 / 10^9)
}
...
function isOverLiquified(uint256 arg1, uint256 arg2) payable {
    ...
    if not -stor34[stor11] + -stor34[stor12] - 564039457584007913129639936 / stor32 / 10^9:
        revert with 0, 'SafeMath: division by zero'
    return (0 / -stor34[stor11] + -stor34[stor12] - 564039457584007913129639936 / stor32 / 10^9 > arg1)
}
...
function sub_61a9d1b1(?) {
    ...
    if not stor32:
        revert with 0, 'SafeMath: division by zero'
    if not -stor34[stor11] + -stor34[stor12] - 564039457584007913129639936 / stor32:
        if not sub_d7832b11:
            revert with 0, 'SafeMath: division by zero'
        if not 0 / sub_d7832b11:
            ...
            if 0 / sub_d7832b11 >= 0:
                ...
                if not totalSupply:
                    revert with 0, 'SafeMath: division by zero'
                stor32 = 0xfffffffffffffffffffffffffffffffffffffffffe2d6fffbc6a148440000000 / totalSupply
        ...
        if sub_0af08314 * -stor34[stor11] + -stor34[stor12] - 564039457584007913129639936 / stor32 / -stor34[stor11] + -stor34[stor12] - 564039457584007913129639936 / stor32 != sub_0af08314:
            revert with 0, 32, 33, 0xfe536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
        if not sub_d7832b11:
            revert with 0, 'SafeMath: division by zero'
        if not sub_0af08314 * -stor34[stor11] + -stor34[stor12] - 564039457584007913129639936 / stor32 / sub_d7832b11:
            emit LogRebase(totalSupply, block.timestamp);
            idx = 0
            while idx < sub_e1d5584c.length:
                mem[0] = 9
            ...
            if sub_0af08314 * -stor34[stor11] + -stor34[stor12] - 564039457584007913129639936 / stor32 / sub_d7832b11 >= 0:
                if (sub_0af08314 * -stor34[stor11] + -stor34[stor12] - 564039457584007913129639936 / stor32 / sub_d7832b11) + totalSupply < totalSupply:
                    revert with 0, 'SafeMath: addition overflow'
                totalSupply += sub_0af08314 * -stor34[stor11] + -stor34[stor12] - 564039457584007913129639936 / stor32 / sub_d7832b11
                if test266151307() < totalSupply:
                    totalSupply = test266151307()
                if not totalSupply:
                    revert with 0, 'SafeMath: division by zero'
                ...
                if -sub_0af08314 * -stor34[stor11] + -stor34[stor12] - 564039457584007913129639936 / stor32 / sub_d7832b11 > totalSupply:
                    revert with 0, 'SafeMath: subtraction overflow'
                totalSupply += sub_0af08314 * -stor34[stor11] + -stor34[stor12] - 564039457584007913129639936 / stor32 / sub_d7832b11
                if test266151307() < totalSupply:
                    totalSupply = test266151307()
