...
function sub_ac0e5b5a(?) {
    ...
    if not address(ext_call.return_data[32]):
        ...
        staticcall address(ext_call.return_data[64]).balanceOf(address arg1) with:
                gas gas_remaining wei
               args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
...
function claimAllRewards(address arg1) {
    ...
    if owner == msg.sender:
        ...
        require (32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 0 + 192]) + 32 >= 0 and (2 * ceil32(return_data.size)) + (32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 0 + 192]) + 224 <= test266151307()
        mem[64] = (2 * ceil32(return_data.size)) + (32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 0 + 192]) + 224
        mem[(2 * ceil32(return_data.size)) + 192] = _57
...
function claimRewards(address arg1, uint256 arg2) {
    ...
    if owner == msg.sender:
        ...
        staticcall address(_92).balanceOf(address arg1) with:
                gas gas_remaining wei
               args this.address
        ...
        while idx < mem[_94]:
            ...
            t = t + 32
            continue 
        mem[_94 + (2 * ceil32(return_data.size)) + 132] = arg2
        mem[_94 + (2 * ceil32(return_data.size)) + 164] = this.address
        mem[_94 + (2 * ceil32(return_data.size)) + 196] = address(_92)
        require ext_code.size(stor2)
        call stor2.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _94 + (2 * ceil32(return_data.size)) + (32 * mem[_94]) + -mem[64] + 256]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        mem[64] = mem[64] + ceil32(return_data.size)
        require return_data.size >= 32
        if ext_call.return_data[0] > mem[_160]:
            revert with 0, 'SafeMath: subtraction overflow'
        mem[mem[64]] = mem[_160] - ext_call.return_data[0]
    else:
        mem[0] = msg.sender
        mem[32] = 1
        if not stor1[msg.sender]:
        ...
        require (32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], address(ext_call.return_data[0]) << 64 + 96]) + 32 >= 0 and (2 * ceil32(return_data.size)) + (32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], address(ext_call.return_data[0]) << 64 + 96]) + 128 <= test266151307()
        mem[64] = (2 * ceil32(return_data.size)) + (32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], address(ext_call.return_data[0]) << 64 + 96]) + 128
        mem[(2 * ceil32(return_data.size)) + 96] = _25
        ...
        staticcall address(_93).balanceOf(address arg1) with:
                gas gas_remaining wei
               args this.address
        ...
        while idx < mem[_95]:
            ...
            t = t + 32
            continue 
        mem[_95 + (2 * ceil32(return_data.size)) + 132] = arg2
        mem[_95 + (2 * ceil32(return_data.size)) + 164] = this.address
        mem[_95 + (2 * ceil32(return_data.size)) + 196] = address(_93)
        require ext_code.size(stor2)
        call stor2.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _95 + (2 * ceil32(return_data.size)) + (32 * mem[_95]) + -mem[64] + 256]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[64] = mem[64] + ceil32(return_data.size)
        require return_data.size >= 32
        ...
        mem[64] = mem[64] + ceil32(return_data.size)
        require return_data.size >= 32
        if ext_call.return_data[0] > mem[_161]:
            revert with 0, 'SafeMath: subtraction overflow'
        mem[mem[64]] = mem[_161] - ext_call.return_data[0]
    return memory
      from mem[64]
       len 32
}
...
function sub_507c9ff0(?) {
    ...
    if not address(ext_call.return_data[32]):
        if not address(ext_call.return_data[64]):
            ...
            mem[(6 * ceil32(return_data.size)) + 256] = _95
        ...
        mem[(7 * ceil32(return_data.size)) + 256] = _137
    ...
    mem[(8 * ceil32(return_data.size)) + 256] = _246
