...
function sub_80610936(?) payable {
    ...
    call address(cd[100]).transfer(address arg1, uint256 arg2) with:
         gas gas_remaining wei
    ...
    if address(cd[100]) == mem[140 len 20]:
        ...
        mem[(32 * ('cd', 132).length) + (32 * ('cd', 164).length) + ceil32(return_data.size) + 160] = 0x6d9a640a00000000000000000000000000000000000000000000000000000000
        ...
        call address(_93).swap(uint256 arg1, uint256 arg2, address arg3) with:
             gas gas_remaining wei
            args 0, cd[68], address(_97)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require 1 < ('cd', 164).length
        require ext_code.size(mem[(32 * ('cd', 132).length) + 204 len 20])
        call mem[(32 * ('cd', 132).length) + 204 len 20].swap(uint256 arg1, uint256 arg2, address arg3) with:
             gas gas_remaining wei
            args cd[36], 0, this.address
    else:
        ...
        call address(_96).swap(uint256 arg1, uint256 arg2, address arg3) with:
             gas gas_remaining wei
            args cd[68], 0, address(_100)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require 1 < ('cd', 164).length
        require ext_code.size(mem[(32 * ('cd', 132).length) + 204 len 20])
