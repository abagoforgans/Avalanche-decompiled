...
function sub_5249dfac(?) {
    ...
    if arg4:
        ...
        while idx < _373:
            ...
            t = t + 32
            continue 
        staticcall traderJoeRouterAddress.mem[mem[64] len 4] with:
                gas gas_remaining wei
               args mem[mem[64] + 4 len _370 + (32 * _373) + -mem[64] + 96]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _435 = mem[64]
        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        call traderJoeRouterAddress.mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len 96], address(this.address), block.timestamp, mem[mem[64] + 164 len (32 * _499) + 32]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _535 = mem[64]
        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        staticcall sub_70d4c397Address.getAmountsOut(uint256 arg1, address[] arg2) with:
                gas gas_remaining wei
               args _371, 64, mem[mem[64] + 68 len (32 * _374) + 32]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _436 = mem[64]
        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
