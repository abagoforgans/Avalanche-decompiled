...
const factory = 0xbfc3c95af01d8d6477c4fd9065580322633b4f77
...
function withdrawEth() {
    staticcall 0xbfc3c95af01d8d6477c4fd9065580322633b4f77.0x3ecce421 with:
    ...
    if not ext_call.return_data[0]:
        if msg.sender != 0xbfc3c95af01d8d6477c4fd9065580322633b4f77:
            revert with 0, 'NotOperator'
    if eth.balance(this.address) < eth.balance(this.address):
        revert with 0, 'Address: insufficient balance'
    call 0xbfc3c95af01d8d6477c4fd9065580322633b4f77 with:
...
function sub_13e6911f(?) {
    ...
    call 0x9ab2de34a33fb459b538c43f251eb825645e8595.decreasePosition(address arg1, address arg2, address arg3, uint256 arg4, uint256 arg5, bool arg6, address arg7) with:
         gas gas_remaining wei
        args this.address, address(arg1), address(arg2), arg3, arg4, bool(arg5), 0xbfc3c95af01d8d6477c4fd9065580322633b4f77
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
}
...
function withdrawERC20(address arg1) {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    mem[(2 * ceil32(return_data.size)) + 132] = 0xbfc3c95af01d8d6477c4fd9065580322633b4f77
    mem[(2 * ceil32(return_data.size)) + 164] = ext_call.return_data[0]
    mem[(2 * ceil32(return_data.size)) + 96] = 68
    mem[(2 * ceil32(return_data.size)) + 132 len 28] = 0xbfc3c95af01d8d6477c4fd9065580322
    ...
    mem[(2 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), 0xbfc3c95af01d8d6477c4fd90, 0, ext_call.return_data[0], 0
    mem[(2 * ceil32(return_data.size)) + 328] = 0
    call arg1 with:
       funct Mask(32, 224, unknown_0xa9059cbb(?????), 0xbfc3c95af01d8d6477c4fd90, 0, ext_call.return_data[0], 0) >> 224
         gas gas_remaining wei
        args (Mask(512, -288, unknown_0xa9059cbb(?????), 0xbfc3c95af01d8d6477c4fd90, 0, ext_call.return_data[0], 0) << 288)
        ...
        if unknown_0xe3fb008e(?????) > uint32(call.func_hash) >> 224:
            if uint32(call.func_hash) >> 224 != unknown_0x13e6911f(?????):
                if uint32(call.func_hash) >> 224 != unknown_0xa0ef91df(?????):
                    ...
                    return 0xbfc3c95af01d8d6477c4fd9065580322633b4f77
                require not msg.value
                staticcall 0xbfc3c95af01d8d6477c4fd9065580322633b4f77.0x3ecce421 with:
                        gas gas_remaining wei
                       args msg.sender
            ...
            if unknown_0xe3fb008e(?????) == uint32(call.func_hash) >> 224:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[(2 * ceil32(return_data.size)) + 164] = 0xbfc3c95af01d8d6477c4fd9065580322633b4f77
                mem[(2 * ceil32(return_data.size)) + 196] = ext_call.return_data[0]
                mem[(2 * ceil32(return_data.size)) + 128] = 68
                mem[(2 * ceil32(return_data.size)) + 164 len 28] = 0xbfc3c95af01d8d6477c4fd9065580322
                ...
                if not ext_code.size(address(arg1)):
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 292 len 96] = unknown_0xa9059cbb(?????), 0xbfc3c95af01d8d6477c4fd90, 0, ext_call.return_data[0], 0
