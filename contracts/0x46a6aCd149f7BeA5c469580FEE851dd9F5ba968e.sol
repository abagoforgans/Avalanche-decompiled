...
const qieth = 0x334ad834cd4481bb02d09615e7c11a00579a79
...
function getSupplied() {
    require ext_code.size(0x77000000000000000000000000334ad834cd4481bb02d09615e7c11a00579a79)
...
function getSuppliedView() {
    require ext_code.size(0x77000000000000000000000000334ad834cd4481bb02d09615e7c11a00579a79)
    staticcall 0x77000000000000000000000000334ad834cd4481bb02d09615e7c11a00579a79.getAccountSnapshot(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function getSafeSyncColFactor() {
    ...
    staticcall 0x486af39519b4dc9a7fccd318217352830e8ad9b4.markets(address rg1) with:
            gas gas_remaining wei
           args 0x77000000000000000000000000334ad834cd4481bb02d09615e7c11a00579a79
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function balanceOfPool() {
    ...
    require return_data.size >= 128
    require ext_code.size(0x77000000000000000000000000334ad834cd4481bb02d09615e7c11a00579a79)
    staticcall 0x77000000000000000000000000334ad834cd4481bb02d09615e7c11a00579a79.borrowBalanceStored(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function withdraw(address arg1) {
    ...
    if not return_data.size:
        ...
        if not unknown_0xa9059cbb(?????), Mask(224, 0, stor7):
            revert with 0, 32, 42, 0x95361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
    else:
        ...
        if return_data.size:
            ...
            if not mem[292]:
                revert with 0, 
                            32,
                            42,
                            0x95361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
...
function withdrawForSwap(uint256 arg1) {
    ...
    if ext_call.return_data[0] > arg1:
        revert with 0, 'SafeMath: subtraction overflow'
    require ext_code.size(0x334ad834cd4481bb02d09615e7c11a00579a79)
    staticcall 0x334ad834cd4481bb02d09615e7c11a00579a79.getCash() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function withdrawAll() {
    ...
    if not return_data.size:
        ...
        revert with 0, 32, 42, 0x95361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[562 len 22]
...
function deposit() {
    ...
    if ext_call.return_data[0]:
        if not ext_code.size(wantAddress):
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = approve(address rg1, uint256 rg2), 62008660221570947095908502, 0, 0
        mem[324 len 0] = 0
        call wantAddress.0x579a79 with:
             gas gas_remaining wei
            args Mask(480, -256, approve(address rg1, uint256 rg2), 62008660221570947095908502, 0, 0) << 256, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address rg1, uint256 rg2), 62008660221570947095908502, 0, 0
            if not approve(address rg1, uint256 rg2), 62008660221570947095908502:
                revert with 0, 32, 42, 0x95361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
            if ext_call.return_data[0]:
                require ext_code.size(wantAddress)
                staticcall wantAddress.0xdd62ed3e with:
                        gas gas_remaining wei
                       args this.address, 0x334ad834cd4481bb02d09615e7c11a00579a79
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                if ext_call.return_data[0]:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = 0, 0x334ad834cd4481bb02d09615e7c11a00579a79, ext_call.return_data[0 len 28]
            call wantAddress.0x579a79 with:
                 gas gas_remaining wei
            ...
            if not return_data.size:
                if not ext_call.success:
                    revert with approve(address rg1, uint256 rg2), 62008660221570947095908502, 0, 0
                if not approve(address rg1, uint256 rg2), 62008660221570947095908502:
                    revert with 0, 32, 42, 0x95361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[534 len 22]
            else:
            ...
            require ext_code.size(0x334ad834cd4481bb02d09615e7c11a00579a79)
            call 0x00334ad834cd4481bb02d09615e7c11a00579a79.mint(uint256 rg1) with:
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 425 len 64] = 0, 0x334ad834cd4481bb02d09615e7c11a00579a79, ext_call.return_data[0 len 28]
                call wantAddress.0x579a79 with:
                     gas gas_remaining wei
...
function getHarvestable() {
    ...
    staticcall 0x486af39519b4dc9a7fccd318217352830e8ad9b4.rewardSupplierIndex(uint8 rg1, address rg2, address rg3) with:
            gas gas_remaining wei
           args 0, 0x77000000000000000000000000334ad834cd4481bb02d09615e7c11a00579a79, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(0x334ad834cd4481bb02d09615e7c11a00579a79)
    staticcall 0x334ad834cd4481bb02d09615e7c11a00579a79.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if ext_call.return_data[0] >= Mask(224, 0, ext_call.return_data[0]):
        ...
        require return_data.size >= 32
        require ext_code.size(0x334ad834cd4481bb02d09615e7c11a00579a79)
        staticcall 0x334ad834cd4481bb02d09615e7c11a00579a79.borrowBalanceStored(address rg1) with:
                gas gas_remaining wei
               args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if ext_call.return_data[0] >= Mask(224, 0, ext_call.return_data[0]):
            ...
            staticcall 0x486af39519b4dc9a7fccd318217352830e8ad9b4.rewardSupplierIndex(uint8 rg1, address rg2, address rg3) with:
                    gas gas_remaining wei
                   args 1, 0x77000000000000000000000000334ad834cd4481bb02d09615e7c11a00579a79, this.address
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require ext_code.size(0x334ad834cd4481bb02d09615e7c11a00579a79)
