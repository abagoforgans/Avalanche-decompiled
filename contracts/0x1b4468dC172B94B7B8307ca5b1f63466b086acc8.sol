...
const getName = 'StrategyPngAvaxSushiLp'
...
uint256 keepPNG;
address sub_d243eb06Address;
address sub_a9febc53Address;
...
function sub_a9febc53(?) {
    return sub_a9febc53Address
}
...
function sub_d243eb06(?) {
    return sub_d243eb06Address
}
