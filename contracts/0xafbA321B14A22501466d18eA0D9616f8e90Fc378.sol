...
const getName = 'StrategyPngWbtcPngLp'
...
uint256 keepPNG;
address sub_e819addeAddress;
address sub_9e389ec2Address;
address wbtcAddress;
...
function sub_9e389ec2(?) {
    return sub_9e389ec2Address
}
...
function sub_e819adde(?) {
    return sub_e819addeAddress
}
