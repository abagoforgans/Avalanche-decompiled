...
function sub_6c8f2a3c(?) payable {
    return sub_6c8f2a3cAddress
}
...
function sub_55a450c1(?) payable {
    if tx.origin != msg.sender:
        revert with 0, '!EOA'
    require ext_code.size(sub_6c8f2a3cAddress)
    call sub_6c8f2a3cAddress.0xa9059cbb with:
