...
function withdrawDAI(address arg1, uint256 arg2) payable {
    ...
    if not sub_77b7dc5f[address(msg.sender)].field_256:
        ...
        if not ext_call.return_data[0]:
            ...
            call stor1.withdraw(address arg1, uint256 arg2, address arg3) with:
                 gas gas_remaining wei
                args stor2, (sub_77b7dc5f[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18, this.address
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if ext_call.return_data[0] < (sub_77b7dc5f[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18:
                revert with 0, 17
            if ext_call.return_data[0] - ((sub_77b7dc5f[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18) and arg2 > -1 / ext_call.return_data[0] - ((sub_77b7dc5f[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18):
                revert with 0, 17
            if ext_call.return_data[0] < (ext_call.return_data[0] * arg2) - ((sub_77b7dc5f[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100:
                revert with 0, 17
            if (ext_call.return_data[0] * arg2) - ((sub_77b7dc5f[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100:
                call stor2.0xa9059cbb with:
                     gas gas_remaining wei
                    args address(arg1), (ext_call.return_data[0] * arg2) - ((sub_77b7dc5f[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
            ...
            if ext_call.return_data[0] - ((ext_call.return_data[0] * arg2) - ((sub_77b7dc5f[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100):
                call stor2.0xa9059cbb with:
                     gas gas_remaining wei
                    args msg.sender, ext_call.return_data[0] - ((ext_call.return_data[0] * arg2) - ((sub_77b7dc5f[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                if not ext_call.return_data[0]:
                    revert with 0, 'Could not transfer tokens'
            emit Withdrawal((sub_77b7dc5f[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18, stor2, address(arg1), arg2, ext_call.return_data[0], (ext_call.return_data[0] * arg2) - ((sub_77b7dc5f[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100, msg.sender);
}
...
function withdrawUSDT(address arg1, uint256 arg2) payable {
    ...
    if not sub_60a6e624[address(msg.sender)].field_256:
        ...
        if not ext_call.return_data[0]:
            ...
            call stor1.withdraw(address arg1, uint256 arg2, address arg3) with:
                 gas gas_remaining wei
                args stor3, (sub_60a6e624[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18, this.address
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if ext_call.return_data[0] < (sub_60a6e624[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18:
                revert with 0, 17
            if ext_call.return_data[0] - ((sub_60a6e624[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18) and arg2 > -1 / ext_call.return_data[0] - ((sub_60a6e624[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18):
                revert with 0, 17
            if ext_call.return_data[0] < (ext_call.return_data[0] * arg2) - ((sub_60a6e624[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100:
                revert with 0, 17
            if (ext_call.return_data[0] * arg2) - ((sub_60a6e624[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100:
                call stor3.0xa9059cbb with:
                     gas gas_remaining wei
                    args address(arg1), (ext_call.return_data[0] * arg2) - ((sub_60a6e624[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
            ...
            if ext_call.return_data[0] - ((ext_call.return_data[0] * arg2) - ((sub_60a6e624[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100):
                call stor3.0xa9059cbb with:
                     gas gas_remaining wei
                    args msg.sender, ext_call.return_data[0] - ((ext_call.return_data[0] * arg2) - ((sub_60a6e624[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                if not ext_call.return_data[0]:
                    revert with 0, 'Could not transfer tokens'
            emit Withdrawal((sub_60a6e624[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18, stor3, address(arg1), arg2, ext_call.return_data[0], (ext_call.return_data[0] * arg2) - ((sub_60a6e624[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100, msg.sender);
}
...
function withdrawUSDC(address arg1, uint256 arg2) payable {
    ...
    if not sub_f9f5cc73[address(msg.sender)].field_256:
        ...
        if not ext_call.return_data[0]:
            ...
            call stor1.withdraw(address arg1, uint256 arg2, address arg3) with:
                 gas gas_remaining wei
                args stor4, (sub_f9f5cc73[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18, this.address
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if ext_call.return_data[0] < (sub_f9f5cc73[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18:
                revert with 0, 17
            if ext_call.return_data[0] - ((sub_f9f5cc73[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18) and arg2 > -1 / ext_call.return_data[0] - ((sub_f9f5cc73[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18):
                revert with 0, 17
            if ext_call.return_data[0] < (ext_call.return_data[0] * arg2) - ((sub_f9f5cc73[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100:
                revert with 0, 17
            if (ext_call.return_data[0] * arg2) - ((sub_f9f5cc73[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100:
                call stor4.0xa9059cbb with:
                     gas gas_remaining wei
                    args address(arg1), (ext_call.return_data[0] * arg2) - ((sub_f9f5cc73[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
            ...
            if ext_call.return_data[0] - ((ext_call.return_data[0] * arg2) - ((sub_f9f5cc73[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100):
                call stor4.0xa9059cbb with:
                     gas gas_remaining wei
                    args msg.sender, ext_call.return_data[0] - ((ext_call.return_data[0] * arg2) - ((sub_f9f5cc73[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                if not ext_call.return_data[0]:
                    revert with 0, 'Could not transfer tokens'
            emit Withdrawal((sub_f9f5cc73[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18, stor4, address(arg1), arg2, ext_call.return_data[0], (ext_call.return_data[0] * arg2) - ((sub_f9f5cc73[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18 * arg2) / 100, msg.sender);
}
