...
array of address sub_c854f12a;
array of address sub_4ae042ef;
...
function sub_4ae042ef(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_4ae042ef.length
    return sub_4ae042ef[arg1]
}
...
function sub_c854f12a(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < sub_c854f12a.length
    return sub_c854f12a[arg1]
}
...
function farm() payable {
    ...
    if not sub_0ddea8c3:
        ...
        call farmContractAddress.deposit(uint256 rg1) with:
             gas gas_remaining wei
                ...
                if not isAutoComp:
                    ...
                    if arg2 <= ext_call.return_data[0]:
                        if wantLockedTotal >= arg2:
                            ...
                            if ext_code.size(wantAddress) <= 0:
                                revert with 0, 'Address: call to non-contract'
                            mem[452 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, arg2) >> 32
                            mem[516 len 0] = 0
                            call wantAddress with:
                               funct uint32(stor12)
                                 gas gas_remaining wei
                            ...
                            if ext_code.size(wantAddress) <= 0:
                                revert with 0, 'Address: call to non-contract'
                            mem[452 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 0, stor16.field_32)
                            mem[516 len 0] = 0
                            call wantAddress with:
                               funct uint32(stor12)
                                 gas gas_remaining wei
                        ...
                        if wantLockedTotal >= ext_call.return_data[0]:
                            ...
                            if ext_code.size(wantAddress) <= 0:
                                revert with 0, 'Address: call to non-contract'
                            mem[452 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor12), uint32(stor12), ext_call.return_data[0 len 28]
                            mem[516 len 0] = 0
                            call wantAddress with:
                               funct uint32(stor12)
                                 gas gas_remaining wei
                    ...
                    if not sub_0ddea8c3:
                        ...
                        call farmContractAddress.withdraw(uint256 rg1) with:
                             gas gas_remaining wei
                            args arg2
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                    ...
                    if not isAutoComp:
                        ...
                        if 0 <= ext_call.return_data[0]:
                            if wantLockedTotal >= 0:
                                ...
                                if ext_code.size(wantAddress) <= 0:
                                    revert with 0, 'Address: call to non-contract'
                                mem[516 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor12), uint32(stor12), 0
                                mem[580 len 0] = 0
                                call wantAddress with:
                                   funct uint32(stor12)
                                     gas gas_remaining wei
                                    args Mask(480, -256, transfer(address rg1, uint256 rg2), Mask(224, 0, stor12), uint32(stor12), 0) << 256, mem[580 len 4]
                            else:
                                if wantLockedTotal > wantLockedTotal:
                                    revert with 0, 'SafeMath: subtraction overflow'
                                wantLockedTotal = 0
                                ...
                                if ext_code.size(wantAddress) <= 0:
                                    revert with 0, 'Address: call to non-contract'
                                mem[516 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 0, stor16.field_32)
                                mem[580 len 0] = 0
                                call wantAddress with:
                                   funct uint32(stor12)
                                     gas gas_remaining wei
                            ...
                            if wantLockedTotal >= ext_call.return_data[0]:
                                ...
                                if ext_code.size(wantAddress) <= 0:
                                    revert with 0, 'Address: call to non-contract'
                                mem[516 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor12), uint32(stor12), ext_call.return_data[0 len 28]
                                mem[580 len 0] = 0
                                call wantAddress with:
                                   funct uint32(stor12)
                                     gas gas_remaining wei
                    ...
                    if not isAutoComp:
                        ...
                        if arg2 * withdrawFeeFactor / 10000 <= ext_call.return_data[0]:
                            if wantLockedTotal >= arg2 * withdrawFeeFactor / 10000:
                                ...
                                if ext_code.size(wantAddress) <= 0:
                                    revert with 0, 'Address: call to non-contract'
                                mem[516 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor12), uint32(stor12), Mask(224, 32, arg2 * withdrawFeeFactor / 10000) >> 32
                                mem[580 len 0] = 0
                                call wantAddress with:
                                   funct uint32(stor12)
                                     gas gas_remaining wei
        ...
        if not arg2:
            if wantLockedTotal <= 0:
                ...
                if not isAutoComp:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[520 len 64] = 0, address(stor2.field_0), Mask(224, 31, ext_call.return_data[0]) >> 31
                    call wantAddress with:
                       funct uint32(stor2.field_0)
                         gas gas_remaining wei
            ...
            if not isAutoComp:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[648 len 64] = 0, address(stor2.field_0), Mask(224, 31, ext_call.return_data[0]) >> 31
                call wantAddress with:
                   funct uint32(stor2.field_0)
                     gas gas_remaining wei
                    args 2 * ext_call.return_data[0], mem[584 len 28], mem[712 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg2
                    if not transferFrom(address rg1, address rg2, uint256 rg3), Mask(224, 32, msg.sender) >> 32:
            ...
            if not arg2:
                if wantLockedTotal <= 0:
                    ...
                    if not isAutoComp:
                        ...
                        if ext_code.size(wantAddress) <= 0:
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 521 len 64] = 0, address(stor2.field_0), Mask(224, 31, ext_call.return_data[0]) >> 31
                ...
                if not isAutoComp:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 649 len 64] = 0, address(stor2.field_0), Mask(224, 31, ext_call.return_data[0]) >> 31
                    mem[ceil32(return_data.size) + 741 len 4] = 0
                    call wantAddress with:
                       funct uint32(stor2.field_0)
                         gas gas_remaining wei
                        args 2 * ext_call.return_data[0], mem[ceil32(return_data.size) + 585 len 28], mem[ceil32(return_data.size) + 713 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg2
                        if not transferFrom(address rg1, address rg2, uint256 rg3), Mask(224, 32, msg.sender) >> 32:
                        ...
                        if not sub_0ddea8c3:
                            call farmContractAddress.deposit(uint256 rg1, uint256 rg2) with:
                                 gas gas_remaining wei
                                args pid, ext_call.return_data[0], mem[(2 * ceil32(return_data.size)) + 718 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                        else:
                            call farmContractAddress.deposit(uint256 rg1) with:
                                 gas gas_remaining wei
                                args ext_call.return_data[0]
