...
function swap(address arg1, address arg2, address arg3, uint256 arg4, uint256 arg5) payable {
    ...
    mem[164] = 0x4d308c46ea9f234ea515cc51f16fba776451cac8
    mem[196] = 0
    mem[228] = arg5
    ...
    call 0x4d308c46ea9f234ea515cc51f16fba776451cac8.swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
         gas gas_remaining wei
        args 0, 0 / (997 * ext_call.return_data[0]) + (1000 * Mask(112, 0, ext_call.return_data[0])), 0xf4f46382c2be1603dc817551ff9a7b333ed1d18f, 128, 0, None
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(2 * ceil32(return_data.size)) + 164] = 0xf4f46382c2be1603dc817551ff9a7b333ed1d18f
    mem[(2 * ceil32(return_data.size)) + 196] = arg3
    mem[(2 * ceil32(return_data.size)) + 228] = 0 / (997 * ext_call.return_data[0]) + (1000 * Mask(112, 0, ext_call.return_data[0]))
