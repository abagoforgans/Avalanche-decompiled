...
const getName = 'StrategyPngBnbPngLp'
...
uint256 keepPNG;
address sub_628be68fAddress;
address sub_7ca9dcc1Address;
address bnbAddress;
...
function sub_628be68f(?) {
    return sub_628be68fAddress
}

function sub_7ca9dcc1(?) {
    return sub_7ca9dcc1Address
}
    ...
    if ext_call.return_data[0] >= arg1:
        if not arg1:
            ...
            if not arg1:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 553 len 64] = 0, address(ext_call.return_data[0]), Mask(224, 32, arg1 * withdrawalTreasuryFee / 100000) >> 32
                call wantAddress with:
                     gas gas_remaining wei
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 846 len 64] = 0, address(ext_call.return_data[0]), Mask(224, 32, arg1 - (arg1 * withdrawalTreasuryFee / 100000)) >> 32
                call wantAddress with:
                     gas gas_remaining wei
                    args arg1 - (arg1 * withdrawalTreasuryFee / 100000), mem[(2 * ceil32(return_data.size)) + 782 len 28], mem[(2 * ceil32(return_data.size)) + 910 len 4]
        else:
            require arg1
            ...
            call wantAddress.mem[224 len 4] with:
                 gas gas_remaining wei
                args Mask(224, 32, arg1 * withdrawalDevFundFee / 100000) << 224, mem[388 len 4]
            if not return_data.size:
                require not ext_call.success
                revert with 'SafeMath: division by zero'
            mem[356 len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if not arg1:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 846 len 64] = 0, address(ext_call.return_data[0]), Mask(224, 32, arg1 - (arg1 * withdrawalDevFundFee / 100000)) >> 32
                call wantAddress with:
                     gas gas_remaining wei
                    args arg1 - (arg1 * withdrawalDevFundFee / 100000), mem[(2 * ceil32(return_data.size)) + 782 len 28], mem[(2 * ceil32(return_data.size)) + 910 len 4]
            else:
                require arg1
                if arg1 * withdrawalTreasuryFee / arg1 != withdrawalTreasuryFee:
                    revert with 0, 
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 846 len 64] = 0, address(ext_call.return_data[0]), Mask(224, 32, arg1 - (arg1 * withdrawalDevFundFee / 100000) - (arg1 * withdrawalTreasuryFee / 100000)) >> 32
                call wantAddress with:
                     gas gas_remaining wei
                    args arg1 - (arg1 * withdrawalDevFundFee / 100000) - (arg1 * withdrawalTreasuryFee / 100000), mem[(2 * ceil32(return_data.size)) + 782 len 28], mem[(2 * ceil32(return_data.size)) + 910 len 4]
        if not return_data.size:
            require not ext_call.success
            revert with 'SafeMath: division by zero'
        ...
        if not arg1:
            ...
            if not arg1:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 617 len 64] = 0, address(ext_call.return_data[0]), Mask(224, 32, arg1 * withdrawalTreasuryFee / 100000) >> 32
                call wantAddress with:
                     gas gas_remaining wei
                    args arg1 * withdrawalTreasuryFee / 100000, mem[ceil32(return_data.size) + 553 len 28], mem[ceil32(return_data.size) + 681 len 4]
                if not return_data.size:
                    require not ext_call.success
                    revert with 'SafeMath: subtraction overflow'
                mem[ceil32(return_data.size) + 649 len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 910 len 64] = 0, address(ext_call.return_data[0]), Mask(224, 32, arg1 - (arg1 * withdrawalTreasuryFee / 100000)) >> 32
                call wantAddress with:
                     gas gas_remaining wei
                    args arg1 - (arg1 * withdrawalTreasuryFee / 100000), mem[(2 * ceil32(return_data.size)) + 846 len 28], mem[(2 * ceil32(return_data.size)) + 974 len 4]
        else:
            require arg1
            if arg1 * withdrawalDevFundFee / arg1 != withdrawalDevFundFee:
            ...
            call wantAddress.mem[288 len 4] with:
                 gas gas_remaining wei
                args Mask(224, 32, arg1 * withdrawalDevFundFee / 100000) << 224, mem[452 len 4]
            if not return_data.size:
                require not ext_call.success
                revert with 'SafeMath: subtraction overflow'
            mem[420 len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if not arg1:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 910 len 64] = 0, address(ext_call.return_data[0]), Mask(224, 32, arg1 - (arg1 * withdrawalDevFundFee / 100000)) >> 32
                call wantAddress with:
                     gas gas_remaining wei
                    args arg1 - (arg1 * withdrawalDevFundFee / 100000), mem[(2 * ceil32(return_data.size)) + 846 len 28], mem[(2 * ceil32(return_data.size)) + 974 len 4]
            else:
                require arg1
                if arg1 * withdrawalTreasuryFee / arg1 != withdrawalTreasuryFee:
                    revert with 0, 
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 910 len 64] = 0, address(ext_call.return_data[0]), Mask(224, 32, arg1 - (arg1 * withdrawalDevFundFee / 100000) - (arg1 * withdrawalTreasuryFee / 100000)) >> 32
                call wantAddress with:
                     gas gas_remaining wei
                    args arg1 - (arg1 * withdrawalDevFundFee / 100000) - (arg1 * withdrawalTreasuryFee / 100000), mem[(2 * ceil32(return_data.size)) + 846 len 28], mem[(2 * ceil32(return_data.size)) + 974 len 4]
        if not return_data.size:
            require not ext_call.success
            revert with 'SafeMath: subtraction overflow'
