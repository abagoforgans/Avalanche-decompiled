...
function execute(address arg1, address arg2, address arg3) payable {
    ...
    if 1 > !block.timestamp:
        revert with 0, 17
    call stor0.swap(address arg1, address arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
         gas gas_remaining wei
        args address(arg1), address(arg2), ext_call.return_data[0], 0, address(this.address), block.timestamp + 1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 64
