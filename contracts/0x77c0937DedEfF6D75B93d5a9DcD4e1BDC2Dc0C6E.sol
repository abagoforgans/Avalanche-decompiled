...
const sub_233a70d8(?) = 0x57319d41f71e81f3c65f2a47ca4e001ebafd4f33

const getBlockNumber = block.number

const getCloseFactor = ext_call.return_data[0]

const sub_59601a0c(?) = 0xc146783a59807154f92084f9243eb139d58da696
...
function sub_b8155e48(?) {
    ...
    if not ext_call.return_data[0]:
        ...
        require ext_code.size(0xdc13687554205e5b89ac783db14bb5bba4a1edac)
        staticcall 0xdc13687554205e5b89ac783db14bb5bba4a1edac.getAccountLiquidity(address arg1) with:
                gas gas_remaining wei
               args mem[140 len 20]
