...
function sub_d89ff504(?) payable {
    ...
    if not uint8(arg2):
        ...
        require mem[_68 + 224] == mem[_68 + 236 len 20]
        mem[_72 + 224] = mem[_68 + 224]
        _96 = mem[_72 + 32]
        _97 = mem[_72 + 96]
        _98 = mem[_72]
        _99 = mem[_72 + 64]
        require ext_code.size(mem[_72 + 236 len 20])
        staticcall mem[_72 + 236 len 20].0x18160ddd with:
                gas gas_remaining wei
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    ...
    require mem[_69 + 224] == mem[_69 + 236 len 20]
    mem[_73 + 224] = mem[_69 + 224]
    _103 = mem[_73 + 32]
    _104 = mem[_73 + 96]
    _105 = mem[_73]
    _106 = mem[_73 + 64]
    require ext_code.size(mem[_73 + 236 len 20])
    staticcall mem[_73 + 236 len 20].0x18160ddd with:
            gas gas_remaining wei
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
