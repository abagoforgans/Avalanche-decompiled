...
function sub_850e2430(?) payable {
    ...
    mem[(4 * ceil32(return_data.size)) + 196] = sub_8a14c2fdAddress
    ...
    mem[(4 * ceil32(return_data.size)) + 196] = ext_call.return_data[0] * arg1 / 100
...
function sub_a1731eca(?) payable {
    ...
    if mem[_34 + mem[_34]] > test266151307():
        revert with 0, 65
    if _34 + ceil32(return_data.size) + ceil32(32 * mem[_34 + mem[_34]]) + 1 > test266151307() or ceil32(32 * mem[_34 + mem[_34]]) + 1 < 0:
        revert with 0, 65
    require return_data.size >= mem[_34] + (32 * mem[_34 + mem[_34]]) + 32
    emit 0x96cefb06: msg.sender, ext_call.return_data[0] * arg1 / 100
}
