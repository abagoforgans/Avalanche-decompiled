...
function isRegistred(address arg1) {
    require calldata.size - 4 >= 32
...
function removeUser(address arg1) {
    ...
    stor1[address(arg1)].field_8 = 'deleted' / 256
    idx = 0
...
function removeAdmin(address arg1) {
    ...
    stor3[address(arg1)].field_8 = 'deleted' / 256
    idx = 0
...
function addAdmin(address arg1, string arg2) {
    ...
    mem[ceil32(arg2.length) + 224 len ceil32(arg2.length)] = arg2[all], mem[arg2.length + 128 len ceil32(arg2.length) - arg2.length]
    if not arg2.length % 32:
        emit 0x4781cd01: Mask(8 * -ceil32(arg2.length) + arg2.length + 32, 0, 0), mem[arg2.length + 160 len ceil32(arg2.length) + -arg2.length + 32], arg2.length, Mask(8 * arg2.length, -(8 * arg2.length) + 256, arg2[all], mem[arg2.length + 128 len ceil32(arg2.length) - arg2.length]) << (8 * arg2.length) - 256
    else:
        mem[floor32(arg2.length) + ceil32(arg2.length) + 224] = mem[floor32(arg2.length) + ceil32(arg2.length) + -(arg2.length % 32) + 256 len arg2.length % 32]
