...
const sub_33623794(?) = 0x5cb40f337054f2e20df3e066ec517e96c5454746

const sub_5f22f53f(?) = 0x8729438eb15e2c8b576fcc6aecda6a148776c0f5
...
function sub_59b78dc7(?) payable {
    require ext_code.size(0x5cb40f337054f2e20df3e066ec517e96c5454746)
    staticcall 0x5cb40f337054f2e20df3e066ec517e96c5454746.0x72f702f3 with:
    ...
    require return_data.size >= 32
    require ext_code.size(0x5cb40f337054f2e20df3e066ec517e96c5454746)
    staticcall 0x5cb40f337054f2e20df3e066ec517e96c5454746.0x18160ddd with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(sha3(0, 17269419903419772280, sha3(8712802085545782520, 0x8729438eb15e2c8b576fcc6aecda6a148776c0f5), 0x40231f6b438bce0797c9ada29b718a87ea0a5cea3fe9a771abdd76bd41a3e545)))
    staticcall address(sha3(0, 17269419903419772280, sha3(8712802085545782520, 0x8729438eb15e2c8b576fcc6aecda6a148776c0f5), 0x40231f6b438bce0797c9ada29b718a87ea0a5cea3fe9a771abdd76bd41a3e545)).getReserves() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
