...
function balanceOf(address arg1) {
    ...
    if not stor6 / 10^17:
        revert with 'NH{q', 18
    return (stor2[address(arg1)] / stor6 / 10^17)
}
...
function manualswap() {
    ...
    if not stor16:
        revert with 0, 'ERC20: approve to the zero address'
    allowance[address(this.address)][stor16] = stor2[address(this.address)] / stor6 / 10^17
    emit Approval((stor2[address(this.address)] / stor6 / 10^17), this.address, stor16);
