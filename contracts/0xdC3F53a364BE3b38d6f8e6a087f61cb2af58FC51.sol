...
uint256 keepPNG;
address sub_42d556c9Address;
address sub_552e2d96Address;
...
function sub_42d556c9(?) {
    return sub_42d556c9Address
}
...
function sub_552e2d96(?) {
    return sub_552e2d96Address
}
...
function setKeepPNG(uint256 arg1) {
    require calldata.size - 4 >= 32
...
function balanceOfPool() {
    require ext_code.size(address(rewardsAddress))
    staticcall address(rewardsAddress).balanceOf(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
        ...
        if not return_data.size:
            ...
            if ext_call.return_data[0]:
                ...
                staticcall wantAddress.allowance(address rg1, address rg2) with:
                        gas gas_remaining wei
                       args address(this.address), address(rewardsAddress)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                if ext_call.return_data[0]:
    ...
    if ext_call.return_data[0] >= arg1:
        ...
        if not arg1:
            ...
            if not arg1:
                ...
                if ext_code.size(wantAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 910 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)] = transfer(address rg1, uint256 rg2), address(ext_call.return_data[0]) << 64, 0, Mask(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36, -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256, arg1) >> -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256
                call wantAddress with:
