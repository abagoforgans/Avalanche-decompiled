...
function epoch() {
    ...
    staticcall masterChefAddress.0x900cf0cf with:
...
function nextEpochPoint() {
    require ext_code.size(masterChefAddress)
    staticcall masterChefAddress.0xc5967c26 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function withdrawLockupEpochs() {
    require ext_code.size(masterChefAddress)
    staticcall masterChefAddress.0x1e85cd65 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function emergencyWithdraw() {
    ...
    require ext_code.size(masterChefAddress)
    call masterChefAddress.exit() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function initialize(uint256 arg1, bool arg2, address[7] arg3, address[] arg4, address[] arg5, address[] arg6, address[] arg7) {
    ...
    masterChefAddress = address(arg6)
