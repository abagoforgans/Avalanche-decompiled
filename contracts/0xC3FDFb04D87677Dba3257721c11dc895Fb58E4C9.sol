            ...
            if unknown_0x583bd7a6(?????) > uint32(call.func_hash) >> 224:
                if unknown_0x2bb14e1d(?????) > uint32(call.func_hash) >> 224:
                    ...
                    if ceil32(_356) <= _356:
                        ...
                        return memory
                          from mem[64]
                           len ceil32(_356) + _926 + -mem[64] + 64
                    ...
                    return memory
                      from mem[64]
                       len ceil32(_356) + _927 + -mem[64] + 64
            ...
            if unknown_0xa0a8fe65(?????) > uint32(call.func_hash) >> 224:
                ...
                if uint32(call.func_hash) >> 224 != unknown_0xb403cd91(?????):
                    ...
                    while idx < 10:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 64
                        if mem[_1196] > !mem[_1196 + 32]:
                            revert with 0, 17
                        if mem[_1196] + mem[_1196 + 32] < mem[_1196]:
                            revert with 0, 'SafeMath: addition overflow'
                        if s > !(mem[_1196] + mem[_1196 + 32]):
                            revert with 0, 17
                        if not idx + 1:
                            revert with 0, 17
                        idx = idx + 1
                        s = s + mem[_1196] + mem[_1196 + 32]
                        continue 
                    staticcall nodeRewardManagerAddress.nodePrice() with:
                            gas gas_remaining wei
                    mem[mem[64]] = ext_call.return_data[0]
                    ...
                    if 0x35f9dea3e1f6bdfef70cdd17b25efa418ca63a22764cec100000000000000000000 * s / _1195 > 0x35f9dea3e1f6bdfef70cdd17b25efa418ca63a22764cec100000000000000000000 * s:
                        revert with 0, 'SafeMath: subtraction overflow', 0
                    if 0x35f9dea3e1f6bdfef70cdd17b25efa418ca63a22764cec100000000000000000000 * s < 0x35f9dea3e1f6bdfef70cdd17b25efa418ca63a22764cec100000000000000000000 * s / _1195:
                        revert with 0, 17
                    if 0x35f9dea3e1f6bdfef70cdd17b25efa418ca63a22764cec100000000000000000000 * s < _1195:
                        revert with 0, 'Balance not enough to compound'
                    mem[mem[64]] = 0x9021973200000000000000000000000000000000000000000000000000000000
                    mem[mem[64] + 4] = msg.sender
                    mem[mem[64] + 36] = 96
                    _1263 = mem[ceil32(32 * ('cd', 4).length) + 129]
                    mem[mem[64] + 100] = mem[ceil32(32 * ('cd', 4).length) + 129]
                    mem[mem[64] + 132 len ceil32(_1263)] = mem[ceil32(32 * ('cd', 4).length) + 161 len ceil32(_1263)]
                    if ceil32(_1263) > _1263:
                        mem[_1263 + mem[64] + 132] = 0
                    require ext_code.size(nodeRewardManagerAddress)
                    call nodeRewardManagerAddress.0x90219732 with:
                         gas gas_remaining wei
                        args msg.sender, 96, 0x35f9dea3e1f6bdfef70cdd17b25efa418ca63a22764cec100000000000000000000 * s / _1195, mem[mem[64] + 100 len ceil32(_1263) + 32]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    if (0x35f9dea3e1f6bdfef70cdd17b25efa418ca63a22764cec100000000000000000000 * s) - (0x35f9dea3e1f6bdfef70cdd17b25efa418ca63a22764cec100000000000000000000 * s / _1195) > 0:
                        require ext_code.size(nodeRewardManagerAddress)
                        call nodeRewardManagerAddress.0x2d6f594f with:
                             gas gas_remaining wei
                            args msg.sender, (0x35f9dea3e1f6bdfef70cdd17b25efa418ca63a22764cec100000000000000000000 * s) - (0x35f9dea3e1f6bdfef70cdd17b25efa418ca63a22764cec100000000000000000000 * s / _1195)
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
}
