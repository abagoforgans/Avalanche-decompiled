        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                call lpToken1Address with:
                   funct uint32(stor2)
                     gas gas_remaining wei
                    args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor2), uint32(stor2), 0) << 256, mem[816 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor15), uint32(stor15), 0
                    if not approve(address arg1, uint256 arg2), Mask(224, 0, stor15):
                ...
                if not return_data.size:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(lpToken1Address):
                            revert with 0, 'Address: call to non-contract'
                        mem[(2 * ceil32(return_data.size)) + 754 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor2), uint32(stor2), 0
                        mem[(2 * ceil32(return_data.size)) + 846 len 4] = 0
                        call lpToken1Address with:
                           funct uint32(stor2)
                             gas gas_remaining wei
                            args 0, mem[(2 * ceil32(return_data.size)) + 818 len 4]
                        if not return_data.size:
                            ...
                            staticcall address(masterchefAddress).0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address, mem[ceil32(return_data.size) + (2 * ceil32(return_data.size)) + 791 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            require ext_code.size(address(masterchefAddress))
                            call address(masterchefAddress).emergencyWithdraw(uint256 arg1) with:
                                 gas gas_remaining wei
                                args ext_call.return_data[0], mem[ceil32(return_data.size) + (2 * ceil32(return_data.size)) + 791 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
            else:
                require return_data.size >= 32
                if not mem[456]:
                    revert with 0, 
