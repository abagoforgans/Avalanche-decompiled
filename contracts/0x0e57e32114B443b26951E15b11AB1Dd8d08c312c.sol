...
const SecondTeamWallet = 0xc258818798690e4122121b13baea1e92b2b605be
...
const TeamWallet = 0xc258818798690e4122121b13baea1e92b2b605be

const WhiteListBalanceLimitDivider = 50

const symbol = 'AvaRice', 0
...
function SetupEnableTrading() {
    if owner != msg.sender:
        if msg.sender != 0xc258818798690e4122121b13baea1e92b2b605be:
...
function sub_2e2d5eb3(?) {
    if owner != msg.sender:
        if msg.sender != 0xc258818798690e4122121b13baea1e92b2b605be:
            revert with 0, 'Caller not in Team'
    marketingBalance = 0
    call 0xc258818798690e4122121b13baea1e92b2b605be with:
