...
function withdrawAndRemove(address arg1, address arg2, uint256 arg3, uint256 arg4, address arg5, uint8 arg6, uint256 arg7, uint256 arg8, bytes32 arg9) {
    ...
    if ext_call.return_data[0] < arg7:
        ...
        if not return_data.size:
            ...
            if arg4 > arg3:
                revert with 0, 'SafeMath: subtraction overflow'
            emit 0xc1a608d0: address(arg2), arg3 - arg4, 0, arg4, arg6 << 248, arg7, arg8, 0, arg1, arg9
        else:
            mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
                if return_data.size:
        ...
        if not return_data.size:
            ...
            if not ext_call.success:
                ...
                if not return_data.size:
                    ...
                    if not approve(address arg1, uint256 arg2), address(arg5) << 64:
                        revert with 0, 32, 42, 0x645361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[534 len 22]
                    emit 0xc1a608d0: address(arg2), ext_call.return_data[0], 0, arg4, arg6 << 248, arg7, arg8, 1, arg1, arg9
                else:
                    mem[456 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    if not ext_call.success:
                        if return_data.size:
        ...
        if eth.balance(this.address) <= chainGasAmount:
            ...
            if not return_data.size:
                ...
                if ext_call.return_data[0] < arg8:
                    ...
                    if not ext_code.size(arg2):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 261 len 64] = unknown_0xa9059cbb(?????), address(arg1) << 64, 0, Mask(224, 32, arg3 - arg4) >> 32
                    ...
                    if not return_data.size:
                        ...
                        if not ext_call.success:
                            ...
                            call arg2 with:
                                 gas gas_remaining wei
                                args arg3 - arg4, Mask(224, 32, arg8) >> 32, mem[(2 * ceil32(return_data.size)) + 490 len 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    if return_data.size:
                                        revert with ext_call.return_data[0 len return_data.size]
                            ...
                            if WETH_ADDRESS != address(ext_call.return_data[0]):
                                ...
                                if not ext_code.size(address(ext_call.return_data[0])):
                                    revert with 0, 'Address: call to non-contract'
                                mem[(2 * ceil32(return_data.size)) + 426 len 64] = 0, address(arg1), ext_call.return_data[0 len 28]
                                call address(ext_call.return_data[0]) with:
                                     gas gas_remaining wei
                                    args ext_call.return_data[0], Mask(224, 32, arg8) >> 32, mem[(2 * ceil32(return_data.size)) + 490 len 4]
                                if not return_data.size:
                                    if not ext_call.success:
                                        if return_data.size:
                                            revert with ext_call.return_data[0 len return_data.size]
