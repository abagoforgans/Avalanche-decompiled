...
function swapAndStake(uint256 arg1) payable {
    ...
    mem[(32 * _50) + ceil32(return_data.size) + 260] = 99 * _80 / 100
    ...
    call traderJoeRouterAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args arg1, 99 * _80 / 100, Array(len=2, data=mem[(32 * _50) + ceil32(return_data.size) + 420 len 64]), address(this.address), block.timestamp + 60
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require mem[(32 * _50) + ceil32(return_data.size) + mem[(32 * _50) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32 + 224] <= 4294967296 and mem[(32 * _50) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32 + (32 * mem[(32 * _50) + ceil32(return_data.size) + mem[(32 * _50) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32 + 224]) + 32 <= return_data.size
    ...
    require return_data.size >= 32
    require ext_code.size(sub_37f6f658Address)
    call sub_37f6f658Address.0xa9059cbb with:
         gas gas_remaining wei
