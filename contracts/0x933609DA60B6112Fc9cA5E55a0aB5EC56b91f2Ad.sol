...
function withdraw(uint256 arg1) {
    ...
    if ext_call.return_data[0] >= arg1:
            ...
            if not arg1:
                ...
                if withdrawalTreasuryFee * arg1 / arg1 != withdrawalTreasuryFee:
                    revert with 0, 
                                32,
                                33,
                                0x50536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
        ...
        if not arg1:
            ...
            if withdrawalDevFundFee * arg1 / arg1 != withdrawalDevFundFee:
                revert with 0, 32, 33, 0x50536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
            require ext_code.size(address(controllerAddress))
            staticcall address(controllerAddress).devfund() with:
                    gas gas_remaining wei
            if not ext_call.success:
