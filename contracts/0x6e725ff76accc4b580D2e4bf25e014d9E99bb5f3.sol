...
function sub_c7b3d12c(?) payable {
    ...
    call stakeTokenAddress.transferFrom(address arg1, address arg2, uint256 arg3) with:
...
function unstake() payable {
    ...
    if block.timestamp - balanceOf[address(msg.sender)].field_1024 / stor25 >= 15:
        ...
        if not sub_26d36ee5:
            revert with 'NH{q', 18
        require ext_code.size(stakeTokenAddress)
        call stakeTokenAddress.transfer(address arg1, uint256 arg2) with:
             gas gas_remaining wei
...
function stake(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] < arg1 / sub_26d36ee5:
