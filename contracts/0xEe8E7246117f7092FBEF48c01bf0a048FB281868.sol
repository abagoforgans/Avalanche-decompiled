...
#
#  - getSize(uint256 arg1)
#  - getElement(uint256 arg1)
#  - sub_9766a3b4(?)
#  - tokenURI(uint256 arg1)
#  - getGender(uint256 arg1)
#
...
uint256 stor10;
address owner;
mapping of uint256 sub_4347e7d3;
array of address sub_01c7224f;

function sub_01c7224f(?) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require arg1 < sub_01c7224f.length
    return sub_01c7224f[arg1]
}
...
function sub_4347e7d3(?) {
    return sub_4347e7d3[address(msg.sender)]
}
...
function getTier(uint256 arg1) {
    ...
    require arg1 == arg1
    if arg1 <= 500:
        return 'Legendary Tier', 0
    if arg1 <= 2500:
        return 'Diamond Tier', 0
    if arg1 <= 10000:
        return 'Platinum Tier', 0
    if arg1 > 10420:
        return ''
    return 'Founder Edition', 0
}
...
function claim(uint256 arg1) payable {
    ...
    if msg.value < 5 * 10^17:
        revert with 0, 'Mint costs 0.5 AVAX'
    if arg1 <= 0:
        revert with 0, 'Token ID invalid'
    if arg1 > 10000:
        revert with 0, 'Token ID invalid'
...
function sub_7381ad25(?) payable {
    ...
    if msg.value < 4 * 10^17:
        revert with 0, 'Mint costs 0.4 AVAX'
    if arg1 <= 0:
        revert with 0, 'Token ID invalid'
    if arg1 > 10000:
        revert with 0, 'Token ID invalid'
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if not sub_4347e7d3[address(arg2)]:
        sub_01c7224f.length++
        sub_01c7224f[sub_01c7224f.length] = address(arg2)
    if sub_4347e7d3[address(arg2)] > -2:
        revert with 'NH{q', 17
    sub_4347e7d3[address(arg2)]++
    stor10 = 1
}
