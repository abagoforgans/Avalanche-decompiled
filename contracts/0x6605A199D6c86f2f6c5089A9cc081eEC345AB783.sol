...
const sub_6af66772(?) = 0x22d4002028f537599be9f666d1c4fa138522f9
...
address sub_3669ca7eAddress;
address sub_e7b75ab2Address;
...
function sub_3669ca7e(?) {
    return sub_3669ca7eAddress
}
...
function sub_e7b75ab2(?) {
    return sub_e7b75ab2Address
}
...
function getHarvestable() {
    ...
    mem[164] = 0xd400000000000000000000000022d4002028f537599be9f666d1c4fa138522f9
    require ext_code.size(stakingAddress)
    staticcall stakingAddress.0xad05e627 with:
            gas gas_remaining wei
           args address(wantAddress), this.address, 0xd400000000000000000000000022d4002028f537599be9f666d1c4fa138522f9
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[96 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = ceil32(return_data.size) + 96
    require return_data.size >= 128
    _6 = mem[96 len 4], Mask(224, 0, stor0)
    require uint32(this.address), 0xd400000000000000000000000022d4002028f537599be9f666d1c4fa <= 4294967296
    require uint32(this.address), 0xd400000000000000000000000022d4002028f537599be9f666d1c4fa + 32 <= return_data.size
    require return_data.size >= mem[uint32(this.address), 0xd400000000000000000000000022d4002028f537599be9f666d1c4fa + 96] + uint32(this.address), 0xd400000000000000000000000022d4002028f537599be9f666d1c4fa + 32 and mem[uint32(this.address), 0xd400000000000000000000000022d4002028f537599be9f666d1c4fa + 96] <= 4294967296
    mem[ceil32(return_data.size) + 96] = mem[uint32(this.address), 0xd400000000000000000000000022d4002028f537599be9f666d1c4fa + 96]
    _11 = mem[uint32(this.address), 0xd400000000000000000000000022d4002028f537599be9f666d1c4fa + 96]
    mem[ceil32(return_data.size) + 128 len ceil32(mem[uint32(this.address), 0xd400000000000000000000000022d4002028f537599be9f666d1c4fa + 96])] = mem[uint32(this.address), 0xd400000000000000000000000022d4002028f537599be9f666d1c4fa + 128 len ceil32(mem[uint32(this.address), 0xd400000000000000000000000022d4002028f537599be9f666d1c4fa + 96])]
    if _11 % 32:
        mem[floor32(_11) + ceil32(return_data.size) + 128] = mem[floor32(_11) + ceil32(return_data.size) + -(_11 % 32) + 160 len _11 % 32]
    return _6, 327492345, mem[196 len 28]
}
...
function withdrawForSwap(uint256 arg1) {
    ...
    if address(controllerAddress) != msg.sender:
        revert with 0, '!controller'
    require ext_code.size(stakingAddress)
    call stakingAddress.0xf3fef3a3 with:
         gas gas_remaining wei
