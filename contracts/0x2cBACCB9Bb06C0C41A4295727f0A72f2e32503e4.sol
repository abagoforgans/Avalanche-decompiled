...
function sub_92e9b038(?) payable {
    ...
    require arg1 == address(arg1)
    require msg.sender == stor2
    mem[96 len 3045] = code.data[3209 len 3045]
    create contract with 0 wei
                    code: code.data[3209 len 3045]
    ...
    idx = 0
    while idx < 9:
        mem[mem[64] len 3045] = code.data[3209 len 3045]
        create contract with 0 wei
                        code: code.data[3209 len 3045]
        if not create.new_address:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        mem[mem[64] + 4] = mem[_31 + 12 len 20]
        require ext_code.size(sub_7b127752Address)
        call sub_7b127752Address.0xa9059cbb with:
             gas gas_remaining wei
        ...
        idx = idx + 1
        continue 
    require ext_code.size(0x4c2b19065fed9ab028dd67933fd64dce5435e342)
    call 0x4c2b19065fed9ab028dd67933fd64dce5435e342.0x92e9b038 with:
         gas gas_remaining wei
        args address(arg1)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
