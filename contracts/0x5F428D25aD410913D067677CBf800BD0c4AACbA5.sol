...
const name = 'Cherry Yield Finance'

const decimals = 8

const requestMinimum = 10^13
            ...
            if tokensPerEth * msg.value / 10^18:
                ...
                if stor4[address(msg.sender)]:
                    ...
                    if progress0drop > target0drop:
                        ...
                        require not distributionFinished
                        require totalDistributed + 500 * 10^6 >= totalDistributed
                        totalDistributed += 500 * 10^6
                        require balanceOf[address(msg.sender)] + 500 * 10^6 >= balanceOf[address(msg.sender)]
                        balanceOf[address(msg.sender)] += 500 * 10^6
                        emit Distr(500 * 10^6, msg.sender);
                        emit Transfer(500 * 10^6, 0, msg.sender);
                                ...
                                if tokensPerEth * msg.value / 10^18 <= 0:
                                    ...
                                    if block.timestamp < deadline:
                                        if msg.value < 10^18:
                                            ...
                                            require not distributionFinished
                                            require totalDistributed + (tokensPerEth * msg.value / 10^18) + (100 * tokensPerEth * msg.value / 10^18 / 100) >= totalDistributed
                                            totalDistributed = totalDistributed + (tokensPerEth * msg.value / 10^18) + (100 * tokensPerEth * msg.value / 10^18 / 100)
                                            require balanceOf[address(msg.sender)] + (tokensPerEth * msg.value / 10^18) + (100 * tokensPerEth * msg.value / 10^18 / 100) >= balanceOf[address(msg.sender)]
                                            balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] + (tokensPerEth * msg.value / 10^18) + (100 * tokensPerEth * msg.value / 10^18 / 100)
                                            emit Distr(((tokensPerEth * msg.value / 10^18) + (100 * tokensPerEth * msg.value / 10^18 / 100)), msg.sender);
                                            emit Transfer(((tokensPerEth * msg.value / 10^18) + (100 * tokensPerEth * msg.value / 10^18 / 100)), 0, msg.sender);
                                            if totalDistributed < totalSupply:
                                            else:
                                                distributionFinished = 1
                                    else:
