...
#
const devAddress = 0xea1ff804deb8cabe309c941bd3d1abfc6a1c6dfd
...
function flipSaleState() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    uint256(stor17) = not bool(uint8(saleIsActive)) or Mask(248, 8, uint256(stor17))
}
...
function setStartingIndex() {
    ...
    startingIndex = block.hash(startingIndexBlock) % 10
    if block.number < startingIndexBlock:
        revert with 'NH{q', 17
    if block.number - startingIndexBlock > 255:
        if block.number < 1:
            revert with 'NH{q', 17
        startingIndex = block.hash(block.number - 1) % 10
}
...
function mintToken(address arg1, uint256 arg2) payable {
    ...
    if tokenByIndex.length > -arg2 - 1:
        revert with 'NH{q', 17
    if tokenByIndex.length + arg2 > 10:
    ...
    while idx < arg2:
        ...
        if arg1:
            ...
            if ext_code.size(arg1) > 0:
                ...
                require return_data.size >= 32
                require mem[_217] == Mask(32, 224, mem[_217])
                if Mask(32, 224, mem[_217]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                    revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
        else:
            if tokenByIndex.length < 1:
                revert with 'NH{q', 17
            ...
            if ext_code.size(arg1) > 0:
                ...
                mem[64] = mem[64] + ceil32(return_data.size)
                require return_data.size >= 32
                require mem[_218] == Mask(32, 224, mem[_218])
                if Mask(32, 224, mem[_218]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                    revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
        emit 0x3569967c: tokenByIndex.length
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
