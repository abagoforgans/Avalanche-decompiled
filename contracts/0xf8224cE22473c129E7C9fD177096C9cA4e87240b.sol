...
#  - harvest()
#
const sub_0807f23a(?) = 0xc9aa91645c3a400246b9d16c8d648f5dcec6d1c8
...
function sub_b66f5f03(?) {
    return sub_b66f5f03Address
}
...
function getHarvestable() {
    require ext_code.size(0xc9aa91645c3a400246b9d16c8d648f5dcec6d1c8)
    staticcall 0xc9aa91645c3a400246b9d16c8d648f5dcec6d1c8.0x3a4b022c with:
            gas gas_remaining wei
...
function balanceOfPool() {
    require ext_code.size(0xc9aa91645c3a400246b9d16c8d648f5dcec6d1c8)
    staticcall 0xc9aa91645c3a400246b9d16c8d648f5dcec6d1c8.userInfo(uint256 arg1, address arg2) with:
            gas gas_remaining wei
           args stor13, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit() {
    ...
    if ext_call.return_data[0]:
        ...
        call wantAddress.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args 0xc9aa91645c3a400246b9d16c8d648f5dcec6d1c8, 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_code.size(wantAddress)
        call wantAddress.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args 0xc9aa91645c3a400246b9d16c8d648f5dcec6d1c8, ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_code.size(0xc9aa91645c3a400246b9d16c8d648f5dcec6d1c8)
        call 0xc9aa91645c3a400246b9d16c8d648f5dcec6d1c8.deposit(uint256 arg1, uint256 arg2) with:
             gas gas_remaining wei
...
function withdrawForSwap(uint256 arg1) {
    ...
    if address(controllerAddress) != msg.sender:
        revert with 0, '!controller'
    require ext_code.size(0xc9aa91645c3a400246b9d16c8d648f5dcec6d1c8)
    call 0xc9aa91645c3a400246b9d16c8d648f5dcec6d1c8.withdraw(uint256 arg1, uint256 arg2) with:
         gas gas_remaining wei
        args stor13, arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
