...
function sub_841449d7(?) payable {
    ...
    while idx < allowedTokenById.length:
        mem[0] = 4
        mem[ceil32(arg1.length) + 132] = vaultServiceAddress
        ...
        if not ext_call.return_data[0]:
            ...
            mem[0] = 4
            mem[ceil32(arg1.length) + 128] = 0xefc16c7500000000000000000000000000000000000000000000000000000000
            mem[ceil32(arg1.length) + 132] = allowedTokenById[idx]
            mem[ceil32(arg1.length) + 164] = 64
            mem[ceil32(arg1.length) + 196] = arg1.length
            s = 0
            while s < arg1.length:
                mem[s + ceil32(arg1.length) + 228] = mem[s + 128]
                s = s + 32
                continue 
            require ext_code.size(vaultServiceAddress)
            call vaultServiceAddress.0xefc16c75 with:
                 gas gas_remaining wei
                args allowedTokenById[idx], Array(len=arg1.length, data=mem[ceil32(arg1.length) + 228 len arg1.length])
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        idx = idx + 1
        continue 
...
function sub_773dcbc8(?) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[ceil32(('cd', 132).length) + 128] = cd[4]
    mem[ceil32(('cd', 132).length) + 320] = ('cd', 68).length
    mem[ceil32(('cd', 132).length) + 352 len 32 * ('cd', 68).length] = call.data[cd[68] + 36 len 32 * ('cd', 68).length]
    mem[(32 * ('cd', 68).length) + ceil32(('cd', 132).length) + 352] = 0
    mem[ceil32(('cd', 132).length) + floor32(('cd', 68).length) + 384 len ceil32(('cd', 132).length)] = call.data[cd[132] + 36 len ('cd', 132).length], mem[('cd', 132).length + 128 len ceil32(('cd', 132).length) - ('cd', 132).length]
    if not ('cd', 132).length % 32:
        emit 0x9f2adb11: 0, Mask(224, 0, cd[4]), cd[36], 192, cd[100], floor32(('cd', 68).length) + 224, 0, mem[ceil32(('cd', 132).length) + 320 len floor32(('cd', 68).length) + 4], Mask(224, 32, ('cd', 132).length) >> 32, ('cd', 132).length, Mask(8 * ('cd', 132).length, -(8 * ('cd', 132).length) + 256, call.data[cd[132] + 36 len ('cd', 132).length], mem[('cd', 132).length + 128 len ceil32(('cd', 132).length) - ('cd', 132).length]) << (8 * ('cd', 132).length) - 256, msg.sender
    else:
        mem[floor32(('cd', 132).length) + ceil32(('cd', 132).length) + floor32(('cd', 68).length) + 384] = mem[floor32(('cd', 132).length) + ceil32(('cd', 132).length) + floor32(('cd', 68).length) + -(('cd', 132).length % 32) + 416 len ('cd', 132).length % 32]
        emit 0x9f2adb11: 0, Mask(224, 0, cd[4]), cd[36], 192, cd[100], floor32(('cd', 68).length) + 224, 0, mem[ceil32(('cd', 132).length) + 320 len floor32(('cd', 68).length) + 4], Mask(224, 32, ('cd', 132).length) >> 32, ('cd', 132).length, Mask(8 * ceil32(('cd', 132).length), -(8 * ceil32(('cd', 132).length)) + 256, call.data[cd[132] + 36 len ('cd', 132).length], mem[('cd', 132).length + 128 len ceil32(('cd', 132).length) - ('cd', 132).length]) << (8 * ceil32(('cd', 132).length)) - 256, mem[(2 * ceil32(('cd', 132).length)) + floor32(('cd', 68).length) + 384 len floor32(('cd', 132).length) + -ceil32(('cd', 132).length) + 32], msg.sender
}
...
function sub_f26ecf24(?) payable {
    ...
    mem[ceil32(('cd', 132).length) + floor32(('cd', 68).length) + 384 len ceil32(('cd', 132).length)] = call.data[cd[132] + 36 len ('cd', 132).length], mem[('cd', 132).length + 128 len ceil32(('cd', 132).length) - ('cd', 132).length]
    if not ('cd', 132).length % 32:
        emit 0xb976e816: 0, Mask(224, 0, cd[4]), cd[36], 192, cd[100], floor32(('cd', 68).length) + 224, 0, mem[ceil32(('cd', 132).length) + 320 len floor32(('cd', 68).length) + 4], Mask(224, 32, ('cd', 132).length) >> 32, ('cd', 132).length, Mask(8 * ('cd', 132).length, -(8 * ('cd', 132).length) + 256, call.data[cd[132] + 36 len ('cd', 132).length], mem[('cd', 132).length + 128 len ceil32(('cd', 132).length) - ('cd', 132).length]) << (8 * ('cd', 132).length) - 256, msg.sender
    else:
        mem[floor32(('cd', 132).length) + ceil32(('cd', 132).length) + floor32(('cd', 68).length) + 384] = mem[floor32(('cd', 132).length) + ceil32(('cd', 132).length) + floor32(('cd', 68).length) + -(('cd', 132).length % 32) + 416 len ('cd', 132).length % 32]
        emit 0xb976e816: 0, Mask(224, 0, cd[4]), cd[36], 192, cd[100], floor32(('cd', 68).length) + 224, 0, mem[ceil32(('cd', 132).length) + 320 len floor32(('cd', 68).length) + 4], Mask(224, 32, ('cd', 132).length) >> 32, ('cd', 132).length, Mask(8 * ceil32(('cd', 132).length), -(8 * ceil32(('cd', 132).length)) + 256, call.data[cd[132] + 36 len ('cd', 132).length], mem[('cd', 132).length + 128 len ceil32(('cd', 132).length) - ('cd', 132).length]) << (8 * ceil32(('cd', 132).length)) - 256, mem[(2 * ceil32(('cd', 132).length)) + floor32(('cd', 68).length) + 384 len floor32(('cd', 132).length) + -ceil32(('cd', 132).length) + 32], msg.sender
}
