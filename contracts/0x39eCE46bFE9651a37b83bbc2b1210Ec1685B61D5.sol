...
function _getNodeNumberOf(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require ext_code.size(0xb664175c6d583af50f75a62fe9102dbabf1c46cf)
    delegate 0xb664175c6d583af50f75a62fe9102dbabf1c46cf.0x732a2ccf with:
...
function _migrateNodes(address arg1, string[] arg2, uint256[] arg3, uint256[] arg4, uint256[] arg5) payable {
    ...
    if msg.sender == tokenAddress:
        ...
        while idx < _456:
            ...
            continue 
    require ext_code.size(0xb664175c6d583af50f75a62fe9102dbabf1c46cf)
    delegate 0xb664175c6d583af50f75a62fe9102dbabf1c46cf.0xbc2b405c with:
         gas gas_remaining wei
