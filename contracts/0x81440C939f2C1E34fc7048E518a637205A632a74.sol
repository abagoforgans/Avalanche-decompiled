...
function authorize(uint256 arg1) payable {
    ...
    stor6 = 2
    authorizedAmount[address(msg.sender)] = arg1
    stor6 = 1
}
...
function setTimelock(address arg1) payable {
    ...
    emit TimelockUpdated(timelockAddress);
}
...
function setDistributor(address arg1) payable {
    ...
    emit 0xc0ebb188: distributorAddress
}
    ...
    if distributionPhase != 1:
        if distributionPhase != 2:
            ...
            if arg1 > balanceOf[address(msg.sender)]:
                revert with 0, 32, 36, 0x7345524332303a206275726e20616d6f756e74496e20657863656564732062616c616e63, mem[164 len 28], mem[220 len 4]
            ...
            if not arg1:
                ...
                if balanceOf[stor7] < balanceOf[stor7]:
                    revert with 0, 'SafeMath: addition overflow'
                emit Transfer(0, 0, distributorAddress);
                emit 0xff31fc55: arg1, 0, msg.sender
            else:
                require arg1
                if arg1 * scalingFactor / arg1 != scalingFactor:
                    revert with 0, 32, 33, 0x6b536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[293 len 31]
                if not distributorAddress:
                    revert with 0, 'ERC20: mint to the zero address'
                if totalSupply + (arg1 * scalingFactor / 100) < totalSupply:
                    revert with 0, 'SafeMath: addition overflow'
                totalSupply += arg1 * scalingFactor / 100
                if balanceOf[stor7] + (arg1 * scalingFactor / 100) < balanceOf[stor7]:
                    revert with 0, 'SafeMath: addition overflow'
                balanceOf[stor7] += arg1 * scalingFactor / 100
                emit Transfer((arg1 * scalingFactor / 100), 0, distributorAddress);
                emit 0xff31fc55: arg1, arg1 * scalingFactor / 100, msg.sender
    else:
        ...
        if not arg1:
            ...
            if 0 <= balanceOf[address(this.address)]:
                ...
                if balanceOf[stor7] < balanceOf[stor7]:
                    revert with 0, 'SafeMath: addition overflow'
                emit Transfer(0, this.address, distributorAddress);
            else:
                ...
                if balanceOf[stor7] + balanceOf[address(this.address)] < balanceOf[stor7]:
                    revert with 0, 'SafeMath: addition overflow'
                balanceOf[stor7] += balanceOf[address(this.address)]
                emit Transfer(balanceOf[address(this.address)], this.address, distributorAddress);
                distributionPhase = 2
            emit 0xff31fc55: arg1, 0, msg.sender
        else:
            require arg1
            ...
            if (300 * arg1) + (balanceOf[address(this.address)] / 10^18 / 900 * arg1) / 100 <= balanceOf[address(this.address)]:
                ...
                if balanceOf[stor7] + ((300 * arg1) + (balanceOf[address(this.address)] / 10^18 / 900 * arg1) / 100) < balanceOf[stor7]:
                    revert with 0, 'SafeMath: addition overflow'
                balanceOf[stor7] += (300 * arg1) + (balanceOf[address(this.address)] / 10^18 / 900 * arg1) / 100
                emit Transfer(((300 * arg1) + (balanceOf[address(this.address)] / 10^18 / 900 * arg1) / 100), this.address, distributorAddress);
            else:
                if balanceOf[address(this.address)] > balanceOf[address(this.address)]:
                    revert with 0, 
                                32,
