...
function execute(address arg1, uint256 arg2, bytes arg3) payable {
    ...
    mem[100] = var31001
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).mem[var33003 len 4] with:
            gas gas_remaining wei
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if mem[var37002 + 12 len 20] != address(ext_call.return_data[0]):
        mem[100] = var37004 + 1
        require ext_code.size(address(ext_call.return_data[0]))
    ...
    call address(ext_call.return_data[0]).remove_liquidity_one_coin(uint256 arg1, int128 arg2, uint256 arg3) with:
         gas gas_remaining wei
        args ext_call.return_data[0], ('signextend', 15, ('signextend', 15, ('var', 37004))), 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(ext_call.return_data[0]))
