...
const VESTING_DURATION = (24 * 3600)

const DEV_FUND_POOL_ALLOCATION = 10^18

const FARMING_POOL_REWARD_ALLOCATION = (125 * 10^17 * 3600)
...
function distributeReward(address arg1) payable {
    ...
    stor12 = 1
    if totalSupply + (125 * 10^17 * 3600) < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 125 * 10^17 * 3600
    if balanceOf[address(arg1)] + (125 * 10^17 * 3600) < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 125 * 10^17 * 3600
    emit Transfer((125 * 10^17 * 3600), 0, arg1);
}
            ...
            if block.timestamp - devFundLastClaimed:
                ...
                if (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) > 0:
                    if devFundAddress:
                        ...
                        if balanceOf[stor10] + (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) < balanceOf[stor10]:
                            revert with 0, 'SafeMath: addition overflow'
                        balanceOf[stor10] = balanceOf[stor10] + (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate)
            ...
            if endTime - devFundLastClaimed:
                ...
                if (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) > 0:
                    if devFundAddress:
                        ...
                        if balanceOf[stor10] + (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) < balanceOf[stor10]:
                            revert with 0, 'SafeMath: addition overflow'
                        balanceOf[stor10] = balanceOf[stor10] + (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate)
