...
function _fallback() payable {
    ...
    if sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) < 10^9 * sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) / 10^9:
        revert with 'NH{q', 17
    if sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) - (10^9 * sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) / 10^9) < 10^6:
        if msg.value and 1000 > -1 / msg.value:
            revert with 'NH{q', 17
        if eth.balance(this.address) >= 1000 * msg.value:
            if msg.value and 100000 > -1 / msg.value:
                revert with 'NH{q', 17
            call msg.sender with:
               value 100000 * msg.value / 100 wei
        ...
        if sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) < 10^9 * sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) / 10^9:
            revert with 'NH{q', 17
        if sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) - (10^9 * sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) / 10^9) < 10 * 10^6:
            if msg.value and 100 > -1 / msg.value:
                revert with 'NH{q', 17
            if eth.balance(this.address) >= 100 * msg.value:
                if msg.value and 10000 > -1 / msg.value:
                    revert with 'NH{q', 17
                call msg.sender with:
                   value 10000 * msg.value / 100 wei
                     gas 2300 * is_zero(value) wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
        else:
            ...
            if sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) - (10^9 * sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) / 10^9) < 100 * 10^6:
                if msg.value and 10 > -1 / msg.value:
                    revert with 'NH{q', 17
                if eth.balance(this.address) >= 10 * msg.value:
                    if msg.value and 1000 > -1 / msg.value:
                        revert with 'NH{q', 17
                    call msg.sender with:
                       value 1000 * msg.value / 100 wei
                         gas 2300 * is_zero(value) wei
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
            else:
