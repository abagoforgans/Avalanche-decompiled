...
function farm() payable {
    ...
    call farmContractAddress.deposit(uint256 arg1, uint256 arg2, bool arg3) with:
         gas gas_remaining wei
        args pid, ext_call.return_data[0], 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    stor1 = 1
}
            ...
            if wantLockedTotal <= 0:
                ...
                if not uint8(stor2.field_24):
                    ...
                    if not return_data.size:
                        ...
                        call farmContractAddress.deposit(uint256 arg1, uint256 arg2, bool arg3) with:
                             gas gas_remaining wei
                            args pid, ext_call.return_data[0], 0, mem[(2 * ceil32(return_data.size)) + 558 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if arg2 <= 1000:
                            revert with 0, 
            ...
            if not arg2:
                ...
                if not uint8(stor2.field_24):
                    ...
                    if not return_data.size:
                        ...
                        call farmContractAddress.deposit(uint256 arg1, uint256 arg2, bool arg3) with:
                             gas gas_remaining wei
                            args pid, ext_call.return_data[0], 0, mem[(2 * ceil32(return_data.size)) + 686 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if 0 / wantLockedTotal / 10000 <= 1000:
                            revert with 0, 
            ...
            if 0 / wantLockedTotal <= sharesTotal:
                ...
                if withdrawFeeFactor >= 10000:
                    if uint8(stor2.field_24):
                        require ext_code.size(farmContractAddress)
                        call farmContractAddress.withdraw(uint256 arg1, uint256 arg2, bool arg3) with:
                             gas gas_remaining wei
                            args pid, 0 / sharesTotal, 1
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                    require ext_code.size(wantAddress)
                    staticcall wantAddress.0x70a08231 with:
                    ...
                    if not 0 / sharesTotal:
                        ...
                        if not uint8(stor2.field_24):
                            ...
                            call farmContractAddress.withdraw(uint256 arg1, uint256 arg2, bool arg3) with:
                                 gas gas_remaining wei
                                args pid, 0 / sharesTotal * withdrawFeeFactor / 10000, 1
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(wantAddress)
                            staticcall wantAddress.0x70a08231 with:
            ...
            if 0 / wantLockedTotal <= sharesTotal:
                ...
                if withdrawFeeFactor >= 10000:
                    if not uint8(stor2.field_24):
                        ...
                        call farmContractAddress.withdraw(uint256 arg1, uint256 arg2, bool arg3) with:
                             gas gas_remaining wei
                            args pid, 0 / wantLockedTotal * wantLockedTotal / sharesTotal, 1
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require ext_code.size(wantAddress)
                        staticcall wantAddress.0x70a08231 with:
                    ...
                    if not 0 / wantLockedTotal * wantLockedTotal / sharesTotal:
                        ...
                        if uint8(stor2.field_24):
                            ...
                            call farmContractAddress.withdraw(uint256 arg1, uint256 arg2, bool arg3) with:
                                 gas gas_remaining wei
                                args pid, 0 / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 10000, 1
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                        require ext_code.size(wantAddress)
                        staticcall wantAddress.0x70a08231 with:
            ...
            if arg2 * sharesTotal / wantLockedTotal <= sharesTotal:
                ...
                if withdrawFeeFactor >= 10000:
                    if uint8(stor2.field_24):
                        ...
                        call farmContractAddress.withdraw(uint256 arg1, uint256 arg2, bool arg3) with:
                             gas gas_remaining wei
                            args pid, arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal, 1
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                    require ext_code.size(wantAddress)
                    staticcall wantAddress.0x70a08231 with:
                    ...
                    if not arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal:
                        ...
                        if not uint8(stor2.field_24):
                            ...
                            call farmContractAddress.withdraw(uint256 arg1, uint256 arg2, bool arg3) with:
                                 gas gas_remaining wei
                                args pid, arg2 * sharesTotal / wantLockedTotal * wantLockedTotal / sharesTotal * withdrawFeeFactor / 10000, 1
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(wantAddress)
                            staticcall wantAddress.0x70a08231 with:
