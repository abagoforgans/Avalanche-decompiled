        ...
        if address(arg1) == stor2:
            ...
            while idx < arg3:
                ...
                if mem[_160 + mem[_160]] > test266151307():
                    revert with 'NH{q', 65
                if _160 + ceil32(return_data.size) + floor32(mem[_160 + mem[_160]]) + 1 > test266151307() or floor32(mem[_160 + mem[_160]]) + 1 < 0:
                    revert with 'NH{q', 65
                mem[64] = _160 + ceil32(return_data.size) + floor32(mem[_160 + mem[_160]]) + 1
            ...
            while idx < arg3:
                ...
                staticcall stor1.mem[mem[64] len 4] with:
                        gas gas_remaining wei
                       args mem[mem[64] + 4 len _83 + (32 * _87) + -mem[64] + 96]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _159 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                if mem[_159 + mem[_159]] > test266151307():
                    revert with 'NH{q', 65
                if _159 + ceil32(return_data.size) + floor32(mem[_159 + mem[_159]]) + 1 > test266151307() or floor32(mem[_159 + mem[_159]]) + 1 < 0:
                    revert with 'NH{q', 65
                mem[64] = _159 + ceil32(return_data.size) + floor32(mem[_159 + mem[_159]]) + 1
        ...
        if address(arg1) == stor2:
            ...
            while idx < arg3:
                ...
                if mem[_162 + mem[_162]] > test266151307():
                    revert with 'NH{q', 65
                if _162 + ceil32(return_data.size) + floor32(mem[_162 + mem[_162]]) + 1 > test266151307() or floor32(mem[_162 + mem[_162]]) + 1 < 0:
                    revert with 'NH{q', 65
                mem[64] = _162 + ceil32(return_data.size) + floor32(mem[_162 + mem[_162]]) + 1
