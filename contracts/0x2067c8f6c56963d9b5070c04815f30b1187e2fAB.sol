    ...
    if not totalSupply:
        ...
        if ext_call.return_data[0] >= 10^18:
            ...
            if ext_call.return_data[0] > 10^18:
                revert with 0, 'SafeMath: subtraction overflow'
            require ext_code.size(address(sub_5d44569dAddress))
            call address(sub_5d44569dAddress).withdraw(uint256 rg1) with:
                 gas gas_remaining wei
...
function depositLP(uint256 arg1) {
    ...
    if not return_data.size:
        ...
        if not ext_code.size(lPtokenAddress):
            revert with 0, 'Address: call to non-contract'
        mem[456 len 64] = 0, address(sub_5d44569dAddress), Mask(224, 32, arg1) >> 32
        call lPtokenAddress with:
           funct uint32(stor11)
             gas gas_remaining wei
        ...
        if not return_data.size:
            if not totalSupply:
                ...
                if not ext_code.size(lPtokenAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 457 len 64] = 0, address(sub_5d44569dAddress), Mask(224, 32, arg1) >> 32
                call lPtokenAddress with:
                   funct uint32(stor11)
                     gas gas_remaining wei
...
function sub_a0d065c3(?) payable {
    ...
    call 0x00b31f66aa3c1e785363f0875a1b74e27b85fd66.deposit() with:
       value msg.value wei
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if 0xef000000000000000000000000b31f66aa3c1e785363f0875a1b74e27b85fd66 == address(sub_f0fe082aAddress):
        ...
        if not sub_906682ec.length:
            ...
            call routerAddress.addLiquidity(address rg1, address rg2, uint256 rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint256 rg8) with:
                 gas gas_remaining wei
                args address(sub_f0fe082aAddress), sub_96a8797eAddress, ext_call.return_data[0], ext_call.return_data[0], 0, 0, address(this.address), block.timestamp + 120
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            mem[(32 * _46) + ceil32(return_data.size) + 356 len 28] = Mask(224, 32, block.timestamp + 120) >> 32
            mem[(32 * _46) + ceil32(return_data.size) + 356 len 0] = 0
            call lPtokenAddress with:
               funct uint32(stor11)
                 gas gas_remaining wei
            ...
            if not totalSupply:
                ...
                mem[(32 * _2009) + ceil32(return_data.size) + 292 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), ext_call.return_data[64 len 28]
                mem[(32 * _2009) + ceil32(return_data.size) + 384 len 4] = 0
                mem[(32 * _2009) + ceil32(return_data.size) + 356 len 28] = Mask(224, 32, block.timestamp + 120) >> 32
                mem[(32 * _2009) + ceil32(return_data.size) + 356 len 0] = 0
                call lPtokenAddress with:
                   funct uint32(stor11)
                     gas gas_remaining wei
                    args Mask(480, -256, ext_call.return_data[64 len 28]) << 256, Mask(32, 224, block.timestamp + 120) >> 224
        ...
        if 0xef000000000000000000000000b31f66aa3c1e785363f0875a1b74e27b85fd66 == sub_96a8797eAddress:
            if not sub_ec499c72.length:
                ...
                if not totalSupply:
                    ...
                    mem[(32 * _48) + ceil32(return_data.size) + 356 len 28] = Mask(224, 32, block.timestamp + 120) >> 32
                    mem[(32 * _48) + ceil32(return_data.size) + 356 len 0] = 0
                    call lPtokenAddress with:
                       funct uint32(stor11)
                         gas gas_remaining wei
                        args Mask(480, -256, ext_call.return_data[64 len 28]) << 256, Mask(32, 224, block.timestamp + 120) >> 224
                ...
                if not totalSupply:
                    ...
                    mem[(32 * _1984) + ceil32(return_data.size) + 292 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), ext_call.return_data[64 len 28]
                    mem[(32 * _1984) + ceil32(return_data.size) + 384 len 4] = 0
                    mem[(32 * _1984) + ceil32(return_data.size) + 356 len 28] = Mask(224, 32, block.timestamp + 120) >> 32
                    mem[(32 * _1984) + ceil32(return_data.size) + 356 len 0] = 0
                    call lPtokenAddress with:
                       funct uint32(stor11)
                         gas gas_remaining wei
                        args Mask(480, -256, ext_call.return_data[64 len 28]) << 256, Mask(32, 224, block.timestamp + 120) >> 224
            ...
            if not sub_ec499c72.length:
                ...
                if not sub_906682ec.length:
                    ...
                    if not totalSupply:
                        ...
                        mem[(32 * _1004) + (32 * _47) + (2 * ceil32(return_data.size)) + 388 len 28] = Mask(224, 32, block.timestamp + 120) >> 32
                        mem[(32 * _1004) + (32 * _47) + (2 * ceil32(return_data.size)) + 388 len 0] = 0
                        call lPtokenAddress with:
                           funct uint32(stor11)
                             gas gas_remaining wei
                            args Mask(480, -256, ext_call.return_data[64 len 28]) << 256, Mask(32, 224, block.timestamp + 120) >> 224
                    ...
                    if not totalSupply:
                        ...
                        mem[(32 * _3600) + (32 * _47) + (2 * ceil32(return_data.size)) + 324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor11), uint32(stor11), ext_call.return_data[64 len 28]
                        mem[(32 * _3600) + (32 * _47) + (2 * ceil32(return_data.size)) + 416 len 4] = 0
                        mem[(32 * _3600) + (32 * _47) + (2 * ceil32(return_data.size)) + 388 len 28] = Mask(224, 32, block.timestamp + 120) >> 32
                        mem[(32 * _3600) + (32 * _47) + (2 * ceil32(return_data.size)) + 388 len 0] = 0
                        call lPtokenAddress with:
                           funct uint32(stor11)
                             gas gas_remaining wei
                            args Mask(480, -256, ext_call.return_data[64 len 28]) << 256, Mask(32, 224, block.timestamp + 120) >> 224
                ...
                if not sub_906682ec.length:
                    ...
                    if not totalSupply:
                        ...
                        mem[(32 * _3683) + (32 * _1959) + (2 * ceil32(return_data.size)) + 388 len 28] = Mask(224, 32, block.timestamp + 120) >> 32
                        mem[(32 * _3683) + (32 * _1959) + (2 * ceil32(return_data.size)) + 388 len 0] = 0
                        call lPtokenAddress with:
                           funct uint32(stor11)
                             gas gas_remaining wei
                            args Mask(480, -256, ext_call.return_data[64 len 28]) << 256, Mask(32, 224, block.timestamp + 120) >> 224
                    ...
                    if not totalSupply:
                        ...
                        mem[(32 * _6051) + (32 * _1959) + (2 * ceil32(return_data.size)) + 388 len 28] = Mask(224, 32, block.timestamp + 120) >> 32
                        mem[(32 * _6051) + (32 * _1959) + (2 * ceil32(return_data.size)) + 388 len 0] = 0
                        call lPtokenAddress with:
                           funct uint32(stor11)
                             gas gas_remaining wei
                            args Mask(480, -256, ext_call.return_data[64 len 28]) << 256, Mask(32, 224, block.timestamp + 120) >> 224
        ...
        if ext_call.return_data[0] >= 10^18:
            ...
            if 0xef000000000000000000000000b31f66aa3c1e785363f0875a1b74e27b85fd66 == address(sub_f0fe082aAddress):
                ...
                if not sub_6ec44b8f.length:
                    ...
                    require return_data.size >= 32
                    require ext_code.size(0xef000000000000000000000000b31f66aa3c1e785363f0875a1b74e27b85fd66)
                    call ????????????????????????????????????????.withdraw(uint256 rg1) with:
                         gas gas_remaining wei
