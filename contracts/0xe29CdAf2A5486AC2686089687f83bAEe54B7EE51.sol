        ...
        if return_data.size <= 3:
            if not return_data.size:
                ...
                if ceil32(return_data.size) <= return_data.size:
                    ...
                    emit 0xd5a827cf: mem[mem[64] len ceil32(return_data.size) + _109 + -mem[64] + 64]
        else:
                ...
                if uint32(mem[4 len 28]) >> 224 != Panic(uint256 arg1):
                    if not return_data.size:
                        ...
                        if ceil32(return_data.size) <= return_data.size:
                            ...
                            mem[return_data.size + mem[64] + 64] = 0
                            emit 0xd5a827cf: mem[mem[64] len ceil32(return_data.size) + _114 + -mem[64] + 64]
                else:
                    if return_data.size > 35:
                        emit 0x8c3808c0: ext_call.return_data[4]
                    else:
                        if not return_data.size:
                            ...
                            if ceil32(return_data.size) <= return_data.size:
                                ...
                                mem[return_data.size + mem[64] + 64] = 0
                                emit 0xd5a827cf: mem[mem[64] len ceil32(return_data.size) + _133 + -mem[64] + 64]
            else:
                if return_data.size < 68:
                    if not return_data.size:
                        mem[mem[64]] = 32
                        ...
                        if ceil32(return_data.size) <= return_data.size:
                            ...
                            mem[return_data.size + mem[64] + 64] = 0
                            emit 0xd5a827cf: mem[mem[64] len ceil32(return_data.size) + _129 + -mem[64] + 64]
                else:
                    _111 = mem[64]
                    ...
                    if mem[mem[64]] > test266151307() or mem[mem[64]] + 36 > return_data.size:
                        if not return_data.size:
                            ...
                            if ceil32(return_data.size) <= return_data.size:
                                ...
                                mem[return_data.size + mem[64] + 64] = 0
                                emit 0xd5a827cf: mem[mem[64] len ceil32(return_data.size) + _136 + -mem[64] + 64]
                    else:
                        if mem[mem[64] + mem[mem[64]]] > test266151307():
                            if not return_data.size:
                                ...
                                if ceil32(return_data.size) <= return_data.size:
                                    ...
                                    mem[return_data.size + mem[64] + 64] = 0
                                    emit 0xd5a827cf: mem[mem[64] len ceil32(return_data.size) + _139 + -mem[64] + 64]
                        else:
                            if mem[mem[64]] + mem[mem[64] + mem[mem[64]]] + 32 > return_data.size - 4:
                                if not return_data.size:
                                    ...
                                    if ceil32(return_data.size) <= return_data.size:
                                        ...
                                        mem[return_data.size + mem[64] + 64] = 0
                                        emit 0xd5a827cf: mem[mem[64] len ceil32(return_data.size) + _146 + -mem[64] + 64]
                            else:
                                ...
                                if _111 + _112:
                                    ...
                                    if not return_data.size:
                                        ...
                                        if ceil32(return_data.size) <= return_data.size:
                                            ...
                                            mem[return_data.size + mem[64] + 64] = 0
                                            emit 0xd5a827cf: mem[mem[64] len ceil32(return_data.size) + _168 + -mem[64] + 64]
}
