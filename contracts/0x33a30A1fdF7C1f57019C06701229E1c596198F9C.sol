...
function setBackendAddress(address arg1) {
    ...
    require arg1 == arg1
    if stor7 != msg.sender:
        revert with 0, 'msg.sender is not admin user'
    if not arg1:
...
function sub_58870770(?) {
    ...
    if arg2 > -121:
        revert with 'NH{q', 17
    if arg2 + 120 <= block.timestamp:
        revert with 0, 'timestamp <= block.timestamp'
    if arg2 >= block.timestamp:
        revert with 0, 'timestamp > block.timestamp'
    mem[ceil32(ceil32(arg4.length)) + 129] = arg1
    mem[ceil32(ceil32(arg4.length)) + 161] = arg2
    mem[ceil32(ceil32(arg4.length)) + 97] = 116
    if arg4.length != 65:
        return (0 == stor8)
    signer = erecover(sha3(arg1, arg2, arg3, msg.sender), 27, mem[128], mem[160]) 
    if not erecover.result:
        revert with ext_call.return_data[0 len return_data.size]
    return (address(signer) == stor8)
}

function setBaseUrl(string arg1) {
    require calldata.size - 4 >= 32
    ...
    if stor8 != msg.sender:
        revert with 0, 'msg.sender is not backend user'
...
function sub_1746b220(?) {
    ...
    if stor8 != msg.sender:
        revert with 0, 'msg.sender is not backend user'
    if ownerOf[arg1]:
        revert with 0, 'tokenId is existent'
    if not address(arg2):
    ...
    ownerOf[arg1] = address(arg2)
    emit Transfer(0, address(arg2), arg1);
...
function sub_4a9eee69(?) payable {
    ...
    if arg4.length != 65:
        if stor8 != 0:
            revert with 0, 'user invalid'
    else:
        signer = erecover(sha3(arg1, arg2, arg3, msg.sender), 27, mem[128], mem[160]) 
        if not erecover.result:
            revert with ext_call.return_data[0 len return_data.size]
        if address(signer) != stor8:
            revert with 0, 'user invalid'
    if arg3 > msg.value:
        revert with 0, 'value < amount'
    call stor8 with:
       value msg.value wei
