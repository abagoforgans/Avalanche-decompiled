    ...
    if block.number > poolInfo[arg1].field_512:
        ...
        if ext_call.return_data[0]:
            if poolInfo[arg1].field_256:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint and 2 > -1 / (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                    revert with 'NH{q', 17
                require ext_code.size(tokenAddress)
                call tokenAddress.0xa9059cbb with:
                     gas gas_remaining wei
                    args 57005, 2 * (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 100
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                if (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint < 2 * (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 100:
                    revert with 'NH{q', 17
                if ((block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint) - (2 * (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 100) and 10^12 > -1 / ((block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint) - (2 * (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 100):
                    revert with 'NH{q', 17
                if not ext_call.return_data[0]:
                    revert with 'NH{q', 18
                if poolInfo[arg1].field_768 > -((10^12 * (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint) - (10^12 * 2 * (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 100) / ext_call.return_data[0]) - 1:
                    revert with 'NH{q', 17
                poolInfo[arg1].field_768 += (10^12 * (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint) - (10^12 * 2 * (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 100) / ext_call.return_data[0]
        ...
        if block.number > poolInfo[idx].field_512:
            ...
            if mem[_17]:
                if poolInfo[idx].field_256:
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    if (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint and 2 > -1 / (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
                        revert with 'NH{q', 17
                    mem[mem[64] + 4] = 57005
                    mem[mem[64] + 36] = 2 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 100
                    require ext_code.size(tokenAddress)
                    call tokenAddress.0xa9059cbb with:
                         gas gas_remaining wei
                        args 57005, 2 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 100
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _25 = mem[64]
                    ...
                    if (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint < 2 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 100:
                        revert with 'NH{q', 17
                    if ((block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint) - (2 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 100) and 10^12 > -1 / ((block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint) - (2 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 100):
                        revert with 'NH{q', 17
                    if not _18:
                        revert with 'NH{q', 18
                    if poolInfo[idx].field_768 > -((10^12 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint) - (10^12 * 2 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 100) / _18) - 1:
                        revert with 'NH{q', 17
                    poolInfo[idx].field_768 += (10^12 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint) - (10^12 * 2 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 100) / _18
        ...
        if block.number > poolInfo[idx].field_512:
            ...
            if mem[_23]:
                if poolInfo[idx].field_256:
                    ...
                    if not _24:
                        revert with 'NH{q', 18
                    if poolInfo[idx].field_768 > -((10^12 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint) - (10^12 * 2 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 100) / _24) - 1:
                        revert with 'NH{q', 17
                    poolInfo[idx].field_768 += (10^12 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint) - (10^12 * 2 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 100) / _24
            poolInfo[idx].field_512 = block.number
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
            ...
            if block.number > poolInfo[idx].field_512:
                ...
                if mem[_28]:
                    if poolInfo[idx].field_256:
                        ...
                        if not _29:
                            revert with 'NH{q', 18
                        if poolInfo[idx].field_768 > -((10^12 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint) - (10^12 * 2 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 100) / _29) - 1:
                            revert with 'NH{q', 17
                        poolInfo[idx].field_768 += (10^12 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint) - (10^12 * 2 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 100) / _29
                poolInfo[idx].field_512 = block.number
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
            ...
            if block.number > poolInfo[idx].field_512:
                ...
                if mem[_72]:
                    if poolInfo[idx].field_256:
                        ...
                        if not _73:
                            revert with 'NH{q', 18
                        if poolInfo[idx].field_768 > -((10^12 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint) - (10^12 * 2 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 100) / _73) - 1:
                            revert with 'NH{q', 17
                        poolInfo[idx].field_768 += (10^12 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint) - (10^12 * 2 * (block.number * tokenPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokenPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 100) / _73
                poolInfo[idx].field_512 = block.number
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
    ...
    if block.number <= poolInfo[arg1].field_512:
        ...
        if not ext_call.return_data[0]:
            ...
            if not poolInfo[arg1].field_256:
                ...
                if (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint and 2 > -1 / (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                    revert with 'NH{q', 17
                mem[ceil32(return_data.size) + 100] = 57005
                mem[ceil32(return_data.size) + 132] = 2 * (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 100
                require ext_code.size(tokenAddress)
                call tokenAddress.0xa9059cbb with:
                     gas gas_remaining wei
                    args 57005, 2 * (block.number * tokenPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokenPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 100
                ...
                if userInfo[arg1][address(msg.sender)].field_0 <= 0:
                    ...
                    if (userInfo[arg1][address(msg.sender)].field_0 * poolInfo[arg1].field_768 / 10^12) - userInfo[arg1][address(msg.sender)].field_256 <= 0:
                        ...
                        if (userInfo[arg1][address(msg.sender)].field_0 * poolInfo[arg1].field_768 / 10^12) - userInfo[arg1][address(msg.sender)].field_256 <= ext_call.return_data[0]:
                            mem[(4 * ceil32(return_data.size)) + 132] = (userInfo[arg1][address(msg.sender)].field_0 * poolInfo[arg1].field_768 / 10^12) - userInfo[arg1][address(msg.sender)].field_256
                            require ext_code.size(tokenAddress)
                            call tokenAddress.0xa9059cbb with:
                                 gas gas_remaining wei
                                args msg.sender, (userInfo[arg1][address(msg.sender)].field_0 * poolInfo[arg1].field_768 / 10^12) - userInfo[arg1][address(msg.sender)].field_256
                        ...
                        if arg2 > 0:
                            ...
                            mem[(7 * ceil32(return_data.size)) + 260] = 'SafeBEP20: low-level call failed'
                            if eth.balance(this.address) < 0:
                                revert with 0, 'Address: insufficient balance for call'
                            if ext_code.size(poolInfo[arg1].field_0) <= 0:
                                revert with 0, 'Address: call to non-contract'
