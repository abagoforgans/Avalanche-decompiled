...
const sub_57ad72d1(?) = 15

const sub_aea3df28(?) = 3

const sub_fe0cf254(?) = 3

const PERMIT_TYPEHASH = 0x6e71edae12b1b97f4d1f60370fef10105fa2faae0126114a169c64845d6126c9


uint128 sub_bcff895a; offset 160
address liquidityPoolAddress;
mapping of uint256 balanceOf;
address vaultAddress;
uint128 sub_46022c8a;
mapping of uint256 bought;
array of uint8 sub_e07ca3e2;
...
function sub_1509b0bd(?) payable {
    require calldata.size - 4 >= 64
    require arg2 < 3
    return bool(stor('array', ('div', 0.03125, ('param', 'arg2')), ('map', ('param', 'arg1'), ('name', 'stor13', 13)))[uint8(arg2)])
}
...
function bought(address arg1) payable {
...
function sub_e07ca3e2(?) payable {
    require calldata.size - 4 >= 32
    require arg1 < 3
    return sub_e07ca3e2[uint8(arg1)]
}
...
function permit(address arg1, address arg2, uint256 arg3, uint256 arg4, uint8 arg5, bytes32 arg6, bytes32 arg7) payable {
    ...
    if not address(signer):
        revert with 0, 32, 33, 0x535a65726f537761705065726d69743a20496e76616c6964207369676e61747572, Mask(216, 0, arg7), mem[578 len 4]
