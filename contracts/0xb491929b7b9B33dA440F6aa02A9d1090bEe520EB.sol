...
function getSetDetails(address arg1, address[] arg2) payable {
    ...
    while idx < _2083:
        ...
        if not arg2.length:
            ...
            mem[_2097 + 32 len 32 * arg2.length] = call.data[calldata.size len 32 * arg2.length]
            s = 0
            while s < arg2.length:
                require idx < mem[320]
        ...
        while idx < _3117:
            ...
            if ceil32(_3165) <= _3165:
                ...
                if ceil32(_4207) <= _4207:
                    ...
                    require ext_code.size(address(_3126))
                    staticcall address(_3126).manager() with:
                            gas gas_remaining wei
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
        ...
        if ceil32(_3164) <= _3164:
            ...
            if ceil32(_4148) <= _4148:
                ...
                while idx < _5150:
                    ...
                    continue 
                _5966 = mem[_3135 + 128]
                mem[_3142 + 160] = ceil32(_4148) + ceil32(_3164) + (32 * _5150) + 320
                _5974 = mem[_5966]
                mem[ceil32(_4148) + ceil32(_3164) + _3142 + (32 * _5150) + 352] = mem[_5966]
                idx = 0
                s = _5966 + 32
                t = ceil32(_4148) + ceil32(_3164) + _3142 + (32 * _5150) + 384
                while idx < _5974:
                    require mem[s] < 3
                    mem[t] = mem[s]
                    idx = idx + 1
            ...
            mem[mem[64] + 64] = ceil32(_3164) + 256
            _4160 = mem[_4149]
            mem[ceil32(_3164) + _3142 + 288] = mem[_4149]
            mem[ceil32(_3164) + _3142 + 320 len ceil32(_4160)] = mem[_4149 + 32 len ceil32(_4160)]
            if ceil32(_4160) <= _4160:
                mem[_3142 + 96] = mem[_3135 + 76 len 20]
                _5113 = mem[_3135 + 96]
                mem[_3142 + 128] = ceil32(_4160) + ceil32(_3164) + 288
                _5131 = mem[_5113]
                mem[ceil32(_4160) + ceil32(_3164) + _3142 + 320] = mem[_5113]
                idx = 0
                s = _5113 + 32
                t = ceil32(_4160) + ceil32(_3164) + _3142 + 352
                while idx < _5131:
                    mem[t] = mem[s + 12 len 20]
                    idx = idx + 1
                    s = s + 32
                ...
                mem[ceil32(_3164) + _3142 + _4160 + 320] = 0
                mem[_3142 + 96] = mem[_3135 + 76 len 20]
                _5133 = mem[_3135 + 96]
                mem[_3142 + 128] = ceil32(_4160) + ceil32(_3164) + 288
                _5151 = mem[_5133]
                mem[ceil32(_4160) + ceil32(_3164) + _3142 + 320] = mem[_5133]
                idx = 0
                s = _5133 + 32
                t = ceil32(_4160) + ceil32(_3164) + _3142 + 352
                while idx < _5151:
        ...
        while idx < _5064:
            ...
            if ceil32(_5204) <= _5204:
                ...
                if ceil32(_6167) <= _6167:
                    ...
                    require ext_code.size(address(_5088))
                    staticcall address(_5088).manager() with:
                            gas gas_remaining wei
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
        ...
        if ceil32(_5203) <= _5203:
            ...
            if ceil32(_6078) <= _6078:
                ...
                while idx < _6808:
                    ...
                    continue 
                _7255 = mem[_5114 + 128]
                mem[mem[64] + 160] = ceil32(_6078) + ceil32(_5203) + (32 * _6808) + 320
                _7267 = mem[_7255]
                mem[ceil32(_6078) + ceil32(_5203) + mem[64] + (32 * _6808) + 352] = mem[_7255]
                idx = 0
                s = _7255 + 32
                t = ceil32(_6078) + ceil32(_5203) + mem[64] + (32 * _6808) + 384
                while idx < _7267:
                    require mem[s] < 3
                    mem[t] = mem[s]
                    idx = idx + 1
                    ...
                    continue 
                _7549 = mem[_5114 + 160]
                mem[mem[64] + 192] = ceil32(_6078) + ceil32(_5203) + (32 * _6808) + (32 * _7267) + 352
                _7550 = mem[_7549]
                mem[ceil32(_6078) + ceil32(_5203) + mem[64] + (32 * _6808) + (32 * _7267) + 384] = mem[_7549]
                idx = 0
                s = ceil32(_6078) + ceil32(_5203) + mem[64] + (32 * _6808) + (32 * _7267) + (32 * _7550) + 416
                t = ceil32(_6078) + ceil32(_5203) + mem[64] + (32 * _6808) + (32 * _7267) + 416
                u = _7549 + 32
                while idx < _7550:
