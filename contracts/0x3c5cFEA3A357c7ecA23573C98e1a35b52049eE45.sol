...
function sub_c1c6a7d9(?) {
    ...
    idx = 0
    while idx < arg1:
        mem[96 len 5965] = code.data[8519 len 5965]
        create contract with 0 wei
                        code: code.data[8519 len 5965]
...
function sub_5f4b9bde(?) {
    ...
    while idx < arg2:
        ...
        if idx >= instances.length:
            revert with 'NH{q', 50
        mem[0] = 1
        mem[mem[64]] = 0xbc157ac100000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = arg3
        mem[mem[64] + 36] = address(arg4)
        mem[mem[64] + 68] = arg5
        require ext_code.size(instances[idx])
        call instances[idx].deposit(uint256 arg1, address arg2, uint256 arg3) with:
             gas gas_remaining wei
