        ...
        while idx <= arg2:
            ...
            if arg1:
                ...
                if ext_code.size(arg1) > 0:
                    ...
                    s = 0
                    while s < 0:
                        mem[mem[64] + s + 164] = mem[_187 + s + 32]
                        s = s + 32
                        continue 
        ...
        while idx <= arg2:
            ...
            if arg1:
                ...
                if ext_code.size(arg1) > 0:
                    ...
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    require mem[_377] == Mask(32, 224, mem[_377])
                    if Mask(32, 224, mem[_377]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                        revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
            else:
                if tokenByIndex.length < 1:
                    revert with 'NH{q', 17
                ...
                if ext_code.size(arg1) > 0:
                    ...
                    mem[64] = mem[64] + ceil32(return_data.size)
                    require return_data.size >= 32
                    require mem[_378] == Mask(32, 224, mem[_378])
                    if Mask(32, 224, mem[_378]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                        revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
