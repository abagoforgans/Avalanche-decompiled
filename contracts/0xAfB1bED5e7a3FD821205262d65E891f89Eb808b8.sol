...
const sub_4e20a02c(?) = 16500 * 10^18
...
function distributeReward(address arg1) payable {
    ...
    if totalSupply + 16500 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 16500 * 10^18
    if balanceOf[address(arg1)] + 16500 * 10^18 < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 16500 * 10^18
    emit Transfer(16500 * 10^18, 0, arg1);
}
