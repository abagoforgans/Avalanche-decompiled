...
function prezzoKRWinUSDC() payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return (10^12 * ext_call.return_data[0] / 10^12 * ext_call.return_data[0] / 10^18)
}
...
function reverseToken0(uint256 arg1) payable {
    ...
    require return_data.size >= 32
    require ext_call.return_data[0]
    return (10^12 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0])
}
...
function tvl(uint256 arg1) payable {
    ...
    if not arg1:
        ...
        if not _16 % 32:
            ...
            require return_data.size >= 288
            _1466 = mem[_16 + ceil32(return_data.size) + 128 len 4], Mask(224, 32, arg1) >> 32
            ...
            staticcall address(_1466).getReserves() with:
                    gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 96
            require ext_code.size(address(_1466))
            staticcall address(_1466).0x18160ddd with:
                    gas gas_remaining wei
        else:
            ...
            require return_data.size >= 288
            _1475 = mem[floor32(_16) + ceil32(return_data.size) + 160 len 4], Mask(224, 32, arg1) >> 32
            require uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 <= 4294967296
            require uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + 32 <= return_data.size
            ...
            require ext_code.size(address(_1475))
            staticcall address(_1475).getReserves() with:
                    gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 96
            require ext_code.size(address(_1475))
            staticcall address(_1475).0x18160ddd with:
                    gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        return ((10^12 * ext_call.return_data[0] * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) / ext_call.return_data[0] / 10^18) + (10^12 * 10^12 * ext_call.return_data[0] / 10^12 * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0] / 10^18))
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return ((10^12 * 10^12 * ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0] / 10^18) + (10^12 * ext_call.return_data[0] / 10^12 * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) / ext_call.return_data[0] / 10^18))
}
...
function tvlTotal(uint256 arg1, address arg2) payable {
    ...
    if not arg1:
        ...
        if not _16 % 32:
            ...
            mem[64] = _16 + (2 * ceil32(return_data.size)) + 128
            require return_data.size >= 288
            _1486 = mem[_16 + ceil32(return_data.size) + 128 len 4], Mask(224, 32, arg1) >> 32
            require uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 <= 4294967296
            require uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + 32 <= return_data.size
            require mem[uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + _16 + ceil32(return_data.size) + 128] <= 4294967296 and uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + mem[uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + _16 + ceil32(return_data.size) + 128] + 32 <= return_data.size
            mem[_16 + (2 * ceil32(return_data.size)) + 128] = mem[uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + _16 + ceil32(return_data.size) + 128]
            ...
            staticcall address(_1486).getReserves() with:
                    gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 96
            require ext_code.size(address(_1486))
            staticcall address(_1486).0x18160ddd with:
                    gas gas_remaining wei
        else:
            mem[floor32(_16) + ceil32(return_data.size) + 128] = mem[floor32(_16) + ceil32(return_data.size) + -(_16 % 32) + 160 len _16 % 32]
            require ext_code.size(stor4)
            ...
            mem[64] = floor32(_16) + (2 * ceil32(return_data.size)) + 160
            require return_data.size >= 288
            _1495 = mem[floor32(_16) + ceil32(return_data.size) + 160 len 4], Mask(224, 32, arg1) >> 32
            require uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 <= 4294967296
            require uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + 32 <= return_data.size
            require mem[uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + floor32(_16) + ceil32(return_data.size) + 160] <= 4294967296 and uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + mem[uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + floor32(_16) + ceil32(return_data.size) + 160] + 32 <= return_data.size
            mem[floor32(_16) + (2 * ceil32(return_data.size)) + 160] = mem[uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + floor32(_16) + ceil32(return_data.size) + 160]
            ...
            staticcall address(_1495).getReserves() with:
                    gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 96
            require ext_code.size(address(_1495))
            staticcall address(_1495).0x18160ddd with:
                    gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
    ...
    if not arg1:
        ...
        if not _40 % 32:
            ...
            if ext_call.return_data[0]:
                ...
                require return_data.size >= 288
                _1490 = mem[_40 + ceil32(return_data.size) + 128 len 4], Mask(224, 32, arg1) >> 32
                require uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 <= 4294967296
                require uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + 32 <= return_data.size
                ...
                if ext_call.return_data[0]:
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    if (10^12 * ext_call.return_data[0] * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) / ext_call.return_data[0] / 10^18) + (10^12 * 10^12 * ext_call.return_data[0] / 10^12 * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0] / 10^18) + 1:
                        return (100 * 14334545 * ext_call.return_data[0] * 10^12 * ext_call.return_data[0] / 10^12 * ext_call.return_data[0] / 10^18 / (10^12 * ext_call.return_data[0] * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) / ext_call.return_data[0] / 10^18) + (10^12 * 10^12 * ext_call.return_data[0] / 10^12 * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0] / 10^18) + 1 / 10^18)
        else:
            ...
            if ext_call.return_data[0]:
                ...
                require return_data.size >= 288
                _1499 = mem[floor32(_40) + ceil32(return_data.size) + 160 len 4], Mask(224, 32, arg1) >> 32
                require uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 <= 4294967296
                require uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + 32 <= return_data.size
                ...
                staticcall address(_1499).getReserves() with:
                        gas gas_remaining wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 96
                require ext_code.size(address(_1499))
                staticcall address(_1499).0x18160ddd with:
                        gas gas_remaining wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                    ...
                    if not _2739 % 32:
                        ...
                        if ext_call.return_data[0]:
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            if (10^12 * 10^12 * ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0] / 10^18) + (10^12 * ext_call.return_data[0] / 10^12 * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) / ext_call.return_data[0] / 10^18) + 1:
                                return (100 * 14334545 * ext_call.return_data[0] * 10^12 * ext_call.return_data[0] / 10^12 * ext_call.return_data[0] / 10^18 / (10^12 * 10^12 * ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0] / 10^18) + (10^12 * ext_call.return_data[0] / 10^12 * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) / ext_call.return_data[0] / 10^18) + 1 / 10^18)
                    else:
...
function dollariPerUnita(uint256 arg1) payable {
    ...
    if not arg1:
        ...
        mem[64] = ceil32(return_data.size) + 96
        require return_data.size >= 288
        _71 = mem[96 len 4], Mask(224, 32, arg1) >> 32
        require uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 <= 4294967296
        require uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + 32 <= return_data.size
        require mem[uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + 96] <= 4294967296 and uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + mem[uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + 96] + 32 <= return_data.size
        mem[ceil32(return_data.size) + 96] = mem[uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + 96]
        _82 = mem[uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + 96]
        mem[ceil32(return_data.size) + 128 len ceil32(mem[uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + 96])] = mem[uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + 128 len ceil32(mem[uint32(arg1), Mask(112, 0, ext_call.return_data[0]) << 112 + 96])]
        if not _82 % 32:
            require ext_code.size(address(_71))
            staticcall address(_71).0x18160ddd with:
                    gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[_82 + ceil32(return_data.size) + 128] = 0x1526fe2700000000000000000000000000000000000000000000000000000000
            mem[_82 + ceil32(return_data.size) + 132] = arg1
            require ext_code.size(stor4)
            staticcall stor4.0x1526fe27 with:
                    gas gas_remaining wei
                   args arg1
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[_82 + ceil32(return_data.size) + 128 len return_data.size] = ext_call.return_data[0 len return_data.size]
            mem[64] = _82 + (2 * ceil32(return_data.size)) + 128
            require return_data.size >= 288
            _2828 = mem[_82 + ceil32(return_data.size) + 128 len 4], Mask(224, 32, arg1) >> 32
            _2829 = uint32(arg1), mem[_82 + ceil32(return_data.size) + 164 len 28]
            require uint32(arg1), mem[_82 + ceil32(return_data.size) + 164 len 28] <= 4294967296
            require uint32(arg1), mem[_82 + ceil32(return_data.size) + 164 len 28] + 32 <= return_data.size
            require mem[uint32(arg1), mem[_82 + ceil32(return_data.size) + 164 len 28] + _82 + ceil32(return_data.size) + 128] <= 4294967296 and uint32(arg1), mem[_82 + ceil32(return_data.size) + 164 len 28] + mem[uint32(arg1), mem[_82 + ceil32(return_data.size) + 164 len 28] + _82 + ceil32(return_data.size) + 128] + 32 <= return_data.size
            mem[_82 + (2 * ceil32(return_data.size)) + 128] = mem[uint32(arg1), mem[_82 + ceil32(return_data.size) + 164 len 28] + _82 + ceil32(return_data.size) + 128]
            require ext_code.size(address(_2828))
            staticcall address(_2828).getReserves() with:
                    gas gas_remaining wei
        else:
            mem[floor32(_82) + ceil32(return_data.size) + 128] = mem[floor32(_82) + ceil32(return_data.size) + -(_82 % 32) + 160 len _82 % 32]
            require ext_code.size(address(_71))
            staticcall address(_71).0x18160ddd with:
                    gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[floor32(_82) + ceil32(return_data.size) + 160] = 0x1526fe2700000000000000000000000000000000000000000000000000000000
            mem[floor32(_82) + ceil32(return_data.size) + 164] = arg1
            require ext_code.size(stor4)
            staticcall stor4.0x1526fe27 with:
                    gas gas_remaining wei
                   args arg1
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[floor32(_82) + ceil32(return_data.size) + 160 len return_data.size] = ext_call.return_data[0 len return_data.size]
            mem[64] = floor32(_82) + (2 * ceil32(return_data.size)) + 160
            require return_data.size >= 288
            _2833 = mem[floor32(_82) + ceil32(return_data.size) + 160 len 4], Mask(224, 32, arg1) >> 32
            _2834 = uint32(arg1), mem[floor32(_82) + ceil32(return_data.size) + 196 len 28]
            require uint32(arg1), mem[floor32(_82) + ceil32(return_data.size) + 196 len 28] <= 4294967296
            require uint32(arg1), mem[floor32(_82) + ceil32(return_data.size) + 196 len 28] + 32 <= return_data.size
            require mem[uint32(arg1), mem[floor32(_82) + ceil32(return_data.size) + 196 len 28] + floor32(_82) + ceil32(return_data.size) + 160] <= 4294967296 and uint32(arg1), mem[floor32(_82) + ceil32(return_data.size) + 196 len 28] + mem[uint32(arg1), mem[floor32(_82) + ceil32(return_data.size) + 196 len 28] + floor32(_82) + ceil32(return_data.size) + 160] + 32 <= return_data.size
            mem[floor32(_82) + (2 * ceil32(return_data.size)) + 160] = mem[uint32(arg1), mem[floor32(_82) + ceil32(return_data.size) + 196 len 28] + floor32(_82) + ceil32(return_data.size) + 160]
        ...
        require return_data.size >= 96
        if ext_call.return_data[0]:
            return (2 * 10^18 * ext_call.return_data[18 len 14] / ext_call.return_data[0] * 10^12 * ext_call.return_data[0] / 10^12 * ext_call.return_data[0] / 10^18 / 10^18)
    else:
