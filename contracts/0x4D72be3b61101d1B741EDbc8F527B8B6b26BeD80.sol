    ...
    if owner == msg.sender:
        ...
        if mem[_744] >= cd[36]:
            ...
            call stor2.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args cd[36], _734, Array(len=('cd', 4).length, data=mem[mem[64] + 196 len 32 * ('cd', 4).length]), address(this.address), block.timestamp + 300
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _948 = mem[64]
            ...
            mem[mem[64] + 36] = -1
            require ext_code.size(address(_738))
            call address(_738).approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args stor2, -1
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
        ...
        if mem[_745] >= cd[36]:
            ...
            call stor2.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args cd[36], mem[mem[64] + 36], Array(len=('cd', 4).length, data=mem[mem[64] + 196 len 32 * ('cd', 4).length]), address(this.address), block.timestamp + 300
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _950 = mem[64]
            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            mem[mem[64] + 36] = -1
            require ext_code.size(address(_739))
            call address(_739).approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args stor2, -1
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
