...
const rewardAddress = 0x3efa197ab71c330676021d2350255508e66b7069
...
function vaultSharesTotal() payable {
    ...
    staticcall masterchefAddress.0x70a08231 with:
...
function withdraw(address arg1, uint256 arg2) payable {
            ...
            if not arg2:
                ...
                if 0 / 2 * ext_call.return_data[0] <= sharesTotal:
                    ...
                    if not arg2:
                        ...
                        if not ext_code.hash(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[580 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2.field_0), uint32(stor2.field_0), Mask(224, 32, arg2) >> 32
                        call wantAddress with:
                        ...
                        if not (10000 * arg2) - (withdrawFeeFactor * arg2) / 10000:
                            ...
                            if not ext_code.hash(wantAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[580 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2.field_0), uint32(stor2.field_0), Mask(224, 32, arg2 - ((10000 * arg2) - (withdrawFeeFactor * arg2) / 10000)) >> 32
                            call wantAddress with:
                               funct uint32(stor2.field_0)
                                 gas gas_remaining wei
                            ...
                            if not ext_code.hash(wantAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[516 len 64] = unknown_0xa9059cbb(?????), 0xd12bc198269a14475baf42fa, 0, Mask(224, 32, (10000 * arg2) - (withdrawFeeFactor * arg2) / 10000) >> 32
            ...
            if not 2 * ext_call.return_data[0]:
                ...
                if 0 / 2 * ext_call.return_data[0] <= sharesTotal:
                    ...
                    if not 2 * ext_call.return_data[0]:
                        ...
                        if not ext_code.hash(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[580 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2.field_0), uint32(stor2.field_0), Mask(224, 31, ext_call.return_data[0]) >> 31
                        call wantAddress with:
                           funct uint32(stor2.field_0)
                             gas gas_remaining wei
                    ...
                    if not (20000 * ext_call.return_data[0]) - (ext_call.return_data[0] * withdrawFeeFactor) - (ext_call.return_data[0] * withdrawFeeFactor) / 10000:
                        ...
                        if not ext_code.hash(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[580 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2.field_0), uint32(stor2.field_0), Mask(224, 32, (2 * ext_call.return_data[0]) - ((20000 * ext_call.return_data[0]) - (ext_call.return_data[0] * withdrawFeeFactor) - (ext_call.return_data[0] * withdrawFeeFactor) / 10000)) >> 32
                        call wantAddress with:
                           funct uint32(stor2.field_0)
                             gas gas_remaining wei
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[516 len 64] = unknown_0xa9059cbb(?????), 0xd12bc198269a14475baf42fa, 0, Mask(224, 32, (20000 * ext_call.return_data[0]) - (ext_call.return_data[0] * withdrawFeeFactor) - (ext_call.return_data[0] * withdrawFeeFactor) / 10000) >> 32
                    call wantAddress.0x75e9df1e with:
                         gas gas_remaining wei
    ...
    if ext_call.return_data[0] > arg2:
        revert with 0, 'SafeMath: subtraction overflow'
    require ext_code.size(masterchefAddress)
    call masterchefAddress.0x2e1a7d4d with:
         gas gas_remaining wei
            ...
            if not arg2:
                ...
                if 0 / 2 * ext_call.return_data[0] <= sharesTotal:
                    ...
                    if not arg2:
                        ...
                        if not ext_code.hash(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[644 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2.field_0), uint32(stor2.field_0), Mask(224, 32, arg2) >> 32
                        call wantAddress with:
                           funct uint32(stor2.field_0)
                             gas gas_remaining wei
                    ...
                    if not (10000 * arg2) - (withdrawFeeFactor * arg2) / 10000:
                        ...
                        if not ext_code.hash(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[644 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2.field_0), uint32(stor2.field_0), Mask(224, 32, arg2 - ((10000 * arg2) - (withdrawFeeFactor * arg2) / 10000)) >> 32
                        call wantAddress with:
                           funct uint32(stor2.field_0)
                             gas gas_remaining wei
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[580 len 64] = unknown_0xa9059cbb(?????), 0xd12bc198269a14475baf42fa, 0, Mask(224, 32, (10000 * arg2) - (withdrawFeeFactor * arg2) / 10000) >> 32
                    call wantAddress.0x75e9df1e with:
                         gas gas_remaining wei
        ...
        if not 2 * ext_call.return_data[0]:
            ...
            if 0 / 2 * ext_call.return_data[0] <= sharesTotal:
                ...
                if not 2 * ext_call.return_data[0]:
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[644 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2.field_0), uint32(stor2.field_0), Mask(224, 31, ext_call.return_data[0]) >> 31
                    call wantAddress with:
                       funct uint32(stor2.field_0)
                         gas gas_remaining wei
                ...
                if not (20000 * ext_call.return_data[0]) - (ext_call.return_data[0] * withdrawFeeFactor) - (ext_call.return_data[0] * withdrawFeeFactor) / 10000:
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[644 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2.field_0), uint32(stor2.field_0), Mask(224, 32, (2 * ext_call.return_data[0]) - ((20000 * ext_call.return_data[0]) - (ext_call.return_data[0] * withdrawFeeFactor) - (ext_call.return_data[0] * withdrawFeeFactor) / 10000)) >> 32
                    mem[708 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor2.field_0)
                         gas gas_remaining wei
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[580 len 64] = unknown_0xa9059cbb(?????), 0xd12bc198269a14475baf42fa, 0, Mask(224, 32, (20000 * ext_call.return_data[0]) - (ext_call.return_data[0] * withdrawFeeFactor) - (ext_call.return_data[0] * withdrawFeeFactor) / 10000) >> 32
                call wantAddress.0x75e9df1e with:
                     gas gas_remaining wei
        ...
        if not ext_call.return_data[0]:
            ...
            if 0 / 2 * ext_call.return_data[0] <= sharesTotal:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[644 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2.field_0), uint32(stor2.field_0), ext_call.return_data[0 len 28]
                    call wantAddress with:
                       funct uint32(stor2.field_0)
                         gas gas_remaining wei
                ...
                if not (10000 * ext_call.return_data[0]) - (withdrawFeeFactor * ext_call.return_data[0]) / 10000:
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[644 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor2.field_0), uint32(stor2.field_0), Mask(224, 32, ext_call.return_data[0] - ((10000 * ext_call.return_data[0]) - (withdrawFeeFactor * ext_call.return_data[0]) / 10000)) >> 32
                    mem[708 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor2.field_0)
                         gas gas_remaining wei
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[580 len 64] = unknown_0xa9059cbb(?????), 0xd12bc198269a14475baf42fa, 0, Mask(224, 32, (10000 * ext_call.return_data[0]) - (withdrawFeeFactor * ext_call.return_data[0]) / 10000) >> 32
                call wantAddress.0x75e9df1e with:
                     gas gas_remaining wei
...
function earn() payable {
    ...
    if govAddress != msg.sender:
        revert with 0, '!gov'
    require ext_code.size(masterchefAddress)
    call masterchefAddress.0x3d18b912 with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if ext_call.return_data[0]:
        if address(token0Address) == earnedAddress:
            if token1Address == earnedAddress:
                ...
                staticcall address(token0Address).0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
