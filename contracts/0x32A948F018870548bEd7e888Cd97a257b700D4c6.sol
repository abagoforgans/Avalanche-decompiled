...
uint8 decimals;
address sub_d10fc104Address; offset 8
...
function unstake(uint256 arg1) payable {
    ...
    staticcall sub_d10fc104Address.0x70a08231 with:
    ...
    if not arg1:
        ...
        require ext_code.size(sub_d10fc104Address)
        call sub_d10fc104Address.0xa9059cbb with:
             gas gas_remaining wei
...
function stake(uint256 arg1) payable {
    ...
    require ext_code.size(sub_d10fc104Address)
    call sub_d10fc104Address.0x23b872dd with:
         gas gas_remaining wei
