...
function setPriceFeed(address arg1) {
    ...
    create contract with 0 wei
                    code: code.data[12196 len 914], address(arg1)
...
function sub_5b6c3924(?) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    staticcall address(stor2.field_0).getLatestPrice() with:
...
function sub_417cfe28(?) {
    ...
    if not arg2:
        ...
        mem[ceil32(ceil32(arg1.length)) + (2 * arg1.length) + 195] = 13
    ...
    mem[ceil32(ceil32(arg1.length)) + ceil32(s) + (2 * mem[ceil32(ceil32(arg1.length)) + 97]) + (2 * arg1.length) + 161] = 13
