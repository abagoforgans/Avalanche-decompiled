...
function getNextUnwrapTimestamp(address arg1) payable {
    require calldata.size - 4 >= 32
    if stor8[address(arg1)] + (8760 * 24 * 3600) < stor8[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    return (stor8[address(arg1)] + (8760 * 24 * 3600))
}
...
function sub_f5390162(?) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(0xbe6d6323ea233fd1dbe1ff66c5252170c69fb6c7)
    call 0xbe6d6323ea233fd1dbe1ff66c5252170c69fb6c7.0x23b872dd with:
...
function sub_339bdbe9(?) payable {
    ...
    if stor8[address(msg.sender)] + (8760 * 24 * 3600) < stor8[address(msg.sender)]:
        revert with 0, 'SafeMath: addition overflow'
    require ext_code.size(0xbe6d6323ea233fd1dbe1ff66c5252170c69fb6c7)
    if block.timestamp >= stor8[address(msg.sender)] + (8760 * 24 * 3600):
        call 0xbe6d6323ea233fd1dbe1ff66c5252170c69fb6c7.0xa9059cbb with:
             gas gas_remaining wei
...
function sub_258bc95e(?) payable {
    require ext_code.size(0xbe6d6323ea233fd1dbe1ff66c5252170c69fb6c7)
    staticcall 0xbe6d6323ea233fd1dbe1ff66c5252170c69fb6c7.0x70a08231 with:
            gas gas_remaining wei
           args msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
