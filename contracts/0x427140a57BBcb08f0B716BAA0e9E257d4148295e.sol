...
function withdraw(uint256 arg1) payable {
            ...
            if arg1 < stor17:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if not arg1:
                        ...
                        if 1 > 0 / ext_call.return_data[0]:
                            revert with 0, 'SafeMath: subtraction overflow', 0
                        mem[(8 * ceil32(return_data.size)) + 260] = (0 / ext_call.return_data[0]) - 1
                        require ext_code.size(gaugeAddress)
                        call gaugeAddress.withdraw(uint256 arg1, uint256 arg2) with:
                             gas gas_remaining wei
                            args uint16(stor16.field_160) - 1 << 240, (0 / ext_call.return_data[0]) - 1
                        ...
                        if 1 > 10^6 * arg1 / ext_call.return_data[0]:
                            revert with 0, 'SafeMath: subtraction overflow', 0
                        mem[(8 * ceil32(return_data.size)) + 260] = (10^6 * arg1 / ext_call.return_data[0]) - 1
                        require ext_code.size(gaugeAddress)
                        call gaugeAddress.withdraw(uint256 arg1, uint256 arg2) with:
                             gas gas_remaining wei
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(13 * ceil32(return_data.size)) + 388 len 96] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0], 0
    ...
    if not arg1:
        ...
        if not ext_code.hash(wantAddress):
            revert with 0, 'Address: call to non-contract'
        mem[(6 * ceil32(return_data.size)) + 324 len 96] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0], 0
        ...
        if arg1 < stor17:
            ...
            if not ext_call.return_data[0]:
                ...
                if not arg1:
                    ...
                    if not ext_call.return_data[0]:
                        revert with 0, 'SafeMath: division by zero', 0
                    mem[(8 * ceil32(return_data.size)) + 224] = 30
                    mem[(8 * ceil32(return_data.size)) + 256] = 'SafeMath: subtraction overflow'
                    if 1 > 0 / ext_call.return_data[0]:
                        revert with 0, 'SafeMath: subtraction overflow', 0
                    mem[(8 * ceil32(return_data.size)) + 324] = (0 / ext_call.return_data[0]) - 1
                    require ext_code.size(gaugeAddress)
                    call gaugeAddress.withdraw(uint256 arg1, uint256 arg2) with:
                         gas gas_remaining wei
                        args uint16(stor16.field_160) - 1 << 240, (0 / ext_call.return_data[0]) - 1
                    ...
                    if 1 > 10^6 * arg1 / ext_call.return_data[0]:
                        revert with 0, 'SafeMath: subtraction overflow', 0
                    mem[(8 * ceil32(return_data.size)) + 324] = (10^6 * arg1 / ext_call.return_data[0]) - 1
                    require ext_code.size(gaugeAddress)
                    call gaugeAddress.withdraw(uint256 arg1, uint256 arg2) with:
                         gas gas_remaining wei
                        args uint16(stor16.field_160) - 1 << 240, (10^6 * arg1 / ext_call.return_data[0]) - 1
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[(10 * ceil32(return_data.size)) + 292] = sub_e956dcd7Address
                ...
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                mem[(11 * ceil32(return_data.size)) + 292] = uint16(stor16.field_160)
                mem[(11 * ceil32(return_data.size)) + 324] = ext_call.return_data[0]
                ...
                mem[(13 * ceil32(return_data.size)) + 320 len 4] = unknown_0xa9059cbb(?????)
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(13 * ceil32(return_data.size)) + 452 len 96] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0], 0
