...
function antiWhale() payable {
    return bool(antiWhale)
}

function sub_6b5e139b(?) payable {
    return sub_6b5e139b
}
...
function transferOwnership(address arg1) payable {
    ...
    tokenOwner = arg1
    emit 0xa1588401: tokenOwner, tokenOwner
}

function updateAntiWhale(bool arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if tokenOwner != msg.sender:
        revert with 0, 'Only owner'
    antiWhale = uint8(arg1)
    emit 0x826055be: bool(antiWhale), block.timestamp
}
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if antiWhale:
        if arg2 > sub_6b5e139b:
            revert with 0, 'Exceeded whale amount'
...
function sub_0bf77a14(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if tokenOwner != msg.sender:
        revert with 0, 'Only owner'
    if not antiWhale:
        revert with 0, 'Anti whale is turned off'
    if not decimals:
        if arg1 < 1000:
            revert with 0, 'Whale amount less than 1000'
    else:
        if bool(bool(decimals < 78)) or bool(bool(decimals < 32)):
            if 10^decimals > -1:
                revert with 'NH{q', 17
            if 10^decimals > 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5604189374bc6a7:
                revert with 'NH{q', 17
            if arg1 < 1000 * 10^decimals:
                revert with 0, 'Whale amount less than 1000'
        else:
            s = 10
            t = 1
            ...
            if t > -1 / s:
                revert with 'NH{q', 17
            if t * s > 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5604189374bc6a7:
                revert with 'NH{q', 17
            if arg1 < 1000 * t * s:
                revert with 0, 'Whale amount less than 1000'
    sub_6b5e139b = arg1
    emit 0xca21e57d: sub_6b5e139b, sub_6b5e139b, block.timestamp
}
