...
function sub_4b007dbb(?) payable {
    ...
    mem[196] = 0
    mem[228 len 128] = depositETH(address arg1, address arg2, uint16 arg3), 0x70bbe4a294878a14cb3cdd93, 0, 0xc3d48eed72362ed5e189e5ba7c8561aab17912aa, 0, mem[228 len 28]
    mem[328] = 0
    ...
    if not return_data.size:
        ...
        mem[ceil32(return_data.size) + 260 len 4] = withdrawETH(address arg1, uint256 arg2, address arg3)
        ...
        mem[ceil32(return_data.size) + ceil32(return_data.size) + 261 len 4] = withdrawETH(address arg1, uint256 arg2, address arg3)
