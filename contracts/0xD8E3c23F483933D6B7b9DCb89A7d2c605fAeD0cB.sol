...
const getName = 'StrategyJoeAvaxCly'
...
uint256 poolId;
uint256 sub_fd52b861;
address sub_9e41dbcfAddress;
address addToRXBalanceAddress;
...
function AddToRXBalance(address arg1) {
    return addToRXBalanceAddress
}
...
function sub_9e41dbcf(?) {
    return sub_9e41dbcfAddress
}
