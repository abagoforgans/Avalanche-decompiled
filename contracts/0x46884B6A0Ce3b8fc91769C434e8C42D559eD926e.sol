...
const COMMUNITY_FUND_POOL_ALLOCATION = 15000 * 10^18

const VESTING_DURATION = (3600 * 24 * 3600)

const DEV_FUND_POOL_ALLOCATION = 5000 * 10^18

const FARMING_POOL_REWARD_ALLOCATION = 60000 * 10^18
...
function distributeReward(address arg1) payable {
    ...
    if totalSupply + 60000 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 60000 * 10^18
    if balanceOf[address(arg1)] + 60000 * 10^18 < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 60000 * 10^18
    emit Transfer(60000 * 10^18, 0, arg1);
}
                            ...
                            if sub_ca9ab2eeAddress:
                                if sub_6beec71aAddress:
                                    if not sub_6dc651d9Address:
                                        revert with 0, 'ERC20: mint to the zero address'
                                    if ((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4) + totalSupply < totalSupply:
                                        revert with 0, 'SafeMath: addition overflow'
                                    totalSupply += (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4
                                    if ((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4) + balanceOf[stor12] < balanceOf[stor12]:
                                        revert with 0, 'SafeMath: addition overflow'
                                    balanceOf[stor12] += (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4
                                    emit Transfer(((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4), 0, sub_6dc651d9Address);
                                    if not sub_117effebAddress:
                                        revert with 0, 'ERC20: mint to the zero address'
                                    if ((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4) + totalSupply < totalSupply:
                                        revert with 0, 'SafeMath: addition overflow'
                                    totalSupply += (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4
                                    if ((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4) + balanceOf[stor13] < balanceOf[stor13]:
                                        revert with 0, 'SafeMath: addition overflow'
                                    balanceOf[stor13] += (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4
                                    emit Transfer(((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4), 0, sub_117effebAddress);
                                    if not sub_ca9ab2eeAddress:
                                        revert with 0, 'ERC20: mint to the zero address'
                                    if ((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4) + totalSupply < totalSupply:
                                        revert with 0, 'SafeMath: addition overflow'
                                    totalSupply += (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4
                                    if ((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4) + balanceOf[stor14] < balanceOf[stor14]:
                                        revert with 0, 'SafeMath: addition overflow'
                                    balanceOf[stor14] += (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4
                                    emit Transfer(((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4), 0, sub_ca9ab2eeAddress);
                                    if not sub_6beec71aAddress:
                                        revert with 0, 'ERC20: mint to the zero address'
                                    if ((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4) + totalSupply < totalSupply:
                                        revert with 0, 'SafeMath: addition overflow'
                                    totalSupply += (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4
                                    if ((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4) + balanceOf[stor15] < balanceOf[stor15]:
                                        revert with 0, 'SafeMath: addition overflow'
                                    balanceOf[stor15] += (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4
                                    emit Transfer(((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4), 0, sub_6beec71aAddress);
                        ...
                        if sub_117effebAddress:
                            if sub_ca9ab2eeAddress:
                                if sub_6beec71aAddress:
                                    if not sub_6dc651d9Address:
                                        revert with 0, 'ERC20: mint to the zero address'
                                    if ((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4) + totalSupply < totalSupply:
                                        revert with 0, 'SafeMath: addition overflow'
                                    totalSupply += (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4
                                    if ((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4) + balanceOf[stor12] < balanceOf[stor12]:
                                        revert with 0, 'SafeMath: addition overflow'
                                    balanceOf[stor12] += (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4
                                    emit Transfer(((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4), 0, sub_6dc651d9Address);
                                    if not sub_117effebAddress:
                                        revert with 0, 'ERC20: mint to the zero address'
                                    if ((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4) + totalSupply < totalSupply:
                                        revert with 0, 'SafeMath: addition overflow'
                                    totalSupply += (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4
                                    if ((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4) + balanceOf[stor13] < balanceOf[stor13]:
                                        revert with 0, 'SafeMath: addition overflow'
                                    balanceOf[stor13] += (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4
                                    emit Transfer(((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4), 0, sub_117effebAddress);
                                    if not sub_ca9ab2eeAddress:
                                        revert with 0, 'ERC20: mint to the zero address'
                                    if ((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4) + totalSupply < totalSupply:
                                        revert with 0, 'SafeMath: addition overflow'
                                    totalSupply += (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4
                                    if ((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4) + balanceOf[stor14] < balanceOf[stor14]:
                                        revert with 0, 'SafeMath: addition overflow'
                                    balanceOf[stor14] += (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4
                                    emit Transfer(((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4), 0, sub_ca9ab2eeAddress);
                                    if not sub_6beec71aAddress:
                                        revert with 0, 'ERC20: mint to the zero address'
                                    if ((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4) + totalSupply < totalSupply:
                                        revert with 0, 'SafeMath: addition overflow'
                                    totalSupply += (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4
                                    if ((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4) + balanceOf[stor15] < balanceOf[stor15]:
                                        revert with 0, 'SafeMath: addition overflow'
                                    balanceOf[stor15] += (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4
                                    emit Transfer(((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) / 4), 0, sub_6beec71aAddress);
                                    devFundLastClaimed = block.timestamp
}
