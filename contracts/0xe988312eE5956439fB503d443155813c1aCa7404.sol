...
function isHoneypotETHBuyOnly(address arg1, address arg2) payable {
    ...
    require return_data.size >= 32
    _32 = mem[ceil32(return_data.size) + 192 len 4], Mask(224, 0, stor1.field_32)
    ...
    _33 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 0, stor1.field_32) + 192]
    ...
    idx = ceil32(return_data.size) + _32 + 224
    s = (2 * ceil32(return_data.size)) + 224
    while idx < ceil32(return_data.size) + _32 + (32 * _33) + 224:
    ...
    if 1 >= _33:
        revert with 'NH{q', 50
    _50 = mem[(2 * ceil32(return_data.size)) + 256]
    ...
    require ext_code.size(arg2)
    call arg2.swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
...
function isHoneypotTokenBuyOnly(address arg1, address arg2, address arg3) payable {
    ...
    require return_data.size >= 32
    _73 = mem[(4 * ceil32(return_data.size)) + 288 len 4], Mask(224, 0, stor1.field_32)
    ...
    _74 = mem[(4 * ceil32(return_data.size)) + mem[(4 * ceil32(return_data.size)) + 288 len 4], Mask(224, 0, stor1.field_32) + 288]
    ...
    require _73 + (32 * _74) + 32 <= return_data.size
    idx = (4 * ceil32(return_data.size)) + _73 + 320
    s = (6 * ceil32(return_data.size)) + 320
    while idx < (4 * ceil32(return_data.size)) + _73 + (32 * _74) + 320:
        require mem[idx] == mem[idx]
        mem[s] = mem[idx]
        idx = idx + 32
        s = s + 32
    ...
    if 1 >= _74:
        revert with 'NH{q', 50
    _91 = mem[(6 * ceil32(return_data.size)) + 352]
...
function isHoneypotETH(address arg1, address arg2) payable {
    ...
    staticcall arg2.getAmountsOut(uint256 arg1, address[] arg2) with:
            gas gas_remaining wei
           args _182, 64, mem[_197 + ceil32(return_data.size) + 164 len (32 * mem[_197]) + 32]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[_197 + ceil32(return_data.size) + 96 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = _197 + (2 * ceil32(return_data.size)) + 96
    require return_data.size >= 32
    _244 = mem[_197 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, _182) >> 32
    require mem[_197 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, _182) >> 32 <= test266151307()
    require _197 + ceil32(return_data.size) + mem[_197 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, _182) >> 32 + 127 < _197 + ceil32(return_data.size) + return_data.size + 96
    _246 = mem[_197 + ceil32(return_data.size) + mem[_197 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, _182) >> 32 + 96]
    if mem[_197 + ceil32(return_data.size) + mem[_197 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, _182) >> 32 + 96] > test266151307():
        revert with 'NH{q', 65
    if _197 + (2 * ceil32(return_data.size)) + floor32(mem[_197 + ceil32(return_data.size) + mem[_197 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, _182) >> 32 + 96]) + 97 > test266151307() or floor32(mem[_197 + ceil32(return_data.size) + mem[_197 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, _182) >> 32 + 96]) + 1 < 0:
        revert with 'NH{q', 65
    mem[64] = _197 + (2 * ceil32(return_data.size)) + floor32(mem[_197 + ceil32(return_data.size) + mem[_197 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, _182) >> 32 + 96]) + 97
    mem[_197 + (2 * ceil32(return_data.size)) + 96] = mem[_197 + ceil32(return_data.size) + mem[_197 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, _182) >> 32 + 96]
    require _244 + (32 * _246) + 32 <= return_data.size
    idx = _197 + ceil32(return_data.size) + _244 + 128
    s = _197 + (2 * ceil32(return_data.size)) + 128
    while idx < _197 + ceil32(return_data.size) + _244 + (32 * _246) + 128:
        require mem[idx] == mem[idx]
        mem[s] = mem[idx]
        idx = idx + 32
        s = s + 32
    ...
    if 1 >= _246:
        revert with 'NH{q', 50
    _272 = mem[_197 + (2 * ceil32(return_data.size)) + 160]
    stor0 = 1
    mem[mem[64]] = 0x762b156200000000000000000000000000000000000000000000000000000000
    mem[mem[64] + 4] = _182
    mem[mem[64] + 36] = 0
