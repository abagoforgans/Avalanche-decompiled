...
function userDetails1(uint256 arg1, uint256 arg2) {
    ...
    if bool(stor3[address(msg.sender)]) != 1:
        revert with 0, 'no'
    mem[floor32(('cd', 100).length) + 97] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
    mem[floor32(('cd', 100).length) + 101] = arg2
    mem[floor32(('cd', 100).length) + 133] = 64
    mem[floor32(('cd', 100).length) + 165] = ('cd', 100).length
    idx = 0
    s = 128
    t = floor32(('cd', 100).length) + 197
    while idx < ('cd', 100).length:
        mem[t] = mem[s + 12 len 20]
        idx = idx + 1
        s = s + 32
    ...
    staticcall address(arg1).getAmountsOut(uint256 arg1, address[] arg2) with:
            gas gas_remaining wei
           args arg2, Array(len=('cd', 100).length, data=mem[floor32(('cd', 100).length) + 197 len 32 * ('cd', 100).length])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    _43 = mem[floor32(('cd', 100).length) + 97 len 4], Mask(224, 32, arg2) >> 32
    require mem[floor32(('cd', 100).length) + 97 len 4], Mask(224, 32, arg2) >> 32 <= test266151307()
    require floor32(('cd', 100).length) + mem[floor32(('cd', 100).length) + 97 len 4], Mask(224, 32, arg2) >> 32 + 128 < floor32(('cd', 100).length) + return_data.size + 97
    _44 = mem[floor32(('cd', 100).length) + mem[floor32(('cd', 100).length) + 97 len 4], Mask(224, 32, arg2) >> 32 + 97]
    if mem[floor32(('cd', 100).length) + mem[floor32(('cd', 100).length) + 97 len 4], Mask(224, 32, arg2) >> 32 + 97] > test266151307():
        revert with 'NH{q', 65
    if floor32(('cd', 100).length) + ceil32(return_data.size) + floor32(mem[floor32(('cd', 100).length) + mem[floor32(('cd', 100).length) + 97 len 4], Mask(224, 32, arg2) >> 32 + 97]) + 98 > test266151307() or floor32(mem[floor32(('cd', 100).length) + mem[floor32(('cd', 100).length) + 97 len 4], Mask(224, 32, arg2) >> 32 + 97]) + 1 < 0:
        revert with 'NH{q', 65
    mem[64] = floor32(('cd', 100).length) + ceil32(return_data.size) + floor32(mem[floor32(('cd', 100).length) + mem[floor32(('cd', 100).length) + 97 len 4], Mask(224, 32, arg2) >> 32 + 97]) + 98
    mem[floor32(('cd', 100).length) + ceil32(return_data.size) + 97] = _44
    require _43 + (32 * _44) + 32 <= return_data.size
    idx = 0
    s = floor32(('cd', 100).length) + _43 + 129
    ...
    if ('cd', 100).length < 1:
        revert with 'NH{q', 17
    if ('cd', 100).length - 1 >= _44:
        revert with 'NH{q', 50
    if mem[(32 * ('cd', 100).length - 1) + floor32(('cd', 100).length) + ceil32(return_data.size) + 129] >= cd[68]:
        ...
        call address(arg1).mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len 96], address(this.address), cd[132], mem[mem[64] + 164 len (32 * ('cd', 100).length) + 32]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
}
...
function sub_91ed1285(?) {
    ...
    if bool(stor3[address(msg.sender)]) != 1:
        revert with 0, 'no'
    mem[floor32(('cd', 100).length) + 97] = 0x1f00ca7400000000000000000000000000000000000000000000000000000000
    ...
    staticcall address(cd[4]).getAmountsIn(uint256 arg1, address[] arg2) with:
            gas gas_remaining wei
           args cd[36], Array(len=('cd', 100).length, data=mem[floor32(('cd', 100).length) + 197 len 32 * ('cd', 100).length])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[floor32(('cd', 100).length) + 97 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = floor32(('cd', 100).length) + ceil32(return_data.size) + 97
    require return_data.size >= 32
    _51 = mem[floor32(('cd', 100).length) + 97 len 4], Mask(224, 32, cd[36]) >> 32
    ...
    _52 = mem[floor32(('cd', 100).length) + mem[floor32(('cd', 100).length) + 97 len 4], Mask(224, 32, cd[36]) >> 32 + 97]
    ...
    mem[floor32(('cd', 100).length) + ceil32(return_data.size) + 97] = _52
    require _51 + (32 * _52) + 32 <= return_data.size
    idx = 0
    s = floor32(('cd', 100).length) + _51 + 129
    t = floor32(('cd', 100).length) + ceil32(return_data.size) + 129
    while idx < _52:
        require mem[s] == mem[s]
        mem[t] = mem[s]
    ...
    if 0 >= _52:
        revert with 'NH{q', 50
    if mem[floor32(('cd', 100).length) + ceil32(return_data.size) + 129] <= cd[68]:
        _69 = mem[64]
        ...
        call address(cd[4]).mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _69 + (32 * ('cd', 100).length) + -mem[64] + 192]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _80 = mem[64]
        ...
        if cd[4] < stor4.length:
            ...
            while idx < stor4.length:
                ...
                if mem[_183] > cd[36]:
                    if cd[36] > 0:
                        ...
                        call address(_194).mem[mem[64] len 4] with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _195 + (32 * _200) + -mem[64] + 160]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                    if idx == -1:
                        revert with 'NH{q', 17
                ...
                call address(_196).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _197 + (32 * _201) + -mem[64] + 160]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if idx == -1:
                    revert with 'NH{q', 17
    ...
    if not stor4.length:
        if cd[4] < stor4.length:
            ...
            while idx < cd[4]:
                ...
                staticcall stor1.mem[mem[64] len 4] with:
                        gas gas_remaining wei
                       args mem[mem[64] + 4 len _120 + (32 * _122) + -mem[64] + 96]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _174 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                call address(_292).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _293 + (32 * _302) + -mem[64] + 160]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if idx == -1:
                    revert with 'NH{q', 17
            ...
            while idx < stor4.length:
                ...
                staticcall stor1.mem[mem[64] len 4] with:
                        gas gas_remaining wei
                       args mem[mem[64] + 4 len _121 + (32 * _123) + -mem[64] + 96]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _175 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                call address(_294).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _295 + (32 * _303) + -mem[64] + 160]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if idx == -1:
                    revert with 'NH{q', 17
        ...
        if cd[4] < stor4.length:
            ...
            while idx < cd[4]:
                ...
                staticcall stor1.mem[mem[64] len 4] with:
                        gas gas_remaining wei
                       args mem[mem[64] + 4 len _256 + (32 * _264) + -mem[64] + 96]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _338 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                call address(_398).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _399 + (32 * _402) + -mem[64] + 160]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if idx == -1:
                    revert with 'NH{q', 17
            ...
            while idx < stor4.length:
                ...
                staticcall stor1.mem[mem[64] len 4] with:
                        gas gas_remaining wei
                       args mem[mem[64] + 4 len _257 + (32 * _265) + -mem[64] + 96]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _339 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                call address(_400).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _401 + (32 * _403) + -mem[64] + 160]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if idx == -1:
                    revert with 'NH{q', 17
