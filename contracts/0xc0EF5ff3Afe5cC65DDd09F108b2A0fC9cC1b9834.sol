...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    require address(stor15.field_0) - arg2
    if uint8(stor15.field_160):
            ...
            if this.address == arg2:
                ...
                if stor13 == arg2:
                    ...
                    if uint8(stor15.field_168):
                        ...
                        if arg3 < arg3 - (arg3 / 10):
                            revert with 'NH{q', 17
                        emit Transfer((arg3 / 10), arg1, this.address);
                        if not arg1 - stor10:
                            ...
                            if ext_call.return_data[0] > sub_ba0607c3:
                                if ext_call.return_data[0] < sub_ba0607c3:
                                    revert with 'NH{q', 17
                                if ext_call.return_data[0] - sub_ba0607c3 >= 2 * 10^18:
                                    sub_6bd3d45bAddress = arg2
                                if ext_call.return_data[0] - sub_ba0607c3 >= 2 * 10^17:
                                    if sub_6bd3d45bAddress != arg2:
                                        if stor16 != arg2:
                                            if stor17 != arg2:
                                                stor18 = stor17
                                                stor17 = stor16
        ...
        if unknown_0xa457c2d7(?????) > uint32(call.func_hash) >> 224:
            if unknown_0x95d89b41(?????) <= uint32(call.func_hash) >> 224:
                if uint32(call.func_hash) >> 224 != unknown_0x95d89b41(?????):
                    if unknown_0x9b1ad7fc(?????) == uint32(call.func_hash) >> 224:
                        require not msg.value
                        require calldata.size - 4 >= 32
                        require arg1 == address(arg1)
                        return bool(stor2[arg1])
                    if unknown_0x9dd58b58(?????) == uint32(call.func_hash) >> 224:
                        require not msg.value
                        return wethBalance
                    require unknown_0xa0189905(?????) == uint32(call.func_hash) >> 224
                    require not msg.value
                    require calldata.size - 4 >= 32
                    require arg1 == bool(arg1)
                    require msg.sender == stor14
