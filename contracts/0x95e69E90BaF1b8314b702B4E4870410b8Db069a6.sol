...
function _fallback() payable {
    ...
    if unknown_0x88bdd9be(?????) > uint32(call.func_hash) >> 224:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[64] = _8539 + (4 * ceil32(return_data.size)) + 224
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[12 len 20]
                ...
                if stor18[address(msg.sender)]:
                    ...
                    if owner == msg.sender:
                        ...
                        if owner == address(cd[4]):
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            mem[64] = _8541 + (4 * ceil32(return_data.size)) + 224
                            require return_data.size >= 32
                            require ext_call.return_data[0] == ext_call.return_data[12 len 20]
                            ...
                            call uniswapV2RouterAddress.mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _8541 + (4 * ceil32(return_data.size)) + (32 * mem[_8541 + (2 * ceil32(return_data.size)) + 96]) + -mem[64] + 416]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            mem[mem[64] + 4] = this.address
                            require ext_code.size(rewardTokenAddress)
