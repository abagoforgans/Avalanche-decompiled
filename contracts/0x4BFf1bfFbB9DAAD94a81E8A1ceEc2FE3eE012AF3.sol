...
function sub_c6f5eb7d(?) payable {
    ...
    if not address(cd[132]):
        ...
        call address(('cd', 164)[0]).deposit() with:
                    ...
                    if address(s) < mem[(32 * idx) + (7 * ceil32(return_data.size)) + 140 len 20]:
                        ...
                        if address(s) == address(s):
                            ...
                            if address(s) == address(s):
                                if t >= mem[(7 * ceil32(return_data.size)) + 96] - 2:
                                    ...
                                    call address(_8134).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args 0, (997 * _8186 * Mask(112, 0, _8154)) - (997 * Mask(112, 0, _8150) * Mask(112, 0, _8154)) / (3 * Mask(112, 0, _8150)) + (997 * _8186), address(cd[68]), 128, mem[_8258], mem[_8258 + 196 len ceil32(mem[_8258])]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    if not t + 1:
                                        revert with 0, 17
                                ...
                                if t >= mem[(7 * ceil32(return_data.size)) + 96] - 2:
                                    ...
                                    if ceil32(mem[_8533]) <= mem[_8533]:
                                        ...
                                        call address(_8134).mem[mem[64] len 4] with:
                                             gas gas_remaining wei
                                            args mem[mem[64] + 4 len ceil32(mem[_8533]) + _8533 + -mem[64] + 192]
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        if not t + 1:
                                            revert with 0, 17
                                        ...
                                        mem[64] = mem[64] + ceil32(return_data.size)
                                        require return_data.size >= 32
                                        if mem[_9702] < ext_call.return_data[0]:
                                            revert with 0, 17
                                        if mem[_9702] - ext_call.return_data[0] < cd[4] - (cd[4] * baseFee / DIVISOR):
                                            revert with 0, 'RBXTeleSwap: INSUFFICIENT_OUTPUT_AMOUNT'
                                        if mem[_9702] < ext_call.return_data[0]:
                                            revert with 0, 17
                                        mem[mem[64]] = mem[_9702] - ext_call.return_data[0]
                                    else:
                                        ...
                                        mem[64] = mem[64] + ceil32(return_data.size)
                                        require return_data.size >= 32
                                        if mem[_9703] < ext_call.return_data[0]:
                                            revert with 0, 17
                                        if mem[_9703] - ext_call.return_data[0] < cd[4] - (cd[4] * baseFee / DIVISOR):
                                            revert with 0, 'RBXTeleSwap: INSUFFICIENT_OUTPUT_AMOUNT'
                                        if mem[_9703] < ext_call.return_data[0]:
                                            revert with 0, 17
                                        mem[mem[64]] = mem[_9703] - ext_call.return_data[0]
                        else:
                            _8179 = mem[64]
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            ...
                            if address(s) == address(s):
                                if t >= mem[(7 * ceil32(return_data.size)) + 96] - 2:
                                    ...
                                    if ceil32(mem[_8260]) <= mem[_8260]:
                                        ...
                                        call address(_8134).mem[mem[64] len 4] with:
                                             gas gas_remaining wei
                                            args mem[mem[64] + 4 len ceil32(mem[_8260]) + _8260 + -mem[64] + 192]
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        if not t + 1:
                                            revert with 0, 17
                                        ...
                                        mem[64] = mem[64] + ceil32(return_data.size)
                                        require return_data.size >= 32
                                        if mem[_9708] < ext_call.return_data[0]:
                                            revert with 0, 17
                                        if mem[_9708] - ext_call.return_data[0] < cd[4] - (cd[4] * baseFee / DIVISOR):
                                            revert with 0, 'RBXTeleSwap: INSUFFICIENT_OUTPUT_AMOUNT'
                                        if mem[_9708] < ext_call.return_data[0]:
                                            revert with 0, 17
                                        mem[mem[64]] = mem[_9708] - ext_call.return_data[0]
                                    else:
                                        ...
                                        mem[64] = mem[64] + ceil32(return_data.size)
                                        require return_data.size >= 32
                                        if mem[_9709] < ext_call.return_data[0]:
                                            revert with 0, 17
                                        if mem[_9709] - ext_call.return_data[0] < cd[4] - (cd[4] * baseFee / DIVISOR):
                                            revert with 0, 'RBXTeleSwap: INSUFFICIENT_OUTPUT_AMOUNT'
                                        if mem[_9709] < ext_call.return_data[0]:
                                            revert with 0, 17
                                        mem[mem[64]] = mem[_9709] - ext_call.return_data[0]
                                    return memory
                                      from mem[64]
                                       len 32
                                if 2 > !t:
                                ...
                                call address(_8134).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                     gas gas_remaining wei
                                    args 0, (997 * _8187 * Mask(112, 0, _8150)) - (997 * Mask(112, 0, _8154) * Mask(112, 0, _8150)) / (3 * Mask(112, 0, _8154)) + (997 * _8187), address(_8484), 128, mem[_8536], mem[_8536 + 196 len ceil32(mem[_8536])]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not t + 1:
                                    revert with 0, 17
                            ...
                            if t >= mem[(7 * ceil32(return_data.size)) + 96] - 2:
                                ...
                                call address(_8134).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                     gas gas_remaining wei
                                    args (997 * _8187 * Mask(112, 0, _8150)) - (997 * Mask(112, 0, _8154) * Mask(112, 0, _8150)) / (3 * Mask(112, 0, _8154)) + (997 * _8187), 0, address(cd[68]), 128, mem[_8261], mem[_8261 + 196 len ceil32(mem[_8261])]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not t + 1:
                                    revert with 0, 17
                            ...
                            if ceil32(mem[_8539]) <= mem[_8539]:
                                ...
                                call address(_8134).mem[mem[64] len 4] with:
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4 len ceil32(mem[_8539]) + _8539 + -mem[64] + 192]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not t + 1:
                                    revert with 0, 17
                                ...
                                mem[64] = mem[64] + ceil32(return_data.size)
                                require return_data.size >= 32
                                if mem[_9710] < ext_call.return_data[0]:
                                    revert with 0, 17
                                if mem[_9710] - ext_call.return_data[0] < cd[4] - (cd[4] * baseFee / DIVISOR):
                                    revert with 0, 'RBXTeleSwap: INSUFFICIENT_OUTPUT_AMOUNT'
                                if mem[_9710] < ext_call.return_data[0]:
                                    revert with 0, 17
                                mem[mem[64]] = mem[_9710] - ext_call.return_data[0]
                            else:
                                ...
                                mem[64] = mem[64] + ceil32(return_data.size)
                                require return_data.size >= 32
                                if mem[_9711] < ext_call.return_data[0]:
                                    revert with 0, 17
                                if mem[_9711] - ext_call.return_data[0] < cd[4] - (cd[4] * baseFee / DIVISOR):
                                    revert with 0, 'RBXTeleSwap: INSUFFICIENT_OUTPUT_AMOUNT'
                                if mem[_9711] < ext_call.return_data[0]:
                                    revert with 0, 17
                                mem[mem[64]] = mem[_9711] - ext_call.return_data[0]
                    else:
                        ...
                        if address(s) == address(_8092):
                            ...
                            if address(s) == address(_8092):
                                ...
                                if t >= mem[(7 * ceil32(return_data.size)) + 96] - 2:
                                    ...
                                    call address(_8135).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args (997 * _8188 * Mask(112, 0, _8155)) - (997 * Mask(112, 0, _8151) * Mask(112, 0, _8155)) / (3 * Mask(112, 0, _8151)) + (997 * _8188), 0, address(cd[68]), 128, mem[_8263], mem[_8263 + 196 len ceil32(mem[_8263])]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    if not t + 1:
                                        revert with 0, 17
                                ...
                                if ceil32(mem[_8545]) <= mem[_8545]:
                                    ...
                                    call address(_8135).mem[mem[64] len 4] with:
                                         gas gas_remaining wei
                                        args mem[mem[64] + 4 len ceil32(mem[_8545]) + _8545 + -mem[64] + 192]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    if not t + 1:
                                        revert with 0, 17
                                    ...
                                    mem[64] = mem[64] + ceil32(return_data.size)
                                    require return_data.size >= 32
                                    if mem[_9718] < ext_call.return_data[0]:
                                        revert with 0, 17
                                    if mem[_9718] - ext_call.return_data[0] < cd[4] - (cd[4] * baseFee / DIVISOR):
                                        revert with 0, 'RBXTeleSwap: INSUFFICIENT_OUTPUT_AMOUNT'
                                    if mem[_9718] < ext_call.return_data[0]:
                                        revert with 0, 17
                                    mem[mem[64]] = mem[_9718] - ext_call.return_data[0]
                                else:
                                    ...
                                    mem[64] = mem[64] + ceil32(return_data.size)
                                    require return_data.size >= 32
                                    if mem[_9719] < ext_call.return_data[0]:
                                        revert with 0, 17
                                    if mem[_9719] - ext_call.return_data[0] < cd[4] - (cd[4] * baseFee / DIVISOR):
                                        revert with 0, 'RBXTeleSwap: INSUFFICIENT_OUTPUT_AMOUNT'
                                    if mem[_9719] < ext_call.return_data[0]:
                                        revert with 0, 17
                                    mem[mem[64]] = mem[_9719] - ext_call.return_data[0]
                        else:
                            _8181 = mem[64]
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            ...
                            if address(s) == address(_8092):
                                if t >= mem[(7 * ceil32(return_data.size)) + 96] - 2:
                                    ...
                                    call address(_8135).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args 0, (997 * _8189 * Mask(112, 0, _8151)) - (997 * Mask(112, 0, _8155) * Mask(112, 0, _8151)) / (3 * Mask(112, 0, _8155)) + (997 * _8189), address(cd[68]), 128, mem[_8264], mem[_8264 + 196 len ceil32(mem[_8264])]
                                else:
                                    if 2 > !t:
                                        revert with 0, 17
                                    if t + 2 >= mem[(7 * ceil32(return_data.size)) + 96]:
                                    ...
                                    call address(_8135).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args 0, (997 * _8189 * Mask(112, 0, _8151)) - (997 * Mask(112, 0, _8155) * Mask(112, 0, _8151)) / (3 * Mask(112, 0, _8155)) + (997 * _8189), address(_8488), 128, mem[_8548], mem[_8548 + 196 len ceil32(mem[_8548])]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not t + 1:
                                    revert with 0, 17
                            ...
                            if t >= mem[(7 * ceil32(return_data.size)) + 96] - 2:
                                ...
                                call address(_8135).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                     gas gas_remaining wei
                                    args (997 * _8189 * Mask(112, 0, _8151)) - (997 * Mask(112, 0, _8155) * Mask(112, 0, _8151)) / (3 * Mask(112, 0, _8155)) + (997 * _8189), 0, address(cd[68]), 128, mem[_8265], mem[_8265 + 196 len ceil32(mem[_8265])]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not t + 1:
                                    revert with 0, 17
                    ...
                    if address(s) < mem[(32 * idx) + (7 * ceil32(return_data.size)) + 140 len 20]:
                        ...
                        if address(s) == address(s):
                            ...
                            if address(s) == address(s):
                                if t >= mem[(7 * ceil32(return_data.size)) + 96] - 2:
                                    ...
                                    call address(_8136).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args 0, (997 * _8190 * Mask(112, 0, _8156)) - (997 * Mask(112, 0, _8152) * Mask(112, 0, _8156)) / (3 * Mask(112, 0, _8152)) + (997 * _8190), address(_8490), 128, mem[_8554], mem[_8554 + 196 len ceil32(mem[_8554])]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not t + 1:
                                    revert with 0, 17
                            ...
                            if ceil32(mem[_8557]) <= mem[_8557]:
                                ...
                                call address(_8136).mem[mem[64] len 4] with:
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4 len ceil32(mem[_8557]) + _8557 + -mem[64] + 192]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not t + 1:
                                    revert with 0, 17
                                ...
                                mem[64] = mem[64] + ceil32(return_data.size)
                                require return_data.size >= 32
                                if mem[_9734] < ext_call.return_data[0]:
                                    revert with 0, 17
                                if mem[_9734] - ext_call.return_data[0] < cd[4] - ((baseFee * cd[4]) + (sub_d04545cb * cd[4]) / DIVISOR):
                                    revert with 0, 'RBXTeleSwap: INSUFFICIENT_OUTPUT_AMOUNT'
                                if mem[_9734] < ext_call.return_data[0]:
                                    revert with 0, 17
                                mem[mem[64]] = mem[_9734] - ext_call.return_data[0]
                            else:
                                ...
                                mem[64] = mem[64] + ceil32(return_data.size)
                                require return_data.size >= 32
                                if mem[_9735] < ext_call.return_data[0]:
                                    revert with 0, 17
                                if mem[_9735] - ext_call.return_data[0] < cd[4] - ((baseFee * cd[4]) + (sub_d04545cb * cd[4]) / DIVISOR):
                                    revert with 0, 'RBXTeleSwap: INSUFFICIENT_OUTPUT_AMOUNT'
                                if mem[_9735] < ext_call.return_data[0]:
                                    revert with 0, 17
                                mem[mem[64]] = mem[_9735] - ext_call.return_data[0]
                        else:
                            _8183 = mem[64]
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            ...
                            if address(s) == address(s):
                                if t >= mem[(7 * ceil32(return_data.size)) + 96] - 2:
                                    ...
                                    call address(_8136).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args 0, (997 * _8191 * Mask(112, 0, _8152)) - (997 * Mask(112, 0, _8156) * Mask(112, 0, _8152)) / (3 * Mask(112, 0, _8156)) + (997 * _8191), address(cd[68]), 128, mem[_8268], mem[_8268 + 196 len ceil32(mem[_8268])]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    if not t + 1:
                                        revert with 0, 17
                        ...
                        if address(s) == address(_8093):
                            ...
                            if address(s) == address(_8093):
                                ...
                                call address(_8137).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                     gas gas_remaining wei
                                    args 0, (997 * _8193 * Mask(112, 0, _8153)) - (997 * Mask(112, 0, _8157) * Mask(112, 0, _8153)) / (3 * Mask(112, 0, _8157)) + (997 * _8193), address(_8496), 128, mem[_8572], mem[_8572 + 196 len ceil32(mem[_8572])]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not t + 1:
                                    revert with 0, 17
                            ...
                            if t >= mem[(7 * ceil32(return_data.size)) + 96] - 2:
                                ...
                                call address(_8137).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                     gas gas_remaining wei
                                    args (997 * _8193 * Mask(112, 0, _8153)) - (997 * Mask(112, 0, _8157) * Mask(112, 0, _8153)) / (3 * Mask(112, 0, _8157)) + (997 * _8193), 0, address(cd[68]), 128, mem[_8273], mem[_8273 + 196 len ceil32(mem[_8273])]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not t + 1:
                                    revert with 0, 17
