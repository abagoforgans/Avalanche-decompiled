...
function mint(uint8 arg1) payable {
    ...
    require arg1 == arg1
    if arg1 >= 5:
        revert with 0, 'Max 4 NFTs per transaction'
    if stor12 > -arg1 - 1:
        revert with 'NH{q', 17
    ...
    if stor14[address(msg.sender)] > -arg1 - 1:
        revert with 'NH{q', 17
    if stor14[address(msg.sender)] + arg1 >= 13:
        revert with 0, 'Exceeds max overall mint'
    if stor14[address(msg.sender)] > -5:
        revert with 'NH{q', 17
    mem[0] = msg.sender
    mem[32] = 14
    stor14[address(msg.sender)] += 4
    idx = 1
    while idx <= arg1:
        if stor12 == -1:
            revert with 'NH{q', 17
        ...
        if ext_code.size(msg.sender) > 0:
            ...
            require return_data.size >= 32
            require mem[_89] == Mask(32, 224, mem[_89])
            if Mask(32, 224, mem[_89]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
    ...
    if bool(stor9[arg1 << 240].field_0):
        ...
        if not bool(stor9[arg1 << 240].field_0):
            ...
            call stor7.0xc5803100 with:
               value msg.value wei
                 gas gas_remaining wei
                args arg1 << 240, 192, 256, msg.sender, 0, 352, 2 * Mask(256, -1, uint255(stor9[arg1 << 240].field_1)), Mask(248, 8, stor9[arg1 << 240].field_0), 64, msg.sender, arg2, 34, stor15, ext_call.return_data[0 len 30] >> 16, 0
        else:
            if bool(stor9[arg1 << 240].field_0) == 1:
                ...
                call stor7.0xc5803100 with:
                   value msg.value wei
                     gas gas_remaining wei
                    args arg1 << 240, 192, ceil32(uint255(stor9[arg1 << 240].field_1)) + 224, msg.sender, 0, ceil32(uint255(stor9[arg1 << 240].field_1)) + 320, 2 * Mask(256, -1, uint255(stor9[arg1 << 240].field_1)), mem[ceil32(return_data.size) + 486 len ceil32(uint255(stor9[arg1 << 240].field_1)) + 32], msg.sender, arg2, 34, stor15, ext_call.return_data[0 len 30] >> 16, 0
            else:
