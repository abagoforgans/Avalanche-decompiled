                            ...
                            if not totalSupply:
                                if balanceOf[address(this.address)] > 0:
                                    if 0 < minAmountToLiquify:
                                        ...
                                        mem[388 len 0] = None
                                        require ext_code.size(sub_ea72edcaAddress)
                                        call sub_ea72edcaAddress.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                                             gas gas_remaining wei
                                        ...
                                        require ext_code.size(sub_ea72edcaAddress)
                                        call sub_ea72edcaAddress.addLiquidityETH(address rg1, uint256 rg2, uint256 rg3, uint256 rg4, address rg5, uint256 rg6) with:
                                             gas gas_remaining wei
