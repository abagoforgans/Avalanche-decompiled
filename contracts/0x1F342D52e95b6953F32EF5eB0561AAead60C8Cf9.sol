...
function estimateZapIn(address arg1, address arg2, uint256 arg3) {
    ...
    if stor1 == address(ext_call.return_data[0]):
        if not stor2[stor1][address(arg2)]:
            if stor2[address(ext_call.return_data[0])][address(arg2)]:
                mem[(2 * ceil32(return_data.size)) + 96] = 4
                mem[(2 * ceil32(return_data.size)) + 128] = stor1
                mem[(2 * ceil32(return_data.size)) + 160] = stor1
                mem[(2 * ceil32(return_data.size)) + 192] = stor2[address(ext_call.return_data[0])][address(arg2)]
            ...
            if stor2[address(ext_call.return_data[0])][address(arg2)]:
                if stor2[stor1][address(arg2)] == stor2[address(ext_call.return_data[0])][address(arg2)]:
                    mem[(2 * ceil32(return_data.size)) + 96] = 3
                    mem[(2 * ceil32(return_data.size)) + 128] = stor1
                    mem[(2 * ceil32(return_data.size)) + 160] = stor2[stor1][address(arg2)]
                    mem[(2 * ceil32(return_data.size)) + 192] = address(ext_call.return_data[0])
                    mem[(2 * ceil32(return_data.size)) + 224] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
                    mem[(2 * ceil32(return_data.size)) + 228] = arg3 / 2
                    mem[(2 * ceil32(return_data.size)) + 260] = 64
                    ...
                    mem[(2 * ceil32(return_data.size)) + 224] = stor2[address(ext_call.return_data[0])][address(arg2)]
                ...
                if stor2[stor1][address(arg2)]:
                    if stor1 == ext_call.return_data[12 len 20]:
                        ...
                        if _3794 - 1 >= _3794:
                            revert with 0, 50
                        if stor1 != address(ext_call.return_data[0]):
                            return mem[(32 * _3794 - 1) + (4 * ceil32(return_data.size)) + 256], Mask(255, 1, arg3)
                    ...
                    if stor1 == stor1:
                        ...
                        if stor1 != ext_call.return_data[12 len 20]:
                            ...
                            if _3810 - 1 >= _3810:
                                revert with 0, 50
                            if stor1 != address(ext_call.return_data[0]):
                                return mem[(32 * _3810 - 1) + (4 * ceil32(return_data.size)) + 256], Mask(255, 1, arg3)
                ...
                if stor2[address(ext_call.return_data[0])][address(arg2)]:
                    if stor2[stor1][address(arg2)] == stor2[address(ext_call.return_data[0])][address(arg2)]:
                        ...
                        if _3819 - 1 >= _3819:
                            revert with 0, 50
                        if stor1 != address(ext_call.return_data[0]):
                            return mem[(32 * _3819 - 1) + (4 * ceil32(return_data.size)) + 256], Mask(255, 1, arg3)
                    ...
                    if stor2[stor1][address(arg2)]:
                        ...
                        if stor2[address(ext_call.return_data[0])][address(arg2)]:
                            ...
                            if _3816 - 1 >= _3816:
                                revert with 0, 50
                            if stor1 != address(ext_call.return_data[0]):
                                return mem[(32 * _3816 - 1) + (4 * ceil32(return_data.size)) + 288], Mask(255, 1, arg3)
    ...
    if not stor2[stor1][address(arg2)]:
        if stor2[address(ext_call.return_data[0])][address(arg2)]:
            ...
            if not stor2[stor1][address(arg2)]:
                ...
                if 2 >= mem[_7271]:
                    revert with 0, 50
                mem[_7271 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
                if 3 >= mem[_7271]:
                    revert with 0, 50
            ...
            if not stor2[address(ext_call.return_data[0])][address(arg2)]:
                if not stor2[stor1][address(arg2)]:
                    ...
                    if 2 >= mem[_7353]:
                        revert with 0, 50
                    mem[_7353 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
                    if 3 >= mem[_7353]:
                        revert with 0, 50
                ...
                if stor1 == address(ext_call.return_data[0]):
                    ...
                    if 1 >= mem[_7357]:
                        revert with 0, 50
                    mem[_7357 + 64] = stor2[stor1][address(arg2)]
                    if 2 >= mem[_7357]:
                        revert with 0, 50
                    mem[_7357 + 96] = stor1
                ...
                if 1 >= mem[_7355]:
                    revert with 0, 50
                mem[_7355 + 64] = stor2[stor1][address(arg2)]
                if 2 >= mem[_7355]:
                    revert with 0, 50
                mem[_7355 + 96] = stor1
                if 3 >= mem[_7355]:
            ...
            if stor2[stor1][address(arg2)] == stor2[address(ext_call.return_data[0])][address(arg2)]:
                ...
                if 1 >= mem[_7273]:
                    revert with 0, 50
                mem[_7273 + 64] = stor2[stor1][address(arg2)]
                if 2 >= mem[_7273]:
                    revert with 0, 50
            ...
            if 1 >= mem[_7275]:
                revert with 0, 50
            mem[_7275 + 64] = stor2[stor1][address(arg2)]
            if 2 >= mem[_7275]:
                revert with 0, 50
            mem[_7275 + 96] = stor1
            if 3 >= mem[_7275]:
                revert with 0, 50
            mem[_7275 + 128] = stor2[address(ext_call.return_data[0])][address(arg2)]
            if 4 >= mem[_7275]:
                revert with 0, 50
        ...
        if stor1 == stor1:
            ...
            if not stor2[stor1][address(arg2)]:
                ...
                if 2 >= mem[_7253]:
                    revert with 0, 50
                mem[_7253 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
                if 3 >= mem[_7253]:
                    revert with 0, 50
            ...
            if not stor2[address(ext_call.return_data[0])][address(arg2)]:
                if not stor2[stor1][address(arg2)]:
                    ...
                    if 2 >= mem[_7326]:
                        revert with 0, 50
                    mem[_7326 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
                    if 3 >= mem[_7326]:
                        revert with 0, 50
                ...
                if stor1 == address(ext_call.return_data[0]):
                    ...
                    if 1 >= mem[_7330]:
                        revert with 0, 50
                    mem[_7330 + 64] = stor2[stor1][address(arg2)]
                    if 2 >= mem[_7330]:
                        revert with 0, 50
                    mem[_7330 + 96] = stor1
                ...
                if 1 >= mem[_7328]:
                    revert with 0, 50
                mem[_7328 + 64] = stor2[stor1][address(arg2)]
                if 2 >= mem[_7328]:
                    revert with 0, 50
                mem[_7328 + 96] = stor1
                if 3 >= mem[_7328]:
            ...
            if stor2[stor1][address(arg2)] == stor2[address(ext_call.return_data[0])][address(arg2)]:
                ...
                if 1 >= mem[_7255]:
                    revert with 0, 50
                mem[_7255 + 64] = stor2[stor1][address(arg2)]
                if 2 >= mem[_7255]:
                    revert with 0, 50
            ...
            if 1 >= mem[_7257]:
                revert with 0, 50
            mem[_7257 + 64] = stor2[stor1][address(arg2)]
            if 2 >= mem[_7257]:
                revert with 0, 50
            mem[_7257 + 96] = stor1
            if 3 >= mem[_7257]:
                revert with 0, 50
            mem[_7257 + 128] = stor2[address(ext_call.return_data[0])][address(arg2)]
            if 4 >= mem[_7257]:
                revert with 0, 50
        ...
        if stor1 == address(ext_call.return_data[0]):
            ...
            if not stor2[stor1][address(arg2)]:
                ...
                if 2 >= mem[_7265]:
                    revert with 0, 50
                mem[_7265 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
                if 3 >= mem[_7265]:
                    revert with 0, 50
            ...
            if not stor2[address(ext_call.return_data[0])][address(arg2)]:
                if not stor2[stor1][address(arg2)]:
                    ...
                    if 2 >= mem[_7344]:
                        revert with 0, 50
                    mem[_7344 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
                    if 3 >= mem[_7344]:
                        revert with 0, 50
                ...
                if stor1 == address(ext_call.return_data[0]):
                    ...
                    if 1 >= mem[_7348]:
                        revert with 0, 50
                    mem[_7348 + 64] = stor2[stor1][address(arg2)]
                    if 2 >= mem[_7348]:
                        revert with 0, 50
                    mem[_7348 + 96] = stor1
                ...
                if 1 >= mem[_7346]:
                    revert with 0, 50
                mem[_7346 + 64] = stor2[stor1][address(arg2)]
                if 2 >= mem[_7346]:
                    revert with 0, 50
                mem[_7346 + 96] = stor1
                if 3 >= mem[_7346]:
            ...
            if stor2[stor1][address(arg2)] == stor2[address(ext_call.return_data[0])][address(arg2)]:
                ...
                if 1 >= mem[_7267]:
                    revert with 0, 50
                mem[_7267 + 64] = stor2[stor1][address(arg2)]
                if 2 >= mem[_7267]:
                    revert with 0, 50
            ...
            if 1 >= mem[_7269]:
                revert with 0, 50
            mem[_7269 + 64] = stor2[stor1][address(arg2)]
            if 2 >= mem[_7269]:
                revert with 0, 50
            mem[_7269 + 96] = stor1
            if 3 >= mem[_7269]:
                revert with 0, 50
            mem[_7269 + 128] = stor2[address(ext_call.return_data[0])][address(arg2)]
            if 4 >= mem[_7269]:
                revert with 0, 50
        ...
        if not stor2[stor1][address(arg2)]:
            ...
            if 2 >= mem[_7259]:
                revert with 0, 50
            mem[_7259 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
            if 3 >= mem[_7259]:
                revert with 0, 50
        ...
        if not stor2[address(ext_call.return_data[0])][address(arg2)]:
            if not stor2[stor1][address(arg2)]:
                ...
                if 2 >= mem[_7335]:
                    revert with 0, 50
                mem[_7335 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
                if 3 >= mem[_7335]:
                    revert with 0, 50
            ...
            if stor1 == address(ext_call.return_data[0]):
                ...
                if 1 >= mem[_7339]:
                    revert with 0, 50
                mem[_7339 + 64] = stor2[stor1][address(arg2)]
                if 2 >= mem[_7339]:
                    revert with 0, 50
                mem[_7339 + 96] = stor1
            ...
            if 1 >= mem[_7337]:
                revert with 0, 50
            mem[_7337 + 64] = stor2[stor1][address(arg2)]
            if 2 >= mem[_7337]:
                revert with 0, 50
            mem[_7337 + 96] = stor1
            if 3 >= mem[_7337]:
        ...
        if stor2[stor1][address(arg2)] == stor2[address(ext_call.return_data[0])][address(arg2)]:
            ...
            if 1 >= mem[_7261]:
                revert with 0, 50
            mem[_7261 + 64] = stor2[stor1][address(arg2)]
            if 2 >= mem[_7261]:
                revert with 0, 50
        ...
        if 1 >= mem[_7263]:
            revert with 0, 50
        mem[_7263 + 64] = stor2[stor1][address(arg2)]
        if 2 >= mem[_7263]:
            revert with 0, 50
        mem[_7263 + 96] = stor1
        if 3 >= mem[_7263]:
            revert with 0, 50
        mem[_7263 + 128] = stor2[address(ext_call.return_data[0])][address(arg2)]
        if 4 >= mem[_7263]:
            revert with 0, 50
    ...
    if stor2[address(ext_call.return_data[0])][address(arg2)]:
        if stor2[stor1][address(arg2)] == stor2[address(ext_call.return_data[0])][address(arg2)]:
            ...
            if not stor2[stor1][address(arg2)]:
                ...
                if 2 >= mem[_7313]:
                    revert with 0, 50
                mem[_7313 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
                if 3 >= mem[_7313]:
                    revert with 0, 50
            ...
            if not stor2[address(ext_call.return_data[0])][address(arg2)]:
                if not stor2[stor1][address(arg2)]:
                    ...
                    if 2 >= mem[_7416]:
                        revert with 0, 50
                    mem[_7416 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
                    if 3 >= mem[_7416]:
                        revert with 0, 50
                ...
                if stor1 == address(ext_call.return_data[0]):
                    ...
                    if 1 >= mem[_7420]:
                        revert with 0, 50
                    mem[_7420 + 64] = stor2[stor1][address(arg2)]
                    if 2 >= mem[_7420]:
                        revert with 0, 50
                    mem[_7420 + 96] = stor1
                ...
                if 1 >= mem[_7418]:
                    revert with 0, 50
                mem[_7418 + 64] = stor2[stor1][address(arg2)]
                if 2 >= mem[_7418]:
                    revert with 0, 50
                mem[_7418 + 96] = stor1
                if 3 >= mem[_7418]:
            ...
            if stor2[stor1][address(arg2)] == stor2[address(ext_call.return_data[0])][address(arg2)]:
                ...
                if 1 >= mem[_7315]:
                    revert with 0, 50
                mem[_7315 + 64] = stor2[stor1][address(arg2)]
                if 2 >= mem[_7315]:
                    revert with 0, 50
            ...
            if 1 >= mem[_7317]:
                revert with 0, 50
            mem[_7317 + 64] = stor2[stor1][address(arg2)]
            if 2 >= mem[_7317]:
                revert with 0, 50
            mem[_7317 + 96] = stor1
            if 3 >= mem[_7317]:
                revert with 0, 50
            mem[_7317 + 128] = stor2[address(ext_call.return_data[0])][address(arg2)]
            if 4 >= mem[_7317]:
                revert with 0, 50
        ...
        if not stor2[stor1][address(arg2)]:
            ...
            if 2 >= mem[_7319]:
                revert with 0, 50
            mem[_7319 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
            if 3 >= mem[_7319]:
                revert with 0, 50
        ...
        if not stor2[address(ext_call.return_data[0])][address(arg2)]:
            if not stor2[stor1][address(arg2)]:
                ...
                if 2 >= mem[_7425]:
                    revert with 0, 50
                mem[_7425 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
                if 3 >= mem[_7425]:
                    revert with 0, 50
            ...
            if stor1 == address(ext_call.return_data[0]):
                ...
                if 1 >= mem[_7429]:
                    revert with 0, 50
                mem[_7429 + 64] = stor2[stor1][address(arg2)]
                if 2 >= mem[_7429]:
                    revert with 0, 50
                mem[_7429 + 96] = stor1
            ...
            if 1 >= mem[_7427]:
                revert with 0, 50
            mem[_7427 + 64] = stor2[stor1][address(arg2)]
            if 2 >= mem[_7427]:
                revert with 0, 50
            mem[_7427 + 96] = stor1
            if 3 >= mem[_7427]:
        ...
        if stor2[stor1][address(arg2)] == stor2[address(ext_call.return_data[0])][address(arg2)]:
            ...
            if 1 >= mem[_7321]:
                revert with 0, 50
            mem[_7321 + 64] = stor2[stor1][address(arg2)]
            if 2 >= mem[_7321]:
                revert with 0, 50
        ...
        if 1 >= mem[_7323]:
            revert with 0, 50
        mem[_7323 + 64] = stor2[stor1][address(arg2)]
        if 2 >= mem[_7323]:
            revert with 0, 50
        mem[_7323 + 96] = stor1
        if 3 >= mem[_7323]:
            revert with 0, 50
        mem[_7323 + 128] = stor2[address(ext_call.return_data[0])][address(arg2)]
        if 4 >= mem[_7323]:
            revert with 0, 50
    ...
    if stor2[stor1][address(arg2)]:
        if stor1 == address(ext_call.return_data[0]):
            ...
            if not stor2[stor1][address(arg2)]:
                ...
                if 2 >= mem[_7307]:
                    revert with 0, 50
                mem[_7307 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
                if 3 >= mem[_7307]:
                    revert with 0, 50
            ...
            if not stor2[address(ext_call.return_data[0])][address(arg2)]:
                if not stor2[stor1][address(arg2)]:
                    ...
                    if 2 >= mem[_7407]:
                        revert with 0, 50
                    mem[_7407 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
                    if 3 >= mem[_7407]:
                        revert with 0, 50
                ...
                if stor1 == address(ext_call.return_data[0]):
                    ...
                    if 1 >= mem[_7411]:
                        revert with 0, 50
                    mem[_7411 + 64] = stor2[stor1][address(arg2)]
                    if 2 >= mem[_7411]:
                        revert with 0, 50
                    mem[_7411 + 96] = stor1
                ...
                if 1 >= mem[_7409]:
                    revert with 0, 50
                mem[_7409 + 64] = stor2[stor1][address(arg2)]
                if 2 >= mem[_7409]:
                    revert with 0, 50
                mem[_7409 + 96] = stor1
                if 3 >= mem[_7409]:
            ...
            if stor2[stor1][address(arg2)] == stor2[address(ext_call.return_data[0])][address(arg2)]:
                ...
                if 1 >= mem[_7309]:
                    revert with 0, 50
                mem[_7309 + 64] = stor2[stor1][address(arg2)]
                if 2 >= mem[_7309]:
                    revert with 0, 50
            ...
            if 1 >= mem[_7311]:
                revert with 0, 50
            mem[_7311 + 64] = stor2[stor1][address(arg2)]
            if 2 >= mem[_7311]:
                revert with 0, 50
            mem[_7311 + 96] = stor1
            if 3 >= mem[_7311]:
                revert with 0, 50
            mem[_7311 + 128] = stor2[address(ext_call.return_data[0])][address(arg2)]
            if 4 >= mem[_7311]:
                revert with 0, 50
        ...
        if not stor2[stor1][address(arg2)]:
            ...
            if 2 >= mem[_7301]:
                revert with 0, 50
            mem[_7301 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
            if 3 >= mem[_7301]:
                revert with 0, 50
        ...
        if not stor2[address(ext_call.return_data[0])][address(arg2)]:
            if not stor2[stor1][address(arg2)]:
                ...
                if 2 >= mem[_7398]:
                    revert with 0, 50
                mem[_7398 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
                if 3 >= mem[_7398]:
                    revert with 0, 50
            ...
            if stor1 == address(ext_call.return_data[0]):
                ...
                if 1 >= mem[_7402]:
                    revert with 0, 50
                mem[_7402 + 64] = stor2[stor1][address(arg2)]
                if 2 >= mem[_7402]:
                    revert with 0, 50
                mem[_7402 + 96] = stor1
            ...
            if 1 >= mem[_7400]:
                revert with 0, 50
            mem[_7400 + 64] = stor2[stor1][address(arg2)]
            if 2 >= mem[_7400]:
                revert with 0, 50
            mem[_7400 + 96] = stor1
            if 3 >= mem[_7400]:
        ...
        if stor2[stor1][address(arg2)] == stor2[address(ext_call.return_data[0])][address(arg2)]:
            ...
            if 1 >= mem[_7303]:
                revert with 0, 50
            mem[_7303 + 64] = stor2[stor1][address(arg2)]
            if 2 >= mem[_7303]:
                revert with 0, 50
        ...
        if 1 >= mem[_7305]:
            revert with 0, 50
        mem[_7305 + 64] = stor2[stor1][address(arg2)]
        if 2 >= mem[_7305]:
            revert with 0, 50
        mem[_7305 + 96] = stor1
        if 3 >= mem[_7305]:
            revert with 0, 50
        mem[_7305 + 128] = stor2[address(ext_call.return_data[0])][address(arg2)]
        if 4 >= mem[_7305]:
            revert with 0, 50
    ...
    if stor2[address(ext_call.return_data[0])][address(arg2)]:
        ...
        if not stor2[stor1][address(arg2)]:
            ...
            if 2 >= mem[_7295]:
                revert with 0, 50
            mem[_7295 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
            if 3 >= mem[_7295]:
                revert with 0, 50
        ...
        if not stor2[address(ext_call.return_data[0])][address(arg2)]:
            if not stor2[stor1][address(arg2)]:
                ...
                if 2 >= mem[_7389]:
                    revert with 0, 50
                mem[_7389 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
                if 3 >= mem[_7389]:
                    revert with 0, 50
            ...
            if stor1 == address(ext_call.return_data[0]):
                ...
                if 1 >= mem[_7393]:
                    revert with 0, 50
                mem[_7393 + 64] = stor2[stor1][address(arg2)]
                if 2 >= mem[_7393]:
                    revert with 0, 50
                mem[_7393 + 96] = stor1
            ...
            if 1 >= mem[_7391]:
                revert with 0, 50
            mem[_7391 + 64] = stor2[stor1][address(arg2)]
            if 2 >= mem[_7391]:
                revert with 0, 50
            mem[_7391 + 96] = stor1
            if 3 >= mem[_7391]:
        ...
        if stor2[stor1][address(arg2)] == stor2[address(ext_call.return_data[0])][address(arg2)]:
            ...
            if 1 >= mem[_7297]:
                revert with 0, 50
            mem[_7297 + 64] = stor2[stor1][address(arg2)]
            if 2 >= mem[_7297]:
                revert with 0, 50
        ...
        if 1 >= mem[_7299]:
            revert with 0, 50
        mem[_7299 + 64] = stor2[stor1][address(arg2)]
        if 2 >= mem[_7299]:
            revert with 0, 50
        mem[_7299 + 96] = stor1
        if 3 >= mem[_7299]:
            revert with 0, 50
        mem[_7299 + 128] = stor2[address(ext_call.return_data[0])][address(arg2)]
        if 4 >= mem[_7299]:
            revert with 0, 50
    ...
    if stor1 == stor1:
        ...
        if not stor2[stor1][address(arg2)]:
            ...
            if 2 >= mem[_7277]:
                revert with 0, 50
            mem[_7277 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
            if 3 >= mem[_7277]:
                revert with 0, 50
        ...
        if not stor2[address(ext_call.return_data[0])][address(arg2)]:
            if not stor2[stor1][address(arg2)]:
                ...
                if 2 >= mem[_7362]:
                    revert with 0, 50
                mem[_7362 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
                if 3 >= mem[_7362]:
                    revert with 0, 50
            ...
            if stor1 == address(ext_call.return_data[0]):
                ...
                if 1 >= mem[_7366]:
                    revert with 0, 50
                mem[_7366 + 64] = stor2[stor1][address(arg2)]
                if 2 >= mem[_7366]:
                    revert with 0, 50
                mem[_7366 + 96] = stor1
            ...
            if 1 >= mem[_7364]:
                revert with 0, 50
            mem[_7364 + 64] = stor2[stor1][address(arg2)]
            if 2 >= mem[_7364]:
                revert with 0, 50
            mem[_7364 + 96] = stor1
            if 3 >= mem[_7364]:
        ...
        if stor2[stor1][address(arg2)] == stor2[address(ext_call.return_data[0])][address(arg2)]:
            ...
            if 1 >= mem[_7279]:
                revert with 0, 50
            mem[_7279 + 64] = stor2[stor1][address(arg2)]
            if 2 >= mem[_7279]:
                revert with 0, 50
        ...
        if 1 >= mem[_7281]:
            revert with 0, 50
        mem[_7281 + 64] = stor2[stor1][address(arg2)]
        if 2 >= mem[_7281]:
            revert with 0, 50
        mem[_7281 + 96] = stor1
        if 3 >= mem[_7281]:
            revert with 0, 50
        mem[_7281 + 128] = stor2[address(ext_call.return_data[0])][address(arg2)]
        if 4 >= mem[_7281]:
            revert with 0, 50
    ...
    if stor1 == address(ext_call.return_data[0]):
        ...
        if not stor2[stor1][address(arg2)]:
            ...
            if 2 >= mem[_7289]:
                revert with 0, 50
            mem[_7289 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
            if 3 >= mem[_7289]:
                revert with 0, 50
        ...
        if not stor2[address(ext_call.return_data[0])][address(arg2)]:
            if not stor2[stor1][address(arg2)]:
                ...
                if 2 >= mem[_7380]:
                    revert with 0, 50
                mem[_7380 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
                if 3 >= mem[_7380]:
                    revert with 0, 50
            ...
            if stor1 == address(ext_call.return_data[0]):
                ...
                if 1 >= mem[_7384]:
                    revert with 0, 50
                mem[_7384 + 64] = stor2[stor1][address(arg2)]
                if 2 >= mem[_7384]:
                    revert with 0, 50
                mem[_7384 + 96] = stor1
            ...
            if 1 >= mem[_7382]:
                revert with 0, 50
            mem[_7382 + 64] = stor2[stor1][address(arg2)]
            if 2 >= mem[_7382]:
                revert with 0, 50
            mem[_7382 + 96] = stor1
            if 3 >= mem[_7382]:
        ...
        if stor2[stor1][address(arg2)] == stor2[address(ext_call.return_data[0])][address(arg2)]:
            ...
            if 1 >= mem[_7291]:
                revert with 0, 50
            mem[_7291 + 64] = stor2[stor1][address(arg2)]
            if 2 >= mem[_7291]:
                revert with 0, 50
        ...
        if 1 >= mem[_7293]:
            revert with 0, 50
        mem[_7293 + 64] = stor2[stor1][address(arg2)]
        if 2 >= mem[_7293]:
            revert with 0, 50
        mem[_7293 + 96] = stor1
        if 3 >= mem[_7293]:
            revert with 0, 50
        mem[_7293 + 128] = stor2[address(ext_call.return_data[0])][address(arg2)]
        if 4 >= mem[_7293]:
            revert with 0, 50
    ...
    if not stor2[stor1][address(arg2)]:
        ...
        if 2 >= mem[_7283]:
            revert with 0, 50
        mem[_7283 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
        if 3 >= mem[_7283]:
            revert with 0, 50
    ...
    if not stor2[address(ext_call.return_data[0])][address(arg2)]:
        if not stor2[stor1][address(arg2)]:
            ...
            if 2 >= mem[_7371]:
                revert with 0, 50
            mem[_7371 + 96] = stor2[address(ext_call.return_data[0])][address(arg2)]
            if 3 >= mem[_7371]:
                revert with 0, 50
        ...
        if stor1 == address(ext_call.return_data[0]):
            ...
            if 1 >= mem[_7375]:
                revert with 0, 50
            mem[_7375 + 64] = stor2[stor1][address(arg2)]
            if 2 >= mem[_7375]:
                revert with 0, 50
            mem[_7375 + 96] = stor1
        ...
        if 1 >= mem[_7373]:
            revert with 0, 50
        mem[_7373 + 64] = stor2[stor1][address(arg2)]
        if 2 >= mem[_7373]:
            revert with 0, 50
        mem[_7373 + 96] = stor1
        if 3 >= mem[_7373]:
    ...
    if stor2[stor1][address(arg2)] == stor2[address(ext_call.return_data[0])][address(arg2)]:
        ...
        if 1 >= mem[_7285]:
            revert with 0, 50
        mem[_7285 + 64] = stor2[stor1][address(arg2)]
        if 2 >= mem[_7285]:
            revert with 0, 50
    ...
    if 1 >= mem[_7287]:
        revert with 0, 50
    mem[_7287 + 64] = stor2[stor1][address(arg2)]
    if 2 >= mem[_7287]:
        revert with 0, 50
    mem[_7287 + 96] = stor1
    if 3 >= mem[_7287]:
        revert with 0, 50
    mem[_7287 + 128] = stor2[address(ext_call.return_data[0])][address(arg2)]
    if 4 >= mem[_7287]:
        revert with 0, 50
