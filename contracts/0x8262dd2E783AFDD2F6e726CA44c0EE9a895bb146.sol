            ...
            if unknown_0x3e0a322d(?????) == uint32(call.func_hash) >> 224:
                ...
                if uint32(call.func_hash) >> 224 != unknown_0x5e256286(?????):
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    mem[mem[64] + 4] = msg.sender
                    mem[mem[64] + 36] = 10^18 * 10^6 * _165 / 10^6 / sub_cdac724d
                    require ext_code.size(stor1)
                    call stor1.0xa9059cbb with:
                         gas gas_remaining wei
                        args msg.sender, 10^18 * 10^6 * _165 / 10^6 / sub_cdac724d
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _176 = mem[64]
                    ...
                    if sub_f85ffe77[msg.sender] > !(10^6 * _165 / 10^6):
                        revert with 0, 17
                    sub_f85ffe77[msg.sender] += 10^6 * _165 / 10^6
                    emit 0x591accc0: this.address, msg.sender, 10^18 * 10^6 * _165 / 10^6 / sub_cdac724d
}
