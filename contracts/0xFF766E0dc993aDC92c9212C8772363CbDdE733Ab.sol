...
function postUpgrade() payable {
    if owner:
        revert with 0, 'Owner already set'
    owner = 0x13b0c632ed7749f0f69a844e6ef8de26bedf85e
    emit OwnershipTransferred(owner, 0x13b0c632ed7749f0f69a844e6ef8de26bedf85e);
}
...
function deposit(uint256 arg1) payable {
    ...
    while idx < sub_21930d35.length:
        ...
        while s < _19:
            ...
            u = u + 32
            continue 
        require ext_code.size(address(sub_21930d35[_19]))
        call address(sub_21930d35[_19]).mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _17 + (32 * _19) + -mem[64] + 64]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if _19 == -1:
            revert with 'NH{q', 17
...
function withdraw(uint256 arg1) payable {
    ...
    while idx < sub_21930d35.length:
        ...
        while s < _31:
            ...
            u = u + 32
            continue 
        require ext_code.size(address(sub_21930d35[_31]))
        call address(sub_21930d35[_31]).mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len _30 + (32 * _31) + -mem[64] + 64]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if _31 == -1:
            revert with 'NH{q', 17
...
function sub_e3c7309b(?) payable {
    ...
    while idx < sub_21930d35.length:
        ...
        while s < mem[96]:
            ...
            u = u + 32
            continue 
        require ext_code.size(address(sub_21930d35[_17]))
        call address(sub_21930d35[_17]).mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len (32 * _17) + 64]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if _17 == -1:
            revert with 'NH{q', 17
...
function withdrawBatch(uint256[] arg1) payable {
    ...
    while idx < sub_21930d35.length:
        ...
        while s < mem[96]:
            ...
            u = u + 32
            continue 
        require ext_code.size(address(sub_21930d35[_28]))
        call address(sub_21930d35[_28]).mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len (32 * _28) + 64]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if _28 == -1:
            revert with 'NH{q', 17
...
function sub_70ec77e6(?) payable {
    ...
    while idx < sub_21930d35.length:
        ...
        while s < mem[96]:
            ...
            u = u + 32
            continue 
        require ext_code.size(address(sub_21930d35[_29]))
        call address(sub_21930d35[_29]).mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len (32 * _29) + 64]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if _29 == -1:
            revert with 'NH{q', 17
