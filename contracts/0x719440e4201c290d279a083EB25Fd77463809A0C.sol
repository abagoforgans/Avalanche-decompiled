...
function resources(uint256 arg1) payable {
    ...
    return address(resources[arg1].field_0)
}
...
function sets(uint256 arg1) payable {
    ...
    return address(sets[arg1].field_0)
}

function factories(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 < factories.length
    return address(factories[arg1].field_0)
}
...
function modules(uint256 arg1) payable {
    ...
    return address(modules[arg1].field_0)
}
...
function isDomani(address arg1) payable {
    require calldata.size - 4 >= 32
...
function editFeeRecipient(address arg1) payable {
    ...
    if not isInitialized:
        revert with 0, 'rContract must be initialized.'
    if owner != msg.sender:
        revert with 0, 'eOwnable: caller is not the owne'
    if not arg1:
...
function addModule(address arg1) payable {
    ...
    modules.length++
    address(modules[modules.length].field_0) = arg1
    emit ModuleAdded(arg1);
}

function addDomani(address arg1) payable {
    require calldata.size - 4 >= 32
    if not isInitialized:
        revert with 0, 'rContract must be initialized.'
    ...
    if stor5[address(arg1)]:
        revert with 0, 'Domani already exists'
    stor5[address(arg1)] = 1
    sets.length++
    address(sets[sets.length].field_0) = arg1
    emit 0xab7bbfa2: arg1, msg.sender
}
...
function addFactory(address arg1) payable {
    ...
    factories.length++
    address(factories[factories.length].field_0) = arg1
...
function addResource(address arg1, uint256 arg2) payable {
    ...
    resources.length++
    address(resources[resources.length].field_0) = arg1
    ...
    if modules.length:
        ...
        if (32 * modules.length) + 32 > 64:
            ...
            while (32 * modules.length) + 96 > idx:
                mem[idx + 32] = address(modules[s].field_256)
                idx = idx + 32
                s = s + 1
                continue 
    ...
    if factories.length:
        ...
        if (32 * factories.length) + 32 > 64:
            ...
            while (32 * factories.length) + 96 > idx:
                mem[idx + 32] = address(factories[s].field_256)
                idx = idx + 32
                s = s + 1
                continue 
    ...
    if resources.length:
        ...
        if (32 * resources.length) + 32 > 64:
            ...
            while (32 * resources.length) + 96 > idx:
                mem[idx + 32] = address(resources[s].field_256)
                idx = idx + 32
                s = s + 1
                continue 
...
function getDomanis() payable {
    ...
    while (32 * sets.length) + 96 > idx:
        mem[idx + 32] = address(sets[s].field_256)
        idx = idx + 32
        s = s + 1
        continue 
    mem[(32 * sets.length) + 192 len floor32(sets.length)] = mem[128 len floor32(sets.length)]
...
function removeDomani(address arg1) payable {
    require calldata.size - 4 >= 32
    if not isInitialized:
        revert with 0, 'rContract must be initialized.'
    if owner != msg.sender:
    ...
    if not stor5[address(arg1)]:
        revert with 0, 'Domani does not exist'
...
function removeResource(uint256 arg1) payable {
    ...
    if not resources.length:
        ...
        while idx < resources.length:
            ...
            mem[64] = (32 * resources.length) + (32 * resources.length - 1) + 160
...
function initialize(address[] arg1, address[] arg2, address[] arg3, uint256[] arg4) payable {
    ...
    if not arg1.length:
        ...
        while factories.length > idx:
            uint256(factories[idx].field_0) = 0
            idx = idx + 1
            continue 
    else:
        s = 0
        ...
        while (32 * arg1.length) + 128 > idx:
            address(factories[s].field_0) = mem[idx + 12 len 20]
            s = s + 1
            idx = idx + 32
            continue 
    ...
    if not arg2.length:
        ...
        while (32 * arg1.length) + (32 * arg2.length) + 160 > idx:
            address(modules[s].field_0) = mem[idx + 12 len 20]
            s = s + 1
            idx = idx + 32
            continue 
    ...
    if not arg3.length:
        ...
        while resources.length > idx:
            uint256(resources[idx].field_0) = 0
            idx = idx + 1
            continue 
    else:
        s = 0
        ...
        while (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 192 > idx:
            address(resources[s].field_0) = mem[idx + 12 len 20]
            s = s + 1
            idx = idx + 32
            continue 
    ...
    while idx < arg1.length:
        ...
        if not mem[(32 * idx) + 140 len 20]:
            revert with 0, 'Zero address submitted.'
        require idx < arg1.length
