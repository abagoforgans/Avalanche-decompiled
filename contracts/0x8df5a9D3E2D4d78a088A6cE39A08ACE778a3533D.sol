...
function sub_8c70c3bd(?) {
    ...
    call stor[sha3(mem[ceil32(ceil32(arg1.length)) + 97 len arg1.length + 32])].0x2e1a7d4d with:
         gas gas_remaining wei
        args arg2
    if not ext_call.success:
...
function sub_3df82e4e(?) {
    ...
    mem[arg1.length + ceil32(ceil32(arg1.length)) + 97] = 3
    require ext_code.size(stor[sha3(mem[ceil32(ceil32(arg1.length)) + 97 len arg1.length + 32])])
    call stor[sha3(mem[ceil32(ceil32(arg1.length)) + 97 len arg1.length + 32])].0xd0e30db0 with:
       value arg2 wei
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_d05429d3(?) {
    ...
    if bool(stor4.length):
        ...
        require ext_code.size(0xb4706cb4d2f33514893a91572984d83589ae52eb)
        delegate 0xb4706cb4d2f33514893a91572984d83589ae52eb.compare(string arg1, string arg2) with:
             gas gas_remaining wei
