...
function sub_2098ecb6(?) payable {
    ...
    staticcall sub_50ed1471Address.balanceOf(address rg1) with:
...
function exchangeRate() payable {
    ...
    require ext_call.return_data[0] == ext_call.return_data[0]
    require ext_code.size(sub_50ed1471Address)
    staticcall sub_50ed1471Address.totalSupply() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        require ext_code.size(sub_50ed1471Address)
        call sub_50ed1471Address.enter(uint256 rg1) with:
             gas gas_remaining wei
...
function getPendingFees() payable {
    ...
    if ceil32(_7) <= _7:
        ...
        staticcall pcsRouterAddress.getAmountsOut(uint256 rg1, address[] rg2) with:
                gas gas_remaining wei
               args _65, Array(len=sub_0400d2b0.length, data=mem[mem[64] + 100 len 32 * sub_0400d2b0.length])
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _105 = mem[64]
        ...
        staticcall pcsRouterAddress.getAmountsOut(uint256 rg1, address[] rg2) with:
                gas gas_remaining wei
               args _66, Array(len=sub_0400d2b0.length, data=mem[mem[64] + 100 len 32 * sub_0400d2b0.length])
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _106 = mem[64]
        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
...
function harvest() payable {
    ...
    if ext_call.return_data[0] > 0:
        ...
        require ext_code.size(pcsRouterAddress)
        call pcsRouterAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
             gas gas_remaining wei
        ...
        if not return_data.size:
            ...
            call sub_94f0d0bfAddress.process(uint256 rg1) with:
                 gas gas_remaining wei
                args ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            mem[_267 + (4 * ceil32(return_data.size)) + 196 len 4] = transfer(address rg1, uint256 rg2)
            ...
            mem[_267 + ceil32(return_data.size) + (4 * ceil32(return_data.size)) + 197 len 4] = transfer(address rg1, uint256 rg2)
...
function beforeDeposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        ...
        if not return_data.size:
            ...
            mem[_266 + (4 * ceil32(return_data.size)) + 196 len 4] = transfer(address rg1, uint256 rg2)
            ...
            mem[_266 + ceil32(return_data.size) + (4 * ceil32(return_data.size)) + 197 len 4] = transfer(address rg1, uint256 rg2)
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] >= arg1:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(sub_50ed1471Address)
        call sub_50ed1471Address.leave(uint256 rg1) with:
             gas gas_remaining wei
        ...
        if ext_call.return_data[0] <= arg1:
            if tx.origin == owner:
                ...
                if ext_code.size(farmingTokenAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(6 * ceil32(return_data.size)) + 260 len 96] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor151), uint32(stor151), ext_call.return_data[0], 0
                ...
                if paused:
                    ...
                    if ext_code.size(farmingTokenAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(7 * ceil32(return_data.size)) + 260 len 96] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor151), uint32(stor151), 0, 0
            ...
            if tx.origin == owner:
                ...
                if ext_code.size(farmingTokenAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[(6 * ceil32(return_data.size)) + 260 len 96] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor151), uint32(stor151), arg1, 0
                mem[(6 * ceil32(return_data.size)) + 328] = 0
                call farmingTokenAddress with:
                   funct Mask(32, 224, transfer(address rg1, uint256 rg2), Mask(224, 0, stor151), uint32(stor151), arg1, 0) >> 224
                     gas gas_remaining wei
                ...
                if paused:
                    ...
                    if ext_code.size(farmingTokenAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[(7 * ceil32(return_data.size)) + 260 len 96] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor151), uint32(stor151), arg1 - ext_call.return_data[0], 0
                    mem[(7 * ceil32(return_data.size)) + 328] = 0
                    call farmingTokenAddress with:
                       funct Mask(32, 224, transfer(address rg1, uint256 rg2), Mask(224, 0, stor151), uint32(stor151), arg1 - ext_call.return_data[0], 0) >> 224
                         gas gas_remaining wei
