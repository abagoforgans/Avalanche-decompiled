...
function statusOf(address arg1) payable {
    ...
    staticcall daoAddress.0x900cf0cf with:
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] < balanceOfClaimable[address(msg.sender)].field_1024:
        ...
        call univ2Address.0xa9059cbb with:
             gas gas_remaining wei
        ...
        require ext_code.size(univ2Address)
        staticcall univ2Address.0x70a08231 with:
                gas gas_remaining wei
               args this.address
        ...
        while idx:
            ...
            if not Mask(8, 248, mem[idx + (4 * ceil32(return_data.size)) + 223]):
                idx = idx - 1
                continue 
            mem[(4 * ceil32(return_data.size)) + 288] = 'Inconsistent UNI-V2 balances'
        ...
        mem[(4 * ceil32(return_data.size)) + 320] = 'Inconsistent UNI-V2 balances'
...
function deposit(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] < balanceOfClaimable[address(msg.sender)].field_1024:
        ...
        if stor8:
            ...
            require ext_code.size(univ2Address)
            call univ2Address.0x23b872dd with:
                 gas gas_remaining wei
            ...
            while idx:
                ...
                if not Mask(8, 248, mem[idx + (4 * ceil32(return_data.size)) + 127]):
                    idx = idx - 1
                    continue 
                mem[(4 * ceil32(return_data.size)) + 192] = 'Inconsistent UNI-V2 balances'
            ...
            mem[(4 * ceil32(return_data.size)) + 224] = 'Inconsistent UNI-V2 balances'
            mem[(4 * ceil32(return_data.size)) + 192] = 32
            idx = 32
            while idx:
                require idx - 1 < 32
...
function bond(uint256 arg1) payable {
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    if ext_call.return_data[0] + 144 < ext_call.return_data[0]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOfClaimable[address(msg.sender)].field_1024 = ext_call.return_data[0] + 144
        ...
        if ext_call.return_data[0] < totalBonded + totalStaged:
            ...
            while idx:
                ...
                if not Mask(8, 248, mem[idx + (4 * ceil32(return_data.size)) + 351]):
                    idx = idx - 1
                    continue 
                mem[(4 * ceil32(return_data.size)) + 416] = 'Inconsistent UNI-V2 balances'
            ...
            mem[(4 * ceil32(return_data.size)) + 448] = 'Inconsistent UNI-V2 balances'
        ...
        if ext_call.return_data[0] < totalBonded + totalStaged:
            ...
            while idx:
                ...
                if not Mask(8, 248, mem[idx + (6 * ceil32(return_data.size)) + 351]):
                    idx = idx - 1
                    continue 
                mem[(6 * ceil32(return_data.size)) + 416] = 'Inconsistent UNI-V2 balances'
            ...
            mem[(6 * ceil32(return_data.size)) + 448] = 'Inconsistent UNI-V2 balances'
