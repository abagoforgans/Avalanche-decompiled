...
uint256 keepPNG;
address sub_e6eeddacAddress;
address sub_276c87beAddress;
address usdcAddress;
...
function sub_276c87be(?) {
    return sub_276c87beAddress
}
...
function sub_e6eeddac(?) {
    return sub_e6eeddacAddress
}
