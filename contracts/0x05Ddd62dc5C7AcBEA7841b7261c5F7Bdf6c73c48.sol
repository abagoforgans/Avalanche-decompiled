...
function swapExactETHForTokens(uint256 arg1, uint256 arg2, address[] arg3, uint256 arg4) payable {
    ...
    call sub_282c8ebd[arg1].field_512.swapExactETHForTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
...
function sub_73169978(?) {
    ...
    if cd[36] <= ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            if not sub_282c8ebd[cd[4]].field_0:
                mem[ceil32(return_data.size) + 452] = 0x18cbafe500000000000000000000000000000000000000000000000000000000
                ...
                require ext_code.size(sub_282c8ebd[cd[4]].field_512)
                call sub_282c8ebd[cd[4]].field_512.swapExactTokensForETH(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                ...
                mem[(2 * ceil32(return_data.size)) + 452] = _707
            ...
            if (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 452 len 4], Mask(224, 32, cd[36] - (cd[36] / 10000 * sub_282c8ebd[cd[4]].field_1024)) >> 32 + 452]) + 453 > test266151307() or ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 452 len 4], Mask(224, 32, cd[36] - (cd[36] / 10000 * sub_282c8ebd[cd[4]].field_1024)) >> 32 + 452]) + 1 < 0:
                revert with 0, 65
            mem[64] = (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 452 len 4], Mask(224, 32, cd[36] - (cd[36] / 10000 * sub_282c8ebd[cd[4]].field_1024)) >> 32 + 452]) + 453
            mem[(2 * ceil32(return_data.size)) + 452] = _708
        ...
        if not ext_call.success:
            ...
            revert with 0, 'SafeERC20: low-level call failed'
        if not return_data.size:
            mem[ceil32(return_data.size) + ceil32(return_data.size) + 453] = 0x18cbafe500000000000000000000000000000000000000000000000000000000
            ...
            mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 453] = mem[ceil32(return_data.size) + ceil32(return_data.size) + mem[ceil32(return_data.size) + ceil32(return_data.size) + 453 len 4], Mask(224, 32, cd[36] - (cd[36] / 10000 * sub_282c8ebd[cd[4]].field_1024)) >> 32 + 453]
    ...
    if not return_data.size:
        if not ext_call.success:
            ...
            revert with 0, 'SafeERC20: low-level call failed'
        if not sub_282c8ebd[cd[4]].field_0:
            mem[(2 * ceil32(return_data.size)) + 452] = 0x18cbafe500000000000000000000000000000000000000000000000000000000
    ...
    if not ext_call.success:
        ...
        revert with 0, 'SafeERC20: low-level call failed'
    if not return_data.size:
        mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 453] = 0x18cbafe500000000000000000000000000000000000000000000000000000000
