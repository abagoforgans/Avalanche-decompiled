            ...
            if ('cd', 4).length:
                if 0 < ('cd', 36).length:
                    ...
                    if not address(ext_call.return_data[0]):
                        ...
                        require ext_code.size(factoryAddress)
                        staticcall factoryAddress.0x2f2750ae with:
                                gas gas_remaining wei
                        ...
                        if ('cd', 4).length <= 1:
                            ...
                            if ext_call.return_data[0] < 0:
                                ...
                                if ('cd', 4).length - 1 < _2244:
                                    _2766 = mem[(32 * ('cd', 4).length - 1) + _2208 + ceil32(return_data.size) + 32]
                                    if mem[(32 * ('cd', 4).length) + 128] <= 1:
                                        mem[mem[64]] = -mem[(32 * ('cd', 4).length - 1) + _2208 + ceil32(return_data.size) + 32]
                                    ...
                                    if ext_call.return_data[32] < 0:
                                        ...
                                        if not _2825:
                                            ...
                                            staticcall swapRouterAddress.mem[mem[64] len 4] with:
                                                    gas gas_remaining wei
                                                   args mem[mem[64] + 4 len _3261 + (32 * _3291) + -mem[64] + 96]
                                            if not ext_call.success:
                                                revert with ext_call.return_data[0 len return_data.size]
                                            _3685 = mem[64]
                                            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                        ...
                        if ('cd', 4).length <= 1:
                            ...
                            if ext_call.return_data[32] < 0:
                                ...
                                if not ('cd', 36).length:
                                    ...
                                    staticcall swapRouterAddress.getAmountsIn(uint256 rg1, address[] rg2) with:
                                            gas gas_remaining wei
                                           args mem[(32 * ('cd', 4).length) + (64 * ('cd', 36).length) + (7 * ceil32(return_data.size)) + 196 len (161 * ('cd', 36).length) + 96]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                            ...
                            if ext_call.return_data[0] < 0:
                                ...
                                if ('cd', 4).length - 1 < _2247:
                                    _2775 = mem[(32 * ('cd', 4).length - 1) + _2211 + ceil32(return_data.size) + 32]
                                    if mem[(32 * ('cd', 4).length) + 128] <= 1:
                                        mem[mem[64]] = -mem[(32 * ('cd', 4).length - 1) + _2211 + ceil32(return_data.size) + 32]
                                        mem[mem[64] + 64] = ext_call.return_data[64]
                                        mem[mem[64] + 96] = ext_call.return_data[96]
                                        return mem[mem[64]], ext_call.return_data[32], ext_call.return_data[64], ext_call.return_data[96]
                                    if ext_call.return_data[32] < 0:
                                        ...
                                        staticcall swapRouterAddress.mem[mem[64] len 4] with:
                                                gas gas_remaining wei
                                               args mem[mem[64] + 4 len _2811 + (32 * _2829) + -mem[64] + 96]
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        _3295 = mem[64]
                                        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                                    ...
                                    if not ('cd', 4).length:
                                        ...
                                        if 0 < _2822:
                                            ...
                                            if ext_call.return_data[32] < 0:
                                                ...
                                                staticcall swapRouterAddress.mem[mem[64] len 4] with:
                                                        gas gas_remaining wei
                                                       args mem[mem[64] + 4 len _3326 + (32 * _3342) + -mem[64] + 96]
                                                if not ext_call.success:
                                                    revert with ext_call.return_data[0 len return_data.size]
                                                _3686 = mem[64]
                                                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                                                ...
                                                if not _3341:
                                                    ...
                                                    staticcall swapRouterAddress.mem[mem[64] len 4] with:
                                                            gas gas_remaining wei
                                                           args mem[mem[64] + 4 len _3650 + (32 * _3678) + -mem[64] + 96]
                                                    if not ext_call.success:
                                                        revert with ext_call.return_data[0 len return_data.size]
                                                    _3898 = mem[64]
                                                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                                        ...
                                        if 0 < _2823:
                                            ...
                                            if ext_call.return_data[32] < 0:
                                                ...
                                                if not _3344:
                                                    ...
                                                    staticcall swapRouterAddress.mem[mem[64] len 4] with:
                                                            gas gas_remaining wei
                                                           args mem[mem[64] + 4 len _3659 + (32 * _3681) + -mem[64] + 96]
                                                    if not ext_call.success:
                                                        revert with ext_call.return_data[0 len return_data.size]
                                                    _3901 = mem[64]
                                                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
