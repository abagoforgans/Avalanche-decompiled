...
const sub_b3533793(?) = 10^12

const sub_c5c70035(?) = 100 * 10^6
...
function sub_9203430e(?) {
    return sub_9203430eAddress
}
...
function sub_bf56700a(?) {
    ...
    sub_9203430eAddress = address(arg2)
}
...
function totalHoldings() {
    ...
    call underlyingAddress.0x4a36d6c1 with:
         gas gas_remaining wei
...
function emergencyRedeem(uint256 arg1) {
    ...
    if 0 == totalSupply:
        if not underlyingDecimal:
            ...
            call underlyingAddress.0x4a36d6c1 with:
                 gas gas_remaining wei
                args (ext_call.return_data[0] - (arg1 / 10^18))
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            sub_4d0b0ed0 = ext_call.return_data[0]
        ...
        if bool(bool(underlyingDecimal < 78)) or bool(bool(underlyingDecimal < 32)):
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if ext_call.return_data[0] < 10^underlyingDecimal * arg1 / 10^18:
                revert with 0, 17
            call underlyingAddress.0x4a36d6c1 with:
                 gas gas_remaining wei
                args (ext_call.return_data[0] - (10^underlyingDecimal * arg1 / 10^18))
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            sub_4d0b0ed0 = ext_call.return_data[0]
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if ext_call.return_data[0] < s * t * arg1 / 10^18:
            revert with 0, 17
        call underlyingAddress.0x4a36d6c1 with:
             gas gas_remaining wei
            args (ext_call.return_data[0] - (s * t * arg1 / 10^18))
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        sub_4d0b0ed0 = ext_call.return_data[0]
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] < 10^18 * ext_call.return_data[0] / totalSupply * arg1 / 10^18:
        revert with 0, 17
    call underlyingAddress.0x4a36d6c1 with:
         gas gas_remaining wei
        args (ext_call.return_data[0] - (10^18 * ext_call.return_data[0] / totalSupply * arg1 / 10^18))
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    sub_4d0b0ed0 = ext_call.return_data[0]
