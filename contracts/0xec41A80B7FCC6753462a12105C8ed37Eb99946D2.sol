...
function contribute(uint256 arg1) payable {
    ...
    if not contributed[msg.sender]:
        ...
        if arg1 > !(contributed[msg.sender] * sub_385e0de0):
            revert with 0, 17
        if arg1 + (contributed[msg.sender] * sub_385e0de0) < arg1:
            revert with 0, 'SafeMath: addition overflow'
        if arg1 + (contributed[msg.sender] * sub_385e0de0) > sub_9d17910f:
            revert with 0, 'CONTRIBUTE: Contribution too high'
    if arg1 > !totalSold:
        revert with 0, 17
