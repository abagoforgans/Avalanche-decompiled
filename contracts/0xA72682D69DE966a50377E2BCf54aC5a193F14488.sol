...
function _fallback() payable {
    ...
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                mem[ceil32(return_data.size) + 688 len 128] = 0, 0x70bbe4a294878a14cb3cdd9315f5eb490e346163, ext_call.return_data[0], address(this.address), mem[ceil32(return_data.size) + 688 len 28]
                ...
                mem[ceil32(return_data.size) + ceil32(return_data.size) + 689 len 128] = 0, 0x70bbe4a294878a14cb3cdd9315f5eb490e346163, ext_call.return_data[0], address(this.address), mem[ceil32(return_data.size) + ceil32(return_data.size) + 689 len 28]
            ...
            if not return_data.size:
                ...
                mem[(4 * ceil32(return_data.size)) + 690 len 128] = 0, 0x70bbe4a294878a14cb3cdd9315f5eb490e346163, ext_call.return_data[0], address(this.address), mem[(4 * ceil32(return_data.size)) + 690 len 28]
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    mem[ceil32(return_data.size) + (4 * ceil32(return_data.size)) + 691 len 128] = 0, 0x70bbe4a294878a14cb3cdd9315f5eb490e346163, ext_call.return_data[0], address(this.address), mem[ceil32(return_data.size) + (4 * ceil32(return_data.size)) + 691 len 28]
