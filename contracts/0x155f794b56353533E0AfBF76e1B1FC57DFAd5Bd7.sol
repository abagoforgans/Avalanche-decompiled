...
const COMMUNITY_FUND_POOL_ALLOCATION = (125 * 10^16 * 3600)

const VESTING_DURATION = (2160 * 24 * 3600)

const DEV_FUND_POOL_ALLOCATION = (125 * 10^16 * 3600)

const FARMING_POOL_REWARD_ALLOCATION = 41000 * 10^18
...
function distributeReward(address arg1) payable {
    ...
    if totalSupply > 0xfffffffffffffffffffffffffffffffffffffffffffff75162b32b4f585fffff:
        revert with 'NH{q', 17
    totalSupply += 41000 * 10^18
    if balanceOf[address(arg1)] > 0xfffffffffffffffffffffffffffffffffffffffffffff75162b32b4f585fffff:
        revert with 'NH{q', 17
    balanceOf[address(arg1)] += 41000 * 10^18
    emit Transfer(41000 * 10^18, 0, arg1);
}
