...
address sub_3564fcf9Address;

function totalSupply() payable {
    return totalSupply
}

function sub_3564fcf9(?) payable {
    return sub_3564fcf9Address
}
...
function withdraw(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require ext_code.size(sub_3564fcf9Address)
    staticcall sub_3564fcf9Address.0x70a08231 with:
    ...
    require ext_code.size(sub_3564fcf9Address)
    call sub_3564fcf9Address.0xa9059cbb with:
         gas gas_remaining wei
...
function deposit(uint256 arg1) payable {
    ...
    if not totalSupply:
        ...
        if not ext_call.return_data[0]:
            ...
            if not msg.sender:
                revert with 0, 'ERC20: mint to the zero address'
            if totalSupply > -(arg1 * totalSupply / ext_call.return_data[0]) - 1:
                revert with 'NH{q', 17
            totalSupply += arg1 * totalSupply / ext_call.return_data[0]
            if balanceOf[address(msg.sender)] > -(arg1 * totalSupply / ext_call.return_data[0]) - 1:
                revert with 'NH{q', 17
    ...
    require ext_code.size(sub_3564fcf9Address)
    call sub_3564fcf9Address.0x23b872dd with:
         gas gas_remaining wei
