...
function fetchPrice_v() payable {
    ...
    if sub_19ad4a49Address != address(ext_call.return_data[0]):
        ...
        if not ext_call.return_data[0]:
            revert with 0, 'div by 0'
        return (10^18 * Mask(112, 0, ext_call.return_data[0]) / Mask(112, 0, ext_call.return_data[32]) / ext_call.return_data[0] / 10^18)
    ...
    if 10^18 * Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0]) * ext_call.return_data[0] / ext_call.return_data[0] != 10^18 * Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0]):
        revert with 0, 'ds-math-mul-overflow'
    return (10^18 * Mask(112, 0, ext_call.return_data[32]) / Mask(112, 0, ext_call.return_data[0]) * ext_call.return_data[0] / 10^18)
}
