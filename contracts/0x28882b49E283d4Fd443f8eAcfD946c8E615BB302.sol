...
function getBalances(address[] arg1) payable {
    ...
    if arg1.length:
        mem[128 len 32 * arg1.length] = code.data[5014 len 32 * arg1.length]
    idx = 0
...
function sub_21d318b5(?) payable {
    ...
    while uint16(idx) < ('cd', 4).length:
        ...
        mem[64] = mem[64] + 64
        mem[_501] = 25
        mem[_501 + 32] = 'transfer(address,uint256)'
        _504 = mem[64]
        ...
        mem[mem[64]] = 68
        mem[64] = mem[64] + 100
        mem[_505 + 32] = mem[_505 + 36 len 28] or Mask(32, 224, sha3('transfer(address,uint256)'))
        _508 = mem[_505]
        u = _505 + 32
        v = _504 + 100
        t = mem[_505]
        while t >= 32:
            ...
            t = t - 32
            continue 
        mem[_504 + floor32(mem[_505]) + 100] = mem[_505 + -(mem[_505] % 32) + floor32(mem[_505]) + 64 len mem[_505] % 32] or Mask(8 * -(mem[_505] % 32) + 32, -(8 * -(mem[_505] % 32) + 32) + 256, mem[_504 + floor32(mem[_505]) + 100])
        call address(cd[((32 * uint16(idx)) + cd[36] + 36)]).mem[_504 + 100 len 4] with:
             gas gas_remaining wei
            args mem[_504 + 104 len _508 - 4]
        if not return_data.size:
            if not ext_call.success:
                revert with 0, 'Safe transfer failed'
            if mem[96]:
            ...
            if ext_call.return_data[12 len 20] == address(cd[((32 * uint16(idx)) + cd[36] + 36)]):
                if not Mask(112, 0, ext_call.return_data[32]):
                    ...
                    mem[_504 + 100] = 0
                    mem[64] = _504 + 132
                    mem[_504 + 132] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                    if ext_call.return_data[12 len 20] == address(cd[((32 * uint16(idx)) + cd[36] + 36)]):
                        mem[_504 + 136] = 0
                        mem[_504 + 168] = 0 / (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * s)
                        mem[_504 + 200] = this.address
                        mem[_504 + 232] = 128
                        mem[_504 + 264] = 0
                        t = 0
                        while t < 0:
                            mem[_504 + t + 296] = mem[_504 + t + 132]
                            t = t + 32
                            continue 
                        require ext_code.size(address(cd[((32 * uint16(idx)) + cd[4] + 36)]))
                        ...
                        mem[_504 + 136] = 0 / (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * s)
                        mem[_504 + 168] = 0
                        mem[_504 + 200] = this.address
                        mem[_504 + 232] = 128
                        mem[_504 + 264] = 0
                ...
                if ext_call.return_data[12 len 20] == address(cd[((32 * uint16(idx)) + cd[36] + 36)]):
                    mem[_504 + 136] = 0
                    mem[_504 + 168] = 997 * s * Mask(112, 0, ext_call.return_data[32]) / (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * s)
                    mem[_504 + 200] = this.address
                    mem[_504 + 232] = 128
                    mem[_504 + 264] = 0
                    t = 0
                    ...
                    mem[_504 + 136] = 997 * s * Mask(112, 0, ext_call.return_data[32]) / (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * s)
                    mem[_504 + 168] = 0
                    mem[_504 + 200] = this.address
                    mem[_504 + 232] = 128
                    mem[_504 + 264] = 0
            ...
            if not Mask(112, 0, ext_call.return_data[0]):
                ...
                if ext_call.return_data[12 len 20] == address(cd[((32 * uint16(idx)) + cd[36] + 36)]):
                    mem[_504 + 136] = 0
                    mem[_504 + 168] = 0 / (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * s)
                    mem[_504 + 200] = this.address
                    mem[_504 + 232] = 128
                    mem[_504 + 264] = 0
                    t = 0
                    ...
                    mem[_504 + 136] = 0 / (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * s)
                    mem[_504 + 168] = 0
                    mem[_504 + 200] = this.address
                    mem[_504 + 232] = 128
                    mem[_504 + 264] = 0
            ...
            if ext_call.return_data[12 len 20] == address(cd[((32 * uint16(idx)) + cd[36] + 36)]):
                mem[_504 + 136] = 0
                mem[_504 + 168] = 997 * s * Mask(112, 0, ext_call.return_data[0]) / (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * s)
                mem[_504 + 200] = this.address
                mem[_504 + 232] = 128
                mem[_504 + 264] = 0
                t = 0
                ...
                mem[_504 + 136] = 997 * s * Mask(112, 0, ext_call.return_data[0]) / (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * s)
                mem[_504 + 168] = 0
                mem[_504 + 200] = this.address
                mem[_504 + 232] = 128
                mem[_504 + 264] = 0
            ...
            mem[_504 + 100] = return_data.size
            mem[_504 + 132 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
                revert with 0, 'Safe transfer failed'
            if return_data.size:
                require return_data.size >= 32
            ...
            if ext_call.return_data[12 len 20] == address(cd[((32 * uint16(idx)) + cd[36] + 36)]):
                if not Mask(112, 0, ext_call.return_data[32]):
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[_504 + ceil32(return_data.size) + 101] = 0
                    mem[64] = _504 + ceil32(return_data.size) + 133
                    mem[_504 + ceil32(return_data.size) + 133] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                    if ext_call.return_data[12 len 20] == address(cd[((32 * uint16(idx)) + cd[36] + 36)]):
                        mem[_504 + ceil32(return_data.size) + 137] = 0
                        mem[_504 + ceil32(return_data.size) + 169] = 0 / (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * s)
                        mem[_504 + ceil32(return_data.size) + 201] = this.address
                        mem[_504 + ceil32(return_data.size) + 233] = 128
                        mem[_504 + ceil32(return_data.size) + 265] = 0
                        t = 0
                        while t < 0:
                            mem[_504 + ceil32(return_data.size) + t + 297] = mem[_504 + ceil32(return_data.size) + t + 133]
                            t = t + 32
                            continue 
                        require ext_code.size(address(cd[((32 * uint16(idx)) + cd[4] + 36)]))
                        call address(cd[((32 * uint16(idx)) + cd[4] + 36)]).swap(uint256 rg1, uint256 rg2, address rg3, bytes rg4) with:
                        ...
                        mem[_504 + ceil32(return_data.size) + 137] = 0 / (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * s)
                        mem[_504 + ceil32(return_data.size) + 169] = 0
                        mem[_504 + ceil32(return_data.size) + 201] = this.address
                        mem[_504 + ceil32(return_data.size) + 233] = 128
                        mem[_504 + ceil32(return_data.size) + 265] = 0
                        t = 0
                ...
                if ext_call.return_data[12 len 20] == address(cd[((32 * uint16(idx)) + cd[36] + 36)]):
                    mem[_504 + ceil32(return_data.size) + 137] = 0
                    mem[_504 + ceil32(return_data.size) + 169] = 997 * s * Mask(112, 0, ext_call.return_data[32]) / (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * s)
                    mem[_504 + ceil32(return_data.size) + 201] = this.address
                    mem[_504 + ceil32(return_data.size) + 233] = 128
                    mem[_504 + ceil32(return_data.size) + 265] = 0
                    t = 0
                    ...
                    mem[_504 + ceil32(return_data.size) + 137] = 997 * s * Mask(112, 0, ext_call.return_data[32]) / (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * s)
                    mem[_504 + ceil32(return_data.size) + 169] = 0
                    mem[_504 + ceil32(return_data.size) + 201] = this.address
                    mem[_504 + ceil32(return_data.size) + 233] = 128
                    mem[_504 + ceil32(return_data.size) + 265] = 0
            ...
            if not Mask(112, 0, ext_call.return_data[0]):
                ...
                if ext_call.return_data[12 len 20] == address(cd[((32 * uint16(idx)) + cd[36] + 36)]):
                    mem[_504 + ceil32(return_data.size) + 137] = 0
                    mem[_504 + ceil32(return_data.size) + 169] = 0 / (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * s)
                    mem[_504 + ceil32(return_data.size) + 201] = this.address
                    mem[_504 + ceil32(return_data.size) + 233] = 128
                    mem[_504 + ceil32(return_data.size) + 265] = 0
                    t = 0
                    ...
                    mem[_504 + ceil32(return_data.size) + 137] = 0 / (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * s)
                    mem[_504 + ceil32(return_data.size) + 169] = 0
                    mem[_504 + ceil32(return_data.size) + 201] = this.address
                    mem[_504 + ceil32(return_data.size) + 233] = 128
                    mem[_504 + ceil32(return_data.size) + 265] = 0
            ...
            if ext_call.return_data[12 len 20] == address(cd[((32 * uint16(idx)) + cd[36] + 36)]):
                mem[_504 + ceil32(return_data.size) + 137] = 0
                mem[_504 + ceil32(return_data.size) + 169] = 997 * s * Mask(112, 0, ext_call.return_data[0]) / (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * s)
                mem[_504 + ceil32(return_data.size) + 201] = this.address
                mem[_504 + ceil32(return_data.size) + 233] = 128
                mem[_504 + ceil32(return_data.size) + 265] = 0
                t = 0
                ...
                mem[_504 + ceil32(return_data.size) + 137] = 997 * s * Mask(112, 0, ext_call.return_data[0]) / (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * s)
                mem[_504 + ceil32(return_data.size) + 169] = 0
                mem[_504 + ceil32(return_data.size) + 201] = this.address
                mem[_504 + ceil32(return_data.size) + 233] = 128
                mem[_504 + ceil32(return_data.size) + 265] = 0
