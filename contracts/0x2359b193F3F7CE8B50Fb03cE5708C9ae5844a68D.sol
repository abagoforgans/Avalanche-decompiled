...
function sub_5e256286(?) payable {
    ...
    mem[mem[64] + 36] = _62 / sub_cdac724d
    require ext_code.size(stor1)
    call stor1.0xa9059cbb with:
         gas gas_remaining wei
        args msg.sender, _62 / sub_cdac724d
    ...
    emit 0x591accc0: this.address, msg.sender, _62 / sub_cdac724d
}
        ...
        if unknown_0x8a14c2fd(?????) <= uint32(call.func_hash) >> 224:
            ...
            if unknown_0x5e256286(?????) > uint32(call.func_hash) >> 224:
                ...
                if uint32(call.func_hash) >> 224 != unknown_0x5e256286(?????):
                    ...
                    require return_data.size >= 32
                    _110 = mem[ceil32(return_data.size) + 224 len 4], Mask(224, 32, msg.value) >> 32
                    ...
                    _111 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 224 len 4], Mask(224, 32, msg.value) >> 32 + 224]
                    ...
                    mem[(2 * ceil32(return_data.size)) + 224] = _111
                    require return_data.size >= _110 + (32 * _111) + 32
                    mem[(2 * ceil32(return_data.size)) + 256 len 32 * _111] = mem[ceil32(return_data.size) + _110 + 256 len 32 * _111]
                    if 1 >= _111:
                        revert with 0, 50
                    _131 = mem[(2 * ceil32(return_data.size)) + 288]
                    if not sub_cdac724d:
                        revert with 0, 18
                    mem[0] = msg.sender
                    mem[32] = 10
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    mem[mem[64] + 4] = msg.sender
                    mem[mem[64] + 36] = _131 / sub_cdac724d
                    require ext_code.size(stor1)
                    call stor1.0xa9059cbb with:
                         gas gas_remaining wei
                        args msg.sender, _131 / sub_cdac724d
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _140 = mem[64]
                    ...
                    if sub_f85ffe77[msg.sender] > !_131:
                        revert with 0, 17
                    sub_f85ffe77[msg.sender] += _131
                    emit 0x591accc0: this.address, msg.sender, _131 / sub_cdac724d
}
