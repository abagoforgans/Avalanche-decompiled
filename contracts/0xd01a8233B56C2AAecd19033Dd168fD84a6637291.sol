                ...
                if not block.timestamp - poolInfo[arg1].field_512:
                    ...
                    if not (block.timestamp * sub_f60aa54f) - (poolInfo[arg1].field_512 * sub_f60aa54f):
                        ...
                        if (block.timestamp * sub_f60aa54f * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_f60aa54f * poolInfo[arg1].field_256) / totalAllocPoint < 0:
                            revert with 0, 'SafeMath: addition overflow'
                        require ext_code.size(sub_25731067Address)
                        if ext_call.return_data[0] + ((block.timestamp * sub_f60aa54f * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_f60aa54f * poolInfo[arg1].field_256) / totalAllocPoint / 10) + ((block.timestamp * sub_f60aa54f * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * sub_f60aa54f * poolInfo[arg1].field_256) / totalAllocPoint) <= 50000 * 10^18:
                            call sub_25731067Address.0x40c10f19 with:
                                 gas gas_remaining wei
                    ...
                    if not block.timestamp - poolInfo[idx].field_512:
                        ...
                        if not (block.timestamp * sub_f60aa54f) - (poolInfo[idx].field_512 * sub_f60aa54f):
                            ...
                            if (block.timestamp * sub_f60aa54f * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_f60aa54f * poolInfo[idx].field_256) / totalAllocPoint < 0:
                                revert with 0, 'SafeMath: addition overflow'
                            require ext_code.size(sub_25731067Address)
                            if ext_call.return_data[0] + ((block.timestamp * sub_f60aa54f * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_f60aa54f * poolInfo[idx].field_256) / totalAllocPoint / 10) + ((block.timestamp * sub_f60aa54f * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_f60aa54f * poolInfo[idx].field_256) / totalAllocPoint) <= 50000 * 10^18:
                                call sub_25731067Address.0x40c10f19 with:
                                     gas gas_remaining wei
