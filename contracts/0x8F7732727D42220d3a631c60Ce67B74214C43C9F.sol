...
function sub_aaaa19c8(?) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    address(stor17.field_24) = address(arg1)
}
...
function sub_9d34b691(?) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    Mask(240, 0, stor17.field_16) = Mask(240, 0, bool(arg1))
}
...
function sub_d5128535(?) payable {
    ...
    if arg2:
        ...
        Mask(80, 0, pack[-ext_call.return_data[287 len 1] + 8 << 248][uint256(pack[-ext_call.return_data[287 len 1] + 8 << 248].field_0)].field_0) = Mask(80, 0, stor12)
...
function sub_9b05e6b2(?) payable {
    ...
    if uint8(stor17.field_8):
        revert with 0, 'No reentrancy'
    Mask(248, 0, stor17.field_8) = 1
    if address(stor17.field_24) != msg.sender:
    ...
    while idx < ('cd', 4).length:
        ...
        if sub_94edf9d4[cd[((32 * idx) + cd[4] + 36)] << 240]:
            ...
            mem[_39] = mem[_38]
            require mem[_38 + 32] == mem[_38 + 63 len 1]
            mem[_39 + 32] = mem[_38 + 32]
            require mem[_38 + 64] == mem[_38 + 95 len 1]
            mem[_39 + 64] = mem[_38 + 64]
            require mem[_38 + 96] == mem[_38 + 127 len 1]
            mem[_39 + 96] = mem[_38 + 96]
            require mem[_38 + 128] == mem[_38 + 159 len 1]
            mem[_39 + 128] = mem[_38 + 128]
            require mem[_38 + 160] == mem[_38 + 191 len 1]
            mem[_39 + 160] = mem[_38 + 160]
            require mem[_38 + 192] == mem[_38 + 223 len 1]
            mem[_39 + 192] = mem[_38 + 192]
            require mem[_38 + 224] == mem[_38 + 255 len 1]
            mem[_39 + 224] = mem[_38 + 224]
            require mem[_38 + 256] == mem[_38 + 287 len 1]
            mem[_39 + 256] = mem[_38 + 256]
            if mem[_39]:
                if idx >= ('cd', 4).length:
                    revert with 'NH{q', 50
                require cd[((32 * idx) + cd[4] + 36)] == uint16(cd[((32 * idx) + cd[4] + 36)])
                ...
                _51 = mem[64]
                mem[64] = mem[64] + 96
                mem[_51] = uint16(sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_0)
                mem[_51 + 32] = Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)
                mem[_51 + 64] = address(sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_96)
                if address(sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_96) == msg.sender:
                    mem[mem[64] + 4] = uint16(cd[((32 * idx) + cd[4] + 36)])
                    staticcall address(stor17.field_24).levelOf(uint256 arg1) with:
                            gas gas_remaining wei
                           args (cd[((32 * idx) + cd[4] + 36)] << 240)
                    ...
                    if multiplier and mem[_57 + 31 len 1] > -1 / multiplier:
                        revert with 'NH{q', 17
                    if sub_000d07ce > (-1 * multiplier * mem[_57 + 31 len 1]) - 1:
                        revert with 'NH{q', 17
                    if block.timestamp < Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16):
                        revert with 'NH{q', 17
                    if block.timestamp - Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16) and sub_000d07ce + (multiplier * mem[_57 + 31 len 1]) > -1 / block.timestamp - Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16):
                        revert with 'NH{q', 17
                    if (sub_000d07ce * block.timestamp) + (multiplier * mem[_57 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_57 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 and 20 > -1 / (sub_000d07ce * block.timestamp) + (multiplier * mem[_57 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_57 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600:
                        revert with 'NH{q', 17
                    if not totalAlphaStaked:
                        if unaccountedRewards > -(20 * (sub_000d07ce * block.timestamp) + (multiplier * mem[_57 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_57 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 / 100) - 1:
                            revert with 'NH{q', 17
                        unaccountedRewards += 20 * (sub_000d07ce * block.timestamp) + (multiplier * mem[_57 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_57 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 / 100
                        if (sub_000d07ce * block.timestamp) + (multiplier * mem[_57 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_57 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 and 80 > -1 / (sub_000d07ce * block.timestamp) + (multiplier * mem[_57 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_57 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600:
                            revert with 'NH{q', 17
                        _65 = mem[64]
                        mem[64] = mem[64] + 96
                        mem[_65] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        mem[_65 + 32] = Mask(80, 0, block.timestamp)
                        mem[_65 + 64] = address(sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_96)
                    else:
                        if 20 * (sub_000d07ce * block.timestamp) + (multiplier * mem[_57 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_57 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 / 100 > -unaccountedRewards - 1:
                            revert with 'NH{q', 17
                        if not totalAlphaStaked:
                            revert with 'NH{q', 18
                        if uint256(sub_7bde72dc) > -((20 * (sub_000d07ce * block.timestamp) + (multiplier * mem[_57 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_57 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 / 100) + unaccountedRewards / totalAlphaStaked) - 1:
                            revert with 'NH{q', 17
                        uint256(sub_7bde72dc) += (20 * (sub_000d07ce * block.timestamp) + (multiplier * mem[_57 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_57 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 / 100) + unaccountedRewards / totalAlphaStaked
                        unaccountedRewards = 0
                        if (sub_000d07ce * block.timestamp) + (multiplier * mem[_57 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_57 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 and 80 > -1 / (sub_000d07ce * block.timestamp) + (multiplier * mem[_57 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_57 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600:
                            revert with 'NH{q', 17
                        _79 = mem[64]
                        mem[64] = mem[64] + 96
                        mem[_79] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        mem[_79 + 32] = Mask(80, 0, block.timestamp)
                        mem[_79 + 64] = address(sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_96)
                    mem[0] = uint16(cd[((32 * idx) + cd[4] + 36)])
                    mem[32] = 4
                    ...
                    mem[mem[64] + 32] = 80 * (sub_000d07ce * block.timestamp) + (multiplier * uint8(_59) * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * uint8(_59) * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 / 100
                    mem[mem[64] + 64] = 0
                    emit 0x77eeecee: cd[((32 * idx) + cd[4] + 36)] << 240, 80 * (sub_000d07ce * block.timestamp) + (multiplier * uint8(_59) * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * uint8(_59) * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 / 100, 0
                    if 0 > -(80 * (sub_000d07ce * block.timestamp) + (multiplier * uint8(_59) * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * uint8(_59) * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 / 100) - 1:
                        revert with 'NH{q', 17
                else:
                    if address(stor17.field_24) != msg.sender:
                        revert with 0, 'SWIPER, NO SWIPING'
                    ...
                    if multiplier and mem[_60 + 31 len 1] > -1 / multiplier:
                        revert with 'NH{q', 17
                    if sub_000d07ce > (-1 * multiplier * mem[_60 + 31 len 1]) - 1:
                        revert with 'NH{q', 17
                    if block.timestamp < Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16):
                        revert with 'NH{q', 17
                    if block.timestamp - Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16) and sub_000d07ce + (multiplier * mem[_60 + 31 len 1]) > -1 / block.timestamp - Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16):
                        revert with 'NH{q', 17
                    if (sub_000d07ce * block.timestamp) + (multiplier * mem[_60 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_60 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 and 20 > -1 / (sub_000d07ce * block.timestamp) + (multiplier * mem[_60 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_60 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600:
                        revert with 'NH{q', 17
                    if not totalAlphaStaked:
                        if unaccountedRewards > -(20 * (sub_000d07ce * block.timestamp) + (multiplier * mem[_60 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_60 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 / 100) - 1:
                            revert with 'NH{q', 17
                        unaccountedRewards += 20 * (sub_000d07ce * block.timestamp) + (multiplier * mem[_60 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_60 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 / 100
                        if (sub_000d07ce * block.timestamp) + (multiplier * mem[_60 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_60 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 and 80 > -1 / (sub_000d07ce * block.timestamp) + (multiplier * mem[_60 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_60 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600:
                            revert with 'NH{q', 17
                        _72 = mem[64]
                        mem[64] = mem[64] + 96
                        mem[_72] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        mem[_72 + 32] = Mask(80, 0, block.timestamp)
                        mem[_72 + 64] = address(sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_96)
                    else:
                        if 20 * (sub_000d07ce * block.timestamp) + (multiplier * mem[_60 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_60 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 / 100 > -unaccountedRewards - 1:
                            revert with 'NH{q', 17
                        if not totalAlphaStaked:
                            revert with 'NH{q', 18
                        if uint256(sub_7bde72dc) > -((20 * (sub_000d07ce * block.timestamp) + (multiplier * mem[_60 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_60 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 / 100) + unaccountedRewards / totalAlphaStaked) - 1:
                            revert with 'NH{q', 17
                        uint256(sub_7bde72dc) += (20 * (sub_000d07ce * block.timestamp) + (multiplier * mem[_60 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_60 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 / 100) + unaccountedRewards / totalAlphaStaked
                        unaccountedRewards = 0
                        if (sub_000d07ce * block.timestamp) + (multiplier * mem[_60 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_60 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 and 80 > -1 / (sub_000d07ce * block.timestamp) + (multiplier * mem[_60 + 31 len 1] * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * mem[_60 + 31 len 1] * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600:
                            revert with 'NH{q', 17
                        _87 = mem[64]
                        mem[64] = mem[64] + 96
                        mem[_87] = uint16(cd[((32 * idx) + cd[4] + 36)])
                        mem[_87 + 32] = Mask(80, 0, block.timestamp)
                        mem[_87 + 64] = address(sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_96)
                    mem[0] = uint16(cd[((32 * idx) + cd[4] + 36)])
                    mem[32] = 4
                    uint16(sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_0) = uint16(cd[((32 * idx) + cd[4] + 36)])
                    Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16) = Mask(80, 0, block.timestamp)
                    address(sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_96) = address(sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_96)
                    mem[mem[64]] = uint16(cd[((32 * idx) + cd[4] + 36)])
                    mem[mem[64] + 32] = 80 * (sub_000d07ce * block.timestamp) + (multiplier * uint8(_62) * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * uint8(_62) * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 / 100
                    mem[mem[64] + 64] = 0
                    emit 0x77eeecee: cd[((32 * idx) + cd[4] + 36)] << 240, 80 * (sub_000d07ce * block.timestamp) + (multiplier * uint8(_62) * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * uint8(_62) * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 / 100, 0
                    if 0 > -(80 * (sub_000d07ce * block.timestamp) + (multiplier * uint8(_62) * block.timestamp) - (sub_000d07ce * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) - (multiplier * uint8(_62) * Mask(80, 0, sub_771f2476[cd[((32 * idx) + cd[4] + 36)] << 240].field_16)) / 24 * 3600 / 100) - 1:
                        revert with 'NH{q', 17
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
            ...
            if mem[_204 + 12 len 20] == sub_b1494df2Address:
                ...
                if mem[_214]:
                    ...
                    if mem[_214]:
                        ...
                        mem[32] = 4
                        uint16(sub_771f2476[_198].field_0) = uint16(_198)
                        Mask(80, 0, sub_771f2476[_198].field_0) = Mask(80, 0, stor15)
                        Mask(80, 0, sub_771f2476[_198].field_16) = 0
                        address(sub_771f2476[_198].field_96) = address(_257)
                        ...
                        packIndices[_198] = uint256(pack[mem[0]].field_0)
                        ...
                        uint256(pack[-uint8(_374) + 8 << 248].field_0)++
                        uint16(pack[-uint8(_374) + 8 << 248][uint256(pack[-uint8(_374) + 8 << 248].field_0)].field_0) = uint16(_198)
                        Mask(80, 0, pack[-uint8(_374) + 8 << 248][uint256(pack[-uint8(_374) + 8 << 248].field_0)].field_0) = Mask(80, 0, stor12)
                        Mask(80, 0, pack[-uint8(_374) + 8 << 248][uint256(pack[-uint8(_374) + 8 << 248].field_0)].field_16) = 0
                        address(pack[-uint8(_374) + 8 << 248][uint256(pack[-uint8(_374) + 8 << 248].field_0)].field_96) = address(_257)
                        mem[mem[64]] = address(_257)
                        mem[mem[64] + 32] = _198
                    ...
                    if mem[_214]:
                        ...
                        Mask(80, 0, sub_771f2476[_198].field_0) = Mask(80, 0, stor15)
                        Mask(80, 0, sub_771f2476[_198].field_16) = 0
                        address(sub_771f2476[_198].field_96) = address(_298)
                        ...
                        uint256(pack[-uint8(_410) + 8 << 248].field_0)++
                        uint16(pack[-uint8(_410) + 8 << 248][uint256(pack[-uint8(_410) + 8 << 248].field_0)].field_0) = uint16(_198)
                        Mask(80, 0, pack[-uint8(_410) + 8 << 248][uint256(pack[-uint8(_410) + 8 << 248].field_0)].field_0) = Mask(80, 0, stor12)
                        Mask(80, 0, pack[-uint8(_410) + 8 << 248][uint256(pack[-uint8(_410) + 8 << 248].field_0)].field_16) = 0
                        address(pack[-uint8(_410) + 8 << 248][uint256(pack[-uint8(_410) + 8 << 248].field_0)].field_96) = address(_298)
                        mem[mem[64]] = address(_298)
                        mem[mem[64] + 32] = _198
                        mem[mem[64] + 64] = uint256(sub_7bde72dc)
            ...
            if mem[_205 + 12 len 20] == sub_b1494df2Address:
                ...
                if mem[_215]:
                    ...
                    if mem[_215]:
                        ...
                        mem[32] = 4
                        uint16(sub_771f2476[_200].field_0) = uint16(_200)
                        Mask(80, 0, sub_771f2476[_200].field_0) = Mask(80, 0, stor15)
                        Mask(80, 0, sub_771f2476[_200].field_16) = 0
                        address(sub_771f2476[_200].field_96) = address(_259)
                        ...
                        packIndices[_200] = uint256(pack[mem[0]].field_0)
                        ...
                        uint256(pack[-uint8(_375) + 8 << 248].field_0)++
                        uint16(pack[-uint8(_375) + 8 << 248][uint256(pack[-uint8(_375) + 8 << 248].field_0)].field_0) = uint16(_200)
                        Mask(80, 0, pack[-uint8(_375) + 8 << 248][uint256(pack[-uint8(_375) + 8 << 248].field_0)].field_0) = Mask(80, 0, stor12)
                        Mask(80, 0, pack[-uint8(_375) + 8 << 248][uint256(pack[-uint8(_375) + 8 << 248].field_0)].field_16) = 0
                        address(pack[-uint8(_375) + 8 << 248][uint256(pack[-uint8(_375) + 8 << 248].field_0)].field_96) = address(_259)
                        mem[mem[64]] = address(_259)
                        mem[mem[64] + 32] = _200
                        mem[mem[64] + 64] = uint256(sub_7bde72dc)
                    ...
                    if mem[_215]:
                        ...
                        Mask(80, 0, sub_771f2476[_200].field_0) = Mask(80, 0, stor15)
                        Mask(80, 0, sub_771f2476[_200].field_16) = 0
                        address(sub_771f2476[_200].field_96) = address(_300)
                        ...
                        uint256(pack[-uint8(_411) + 8 << 248].field_0)++
                        uint16(pack[-uint8(_411) + 8 << 248][uint256(pack[-uint8(_411) + 8 << 248].field_0)].field_0) = uint16(_200)
                        Mask(80, 0, pack[-uint8(_411) + 8 << 248][uint256(pack[-uint8(_411) + 8 << 248].field_0)].field_0) = Mask(80, 0, stor12)
                        Mask(80, 0, pack[-uint8(_411) + 8 << 248][uint256(pack[-uint8(_411) + 8 << 248].field_0)].field_16) = 0
                        address(pack[-uint8(_411) + 8 << 248][uint256(pack[-uint8(_411) + 8 << 248].field_0)].field_96) = address(_300)
                        mem[mem[64]] = address(_300)
                        mem[mem[64] + 32] = _200
                        mem[mem[64] + 64] = uint256(sub_7bde72dc)
                ...
                if uint16(cd[((32 * idx) + cd[36] + 36)]):
                    ...
                    if msg.sender == swapperAddress:
                        ...
                        if mem[_317]:
                            ...
                            uint256(pack[-uint8(_677) + 8 << 248].field_0)++
                            uint16(pack[-uint8(_677) + 8 << 248][uint256(pack[-uint8(_677) + 8 << 248].field_0)].field_0) = uint16(cd[((32 * idx) + cd[36] + 36)])
                            Mask(80, 0, pack[-uint8(_677) + 8 << 248][uint256(pack[-uint8(_677) + 8 << 248].field_0)].field_0) = Mask(80, 0, stor12)
                            Mask(80, 0, pack[-uint8(_677) + 8 << 248][uint256(pack[-uint8(_677) + 8 << 248].field_0)].field_16) = 0
                            address(pack[-uint8(_677) + 8 << 248][uint256(pack[-uint8(_677) + 8 << 248].field_0)].field_96) = address(cd[4])
                            mem[mem[64]] = address(cd[4])
                            mem[mem[64] + 32] = uint16(cd[((32 * idx) + cd[36] + 36)])
                            mem[mem[64] + 64] = uint256(sub_7bde72dc)
                        ...
                        if mem[_443]:
                            ...
                            uint256(pack[-uint8(_833) + 8 << 248].field_0)++
                            uint16(pack[-uint8(_833) + 8 << 248][uint256(pack[-uint8(_833) + 8 << 248].field_0)].field_0) = uint16(cd[((32 * idx) + cd[36] + 36)])
                            Mask(80, 0, pack[-uint8(_833) + 8 << 248][uint256(pack[-uint8(_833) + 8 << 248].field_0)].field_0) = Mask(80, 0, stor12)
                            Mask(80, 0, pack[-uint8(_833) + 8 << 248][uint256(pack[-uint8(_833) + 8 << 248].field_0)].field_16) = 0
                            address(pack[-uint8(_833) + 8 << 248][uint256(pack[-uint8(_833) + 8 << 248].field_0)].field_96) = address(cd[4])
                            mem[mem[64]] = address(cd[4])
                            mem[mem[64] + 32] = uint16(cd[((32 * idx) + cd[36] + 36)])
                            mem[mem[64] + 64] = uint256(sub_7bde72dc)
                            emit TokenStaked(address(cd[4]), cd[((32 * idx) + cd[36] + 36)] << 240, uint256(sub_7bde72dc));
                ...
                if uint16(cd[((32 * idx) + cd[36] + 36)]):
                    ...
                    if msg.sender == swapperAddress:
                        ...
                        if mem[_319]:
                            ...
                            uint256(pack[-uint8(_679) + 8 << 248].field_0)++
                            uint16(pack[-uint8(_679) + 8 << 248][uint256(pack[-uint8(_679) + 8 << 248].field_0)].field_0) = uint16(cd[((32 * idx) + cd[36] + 36)])
                            Mask(80, 0, pack[-uint8(_679) + 8 << 248][uint256(pack[-uint8(_679) + 8 << 248].field_0)].field_0) = Mask(80, 0, stor12)
                            Mask(80, 0, pack[-uint8(_679) + 8 << 248][uint256(pack[-uint8(_679) + 8 << 248].field_0)].field_16) = 0
                            address(pack[-uint8(_679) + 8 << 248][uint256(pack[-uint8(_679) + 8 << 248].field_0)].field_96) = address(cd[4])
                            mem[mem[64]] = address(cd[4])
                            mem[mem[64] + 32] = uint16(cd[((32 * idx) + cd[36] + 36)])
                            mem[mem[64] + 64] = uint256(sub_7bde72dc)
                            emit TokenStaked(address(cd[4]), cd[((32 * idx) + cd[36] + 36)] << 240, uint256(sub_7bde72dc));
                        ...
                        if mem[_444]:
                            ...
                            uint256(pack[-uint8(_834) + 8 << 248].field_0)++
                            uint16(pack[-uint8(_834) + 8 << 248][uint256(pack[-uint8(_834) + 8 << 248].field_0)].field_0) = uint16(cd[((32 * idx) + cd[36] + 36)])
                            Mask(80, 0, pack[-uint8(_834) + 8 << 248][uint256(pack[-uint8(_834) + 8 << 248].field_0)].field_0) = Mask(80, 0, stor12)
                            Mask(80, 0, pack[-uint8(_834) + 8 << 248][uint256(pack[-uint8(_834) + 8 << 248].field_0)].field_16) = 0
                            address(pack[-uint8(_834) + 8 << 248][uint256(pack[-uint8(_834) + 8 << 248].field_0)].field_96) = address(cd[4])
                            mem[mem[64]] = address(cd[4])
                            mem[mem[64] + 32] = uint16(cd[((32 * idx) + cd[36] + 36)])
                            mem[mem[64] + 64] = uint256(sub_7bde72dc)
                            emit TokenStaked(address(cd[4]), cd[((32 * idx) + cd[36] + 36)] << 240, uint256(sub_7bde72dc));
                    ...
                    if uint16(cd[((32 * idx) + cd[36] + 36)]):
                        ...
                        if msg.sender == swapperAddress:
                            ...
                            if mem[_321]:
                                ...
                                uint256(pack[-uint8(_681) + 8 << 248].field_0)++
                                uint16(pack[-uint8(_681) + 8 << 248][uint256(pack[-uint8(_681) + 8 << 248].field_0)].field_0) = uint16(cd[((32 * idx) + cd[36] + 36)])
                                Mask(80, 0, pack[-uint8(_681) + 8 << 248][uint256(pack[-uint8(_681) + 8 << 248].field_0)].field_0) = Mask(80, 0, stor12)
                                Mask(80, 0, pack[-uint8(_681) + 8 << 248][uint256(pack[-uint8(_681) + 8 << 248].field_0)].field_16) = 0
                                address(pack[-uint8(_681) + 8 << 248][uint256(pack[-uint8(_681) + 8 << 248].field_0)].field_96) = address(cd[4])
                                mem[mem[64]] = address(cd[4])
                                mem[mem[64] + 32] = uint16(cd[((32 * idx) + cd[36] + 36)])
                                mem[mem[64] + 64] = uint256(sub_7bde72dc)
                                emit TokenStaked(address(cd[4]), cd[((32 * idx) + cd[36] + 36)] << 240, uint256(sub_7bde72dc));
                            ...
                            if mem[_445]:
                                ...
                                uint256(pack[-uint8(_835) + 8 << 248].field_0)++
                                uint16(pack[-uint8(_835) + 8 << 248][uint256(pack[-uint8(_835) + 8 << 248].field_0)].field_0) = uint16(cd[((32 * idx) + cd[36] + 36)])
                                Mask(80, 0, pack[-uint8(_835) + 8 << 248][uint256(pack[-uint8(_835) + 8 << 248].field_0)].field_0) = Mask(80, 0, stor12)
                                Mask(80, 0, pack[-uint8(_835) + 8 << 248][uint256(pack[-uint8(_835) + 8 << 248].field_0)].field_16) = 0
                                address(pack[-uint8(_835) + 8 << 248][uint256(pack[-uint8(_835) + 8 << 248].field_0)].field_96) = address(cd[4])
                                mem[mem[64]] = address(cd[4])
                                mem[mem[64] + 32] = uint16(cd[((32 * idx) + cd[36] + 36)])
                                mem[mem[64] + 64] = uint256(sub_7bde72dc)
                                emit TokenStaked(address(cd[4]), cd[((32 * idx) + cd[36] + 36)] << 240, uint256(sub_7bde72dc));
                    ...
                    if uint16(cd[((32 * idx) + cd[36] + 36)]):
                        ...
                        if msg.sender == swapperAddress:
                            ...
                            if mem[_323]:
                                ...
                                uint256(pack[-uint8(_683) + 8 << 248].field_0)++
                                uint16(pack[-uint8(_683) + 8 << 248][uint256(pack[-uint8(_683) + 8 << 248].field_0)].field_0) = uint16(cd[((32 * idx) + cd[36] + 36)])
                                Mask(80, 0, pack[-uint8(_683) + 8 << 248][uint256(pack[-uint8(_683) + 8 << 248].field_0)].field_0) = Mask(80, 0, stor12)
                                Mask(80, 0, pack[-uint8(_683) + 8 << 248][uint256(pack[-uint8(_683) + 8 << 248].field_0)].field_16) = 0
                                address(pack[-uint8(_683) + 8 << 248][uint256(pack[-uint8(_683) + 8 << 248].field_0)].field_96) = address(cd[4])
                                mem[mem[64]] = address(cd[4])
                                mem[mem[64] + 32] = uint16(cd[((32 * idx) + cd[36] + 36)])
                                mem[mem[64] + 64] = uint256(sub_7bde72dc)
                                emit TokenStaked(address(cd[4]), cd[((32 * idx) + cd[36] + 36)] << 240, uint256(sub_7bde72dc));
                            ...
                            if mem[_446]:
                                ...
                                uint256(pack[-uint8(_836) + 8 << 248].field_0)++
                                uint16(pack[-uint8(_836) + 8 << 248][uint256(pack[-uint8(_836) + 8 << 248].field_0)].field_0) = uint16(cd[((32 * idx) + cd[36] + 36)])
                                Mask(80, 0, pack[-uint8(_836) + 8 << 248][uint256(pack[-uint8(_836) + 8 << 248].field_0)].field_0) = Mask(80, 0, stor12)
                                Mask(80, 0, pack[-uint8(_836) + 8 << 248][uint256(pack[-uint8(_836) + 8 << 248].field_0)].field_16) = 0
                                address(pack[-uint8(_836) + 8 << 248][uint256(pack[-uint8(_836) + 8 << 248].field_0)].field_96) = address(cd[4])
                                mem[mem[64]] = address(cd[4])
                                mem[mem[64] + 32] = uint16(cd[((32 * idx) + cd[36] + 36)])
                                mem[mem[64] + 64] = uint256(sub_7bde72dc)
                                emit TokenStaked(address(cd[4]), cd[((32 * idx) + cd[36] + 36)] << 240, uint256(sub_7bde72dc));
                    ...
                    if uint16(cd[((32 * idx) + cd[36] + 36)]):
                        ...
                        if msg.sender == swapperAddress:
                            ...
                            if mem[_325]:
                                ...
                                uint256(pack[-uint8(_685) + 8 << 248].field_0)++
                                uint16(pack[-uint8(_685) + 8 << 248][uint256(pack[-uint8(_685) + 8 << 248].field_0)].field_0) = uint16(cd[((32 * idx) + cd[36] + 36)])
                                Mask(80, 0, pack[-uint8(_685) + 8 << 248][uint256(pack[-uint8(_685) + 8 << 248].field_0)].field_0) = Mask(80, 0, stor12)
                                Mask(80, 0, pack[-uint8(_685) + 8 << 248][uint256(pack[-uint8(_685) + 8 << 248].field_0)].field_16) = 0
                                address(pack[-uint8(_685) + 8 << 248][uint256(pack[-uint8(_685) + 8 << 248].field_0)].field_96) = address(cd[4])
                                mem[mem[64]] = address(cd[4])
                                mem[mem[64] + 32] = uint16(cd[((32 * idx) + cd[36] + 36)])
                                mem[mem[64] + 64] = uint256(sub_7bde72dc)
                                emit TokenStaked(address(cd[4]), cd[((32 * idx) + cd[36] + 36)] << 240, uint256(sub_7bde72dc));
                            ...
                            if mem[_447]:
                                ...
                                uint256(pack[-uint8(_837) + 8 << 248].field_0)++
                                uint16(pack[-uint8(_837) + 8 << 248][uint256(pack[-uint8(_837) + 8 << 248].field_0)].field_0) = uint16(cd[((32 * idx) + cd[36] + 36)])
                                Mask(80, 0, pack[-uint8(_837) + 8 << 248][uint256(pack[-uint8(_837) + 8 << 248].field_0)].field_0) = Mask(80, 0, stor12)
                                Mask(80, 0, pack[-uint8(_837) + 8 << 248][uint256(pack[-uint8(_837) + 8 << 248].field_0)].field_16) = 0
                                address(pack[-uint8(_837) + 8 << 248][uint256(pack[-uint8(_837) + 8 << 248].field_0)].field_96) = address(cd[4])
                                mem[mem[64]] = address(cd[4])
                                mem[mem[64] + 32] = uint16(cd[((32 * idx) + cd[36] + 36)])
                                mem[mem[64] + 64] = uint256(sub_7bde72dc)
                                emit TokenStaked(address(cd[4]), cd[((32 * idx) + cd[36] + 36)] << 240, uint256(sub_7bde72dc));
                    ...
                    if uint16(cd[((32 * idx) + cd[36] + 36)]):
                        ...
                        if msg.sender == swapperAddress:
                            ...
                            if mem[_327]:
                                ...
                                uint256(pack[-uint8(_687) + 8 << 248].field_0)++
                                uint16(pack[-uint8(_687) + 8 << 248][uint256(pack[-uint8(_687) + 8 << 248].field_0)].field_0) = uint16(cd[((32 * idx) + cd[36] + 36)])
                                Mask(80, 0, pack[-uint8(_687) + 8 << 248][uint256(pack[-uint8(_687) + 8 << 248].field_0)].field_0) = Mask(80, 0, stor12)
                                Mask(80, 0, pack[-uint8(_687) + 8 << 248][uint256(pack[-uint8(_687) + 8 << 248].field_0)].field_16) = 0
                                address(pack[-uint8(_687) + 8 << 248][uint256(pack[-uint8(_687) + 8 << 248].field_0)].field_96) = address(cd[4])
                                mem[mem[64]] = address(cd[4])
                                mem[mem[64] + 32] = uint16(cd[((32 * idx) + cd[36] + 36)])
                                mem[mem[64] + 64] = uint256(sub_7bde72dc)
                                emit TokenStaked(address(cd[4]), cd[((32 * idx) + cd[36] + 36)] << 240, uint256(sub_7bde72dc));
                            ...
                            if mem[_448]:
                                ...
                                uint256(pack[-uint8(_838) + 8 << 248].field_0)++
                                uint16(pack[-uint8(_838) + 8 << 248][uint256(pack[-uint8(_838) + 8 << 248].field_0)].field_0) = uint16(cd[((32 * idx) + cd[36] + 36)])
                                Mask(80, 0, pack[-uint8(_838) + 8 << 248][uint256(pack[-uint8(_838) + 8 << 248].field_0)].field_0) = Mask(80, 0, stor12)
                                Mask(80, 0, pack[-uint8(_838) + 8 << 248][uint256(pack[-uint8(_838) + 8 << 248].field_0)].field_16) = 0
                                address(pack[-uint8(_838) + 8 << 248][uint256(pack[-uint8(_838) + 8 << 248].field_0)].field_96) = address(cd[4])
                                mem[mem[64]] = address(cd[4])
                                mem[mem[64] + 32] = uint16(cd[((32 * idx) + cd[36] + 36)])
                                mem[mem[64] + 64] = uint256(sub_7bde72dc)
                                emit TokenStaked(address(cd[4]), cd[((32 * idx) + cd[36] + 36)] << 240, uint256(sub_7bde72dc));
