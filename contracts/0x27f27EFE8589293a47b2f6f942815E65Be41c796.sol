...
function sub_a1040c0c(?) payable {
    ...
    return 64, 
           ...
           mem[(2 * ceil32(return_data.size)) + 176 len 16],
           mem[(2 * ceil32(return_data.size)) + 208 len 16],
           128,
           address(arg1),
...
function sub_1d6bfcd8(?) payable {
    ...
    if arg1 >= ext_call.return_data[0]:
        revert with 0, 'Invalid pid!'
    require ext_code.size(0x290000000000000000000000001f806f7c8ded893fd3cae279191ad7aa3798e9)
    staticcall 0x290000000000000000000000001f806f7c8ded893fd3cae279191ad7aa3798e9.userInfo(uint256 arg1, address arg2) with:
            gas gas_remaining wei
           args arg1, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
