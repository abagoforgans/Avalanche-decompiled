...
uint256 stor4;
address sub_e25e1c3aAddress;
uint256 withdrawalFee;
uint256 callFee;
uint256 sub_173c1771;
...
function sub_e25e1c3a(?) payable {
    return sub_e25e1c3aAddress
}
...
function setBorgFeeRecipient(address arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_e25e1c3aAddress = arg1
}
...
function harvest() payable {
    ...
    if ext_call.return_data[0] > 0:
        ...
        mem[260] = 160
        mem[356] = nativeToWantRoute.length
        if not nativeToWantRoute.length:
            ...
            call address(unirouterAddress).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args ext_call.return_data[0], 0, 160, address(this.address), 0, block.timestamp, nativeToWantRoute.length
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[192 len return_data.size] = ext_call.return_data[0 len return_data.size]
            mem[64] = ceil32(return_data.size) + 192
            require return_data.size >= 32
            _68 = mem[192 len 4], ext_call.return_data[0 len 28]
            ...
            if ext_call.return_data[0] - reserves > 0:
                if ext_call.return_data[0] - reserves >= minLeverage:
                    idx = 0
                    s = mem[(32 * _71) + ceil32(return_data.size) + 224] - reserves
                    while idx < borrowDepth:
                        mem[(32 * _71) + ceil32(return_data.size) + 224] = 0xe8eda9df00000000000000000000000000000000000000000000000000000000
                        mem[(32 * _71) + ceil32(return_data.size) + 228] = address(wantAddress)
                        mem[(32 * _71) + ceil32(return_data.size) + 260] = s
                        mem[(32 * _71) + ceil32(return_data.size) + 292] = this.address
                        mem[(32 * _71) + ceil32(return_data.size) + 324] = 0
                        require ext_code.size(address(lendingPoolAddress))
                        call address(lendingPoolAddress).deposit(address arg1, uint256 arg2, address arg3, uint16 arg4) with:
                             gas gas_remaining wei
                            args address(wantAddress), s, address(this.address), 0
                        ...
                        if s * borrowRate / s != borrowRate:
                            revert with 0, 'lSafeMath: multiplication overflo'
                        if s * borrowRate / 100 > 0:
                            mem[(32 * _71) + ceil32(return_data.size) + 224] = 0xa415bcad00000000000000000000000000000000000000000000000000000000
                            mem[(32 * _71) + ceil32(return_data.size) + 228] = address(wantAddress)
                            mem[(32 * _71) + ceil32(return_data.size) + 260] = s * borrowRate / 100
                            mem[(32 * _71) + ceil32(return_data.size) + 292] = 2
                            mem[(32 * _71) + ceil32(return_data.size) + 324] = 0
                            mem[(32 * _71) + ceil32(return_data.size) + 356] = this.address
                            require ext_code.size(address(lendingPoolAddress))
                            call address(lendingPoolAddress).borrow(address arg1, uint256 arg2, uint256 arg3, uint16 arg4, address arg5) with:
                                 gas gas_remaining wei
                                args address(wantAddress), s * borrowRate / 100, 2, 0, this.address
            ...
            mem[0] = 16
            mem[388] = address(nativeToWantRoute.field_0)
            idx = 388
            s = 0
            while (32 * nativeToWantRoute.length) + 388 > idx + 32:
                mem[idx + 32] = nativeToWantRoute[s].field_256
                idx = idx + 32
                s = s + 1
                continue 
            ...
            call address(unirouterAddress).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args ext_call.return_data[0], 0, 160, address(this.address), 0, block.timestamp, nativeToWantRoute.length, mem[388 len 32 * nativeToWantRoute.length]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[192 len return_data.size] = ext_call.return_data[0 len return_data.size]
            mem[64] = ceil32(return_data.size) + 192
            require return_data.size >= 32
            _124 = mem[192 len 4], ext_call.return_data[0 len 28]
            require mem[192 len 4], ext_call.return_data[0 len 28] <= 4294967296
            require mem[192 len 4], ext_call.return_data[0 len 28] + 32 <= return_data.size
            require mem[mem[192 len 4], ext_call.return_data[0 len 28] + 192] <= 4294967296 and mem[192 len 4], ext_call.return_data[0 len 28] + (32 * mem[mem[192 len 4], ext_call.return_data[0 len 28] + 192]) + 32 <= return_data.size
            mem[ceil32(return_data.size) + 192] = mem[mem[192 len 4], ext_call.return_data[0 len 28] + 192]
            _127 = mem[_124 + 192]
            mem[ceil32(return_data.size) + 224 len floor32(mem[_124 + 192])] = mem[_124 + 224 len floor32(mem[_124 + 192])]
            if uint8(stor0.field_160):
                revert with 0, 'Pausable: paused'
            require ext_code.size(address(wantAddress))
            staticcall address(wantAddress).0x70a08231 with:
                    gas gas_remaining wei
                   args this.address
            mem[(32 * _127) + ceil32(return_data.size) + 224] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if reserves > ext_call.return_data[0]:
            ...
            if ext_call.return_data[0] - reserves > 0:
                if ext_call.return_data[0] - reserves >= minLeverage:
                    idx = 0
                    s = mem[(32 * _127) + ceil32(return_data.size) + 224] - reserves
                    while idx < borrowDepth:
                        mem[(32 * _127) + ceil32(return_data.size) + 224] = 0xe8eda9df00000000000000000000000000000000000000000000000000000000
                        mem[(32 * _127) + ceil32(return_data.size) + 228] = address(wantAddress)
                        mem[(32 * _127) + ceil32(return_data.size) + 260] = s
                        mem[(32 * _127) + ceil32(return_data.size) + 292] = this.address
                        mem[(32 * _127) + ceil32(return_data.size) + 324] = 0
                        require ext_code.size(address(lendingPoolAddress))
                        call address(lendingPoolAddress).deposit(address arg1, uint256 arg2, address arg3, uint16 arg4) with:
                             gas gas_remaining wei
                            args address(wantAddress), s, address(this.address), 0
                        ...
                        if s * borrowRate / s != borrowRate:
                            revert with 0, 'lSafeMath: multiplication overflo'
                        if s * borrowRate / 100 > 0:
                            mem[(32 * _127) + ceil32(return_data.size) + 224] = 0xa415bcad00000000000000000000000000000000000000000000000000000000
                            mem[(32 * _127) + ceil32(return_data.size) + 228] = address(wantAddress)
                            mem[(32 * _127) + ceil32(return_data.size) + 260] = s * borrowRate / 100
                            mem[(32 * _127) + ceil32(return_data.size) + 292] = 2
                            mem[(32 * _127) + ceil32(return_data.size) + 324] = 0
    ...
    if stor17:
        ...
        if ext_call.return_data[0] > 0:
            ...
            if not nativeToWantRoute.length:
                ...
                mem[64] = ceil32(return_data.size) + 192
                require return_data.size >= 32
                _70 = mem[192 len 4], ext_call.return_data[0 len 28]
                require mem[192 len 4], ext_call.return_data[0 len 28] <= 4294967296
                require mem[192 len 4], ext_call.return_data[0 len 28] + 32 <= return_data.size
                require mem[mem[192 len 4], ext_call.return_data[0 len 28] + 192] <= 4294967296 and mem[192 len 4], ext_call.return_data[0 len 28] + (32 * mem[mem[192 len 4], ext_call.return_data[0 len 28] + 192]) + 32 <= return_data.size
                mem[ceil32(return_data.size) + 192] = mem[mem[192 len 4], ext_call.return_data[0 len 28] + 192]
                ...
                staticcall address(wantAddress).0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                mem[(32 * _73) + ceil32(return_data.size) + 224] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                if reserves > ext_call.return_data[0]:
                ...
                if ext_call.return_data[0] - reserves > 0:
                    if ext_call.return_data[0] - reserves >= minLeverage:
                        idx = 0
                        s = mem[(32 * _73) + ceil32(return_data.size) + 224] - reserves
                        while idx < borrowDepth:
                            mem[(32 * _73) + ceil32(return_data.size) + 224] = 0xe8eda9df00000000000000000000000000000000000000000000000000000000
                            mem[(32 * _73) + ceil32(return_data.size) + 228] = address(wantAddress)
                            mem[(32 * _73) + ceil32(return_data.size) + 260] = s
                            mem[(32 * _73) + ceil32(return_data.size) + 292] = this.address
                            mem[(32 * _73) + ceil32(return_data.size) + 324] = 0
                            require ext_code.size(address(lendingPoolAddress))
                            call address(lendingPoolAddress).deposit(address arg1, uint256 arg2, address arg3, uint16 arg4) with:
                                 gas gas_remaining wei
                                args address(wantAddress), s, address(this.address), 0
                            ...
                            if s * borrowRate / s != borrowRate:
                                revert with 0, 'lSafeMath: multiplication overflo'
                            if s * borrowRate / 100 > 0:
                                mem[(32 * _73) + ceil32(return_data.size) + 224] = 0xa415bcad00000000000000000000000000000000000000000000000000000000
                                mem[(32 * _73) + ceil32(return_data.size) + 228] = address(wantAddress)
                                mem[(32 * _73) + ceil32(return_data.size) + 260] = s * borrowRate / 100
                                mem[(32 * _73) + ceil32(return_data.size) + 292] = 2
                                mem[(32 * _73) + ceil32(return_data.size) + 324] = 0
                                mem[(32 * _73) + ceil32(return_data.size) + 356] = this.address
                                require ext_code.size(address(lendingPoolAddress))
                                call address(lendingPoolAddress).borrow(address arg1, uint256 arg2, uint256 arg3, uint16 arg4, address arg5) with:
                                     gas gas_remaining wei
                                    args address(wantAddress), s * borrowRate / 100, 2, 0, this.address
                ...
                mem[64] = ceil32(return_data.size) + 192
                require return_data.size >= 32
                _126 = mem[192 len 4], ext_call.return_data[0 len 28]
                require mem[192 len 4], ext_call.return_data[0 len 28] <= 4294967296
                require mem[192 len 4], ext_call.return_data[0 len 28] + 32 <= return_data.size
                require mem[mem[192 len 4], ext_call.return_data[0 len 28] + 192] <= 4294967296 and mem[192 len 4], ext_call.return_data[0 len 28] + (32 * mem[mem[192 len 4], ext_call.return_data[0 len 28] + 192]) + 32 <= return_data.size
                mem[ceil32(return_data.size) + 192] = mem[mem[192 len 4], ext_call.return_data[0 len 28] + 192]
                _129 = mem[_126 + 192]
                mem[ceil32(return_data.size) + 224 len floor32(mem[_126 + 192])] = mem[_126 + 224 len floor32(mem[_126 + 192])]
                if uint8(stor0.field_160):
                    revert with 0, 'Pausable: paused'
                require ext_code.size(address(wantAddress))
                staticcall address(wantAddress).0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                mem[(32 * _129) + ceil32(return_data.size) + 224] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                if reserves > ext_call.return_data[0]:
                ...
                if ext_call.return_data[0] - reserves > 0:
                    if ext_call.return_data[0] - reserves >= minLeverage:
                        idx = 0
                        s = mem[(32 * _129) + ceil32(return_data.size) + 224] - reserves
                        while idx < borrowDepth:
                            mem[(32 * _129) + ceil32(return_data.size) + 224] = 0xe8eda9df00000000000000000000000000000000000000000000000000000000
                            mem[(32 * _129) + ceil32(return_data.size) + 228] = address(wantAddress)
                            mem[(32 * _129) + ceil32(return_data.size) + 260] = s
                            mem[(32 * _129) + ceil32(return_data.size) + 292] = this.address
                            mem[(32 * _129) + ceil32(return_data.size) + 324] = 0
                            require ext_code.size(address(lendingPoolAddress))
                            call address(lendingPoolAddress).deposit(address arg1, uint256 arg2, address arg3, uint16 arg4) with:
                                 gas gas_remaining wei
                                args address(wantAddress), s, address(this.address), 0
                            ...
                            if s * borrowRate / s != borrowRate:
                                revert with 0, 'lSafeMath: multiplication overflo'
                            if s * borrowRate / 100 > 0:
                                mem[(32 * _129) + ceil32(return_data.size) + 224] = 0xa415bcad00000000000000000000000000000000000000000000000000000000
                                mem[(32 * _129) + ceil32(return_data.size) + 228] = address(wantAddress)
                                mem[(32 * _129) + ceil32(return_data.size) + 260] = s * borrowRate / 100
                                mem[(32 * _129) + ceil32(return_data.size) + 292] = 2
                                mem[(32 * _129) + ceil32(return_data.size) + 324] = 0
                                mem[(32 * _129) + ceil32(return_data.size) + 356] = this.address
                                require ext_code.size(address(lendingPoolAddress))
                                call address(lendingPoolAddress).borrow(address arg1, uint256 arg2, uint256 arg3, uint16 arg4, address arg5) with:
                                     gas gas_remaining wei
                                    args address(wantAddress), s * borrowRate / 100, 2, 0, this.address
