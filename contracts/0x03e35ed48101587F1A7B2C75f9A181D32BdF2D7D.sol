...
function emergencyWithdraw() payable {
    ...
    staticcall sub_9817299eAddress.balanceOf(address arg1) with:
    ...
    mem[ceil32(return_data.size) + 260 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), ext_call.return_data[0], 0
    mem[ceil32(return_data.size) + 328] = 0
    call sub_9817299eAddress with:
       funct Mask(32, 224, transfer(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), ext_call.return_data[0], 0) >> 224
         gas gas_remaining wei
        args (Mask(512, -288, transfer(address arg1, uint256 arg2), Mask(224, 0, stor8), uint32(stor8), ext_call.return_data[0], 0) << 288)
    ...
    if not sub_43139309[stor0]:
        if expiry > 0:
            if ext_call.return_data[0] > sub_8d44c8f3[stor0]:
                if ext_call.return_data[0] < sub_8d44c8f3[stor0]:
                    revert with 0, 17
                if sub_e24f97a3[stor0] and ext_call.return_data[0] - sub_8d44c8f3[stor0] > -1 / sub_e24f97a3[stor0]:
                    revert with 0, 17
                if not ext_call.return_data[0]:
                    revert with 0, 18
                sub_43139309[stor0] = (ext_call.return_data[0] * sub_e24f97a3[stor0]) - (sub_8d44c8f3[stor0] * sub_e24f97a3[stor0]) / ext_call.return_data[0]
            ...
            if not ext_code.size(sub_9817299eAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 260 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor7), uint32(stor7), sub_43139309[stor0], 0
            mem[ceil32(return_data.size) + 328] = 0
            call sub_9817299eAddress with:
               funct Mask(32, 224, transfer(address arg1, uint256 arg2), Mask(224, 0, stor7), uint32(stor7), sub_43139309[stor0], 0) >> 224
                 gas gas_remaining wei
                args (Mask(512, -288, transfer(address arg1, uint256 arg2), Mask(224, 0, stor7), uint32(stor7), sub_43139309[stor0], 0) << 288)
            if not return_data.size:
                if not ext_call.success:
                    if ext_call.return_data[0]:
                        revert with memory
                ...
                if return_data.size:
                    ...
                    if not mem[ceil32(return_data.size) + 292]:
                        revert with 0, 'SafeERC20: ERC20 operation did not succeed'
            emit 0xf3455c58: ext_call.return_data[0], expiry, sub_43139309[stor0], epoch
}
    ...
    if not sub_43139309[stor0]:
        if expiry > 0:
            if ext_call.return_data[0] / 100 > sub_8d44c8f3[stor0]:
                if ext_call.return_data[0] / 100 < sub_8d44c8f3[stor0]:
                    revert with 0, 17
                if sub_e24f97a3[stor0] and (ext_call.return_data[0] / 100) - sub_8d44c8f3[stor0] > -1 / sub_e24f97a3[stor0]:
                    revert with 0, 17
                if not ext_call.return_data[0] / 100:
                    revert with 0, 18
                sub_43139309[stor0] = (ext_call.return_data[0] / 100 * sub_e24f97a3[stor0]) - (sub_8d44c8f3[stor0] * sub_e24f97a3[stor0]) / ext_call.return_data[0] / 100
            if sub_e24f97a3[stor0] > !sub_83cd45f2[stor0]:
                revert with 0, 17
            if sub_e24f97a3[stor0] + sub_83cd45f2[stor0] < sub_43139309[stor0]:
                revert with 0, 17
            ...
            if not ext_code.size(sub_9817299eAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), Mask(224, 0, stor7), uint32(stor7), sub_43139309[stor0], 0
            ...
            if not return_data.size:
                ...
                if return_data.size:
                    ...
                    if not mem[(2 * ceil32(return_data.size)) + 292]:
                        revert with 0, 'SafeERC20: ERC20 operation did not succeed'
            emit 0xf3455c58: ext_call.return_data[0] / 100, ext_call.return_data[0], sub_43139309[stor0], epoch
}
