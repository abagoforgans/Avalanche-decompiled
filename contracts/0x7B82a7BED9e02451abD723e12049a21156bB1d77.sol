...
function sub_b9ea8671(?) {
    ...
    staticcall sub_9e1a8613Address.0x70a08231 with:
    ...
    require ext_code.size(sub_9e1a8613Address)
    call sub_9e1a8613Address.0xa9059cbb with:
         gas gas_remaining wei
...
function execute() {
    ...
    if not sub_e7e7c2d2.length:
        ...
        mem[(2 * ceil32(return_data.size)) + (32 * sub_e7e7c2d2.length) + 128] = mem[ceil32(return_data.size) + (32 * sub_e7e7c2d2.length) + mem[ceil32(return_data.size) + (32 * sub_e7e7c2d2.length) + 128 len 4], Mask(224, 32, ext_call.return_data[0]) >> 32 + 128]
        ...
        call routerAddress.swapExactTokensForAVAX(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args Mask(255, 1, ext_call.return_data[0]), _71 * stor5 / 1000, 160, address(this.address), block.timestamp, mem[mem[64] + 164 len (32 * _79) + 32]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _130 = mem[64]
        ...
        mem[mem[64]] = 0x676528d100000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = ext_call.return_data[0] / 2
        mem[mem[64] + 36] = mem[(32 * _128 - 1) + (2 * ceil32(return_data.size)) + (32 * sub_e7e7c2d2.length) + 160] * stor5 / 1000
        mem[mem[64] + 68] = 160
        ...
        call routerAddress.swapExactTokensForAVAX(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args Mask(255, 1, ext_call.return_data[0]), mem[mem[64] + 36], 160, address(this.address), block.timestamp, mem[mem[64] + 164 len (32 * _186) + 32]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _223 = mem[64]
        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
