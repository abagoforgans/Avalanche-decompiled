...
function cashoutAll() {
    ...
    if not uint8(stor25):
        ...
        if ext_call.return_data[0] > balanceOf[stor18]:
            revert with 0, 
                        32,
                        38,
            ...
            if not ext_call.return_data[0]:
                ...
                if not uniswapV2RouterAddress:
                    ...
                    revert with memory
                      from (2 * ceil32(return_data.size)) + 256
                       len ceil32(return_data.size) + 132
                allowance[address(this.address)][stor15] = ext_call.return_data[0] * cashoutFee / 100
                ...
                if ext_call.return_data[0] - (ext_call.return_data[0] * cashoutFee / 100) > 10^18 * antiWhale:
                    if stor29[stor18]:
                        revert with 0, 'You are not permitted to transfer more than 100,000 tokens'
                if ext_call.return_data[0] - (ext_call.return_data[0] * cashoutFee / 100) > balanceOf[stor18]:
                    revert with 0, 
                                32,
                                38,
                                0xfe45524332303a207472616e7366657220616d6f756e7420657863656564732062616c616e63, Mask(208, 32, block.timestamp) >> 32 >> 48,
                                0
                if balanceOf[stor18] < ext_call.return_data[0] - (ext_call.return_data[0] * cashoutFee / 100):
                    revert with 0, 17
                balanceOf[stor18] = balanceOf[stor18] - ext_call.return_data[0] + (ext_call.return_data[0] * cashoutFee / 100)
