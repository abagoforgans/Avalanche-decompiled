...
function sub_31455e86(?) payable {
    ...
    if not stor11:
        ...
        require return_data.size >= 32
        _180 = mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32
        ...
        _182 = mem[ceil32(32 * ('cd', 164).length) + mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 + 97]
        ...
        mem[ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 97] = _182
        require _180 + (32 * _182) + 32 <= return_data.size
        mem[ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 129 len 32 * _182] = mem[ceil32(32 * ('cd', 164).length) + _180 + 129 len 32 * _182]
        if 10000 < cd[132]:
            revert with 0, 17
        if 1 >= _182:
            revert with 0, 50
        _246 = mem[ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 161]
        if mem[ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 161] and -cd[132] + 10000 > -1 / mem[ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 161]:
            revert with 0, 17
        ...
        mem[mem[64] + 4] = cd[100]
        mem[mem[64] + 36] = (10000 * _246) - (cd[132] * _246) / 10000
        mem[mem[64] + 68] = 160
        ...
        call address(cd[68]).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args cd[100], (10000 * _246) - (cd[132] * _246) / 10000, Array(len=('cd', 164).length, data=mem[mem[64] + 196 len 32 * ('cd', 164).length]), address(this.address), block.timestamp + 60
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _302 = mem[64]
        ...
        require return_data.size >= 32
        _304 = mem[_302]
        require mem[_302] <= test266151307()
        require _302 + return_data.size > _302 + mem[_302] + 31
        _306 = mem[_302 + mem[_302]]
        if mem[_302 + mem[_302]] > test266151307():
            revert with 0, 65
        if ceil32(32 * mem[_302 + mem[_302]]) + 1 < 0 or _302 + ceil32(return_data.size) + ceil32(32 * mem[_302 + mem[_302]]) + 1 > test266151307():
            revert with 0, 65
        mem[64] = _302 + ceil32(return_data.size) + ceil32(32 * mem[_302 + mem[_302]]) + 1
        mem[_302 + ceil32(return_data.size)] = _306
        require _304 + (32 * _306) + 32 <= return_data.size
        mem[_302 + ceil32(return_data.size) + 32 len 32 * _306] = mem[_302 + _304 + 32 len 32 * _306]
        if 0 >= _306:
            revert with 0, 50
        if 1 >= _306:
            revert with 0, 50
        if mem[_302 + ceil32(return_data.size) + 64] > mem[_302 + ceil32(return_data.size) + 32]:
            if 1 >= _306:
                revert with 0, 50
            mem[mem[64]] = mem[_302 + ceil32(return_data.size) + 64]
        else:
            if 0 >= _306:
                revert with 0, 50
            mem[mem[64]] = mem[_302 + ceil32(return_data.size) + 32]
    else:
        if managerAddress != msg.sender:
            revert with 0, 'Only manager can call managed vaults'
        if 0 >= ('cd', 164).length:
        ...
        mem[64] = ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 97
        require return_data.size >= 32
        _181 = mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32
        require mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 <= test266151307()
        require ceil32(32 * ('cd', 164).length) + return_data.size + 97 > ceil32(32 * ('cd', 164).length) + mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 + 128
        _183 = mem[ceil32(32 * ('cd', 164).length) + mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 + 97]
        if mem[ceil32(32 * ('cd', 164).length) + mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 + 97] > test266151307():
            revert with 0, 65
        if ceil32(32 * mem[ceil32(32 * ('cd', 164).length) + mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 + 97]) + 1 < 0 or ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + ceil32(32 * mem[ceil32(32 * ('cd', 164).length) + mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 + 97]) + 98 > test266151307():
            revert with 0, 65
        mem[64] = ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + ceil32(32 * mem[ceil32(32 * ('cd', 164).length) + mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 + 97]) + 98
        mem[ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 97] = _183
        require _181 + (32 * _183) + 32 <= return_data.size
        mem[ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 129 len 32 * _183] = mem[ceil32(32 * ('cd', 164).length) + _181 + 129 len 32 * _183]
        if 10000 < cd[132]:
            revert with 0, 17
        if 1 >= _183:
            revert with 0, 50
        _247 = mem[ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 161]
        if mem[ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 161] and -cd[132] + 10000 > -1 / mem[ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 161]:
            revert with 0, 17
        mem[mem[64] + 4] = address(cd[68])
        mem[mem[64] + 36] = cd[100]
        ...
        mem[mem[64]] = 0x38ed173900000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = cd[100]
        mem[mem[64] + 36] = (10000 * _247) - (cd[132] * _247) / 10000
        mem[mem[64] + 68] = 160
        mem[mem[64] + 164] = ('cd', 164).length
        idx = 0
        s = 128
        ...
        call address(cd[68]).swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args cd[100], (10000 * _247) - (cd[132] * _247) / 10000, Array(len=('cd', 164).length, data=mem[mem[64] + 196 len 32 * ('cd', 164).length]), address(this.address), block.timestamp + 60
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _303 = mem[64]
        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        require _303 + return_data.size > _303 + mem[_303] + 31
        _307 = mem[_303 + mem[_303]]
        if mem[_303 + mem[_303]] > test266151307():
            revert with 0, 65
        if ceil32(32 * mem[_303 + mem[_303]]) + 1 < 0 or _303 + ceil32(return_data.size) + ceil32(32 * mem[_303 + mem[_303]]) + 1 > test266151307():
            revert with 0, 65
        mem[64] = _303 + ceil32(return_data.size) + ceil32(32 * mem[_303 + mem[_303]]) + 1
        mem[_303 + ceil32(return_data.size)] = _307
        require _305 + (32 * _307) + 32 <= return_data.size
        mem[_303 + ceil32(return_data.size) + 32 len 32 * _307] = mem[_303 + _305 + 32 len 32 * _307]
        if 0 >= _307:
            revert with 0, 50
        if 1 >= _307:
            revert with 0, 50
        if mem[_303 + ceil32(return_data.size) + 64] > mem[_303 + ceil32(return_data.size) + 32]:
            if 1 >= _307:
                revert with 0, 50
            mem[mem[64]] = mem[_303 + ceil32(return_data.size) + 64]
        else:
            if 0 >= _307:
                revert with 0, 50
            mem[mem[64]] = mem[_303 + ceil32(return_data.size) + 32]
    return memory
      from mem[64]
       len 32
}
