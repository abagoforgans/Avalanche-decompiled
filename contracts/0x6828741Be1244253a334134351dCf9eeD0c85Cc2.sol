...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        ...
        call address(lendingPoolAddress).deposit(address rg1, uint256 rg2, address rg3, uint16 rg4) with:
             gas gas_remaining wei
            args 0, uint32(stor10), ext_call.return_data[0], address(this.address), 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
}
...
function unpause() payable {
    ...
    mem[260 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor13), uint32(stor13), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
    ...
    if not return_data.size:
        if not ext_call.success:
            revert with approve(address rg1, uint256 rg2), Mask(224, 0, stor13), uint32(stor13), -1
        ...
        if ext_call.return_data[0] > 0:
            ...
            call address(lendingPoolAddress).deposit(address rg1, uint256 rg2, address rg3, uint16 rg4) with:
                 gas gas_remaining wei
                args address(wantAddress), ext_call.return_data[0], address(this.address), 0
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
    else:
        ...
        if not return_data.size:
            ...
            if ext_call.return_data[0] > 0:
                ...
                call address(lendingPoolAddress).deposit(address rg1, uint256 rg2, address rg3, uint16 rg4) with:
                     gas gas_remaining wei
                    args address(wantAddress), ext_call.return_data[0], address(this.address), 0, mem[(2 * ceil32(return_data.size)) + 558 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
}
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] >= arg1:
        ...
        call address(lendingPoolAddress).withdraw(address rg1, uint256 rg2, address rg3) with:
             gas gas_remaining wei
            args address(wantAddress), arg1 - ext_call.return_data[0], this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_code.size(address(wantAddress))
