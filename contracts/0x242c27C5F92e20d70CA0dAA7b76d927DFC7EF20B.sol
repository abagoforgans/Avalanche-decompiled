...
function sub_a30119a5(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(sub_7a972ea0Address)
    call sub_7a972ea0Address.0xf2fde38b with:
...
function add(uint256 arg1, address arg2, uint16 arg3, uint256 arg4) payable {
                ...
                if ext_call.return_data[0]:
                    if poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256:
                        ...
                        if poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_512 > block.number:
                            ...
                            idx = 0
                            while idx < 30:
                                mem[_154 + idx + 68] = mem[_152 + idx + 32]
                                idx = idx + 32
                                continue 
                        ...
                        if not block.number - poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_512:
                            ...
                            if totalAllocPoint <= 0:
                                ...
                                idx = 0
                                while idx < 26:
                                    mem[_168 + idx + 68] = mem[_164 + idx + 32]
                                    idx = idx + 32
                                    continue 
                            ...
                            if not 0 / totalAllocPoint:
                                ...
                                if ext_call.return_data[0] <= 0:
                                    ...
                                    idx = 0
                                    while idx < 26:
                                        mem[_212 + idx + 68] = mem[_207 + idx + 32]
                                        idx = idx + 32
                                        continue 
                                ...
                                if ext_call.return_data[0] <= 0:
                                    ...
                                    idx = 0
                                    while idx < 26:
                                        mem[_222 + idx + 68] = mem[_211 + idx + 32]
                                        idx = idx + 32
                                        continue 
                            ...
                            if (block.number * sub_0d7f7f0a) - (poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_512 * sub_0d7f7f0a) / block.number - poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_512 != sub_0d7f7f0a:
                                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
                            if not (block.number * sub_0d7f7f0a) - (poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_512 * sub_0d7f7f0a):
                                _167 = mem[64]
                                mem[64] = mem[64] + 64
                                mem[_167] = 26
                                ...
                                if totalAllocPoint <= 0:
                                    ...
                                    idx = 0
                                    while idx < 26:
                                        mem[_172 + idx + 68] = mem[_167 + idx + 32]
                                        idx = idx + 32
                                        continue 
                                    mem[_172 + 68] = mem[_172 + 74 len 26]
                                    revert with memory
                                      from mem[64]
                                       len _172 + -mem[64] + 100
                                require totalAllocPoint
                                ...
                                if not 0 / totalAllocPoint:
                                    ...
                                    if ext_call.return_data[0] <= 0:
                                        ...
                                        idx = 0
                                        while idx < 26:
                                            mem[_219 + idx + 68] = mem[_210 + idx + 32]
                                            idx = idx + 32
                                            continue 
                                    ...
                                    if ext_call.return_data[0] <= 0:
                                        ...
                                        idx = 0
                                        while idx < 26:
                                            mem[_232 + idx + 68] = mem[_218 + idx + 32]
                                            idx = idx + 32
                                            continue 
                                        mem[_232 + 68] = mem[_232 + 74 len 26]
                                        revert with memory
                                ...
                                require (block.number * sub_0d7f7f0a) - (poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_512 * sub_0d7f7f0a)
                                if (block.number * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) - (poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_512 * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) / (block.number * sub_0d7f7f0a) - (poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_512 * sub_0d7f7f0a) != poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256:
                                    revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
                                _171 = mem[64]
                                mem[64] = mem[64] + 64
                                mem[_171] = 26
                                ...
                                if totalAllocPoint <= 0:
                                    ...
                                    idx = 0
                                    while idx < 26:
                                        mem[_178 + idx + 68] = mem[_171 + idx + 32]
                                        idx = idx + 32
                                        continue 
                                ...
                                call sub_7a972ea0Address.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args devAddress, (block.number * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) - (poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_512 * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) / totalAllocPoint / 10
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
                                mem[mem[64] + 4] = this.address
                                mem[mem[64] + 36] = (block.number * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) - (poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_512 * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) / totalAllocPoint
                                require ext_code.size(sub_7a972ea0Address)
                                call sub_7a972ea0Address.0x40c10f19 with:
                                     gas gas_remaining wei
                                    args address(this.address), (block.number * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) - (poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_512 * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) / totalAllocPoint
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                if not (block.number * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) - (poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_512 * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) / totalAllocPoint:
                                    _217 = mem[64]
                                    mem[64] = mem[64] + 64
                                    mem[_217] = 26
                                    ...
                                    if ext_call.return_data[0] <= 0:
                                        ...
                                        idx = 0
                                        while idx < 26:
                                            mem[_229 + idx + 68] = mem[_217 + idx + 32]
                                            idx = idx + 32
                                            continue 
                                    ...
                                    require (block.number * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) - (poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_512 * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) / totalAllocPoint
                                    if 10^18 * (block.number * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) - (poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_512 * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) / totalAllocPoint / (block.number * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) - (poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_512 * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) / totalAllocPoint != 10^18:
                                        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
                                    _228 = mem[64]
                                    mem[64] = mem[64] + 64
                                    mem[_228] = 26
                                    ...
                                    if ext_call.return_data[0] <= 0:
                                        ...
                                        idx = 0
                                        while idx < 26:
                                            mem[_244 + idx + 68] = mem[_228 + idx + 32]
                                            idx = idx + 32
                                            continue 
                                        ...
                                        revert with memory
                                          from mem[64]
                                           len _244 + -mem[64] + 100
                                    require ext_call.return_data[0]
                                    if poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_768 + (10^18 * (block.number * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) - (poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_512 * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_768:
                                        revert with 0, 'SafeMath: addition overflow'
                                    poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_768 += 10^18 * (block.number * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) - (poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_512 * sub_0d7f7f0a * poolInfo[uint16(cd[((32 * idx) + cd[4] + 36)])].field_256) / totalAllocPoint / ext_call.return_data[0]
