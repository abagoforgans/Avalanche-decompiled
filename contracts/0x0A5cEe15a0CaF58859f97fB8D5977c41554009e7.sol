...
function sub_16c0e2b7(?) {
    require calldata.size - 4 >= 32
    mem[96] = 3
    mem[128 len 96] = code.data[14182 len 96]
    idx = 0
    while idx < userDownlineCount[address(arg1)].field_0:
    ...
    if mem[128] < 1000 * 10^18:
        ...
        if 2 * mem[160] / 1000 * 10^18 < 0:
            revert with 0, 'SafeMath: addition overflow'
        if 3 * mem[192] / 1000 * 10^18 <= 100:
            if (2 * mem[160] / 1000 * 10^18) + (3 * mem[192] / 1000 * 10^18) < 2 * mem[160] / 1000 * 10^18:
                revert with 0, 'SafeMath: addition overflow'
            return ((2 * mem[160] / 1000 * 10^18) + (3 * mem[192] / 1000 * 10^18))
    ...
    if mem[128] / 1000 * 10^18 <= 10:
        if mem[160] < 1000 * 10^18:
            ...
            if mem[128] / 1000 * 10^18 < mem[128] / 1000 * 10^18:
                revert with 0, 'SafeMath: addition overflow'
            if 3 * mem[192] / 1000 * 10^18 <= 100:
                if (mem[128] / 1000 * 10^18) + (3 * mem[192] / 1000 * 10^18) < mem[128] / 1000 * 10^18:
                    revert with 0, 'SafeMath: addition overflow'
                return ((mem[128] / 1000 * 10^18) + (3 * mem[192] / 1000 * 10^18))
        ...
        if 2 * mem[160] / 1000 * 10^18 <= 50:
            if mem[192] < 1000 * 10^18:
                if (mem[128] / 1000 * 10^18) + (2 * mem[160] / 1000 * 10^18) < mem[128] / 1000 * 10^18:
                    revert with 0, 'SafeMath: addition overflow'
                return ((mem[128] / 1000 * 10^18) + (2 * mem[160] / 1000 * 10^18))
            if not mem[192] / 1000 * 10^18:
                if (mem[128] / 1000 * 10^18) + (2 * mem[160] / 1000 * 10^18) < mem[128] / 1000 * 10^18:
                    revert with 0, 'SafeMath: addition overflow'
                return ((mem[128] / 1000 * 10^18) + (2 * mem[160] / 1000 * 10^18))
            ...
            if (mem[128] / 1000 * 10^18) + (2 * mem[160] / 1000 * 10^18) < mem[128] / 1000 * 10^18:
                revert with 0, 'SafeMath: addition overflow'
            if 3 * mem[192] / 1000 * 10^18 > 100:
                return ((mem[128] / 1000 * 10^18) + (2 * mem[160] / 1000 * 10^18) + 100)
            if 3 * mem[192] / 1000 * 10^18 < 0:
                revert with 0, 'SafeMath: addition overflow'
            return ((mem[128] / 1000 * 10^18) + (2 * mem[160] / 1000 * 10^18) + (3 * mem[192] / 1000 * 10^18))
        if mem[192] < 1000 * 10^18:
        ...
        if 3 * mem[192] / 1000 * 10^18 < 0:
            revert with 0, 'SafeMath: addition overflow'
        return ((mem[128] / 1000 * 10^18) + (3 * mem[192] / 1000 * 10^18) + 50)
    if mem[160] < 1000 * 10^18:
        require 2 < mem[96]
        if mem[192] < 1000 * 10^18:
            return 10
    ...
    if 3 * mem[192] / 1000 * 10^18 < 0:
        revert with 0, 'SafeMath: addition overflow'
    return ((2 * mem[160] / 1000 * 10^18) + (3 * mem[192] / 1000 * 10^18) + 10)
}
