            ...
            if not threshold:
                ...
                if not _4916 % 32:
                    ...
                    if not _9431 % 32:
                        ...
                        staticcall address(_4722).mem[mem[64] len 4] with:
                                gas gas_remaining wei
                               args mem[mem[64] + 4 len _9431 + _4916 + _4914 + -mem[64] + 128]
                    else:
                        mem[floor32(_9431) + _4916 + _4914 + 132] = mem[floor32(_9431) + _4916 + _4914 + -(_9431 % 32) + 164 len _9431 % 32]
                        require ext_code.size(address(_4722))
                        staticcall address(_4722).mem[mem[64] len 4] with:
                                gas gas_remaining wei
                               args mem[mem[64] + 4 len floor32(_9431) + _4916 + _4914 + -mem[64] + 160]
                else:
                    mem[floor32(_4916) + mem[64] + 100] = mem[floor32(_4916) + mem[64] + -(_4916 % 32) + 132 len _4916 % 32]
                    mem[mem[64] + 36] = floor32(_4916) + 128
                    mem[floor32(_4916) + _4914 + 132] = mem[ceil32(arg3.length) + _4723 + 642]
                    _9440 = mem[ceil32(arg3.length) + _4723 + 642]
                    t = 0
                    while t < _9440:
                        mem[floor32(_4916) + _4914 + t + 164] = mem[ceil32(arg3.length) + _4723 + t + 674]
                        t = t + 32
                        continue 
                    if not _9440 % 32:
                        require ext_code.size(address(_4722))
                        staticcall address(_4722).mem[mem[64] len 4] with:
                                gas gas_remaining wei
                               args mem[mem[64] + 4 len _9440 + floor32(_4916) + _4914 + -mem[64] + 160]
                    else:
                        mem[floor32(_9440) + floor32(_4916) + _4914 + 164] = mem[floor32(_9440) + floor32(_4916) + _4914 + -(_9440 % 32) + 196 len _9440 % 32]
                        require ext_code.size(address(_4722))
                        staticcall address(_4722).mem[mem[64] len 4] with:
                                gas gas_remaining wei
                               args mem[mem[64] + 4 len floor32(_9440) + floor32(_4916) + _4914 + -mem[64] + 192]
            else:
                require threshold
                require 65 * threshold / threshold == 65
                ...
                if not _4927 % 32:
                    ...
                    if not _9428 % 32:
                        ...
                        staticcall address(_4722).mem[mem[64] len 4] with:
                                gas gas_remaining wei
                               args mem[mem[64] + 4 len _9428 + _4927 + _4925 + -mem[64] + 128]
                    else:
                        mem[floor32(_9428) + _4927 + _4925 + 132] = mem[floor32(_9428) + _4927 + _4925 + -(_9428 % 32) + 164 len _9428 % 32]
                        require ext_code.size(address(_4722))
                        staticcall address(_4722).mem[mem[64] len 4] with:
                                gas gas_remaining wei
                               args mem[mem[64] + 4 len floor32(_9428) + _4927 + _4925 + -mem[64] + 160]
                else:
                    mem[floor32(_4927) + mem[64] + 100] = mem[floor32(_4927) + mem[64] + -(_4927 % 32) + 132 len _4927 % 32]
                    mem[mem[64] + 36] = floor32(_4927) + 128
                    mem[floor32(_4927) + _4925 + 132] = mem[ceil32(arg3.length) + _4723 + 642]
                    _9438 = mem[ceil32(arg3.length) + _4723 + 642]
                    t = 0
                    while t < _9438:
                        mem[floor32(_4927) + _4925 + t + 164] = mem[ceil32(arg3.length) + _4723 + t + 674]
                        t = t + 32
                        continue 
                    if not _9438 % 32:
                        require ext_code.size(address(_4722))
                        staticcall address(_4722).mem[mem[64] len 4] with:
                                gas gas_remaining wei
                               args mem[mem[64] + 4 len _9438 + floor32(_4927) + _4925 + -mem[64] + 160]
                    else:
                        mem[floor32(_9438) + floor32(_4927) + _4925 + 164] = mem[floor32(_9438) + floor32(_4927) + _4925 + -(_9438 % 32) + 196 len _9438 % 32]
                        require ext_code.size(address(_4722))
                        staticcall address(_4722).mem[mem[64] len 4] with:
                                gas gas_remaining wei
                               args mem[mem[64] + 4 len floor32(_9438) + floor32(_4927) + _4925 + -mem[64] + 192]
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
