...
function sub_80fbd162(?) payable {
    ...
    staticcall sub_e89b7016Address.balanceOf(address arg1) with:
...
function sub_f5e46484(?) payable {
    ...
    if ext_code.size(sub_3bb8141aAddress) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = transfer(address arg1, uint256 arg2), msg.sender, userInfo[address(msg.sender)].field_288
    mem[324 len 0] = 0
...
function withdraw(uint256 arg1) payable {
    ...
    if not return_data.size:
        ...
        if ext_code.size(sub_e89b7016Address) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[456 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, arg1) >> 32
        ...
        if ext_code.size(sub_e89b7016Address) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 457 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, arg1) >> 32
    ...
    if bool(stor13[address(msg.sender)]) == 1:
        ...
        if bool(stor13[address(msg.sender)]) == 1:
            if not arg1:
                ...
                call sub_3bb8141aAddress.mint(address arg1, uint256 arg2) with:
                     gas gas_remaining wei
