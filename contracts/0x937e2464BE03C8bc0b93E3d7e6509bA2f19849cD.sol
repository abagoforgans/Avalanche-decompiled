...
function closePosition() payable {
    ...
    while idx < ext_call.return_data[0]:
        ...
        if stor1 != address(ext_call.return_data[0]):
            ...
            mem[64] = mem[64] + 96
            require 0 < mem[_1012]
            mem[_1012 + 32] = address(ext_call.return_data[0])
            require 1 < mem[_1012]
            mem[_1012 + 64] = stor1
            mem[_1012 + 96] = 0x1f263f5900000000000000000000000000000000000000000000000000000000
            mem[_1012 + 100] = ext_call.return_data[32]
            mem[_1012 + 132] = 0
            mem[_1012 + 196] = block.timestamp + 1
            mem[_1012 + 164] = 128
            mem[_1012 + 228] = mem[_1012]
            s = 0
            while s < 32 * mem[_1012]:
                mem[s + _1012 + 260] = mem[s + _1012 + 32]
                s = s + 32
                continue 
            require ext_code.size(vaultServiceAddress)
            call vaultServiceAddress.0x1f263f59 with:
                 gas gas_remaining wei
                args ext_call.return_data[32], 0, 128, block.timestamp + 1, mem[_1012 + 228 len (32 * mem[_1012]) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        idx = idx + 1
        continue 
    ...
    if not ext_call.return_data[32] - ext_call.return_data[0]:
        ...
        if 0 <= (0 / ext_call.return_data[64] / 10^18) + ext_call.return_data[32] - ext_call.return_data[0]:
            ...
            call vaultServiceAddress with:
                 gas gas_remaining wei
                args msg.sender, 0, ext_call.return_data[0], 0, (0 / ext_call.return_data[64] / 10^18) + ext_call.return_data[32] - ext_call.return_data[0], 0 / ext_call.return_data[64] / 10^18, 0
        else:
        ...
        if 0 <= ((ext_call.return_data[32] * ext_call.return_data[0]) - (ext_call.return_data[0] * ext_call.return_data[0]) / ext_call.return_data[64] / 10^18) + ext_call.return_data[32] - ext_call.return_data[0]:
            ...
            call vaultServiceAddress with:
                 gas gas_remaining wei
                args msg.sender, 0, ext_call.return_data[0], 0, ((ext_call.return_data[32] * ext_call.return_data[0]) - (ext_call.return_data[0] * ext_call.return_data[0]) / ext_call.return_data[64] / 10^18) + ext_call.return_data[32] - ext_call.return_data[0], (ext_call.return_data[32] * ext_call.return_data[0]) - (ext_call.return_data[0] * ext_call.return_data[0]) / ext_call.return_data[64] / 10^18, 0
        else:
