    ...
    if ext_call.return_data[0] > 0:
        ...
        if not return_data.size:
            ...
            if not ext_call.return_data[0]:
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[424 len 64] = approve(address rg1, uint256 rg2), 0x830a966b9b447c9b15ab24c0, 0, ext_call.return_data[0 len 28]
                mem[488 len 0] = 0
            else:
                require ext_code.size(lpPairAddress)
            ...
            if ext_code.size(lpPairAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 425 len 64] = approve(address rg1, uint256 rg2), 0x830a966b9b447c9b15ab24c0, 0, ext_call.return_data[0 len 28]
    ...
    if ext_call.return_data[0] >= arg1:
        if ext_call.return_data[0] <= arg1:
            ...
            if not arg1:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 553 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, arg1) >> 32
                call lpPairAddress with:
                   funct uint32(stor4)
                     gas gas_remaining wei
        ...
        if ext_call.return_data[0] > arg1:
            if not arg1:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 617 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, arg1) >> 32
                call lpPairAddress with:
                   funct uint32(stor4)
                     gas gas_remaining wei
