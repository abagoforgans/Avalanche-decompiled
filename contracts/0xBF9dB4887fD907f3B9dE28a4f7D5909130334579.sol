...
#
#  - askToInvestAsCreditor(uint256 arg1)
#
...
function investAll() payable {
    ...
    if ext_call.return_data[0]:
        ...
        call baseAssetAddress.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args 0x4f01aed16d97e3ab5ab2b501154dc9bb0f1a5a2c, ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
...
function initialize(address arg1, address arg2) payable {
    ...
    if not uint8(stor0.field_8):
        uint8(stor0.field_8) = 0
    require ext_code.size(0x4f01aed16d97e3ab5ab2b501154dc9bb0f1a5a2c)
    staticcall 0x4f01aed16d97e3ab5ab2b501154dc9bb0f1a5a2c.getReserveData(address arg1) with:
            gas gas_remaining wei
           args arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if totalShares:
        ...
        if var64002 < stor5.length:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(4 * ceil32(return_data.size)) + 320] = 0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7
...
function collectProfitAndDistribute(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(storeAddress)
    staticcall storeAddress.0x5aa6e675 with:
            gas gas_remaining wei
    ...
    if msg.sender == ext_call.return_data[12 len 20]:
        ...
        if not ext_call.return_data[0]:
            ...
            if 2 * ext_call.return_data[0] < ext_call.return_data[0]:
                revert with 0, 'SafeMath: addition overflow'
            if not totalShares:
                if var93002 < stor5.length:
                    if var99001 >= stor5.length:
                        revert with 0, 
                                    32,
                                    34,
                                    0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                    mem[(4 * ceil32(return_data.size)) + 326 len 30]
                    require var101002 < stor5.length
                    if var109001 + var109002 < var109002:
                        revert with 0, 'SafeMath: addition overflow'
                    # nil
                else:
                    if var93003 > 2 * ext_call.return_data[0]:
                        revert with 0, 'SafeMath: subtraction overflow'
                    if (2 * ext_call.return_data[0]) - var93003 < arg1:
                        revert with 0, 
                                    32,
                                    44,
                                    0x6c4956534142553a2070726f66697420646964206e6f742061636869657665206d696e4261736550726f6669,
                                    mem[(4 * ceil32(return_data.size)) + 400 len 20]
                    emit 0x6c14a48d: ((2 * ext_call.return_data[0]) - var93003)
                    if var131002 < stor5.length:
                        if var137001 >= stor5.length:
                            revert with 0, 
                                        32,
                                        34,
                                        0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                        mem[(4 * ceil32(return_data.size)) + 390 len 30]
                        require var139002 < stor5.length
                        # nil
                    else:
                        if not (2 * ext_call.return_data[0]) - var93003:
                            if not totalShares:
                                revert with 0, 'SafeMath: division by zero'
                            if (0 / totalShares) + sharePrice < sharePrice:
                                revert with 0, 'SafeMath: addition overflow'
                            sharePrice += 0 / totalShares
                        else:
                            if (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var93003) / (2 * ext_call.return_data[0]) - var93003 != 10^18:
                                revert with 0, 
                                            32,
                                            33,
                                            0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                            ...
                            if not totalShares:
                                revert with 0, 'SafeMath: division by zero'
                            if ((2 * 10^18 * ext_call.return_data[0]) - (10^18 * var93003) / totalShares) + sharePrice < sharePrice:
                                revert with 0, 'SafeMath: addition overflow'
                            sharePrice += (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var93003) / totalShares
                        require ext_code.size(baseAssetAddress)
                        staticcall baseAssetAddress.0x70a08231 with:
                                gas gas_remaining wei
                               args this.address
                ...
                if sharePrice * totalShares / totalShares != sharePrice:
                    revert with 0, 
                                ...
                                33,
                                0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                mem[(4 * ceil32(return_data.size)) + 261 len 31]
                if var94002 < stor5.length:
                    if var100001 >= stor5.length:
                        revert with 0, 
                                    32,
                                    34,
                                    0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                    mem[(4 * ceil32(return_data.size)) + 326 len 30]
                    require var102002 < stor5.length
                    if var110001 + var110002 < var110002:
                        revert with 0, 'SafeMath: addition overflow'
                    # nil
                else:
                    if var94003 > 2 * ext_call.return_data[0]:
                        revert with 0, 'SafeMath: subtraction overflow'
                    if (2 * ext_call.return_data[0]) - var94003 < arg1:
                        revert with 0, 
                                    32,
                                    44,
                                    0x6c4956534142553a2070726f66697420646964206e6f742061636869657665206d696e4261736550726f6669,
                                    mem[(4 * ceil32(return_data.size)) + 400 len 20]
                    emit 0x6c14a48d: ((2 * ext_call.return_data[0]) - var94003)
                    if var132002 < stor5.length:
                        if var138001 >= stor5.length:
                            revert with 0, 
                                        32,
                                        34,
                                        0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                        mem[(4 * ceil32(return_data.size)) + 390 len 30]
                        require var140002 < stor5.length
                        # nil
                    else:
                        if not (2 * ext_call.return_data[0]) - var94003:
                            if not totalShares:
                                revert with 0, 'SafeMath: division by zero'
                            if (0 / totalShares) + sharePrice < sharePrice:
                                revert with 0, 'SafeMath: addition overflow'
                            ...
                            if (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var94003) / (2 * ext_call.return_data[0]) - var94003 != 10^18:
                                revert with 0, 
                                            32,
                                            33,
                                            0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                            ...
                            if not totalShares:
                                revert with 0, 'SafeMath: division by zero'
                            if ((2 * 10^18 * ext_call.return_data[0]) - (10^18 * var94003) / totalShares) + sharePrice < sharePrice:
                                revert with 0, 'SafeMath: addition overflow'
                            sharePrice += (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var94003) / totalShares
                        require ext_code.size(baseAssetAddress)
                        staticcall baseAssetAddress.0x70a08231 with:
                                gas gas_remaining wei
                               args this.address
            ...
            call 0x01d83fe6a10d2f2b7af17034343746188272cac9.claimRewards(address[] arg1, uint256 arg2, address arg3) with:
                 gas gas_remaining wei
                args Array(len=1, data=mem[ceil32(return_data.size) + 292]), ext_call.return_data[0], this.address
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require ext_code.size(storeAddress)
            ...
            call address(ext_call.return_data[0]).swapExactTokenIn(address arg1, address arg2, uint256 arg3, uint256 arg4) with:
                 gas gas_remaining wei
                args 0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7, address(stor0.field_0), ext_call.return_data[0], 0
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require ext_code.size(baseAssetAddress)
            ...
            if 2 * ext_call.return_data[0] < ext_call.return_data[0]:
                revert with 0, 'SafeMath: addition overflow'
            if not totalShares:
                if var141002 < stor5.length:
                    if var147001 >= stor5.length:
                        revert with 0, 
                                    32,
                                    34,
                                    0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                    mem[(10 * ceil32(return_data.size)) + 326 len 30]
                    require var149002 < stor5.length
                    if var157001 + var157002 < var157002:
                        revert with 0, 'SafeMath: addition overflow'
                    # nil
                else:
                    if var141003 > 2 * ext_call.return_data[0]:
                        revert with 0, 'SafeMath: subtraction overflow'
                    if (2 * ext_call.return_data[0]) - var141003 < arg1:
                        revert with 0, 
                                    32,
                                    44,
                                    0x6c4956534142553a2070726f66697420646964206e6f742061636869657665206d696e4261736550726f6669,
                                    mem[(10 * ceil32(return_data.size)) + 400 len 20]
                    emit 0x6c14a48d: ((2 * ext_call.return_data[0]) - var141003)
                    if var179002 < stor5.length:
                        if var185001 >= stor5.length:
                            revert with 0, 
                                        32,
                                        34,
                                        0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                        mem[(10 * ceil32(return_data.size)) + 390 len 30]
                        require var187002 < stor5.length
                        # nil
                    else:
                        if not (2 * ext_call.return_data[0]) - var141003:
                            if not totalShares:
                                revert with 0, 'SafeMath: division by zero'
                            if (0 / totalShares) + sharePrice < sharePrice:
                                revert with 0, 'SafeMath: addition overflow'
                            ...
                            if (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var141003) / (2 * ext_call.return_data[0]) - var141003 != 10^18:
                                revert with 0, 
                                            32,
                                            33,
                                            0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                            mem[(10 * ceil32(return_data.size)) + 389 len 31]
                            if not totalShares:
                                revert with 0, 'SafeMath: division by zero'
                            if ((2 * 10^18 * ext_call.return_data[0]) - (10^18 * var141003) / totalShares) + sharePrice < sharePrice:
                                revert with 0, 'SafeMath: addition overflow'
                            sharePrice += (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var141003) / totalShares
                        require ext_code.size(baseAssetAddress)
                        staticcall baseAssetAddress.0x70a08231 with:
                                gas gas_remaining wei
                               args address(this.address)
                ...
                if sharePrice * totalShares / totalShares != sharePrice:
                    revert with 0, 
                                ...
                                33,
                                0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                mem[(10 * ceil32(return_data.size)) + 261 len 31]
                if var142002 < stor5.length:
                    if var148001 >= stor5.length:
                        revert with 0, 
                                    32,
                                    34,
                                    0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                    mem[(10 * ceil32(return_data.size)) + 326 len 30]
                    require var150002 < stor5.length
                    if var158001 + var158002 < var158002:
                        revert with 0, 'SafeMath: addition overflow'
                    # nil
                else:
                    if var142003 > 2 * ext_call.return_data[0]:
                        revert with 0, 'SafeMath: subtraction overflow'
                    if (2 * ext_call.return_data[0]) - var142003 < arg1:
                        revert with 0, 
                                    32,
                                    44,
                                    0x6c4956534142553a2070726f66697420646964206e6f742061636869657665206d696e4261736550726f6669,
                                    mem[(10 * ceil32(return_data.size)) + 400 len 20]
                    emit 0x6c14a48d: ((2 * ext_call.return_data[0]) - var142003)
                    if var180002 < stor5.length:
                        if var186001 >= stor5.length:
                            revert with 0, 
                                        32,
                                        34,
                                        0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                        mem[(10 * ceil32(return_data.size)) + 390 len 30]
                        require var188002 < stor5.length
                        # nil
                    else:
                        if not (2 * ext_call.return_data[0]) - var142003:
                            if not totalShares:
                                revert with 0, 'SafeMath: division by zero'
                            if (0 / totalShares) + sharePrice < sharePrice:
                                revert with 0, 'SafeMath: addition overflow'
                            ...
                            if (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var142003) / (2 * ext_call.return_data[0]) - var142003 != 10^18:
                                revert with 0, 
                                            32,
                                            33,
                                            0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                            ...
                            if not totalShares:
                                revert with 0, 'SafeMath: division by zero'
                            if ((2 * 10^18 * ext_call.return_data[0]) - (10^18 * var142003) / totalShares) + sharePrice < sharePrice:
                                revert with 0, 'SafeMath: addition overflow'
                            sharePrice += (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var142003) / totalShares
                        require ext_code.size(baseAssetAddress)
                        staticcall baseAssetAddress.0x70a08231 with:
                                gas gas_remaining wei
                               args address(this.address)
        ...
        if ext_call.return_data[0]:
            ...
            if not ext_call.return_data[0]:
                ...
                if 2 * ext_call.return_data[0] < ext_call.return_data[0]:
                    revert with 0, 'SafeMath: addition overflow'
                if not totalShares:
                    if var102002 < stor5.length:
                        if var108001 >= stor5.length:
                            revert with 0, 
                                        32,
                                        34,
                                        0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                        mem[(4 * ceil32(return_data.size)) + 326 len 30]
                        require var110002 < stor5.length
                        if var118001 + var118002 < var118002:
                            revert with 0, 'SafeMath: addition overflow'
                        # nil
                    else:
                        if var102003 > 2 * ext_call.return_data[0]:
                            revert with 0, 'SafeMath: subtraction overflow'
                        if (2 * ext_call.return_data[0]) - var102003 < arg1:
                            revert with 0, 
                                        32,
                                        44,
                                        0x6c4956534142553a2070726f66697420646964206e6f742061636869657665206d696e4261736550726f6669,
                                        mem[(4 * ceil32(return_data.size)) + 400 len 20]
                        emit 0x6c14a48d: ((2 * ext_call.return_data[0]) - var102003)
                        if var140002 < stor5.length:
                            if var146001 >= stor5.length:
                                revert with 0, 
                                            32,
                                            34,
                                            0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                            mem[(4 * ceil32(return_data.size)) + 390 len 30]
                            require var148002 < stor5.length
                            # nil
                        else:
                            if not (2 * ext_call.return_data[0]) - var102003:
                                if not totalShares:
                                    revert with 0, 'SafeMath: division by zero'
                                if (0 / totalShares) + sharePrice < sharePrice:
                                    revert with 0, 'SafeMath: addition overflow'
                                ...
                                if (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var102003) / (2 * ext_call.return_data[0]) - var102003 != 10^18:
                                    revert with 0, 
                                                32,
                                                33,
                                                0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                ...
                                if not totalShares:
                                    revert with 0, 'SafeMath: division by zero'
                                if ((2 * 10^18 * ext_call.return_data[0]) - (10^18 * var102003) / totalShares) + sharePrice < sharePrice:
                                    revert with 0, 'SafeMath: addition overflow'
                                sharePrice += (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var102003) / totalShares
                            require ext_code.size(baseAssetAddress)
                            staticcall baseAssetAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                    ...
                    if sharePrice * totalShares / totalShares != sharePrice:
                        revert with 0, 
                                    ...
                                    0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                    mem[(4 * ceil32(return_data.size)) + 261 len 31]
                    if var103002 < stor5.length:
                        if var109001 >= stor5.length:
                            revert with 0, 
                                        32,
                                        34,
                                        0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                        mem[(4 * ceil32(return_data.size)) + 326 len 30]
                        require var111002 < stor5.length
                        if var119001 + var119002 < var119002:
                            revert with 0, 'SafeMath: addition overflow'
                        # nil
                    else:
                        if var103003 > 2 * ext_call.return_data[0]:
                            revert with 0, 'SafeMath: subtraction overflow'
                        if (2 * ext_call.return_data[0]) - var103003 < arg1:
                            revert with 0, 
                                        32,
                                        44,
                                        0x6c4956534142553a2070726f66697420646964206e6f742061636869657665206d696e4261736550726f6669,
                                        mem[(4 * ceil32(return_data.size)) + 400 len 20]
                        emit 0x6c14a48d: ((2 * ext_call.return_data[0]) - var103003)
                        if var141002 < stor5.length:
                            if var147001 >= stor5.length:
                                revert with 0, 
                                            32,
                            ...
                            if not (2 * ext_call.return_data[0]) - var103003:
                                if not totalShares:
                                    revert with 0, 'SafeMath: division by zero'
                                if (0 / totalShares) + sharePrice < sharePrice:
                                    revert with 0, 'SafeMath: addition overflow'
                                ...
                                if (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var103003) / (2 * ext_call.return_data[0]) - var103003 != 10^18:
                                    revert with 0, 
                                                32,
                                                33,
                                                0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                ...
                                if not totalShares:
                                    revert with 0, 'SafeMath: division by zero'
                                if ((2 * 10^18 * ext_call.return_data[0]) - (10^18 * var103003) / totalShares) + sharePrice < sharePrice:
                                    revert with 0, 'SafeMath: addition overflow'
                                sharePrice += (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var103003) / totalShares
                            require ext_code.size(baseAssetAddress)
                            staticcall baseAssetAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                ...
                if 2 * ext_call.return_data[0] < ext_call.return_data[0]:
                    revert with 0, 'SafeMath: addition overflow'
                if not totalShares:
                    if var150002 < stor5.length:
                        if var156001 >= stor5.length:
                            revert with 0, 
                                        32,
                                        34,
                                        0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                        mem[(10 * ceil32(return_data.size)) + 326 len 30]
                        require var158002 < stor5.length
                        if var166001 + var166002 < var166002:
                            revert with 0, 'SafeMath: addition overflow'
                        # nil
                    else:
                        if var150003 > 2 * ext_call.return_data[0]:
                            revert with 0, 'SafeMath: subtraction overflow'
                        if (2 * ext_call.return_data[0]) - var150003 < arg1:
                            revert with 0, 
                                        32,
                                        44,
                                        0x6c4956534142553a2070726f66697420646964206e6f742061636869657665206d696e4261736550726f6669,
                                        mem[(10 * ceil32(return_data.size)) + 400 len 20]
                        emit 0x6c14a48d: ((2 * ext_call.return_data[0]) - var150003)
                        if var188002 < stor5.length:
                            if var194001 >= stor5.length:
                                revert with 0, 
                                            32,
                                            34,
                                            0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                            mem[(10 * ceil32(return_data.size)) + 390 len 30]
                            require var196002 < stor5.length
                            # nil
                        else:
                            if not (2 * ext_call.return_data[0]) - var150003:
                                if not totalShares:
                                    revert with 0, 'SafeMath: division by zero'
                                if (0 / totalShares) + sharePrice < sharePrice:
                                    revert with 0, 'SafeMath: addition overflow'
                                ...
                                if (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var150003) / (2 * ext_call.return_data[0]) - var150003 != 10^18:
                                    revert with 0, 
                                                32,
                                                33,
                                                0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                ...
                                if not totalShares:
                                    revert with 0, 'SafeMath: division by zero'
                                if ((2 * 10^18 * ext_call.return_data[0]) - (10^18 * var150003) / totalShares) + sharePrice < sharePrice:
                                    revert with 0, 'SafeMath: addition overflow'
                                sharePrice += (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var150003) / totalShares
                            require ext_code.size(baseAssetAddress)
                            staticcall baseAssetAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                    ...
                    if sharePrice * totalShares / totalShares != sharePrice:
                        revert with 0, 
                                    ...
                                    0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                    mem[(10 * ceil32(return_data.size)) + 261 len 31]
                    if var151002 < stor5.length:
                        if var157001 >= stor5.length:
                            revert with 0, 
                                        32,
                                        34,
                                        0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                        mem[(10 * ceil32(return_data.size)) + 326 len 30]
                        require var159002 < stor5.length
                        if var167001 + var167002 < var167002:
                            revert with 0, 'SafeMath: addition overflow'
                        # nil
                    else:
                        if var151003 > 2 * ext_call.return_data[0]:
                            revert with 0, 'SafeMath: subtraction overflow'
                        if (2 * ext_call.return_data[0]) - var151003 < arg1:
                            revert with 0, 
                                        32,
                                        44,
                                        0x6c4956534142553a2070726f66697420646964206e6f742061636869657665206d696e4261736550726f6669,
                                        mem[(10 * ceil32(return_data.size)) + 400 len 20]
                        emit 0x6c14a48d: ((2 * ext_call.return_data[0]) - var151003)
                        if var189002 < stor5.length:
                            if var195001 >= stor5.length:
                                revert with 0, 
                                            32,
                                            34,
                                            0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                            mem[(10 * ceil32(return_data.size)) + 390 len 30]
                            require var197002 < stor5.length
                            # nil
                        else:
                            if not (2 * ext_call.return_data[0]) - var151003:
                                if not totalShares:
                                    revert with 0, 'SafeMath: division by zero'
                                if (0 / totalShares) + sharePrice < sharePrice:
                                    revert with 0, 'SafeMath: addition overflow'
                                ...
                                if (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var151003) / (2 * ext_call.return_data[0]) - var151003 != 10^18:
                                    revert with 0, 
                                                32,
                                                33,
                                                0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                ...
                                if not totalShares:
                                    revert with 0, 'SafeMath: division by zero'
                                if ((2 * 10^18 * ext_call.return_data[0]) - (10^18 * var151003) / totalShares) + sharePrice < sharePrice:
                                    revert with 0, 'SafeMath: addition overflow'
                                sharePrice += (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var151003) / totalShares
                            require ext_code.size(baseAssetAddress)
                            staticcall baseAssetAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
            ...
            if not ext_call.return_data[0]:
                ...
                if 2 * ext_call.return_data[0] < ext_call.return_data[0]:
                    revert with 0, 'SafeMath: addition overflow'
                if not totalShares:
                    if var111002 < stor5.length:
                        if var117001 >= stor5.length:
                            revert with 0, 
                                        32,
                                        34,
                                        0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                        mem[(4 * ceil32(return_data.size)) + 326 len 30]
                        require var119002 < stor5.length
                        if var127001 + var127002 < var127002:
                            revert with 0, 'SafeMath: addition overflow'
                        # nil
                    else:
                        if var111003 > 2 * ext_call.return_data[0]:
                            revert with 0, 'SafeMath: subtraction overflow'
                        if (2 * ext_call.return_data[0]) - var111003 < arg1:
                            revert with 0, 
                                        32,
                                        44,
                                        0x6c4956534142553a2070726f66697420646964206e6f742061636869657665206d696e4261736550726f6669,
                                        mem[(4 * ceil32(return_data.size)) + 400 len 20]
                        emit 0x6c14a48d: ((2 * ext_call.return_data[0]) - var111003)
                        if var149002 < stor5.length:
                            if var155001 >= stor5.length:
                                revert with 0, 
                                            32,
                                            34,
                                            0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                            mem[(4 * ceil32(return_data.size)) + 390 len 30]
                            require var157002 < stor5.length
                            # nil
                        else:
                            if not (2 * ext_call.return_data[0]) - var111003:
                                if not totalShares:
                                    revert with 0, 'SafeMath: division by zero'
                                if (0 / totalShares) + sharePrice < sharePrice:
                                    revert with 0, 'SafeMath: addition overflow'
                                ...
                                if (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var111003) / (2 * ext_call.return_data[0]) - var111003 != 10^18:
                                    revert with 0, 
                                                32,
                                                33,
                                                0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                ...
                                if not totalShares:
                                    revert with 0, 'SafeMath: division by zero'
                                if ((2 * 10^18 * ext_call.return_data[0]) - (10^18 * var111003) / totalShares) + sharePrice < sharePrice:
                                    revert with 0, 'SafeMath: addition overflow'
                                sharePrice += (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var111003) / totalShares
                            require ext_code.size(baseAssetAddress)
                            staticcall baseAssetAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                    ...
                    if sharePrice * totalShares / totalShares != sharePrice:
                        revert with 0, 
                                    ...
                                    0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                    mem[(4 * ceil32(return_data.size)) + 261 len 31]
                    if var112002 < stor5.length:
                        if var118001 >= stor5.length:
                            revert with 0, 
                                        32,
                                        34,
                                        0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                        mem[(4 * ceil32(return_data.size)) + 326 len 30]
                        require var120002 < stor5.length
                        if var128001 + var128002 < var128002:
                            revert with 0, 'SafeMath: addition overflow'
                        # nil
                    else:
                        if var112003 > 2 * ext_call.return_data[0]:
                            revert with 0, 'SafeMath: subtraction overflow'
                        if (2 * ext_call.return_data[0]) - var112003 < arg1:
                            revert with 0, 
                                        32,
                                        44,
                                        0x6c4956534142553a2070726f66697420646964206e6f742061636869657665206d696e4261736550726f6669,
                                        mem[(4 * ceil32(return_data.size)) + 400 len 20]
                        emit 0x6c14a48d: ((2 * ext_call.return_data[0]) - var112003)
                        if var150002 < stor5.length:
                            if var156001 >= stor5.length:
                                revert with 0, 
                                            32,
                            ...
                            if not (2 * ext_call.return_data[0]) - var112003:
                                if not totalShares:
                                    revert with 0, 'SafeMath: division by zero'
                                if (0 / totalShares) + sharePrice < sharePrice:
                                    revert with 0, 'SafeMath: addition overflow'
                                ...
                                if (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var112003) / (2 * ext_call.return_data[0]) - var112003 != 10^18:
                                    revert with 0, 
                                                32,
                                                33,
                                                0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                ...
                                if not totalShares:
                                    revert with 0, 'SafeMath: division by zero'
                                if ((2 * 10^18 * ext_call.return_data[0]) - (10^18 * var112003) / totalShares) + sharePrice < sharePrice:
                                    revert with 0, 'SafeMath: addition overflow'
                                sharePrice += (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var112003) / totalShares
                            require ext_code.size(baseAssetAddress)
                            staticcall baseAssetAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args this.address
                ...
                if 2 * ext_call.return_data[0] < ext_call.return_data[0]:
                    revert with 0, 'SafeMath: addition overflow'
                if not totalShares:
                    if var159002 < stor5.length:
                        if var165001 >= stor5.length:
                            revert with 0, 
                                        32,
                                        34,
                                        0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                        mem[(10 * ceil32(return_data.size)) + 326 len 30]
                        require var167002 < stor5.length
                        if var175001 + var175002 < var175002:
                            revert with 0, 'SafeMath: addition overflow'
                        # nil
                    else:
                        if var159003 > 2 * ext_call.return_data[0]:
                            revert with 0, 'SafeMath: subtraction overflow'
                        if (2 * ext_call.return_data[0]) - var159003 < arg1:
                            revert with 0, 
                                        32,
                                        44,
                                        0x6c4956534142553a2070726f66697420646964206e6f742061636869657665206d696e4261736550726f6669,
                                        mem[(10 * ceil32(return_data.size)) + 400 len 20]
                        emit 0x6c14a48d: ((2 * ext_call.return_data[0]) - var159003)
                        if var197002 < stor5.length:
                            if var203001 >= stor5.length:
                                revert with 0, 
                                            32,
                                            34,
                                            0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                            mem[(10 * ceil32(return_data.size)) + 390 len 30]
                            require var205002 < stor5.length
                            # nil
                        else:
                            if not (2 * ext_call.return_data[0]) - var159003:
                                if not totalShares:
                                    revert with 0, 'SafeMath: division by zero'
                                if (0 / totalShares) + sharePrice < sharePrice:
                                    revert with 0, 'SafeMath: addition overflow'
                                ...
                                if (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var159003) / (2 * ext_call.return_data[0]) - var159003 != 10^18:
                                    revert with 0, 
                                                32,
                                                33,
                                                0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                ...
                                if not totalShares:
                                    revert with 0, 'SafeMath: division by zero'
                                if ((2 * 10^18 * ext_call.return_data[0]) - (10^18 * var159003) / totalShares) + sharePrice < sharePrice:
                                    revert with 0, 'SafeMath: addition overflow'
                                sharePrice += (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var159003) / totalShares
                            require ext_code.size(baseAssetAddress)
                            staticcall baseAssetAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args address(this.address)
                    ...
                    if sharePrice * totalShares / totalShares != sharePrice:
                        revert with 0, 
                                    ...
                                    0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                    mem[(10 * ceil32(return_data.size)) + 261 len 31]
                    if var160002 < stor5.length:
                        if var166001 >= stor5.length:
                            revert with 0, 
                                        32,
                                        34,
                                        0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                        mem[(10 * ceil32(return_data.size)) + 326 len 30]
                        require var168002 < stor5.length
                        if var176001 + var176002 < var176002:
                            revert with 0, 'SafeMath: addition overflow'
                        # nil
                    else:
                        if var160003 > 2 * ext_call.return_data[0]:
                            revert with 0, 'SafeMath: subtraction overflow'
                        if (2 * ext_call.return_data[0]) - var160003 < arg1:
                            revert with 0, 
                                        32,
                                        44,
                                        0x6c4956534142553a2070726f66697420646964206e6f742061636869657665206d696e4261736550726f6669,
                                        mem[(10 * ceil32(return_data.size)) + 400 len 20]
                        emit 0x6c14a48d: ((2 * ext_call.return_data[0]) - var160003)
                        if var198002 < stor5.length:
                            if var204001 >= stor5.length:
                                revert with 0, 
                                            32,
                                            34,
                                            0xfe456e756d657261626c655365743a20696e646578206f7574206f6620626f756e64,
                                            mem[(10 * ceil32(return_data.size)) + 390 len 30]
                            require var206002 < stor5.length
                            # nil
                        else:
                            if not (2 * ext_call.return_data[0]) - var160003:
                                if not totalShares:
                                    revert with 0, 'SafeMath: division by zero'
                                if (0 / totalShares) + sharePrice < sharePrice:
                                    revert with 0, 'SafeMath: addition overflow'
                                ...
                                if (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var160003) / (2 * ext_call.return_data[0]) - var160003 != 10^18:
                                    revert with 0, 
                                                32,
                                                33,
                                                0x2e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                ...
                                if not totalShares:
                                    revert with 0, 'SafeMath: division by zero'
                                if ((2 * 10^18 * ext_call.return_data[0]) - (10^18 * var160003) / totalShares) + sharePrice < sharePrice:
                                    revert with 0, 'SafeMath: addition overflow'
                                sharePrice += (2 * 10^18 * ext_call.return_data[0]) - (10^18 * var160003) / totalShares
                            require ext_code.size(baseAssetAddress)
                            staticcall baseAssetAddress.0x70a08231 with:
                                    gas gas_remaining wei
                                   args address(this.address)
