...
const sub_1e471e42(?) = (168 * 24 * 3600)

const sub_4139f4ea(?) = (48 * 24 * 3600)
...
function deposit(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    if sub_31fa95b8 + (48 * 24 * 3600) < sub_31fa95b8:
        revert with 0, 'SafeMath: addition overflow'
    if block.timestamp < sub_31fa95b8 + (48 * 24 * 3600):
        if not msg.sender:
...
function lost() payable {
    ...
    if 1 == bool(uint8(stor5.field_168)):
        require ext_code.size(tokenAddress)
...
function claim(uint256 arg1) payable {
    ...
    if not arg1:
        if not totalSupply:
            revert with 0, 'SafeMath: division by zero'
        if sub_31fa95b8 + (168 * 24 * 3600) < sub_31fa95b8:
            revert with 0, 'SafeMath: addition overflow'
        if block.timestamp > sub_31fa95b8 + (168 * 24 * 3600):
            if not msg.sender:
