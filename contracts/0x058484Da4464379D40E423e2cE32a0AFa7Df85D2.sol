...
const getName = 'StrategyTeddyxTeddy'
...
uint256 stor14;
address teddyAddress;
address sub_31012f10Address;
address sub_12a2bd49Address;

function feeDistributor() {
    return feeDistributorAddress
}

function sub_12a2bd49(?) {
    return sub_12a2bd49Address
}
...
function balanceOfPool() {
    ...
    staticcall address(rewardsAddress).stakes(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function getHarvestable() {
    require ext_code.size(address(rewardsAddress))
    staticcall address(rewardsAddress).getPendingLUSDGain(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(rewardsAddress))
    staticcall address(rewardsAddress).getPendingETHGain(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function withdraw(address arg1) {
    ...
    mem[260 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor10), uint32(stor10), ext_call.return_data[0 len 28]
    mem[324 len 0] = 0
    call arg1 with:
       funct uint32(stor10)
         gas gas_remaining wei
    ...
    if not return_data.size:
        if not ext_call.success:
            revert with transfer(address rg1, uint256 rg2), Mask(224, 0, stor10), uint32(stor10), ext_call.return_data[0]
...
function withdrawForSwap(uint256 arg1) {
    ...
    if address(controllerAddress) != msg.sender:
        revert with 0, '!controller'
    require ext_code.size(address(rewardsAddress))
    call address(rewardsAddress).unstake(uint256 rg1) with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit() {
    require ext_code.size(teddyAddress)
    staticcall teddyAddress.balanceOf(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            if ext_call.return_data[0]:
                require ext_code.size(teddyAddress)
                staticcall teddyAddress.allowance(address rg1, address rg2) with:
                        gas gas_remaining wei
