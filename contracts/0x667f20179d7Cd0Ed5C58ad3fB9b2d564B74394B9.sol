...
function safeMint(address arg1) payable {
    ...
    if ext_code.size(arg1):
        ...
        call arg1.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
            ...
            args 0, uint32(msg.sender), 0, stor7, 128, 0
...
function batchMint(address[] arg1) payable {
    mem[64] = 96
    require calldata.size - 4 >= 32
    require arg1 <= test266151307()
    ...
    while idx < arg1.length:
        ...
        if not stor9[address(cd[((32 * idx) + arg1 + 36)])]:
            ...
            mem[0] = stor7
            mem[32] = 2
            ownerOf[stor7] = address(cd[((32 * idx) + arg1 + 36)])
            emit Transfer(0, address(cd[((32 * idx) + arg1 + 36)]), stor7);
            if ext_code.size(address(cd[((32 * idx) + arg1 + 36)])):
