...
function sub_c057e4f1(?) {
    require calldata.size - 4 >= 32
    require arg1 == uint32(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_3747bd45 = uint32(arg1)
}
            ...
            if not address(sub_74bf71c5[stor8[address(arg1)][uint32(idx)] - 1].field_40) - address(arg1):
                ...
                if bool(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_256):
                    ...
                    if not bool(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_256):
                        ...
                        if not uint32(stor[mem[mem[64] + 32 len stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_257 % 128]][Mask(248, 8, uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_256))]):
                            revert with 0, 17
                        uint32(stor[mem[mem[64] + 32 len stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_257 % 128]][Mask(248, 8, uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_256))]) = uint32(uint32(stor[mem[mem[64] + 32 len stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_257 % 128]][Mask(248, 8, uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_256))]) - 1)
                    else:
                        if bool(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_256) != 1:
                            mem[0] = 11
                            if not uint32(stor[sha3(mem[mem[64] len -mem[64] + 32])]):
    ...
    if -('cd', 36).length:
        ...
        while uint32(idx) < ('cd', 36).length:
            ...
            if not address(sub_74bf71c5[mem[(32 * uint32(idx)) + 128]].field_40) - msg.sender:
                ...
                if uint256(stor4[uint8(stor7[mem[(32 * uint32(idx)) + 128]].field_32)].field_512) and sub_3747bd45 > -1 / uint256(stor4[uint8(stor7[mem[(32 * uint32(idx)) + 128]].field_32)].field_512):
                    revert with 0, 17
                if uint256(stor4[uint8(stor7[mem[(32 * uint32(idx)) + 128]].field_32)].field_512) * sub_3747bd45 / 10000 and uint8(cd[4]) > -1 / uint256(stor4[uint8(stor7[mem[(32 * uint32(idx)) + 128]].field_32)].field_512) * sub_3747bd45 / 10000:
                    revert with 0, 17
                if uniswapV2RouterAddress:
                    ...
                    mem[_140 + ceil32(return_data.size) + 100] = uint256(stor4[uint8(stor7[_124].field_32)].field_512) * sub_3747bd45 / 10000 * uint8(cd[4])
                    ...
                    staticcall uniswapV2RouterAddress.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len _140 + ceil32(return_data.size) + (32 * mem[_140]) + -mem[64] + 192]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _180 = mem[64]
                    ...
                    require _180 + return_data.size > _180 + mem[_180] + 31
                    _184 = mem[_180 + mem[_180]]
                    if mem[_180 + mem[_180]] > test266151307():
                        revert with 0, 65
                    if ceil32(32 * mem[_180 + mem[_180]]) + 1 < 0 or _180 + ceil32(return_data.size) + ceil32(32 * mem[_180 + mem[_180]]) + 1 > test266151307():
                        revert with 0, 65
                    ...
                    t = _180 + ceil32(return_data.size) + 32
                    s = _180 + _182 + 32
                    while s < _180 + _182 + (32 * _184) + 32:
                        mem[t] = mem[s]
                        t = t + 32
                        s = s + 32
                        continue 
                    if 1 >= _184:
                        revert with 0, 50
                    if 0 > !mem[_180 + ceil32(return_data.size) + 64]:
                        revert with 0, 17
            if not uint32(idx) - test266151307():
                revert with 0, 17
            idx = uint32(idx) + 1
            ...
            if sub_2655c1b9[msg.sender][uint32(idx)] > 0:
                ...
                if not address(sub_74bf71c5[stor8[msg.sender][uint32(idx)] - 1].field_40) - msg.sender:
                    ...
                    if uint8(uint32(sub_74bf71c5[stor8[msg.sender][uint32(idx)] - 1].field_288) - block.timestamp / sub_8e6a1bc2) > 3:
                        revert with 0, 'Cannot pay more than 3 months'
                    if uint256(stor4[uint8(stor7[stor8[msg.sender][uint32(idx)] - 1].field_32)].field_512) and sub_3747bd45 > -1 / uint256(stor4[uint8(stor7[stor8[msg.sender][uint32(idx)] - 1].field_32)].field_512):
                        revert with 0, 17
                    if uint256(stor4[uint8(stor7[stor8[msg.sender][uint32(idx)] - 1].field_32)].field_512) * sub_3747bd45 / 10000 and uint8(cd[4]) > -1 / uint256(stor4[uint8(stor7[stor8[msg.sender][uint32(idx)] - 1].field_32)].field_512) * sub_3747bd45 / 10000:
                        revert with 0, 17
                    if uniswapV2RouterAddress:
                        _146 = mem[64]
                        mem[mem[64]] = 2
                        ...
                        mem[_146 + ceil32(return_data.size) + 100] = uint256(stor4[uint8(stor7[stor8[msg.sender][uint32(idx)] - 1].field_32)].field_512) * sub_3747bd45 / 10000 * uint8(cd[4])
                        ...
                        staticcall uniswapV2RouterAddress.getAmountsOut(uint256 arg1, address[] arg2) with:
                                gas gas_remaining wei
                               args uint256(stor4[uint8(stor7[stor8[msg.sender][uint32(idx)] - 1].field_32)].field_512) * sub_3747bd45 / 10000 * uint8(cd[4]), 64, mem[_146 + ceil32(return_data.size) + 164 len (32 * mem[_146]) + 32]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        mem[_146 + ceil32(return_data.size) + 96 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        mem[64] = _146 + (2 * ceil32(return_data.size)) + 96
                        require return_data.size >= 32
                        _183 = mem[_146 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, uint256(stor4[uint8(stor7[stor8[msg.sender][uint32(idx)] - 1].field_32)].field_512) * sub_3747bd45 / 10000 * uint8(cd[4])) >> 32
                        require mem[_146 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, uint256(stor4[uint8(stor7[stor8[msg.sender][uint32(idx)] - 1].field_32)].field_512) * sub_3747bd45 / 10000 * uint8(cd[4])) >> 32 <= test266151307()
                        require _146 + ceil32(return_data.size) + return_data.size + 96 > _146 + ceil32(return_data.size) + mem[_146 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, uint256(stor4[uint8(stor7[stor8[msg.sender][uint32(idx)] - 1].field_32)].field_512) * sub_3747bd45 / 10000 * uint8(cd[4])) >> 32 + 127
                        _185 = mem[_146 + ceil32(return_data.size) + mem[_146 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, uint256(stor4[uint8(stor7[stor8[msg.sender][uint32(idx)] - 1].field_32)].field_512) * sub_3747bd45 / 10000 * uint8(cd[4])) >> 32 + 96]
                        if mem[_146 + ceil32(return_data.size) + mem[_146 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, uint256(stor4[uint8(stor7[stor8[msg.sender][uint32(idx)] - 1].field_32)].field_512) * sub_3747bd45 / 10000 * uint8(cd[4])) >> 32 + 96] > test266151307():
                            revert with 0, 65
                        if ceil32(32 * mem[_146 + ceil32(return_data.size) + mem[_146 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, uint256(stor4[uint8(stor7[stor8[msg.sender][uint32(idx)] - 1].field_32)].field_512) * sub_3747bd45 / 10000 * uint8(cd[4])) >> 32 + 96]) + 1 < 0 or _146 + (2 * ceil32(return_data.size)) + ceil32(32 * mem[_146 + ceil32(return_data.size) + mem[_146 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, uint256(stor4[uint8(stor7[stor8[msg.sender][uint32(idx)] - 1].field_32)].field_512) * sub_3747bd45 / 10000 * uint8(cd[4])) >> 32 + 96]) + 97 > test266151307():
                            revert with 0, 65
                        mem[64] = _146 + (2 * ceil32(return_data.size)) + ceil32(32 * mem[_146 + ceil32(return_data.size) + mem[_146 + ceil32(return_data.size) + 96 len 4], Mask(224, 32, uint256(stor4[uint8(stor7[stor8[msg.sender][uint32(idx)] - 1].field_32)].field_512) * sub_3747bd45 / 10000 * uint8(cd[4])) >> 32 + 96]) + 97
                        mem[_146 + (2 * ceil32(return_data.size)) + 96] = _185
                        require _183 + (32 * _185) + 32 <= return_data.size
                        t = _146 + (2 * ceil32(return_data.size)) + 128
                        s = _146 + ceil32(return_data.size) + _183 + 128
                        while s < _146 + ceil32(return_data.size) + _183 + (32 * _185) + 128:
                            mem[t] = mem[s]
                            t = t + 32
                            s = s + 32
                            continue 
                        if 1 >= _185:
                            revert with 0, 50
                        if 0 > !mem[_146 + (2 * ceil32(return_data.size)) + 160]:
                            revert with 0, 17
            if not uint32(idx) - test266151307():
                revert with 0, 17
            idx = uint32(idx) + 1
...
function claimable(address arg1) {
    ...
    if not sub_2655c1b9[address(arg1)]:
        ...
        while uint32(idx) < sub_2655c1b9[address(arg1)]:
            mem[32] = 8
            if uint32(idx) >= sub_2655c1b9[address(arg1)]:
                revert with 0, 50
            mem[0] = sha3(address(arg1), 8)
            if sub_2655c1b9[address(arg1)][uint32(idx)] <= 0:
                if not uint32(idx) - test266151307():
            ...
            if block.timestamp - uint32(sub_74bf71c5[stor8[address(arg1)][uint32(idx)] - 1].field_256) and uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_768) > -1 / block.timestamp - uint32(sub_74bf71c5[stor8[address(arg1)][uint32(idx)] - 1].field_256):
                revert with 0, 17
            if (block.timestamp * uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_768)) - (uint32(sub_74bf71c5[stor8[address(arg1)][uint32(idx)] - 1].field_256) * uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_768)) and mem[_59] > -1 / (block.timestamp * uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_768)) - (uint32(sub_74bf71c5[stor8[address(arg1)][uint32(idx)] - 1].field_256) * uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_768)):
                revert with 0, 17
            if not uint32(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_1024):
                revert with 0, 18
            if (block.timestamp * uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_768) * mem[_59]) - (uint32(sub_74bf71c5[stor8[address(arg1)][uint32(idx)] - 1].field_256) * uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_768) * mem[_59]) / 10^18 / uint32(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_1024) > !s:
                revert with 0, 17
            if uint32(t) >= mem[96]:
                revert with 0, 50
            mem[(32 * uint32(t)) + 128] = sub_2655c1b9[address(arg1)][uint32(idx)]
            ...
            if not uint32(idx) - test266151307():
                revert with 0, 17
            idx = uint32(idx) + 1
            s = ((block.timestamp * uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_768) * _61) - (uint32(sub_74bf71c5[stor8[address(arg1)][uint32(idx)] - 1].field_256) * uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_768) * _61) / 10^18 / uint32(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_1024)) + s
            t = uint32(t) + 1
            continue 
    else:
        ...
        while uint32(idx) < sub_2655c1b9[address(arg1)]:
            ...
            if block.timestamp - uint32(sub_74bf71c5[stor8[address(arg1)][uint32(idx)] - 1].field_256) and uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_768) > -1 / block.timestamp - uint32(sub_74bf71c5[stor8[address(arg1)][uint32(idx)] - 1].field_256):
                revert with 0, 17
            if (block.timestamp * uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_768)) - (uint32(sub_74bf71c5[stor8[address(arg1)][uint32(idx)] - 1].field_256) * uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_768)) and mem[_60] > -1 / (block.timestamp * uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_768)) - (uint32(sub_74bf71c5[stor8[address(arg1)][uint32(idx)] - 1].field_256) * uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_768)):
                revert with 0, 17
            if not uint32(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_1024):
                revert with 0, 18
            if (block.timestamp * uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_768) * mem[_60]) - (uint32(sub_74bf71c5[stor8[address(arg1)][uint32(idx)] - 1].field_256) * uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_768) * mem[_60]) / 10^18 / uint32(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_1024) > !s:
                revert with 0, 17
            if uint32(t) >= mem[96]:
                revert with 0, 50
            mem[(32 * uint32(t)) + 128] = sub_2655c1b9[address(arg1)][uint32(idx)]
            ...
            if not uint32(idx) - test266151307():
                revert with 0, 17
            idx = uint32(idx) + 1
            s = ((block.timestamp * uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_768) * _62) - (uint32(sub_74bf71c5[stor8[address(arg1)][uint32(idx)] - 1].field_256) * uint256(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_768) * _62) / 10^18 / uint32(stor4[uint8(stor7[stor8[address(arg1)][uint32(idx)] - 1].field_32)].field_1024)) + s
            t = uint32(t) + 1
            continue 
    if s > !sub_4c3f427d[msg.sender]:
        revert with 0, 17
    return (s + sub_4c3f427d[msg.sender])
}
...
function claim() {
    ...
    if not sub_2655c1b9[address(msg.sender)]:
        ...
        while uint32(idx) < sub_2655c1b9[address(msg.sender)]:
            mem[32] = 8
            if uint32(idx) >= sub_2655c1b9[address(msg.sender)]:
                revert with 0, 50
            mem[0] = sha3(address(msg.sender), 8)
            if sub_2655c1b9[address(msg.sender)][uint32(idx)] <= 0:
                if not uint32(idx) - test266151307():
                    revert with 0, 17
                idx = uint32(idx) + 1
                s = s
            ...
            if not address(stor1.length):
                ...
                if not uint32(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_1024):
                    revert with 0, 18
                if (10^18 * block.timestamp * uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768)) - (10^18 * uint32(sub_74bf71c5[stor8[address(msg.sender)][uint32(idx)] - 1].field_256) * uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768)) / 10^18 / uint32(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_1024) > !s:
                    revert with 0, 17
                if uint32(t) >= mem[96]:
                    revert with 0, 50
                mem[(32 * uint32(t)) + 128] = sub_2655c1b9[address(msg.sender)][uint32(idx)]
                if not uint32(t) - test266151307():
                    revert with 0, 17
                if not uint32(idx) - test266151307():
                    revert with 0, 17
            ...
            if block.timestamp - uint32(sub_74bf71c5[stor8[address(msg.sender)][uint32(idx)] - 1].field_256) and uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768) > -1 / block.timestamp - uint32(sub_74bf71c5[stor8[address(msg.sender)][uint32(idx)] - 1].field_256):
                revert with 0, 17
            if (block.timestamp * uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768)) - (uint32(sub_74bf71c5[stor8[address(msg.sender)][uint32(idx)] - 1].field_256) * uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768)) and mem[_138] > -1 / (block.timestamp * uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768)) - (uint32(sub_74bf71c5[stor8[address(msg.sender)][uint32(idx)] - 1].field_256) * uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768)):
                revert with 0, 17
            if not uint32(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_1024):
                revert with 0, 18
            if (block.timestamp * uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768) * mem[_138]) - (uint32(sub_74bf71c5[stor8[address(msg.sender)][uint32(idx)] - 1].field_256) * uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768) * mem[_138]) / 10^18 / uint32(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_1024) > !s:
                revert with 0, 17
            if uint32(t) >= mem[96]:
                revert with 0, 50
            mem[(32 * uint32(t)) + 128] = sub_2655c1b9[address(msg.sender)][uint32(idx)]
            ...
            if not uint32(idx) - test266151307():
                revert with 0, 17
            idx = uint32(idx) + 1
            s = ((block.timestamp * uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768) * _141) - (uint32(sub_74bf71c5[stor8[address(msg.sender)][uint32(idx)] - 1].field_256) * uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768) * _141) / 10^18 / uint32(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_1024)) + s
            t = uint32(t) + 1
            continue 
        if not s:
            s = 0
            while uint32(s) < uint32(t):
                if uint32(s) >= mem[96]:
                    revert with 0, 50
                if mem[(32 * uint32(s)) + 128] < 1:
                    revert with 0, 17
                if mem[(32 * uint32(s)) + 128] - 1 >= sub_74bf71c5.length:
                    revert with 0, 50
                mem[0] = 7
                uint32(sub_74bf71c5[mem[(32 * uint32(s)) + 128] - 1].field_256) = uint32(block.timestamp)
                if not uint32(s) - test266151307():
                    revert with 0, 17
                s = uint32(s) + 1
                continue 
            if not claimFee:
                ...
                mem[mem[64] + 68] = sub_4c3f427d[msg.sender]
                call tokenAddress.transferFrom(address arg1, address arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args rewardsPoolAddress, msg.sender, sub_4c3f427d[msg.sender]
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _205 = mem[64]
                ...
                if sub_4c3f427d[msg.sender] and claimFee > -1 / sub_4c3f427d[msg.sender]:
                    revert with 0, 17
                mem[0] = msg.sender
                mem[32] = 14
                if sub_4c3f427d[msg.sender] < sub_4c3f427d[msg.sender] * claimFee / 10000:
                    revert with 0, 17
                sub_4c3f427d[msg.sender] -= sub_4c3f427d[msg.sender] * claimFee / 10000
                mem[mem[64] + 4] = rewardsPoolAddress
                mem[mem[64] + 36] = sub_919df198Address
                mem[mem[64] + 68] = sub_4c3f427d[msg.sender] * claimFee / 10000
                call tokenAddress.transferFrom(address arg1, address arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args rewardsPoolAddress, sub_919df198Address, sub_4c3f427d[msg.sender] * claimFee / 10000
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _233 = mem[64]
            ...
            if rewardsTotal > !s:
                revert with 0, 17
            rewardsTotal += s
            if sub_4c3f427d[msg.sender] > !s:
                revert with 0, 17
            sub_4c3f427d[msg.sender] += s
            s = 0
            while uint32(s) < uint32(t):
                if uint32(s) >= mem[96]:
                    revert with 0, 50
        ...
        while uint32(idx) < sub_2655c1b9[address(msg.sender)]:
            ...
            if block.timestamp - uint32(sub_74bf71c5[stor8[address(msg.sender)][uint32(idx)] - 1].field_256) and uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768) > -1 / block.timestamp - uint32(sub_74bf71c5[stor8[address(msg.sender)][uint32(idx)] - 1].field_256):
                revert with 0, 17
            if (block.timestamp * uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768)) - (uint32(sub_74bf71c5[stor8[address(msg.sender)][uint32(idx)] - 1].field_256) * uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768)) and mem[_140] > -1 / (block.timestamp * uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768)) - (uint32(sub_74bf71c5[stor8[address(msg.sender)][uint32(idx)] - 1].field_256) * uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768)):
                revert with 0, 17
            if not uint32(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_1024):
                revert with 0, 18
            if (block.timestamp * uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768) * mem[_140]) - (uint32(sub_74bf71c5[stor8[address(msg.sender)][uint32(idx)] - 1].field_256) * uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768) * mem[_140]) / 10^18 / uint32(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_1024) > !s:
                revert with 0, 17
            if uint32(t) >= mem[96]:
                revert with 0, 50
            mem[(32 * uint32(t)) + 128] = sub_2655c1b9[address(msg.sender)][uint32(idx)]
            ...
            if not uint32(idx) - test266151307():
                revert with 0, 17
            idx = uint32(idx) + 1
            s = ((block.timestamp * uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768) * _142) - (uint32(sub_74bf71c5[stor8[address(msg.sender)][uint32(idx)] - 1].field_256) * uint256(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_768) * _142) / 10^18 / uint32(stor4[uint8(stor7[stor8[address(msg.sender)][uint32(idx)] - 1].field_32)].field_1024)) + s
            t = uint32(t) + 1
            continue 
        if not s:
            s = 0
        ...
        while uint8(idx) < stor4.length:
            ...
            if bool(stor4[uint8(idx)].field_256):
                ...
                if not bool(stor4[uint8(idx)].field_256):
                    mem[mem[64]] = Mask(248, 8, uint256(stor4[uint8(idx)].field_256))
                    mem[mem[64] + stor4[uint8(idx)].field_257 % 128] = 5
                    if uint8(stor[sha3(mem[mem[64] len _6367 + stor4[uint8(idx)].field_257 % 128 + -mem[64] + 32])]) <= 0:
                        if not uint8(idx) - 255:
                            revert with 0, 17
                        idx = uint8(idx) + 1
                        s = s
