...
const VESTING_DURATION = (2160 * 24 * 3600)

const DEV_FUND_POOL_ALLOCATION = 4999 * 10^18

const FARMING_POOL_REWARD_ALLOCATION = 65000 * 10^18
...
function distributeReward(address arg1) payable {
    ...
    stor12 = 1
    if totalSupply + 65000 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 65000 * 10^18
    if balanceOf[address(arg1)] + 65000 * 10^18 < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 65000 * 10^18
    emit Transfer(65000 * 10^18, 0, arg1);
}
