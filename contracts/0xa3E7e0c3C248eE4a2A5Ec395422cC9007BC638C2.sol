...
function sub_b2b6b6c9(?) {
    ...
    if not sub_efca2a3e[address(msg.sender)].field_256:
        ...
        if eth.balance(this.address) < eth.balance(this.address):
            revert with 0, 17
        if 0 < sub_77b7dc5f[msg.sender].field_0:
            revert with 0, 17
        if -sub_77b7dc5f[msg.sender].field_0 and arg2 > -1 / -sub_77b7dc5f[msg.sender].field_0:
            revert with 0, 17
        if 0 < -1 * sub_77b7dc5f[msg.sender].field_0 * arg2 / 100:
            revert with 0, 17
        if -1 * sub_77b7dc5f[msg.sender].field_0 * arg2 / 100:
            call address(arg1) with:
               value -1 * sub_77b7dc5f[msg.sender].field_0 * arg2 / 100 wei
        ...
        if --1 * sub_77b7dc5f[msg.sender].field_0 * arg2 / 100:
            ...
            if not ext_call.success:
                revert with 0, 'Could not transfer tokens'
        emit 0x9a54804c: 0, address(arg1), arg2, 0, -1 * sub_77b7dc5f[msg.sender].field_0 * arg2 / 100, msg.sender
    else:
        if not ext_call.return_data[0]:
            sub_efca2a3e[msg.sender].field_0 = 0
            sub_efca2a3e[msg.sender].field_256 = 0
            ...
            if --1 * sub_77b7dc5f[msg.sender].field_0 * arg2 / 100:
                ...
                if not ext_call.success:
                    revert with 0, 'Could not transfer tokens'
            emit 0x9a54804c: (sub_efca2a3e[address(msg.sender)].field_256 * ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18, address(arg1), arg2, 0, -1 * sub_77b7dc5f[msg.sender].field_0 * arg2 / 100, msg.sender
}
