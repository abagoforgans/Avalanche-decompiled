...
function _getNodeNumberOf(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require ext_code.size(0x49c4943e781d5f5835b2f43a481f86678c0d420e)
    delegate 0x49c4943e781d5f5835b2f43a481f86678c0d420e.0x732a2ccf with:
...
function _migrateNodes(address arg1, string[] arg2, uint256[] arg3, uint256[] arg4, uint256[] arg5) payable {
    ...
    if msg.sender == tokenAddress:
        ...
        while idx < _456:
            ...
            continue 
    require ext_code.size(0x49c4943e781d5f5835b2f43a481f86678c0d420e)
    delegate 0x49c4943e781d5f5835b2f43a481f86678c0d420e.0xbc2b405c with:
         gas gas_remaining wei
