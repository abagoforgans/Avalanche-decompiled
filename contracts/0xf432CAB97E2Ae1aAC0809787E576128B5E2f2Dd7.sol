...
function name() payable {
    call stor0 with:
       funct Mask(32, 224, '0x06fdde03') >> 224
         gas gas_remaining wei
        args (Mask(48, 176, '0x06fdde03') >> 176)
    if return_data.size:
        return bool(ext_call.success), Array(len=return_data.size, data=ext_call.return_data[0 len return_data.size])
...
function newun() payable {
    call stor0 with:
       funct Mask(32, 224, '0x1ee59f20') >> 224
         gas gas_remaining wei
        args (Mask(48, 176, '0x1ee59f20') >> 176)
    if return_data.size:
        return bool(ext_call.success), Array(len=return_data.size, data=ext_call.return_data[0 len return_data.size])
    mem[96] = bool(ext_call.success)
    mem[128] = 64
...
function decimals() payable {
    call stor0 with:
       funct Mask(32, 224, '0x313ce567') >> 224
         gas gas_remaining wei
        args (Mask(48, 176, '0x313ce567') >> 176)
    if return_data.size:
        return bool(ext_call.success), Array(len=return_data.size, data=ext_call.return_data[0 len return_data.size])
    mem[96] = bool(ext_call.success)
    mem[128] = 64
