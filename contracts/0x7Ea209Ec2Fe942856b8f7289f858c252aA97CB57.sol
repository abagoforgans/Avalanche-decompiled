...
function sub_4b007dbb(?) payable {
    ...
    if not return_data.size:
        ...
        mem[264] = 0x56d0fed06d2e0b5ac80d7a9ed0387694bdf90c33
        mem[296] = -1
        mem[228] = 68
        mem[260 len 4] = approve(address arg1, uint256 arg2)
        mem[328 len 96] = 0, 0x56d0fed06d2e0b5ac80d7a9ed0387694bdf90c33, -1, 0
        mem[396] = 0
        call 0xb2ac04b71888e17aa2c5102cf3d0215467d74100 with:
           funct Mask(32, 224, 0, 0x56d0fed06d2e0b5ac80d7a9ed0387694bdf90c33, -1, 0) >> 224
             gas gas_remaining wei
            args (Mask(512, -288, 0, 0x56d0fed06d2e0b5ac80d7a9ed0387694bdf90c33, -1, 0) << 288)
        if not return_data.size:
            if not ext_call.success:
                revert with 0, 'Not success approve'
            mem[332] = this.address
            ...
            if not ext_call.success:
                revert with 0, 'Not success approve'
            mem[ceil32(return_data.size) + 333] = this.address
            require ext_code.size(0xb2ac04b71888e17aa2c5102cf3d0215467d74100)
            call 0xb2ac04b71888e17aa2c5102cf3d0215467d74100.0x70a08231 with:
                 gas gas_remaining wei
                args this.address
    ...
    if not ext_call.success:
        revert with 0, 'Not success deposit'
    mem[ceil32(return_data.size) + 265] = 0x56d0fed06d2e0b5ac80d7a9ed0387694bdf90c33
    mem[ceil32(return_data.size) + 297] = -1
    mem[ceil32(return_data.size) + 229] = 68
    mem[ceil32(return_data.size) + 261 len 4] = approve(address arg1, uint256 arg2)
    mem[ceil32(return_data.size) + 329 len 96] = 0, 0x56d0fed06d2e0b5ac80d7a9ed0387694bdf90c33, -1, mem[ceil32(return_data.size) + 329 len 28]
    mem[ceil32(return_data.size) + 397] = 0
    call 0xb2ac04b71888e17aa2c5102cf3d0215467d74100.mem[ceil32(return_data.size) + 329 len 4] with:
         gas gas_remaining wei
        args mem[ceil32(return_data.size) + 333 len 64]
    if not return_data.size:
        if not ext_call.success:
            revert with 0, 'Not success approve'
        mem[ceil32(return_data.size) + 333] = this.address
        ...
        revert with memory
          from (4 * ceil32(return_data.size)) + 3794
           len (4 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 100
    mem[ceil32(return_data.size) + 329] = return_data.size
    ...
    call 0xb2ac04b71888e17aa2c5102cf3d0215467d74100.0x70a08231 with:
         gas gas_remaining wei
        args this.address
    mem[(2 * ceil32(return_data.size)) + 330] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
