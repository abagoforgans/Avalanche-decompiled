...
function unmoon(uint256 arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    mem[100] = msg.sender
...
function moon(uint256 arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    mem[100] = msg.sender
    require ext_code.size(YAKAddress)
    staticcall YAKAddress.0x70a08231 with:
            gas gas_remaining wei
           args msg.sender
    mem[96] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    if arg1 < ext_call.return_data[0]:
        ...
        if totalSupply > -ext_call.return_data[0] - 1:
            revert with 'NH{q', 17
        totalSupply += ext_call.return_data[0]
        if balanceOf[address(arg2)] > -ext_call.return_data[0] - 1:
            revert with 'NH{q', 17
        balanceOf[address(arg2)] += ext_call.return_data[0]
        emit Transfer(ext_call.return_data[0], 0, arg2);
}
