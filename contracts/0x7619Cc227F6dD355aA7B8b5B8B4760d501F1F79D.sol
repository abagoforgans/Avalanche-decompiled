...
function rewardsAvailable() payable {
    ...
    mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 437 len 64] = Mask(32, 224, sha3(mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 341 len mem[ceil32(sub_277e5cfd.length) + 192]])) >> 224, Mask(224, 0, stor16.field_32), uint32(stor16.field_0), Mask(224, 32, this.address) >> 32
