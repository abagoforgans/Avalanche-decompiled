                    ...
                    if not (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 / 10^(-uint8(ext_call.return_data[0]) + 18):
                        ...
                        if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[_618 + floor32(mem[_619]) + 100] = mem[_619 + -(mem[_619] % 32) + floor32(mem[_619]) + 64 len mem[_619] % 32] or Mask(8 * -(mem[_619] % 32) + 32, -(8 * -(mem[_619] % 32) + 32) + 256, mem[_618 + floor32(mem[_619]) + 100])
                            call sub_8ef4403c[idx].mem[_618 + 100 len 4] with:
                                 gas gas_remaining wei
                                args mem[_618 + 104 len _622 - 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, '!safeTransfer'
                                if mem[96]:
                                    ...
                                    if not mem[128]:
                                        revert with 0, '!safeTransfer'
                                mem[_618 + 100] = (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 / 10^(-uint8(ext_call.return_data[0]) + 18)
                            else:
                                mem[64] = _618 + ceil32(return_data.size) + 101
                                mem[_618 + 100] = return_data.size
                                mem[_618 + 132 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                if not ext_call.success:
                                    revert with 0, '!safeTransfer'
                                if return_data.size:
                                    require return_data.size >= 32
                                    if not mem[_618 + 132]:
                                        revert with 0, '!safeTransfer'
                                mem[_618 + ceil32(return_data.size) + 101] = (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 / 10^(-uint8(ext_call.return_data[0]) + 18)
                    emit StakingGainsWithdrawn(((sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 / 10^(-uint8(ext_call.return_data[0]) + 18)), msg.sender, sub_8ef4403c[idx]);
                else:
                    _487 = mem[64]
                    mem[64] = mem[64] + 64
