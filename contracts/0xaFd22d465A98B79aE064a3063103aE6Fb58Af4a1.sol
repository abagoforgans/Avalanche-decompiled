...
function panic() payable {
    ...
    call 0x006cc053bdb84c2d6380b3c4a573d84636378a47.exit() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        ...
        call lpPairAddress.0x36378a47 with:
             gas gas_remaining wei
            args Mask(480, -256, approve(address rg1, uint256 rg2), 131472227633609467351839684, 0, 0) << 256, mem[324 len 4]
        if not return_data.size:
            ...
            if ext_code.size(lpPairAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = 0, 0x6cc053bdb84c2d6380b3c4a573d84636378a47, ext_call.return_data[0 len 28]
            call lpPairAddress.0x36378a47 with:
                 gas gas_remaining wei
            ...
            if ext_code.size(lpPairAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 425 len 64] = 0, 0x6cc053bdb84c2d6380b3c4a573d84636378a47, ext_call.return_data[0 len 28]
            call lpPairAddress.0x36378a47 with:
                 gas gas_remaining wei
