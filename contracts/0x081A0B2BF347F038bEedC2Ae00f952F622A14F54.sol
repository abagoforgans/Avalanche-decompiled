...
function sub_ae97fa8c(?) payable {
    ...
    mem[ceil32(arg1.length) + 196] = 10^18
    require ext_code.size(stor10)
    call stor10 with:
         gas gas_remaining wei
        args msg.sender, 96, 10^18, arg1.length, arg1[all], mem[arg1.length + 128 len ceil32(arg1.length) - arg1.length]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
