...
function buyItem(uint256 arg1) payable {
    ...
    staticcall itemsForSale[arg1].field_256.getApproved(uint256 arg1) with:
            gas gas_remaining wei
           args itemsForSale[arg1].field_512
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    ...
    if msg.value < itemsForSale[arg1].field_1024:
        revert with 0, 'Not enought funds sent'
    if arg1 >= itemsForSale.length:
        revert with 'NH{q', 50
    if msg.sender == itemsForSale[arg1].field_768:
        revert with 0, 'You can't buy your own item'
    if arg1 >= itemsForSale.length:
        revert with 'NH{q', 50
    require ext_code.size(itemsForSale[arg1].field_256)
    staticcall itemsForSale[arg1].field_256.ownerOf(uint256 arg1) with:
            gas gas_remaining wei
           args itemsForSale[arg1].field_512
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if arg1 >= itemsForSale.length:
        revert with 'NH{q', 50
    if itemsForSale[arg1].field_768 != ext_call.return_data[12 len 20]:
        revert with 0, 'The seller no longer has the item'
    if arg1 >= itemsForSale.length:
        revert with 'NH{q', 50
    stor3[stor1[arg1].field_256][stor1[arg1].field_512] = 0
    stor2[stor1[arg1].field_256][stor1[arg1].field_512] = 0
    ...
    if not stor4[stor1[arg1].field_256]:
        ...
        if msg.value - (25 * msg.value / 1000) - (975 * msg.value / 1000) <= 0:
            ...
            call stor8 with:
               value msg.value - (975 * msg.value / 1000) wei
                 gas gas_remaining wei
        if not ext_call.success:
            revert with 0, 'Platform payment failed'
        call itemsForSale[arg1].field_768 with:
           value 975 * msg.value / 1000 wei
             gas gas_remaining wei
        if not ext_call.success:
            revert with 0, 'Seller payment failed'
    else:
        ...
        call stor6[stor1[arg1].field_256] with:
           value msg.value * stor5[stor1[arg1].field_256] / 1000 wei
             gas gas_remaining wei
        if not ext_call.success:
            revert with 0, 'Royalties payment failed'
    ('bool', 'ext_call.success')
    require ext_code.size(itemsForSale[arg1].field_256)
    call itemsForSale[arg1].field_256.0x23b872dd with:
         gas gas_remaining wei
