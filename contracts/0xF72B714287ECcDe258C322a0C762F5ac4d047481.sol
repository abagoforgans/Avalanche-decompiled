    ...
    if stor4[address(msg.sender)]:
        ...
        if stor4[address(arg1)]:
            ...
            if not arg2:
                ...
                if arg2 * devFee / 700 > balanceOf[address(msg.sender)]:
                    revert with 0, 'SafeMath: subtraction overflow'
                balanceOf[address(msg.sender)] -= arg2 * devFee / 700
                if balanceOf[stor11] + (arg2 * devFee / 700) < balanceOf[stor11]:
                    revert with 0, 'SafeMath: addition overflow'
                balanceOf[stor11] += arg2 * devFee / 700
                emit Transfer((arg2 * devFee / 700), msg.sender, devAddress);
                if not msg.sender:
                    revert with 0, 32, 37, 0x7345524332303a207472616e736665722066726f6d20746865207a65726f20616464726573, mem[393 len 27]
                if not address(stor10.field_8):
            ...
            if arg2 * stor12 / 100 > balanceOf[address(msg.sender)]:
                revert with 0, 'SafeMath: subtraction overflow'
            balanceOf[address(msg.sender)] -= arg2 * stor12 / 100
            if balanceOf[address(stor10.field_0)] + (arg2 * stor12 / 100) < balanceOf[address(stor10.field_0)]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[address(stor10.field_0)] += arg2 * stor12 / 100
            emit Transfer((arg2 * stor12 / 100), msg.sender, address(stor10.field_8));
            if arg2 * devFee / 700 > arg2:
                revert with 0, 'SafeMath: subtraction overflow'
            if arg2 * stor12 / 100 > arg2 - (arg2 * devFee / 700):
                revert with 0, 'SafeMath: subtraction overflow'
            if not msg.sender:
            ...
            if arg2 - (arg2 * devFee / 700) - (arg2 * stor12 / 100) <= 0:
            ...
            if arg2 - (arg2 * devFee / 700) - (arg2 * stor12 / 100) > balanceOf[address(msg.sender)]:
                revert with 0, 'SafeMath: subtraction overflow'
            balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] - arg2 + (arg2 * devFee / 700) + (arg2 * stor12 / 100)
            if balanceOf[address(arg1)] + arg2 - (arg2 * devFee / 700) - (arg2 * stor12 / 100) < balanceOf[address(arg1)]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[address(arg1)] = balanceOf[address(arg1)] + arg2 - (arg2 * devFee / 700) - (arg2 * stor12 / 100)
            emit Transfer((arg2 - (arg2 * devFee / 700) - (arg2 * stor12 / 100)), msg.sender, arg1);
    return 1
}
    ...
    if stor4[address(msg.sender)]:
        ...
        if stor4[address(arg2)]:
            ...
            if not arg3:
                ...
                if not devAddress:
                    revert with 0, 32, 35, 0x6f42455032303a207472616e7366657220746f20746865207a65726f20616464726573, mem[327 len 29]
                if arg3 * devFee / 700 > balanceOf[address(arg1)]:
                    revert with 0, 'SafeMath: subtraction overflow'
                balanceOf[address(arg1)] -= arg3 * devFee / 700
                if balanceOf[stor11] + (arg3 * devFee / 700) < balanceOf[stor11]:
                    revert with 0, 'SafeMath: addition overflow'
                balanceOf[stor11] += arg3 * devFee / 700
                emit Transfer((arg3 * devFee / 700), arg1, devAddress);
                if not arg1:
                    revert with 0, 32, 37, 0x7345524332303a207472616e736665722066726f6d20746865207a65726f20616464726573, mem[393 len 27]
                if not address(stor10.field_8):
                    revert with 0, 32, 35, 0xfe45524332303a207472616e7366657220746f20746865207a65726f20616464726573, mem[391 len 29]
            ...
            if not address(stor10.field_8):
                revert with 0, 32, 35, 0x6f42455032303a207472616e7366657220746f20746865207a65726f20616464726573, mem[391 len 29]
            if arg3 * stor12 / 100 > balanceOf[address(arg1)]:
                revert with 0, 'SafeMath: subtraction overflow'
            balanceOf[address(arg1)] -= arg3 * stor12 / 100
            if balanceOf[address(stor10.field_0)] + (arg3 * stor12 / 100) < balanceOf[address(stor10.field_0)]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[address(stor10.field_0)] += arg3 * stor12 / 100
            emit Transfer((arg3 * stor12 / 100), arg1, address(stor10.field_8));
            if arg3 * devFee / 700 > arg3:
                revert with 0, 'SafeMath: subtraction overflow'
            if arg3 * stor12 / 100 > arg3 - (arg3 * devFee / 700):
                revert with 0, 'SafeMath: subtraction overflow'
            if not arg1:
                revert with 0, 32, 37, 0x7345524332303a207472616e736665722066726f6d20746865207a65726f20616464726573, mem[585 len 27]
            if not arg2:
                revert with 0, 32, 35, 0xfe45524332303a207472616e7366657220746f20746865207a65726f20616464726573, mem[583 len 29]
            if arg3 - (arg3 * devFee / 700) - (arg3 * stor12 / 100) <= 0:
                revert with 0, 32, 41, 0x655472616e7366657220616d6f756e74206d7573742062652067726561746572207468616e207a6572, mem[589 len 23]
            if uint8(stor15.field_0):
                if stor14[address(arg1)]:
                    revert with 0, 32, 41, 0x655472616e7366657220616d6f756e74206d7573742062652067726561746572207468616e207a6572, mem[589 len 23]
            ...
            if not arg2:
                revert with 0, 32, 35, 0x6f42455032303a207472616e7366657220746f20746865207a65726f20616464726573, mem[583 len 29]
            if arg3 - (arg3 * devFee / 700) - (arg3 * stor12 / 100) > balanceOf[address(arg1)]:
                revert with 0, 'SafeMath: subtraction overflow'
            balanceOf[address(arg1)] = balanceOf[address(arg1)] - arg3 + (arg3 * devFee / 700) + (arg3 * stor12 / 100)
            if balanceOf[address(arg2)] + arg3 - (arg3 * devFee / 700) - (arg3 * stor12 / 100) < balanceOf[address(arg2)]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[address(arg2)] = balanceOf[address(arg2)] + arg3 - (arg3 * devFee / 700) - (arg3 * stor12 / 100)
            emit Transfer((arg3 - (arg3 * devFee / 700) - (arg3 * stor12 / 100)), arg1, arg2);
