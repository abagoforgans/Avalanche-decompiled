...
function sKLIMA() payable {
    return sKLIMAAddress
}
...
function sub_2f236c65(?) payable {
    ...
    require ext_code.size(sKLIMAAddress)
    call sKLIMAAddress.0x23b872dd with:
         gas gas_remaining wei
    ...
    require ext_code.size(sKLIMAAddress)
    call sKLIMAAddress.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
    ...
    call KLIMAAddress.0xa9059cbb with:
         gas gas_remaining wei
    ...
    mem[floor32(('cd', 4).length) + floor32(('cd', 36).length) + (4 * ceil32(return_data.size)) + 134] = KLIMAAddress
    ...
    call SWAPAddress.0xf4214a53 with:
         gas gas_remaining wei
        args cd[100], KLIMAAddress, Array(len=('cd', 4).length, data=mem[floor32(('cd', 4).length) + floor32(('cd', 36).length) + (4 * ceil32(return_data.size)) + 294 len (32 * ('cd', 4).length) + (32 * ('cd', 36).length) + 32]), (32 * ('cd', 4).length) + 192, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_c7987c06(?) payable {
    ...
    while idx < 2:
        if mem[mem[(32 * idx) + 96]] <= 0:
            if idx >= mem[_19]:
                revert with 'NH{q', 50
            mem[(32 * idx) + _19 + 32] = KLIMAAddress
            if idx >= mem[_19 + 96]:
                revert with 'NH{q', 50
            ...
            while s < _74:
                ...
                u = u + 32
                continue 
            mem[mem[64] + 100] = (32 * _74) + 192
            _375 = mem[_72]
            mem[mem[64] + (32 * _74) + 196] = mem[_72]
            s = 0
            t = _72 + 32
            u = mem[64] + (32 * _74) + 228
            while s < _375:
            ...
            call SWAPAddress.0xf4214a53 with:
                 gas gas_remaining wei
                args Mask(255, 1, cd[100]), KLIMAAddress, 160, (32 * _74) + 192, address(this.address), mem[mem[64] + 164 len (32 * _74) + (32 * _375) + 64]
        ...
        if _50 * Mask(112, 0, _62) / Mask(112, 0, _59) <= _54:
            ...
            if mem[_19 + 128] <= _50:
                ...
                if mem[_19 + 160] <= _50 * Mask(112, 0, _62) / Mask(112, 0, _59):
                    ...
                    call address(_148).0xa9059cbb with:
                         gas gas_remaining wei
                        args msg.sender, _153 - (_50 * Mask(112, 0, _62) / Mask(112, 0, _59))
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _203 = mem[64]
                ...
                if mem[_19 + 160] <= _50 * Mask(112, 0, _62) / Mask(112, 0, _59):
                    ...
                    call address(_233).0xa9059cbb with:
                         gas gas_remaining wei
                        args msg.sender, _239 - (_50 * Mask(112, 0, _62) / Mask(112, 0, _59))
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _302 = mem[64]
            ...
            if mem[_19 + 128] <= _54 * Mask(112, 0, _59) / Mask(112, 0, _62):
                ...
                call address(_177).0xa9059cbb with:
                     gas gas_remaining wei
                    args msg.sender, _184 - (_54 * Mask(112, 0, _59) / Mask(112, 0, _62))
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _243 = mem[64]
        ...
        if _50 * Mask(112, 0, _59) / Mask(112, 0, _62) <= _54:
            ...
            if mem[_19 + 128] <= _50:
                ...
                if mem[_19 + 160] <= _50 * Mask(112, 0, _59) / Mask(112, 0, _62):
                    ...
                    call address(_150).0xa9059cbb with:
                         gas gas_remaining wei
                        args msg.sender, _155 - (_50 * Mask(112, 0, _59) / Mask(112, 0, _62))
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _205 = mem[64]
                ...
                if mem[_19 + 160] <= _50 * Mask(112, 0, _59) / Mask(112, 0, _62):
                    ...
                    call address(_236).0xa9059cbb with:
                         gas gas_remaining wei
                        args msg.sender, _241 - (_50 * Mask(112, 0, _59) / Mask(112, 0, _62))
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _303 = mem[64]
            ...
            if mem[_19 + 128] <= _54 * Mask(112, 0, _62) / Mask(112, 0, _59):
                ...
                call address(_180).0xa9059cbb with:
                     gas gas_remaining wei
                    args msg.sender, _187 - (_54 * Mask(112, 0, _62) / Mask(112, 0, _59))
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _246 = mem[64]
