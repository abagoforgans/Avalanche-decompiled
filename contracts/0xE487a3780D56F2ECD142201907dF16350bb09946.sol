...
function exitGem(address arg1, address arg2, uint256 arg3, uint256 arg4, address arg5) payable {
    ...
    if not arg5:
        ...
        if ext_call.return_data[31 len 1] != 8:
            ...
            call address(ext_call.return_data[0]).withdraw(uint256 arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args arg4, 1
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
            ...
            if not ext_call.return_data[0]:
                ...
                if ext_call.return_data[31 len 1] != 8:
                    ...
                    call address(ext_call.return_data[0]).deposit(uint256 arg1, uint256 arg2) with:
                         gas gas_remaining wei
                        args ext_call.return_data[0] - 1 / ext_call.return_data[0], 1
            else:
                require ext_call.return_data[0]
                ...
                if ext_call.return_data[31 len 1] != 8:
                    ...
                    call address(ext_call.return_data[0]).deposit(uint256 arg1, uint256 arg2) with:
                         gas gas_remaining wei
                        args (arg3 * ext_call.return_data[0]) + ext_call.return_data[0] - 1 / ext_call.return_data[0], 1
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(address(ext_call.return_data[0]))
        call address(ext_call.return_data[0]).approve(address arg1, uint256 arg2) with:
        ...
        if not arg6:
            ...
            if not ext_call.return_data[0]:
                ...
                if ext_call.return_data[31 len 1] != 8:
                    ...
                    call address(ext_call.return_data[0]).deposit(uint256 arg1, uint256 arg2) with:
                         gas gas_remaining wei
                        args (arg4 * ext_call.return_data[0]) + ext_call.return_data[0] - 1 / ext_call.return_data[0], 1
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(address(ext_call.return_data[0]))
        call address(ext_call.return_data[0]).approve(address arg1, uint256 arg2) with:
        ...
        if not arg9:
            ...
            if not ext_call.return_data[0]:
                ...
                if ext_call.return_data[31 len 1] != 8:
                    ...
                    call address(ext_call.return_data[0]).deposit(uint256 arg1, uint256 arg2) with:
                         gas gas_remaining wei
                        args (arg6 * ext_call.return_data[0]) + ext_call.return_data[0] - 1 / ext_call.return_data[0], 1
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(address(ext_call.return_data[0]))
        call address(ext_call.return_data[0]).approve(address arg1, uint256 arg2) with:
