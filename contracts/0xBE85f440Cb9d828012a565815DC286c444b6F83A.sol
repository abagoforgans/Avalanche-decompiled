...
const pairCodeHash = sha3(code.data[1829 len 9233])
...
function createPair(address arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    if arg1 == arg2:
        revert with 0, 'STAR: IDENTICAL_ADDRESSES'
    if arg1 < arg2:
        if not arg1:
            revert with 0, 'STAR: ZERO_ADDRESS'
        if pair[address(arg1)][address(arg2)]:
            revert with 0, 'STAR: PAIR_EXISTS'
        create2 contract with 0 wei
                        salt: sha3(arg1, arg2)
                        code: code.data[1829 len 9233]
