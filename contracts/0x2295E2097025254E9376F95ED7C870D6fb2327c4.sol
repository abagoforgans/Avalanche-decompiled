...
address sub_c268aabcAddress;
address sub_47d03130Address;
address sub_6e1fb48cAddress;
...
function sub_47d03130(?) {
    return sub_47d03130Address
}
...
function sub_6e1fb48c(?) {
    return sub_6e1fb48cAddress
}
...
function sub_c268aabc(?) {
    return sub_c268aabcAddress
}
...
function getHarvestable() {
    require ext_code.size(address(rewardsAddress))
    staticcall address(rewardsAddress).earned(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit() {
    ...
    if ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor14), uint32(stor14), ext_call.return_data[0 len 28]
            mem[488 len 0] = 0
            call wantAddress with:
               funct uint32(stor14)
                 gas gas_remaining wei
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 425 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor14), uint32(stor14), ext_call.return_data[0 len 28]
        ...
        require ext_code.size(address(rewardsAddress))
        call address(rewardsAddress).stake(uint256 arg1) with:
             gas gas_remaining wei
            args ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
