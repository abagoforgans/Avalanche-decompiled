...
const feeDistribution = 0xa867c1aca4b5f1e0a66cf7b1fe33525d57608854
...
function balanceOfPool() payable {
    require ext_code.size(0x514e0b2ad01e44a7f1d31a83a662e42c2b585849)
    staticcall 0x514e0b2ad01e44a7f1d31a83a662e42c2b585849.userInfo(address arg1, address arg2) with:
            gas gas_remaining wei
...
function retireStrat() payable {
    if address(vaultAddress) != msg.sender:
        revert with 0, '!vault'
    require ext_code.size(0x514e0b2ad01e44a7f1d31a83a662e42c2b585849)
    call 0x514e0b2ad01e44a7f1d31a83a662e42c2b585849.emergencyWithdraw(address arg1) with:
         gas gas_remaining wei
        args wantAddress
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit() payable {
    ...
    if ext_call.return_data[0]:
        require ext_code.size(0x514e0b2ad01e44a7f1d31a83a662e42c2b585849)
        call 0x514e0b2ad01e44a7f1d31a83a662e42c2b585849.deposit(address arg1, uint256 arg2) with:
             gas gas_remaining wei
...
function rewardsAvailable() payable {
    ...
    mem[260 len 0] = None
    require ext_code.size(0x514e0b2ad01e44a7f1d31a83a662e42c2b585849)
    staticcall 0x514e0b2ad01e44a7f1d31a83a662e42c2b585849.0xe5b53498 with:
            gas gas_remaining wei
...
function callReward() payable {
    ...
    if not outputToNativeRoute.length:
        ...
        mem[64] = (32 * _88) + (32 * _48) + (2 * ceil32(return_data.size)) + 224
    ...
    mem[64] = (32 * _126) + (32 * _48) + (2 * ceil32(return_data.size)) + 224
    require mem[(32 * _48) + (2 * ceil32(return_data.size)) + 192] - 1 < mem[(32 * _48) + (2 * ceil32(return_data.size)) + 192]
    if not mem[(32 * mem[(32 * _48) + (2 * ceil32(return_data.size)) + 192] - 1) + (32 * _48) + (2 * ceil32(return_data.size)) + 224]:
        return 0
    if 45 * mem[(32 * mem[(32 * _48) + (2 * ceil32(return_data.size)) + 192] - 1) + (32 * _48) + (2 * ceil32(return_data.size)) + 224] / mem[(32 * mem[(32 * _48) + (2 * ceil32(return_data.size)) + 192] - 1) + (32 * _48) + (2 * ceil32(return_data.size)) + 224] != 45:
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] < arg1:
        ...
        require ext_code.size(0x514e0b2ad01e44a7f1d31a83a662e42c2b585849)
        call 0x514e0b2ad01e44a7f1d31a83a662e42c2b585849.withdraw(address arg1, uint256 arg2) with:
             gas gas_remaining wei
...
function pause() payable {
    ...
    if not ext_code.size(wantAddress):
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = approve(address arg1, uint256 arg2), 0x514e0b2ad01e44a7f1d31a83, 0, 0
    mem[324 len 0] = 0
    call wantAddress.0x2b585849 with:
         gas gas_remaining wei
        args Mask(480, -256, approve(address arg1, uint256 arg2), 0x514e0b2ad01e44a7f1d31a83, 0, 0) << 256, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with approve(address arg1, uint256 arg2), 0x514e0b2ad01e44a7f1d31a83, 0, 0
        if not approve(address arg1, uint256 arg2), 0x514e0b2ad01e44a7f1d31a83:
            revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
        if eth.balance(this.address) < 0:
