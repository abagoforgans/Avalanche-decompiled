    ...
    if serviceAddress != msg.sender:
        if sub_a66e4e5fAddress != msg.sender:
            if owner != msg.sender:
                revert with 0, 'not service'
    require arg1 < poolInfo.length
    require ext_code.size(0x1efbdb9f8ad6ac5a1877d38129e207d1efc1a4d)
    delegate 0x1efbdb9f8ad6ac5a1877d38129e207d1efc1a4d.0x18f1f18b with:
...
function sub_f9c516ea(?) {
    ...
    require arg1 < poolInfo.length
    require ext_code.size(0x1efbdb9f8ad6ac5a1877d38129e207d1efc1a4d)
    delegate 0x1efbdb9f8ad6ac5a1877d38129e207d1efc1a4d.0x5bc609c6 with:
         gas gas_remaining wei
...
function sub_c0881f2a(?) {
    ...
    if arg4:
        require ext_code.size(0x1efbdb9f8ad6ac5a1877d38129e207d1efc1a4d)
        delegate 0x1efbdb9f8ad6ac5a1877d38129e207d1efc1a4d.0x3b2a018c with:
             gas gas_remaining wei
    ...
    if arg4:
        require arg1 < poolInfo.length
        require ext_code.size(0x1efbdb9f8ad6ac5a1877d38129e207d1efc1a4d)
        delegate 0x1efbdb9f8ad6ac5a1877d38129e207d1efc1a4d.0x434857c7 with:
             gas gas_remaining wei
            args poolInfo[arg1].field_0, poolInfo[arg1].field_256
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        require ext_code.size(0x1efbdb9f8ad6ac5a1877d38129e207d1efc1a4d)
        delegate 0x1efbdb9f8ad6ac5a1877d38129e207d1efc1a4d.0x7b0b708a with:
             gas gas_remaining wei
...
function sub_37db62b5(?) {
    ...
    if not ext_code.size(address(delegate.return_data[0])):
        revert with 0, 'Address: call to non-contract'
    mem[(32 * arg2.length) + 548 len 64] = transfer(address rg1, uint256 rg2), poolInfo[arg3].field_0, poolInfo[arg3].field_0, Mask(224, 32, arg4) >> 32
...
function sub_f12ffbb7(?) {
    ...
    if not ext_code.size(arg1):
        revert with 0, 'Address: call to non-contract'
    mem[(32 * arg2.length) + 324 len 96] = transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, poolInfo[arg3].field_0, Mask(224, 32, arg4) >> 32
    mem[(32 * arg2.length) + 448 len 4] = 0
    mem[(32 * arg2.length) + 420 len 0] = 0
    call arg1 with:
       funct poolInfo[arg3].field_0
         gas gas_remaining wei
