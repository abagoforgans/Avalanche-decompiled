...
function sub_18f6aeaf(?) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 > 5:
        revert with 0, 'Value cannot be greater than 5%'
    sub_6da8bea3 = arg1
}
...
function deposit(uint256 arg1, uint256 arg2) payable {
    ...
    if msg.value > 0:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    if arg2 and sub_6da8bea3 > -1 / arg2:
        revert with 'NH{q', 17
    if arg2 * sub_6da8bea3 / 100 > 0:
        call lockedTokens[arg1].field_256.0xa9059cbb with:
             gas gas_remaining wei
            args feeRecipientAddress, arg2 * sub_6da8bea3 / 100
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
    ...
    if arg2 < arg2 * sub_6da8bea3 / 100:
        revert with 'NH{q', 17
    if lockedTokens[arg1].field_768 > -arg2 + (arg2 * sub_6da8bea3 / 100) - 1:
        revert with 'NH{q', 17
    lockedTokens[arg1].field_768 = lockedTokens[arg1].field_768 + arg2 - (arg2 * sub_6da8bea3 / 100)
    emit TokensDeposited(lockedTokens[arg1].field_0, arg2 - (arg2 * sub_6da8bea3 / 100));
}
...
function lock(address arg1, uint256 arg2, uint256 arg3) payable {
    ...
    if sub_9b10b6f5 == -1:
        revert with 'NH{q', 17
    sub_9b10b6f5++
    lockedTokens[stor5].field_0 = sub_9b10b6f5
    lockedTokens[stor5].field_256 = arg1
    lockedTokens[stor5].field_512 = msg.sender
    lockedTokens[stor5].field_768 = arg2 - (arg2 * sub_6da8bea3 / 100)
    lockedTokens[stor5].field_1024 = 0
    lockedTokens[stor5].field_1280 = block.timestamp
    lockedTokens[stor5].field_1536 = arg3
    lockedTokens[stor5].field_1792 = 1
