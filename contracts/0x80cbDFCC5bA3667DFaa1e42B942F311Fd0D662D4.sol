...
function sub_050c9cee(?) {
    ...
    if 0x6cf40c4224ec9729a796eeeb912d3157231a2b35 != msg.sender:
...
function sub_93bcd4d4(?) {
    require calldata.size - 4 >= 32
    if bool(stor21[arg1].field_512):
        if not bool(stor21[arg1].field_512) - (uint255(stor21[arg1].field_512) * 0.5 < 32):
            revert with 0, 34
        if bool(stor21[arg1].field_512):
            if not bool(stor21[arg1].field_512) - (uint255(stor21[arg1].field_512) * 0.5 < 32):
                revert with 0, 34
            if Mask(256, -1, stor21[arg1].field_512):
                if 31 >= uint255(stor21[arg1].field_512) * 0.5:
                    mem[128] = 256 * Mask(248, 0, stor21[arg1].field_520)
                else:
                    mem[128] = stor21[arg1][2].field_0
                    idx = 128
                    s = 0
                    while (uint255(stor21[arg1].field_512) * 0.5) + 96 > idx:
                        mem[idx + 32] = stor21[arg1][s + 2].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
        else:
            if not bool(stor21[arg1].field_512) - (stor21[arg1].field_513 % 128 < 32):
                revert with 0, 34
            if stor21[arg1].field_513 % 128:
                if 31 >= stor21[arg1].field_513 % 128:
                    mem[128] = 256 * Mask(248, 0, stor21[arg1].field_520)
                else:
                    mem[128] = stor21[arg1][2].field_0
                    idx = 128
                    s = 0
                    while stor21[arg1].field_513 % 128 + 96 > idx:
                        mem[idx + 32] = stor21[arg1][s + 2].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
        if uint8(stor21[arg1].field_16) >= 3:
            revert with 0, 33
        return bool(uint8(stor21[arg1].field_0)), 
               bool(uint8(stor21[arg1].field_8)),
               uint8(stor21[arg1].field_0),
               stor21[arg1].field_256,
               Array(len=2 * Mask(256, -1, stor21[arg1].field_512), data=mem[128 len ceil32(uint255(stor21[arg1].field_512) * 0.5)]),
               stor21[arg1].field_768
    if not bool(stor21[arg1].field_512) - (stor21[arg1].field_513 % 128 < 32):
        revert with 0, 34
    if bool(stor21[arg1].field_512):
        if not bool(stor21[arg1].field_512) - (uint255(stor21[arg1].field_512) * 0.5 < 32):
    ...
    return bool(uint8(stor21[arg1].field_0)), 
           ...
           uint8(stor21[arg1].field_0),
           stor21[arg1].field_256,
           Array(len=stor21[arg1].field_512 % 128, data=mem[128 len ceil32(stor21[arg1].field_513 % 128)]),
           stor21[arg1].field_768
}
...
function sub_fbe14ce9(?) {
    ...
    if not uint8(assetType[arg1]):
        call stor20.withdraw(address arg1, uint256 arg2, address arg3) with:
             gas gas_remaining wei
            args stor14, 25 * 10^18, this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        call stor14.0xa9059cbb with:
             gas gas_remaining wei
            args msg.sender, 25 * 10^18
    else:
        if uint8(assetType[arg1]) > 2:
            revert with 0, 33
        if uint8(assetType[arg1]) - 2:
            call stor20.withdraw(address arg1, uint256 arg2, address arg3) with:
                 gas gas_remaining wei
                args stor15, 25 * 10^6, this.address
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            call stor15.0xa9059cbb with:
                 gas gas_remaining wei
                args msg.sender, 25 * 10^6
        else:
            call stor20.withdraw(address arg1, uint256 arg2, address arg3) with:
                 gas gas_remaining wei
                args stor16, 25 * 10^6, this.address
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            call stor16.0xa9059cbb with:
...
function sub_8997ce4e(?) {
    if bool(stor34.length):
        if not bool(stor34.length) - (uint255(stor34.length) * 0.5 < 32):
            revert with 0, 34
        if bool(stor34.length):
            if not bool(stor34.length) - (uint255(stor34.length) * 0.5 < 32):
                revert with 0, 34
            if Mask(256, -1, stor34.length):
                if 31 < uint255(stor34.length) * 0.5:
                    mem[128] = uint256(stor34.field_0)
                    idx = 128
                    s = 0
                    while (uint255(stor34.length) * 0.5) + 96 > idx:
                        mem[idx + 32] = stor34[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    return Array(len=2 * Mask(256, -1, stor34.length), data=mem[128 len ceil32(uint255(stor34.length) * 0.5)])
                mem[128] = 256 * Mask(248, 0, stor34.length.field_8)
        else:
            if not bool(stor34.length) - (stor34.length.field_1 % 128 < 32):
                revert with 0, 34
            if stor34.length.field_1 % 128:
                if 31 < stor34.length.field_1 % 128:
                    mem[128] = uint256(stor34.field_0)
                    idx = 128
                    s = 0
                    while stor34.length.field_1 % 128 + 96 > idx:
                        mem[idx + 32] = stor34[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    return Array(len=2 * Mask(256, -1, stor34.length), data=mem[128 len ceil32(uint255(stor34.length) * 0.5)])
                mem[128] = 256 * Mask(248, 0, stor34.length.field_8)
        mem[ceil32(uint255(stor34.length) * 0.5) + 192 len ceil32(uint255(stor34.length) * 0.5)] = mem[128 len ceil32(uint255(stor34.length) * 0.5)]
        if ceil32(uint255(stor34.length) * 0.5) > uint255(stor34.length) * 0.5:
            mem[(uint255(stor34.length) * 0.5) + ceil32(uint255(stor34.length) * 0.5) + 192] = 0
        return Array(len=2 * Mask(256, -1, stor34.length), data=mem[128 len ceil32(uint255(stor34.length) * 0.5)], mem[(2 * ceil32(uint255(stor34.length) * 0.5)) + 192 len 2 * ceil32(uint255(stor34.length) * 0.5)]), 
    if not bool(stor34.length) - (stor34.length.field_1 % 128 < 32):
        revert with 0, 34
    if bool(stor34.length):
        if not bool(stor34.length) - (uint255(stor34.length) * 0.5 < 32):
        ...
        if Mask(256, -1, stor34.length):
            if 31 < uint255(stor34.length) * 0.5:
                ...
                while (uint255(stor34.length) * 0.5) + 96 > idx:
                    ...
                    s = s + 1
                    continue 
                return Array(len=stor34.length % 128, data=mem[128 len ceil32(stor34.length.field_1 % 128)])
            mem[128] = 256 * Mask(248, 0, stor34.length.field_8)
    else:
        if not bool(stor34.length) - (stor34.length.field_1 % 128 < 32):
            revert with 0, 34
        if stor34.length.field_1 % 128:
            if 31 < stor34.length.field_1 % 128:
                ...
                return Array(len=stor34.length % 128, data=mem[128 len ceil32(stor34.length.field_1 % 128)])
            mem[128] = 256 * Mask(248, 0, stor34.length.field_8)
    mem[ceil32(stor34.length.field_1 % 128) + 192 len ceil32(stor34.length.field_1 % 128)] = mem[128 len ceil32(stor34.length.field_1 % 128)]
    if ceil32(stor34.length.field_1 % 128) > stor34.length.field_1 % 128:
        mem[stor34.length.field_1 % 128 + ceil32(stor34.length.field_1 % 128) + 192] = 0
    return Array(len=stor34.length % 128, data=mem[128 len ceil32(stor34.length.field_1 % 128)], mem[(2 * ceil32(stor34.length.field_1 % 128)) + 192 len 2 * ceil32(stor34.length.field_1 % 128)]), 
}
...
function sub_a2b450a0(?) {
    ...
    if arg2 > 2:
        revert with 0, 33
    uint8(stor21[arg1].field_0) = 1
    Mask(248, 0, stor21[arg1].field_8) = 0
    Mask(240, 0, stor21[arg1].field_16) = 0
    if arg2 > 2:
        revert with 0, 33
    uint8(stor21[arg1].field_0) = 1
    uint8(stor21[arg1].field_8) = 0
    Mask(240, 0, stor21[arg1].field_16) = Mask(240, 0, arg2)
    Mask(232, 0, stor21[arg1].field_24) = 0
    Mask(232, 0, stor21[arg1].field_24) = 0
    stor21[arg1].field_256 = arg3
    if bool(stor21[arg1].field_512):
        if not bool(stor21[arg1].field_512) - (uint255(stor21[arg1].field_512) * 0.5 < 32):
            revert with 0, 34
        if arg4.length:
            stor21[arg1][2][].field_0 = Array(len=arg4.length, data=arg4[all])
        else:
            stor21[arg1].field_512 = 0
            idx = 0
            while (uint255(stor21[arg1].field_512) * 0.5) + 31 / 32 > idx:
                stor21[arg1][idx + 2].field_0 = 0
                idx = idx + 1
                continue 
    else:
        if not bool(stor21[arg1].field_512) - (stor21[arg1].field_513 % 128 < 32):
        ...
        if arg4.length:
            ...
            stor21[arg1].field_512 = 0
            idx = 0
            while stor21[arg1].field_513 % 128 + 31 / 32 > idx:
                stor21[arg1][idx + 2].field_0 = 0
                idx = idx + 1
                continue 
    stor21[arg1].field_768 = 0
...
function sub_fbccfe03(?) {
    ...
    if not arg1:
        ...
        call stor14.0x23b872dd with:
             gas gas_remaining wei
            args msg.sender, address(this.address), 25 * 10^18
        ...
        call stor20.deposit(address arg1, uint256 arg2, address arg3, uint16 arg4) with:
             gas gas_remaining wei
            args stor14, 25 * 10^18, address(this.address), 0
    else:
        if arg1 > 2:
            revert with 0, 33
        mem[100] = msg.sender
        ...
        if arg1 - 2:
            call stor15.0x23b872dd with:
                 gas gas_remaining wei
                args msg.sender, address(this.address), 25 * 10^6
            mem[96] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            ...
            call stor20.deposit(address arg1, uint256 arg2, address arg3, uint16 arg4) with:
                 gas gas_remaining wei
                args stor15, 25 * 10^6, address(this.address), 0
        else:
            call stor16.0x23b872dd with:
                 gas gas_remaining wei
                args msg.sender, address(this.address), 25 * 10^6
            ...
            call stor20.deposit(address arg1, uint256 arg2, address arg3, uint16 arg4) with:
                 gas gas_remaining wei
                args stor16, 25 * 10^6, address(this.address), 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if not uint8(roleAdmin[0x9f2df0fed2c77648de5860a4cc508cd0818c85b8b8a1ab4ceeef8d981c8956a6][address(msg.sender)].field_0):
...
function claim(uint256 arg1, address arg2, uint256 arg3) {
    ...
    call stor20.withdraw(address arg1, uint256 arg2, address arg3) with:
         gas gas_remaining wei
        args stor14, sub_11ab39a8[arg1][0], this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    call stor20.withdraw(address arg1, uint256 arg2, address arg3) with:
    ...
    if arg3 <= 100:
        ...
        if sub_11ab39a8[arg1][2] - (sub_11ab39a8[arg1][2] * arg3 / 100) > 0x116e0689427378eb4d583d0116e0689427378eb4d583d0116e0689427378eb4:
            revert with 0, 17
        if stor26 > !((235 * sub_11ab39a8[arg1][0]) - (235 * sub_11ab39a8[arg1][0] * arg3 / 100) / 10000):
            revert with 0, 17
        stor26 += (235 * sub_11ab39a8[arg1][0]) - (235 * sub_11ab39a8[arg1][0] * arg3 / 100) / 10000
        if stor27 > !((235 * sub_11ab39a8[arg1][1]) - (235 * sub_11ab39a8[arg1][1] * arg3 / 100) / 10000):
            revert with 0, 17
        stor27 += (235 * sub_11ab39a8[arg1][1]) - (235 * sub_11ab39a8[arg1][1] * arg3 / 100) / 10000
        if stor28 > !((235 * sub_11ab39a8[arg1][2]) - (235 * sub_11ab39a8[arg1][2] * arg3 / 100) / 10000):
            revert with 0, 17
        stor28 += (235 * sub_11ab39a8[arg1][2]) - (235 * sub_11ab39a8[arg1][2] * arg3 / 100) / 10000
        ...
        if sub_11ab39a8[arg1][2] - (100 * sub_11ab39a8[arg1][2] / 100) > 0x116e0689427378eb4d583d0116e0689427378eb4d583d0116e0689427378eb4:
            revert with 0, 17
        if stor26 > !((235 * sub_11ab39a8[arg1][0]) - (235 * 100 * sub_11ab39a8[arg1][0] / 100) / 10000):
            revert with 0, 17
        stor26 += (235 * sub_11ab39a8[arg1][0]) - (235 * 100 * sub_11ab39a8[arg1][0] / 100) / 10000
        if stor27 > !((235 * sub_11ab39a8[arg1][1]) - (235 * 100 * sub_11ab39a8[arg1][1] / 100) / 10000):
            revert with 0, 17
        stor27 += (235 * sub_11ab39a8[arg1][1]) - (235 * 100 * sub_11ab39a8[arg1][1] / 100) / 10000
        if stor28 > !((235 * sub_11ab39a8[arg1][2]) - (235 * 100 * sub_11ab39a8[arg1][2] / 100) / 10000):
            revert with 0, 17
        stor28 += (235 * sub_11ab39a8[arg1][2]) - (235 * 100 * sub_11ab39a8[arg1][2] / 100) / 10000
