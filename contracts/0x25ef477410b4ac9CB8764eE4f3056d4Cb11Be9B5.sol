...
#
const sub_c6668f7d(?) = 0xc35c8a03ad7188a26047dfa0d199791a9ef38ec80eeae3318e9af9b21f10e543
...
function sub_6e6b246b(?) {
    return block.timestamp >= stor18
}

function sub_77a1e023(?) {
    return block.timestamp >= stor17
}
...
function withdraw() payable {
    if roleAdmin[0][address(msg.sender)].field_0:
        if 0 >= roleMember[0xc35c8a03ad7188a26047dfa0d199791a9ef38ec80eeae3318e9af9b21f10e543].field_0:
            revert with 'NH{q', 50
        ...
        call roleMember[0xc35c8a03ad7188a26047dfa0d199791a9ef38ec80eeae3318e9af9b21f10e543].field_0 with:
...
function transferOwnerShip(address arg1) {
    ...
    if roleMember[0][1][address(msg.sender)].field_0:
        if roleMember[0][1][address(msg.sender)].field_0 < 1:
            revert with 'NH{q', 17
        if roleMember[0].field_0 < 1:
            revert with 'NH{q', 17
        if roleMember[0].field_0 - 1 != roleMember[0][1][address(msg.sender)].field_0 - 1:
            if roleMember[0].field_0 - 1 >= roleMember[0].field_0:
                revert with 'NH{q', 50
            if roleMember[0][1][address(msg.sender)].field_0 - 1 >= roleMember[0].field_0:
                revert with 'NH{q', 50
            roleMember[0][roleMember[0][1][address(msg.sender)].field_0].field_0 = roleMember[0][roleMember[0].field_0].field_0
            roleMember[0][1][roleMember[0][roleMember[0].field_0].field_0].field_0 = roleMember[0][1][address(msg.sender)].field_0
        if not roleMember[0].field_0:
            revert with 'NH{q', 49
        roleMember[0][roleMember[0].field_0].field_0 = 0
        roleMember[0].field_0--
        roleMember[0][1][address(msg.sender)].field_0 = 0
}
...
function mint(uint256 arg1) payable {
    ...
    require not paused
    if arg1 <= 0:
        revert with 0, 'Mint at least 1 Asset'
    if arg1 > maxMintAmount:
        revert with 0, 'Maximum mint amount exceeded'
    if tokenByIndex.length > -arg1 - 1:
        revert with 'NH{q', 17
    if tokenByIndex.length + arg1 > maxSupply:
        revert with 0, 'Mint is Over'
    if arg1 and cost > -1 / arg1:
        revert with 'NH{q', 17
    if arg1 * cost / 2 != msg.value:
        if arg1 and cost > -1 / arg1:
            revert with 'NH{q', 17
        if arg1 * cost != msg.value:
            revert with 0, 'Insufficient Balance'
        if block.timestamp >= stor18 != 1:
            revert with 0, 'Minting is not live yet'
        idx = 1
        while idx <= arg1:
            ...
            if msg.sender:
                ...
                if ext_code.size(msg.sender) > 0:
                    ...
                    require return_data.size >= 32
                    require mem[_371] == Mask(32, 224, mem[_371])
                    if Mask(32, 224, mem[_371]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                        revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
            else:
                if tokenByIndex.length < 1:
                    revert with 'NH{q', 17
        ...
        mem[100] = msg.sender
        mem[132] = 0
        staticcall stor12.balanceOf(address arg1, uint256 arg2) with:
                gas gas_remaining wei
               args msg.sender, 0
        ...
        if ext_call.return_data[0] < arg1:
            revert with 0, 'Message sender is not white listed'
        if block.timestamp >= stor17 != 1:
            revert with 0, 'White Minting is not live yet'
        if block.timestamp >= stor18:
            revert with 0, 'White Minting is over.'
        mem[ceil32(return_data.size) + 96] = 0xf5298aca00000000000000000000000000000000000000000000000000000000
        mem[ceil32(return_data.size) + 100] = msg.sender
        mem[ceil32(return_data.size) + 132] = 0
        mem[ceil32(return_data.size) + 164] = arg1
        require ext_code.size(stor12)
        call stor12.burn(address arg1, uint256 arg2, uint256 arg3) with:
             gas gas_remaining wei
