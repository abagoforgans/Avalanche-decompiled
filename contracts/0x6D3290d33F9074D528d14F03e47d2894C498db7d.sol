...
function _fallback() payable {
    if calldata.size < 4:
        ...
        if unknown_0x7b7d7225(?????) > uint32(call.func_hash) >> 224:
            if unknown_0x2c6ea668(?????) > uint32(call.func_hash) >> 224:
                if unknown_0x1481794e(?????) > uint32(call.func_hash) >> 224:
                    ...
                    if a() == uint32(call.func_hash) >> 224:
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                    require unknown_0x108c31f5(?????) == uint32(call.func_hash) >> 224
                    require not msg.value
                    require calldata.size - 4 >= 32
                    require arg1 == address(arg1)
                    staticcall stor1.getReserveNormalizedIncome(address arg1) with:
                ...
                if uint32(call.func_hash) >> 224 != unknown_0x1481794e(?????):
                    if unknown_0x24323ccc(?????) == uint32(call.func_hash) >> 224:
                        require not msg.value
                        require calldata.size - 4 >= 64
                        require arg1 == address(arg1)
                        if owner != msg.sender:
                        ...
                        if unknown_0x2478239a(?????) == uint32(call.func_hash) >> 224:
                            ...
                            require arg1 == address(arg1)
                            return bool(stor12[arg1])
                        require unknown_0x26787cd7(?????) == uint32(call.func_hash) >> 224
                        require not msg.value
                        require calldata.size - 4 >= 64
                        require arg2 == address(arg2)
                        if owner != msg.sender:
                ...
                if unknown_0x44471fd9(?????) <= uint32(call.func_hash) >> 224:
                    if uint32(call.func_hash) >> 224 != unknown_0x44471fd9(?????):
                    ...
                    if unknown_0x2c6ea668(?????) == uint32(call.func_hash) >> 224:
                        ...
                        require return_data.size >= 32
                        return ext_call.return_data[0]
                    if uint32(call.func_hash) >> 224 != unknown_0x365833e1(?????):
                        if unknown_0x36ba9fa3(?????) == uint32(call.func_hash) >> 224:
                            require not msg.value
                            if not sub_efca2a3e[msg.sender].field_0:
                                revert with 0, 'Nothing to withdraw'
                            staticcall stor1.getReserveNormalizedIncome(address arg1) with:
                            ...
                            require unknown_0x3aadc501(?????) == uint32(call.func_hash) >> 224
                            if msg.value <= 0:
                                revert with 0, 'Invalid value'
                            require ext_code.size(stor2)
                            call stor2.depositETH(address arg1, address arg2, uint16 arg3) with:
            ...
            if unknown_0xcd580ff3(?????) > uint32(call.func_hash) >> 224:
                if unknown_0x99ba9578(?????) > uint32(call.func_hash) >> 224:
                    if unknown_0x7b7d7225(?????) == uint32(call.func_hash) >> 224:
                        require not msg.value
                        require calldata.size - 4 >= 64
                        require arg1 == address(arg1)
                    ...
                    if unknown_0x8da5cb5b(?????) == uint32(call.func_hash) >> 224:
                        require not msg.value
                        return owner
                    require unknown_0x93362eee(?????) == uint32(call.func_hash) >> 224
                    require not msg.value
                    require calldata.size - 4 >= 32
                    require arg1 == address(arg1)
                    staticcall stor1.getReserveNormalizedIncome(address arg1) with:
                ...
                if unknown_0x99ba9578(?????) == uint32(call.func_hash) >> 224:
                    ...
                    if uint32(call.func_hash) >> 224 != unknown_0xb2b6b6c9(?????):
                        require unknown_0xca69282f(?????) == uint32(call.func_hash) >> 224
                        require not msg.value
                        require calldata.size - 4 >= 64
                        require arg2 == address(arg2)
                        staticcall stor1.getReserveNormalizedIncome(address arg1) with:
