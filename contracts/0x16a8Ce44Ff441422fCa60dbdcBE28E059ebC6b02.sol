...
function getPrice() payable {
    ...
    if 10^10 * ext_call.return_data[0] and 10^18 * ext_call.return_data[50 len 14] / ext_call.return_data[0] > -1 / 10^10 * ext_call.return_data[0]:
        revert with 'NH{q', 17
    if 10^18 * ext_call.return_data[18 len 14] / ext_call.return_data[0] > 0x119799812dea11197f27f0f6e885c8ba7eb31f476caf7411a863387:
        revert with 'NH{q', 17
    if 10^12 * 10^18 * ext_call.return_data[18 len 14] / ext_call.return_data[0] > !(10^10 * ext_call.return_data[0] * 10^18 * ext_call.return_data[50 len 14] / ext_call.return_data[0] / 10^18):
        revert with 'NH{q', 17
    return ((10^12 * 10^18 * ext_call.return_data[18 len 14] / ext_call.return_data[0]) + (10^10 * ext_call.return_data[0] * 10^18 * ext_call.return_data[50 len 14] / ext_call.return_data[0] / 10^18))
}
