...
function sub_ace33294(?) payable {
    ...
    while idx < factoryCount:
        ...
        idx = idx + 1
        continue 
    mem[(64 * factoryCount) + 192] = 32
    mem[(64 * factoryCount) + 224] = mem[(64 * factoryCount) + 160]
    mem[(64 * factoryCount) + 256 len floor32(mem[(64 * factoryCount) + 160])] = mem[(64 * factoryCount) + 192 len floor32(mem[(64 * factoryCount) + 160])]
    return 32, mem[(64 * factoryCount) + 224 len (32 * mem[(64 * factoryCount) + 160]) + 32]
}
...
function sub_d2bbd52f(?) payable {
    ...
    while idx < ('cd', 68).length:
        ...
        pairs[address(cd[4]) xor address(cd[36])][idx] = address(cd[((32 * idx) + cd[68] + 36)]) or cd[((32 * idx) + cd[100] + 36)] << 160 or cd[((32 * idx) + cd[132] + 36)] << 174
        idx = idx + 1
        continue 
