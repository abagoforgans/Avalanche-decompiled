...
function batch(bytes[] arg1, bool arg2) payable {
    ...
    while idx < arg1.length:
        ...
        if not return_data.size:
            ...
            idx = 0
            while idx < _109:
                mem[_103 + idx + 68] = mem[_65 + idx + 32]
                idx = idx + 32
                continue 
            if ceil32(_109) > _109:
                mem[_103 + _109 + 68] = 0
            revert with memory
              from mem[64]
               len _103 + ceil32(_109) + -mem[64] + 68
        _50 = mem[64]
        ...
        require mem[_50 + mem[_50 + 36] + 36] <= test266151307()
        _66 = mem[64]
        require mem[64] + ceil32(mem[_50 + mem[_50 + 36] + 36]) + 32 <= test266151307() and mem[64] + ceil32(mem[_50 + mem[_50 + 36] + 36]) + 32 >= mem[64]
        ...
        if ceil32(_63) <= _63:
            ...
            idx = 0
            while idx < _63:
                mem[_101 + idx + 68] = mem[_66 + idx + 32]
                idx = idx + 32
                continue 
            if ceil32(_63) > _63:
                mem[_101 + _63 + 68] = 0
        ...
        idx = 0
        while idx < _63:
            mem[_105 + idx + 68] = mem[_66 + idx + 32]
            idx = idx + 32
            continue 
        if ceil32(_63) > _63:
            mem[_105 + _63 + 68] = 0
