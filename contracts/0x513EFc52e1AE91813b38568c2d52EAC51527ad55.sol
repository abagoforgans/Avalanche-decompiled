...
function _getNodeNumberOf(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    delegate 0xce0aec8b7352c1981ede4b674314b7c80542a0df.0x732a2ccf with:
...
function createNode(address arg1, string arg2) payable {
    ...
    require ext_code.size(0xce0aec8b7352c1981ede4b674314b7c80542a0df)
    delegate 0xce0aec8b7352c1981ede4b674314b7c80542a0df.0xbc2b405c with:
         gas gas_remaining wei
