...
function setReserve(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if address(reserveAddress):
        revert with 0, 'Pool::setReserve: not allowed'
    address(reserveAddress) = arg1
}
...
function sub_c29118fc(?) {
    ...
    Mask(248, 0, stor11.field_8) = Mask(248, 0, bool(arg2))
    Mask(240, 0, stor11.field_16) = Mask(240, 16, bool(arg1)) >> 16
...
function calcRedeem(uint256 arg1) {
    ...
    if collateralRatio >= 10^6:
        if not collateralRatio:
            return 0, 0, 0, arg1 * collateralRatio / 10^6
    ...
    if not userInfo[address(msg.sender)].field_0:
        if not userInfo[address(msg.sender)].field_256:
            ...
            if not userInfo[address(msg.sender)].field_512:
                ...
                call sub_49bfcca1Address.0x40c10f19 with:
                     gas gas_remaining wei
    ...
    if ext_call.return_data[0] <= sub_1be626c1:
        if 0 < ext_call.return_data[0] * collateralRatio / 10^6:
            ...
            if -ext_call.return_data[0] * collateralRatio / 10^6 > 0:
                ...
                if not address(reserveAddress):
                    revert with 0, 'Pool::reduceExcessCollateral: invalid address'
                mem[(2 * ceil32(return_data.size)) + 132] = address(reserveAddress)
                ...
                mem[(2 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor6), uint32(stor6), arg1, 0
                mem[(2 * ceil32(return_data.size)) + 328] = 0
                call 0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7 with:
                   funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor6), uint32(stor6), arg1, 0) >> 224
                     gas gas_remaining wei
                    args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor6), uint32(stor6), arg1, 0) << 288)
...
function redeem(uint256 arg1, uint256 arg2, uint256 arg3) {
    ...
    if collateralRatio >= 10^6:
        if not collateralRatio:
            ...
            require ext_code.size(xTokenAddress)
            call xTokenAddress.0x9dc29fac with:
                 gas gas_remaining wei
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if arg1 * collateralRatio * redemptionFee / 10^6 / 10^6 > 0:
                mem[(2 * ceil32(return_data.size)) + 132] = address(reserveAddress)
                mem[(2 * ceil32(return_data.size)) + 164] = arg1 * collateralRatio * redemptionFee / 10^6 / 10^6
                mem[(2 * ceil32(return_data.size)) + 96] = 68
                mem[(2 * ceil32(return_data.size)) + 132 len 28] = Mask(224, 0, stor6)
                mem[(2 * ceil32(return_data.size)) + 128 len 4] = unknown_0xa9059cbb(?????)
                mem[(2 * ceil32(return_data.size)) + 196] = 32
                ...
                if not ext_code.size(0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7):
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor6), uint32(stor6), arg1 * collateralRatio * redemptionFee / 10^6 / 10^6, 0
                mem[(2 * ceil32(return_data.size)) + 328] = 0
                call 0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7 with:
                   funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor6), uint32(stor6), arg1 * collateralRatio * redemptionFee / 10^6 / 10^6, 0) >> 224
                     gas gas_remaining wei
                    args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor6), uint32(stor6), arg1 * collateralRatio * redemptionFee / 10^6 / 10^6, 0) << 288)
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0]:
                            revert with memory
...
function mint(uint256 arg1) payable {
    ...
    stor1 = 2
    if mintPaused:
        revert with 0, 'Pool::zap: Minting is paused'
    require ext_code.size(oracleAddress)
    staticcall oracleAddress.0x6e16399c with:
            gas gas_remaining wei
    mem[96] = ext_call.return_data[0]
    ...
    if msg.value - (msg.value * mintingFee / 10^6) < arg1:
        revert with 0, 'Pool::zap: slippage'
    require ext_code.size(0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7)
    call 0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7.deposit() with:
       value msg.value wei
         gas gas_remaining wei
    ...
    if 10^18 * (10^6 * msg.value) - (collateralRatio * msg.value) / 10^6 / ext_call.return_data[0] <= 0:
        ...
        if msg.value * mintingFee * collateralRatio / 10^6 / 10^6:
            mem[ceil32(return_data.size) + 132] = address(reserveAddress)
            ...
            if not ext_code.size(0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor6), uint32(stor6), msg.value * mintingFee * collateralRatio / 10^6 / 10^6, 0
            mem[ceil32(return_data.size) + 328] = 0
            call 0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7 with:
               funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor6), uint32(stor6), msg.value * mintingFee * collateralRatio / 10^6 / 10^6, 0) >> 224
                 gas gas_remaining wei
                args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor6), uint32(stor6), msg.value * mintingFee * collateralRatio / 10^6 / 10^6, 0) << 288)
            if not return_data.size:
                if not ext_call.success:
                    if ext_call.return_data[0]:
                        revert with memory
        ...
        if (10^6 * msg.value) - (collateralRatio * msg.value) / 10^6 <= 0:
            ...
            if not ext_code.size(0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7):
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + 260 len 96] = approve(address arg1, uint256 arg2), Mask(224, 0, stor5), uint32(stor5), ext_call.return_data[0] + ((10^6 * msg.value) - (collateralRatio * msg.value) / 10^6), 0
            mem[(2 * ceil32(return_data.size)) + 328] = 0
            call 0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7 with:
               funct Mask(32, 224, approve(address arg1, uint256 arg2), Mask(224, 0, stor5), uint32(stor5), ext_call.return_data[0] + ((10^6 * msg.value) - (collateralRatio * msg.value) / 10^6), 0) >> 224
                 gas gas_remaining wei
                args (Mask(512, -288, approve(address arg1, uint256 arg2), Mask(224, 0, stor5), uint32(stor5), ext_call.return_data[0] + ((10^6 * msg.value) - (collateralRatio * msg.value) / 10^6), 0) << 288)
            if not return_data.size:
                if not ext_call.success:
                    if ext_call.return_data[0]:
                        revert with memory
                ...
                if msg.value - (msg.value * mintingFee / 10^6):
                    ...
                    sub_2ebfa5bd = sub_2ebfa5bd + msg.value - (msg.value * mintingFee / 10^6)
                if msg.value * mintingFee * collateralRatio / 10^6 / 10^6:
                    mem[(2 * ceil32(return_data.size)) + 296] = address(reserveAddress)
                    ...
                    if not ext_code.size(0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7):
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 424 len 96] = 0, address(reserveAddress), msg.value * mintingFee * collateralRatio / 10^6 / 10^6, 0
                    mem[(2 * ceil32(return_data.size)) + 492] = 0
                    call 0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7 with:
                       funct Mask(32, 224, 0, address(reserveAddress), msg.value * mintingFee * collateralRatio / 10^6 / 10^6, 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, 0, address(reserveAddress), msg.value * mintingFee * collateralRatio / 10^6 / 10^6, 0) << 288)
                    if not return_data.size:
                        if not ext_call.success:
                            if ext_call.return_data[0]:
                                revert with memory
                ...
                if not msg.value * mintingFee * collateralRatio / 10^6 / 10^6:
                    ...
                    mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 297] = address(reserveAddress)
                    ...
                    if not ext_code.size(0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7):
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 425 len 96] = 0, address(reserveAddress), msg.value * mintingFee * collateralRatio / 10^6 / 10^6, 0
