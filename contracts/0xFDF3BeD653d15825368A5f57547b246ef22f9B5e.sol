...
function retireStrat() payable {
    if vaultAddress != msg.sender:
        revert with 0, '!vault'
    require ext_code.size(chefAddress)
    call chefAddress.0x2f940c70 with:
         gas gas_remaining wei
        args poolId, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function rewardsAvailable() payable {
    ...
    require ext_code.size(chefAddress)
    staticcall chefAddress.0x98969e82 with:
            gas gas_remaining wei
           args poolId, this.address
    ...
    require ext_code.size(chefAddress)
    staticcall chefAddress.0xc346253d with:
            gas gas_remaining wei
           args poolId
    ...
    if not ext_call.return_data[12 len 20]:
        ...
        if not ext_call.success:
            ...
            while idx < stor22.length:
                ...
                if _547 - 1 < _547:
                    mem[mem[64]] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
                    mem[mem[64] + 4] = mem[(32 * _547 - 1) + _540 + ceil32(return_data.size) + 32]
                    mem[mem[64] + 36] = 64
                    ...
                    staticcall unirouterAddress.getAmountsOut(uint256 arg1, address[] arg2) with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4], Array(len=outputToNativeRoute.length, data=mem[mem[64] + 100 len 32 * outputToNativeRoute.length])
                    if not ext_call.success:
                        idx = idx + 1
                        s = s
                        continue 
            ...
            if not stor22.length:
                ...
                if callFee * 45 * mem[(32 * _198 - 1) + (4 * ceil32(return_data.size)) + 128] / 1000 / 45 * mem[(32 * _198 - 1) + (4 * ceil32(return_data.size)) + 128] / 1000 != callFee:
                    revert with 0, 'SafeMath: multiplication overflow'
                return (callFee * 45 * mem[(32 * _198 - 1) + (4 * ceil32(return_data.size)) + 128] / 1000 / 1000)
            idx = 0
        ...
        if not ext_call.success:
            ...
            while idx < stor22.length:
                ...
                if _811 - 1 < _811:
                    mem[mem[64]] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
                    mem[mem[64] + 4] = mem[(32 * _811 - 1) + _803 + ceil32(return_data.size) + 32]
                    mem[mem[64] + 36] = 64
                    mem[mem[64] + 68] = outputToNativeRoute.length
                    mem[0] = 19
                    t = 0
            ...
            if not stor22.length:
                ...
                if callFee * 45 * mem[(32 * _549 - 1) + _542 + ceil32(return_data.size) + 32] / 1000 / 45 * mem[(32 * _549 - 1) + _542 + ceil32(return_data.size) + 32] / 1000 != callFee:
                    revert with 0, 'SafeMath: multiplication overflow'
                return (callFee * 45 * mem[(32 * _549 - 1) + _542 + ceil32(return_data.size) + 32] / 1000 / 1000)
            idx = 0
