...
function joeCall(address arg1, uint256 arg2, uint256 arg3, bytes arg4) {
    ...
    if 0xb54f16fb19478766a268f172c9480f8da1a7c9c3 == address(cd[(arg4 + 68)]):
        ...
        mem[ceil32(cd[(arg4 + cd[(arg4 + 196)] + 36)]) + (7 * ceil32(return_data.size)) + 416] = mem[ceil32(cd[(arg4 + cd[(arg4 + 196)] + 36)]) + (6 * ceil32(return_data.size)) + mem[ceil32(cd[(arg4 + cd[(arg4 + 196)] + 36)]) + (6 * ceil32(return_data.size)) + 416 len 4], ext_call.return_data[0 len 28] + 416]
        ...
        _281 = mem[_277 + mem[_277]]
        require mem[_277 + mem[_277]] <= test266151307()
        require (32 * mem[_277 + mem[_277]]) + 32 >= 0 and _277 + ceil32(return_data.size) + (32 * mem[_277 + mem[_277]]) + 32 <= test266151307()
        mem[64] = _277 + ceil32(return_data.size) + (32 * mem[_277 + mem[_277]]) + 32
        mem[_277 + ceil32(return_data.size)] = _281
        require return_data.size >= _279 + (32 * _281) + 32
        mem[_277 + ceil32(return_data.size) + 32 len 32 * _281] = mem[_277 + _279 + 32 len 32 * _281]
        mem[mem[64] + 4] = this.address
        require ext_code.size(0xda67235dd5787d67955420c84ca1cecd4e5bb3b)
        staticcall 0xda67235dd5787d67955420c84ca1cecd4e5bb3b.0x70a08231 with:
                gas gas_remaining wei
