...
function getBalances(address[] arg1) {
    ...
    if 2 * arg1.length > -5:
        revert with 'NH{q', 17
    if (2 * arg1.length) + 4 > test266151307():
        revert with 'NH{q', 65
    mem[floor32(arg1.length) + 97] = (2 * arg1.length) + 4
    mem[64] = floor32(arg1.length) + (32 * (2 * arg1.length) + 4) + 129
    if not (2 * arg1.length) + 4:
        if 0 >= (2 * arg1.length) + 4:
            revert with 'NH{q', 50
        mem[floor32(arg1.length) + 129] = eth.balance(0x85a92368ab710a85f57b9872c0fe4361a405e5d)
        if 1 >= (2 * arg1.length) + 4:
            revert with 'NH{q', 50
        mem[floor32(arg1.length) + 161] = eth.balance(0xebdef90adcd0cef650afd081375570b391a6880a)
        if 2 >= (2 * arg1.length) + 4:
            revert with 'NH{q', 50
        mem[floor32(arg1.length) + 193] = eth.balance(0xd0378dc03bbe09df7b474b5a3a7bbe9171ce5b99)
        if 3 >= (2 * arg1.length) + 4:
            revert with 'NH{q', 50
        mem[floor32(arg1.length) + 225] = eth.balance(0xb5bd52398a18f53dcb8d2a578b245756e9114f87)
        idx = 0
        while idx < arg1.length:
            if idx >= mem[96]:
                revert with 'NH{q', 50
            ...
            if 4 > -idx - 1:
                revert with 'NH{q', 17
            if idx + 4 >= mem[floor32(arg1.length) + 97]:
                revert with 'NH{q', 50
            mem[(32 * idx + 4) + floor32(arg1.length) + 129] = mem[_129]
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
            continue 
        ...
        while idx < _148:
            ...
            staticcall address(_153).0x70a08231 with:
                    gas gas_remaining wei
                   args 0xd0378dc03bbe09df7b474b5a3a7bbe9171ce5b99
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _163 = mem[64]
            ...
            if idx + 4 > -mem[96] - 1:
                revert with 'NH{q', 17
            if idx + mem[96] + 4 >= mem[floor32(arg1.length) + 97]:
                revert with 'NH{q', 50
            mem[(32 * idx + mem[96] + 4) + floor32(arg1.length) + 129] = mem[_163]
            if idx == -1:
                revert with 'NH{q', 17
            _148 = mem[96]
            idx = idx + 1
            continue 
        mem[mem[64]] = 32
        _158 = mem[floor32(arg1.length) + 97]
        mem[mem[64] + 32] = mem[floor32(arg1.length) + 97]
        mem[mem[64] + 64 len 32 * _158] = mem[floor32(arg1.length) + 129 len 32 * _158]
        return 32, mem[mem[64] + 32 len (32 * _158) + 32]
    mem[floor32(arg1.length) + 129 len 32 * (2 * arg1.length) + 4] = call.data[calldata.size len 32 * (2 * arg1.length) + 4]
    if 0 >= (2 * arg1.length) + 4:
        revert with 'NH{q', 50
    mem[floor32(arg1.length) + 129] = eth.balance(0x85a92368ab710a85f57b9872c0fe4361a405e5d)
    if 1 >= (2 * arg1.length) + 4:
    ...
    while idx < arg1.length:
        ...
        if idx + 4 >= mem[floor32(arg1.length) + 97]:
            revert with 'NH{q', 50
        mem[(32 * idx + 4) + floor32(arg1.length) + 129] = mem[_131]
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
    ...
    while idx < _149:
        ...
        if idx + mem[96] + 4 >= mem[floor32(arg1.length) + 97]:
            revert with 'NH{q', 50
        mem[(32 * idx + mem[96] + 4) + floor32(arg1.length) + 129] = mem[_165]
        if idx == -1:
            revert with 'NH{q', 17
        _149 = mem[96]
        idx = idx + 1
        continue 
    mem[mem[64]] = 32
    _159 = mem[floor32(arg1.length) + 97]
    mem[mem[64] + 32] = mem[floor32(arg1.length) + 97]
    mem[mem[64] + 64 len 32 * _159] = mem[floor32(arg1.length) + 129 len 32 * _159]
