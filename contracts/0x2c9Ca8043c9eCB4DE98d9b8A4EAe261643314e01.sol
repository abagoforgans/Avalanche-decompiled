...
function sub_ae85e61a(?) payable {
    ...
    if not arg1.length:
        ...
        while idx < arg1.length:
            ...
            require 1 < mem[_97 + ceil32(return_data.size)]
            require floor32(_105) < mem[(32 * arg1.length) + (32 * arg2.length) + 160]
            mem[(Mask(251, 0, _105) * 32) + (32 * arg1.length) + (32 * arg2.length) + 192] = mem[_97 + ceil32(return_data.size) + 64]
            s = floor32(_105) + 1
    ...
    while idx < arg1.length:
        ...
        require 1 < mem[_98 + ceil32(return_data.size)]
        require floor32(_106) < mem[(32 * arg1.length) + (32 * arg2.length) + 160]
        mem[(Mask(251, 0, _106) * 32) + (32 * arg1.length) + (32 * arg2.length) + 192] = mem[_98 + ceil32(return_data.size) + 64]
        s = floor32(_106) + 1
