...
function getPrices(address[] arg1) payable {
    ...
    if not arg1.length:
        ...
        while idx < arg1.length:
            ...
            mem[mem[64]] = 4
            mem[64] = mem[64] + 36
            mem[_270 + 32] = 0x902f1ac00000000000000000000000000000000000000000000000000000000 or mem[_270 + 36 len 28]
            _273 = mem[_270]
            t = _270 + 32
            u = mem[64]
            s = mem[_270]
            ...
            staticcall address(cd[((32 * idx) + arg1 + 36)]).mem[mem[64] len 4] with:
                    gas gas_remaining wei
                   args mem[mem[64] + 4 len _273 + _270 + -mem[64] + 32]
            if return_data.size:
                _534 = mem[64]
        ...
        while idx < arg1.length:
            ...
            mem[mem[64]] = 4
            mem[64] = mem[64] + 36
            mem[_276 + 32] = 0x902f1ac00000000000000000000000000000000000000000000000000000000 or mem[_276 + 36 len 28]
            _279 = mem[_276]
            t = _276 + 32
            u = mem[64]
            s = mem[_276]
            ...
            staticcall address(cd[((32 * idx) + arg1 + 36)]).mem[mem[64] len 4] with:
                    gas gas_remaining wei
                   args mem[mem[64] + 4 len _279 + _276 + -mem[64] + 32]
            if return_data.size:
                _535 = mem[64]
                mem[64] = mem[64] + ceil32(return_data.size) + 1
