...
function getTokensUnclaimed(address arg1) payable {
    require calldata.size - 4 >= 32
    return tokensUnclaimed[address(arg1)].field_0
}
...
function buy(uint256 arg1) payable {
    ...
    if arg1 + (tokensOwned[msg.sender] * sub_3549756a) > sub_7a995c2b:
        revert with 0, 'high amount than max'
    if not arg1:
        if eth.balance(this.address) < 0:
        ...
        if not return_data.size:
            ...
            if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
                revert with 0, 
                            ...
                            0,
                            mem[420 len 4]
            if tokensOwned[address(msg.sender)] < tokensOwned[address(msg.sender)]:
                revert with 0, 'SafeMath: addition overflow'
            if tokensUnclaimed[address(msg.sender)].field_0 < tokensUnclaimed[address(msg.sender)].field_0:
                revert with 0, 'SafeMath: addition overflow'
            if totalTokensSold < totalTokensSold:
                revert with 0, 'SafeMath: addition overflow'
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if ext_call.return_data[0] < tokensUnclaimed[msg.sender].field_0:
                revert with 0, 
                            32,
                            44,
                            0x73546865726520617265206e6f7420656e6f7567682050444620746f6b656e7320746f207472616e73666572,
                            mem[404 len 12],
                            0,
                            mem[420 len 4]
            tokensUnclaimed[msg.sender].field_0 = 0
            if eth.balance(this.address) < 0:
                revert with 0, 32, 38, 0x2e416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[562 len 26]
            if not ext_code.size(sub_3a75b50bAddress):
                revert with 0, 'Address: call to non-contract'
            mem[456 len 64] = 0, msg.sender, tokensUnclaimed[msg.sender].field_32
            call sub_3a75b50bAddress with:
               funct uint32(msg.sender)
                 gas gas_remaining wei
                args tokensUnclaimed[msg.sender].field_0, mem[392 len 24], 0, mem[520 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), arg1
                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
            ...
            if ext_call.return_data[0] < tokensUnclaimed[msg.sender].field_0:
                revert with 0, 
                            ...
                            44,
                            0x73546865726520617265206e6f7420656e6f7567682050444620746f6b656e7320746f207472616e73666572,
                            mem[ceil32(return_data.size) + 405 len 20]
            tokensUnclaimed[msg.sender].field_0 = 0
            if eth.balance(this.address) < 0:
                revert with 0, 
                            32,
            ...
            if not ext_code.size(sub_3a75b50bAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 457 len 64] = 0, msg.sender, tokensUnclaimed[msg.sender].field_32
            call sub_3a75b50bAddress with:
               funct uint32(msg.sender)
                 gas gas_remaining wei
                args tokensUnclaimed[msg.sender].field_0, mem[ceil32(return_data.size) + 393 len 28], mem[ceil32(return_data.size) + 521 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), arg1
                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
        ...
        if not return_data.size:
            ...
            if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
                revert with 0, 
                            ...
                            0,
                            mem[420 len 4]
            if (sub_3549756a * arg1) + tokensOwned[address(msg.sender)] < tokensOwned[address(msg.sender)]:
                revert with 0, 'SafeMath: addition overflow'
            tokensOwned[address(msg.sender)] += sub_3549756a * arg1
            if (sub_3549756a * arg1) + tokensUnclaimed[address(msg.sender)].field_0 < tokensUnclaimed[address(msg.sender)].field_0:
                revert with 0, 'SafeMath: addition overflow'
            tokensUnclaimed[address(msg.sender)].field_0 += sub_3549756a * arg1
            if (sub_3549756a * arg1) + totalTokensSold < totalTokensSold:
                revert with 0, 'SafeMath: addition overflow'
            totalTokensSold += sub_3549756a * arg1
            if arg1 + stor10 < stor10:
                revert with 0, 'SafeMath: addition overflow'
            stor10 += arg1
            require ext_code.size(sub_3a75b50bAddress)
                ...
                if return_data.size:
                    ...
                    if not mem[ceil32(return_data.size) + 489]:
                        revert with 0, 
                                    ...
                                    0xfe5361666542455032303a204245503230206f7065726174696f6e20646964206e6f7420737563636565,
                                    mem[(2 * ceil32(return_data.size)) + 568 len (2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 22]
        emit TokenBuy(msg.sender, sub_3549756a * arg1);
    stor1 = 1
}
