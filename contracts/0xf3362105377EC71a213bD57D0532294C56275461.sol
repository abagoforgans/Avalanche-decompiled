...
function mint() payable {
    if stor12:
        revert with 0, 'Minting is currently paused!'
    if tokenByIndex.length + 1 >= -stor13 + 10000:
        revert with 0, 'Supply exceeded!'
    if msg.value < price:
        revert with 0, 'AVAX sent not correct!'
    if not msg.sender:
        revert with 0, 'ERC721: mint to the zero address'
    if stor3[stor2.length + 1]:
        revert with 0, 'ERC721: token already minted'
    if not tokenOfOwnerByIndex[address(msg.sender)][1][stor2.length + 1]:
        tokenOfOwnerByIndex[address(msg.sender)]++
        tokenOfOwnerByIndex[address(msg.sender)][tokenOfOwnerByIndex[address(msg.sender)]] = tokenByIndex.length + 1
        tokenOfOwnerByIndex[address(msg.sender)][1][stor2.length + 1] = tokenOfOwnerByIndex[address(msg.sender)]
    if stor3[stor2.length + 1]:
        require stor3[stor2.length + 1] - 1 < tokenByIndex.length
        tokenByIndex[stor3[tokenByIndex.length + 1] - 1].field_256 = msg.sender
        ...
        if ext_code.size(msg.sender) > 0:
            ...
            mem[420 len 160] = onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, tokenByIndex.length + 1, 128, 0
            mem[608 len 4] = 0
            mem[580 len 0] = 0
            call msg.sender.0x80 with:
                 gas gas_remaining wei
                args Mask(1248, -1024, onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, tokenByIndex.length + 1, 128, 0) << 1024, mem[580 len 4]
        ...
        if ext_code.size(msg.sender) > 0:
            ...
            if ext_code.size(msg.sender) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[484 len 160] = onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, tokenByIndex.length + 1, 128, 0
            mem[672 len 4] = 0
            mem[644 len 0] = 0
            call msg.sender.0x80 with:
                 gas gas_remaining wei
                args Mask(1248, -1024, onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, tokenByIndex.length + 1, 128, 0) << 1024, mem[644 len 4]
            if not return_data.size:
                require not ext_call.success
                revert with 0, 
                            32,
...
function giveAway(address arg1) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if stor13 < 1:
        revert with 0, 'Reserve is exceeded!'
    if not arg1:
        revert with 0, 'ERC721: mint to the zero address'
    if stor3[-stor13 + 10000]:
        revert with 0, 'ERC721: token already minted'
    if tokenOfOwnerByIndex[address(arg1)][1][-stor13 + 10000]:
        if stor3[-stor13 + 10000]:
            require stor3[-stor13 + 10000] - 1 < tokenByIndex.length
            tokenByIndex[stor3[-stor13 + 10000] - 1].field_256 = arg1
            tokenByIndex[stor3[-stor13 + 10000] - 1].field_416 = 0
            emit Transfer(0, arg1, -stor13 + 10000);
            if ext_code.size(arg1) > 0:
                if eth.balance(this.address) < 0:
                    revert with 0, 32, 38, 0x73416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[526 len 26]
                if ext_code.size(arg1) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[420 len 160] = onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, -stor13 + 10000, 128, 0
                mem[608 len 4] = 0
                mem[580 len 0] = 0
                call arg1.0x80 with:
                     gas gas_remaining wei
                    args Mask(1248, -1024, onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, -stor13 + 10000, 128, 0) << 1024, mem[580 len 4]
                if not return_data.size:
                    require not ext_call.success
                    revert with 0, 
                                32,
            ...
            tokenByIndex.length++
            tokenByIndex[tokenByIndex.length].field_0 = -stor13 + 10000
            tokenByIndex[tokenByIndex.length].field_256 = arg1
            tokenByIndex[tokenByIndex.length].field_416 = 0
            stor3[-stor13 + 10000] = tokenByIndex.length
            emit Transfer(0, arg1, -stor13 + 10000);
            if ext_code.size(arg1) > 0:
                if eth.balance(this.address) < 0:
                    revert with 0, 32, 38, 0x73416464726573733a20696e73756666696369656e742062616c616e636520666f722063616c, mem[590 len 26]
                if ext_code.size(arg1) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[484 len 160] = onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, -stor13 + 10000, 128, 0
                mem[672 len 4] = 0
                mem[644 len 0] = 0
                call arg1.0x80 with:
                     gas gas_remaining wei
                    args Mask(1248, -1024, onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4), msg.sender, 0, -stor13 + 10000, 128, 0) << 1024, mem[644 len 4]
                if not return_data.size:
                    require not ext_call.success
                    revert with 0, 
                                32,
        ...
        tokenOfOwnerByIndex[address(arg1)]++
        tokenOfOwnerByIndex[address(arg1)][tokenOfOwnerByIndex[address(arg1)]] = -stor13 + 10000
        tokenOfOwnerByIndex[address(arg1)][1][-stor13 + 10000] = tokenOfOwnerByIndex[address(arg1)]
        if stor3[-stor13 + 10000]:
            require stor3[-stor13 + 10000] - 1 < tokenByIndex.length
            tokenByIndex[stor3[-stor13 + 10000] - 1].field_256 = arg1
            tokenByIndex[stor3[-stor13 + 10000] - 1].field_416 = 0
