...
function increaseTransferFee(uint256 arg1) {
    ...
    if not totalTokenStaked:
        ...
        if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_433f4660[msg.sender]:
            ...
            staticcall sub_433f4660[msg.sender].decimals() with:
                    gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
    ...
    if stakes[msg.sender]:
        ...
        while idx < sub_8ef4403c.length:
            if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                ...
                staticcall sub_8ef4403c[idx].decimals() with:
                        gas gas_remaining wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
...
function unstake(uint256 arg1) payable {
                    ...
                    if not (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 / 10^(-uint8(ext_call.return_data[0]) + 18):
                        ...
                        if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[_625 + floor32(mem[_625]) + 32] = mem[_625 + -(mem[_625] % 32) + floor32(mem[_625]) + 64 len mem[_625] % 32] or Mask(8 * -(mem[_625] % 32) + 32, -(8 * -(mem[_625] % 32) + 32) + 256, mem[_625 + floor32(mem[_625]) + 32])
                            call msg.sender.mem[_625 + 32 len 4] with:
                               value (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 / 10^(-uint8(ext_call.return_data[0]) + 18) wei
                                 gas gas_remaining wei
                                args mem[_625 + 36 len _627 - 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, '!safeTransferETH'
                                mem[_625 + 32] = (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 / 10^(-uint8(ext_call.return_data[0]) + 18)
                            else:
                                mem[64] = _625 + ceil32(return_data.size) + 33
                                mem[_625 + 32] = return_data.size
                                mem[_625 + 64 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                if not ext_call.success:
                                    revert with 0, '!safeTransferETH'
                                mem[_625 + ceil32(return_data.size) + 33] = (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 / 10^(-uint8(ext_call.return_data[0]) + 18)
                        else:
                            _620 = mem[64]
                            mem[mem[64] + 36] = msg.sender
                            mem[mem[64] + 68] = (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 / 10^(-uint8(ext_call.return_data[0]) + 18)
    ...
    if arg1:
        if arg1 < stakes[msg.sender]:
            ...
            mem[mem[64]] = 68
            mem[64] = mem[64] + 100
            mem[_1001 + 32 len 4] = transfer(address arg1, uint256 arg2)
            _1004 = mem[_1001]
            ...
            mem[mem[64]] = 68
            mem[64] = mem[64] + 100
            mem[_1007 + 32 len 4] = transfer(address arg1, uint256 arg2)
            _1010 = mem[_1007]
