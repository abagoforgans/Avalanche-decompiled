...
#
const sub_b17da74e(?) = 0


address owner;
address stor1;
address sub_65a90207Address;
uint32 stor3; offset 224
uint128 stor3;
uint128 stor3; offset 112
uint256 sub_51303622;
address joeAddress;
address devAddr;
...
function sub_51303622(?) payable {
    return sub_51303622
}

function sub_65a90207(?) payable {
    return sub_65a90207Address
}
...
function sub_ceb688b8(?) payable {
    return Mask(112, 0, Mask(112, 0, stor3.field_0) / 10^18)
}

function sub_8192ff3b(?) payable {
    return Mask(112, 0, stor3.field_0), Mask(112, 0, stor3.field_0), uint32(stor3.field_224)
}
...
function sub_a7d6c7b0(?) payable {
    require ext_code.size(sub_65a90207Address)
    staticcall sub_65a90207Address.0x18160ddd with:
...
function sub_5f960089(?) payable {
    require ext_code.size(sub_65a90207Address)
    staticcall sub_65a90207Address.getReserves() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function setLPTokenAddress(address arg1) payable {
    ...
    sub_51303622 = 2 * Mask(112, 0, Mask(112, 0, stor3.field_0) / 10^18) * ext_call.return_data[32] / 100 * 10^6 / ext_call.return_data[0] / 10^18
    return sub_51303622
}
...
function add(uint256 arg1, address arg2, address arg3) payable {
    ...
    if not stor17[address(arg2)]:
        stor16.length++
        stor16[stor16.length].field_0 = arg2
        stor16[stor16.length].field_160 = 0
        stor17[address(arg2)] = stor16.length
