...
function emergencyWithdraw(address arg1, uint256 arg2) payable {
    ...
    if ext_call.return_data[0] < arg2:
        revert with 0, 'Contract balance of token too low'
...
function withdraw(address arg1, address arg2, uint256 arg3) payable {
    ...
    if arg3 * fee / 10000 > 0:
        ...
        if ext_call.return_data[0] < arg3:
            revert with 0, 'Insufficient token balance in contract'
        if stor3 == arg1:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if arg3 < arg3 * fee / 10000:
                revert with 0, 17
            call arg1.0xa9059cbb with:
                 gas gas_remaining wei
                args address(arg2), arg3 - (arg3 * fee / 10000)
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require ext_call.return_data[0] == bool(ext_call.return_data[0])
            ...
            mem[ceil32(return_data.size) + 196] = arg3 * fee / 10000
            ...
            staticcall stor2.getAmountsOut(uint256 arg1, address[] arg2) with:
                    gas gas_remaining wei
                   args arg3 * fee / 10000, Array(len=2, data=mem[ceil32(return_data.size) + 292 len 64])
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[ceil32(return_data.size) + 192 len return_data.size] = ext_call.return_data[0 len return_data.size]
            mem[64] = (2 * ceil32(return_data.size)) + 192
            require return_data.size >= 32
            _100 = mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3 * fee / 10000) >> 32
            require mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3 * fee / 10000) >> 32 <= test266151307()
            require ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3 * fee / 10000) >> 32 + 223 < ceil32(return_data.size) + return_data.size + 192
            _102 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3 * fee / 10000) >> 32 + 192]
            if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3 * fee / 10000) >> 32 + 192] > test266151307():
                revert with 0, 65
            if (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3 * fee / 10000) >> 32 + 192]) + 193 > test266151307() or ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3 * fee / 10000) >> 32 + 192]) + 1 < 0:
                revert with 0, 65
            mem[64] = (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3 * fee / 10000) >> 32 + 192]) + 193
            mem[(2 * ceil32(return_data.size)) + 192] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3 * fee / 10000) >> 32 + 192]
            require (32 * _102) + _100 + 32 <= return_data.size
            mem[(2 * ceil32(return_data.size)) + 224 len ceil32(32 * _102)] = mem[ceil32(return_data.size) + _100 + 224 len ceil32(32 * _102)]
            if _102 < 1:
                revert with 0, 17
            if _102 - 1 >= _102:
                revert with 0, 50
            if mem[(32 * _102 - 1) + (2 * ceil32(return_data.size)) + 224] > 0x69eab14955bf40069eab14955bf40069eab14955bf40069eab14955bf4006:
                revert with 0, 17
            if 60 > !block.timestamp:
                revert with 0, 17
            mem[mem[64]] = 0x676528d100000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = arg3 * fee / 10000
            mem[mem[64] + 36] = 9900 * mem[(32 * _102 - 1) + (2 * ceil32(return_data.size)) + 224] / 10000
            mem[mem[64] + 68] = 160
            mem[mem[64] + 164] = 2
            idx = 0
            s = ceil32(return_data.size) + 128
            ...
            call stor2.swapExactTokensForAVAX(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args arg3 * fee / 10000, 9900 * mem[(32 * _102 - 1) + (2 * ceil32(return_data.size)) + 224] / 10000, Array(len=2, data=mem[mem[64] + 196 len 64]), msg.sender, block.timestamp + 60
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _215 = mem[64]
            ...
            mem[_215 + ceil32(return_data.size)] = _221
            require (32 * _221) + _217 + 32 <= return_data.size
            mem[_215 + ceil32(return_data.size) + 32 len ceil32(32 * _221)] = mem[_215 + _217 + 32 len ceil32(32 * _221)]
            if arg3 < arg3 * fee / 10000:
                revert with 0, 17
            mem[mem[64] + 4] = arg2
            mem[mem[64] + 36] = arg3 - (arg3 * fee / 10000)
            call arg1.0xa9059cbb with:
                 gas gas_remaining wei
                args address(arg2), arg3 - (arg3 * fee / 10000)
        ...
        if fee:
            revert with 0, 'Withdrawal amount too low'
        mem[100] = this.address
        staticcall arg1.0x70a08231 with:
                gas gas_remaining wei
               args this.address
        ...
        if stor3 == arg1:
            ...
            mem[64] = (2 * ceil32(return_data.size)) + 192
            require return_data.size >= 32
            _101 = mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3 * fee / 10000) >> 32
            require mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3 * fee / 10000) >> 32 <= test266151307()
            require ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3 * fee / 10000) >> 32 + 223 < ceil32(return_data.size) + return_data.size + 192
            _103 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3 * fee / 10000) >> 32 + 192]
            if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3 * fee / 10000) >> 32 + 192] > test266151307():
                revert with 0, 65
            if (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3 * fee / 10000) >> 32 + 192]) + 193 > test266151307() or ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg3 * fee / 10000) >> 32 + 192]) + 1 < 0:
                revert with 0, 65
            ...
            mem[(2 * ceil32(return_data.size)) + 224 len ceil32(32 * _103)] = mem[ceil32(return_data.size) + _101 + 224 len ceil32(32 * _103)]
            if _103 < 1:
                revert with 0, 17
            if _103 - 1 >= _103:
                revert with 0, 50
            if mem[(32 * _103 - 1) + (2 * ceil32(return_data.size)) + 224] > 0x69eab14955bf40069eab14955bf40069eab14955bf40069eab14955bf4006:
                revert with 0, 17
            if 60 > !block.timestamp:
                revert with 0, 17
            mem[mem[64]] = 0x676528d100000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = arg3 * fee / 10000
            mem[mem[64] + 36] = 9900 * mem[(32 * _103 - 1) + (2 * ceil32(return_data.size)) + 224] / 10000
            mem[mem[64] + 68] = 160
            mem[mem[64] + 164] = 2
            idx = 0
            s = ceil32(return_data.size) + 128
            ...
            call stor2.swapExactTokensForAVAX(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args arg3 * fee / 10000, 9900 * mem[(32 * _103 - 1) + (2 * ceil32(return_data.size)) + 224] / 10000, Array(len=2, data=mem[mem[64] + 196 len 64]), msg.sender, block.timestamp + 60
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _216 = mem[64]
            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            mem[_216 + ceil32(return_data.size)] = _222
            require (32 * _222) + _218 + 32 <= return_data.size
            mem[_216 + ceil32(return_data.size) + 32 len ceil32(32 * _222)] = mem[_216 + _218 + 32 len ceil32(32 * _222)]
            if arg3 < arg3 * fee / 10000:
                revert with 0, 17
            mem[mem[64] + 4] = arg2
            mem[mem[64] + 36] = arg3 - (arg3 * fee / 10000)
