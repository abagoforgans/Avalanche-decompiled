...
function getMaxToken0AmountOut(address arg1, uint256 arg2) payable {
    ...
    staticcall pairs[address(arg1)].getReserves(uint256 rg1) with:
...
function removeLiquidity(address arg1, uint256 arg2, address arg3) payable {
    ...
    mem[100] = msg.sender
    require ext_code.size(pairs[address(arg1)])
    staticcall pairs[address(arg1)].balanceOf(address rg1) with:
            gas gas_remaining wei
           args msg.sender
    ...
    require ext_code.size(pairs[address(arg1)])
    call pairs[address(arg1)].burn(address rg1, address rg2, uint256 rg3, address rg4, uint256 rg5) with:
         gas gas_remaining wei
    ...
    if arg4 < ext_call.return_data[32] / ext_call.return_data[0]:
        if not arg4:
            if arg4 > ext_call.return_data[32] / ext_call.return_data[0]:
                ...
                mem[(2 * ceil32(return_data.size)) + 292 len 128] = transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), 0, 0
                mem[(2 * ceil32(return_data.size)) + 392] = 0
                call arg1 with:
                   funct Mask(32, 224, transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), 0, 0) >> 224
                     gas gas_remaining wei
                    args (Mask(768, -544, transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), 0, 0) << 544)
            ...
            if not ext_code.size(arg1):
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + 292 len 128] = transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, pairs[address(arg1)], arg4, 0
            mem[(2 * ceil32(return_data.size)) + 392] = 0
            call arg1 with:
               funct Mask(32, 224, transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, pairs[address(arg1)], arg4, 0) >> 224
                 gas gas_remaining wei
                args (Mask(768, -544, transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, pairs[address(arg1)], arg4, 0) << 544)
            if not return_data.size:
                if not ext_call.success:
                    if ext_call.return_data[0]:
                        revert with memory
                ...
                require ext_code.size(pairs[address(arg1)])
                call pairs[address(arg1)].swapOut(address rg1, uint256 rg2, uint256 rg3) with:
                     gas gas_remaining wei
                ...
                if arg4 > ext_call.return_data[32] / ext_call.return_data[0]:
                    ...
                    mem[(4 * ceil32(return_data.size)) + 324 len 4] = transferFrom(address rg1, address rg2, uint256 rg3)
                    ...
                    if not return_data.size:
                        ...
                        if False and ext_call.return_data[0] > 0:
                            revert with 0, 17
                        emit Lock(address rg1, address rg2, uint256 rg3, uint256 rg4, address rg5, address rg6, uint256 rg7):
                                  address(arg1),
                ...
                if arg4 > ext_call.return_data[32] / ext_call.return_data[0]:
                    ...
                    mem[(4 * ceil32(return_data.size)) + ceil32(return_data.size) + 325 len 4] = transferFrom(address rg1, address rg2, uint256 rg3)
        ...
        if not ext_call.return_data[32] / ext_call.return_data[0]:
            if arg4 > ext_call.return_data[32] / ext_call.return_data[0]:
                ...
                if not ext_code.size(arg1):
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 292 len 128] = transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg4 - (ext_call.return_data[32] / ext_call.return_data[0]), 0
                mem[(2 * ceil32(return_data.size)) + 392] = 0
                call arg1 with:
                   funct Mask(32, 224, transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg4 - (ext_call.return_data[32] / ext_call.return_data[0]), 0) >> 224
                     gas gas_remaining wei
                    args (Mask(768, -544, transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, address(this.address), arg4 - (ext_call.return_data[32] / ext_call.return_data[0]), 0) << 544)
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0]:
                            revert with memory
            ...
            if not ext_code.size(arg1):
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + 292 len 128] = transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, pairs[address(arg1)], ext_call.return_data[32] / ext_call.return_data[0], 0
            mem[(2 * ceil32(return_data.size)) + 392] = 0
            call arg1 with:
               funct Mask(32, 224, transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, pairs[address(arg1)], ext_call.return_data[32] / ext_call.return_data[0], 0) >> 224
                 gas gas_remaining wei
                args (Mask(768, -544, transferFrom(address rg1, address rg2, uint256 rg3), msg.sender, pairs[address(arg1)], ext_call.return_data[32] / ext_call.return_data[0], 0) << 544)
            if not return_data.size:
                if not ext_call.success:
                    if ext_call.return_data[0]:
                        revert with memory
