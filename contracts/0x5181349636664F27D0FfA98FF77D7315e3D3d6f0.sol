...
const getName = 'StrategyPngAVAXWALBTMiniLp'
...
function sub_e17ffbc9(?) {
    return sub_e17ffbc9Address
}
    ...
    if ext_call.return_data[0] >= arg1:
        if not arg1:
            ...
            if not return_data.size:
                if not arg1:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(2 * ceil32(return_data.size)) + 846 len 64] = unknown_0xa9059cbb(?????), address(ext_call.return_data[0]) << 64, 0, Mask(224, 32, arg1 - (withdrawalTreasuryFee * arg1 / 100000)) >> 32
                        call wantAddress with:
                             gas gas_remaining wei
                            args Mask(224, 32, arg1 - (withdrawalTreasuryFee * arg1 / 100000)) << 224, mem[(2 * ceil32(return_data.size)) + 910 len 4]
                        if not return_data.size:
                            require not ext_call.success
                            revert with 'SafeMath: division by zero'
                        mem[(2 * ceil32(return_data.size)) + 878 len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if not arg1:
                ...
                call wantAddress.mem[ceil32(return_data.size) + 453 len 4] with:
                     gas gas_remaining wei
                    args Mask(224, 32, withdrawalTreasuryFee * arg1 / 100000) << 224, mem[ceil32(return_data.size) + 617 len 4]
                if not return_data.size:
                    require not ext_call.success
                    revert with 'SafeMath: division by zero'
                mem[ceil32(return_data.size) + 585 len return_data.size] = ext_call.return_data[0 len return_data.size]
