...
const INIT_CODE_HASH = sha3(code.data[3596 len 15520], mem[31232 len 9])
...
function setFeeTo(address arg1) payable {
    ...
    if feeToSetterAddress != msg.sender:
        revert with 0, 'BeeTrade: FORBIDDEN'
    feeToAddress = arg1
}
...
function createPair(address arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    if arg1 == arg2:
        revert with 0, 'BeeTrade: IDENTICAL_ADDRESSES'
    if arg1 < arg2:
        if not arg1:
            revert with 0, 'BeeTrade: ZERO_ADDRESS'
        if pair[address(arg1)][address(arg2)]:
            revert with 0, 'BeeTrade: PAIR_EXISTS'
        create2 contract with 0 wei
                        salt: sha3(arg1, arg2)
                        code: code.data[3596 len 15529]
