...
function _getNodeNumberOf(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    delegate 0x94384e7d1fdfee85008a832314c565de6db3bc7f.0x732a2ccf with:
...
function createNode(address arg1, string arg2) payable {
    ...
    require ext_code.size(0x94384e7d1fdfee85008a832314c565de6db3bc7f)
    delegate 0x94384e7d1fdfee85008a832314c565de6db3bc7f.0xbc2b405c with:
         gas gas_remaining wei
