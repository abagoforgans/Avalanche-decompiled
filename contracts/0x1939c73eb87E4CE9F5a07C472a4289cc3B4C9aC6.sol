...
#
const name = 'Loki Nudes'

const totalSupply = 10^18

const decimals = 9

const symbol = 'LOKIDAO'
...
function buyMVAXWithLeftoverWAVAX(uint256 arg1) {
    ...
    mem[356 len 0] = None
    require ext_code.size(uniswapV2RouterAddress)
    call uniswapV2RouterAddress.swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
         gas gas_remaining wei
