...
function addBank(uint256 arg1, address arg2, string arg3, string arg4, address arg5) payable {
    ...
    mem[ceil32(arg3.length) + ceil32(arg4.length) + 356 len 2591] = code.data[15191 len 2591]
    ...
    create contract with 0 wei
                    code: Mask(8 * -ceil32(arg4.length) + arg4.length + 32, 0, 0), code.data[arg4.length + -ceil32(arg4.length) + 15223 len -arg4.length + ceil32(arg4.length) + 2559], address(this.address), 64, ceil32(arg3.length) + ceil32(arg4.length) + 228, unknown_0x41a5068f(?????), arg1, address(arg2), 160, ceil32(arg3.length) + 192, arg5, arg3.length, arg3[all], 0, mem[arg3.length + 356 len ceil32(arg3.length) + ceil32(arg4.length) - arg3.length], code.data[15191 len floor32(ceil32(arg3.length) + ceil32(arg4.length) + 259) + -ceil32(arg3.length) + -ceil32(arg4.length) - 228]
