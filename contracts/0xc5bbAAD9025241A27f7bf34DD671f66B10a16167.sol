...
function withdrawUnderlying(uint256 arg1) payable {
    ...
    if arg1 < principalOf[msg.sender]:
        ...
        if arg1 > ext_call.return_data[0]:
            revert with 0, 'SafeMath: subtraction overflow', 0
        mem[(4 * ceil32(return_data.size)) + 416] = 30
        mem[(4 * ceil32(return_data.size)) + 448] = 'SafeMath: subtraction overflow'
        ...
        if not stor206:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(7 * ceil32(return_data.size)) + 480] = 30
            mem[(7 * ceil32(return_data.size)) + 512] = 'SafeMath: subtraction overflow'
            if ext_call.return_data[0] > ext_call.return_data[0]:
                revert with 0, 'SafeMath: subtraction overflow', 0
            mem[(7 * ceil32(return_data.size)) + 580] = msg.sender
            mem[(7 * ceil32(return_data.size)) + 612] = 0
            mem[(7 * ceil32(return_data.size)) + 544] = 68
            mem[(7 * ceil32(return_data.size)) + 580 len 28] = Mask(224, 32, msg.sender) >> 32
            mem[(7 * ceil32(return_data.size)) + 576 len 4] = unknown_0xa9059cbb(?????)
            mem[(7 * ceil32(return_data.size)) + 644] = 32
            mem[(7 * ceil32(return_data.size)) + 676] = 'SafeERC20: low-level call failed'
            if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(0x6e84a6216ea6dacc71ee8e6b0a5b7322eebc0f):
                revert with 0, 'Address: call to non-contract'
            if not ext_code.hash(0x6e84a6216ea6dacc71ee8e6b0a5b7322eebc0f):
                revert with 0, 'Address: call to non-contract'
            mem[(7 * ceil32(return_data.size)) + 708 len 96] = unknown_0xa9059cbb(?????), msg.sender, 0, 0
            mem[(7 * ceil32(return_data.size)) + 776] = 0
            call 0x006e84a6216ea6dacc71ee8e6b0a5b7322eebc0f with:
               funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, 0, 0) >> 224
                 gas gas_remaining wei
                args (Mask(512, -288, unknown_0xa9059cbb(?????), msg.sender, 0, 0) << 288)
            if not return_data.size:
                ...
                mem[(7 * ceil32(return_data.size)) + 740 len return_data.size] = ext_call.return_data[0 len return_data.size]
                if not ext_call.success:
                    if return_data.size:
                        revert with ext_call.return_data[0 len return_data.size]
                    revert with 0, 'SafeERC20: low-level call failed'
                if return_data.size:
                    require return_data.size >= 32
                    require mem[(7 * ceil32(return_data.size)) + 740] == bool(mem[(7 * ceil32(return_data.size)) + 740])
                    if not mem[(7 * ceil32(return_data.size)) + 740]:
                        revert with 0, 'SafeERC20: ERC20 operation did not succeed'
            ...
            if not ext_call.return_data[0]:
                ...
                if ext_call.return_data[0] > ext_call.return_data[0]:
                    revert with 0, 'SafeMath: subtraction overflow', 0
                mem[(8 * ceil32(return_data.size)) + 580] = msg.sender
                mem[(8 * ceil32(return_data.size)) + 612] = 0
                mem[(8 * ceil32(return_data.size)) + 544] = 68
                mem[(8 * ceil32(return_data.size)) + 580 len 28] = Mask(224, 32, msg.sender) >> 32
                mem[(8 * ceil32(return_data.size)) + 576 len 4] = unknown_0xa9059cbb(?????)
                mem[(8 * ceil32(return_data.size)) + 644] = 32
                mem[(8 * ceil32(return_data.size)) + 676] = 'SafeERC20: low-level call failed'
                if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(0x6e84a6216ea6dacc71ee8e6b0a5b7322eebc0f):
                    revert with 0, 'Address: call to non-contract'
                if not ext_code.hash(0x6e84a6216ea6dacc71ee8e6b0a5b7322eebc0f):
                    revert with 0, 'Address: call to non-contract'
                mem[(8 * ceil32(return_data.size)) + 708 len 96] = unknown_0xa9059cbb(?????), msg.sender, 0, 0
                mem[(8 * ceil32(return_data.size)) + 776] = 0
                call 0x006e84a6216ea6dacc71ee8e6b0a5b7322eebc0f with:
                   funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, 0, 0) >> 224
                     gas gas_remaining wei
                    args (Mask(512, -288, unknown_0xa9059cbb(?????), msg.sender, 0, 0) << 288)
                if not return_data.size:
                    ...
                    mem[(8 * ceil32(return_data.size)) + 740 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    if not ext_call.success:
                        if return_data.size:
                            revert with ext_call.return_data[0 len return_data.size]
                        revert with 0, 'SafeERC20: low-level call failed'
                    if return_data.size:
                        require return_data.size >= 32
                        require mem[(8 * ceil32(return_data.size)) + 740] == bool(mem[(8 * ceil32(return_data.size)) + 740])
                        if not mem[(8 * ceil32(return_data.size)) + 740]:
                            revert with 0, 'SafeERC20: ERC20 operation did not succeed'
                emit Withdrawn(arg1, 0, msg.sender);
            else:
                mem[(6 * ceil32(return_data.size)) + 484] = arg1
                mem[(6 * ceil32(return_data.size)) + 516] = depositedAt[msg.sender]
                require ext_code.size(stor206)
                staticcall stor206.withdrawalFee(uint256 rg1, uint256 rg2) with:
                        gas gas_remaining wei
                       args arg1, depositedAt[msg.sender]
                mem[(6 * ceil32(return_data.size)) + 480] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                ...
                if ext_call.return_data[0] <= 1000:
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[(10 * ceil32(return_data.size)) + 480] = 30
                    mem[(10 * ceil32(return_data.size)) + 512] = 'SafeMath: subtraction overflow'
                    if ext_call.return_data[0] > ext_call.return_data[0]:
                        revert with 0, 'SafeMath: subtraction overflow', 0
                    mem[(10 * ceil32(return_data.size)) + 580] = msg.sender
                    mem[(10 * ceil32(return_data.size)) + 612] = 0
                    mem[(10 * ceil32(return_data.size)) + 544] = 68
                    mem[(10 * ceil32(return_data.size)) + 580 len 28] = Mask(224, 32, msg.sender) >> 32
                    mem[(10 * ceil32(return_data.size)) + 576 len 4] = unknown_0xa9059cbb(?????)
                    mem[(10 * ceil32(return_data.size)) + 644] = 32
                    mem[(10 * ceil32(return_data.size)) + 676] = 'SafeERC20: low-level call failed'
                    if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(0x6e84a6216ea6dacc71ee8e6b0a5b7322eebc0f):
                        revert with 0, 'Address: call to non-contract'
                    if not ext_code.hash(0x6e84a6216ea6dacc71ee8e6b0a5b7322eebc0f):
                        revert with 0, 'Address: call to non-contract'
                    mem[(10 * ceil32(return_data.size)) + 708 len 96] = unknown_0xa9059cbb(?????), msg.sender, 0, 0
                    mem[(10 * ceil32(return_data.size)) + 776] = 0
                    call 0x006e84a6216ea6dacc71ee8e6b0a5b7322eebc0f with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, 0, 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, unknown_0xa9059cbb(?????), msg.sender, 0, 0) << 288)
                    if not return_data.size:
                        ...
                        mem[(10 * ceil32(return_data.size)) + 740 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        if not ext_call.success:
                            if return_data.size:
                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 0, 'SafeERC20: low-level call failed'
                        if return_data.size:
                            require return_data.size >= 32
                            require mem[(10 * ceil32(return_data.size)) + 740] == bool(mem[(10 * ceil32(return_data.size)) + 740])
                            if not mem[(10 * ceil32(return_data.size)) + 740]:
                                revert with 0, 'SafeERC20: ERC20 operation did not succeed'
                    emit Withdrawn(arg1, ext_call.return_data[0], msg.sender);
                else:
                    call 0x57319d41f71e81f3c65f2a47ca4e001ebafd4f33.leave(uint256 rg1) with:
                         gas gas_remaining wei
                        args ext_call.return_data[0]
                    ...
                    if ext_call.return_data[0] > ext_call.return_data[0]:
                        revert with 0, 'SafeMath: subtraction overflow', 0
                    mem[(10 * ceil32(return_data.size)) + 644] = msg.sender
                    mem[(10 * ceil32(return_data.size)) + 676] = depositedAt[msg.sender]
                    require ext_code.size(stor206)
                    call stor206.mintFor(address rg1, uint256 rg2, uint256 rg3, address rg4, uint256 rg5) with:
                         gas gas_remaining wei
                        args 0x6e84a6216ea6dacc71ee8e6b0a5b7322eebc0f, 0, 0, msg.sender, depositedAt[msg.sender]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    mem[(10 * ceil32(return_data.size)) + 544] = 30
                    mem[(10 * ceil32(return_data.size)) + 576] = 'SafeMath: subtraction overflow'
                    if ext_call.return_data[0] > arg1:
                        revert with 0, 'SafeMath: subtraction overflow', 0
                    mem[(10 * ceil32(return_data.size)) + 612] = this.address
                    require ext_code.size(0xfe0000000000000000000000006e84a6216ea6dacc71ee8e6b0a5b7322eebc0f)
                    staticcall 0xfe0000000000000000000000006e84a6216ea6dacc71ee8e6b0a5b7322eebc0f.0x70a08231 with:
                            gas gas_remaining wei
                           args this.address
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    mem[(11 * ceil32(return_data.size)) + 612] = this.address
                    require ext_code.size(0xfe0000000000000000000000006e84a6216ea6dacc71ee8e6b0a5b7322eebc0f)
                    staticcall 0xfe0000000000000000000000006e84a6216ea6dacc71ee8e6b0a5b7322eebc0f.0x70a08231 with:
                            gas gas_remaining wei
                           args this.address
                    mem[(11 * ceil32(return_data.size)) + 608] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[(12 * ceil32(return_data.size)) + 608] = 30
                    mem[(12 * ceil32(return_data.size)) + 640] = 'SafeMath: subtraction overflow'
                    if ext_call.return_data[0] > ext_call.return_data[0]:
                        revert with 0, 'SafeMath: subtraction overflow', 0
                    mem[(12 * ceil32(return_data.size)) + 708] = msg.sender
                    mem[(12 * ceil32(return_data.size)) + 740] = 0
                    mem[(12 * ceil32(return_data.size)) + 672] = 68
                    mem[(12 * ceil32(return_data.size)) + 708 len 28] = Mask(224, 32, msg.sender) >> 32
                    mem[(12 * ceil32(return_data.size)) + 704 len 4] = unknown_0xa9059cbb(?????)
                    mem[(12 * ceil32(return_data.size)) + 772] = 32
                    mem[(12 * ceil32(return_data.size)) + 804] = 'SafeERC20: low-level call failed'
                    if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(0x6e84a6216ea6dacc71ee8e6b0a5b7322eebc0f):
                        revert with 0, 'Address: call to non-contract'
                    if not ext_code.hash(0x6e84a6216ea6dacc71ee8e6b0a5b7322eebc0f):
                        revert with 0, 'Address: call to non-contract'
                    mem[(12 * ceil32(return_data.size)) + 836 len 96] = unknown_0xa9059cbb(?????), msg.sender, 0, 0
                    mem[(12 * ceil32(return_data.size)) + 904] = 0
                    call 0x006e84a6216ea6dacc71ee8e6b0a5b7322eebc0f with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), msg.sender, 0, 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, unknown_0xa9059cbb(?????), msg.sender, 0, 0) << 288)
                    if not return_data.size:
                        ...
                        mem[(12 * ceil32(return_data.size)) + 868 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        if not ext_call.success:
                            if return_data.size:
                                revert with ext_call.return_data[0 len return_data.size]
                            revert with 0, 'SafeERC20: low-level call failed'
                        if return_data.size:
                            require return_data.size >= 32
                            require mem[(12 * ceil32(return_data.size)) + 868] == bool(mem[(12 * ceil32(return_data.size)) + 868])
                            if not mem[(12 * ceil32(return_data.size)) + 868]:
                                revert with 0, 'SafeERC20: ERC20 operation did not succeed'
                    emit Withdrawn(arg1 - ext_call.return_data[0], ext_call.return_data[0], msg.sender);
    else:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        mem[(2 * ceil32(return_data.size)) + 388] = principalOf[msg.sender]
        require ext_code.size(0xd6a4f121ca35509af06a0be99093d08462f53052)
        call 0xd6a4f121ca35509af06a0be99093d08462f53052.0x441a3e70 with:
             gas gas_remaining wei
            args 24, principalOf[msg.sender]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[(2 * ceil32(return_data.size)) + 356] = this.address
        require ext_code.size(0x57319d41f71e81f3c65f2a47ca4e001ebafd4f33)
        ...
        mem[(4 * ceil32(return_data.size)) + 352] = 30
        mem[(4 * ceil32(return_data.size)) + 384] = 'SafeMath: subtraction overflow'
        if principalOf[msg.sender] > ext_call.return_data[0]:
            revert with 0, 'SafeMath: subtraction overflow', 0
        mem[(4 * ceil32(return_data.size)) + 416] = 30
        mem[(4 * ceil32(return_data.size)) + 448] = 'SafeMath: subtraction overflow'
        if ext_call.return_data[0] > ext_call.return_data[0] - principalOf[msg.sender]:
            revert with 0, 'SafeMath: subtraction overflow', 0
        mem[(4 * ceil32(return_data.size)) + 484] = this.address
        if not stor206:
            require ext_code.size(0xfe0000000000000000000000006e84a6216ea6dacc71ee8e6b0a5b7322eebc0f)
            ...
            if not return_data.size:
                ...
                if return_data.size:
                    ...
                    if not mem[(7 * ceil32(return_data.size)) + 740]:
                        revert with 0, 'SafeERC20: ERC20 operation did not succeed'
            emit Withdrawn(principalOf[msg.sender], 0, msg.sender);
        else:
            require ext_code.size(stor206)
            staticcall stor206.isMinter(address rg1) with:
                    gas gas_remaining wei
            ...
            if not ext_call.return_data[0]:
                ...
                mem[(6 * ceil32(return_data.size)) + 484] = principalOf[msg.sender]
                mem[(6 * ceil32(return_data.size)) + 516] = depositedAt[msg.sender]
                require ext_code.size(stor206)
                staticcall stor206.withdrawalFee(uint256 rg1, uint256 rg2) with:
                        gas gas_remaining wei
                       args principalOf[msg.sender], depositedAt[msg.sender]
                mem[(6 * ceil32(return_data.size)) + 480] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                ...
                if ext_call.return_data[0] <= 1000:
                    ...
                    if not return_data.size:
                        ...
                        if return_data.size:
                            ...
                            if not mem[(10 * ceil32(return_data.size)) + 740]:
                                revert with 0, 'SafeERC20: ERC20 operation did not succeed'
                    emit Withdrawn(principalOf[msg.sender], ext_call.return_data[0], msg.sender);
                else:
                    call 0x57319d41f71e81f3c65f2a47ca4e001ebafd4f33.leave(uint256 rg1) with:
                         gas gas_remaining wei
                        args ext_call.return_data[0]
                    ...
                    mem[(10 * ceil32(return_data.size)) + 544] = 30
                    mem[(10 * ceil32(return_data.size)) + 576] = 'SafeMath: subtraction overflow'
                    if ext_call.return_data[0] > principalOf[msg.sender]:
                        revert with 0, 'SafeMath: subtraction overflow', 0
                    mem[(10 * ceil32(return_data.size)) + 612] = this.address
                    require ext_code.size(0xfe0000000000000000000000006e84a6216ea6dacc71ee8e6b0a5b7322eebc0f)
                    staticcall 0xfe0000000000000000000000006e84a6216ea6dacc71ee8e6b0a5b7322eebc0f.0x70a08231 with:
                    ...
                    call 0x57319d41f71e81f3c65f2a47ca4e001ebafd4f33.leave(uint256 rg1) with:
                         gas gas_remaining wei
                        args (principalOf[msg.sender] - ext_call.return_data[0])
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    mem[(11 * ceil32(return_data.size)) + 612] = this.address
                    require ext_code.size(0xfe0000000000000000000000006e84a6216ea6dacc71ee8e6b0a5b7322eebc0f)
                    ...
                    if not return_data.size:
                        ...
                        if return_data.size:
                            ...
                            if not mem[(12 * ceil32(return_data.size)) + 868]:
                                revert with 0, 'SafeERC20: ERC20 operation did not succeed'
                    emit Withdrawn(principalOf[msg.sender] - ext_call.return_data[0], ext_call.return_data[0], msg.sender);
    require ext_code.size(0xfe0000000000000000000000006e84a6216ea6dacc71ee8e6b0a5b7322eebc0f)
    staticcall 0xfe0000000000000000000000006e84a6216ea6dacc71ee8e6b0a5b7322eebc0f.0x70a08231 with:
            gas gas_remaining wei
           args this.address
