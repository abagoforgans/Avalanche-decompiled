...
const masterchef = 0x574d3245e36cf8c9dc86430eadb0fdb2f385f829
...
function panic() payable {
    ...
    Mask(96, 0, stor0.field_160) = 1
    emit Paused(msg.sender);
    require ext_code.size(0x574d3245e36cf8c9dc86430eadb0fdb2f385f829)
    call 0x574d3245e36cf8c9dc86430eadb0fdb2f385f829.exit() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
...
function balanceOf() payable {
    require ext_code.size(0x574d3245e36cf8c9dc86430eadb0fdb2f385f829)
    staticcall 0x574d3245e36cf8c9dc86430eadb0fdb2f385f829.balanceOf(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        ...
        mem[260 len 64] = approve(address rg1, uint256 rg2), 0x574d3245e36cf8c9dc86430e, 0, 0
        call lpPairAddress.0xf385f829 with:
             gas gas_remaining wei
            args 0, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address rg1, uint256 rg2), 0x574d3245e36cf8c9dc86430e, 0, 0
            if not approve(address rg1, uint256 rg2), 0x574d3245e36cf8c9dc86430e:
                revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
            if not ext_call.return_data[0]:
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[424 len 64] = approve(address rg1, uint256 rg2), 0x574d3245e36cf8c9dc86430e, 0, ext_call.return_data[0 len 28]
            else:
                require ext_code.size(lpPairAddress)
                staticcall lpPairAddress.allowance(address rg1, address rg2) with:
                        gas gas_remaining wei
                       args address(this.address), 0x574d3245e36cf8c9dc86430eadb0fdb2f385f829
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
            ...
            require ext_code.size(0x574d3245e36cf8c9dc86430eadb0fdb2f385f829)
            call 0x574d3245e36cf8c9dc86430eadb0fdb2f385f829.stake(uint256 rg1) with:
                 gas gas_remaining wei
            ...
            if return_data.size <= 0:
                if not ext_call.return_data[0]:
                    if ext_code.size(lpPairAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 425 len 64] = approve(address rg1, uint256 rg2), 0x574d3245e36cf8c9dc86430e, 0, ext_call.return_data[0 len 28]
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] >= arg1:
        if ext_call.return_data[0] <= arg1:
            if not ext_call.return_data[0]:
                ...
                if return_data.size <= 0:
                    ...
                    if ext_code.size(lpPairAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 553 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), ext_call.return_data[0 len 28]
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 553 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, ext_call.return_data[0] - (50 * ext_call.return_data[0] / 10000)) >> 32
                call lpPairAddress with:
                   funct uint32(stor4)
                     gas gas_remaining wei
            ...
            if not arg1:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 553 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, arg1 - (50 * arg1 / 10000)) >> 32
                call lpPairAddress with:
                   funct uint32(stor4)
                     gas gas_remaining wei
        ...
        if ext_call.return_data[0] > arg1:
            revert with 0, 'SafeMath: subtraction overflow'
        require ext_code.size(0x574d3245e36cf8c9dc86430eadb0fdb2f385f829)
        call 0x574d3245e36cf8c9dc86430eadb0fdb2f385f829.0x2e1a7d4d with:
             gas gas_remaining wei
        ...
        if ext_call.return_data[0] > arg1:
            if not arg1:
                ...
                if return_data.size <= 0:
                    ...
                    if ext_code.size(lpPairAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 617 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, arg1 - (50 * arg1 / 10000)) >> 32
            ...
            if not ext_call.return_data[0]:
                ...
                if ext_code.size(lpPairAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 617 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), ext_call.return_data[0 len 28]
                call lpPairAddress with:
                   funct uint32(stor4)
                     gas gas_remaining wei
                ...
                if return_data.size <= 0:
                    ...
                    if ext_code.size(lpPairAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 617 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor4), uint32(stor4), Mask(224, 32, ext_call.return_data[0] - (50 * ext_call.return_data[0] / 10000)) >> 32
                    call lpPairAddress with:
                       funct uint32(stor4)
                         gas gas_remaining wei
