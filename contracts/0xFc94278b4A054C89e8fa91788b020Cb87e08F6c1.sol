...
const sub_33623794(?) = 0xd80792e3eb0d8e36fb8df90c1b440bd5899a014a
...
function sub_712c4dd4(?) payable {
    require ext_code.size(0xd80792e3eb0d8e36fb8df90c1b440bd5899a014a)
    staticcall 0xd80792e3eb0d8e36fb8df90c1b440bd5899a014a.0x72f702f3 with:
    ...
    require return_data.size >= 32
    require ext_code.size(0xd80792e3eb0d8e36fb8df90c1b440bd5899a014a)
    staticcall 0xd80792e3eb0d8e36fb8df90c1b440bd5899a014a.0x18160ddd with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(sha3(0, 17269419903419772280, sha3(8712802085545782520, 0x8b1d98a91f853218ddbb066f20b8c63e782e2430), 0x40231f6b438bce0797c9ada29b718a87ea0a5cea3fe9a771abdd76bd41a3e545)))
    staticcall address(sha3(0, 17269419903419772280, sha3(8712802085545782520, 0x8b1d98a91f853218ddbb066f20b8c63e782e2430), 0x40231f6b438bce0797c9ada29b718a87ea0a5cea3fe9a771abdd76bd41a3e545)).getReserves() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
