...
const getName = 'AvaxSnobLp'

const revenueShareMax = 10000

const snob = 0xc38f41a296a4493ff429f1238e030924a1542e
...
uint256 poolId;
uint256 avax_snob_poolId;
address joe_avax_snob_lpAddress;
...
function joe_avax_snob_lp() {
    return joe_avax_snob_lpAddress
}
...
function avax_snob_poolId() {
    return avax_snob_poolId
}
    ...
    if ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            if not ext_call.return_data[0]:
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[424 len 64] = approve(address arg1, uint256 arg2), 0x188bed1968b795d5c9022f6a, 0, ext_call.return_data[0 len 28]
                mem[488 len 0] = 0
            else:
                require ext_code.size(wantAddress)
            ...
            if not return_data.size:
                if not ext_call.return_data[0]:
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 425 len 64] = approve(address arg1, uint256 arg2), 0x188bed1968b795d5c9022f6a, 0, ext_call.return_data[0 len 28]
