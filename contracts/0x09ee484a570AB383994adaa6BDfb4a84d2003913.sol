...
function deposit(uint256 arg1, uint256 arg2, address arg3) payable {
    ...
    if stor4[address(msg.sender)]:
        mem[196 len 96] = 1204246998, arg1, arg2, mem[196 len 28]
        delegate stor6.mem[196 len 4] with:
             gas gas_remaining wei
            args mem[200 len 64]
        if not return_data.size:
            emit 0x9c6327fb: msg.sender, address(arg3), arg2, 160, bool(delegate.return_code), 68, 1204246998, arg1, arg2, Mask(224, 32, msg.sender) >> 32 >> 288, 0
        else:
            emit 0x9c6327fb: msg.sender, address(arg3), arg2, Array(len=return_data.size, data=ext_call.return_data[0 len return_data.size]), bool(delegate.return_code)
    else:
        ...
        mem[228] = arg2
        mem[160] = 68
        mem[196 len 28] = Mask(224, 32, arg1) >> 32
        mem[192 len 4] = 1204246998
        mem[260 len 96] = 1204246998, arg1, arg2, mem[260 len 28]
        delegate stor6.mem[260 len 4] with:
             gas gas_remaining wei
            args mem[264 len 64]
        if return_data.size:
            emit 0x9c6327fb: msg.sender, address(arg3), arg2, Array(len=return_data.size, data=ext_call.return_data[0 len return_data.size]), bool(delegate.return_code)
            ...
            mem[356] = 160
            mem[420] = msg.sender
            mem[452 len ceil32(msg.sender)] = mem[128 len ceil32(msg.sender)]
            if ceil32(msg.sender) > msg.sender:
                mem[msg.sender + 452] = 0
            emit 0x9c6327fb: msg.sender, address(arg3), arg2, Array(len=msg.sender, data=mem[452 len ceil32(msg.sender)]), bool(delegate.return_code)
