...
function sub_73f9571d(?) payable {
        ...
        if idx:
            ...
            if not ext_call.success:
                if idx - 1:
                    ...
                    staticcall 0xe54ca86531e17ef3616d22ca28b0d458b6c89106.getAmountsOut(uint256 arg1, address[] arg2) with:
                            gas gas_remaining wei
                           args arg3 / arg4, 64, mem[mem[64] + 68 len (32 * _134) + 32]
                    if not ext_call.success:
                        if idx >= 2:
                            revert with 'NH{q', 50
                        mem[(32 * idx) + 96] = 0
                ...
                if idx - 1:
                    ...
                    staticcall 0xe54ca86531e17ef3616d22ca28b0d458b6c89106.getAmountsOut(uint256 arg1, address[] arg2) with:
                            gas gas_remaining wei
                           args arg3 / arg4, 64, mem[mem[64] + 68 len (32 * _471) + 32]
                    if not ext_call.success:
                        if idx >= 2:
                            revert with 'NH{q', 50
                        mem[(32 * idx) + 96] = 0
    ...
    while idx < arg4:
        ...
        if not arg3:
            ...
            staticcall 0xe54ca86531e17ef3616d22ca28b0d458b6c89106.getAmountsOut(uint256 arg1, address[] arg2) with:
                    gas gas_remaining wei
                   args 0 / arg4, 64, mem[mem[64] + 68 len (32 * _1107) + 32]
            if not ext_call.success:
                if u >= 2:
                    revert with 'NH{q', 50
                if u >= 2:
        ...
        if not ext_call.success:
            ...
            staticcall 0xe54ca86531e17ef3616d22ca28b0d458b6c89106.getAmountsOut(uint256 arg1, address[] arg2) with:
                    gas gas_remaining wei
                   args arg3 + (_511 * arg3) / arg4, 64, mem[mem[64] + 68 len (32 * _850) + 32]
            if not ext_call.success:
                if u >= 2:
                    revert with 'NH{q', 50
                if u >= 2:
        ...
        if idx:
            ...
            if not ext_call.success:
                ...
                if idx - 1:
                    ...
                    staticcall 0xe54ca86531e17ef3616d22ca28b0d458b6c89106.getAmountsOut(uint256 arg1, address[] arg2) with:
                            gas gas_remaining wei
                           args arg3 / 100, 64, mem[mem[64] + 68 len (32 * _443) + 32]
                    if not ext_call.success:
                        if idx >= 2:
                            revert with 'NH{q', 50
                        mem[(32 * idx) + 96] = 0
    ...
    while idx < 100:
        ...
        if not arg3:
            ...
            if not ext_call.success:
                ...
                staticcall 0xe54ca86531e17ef3616d22ca28b0d458b6c89106.getAmountsOut(uint256 arg1, address[] arg2) with:
                        gas gas_remaining wei
                       args 0, 64, mem[mem[64] + 68 len (32 * _916) + 32]
                if not ext_call.success:
                    if u >= 2:
                        revert with 'NH{q', 50
                    if u >= 2:
            ...
            staticcall 0xe54ca86531e17ef3616d22ca28b0d458b6c89106.getAmountsOut(uint256 arg1, address[] arg2) with:
                    gas gas_remaining wei
                   args 0, 64, mem[mem[64] + 68 len (32 * _1496) + 32]
            if not ext_call.success:
                if u >= 2:
                    revert with 'NH{q', 50
                if u >= 2:
        ...
        if u:
            ...
            mem[_559 + 100] = arg3 + (_508 * arg3) / 100
            mem[_559 + 132] = 64
        ...
        if not ext_call.success:
            ...
            _887 = mem[64]
            mem[mem[64]] = 0xd06ca61f00000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = arg3 + (_508 * arg3) / 100
            mem[mem[64] + 36] = 64
            _914 = mem[_559]
        ...
        if t:
            ...
            if not ext_call.success:
                if t - 1:
                    ...
                    staticcall 0xe54ca86531e17ef3616d22ca28b0d458b6c89106.getAmountsOut(uint256 arg1, address[] arg2) with:
                            gas gas_remaining wei
                           args s / 100, 64, mem[mem[64] + 68 len (32 * _912) + 32]
                    if not ext_call.success:
                        if t >= 2:
                            revert with 'NH{q', 50
                        mem[(32 * t) + _419] = 0
                ...
                if t - 1:
                    ...
                    staticcall 0xe54ca86531e17ef3616d22ca28b0d458b6c89106.getAmountsOut(uint256 arg1, address[] arg2) with:
                            gas gas_remaining wei
                           args s / 100, 64, mem[mem[64] + 68 len (32 * _1492) + 32]
                    if not ext_call.success:
                        if t >= 2:
                            revert with 'NH{q', 50
                        mem[(32 * t) + _419] = 0
    ...
    while t < 100:
        ...
        if not s:
            ...
            if not ext_call.success:
                ...
                staticcall 0xe54ca86531e17ef3616d22ca28b0d458b6c89106.getAmountsOut(uint256 arg1, address[] arg2) with:
                        gas gas_remaining wei
                       args 0, 64, mem[mem[64] + 68 len (32 * _2063) + 32]
                if not ext_call.success:
                    if w >= 2:
                        revert with 'NH{q', 50
                    if w >= 2:
            ...
            staticcall 0xe54ca86531e17ef3616d22ca28b0d458b6c89106.getAmountsOut(uint256 arg1, address[] arg2) with:
                    gas gas_remaining wei
                   args 0, 64, mem[mem[64] + 68 len (32 * _2340) + 32]
            if not ext_call.success:
                if w >= 2:
                    revert with 'NH{q', 50
                if w >= 2:
        ...
        if not ext_call.success:
            ...
            staticcall 0xe54ca86531e17ef3616d22ca28b0d458b6c89106.getAmountsOut(uint256 arg1, address[] arg2) with:
                    gas gas_remaining wei
                   args s + (_1684 * s) / 100, 64, mem[mem[64] + 68 len (32 * _2061) + 32]
            if not ext_call.success:
                if w >= 2:
                    revert with 'NH{q', 50
                if w >= 2:
