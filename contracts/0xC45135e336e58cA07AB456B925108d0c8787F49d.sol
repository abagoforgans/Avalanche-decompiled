    ...
    if not ('cd', 36).length:
        ...
        if not ('cd', 36).length:
            ...
            while idx < ('cd', 36).length:
                ...
                if address(_1178) == mem[140 len 20]:
                    ...
                    if address(cd[((32 * idx) + cd[132] + 36)]) < address(cd[((32 * idx + 1) + cd[132] + 36)]):
                        ...
                        if not mem[(32 * idx) + mem[_1158 + 64] + 32]:
                            ...
                            call address(cd[((32 * idx) + cd[68] + 36)]).mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _2586 + (32 * mem[96]) + -mem[64] + 288]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if idx == -1:
                                revert with 'NH{q', 17
            ...
            while idx < ('cd', 36).length:
                ...
                if 997 * s / 997 != s:
                    revert with 0, 'ds-math-mul-overflow'
                if address(_1179) == mem[140 len 20]:
                    if not ext_call.return_data[50 len 14]:
                        if ext_call.return_data[18 len 14] and 1000 > -1 / ext_call.return_data[18 len 14]:
                            revert with 'NH{q', 17
                        if 1000 * ext_call.return_data[18 len 14] / 1000 != ext_call.return_data[18 len 14]:
                ...
                if address(cd[((32 * idx) + cd[132] + 36)]) < address(cd[((32 * idx + 1) + cd[132] + 36)]):
                    ...
                    if address(cd[((32 * idx) + cd[132] + 36)]) < address(cd[((32 * idx + 1) + cd[132] + 36)]):
                        ...
                        if not mem[(32 * idx) + mem[_1160 + 64] + 32]:
                            ...
                            call address(cd[((32 * idx) + cd[68] + 36)]).mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _2587 + (32 * mem[96]) + -mem[64] + 288]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if idx == -1:
                                revert with 'NH{q', 17
        ...
        if not ('cd', 36).length:
            ...
            while idx < ('cd', 36).length:
                ...
                if 997 * s / 997 != s:
                    revert with 0, 'ds-math-mul-overflow'
                if address(_1180) == mem[140 len 20]:
                    if not ext_call.return_data[50 len 14]:
                        if ext_call.return_data[18 len 14] and 1000 > -1 / ext_call.return_data[18 len 14]:
                            revert with 'NH{q', 17
                        if 1000 * ext_call.return_data[18 len 14] / 1000 != ext_call.return_data[18 len 14]:
                ...
                if address(cd[((32 * idx) + cd[132] + 36)]) < address(cd[((32 * idx + 1) + cd[132] + 36)]):
                    ...
                    if address(cd[((32 * idx) + cd[132] + 36)]) < address(cd[((32 * idx + 1) + cd[132] + 36)]):
                        ...
                        if not mem[(32 * idx) + mem[_1162 + 64] + 32]:
                            ...
                            call address(cd[((32 * idx) + cd[68] + 36)]).mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _2588 + (32 * mem[96]) + -mem[64] + 288]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if idx == -1:
                                revert with 'NH{q', 17
            ...
            while idx < ('cd', 36).length:
                ...
                if 997 * s / 997 != s:
                    revert with 0, 'ds-math-mul-overflow'
                if address(_1181) == mem[140 len 20]:
                    if not ext_call.return_data[50 len 14]:
                        if ext_call.return_data[18 len 14] and 1000 > -1 / ext_call.return_data[18 len 14]:
                            revert with 'NH{q', 17
                        if 1000 * ext_call.return_data[18 len 14] / 1000 != ext_call.return_data[18 len 14]:
                ...
                if address(cd[((32 * idx) + cd[132] + 36)]) < address(cd[((32 * idx + 1) + cd[132] + 36)]):
                    ...
                    if address(cd[((32 * idx) + cd[132] + 36)]) < address(cd[((32 * idx + 1) + cd[132] + 36)]):
                        ...
                        if not mem[(32 * idx) + mem[_1164 + 64] + 32]:
                            ...
                            call address(cd[((32 * idx) + cd[68] + 36)]).mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _2589 + (32 * mem[96]) + -mem[64] + 288]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if idx == -1:
                                revert with 'NH{q', 17
