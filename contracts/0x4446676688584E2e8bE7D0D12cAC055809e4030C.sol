...
function mint(uint256 arg1) payable {
    ...
    if uint8(stor5.field_160):
        revert with 0, 'Minting permanently disabled!'
    if not msg.sender:
...
function transferMulti(address[] arg1, uint256[] arg2) payable {
    ...
    if arg1.length != arg2.length:
        revert with 0, 'Inputs must have same size!'
    idx = 0
    while idx < arg1.length:
        if idx >= mem[96]:
            revert with 'NH{q', 50
        ...
        if idx >= mem[floor32(arg1.length) + 97]:
            revert with 'NH{q', 50
        _68 = mem[(32 * idx) + floor32(arg1.length) + 129]
        if not msg.sender:
        ...
        mem[floor32(arg1.length) + floor32(arg2.length) + 98] = mem[(32 * idx) + floor32(arg1.length) + 129]
        emit Transfer(_68, msg.sender, address(_66));
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
