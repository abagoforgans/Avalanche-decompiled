...
function sub_10c8af80(?) payable {
    ...
    while idx < ('cd', 100).length:
        ...
        mem[_74 + 132] = block.timestamp + 60
        ...
        s = 0
        t = _98 + _99 + 32
        u = _98 + ceil32(return_data.size) + 32
        while s < _100:
            require mem[t] == mem[t]
            mem[u] = mem[t]
            s = s + 1
    ...
    require mem[_72 + 32] == mem[_72 + 32]
    require mem[_72 + 64] == mem[_72 + 92 len 4]
    require mem[_72 + 96] == mem[_72 + 124 len 4]
    mem[mem[64] + 4] = _57
    mem[mem[64] + 36] = _66
...
function sub_14535932(?) payable {
    ...
    if address(ext_call.return_data[0]) != address(cd[36]):
        ...
        while idx < ('cd', 100).length:
            ...
            require address(cd[((32 * cd[(cd[100] + cd[(cd[100] + (32 * idx) + 36)] + 36)] - 1) + cd[100] + cd[(cd[100] + (32 * idx) + 36)] + 68)])
            mem[mem[64] + 4] = address(cd[((32 * idx) + cd[68] + 36)])
            mem[mem[64] + 36] = (997 * (997 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0])) * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1997 * Mask(112, 0, ext_call.return_data[0])) * (997 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0])) * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * (997 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0])) * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1997 * Mask(112, 0, ext_call.return_data[0]))
            require ext_code.size(stor0)
            call stor0.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args address(cd[((32 * idx) + cd[68] + 36)]), (997 * (997 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0])) * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1997 * Mask(112, 0, ext_call.return_data[0])) * (997 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0])) * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * (997 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0])) * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1997 * Mask(112, 0, ext_call.return_data[0]))
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _232 = mem[64]
            ...
            _246 = mem[64]
            mem[mem[64]] = 0x38ed173900000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = (997 * (997 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0])) * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1997 * Mask(112, 0, ext_call.return_data[0])) * (997 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0])) * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * (997 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0])) * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[0]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1997 * Mask(112, 0, ext_call.return_data[0]))) + (1997 * Mask(112, 0, ext_call.return_data[0]))
            mem[mem[64] + 36] = 0
            mem[mem[64] + 68] = 160
            mem[mem[64] + 164] = cd[(cd[100] + cd[(cd[100] + (32 * idx) + 36)] + 36)]
            s = 0
            ...
            mem[_246 + 132] = block.timestamp + 60
            require ext_code.size(address(cd[((32 * idx) + cd[68] + 36)]))
            call address(cd[((32 * idx) + cd[68] + 36)]).mem[mem[64] len 4] with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len u + -mem[64] - 4]
            ...
            mem[_328 + ceil32(return_data.size)] = _339
            require _333 + (32 * _339) + 32 <= return_data.size
            s = 0
            t = _328 + _333 + 32
        ...
        call address(cd[132]).addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
             gas gas_remaining wei
            args stor0, address(cd[36]), _216, _204, 0, 0, address(this.address), block.timestamp + 60
        mem[mem[64] len 96] = ext_call.return_data[0 len 96]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _282 = mem[64]
        ...
        require mem[_282 + 32] == mem[_282 + 32]
        require mem[_282 + 64] == mem[_282 + 64]
        mem[mem[64] + 4] = this.address
        require ext_code.size(address(cd[164]))
        ...
        _357 = mem[_351]
        require mem[_351] == mem[_351]
        require mem[_351 + 32] == mem[_351 + 32]
        require mem[_351 + 64] == mem[_351 + 92 len 4]
        require mem[_351 + 96] == mem[_351 + 124 len 4]
        mem[mem[64] + 4] = _303
        mem[mem[64] + 36] = _336
        mem[mem[64] + 68] = msg.sender
        require ext_code.size(address(cd[196]))
        ...
        require mem[_387 + 96] == mem[_387 + 124 len 4]
        if mem[_387] < _357:
            revert with 'NH{q', 17
        mem[mem[64]] = mem[_387] - _357
    else:
        if ext_call.return_data[12 len 20] == stor0:
            ...
            while idx < ('cd', 100).length:
                ...
                require address(cd[((32 * cd[(cd[100] + cd[(cd[100] + (32 * idx) + 36)] + 36)] - 1) + cd[100] + cd[(cd[100] + (32 * idx) + 36)] + 68)])
                mem[mem[64] + 4] = address(cd[((32 * idx) + cd[68] + 36)])
                mem[mem[64] + 36] = (997 * (997 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32])) * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1997 * Mask(112, 0, ext_call.return_data[32])) * (997 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32])) * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * (997 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32])) * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1997 * Mask(112, 0, ext_call.return_data[32]))
                require ext_code.size(stor0)
                call stor0.approve(address arg1, uint256 arg2) with:
                     gas gas_remaining wei
                    args address(cd[((32 * idx) + cd[68] + 36)]), (997 * (997 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32])) * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1997 * Mask(112, 0, ext_call.return_data[32])) * (997 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32])) * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * (997 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32])) * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1997 * Mask(112, 0, ext_call.return_data[32]))
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _236 = mem[64]
                ...
                _248 = mem[64]
                mem[mem[64]] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                mem[mem[64] + 4] = (997 * (997 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32])) * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1997 * Mask(112, 0, ext_call.return_data[32])) * (997 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32])) * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * (997 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32])) * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * (997 * cd[4] / 2 * cd[4] / 2) + (1000 * Mask(112, 0, ext_call.return_data[32]) * cd[4]) / (1994 * cd[4] / 2) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1997 * Mask(112, 0, ext_call.return_data[32]))) + (1997 * Mask(112, 0, ext_call.return_data[32]))
                mem[mem[64] + 36] = 0
                mem[mem[64] + 68] = 160
                mem[mem[64] + 164] = cd[(cd[100] + cd[(cd[100] + (32 * idx) + 36)] + 36)]
                s = 0
                ...
                while s < cd[(cd[100] + cd[(cd[100] + (32 * idx) + 36)] + 36)]:
                    ...
                    u = u + 32
                    continue 
                mem[_248 + 100] = this.address
                mem[_248 + 132] = block.timestamp + 60
                require ext_code.size(address(cd[((32 * idx) + cd[68] + 36)]))
                call address(cd[((32 * idx) + cd[68] + 36)]).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len u + -mem[64] - 4]
                ...
                mem[_332 + ceil32(return_data.size)] = _341
                require _335 + (32 * _341) + 32 <= return_data.size
                s = 0
                t = _332 + _335 + 32
                u = _332 + ceil32(return_data.size) + 32
                while s < _341:
                    require mem[t] == mem[t]
                    mem[u] = mem[t]
                    s = s + 1
            ...
            call address(cd[132]).addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
                 gas gas_remaining wei
                args stor0, address(cd[36]), _218, _206, 0, 0, address(this.address), block.timestamp + 60
            mem[mem[64] len 96] = ext_call.return_data[0 len 96]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _284 = mem[64]
            ...
            require mem[_284 + 64] == mem[_284 + 64]
            mem[mem[64] + 4] = this.address
            require ext_code.size(address(cd[164]))
            staticcall address(cd[164]).0x70a08231 with:
                    gas gas_remaining wei
            ...
            require mem[_389 + 64] == mem[_389 + 92 len 4]
            require mem[_389 + 96] == mem[_389 + 124 len 4]
            if mem[_389] < _359:
                revert with 'NH{q', 17
            mem[mem[64]] = mem[_389] - _359
        else:
            if ext_call.return_data[12 len 20] != address(cd[36]):
                revert with 0, 'bad LP token'
            if address(ext_call.return_data[0]) != stor0:
            ...
            while idx < ('cd', 100).length:
                ...
                while s < cd[(cd[100] + cd[(cd[100] + (32 * idx) + 36)] + 36)]:
                    ...
                    u = u + 32
                    continue 
                mem[_247 + 100] = this.address
                mem[_247 + 132] = block.timestamp + 60
                require ext_code.size(address(cd[((32 * idx) + cd[68] + 36)]))
                call address(cd[((32 * idx) + cd[68] + 36)]).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len u + -mem[64] - 4]
                ...
                mem[_330 + ceil32(return_data.size)] = _340
                require _334 + (32 * _340) + 32 <= return_data.size
                s = 0
                t = _330 + _334 + 32
                u = _330 + ceil32(return_data.size) + 32
                while s < _340:
                    require mem[t] == mem[t]
                    mem[u] = mem[t]
                    s = s + 1
            ...
            call address(cd[132]).addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
                 gas gas_remaining wei
                args stor0, address(cd[36]), _217, _205, 0, 0, address(this.address), block.timestamp + 60
            mem[mem[64] len 96] = ext_call.return_data[0 len 96]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _283 = mem[64]
            ...
            require mem[_283 + 32] == mem[_283 + 32]
            require mem[_283 + 64] == mem[_283 + 64]
            mem[mem[64] + 4] = this.address
            require ext_code.size(address(cd[164]))
            staticcall address(cd[164]).0x70a08231 with:
                    gas gas_remaining wei
            ...
            require mem[_388 + 96] == mem[_388 + 124 len 4]
            if mem[_388] < _358:
                revert with 'NH{q', 17
            mem[mem[64]] = mem[_388] - _358
    return memory
      from mem[64]
       len 32
}
    ...
    if address(ext_call.return_data[0]) != address(cd[36]):
        ...
        while idx < ('cd', 100).length:
            ...
            while s < cd[(cd[100] + cd[(cd[100] + (32 * idx) + 36)] + 36)]:
                ...
                u = u + 32
                continue 
            mem[_239 + 100] = this.address
            mem[_239 + 132] = block.timestamp + 60
            require ext_code.size(address(cd[((32 * idx) + cd[68] + 36)]))
            call address(cd[((32 * idx) + cd[68] + 36)]).mem[mem[64] len 4] with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len u + -mem[64] - 4]
            ...
            _332 = mem[_321 + mem[_321]]
            if mem[_321 + mem[_321]] > test266151307():
                revert with 'NH{q', 65
            if _321 + ceil32(return_data.size) + floor32(mem[_321 + mem[_321]]) + 1 > test266151307() or floor32(mem[_321 + mem[_321]]) + 1 < 0:
                revert with 'NH{q', 65
            mem[64] = _321 + ceil32(return_data.size) + floor32(mem[_321 + mem[_321]]) + 1
            mem[_321 + ceil32(return_data.size)] = _332
            require _326 + (32 * _332) + 32 <= return_data.size
            s = 0
            t = _321 + _326 + 32
            u = _321 + ceil32(return_data.size) + 32
            while s < _332:
                require mem[t] == mem[t]
                mem[u] = mem[t]
                s = s + 1
        ...
        call address(cd[132]).addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
             gas gas_remaining wei
            args stor0, address(cd[36]), _209, _197, 0, 0, address(this.address), block.timestamp + 60
        mem[mem[64] len 96] = ext_call.return_data[0 len 96]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _275 = mem[64]
        ...
        require mem[_275 + 32] == mem[_275 + 32]
        ...
        require mem[_344 + 64] == mem[_344 + 92 len 4]
        require mem[_344 + 96] == mem[_344 + 124 len 4]
        mem[mem[64] + 4] = _296
        mem[mem[64] + 36] = _329
        mem[mem[64] + 68] = msg.sender
        require ext_code.size(address(cd[196]))
        ...
        if ext_call.return_data[12 len 20] == stor0:
            ...
            while idx < ('cd', 100).length:
                ...
                while s < cd[(cd[100] + cd[(cd[100] + (32 * idx) + 36)] + 36)]:
                    ...
                    u = u + 32
                    continue 
                mem[_241 + 100] = this.address
                mem[_241 + 132] = block.timestamp + 60
                require ext_code.size(address(cd[((32 * idx) + cd[68] + 36)]))
                call address(cd[((32 * idx) + cd[68] + 36)]).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len u + -mem[64] - 4]
                ...
                require _328 + (32 * _334) + 32 <= return_data.size
                s = 0
                t = _325 + _328 + 32
                u = _325 + ceil32(return_data.size) + 32
                while s < _334:
                    require mem[t] == mem[t]
                    mem[u] = mem[t]
                    s = s + 1
            ...
            call address(cd[132]).addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
                 gas gas_remaining wei
                args stor0, address(cd[36]), _211, _199, 0, 0, address(this.address), block.timestamp + 60
            mem[mem[64] len 96] = ext_call.return_data[0 len 96]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _277 = mem[64]
            ...
            require return_data.size >= 96
            require mem[_277] == mem[_277]
            require mem[_277 + 32] == mem[_277 + 32]
            require mem[_277 + 64] == mem[_277 + 64]
            mem[mem[64] + 4] = this.address
            require ext_code.size(address(cd[164]))
            staticcall address(cd[164]).0x70a08231 with:
                    gas gas_remaining wei
            ...
            while idx < ('cd', 100).length:
                ...
                while s < cd[(cd[100] + cd[(cd[100] + (32 * idx) + 36)] + 36)]:
                    ...
                    u = u + 32
                    continue 
                mem[_240 + 100] = this.address
                mem[_240 + 132] = block.timestamp + 60
                require ext_code.size(address(cd[((32 * idx) + cd[68] + 36)]))
                call address(cd[((32 * idx) + cd[68] + 36)]).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len u + -mem[64] - 4]
                ...
                mem[_323 + ceil32(return_data.size)] = _333
                require _327 + (32 * _333) + 32 <= return_data.size
                s = 0
                t = _323 + _327 + 32
                u = _323 + ceil32(return_data.size) + 32
                while s < _333:
                    require mem[t] == mem[t]
                    mem[u] = mem[t]
                    s = s + 1
            ...
            call address(cd[132]).addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
                 gas gas_remaining wei
                args stor0, address(cd[36]), _210, _198, 0, 0, address(this.address), block.timestamp + 60
            mem[mem[64] len 96] = ext_call.return_data[0 len 96]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _276 = mem[64]
            ...
            require mem[_276 + 64] == mem[_276 + 64]
            mem[mem[64] + 4] = this.address
            require ext_code.size(address(cd[164]))
            staticcall address(cd[164]).0x70a08231 with:
                    gas gas_remaining wei
