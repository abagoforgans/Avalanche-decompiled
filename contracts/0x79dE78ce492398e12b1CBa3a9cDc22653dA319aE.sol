...
function randomValueCreated(uint256 arg1, uint256 arg2) payable {
    ...
    if not arg2:
        ...
        pendingWithdrawAmount[stor0[arg1].field_0] += 175 * 10^17
        emit 0xa4b93897: 175 * 10^17, stor0[arg1].field_0, sub_9656b7d8, 0
        vaultAmount += 5 * 10^17
        sub_5e370784 = 0
        stor0.length = 0
        idx = 0
