...
function sub_b05dba96(?) payable {
    ...
    call stor3.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 0xa0965825774a73c6009f77dea230123b5f0cf240, -1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    ...
    call stor4.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 0x7e4939ca7847ae3ff9501b27470dcd0a69f54fa6, -1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
...
function sub_ad760032(?) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    mem[128] = 0xa5b0f5ef809fd04c9d4320211c711cb34ef812dd
...
function sub_6ee141ff(?) payable {
    ...
    mem[(2 * ceil32(return_data.size)) + 160] = 0xa5b0f5ef809fd04c9d4320211c711cb34ef812dd
    ...
    call stor1.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args arg1, arg2, Array(len=2, data=mem[(2 * ceil32(return_data.size)) + 388 len 64]), address(this.address), arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(2 * ceil32(return_data.size)) + 192 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = (4 * ceil32(return_data.size)) + 192
    require return_data.size >= 32
    _35 = mem[(2 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg1) >> 32
    ...
    _36 = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg1) >> 32 + 192]
    if mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg1) >> 32 + 192] > test266151307():
        revert with 'NH{q', 65
    if (4 * ceil32(return_data.size)) + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg1) >> 32 + 192]) + 224 > test266151307() or (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg1) >> 32 + 192]) + 32 < 0:
        revert with 'NH{q', 65
    ...
    mem[(4 * ceil32(return_data.size)) + 192] = _36
    require _35 + (32 * _36) + 32 <= return_data.size
    idx = 0
    s = (2 * ceil32(return_data.size)) + _35 + 224
...
function sub_f5a85a10(?) payable {
    ...
    mem[ceil32(return_data.size) + 128] = 0xa5b0f5ef809fd04c9d4320211c711cb34ef812dd
    ...
    mem[64] = (4 * ceil32(return_data.size)) + 192
    require return_data.size >= 32
    _47 = mem[(2 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[0 len 28]
    ...
    _48 = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[0 len 28] + 192]
    ...
    mem[(4 * ceil32(return_data.size)) + 192] = _48
    require _47 + (32 * _48) + 32 <= return_data.size
    idx = 0
    s = (2 * ceil32(return_data.size)) + _47 + 224
    t = (4 * ceil32(return_data.size)) + 224
    while idx < _48:
        require mem[s] == mem[s]
        mem[t] = mem[s]
    ...
    if 1 >= _48:
        revert with 'NH{q', 50
    _68 = mem[(4 * ceil32(return_data.size)) + 256]
    ...
    while idx < _74:
        ...
        t = t + 32
        continue 
    mem[_73 + 100] = msg.sender
    mem[_73 + 132] = block.timestamp + 60
    require ext_code.size(stor1)
    call stor1.mem[mem[64] len 4] with:
         gas gas_remaining wei
        args mem[mem[64] + 4 len _73 + (32 * _74) + -mem[64] + 192]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _84 = mem[64]
    ...
    require _85 + (32 * _86) + 32 <= return_data.size
    idx = 0
    s = _84 + _85 + 32
    t = _84 + ceil32(return_data.size) + 32
    while idx < _86:
        require mem[s] == mem[s]
        mem[t] = mem[s]
        idx = idx + 1
