...
function flipPause() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    Mask(88, 0, stor21.field_168) = Mask(88, 0, not bool(paused))
}
...
function sub_099b83fe(?) {
    ...
    while idx < ('cd', 4).length:
        ...
        mem[32] = 22
        stor22[mem[(32 * idx) + 140 len 20]] = uint8(bool(cd[36]))
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
...
function sub_1bf8a889(?) {
    ...
    while idx < ('cd', 4).length:
        ...
        staticcall stor20.0x6352211e with:
                gas gas_remaining wei
               args _109
        ...
        if idx >= mem[96]:
            revert with 'NH{q', 50
        _120 = mem[(32 * idx) + 128]
        require mem[(32 * idx) + 128] < 1904
        mem[mem[64] + 36] = this.address
        mem[mem[64] + 68] = _120
        require ext_code.size(address(stor21.field_0))
        call address(stor21.field_0).0x23b872dd with:
             gas gas_remaining wei
        ...
        if msg.sender:
            ...
            mem[mem[64] + 4] = _120
            require ext_code.size(address(stor21.field_0))
            staticcall address(stor21.field_0).0xbac93203 with:
                    gas gas_remaining wei
                   args _120
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
    ...
    require ext_code.size(stor20)
    staticcall stor20.0xf4901772 with:
            gas gas_remaining wei
...
function sub_04c83122(?) {
    ...
    while idx < ('cd', 4).length:
        ...
        mem[mem[64] + 4] = mem[(32 * idx) + 128]
        require ext_code.size(address(stor21.field_0))
        staticcall address(stor21.field_0).0x6352211e with:
                gas gas_remaining wei
               args _109
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
    ...
    mem[mem[64] + 68 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
    require ext_code.size(address(stor21.field_0))
    staticcall address(stor21.field_0).0xf4901772 with:
            gas gas_remaining wei
           args 32, mem[mem[64] + 36 len (32 * mem[96]) + 32]
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
