...
const sub_d9491636(?) = 0x1dab6560494b04473a0be3e7d83cf3fdf3a51828
...
function depositFor(address arg1, uint256 arg2, bytes32[] arg3) payable {
    ...
    call 0x58e57ca18b7a47112b877e31929798cd3d703b0f.add_liquidity(uint256[5] arg1, uint256 arg2) with:
         gas gas_remaining wei
        args arg2, 0, 0, 0, 0 >> 1024, 1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(tokenAddress)
    staticcall tokenAddress.0x70a08231 with:
...
function depositAll(bytes32[] arg1) payable {
    ...
    call 0x58e57ca18b7a47112b877e31929798cd3d703b0f.add_liquidity(uint256[5] arg1, uint256 arg2) with:
         gas gas_remaining wei
        args ext_call.return_data[0], 0, 0, 0, 0 >> 1024, 1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(tokenAddress)
    staticcall tokenAddress.0x70a08231 with:
    ...
    if stor154[msg.sender]:
        ...
        if not 2 * ext_call.return_data[0]:
            ...
            if ext_call.return_data[0] >= 0 / totalSupply:
                require ext_code.size(0x58e57ca18b7a47112b877e31929798cd3d703b0f)
                call 0x58e57ca18b7a47112b877e31929798cd3d703b0f.remove_liquidity_one_coin(uint256 arg1, uint256 arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args 0 / totalSupply, 0, 1
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            ...
            if ext_call.return_data[0] >= (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalSupply:
                ...
                call 0x58e57ca18b7a47112b877e31929798cd3d703b0f.remove_liquidity_one_coin(uint256 arg1, uint256 arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args (ext_call.return_data[0] * arg1) + (ext_call.return_data[0] * arg1) / totalSupply, 0, 1
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require ext_code.size(0xd586e7f844cea2f87f50152665bcbc2c279d8d70)
                staticcall 0xd586e7f844cea2f87f50152665bcbc2c279d8d70.0x70a08231 with:
    ...
    if stor154[msg.sender]:
        ...
        if not 2 * ext_call.return_data[0]:
            ...
            if ext_call.return_data[0] >= (ext_call.return_data[0] * balanceOf[address(msg.sender)]) + (ext_call.return_data[0] * balanceOf[address(msg.sender)]) / totalSupply:
                ...
                call 0x58e57ca18b7a47112b877e31929798cd3d703b0f.remove_liquidity_one_coin(uint256 arg1, uint256 arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args (ext_call.return_data[0] * balanceOf[address(msg.sender)]) + (ext_call.return_data[0] * balanceOf[address(msg.sender)]) / totalSupply, 0, 1
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require ext_code.size(0xd586e7f844cea2f87f50152665bcbc2c279d8d70)
                staticcall 0xd586e7f844cea2f87f50152665bcbc2c279d8d70.0x70a08231 with:
