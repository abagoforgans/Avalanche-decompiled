...
function sub_7897f76a(?) payable {
    ...
    if not uint8(stor152[0x9f2df0fed2c77648de5860a4cc508cd0818c85b8b8a1ab4ceeef8d981c8956a6][address(msg.sender)].field_0):
        revert with 0, '403'
    if stor[Mask(8 * -ceil32(arg2.length) + arg2.length + 32, 0, 160)][Mask(8 * ceil32(arg2.length), -(8 * ceil32(arg2.length)) + 256, arg2[all], Mask(8 * ceil32(arg2.length) - arg2.length, -(8 * ceil32(arg2.length) + -ceil32(ceil32(arg2.length)) + 31) + 256, arg3.length) >> 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff08 + (8 * -ceil32(arg2.length)) + (8 * ceil32(ceil32(arg2.length))) + 256) << (8 * ceil32(arg2.length)) - 256] >= stor2[('map', ('mask_shl', ('mask_shl', 248, 5, 3, ('add', 31, ('cd', ('add', 4, ('param', 'arg2'))))), ('add', 256, ('mul', -1, ('mask_shl', 248, 5, 3, ('add', 31, ('cd', ('add', 4, ('param', 'arg2'))))))), ('add', -256, ('mask_shl', 248, 5, 3, ('add', 31, ('cd', ('add', 4, ('param', 'arg2')))))), ('data', ('call.data', ('add', 36, ('param', 'arg2')), ('cd', ('add', 4, ('param', 'arg2')))), ('mask_shl', ('mul', 8, ('add', ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg2'))))), ('mul', -1, ('cd', ('add', 4, ('param', 'arg2')))))), ('add', 256, ('mul', -1, ('mul', 8, ('add', 31, ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg2'))))), ('mul', -1, ('mask_shl', 256, 5, 0, ('add', 31, ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg2')))))))))))), ('add', -256, ('mul', 8, ('add', 31, ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg2'))))), ('mul', -1, ('mask_shl', 256, 5, 0, ('add', 31, ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg2'))))))))))), ('cd', ('add', 4, ('param', 'arg3')))))), ('mask_shl', ('mul', 8, ('add', 32, ('mul', -1, ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg2')))))), ('cd', ('add', 4, ('param', 'arg2'))))), 0, 0, 158))]:
        revert with 0, '429'
    if tokenCount > -2:
        revert with 'NH{q', 17
    if stor[Mask(8 * -ceil32(arg2.length) + arg2.length + 32, 0, 160)][Mask(8 * ceil32(arg2.length), -(8 * ceil32(arg2.length)) + 256, arg2[all], Mask(8 * ceil32(arg2.length) - arg2.length, -(8 * ceil32(arg2.length) + -ceil32(ceil32(arg2.length)) + 31) + 256, arg3.length) >> 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff08 + (8 * -ceil32(arg2.length)) + (8 * ceil32(ceil32(arg2.length))) + 256) << (8 * ceil32(arg2.length)) - 256] > -2:
        revert with 'NH{q', 17
    stor[Mask(8 * -ceil32(arg2.length) + arg2.length + 32, 0, 160)][Mask(8 * ceil32(arg2.length), -(8 * ceil32(arg2.length)) + 256, arg2[all], Mask(8 * ceil32(arg2.length) - arg2.length, -(8 * ceil32(arg2.length) + -ceil32(ceil32(arg2.length)) + 31) + 256, arg3.length) >> 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff08 + (8 * -ceil32(arg2.length)) + (8 * ceil32(ceil32(arg2.length))) + 256) << (8 * ceil32(arg2.length)) - 256]++
    if not address(arg1):
        revert with 0, 'ERC721: mint to the zero address'
    if ownerOf[stor154 + 1]:
        revert with 0, 'ERC721: token already minted'
    require not paused
    if balanceOf[address(arg1)] > -2:
        revert with 'NH{q', 17
    balanceOf[address(arg1)]++
    ownerOf[stor154 + 1] = address(arg1)
    emit Transfer(0, address(arg1), tokenCount + 1);
    if tokenCount > -2:
        revert with 'NH{q', 17
    tokenCount++
    if bool(stor155[stor154 + 1].field_0):
        if bool(stor155[stor154 + 1].field_0) == uint255(stor155[stor154 + 1].field_1) < 32:
            revert with 'NH{q', 34
        if arg3.length:
            stor155[stor154 + 1][].field_0 = Array(len=arg3.length, data=arg3[all])
        else:
            stor155[stor154 + 1].field_0 = 0
            idx = 0
            while uint255(stor155[stor154 + 1].field_1) + 31 / 32 > idx:
                stor155[stor154 + 1][idx].field_0 = 0
                idx = idx + 1
                continue 
    else:
        if bool(stor155[stor154 + 1].field_0) == stor155[stor154 + 1].field_1 % 128 < 32:
            revert with 'NH{q', 34
        if arg3.length:
            stor155[stor154 + 1][].field_0 = Array(len=arg3.length, data=arg3[all])
        else:
            stor155[stor154 + 1].field_0 = 0
            idx = 0
            while stor155[stor154 + 1].field_1 % 128 + 31 / 32 > idx:
                stor155[stor154 + 1][idx].field_0 = 0
                idx = idx + 1
                continue 
    if bool(stor159[stor154 + 1].field_0):
        if bool(stor159[stor154 + 1].field_0) == uint255(stor159[stor154 + 1].field_1) < 32:
            revert with 'NH{q', 34
        if arg2.length:
            stor159[stor154 + 1][].field_0 = Array(len=arg2.length, data=arg2[all])
        else:
            stor159[stor154 + 1].field_0 = 0
            idx = 0
            while uint255(stor159[stor154 + 1].field_1) + 31 / 32 > idx:
                stor159[stor154 + 1][idx].field_0 = 0
                idx = idx + 1
                continue 
    else:
        if bool(stor159[stor154 + 1].field_0) == stor159[stor154 + 1].field_1 % 128 < 32:
            revert with 'NH{q', 34
        if arg2.length:
            stor159[stor154 + 1][].field_0 = Array(len=arg2.length, data=arg2[all])
        else:
            stor159[stor154 + 1].field_0 = 0
            idx = 0
            while stor159[stor154 + 1].field_1 % 128 + 31 / 32 > idx:
                stor159[stor154 + 1][idx].field_0 = 0
                idx = idx + 1
                continue 
    emit Minted(address(arg1), tokenCount + 1, Array(len=arg2.length, data=arg2[all]));
}
