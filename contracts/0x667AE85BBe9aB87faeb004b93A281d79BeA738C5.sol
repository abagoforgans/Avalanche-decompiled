...
function sub_ea4c532f(?) payable {
    ...
    Mask(72, 0, stor23.field_184) = Mask(72, 0, arg4)
    uint64(stor23.field_192) = 0
    uint64(stor23.field_192) = Mask(64, 32, arg1) >> 32
    uint64(stor23.field_192) = Mask(64, 24, arg2) >> 24
    uint64(stor23.field_192) = Mask(64, 16, arg3) >> 16
...
function sub_3330fc23(?) payable {
    require calldata.size - 4 >= 32
    if stor27[arg1].field_768:
        mem[128] = stor27[arg1][3].field_0
        idx = 128
        s = 0
        while (32 * stor27[arg1].field_768) + 96 > idx:
            mem[idx + 32] = stor27[arg1][s + 3].field_256
            idx = idx + 32
            s = s + 1
            continue 
    if stor27[arg1].field_1024:
        mem[(32 * stor27[arg1].field_768) + 160] = stor27[arg1][4].field_0
        idx = (32 * stor27[arg1].field_768) + 160
        s = 0
        while (32 * stor27[arg1].field_768) + (32 * stor27[arg1].field_1024) + 128 > idx:
            mem[idx + 32] = stor27[arg1][s + 4].field_256
            idx = idx + 32
            s = s + 1
            continue 
    mem[(32 * stor27[arg1].field_768) + (32 * stor27[arg1].field_1024) + 352 len floor32(stor27[arg1].field_768)] = mem[128 len floor32(stor27[arg1].field_768)]
    mem[(64 * stor27[arg1].field_768) + (32 * stor27[arg1].field_1024) + 352] = stor27[arg1].field_1024
    mem[(64 * stor27[arg1].field_768) + (32 * stor27[arg1].field_1024) + 384 len floor32(stor27[arg1].field_1024)] = mem[(32 * stor27[arg1].field_768) + 160 len floor32(stor27[arg1].field_1024)]
    return stor27[arg1].field_256, 
           stor27[arg1].field_512,
           Array(len=stor27[arg1].field_768, data=mem[128 len floor32(stor27[arg1].field_768)], mem[(32 * stor27[arg1].field_768) + (32 * stor27[arg1].field_1024) + floor32(stor27[arg1].field_768) + 352 len (32 * stor27[arg1].field_768) + (32 * stor27[arg1].field_1024) + -floor32(stor27[arg1].field_768) + 32]),
           (32 * stor27[arg1].field_768) + 192,
           stor27[arg1].field_0
}
...
function emergencyTransferToken(address arg1, uint256 arg2) payable {
    ...
    if address(sub_980c7707Address) != msg.sender:
        revert with 0, 'not pot owner'
    mem[196 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor19), uint32(stor19), Mask(224, 32, arg2) >> 32
    call arg1 with:
       funct uint32(stor19)
         gas gas_remaining wei
    ...
    if not return_data.size:
        if not ext_call.success:
            revert with 0, 
                        ...
                        mem[309 len 19]
        if not unknown_0xa9059cbb(?????), Mask(224, 0, stor19):
            revert with 0, 
                        32,
                        45,
                        0x5472616e7366657248656c7065723a3a736166655472616e736665723a207472616e73666572206661696c6500,
...
function sub_68d1a952(?) payable {
    ...
    if ext_call.return_data[0] > ext_call.return_data[0]:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        mem[196 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor19), uint32(stor19), ext_call.return_data[0 len 28]
        ...
        mem[196 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor17), uint32(stor17), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        ...
        if not return_data.size:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[296 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor19), uint32(stor19), ext_call.return_data[0 len 28]
            call sub_8cab0f99Address with:
               funct uint32(stor19)
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[ceil32(return_data.size) + 297 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor19), uint32(stor19), ext_call.return_data[0 len 28]
                call sub_8cab0f99Address with:
                   funct uint32(stor19)
                     gas gas_remaining wei
