...
function sub_d550dda2(?) payable {
    ...
    require ext_code.size(0x17dd02c267e9f805e18d135fcb70a9baba3bc2f9)
    delegate 0x17dd02c267e9f805e18d135fcb70a9baba3bc2f9.isContract(address rg1) with:
...
function sub_35cdb1f4(?) payable {
    ...
    if not sub_0efc1b9c:
        revert with 0, 18
    require ext_code.size(0x17dd02c267e9f805e18d135fcb70a9baba3bc2f9)
    delegate 0x17dd02c267e9f805e18d135fcb70a9baba3bc2f9.today() with:
         gas gas_remaining wei
        args 
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
