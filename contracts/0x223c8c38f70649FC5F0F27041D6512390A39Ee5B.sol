            ...
            if ext_call.return_data[0] > 0:
                if arg4:
                    ...
                    while idx < (ext_call.return_data[0] / arg4) + 1:
                        ...
                        call arg2.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args arg4, 0, 160, address(this.address), block.timestamp + (24 * 3600), mem[mem[64] + 164 len (32 * _139) + 32]
                        if not ext_call.success:
                            if arg6:
                                if stor5 == -1:
                                    revert with 0, 17
                    ...
                    if 24 * 3600 > !block.timestamp:
                        revert with 0, 17
                    mem[(2 * ceil32(return_data.size)) + (32 * arg3.length) + 128] = 0x791ac94700000000000000000000000000000000000000000000000000000000
                ...
                if ext_call.success:
                    ...
                    if arg4:
                        ...
                        if 24 * 3600 > !block.timestamp:
                            revert with 0, 17
                        mem[(4 * ceil32(return_data.size)) + (32 * arg3.length) + 128] = 0x791ac94700000000000000000000000000000000000000000000000000000000
                ...
                if arg4:
                    ...
                    while idx < (ext_call.return_data[0] / arg4) + 1:
                        ...
                        if t <= arg4:
                            ...
                            call arg2.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                 gas gas_remaining wei
                                args t, 0, 160, address(this.address), block.timestamp + (24 * 3600), mem[mem[64] + 164 len (32 * _144) + 32]
                            if not ext_call.success:
                                if arg6:
                                    if stor5 == -1:
                                        revert with 0, 17
                        ...
                        call arg2.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args arg4, 0, 160, address(this.address), block.timestamp + (24 * 3600), mem[mem[64] + 164 len (32 * _143) + 32]
                        if not ext_call.success:
                            if arg6:
                                if stor5 == -1:
                                    revert with 0, 17
