...
function sub_b05dba96(?) payable {
    ...
    call stor3.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 0x166840a0f79326f74705da4ae0fee085aed89b7c, -1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    ...
    call stor4.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 0x3875ac1f19e05813000f02414b3141dc3ff991b6, -1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
...
function sub_ad760032(?) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    mem[128] = 0x70b33ebc5544c12691d055b49762d0f8365d99fe
...
function sub_6ee141ff(?) payable {
    ...
    mem[ceil32(return_data.size) + 160] = 0x70b33ebc5544c12691d055b49762d0f8365d99fe
    mem[ceil32(return_data.size) + 192] = 0x38ed173900000000000000000000000000000000000000000000000000000000
...
function sub_f5a85a10(?) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[ceil32(return_data.size) + 96] = 2
    mem[ceil32(return_data.size) + 128] = 0x70b33ebc5544c12691d055b49762d0f8365d99fe
    ...
    mem[_71 + 132] = block.timestamp + 60
    require ext_code.size(stor1)
    call stor1.mem[mem[64] len 4] with:
         gas gas_remaining wei
        args mem[mem[64] + 4 len _71 + (32 * _72) + -mem[64] + 192]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _82 = mem[64]
