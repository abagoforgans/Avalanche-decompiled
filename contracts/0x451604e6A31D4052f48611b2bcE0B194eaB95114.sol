...
#
const name = 'AVAX CHADS ARE BACK', 0

const decimals = 6

const symbol = 'ACHADS', 0
...
function getCirculatingSupply() {
    if totalSupply < balanceOf[stor6]:
        revert with 'NH{q', 17
    if totalSupply - balanceOf[stor6] < balanceOf[stor7]:
        revert with 'NH{q', 17
    return (totalSupply - balanceOf[stor6] - balanceOf[stor7])
}
...
function getLiquidityBacking(uint256 arg1) {
    ...
    if arg1 and 2 * balanceOf[stor29] > -1 / arg1:
        revert with 'NH{q', 17
    if not totalSupply - balanceOf[stor6] - balanceOf[stor7]:
        revert with 'NH{q', 18
    return (arg1 * 2 * balanceOf[stor29] / totalSupply - balanceOf[stor6] - balanceOf[stor7])
}
...
function isOverLiquified(uint256 arg1, uint256 arg2) {
    ...
    if not totalSupply - balanceOf[stor6] - balanceOf[stor7]:
        revert with 'NH{q', 18
    return (arg2 * 2 * balanceOf[stor29] / totalSupply - balanceOf[stor6] - balanceOf[stor7] > arg1)
}
...
function setFees(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint256 arg5) {
    ...
    uint256(stor23.field_0) = arg5
    require multipliedFee < Mask(254, 0, stor23.field_2)
}
...
function triggerZeusBuyback(uint256 arg1, bool arg2) {
    ...
    call routerAddress.swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
       value arg1 wei
         gas gas_remaining wei
        args 0, 128, stor6, block.timestamp, 2, mem[356 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    stor48 = 0
    if arg2:
