...
function sub_36888411(?) {
    ...
    staticcall address(arg3).decimals() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function sub_9ead80fd(?) payable {
    ...
    call mem[mem[128] + 12 len 20].deposit() with:
       value msg.value wei
         gas gas_remaining wei
    if not ext_call.success:
        mem[mem[64]] = 0x407045a800000000000000000000000000000000000000000000000000000000
        ...
        while idx < _4582:
            ...
            if mem[mem[(32 * idx) + 128] + 160] == 1:
                ...
                call address(_4606).transfer(address arg1, uint256 arg2) with:
                     gas gas_remaining wei
                        ...
                        if mem[mem[(32 * idx) + 128] + 160] < 80:
                            if mem[mem[(32 * idx) + 128] + 160] != 12:
                                if mem[mem[(32 * idx) + 128] + 160] == 13:
                                    ...
                                    call address(_4657).transfer(address arg1, uint256 arg2) with:
                                         gas gas_remaining wei
                                        args mem[mem[64] + 4], _4592
                                    mem[mem[64]] = ext_call.return_data[0]
                                    if not ext_call.success:
                                ...
                                call address(_4908).mem[mem[64] len 4] with:
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4 len _4645 + ceil32(return_data.size) + (32 * mem[_4645]) + -mem[64] + 480]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _6276 = mem[64]
                                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                                ...
                                require _6276 + mem[_6276] + 31 < _6276 + return_data.size
                                _6286 = mem[_6276 + mem[_6276]]
                                if mem[_6276 + mem[_6276]] > test266151307():
                                    revert with 'NH{q', 65
                                if _6276 + ceil32(return_data.size) + floor32(mem[_6276 + mem[_6276]]) + 1 > test266151307() or floor32(mem[_6276 + mem[_6276]]) + 1 < 0:
                                    revert with 'NH{q', 65
                                mem[64] = _6276 + ceil32(return_data.size) + floor32(mem[_6276 + mem[_6276]]) + 1
                                mem[_6276 + ceil32(return_data.size)] = _6286
                                require _6280 + (32 * _6286) + 32 <= return_data.size
                                s = 0
                                t = _6276 + _6280 + 32
                                u = _6276 + ceil32(return_data.size) + 32
                                while s < _6286:
                                    require mem[t] == mem[t]
                                    mem[u] = mem[t]
                                    _4582 = mem[96]
                            ...
                            if mem[mem[(32 * idx) + 128] + 160] < 90:
                                ...
                                if mem[mem[(32 * idx) + 128] + 160] != 12:
                                    if mem[mem[(32 * idx) + 128] + 160] == 13:
                                        ...
                                        call address(_4674).transfer(address arg1, uint256 arg2) with:
                                             gas gas_remaining wei
                                            args mem[mem[64] + 4], _4592
                                        mem[mem[64]] = ext_call.return_data[0]
                                        if not ext_call.success:
                                    ...
                                    call address(_4912).mem[mem[64] len 4] with:
                                         gas gas_remaining wei
                                        args mem[mem[64] + 4 len _4661 + ceil32(return_data.size) + (32 * mem[_4661]) + -mem[64] + 480]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    _6277 = mem[64]
                                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                                    ...
                                    require _6277 + mem[_6277] + 31 < _6277 + return_data.size
                                    _6287 = mem[_6277 + mem[_6277]]
                                    if mem[_6277 + mem[_6277]] > test266151307():
                                        revert with 'NH{q', 65
                                    if _6277 + ceil32(return_data.size) + floor32(mem[_6277 + mem[_6277]]) + 1 > test266151307() or floor32(mem[_6277 + mem[_6277]]) + 1 < 0:
                                        revert with 'NH{q', 65
                                    mem[64] = _6277 + ceil32(return_data.size) + floor32(mem[_6277 + mem[_6277]]) + 1
                                    mem[_6277 + ceil32(return_data.size)] = _6287
                                    require _6281 + (32 * _6287) + 32 <= return_data.size
                                    s = 0
                                    t = _6277 + _6281 + 32
                                    u = _6277 + ceil32(return_data.size) + 32
                                    while s < _6287:
                                        require mem[t] == mem[t]
                                        mem[u] = mem[t]
                                        _4582 = mem[96]
    ...
    while idx < _4583:
        ...
        if mem[mem[(32 * idx) + 128] + 160] == 1:
            ...
            call address(_4610).transfer(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                    ...
                    if mem[mem[(32 * idx) + 128] + 160] < 80:
                        if mem[mem[(32 * idx) + 128] + 160] != 12:
                            if mem[mem[(32 * idx) + 128] + 160] == 13:
                                ...
                                call address(_4663).transfer(address arg1, uint256 arg2) with:
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4], _4593
                                mem[mem[64]] = ext_call.return_data[0]
                                if not ext_call.success:
                            ...
                            call address(_4910).mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _4651 + ceil32(return_data.size) + (32 * mem[_4651]) + -mem[64] + 480]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            _6278 = mem[64]
                            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                            ...
                            require _6278 + mem[_6278] + 31 < _6278 + return_data.size
                            _6289 = mem[_6278 + mem[_6278]]
                            if mem[_6278 + mem[_6278]] > test266151307():
                                revert with 'NH{q', 65
                            if _6278 + ceil32(return_data.size) + floor32(mem[_6278 + mem[_6278]]) + 1 > test266151307() or floor32(mem[_6278 + mem[_6278]]) + 1 < 0:
                                revert with 'NH{q', 65
                            mem[64] = _6278 + ceil32(return_data.size) + floor32(mem[_6278 + mem[_6278]]) + 1
                            mem[_6278 + ceil32(return_data.size)] = _6289
                            require _6282 + (32 * _6289) + 32 <= return_data.size
                            s = 0
                            t = _6278 + _6282 + 32
                            u = _6278 + ceil32(return_data.size) + 32
                            while s < _6289:
                                require mem[t] == mem[t]
                                mem[u] = mem[t]
                                _4583 = mem[96]
                        ...
                        if mem[mem[(32 * idx) + 128] + 160] < 90:
                            ...
                            if mem[mem[(32 * idx) + 128] + 160] != 12:
                                if mem[mem[(32 * idx) + 128] + 160] == 13:
                                    ...
                                    call address(_4686).transfer(address arg1, uint256 arg2) with:
                                         gas gas_remaining wei
                                        args mem[mem[64] + 4], _4593
                                    mem[mem[64]] = ext_call.return_data[0]
                                    if not ext_call.success:
                                ...
                                call address(_4914).0xceb757d5 with:
                                     gas gas_remaining wei
                                    args _4593, 0, 192, (32 * mem[_4667]) + 224, address(this.address), block.timestamp, mem[_4667 + ceil32(return_data.size) + 356 len (32 * mem[_4667]) + 32], 2, mem[_4667 + ceil32(return_data.size) + (32 * mem[_4667]) + 420 len 64]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                mem[_4667 + ceil32(return_data.size) + 160 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                mem[64] = _4667 + (2 * ceil32(return_data.size)) + 160
                                require return_data.size >= 32
                                _6283 = mem[_4667 + ceil32(return_data.size) + 160 len 4], Mask(224, 32, _4593) >> 32
                                require mem[_4667 + ceil32(return_data.size) + 160 len 4], Mask(224, 32, _4593) >> 32 <= test266151307()
                                require _4667 + ceil32(return_data.size) + mem[_4667 + ceil32(return_data.size) + 160 len 4], Mask(224, 32, _4593) >> 32 + 191 < _4667 + ceil32(return_data.size) + return_data.size + 160
                                _6290 = mem[_4667 + ceil32(return_data.size) + mem[_4667 + ceil32(return_data.size) + 160 len 4], Mask(224, 32, _4593) >> 32 + 160]
                                if mem[_4667 + ceil32(return_data.size) + mem[_4667 + ceil32(return_data.size) + 160 len 4], Mask(224, 32, _4593) >> 32 + 160] > test266151307():
                                    revert with 'NH{q', 65
                                if _4667 + (2 * ceil32(return_data.size)) + floor32(mem[_4667 + ceil32(return_data.size) + mem[_4667 + ceil32(return_data.size) + 160 len 4], Mask(224, 32, _4593) >> 32 + 160]) + 161 > test266151307() or floor32(mem[_4667 + ceil32(return_data.size) + mem[_4667 + ceil32(return_data.size) + 160 len 4], Mask(224, 32, _4593) >> 32 + 160]) + 1 < 0:
                                    revert with 'NH{q', 65
                                mem[64] = _4667 + (2 * ceil32(return_data.size)) + floor32(mem[_4667 + ceil32(return_data.size) + mem[_4667 + ceil32(return_data.size) + 160 len 4], Mask(224, 32, _4593) >> 32 + 160]) + 161
                                mem[_4667 + (2 * ceil32(return_data.size)) + 160] = _6290
                                require _6283 + (32 * _6290) + 32 <= return_data.size
                                s = 0
                                t = _4667 + ceil32(return_data.size) + _6283 + 192
                                u = _4667 + (2 * ceil32(return_data.size)) + 192
                                while s < _6290:
                                    require mem[t] == mem[t]
                                    mem[u] = mem[t]
                                    _4583 = mem[96]
...
function _fallback() {
    ...
    if msg.sender == mem[mem[_283 + 32] + 76 len 20]:
        ...
        while idx < _1549:
            if idx:
                ...
                if mem[mem[(32 * idx) + _283 + 32] + 160] == 1:
                    ...
                    call address(_1578).transfer(address arg1, uint256 arg2) with:
                         gas gas_remaining wei
                            ...
                            if mem[mem[(32 * idx) + _283 + 32] + 160] < 80:
                                if mem[mem[(32 * idx) + _283 + 32] + 160] != 12:
                                    if mem[mem[(32 * idx) + _283 + 32] + 160] == 13:
                                        ...
                                        call address(_1612).transfer(address arg1, uint256 arg2) with:
                                             gas gas_remaining wei
                                            args mem[mem[64] + 4], _1561
                                        mem[mem[64]] = ext_call.return_data[0]
                                        if not ext_call.success:
                                    ...
                                    call address(_1870).mem[mem[64] len 4] with:
                                         gas gas_remaining wei
                                        args mem[mem[64] + 4 len _1602 + ceil32(return_data.size) + (32 * mem[_1602]) + -mem[64] + 480]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    _3281 = mem[64]
                                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                                    ...
                                    require return_data.size >= 32
                                    _3285 = mem[_3281]
                                    require mem[_3281] <= test266151307()
                                    require _3281 + mem[_3281] + 31 < _3281 + return_data.size
                                    _3292 = mem[_3281 + mem[_3281]]
                                    if mem[_3281 + mem[_3281]] > test266151307():
                                        revert with 'NH{q', 65
                                    if _3281 + ceil32(return_data.size) + floor32(mem[_3281 + mem[_3281]]) + 1 > test266151307() or floor32(mem[_3281 + mem[_3281]]) + 1 < 0:
                                        revert with 'NH{q', 65
                                    mem[64] = _3281 + ceil32(return_data.size) + floor32(mem[_3281 + mem[_3281]]) + 1
                                    mem[_3281 + ceil32(return_data.size)] = _3292
                                    require _3285 + (32 * _3292) + 32 <= return_data.size
                                    s = 0
                                    t = _3281 + _3285 + 32
                                    u = _3281 + ceil32(return_data.size) + 32
                                    while s < _3292:
                                        require mem[t] == mem[t]
                                        mem[u] = mem[t]
                                        _1549 = mem[_283]
                                ...
                                if mem[mem[(32 * idx) + _283 + 32] + 160] < 90:
                                    ...
                                    if mem[mem[(32 * idx) + _283 + 32] + 160] != 12:
                                        if mem[mem[(32 * idx) + _283 + 32] + 160] == 13:
                                            ...
                                            call address(_1627).transfer(address arg1, uint256 arg2) with:
                                                 gas gas_remaining wei
                                                args mem[mem[64] + 4], _1561
                                            mem[mem[64]] = ext_call.return_data[0]
                                            if not ext_call.success:
                                        ...
                                        call address(_1882).mem[mem[64] len 4] with:
                                             gas gas_remaining wei
                                            args mem[mem[64] + 4 len _1616 + ceil32(return_data.size) + (32 * mem[_1616]) + -mem[64] + 480]
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        _3282 = mem[64]
                                        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                                        ...
                                        require return_data.size >= 32
                                        _3286 = mem[_3282]
                                        require mem[_3282] <= test266151307()
                                        require _3282 + mem[_3282] + 31 < _3282 + return_data.size
                                        _3293 = mem[_3282 + mem[_3282]]
                                        if mem[_3282 + mem[_3282]] > test266151307():
                                            revert with 'NH{q', 65
                                        if _3282 + ceil32(return_data.size) + floor32(mem[_3282 + mem[_3282]]) + 1 > test266151307() or floor32(mem[_3282 + mem[_3282]]) + 1 < 0:
                                            revert with 'NH{q', 65
                                        mem[64] = _3282 + ceil32(return_data.size) + floor32(mem[_3282 + mem[_3282]]) + 1
                                        mem[_3282 + ceil32(return_data.size)] = _3293
                                        require _3286 + (32 * _3293) + 32 <= return_data.size
                                        s = 0
                                        t = _3282 + _3286 + 32
                                        u = _3282 + ceil32(return_data.size) + 32
                                        while s < _3293:
                                            require mem[t] == mem[t]
                                            mem[u] = mem[t]
                                            _1549 = mem[_283]
        ...
        call address(_1553).transfer(address arg1, uint256 arg2) with:
             gas gas_remaining wei
        ...
        call address(_1662).transfer(address arg1, uint256 arg2) with:
             gas gas_remaining wei
        ...
        while idx < _1548:
            ...
            if idx != mem[_283] - 1:
                ...
                if mem[mem[(32 * idx) + _283 + 32] + 160] == 1:
                    ...
                    call address(_1609).transfer(address arg1, uint256 arg2) with:
                         gas gas_remaining wei
                            ...
                            if mem[mem[(32 * idx) + _283 + 32] + 160] < 80:
                                if mem[mem[(32 * idx) + _283 + 32] + 160] != 12:
                                    if mem[mem[(32 * idx) + _283 + 32] + 160] == 13:
                                        ...
                                        call address(_1670).transfer(address arg1, uint256 arg2) with:
                                             gas gas_remaining wei
                                            args mem[mem[64] + 4], _1569
                                        mem[mem[64]] = ext_call.return_data[0]
                                        if not ext_call.success:
                                ...
                                if mem[mem[(32 * idx) + _283 + 32] + 160] < 90:
                                    ...
                                    if mem[mem[(32 * idx) + _283 + 32] + 160] != 12:
                                        if mem[mem[(32 * idx) + _283 + 32] + 160] == 13:
                                            ...
                                            call address(_1692).transfer(address arg1, uint256 arg2) with:
                                                 gas gas_remaining wei
                                                args mem[mem[64] + 4], _1569
                                            mem[mem[64]] = ext_call.return_data[0]
                                            if not ext_call.success:
                                        ...
                                        call address(_1915).0xceb757d5 with:
                                             gas gas_remaining wei
                                            args _1569, 0, 192, (32 * mem[_1674]) + 224, address(this.address), block.timestamp, mem[_1674 + ceil32(return_data.size) + 356 len (32 * mem[_1674]) + 32], 2, mem[_1674 + ceil32(return_data.size) + (32 * mem[_1674]) + 420 len 64]
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        mem[_1674 + ceil32(return_data.size) + 160 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                        mem[64] = _1674 + (2 * ceil32(return_data.size)) + 160
                                        require return_data.size >= 32
                                        _3284 = mem[_1674 + ceil32(return_data.size) + 160 len 4], Mask(224, 32, _1569) >> 32
                                        require mem[_1674 + ceil32(return_data.size) + 160 len 4], Mask(224, 32, _1569) >> 32 <= test266151307()
                                        require _1674 + ceil32(return_data.size) + mem[_1674 + ceil32(return_data.size) + 160 len 4], Mask(224, 32, _1569) >> 32 + 191 < _1674 + ceil32(return_data.size) + return_data.size + 160
                                        _3290 = mem[_1674 + ceil32(return_data.size) + mem[_1674 + ceil32(return_data.size) + 160 len 4], Mask(224, 32, _1569) >> 32 + 160]
                                        if mem[_1674 + ceil32(return_data.size) + mem[_1674 + ceil32(return_data.size) + 160 len 4], Mask(224, 32, _1569) >> 32 + 160] > test266151307():
                                            revert with 'NH{q', 65
                                        if _1674 + (2 * ceil32(return_data.size)) + floor32(mem[_1674 + ceil32(return_data.size) + mem[_1674 + ceil32(return_data.size) + 160 len 4], Mask(224, 32, _1569) >> 32 + 160]) + 161 > test266151307() or floor32(mem[_1674 + ceil32(return_data.size) + mem[_1674 + ceil32(return_data.size) + 160 len 4], Mask(224, 32, _1569) >> 32 + 160]) + 1 < 0:
                                            revert with 'NH{q', 65
                                        mem[64] = _1674 + (2 * ceil32(return_data.size)) + floor32(mem[_1674 + ceil32(return_data.size) + mem[_1674 + ceil32(return_data.size) + 160 len 4], Mask(224, 32, _1569) >> 32 + 160]) + 161
                                        mem[_1674 + (2 * ceil32(return_data.size)) + 160] = _3290
                                        require _3284 + (32 * _3290) + 32 <= return_data.size
                                        s = 0
                                        t = _1674 + ceil32(return_data.size) + _3284 + 192
                                        u = _1674 + (2 * ceil32(return_data.size)) + 192
                                        while s < _3290:
                                            require mem[t] == mem[t]
                                            mem[u] = mem[t]
                                            _1548 = mem[_283]
        ...
        call address(_1564).transfer(address arg1, uint256 arg2) with:
             gas gas_remaining wei
        ...
        call address(_1771).transfer(address arg1, uint256 arg2) with:
             gas gas_remaining wei
