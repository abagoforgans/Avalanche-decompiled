...
function emergencyWithdraw(uint256 arg1) {
    ...
    if not arg1:
        ...
        staticcall libAddress.balanceOf(address arg1) with:
        ...
        if uint256(userInfo[arg1][msg.sender].field_0) <= ext_call.return_data[0]:
            call libAddress.transfer(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
        ...
        if not ext_code.hash(poolInfo[arg1].field_0):
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 0, userInfo[arg1][msg.sender].field_32)
        mem[324 len 0] = 0
        ...
        if not return_data.size:
            if not ext_call.success:
                revert with transfer(address arg1, uint256 arg2), msg.sender, uint256(userInfo[arg1][msg.sender].field_0)
            ...
            if totalStaked:
                ...
                if not block.number - uint256(poolInfo[arg1].field_512):
                    if not totalAllocPoint:
                        revert with 0, 'SafeMath: division by zero'
                    require ext_code.size(libAddress)
                    call libAddress.mint(address arg1, uint256 arg2) with:
                         gas gas_remaining wei
...
function stake(uint256 arg1) {
    ...
    stor2 = 2
    require ext_code.size(libAddress)
    call libAddress.transferFrom(address arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
...
function withdraw(uint256 arg1, uint256 arg2) payable {
    ...
    if block.number <= uint256(poolInfo[arg1].field_512):
        if not uint256(userInfo[arg1][msg.sender].field_0):
            ...
            if not -uint256(userInfo[arg1][msg.sender].field_256):
                ...
                staticcall stor[sha3((6 * arg1) + ('name', 'poolInfo', 8) + 3)].field_0.balanceOf(address arg1) with:
                        gas gas_remaining wei
                       args this.address
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                staticcall stor[sha3((6 * arg1) + ('name', 'poolInfo', 8) + 3)].field_256.balanceOf(address arg1) with:
                        gas gas_remaining wei
                       args this.address
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
    ...
    if not uint8(poolInfo[arg1].field_1280):
        require ext_code.size(stor[sha3((6 * arg1) + ('name', 'poolInfo', 8) + 3)].field_0)
        call stor[sha3((6 * arg1) + ('name', 'poolInfo', 8) + 3)].field_0.transfer(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args msg.sender, 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(stor[sha3((6 * arg1) + ('name', 'poolInfo', 8) + 3)].field_256)
    call stor[sha3((6 * arg1) + ('name', 'poolInfo', 8) + 3)].field_256.transfer(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args msg.sender, 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
