...
function swap(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5) payable {
    require calldata.size - 4 >= 160
    mem[164] = arg3
    require ext_code.size(0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7)
    call 0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7.0x23b872dd with:
         gas gas_remaining wei
        args 0xbb88e840605eaf50f1af478c21b3a1e737585057, address(this.address), arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7)
        ...
        while idx < arg5:
            ...
            if not stor2:
                ...
                while s < 32 * _629:
                    ...
                    s = s + 32
                    continue 
                emit 0x47286a0b: 96, 160, (32 * mem[_385 + ceil32(return_data.size)]) + 192, 7, 'Success', mem[_385 + ceil32(return_data.size)], mem[(32 * _424) + _385 + ceil32(return_data.size) + 224 len (32 * _629) + (32 * mem[_385 + ceil32(return_data.size)]) + 32]
                s = floor32(_629) + 1
                continue 
            _201 = mem[64]
            mem[mem[64]] = 0x38ed173900000000000000000000000000000000000000000000000000000000
            ...
            if ext_call.success:
                ...
                while s < 32 * mem[96]:
                    ...
                    s = s + 32
                    continue 
                emit 0x47286a0b: 96, 160, (32 * mem[_386 + ceil32(return_data.size)]) + 192, 7, 'Success', mem[_386 + ceil32(return_data.size)], mem[(32 * _425) + _386 + ceil32(return_data.size) + 224 len (32 * mem[96]) + (32 * mem[_386 + ceil32(return_data.size)]) + 32]
                idx = idx + 1
                continue 
            _393 = mem[64]
