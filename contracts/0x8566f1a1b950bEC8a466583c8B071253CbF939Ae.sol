...
function withdraw(bytes arg1, bytes32 arg2, bytes32 arg3, address arg4, address arg5, uint256 arg6, uint256 arg7) payable {
    ...
    if not return_data.size:
        ...
        if not arg6:
            if not arg7:
                require sub_f27b4b45
                mem[488 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor112), uint32(stor112), Mask(224, 32, denomination / sub_f27b4b45) >> 32
                call tokenAddress with:
                   funct uint32(stor112)
                     gas gas_remaining wei
                    args Mask(224, 32, denomination / sub_f27b4b45) << 224, mem[552 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with 0, 'not enough tokens'
                    if arg2:
                ...
                if not return_data.size:
                    ...
                    mem[ceil32(return_data.size) + 489 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor112), uint32(stor112), Mask(224, 32, denomination / sub_f27b4b45) >> 32
                    call tokenAddress with:
                       funct uint32(stor112)
                         gas gas_remaining wei
                        args Mask(224, 32, denomination / sub_f27b4b45) << 224, mem[ceil32(return_data.size) + 553 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with 0, 'not enough tokens'
                        if arg2:
                        ...
                        if return_data.size:
                            ...
                            if not mem[ceil32(return_data.size) + 521]:
                                revert with 0, 
                                            ...
                                            39,
                                            0x746e6f7420656e6f75676820746f6b656e732e20546f6b656e2072657475726e732066616c7365,
                                            mem[(2 * ceil32(return_data.size)) + 597 len (2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 25]
            ...
            mem[488 len 64] = unknown_0xa9059cbb(?????), address(arg5) << 64, 0, Mask(224, 32, arg6) >> 32
            call tokenAddress with:
                 gas gas_remaining wei
                args Mask(224, 32, arg6) << 224, mem[552 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 'not enough tokens'
                if arg2:
    ...
    if not arg6:
        if not arg7:
            ...
            if not return_data.size:
                ...
                mem[(2 * ceil32(return_data.size)) + 490 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor112), uint32(stor112), Mask(224, 32, denomination / sub_f27b4b45) >> 32
                call tokenAddress with:
                   funct uint32(stor112)
                     gas gas_remaining wei
                    args Mask(224, 32, denomination / sub_f27b4b45) << 224, mem[(2 * ceil32(return_data.size)) + 554 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with 0, 'not enough tokens'
                    if arg2:
                ...
                if stor104 + 1 != stor104:
                    revert with 0, 'ReentrancyGuard: reentrant call'
        ('eq', ('add', 1, ('stor', ('name', 'stor104', 104))), ('stor', ('name', 'stor104', 104)))
    mem[ceil32(return_data.size) + 489 len 64] = unknown_0xa9059cbb(?????), address(arg5) << 64, 0, Mask(224, 32, arg6) >> 32
    mem[ceil32(return_data.size) + 581 len 4] = uint32(arg6)
    call tokenAddress with:
         gas gas_remaining wei
        args Mask(224, 32, arg6) << 224, mem[ceil32(return_data.size) + 553 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with 0, 'not enough tokens'
        if arg2:
        ...
        if not arg7:
            ...
            if not return_data.size:
                ...
                mem[(2 * ceil32(return_data.size)) + 590 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)] = unknown_0xa9059cbb(?????), Mask(224, 0, stor112), uint32(stor112), Mask(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36, -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256, denomination / sub_f27b4b45) >> -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256
                call tokenAddress with:
                   funct Mask(8 * -floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) + 68, 0, stor112), mem[(2 * ceil32(return_data.size)) + 558 len floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 64]
                     gas gas_remaining wei
                    args Mask(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 4, -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)) + 256, Mask(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36, -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256, denomination / sub_f27b4b45) >> -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256) << (8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)) - 256, mem[(2 * ceil32(return_data.size)) + floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) + 590 len (2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + -floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) + 68]
                if not return_data.size:
                    if not ext_call.success:
                        revert with 0, 'not enough tokens'
                    if arg2:
                    ...
                    emit Withdrawal(address arg1, bytes32 arg2, address arg3, uint256 arg4):
                                    address(arg4),
                                    arg3,
                                    Mask(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 64, -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)) + 256, Mask(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36, -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256, denomination / sub_f27b4b45) >> -(8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) - 36) + 256) << (8 * floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68)) - 256,
                                    Mask(8 * -floor32((2 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 68) + 96, 0, arg6),
                                    arg5,
                else:
                    mem[(2 * ceil32(return_data.size)) + 622 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    if not ext_call.success:
