...
function sub_da384f1a(?) {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if not roleAdmin[0][1][address(msg.sender)].field_0:
        revert with 0, 'only admin'
    priceOracleAddress = address(arg1)
}
...
function sub_7ca2f1b9(?) {
    ...
    call sub_f5c4bed8Address.safeTransferFrom(address arg1, address arg2, uint256 arg3) with:
...
function sub_7358c7d8(?) {
    ...
    totalMint++
    require ext_code.size(sub_f5c4bed8Address)
    call sub_f5c4bed8Address.mint(uint256 arg1, uint256 arg2) with:
         gas gas_remaining wei
...
function sub_219b0f71(?) {
    ...
    if not ext_call.return_data[0]:
        ...
        if not 0 / sub_b24f9ab0 / 10:
            ...
            mem[ceil32(return_data.size) + 292 len 128] = transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(this.address), 0 / sub_b24f9ab0 / 10, 0
            mem[ceil32(return_data.size) + 392] = 0
            call buyTokenAddress with:
               funct Mask(32, 224, transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(this.address), 0 / sub_b24f9ab0 / 10, 0) >> 224
                 gas gas_remaining wei
                args (Mask(768, -544, transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(this.address), 0 / sub_b24f9ab0 / 10, 0) << 544)
            ...
            call buyTokenAddress.burn(uint256 arg1) with:
                 gas gas_remaining wei
            ...
            if not ext_code.size(buyTokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 292 len 128] = transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(this.address), (stor14[arg1].field_0 * 0 / sub_b24f9ab0 / 10 / 10) + (0 / sub_b24f9ab0 / 10), 0
            mem[ceil32(return_data.size) + 392] = 0
            call buyTokenAddress with:
               funct Mask(32, 224, transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(this.address), (stor14[arg1].field_0 * 0 / sub_b24f9ab0 / 10 / 10) + (0 / sub_b24f9ab0 / 10), 0) >> 224
                 gas gas_remaining wei
                args (Mask(768, -544, transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(this.address), (stor14[arg1].field_0 * 0 / sub_b24f9ab0 / 10 / 10) + (0 / sub_b24f9ab0 / 10), 0) << 544)
            if not return_data.size:
                if not ext_call.success:
                    if ext_call.return_data[0]:
                        revert with memory
        ...
        if not sub_b8fad400 * ext_call.return_data[0] / sub_b24f9ab0 / 10:
            ...
            if not ext_code.size(buyTokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 292 len 128] = transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(this.address), sub_b8fad400 * ext_call.return_data[0] / sub_b24f9ab0 / 10, 0
            mem[ceil32(return_data.size) + 392] = 0
            call buyTokenAddress with:
               funct Mask(32, 224, transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(this.address), sub_b8fad400 * ext_call.return_data[0] / sub_b24f9ab0 / 10, 0) >> 224
                 gas gas_remaining wei
                args (Mask(768, -544, transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(this.address), sub_b8fad400 * ext_call.return_data[0] / sub_b24f9ab0 / 10, 0) << 544)
            if not return_data.size:
                if not ext_call.success:
                    if ext_call.return_data[0]:
                        revert with memory
            ...
            if not ext_code.size(buyTokenAddress):
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 292 len 128] = transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(this.address), (stor14[arg1].field_0 * sub_b8fad400 * ext_call.return_data[0] / sub_b24f9ab0 / 10 / 10) + (sub_b8fad400 * ext_call.return_data[0] / sub_b24f9ab0 / 10), 0
            mem[ceil32(return_data.size) + 392] = 0
            call buyTokenAddress with:
               funct Mask(32, 224, transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(this.address), (stor14[arg1].field_0 * sub_b8fad400 * ext_call.return_data[0] / sub_b24f9ab0 / 10 / 10) + (sub_b8fad400 * ext_call.return_data[0] / sub_b24f9ab0 / 10), 0) >> 224
                 gas gas_remaining wei
                args (Mask(768, -544, transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(this.address), (stor14[arg1].field_0 * sub_b8fad400 * ext_call.return_data[0] / sub_b24f9ab0 / 10 / 10) + (sub_b8fad400 * ext_call.return_data[0] / sub_b24f9ab0 / 10), 0) << 544)
            if not return_data.size:
                if not ext_call.success:
                    if ext_call.return_data[0]:
                        revert with memory
