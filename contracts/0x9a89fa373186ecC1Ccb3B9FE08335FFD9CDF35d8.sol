...
function createPair(address arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    if arg1 == arg2:
        revert with 0, 'Ruggy: IDENTICAL_ADDRESSES'
    if arg1 < arg2:
        if not arg1:
            revert with 0, 'Ruggy: ZERO_ADDRESS'
        if pair[address(arg1)][address(arg2)]:
            revert with 0, 'Ruggy: PAIR_EXISTS'
        create2 contract with 0 wei
                        salt: sha3(arg1, arg2)
                        code: code.data[3403 len 451], 40, address(arg1), uint64(arg2) << 96, code.data[3938 len 14889]
        ...
        create2 contract with 0 wei
                        salt: sha3(arg2, arg1)
                        code: code.data[3403 len 451], 40, address(arg2), uint64(arg1) << 96, code.data[3938 len 14889]
        require ext_code.size(address(create2.new_address))
        call address(create2.new_address).initialize(address arg1, address arg2) with:
             gas gas_remaining wei
