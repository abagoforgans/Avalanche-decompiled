...
function prestige(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
...
function sub_e577940d(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        idx = idx + 1
        continue 
    if ('cd', 4).length > 0x78e480405d7b9658a9926345896eb19c38658a4109e553:
        revert with 'NH{q', 17
    mem[floor32(('cd', 4).length) + 133] = msg.sender
    mem[floor32(('cd', 4).length) + 165] = this.address
    mem[floor32(('cd', 4).length) + 197] = 10000 * 10^18 * ('cd', 4).length
    ...
    mem[floor32(('cd', 4).length) + 293 len 128] = 0, msg.sender, address(this.address), 10000 * 10^18 * ('cd', 4).length, 0
    mem[floor32(('cd', 4).length) + 393] = 0
    call sub_ec04327aAddress with:
       funct Mask(32, 224, 0, msg.sender, address(this.address), 10000 * 10^18 * ('cd', 4).length, 0) >> 224
         gas gas_remaining wei
        args (Mask(768, -544, 0, msg.sender, address(this.address), 10000 * 10^18 * ('cd', 4).length, 0) << 544)
...
function sub_b0ace769(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        if sub_44fddb3c[mem[(32 * idx) + 128]]:
            ...
            if sub_44fddb3c[mem[(32 * idx) + 128]] != 1:
                ...
                if sub_44fddb3c[mem[(32 * idx) + 128]] != 2:
                    ...
                    s = s
                    continue 
                if s > 0xfffffffffffffffffffffffffffffffffffffffffffff9a5b25da2cfe93fffff:
                    revert with 'NH{q', 17
                if idx == -1:
                    revert with 'NH{q', 17
                idx = idx + 1
                s = s + 30000 * 10^18
                continue 
            if s > 0xfffffffffffffffffffffffffffffffffffffffffffffbc3cc3e6c8a9b7fffff:
                revert with 'NH{q', 17
            if idx >= ('cd', 4).length:
                revert with 'NH{q', 50
            mem[0] = mem[(32 * idx) + 128]
            ...
            if sub_44fddb3c[mem[(32 * idx) + 128]] != 2:
                ...
                s = s + 20000 * 10^18
                continue 
            if s + 20000 * 10^18 > 0xfffffffffffffffffffffffffffffffffffffffffffff9a5b25da2cfe93fffff:
                revert with 'NH{q', 17
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
            s = s + 50000 * 10^18
            continue 
        if s > 0xfffffffffffffffffffffffffffffffffffffffffffffde1e61f36454dbfffff:
            revert with 'NH{q', 17
        if idx >= ('cd', 4).length:
            revert with 'NH{q', 50
        if sub_44fddb3c[mem[(32 * idx) + 128]] != 1:
            ...
            if sub_44fddb3c[mem[(32 * idx) + 128]] != 2:
                ...
                s = s + 10000 * 10^18
                continue 
            if s + 10000 * 10^18 > 0xfffffffffffffffffffffffffffffffffffffffffffff9a5b25da2cfe93fffff:
                revert with 'NH{q', 17
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
            s = s + 40000 * 10^18
            continue 
        if s + 10000 * 10^18 > 0xfffffffffffffffffffffffffffffffffffffffffffffbc3cc3e6c8a9b7fffff:
            revert with 'NH{q', 17
        if idx >= ('cd', 4).length:
            revert with 'NH{q', 50
        mem[0] = mem[(32 * idx) + 128]
        ...
        if sub_44fddb3c[mem[(32 * idx) + 128]] != 2:
            ...
            s = s + 30000 * 10^18
            continue 
        if s + 30000 * 10^18 > 0xfffffffffffffffffffffffffffffffffffffffffffff9a5b25da2cfe93fffff:
            revert with 'NH{q', 17
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
...
function depositsOf(address arg1) payable {
    ...
    if not stor5[address(arg1)].field_0:
        if var46002 >= stor5[address(arg1)].field_0:
        ...
        if var52001 >= stor5[address(arg1)].field_0:
            revert with 'NH{q', 50
        mem[0] = sha3(address(arg1), 5)
        if var58002 >= stor5[address(arg1)].field_0:
            revert with 'NH{q', 50
        ...
        idx = var58002
        while idx != -1:
            if idx + 1 >= stor5[address(arg1)].field_0:
                mem[(32 * stor5[address(arg1)].field_0) + 128] = 32
                mem[(32 * stor5[address(arg1)].field_0) + 160] = stor5[address(arg1)].field_0
                idx = 0
                u = 128
                v = (32 * stor5[address(arg1)].field_0) + 192
            ...
            if idx + 1 >= stor5[address(arg1)].field_0:
                revert with 'NH{q', 50
            mem[(32 * idx + 2) + 128] = stor5[address(arg1)][idx].field_512
            s = idx + 1
            t = stor5[address(arg1)][idx].field_256
            idx = idx + 1
            continue 
    else:
        mem[128 len 32 * stor5[address(arg1)].field_0] = call.data[calldata.size len 32 * stor5[address(arg1)].field_0]
        if var47002 >= stor5[address(arg1)].field_0:
            mem[(32 * stor5[address(arg1)].field_0) + 128] = 32
            mem[(32 * stor5[address(arg1)].field_0) + 160] = stor5[address(arg1)].field_0
            mem[(32 * stor5[address(arg1)].field_0) + 192 len 32 * stor5[address(arg1)].field_0] = call.data[calldata.size len 32 * stor5[address(arg1)].field_0]
            return memory
              from (32 * stor5[address(arg1)].field_0) + 128
               len (96 * stor5[address(arg1)].field_0) + 64
        if var53001 >= stor5[address(arg1)].field_0:
            revert with 'NH{q', 50
        mem[0] = sha3(address(arg1), 5)
        if var59002 >= stor5[address(arg1)].field_0:
            revert with 'NH{q', 50
...
function calculateRewards(address arg1, uint256[] arg2) payable {
    ...
    while idx < arg2.length:
        ...
        if block.number < EXPIRATION:
            ...
            if stor5[address(arg1)][1][mem[(32 * idx) + 128]].field_0:
...
function claimRewards(uint256[] arg1) payable {
    ...
    while idx < arg1.length:
        ...
        if block.number < EXPIRATION:
            ...
            if stor5[address(msg.sender)][1][mem[(32 * idx) + 128]].field_0:
                if (10^18 * rewardRate[stor7[mem[(32 * idx) + 128]]] * sub_b72425e3[stor8[mem[(32 * idx) + 128]]]) + (10^18 * prestige[mem[(32 * idx) + 128]] * rewardRate[stor7[mem[(32 * idx) + 128]]] * sub_b72425e3[stor8[mem[(32 * idx) + 128]]]) / 6000 and 1 > -1 / (10^18 * rewardRate[stor7[mem[(32 * idx) + 128]]] * sub_b72425e3[stor8[mem[(32 * idx) + 128]]]) + (10^18 * prestige[mem[(32 * idx) + 128]] * rewardRate[stor7[mem[(32 * idx) + 128]]] * sub_b72425e3[stor8[mem[(32 * idx) + 128]]]) / 6000:
                    revert with 'NH{q', 17
...
function deposit(uint256[] arg1) payable {
    ...
    while idx < arg1.length:
        ...
        mem[0] = cd[((32 * idx) + arg1 + 36)]
        mem[32] = sha3(address(msg.sender), 5) + 1
        if not stor5[address(msg.sender)][1][cd[((32 * idx) + arg1 + 36)]].field_0:
            stor5[address(msg.sender)].field_0++
            stor5[address(msg.sender)][stor5[address(msg.sender)].field_0].field_0 = cd[((32 * idx) + arg1 + 36)]
            mem[0] = cd[((32 * idx) + arg1 + 36)]
            mem[32] = sha3(address(msg.sender), 5) + 1
            stor5[address(msg.sender)][1][cd[((32 * idx) + arg1 + 36)]].field_0 = stor5[address(msg.sender)].field_0
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
...
function withdraw(uint256[] arg1) payable {
    ...
    while idx < arg1.length:
        ...
        mem[0] = cd[((32 * idx) + arg1 + 36)]
        mem[32] = sha3(address(msg.sender), 5) + 1
        if stor5[address(msg.sender)][1][cd[((32 * idx) + arg1 + 36)]].field_0:
            if stor5[address(msg.sender)][1][cd[((32 * idx) + arg1 + 36)]].field_0 < 1:
                revert with 'NH{q', 17
            if stor5[address(msg.sender)].field_0 < 1:
                revert with 'NH{q', 17
            if stor5[address(msg.sender)].field_0 - 1 != stor5[address(msg.sender)][1][cd[((32 * idx) + arg1 + 36)]].field_0 - 1:
                if stor5[address(msg.sender)].field_0 - 1 >= stor5[address(msg.sender)].field_0:
                    revert with 'NH{q', 50
                if stor5[address(msg.sender)][1][cd[((32 * idx) + arg1 + 36)]].field_0 - 1 >= stor5[address(msg.sender)].field_0:
                    revert with 'NH{q', 50
                stor5[address(msg.sender)][stor5[address(msg.sender)][1][cd[((32 * idx) + arg1 + 36)]].field_0].field_0 = stor5[address(msg.sender)][stor5[address(msg.sender)].field_0].field_0
                stor5[address(msg.sender)][1][stor5[address(msg.sender)][stor5[address(msg.sender)].field_0].field_0].field_0 = stor5[address(msg.sender)][1][cd[((32 * idx) + arg1 + 36)]].field_0
            if not stor5[address(msg.sender)].field_0:
                revert with 'NH{q', 49
            stor5[address(msg.sender)][stor5[address(msg.sender)].field_0].field_0 = 0
            stor5[address(msg.sender)].field_0--
            mem[0] = cd[((32 * idx) + arg1 + 36)]
            mem[32] = sha3(address(msg.sender), 5) + 1
            stor5[address(msg.sender)][1][cd[((32 * idx) + arg1 + 36)]].field_0 = 0
        if idx >= arg1.length:
            revert with 'NH{q', 50
        mem[(64 * arg1.length) + 160] = 0xb88d4fde00000000000000000000000000000000000000000000000000000000
