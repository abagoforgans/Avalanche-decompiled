...
#
const creatorAddress = 0xdee6f6d4d10a7ddbab9c8526ebe8ef13e1cf99cc
...
function toggleSaleStatus() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    uint256(stor14) = not bool(uint8(saleIsActive)) or Mask(248, 8, uint256(stor14))
}
...
function withdrawBalance() payable {
    ...
    call 0xdee6f6d4d10a7ddbab9c8526ebe8ef13e1cf99cc with:
...
function tokenURI(uint256 arg1) {
    ...
    require arg1 == arg1
    if not ownerOf[arg1]:
        revert with 0, 'Code 4: Token not exists'
    if stor16[arg1].field_0:
        if stor16[arg1].field_0 == stor16[arg1].field_1 < 32:
            revert with 'NH{q', 34
        if stor16[arg1].field_0:
...
function getReservedTokens(address arg1, uint256 arg2) payable {
    mem[64] = 96
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg2 <= 0:
        revert with 0, 'Not Handled.'
    if arg2 > 100:
        revert with 0, 'Not Handled.'
    if stor13 > -arg2 - 1:
        revert with 'NH{q', 17
    if stor13 + arg2 > 100:
        revert with 0, 'Reserved Tokens Exceed.'
    idx = 0
    while arg2 > idx:
