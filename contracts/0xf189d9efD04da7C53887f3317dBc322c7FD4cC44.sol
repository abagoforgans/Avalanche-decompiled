...
address levelEnhancerAddress;
array of struct bear;
...
function levelEnhancer() payable {
    return levelEnhancerAddress
}
...
function getBear(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 < bear.length
    return bear[arg1].field_0 % 1000, 
           bear[arg1].field_0 / 1000 % 1000,
           bear[arg1].field_0 / 10^6,
           bear[arg1].field_256,
           bear[arg1].field_512
}
...
function initialMinter() payable {
    return initialMinterAddress
}
...
function setlevelEnhancer(address arg1) payable {
    require calldata.size - 4 >= 32
    require msg.sender == levelEnhancerAddress
    levelEnhancerAddress = arg1
}

function setinitialMinter(address arg1) payable {
    require calldata.size - 4 >= 32
    require msg.sender == initialMinterAddress
    initialMinterAddress = arg1
}
...
function levelup(uint256 arg1, address arg2, uint256 arg3) payable {
    ...
    if not stor3[arg1]:
        revert with 0, 
                    ...
                    mem[215 len 9]
    require stor3[arg1] - 1 < tokenByIndex.length
    require arg2 == tokenByIndex[stor3[arg1] - 1].field_256
    require arg1 < bear.length
    bear[arg1].field_512 = arg3
    emit 0x91b9315b: arg3, arg1
}
...
function mint(address arg1, uint256 arg2) payable {
    ...
    require msg.sender == minterAddress
    bear.length++
    bear[bear.length].field_0 = arg2
    storBB7B[stor14.length] = block.timestamp
    storBB7B[stor14.length] = 1
    if not arg1:
        revert with 0, 'ERC721: mint to the zero address'
    if stor3[stor2.length]:
        revert with 0, 'ERC721: token already minted'
    if not tokenOfOwnerByIndex[address(arg1)][1][stor2.length]:
        tokenOfOwnerByIndex[address(arg1)]++
        tokenOfOwnerByIndex[address(arg1)][tokenOfOwnerByIndex[address(arg1)]] = tokenByIndex.length
        tokenOfOwnerByIndex[address(arg1)][1][stor2.length] = tokenOfOwnerByIndex[address(arg1)]
    if stor3[stor2.length]:
        require stor3[stor2.length] - 1 < tokenByIndex.length
        tokenByIndex[stor3[tokenByIndex.length] - 1].field_256 = arg1
        ...
        if not arg2 % 1000:
            ...
            stor8[stor2.length].field_1 = 1
            stor8[stor2.length].field_248 = 48
            idx = 0
            ...
            while idx:
                ...
                idx = idx / 10
                continue 
            require uint8(s) <= test266151307()
            mem[192] = uint8(s)
            if uint8(s):
                mem[224 len uint8(s)] = call.data[calldata.size len uint8(s)]
            t = s
            idx = arg2 % 1000
            while idx:
                require uint8(t - 1) < mem[192]
                mem[uint8(t - 1) + 224 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('add', 48, ('var', 0), ('mul', -10, ('div', ('var', 0), 10)))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('add', 48, ('var', 0), ('mul', -10, ('div', ('var', 0), 10)))), 0) - 256
                t = t - 1
                idx = idx / 10
                continue 
            if not stor3[stor2.length]:
                revert with 0, 
                            ...
                            mem[ceil32(uint8(s)) + 336 len 20]
            if mem[192]:
                stor8[stor2.length][].field_0 = Array(len=mem[192], data=mem[224 len mem[192]])
            else:
                stor8[stor2.length].field_0 = 0
                idx = 0
                while stor8[stor2.length].length + 31 / 32 > idx:
        ...
        if not arg2 % 1000:
            if not stor3[stor2.length]:
                revert with 0, 32, 44, 0x6e4552433732314d657461646174613a2055524920736574206f66206e6f6e6578697374656e7420746f6b65, mem[432 len 20]
            stor8[stor2.length].field_0 = 0
            stor8[stor2.length].field_1 = 1
            stor8[stor2.length].field_248 = 48
            idx = 0
            ...
            mem[256] = uint8(s)
            if uint8(s):
                mem[288 len uint8(s)] = call.data[calldata.size len uint8(s)]
            t = s
            idx = arg2 % 1000
            while idx:
                require uint8(t - 1) < mem[256]
                mem[uint8(t - 1) + 288 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('add', 48, ('var', 0), ('mul', -10, ('div', ('var', 0), 10)))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('add', 48, ('var', 0), ('mul', -10, ('div', ('var', 0), 10)))), 0) - 256
                t = t - 1
                idx = idx / 10
                continue 
            if not stor3[stor2.length]:
                revert with 0, 
                            ...
                            44,
                            0x6e4552433732314d657461646174613a2055524920736574206f66206e6f6e6578697374656e7420746f6b65,
                            mem[ceil32(uint8(s)) + 400 len 20]
            if mem[256]:
                stor8[stor2.length][].field_0 = Array(len=mem[256], data=mem[288 len mem[256]])
            else:
                stor8[stor2.length].field_0 = 0
                idx = 0
                while stor8[stor2.length].length + 31 / 32 > idx:
                    ...
                    idx = idx + 1
                    continue 
    emit 0x6dc399c1: arg2, tokenByIndex.length
    return tokenByIndex.length
}

function InitialMint(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require msg.sender == initialMinterAddress
    require tokenByIndex.length < 5000
    bear.length++
    bear[bear.length].field_0 = arg2
    storBB7B[stor14.length] = block.timestamp
    storBB7B[stor14.length] = 1
