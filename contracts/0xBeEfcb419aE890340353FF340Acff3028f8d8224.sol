...
function sub_269d1faa(?) {
    return sub_269d1faaAddress
}
...
function sub_6ed54904(?) {
    return sub_6ed54904Address
}
...
function getSniperAmt() {
    staticcall address(stor23.field_16).0x55dbc369 with:
...
function setWallets(address arg1, address arg2, address arg3) {
    ...
    sub_269d1faaAddress = arg2
    sub_6ed54904Address = arg3
}
...
function removeSniper(address arg1) {
    ...
    call address(stor23.field_16).0x33251a0b with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function removeBlacklisted(address arg1) {
    ...
    if owner != msg.sender:
        revert with 0, 'Caller =/= owner.'
    require ext_code.size(address(stor23.field_16))
    call address(stor23.field_16).0xc6a276c2 with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function isBlacklisted(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    staticcall address(stor23.field_16).0xfe575a87 with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function setGasPriceLimit(uint256 arg1) {
    ...
    require ext_code.size(address(stor23.field_16))
    call address(stor23.field_16).setGasPriceLimit(uint256 arg1) with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function setSwapSettings(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4) {
    ...
    if not arg2:
        revert with 0, 18
    stor21 = totalSupply * arg1 / arg2
    if totalSupply and arg3 > -1 / totalSupply:
        revert with 0, 17
    if not arg4:
        revert with 0, 18
    stor22 = totalSupply * arg3 / arg4
}
...
function setProtectionSettings(bool arg1, bool arg2, bool arg3, bool arg4) {
    ...
    if owner != msg.sender:
        revert with 0, 'Caller =/= owner.'
    require ext_code.size(address(stor23.field_16))
    call address(stor23.field_16).setProtections(bool arg1, bool arg2, bool arg3, bool arg4) with:
         gas gas_remaining wei
...
function setTaxes(uint16 arg1, uint16 arg2, uint16 arg3) {
    ...
    if owner != msg.sender:
        revert with 0, 'Caller =/= owner.'
    if arg1 > uint16(stor12.field_0):
        revert with 0, 'Cannot exceed maximums.'
    if arg2 > uint16(stor12.field_16):
        revert with 0, 'Cannot exceed maximums.'
    if arg3 > uint16(stor12.field_32):
        revert with 0, 'Cannot exceed maximums.'
...
function enableTrading() {
    ...
    if not address(stor23.field_16):
        Mask(240, 0, stor23.field_16) = Mask(240, 0, this.address)
    require ext_code.size(address(stor23.field_16))
    call address(stor23.field_16).setLaunch(address arg1, uint32 arg2, uint64 arg3, uint8 arg4) with:
         gas gas_remaining wei
        args 0, uint32(stor14), block.number << 224, block.timestamp << 192, decimals
    tradingEnabled = 1
}
...
function setLpPair(address arg1, bool arg2) {
    ...
    if not arg2:
        ...
        require ext_code.size(address(stor23.field_16))
        call address(stor23.field_16).0x80c581d1 with:
             gas gas_remaining wei
            args address(arg1), 0
    else:
        if stor3:
