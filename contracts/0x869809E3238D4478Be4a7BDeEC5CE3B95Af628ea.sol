...
function sub_208457db(?) {
    ...
    require return_data.size >= 32
    _44 = mem[192 len 4], Mask(224, 0, stor13.field_32)
    ...
    mem[(32 * _47) + ceil32(return_data.size) + 288] = stor3
    require ext_code.size(target_token_address)
    staticcall target_token_address.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    mem[(32 * _47) + ceil32(return_data.size) + 324] = ext_call.return_data[0]
    mem[(32 * _47) + ceil32(return_data.size) + 356] = 0
    mem[(32 * _47) + ceil32(return_data.size) + 420] = this.address
    mem[(32 * _47) + ceil32(return_data.size) + 452] = 1756181673
    ...
    call stor4.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args ext_call.return_data[0], 0, 160, address(this.address), 1756181673, 2, mem[(32 * _47) + ceil32(return_data.size) + 516 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    require mem[(32 * _47) + ceil32(return_data.size) + 320 len 4], ext_call.return_data[0 len 28] <= 4294967296
    require mem[(32 * _47) + ceil32(return_data.size) + 320 len 4], ext_call.return_data[0 len 28] + 32 <= return_data.size
    require mem[mem[(32 * _47) + ceil32(return_data.size) + 320 len 4], ext_call.return_data[0 len 28] + (32 * _47) + ceil32(return_data.size) + 320] <= 4294967296 and mem[(32 * _47) + ceil32(return_data.size) + 320 len 4], ext_call.return_data[0 len 28] + (32 * mem[mem[(32 * _47) + ceil32(return_data.size) + 320 len 4], ext_call.return_data[0 len 28] + (32 * _47) + ceil32(return_data.size) + 320]) + 32 <= return_data.size
    require ext_code.size(stor3)
    staticcall stor3.0x70a08231 with:
            gas gas_remaining wei
           args this.address
