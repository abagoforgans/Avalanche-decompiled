...
mapping of uint8 sub_1cfb777e;
mapping of uint256 sub_ebd2b309;
uint256 nextTokenID;
...
function sub_ebd2b309(?) payable {
    require calldata.size - 4 >= 32
    return sub_ebd2b309[arg1]
}
...
function get(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    return sub_1cfb777e[arg1], sub_ebd2b309[arg1]
}
...
function sub_38b00354(?) payable {
    ...
    while idx < arg1.length:
        ...
        mem[32] = 202
        require idx < arg1.length
        mem[(32 * idx) + (32 * arg1.length) + 160] = sub_1cfb777e[mem[(32 * idx) + 128]]
        idx = idx + 1
        continue 
...
function mint(address arg1, uint8 arg2, uint256 arg3) payable {
    require calldata.size - 4 >= 96
    if not stor151[('name', 'stor4741', 336492626609784167942478)][1][address(msg.sender)]:
        revert with 0, 'Not game admin'
    nextTokenID++
    sub_1cfb777e[stor204] = arg2
    sub_ebd2b309[stor204] = arg3 / 100 % 5
    if not arg1:
    ...
    require return_data.size >= 32
    require not ext_call.return_data[0]
    if not tokenOfOwnerByIndex[address(arg1)][1][stor204]:
        tokenOfOwnerByIndex[address(arg1)]++
        tokenOfOwnerByIndex[address(arg1)][tokenOfOwnerByIndex[address(arg1)]] = nextTokenID
        tokenOfOwnerByIndex[address(arg1)][1][stor204] = tokenOfOwnerByIndex[address(arg1)]
    if stor103[stor204]:
        require stor103[stor204] - 1 < tokenByIndex.length
        address(tokenByIndex[stor103[stor204] - 1].field_256) = arg1
        Mask(96, 0, tokenByIndex[stor103[stor204] - 1].field_416) = 0
    else:
        tokenByIndex.length++
        ...
        stor103[stor204] = tokenByIndex.length
...
function tokenURI(uint256 arg1) payable {
    ...
    if stor108[arg1].length:
        ...
        return Array(len=mem[ceil32(stor108[arg1].length) + ceil32(baseURI.length) + 160], data=mem[stor108[arg1].length + ceil32(stor108[arg1].length) + ceil32(baseURI.length) + baseURI.length + 256 len floor32(mem[ceil32(stor108[arg1].length) + ceil32(baseURI.length) + 160]) + 32]), 
    if not arg1:
...
function sub_615ce1c9(?) payable {
    ...
    if not arg3:
        ...
        while idx < arg3:
            ...
            require return_data.size >= 32
            require not ext_call.return_data[0]
            if tokenOfOwnerByIndex[address(arg1)][1][stor204]:
                mem[0] = nextTokenID
                mem[32] = 103
                if stor103[stor204]:
                    require stor103[stor204] - 1 < tokenByIndex.length
                    ...
                    mem[64] = mem[64] + 96
                    idx = idx + 1
                    s = sha3(mem[_286 + 32 len mem[_286]])
                    continue 
                _221 = mem[64]
                mem[64] = mem[64] + 64
                mem[_221] = nextTokenID
                mem[_221 + 32] = arg1
                tokenByIndex.length++
                tokenByIndex[tokenByIndex.length].field_0 = nextTokenID
                address(tokenByIndex[tokenByIndex.length].field_256) = arg1
                ...
                mem[64] = mem[64] + 96
                idx = idx + 1
                s = sha3(mem[_270 + 32 len mem[_270]])
                continue 
            tokenOfOwnerByIndex[address(arg1)]++
            tokenOfOwnerByIndex[address(arg1)][tokenOfOwnerByIndex[address(arg1)]] = nextTokenID
            tokenOfOwnerByIndex[address(arg1)][1][stor204] = tokenOfOwnerByIndex[address(arg1)]
            ...
            if stor103[stor204]:
                ...
                mem[64] = mem[64] + 96
                idx = idx + 1
                s = sha3(mem[_290 + 32 len mem[_290]])
                continue 
            _226 = mem[64]
            mem[64] = mem[64] + 64
            mem[_226] = nextTokenID
            mem[_226 + 32] = arg1
            tokenByIndex.length++
            tokenByIndex[tokenByIndex.length].field_0 = nextTokenID
            address(tokenByIndex[tokenByIndex.length].field_256) = arg1
            ...
            mem[64] = mem[64] + 96
            idx = idx + 1
            s = sha3(mem[_274 + 32 len mem[_274]])
            continue 
    else:
        ...
        while idx < arg3:
            ...
            if tokenOfOwnerByIndex[address(arg1)][1][stor204]:
                ...
                if stor103[stor204]:
                    ...
                    mem[64] = mem[64] + 96
                    idx = idx + 1
                    s = sha3(mem[_294 + 32 len mem[_294]])
                    continue 
                _231 = mem[64]
                mem[64] = mem[64] + 64
                mem[_231] = nextTokenID
                mem[_231 + 32] = arg1
                tokenByIndex.length++
                tokenByIndex[tokenByIndex.length].field_0 = nextTokenID
                address(tokenByIndex[tokenByIndex.length].field_256) = arg1
                ...
                mem[64] = mem[64] + 96
                idx = idx + 1
                s = sha3(mem[_278 + 32 len mem[_278]])
                continue 
            tokenOfOwnerByIndex[address(arg1)]++
            tokenOfOwnerByIndex[address(arg1)][tokenOfOwnerByIndex[address(arg1)]] = nextTokenID
            tokenOfOwnerByIndex[address(arg1)][1][stor204] = tokenOfOwnerByIndex[address(arg1)]
            ...
            if stor103[stor204]:
                ...
                mem[64] = mem[64] + 96
                idx = idx + 1
                s = sha3(mem[_298 + 32 len mem[_298]])
                continue 
            _236 = mem[64]
            mem[64] = mem[64] + 64
            mem[_236] = nextTokenID
            mem[_236 + 32] = arg1
            tokenByIndex.length++
            tokenByIndex[tokenByIndex.length].field_0 = nextTokenID
            address(tokenByIndex[tokenByIndex.length].field_256) = arg1
            ...
            mem[64] = mem[64] + 96
            idx = idx + 1
            s = sha3(mem[_282 + 32 len mem[_282]])
            continue 
    mem[mem[64]] = 32
