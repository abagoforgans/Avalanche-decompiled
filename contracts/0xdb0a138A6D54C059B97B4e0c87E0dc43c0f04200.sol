...
function balanceOf(address arg1) payable {
    ...
    require arg1 == arg1
    if not stor7[msg.sender]:
        if block.number <= stor6[tx.origin]:
            revert with 0, 'hmmmm what doing?'
    if not stor7[msg.sender]:
...
function mint(address arg1, uint256 arg2) payable {
    ...
    require arg1 == arg1
    if not stor7[msg.sender]:
        revert with 0, 'Only admins can mint'
    if not arg1:
...
function burn(address arg1, uint256 arg2) payable {
    ...
    require arg1 == arg1
    if not stor7[msg.sender]:
        revert with 0, 'Only admins can burn'
    if not arg1:
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if not stor7[msg.sender]:
        if block.number <= stor6[tx.origin]:
            revert with 0, 'hmmmm what doing?'
    if not stor7[msg.sender]:
        if block.number <= stor6[msg.sender]:
            revert with 0, 'hmmmm what doing?'
    if not msg.sender:
