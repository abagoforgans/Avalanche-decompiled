...
function _fallback() payable {
        ...
        if unknown_0xe5c9ceb3(?????) > uint32(call.func_hash) >> 224:
            if unknown_0xbe4b1772(?????) == uint32(call.func_hash) >> 224:
                ...
                if unknown_0xcc560a1d(?????) == uint32(call.func_hash) >> 224:
                    ...
                    if unknown_0xe3e0da3e(?????) == uint32(call.func_hash) >> 224:
                        require not msg.value
                        require calldata.size - 4 >= 32
                        require cd[4] <= test266151307()
                        require cd[4] + 35 < calldata.size
    ...
    if unknown_0xabce145b(?????) == uint32(call.func_hash) >> 224:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    if uint32(call.func_hash) >> 224 != unknown_0xafaa701f(?????):
    ...
    require return_data.size >= 96
    _38 = mem[128 len 4], Mask(224, 32, cd[4]) >> 32
    ...
    _55 = mem[mem[128 len 4], Mask(224, 32, cd[4]) >> 32 + 128]
    ...
    require _38 + (32 * _55) + 32 <= return_data.size
    s = _38 + 160
