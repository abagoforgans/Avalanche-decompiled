...
const sub_4e20a02c(?) = 48000 * 10^18

const sub_ffa8226e(?) = 2400 * 10^18
...
function sub_d6e5639d(?) payable {
    return sub_d6e5639dAddress
}
...
function distributeReward(address arg1, address arg2) payable {
    ...
    if not arg1:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply + 48000 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 48000 * 10^18
    if balanceOf[address(arg1)] + 48000 * 10^18 < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 48000 * 10^18
    emit Transfer(48000 * 10^18, 0, arg1);
    if not arg2:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply + 2400 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 2400 * 10^18
    if balanceOf[address(arg2)] + 2400 * 10^18 < balanceOf[address(arg2)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg2)] += 2400 * 10^18
    emit Transfer(2400 * 10^18, 0, arg2);
}
