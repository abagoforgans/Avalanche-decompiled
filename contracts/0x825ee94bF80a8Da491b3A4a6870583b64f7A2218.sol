...
const png = 0xe1c110e1b1b4a1ded0caf3e42bfbdbb7b5d7ce1c

const treasury = 0xd28731f314357b40b1ae1e12e5cdef6bd33fe63f

const sub_76cc09ed(?) = 0x9e4aabd2b3e60ee1322e94307d0776f2c8e6cfbb
...
function deposit() payable {
    ...
    if ext_call.return_data[0] > 0:
        require ext_code.size(rewardPoolAddress)
        call rewardPoolAddress.stake(uint256 arg1) with:
             gas gas_remaining wei
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] > arg1:
        if not arg1:
            ...
            if ext_code.size(lpPairAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[260 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor5), uint32(stor5), Mask(224, 32, arg1 - (10 * arg1 / 10000)) >> 32
            call lpPairAddress with:
               funct uint32(stor5)
                 gas gas_remaining wei
            ...
            if not return_data.size:
                if not ext_call.success:
                    revert with unknown_0xa9059cbb(?????), Mask(224, 0, stor5), uint32(stor5), arg1 - (10 * arg1 / 10000)
                if not unknown_0xa9059cbb(?????), Mask(224, 0, stor5):
                    revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
            else:
                mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        if not ext_call.return_data[0]:
            ...
            if ext_code.size(lpPairAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[260 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor5), uint32(stor5), Mask(224, 32, ext_call.return_data[0] - (10 * ext_call.return_data[0] / 10000)) >> 32
            mem[324 len 0] = 0
            call lpPairAddress with:
               funct uint32(stor5)
                 gas gas_remaining wei
