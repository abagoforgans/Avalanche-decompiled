...
function sub_deac925f(?) payable {
    ...
    if stor9[arg1].field_256:
        if stor9[arg1].field_256 == stor9[arg1].field_257 < 32:
            revert with 'NH{q', 34
        if arg3.length:
            stor9[arg1][1][].field_0 = Array(len=arg3.length, data=arg3[all])
        else:
...
function mint(address arg1, uint256 arg2, string arg3) payable {
    ...
    if stor6[arg2].field_0:
        if stor6[arg2].field_0 == stor6[arg2].field_1 < 32:
            revert with 'NH{q', 34
        if arg3.length:
            stor6[arg2][].field_0 = Array(len=arg3.length, data=arg3[all])
        else:
            stor6[arg2].field_0 = 0
            idx = 0
            while stor6[arg2].field_1 + 31 / 32 > idx:
