...
function sub_ab4e731d(?) {
    ...
    if owner == msg.sender:
        ...
        if mem[_745] >= cd[36]:
            ...
            call stor2.mem[mem[64] len 4] with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len 96], address(this.address), block.timestamp + 300, mem[mem[64] + 164 len (32 * ('cd', 4).length) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _950 = mem[64]
            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if not address(cd[164]):
                _1144 = mem[(32 * ('cd', 4).length - 1) + 128]
                mem[mem[64] + 4] = address(cd[100])
                mem[mem[64] + 36] = _735
                ...
                if cd[196] > _735:
                    revert with 0, 'SafeMath: subtraction overflow'
                require ('cd', 4).length - 1 < ('cd', 4).length
                _1218 = mem[(32 * ('cd', 4).length - 1) + 128]
                mem[mem[64] + 4] = address(cd[100])
            ...
            require ('cd', 4).length - 1 < ('cd', 4).length
            if not address(cd[164]):
                _1148 = mem[(32 * ('cd', 4).length - 1) + 128]
                mem[mem[64] + 4] = address(cd[100])
                mem[mem[64] + 36] = _735
                ...
                _1150 = mem[(32 * ('cd', 4).length - 1) + 128]
                mem[mem[64] + 4] = address(cd[164])
                mem[mem[64] + 36] = cd[196]
                ...
                if cd[196] > _735:
                    revert with 0, 'SafeMath: subtraction overflow'
                require ('cd', 4).length - 1 < ('cd', 4).length
                _1222 = mem[(32 * ('cd', 4).length - 1) + 128]
                mem[mem[64] + 4] = address(cd[100])
                mem[mem[64] + 36] = _735 - cd[196]
