...
function sub_ea92578a(?) {
    ...
    mem[floor32(('cd', 132).length) + 97] = 0x7ff36ab500000000000000000000000000000000000000000000000000000000
    ...
    call address(cd[68]).swapExactETHForTokens(uint256 rg1, address[] rg2, address rg3, uint256 rg4) with:
       value cd[4] wei
         gas gas_remaining wei
