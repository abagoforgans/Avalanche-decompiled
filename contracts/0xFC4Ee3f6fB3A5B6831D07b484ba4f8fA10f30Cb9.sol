...
function sub_59b05eeb(?) {
    ...
    if address(arg2) == address(arg4):
        ...
        if address(arg2) == address(arg4):
            ...
            if address(arg2) == address(arg4):
                ...
                revert with 0, mem[(32 * mem[_664] - 1) + _836 + ceil32(return_data.size) + 32]
            _663 = mem[64]
            mem[mem[64]] = 3
            mem[64] = mem[64] + 128
            if 0 >= mem[_663]:
            ...
            if not mem[(32 * mem[_663] - 1) + _835 + ceil32(return_data.size) + 32]:
                revert with 0, 'SellEstimatedOutput is zero'
            revert with 0, mem[(32 * mem[_663] - 1) + _835 + ceil32(return_data.size) + 32]
        _239 = mem[64]
        mem[mem[64]] = 3
        mem[64] = mem[64] + 128
        if 0 >= mem[_239]:
        ...
        if address(arg2) == address(arg4):
            ...
            if not mem[(32 * mem[_662] - 1) + _834 + ceil32(return_data.size) + 32]:
                revert with 0, 'SellEstimatedOutput is zero'
            revert with 0, mem[(32 * mem[_662] - 1) + _834 + ceil32(return_data.size) + 32]
        _661 = mem[64]
        mem[mem[64]] = 3
        mem[64] = mem[64] + 128
        if 0 >= mem[_661]:
        ...
        if not mem[(32 * mem[_661] - 1) + _833 + ceil32(return_data.size) + 32]:
            revert with 0, 'SellEstimatedOutput is zero'
        revert with 0, mem[(32 * mem[_661] - 1) + _833 + ceil32(return_data.size) + 32]
    mem[ceil32(return_data.size) + 96] = 3
    mem[ceil32(return_data.size) + 128] = address(arg4)
    mem[ceil32(return_data.size) + 160] = address(arg2)
    mem[ceil32(return_data.size) + 192] = address(arg3)
    ...
    if address(arg2) == address(arg4):
        ...
        if address(arg2) == address(arg4):
            ...
            if not mem[(32 * mem[_660] - 1) + _832 + ceil32(return_data.size) + 32]:
                revert with 0, 'SellEstimatedOutput is zero'
            revert with 0, mem[(32 * mem[_660] - 1) + _832 + ceil32(return_data.size) + 32]
        _659 = mem[64]
        mem[mem[64]] = 3
        mem[64] = mem[64] + 128
        if 0 >= mem[_659]:
        ...
        if not mem[(32 * mem[_659] - 1) + _831 + ceil32(return_data.size) + 32]:
            revert with 0, 'SellEstimatedOutput is zero'
        revert with 0, mem[(32 * mem[_659] - 1) + _831 + ceil32(return_data.size) + 32]
    _237 = mem[64]
    mem[mem[64]] = 3
    mem[64] = mem[64] + 128
    if 0 >= mem[_237]:
    ...
    if address(arg2) == address(arg4):
        ...
        if not mem[(32 * mem[_658] - 1) + _830 + ceil32(return_data.size) + 32]:
            revert with 0, 'SellEstimatedOutput is zero'
        revert with 0, mem[(32 * mem[_658] - 1) + _830 + ceil32(return_data.size) + 32]
    _657 = mem[64]
    mem[mem[64]] = 3
    mem[64] = mem[64] + 128
    if 0 >= mem[_657]:
    ...
    if not mem[(32 * mem[_657] - 1) + _829 + ceil32(return_data.size) + 32]:
        revert with 0, 'SellEstimatedOutput is zero'
    revert with 0, mem[(32 * mem[_657] - 1) + _829 + ceil32(return_data.size) + 32]
}
