...
function master_swap_intermediate() {
    ...
    if stor6 > stor8:
        ...
        require return_data.size >= 32
        _48 = mem[192 len 4], Mask(224, 0, stor9.field_32)
        ...
        mem[(32 * _51) + ceil32(return_data.size) + 288] = target_token_address
        require ext_code.size(stor3)
        staticcall stor3.0x70a08231 with:
                gas gas_remaining wei
               args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        mem[(32 * _51) + ceil32(return_data.size) + 320] = 0x38ed173900000000000000000000000000000000000000000000000000000000
        mem[(32 * _51) + ceil32(return_data.size) + 324] = ext_call.return_data[0]
        mem[(32 * _51) + ceil32(return_data.size) + 356] = minium_purchase_amount
        mem[(32 * _51) + ceil32(return_data.size) + 420] = stor2
        mem[(32 * _51) + ceil32(return_data.size) + 452] = 1756081673
        ...
        call stor12.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
             gas gas_remaining wei
            args ext_call.return_data[0], minium_purchase_amount, Array(len=2, data=mem[(32 * _51) + ceil32(return_data.size) + 516 len 64]), stor2, 1756081673
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        require mem[(32 * _51) + ceil32(return_data.size) + 320 len 4], ext_call.return_data[0 len 28] <= 4294967296
        require mem[(32 * _51) + ceil32(return_data.size) + 320 len 4], ext_call.return_data[0 len 28] + 32 <= return_data.size
        require mem[mem[(32 * _51) + ceil32(return_data.size) + 320 len 4], ext_call.return_data[0 len 28] + (32 * _51) + ceil32(return_data.size) + 320] <= 4294967296 and mem[(32 * _51) + ceil32(return_data.size) + 320 len 4], ext_call.return_data[0 len 28] + (32 * mem[mem[(32 * _51) + ceil32(return_data.size) + 320 len 4], ext_call.return_data[0 len 28] + (32 * _51) + ceil32(return_data.size) + 320]) + 32 <= return_data.size
