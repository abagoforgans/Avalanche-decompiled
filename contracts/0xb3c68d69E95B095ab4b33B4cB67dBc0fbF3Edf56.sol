...
function repayBorrowNative() payable {
    delegate implementationAddress with:
       funct call.data[0 len 4]
         gas gas_remaining wei
        args call.data[4 len calldata.size - 4]
...
function _addReservesNative() payable {
    delegate implementationAddress with:
       funct call.data[0 len 4]
         gas gas_remaining wei
        args call.data[4 len calldata.size - 4]
...
function redeemNative(uint256 arg1) {
    require calldata.size - 4 >= 32
    delegate implementationAddress with:
       funct call.data[0 len 4]
         gas gas_remaining wei
...
function borrowNative(uint256 arg1) {
    require calldata.size - 4 >= 32
    delegate implementationAddress with:
       funct call.data[0 len 4]
         gas gas_remaining wei
...
function redeemUnderlyingNative(uint256 arg1) {
    require calldata.size - 4 >= 32
    delegate implementationAddress with:
       funct call.data[0 len 4]
         gas gas_remaining wei
...
function repayBorrowBehalfNative(address arg1) payable {
    require calldata.size - 4 >= 32
    delegate implementationAddress with:
       funct call.data[0 len 4]
         gas gas_remaining wei
...
function liquidateBorrowNative(address arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    delegate implementationAddress with:
       funct call.data[0 len 4]
         gas gas_remaining wei
...
function getCash() {
    ...
    mem[ceil32(calldata.size) + 196 len floor32(ceil32(calldata.size) + 68)] = delegateToImplementation(bytes rg1), 0, 0, calldata.size, mem[196 len floor32(ceil32(calldata.size) + 68) - 68]
...
function _setImplementation(address arg1, bool arg2, bytes arg3) {
    ...
    if adminAddress != msg.sender:
        revert with 0, 
                    32,
                    65,
                    0xfe43577261707065644e617469766544656c656761746f723a3a5f736574496d706c656d656e746174696f6e3a2043616c6c6572206d7573742062652061646d69,
                    mem[ceil32(arg3.length) + 261 len 31]
    if not arg2:
        ...
        if not arg3.length % 32:
            ...
            delegate implementationAddress.mem[floor32(arg3.length) + ceil32(arg3.length) + 260 len 4] with:
                 gas gas_remaining wei
                args mem[floor32(arg3.length) + ceil32(arg3.length) + 264 len Mask(8 * -ceil32(arg3.length) + arg3.length + 32, 0, 0), mem[arg3.length + 160 len -arg3.length + ceil32(arg3.length)] - 4]
    else:
