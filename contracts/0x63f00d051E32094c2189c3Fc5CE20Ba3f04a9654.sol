...
function sub_e4da7feb(?) {
    if uint8(stor13.field_0):
        return not bool(uint8(stor13.field_0)), 64, 4, 0, 0
    if not uint8(stor13.field_8):
        return bool(uint8(stor13.field_8)), 64, 4, 0, 0
...
function sub_0161a290(?) {
    ...
    pairAddress = 0xb1532cb9fb365255ab76424037565a2f6b0cb9f8
    mem[100] = routerAddr
    mem[132] = -1
    ...
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    stor16.length++
    stor16[stor16.length].field_0 = pairAddress
    stor5 = 1
    mem[64] = (2 * ceil32(return_data.size)) + (32 * stor16.length) + 128
    mem[(2 * ceil32(return_data.size)) + 96] = stor16.length
    if not stor16.length:
        mem[(2 * ceil32(return_data.size)) + (32 * stor16.length) + 128] = 32
        mem[(2 * ceil32(return_data.size)) + (32 * stor16.length) + 160] = stor16.length
        idx = 0
        s = (2 * ceil32(return_data.size)) + 128
        t = (2 * ceil32(return_data.size)) + (32 * stor16.length) + 192
        while idx < stor16.length:
            ...
            continue 
        return memory
          from (2 * ceil32(return_data.size)) + (32 * stor16.length) + 128
           len (96 * stor16.length) + 64
    mem[(2 * ceil32(return_data.size)) + 128] = address(stor16.field_0)
    idx = (2 * ceil32(return_data.size)) + 128
    s = 0
    while (2 * ceil32(return_data.size)) + (32 * stor16.length) + 96 > idx:
    ...
    return memory
      from mem[64]
       len (2 * ceil32(return_data.size)) + (64 * stor16.length) + -mem[64] + 192
}
        ...
        if unknown_0x8f32d59b(?????) <= uint32(call.func_hash) >> 224:
            if unknown_0xdccd8bd2(?????) > uint32(call.func_hash) >> 224:
                ...
                if unknown_0xcc32d176(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    return treasuryFee
                if uint32(call.func_hash) >> 224 != unknown_0xd7c01032(?????):
                    require unknown_0xd8306786(?????) == uint32(call.func_hash) >> 224
                    require not msg.value
                    return bool(uint8(stor13.field_0))
                require not msg.value
                require calldata.size - 4 >= 96
                ...
                if unknown_0xe70e298e(?????) <= uint32(call.func_hash) >> 224:
                    ...
                    if uint32(call.func_hash) >> 224 != unknown_0xde05e712(?????):
                        if unknown_0xdf20fd49(?????) == uint32(call.func_hash) >> 224:
                            ...
                            swapThreshold = arg2
                        require unknown_0xe4da7feb(?????) == uint32(call.func_hash) >> 224
                        require not msg.value
                        if uint8(stor13.field_0):
                            return not bool(uint8(stor13.field_0)), 64, 4, 0, 0
                        if not uint8(stor13.field_8):
            ...
            if unknown_0x6ddd1713(?????) <= uint32(call.func_hash) >> 224:
                if unknown_0x72622a61(?????) <= uint32(call.func_hash) >> 224:
                    ...
                    if uint32(call.func_hash) >> 224 != unknown_0x6fcba377(?????):
                        if unknown_0x715018a6(?????) == uint32(call.func_hash) >> 224:
                            ...
                            require unknown_0x72538c3a(?????) == uint32(call.func_hash) >> 224
                            require not msg.value
                            require calldata.size - 4 >= 32
                            require arg1 == bool(arg1)
                            require msg.sender == owner
                ...
                if unknown_0x40b2f5b5(?????) > uint32(call.func_hash) >> 224:
                    ...
                    stor16[stor16.length].field_0 = pairAddress
                    stor5 = 1
                    mem[64] = (2 * ceil32(return_data.size)) + (32 * stor16.length) + 160
                    mem[(2 * ceil32(return_data.size)) + 128] = stor16.length
                    if not stor16.length:
                        mem[(2 * ceil32(return_data.size)) + (32 * stor16.length) + 160] = 32
                        mem[(2 * ceil32(return_data.size)) + (32 * stor16.length) + 192] = stor16.length
                        idx = 0
                        s = (2 * ceil32(return_data.size)) + 160
                        t = (2 * ceil32(return_data.size)) + (32 * stor16.length) + 224
                        while idx < stor16.length:
                            mem[t] = mem[s + 12 len 20]
                            idx = idx + 1
                            s = s + 32
                            ...
                            continue 
                        return memory
                          from (2 * ceil32(return_data.size)) + (32 * stor16.length) + 160
                           len (96 * stor16.length) + 64
                    mem[(2 * ceil32(return_data.size)) + 160] = address(stor16.field_0)
                    idx = (2 * ceil32(return_data.size)) + 160
                    s = 0
                    while (2 * ceil32(return_data.size)) + (32 * stor16.length) + 128 > idx:
                        mem[idx + 32] = stor16[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
                    ...
                    return memory
                      from mem[64]
                       len (2 * ceil32(return_data.size)) + (64 * stor16.length) + -mem[64] + 224
                if unknown_0x40b2f5b5(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    return address(sub_40b2f5b5Address)
                if unknown_0x61d027b3(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    return address(treasuryAddress)
                if uint32(call.func_hash) >> 224 != unknown_0x6ac5eeee(?????):
                    require unknown_0x6b90694c(?????) == uint32(call.func_hash) >> 224
                    require not msg.value
                    return routerAddr
                require not msg.value
                if uint8(stor13.field_0):
                    ...
                    if not (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18:
                        if not (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18:
                            if not -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18):
                                ...
                                if sub_e70e298e:
                                    mem[(4 * ceil32(return_data.size)) + 228 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor7), uint32(stor7), -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18), mem[(4 * ceil32(return_data.size)) + 228 len 28]
                            ...
                            if not sub_8a9b9d1c:
                                ...
                                if not -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18):
                                    ...
                                    if sub_e70e298e:
                                        mem[(6 * ceil32(return_data.size)) + 324 len 96] = 0, address(sub_40b2f5b5Address), -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18), Mask(224, 0, stor6)
                                ...
                                mem[(4 * ceil32(return_data.size)) + 228 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor6), uint32(stor6), (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18, mem[(4 * ceil32(return_data.size)) + 228 len 28]
                                    ...
                                    if return_data.size:
                                        ...
                                        if not -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18):
                                            ...
                                            if sub_e70e298e:
                                                ...
                                                mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 393] = 160
                                                mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 489] = 2
                                                idx = 0
                                                s = (4 * ceil32(return_data.size)) + ceil32(return_data.size) + 261
                                                t = (6 * ceil32(return_data.size)) + ceil32(return_data.size) + 521
                                                while idx < 2:
                                                    ...
                                                    t = t + 32
                                                    continue 
                                                mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 425] = address(sub_40b2f5b5Address)
                                                mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 457] = block.timestamp
                                                require ext_code.size(routerAddress)
                                                call routerAddress.swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                                     gas gas_remaining wei
                                                    args -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18), 0, 160, address(sub_40b2f5b5Address), block.timestamp, 2, mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 521 len 64]
                                                ...
                                                require return_data.size >= 32
                                                if not ext_call.return_data[0]:
                                                    mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 325] = ext_call.return_data[0]
                                                    mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 357] = ext_call.return_data[0] * treasuryFee / 100
                                                    mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 389] = ext_call.return_data[0] * utilityFee / 100
                                                    mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 421] = ext_call.return_data[0] * liquidityFee / 100
                                                    mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 453] = ext_call.return_data[0]
                                                    emit 0xc20fef04: mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 325 len (13 * ceil32(return_data.size)) + 160]
                                                else:
                                                    mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 329] = 57005
                                                    mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 361] = ext_call.return_data[0]
                                                    call sub_82d90f68Address.0xa9059cbb with:
                                                         gas gas_remaining wei
                                                        args mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 329 len (13 * ceil32(return_data.size)) + 64]
                                                    if not ext_call.success:
                                                        revert with ext_call.return_data[0 len return_data.size]
                                                    require return_data.size >= 32
                                                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                                                    ...
                                                    mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 421] = ext_call.return_data[0] * liquidityFee / 100
                                                    mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 453] = ext_call.return_data[0]
                                                    emit 0xc20fef04: mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 325 len (15 * ceil32(return_data.size)) + 160]
                                else:
                                    if not ext_call.success:
                                        revert with 0, 'TransferHelper: TRANSFER_FAILED'
                                    if mem[96]:
                        ...
                        if not (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18:
                            if not -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18):
                                ...
                                if sub_e70e298e:
                                    mem[(6 * ceil32(return_data.size)) + 228 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor7), uint32(stor7), -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18), mem[(6 * ceil32(return_data.size)) + 228 len 28]
                            ...
                            if not sub_8a9b9d1c:
                                ...
                                if not -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18):
                                    ...
                                    if sub_e70e298e:
                                        mem[(7 * ceil32(return_data.size)) + 324 len 96] = 0, address(sub_40b2f5b5Address), -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18), Mask(224, 0, stor6)
                                        call stableCoinAddress with:
                                           funct uint32(0, address(sub_40b2f5b5Address), -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18))
                                             gas gas_remaining wei
                                            args Mask(512, 0, stor6)
                                ...
                                mem[(6 * ceil32(return_data.size)) + 164] = address(treasuryAddress)
                                mem[(6 * ceil32(return_data.size)) + 196] = (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18
                                mem[(6 * ceil32(return_data.size)) + 128] = 68
                                mem[(6 * ceil32(return_data.size)) + 164 len 28] = Mask(224, 0, stor6)
                                mem[(6 * ceil32(return_data.size)) + 160 len 4] = unknown_0xa9059cbb(?????)
                                mem[(6 * ceil32(return_data.size)) + 228 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor6), uint32(stor6), (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18, mem[(6 * ceil32(return_data.size)) + 228 len 28]
                                        ...
                                        if not -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18):
                                            ...
                                            if sub_e70e298e:
                                                ...
                                                call routerAddress.mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len (7 * ceil32(return_data.size)) + (32 * mem[(6 * ceil32(return_data.size)) + 228]) + -mem[64] + 516]
                                                if not ext_call.success:
                                                    revert with ext_call.return_data[0 len return_data.size]
                                                ...
                                                _14621 = mem[_14359]
                                                if not mem[_14359]:
                                                    emit 0xc20fef04: ext_call.return_data[0], ext_call.return_data[0] * treasuryFee / 100, ext_call.return_data[0] * utilityFee / 100, ext_call.return_data[0] * liquidityFee / 100, mem[_14359]
                                                else:
                                                    mem[mem[64] + 4] = 57005
                                                    mem[mem[64] + 36] = _14621
                                                    call sub_82d90f68Address.0xa9059cbb with:
                                                         gas gas_remaining wei
                                                        args 57005, _14621
                                                    mem[mem[64]] = ext_call.return_data[0]
                                                    ...
                                                    mem[64] = mem[64] + ceil32(return_data.size)
                                                    require return_data.size >= 32
                                                    require mem[_15087] == bool(mem[_15087])
                                                    emit 0xc20fef04: ext_call.return_data[0], ext_call.return_data[0] * treasuryFee / 100, ext_call.return_data[0] * utilityFee / 100, ext_call.return_data[0] * liquidityFee / 100, _14621
                else:
                            ...
                            if not -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18):
                                ...
                                if sub_e70e298e:
                                    ...
                                    while idx < 2:
                                        ...
                                        t = t + 32
                                        continue 
                                    mem[(6 * ceil32(return_data.size)) + 420] = address(sub_40b2f5b5Address)
                                    ...
                                    if not ext_call.return_data[0]:
                                        ...
                                        mem[(8 * ceil32(return_data.size)) + 352] = ext_call.return_data[0] * treasuryFee / 100
                                        mem[(8 * ceil32(return_data.size)) + 384] = ext_call.return_data[0] * utilityFee / 100
                                        mem[(8 * ceil32(return_data.size)) + 416] = ext_call.return_data[0] * liquidityFee / 100
                                        mem[(8 * ceil32(return_data.size)) + 448] = ext_call.return_data[0]
                                        emit 0xc20fef04: mem[(8 * ceil32(return_data.size)) + 320 len (13 * ceil32(return_data.size)) + 160]
                                    else:
                                        mem[(8 * ceil32(return_data.size)) + 324] = 57005
                                        ...
                                        mem[(8 * ceil32(return_data.size)) + 416] = ext_call.return_data[0] * liquidityFee / 100
                                        mem[(8 * ceil32(return_data.size)) + 448] = ext_call.return_data[0]
                                        emit 0xc20fef04: mem[(8 * ceil32(return_data.size)) + 320 len (15 * ceil32(return_data.size)) + 160]
                        else:
                            if not sub_8a9b9d1c:
                                mem[(4 * ceil32(return_data.size)) + 256] = stableCoinAddress
                                staticcall routerAddress.WAVAX() with:
                                ...
                                if not -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18):
                                    ...
                                    if sub_e70e298e:
                                        mem[(6 * ceil32(return_data.size)) + 420 len 96] = 0, address(sub_40b2f5b5Address), -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18), Mask(224, 0, stor6)
                                        var152001 = 96
                                        call stableCoinAddress with:
                                             gas gas_remaining wei
                                            args Mask(512, 0, stor6)
                                ...
                                if return_data.size:
                                    ...
                                    if not -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18):
                                        ...
                                        if sub_e70e298e:
                                            ...
                                            mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 457] = 0
                                            mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 489] = 160
                                            mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 585] = 2
                                            idx = 0
                                            ...
                                            while idx < 2:
                                                ...
                                                t = t + 32
                                                continue 
                                            mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 521] = address(sub_40b2f5b5Address)
                                            mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 553] = block.timestamp
                                            require ext_code.size(routerAddress)
                                            call routerAddress.swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                                 gas gas_remaining wei
                                            ...
                                            require return_data.size >= 32
                                            if not ext_call.return_data[0]:
                                                mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 421] = ext_call.return_data[0]
                                                mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 453] = ext_call.return_data[0] * treasuryFee / 100
                                                mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 485] = ext_call.return_data[0] * utilityFee / 100
                                                mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 517] = ext_call.return_data[0] * liquidityFee / 100
                                                mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 549] = ext_call.return_data[0]
                                                emit 0xc20fef04: mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 421 len (13 * ceil32(return_data.size)) + 160]
                                            else:
                                                mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 425] = 57005
                                                mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 457] = ext_call.return_data[0]
                                                call sub_82d90f68Address.0xa9059cbb with:
                                                     gas gas_remaining wei
                                                    args mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 425 len (13 * ceil32(return_data.size)) + 64]
                                                if not ext_call.success:
                                                    revert with ext_call.return_data[0 len return_data.size]
                                                require return_data.size >= 32
                                                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                                                ...
                                                mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 517] = ext_call.return_data[0] * liquidityFee / 100
                                                mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 549] = ext_call.return_data[0]
                                                emit 0xc20fef04: mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 421 len (15 * ceil32(return_data.size)) + 160]
                                else:
                                    if not ext_call.success:
                                        revert with 0, 'TransferHelper: TRANSFER_FAILED'
                                    if not mem[96]:
                                        if not -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18):
                                            ...
                                            if sub_e70e298e:
                                                ...
                                                _20453 = mem[_20271]
                                                if not mem[_20271]:
                                                    emit 0xc20fef04: ext_call.return_data[0], ext_call.return_data[0] * treasuryFee / 100, ext_call.return_data[0] * utilityFee / 100, ext_call.return_data[0] * liquidityFee / 100, mem[_20271]
                                                else:
                                                    mem[mem[64] + 4] = 57005
                                                    mem[mem[64] + 36] = _20453
                                                    call sub_82d90f68Address.0xa9059cbb with:
                                                         gas gas_remaining wei
                                                        args 57005, _20453
                                                    mem[mem[64]] = ext_call.return_data[0]
                                                    ...
                                                    mem[64] = mem[64] + ceil32(return_data.size)
                                                    require return_data.size >= 32
                                                    require mem[_20831] == bool(mem[_20831])
                                                    emit 0xc20fef04: ext_call.return_data[0], ext_call.return_data[0] * treasuryFee / 100, ext_call.return_data[0] * utilityFee / 100, ext_call.return_data[0] * liquidityFee / 100, _20453
                                    else:
                                        require mem[96] >= 32
                                        require ext_call.return_data[0] == bool(ext_call.return_data[0])
                                        if not ext_call.return_data[0]:
                                        ...
                                        if not -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18):
                                            ...
                                            if sub_e70e298e:
                                                ...
                                                _20460 = mem[_20274]
                                                if not mem[_20274]:
                                                    emit 0xc20fef04: ext_call.return_data[0], ext_call.return_data[0] * treasuryFee / 100, ext_call.return_data[0] * utilityFee / 100, ext_call.return_data[0] * liquidityFee / 100, mem[_20274]
                                                else:
                                                    mem[mem[64] + 4] = 57005
                                                    mem[mem[64] + 36] = _20460
                                                    call sub_82d90f68Address.0xa9059cbb with:
                                                         gas gas_remaining wei
                                                        args 57005, _20460
                                                    mem[mem[64]] = ext_call.return_data[0]
                                                    ...
                                                    mem[64] = mem[64] + ceil32(return_data.size)
                                                    require return_data.size >= 32
                                                    require mem[_20838] == bool(mem[_20838])
                                                    emit 0xc20fef04: ext_call.return_data[0], ext_call.return_data[0] * treasuryFee / 100, ext_call.return_data[0] * utilityFee / 100, ext_call.return_data[0] * liquidityFee / 100, _20460
                    else:
                        if ext_call.return_data[0] * liquidityFee / 100 < ext_call.return_data[0] * liquidityFee / 100 / 2:
                            revert with 0, 17
                        ...
                        if not (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18:
                            ...
                            if not sub_8a9b9d1c:
                                ...
                                if not -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18):
                                    ...
                                    if sub_e70e298e:
                                        mem[(7 * ceil32(return_data.size)) + 420 len 96] = 0, address(sub_40b2f5b5Address), -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18), Mask(224, 0, stor6)
                                        var164001 = 96
                                        call stableCoinAddress with:
                                             gas gas_remaining wei
                                            args Mask(512, 0, stor6)
                                    ...
                                    if return_data.size:
                                        ...
                                        if not -((ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * liquidityFee / 2 / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18) - ((ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) - (ext_call.return_data[0] * 1000 * 10^18 * treasuryFee / (10 * liquidityFee / 2) + (10 * treasuryFee) + (10 * utilityFee)) / 100 * 10^18):
                                            ...
                                            if sub_e70e298e:
                                                ...
                                                _20530 = mem[_20304]
                                                if not mem[_20304]:
                                                    emit 0xc20fef04: ext_call.return_data[0], ext_call.return_data[0] * treasuryFee / 100, ext_call.return_data[0] * utilityFee / 100, ext_call.return_data[0] * liquidityFee / 100, mem[_20304]
                                                else:
                                                    mem[mem[64] + 4] = 57005
                                                    mem[mem[64] + 36] = _20530
                                                    call sub_82d90f68Address.0xa9059cbb with:
                                                         gas gas_remaining wei
                                                        args 57005, _20530
                                                    mem[mem[64]] = ext_call.return_data[0]
                                                    ...
                                                    mem[64] = mem[64] + ceil32(return_data.size)
                                                    require return_data.size >= 32
                                                    require mem[_20908] == bool(mem[_20908])
                                                    emit 0xc20fef04: ext_call.return_data[0], ext_call.return_data[0] * treasuryFee / 100, ext_call.return_data[0] * utilityFee / 100, ext_call.return_data[0] * liquidityFee / 100, _20530
