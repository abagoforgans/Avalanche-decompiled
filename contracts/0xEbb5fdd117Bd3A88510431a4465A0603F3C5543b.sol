    ...
    if not 7 * arg2.length:
        ...
        while idx < arg2.length:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require (7 * idx) + 7 < 7 * arg2.length
            mem[(32 * (7 * idx) + 7) + (32 * arg2.length) + 160] = ext_call.return_data[0]
            require ext_code.size(address(_159))
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require (7 * idx) + 8 < 7 * arg2.length
            mem[(32 * (7 * idx) + 8) + (32 * arg2.length) + 160] = ext_call.return_data[0]
            require ext_code.size(address(_159))
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require (7 * idx) + 9 < 7 * arg2.length
            mem[(32 * (7 * idx) + 9) + (32 * arg2.length) + 160] = ext_call.return_data[0]
            require ext_code.size(address(ext_call.return_data[0]))
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require (7 * idx) + 10 < 7 * arg2.length
            mem[(32 * (7 * idx) + 10) + (32 * arg2.length) + 160] = ext_call.return_data[0]
            mem[(32 * arg2.length) + (32 * 7 * arg2.length) + 164] = arg1
            require ext_code.size(address(_159))
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require (7 * idx) + 11 < 7 * arg2.length
            mem[(32 * (7 * idx) + 11) + (32 * arg2.length) + 160] = ext_call.return_data[0]
            idx = idx + 1
            continue 
    else:
