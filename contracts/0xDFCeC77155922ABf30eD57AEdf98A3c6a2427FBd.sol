...
const quorumVotes = 4000000 * 10^18
...
function __queueSetTimelockPendingAdmin(address arg1, uint256 arg2) {
    ...
    require ext_code.size(address(timelockAddress))
    call address(timelockAddress).queueTransaction(address rg1, uint256 rg2, string rg3, bytes rg4, uint256 rg5) with:
         gas gas_remaining wei
...
function state(uint256 arg1) {
    ...
    if receipt[arg1].field_2304 <= receipt[arg1].field_2560:
        return 3
    if receipt[arg1].field_2304 < 4000000 * 10^18:
        return 3
    ...
    if uint8(receipt[arg1].field_2824):
        return 7
    require ext_code.size(address(timelockAddress))
    staticcall address(timelockAddress).GRACE_PERIOD() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
            ...
            while idx < receipt[arg1].field_768:
                ...
                if not bool(receipt[arg1][idx + 5].field_0):
                    ...
                    if not bool(receipt[arg1][idx + 6].field_0):
                        ...
                        mem[mem[64] + 132] = receipt[arg1].field_512
                        require ext_code.size(address(timelockAddress))
                        call address(timelockAddress).cancelTransaction(address rg1, uint256 rg2, string rg3, bytes rg4, uint256 rg5) with:
                             gas gas_remaining wei
                            args address(receipt[arg1][idx + 3].field_0), receipt[arg1][idx + 4].field_0, 160, 224, receipt[arg1].field_512, receipt[arg1][idx + 5].field_0 % 128, Mask(248, 8, receipt[arg1][idx + 5].field_0), receipt[arg1][idx + 6].field_0 % 128, Mask(248, 8, receipt[arg1][idx + 6].field_0)
                    else:
                        if bool(receipt[arg1][idx + 6].field_0) != 1:
                    ...
                    if bool(receipt[arg1][idx + 5].field_0) != 1:
                        ...
                        mem[_499 + 100] = s + 192
                        if not bool(receipt[arg1][idx + 6].field_0):
                            mem[_499 + s + 196] = receipt[arg1][idx + 6].field_1 % 128
                            mem[_499 + s + 228] = Mask(248, 8, receipt[arg1][idx + 6].field_0)
                            mem[_499 + 132] = receipt[arg1].field_512
                            require ext_code.size(address(timelockAddress))
                            call address(timelockAddress).mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                            ...
                            if bool(receipt[arg1][idx + 6].field_0) != 1:
                                ...
                                mem[_499 + s + 196] = uint255(receipt[arg1][idx + 6].field_1)
                                mem[0] = sha3(sha3(arg1, 4) + 6) + idx
                                t = 0
                                u = sha3(sha3(sha3(arg1, 4) + 6) + idx)
                                while t < uint255(receipt[arg1][idx + 6].field_1):
                                    mem[_499 + s + t + 228] = stor[u]
                                    t = t + 32
                                    u = u + 1
                                    continue 
                                mem[_499 + 132] = receipt[arg1].field_512
                ...
                while idx < receipt[arg1].field_768:
                    ...
                    if not bool(receipt[arg1][idx + 5].field_0):
                        ...
                        if bool(receipt[arg1][idx + 5].field_0) != 1:
                            ...
                            mem[_497 + 100] = s + 192
                            if not bool(receipt[arg1][idx + 6].field_0):
                                mem[_497 + s + 196] = receipt[arg1][idx + 6].field_1 % 128
                                mem[_497 + s + 228] = Mask(248, 8, receipt[arg1][idx + 6].field_0)
                                mem[_497 + 132] = receipt[arg1].field_512
                                require ext_code.size(address(timelockAddress))
                                call address(timelockAddress).mem[mem[64] len 4] with:
                                     gas gas_remaining wei
                                ...
                                if bool(receipt[arg1][idx + 6].field_0) != 1:
                                    ...
                                    mem[_497 + s + 196] = uint255(receipt[arg1][idx + 6].field_1)
                                    mem[0] = sha3(sha3(arg1, 4) + 6) + idx
                                    t = 0
                                    u = sha3(sha3(sha3(arg1, 4) + 6) + idx)
                                    while t < uint255(receipt[arg1][idx + 6].field_1):
                                        mem[_497 + s + t + 228] = stor[u]
                                        t = t + 32
                                        u = u + 1
                                        continue 
                                    mem[_497 + 132] = receipt[arg1].field_512
                        ...
                        while idx < receipt[arg1].field_768:
                            ...
                            if not bool(receipt[arg1][idx + 5].field_0):
                                ...
                                if bool(receipt[arg1][idx + 5].field_0) != 1:
                                    ...
                                    mem[_471 + 100] = s + 192
                                    if not bool(receipt[arg1][idx + 6].field_0):
                                        mem[_471 + s + 196] = receipt[arg1][idx + 6].field_1 % 128
                                        mem[_471 + s + 228] = Mask(248, 8, receipt[arg1][idx + 6].field_0)
                                        mem[_471 + 132] = receipt[arg1].field_512
                                        require ext_code.size(address(timelockAddress))
                                        call address(timelockAddress).mem[mem[64] len 4] with:
                                             gas gas_remaining wei
                                        ...
                                        if bool(receipt[arg1][idx + 6].field_0) != 1:
                                            ...
                                            mem[_471 + s + 196] = uint255(receipt[arg1][idx + 6].field_1)
                                            mem[0] = sha3(sha3(arg1, 4) + 6) + idx
                                            t = 0
                                            u = sha3(sha3(sha3(arg1, 4) + 6) + idx)
                                            while t < uint255(receipt[arg1][idx + 6].field_1):
                                                mem[_471 + s + t + 228] = stor[u]
                                                t = t + 32
                                                u = u + 1
                                                continue 
                                            mem[_471 + 132] = receipt[arg1].field_512
                                ...
                                while idx < receipt[arg1].field_768:
                                    ...
                                    if not bool(receipt[arg1][idx + 5].field_0):
                                        ...
                                        if bool(receipt[arg1][idx + 5].field_0) != 1:
                                            ...
                                            mem[_483 + 100] = s + 192
                                            if not bool(receipt[arg1][idx + 6].field_0):
                                                mem[_483 + s + 196] = receipt[arg1][idx + 6].field_1 % 128
                                                mem[_483 + s + 228] = Mask(248, 8, receipt[arg1][idx + 6].field_0)
                                                mem[_483 + 132] = receipt[arg1].field_512
                                                require ext_code.size(address(timelockAddress))
                                                call address(timelockAddress).mem[mem[64] len 4] with:
                                                     gas gas_remaining wei
                                                    args mem[mem[64] + 4 len _483 + s + -mem[64] + 256]
                                            else:
                                                if bool(receipt[arg1][idx + 6].field_0) != 1:
                                                    mem[_483 + 132] = receipt[arg1].field_512
                                                    require ext_code.size(address(timelockAddress))
                                                    ...
                                                    mem[_483 + s + 196] = uint255(receipt[arg1][idx + 6].field_1)
                                                    mem[0] = sha3(sha3(arg1, 4) + 6) + idx
                                                    t = 0
                                                    u = sha3(sha3(sha3(arg1, 4) + 6) + idx)
                                                    while t < uint255(receipt[arg1][idx + 6].field_1):
                                                        mem[_483 + s + t + 228] = stor[u]
                                                        t = t + 32
                                                        u = u + 1
                                                        continue 
                                                    mem[_483 + 132] = receipt[arg1].field_512
