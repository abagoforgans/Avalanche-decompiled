...
function g(uint256 arg1, uint256 arg2) payable {
    ...
    staticcall stor2.randomizer() with:
    ...
    if uint16(sha3(arg1, arg2)) % 10:
        return 0
    if Mask(2, 64, sha3(arg1, arg2)) >> 64 >= 4:
        revert with 'NH{q', 50
    return uint8(stor0.field_Mask(2, 64, sha3(arg1, arg2)) >> 61)
}
...
function f(uint256 arg1, uint256 arg2, uint256 arg3) payable {
    ...
    if uint16(sha3(arg2, arg3)) % 10:
        return 0
    if Mask(2, 64, sha3(arg2, arg3)) >> 64 >= 4:
        revert with 'NH{q', 50
    return uint8(stor0.field_Mask(2, 64, sha3(arg2, arg3)) >> 61)
}
