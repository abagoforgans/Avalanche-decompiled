...
function sub_111772c9(?) {
    ...
    if arg2:
        ...
        while idx < stor5.length:
            ...
            require ext_code.size(stor5[idx].field_1024)
            call stor5[idx].field_1024.0x4c69c00f with:
                 gas gas_remaining wei
                args oracleAddress
...
function sub_262aa6e7(?) {
    ...
    stor6[address(arg2)].field_1536 = address(arg4)
    stor6[address(arg2)].field_1696 = stor5[stor6[address(arg2)].field_512].field_1696
    stor6[address(arg2)].field_1704 = Mask(88, 0, bool(arg6))
    stor6[address(arg2)].field_1712 = 0
}
