...
function manualswap() {
    ...
    allowance[address(this.address)][stor14] = stor2[address(this.address)] / stor6 / 100000000 * 10^18
    emit Approval((stor2[address(this.address)] / stor6 / 100000000 * 10^18), this.address, stor14);
