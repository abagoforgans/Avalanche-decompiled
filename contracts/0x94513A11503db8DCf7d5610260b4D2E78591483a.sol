...
function sub_0eef1c14(?) {
    ...
    if stor14[address(msg.sender)]:
        revert with 0, 'NODE CREATION: Malicious address'
    mem[ceil32(ceil32(arg1.length)) + 101] = uint8(arg2)
    require ext_code.size(nodeRewardManagementAddress)
    staticcall nodeRewardManagementAddress.0x7a56cdf2 with:
            gas gas_remaining wei
           args uint8(arg2)
    ...
    if ext_call.return_data[0] < swapTokensAmount:
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
        emit 0x33b56213: ext_call.return_data[0], msg.sender, uint8(arg2)
    else:
        if not uint8(stor12.field_200):
            require ext_code.size(nodeRewardManagementAddress)
            call nodeRewardManagementAddress.0x90219732 with:
            ...
            if uint8(stor12.field_192):
                ...
                if owner == msg.sender:
                    ...
                    mem[ceil32(ceil32(arg1.length)) + (4 * ceil32(return_data.size)) + 129] = tokenAddress
                    require ext_code.size(routerAddress)
                    staticcall routerAddress.0x73b295c2 with:
                            gas gas_remaining wei
                    ...
                    mem[ceil32(ceil32(arg1.length)) + (6 * ceil32(return_data.size)) + 197] = routerAddress
                    mem[ceil32(ceil32(arg1.length)) + (6 * ceil32(return_data.size)) + 229] = ext_call.return_data[0] * 0 or sub_9ee8e198 / 100 * sub_6ede0f71 / 100
                    require ext_code.size(tokenAddress)
                    call tokenAddress.approve(address arg1, uint256 arg2) with:
                         gas gas_remaining wei
                        args routerAddress, ext_call.return_data[0] * 0 or sub_9ee8e198 / 100 * sub_6ede0f71 / 100, mem[ceil32(ceil32(arg1.length)) + (6 * ceil32(return_data.size)) + 261 len 9 * ceil32(return_data.size)]
                    ...
                    mem[ceil32(ceil32(arg1.length)) + (8 * ceil32(return_data.size)) + 197] = ext_call.return_data[0] * 0 or sub_9ee8e198 / 100 * sub_6ede0f71 / 100
                    mem[ceil32(ceil32(arg1.length)) + (8 * ceil32(return_data.size)) + 261] = 160
                    mem[ceil32(ceil32(arg1.length)) + (8 * ceil32(return_data.size)) + 357] = 2
                    idx = 0
                    s = ceil32(ceil32(arg1.length)) + (4 * ceil32(return_data.size)) + 129
                    t = ceil32(ceil32(arg1.length)) + (8 * ceil32(return_data.size)) + 389
                    while idx < 2:
                        mem[t] = mem[s + 12 len 20]
                        idx = idx + 1
                        s = s + 32
                    ...
                    call routerAddress.swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args ext_call.return_data[0] * 0 or sub_9ee8e198 / 100 * sub_6ede0f71 / 100, 0, 160, address(this.address), block.timestamp, 2, mem[ceil32(ceil32(arg1.length)) + (8 * ceil32(return_data.size)) + 389 len 64]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    if ext_call.return_data[0] * 0 or sub_9ee8e198 / 100 < ext_call.return_data[0] * 0 or sub_9ee8e198 / 100 * sub_6ede0f71 / 100:
                        revert with 0, 17
                    mem[ceil32(ceil32(arg1.length)) + (8 * ceil32(return_data.size)) + 197] = reservePoolAddress
                    mem[ceil32(ceil32(arg1.length)) + (8 * ceil32(return_data.size)) + 229] = (ext_call.return_data[0] * 0 or sub_9ee8e198 / 100) - (ext_call.return_data[0] * 0 or sub_9ee8e198 / 100 * sub_6ede0f71 / 100)
                    require ext_code.size(tokenAddress)
                    ...
                    mem[ceil32(ceil32(arg1.length)) + (8 * ceil32(return_data.size)) + 193] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    ...
                    if ext_call.return_data[0] * liquidityPoolFee / 100 < ext_call.return_data[0] * liquidityPoolFee / 100 / 2:
                        revert with 0, 17
                    mem[ceil32(ceil32(arg1.length)) + (10 * ceil32(return_data.size)) + 193] = 2
                    mem[ceil32(ceil32(arg1.length)) + (10 * ceil32(return_data.size)) + 225] = tokenAddress
                    require ext_code.size(routerAddress)
                    staticcall routerAddress.0x73b295c2 with:
                            gas gas_remaining wei
                    ...
                    require return_data.size >= 32
                    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
                    mem[ceil32(ceil32(arg1.length)) + (10 * ceil32(return_data.size)) + 257] = ext_call.return_data[12 len 20]
                    mem[ceil32(ceil32(arg1.length)) + (11 * ceil32(return_data.size)) + 293] = routerAddress
                    mem[ceil32(ceil32(arg1.length)) + (11 * ceil32(return_data.size)) + 325] = ext_call.return_data[0] * liquidityPoolFee / 100 / 2
                    require ext_code.size(tokenAddress)
                    call tokenAddress.approve(address arg1, uint256 arg2) with:
                         gas gas_remaining wei
                        args routerAddress, ext_call.return_data[0] * liquidityPoolFee / 100 / 2
                    mem[ceil32(ceil32(arg1.length)) + (11 * ceil32(return_data.size)) + 289] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    mem[ceil32(ceil32(arg1.length)) + (13 * ceil32(return_data.size)) + 289] = 0x762b156200000000000000000000000000000000000000000000000000000000
                    mem[ceil32(ceil32(arg1.length)) + (13 * ceil32(return_data.size)) + 293] = ext_call.return_data[0] * liquidityPoolFee / 100 / 2
                    mem[ceil32(ceil32(arg1.length)) + (13 * ceil32(return_data.size)) + 357] = 160
                    mem[ceil32(ceil32(arg1.length)) + (13 * ceil32(return_data.size)) + 453] = 2
                    idx = 0
                    s = ceil32(ceil32(arg1.length)) + (10 * ceil32(return_data.size)) + 225
                    t = ceil32(ceil32(arg1.length)) + (13 * ceil32(return_data.size)) + 485
                    while idx < 2:
                        mem[t] = mem[s + 12 len 20]
                        idx = idx + 1
                        s = s + 32
                        t = t + 32
                        continue 
                    mem[ceil32(ceil32(arg1.length)) + (13 * ceil32(return_data.size)) + 389] = this.address
                    mem[ceil32(ceil32(arg1.length)) + (13 * ceil32(return_data.size)) + 421] = block.timestamp
                    require ext_code.size(routerAddress)
                    call routerAddress.swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args Mask(255, 1, ext_call.return_data[0] * liquidityPoolFee / 100), 0, 160, address(this.address), block.timestamp, 2, mem[ceil32(ceil32(arg1.length)) + (13 * ceil32(return_data.size)) + 485 len 64]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    if eth.balance(this.address) < eth.balance(this.address):
                        revert with 0, 17
                    mem[ceil32(ceil32(arg1.length)) + (13 * ceil32(return_data.size)) + 293] = routerAddress
                    mem[ceil32(ceil32(arg1.length)) + (13 * ceil32(return_data.size)) + 325] = (ext_call.return_data[0] * liquidityPoolFee / 100) - (ext_call.return_data[0] * liquidityPoolFee / 100 / 2)
                    require ext_code.size(tokenAddress)
                    call tokenAddress.approve(address arg1, uint256 arg2) with:
                         gas gas_remaining wei
                        args routerAddress, (ext_call.return_data[0] * liquidityPoolFee / 100) - (ext_call.return_data[0] * liquidityPoolFee / 100 / 2), mem[ceil32(ceil32(arg1.length)) + (13 * ceil32(return_data.size)) + 357 len 5 * ceil32(return_data.size)]
                    mem[ceil32(ceil32(arg1.length)) + (13 * ceil32(return_data.size)) + 289] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    mem[ceil32(ceil32(arg1.length)) + (15 * ceil32(return_data.size)) + 357] = 0
                    mem[ceil32(ceil32(arg1.length)) + (15 * ceil32(return_data.size)) + 389] = 0
                    mem[ceil32(ceil32(arg1.length)) + (15 * ceil32(return_data.size)) + 421] = 0
                    mem[ceil32(ceil32(arg1.length)) + (15 * ceil32(return_data.size)) + 453] = block.timestamp
                    require ext_code.size(routerAddress)
                    call routerAddress.addLiquidityAVAX(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
                         gas gas_remaining wei
                        args tokenAddress, (ext_call.return_data[0] * liquidityPoolFee / 100) - (ext_call.return_data[0] * liquidityPoolFee / 100 / 2), 0, 0, 0, block.timestamp, mem[ceil32(ceil32(arg1.length)) + (15 * ceil32(return_data.size)) + 485 len 9 * ceil32(return_data.size)]
                    mem[ceil32(ceil32(arg1.length)) + (15 * ceil32(return_data.size)) + 289 len 96] = ext_call.return_data[0 len 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 96
                    mem[ceil32(ceil32(arg1.length)) + (16 * ceil32(return_data.size)) + 289] = ext_call.return_data[0] * liquidityPoolFee / 100 / 2
                    mem[ceil32(ceil32(arg1.length)) + (16 * ceil32(return_data.size)) + 321] = 0
                    mem[ceil32(ceil32(arg1.length)) + (16 * ceil32(return_data.size)) + 353] = (ext_call.return_data[0] * liquidityPoolFee / 100) - (ext_call.return_data[0] * liquidityPoolFee / 100 / 2)
                    emit SwapAndLiquify(uint256 arg1, uint256 arg2, uint256 arg3):
                                        mem[ceil32(ceil32(arg1.length)) + (16 * ceil32(return_data.size)) + 289 len ceil32(return_data.size) + 96],
                    mem[ceil32(ceil32(arg1.length)) + (16 * ceil32(return_data.size)) + 293] = this.address
                    require ext_code.size(tokenAddress)
                    staticcall tokenAddress.0x70a08231 with:
                            gas gas_remaining wei
                           args this.address
                    mem[ceil32(ceil32(arg1.length)) + (16 * ceil32(return_data.size)) + 289] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[ceil32(ceil32(arg1.length)) + (17 * ceil32(return_data.size)) + 289] = 2
                    mem[ceil32(ceil32(arg1.length)) + (17 * ceil32(return_data.size)) + 321] = tokenAddress
                    require ext_code.size(routerAddress)
                    staticcall routerAddress.0x73b295c2 with:
                            gas gas_remaining wei
                    mem[ceil32(ceil32(arg1.length)) + (17 * ceil32(return_data.size)) + 385] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
                    mem[ceil32(ceil32(arg1.length)) + (17 * ceil32(return_data.size)) + 353] = ext_call.return_data[12 len 20]
                    mem[ceil32(ceil32(arg1.length)) + (18 * ceil32(return_data.size)) + 389] = routerAddress
                    mem[ceil32(ceil32(arg1.length)) + (18 * ceil32(return_data.size)) + 421] = ext_call.return_data[0]
                    require ext_code.size(tokenAddress)
                    call tokenAddress.approve(address arg1, uint256 arg2) with:
                         gas gas_remaining wei
                        args routerAddress, ext_call.return_data[0]
                    mem[ceil32(ceil32(arg1.length)) + (18 * ceil32(return_data.size)) + 385] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    mem[64] = ceil32(ceil32(arg1.length)) + (20 * ceil32(return_data.size)) + 385
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    mem[ceil32(ceil32(arg1.length)) + (20 * ceil32(return_data.size)) + 385] = 0x762b156200000000000000000000000000000000000000000000000000000000
                    mem[ceil32(ceil32(arg1.length)) + (20 * ceil32(return_data.size)) + 389] = ext_call.return_data[0]
                    mem[ceil32(ceil32(arg1.length)) + (20 * ceil32(return_data.size)) + 421] = 0
                    mem[ceil32(ceil32(arg1.length)) + (20 * ceil32(return_data.size)) + 453] = 160
                    mem[ceil32(ceil32(arg1.length)) + (20 * ceil32(return_data.size)) + 549] = 2
                    idx = 0
                    s = ceil32(ceil32(arg1.length)) + (17 * ceil32(return_data.size)) + 321
                    t = ceil32(ceil32(arg1.length)) + (20 * ceil32(return_data.size)) + 581
                    while idx < mem[ceil32(ceil32(arg1.length)) + (17 * ceil32(return_data.size)) + 289]:
                        mem[t] = mem[s + 12 len 20]
                        idx = idx + 1
                        s = s + 32
                        t = t + 32
                        continue 
                    mem[ceil32(ceil32(arg1.length)) + (20 * ceil32(return_data.size)) + 485] = this.address
                    mem[ceil32(ceil32(arg1.length)) + (20 * ceil32(return_data.size)) + 517] = block.timestamp
                    require ext_code.size(routerAddress)
                    call routerAddress.mem[mem[64] len 4] with:
                         gas gas_remaining wei
                        args mem[mem[64] + 4 len ceil32(ceil32(arg1.length)) + (20 * ceil32(return_data.size)) + (32 * mem[ceil32(ceil32(arg1.length)) + (17 * ceil32(return_data.size)) + 289]) + -mem[64] + 577]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    ...
                    if ceil32(mem[96]) <= mem[96]:
                        mem[mem[64] + 68] = uint8(arg2)
                        require ext_code.size(nodeRewardManagementAddress)
                        call nodeRewardManagementAddress.0x90219732 with:
                             gas gas_remaining wei
                            args msg.sender, Array(len=mem[96], data=mem[mem[64] + 132 len ceil32(mem[96])]), uint8(arg2)
                        ...
                        emit 0x33b56213: _410, msg.sender, uint8(arg2)
                    else:
                        ...
                        call nodeRewardManagementAddress.0x90219732 with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len ceil32(_385) + _384 + -mem[64] + 128]
                        mem[mem[64]] = ext_call.return_data[0]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        _409 = mem[64]
                        ...
                        emit 0x33b56213: _413, msg.sender, uint8(arg2)
    stor8 = 1
}
                ...
                if unknown_0x19165587(?????) <= uint32(call.func_hash) >> 224:
                    ...
                    if unknown_0x0eef1c14(?????) > uint32(call.func_hash) >> 224:
                        if reservePool() == uint32(call.func_hash) >> 224:
                            require not msg.value
                            return reservePoolAddress
                        if unknown_0x04032099(?????) == uint32(call.func_hash) >> 224:
                            require not msg.value
                            require calldata.size - 4 >= 32
                            require cd[4] == address(cd[4])
                            if owner != msg.sender:
                        ...
                        require _238 + _257 + 32 <= return_data.size
                        mem[ceil32(return_data.size) + 160 len ceil32(_257)] = mem[_238 + 160 len ceil32(_257)]
                        if ceil32(_257) <= _257:
                            _765 = mem[64]
                            mem[mem[64]] = 32
                            mem[mem[64] + 32] = _257
                            mem[mem[64] + 64 len ceil32(_257)] = mem[ceil32(return_data.size) + 160 len ceil32(_257)]
                            if ceil32(_257) <= _257:
                                return Array(len=_257, data=mem[mem[64] + 64 len ceil32(_257)])
                            mem[mem[64] + _257 + 64] = 0
                            return memory
                              from mem[64]
                               len ceil32(_257) + _765 + -mem[64] + 64
                        mem[ceil32(return_data.size) + _257 + 160] = 0
                        _776 = mem[64]
                        mem[mem[64]] = 32
                        mem[mem[64] + 32] = _257
                        mem[mem[64] + 64 len ceil32(_257)] = mem[ceil32(return_data.size) + 160 len ceil32(_257)]
                        ...
                        return memory
                          from mem[64]
                           len ceil32(_257) + _776 + -mem[64] + 64
                    ...
                    if stor14[address(msg.sender)]:
                        revert with 0, 'NODE CREATION: Malicious address'
                    mem[ceil32(ceil32(('cd', 4).length)) + 133] = uint8(cd[36])
                    require ext_code.size(nodeRewardManagementAddress)
                    staticcall nodeRewardManagementAddress.0x7a56cdf2 with:
                            gas gas_remaining wei
                           args uint8(cd[36])
                        ...
                        if not uint8(stor12.field_200):
                            ...
                            if uint8(stor12.field_192):
                                ...
                                if owner == msg.sender:
                                    ...
                                    if ext_call.return_data[0] * 0 or sub_9ee8e198 / 100 and sub_6ede0f71 > -1 / ext_call.return_data[0] * 0 or sub_9ee8e198 / 100:
                                        revert with 0, 17
                                    mem[ceil32(ceil32(('cd', 4).length)) + (4 * ceil32(return_data.size)) + 129] = 2
                                    ...
                                    mem[ceil32(ceil32(('cd', 4).length)) + (6 * ceil32(return_data.size)) + 229] = routerAddress
                                    ...
                                    call tokenAddress.0xa9059cbb with:
                                         gas gas_remaining wei
                                        args reservePoolAddress, (ext_call.return_data[0] * 0 or sub_9ee8e198 / 100) - (ext_call.return_data[0] * 0 or sub_9ee8e198 / 100 * sub_6ede0f71 / 100)
                                    mem[ceil32(ceil32(('cd', 4).length)) + (8 * ceil32(return_data.size)) + 225] = ext_call.return_data[0]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    require return_data.size >= 32
                                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                                    ...
                                    if ext_call.return_data[0] * liquidityPoolFee / 100 < ext_call.return_data[0] * liquidityPoolFee / 100 / 2:
                                        revert with 0, 17
                                    mem[ceil32(ceil32(('cd', 4).length)) + (10 * ceil32(return_data.size)) + 225] = 2
                                    ...
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    mem[64] = ceil32(ceil32(('cd', 4).length)) + (13 * ceil32(return_data.size)) + 321
                                    require return_data.size >= 32
                                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                                    ...
                                    mem[ceil32(ceil32(('cd', 4).length)) + (13 * ceil32(return_data.size)) + 357] = 0
                                    ...
                                    while idx < mem[ceil32(ceil32(('cd', 4).length)) + (10 * ceil32(return_data.size)) + 225]:
                                        mem[t] = mem[s + 12 len 20]
                                        idx = idx + 1
                                        s = s + 32
                                        t = t + 32
                                    ...
                                    call routerAddress.mem[mem[64] len 4] with:
                                         gas gas_remaining wei
                                        args mem[mem[64] + 4 len ceil32(ceil32(('cd', 4).length)) + (13 * ceil32(return_data.size)) + (32 * mem[ceil32(ceil32(('cd', 4).length)) + (10 * ceil32(return_data.size)) + 225]) + -mem[64] + 513]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    if eth.balance(this.address) < eth.balance(this.address):
                                        revert with 0, 17
                                    ...
                                    call tokenAddress.approve(address arg1, uint256 arg2) with:
                                         gas gas_remaining wei
                                        args routerAddress, (ext_call.return_data[0] * liquidityPoolFee / 100) - (ext_call.return_data[0] * liquidityPoolFee / 100 / 2)
                                    mem[mem[64]] = ext_call.return_data[0]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    _1074 = mem[64]
                                    ...
                                    call routerAddress.addLiquidityAVAX(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
                                         gas gas_remaining wei
                                        args tokenAddress, (ext_call.return_data[0] * liquidityPoolFee / 100) - (ext_call.return_data[0] * liquidityPoolFee / 100 / 2), 0, 0, 0, block.timestamp
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    mem[64] = mem[64] + ceil32(return_data.size)
                                    require return_data.size >= 96
                                    ...
                                    mem[mem[64]] = 2
                                    mem[64] = mem[64] + 96
                                    mem[_1088 + 32 len 64] = call.data[calldata.size len 64]
                                    if not mem[_1088]:
                                        revert with 0, 50
                                    mem[_1088 + 32] = tokenAddress
                                    require ext_code.size(routerAddress)
                                    staticcall routerAddress.0x73b295c2 with:
                                            gas gas_remaining wei
                                    ...
                                    if 1 >= mem[_1088]:
                                        revert with 0, 50
                                    mem[_1088 + 64] = ext_call.return_data[12 len 20]
                                    mem[_1088 + ceil32(return_data.size) + 100] = routerAddress
                                    mem[_1088 + ceil32(return_data.size) + 132] = _1087
                                    require ext_code.size(tokenAddress)
                                    call tokenAddress.approve(address arg1, uint256 arg2) with:
                                         gas gas_remaining wei
                                        args routerAddress, _1087
                                    ...
                                    require return_data.size >= 32
                                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                                    mem[_1088 + (2 * ceil32(return_data.size)) + 96] = 0x762b156200000000000000000000000000000000000000000000000000000000
                                    mem[_1088 + (2 * ceil32(return_data.size)) + 100] = _1087
                                    mem[_1088 + (2 * ceil32(return_data.size)) + 132] = 0
                                    mem[_1088 + (2 * ceil32(return_data.size)) + 164] = 160
                                    mem[_1088 + (2 * ceil32(return_data.size)) + 260] = mem[_1088]
                                    idx = 0
                                    s = _1088 + 32
                                    t = _1088 + (2 * ceil32(return_data.size)) + 292
                                    while idx < mem[_1088]:
                                        mem[t] = mem[s + 12 len 20]
                                        idx = idx + 1
                                        s = s + 32
                                        t = t + 32
                                        continue 
                                    mem[_1088 + (2 * ceil32(return_data.size)) + 196] = this.address
                                    mem[_1088 + (2 * ceil32(return_data.size)) + 228] = block.timestamp
                                    require ext_code.size(routerAddress)
                                    call routerAddress.mem[mem[64] len 4] with:
                                         gas gas_remaining wei
                                        args mem[mem[64] + 4 len _1088 + (2 * ceil32(return_data.size)) + (32 * mem[_1088]) + -mem[64] + 288]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    uint8(stor12.field_192) = 0
                                    mem[mem[64]] = 0x9021973200000000000000000000000000000000000000000000000000000000
                                    ...
                                    if ceil32(mem[128]) <= mem[128]:
                                        ...
                                        call nodeRewardManagementAddress.0x90219732 with:
                                             gas gas_remaining wei
                                            args msg.sender, Array(len=mem[128], data=mem[mem[64] + 132 len ceil32(mem[128])]), uint8(cd[36])
                                        mem[mem[64]] = ext_call.return_data[0]
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        _1151 = mem[64]
                                        ...
                                        emit 0x33b56213: _1153, msg.sender, uint8(cd[36])
                                    else:
                                        ...
                                        emit 0x33b56213: _1156, msg.sender, uint8(cd[36])
                    stor8 = 1
}
