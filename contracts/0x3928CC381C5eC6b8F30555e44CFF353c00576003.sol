...
function sub_9701eaa8(?) payable {
    ...
    mem[128] = 0xdc42728b0ea910349ed3c6e1c9dc06b5fb591f98
    mem[160] = 0x1c20e891bab6b1727d14da358fae2984ed9b59eb
    mem[192] = 0xc7198437980c041c805a1edcba50c1ce5db95118
    idx = 0
    while idx < 4:
        ...
        mem[256] = 0xdc42728b0ea910349ed3c6e1c9dc06b5fb591f98
        mem[288] = 0x1c20e891bab6b1727d14da358fae2984ed9b59eb
...
function sub_b9dfb211(?) payable {
    ...
    if this.address == address(cd[164]):
        ...
        while idx < 4:
            ...
            s = 0
            while s < 4:
                if address(('cd', 132)[1]) != mem[(32 * s) + 236 len 20]:
                    if s == -1:
                        revert with 0, 17
                    s = s + 1
                    continue 
        ...
        staticcall address(cd[((32 * ('cd', 132).length - 1) + cd[132] + 36)]).balanceOf(address rg1) with:
                gas gas_remaining wei
               args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if 0 >= ('cd', 132).length:
            revert with 0, 50
        require ('cd', 132)[0] == address(('cd', 132)[0])
        mem[ceil32(return_data.size) + 96] = 0xd586e7f844cea2f87f50152665bcbc2c279d8d70
        mem[ceil32(return_data.size) + 128] = 0xdc42728b0ea910349ed3c6e1c9dc06b5fb591f98
        mem[ceil32(return_data.size) + 160] = 0x1c20e891bab6b1727d14da358fae2984ed9b59eb
        mem[ceil32(return_data.size) + 192] = 0xc7198437980c041c805a1edcba50c1ce5db95118
        idx = 0
        while idx < 4:
            ...
            if 1 >= ('cd', 132).length:
                revert with 0, 50
            require ('cd', 132)[1] == address(('cd', 132)[1])
            mem[ceil32(return_data.size) + 224] = 0xd586e7f844cea2f87f50152665bcbc2c279d8d70
            mem[ceil32(return_data.size) + 256] = 0xdc42728b0ea910349ed3c6e1c9dc06b5fb591f98
            mem[ceil32(return_data.size) + 288] = 0x1c20e891bab6b1727d14da358fae2984ed9b59eb
            mem[ceil32(return_data.size) + 320] = 0xc7198437980c041c805a1edcba50c1ce5db95118
            s = 0
            while s < 4:
                if address(('cd', 132)[1]) != mem[(32 * s) + ceil32(return_data.size) + 236 len 20]:
                    if s == -1:
                        revert with 0, 17
                    s = s + 1
                    continue 
