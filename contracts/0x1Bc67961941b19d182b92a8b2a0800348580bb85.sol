...
#
#  - pendingAmmo(uint256 arg1, address arg2)
        ...
        if ext_call.return_data[0]:
            if poolInfo[arg1].field_256:
                ...
                if not block.number - poolInfo[arg1].field_512:
                    ...
                    require ext_code.size(ammoAddress)
                    call ammoAddress.0x40c10f19 with:
                         gas gas_remaining wei
                    ...
                    if (block.number * ammoPerBlock) - (poolInfo[arg1].field_512 * ammoPerBlock) / block.number - poolInfo[arg1].field_512 != ammoPerBlock:
                        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                    if not (block.number * ammoPerBlock) - (poolInfo[arg1].field_512 * ammoPerBlock):
                        if totalAllocPoint <= 0:
                            revert with 0, 'SafeMath: division by zero'
                        require totalAllocPoint
                        require ext_code.size(ammoAddress)
                        ...
                        require (block.number * ammoPerBlock) - (poolInfo[arg1].field_512 * ammoPerBlock)
                        if (block.number * ammoPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * ammoPerBlock * poolInfo[arg1].field_256) / (block.number * ammoPerBlock) - (poolInfo[arg1].field_512 * ammoPerBlock) != poolInfo[arg1].field_256:
                            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
                        if totalAllocPoint <= 0:
                            revert with 0, 'SafeMath: division by zero'
                        require totalAllocPoint
                        ...
                        call ammoAddress.0x40c10f19 with:
                             gas gas_remaining wei
                            args devAddress, (block.number * ammoPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * ammoPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require ext_code.size(ammoAddress)
                        call ammoAddress.0x40c10f19 with:
                             gas gas_remaining wei
                            args address(this.address), (block.number * ammoPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * ammoPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if not (block.number * ammoPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * ammoPerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                            if ext_call.return_data[0] <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require ext_call.return_data[0]
                            if poolInfo[arg1].field_768 + (0 / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                            ...
                            require (block.number * ammoPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * ammoPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                            if 10^18 * (block.number * ammoPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * ammoPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / (block.number * ammoPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * ammoPerBlock * poolInfo[arg1].field_256) / totalAllocPoint != 10^18:
                                revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                            if ext_call.return_data[0] <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require ext_call.return_data[0]
                            if poolInfo[arg1].field_768 + (10^18 * (block.number * ammoPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * ammoPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                revert with 0, 'SafeMath: addition overflow'
                            poolInfo[arg1].field_768 += 10^18 * (block.number * ammoPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * ammoPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]
...
function massUpdatePools() payable {
    ...
    while idx < poolInfo.length:
        ...
        if (block.number * ammoPerBlock) - (poolInfo[idx].field_512 * ammoPerBlock) / block.number - poolInfo[idx].field_512 != ammoPerBlock:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        if not (block.number * ammoPerBlock) - (poolInfo[idx].field_512 * ammoPerBlock):
            _141 = mem[64]
            mem[64] = mem[64] + 64
            mem[_141] = 26
            ...
            revert with memory
              from mem[64]
               len _206 + -mem[64] + 100
        require (block.number * ammoPerBlock) - (poolInfo[idx].field_512 * ammoPerBlock)
        if (block.number * ammoPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * ammoPerBlock * poolInfo[idx].field_256) / (block.number * ammoPerBlock) - (poolInfo[idx].field_512 * ammoPerBlock) != poolInfo[idx].field_256:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _145 = mem[64]
        mem[64] = mem[64] + 64
        mem[_145] = 26
        ...
        call ammoAddress.0x40c10f19 with:
             gas gas_remaining wei
            args devAddress, (block.number * ammoPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * ammoPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = this.address
        mem[mem[64] + 36] = (block.number * ammoPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * ammoPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        require ext_code.size(ammoAddress)
        call ammoAddress.0x40c10f19 with:
             gas gas_remaining wei
            args address(this.address), (block.number * ammoPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * ammoPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if not (block.number * ammoPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * ammoPerBlock * poolInfo[idx].field_256) / totalAllocPoint:
            _191 = mem[64]
            mem[64] = mem[64] + 64
            mem[_191] = 26
            ...
            revert with memory
              from mem[64]
               len _203 + -mem[64] + 100
        require (block.number * ammoPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * ammoPerBlock * poolInfo[idx].field_256) / totalAllocPoint
        if 10^18 * (block.number * ammoPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * ammoPerBlock * poolInfo[idx].field_256) / totalAllocPoint / (block.number * ammoPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * ammoPerBlock * poolInfo[idx].field_256) / totalAllocPoint != 10^18:
            revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[mem[64] + 101 len 31]
        _202 = mem[64]
        mem[64] = mem[64] + 64
        mem[_202] = 26
        ...
        if ext_call.return_data[0] > 0:
            require ext_call.return_data[0]
            if poolInfo[idx].field_768 + (10^18 * (block.number * ammoPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * ammoPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[idx].field_768:
                revert with 0, 'SafeMath: addition overflow'
            poolInfo[idx].field_768 += 10^18 * (block.number * ammoPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * ammoPerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]
            poolInfo[idx].field_512 = block.number
            idx = idx + 1
            continue 
        _218 = mem[64]
...
function withdraw(uint256 arg1, uint256 arg2) payable {
    ...
    if block.number <= poolInfo[arg1].field_512:
        if not userInfo[arg1][address(msg.sender)].field_0:
            ...
            if -userInfo[arg1][address(msg.sender)].field_256 > 0:
                require ext_code.size(ammoAddress)
                staticcall ammoAddress.0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if -userInfo[arg1][address(msg.sender)].field_256 <= ext_call.return_data[0]:
                    call ammoAddress.0xa9059cbb with:
                         gas gas_remaining wei
                ...
                require return_data.size >= 32
                if not ext_call.return_data[0]:
                    revert with 0, 32, 33, 0x6473616665416d6d6f5472616e736665723a205472616e73666572206661696c65, mem[325 len 31]
        else:
            ...
            if not poolInfo[arg1].field_256:
                ...
                if not userInfo[arg1][address(msg.sender)].field_0:
                    ...
                    if -userInfo[arg1][address(msg.sender)].field_256 > 0:
                        ...
                        require return_data.size >= 32
                        if not ext_call.return_data[0]:
                            revert with 0, 32, 33, 0x6473616665416d6d6f5472616e736665723a205472616e73666572206661696c65, mem[581 len 31]
                else:
                    require userInfo[arg1][address(msg.sender)].field_0
                    if userInfo[arg1][address(msg.sender)].field_0 * poolInfo[arg1].field_768 / userInfo[arg1][address(msg.sender)].field_0 != poolInfo[arg1].field_768:
