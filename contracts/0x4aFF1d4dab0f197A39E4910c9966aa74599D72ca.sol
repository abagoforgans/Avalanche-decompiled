...
function vestedBalance() payable {
    ...
    if block.timestamp < 457910 * 3600:
        revert with 0, 17
    if block.timestamp - (457910 * 3600) > 0x6729633382f8d2372db6f1b9a1a62381e508240e8a26:
        revert with 0, 17
    return ((3000000 * 10^18 * block.timestamp) - (1373730000000 * 10^18 * 24 * 3600) / 26280 * 24 * 3600)
}
...
function claimable() payable {
    ...
    if block.timestamp - (457910 * 3600) > 0x6729633382f8d2372db6f1b9a1a62381e508240e8a26:
        revert with 0, 17
    if (3000000 * 10^18 * block.timestamp) - (1373730000000 * 10^18 * 24 * 3600) / 26280 * 24 * 3600 < claimedAmount:
        revert with 0, 17
    return (((3000000 * 10^18 * block.timestamp) - (1373730000000 * 10^18 * 24 * 3600) / 26280 * 24 * 3600) - claimedAmount)
}
