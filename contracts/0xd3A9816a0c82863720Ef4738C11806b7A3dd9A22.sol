...
function sub_849f5828(?) payable {
    ...
    require ext_code.size(sub_7f216af3Address)
    staticcall sub_7f216af3Address.0x9358928b with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function sub_31455e86(?) payable {
    ...
    if not stor11:
        ...
        require return_data.size >= 32
        _184 = mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32
        ...
        _186 = mem[ceil32(32 * ('cd', 164).length) + mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 + 97]
        ...
        mem[ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 97] = _186
        require _184 + (32 * _186) + 32 <= return_data.size
        mem[ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 129 len 32 * _186] = mem[ceil32(32 * ('cd', 164).length) + _184 + 129 len 32 * _186]
        if 10000 < cd[132]:
            revert with 0, 17
        if _186 < 1:
            revert with 0, 17
        if _186 - 1 >= _186:
            revert with 0, 50
        if mem[(32 * _186 - 1) + ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 129] and -cd[132] + 10000 > -1 / mem[(32 * _186 - 1) + ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 129]:
            revert with 0, 17
        ...
        mem[mem[64] + 4] = cd[100]
        mem[mem[64] + 36] = (10000 * mem[(32 * _186 - 1) + ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 129]) - (cd[132] * mem[(32 * _186 - 1) + ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 129]) / 10000
        mem[mem[64] + 68] = 160
        ...
        if mem[_310 + mem[_310]] > test266151307():
            revert with 0, 65
        if ceil32(32 * mem[_310 + mem[_310]]) + 1 < 0 or _310 + ceil32(return_data.size) + ceil32(32 * mem[_310 + mem[_310]]) + 1 > test266151307():
            revert with 0, 65
        mem[64] = _310 + ceil32(return_data.size) + ceil32(32 * mem[_310 + mem[_310]]) + 1
        mem[_310 + ceil32(return_data.size)] = _314
        require _312 + (32 * _314) + 32 <= return_data.size
        mem[_310 + ceil32(return_data.size) + 32 len 32 * _314] = mem[_310 + _312 + 32 len 32 * _314]
        if 0 >= _314:
            revert with 0, 50
        if 1 >= _314:
            revert with 0, 50
        if mem[_310 + ceil32(return_data.size) + 64] > mem[_310 + ceil32(return_data.size) + 32]:
            if 1 >= _314:
                revert with 0, 50
            mem[mem[64]] = mem[_310 + ceil32(return_data.size) + 64]
        else:
            if 0 >= _314:
                revert with 0, 50
            mem[mem[64]] = mem[_310 + ceil32(return_data.size) + 32]
    else:
        if managerAddress != msg.sender:
            revert with 0, 'Only manager can call managed vaults'
        if 0 >= ('cd', 164).length:
        ...
        mem[64] = ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 97
        require return_data.size >= 32
        _185 = mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32
        require mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 <= test266151307()
        require ceil32(32 * ('cd', 164).length) + return_data.size + 97 > ceil32(32 * ('cd', 164).length) + mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 + 128
        _187 = mem[ceil32(32 * ('cd', 164).length) + mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 + 97]
        if mem[ceil32(32 * ('cd', 164).length) + mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 + 97] > test266151307():
            revert with 0, 65
        if ceil32(32 * mem[ceil32(32 * ('cd', 164).length) + mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 + 97]) + 1 < 0 or ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + ceil32(32 * mem[ceil32(32 * ('cd', 164).length) + mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 + 97]) + 98 > test266151307():
            revert with 0, 65
        mem[64] = ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + ceil32(32 * mem[ceil32(32 * ('cd', 164).length) + mem[ceil32(32 * ('cd', 164).length) + 97 len 4], Mask(224, 32, cd[100]) >> 32 + 97]) + 98
        mem[ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 97] = _187
        require _185 + (32 * _187) + 32 <= return_data.size
        mem[ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 129 len 32 * _187] = mem[ceil32(32 * ('cd', 164).length) + _185 + 129 len 32 * _187]
        if 10000 < cd[132]:
            revert with 0, 17
        if _187 < 1:
            revert with 0, 17
        if _187 - 1 >= _187:
            revert with 0, 50
        if mem[(32 * _187 - 1) + ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 129] and -cd[132] + 10000 > -1 / mem[(32 * _187 - 1) + ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 129]:
            revert with 0, 17
        mem[mem[64] + 4] = address(cd[68])
        mem[mem[64] + 36] = cd[100]
        require ext_code.size(address(cd[4]))
        ...
        mem[mem[64]] = 0x38ed173900000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = cd[100]
        mem[mem[64] + 36] = (10000 * mem[(32 * _187 - 1) + ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 129]) - (cd[132] * mem[(32 * _187 - 1) + ceil32(32 * ('cd', 164).length) + ceil32(return_data.size) + 129]) / 10000
        mem[mem[64] + 68] = 160
        mem[mem[64] + 164] = ('cd', 164).length
        idx = 0
        s = 128
        ...
        mem[_311 + ceil32(return_data.size) + 32 len 32 * _315] = mem[_311 + _313 + 32 len 32 * _315]
        if 0 >= _315:
            revert with 0, 50
        if 1 >= _315:
            revert with 0, 50
        if mem[_311 + ceil32(return_data.size) + 64] > mem[_311 + ceil32(return_data.size) + 32]:
            if 1 >= _315:
                revert with 0, 50
            mem[mem[64]] = mem[_311 + ceil32(return_data.size) + 64]
        else:
            if 0 >= _315:
                revert with 0, 50
            mem[mem[64]] = mem[_311 + ceil32(return_data.size) + 32]
    return memory
      from mem[64]
       len 32
}
