                                                                                ...
                                                                                if cd[(arg4 + 68)] != 1:
                                                                                    if cd[(arg4 + 68)] != 6:
                                                                                        ...
                                                                                        if not ext_call.success:
                                                                                            ...
                                                                                            staticcall address(ext_call.return_data[64]).0x70a08231 with:
                                                                                                    gas gas_remaining wei
                                                                                                   args 0xc3e6d9f7a3a5e3e223356383c7c055ee3f26a34f
                                                                                            if not ext_call.success:
                                                                                                revert with ext_call.return_data[0 len return_data.size]
                                                                                            else:
                                                                                                require return_data.size >= 32
                                                                                                            ...
                                                                                                            if not ext_call.success:
                                                                                                                ...
                                                                                                                if not ext_call.success:
                                                                                                                    ...
                                                                                                                    call address(ext_call.return_data[64]).0xa9059cbb with:
                                                                                                                         gas gas_remaining wei
                                                                                                                        args 0xc3e6d9f7a3a5e3e223356383c7c055ee3f26a34f, ((1000 * ext_call.return_data[0]) + (1000 * 1000 * ext_call.return_data[0] * cd[(arg4 + 164)] / 997 * ext_call.return_data[0] * ext_call.return_data[0]) / (997 * ext_call.return_data[0]) + (-997 * 1000 * ext_call.return_data[0] * cd[(arg4 + 164)] / 997 * ext_call.return_data[0]) - 997) + 1
                                                                                                                    if not ext_call.success:
                                                                                                                        revert with ext_call.return_data[0 len return_data.size]
                                                                                                                    else:
                                                                                                                        require return_data.size >= 32
                                                                                                                        ...
                                                                                                                        if ext_call.return_data[76 len 20] < address(ext_call.return_data[64]):
                                                                                                                            require ext_code.size(0xc3e6d9f7a3a5e3e223356383c7c055ee3f26a34f)
                                                                                                                            call 0xc3e6d9f7a3a5e3e223356383c7c055ee3f26a34f.swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                                                                                                                 gas gas_remaining wei
