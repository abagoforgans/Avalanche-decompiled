        ...
        if bool(stor102.length):
            ...
            if 608 <= var94004:
                if not var94001:
                    ...
                    tierSlope.length = !(65535 * 256^var94001) and tierSlope.length
                    idx = var94001 + (2 * -var94001 + 3 / 32) + (-1 * var94001 * var94001 + 3 / 32) + 2
                    s = (var94001 + 3 / 32) + 560
                    while idx:
                        ...
                        s = (idx + 3 / 32) + s
                        continue 
                    idx = (var94001 + 3 / 32) + (var94001 + (2 * -var94001 + 3 / 32) + (-1 * var94001 * var94001 + 3 / 32) + Mask(254, 1, None + -var94001 + (floor32(var94001 + 3) >> 4) + (var94001 * var94001 + 3 / 32) + 1) + 5 / 32 * uint255(None + -var94001 + (floor32(var94001 + 3) >> 4) + (var94001 * var94001 + 3 / 32) + 1) >> 1) + 560
                    while 561 > idx:
                        stor[idx] = 0
                        idx = idx + 1
                        continue 
                ...
                tierSlope.length = mem[var94004 + 30 len 2] * 256^var94001 or !(65535 * 256^var94001) and tierSlope.length
                s = var94001 + (2 * -var94001 + 3 / 32) + (-1 * var94001 * var94001 + 3 / 32) + 2
                t = (var94001 + 3 / 32) + 560
                idx = var94004 + 32
                while 608 > idx:
                    ...
                    idx = idx + 32
                    continue 
                idx = var94001 + (2 * -var94001 + 3 / 32) + (-1 * var94001 * var94001 + 3 / 32) + (floor32(-var94004 + 607) >> 4) + 2
                s = (var94001 + 3 / 32) + (var94001 + (2 * -var94001 + 3 / 32) + (-1 * var94001 * var94001 + 3 / 32) + (floor32(-var94004 + 607) >> 4) + 5 / 32 * Mask(251, 0, -var94004 + 607) >> 5) + 560
                while idx:
                    stor[s] = !(65535 * 256^idx) and stor[s]
                    idx = idx + (2 * -idx + 3 / 32) + (-1 * idx * idx + 3 / 32) + 2
                    s = (idx + 3 / 32) + s
                    continue 
                idx = (var94001 + 3 / 32) + (var94001 + (2 * -var94001 + 3 / 32) + (-1 * var94001 * var94001 + 3 / 32) + (floor32(-var94004 + 607) >> 4) + 5 / 32 * Mask(251, 0, -var94004 + 607) >> 5) + (var94001 + (2 * -var94001 + 3 / 32) + (-1 * var94001 * var94001 + 3 / 32) + (floor32(-var94004 + 607) >> 4) + Mask(254, 1, None + -var94001 + (floor32(var94001 + 3) >> 4) + (var94001 * var94001 + 3 / 32) + -(floor32(-var94004 + 607) >> 4) + 1) + 5 / 32 * uint255(None + -var94001 + (floor32(var94001 + 3) >> 4) + (var94001 * var94001 + 3 / 32) + -(floor32(-var94004 + 607) >> 4) + 1) >> 1) + 560
                while 561 > idx:
                    stor[idx] = 0
                    idx = idx + 1
                    continue 
            ...
            if 608 <= var95004:
                if not var95001:
                    ...
                    tierSlope.length = !(65535 * 256^var95001) and tierSlope.length
                    idx = var95001 + (2 * -var95001 + 3 / 32) + (-1 * var95001 * var95001 + 3 / 32) + 2
                    s = (var95001 + 3 / 32) + 560
                    while idx:
                        stor[s] = !(65535 * 256^idx) and stor[s]
                        idx = idx + (2 * -idx + 3 / 32) + (-1 * idx * idx + 3 / 32) + 2
                        s = (idx + 3 / 32) + s
                        continue 
                    idx = (var95001 + 3 / 32) + (var95001 + (2 * -var95001 + 3 / 32) + (-1 * var95001 * var95001 + 3 / 32) + Mask(254, 1, None + -var95001 + (floor32(var95001 + 3) >> 4) + (var95001 * var95001 + 3 / 32) + 1) + 5 / 32 * uint255(None + -var95001 + (floor32(var95001 + 3) >> 4) + (var95001 * var95001 + 3 / 32) + 1) >> 1) + 560
                    while 561 > idx:
                        stor[idx] = 0
                        idx = idx + 1
                        continue 
                ...
                tierSlope.length = mem[var95004 + 30 len 2] * 256^var95001 or !(65535 * 256^var95001) and tierSlope.length
                s = var95001 + (2 * -var95001 + 3 / 32) + (-1 * var95001 * var95001 + 3 / 32) + 2
                t = (var95001 + 3 / 32) + 560
                idx = var95004 + 32
                while 608 > idx:
                    stor[t] = mem[idx + 30 len 2] * 256^s or !(65535 * 256^s) and stor[t]
                    ...
                    idx = idx + 32
                    continue 
                idx = var95001 + (2 * -var95001 + 3 / 32) + (-1 * var95001 * var95001 + 3 / 32) + (floor32(-var95004 + 607) >> 4) + 2
                s = (var95001 + 3 / 32) + (var95001 + (2 * -var95001 + 3 / 32) + (-1 * var95001 * var95001 + 3 / 32) + (floor32(-var95004 + 607) >> 4) + 5 / 32 * Mask(251, 0, -var95004 + 607) >> 5) + 560
                while idx:
                    stor[s] = !(65535 * 256^idx) and stor[s]
                    idx = idx + (2 * -idx + 3 / 32) + (-1 * idx * idx + 3 / 32) + 2
                    s = (idx + 3 / 32) + s
                    continue 
                idx = (var95001 + 3 / 32) + (var95001 + (2 * -var95001 + 3 / 32) + (-1 * var95001 * var95001 + 3 / 32) + (floor32(-var95004 + 607) >> 4) + 5 / 32 * Mask(251, 0, -var95004 + 607) >> 5) + (var95001 + (2 * -var95001 + 3 / 32) + (-1 * var95001 * var95001 + 3 / 32) + (floor32(-var95004 + 607) >> 4) + Mask(254, 1, None + -var95001 + (floor32(var95001 + 3) >> 4) + (var95001 * var95001 + 3 / 32) + -(floor32(-var95004 + 607) >> 4) + 1) + 5 / 32 * uint255(None + -var95001 + (floor32(var95001 + 3) >> 4) + (var95001 * var95001 + 3 / 32) + -(floor32(-var95004 + 607) >> 4) + 1) >> 1) + 560
                while 561 > idx:
                    stor[idx] = 0
                    idx = idx + 1
                    continue 
        ...
        if bool(stor102.length):
            ...
            if 608 <= var96004:
                if not var96001:
                    ...
                    tierSlope.length = !(65535 * 256^var96001) and tierSlope.length
                    idx = var96001 + (2 * -var96001 + 3 / 32) + (-1 * var96001 * var96001 + 3 / 32) + 2
                    s = (var96001 + 3 / 32) + 560
                    while idx:
                        stor[s] = !(65535 * 256^idx) and stor[s]
                        idx = idx + (2 * -idx + 3 / 32) + (-1 * idx * idx + 3 / 32) + 2
                        s = (idx + 3 / 32) + s
                        continue 
                    idx = (var96001 + 3 / 32) + (var96001 + (2 * -var96001 + 3 / 32) + (-1 * var96001 * var96001 + 3 / 32) + Mask(254, 1, None + -var96001 + (floor32(var96001 + 3) >> 4) + (var96001 * var96001 + 3 / 32) + 1) + 5 / 32 * uint255(None + -var96001 + (floor32(var96001 + 3) >> 4) + (var96001 * var96001 + 3 / 32) + 1) >> 1) + 560
                    while 561 > idx:
                        stor[idx] = 0
                        idx = idx + 1
                        continue 
                ...
                tierSlope.length = mem[var96004 + 30 len 2] * 256^var96001 or !(65535 * 256^var96001) and tierSlope.length
                s = var96001 + (2 * -var96001 + 3 / 32) + (-1 * var96001 * var96001 + 3 / 32) + 2
                t = (var96001 + 3 / 32) + 560
                idx = var96004 + 32
                while 608 > idx:
                    stor[t] = mem[idx + 30 len 2] * 256^s or !(65535 * 256^s) and stor[t]
                    ...
                    idx = idx + 32
                    continue 
                idx = var96001 + (2 * -var96001 + 3 / 32) + (-1 * var96001 * var96001 + 3 / 32) + (floor32(-var96004 + 607) >> 4) + 2
                s = (var96001 + 3 / 32) + (var96001 + (2 * -var96001 + 3 / 32) + (-1 * var96001 * var96001 + 3 / 32) + (floor32(-var96004 + 607) >> 4) + 5 / 32 * Mask(251, 0, -var96004 + 607) >> 5) + 560
                while idx:
                    stor[s] = !(65535 * 256^idx) and stor[s]
                    idx = idx + (2 * -idx + 3 / 32) + (-1 * idx * idx + 3 / 32) + 2
                    s = (idx + 3 / 32) + s
                    continue 
                idx = (var96001 + 3 / 32) + (var96001 + (2 * -var96001 + 3 / 32) + (-1 * var96001 * var96001 + 3 / 32) + (floor32(-var96004 + 607) >> 4) + 5 / 32 * Mask(251, 0, -var96004 + 607) >> 5) + (var96001 + (2 * -var96001 + 3 / 32) + (-1 * var96001 * var96001 + 3 / 32) + (floor32(-var96004 + 607) >> 4) + Mask(254, 1, None + -var96001 + (floor32(var96001 + 3) >> 4) + (var96001 * var96001 + 3 / 32) + -(floor32(-var96004 + 607) >> 4) + 1) + 5 / 32 * uint255(None + -var96001 + (floor32(var96001 + 3) >> 4) + (var96001 * var96001 + 3 / 32) + -(floor32(-var96004 + 607) >> 4) + 1) >> 1) + 560
                while 561 > idx:
                    stor[idx] = 0
                    idx = idx + 1
                    continue 
