...
function sub_c5da4876(?) {
    ...
    while idx < 2:
        ...
        t = t + 32
        continue 
    mem[292 len 128] = 0, 100000, mem[228 len 92]
    call stor3.mem[292 len 4] with:
    ...
    if calldata.size < 4:
        ...
        if unknown_0x9b3e0ce2(?????) <= uint32(call.func_hash) >> 224:
            if unknown_0x9b3e0ce2(?????) == uint32(call.func_hash) >> 224:
                ...
                return sub_9b3e0ce2
            if unknown_0xc5da4876(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
                require calldata.size - 4 >= 32
                ...
                while idx < 2:
                    ...
                    t = t + 32
                    continue 
                mem[324 len 128] = 0, 100000, mem[260 len 92]
                call stor3.mem[324 len 4] with:
                     gas gas_remaining wei
                    args mem[328 len 96]
                require ext_call.success
            else:
            ...
            if unknown_0x1687fe8e(?????) == uint32(call.func_hash) >> 224:
                ...
                if unknown_0x4116e06a(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    require calldata.size - 4 >= 64
                    require cd[4] <= test266151307()
                    require cd[4] + 35 < calldata.size
                    ...
                    if unknown_0x4844ec37(?????) == uint32(call.func_hash) >> 224:
                        require not msg.value
                        require calldata.size - 4 >= 64
                        require cd[4] <= test266151307()
                        require cd[4] + 35 < calldata.size
                        ...
                        while idx < (32 * ('cd', 4).length) + cd[4] + 36:
                            ...
                            if mem[64] + ceil32(ceil32(cd[(cd[4] + cd[idx] + 36)])) + 1 < mem[64] or mem[64] + ceil32(ceil32(cd[(cd[4] + cd[idx] + 36)])) + 1 > test266151307():
                                revert with 0, 65
                            mem[64] = mem[64] + ceil32(ceil32(cd[(cd[4] + cd[idx] + 36)])) + 1
                            mem[_75] = cd[(cd[4] + cd[idx] + 36)]
                            require cd[4] + cd[idx] + cd[(cd[4] + cd[idx] + 36)] + 68 <= calldata.size
                            mem[_75 + 32 len cd[(cd[4] + cd[idx] + 36)]] = call.data[cd[4] + cd[idx] + 68 len cd[(cd[4] + cd[idx] + 36)]]
                            mem[_75 + cd[(cd[4] + cd[idx] + 36)] + 32] = 0
                            mem[s] = _75
                            s = s + 32
                            idx = idx + 32
                            continue 
                        ...
                        if unknown_0x8da5cb5b(?????) == uint32(call.func_hash) >> 224:
                            require not msg.value
                            return owner
                        require unknown_0x8fa2fc93(?????) == uint32(call.func_hash) >> 224
                        require calldata.size - 4 >= 128
                        require cd[4] <= test266151307()
                        require cd[4] + 35 < calldata.size
                        require ('cd', 4).length <= test266151307()
