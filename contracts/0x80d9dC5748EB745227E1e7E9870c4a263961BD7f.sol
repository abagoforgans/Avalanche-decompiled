...
function getAssetPrice(address arg1, uint256 arg2) payable {
    ...
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).getReserveData(address rg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if not ext_call.return_data[25 len 1]:
        require ext_code.size(address(ext_call.return_data[0]))
        staticcall address(ext_call.return_data[0]).getAssetPrice(address rg1) with:
                gas gas_remaining wei
               args arg1
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if ext_call.return_data[0] and 1 > -1 / ext_call.return_data[0]:
            revert with 'NH{q', 17
        if not Mask(8, 48, ext_call.return_data[0]) >> 48:
            revert with 'NH{q', 18
        return (ext_call.return_data[0] / Mask(8, 48, ext_call.return_data[0]) >> 48)
    if not arg2:
        require ext_code.size(address(ext_call.return_data[0]))
        staticcall address(ext_call.return_data[0]).getAssetPrice(address rg1) with:
                gas gas_remaining wei
        ...
        if not Mask(8, 48, ext_call.return_data[0]) >> 48:
            revert with 'NH{q', 18
        return (0 / Mask(8, 48, ext_call.return_data[0]) >> 48)
    if arg2 == 1:
        require ext_code.size(address(ext_call.return_data[0]))
        staticcall address(ext_call.return_data[0]).getAssetPrice(address rg1) with:
                gas gas_remaining wei
        ...
        return (ext_call.return_data[0] / Mask(8, 48, ext_call.return_data[0]) >> 48)
    if arg2 == 2:
        if ext_call.return_data[25 len 1] > 255:
            revert with 'NH{q', 17
        require ext_code.size(address(ext_call.return_data[0]))
        staticcall address(ext_call.return_data[0]).getAssetPrice(address rg1) with:
                gas gas_remaining wei
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if ext_call.return_data[0] and 1 << Mask(8, 48, ext_call.return_data[0]) >> 48 > -1 / ext_call.return_data[0]:
            revert with 'NH{q', 17
        if not Mask(8, 48, ext_call.return_data[0]) >> 48:
            revert with 'NH{q', 18
        return (ext_call.return_data[0] * 1 << Mask(8, 48, ext_call.return_data[0]) >> 48 / Mask(8, 48, ext_call.return_data[0]) >> 48)
    if arg2 < 11 and ext_call.return_data[25 len 1] < 78 or arg2 < 307 and ext_call.return_data[25 len 1] < 32:
        require ext_code.size(address(ext_call.return_data[0]))
        staticcall address(ext_call.return_data[0]).getAssetPrice(address rg1) with:
                gas gas_remaining wei
               args arg1
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if ext_call.return_data[0] and arg2^(Mask(8, 48, ext_call.return_data[0]) >> 48) > -1 / ext_call.return_data[0]:
            revert with 'NH{q', 17
        if not Mask(8, 48, ext_call.return_data[0]) >> 48:
            revert with 'NH{q', 18
        return (ext_call.return_data[0] * arg2^(Mask(8, 48, ext_call.return_data[0]) >> 48) / Mask(8, 48, ext_call.return_data[0]) >> 48)
    s = arg2
    t = 1
    ...
    if not Mask(8, 48, ext_call.return_data[0]) >> 48:
        revert with 'NH{q', 18
    return (ext_call.return_data[0] * s * t / Mask(8, 48, ext_call.return_data[0]) >> 48)
}
