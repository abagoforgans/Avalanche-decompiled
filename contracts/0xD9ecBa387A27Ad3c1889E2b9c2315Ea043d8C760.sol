...
function sub_35539edf(?) payable {
    ...
    if msg.value < 1000:
        revert with 0, 'ECR20: Must send at least 1000 MU Coins'
    if sub_3e5c3e00[address(msg.sender)] > -msg.value - 1:
        revert with 'NH{q', 17
    sub_3e5c3e00[address(msg.sender)] += msg.value
    if stor9[address(msg.sender)].field_0:
        if stor9[address(msg.sender)].field_0 == stor9[address(msg.sender)].field_1 < 32:
            revert with 'NH{q', 34
        if arg1.length:
            stor9[address(msg.sender)][].field_0 = Array(len=arg1.length, data=arg1[all])
        else:
            stor9[address(msg.sender)].field_0 = 0
            idx = 0
            while stor9[address(msg.sender)].field_1 + 31 / 32 > idx:
