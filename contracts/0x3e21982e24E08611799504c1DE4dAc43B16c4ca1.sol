...
function balances(address[] arg1, address[] arg2) {
    if arg2.length * arg1.length:
        mem[128 len 32 * arg2.length * arg1.length] = code.data[1064 len 32 * arg2.length * arg1.length]
    idx = 0
    while idx < arg1.length:
        ...
        while s < arg2.length:
            ...
            if not address(cd[((32 * s) + arg2 + 36)]):
                require s + (idx * arg2.length) < arg2.length * arg1.length
                mem[(32 * s + (idx * arg2.length)) + 128] = eth.balance(cd[((32 * idx) + arg1 + 36)])
            else:
