...
const SellLimitDivider = 80

const InitialSupply = 40 * 10^18

const BalanceLimitDivider = 33

const decimals = 9

const MaxSellLockTime = 10

const MaxBuyLockTime = 10
...
function getBurnedTokens() {
    if 40 * 10^18 < totalSupply:
        revert with 0, 17
    return (-totalSupply + 40 * 10^18 / 10^9)
}
...
function TeamWithdrawALLMarketingAVAX() {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    marketingBalance = 0
    call teamWalletAddress with:
...
function TeamWithdrawXMarketingAVAX(uint256 arg1) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function TeamRemoveLiquidity(bool arg1) {
    ...
    require return_data.size >= 32
    require ext_code.size(stor33)
    call stor33.approve(address rg1, uint256 rg2) with:
         gas gas_remaining wei
    ...
    call address(stor20.field_0).removeLiquidityAVAXSupportingFeeOnTransferTokens(address rg1, uint256 rg2, uint256 rg3, uint256 rg4, address rg5, uint256 rg6) with:
         gas gas_remaining wei
...
function TeamCreateLPandAVAX() {
    ...
    if uint8(stor19.field_32) > -uint8(stor19.field_40) + 255:
        revert with 0, 17
    if balanceOf[this.address] >= 25 * 10^14:
        if uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
            if uint8(stor19.field_32) > 0x1cd2b297d889bc2b6985d7cd0f31353677ee2d835ba4fe10a479:
                revert with 0, 17
            if not uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
                revert with 0, 18
            if 25 * 10^14 < 25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
                revert with 0, 17
            if 25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) < 25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2:
                revert with 0, 17
            if (25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))) - (25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) > !(-(25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))) + 25 * 10^14):
                revert with 0, 17
            if not this.address:
                revert with 0, 'Approve from zero'
            if not address(stor20.field_0):
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][address(stor20.field_0)].field_0 = -(25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 25 * 10^14
            emit Approval((-(25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 25 * 10^14), this.address, address(stor20.field_0));
            mem[128] = this.address
            require ext_code.size(address(stor20.field_0))
            staticcall address(stor20.field_0).WAVAX() with:
                    gas gas_remaining wei
            ...
            mem[ceil32(return_data.size) + 196] = -(25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 25 * 10^14
            idx = 0
            s = 128
            ...
            while idx < 2:
                ...
                continue 
            require ext_code.size(address(stor20.field_0))
            call address(stor20.field_0).swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                 gas gas_remaining wei
                args -(25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 25 * 10^14, 0, 160, address(this.address), block.timestamp, 2, mem[ceil32(return_data.size) + 388 len 64]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if eth.balance(this.address) < eth.balance(this.address):
                revert with 0, 17
            if False and (25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))) - (25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) > 0:
                revert with 0, 17
            if not -(25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 25 * 10^14:
                revert with 0, 18
            if totalLPAVAX > !(0 / -(25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 25 * 10^14):
                revert with 0, 17
            totalLPAVAX += 0 / -(25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 25 * 10^14
            if not this.address:
                revert with 0, 'Approve from zero'
            if not address(stor20.field_0):
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][address(stor20.field_0)].field_0 = 25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2
            allowance[address(this.address)][address(stor20.field_0)].field_255 = 0
            emit Approval((25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2), this.address, address(stor20.field_0));
            require ext_code.size(address(stor20.field_0))
            call address(stor20.field_0).addLiquidityAVAX(address rg1, uint256 rg2, uint256 rg3, uint256 rg4, address rg5, uint256 rg6) with:
               value 0 / -(25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 25 * 10^14 wei
                 gas gas_remaining wei
                args address(this.address), Mask(255, 1, 25 * 10^14 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))), 0, 0, address(this.address), block.timestamp
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
    ...
    if stor12[address(msg.sender)]:
        ...
        if stor27[address(msg.sender)]:
            ...
            while idx < 2:
                ...
                continue 
            require ext_code.size(address(stor20.field_0))
            call address(stor20.field_0).swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 rg1, address[] rg2, address rg3, uint256 rg4) with:
               value stor27[address(msg.sender)] wei
                 gas gas_remaining wei
                args 0, 128, msg.sender, block.timestamp, 2, mem[ceil32(return_data.size) + 356 len 64]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            emit OnWithdrawAVAX(stor27[address(msg.sender)], msg.sender);
    else:
        ...
        if profitPerShare * balanceOf[address(msg.sender)] < stor26[address(msg.sender)]:
            ...
            if stor27[address(msg.sender)] + (Mask(192, 64, (profitPerShare * balanceOf[address(msg.sender)]) - stor26[address(msg.sender)]) >> 64):
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                emit OnWithdrawAVAX(stor27[address(msg.sender)] + (Mask(192, 64, (profitPerShare * balanceOf[address(msg.sender)]) - stor26[address(msg.sender)]) >> 64), msg.sender);
