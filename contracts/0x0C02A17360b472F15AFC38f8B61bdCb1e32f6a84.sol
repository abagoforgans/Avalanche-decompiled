...
function setTokenURI(uint256 arg1, string arg2) {
    ...
    if stor11[arg1].field_0:
        ...
        if arg2.length:
            ...
            idx = 0
            while (uint255(stor11[arg1].field_0) * 0.5) + 31 / 32 > idx:
...
function getReflectionBalances(address arg1) {
    ...
    while idx < balanceOf[address(arg1)]:
        ...
        if totalDividend < lastDividendAt[stor7[address(arg1)][idx]]:
            revert with 0, 17
        if s > !(totalDividend - lastDividendAt[stor7[address(arg1)][idx]]):
            revert with 0, 17
        if idx == -1:
            revert with 0, 17
        idx = idx + 1
...
function mint(uint256 arg1) payable {
    ...
    while idx < arg1:
        ...
        if msg.value / arg1 < msg.value / arg1 / MINT_REWARD:
            revert with 0, 17
        if reflectionBalance > !(msg.value / arg1 / MINT_REWARD):
            revert with 0, 17
        reflectionBalance += msg.value / arg1 / MINT_REWARD
        if not tokenByIndex.length:
            revert with 0, 18
        if totalDividend > !(msg.value / arg1 / MINT_REWARD / tokenByIndex.length):
            revert with 0, 17
