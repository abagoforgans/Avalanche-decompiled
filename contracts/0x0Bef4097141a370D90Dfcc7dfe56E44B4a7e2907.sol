...
function antibot_maxgas(uint256 arg1) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, '!OWNER'
...
function antibot_status(bool arg1) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, '!OWNER'
...
function getCirculatingSupply() {
    if stor5[stor3] > -4007913129639936:
        revert with 0, 'SafeMath: subtraction overflow'
    if stor5[stor4] > -stor5[stor3] - 4007913129639936:
        revert with 0, 'SafeMath: subtraction overflow'
    if not rate:
        revert with 0, 'SafeMath: division by zero'
    return (-stor5[stor3] + -stor5[stor4] - 4007913129639936 / rate)
}
...
function antibot_managebotlist(address[] arg1, bool arg2) {
    require calldata.size - 4 >= 64
...
function setSwapBackSettings(bool arg1, uint256 arg2) {
    ...
    if 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5603de40d0ec000 * arg2 / 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5603de40d0ec000 != arg2:
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[261 len 31]
    swapThreshold = 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5603de40d0ec000 * arg2
}
...
function getLiquidityBacking(uint256 arg1) {
    ...
    if not stor5[stor29] / rate:
        ...
        if not -stor5[stor3] + -stor5[stor4] - 4007913129639936 / rate:
            revert with 0, 'SafeMath: division by zero'
        return (0 / -stor5[stor3] + -stor5[stor4] - 4007913129639936 / rate)
    ...
    if not -stor5[stor3] + -stor5[stor4] - 4007913129639936 / rate:
        revert with 0, 'SafeMath: division by zero'
    return (2 * stor5[stor29] / rate * arg1 / -stor5[stor3] + -stor5[stor4] - 4007913129639936 / rate)
}
...
function isOverLiquified(uint256 arg1, uint256 arg2) {
    ...
    if not stor5[stor29] / rate:
        ...
        if not -stor5[stor3] + -stor5[stor4] - 4007913129639936 / rate:
            revert with 0, 'SafeMath: division by zero'
        return (0 / -stor5[stor3] + -stor5[stor4] - 4007913129639936 / rate > arg1)
    if 2 * stor5[stor29] / rate / stor5[stor29] / rate != 2:
        revert with 0, 32, 33, 0x73536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
    if not arg2:
        if not -stor5[stor3] + -stor5[stor4] - 4007913129639936 / rate:
    ...
    if not -stor5[stor3] + -stor5[stor4] - 4007913129639936 / rate:
        revert with 0, 'SafeMath: division by zero'
    return (2 * stor5[stor29] / rate * arg2 / -stor5[stor3] + -stor5[stor4] - 4007913129639936 / rate > arg1)
}
...
function multiTransfer(address arg1, address[] arg2, uint256[] arg3) {
    ...
    if stor5[address(arg1)] / rate / rate < cd[((32 * arg2.length) + arg3 + 36)] * arg2.length:
    ...
    while idx < arg2.length:
        ...
        if not cd[((32 * idx) + arg3 + 36)]:
            ...
            mem[64] = mem[64] + 64
            mem[_266] = 20
            mem[_266 + 32] = 'Insufficient Balance' << 96
            mem[32] = 5
            if 0 > stor5[address(arg1)]:
                ...
                idx = 0
                while idx < 20:
                    mem[idx + _276 + 68] = mem[idx + _266 + 32]
                    idx = idx + 32
                    continue 
                mem[_276 + 68] = mem[_276 + 80 len 20]
                revert with memory
                  from mem[64]
                   len _276 + -mem[64] + 100
            ...
            mem[64] = mem[64] + 64
            mem[_270] = 20
            mem[_270 + 32] = 'Insufficient Balance' << 96
            mem[32] = 5
            if rate * cd[((32 * idx) + arg3 + 36)] > stor5[address(arg1)]:
                ...
                idx = 0
                while idx < 20:
                    mem[idx + _280 + 68] = mem[idx + _270 + 32]
                    idx = idx + 32
                    continue 
                mem[_280 + 68] = mem[_280 + 80 len 20]
                revert with memory
                  from mem[64]
                   len _280 + -mem[64] + 100
            ...
            if not stor10[address(cd[((32 * idx) + arg2 + 36)])]:
                ...
                if not rate:
                    ...
                    idx = 32
                    while idx < 26:
                        mem[idx + mem[64] + 68] = mem[idx + _334 + 32]
                        idx = idx + 32
                        continue 
                    revert with 0, 'SafeMath: division by zero'
                mem[mem[64]] = 0x14b6ca9600000000000000000000000000000000000000000000000000000000
