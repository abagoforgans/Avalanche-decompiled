...
function sub_d66517d4(?) {
    ...
    if ext_call.return_data[0] >= cd[68]:
        ...
        while idx < ('cd', 36).length:
            ...
            t = t + 32
            continue 
        mem[floor32(('cd', 36).length) + ceil32(return_data.size) + 133] = cd[68]
        mem[floor32(('cd', 36).length) + ceil32(return_data.size) + 165] = address(cd[4])
        require ext_code.size(address(cd[4]))
        call address(cd[4]).mem[mem[64] len 4] with:
             gas gas_remaining wei
            args mem[mem[64] + 4 len floor32(('cd', 36).length) + ceil32(return_data.size) + (32 * ('cd', 36).length) + -mem[64] + 225]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
}
    ...
    if msg.sender == stor6:
        ...
        if address(arg1) == stor4:
            ...
            if not arg7:
                ...
                while idx < arg3:
                    ...
                    staticcall stor2.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len _378 + (32 * _406) + -mem[64] + 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _780 = mem[64]
                ...
                call stor2.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len 96], stor8, block.timestamp + 15, mem[mem[64] + 164 len (32 * _1950) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            ...
            if not arg7:
                ...
                staticcall stor2.getAmountsOut(uint256 arg1, address[] arg2) with:
                        gas gas_remaining wei
                       args _1236, Array(len=2, data=mem[mem[64] + 100 len 64])
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _1520 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        if address(arg1) == stor4:
            ...
            if not arg7:
                ...
                while idx < mem[96]:
                    ...
                    continue 
                mem[mem[64] + 68] = this.address
                mem[_798 + 100] = block.timestamp + 15
                require ext_code.size(stor2)
                call stor2.mem[mem[64] len 4] with:
                   value 10^15 wei
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _798 + -mem[64] + 224]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if 1 >= mem[96]:
                    revert with 'NH{q', 50
                ...
                staticcall address(_1197).0x70a08231 with:
                        gas gas_remaining wei
                       args address(this.address)
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                ...
                staticcall stor2.getAmountsOut(uint256 arg1, address[] arg2) with:
                        gas gas_remaining wei
                       args _1242, 64, mem[mem[64] + 68 len (32 * _1262) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _1526 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                call stor2.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len 96], stor8, block.timestamp + 15, mem[mem[64] + 164 len (32 * _1954) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                while idx < arg3:
                    ...
                    staticcall stor2.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len (32 * _2434) + 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _2610 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if not arg7:
                ...
                while idx < arg3:
                    ...
                    staticcall stor2.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len (32 * _409) + 96]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _781 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                while idx < mem[96]:
                    ...
                    continue 
                mem[mem[64] + 68] = this.address
                mem[_796 + 100] = block.timestamp + 15
                require ext_code.size(stor2)
                call stor2.mem[mem[64] len 4] with:
                   value 10^15 wei
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _796 + -mem[64] + 256]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                if 1 >= mem[96]:
                    revert with 'NH{q', 50
                _1192 = mem[160]
                mem[mem[64] + 4] = this.address
                require ext_code.size(address(_1192))
                staticcall address(_1192).0x70a08231 with:
                        gas gas_remaining wei
                       args address(this.address)
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                ...
                staticcall stor2.getAmountsOut(uint256 arg1, address[] arg2) with:
                        gas gas_remaining wei
                       args _1240, 64, mem[mem[64] + 68 len (32 * _1260) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _1524 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
