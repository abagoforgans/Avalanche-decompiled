...
const INIT_CODE_PAIR_HASH = sha3(code.data[2113 len 9626], mem[9754 len 6] >> 76752)
...
mapping of uint256 earlybirdLimit;
...
function earlybirdLimit(address arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    return earlybirdLimit[address(arg1)][address(arg2)]
}
...
function endPresale(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if feeToSetterAddress != msg.sender:
        revert with 0, 'INVALID_SETTER'
    earlybirdLimit[address(arg1)][0] = -1
}

function addEarlybird(address arg1, address arg2, uint256 arg3) payable {
    require calldata.size - 4 >= 96
    require arg1 == arg1
    require arg2 == arg2
    if feeToSetterAddress != msg.sender:
        revert with 0, 'INVALID_SETTER'
    earlybirdLimit[address(arg1)][address(arg2)] = arg3
}
...
function createPair(address arg1, address arg2) payable {
    ...
    require arg2 == arg2
    if arg1 == arg2:
        revert with 0, 'Pancake: IDENTICAL_ADDRESSES'
    if arg1 < arg2:
        if not arg1:
            revert with 0, 'Pancake: ZERO_ADDRESS'
        if pair[address(arg1)][address(arg2)]:
            revert with 0, 'Pancake: PAIR_EXISTS'
        create2 contract with 0 wei
                        salt: sha3(arg1, arg2)
                        code: code.data[2113 len 9626]
