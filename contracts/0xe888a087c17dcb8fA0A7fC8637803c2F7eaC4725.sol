...
const SecondTeamWallet = 0xcd074121fe468c02dd78db7870dc7713c83b7aac
...
const TeamWallet = 0xcd074121fe468c02dd78db7870dc7713c83b7aac
...
function SetupEnableTrading() {
    if owner != msg.sender:
        if msg.sender != 0xcd074121fe468c02dd78db7870dc7713c83b7aac:
...
function sub_2e2d5eb3(?) {
    if owner != msg.sender:
        if msg.sender != 0xcd074121fe468c02dd78db7870dc7713c83b7aac:
            revert with 0, 'Caller not in Team'
    marketingBalance = 0
    call 0xcd074121fe468c02dd78db7870dc7713c83b7aac with:
...
function TeamDistributePresale(uint256 arg1, address[] arg2) {
    ...
    if owner == msg.sender:
        ...
        while idx < arg2.length:
            ...
            emit 0xfeddf252: (10^9 * arg1), this.address, address(_62)
            if idx == -1:
                revert with 0, 17
            idx = idx + 1
            continue 
        ...
        while idx < arg2.length:
            ...
            if arg1 and 10^9 > -1 / arg1:
                revert with 0, 17
            mem[ceil32(32 * arg2.length) + 97] = 10^9 * arg1
            emit 0xfeddf252: (10^9 * arg1), this.address, address(_65)
            if idx == -1:
                revert with 0, 17
            idx = idx + 1
            continue 
