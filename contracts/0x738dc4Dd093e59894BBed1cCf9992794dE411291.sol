...
#
const versionRecipient = '1', 0

const EMPTY_BYTES32 = 0

const DEFAULT_ADMIN_ROLE = 0

const GOVERNANCE_ROLE = 0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771
...
function setJobId(bytes32 arg1) payable {
    require calldata.size - 4 >= 32
    if calldata.size < 20:
        if not roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771][1][address(msg.sender)].field_0:
        ...
        if trustedForwarderAddress != msg.sender:
            ...
            if not roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771][1][Mask(64, 96, cd[(calldata.size - 20)]) << 96].field_0:
                revert with 0, 'MISSING_ROLE'
    jobId = arg1
}
...
function initialize(address arg1, address arg2, address arg3, bytes32 arg4) payable {
    require calldata.size - 4 >= 128
    require arg1 == arg1
    require arg2 == arg2
    require arg3 == arg3
    if uint8(stor9.field_8):
        stor11 = 0xb9d5d9136855f6fec3c0993fee6e9ce8a297846
        stor12 = arg2
        jobId = arg4
        fee = 10^16
        expiration = block.timestamp + 900
        trustedForwarderAddress = arg3
    else:
        ...
        if uint8(stor9.field_8):
            ...
            if not uint8(stor9.field_8):
                ...
                if not uint8(stor9.field_8):
                    ...
                    Mask(248, 0, stor9.field_8) = 0
                    uint8(stor9.field_8) = 0
    if roleAdmin[0][1][address(arg1)].field_0:
        if roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771][1][address(arg1)].field_0:
            emit RoleAdminChanged(0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771, roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771].field_512, 0);
            roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771].field_512 = 0
            if not uint8(stor9.field_8):
                uint8(stor9.field_8) = 0
        else:
            roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771].field_0++
            roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771][roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771].field_0].field_0 = arg1
            roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771][roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771].field_0].field_160 = 0
            roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771][1][address(arg1)].field_0 = roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771].field_0
            if calldata.size < 20:
                emit RoleGranted(0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771, arg1, msg.sender);
                emit RoleAdminChanged(0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771, roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771].field_512, 0);
                roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771].field_512 = 0
                if not uint8(stor9.field_8):
                    uint8(stor9.field_8) = 0
                ...
                if trustedForwarderAddress != msg.sender:
                    ...
                    emit RoleGranted(0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771, arg1, Mask(64, 96, cd[(calldata.size - 20)]) >> 96);
                emit RoleAdminChanged(0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771, roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771].field_512, 0);
                roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771].field_512 = 0
                if not uint8(stor9.field_8):
                    uint8(stor9.field_8) = 0
        ...
        if calldata.size < 20:
            ...
            if trustedForwarderAddress != msg.sender:
                ...
                emit RoleGranted(0, arg1, Mask(64, 96, cd[(calldata.size - 20)]) >> 96);
            if roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771][1][address(arg1)].field_0:
                emit RoleAdminChanged(0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771, roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771].field_512, 0);
                roleAdmin[0x35a7846a2a701fff6f9d61a46ebff5da578c5dcee8bdf361c569f9ea4ee64771].field_512 = 0
                if not uint8(stor9.field_8):
