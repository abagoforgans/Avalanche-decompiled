    ...
    if not arg2:
        ...
        while idx < arg2:
            ...
            while s <= numContracts:
                ...
                require ext_code.size(stor15[s])
                staticcall stor15[s].0x4f6ccce7 with:
                        gas gas_remaining wei
                       args (_140 % arg3)
...
function sub_6a45453d(?) {
    ...
    if not sub_84231261[stor13].field_768:
        ...
        staticcall stor15[1].0x18160ddd with:
                gas gas_remaining wei
        ...
        while idx < stor9:
            ...
            if not totalSupply:
                revert with 0, 18
            if sha3(mem[_161 + 32 len mem[_161]]) % totalSupply >= ext_call.return_data[0]:
                s = 2
                ...
                require ext_code.size(stor15[1])
                staticcall stor15[1].0x4f6ccce7 with:
                        gas gas_remaining wei
                ...
                require ext_code.size(stor15[1])
                staticcall stor15[1].0x6352211e with:
                        gas gas_remaining wei
                       args ext_call.return_data[0]
        ...
        while idx < stor9:
            ...
            if not totalSupply:
                revert with 0, 18
            if sha3(mem[_165 + 32 len mem[_165]]) % totalSupply >= ext_call.return_data[0]:
                s = 2
                t = ext_call.return_data[0]
                while s <= numContracts:
                    mem[0] = s
