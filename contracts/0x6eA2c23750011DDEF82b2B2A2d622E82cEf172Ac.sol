...
const axial = 0xcf8419a615c57511807236751c0af38db4ba33
...
const fxs = 0x214db107654ff987ad859f34125307783fc8e387

const teddy = 0x94bd7b2d99711a1486fb94d4395801c6d0fdd
...
address sub_8d02fdbcAddress;
address sub_31012f10Address;
address mimAddress;
address fraxAddress;
address sub_81245488Address;
uint256 sub_fb37cdab;
address lpAddress;
...
function sub_31012f10(?) {
    return sub_31012f10Address
}
...
function sub_8d02fdbc(?) {
    return sub_8d02fdbcAddress
}
...
function getMostPremium() {
    ...
    if ext_call.return_data[0] < ext_call.return_data[0]:
        if ext_call.return_data[0] < ext_call.return_data[0]:
            if ext_call.return_data[0] < ext_call.return_data[0]:
                if sub_22fc8fc3Address != 0x1c20e891bab6b1727d14da358fae2984ed9b59eb:
                    return sub_22fc8fc3Address
    if ext_call.return_data[0] < ext_call.return_data[0]:
        if ext_call.return_data[0] < ext_call.return_data[0]:
            if ext_call.return_data[0] < ext_call.return_data[0]:
                if 0x1c20e891bab6b1727d14da358fae2984ed9b59eb == sub_22fc8fc3Address:
                    return pair2Address
    if ext_call.return_data[0] < ext_call.return_data[0]:
        if ext_call.return_data[0] < ext_call.return_data[0]:
            if ext_call.return_data[0] < ext_call.return_data[0]:
...
function deposit() {
    ...
    if ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = approve(address arg1, uint256 arg2), 0x958c0d0baa8f220846d39667, 0, ext_call.return_data[0 len 28]
            mem[488 len 0] = 0
            call wantAddress.0xdc5493d3 with:
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 425 len 64] = approve(address arg1, uint256 arg2), 0x958c0d0baa8f220846d39667, 0, ext_call.return_data[0 len 28]
                ...
                if not ext_call.return_data[0]:
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 425 len 64] = approve(address arg1, uint256 arg2), 0x958c0d0baa8f220846d39667, 3696530387, ext_call.return_data[0 len 28]
