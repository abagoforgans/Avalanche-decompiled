...
function _fallback() payable {
    ...
    if unknown_0x72336652(?????) <= uint32(call.func_hash) >> 224:
            ...
            if unknown_0x8da5cb5b(?????) > uint32(call.func_hash) >> 224:
                if uint32(call.func_hash) >> 224 != unknown_0x72336652(?????):
                    if unknown_0x768dc710(?????) == uint32(call.func_hash) >> 224:
                        ...
                        require arg1 == address(arg1)
                        return bool(stor7[arg1])
                    if unknown_0x7cf4b90f(?????) == uint32(call.func_hash) >> 224:
                        require not msg.value
                        return bool(uint8(stor12.field_168))
                    require unknown_0x8956dc3d(?????) == uint32(call.func_hash) >> 224
                    require not msg.value
                    return sub_8956dc3d
                require not msg.value
                require calldata.size - 4 >= 64
                ...
                if arg1 == 8:
                    _treasuryAddress = address(arg2)
            if unknown_0x9b201936(?????) <= uint32(call.func_hash) >> 224:
                if unknown_0x9b201936(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    require calldata.size - 4 >= 32
                    require arg1 == address(arg1)
                    return bool(stor8[arg1])
                if unknown_0x9c74daf0(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    return _uniswapV2PairAddress
                require unknown_0x9e0a7810(?????) == uint32(call.func_hash) >> 224
                require not msg.value
                return bool(uint8(stor12.field_184))
            if unknown_0x8da5cb5b(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
            ...
            if unknown_0x583e0568(?????) <= uint32(call.func_hash) >> 224:
                if unknown_0x70a08231(?????) > uint32(call.func_hash) >> 224:
                    if unknown_0x583e0568(?????) == uint32(call.func_hash) >> 224:
                        require not msg.value
                        return _uniswapV2RouterAddress
                    require unknown_0x6c83a2d4(?????) == uint32(call.func_hash) >> 224
                    require not msg.value
                    if bool(stor9[msg.sender]) != 1:
                        revert with 0, 'NOT MANAGER'
                    _launchTime = block.timestamp
                    ...
                    if unknown_0x715018a6(?????) == uint32(call.func_hash) >> 224:
                        ...
                        require unknown_0x71cec707(?????) == uint32(call.func_hash) >> 224
                        require not msg.value
                        require calldata.size - 4 >= 64
                        require arg1 < 9
                        if bool(stor9[msg.sender]) != 1:
        ...
        if unknown_0x18160ddd(?????) > uint32(call.func_hash) >> 224:
            ...
            if uint32(call.func_hash) >> 224 != name():
                if _launchTime() == uint32(call.func_hash) >> 224:
                    require not msg.value
                    return _launchTime
        ...
        if unknown_0x1cdd3be3(?????) > uint32(call.func_hash) >> 224:
            if unknown_0x18160ddd(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
                return totalSupply
            require unknown_0x1b7b84a2(?????) == uint32(call.func_hash) >> 224
            require not msg.value
            return bool(uint8(stor12.field_176))
        if unknown_0x1cdd3be3(?????) == uint32(call.func_hash) >> 224:
            require not msg.value
            ...
            require arg1 == address(arg1)
            return bool(stor6[arg1])
        if unknown_0x207a3c47(?????) == uint32(call.func_hash) >> 224:
            require not msg.value
            return sub_207a3c47
