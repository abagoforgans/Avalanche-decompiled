    ...
    if uint16(ext_call.return_data[30 len 2] + 1) == uint16(arg3):
        ...
        while not idx:
            if bool(ext_call.return_data[30 len 2] + 1):
                if s == -1:
                    revert with 'NH{q', 17
                if uint16(ext_call.return_data[30 len 2] + 1) and s + 1 > -1 / uint16(ext_call.return_data[30 len 2] + 1):
                    revert with 'NH{q', 17
                if uint16(ext_call.return_data[30 len 2] + 1) + (s * uint16(ext_call.return_data[30 len 2] + 1)) > -3:
                    revert with 'NH{q', 17
                s = uint16(ext_call.return_data[30 len 2] + 1) + (s * uint16(ext_call.return_data[30 len 2] + 1)) + 2
                idx = not s + 1 % 3
                s = s + 1
                continue 
            if s > -3:
                revert with 'NH{q', 17
            if uint16(ext_call.return_data[30 len 2] + 1) and s + 2 > -1 / uint16(ext_call.return_data[30 len 2] + 1):
                revert with 'NH{q', 17
            if (2 * uint16(ext_call.return_data[30 len 2] + 1)) + (s * uint16(ext_call.return_data[30 len 2] + 1)) > -2:
                revert with 'NH{q', 17
            s = (2 * uint16(ext_call.return_data[30 len 2] + 1)) + (s * uint16(ext_call.return_data[30 len 2] + 1)) + 1
            idx = not s + 2 % 3
            s = s + 2
            continue 
        call msg.sender with:
