...
function manualsend(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require address(stor5.field_16) == msg.sender
    stor11 = arg1
}
...
function transfer() payable {
    require address(stor5.field_16) == msg.sender
    if stor9 > -totalSupply - 1:
        revert with 'NH{q', 17
    totalSupply += stor9
    if stor9 > -balanceOf[address(stor5.field_0)] - 1:
        revert with 'NH{q', 17
    balanceOf[address(stor5.field_0)] += stor9
    emit Transfer(stor9, 0, address(stor5.field_16));
}
    ...
    if msg.sender == owner:
        ...
        if not arg2:
            ...
            if balanceOf[address(msg.sender)] < arg2:
                revert with 'NH{q', 17
            balanceOf[address(msg.sender)] -= arg2
            if balanceOf[address(stor5.field_0)] > -1:
                revert with 'NH{q', 17
            if balanceOf[address(stor5.field_0)] < balanceOf[address(stor5.field_0)]:
                revert with 0, 'SafeMath: addition overflow'
            if balanceOf[address(arg1)] > -arg2 - 1:
                revert with 'NH{q', 17
            if balanceOf[address(arg1)] + arg2 < balanceOf[address(arg1)]:
            ...
            if balanceOf[address(msg.sender)] < arg2:
                revert with 'NH{q', 17
            balanceOf[address(msg.sender)] -= arg2
            if balanceOf[address(stor5.field_0)] > -(6 * arg2 / 100) - 1:
                revert with 'NH{q', 17
            if balanceOf[address(stor5.field_0)] + (6 * arg2 / 100) < balanceOf[address(stor5.field_0)]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[address(stor5.field_0)] += 6 * arg2 / 100
            if balanceOf[address(arg1)] > -arg2 + (6 * arg2 / 100) - 1:
                revert with 'NH{q', 17
            if balanceOf[address(arg1)] + arg2 - (6 * arg2 / 100) < balanceOf[address(arg1)]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[address(arg1)] = balanceOf[address(arg1)] + arg2 - (6 * arg2 / 100)
    ...
    if arg1 == owner:
        ...
        if not arg3:
            ...
            if balanceOf[address(arg1)] < arg3:
                revert with 'NH{q', 17
            balanceOf[address(arg1)] -= arg3
            if balanceOf[address(stor5.field_0)] > -(6 * arg3 / 100) - 1:
                revert with 'NH{q', 17
            if balanceOf[address(stor5.field_0)] + (6 * arg3 / 100) < balanceOf[address(stor5.field_0)]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[address(stor5.field_0)] += 6 * arg3 / 100
            if balanceOf[address(arg2)] > -arg3 + (6 * arg3 / 100) - 1:
                revert with 'NH{q', 17
            if balanceOf[address(arg2)] + arg3 - (6 * arg3 / 100) < balanceOf[address(arg2)]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[address(arg2)] = balanceOf[address(arg2)] + arg3 - (6 * arg3 / 100)
