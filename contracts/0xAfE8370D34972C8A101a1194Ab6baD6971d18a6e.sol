...
function sub_e24be30d(?) {
    ...
    if not stor14:
        ...
        idx = 0
        s = 0
        t = (7 * ceil32(return_data.size)) + 356
        ...
        call stor7.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args 0 / 100000, 0, 160, address(this.address), stor13, stor6.length, mem[(7 * ceil32(return_data.size)) + 356 len 32 * stor6.length]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(stor12)
        call stor12.0xa9059cbb with:
                ...
                if unknown_0x853828b6(?????) <= uint32(call.func_hash) >> 224:
                    if uint32(call.func_hash) >> 224 != unknown_0x853828b6(?????):
                        ...
                        while idx <= stor4:
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_335] == mem[_335 + 31 len 1]
                            if not mem[_335 + 31 len 1]:
                                mem[mem[64] + 4] = this.address
                                require ext_code.size(tokenList[idx])
                                staticcall tokenList[idx].0x70a08231 with:
                                        gas gas_remaining wei
                                ...
                                if mem[_384]:
                                    ...
                                    call tokenList[idx].0xa9059cbb with:
                                         gas gas_remaining wei
                                        args address(stor0.field_0), _392
                                    mem[mem[64]] = ext_call.return_data[0]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    _420 = mem[64]
                                ...
                                if bool(bool(mem[_335 + 31 len 1] < 78)) or bool(bool(mem[_335 + 31 len 1] < 32)):
                                    if False and 10^mem[_335 + 31 len 1] > 0:
                                        revert with 'NH{q', 17
                                    mem[mem[64] + 4] = this.address
                                    require ext_code.size(tokenList[idx])
                                    staticcall tokenList[idx].0x70a08231 with:
                                    ...
                                    if mem[_464]:
                                        ...
                                        call tokenList[idx].0xa9059cbb with:
                                             gas gas_remaining wei
                                            args address(stor0.field_0), _467
                                        mem[mem[64]] = ext_call.return_data[0]
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        _473 = mem[64]
            ...
            if unknown_0x1b52b9de(?????) > uint32(call.func_hash) >> 224:
                if uint32(call.func_hash) >> 224 != unknown_0x13af4035(?????):
                    ...
                    while idx <= stor4:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_333] == mem[_333 + 31 len 1]
                        if not mem[_333 + 31 len 1]:
                            mem[mem[64] + 4] = this.address
                            require ext_code.size(tokenList[idx])
                            staticcall tokenList[idx].0x70a08231 with:
                                    gas gas_remaining wei
                            ...
                            if mem[_383]:
                                ...
                                call tokenList[idx].0xa9059cbb with:
                                     gas gas_remaining wei
                                    args address(stor0.field_0), _391
                                mem[mem[64]] = ext_call.return_data[0]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _419 = mem[64]
                            ...
                            if bool(bool(mem[_333 + 31 len 1] < 78)) or bool(bool(mem[_333 + 31 len 1] < 32)):
                                if False and 10^mem[_333 + 31 len 1] > 0:
                                    revert with 'NH{q', 17
                                mem[mem[64] + 4] = this.address
                                require ext_code.size(tokenList[idx])
                                staticcall tokenList[idx].0x70a08231 with:
                                ...
                                if mem[_404]:
                                    ...
                                    call tokenList[idx].0xa9059cbb with:
                                         gas gas_remaining wei
                                        args address(stor0.field_0), _414
                                    mem[mem[64]] = ext_call.return_data[0]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    _434 = mem[64]
                                ...
                                if mem[_463]:
                                    ...
                                    call tokenList[idx].0xa9059cbb with:
                                         gas gas_remaining wei
                                        args address(stor0.field_0), _466
                                    mem[mem[64]] = ext_call.return_data[0]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    _472 = mem[64]
                ...
                if unknown_0xdad69c20(?????) == uint32(call.func_hash) >> 224:
                    ...
                    if uint32(call.func_hash) >> 224 != unknown_0xe24be30d(?????):
                        ...
                        if not stor14:
                            ...
                            call stor7.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                 gas gas_remaining wei
                                args 0 / 100000, 0, 160, address(this.address), stor13, stor6.length, mem[(7 * ceil32(return_data.size)) + 388 len 32 * stor6.length]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(stor12)
                            call stor12.0xa9059cbb with:
