...
function royaltyPercentage() payable {
...
function royaltyInfo(uint256 arg1, uint256 arg2) payable {
    ...
    if arg2 and royaltyPercentage > -1 / arg2:
        revert with 0, 17
    return stor11, arg2 * royaltyPercentage / 100
}

function setRoyaltyPercentage(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function setRoyaltyBeneficiary(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function supportsInterface(bytes4 arg1) payable {
    ...
    if '*U Z' == Mask(32, 224, arg1):
        return True
    if 0x79f154c400000000000000000000000000000000000000000000000000000000 == Mask(32, 224, arg1):
        return True
...
function mintNFT(string arg1) payable {
    require calldata.size - 4 >= 32
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if stor13[stor8.length].field_0:
        if stor13[stor8.length].field_0 == uint255(stor13[stor8.length].field_0) * 0.5 < 32:
            revert with 0, 34
        if arg1.length:
            stor13[stor8.length][].field_0 = Array(len=arg1.length, data=arg1[all])
        else:
            stor13[stor8.length].field_0 = 0
            idx = 0
            while (uint255(stor13[stor8.length].field_0) * 0.5) + 31 / 32 > idx:
                stor13[stor8.length][idx].field_0 = 0
                idx = idx + 1
                continue 
    else:
        if stor13[stor8.length].field_0 == stor13[stor8.length].field_1 < 32:
            revert with 0, 34
        if arg1.length:
            stor13[stor8.length][].field_0 = Array(len=arg1.length, data=arg1[all])
        else:
            stor13[stor8.length].field_0 = 0
            idx = 0
            while stor13[stor8.length].field_1 + 31 / 32 > idx:
                stor13[stor8.length][idx].field_0 = 0
                idx = idx + 1
                continue 
    if not msg.sender:
            ...
            if Mask(256, -1, stor13[arg1].field_0):
                if 31 < uint255(stor13[arg1].field_0) * 0.5:
                    ...
                    while (uint255(stor13[arg1].field_0) * 0.5) + 96 > idx:
                        ...
                        s = s + 1
                        continue 
                    if uint255(stor13[arg1].field_0) * 0.5 <= 0:
                        return ''
                    return Array(len=2 * Mask(256, -1, stor13[arg1].field_0), data=mem[128 len ceil32(uint255(stor13[arg1].field_0) * 0.5)])
                mem[128] = 256 * stor13[arg1].field_8
        else:
