...
function mintNFT(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if minterAddress != msg.sender:
        revert with 0, '!no minter'
    if sub_479e46a2 >= maxSupply:
    ...
    tokenByIndex.length++
    tokenByIndex[tokenByIndex.length] = sub_479e46a2
    if arg1:
        tokenOfOwnerByIndex[address(arg1)][stor4[address(arg1)]] = sub_479e46a2
    ...
    ownerOf[stor12] = arg1
    emit Transfer(0, arg1, sub_479e46a2);
    return sub_479e46a2
}

function sub_c04d5a23(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if stor11[arg1].field_256:
        ...
        return stor11[arg1].field_0, 
               Array(len=2 * Mask(256, -1, stor11[arg1].field_257), data=mem[128 len ceil32(stor11[arg1].field_257)])
    if stor11[arg1].field_256 == stor11[arg1].field_257 < 32:
        revert with 'NH{q', 34
    if stor11[arg1].field_256:
        if stor11[arg1].field_256 == stor11[arg1].field_257 < 32:
        ...
        if stor11[arg1].field_257:
            if 31 >= stor11[arg1].field_257:
                ...
                while stor11[arg1].field_257 + 96 > idx:
                    ...
                    s = s + 1
                    continue 
    return stor11[arg1].field_0, Array(len=stor11[arg1].field_256, data=mem[128 len ceil32(stor11[arg1].field_257)])
}
