...
const sub_0f7fb45d(?) = (6 * 10^18 * 24 * 3600)

const sub_4e20a02c(?) = 2400 * 10^18

const sub_ffa8226e(?) = 1000 * 10^18
...
function sub_39ea3c4a(?) payable {
    return sub_39ea3c4aAddress
}
...
function distributeReward(address arg1, address arg2, address arg3) payable {
    ...
    if not arg2:
        revert with 0, '!_stuartPool'
    if not arg3:
        revert with 0, '!_airdropWallet'
    rewardPoolDistributed = 1
    if not arg1:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply + 2400 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 2400 * 10^18
    if balanceOf[address(arg1)] + 2400 * 10^18 < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 2400 * 10^18
    emit Transfer(2400 * 10^18, 0, arg1);
    if not arg2:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply + (6 * 10^18 * 24 * 3600) < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 6 * 10^18 * 24 * 3600
    if balanceOf[address(arg2)] + (6 * 10^18 * 24 * 3600) < balanceOf[address(arg2)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg2)] += 6 * 10^18 * 24 * 3600
    emit Transfer((6 * 10^18 * 24 * 3600), 0, arg2);
    if not arg3:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply + 1000 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 1000 * 10^18
    if balanceOf[address(arg3)] + 1000 * 10^18 < balanceOf[address(arg3)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg3)] += 1000 * 10^18
    emit Transfer(1000 * 10^18, 0, arg3);
}
