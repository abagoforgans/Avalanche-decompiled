...
function sub_eef84ba1(?) payable {
    ...
    while idx < sub_1555717c.length:
        ...
        if sub_1555717c[idx].field_0:
            ...
            s = 0
            while s < _17:
                mem[s + _15 + 36] = mem[s + _16 + 32]
                s = s + 32
                continue 
            if ceil32(_17) <= _17:
                call sub_1555717c[idx].field_0.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _17 + _15 + -mem[64] + 32]
                if return_data.size:
                    _26 = mem[64]
...
function isMarkedAsBotStorageBulk(address[] arg1) payable {
    ...
    mem[ceil32(32 * arg1.length) + 129 len 42] = call.data[calldata.size len 42]
    idx = 41
    s = address(msg.sender)
    while idx > 1:
        if s % 16 >= 16:
        ...
        if idx >= 42:
            revert with 0, 50
        mem[idx + ceil32(32 * arg1.length) + 129 len 8] = Mask(8, -(0, 0) + 256, 0) << (0, 0) - 256
        if not idx:
            revert with 0, 17
        idx = idx - 1
        s = Mask(252, 0, s) * 0.0625
    ...
    if msg.sender + 10240:
        revert with 0, 'Strings: hex length insufficient'
    mem[ceil32(32 * arg1.length) + 225 len 66] = call.data[calldata.size len 66]
    idx = 65
    while idx > 1:
        if idx >= 66:
            revert with 0, 50
        mem[idx + ceil32(32 * arg1.length) + 225 len 8] = Mask(8, -(0, 0) + 256, 0) << (0, 0) - 256
        if not idx:
            revert with 0, 17
        idx = idx - 1
        continue 
    revert with 0, 
                32,
                148,
                'AccessControl: account ', mem[ceil32(32 * arg1.length) + 161 len 42], 8297, mem[ceil32(32 * arg1.length) + 289 len 66], 0, 0 >> 928,
                0
}
