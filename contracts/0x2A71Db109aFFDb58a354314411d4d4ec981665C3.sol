...
array of address sub_795caf7e;
mapping of address sub_989796b5;
...
function sub_795caf7e(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
    require arg2 < uint256(sub_795caf7e[arg1])
    return address(sub_795caf7e[arg1][arg2])
}
...
function sub_989796b5(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    return sub_989796b5[arg1]
}
...
function setPoolToken(address arg1, address arg2) payable {
    ...
    sub_989796b5[address(arg1)] = arg2
}

function sub_f0215269(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
    require arg2 == address(arg2)
    if owner != msg.sender:
        revert with 0, 32, 32, 0xfe4f776e61626c653a2063616c6c6572206973206e6f7420746865206f776e65
    uint256(sub_795caf7e[address(arg1)])++
    address(sub_795caf7e[address(arg1)][uint256(sub_795caf7e[address(arg1)])]) = address(arg2)
}
...
function sub_c8c85d60(?) payable {
    ...
    if ceil32(arg5.length) <= arg5.length:
        require ext_code.size(0xf6c10bf763211f4fb2d487837b4f2b74dbc5a103)
        delegate 0xf6c10bf763211f4fb2d487837b4f2b74dbc5a103.0x8f00c962 with:
             gas gas_remaining wei
            args Array(len=arg5.length, data=Mask(8 * ceil32(arg5.length), -(8 * ceil32(arg5.length)) + 256, arg5[all], Mask(8 * ceil32(arg5.length) - arg5.length, -(8 * ceil32(arg5.length) + -ceil32(ceil32(arg5.length)) + 31) + 256, arg6.length) >> -(8 * ceil32(arg5.length) + -ceil32(ceil32(arg5.length)) + 31) + 256) << (8 * ceil32(arg5.length)) - 256, arg6.length, Mask(8 * ceil32(arg6.length), -(8 * ceil32(arg6.length)) + 256, arg6[all], Mask(8 * ceil32(arg6.length) - arg6.length, -(8 * ceil32(arg6.length) + -ceil32(ceil32(arg6.length)) + 27) + 256, 64) >> -(8 * ceil32(arg6.length) + -ceil32(ceil32(arg6.length)) + 27) + 256) << (8 * ceil32(arg6.length)) - 256), ceil32(arg5.length) + 96
    else:
        mem[ceil32(arg5.length) + ceil32(ceil32(arg5.length)) + ceil32(ceil32(arg6.length)) + 198] = arg6.length
        mem[ceil32(arg5.length) + ceil32(ceil32(arg5.length)) + ceil32(ceil32(arg6.length)) + 230 len ceil32(arg6.length)] = arg6[all], Mask(8 * ceil32(arg6.length) - arg6.length, -(8 * ceil32(arg6.length) + -ceil32(ceil32(arg6.length)) + 27) + 256, 64) >> -(8 * ceil32(arg6.length) + -ceil32(ceil32(arg6.length)) + 27) + 256
        if ceil32(arg6.length) > arg6.length:
            mem[arg6.length + ceil32(arg5.length) + ceil32(ceil32(arg5.length)) + ceil32(ceil32(arg6.length)) + 230] = 0
        require ext_code.size(0xf6c10bf763211f4fb2d487837b4f2b74dbc5a103)
        delegate 0xf6c10bf763211f4fb2d487837b4f2b74dbc5a103.0x8f00c962 with:
             gas gas_remaining wei
            args Array(len=arg5.length, data=Mask(8 * ceil32(arg5.length), -(8 * ceil32(arg5.length)) + 256, arg5[all], Mask(8 * ceil32(arg5.length) - arg5.length, -(8 * ceil32(arg5.length) + -ceil32(ceil32(arg5.length)) + 31) + 256, arg6.length) >> -(8 * ceil32(arg5.length) + -ceil32(ceil32(arg5.length)) + 31) + 256) << (8 * ceil32(arg5.length)) - 256, Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[ceil32(ceil32(arg5.length)) + ceil32(ceil32(arg6.length)) + arg5.length + 230 len ceil32(arg6.length) - arg5.length + ceil32(arg5.length)]), ceil32(arg5.length) + 96
    ...
    require ext_code.size(0x1e0c701e0bef833d57992719e04ff3082f289d70)
    delegate 0x1e0c701e0bef833d57992719e04ff3082f289d70.0x746d19f6 with:
         gas gas_remaining wei
    ...
    call sub_a296454fAddress.0x266f24b7 with:
         gas gas_remaining wei
        args arg7, address(delegate.return_data[0]), address(ext_call.return_data[0]), address(delegate.return_data[0])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    sub_989796b5[address(arg2)] = address(arg4)
    emit PoolAdded(address(arg2));
}

function sub_e0cff141(?) payable {
    ...
    if owner != msg.sender:
        revert with 0, 32, 32, 0xfe4f776e61626c653a2063616c6c6572206973206e6f7420746865206f776e65
    if pools[address(arg4)].field_256:
        revert with 0, 'Pool is already registered or active'
    if ceil32(arg6.length) <= arg6.length:
        require ext_code.size(0xf6c10bf763211f4fb2d487837b4f2b74dbc5a103)
        delegate 0xf6c10bf763211f4fb2d487837b4f2b74dbc5a103.0x8f00c962 with:
             gas gas_remaining wei
            args Array(len=arg6.length, data=Mask(8 * ceil32(arg6.length), -(8 * ceil32(arg6.length)) + 256, arg6[all], Mask(8 * ceil32(arg6.length) - arg6.length, -(8 * ceil32(arg6.length) + -ceil32(ceil32(arg6.length)) + 31) + 256, arg7.length) >> -(8 * ceil32(arg6.length) + -ceil32(ceil32(arg6.length)) + 31) + 256) << (8 * ceil32(arg6.length)) - 256, arg7.length, Mask(8 * ceil32(arg7.length), -(8 * ceil32(arg7.length)) + 256, arg7[all], Mask(8 * ceil32(arg7.length) - arg7.length, -(8 * ceil32(arg7.length) + -ceil32(ceil32(arg7.length)) + 27) + 256, 64) >> -(8 * ceil32(arg7.length) + -ceil32(ceil32(arg7.length)) + 27) + 256) << (8 * ceil32(arg7.length)) - 256), ceil32(arg6.length) + 96
    else:
        mem[ceil32(arg6.length) + ceil32(ceil32(arg6.length)) + ceil32(ceil32(arg7.length)) + 198] = arg7.length
        mem[ceil32(arg6.length) + ceil32(ceil32(arg6.length)) + ceil32(ceil32(arg7.length)) + 230 len ceil32(arg7.length)] = arg7[all], Mask(8 * ceil32(arg7.length) - arg7.length, -(8 * ceil32(arg7.length) + -ceil32(ceil32(arg7.length)) + 27) + 256, 64) >> -(8 * ceil32(arg7.length) + -ceil32(ceil32(arg7.length)) + 27) + 256
        if ceil32(arg7.length) > arg7.length:
            mem[arg7.length + ceil32(arg6.length) + ceil32(ceil32(arg6.length)) + ceil32(ceil32(arg7.length)) + 230] = 0
        require ext_code.size(0xf6c10bf763211f4fb2d487837b4f2b74dbc5a103)
        delegate 0xf6c10bf763211f4fb2d487837b4f2b74dbc5a103.0x8f00c962 with:
             gas gas_remaining wei
            args Array(len=arg6.length, data=Mask(8 * ceil32(arg6.length), -(8 * ceil32(arg6.length)) + 256, arg6[all], Mask(8 * ceil32(arg6.length) - arg6.length, -(8 * ceil32(arg6.length) + -ceil32(ceil32(arg6.length)) + 31) + 256, arg7.length) >> -(8 * ceil32(arg6.length) + -ceil32(ceil32(arg6.length)) + 31) + 256) << (8 * ceil32(arg6.length)) - 256, Mask(8 * -ceil32(arg6.length) + arg6.length + 32, 0, 0), mem[ceil32(ceil32(arg6.length)) + ceil32(ceil32(arg7.length)) + arg6.length + 230 len ceil32(arg7.length) - arg6.length + ceil32(arg6.length)]), ceil32(arg6.length) + 96
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require delegate.return_data[0] == delegate.return_data[12 len 20]
    ...
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    require ext_code.size(0x1e0c701e0bef833d57992719e04ff3082f289d70)
    delegate 0x1e0c701e0bef833d57992719e04ff3082f289d70.0x16e16bf6 with:
         gas gas_remaining wei
        args arg1, address(delegate.return_data[0]), address(arg2), address(arg4), this.address, sub_a296454fAddress, address(ext_call.return_data[0]), sub_131edc46Address
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require delegate.return_data[0] == delegate.return_data[12 len 20]
    ...
    call sub_a296454fAddress.0x266f24b7 with:
         gas gas_remaining wei
        args arg8, address(delegate.return_data[0]), address(ext_call.return_data[0]), address(delegate.return_data[0])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    pools[address(arg4)].field_0 = arg1
    pools[address(arg4)].field_256 = 1
    pools[address(arg4)].field_264 = address(arg2)
    pools[address(arg4)].field_512 = address(arg3)
    pools[address(arg4)].field_768 = 0
    pools[address(arg4)].field_1024 = 0
    pools[address(arg4)].field_1280 = address(delegate.return_data[0])
    pools[address(arg4)].field_1536 = address(ext_call.return_data[0])
    pools[address(arg4)].field_1792 = address(delegate.return_data[0])
    sub_989796b5[address(arg4)] = address(arg5)
    emit PoolAdded(address(arg2));
}
...
function sub_16762eed(?) payable {
    ...
    if not ext_call.return_data[0] * pools[address(arg1)].field_1024:
        ...
        if not ext_call.return_data[0] * pools[address(arg1)].field_768:
            require ext_code.size(pools[address(arg1)].field_1280)
            call pools[address(arg1)].field_1280.0x9dc29fac with:
                 gas gas_remaining wei
                args msg.sender, arg2
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[(2 * ceil32(return_data.size)) + 100] = sub_989796b5[address(arg1)]
            ...
            call pools[address(arg1)].field_512.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args sub_989796b5[address(arg1)], 0
            ...
            require ext_code.size(sub_ed9a5540Address)
            call sub_ed9a5540Address.0x441a3e70 with:
                 gas gas_remaining wei
            ...
            require ext_code.size(sub_989796b5[address(arg1)])
            call sub_989796b5[address(arg1)].withdraw(address arg1, uint256 arg2, uint256 arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
            ...
            call pools[address(arg1)].field_512.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args sub_989796b5[address(arg1)], arg2 * pools[address(arg1)].field_768 / ext_call.return_data[0]
            mem[(2 * ceil32(return_data.size)) + 96] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
        ...
        if not ext_call.return_data[0] * pools[address(arg1)].field_768:
            ...
            call pools[address(arg1)].field_512.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args sub_989796b5[address(arg1)], arg2 * ext_call.return_data[0] / pools[address(arg1)].field_1024 * pools[address(arg1)].field_768 / ext_call.return_data[0]
            mem[(2 * ceil32(return_data.size)) + 96] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
...
function sub_1ab21c07(?) payable {
    require calldata.size - 4 >= 160
    require arg1 == address(arg1)
    require arg2 == address(arg2)
    require arg5 == address(arg5)
    if pools[address(arg2)].field_1792 != msg.sender:
        revert with 0, 'Only helper can withdraw'
    require ext_code.size(pools[address(arg2)].field_1280)
    staticcall pools[address(arg2)].field_1280.0x18160ddd with:
            gas gas_remaining wei
    ...
    if not ext_call.return_data[0] * pools[address(arg2)].field_1024:
        ...
        if not ext_call.return_data[0] * pools[address(arg2)].field_768:
            require ext_code.size(pools[address(arg2)].field_1280)
            call pools[address(arg2)].field_1280.0x9dc29fac with:
                 gas gas_remaining wei
                args msg.sender, arg3
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[(2 * ceil32(return_data.size)) + 100] = sub_989796b5[address(arg2)]
            mem[(2 * ceil32(return_data.size)) + 132] = 0
            require ext_code.size(pools[address(arg2)].field_512)
            call pools[address(arg2)].field_512.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args sub_989796b5[address(arg2)], 0
            mem[(2 * ceil32(return_data.size)) + 96] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            ...
            call sub_ed9a5540Address.0x441a3e70 with:
                 gas gas_remaining wei
                args pools[address(arg2)].field_0, 0
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[(4 * ceil32(return_data.size)) + 100] = this.address
            require ext_code.size(address(arg1))
            ...
            require return_data.size >= 32
            mem[(6 * ceil32(return_data.size)) + 132] = 0
            mem[(6 * ceil32(return_data.size)) + 164] = arg4
            mem[(6 * ceil32(return_data.size)) + 196] = this.address
            mem[(6 * ceil32(return_data.size)) + 228] = block.timestamp
            require ext_code.size(sub_989796b5[address(arg2)])
            call sub_989796b5[address(arg2)].withdraw(address arg1, uint256 arg2, uint256 arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args address(arg1), 0, arg4, this.address, block.timestamp
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if pools[address(arg2)].field_1024 < arg3:
                revert with 0, 17
            pools[address(arg2)].field_1024 -= arg3
            if pools[address(arg2)].field_768 < 0:
                revert with 0, 17
        else:
            if arg3 and pools[address(arg2)].field_768 > -1 / arg3:
                revert with 0, 17
            if not ext_call.return_data[0]:
                revert with 0, 18
            require ext_code.size(pools[address(arg2)].field_1280)
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[(2 * ceil32(return_data.size)) + 100] = sub_989796b5[address(arg2)]
            mem[(2 * ceil32(return_data.size)) + 132] = arg3 * pools[address(arg2)].field_768 / ext_call.return_data[0]
            require ext_code.size(pools[address(arg2)].field_512)
            call pools[address(arg2)].field_512.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args sub_989796b5[address(arg2)], arg3 * pools[address(arg2)].field_768 / ext_call.return_data[0]
            mem[(2 * ceil32(return_data.size)) + 96] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require ext_call.return_data[0] == bool(ext_call.return_data[0])
            mem[(4 * ceil32(return_data.size)) + 132] = arg3 * pools[address(arg2)].field_768 / ext_call.return_data[0]
            require ext_code.size(sub_ed9a5540Address)
            call sub_ed9a5540Address.0x441a3e70 with:
                 gas gas_remaining wei
                args pools[address(arg2)].field_0, arg3 * pools[address(arg2)].field_768 / ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[(4 * ceil32(return_data.size)) + 100] = this.address
            require ext_code.size(address(arg1))
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(6 * ceil32(return_data.size)) + 132] = arg3 * pools[address(arg2)].field_768 / ext_call.return_data[0]
            mem[(6 * ceil32(return_data.size)) + 164] = arg4
            mem[(6 * ceil32(return_data.size)) + 196] = this.address
            mem[(6 * ceil32(return_data.size)) + 228] = block.timestamp
            require ext_code.size(sub_989796b5[address(arg2)])
            call sub_989796b5[address(arg2)].withdraw(address arg1, uint256 arg2, uint256 arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args address(arg1), arg3 * pools[address(arg2)].field_768 / ext_call.return_data[0], arg4, this.address, block.timestamp
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if pools[address(arg2)].field_1024 < arg3:
                revert with 0, 17
            pools[address(arg2)].field_1024 -= arg3
            if pools[address(arg2)].field_768 < arg3 * pools[address(arg2)].field_768 / ext_call.return_data[0]:
                revert with 0, 17
            pools[address(arg2)].field_768 -= arg3 * pools[address(arg2)].field_768 / ext_call.return_data[0]
    else:
        ...
        if not ext_call.return_data[0] * pools[address(arg2)].field_768:
            ...
            call pools[address(arg2)].field_1280.0x9dc29fac with:
                 gas gas_remaining wei
                args msg.sender, arg3 * ext_call.return_data[0] / pools[address(arg2)].field_1024
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[(2 * ceil32(return_data.size)) + 100] = sub_989796b5[address(arg2)]
            mem[(2 * ceil32(return_data.size)) + 132] = 0
            ...
            if arg3 * ext_call.return_data[0] / pools[address(arg2)].field_1024 and pools[address(arg2)].field_768 > -1 / arg3 * ext_call.return_data[0] / pools[address(arg2)].field_1024:
                revert with 0, 17
            if not ext_call.return_data[0]:
                revert with 0, 18
            require ext_code.size(pools[address(arg2)].field_1280)
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[(2 * ceil32(return_data.size)) + 100] = sub_989796b5[address(arg2)]
            mem[(2 * ceil32(return_data.size)) + 132] = arg3 * ext_call.return_data[0] / pools[address(arg2)].field_1024 * pools[address(arg2)].field_768 / ext_call.return_data[0]
            require ext_code.size(pools[address(arg2)].field_512)
            call pools[address(arg2)].field_512.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args sub_989796b5[address(arg2)], arg3 * ext_call.return_data[0] / pools[address(arg2)].field_1024 * pools[address(arg2)].field_768 / ext_call.return_data[0]
            mem[(2 * ceil32(return_data.size)) + 96] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require ext_call.return_data[0] == bool(ext_call.return_data[0])
            mem[(4 * ceil32(return_data.size)) + 132] = arg3 * ext_call.return_data[0] / pools[address(arg2)].field_1024 * pools[address(arg2)].field_768 / ext_call.return_data[0]
            require ext_code.size(sub_ed9a5540Address)
            call sub_ed9a5540Address.0x441a3e70 with:
                 gas gas_remaining wei
                args pools[address(arg2)].field_0, arg3 * ext_call.return_data[0] / pools[address(arg2)].field_1024 * pools[address(arg2)].field_768 / ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            mem[(4 * ceil32(return_data.size)) + 100] = this.address
            require ext_code.size(address(arg1))
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(6 * ceil32(return_data.size)) + 132] = arg3 * ext_call.return_data[0] / pools[address(arg2)].field_1024 * pools[address(arg2)].field_768 / ext_call.return_data[0]
            mem[(6 * ceil32(return_data.size)) + 164] = arg4
            mem[(6 * ceil32(return_data.size)) + 196] = this.address
            mem[(6 * ceil32(return_data.size)) + 228] = block.timestamp
            require ext_code.size(sub_989796b5[address(arg2)])
            call sub_989796b5[address(arg2)].withdraw(address arg1, uint256 arg2, uint256 arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args address(arg1), arg3 * ext_call.return_data[0] / pools[address(arg2)].field_1024 * pools[address(arg2)].field_768 / ext_call.return_data[0], arg4, this.address, block.timestamp
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if pools[address(arg2)].field_1024 < arg3:
                revert with 0, 17
            pools[address(arg2)].field_1024 -= arg3
            if pools[address(arg2)].field_768 < arg3 * ext_call.return_data[0] / pools[address(arg2)].field_1024 * pools[address(arg2)].field_768 / ext_call.return_data[0]:
                revert with 0, 17
            pools[address(arg2)].field_768 -= arg3 * ext_call.return_data[0] / pools[address(arg2)].field_1024 * pools[address(arg2)].field_768 / ext_call.return_data[0]
    mem[(6 * ceil32(return_data.size)) + 100] = this.address
    require ext_code.size(address(arg1))
    staticcall address(arg1).0x70a08231 with:
            gas gas_remaining wei
    ...
    if ext_call.return_data[0] < ext_call.return_data[0]:
        revert with 0, 17
    mem[(7 * ceil32(return_data.size)) + 132] = address(arg5)
    mem[(7 * ceil32(return_data.size)) + 164] = 0
    mem[(7 * ceil32(return_data.size)) + 96] = 68
    mem[(7 * ceil32(return_data.size)) + 132 len 28] = address(arg5) << 64
    mem[(7 * ceil32(return_data.size)) + 128 len 4] = unknown_0xa9059cbb(?????)
    mem[(7 * ceil32(return_data.size)) + 196] = 32
    mem[(7 * ceil32(return_data.size)) + 228] = 'SafeERC20: low-level call failed'
    if eth.balance(this.address) < 0:
    ...
    if not ext_code.size(address(arg1)):
        revert with 0, 'Address: call to non-contract'
    mem[(7 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), address(arg5) << 64, 0, 0, 0
    mem[(7 * ceil32(return_data.size)) + 328] = 0
    call address(arg1) with:
       funct Mask(32, 224, unknown_0xa9059cbb(?????), address(arg5) << 64, 0, 0, 0) >> 224
         gas gas_remaining wei
        args (Mask(512, -288, unknown_0xa9059cbb(?????), address(arg5) << 64, 0, 0, 0) << 288)
    if not return_data.size:
        if not ext_call.success:
            if ext_call.return_data[0]:
                revert with memory
        ...
        if return_data.size:
            ...
            if not mem[(7 * ceil32(return_data.size)) + 292]:
                revert with 0, 'SafeERC20: ERC20 operation did not succeed'
    emit NewWithdraw(arg3, address(arg5), address(arg1));
}
...
function harvest(address arg1, bool arg2) payable {
    ...
    require ext_code.size(sub_ed9a5540Address)
    call sub_ed9a5540Address.0xe2bbb158 with:
         gas gas_remaining wei
        args pools[address(arg1)].field_0, 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
