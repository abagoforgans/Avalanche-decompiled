...
uint8 withdrawEnabled; offset 160
...
address sub_1b0554b4Address;
address sub_349ff790Address;
...
function sub_1b0554b4(?) {
    return sub_1b0554b4Address
}
...
function sub_349ff790(?) {
    return sub_349ff790Address
}
...
function sub_2e750771(?) {
    ...
    stor5 = Mask(96, 0, not withdrawEnabled)
}
...
function setEcosystemAddress(address arg1) {
    ...
    _tokenAddress = ext_call.return_data[12 len 20]
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    sub_349ff790Address = ext_call.return_data[12 len 20]
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    sub_ae5b5b11Address = ext_call.return_data[12 len 20]
}
        ...
        if ext_call.return_data[0]:
            if block.number <= bonusEndBlock:
                ...
                call tokenAddress.0x23b872dd with:
                     gas gas_remaining wei
                    args sub_ae5b5b11Address, rewardReceiverAddress, (10 * block.number * tokensPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * tokensPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                call tokenAddress.0x23b872dd with:
                     gas gas_remaining wei
                    args sub_ae5b5b11Address, this.address, (10 * block.number * tokensPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * tokensPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                ...
                if poolInfo[arg1].field_512 >= bonusEndBlock:
                    ...
                    call tokenAddress.0x23b872dd with:
                         gas gas_remaining wei
                        args sub_ae5b5b11Address, rewardReceiverAddress, (block.number * tokensPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokensPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    call tokenAddress.0x23b872dd with:
                         gas gas_remaining wei
                        args sub_ae5b5b11Address, this.address, (block.number * tokensPerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * tokensPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    ...
                    call tokenAddress.0x23b872dd with:
                         gas gas_remaining wei
                        args sub_ae5b5b11Address, rewardReceiverAddress, (9 * bonusEndBlock * tokensPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * tokensPerBlock * poolInfo[arg1].field_256) + (block.number * tokensPerBlock * poolInfo[arg1].field_256) / totalAllocPoint / 10
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    call tokenAddress.0x23b872dd with:
                         gas gas_remaining wei
                        args sub_ae5b5b11Address, this.address, (9 * bonusEndBlock * tokensPerBlock * poolInfo[arg1].field_256) - (10 * poolInfo[arg1].field_512 * tokensPerBlock * poolInfo[arg1].field_256) + (block.number * tokensPerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
        ...
        if block.number > poolInfo[idx].field_512:
            ...
            if mem[_33]:
                if block.number <= bonusEndBlock:
                    ...
                    if not totalAllocPoint:
                        revert with 0, 18
                    mem[mem[64] + 4] = sub_ae5b5b11Address
                    ...
                    call tokenAddress.0x23b872dd with:
                         gas gas_remaining wei
                        args sub_ae5b5b11Address, rewardReceiverAddress, (10 * block.number * tokensPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * tokensPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _41 = mem[64]
                    ...
                    call tokenAddress.0x23b872dd with:
                         gas gas_remaining wei
                        args sub_ae5b5b11Address, this.address, (10 * block.number * tokensPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * tokensPerBlock * poolInfo[idx].field_256) / totalAllocPoint
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _49 = mem[64]
                    ...
                    if poolInfo[idx].field_512 >= bonusEndBlock:
                        ...
                        call tokenAddress.0x23b872dd with:
                             gas gas_remaining wei
                            args sub_ae5b5b11Address, rewardReceiverAddress, (block.number * tokensPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokensPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
                        mem[mem[64]] = ext_call.return_data[0]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        _37 = mem[64]
                        ...
                        call tokenAddress.0x23b872dd with:
                             gas gas_remaining wei
                            args sub_ae5b5b11Address, this.address, (block.number * tokensPerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * tokensPerBlock * poolInfo[idx].field_256) / totalAllocPoint
                        mem[mem[64]] = ext_call.return_data[0]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        _45 = mem[64]
                        ...
                        call tokenAddress.0x23b872dd with:
                             gas gas_remaining wei
                            args sub_ae5b5b11Address, rewardReceiverAddress, (9 * bonusEndBlock * tokensPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * tokensPerBlock * poolInfo[idx].field_256) + (block.number * tokensPerBlock * poolInfo[idx].field_256) / totalAllocPoint / 10
                        mem[mem[64]] = ext_call.return_data[0]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        _53 = mem[64]
                        ...
                        call tokenAddress.0x23b872dd with:
                             gas gas_remaining wei
                            args sub_ae5b5b11Address, this.address, (9 * bonusEndBlock * tokensPerBlock * poolInfo[idx].field_256) - (10 * poolInfo[idx].field_512 * tokensPerBlock * poolInfo[idx].field_256) + (block.number * tokensPerBlock * poolInfo[idx].field_256) / totalAllocPoint
                        mem[mem[64]] = ext_call.return_data[0]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        _57 = mem[64]
...
function withdraw(uint256 arg1, uint256 arg2) {
    ...
    if block.number <= poolInfo[arg1].field_512:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        mem[ceil32(return_data.size) + 100] = sub_349ff790Address
        if (userInfo[arg1][msg.sender].field_0 * poolInfo[arg1].field_768 / 10^12) - userInfo[arg1][msg.sender].field_256 <= ext_call.return_data[0]:
            ...
            call tokenAddress.0xa9059cbb with:
                 gas gas_remaining wei
                args sub_349ff790Address, (userInfo[arg1][msg.sender].field_0 * poolInfo[arg1].field_768 / 10^12) - userInfo[arg1][msg.sender].field_256
        else:
            mem[ceil32(return_data.size) + 132] = ext_call.return_data[0]
            call tokenAddress.0xa9059cbb with:
                 gas gas_remaining wei
                args sub_349ff790Address, ext_call.return_data[0]
        mem[ceil32(return_data.size) + 96] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        ...
        if not ext_call.return_data[0]:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(2 * ceil32(return_data.size)) + 100] = sub_349ff790Address
            if (userInfo[arg1][msg.sender].field_0 * poolInfo[arg1].field_768 / 10^12) - userInfo[arg1][msg.sender].field_256 <= ext_call.return_data[0]:
                mem[(2 * ceil32(return_data.size)) + 132] = (userInfo[arg1][msg.sender].field_0 * poolInfo[arg1].field_768 / 10^12) - userInfo[arg1][msg.sender].field_256
                call tokenAddress.0xa9059cbb with:
                     gas gas_remaining wei
            ...
            if block.number <= bonusEndBlock:
                ...
                if not totalAllocPoint:
                    revert with 0, 18
                mem[ceil32(return_data.size) + 100] = sub_ae5b5b11Address
                ...
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                mem[(2 * ceil32(return_data.size)) + 100] = sub_ae5b5b11Address
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[(6 * ceil32(return_data.size)) + 100] = sub_349ff790Address
            if (userInfo[arg1][msg.sender].field_0 * poolInfo[arg1].field_768 / 10^12) - userInfo[arg1][msg.sender].field_256 <= ext_call.return_data[0]:
