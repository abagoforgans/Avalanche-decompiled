...
function withdraw() payable {
    ...
    if eth.balance(this.address) and 5 > -1 / eth.balance(this.address):
        revert with 'NH{q', 17
    call 0xb005f38da5f110d5c422f9fb3e1177243bfa96e9 with:
...
function setBaseURI(string arg1) {
    ...
    if bool(stor11.length):
        if not bool(stor11.length) - (stor11.length.field_1 < 32):
            revert with 'NH{q', 34
        if arg1.length:
...
function setBaseExtension(string arg1) {
    ...
    if bool(stor12.length):
        if not bool(stor12.length) - (stor12.length.field_1 < 32):
            revert with 'NH{q', 34
        if arg1.length:
            ...
            if arg1:
                if not arg1:
                    ...
                    if ext_code.size(arg1) > 0:
                        ...
                        s = 0
                        while s < 0:
                            mem[mem[64] + s + 164] = mem[_377 + s + 32]
                            s = s + 32
                            continue 
                ...
                if arg1:
                    if not arg1:
                        ...
                        if ext_code.size(arg1) > 0:
                            ...
                            s = 0
                            while s < 0:
                                mem[mem[64] + s + 164] = mem[_378 + s + 32]
                                s = s + 32
                                continue 
                            call arg1.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                                 gas gas_remaining wei
                ...
                if arg1:
                    if not arg1:
                        ...
                        if ext_code.size(arg1) > 0:
                            ...
                            s = 0
                            while s < 0:
                                mem[mem[64] + s + 164] = mem[_379 + s + 32]
                                s = s + 32
                                continue 
                            call arg1.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                                 gas gas_remaining wei
                    ...
                    if ext_code.size(arg1) > 0:
                        ...
                        mem[64] = mem[64] + ceil32(return_data.size)
                        require return_data.size >= 32
                        require mem[_786] == Mask(32, 224, mem[_786])
                        if Mask(32, 224, mem[_786]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                if not idx - 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff:
                    revert with 'NH{q', 17
                idx = idx + 1
