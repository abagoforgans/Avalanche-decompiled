...
function sub_eafadbc2(?) payable {
    if 0 == lastRewardTimestamp:
        return lastRewardTimestamp != 0
    return bool(bonusEndTimestamp)
}
...
function setStartTimeStamp(uint256 arg1) payable {
    ...
    if lastRewardTimestamp != 0:
        if bonusEndTimestamp:
            revert with 0, 'Factory is running'
...
function sub_37bedc14(?) payable {
    ...
    if not 24 * 3600 * arg2 * arg5:
        revert with 'NH{q', 18
    if arg6 > !(arg4 * arg1 * arg3 / 24 * 3600 * arg2 * arg5):
        revert with 'NH{q', 17
...
function getRewardPerSecond() payable {
    ...
    if not 24 * 3600 * sub_00f968e6 * sub_7093879d:
        revert with 'NH{q', 18
    if baseRate > !(rewardMultiplier * ext_call.return_data[0] * sub_18f9006a / 24 * 3600 * sub_00f968e6 * sub_7093879d):
        revert with 'NH{q', 17
        ...
        if ext_call.return_data[0]:
            if block.timestamp <= bonusEndTimestamp:
                ...
                if sub_8294a88e:
                    ...
                    if not ext_call.return_data[0]:
                        revert with 'NH{q', 18
                    if sub_dd69f04f > !((10^12 * block.timestamp * sub_8294a88e) - (10^12 * lastRewardTimestamp * sub_8294a88e) / ext_call.return_data[0]):
                        revert with 'NH{q', 17
                    ...
                    if not ext_call.return_data[0]:
                        ...
                        if not ext_call.return_data[0]:
                            revert with 'NH{q', 18
                        if sub_dd69f04f > !(0 / ext_call.return_data[0]):
                            revert with 'NH{q', 17
                        ...
                        if not sub_00f968e6:
                            ...
                            if not ext_call.return_data[0]:
                                revert with 'NH{q', 18
                            if sub_dd69f04f > !((10^12 * block.timestamp * baseRate) - (10^12 * lastRewardTimestamp * baseRate) / ext_call.return_data[0]):
                                revert with 'NH{q', 17
                ...
                if lastRewardTimestamp >= bonusEndTimestamp:
                    ...
                    if sub_8294a88e:
                        ...
                        if not ext_call.return_data[0]:
                            revert with 'NH{q', 18
                        if sub_dd69f04f > !((10^12 * bonusEndTimestamp * sub_8294a88e) - (10^12 * lastRewardTimestamp * sub_8294a88e) / ext_call.return_data[0]):
                            revert with 'NH{q', 17
                        ...
                        if not ext_call.return_data[0]:
                            ...
                            if not sub_00f968e6:
                                ...
                                if not ext_call.return_data[0]:
                                    revert with 'NH{q', 18
                                if sub_dd69f04f > !((10^12 * bonusEndTimestamp * baseRate) - (10^12 * lastRewardTimestamp * baseRate) / ext_call.return_data[0]):
                                    revert with 'NH{q', 17
