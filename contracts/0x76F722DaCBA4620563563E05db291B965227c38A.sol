...
const getName = 'StrategyPlatypusUsdce'
...
const sub_2bebee14(?) = 0x22d4002028f537599be9f666d1c4fa138522f9c8

const sub_3b74de3d(?) = 0x66357dcace80431aee0a7507e2e361b7e2402370
...
const sub_97168ca9(?) = 0xb0523f9f473812fb195ee49bc7d2ab9873a98044
...
function balanceOfPool() {
    require ext_code.size(0xb0523f9f473812fb195ee49bc7d2ab9873a98044)
    staticcall 0xb0523f9f473812fb195ee49bc7d2ab9873a98044.userInfo(uint256 arg1, address arg2) with:
            gas gas_remaining wei
...
function getHarvestable() {
    ...
    require ext_code.size(0xb0523f9f473812fb195ee49bc7d2ab9873a98044)
    staticcall 0xb0523f9f473812fb195ee49bc7d2ab9873a98044.pendingTokens(uint256 arg1, address arg2) with:
            gas gas_remaining wei
           args poolId, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function withdrawForSwap(uint256 arg1) {
    ...
    if address(controllerAddress) != msg.sender:
        revert with 0, '!controller'
    require ext_code.size(0xb0523f9f473812fb195ee49bc7d2ab9873a98044)
    call 0xb0523f9f473812fb195ee49bc7d2ab9873a98044.withdraw(uint256 arg1, uint256 arg2) with:
         gas gas_remaining wei
        args poolId, arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit() {
    ...
    if ext_call.return_data[0]:
        if not ext_code.size(wantAddress):
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = approve(address arg1, uint256 arg2), 0xb0523f9f473812fb195ee49b, 0, 0
        mem[324 len 0] = 0
        call wantAddress.0x73a98044 with:
             gas gas_remaining wei
            args Mask(480, -256, approve(address arg1, uint256 arg2), 0xb0523f9f473812fb195ee49b, 0, 0) << 256, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address arg1, uint256 arg2), 0xb0523f9f473812fb195ee49b, 0, 0
            if not approve(address arg1, uint256 arg2), 0xb0523f9f473812fb195ee49b:
                revert with 0, 32, 42, 0xc75361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
            if ext_call.return_data[0]:
                require ext_code.size(wantAddress)
                staticcall wantAddress.0xdd62ed3e with:
                        gas gas_remaining wei
                       args this.address, 0xb0523f9f473812fb195ee49bc7d2ab9873a98044
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                if ext_call.return_data[0]:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = 0, 0xb0523f9f473812fb195ee49bc7d2ab9873a98044, ext_call.return_data[0 len 28]
            call wantAddress.0x73a98044 with:
                 gas gas_remaining wei
            ...
            require ext_code.size(0xb0523f9f473812fb195ee49bc7d2ab9873a98044)
            call 0xb0523f9f473812fb195ee49bc7d2ab9873a98044.deposit(uint256 arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args poolId, ext_call.return_data[0]
        else:
            mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if not return_data.size:
                if not ext_call.return_data[0]:
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 425 len 64] = 0, 0xb0523f9f473812fb195ee49bc7d2ab9873a98044, ext_call.return_data[0 len 28]
                    call wantAddress.0x73a98044 with:
                         gas gas_remaining wei
