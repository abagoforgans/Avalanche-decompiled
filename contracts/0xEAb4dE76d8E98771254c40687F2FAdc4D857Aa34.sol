...
function sub_01315e39(?) {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    emit 0x9bd7b8cc: ext_call.return_data[0], stor11
        ...
        if ext_call.return_data[0] > ext_call.return_data[0] * stor16 / 1000:
            ...
            if eth.balance(this.address) - stor15 > 10^18:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
            emit 0xfbb6d94a: eth.balance(this.address) - stor15, ext_call.return_data[0] - stor14, ext_call.return_data[0], ext_call.return_data[0]
    ...
    if calldata.size >= 4:
        if unknown_0xae4bace5(?????) <= uint32(call.func_hash) >> 224:
            ...
            while idx < ('cd', 4).length:
                ...
                staticcall address(_422).0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                ...
                if mem[_432]:
                    ...
                    call address(_438).0xa9059cbb with:
                         gas gas_remaining wei
                        args address(cd[36]), _434
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _444 = mem[64]
