...
function burn(address arg1, uint256 arg2, uint256 arg3, bytes arg4) payable {
    ...
    emit 0xf1b60a25: address(msg.sender), address(arg1), arg2, block.timestamp, arg3, Array(len=arg4.length, data=arg4[all])
...
function mint(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    emit 0xe6e75b46: address(arg1), address(arg2), arg3, block.timestamp, arg4, Array(len=arg5.length, data=arg5[all])
