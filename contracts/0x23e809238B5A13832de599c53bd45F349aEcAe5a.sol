...
function sub_30a27228(?) {
    ...
    if not sub_84231261[stor13].field_768:
        ...
        while idx < stor9:
            ...
            if not totalSupply:
                revert with 0, 18
            if sha3(mem[_175 + 32 len mem[_175]]) % totalSupply >= ext_call.return_data[0]:
                s = 2
                t = ext_call.return_data[0]
                while s <= numContracts:
                    mem[0] = s
                    ...
                    if t > !mem[_335]:
                        revert with 0, 17
                    if _177 % totalSupply >= t + mem[_335]:
                        if s == -1:
                            revert with 0, 17
                        s = s + 1
                        t = t + mem[_335]
                    ...
                    if idx >= mem[96]:
                        revert with 0, 50
                    if t + mem[_335] < _177 % totalSupply:
                        revert with 0, 17
                    if idx >= mem[96]:
                        revert with 0, 50
                    mem[(32 * idx) + 128] = t + mem[_335] - (_177 % totalSupply)
                    mem[0] = s
                    mem[32] = 15
                    if idx >= mem[96]:
                        revert with 0, 50
                    mem[mem[64] + 4] = t + _342 - (_177 % totalSupply)
                    require ext_code.size(stor15[s])
                    staticcall stor15[s].0x6352211e with:
                            gas gas_remaining wei
                           args (t + _342 - (_177 % totalSupply))
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _401 = mem[64]
                    ...
                    _412 = mem[64]
                    mem[64] = mem[64] + 160
                    mem[_412] = sub_ceeca984 + 1
                    mem[_412 + 32] = s
                    mem[_412 + 64] = stor6
                    mem[_412 + 96] = t + _342 - (_177 % totalSupply)
                    mem[_412 + 128] = address(_406)
                    stor1 = sub_ceeca984 + 1
                    stor2 = s
                    stor3 = stor6
                    stor4 = t + _342 - (_177 % totalSupply)
                    stor5 = address(_406)
        ...
        while idx < stor9:
            ...
            if not totalSupply:
                revert with 0, 18
            if sha3(mem[_179 + 32 len mem[_179]]) % totalSupply >= ext_call.return_data[0]:
                s = 2
                t = ext_call.return_data[0]
                while s <= numContracts:
                    mem[0] = s
                    ...
                    if t > !mem[_339]:
                        revert with 0, 17
                    if _181 % totalSupply >= t + mem[_339]:
                        if s == -1:
                            revert with 0, 17
                        s = s + 1
                        t = t + mem[_339]
                    ...
                    if idx >= mem[96]:
                        revert with 0, 50
                    if t + mem[_339] < _181 % totalSupply:
                        revert with 0, 17
                    if idx >= mem[96]:
                        revert with 0, 50
                    mem[(32 * idx) + 128] = t + mem[_339] - (_181 % totalSupply)
                    mem[0] = s
                    mem[32] = 15
                    if idx >= mem[96]:
                        revert with 0, 50
                    mem[mem[64] + 4] = t + _343 - (_181 % totalSupply)
                    require ext_code.size(stor15[s])
                    staticcall stor15[s].0x6352211e with:
                            gas gas_remaining wei
                           args (t + _343 - (_181 % totalSupply))
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _403 = mem[64]
                    ...
                    _414 = mem[64]
                    mem[64] = mem[64] + 160
                    mem[_414] = sub_ceeca984 + 1
                    mem[_414 + 32] = s
                    mem[_414 + 64] = stor6
                    mem[_414 + 96] = t + _343 - (_181 % totalSupply)
                    mem[_414 + 128] = address(_407)
                    stor1 = sub_ceeca984 + 1
                    stor2 = s
                    stor3 = stor6
                    stor4 = t + _343 - (_181 % totalSupply)
                    stor5 = address(_407)
                    mem[0] = sub_ceeca984 + 1
                    mem[32] = 20
                    sub_edac4a84[stor10 + 1].field_0 = sub_ceeca984 + 1
                ...
                if not stor7:
                    revert with 0, 18
                mem[_173 + 196] = sha3(stor8, idx) % stor7
                require ext_code.size(storFE16)
                staticcall storFE16.0x4f6ccce7 with:
                        gas gas_remaining wei
                       args (sha3(stor8, idx) % stor7)
                mem[_173 + 192] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                if idx >= mem[96]:
                ...
                if idx >= mem[96]:
                    revert with 0, 50
                mem[_173 + ceil32(return_data.size) + 196] = ext_call.return_data[0]
                require ext_code.size(storFE16)
                staticcall storFE16.0x6352211e with:
                        gas gas_remaining wei
                       args ext_call.return_data[0]
                mem[_173 + ceil32(return_data.size) + 192] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] == ext_call.return_data[12 len 20]
                ...
                if 1 > !sub_ceeca984:
                    revert with 0, 17
                mem[64] = _173 + (2 * ceil32(return_data.size)) + 352
                mem[_173 + (2 * ceil32(return_data.size)) + 192] = sub_ceeca984 + 1
                mem[_173 + (2 * ceil32(return_data.size)) + 224] = 1
                mem[_173 + (2 * ceil32(return_data.size)) + 256] = stor6
                mem[_173 + (2 * ceil32(return_data.size)) + 288] = ext_call.return_data[0]
                mem[_173 + (2 * ceil32(return_data.size)) + 320] = address(ext_call.return_data[0])
                stor1 = sub_ceeca984 + 1
                stor2 = 1
                stor3 = stor6
                stor4 = ext_call.return_data[0]
