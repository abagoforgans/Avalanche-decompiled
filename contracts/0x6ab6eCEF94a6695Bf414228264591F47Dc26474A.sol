...
uint32 stor5;
address sub_954cef27Address;
uint256 stor5;
address qiAddress;
address sub_008746efAddress;
...
function sub_008746ef(?) {
    return sub_008746efAddress
}
...
function sub_954cef27(?) {
    return address(sub_954cef27Address)
}
...
function inCaseTokensGetStuck(address arg1, uint256 arg2, address arg3) {
    ...
    if sub_49401a3cAddress == arg1:
        revert with 0, '!safe'
    if address(sub_954cef27Address) == arg1:
        revert with 0, '!safe'
    if qiAddress == arg1:
        revert with 0, '!safe'
...
function deposit(uint256 arg1) {
    ...
    if not return_data.size:
        ...
        if sub_e110930fAddress == sub_49401a3cAddress:
            ...
            call sub_e110930fAddress.withdraw(uint256 arg1) with:
                 gas gas_remaining wei
                args arg1
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require ext_code.size(address(sub_954cef27Address))
            call address(sub_954cef27Address).mint() with:
               value arg1 wei
                 gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            if not arg1:
                ...
                staticcall sub_49401a3cAddress.0xdd62ed3e with:
                        gas gas_remaining wei
                       args this.address, address(sub_954cef27Address)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
            ...
            require ext_code.size(address(sub_954cef27Address))
            call address(sub_954cef27Address).0xa0712d68 with:
                 gas gas_remaining wei
                args arg1
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            if ext_call.return_data[0]:
                revert with 0, 'qiToken minting is failed!'
    else:
