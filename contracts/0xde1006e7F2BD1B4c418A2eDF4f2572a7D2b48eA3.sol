...
function sub_5ada1356(?) payable {
        ...
        if idx:
            ...
            if not ext_call.success:
                ...
                if idx - 1:
                    ...
                    staticcall 0xe54ca86531e17ef3616d22ca28b0d458b6c89106.getAmountsOut(uint256 arg1, address[] arg2) with:
                            gas gas_remaining wei
                           args arg3 / 10, 64, mem[mem[64] + 68 len (32 * _443) + 32]
                    if not ext_call.success:
                        if idx >= 2:
                            revert with 'NH{q', 50
                        mem[(32 * idx) + 96] = 0
        ...
        if t:
            ...
            if not ext_call.success:
                if t - 1:
                    ...
                    staticcall 0xe54ca86531e17ef3616d22ca28b0d458b6c89106.getAmountsOut(uint256 arg1, address[] arg2) with:
                            gas gas_remaining wei
                           args s / 10, 64, mem[mem[64] + 68 len (32 * _912) + 32]
                    if not ext_call.success:
                        if t >= 2:
                            revert with 'NH{q', 50
                        mem[(32 * t) + _419] = 0
                ...
                if t - 1:
                    ...
                    staticcall 0xe54ca86531e17ef3616d22ca28b0d458b6c89106.getAmountsOut(uint256 arg1, address[] arg2) with:
                            gas gas_remaining wei
                           args s / 10, 64, mem[mem[64] + 68 len (32 * _1492) + 32]
                    if not ext_call.success:
                        if t >= 2:
                            revert with 'NH{q', 50
                        mem[(32 * t) + _419] = 0
    ...
    while t < 10:
        ...
        if not ext_call.success:
            ...
            staticcall 0xe54ca86531e17ef3616d22ca28b0d458b6c89106.getAmountsOut(uint256 arg1, address[] arg2) with:
                    gas gas_remaining wei
                   args s + (_1684 * s) / 10, 64, mem[mem[64] + 68 len (32 * _2061) + 32]
            if not ext_call.success:
                if w >= 2:
                    revert with 'NH{q', 50
                if w >= 2:
