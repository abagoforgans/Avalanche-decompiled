...
function sub_135484ac(?) payable {
    ...
    mem[ceil32(return_data.size) + 164] = ('cd', 132).length
    idx = 0
    ...
    staticcall address(cd[4]).getAmountsOut(uint256 arg1, address[] arg2) with:
            gas gas_remaining wei
           args cd[100], Array(len=('cd', 132).length, data=mem[ceil32(return_data.size) + 196 len 32 * ('cd', 132).length])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[ceil32(return_data.size) + 96 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = (2 * ceil32(return_data.size)) + 96
    require return_data.size >= 32
    _32 = mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, cd[100]) >> 32
    require mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, cd[100]) >> 32 <= test266151307()
    require ceil32(return_data.size) + return_data.size + 96 > ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, cd[100]) >> 32 + 127
    _33 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, cd[100]) >> 32 + 96]
    if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, cd[100]) >> 32 + 96] > test266151307():
        revert with 'NH{q', 65
    if (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, cd[100]) >> 32 + 96]) + 97 > test266151307() or ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, cd[100]) >> 32 + 96]) + 1 < 0:
        revert with 'NH{q', 65
    mem[64] = (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, cd[100]) >> 32 + 96]) + 97
    ...
    mem[(2 * ceil32(return_data.size)) + 128 len 32 * _33] = mem[ceil32(return_data.size) + _32 + 128 len 32 * _33]
    ...
    if mem[_57 + 12 len 20] != address(cd[68]):
        if 0 >= _33:
            revert with 'NH{q', 50
        _61 = mem[(2 * ceil32(return_data.size)) + 128]
        _63 = mem[64]
        mem[mem[64]] = 0
        mem[64] = mem[64] + 32
        mem[_63 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
        mem[_63 + 36] = 0
        mem[_63 + 68] = _61
        mem[_63 + 100] = msg.sender
        mem[_63 + 132] = 128
        mem[_63 + 164] = mem[_63]
        mem[_63 + 196 len ceil32(mem[_63])] = mem[_63 + 32 len ceil32(mem[_63])]
        if ceil32(mem[_63]) > mem[_63]:
            mem[mem[_63] + _63 + 196] = 0
        require ext_code.size(address(cd[36]))
        call address(cd[36]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
             gas gas_remaining wei
            args 0, _61, address(msg.sender), 128, mem[_63], mem[_63 + 196 len ceil32(mem[_63])]
    else:
        if 1 >= _33:
            revert with 'NH{q', 50
        _62 = mem[(2 * ceil32(return_data.size)) + 160]
        _64 = mem[64]
        mem[mem[64]] = 0
        mem[64] = mem[64] + 32
        mem[_64 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
        mem[_64 + 36] = 0
        mem[_64 + 68] = _62
        mem[_64 + 100] = msg.sender
        mem[_64 + 132] = 128
        mem[_64 + 164] = mem[_64]
        mem[_64 + 196 len ceil32(mem[_64])] = mem[_64 + 32 len ceil32(mem[_64])]
        if ceil32(mem[_64]) > mem[_64]:
            mem[mem[_64] + _64 + 196] = 0
        require ext_code.size(address(cd[36]))
        call address(cd[36]).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
             gas gas_remaining wei
            args 0, _62, address(msg.sender), 128, mem[_64], mem[_64 + 196 len ceil32(mem[_64])]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
