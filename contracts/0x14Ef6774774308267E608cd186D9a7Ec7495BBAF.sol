...
function kill() payable {
    if 0xb083d5cb468c8f05d1d37c4954ad01678915a026 != msg.sender:
...
function sub_d4278269(?) payable {
    ...
    call address(arg4).approve(address arg1, uint256 arg2) with:
        ...
        args 0x60ae616a2155ee3d9a68541ba4544862310933d4, 0x4b3b4ca85a86c47a098a223fffffffff
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_f3db5490(?) payable {
    ...
    while arg1 > idx:
        ...
        call 0x60ae616a2155ee3d9a68541ba4544862310933d4.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args sub_8f7af475, sub_838de3ab, 160, address(this.address), block.timestamp + 60, mem[mem[64] + 164 len (32 * mem[96]) + 32]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if idx > -2:
            revert with 'NH{q', 17
...
function sub_a75b02fd(?) payable {
    ...
    call address(arg1).0x23b872dd with:
         gas gas_remaining wei
        args address(this.address), 0xb083d5cb468c8f05d1d37c4954ad01678915a026, ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
