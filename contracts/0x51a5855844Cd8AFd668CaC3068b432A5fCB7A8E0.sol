...
function sub_2f0a9ba0(?) payable {
    ...
    require arg2 == address(arg2)
    require msg.sender == stor2
    mem[96 len 2856] = code.data[3254 len 2856]
    create contract with 0 wei
                    code: code.data[3254 len 2856]
    ...
    call sub_7b127752Address.0xa9059cbb with:
         gas gas_remaining wei
        args address(ext_call.return_data[0]), 10
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    idx = 0
    while idx < 9:
        mem[mem[64] len 2856] = code.data[3254 len 2856]
        create contract with 0 wei
                        code: code.data[3254 len 2856]
        if not create.new_address:
            revert with ext_call.return_data[0 len return_data.size]
