...
function sub_792e9e61(?) payable {
    ...
    require ext_code.size(0x720dd9292b3d0dd78c9afa57afd948c2ea2d50d8)
    staticcall 0x720dd9292b3d0dd78c9afa57afd948c2ea2d50d8.token0() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    require ext_code.size(0x720dd9292b3d0dd78c9afa57afd948c2ea2d50d8)
    staticcall 0x720dd9292b3d0dd78c9afa57afd948c2ea2d50d8.getReserves() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
...
function sub_8fdadfc1(?) payable {
    ...
    require ext_code.size(0x7394401c38b63d216be5a518e78414701b2cf0e)
    staticcall 0x7394401c38b63d216be5a518e78414701b2cf0e.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    if uint8(stor1.field_160):
        if ext_call.return_data[0] <= 0:
            revert with 0, 'd'
        if block.number < uint128(stor1.field_0):
            revert with 0, '1e'
        require ext_code.size(0x6323c227f71b30babdd6fe84093027079a955662)
        call 0x6323c227f71b30babdd6fe84093027079a955662.rebase() with:
             gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[0]
        mem[(2 * ceil32(return_data.size)) + 100] = 0x6323c227f71b30babdd6fe84093027079a955662
        mem[(2 * ceil32(return_data.size)) + 132] = ext_call.return_data[0]
        require ext_code.size(0x7394401c38b63d216be5a518e78414701b2cf0e)
        call 0x07394401c38b63d216be5a518e78414701b2cf0e.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args 0x6323c227f71b30babdd6fe84093027079a955662, ext_call.return_data[0]
        ...
        require ext_code.size(0x6323c227f71b30babdd6fe84093027079a955662)
        call 0x6323c227f71b30babdd6fe84093027079a955662.unstake(uint256 arg1, bool arg2) with:
             gas gas_remaining wei
            args ext_call.return_data[0], 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[(4 * ceil32(return_data.size)) + 100] = this.address
        require ext_code.size(0x88a425b738682f58c0ff9fcf2cceb47a361ef4cf)
        staticcall 0x88a425b738682f58c0ff9fcf2cceb47a361ef4cf.0x70a08231 with:
                gas gas_remaining wei
               args this.address
        ...
        mem[(6 * ceil32(return_data.size)) + 128] = 0x88a425b738682f58c0ff9fcf2cceb47a361ef4cf
        ...
        require ext_code.size(0x88a425b738682f58c0ff9fcf2cceb47a361ef4cf)
        call 0x88a425b738682f58c0ff9fcf2cceb47a361ef4cf.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
        ...
        call 0x60ae616a2155ee3d9a68541ba4544862310933d4.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args ext_call.return_data[0], 0, 160, address(this.address), 3 * 10^10, 2, mem[(7 * ceil32(return_data.size)) + 388 len 64]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        _83 = mem[(7 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[0 len 28]
        ...
        _84 = mem[(7 * ceil32(return_data.size)) + mem[(7 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[0 len 28] + 192]
        ...
        require ext_code.size(0x6323c227f71b30babdd6fe84093027079a955662)
        call 0x6323c227f71b30babdd6fe84093027079a955662.epoch() with:
             gas gas_remaining wei
        ...
        uint128(stor1.field_0) = mem[_145 + 80 len 16]
    else:
        ...
        if uint128(stor1.field_0) < uint32(stor1.field_128):
            revert with 'NH{q', 17
        if block.number < uint128(uint128(stor1.field_0) - uint32(stor1.field_128)):
            revert with 0, '2c'
        mem[ceil32(return_data.size) + 100] = this.address
        ...
        mem[(2 * ceil32(return_data.size)) + 160] = 0x88a425b738682f58c0ff9fcf2cceb47a361ef4cf
        require ext_code.size(0x720dd9292b3d0dd78c9afa57afd948c2ea2d50d8)
        staticcall 0x720dd9292b3d0dd78c9afa57afd948c2ea2d50d8.token0() with:
                gas gas_remaining wei
        ...
        if address(ext_call.return_data[0]) == 0x130966628846bfd36ff31a822705796e8cb8c18d:
            ...
            mem[mem[64] + 4] = 0x6323c227f71b30babdd6fe84093027079a955662
            mem[mem[64] + 36] = _198
            require ext_code.size(0x88a425b738682f58c0ff9fcf2cceb47a361ef4cf)
            call 0x88a425b738682f58c0ff9fcf2cceb47a361ef4cf.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args 0x6323c227f71b30babdd6fe84093027079a955662, _198
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _204 = mem[64]
            ...
            require ext_code.size(0x6323c227f71b30babdd6fe84093027079a955662)
            call 0x6323c227f71b30babdd6fe84093027079a955662.stake(uint256 arg1, address arg2) with:
                 gas gas_remaining wei
            ...
            call 0x88a425b738682f58c0ff9fcf2cceb47a361ef4cf.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args 0x6323c227f71b30babdd6fe84093027079a955662, _199
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _205 = mem[64]
        ...
        require ext_code.size(0x6323c227f71b30babdd6fe84093027079a955662)
        call 0x6323c227f71b30babdd6fe84093027079a955662.claim(address arg1) with:
             gas gas_remaining wei
            args address(this.address)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
