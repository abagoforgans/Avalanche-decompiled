...
#
const name = 'SafePrinter', 0

const decimals = 9

const symbol = 'Rudolph Inu', 0
...
function ClearStuckBalance() {
    ...
    emit 0x98be19c3: eth.balance(this.address), stor22
}
...
function setFees(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4) {
    ...
    if stor14 > -stor13 - 1:
        revert with 'NH{q', 17
    if stor14 + stor13 > -stor12 - 1:
        revert with 'NH{q', 17
    if stor14 + stor13 + stor12 > -stor15 - 1:
        revert with 'NH{q', 17
    stor16 = stor14 + stor13 + stor12 + stor15
    if stor14 > -stor13 - 1:
        revert with 'NH{q', 17
    if stor14 + stor13 > -stor15 - 1:
        revert with 'NH{q', 17
    stor17 = stor14 + stor13 + stor15
    emit 0x881c278b: stor14, stor13, stor12, stor15, stor16
}
