...
function sub_8572f6a9(?) {
    ...
    require ceil32(return_data.size) + return_data.size + 192 > ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 2328306436 + 223
    ...
    if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 2328306436 + 192] > test266151307():
        revert with 0, 65
    if ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 2328306436 + 192]) + 1 < 0 or (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 2328306436 + 192]) + 193 > test266151307():
        revert with 0, 65
...
function sub_cd8ee10e(?) {
    ...
    require ceil32(return_data.size) + return_data.size + 192 > ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064365 + 223
    ...
    if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064365 + 192] > test266151307():
        revert with 0, 65
    if ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064365 + 192]) + 1 < 0 or (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064365 + 192]) + 193 > test266151307():
        revert with 0, 65
...
function getClaimFee() {
    ...
    require ceil32(return_data.size) + return_data.size + 192 > ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 0, stor5.field_32) + 223
    ...
    if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 0, stor5.field_32) + 192] > test266151307():
        revert with 0, 65
    if ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 0, stor5.field_32) + 192]) + 1 < 0 or (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 0, stor5.field_32) + 192]) + 193 > test266151307():
        revert with 0, 65
...
function sub_582726fc(?) {
    ...
    require ceil32(return_data.size) + return_data.size + 192 > ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 0, stor4.field_32) + 223
    ...
    if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 0, stor4.field_32) + 192] > test266151307():
        revert with 0, 65
    if ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 0, stor4.field_32) + 192]) + 1 < 0 or (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 0, stor4.field_32) + 192]) + 193 > test266151307():
        revert with 0, 65
...
function sub_0f274b8d(?) {
    ...
    while idx < ('cd', 36).length:
        ...
        idx = idx + 1
        continue 
    if stor11[address(cd[4])].field_0 != ('cd', 36).length:
        revert with 0, 'node length is not equal to enable array length'
    if ('cd', 36).length < 1:
        revert with 0, 17
    if var52001 < ('cd', 36).length:
        if mem[(32 * var54001) + 128]:
            idx = var54003
            while idx:
                if idx - 1 >= ('cd', 36).length:
                    revert with 0, 50
                if not mem[(32 * idx - 1) + 128]:
                    if stor11[address(cd[4])].field_0 < 1:
                        revert with 0, 17
                    if stor11[address(cd[4])].field_0 < 1:
                        revert with 0, 17
                    if stor11[address(cd[4])].field_0 - 1 >= stor11[address(cd[4])].field_0:
                        revert with 0, 50
                    if idx - 1 != stor11[address(cd[4])].field_0 - 1:
                        if idx - 1 >= stor11[address(cd[4])].field_0:
                            revert with 0, 50
                        stor11[address(cd[4])][idx].field_0 = stor11[address(cd[4])][stor11[address(cd[4])].field_0].field_0
                        stor11[address(cd[4])][idx].field_0 = stor11[address(cd[4])][stor11[address(cd[4])].field_0].field_0
                        stor11[address(cd[4])][idx].field_0 = stor11[address(cd[4])][stor11[address(cd[4])].field_0].field_0
                    stor11[address(cd[4])][stor11[address(cd[4])].field_0].field_0 = 0
                    stor11[address(cd[4])][stor11[address(cd[4])].field_0].field_0 = 0
                    stor11[address(cd[4])][stor11[address(cd[4])].field_0].field_0 = 0
                    if not stor11[address(cd[4])].field_0:
                        revert with 0, 49
                    mem[0] = sha3(address(cd[4]), 11)
                    stor11[address(cd[4])][stor11[address(cd[4])].field_0].field_0 = 0
                    stor11[address(cd[4])][stor11[address(cd[4])].field_0].field_0 = 0
                    stor11[address(cd[4])][stor11[address(cd[4])].field_0].field_0 = 0
                    stor11[address(cd[4])].field_0--
                    if not sub_c999fea3:
                        revert with 0, 17
                    sub_c999fea3--
                idx = idx - 1
                continue 
            emit 0xe70f71f8: address(cd[4])
        if stor11[address(cd[4])].field_0 < 1:
            revert with 0, 17
        if stor11[address(cd[4])].field_0 < 1:
            revert with 0, 17
        if var62002 == stor11[address(cd[4])].field_0 - 1:
            s = var68006
            while stor11[address(cd[4])].field_0 - 1 < stor11[address(cd[4])].field_0:
                stor11[address(cd[4])][stor11[address(cd[4])].field_0].field_0 = 0
                stor11[address(cd[4])][stor11[address(cd[4])].field_0].field_0 = 0
                stor11[address(cd[4])][stor11[address(cd[4])].field_0].field_0 = 0
                if not stor11[address(cd[4])].field_0:
            ...
            s = var68006
            while stor11[address(cd[4])].field_0 - 1 < stor11[address(cd[4])].field_0:
                if s < stor11[address(cd[4])].field_0:
                    stor11[address(cd[4])][s].field_0 = stor11[address(cd[4])][stor11[address(cd[4])].field_0].field_0
                    stor11[address(cd[4])][s].field_256 = stor11[address(cd[4])][stor11[address(cd[4])].field_0].field_0
                    stor11[address(cd[4])][s].field_512 = stor11[address(cd[4])][stor11[address(cd[4])].field_0].field_0
                    if stor11[address(cd[4])].field_0 < 1:
                        revert with 0, 17
                    s = var72006
                    while stor11[address(cd[4])].field_0 - 1 < stor11[address(cd[4])].field_0:
...
function buyNode(uint256 arg1) payable {
    ...
    require _123 + ceil32(return_data.size) + return_data.size + 96 > _123 + ceil32(return_data.size) + mem[_123 + ceil32(return_data.size) + 96 len 4], Mask(224, 0, stor4.field_32) + 127
    ...
    if mem[_123 + ceil32(return_data.size) + mem[_123 + ceil32(return_data.size) + 96 len 4], Mask(224, 0, stor4.field_32) + 96] > test266151307():
        revert with 0, 65
    if ceil32(32 * mem[_123 + ceil32(return_data.size) + mem[_123 + ceil32(return_data.size) + 96 len 4], Mask(224, 0, stor4.field_32) + 96]) + 1 < 0 or _123 + (2 * ceil32(return_data.size)) + ceil32(32 * mem[_123 + ceil32(return_data.size) + mem[_123 + ceil32(return_data.size) + 96 len 4], Mask(224, 0, stor4.field_32) + 96]) + 97 > test266151307():
        revert with 0, 65
    ...
    require mem[_123 + ceil32(return_data.size) + 96 len 4], Mask(224, 0, stor4.field_32) + (32 * _154) + 32 <= return_data.size
    ...
    if mem[_123 + (2 * ceil32(return_data.size)) + 160] and arg1 > -1 / mem[_123 + (2 * ceil32(return_data.size)) + 160]:
        revert with 0, 17
    if mem[_123 + (2 * ceil32(return_data.size)) + 160] * arg1 > eth.balance(msg.sender):
        revert with 0, 'no enough balance'
    call 0xcdd337ac33be88d437cfae5e1538ee73c8c76f98 with:
       value mem[_123 + (2 * ceil32(return_data.size)) + 160] * arg1 wei
