...
function sub_c7a54a97(?) payable {
    require ext_code.size(treasuryAddress)
    staticcall treasuryAddress.0xc7a54a97 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function initialize(address arg1, address arg2, address arg3) payable {
    ...
    stor4 = msg.sender or 0x10000000000000000000000000000000000000000 or Mask(88, 168, stor4) or Mask(96, 160, operatorAddress)
...
function stake(uint256 arg1) payable {
    ...
    if not msg.sender:
        ...
        if not balanceOf[address(msg.sender)]:
            ...
            if not ext_code.size(shareAddress):
                revert with 0, 'Address: call to non-contract'
            mem[868 len 96] = transferFrom(address arg1, address arg2, uint256 arg3), msg.sender, address(this.address), Mask(224, 32, arg1) >> 32
            mem[992 len 4] = 0
            mem[964 len 0] = 0
        else:
...
function claimReward() payable {
    if not msg.sender:
        if lastSnapshotIndexOf[msg.sender].field_256:
            ...
            if not ext_code.size(sub_f3499e22Address):
                revert with 0, 'Address: call to non-contract'
            mem[260 len 64] = transfer(address arg1, uint256 arg2), msg.sender, lastSnapshotIndexOf[msg.sender].field_288
            mem[324 len 0] = 0
            call sub_f3499e22Address with:
            ...
            if not return_data.size:
                if not ext_call.success:
                    revert with transfer(address arg1, uint256 arg2), msg.sender, lastSnapshotIndexOf[msg.sender].field_256
        ...
        if not balanceOf[address(msg.sender)]:
            ...
            if lastSnapshotIndexOf[msg.sender].field_256:
                ...
                if not ext_code.size(sub_f3499e22Address):
                    revert with 0, 'Address: call to non-contract'
                mem[836 len 64] = transfer(address arg1, uint256 arg2), msg.sender, lastSnapshotIndexOf[msg.sender].field_288
                mem[900 len 0] = 0
                call sub_f3499e22Address with:
                   funct uint32(msg.sender)
                     gas gas_remaining wei
        ...
        if not msg.sender:
            ...
            if not balanceOf[address(msg.sender)]:
                ...
                if not lastSnapshotIndexOf[msg.sender].field_256:
                    ...
                    if not ext_code.size(shareAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[836 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, arg1) >> 32
                    mem[900 len 0] = 0
                    call shareAddress with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                ...
                if not lastSnapshotIndexOf[msg.sender].field_256:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(shareAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[1000 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, arg1) >> 32
                        mem[1064 len 0] = 0
                        call shareAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                        ...
                        if not return_data.size:
                            ...
                            if not ext_code.size(shareAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 1001 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, arg1) >> 32
            ...
            if not msg.sender:
                ...
                if not balanceOf[address(msg.sender)]:
                    ...
                    if not lastSnapshotIndexOf[msg.sender].field_256:
                        ...
                        if not ext_code.size(shareAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[1412 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, arg1) >> 32
                        mem[1476 len 0] = 0
                        call shareAddress with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                        ...
                        if not ext_code.size(sub_f3499e22Address):
                            revert with 0, 'Address: call to non-contract'
                        mem[1412 len 64] = transfer(address arg1, uint256 arg2), msg.sender, lastSnapshotIndexOf[msg.sender].field_288
                        mem[1476 len 0] = 0
                        call sub_f3499e22Address with:
                           funct uint32(msg.sender)
                             gas gas_remaining wei
                    ...
                    if not lastSnapshotIndexOf[msg.sender].field_256:
                        ...
                        if not return_data.size:
                            ...
                            if not ext_code.size(shareAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[1576 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, arg1) >> 32
                            call shareAddress with:
                               funct uint32(msg.sender)
                                 gas gas_remaining wei
                            ...
                            if not ext_code.size(shareAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 1577 len 64] = transfer(address arg1, uint256 arg2), msg.sender, Mask(224, 32, arg1) >> 32
