...
#  - sub_86f3b157(?)
#
const VERSION = 0x312e302e31000000000000000000000000000000000000000000000000000000
        ...
        if block.timestamp < sub_da10c75c:
            ...
            if block.timestamp < cliff:
                ...
                if block.timestamp >= start + duration:
                    ...
                    if stor12[address(arg1)]:
                        ...
                        if not ext_code.size(arg1):
                            revert with 0, 'Address: call to non-contract'
                        mem[(2 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((block.timestamp * ext_call.return_data[0]) - (cliff * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (cliff * released[address(arg1)]) / duration - cliff + start) + released[address(arg1)], 0
                        mem[(2 * ceil32(return_data.size)) + 328] = 0
                        call arg1 with:
                           funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((block.timestamp * ext_call.return_data[0]) - (cliff * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (cliff * released[address(arg1)]) / duration - cliff + start) + released[address(arg1)], 0) >> 224
                             gas gas_remaining wei
                            args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((block.timestamp * ext_call.return_data[0]) - (cliff * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (cliff * released[address(arg1)]) / duration - cliff + start) + released[address(arg1)], 0) << 288)
            ...
            if stor12[address(arg1)]:
                ...
                if block.timestamp < cliff:
                    ...
                    if not ext_code.size(arg1):
                        revert with 0, 'Address: call to non-contract'
                    mem[(4 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] + released[address(arg1)], 0
                    ...
                    if block.timestamp >= start + duration:
                        ...
                        if not ext_code.size(arg1):
                            revert with 0, 'Address: call to non-contract'
                        mem[(4 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), stor8 * percentage / 100, 0
                        mem[(4 * ceil32(return_data.size)) + 328] = 0
                        call arg1 with:
                           funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), stor8 * percentage / 100, 0) >> 224
                             gas gas_remaining wei
                            args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), stor8 * percentage / 100, 0) << 288)
                    else:
                        if stor12[address(arg1)]:
                            if ext_call.return_data[0] + released[address(arg1)] - (stor8 * percentage / 100) > -1:
                                revert with 0, 17
                            ...
                            if not ext_code.size(arg1):
                                revert with 0, 'Address: call to non-contract'
                            mem[(4 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((block.timestamp * ext_call.return_data[0]) - (cliff * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (cliff * released[address(arg1)]) - (block.timestamp * stor8 * percentage / 100) + (cliff * stor8 * percentage / 100) / duration - cliff + start) + released[address(arg1)], 0
                            mem[(4 * ceil32(return_data.size)) + 328] = 0
                            call arg1 with:
                               funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((block.timestamp * ext_call.return_data[0]) - (cliff * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (cliff * released[address(arg1)]) - (block.timestamp * stor8 * percentage / 100) + (cliff * stor8 * percentage / 100) / duration - cliff + start) + released[address(arg1)], 0) >> 224
                                 gas gas_remaining wei
                                args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((block.timestamp * ext_call.return_data[0]) - (cliff * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (cliff * released[address(arg1)]) - (block.timestamp * stor8 * percentage / 100) + (cliff * stor8 * percentage / 100) / duration - cliff + start) + released[address(arg1)], 0) << 288)
            else:
                if ext_call.return_data[0] > !released[address(arg1)]:
                    revert with 0, 17
                if ext_call.return_data[0] + released[address(arg1)] and percentage > -1 / ext_call.return_data[0] + released[address(arg1)]:
                ...
                if block.timestamp < cliff:
                    ...
                    if block.timestamp >= start + duration:
                        ...
                        if not ext_code.size(arg1):
                            revert with 0, 'Address: call to non-contract'
                        mem[(4 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), (ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100, 0
                        mem[(4 * ceil32(return_data.size)) + 328] = 0
                        call arg1 with:
                           funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), (ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100, 0) >> 224
                             gas gas_remaining wei
                            args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), (ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100, 0) << 288)
                    else:
                        if stor12[address(arg1)]:
                            if ext_call.return_data[0] + released[address(arg1)] - ((ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100) > -1:
                                revert with 0, 17
                            ...
                            if not ext_code.size(arg1):
                                revert with 0, 'Address: call to non-contract'
                            mem[(4 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((block.timestamp * ext_call.return_data[0]) - (cliff * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (cliff * released[address(arg1)]) - (block.timestamp * (ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100) + (cliff * (ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100) / duration - cliff + start) + released[address(arg1)], 0
                            mem[(4 * ceil32(return_data.size)) + 328] = 0
                            call arg1 with:
                               funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((block.timestamp * ext_call.return_data[0]) - (cliff * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (cliff * released[address(arg1)]) - (block.timestamp * (ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100) + (cliff * (ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100) / duration - cliff + start) + released[address(arg1)], 0) >> 224
                                 gas gas_remaining wei
                                args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((block.timestamp * ext_call.return_data[0]) - (cliff * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (cliff * released[address(arg1)]) - (block.timestamp * (ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100) + (cliff * (ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100) / duration - cliff + start) + released[address(arg1)], 0) << 288)
            if not return_data.size:
                if not ext_call.success:
                    if ext_call.return_data[0]:
                        revert with memory
        ...
        if stor12[address(arg1)]:
            ...
            if block.timestamp < sub_da10c75c:
                ...
                if block.timestamp < cliff:
                    ...
                    if not ext_code.size(arg1):
                        revert with 0, 'Address: call to non-contract'
                    mem[(4 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - (stor8 * percentage / 100) + released[address(arg1)], 0
                    mem[(4 * ceil32(return_data.size)) + 328] = 0
                    call arg1 with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - (stor8 * percentage / 100) + released[address(arg1)], 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - (stor8 * percentage / 100) + released[address(arg1)], 0) << 288)
                else:
                    if start > !duration:
                        revert with 0, 17
                    if block.timestamp >= start + duration:
                        ...
                        if stor12[address(arg1)]:
                            ...
                            if not ext_code.size(arg1):
                                revert with 0, 'Address: call to non-contract'
                            mem[(4 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((block.timestamp * ext_call.return_data[0]) - (cliff * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (cliff * released[address(arg1)]) / duration - cliff + start) - (stor8 * percentage / 100) + released[address(arg1)], 0
                            mem[(4 * ceil32(return_data.size)) + 328] = 0
                            call arg1 with:
                               funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((block.timestamp * ext_call.return_data[0]) - (cliff * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (cliff * released[address(arg1)]) / duration - cliff + start) - (stor8 * percentage / 100) + released[address(arg1)], 0) >> 224
                                 gas gas_remaining wei
                                args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((block.timestamp * ext_call.return_data[0]) - (cliff * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (cliff * released[address(arg1)]) / duration - cliff + start) - (stor8 * percentage / 100) + released[address(arg1)], 0) << 288)
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0]:
                            revert with memory
                ...
                if stor12[address(arg1)]:
                    ...
                    if block.timestamp < cliff:
                        ...
                        if not ext_code.size(arg1):
                            revert with 0, 'Address: call to non-contract'
                        mem[(6 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - (stor8 * percentage / 100) + released[address(arg1)], 0
                        ...
                        if block.timestamp >= start + duration:
                            ...
                            if not ext_code.size(arg1):
                                revert with 0, 'Address: call to non-contract'
                            mem[(6 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), 0, 0
                            mem[(6 * ceil32(return_data.size)) + 328] = 0
                            call arg1 with:
                               funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), 0, 0) >> 224
                                 gas gas_remaining wei
                    ...
                    if block.timestamp < cliff:
                        ...
                        if block.timestamp >= start + duration:
                            ...
                            if not ext_code.size(arg1):
                                revert with 0, 'Address: call to non-contract'
                            mem[(6 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ((ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100) - (stor8 * percentage / 100), 0
                            mem[(6 * ceil32(return_data.size)) + 328] = 0
                            call arg1 with:
                               funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ((ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100) - (stor8 * percentage / 100), 0) >> 224
                                 gas gas_remaining wei
                                args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ((ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100) - (stor8 * percentage / 100), 0) << 288)
                        else:
                            if stor12[address(arg1)]:
                                if ext_call.return_data[0] + released[address(arg1)] - ((ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100) > !(stor8 * percentage / 100):
                                    revert with 0, 17
            ...
            if block.timestamp < sub_da10c75c:
                ...
                if block.timestamp < cliff:
                    ...
                    if not ext_code.size(arg1):
                        revert with 0, 'Address: call to non-contract'
                    mem[(4 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100) + released[address(arg1)], 0
                    mem[(4 * ceil32(return_data.size)) + 328] = 0
                    call arg1 with:
                       funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100) + released[address(arg1)], 0) >> 224
                         gas gas_remaining wei
                        args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100) + released[address(arg1)], 0) << 288)
                else:
                    if start > !duration:
                        revert with 0, 17
                    if block.timestamp >= start + duration:
                        ...
                        if stor12[address(arg1)]:
                            ...
                            mem[(4 * ceil32(return_data.size)) + 328] = 0
                            call arg1 with:
                               funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((block.timestamp * ext_call.return_data[0]) - (cliff * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (cliff * released[address(arg1)]) / duration - cliff + start) - ((ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100) + released[address(arg1)], 0) >> 224
                                 gas gas_remaining wei
                                args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((block.timestamp * ext_call.return_data[0]) - (cliff * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (cliff * released[address(arg1)]) / duration - cliff + start) - ((ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100) + released[address(arg1)], 0) << 288)
                if not return_data.size:
                    if not ext_call.success:
                        if ext_call.return_data[0]:
                            revert with memory
                ...
                if stor12[address(arg1)]:
                    ...
                    if block.timestamp < cliff:
                        ...
                        if not ext_code.size(arg1):
                            revert with 0, 'Address: call to non-contract'
                        mem[(6 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100) + released[address(arg1)], 0
                        mem[(6 * ceil32(return_data.size)) + 328] = 0
                        call arg1 with:
                           funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), ext_call.return_data[0] - ((ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100) + released[address(arg1)], 0) >> 224
                             gas gas_remaining wei
                        ...
                        if block.timestamp >= start + duration:
                            ...
                            if not ext_code.size(arg1):
                                revert with 0, 'Address: call to non-contract'
                            mem[(6 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), (stor8 * percentage / 100) - ((ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100), 0
                            mem[(6 * ceil32(return_data.size)) + 328] = 0
                            call arg1 with:
                               funct Mask(32, 224, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), (stor8 * percentage / 100) - ((ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100), 0) >> 224
                                 gas gas_remaining wei
                                args (Mask(512, -288, unknown_0xa9059cbb(?????), Mask(224, 0, stor0), uint32(stor0), (stor8 * percentage / 100) - ((ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100), 0) << 288)
                        else:
                            if stor12[address(arg1)]:
                                if ext_call.return_data[0] + released[address(arg1)] - (stor8 * percentage / 100) > !((ext_call.return_data[0] * percentage) + (released[address(arg1)] * percentage) / 100):
                                    revert with 0, 17
