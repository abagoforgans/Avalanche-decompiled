...
function swap(address arg1, address arg2, address arg3, uint256 arg4, uint256 arg5) payable {
    ...
    if arg1 == stor5:
        ...
        mem[64] = 648
        mem[520 len 28] = 0
        mem[516 len 4] = log(string arg1, address arg2)
    else:
        if arg2 == stor5:
            mem[128 len 64] = call.data[calldata.size len 64]
            stor7.length = 2
            ...
            mem[64] = 680
            mem[552 len 28] = 0
            mem[548 len 4] = log(string arg1, address arg2)
    ...
    while idx < arg5:
        ...
        call ROUTERAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args arg4 / arg5, 10, Array(len=stor7.length, data=mem[mem[64] + 196 len 32 * stor7.length]), address(arg3), block.timestamp
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        s = mem[64] + floor32((32 * stor7.length) - 1) + 197
        continue 
}
...
function sellInPortions(address arg1, address arg2, address arg3, uint256 arg4, uint256 arg5) payable {
    ...
    if arg4 >= 100:
        ...
        while idx < arg5:
            ...
            call ROUTERAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args ext_call.return_data[0] / arg5, 10, Array(len=stor7.length, data=mem[mem[64] + 196 len 32 * stor7.length]), address(arg3), block.timestamp
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            s = mem[64] + floor32((32 * stor7.length) - 1) + 197
            continue 
        ...
        while idx < arg5:
            ...
            call ROUTERAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args ext_call.return_data[0] * arg4 / 100 / arg5, 10, Array(len=stor7.length, data=mem[mem[64] + 196 len 32 * stor7.length]), address(arg3), block.timestamp
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            s = mem[64] + floor32((32 * stor7.length) - 1) + 197
            continue 
