...
function sub_9abed90d(?) payable {
    ...
    if not ext_call.return_data[0] - totalDeposited:
        ...
        if sub_cde8e5d3:
            return (0 / sub_cde8e5d3)
    else:
        if ext_call.return_data[0] - totalDeposited:
            ...
            if sub_cde8e5d3 <= 0:
                revert with 0, 'SafeMath: division by zero'
            if sub_cde8e5d3:
                return ((ext_call.return_data[0] * sub_7e72b29f) - (totalDeposited * sub_7e72b29f) / 10000 / sub_cde8e5d3)
    revert
}
...
function expand(uint256 arg1, uint256 arg2) payable {
    ...
    if not arg2:
        ...
        while idx < arg2:
            ...
            require idx < mem[96]
            mem[(32 * idx) + 128] = sha3(mem[_26 + 32 len mem[_26]]) % players.length
            idx = idx + 1
            continue 
    else:
        ...
        while idx < arg2:
            ...
            require players.length
            require idx < mem[96]
            mem[(32 * idx) + 128] = sha3(mem[_29 + 32 len mem[_29]]) % players.length
            idx = idx + 1
            continue 
    mem[mem[64]] = 32
