...
const sub_1cc09fd1(?) = 0xa94aa23f43e9f00ce154f3c1c7f971ecb5318be8

const ADMIN_ADDRESS = 0xf9e78c3a76befad33f25f1f55936234bee318f5b
...
function sub_ebdbe303(?) payable {
    ...
    if ext_call.return_data[0] > 0:
        ...
        call sub_692ff94bAddress.0x42842e0e with:
             gas gas_remaining wei
            args address(this.address), 0xf9e78c3a76befad33f25f1f55936234bee318f5b, arg1
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
...
function sub_d6aeb421(?) payable {
    ...
    if ext_call.return_data[0] > 0:
        require ext_code.size(sub_692ff94bAddress)
        staticcall sub_692ff94bAddress.tokenOfOwnerByIndex(address arg1, uint256 arg2) with:
                gas gas_remaining wei
        ...
        call sub_692ff94bAddress.0x42842e0e with:
             gas gas_remaining wei
            args address(this.address), 0xf9e78c3a76befad33f25f1f55936234bee318f5b, ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    emit 0x4183fb2f: ext_call.return_data[0]
}
...
function sub_453f4635(?) payable {
    ...
    if ext_call.return_data[0] > 0:
        ...
        while idx < ext_call.return_data[0]:
            ...
            mem[mem[64] + 4] = this.address
            mem[mem[64] + 36] = 0xf9e78c3a76befad33f25f1f55936234bee318f5b
            mem[mem[64] + 68] = _22
            require ext_code.size(sub_692ff94bAddress)
            call sub_692ff94bAddress.0x42842e0e with:
                 gas gas_remaining wei
                args address(this.address), 0xf9e78c3a76befad33f25f1f55936234bee318f5b, _22
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if idx == -1:
                revert with 'NH{q', 17
    ...
    if sub_6d4c6423[address(msg.sender)] + arg1 <= sub_3aebf8b8:
        if arg1 <= ext_call.return_data[0]:
            ...
            if ext_call.return_data[0] > 0:
                ...
                _420 = mem[64]
                mem[mem[64] + 36] = msg.sender
                mem[mem[64] + 68] = 0xa94aa23f43e9f00ce154f3c1c7f971ecb5318be8
