...
uint256 keepPNG;
address png_pefi_png_lp_rewardsAddress;
address png_pefi_png_lpAddress;
address pefiAddress;

function png_pefi_png_lp() {
    return png_pefi_png_lpAddress
}
...
function png_pefi_png_lp_rewards() {
    return png_pefi_png_lp_rewardsAddress
}
