...
function revokeConfirmation(uint256 arg1) {
    ...
    if not stor2[address(msg.sender)]:
        revert with 0, 'Owner does not exists'
    if not uint8(stor1[arg1][address(msg.sender)]):
        revert with 0, 'not confirmed'
...
function getTransaction(uint256 arg1) {
    require calldata.size - 4 >= 32
    mem[448] = stor0[arg1][2].field_0
    idx = 448
    s = 0
    while stor0[arg1][2].length + 416 > idx:
        mem[idx + 32] = stor0[arg1][s + 2].field_256
        idx = idx + 32
        s = s + 1
        continue 
    return Array(len=stor0[arg1][2].length, data=mem[448 len stor0[arg1][2].length]), 
           address(stor0[arg1].field_0),
...
function getConfirmations(uint256 arg1) {
    require calldata.size - 4 >= 32
    if owners.length:
        mem[128 len 32 * owners.length] = code.data[12154 len 32 * owners.length]
    idx = 0
    s = 0
    while idx < owners.length:
        mem[0] = address(owners[idx].field_0)
    ...
    if s:
        mem[(32 * owners.length) + 160 len 32 * s] = code.data[12154 len 32 * s]
    t = 0
    while t < s:
...
function confirmTransaction(uint256 arg1) {
    ...
    if not address(stor0[arg1].field_0):
        revert with 0, 'Tx doesn't exist'
    if uint8(stor1[arg1][address(msg.sender)]):
        revert with 0, 'is already confirmed'
...
function getTransactionIds(uint256 arg1, uint256 arg2, bool arg3, bool arg4) {
    ...
    if transactionCount:
        mem[128 len 32 * transactionCount] = code.data[12154 len 32 * transactionCount]
    idx = 0
    s = 0
    while idx < transactionCount:
        if not arg3:
    ...
    if arg2 - arg1:
        mem[(32 * transactionCount) + 160 len 32 * arg2 - arg1] = code.data[12154 len 32 * arg2 - arg1]
    idx = arg1
    while idx < arg2:
...
function submitTransaction(address arg1, uint256 arg2, bytes arg3) {
    ...
    stor0[stor5].field_1024 = block.timestamp
    transactionCount++
    ...
    while idx < owners.length:
        ...
        mem[ceil32(arg3.length) + 320] = stor0[stor5][2].field_0
        idx = ceil32(arg3.length) + 320
        s = sha3(sha3(transactionCount, 0) + 2)
        while ceil32(arg3.length) + stor0[stor5][2].length + 288 > idx:
            mem[idx + 32] = uint256(stor1[s])
            idx = idx + 32
            s = s + 1
            continue 
        call address(stor0[stor5].field_0).mem[ceil32(arg3.length) + 320 len 4] with:
           value stor0[stor5].field_256 wei
             gas gas_remaining - 34710 wei
            args mem[ceil32(arg3.length) + 324 len stor0[stor5][2].length - 4]
        if ext_call.success:
