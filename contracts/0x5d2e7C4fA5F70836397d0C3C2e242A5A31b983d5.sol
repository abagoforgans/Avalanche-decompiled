            ...
            if lastRewardBlock >= block.number:
                ...
                if sub_ed7832aa <= 0:
                    ...
                    if stor3[address(msg.sender)] > 0:
                        ...
                        mem[_1846 + floor32(mem[_1847]) + -(mem[_1847] % 32) + 228 len mem[_1847] % 32] = mem[_1847 + -(mem[_1847] % 32) + floor32(mem[_1847]) + 64 len mem[_1847] % 32]
                        call stor18.mem[_1846 + 196 len 4] with:
                             gas gas_remaining wei
            ...
            if lastRewardBlock >= endBlock:
                ...
                if sub_ed7832aa <= 0:
                    ...
                    if stor3[address(msg.sender)] > 0:
                        ...
                        mem[_1853 + floor32(mem[_1854]) + -(mem[_1854] % 32) + 228 len mem[_1854] % 32] = mem[_1854 + floor32(mem[_1854]) + -(mem[_1854] % 32) + 64 len mem[_1854] % 32]
                        call stor18 with:
                             gas gas_remaining wei
                        ...
                        mem[_1850 + floor32(mem[_1851]) + -(mem[_1851] % 32) + 228 len mem[_1851] % 32] = mem[_1851 + floor32(mem[_1851]) + -(mem[_1851] % 32) + 64 len mem[_1851] % 32]
                        call stor18 with:
                             gas gas_remaining wei
