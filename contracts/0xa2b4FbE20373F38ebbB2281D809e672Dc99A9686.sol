...
function rewardsAvailable() payable {
    require ext_code.size(address(chefAddress))
    staticcall address(chefAddress).pendingReward(uint256 arg1, address arg2) with:
            gas gas_remaining wei
           args poolId, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function retireStrat() payable {
    if address(vaultAddress) != msg.sender:
        revert with 0, '!vault'
    require ext_code.size(address(chefAddress))
    call address(chefAddress).emergencyWithdraw(uint256 arg1, address arg2) with:
         gas gas_remaining wei
        args poolId, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit() payable {
    ...
    if ext_call.return_data[0]:
        require ext_code.size(address(chefAddress))
        call address(chefAddress).deposit(uint256 arg1, uint256 arg2, address arg3) with:
             gas gas_remaining wei
...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] >= arg1:
        ...
        if ext_call.return_data[0] > arg1:
            revert with 0, 'SafeMath: subtraction overflow'
        require ext_code.size(address(chefAddress))
        call address(chefAddress).withdraw(uint256 arg1, uint256 arg2, address arg3) with:
             gas gas_remaining wei
                        ...
                        if not return_data.size:
                            ...
                            if return_data.size:
                                ...
                                if not return_data.size:
                                    ...
                                    call address(chefAddress).emergencyWithdraw(uint256 arg1, address arg2) with:
                                         gas gas_remaining wei
                                        args poolId, this.address, mem[(4 * ceil32(return_data.size)) + 824 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
                            else:
                                if eth.balance(this.address) < 0:
                                    revert with 0, 
                                                32,
                                ...
                                if not return_data.size:
                                    ...
                                    call address(chefAddress).emergencyWithdraw(uint256 arg1, address arg2) with:
                                         gas gas_remaining wei
                                        args mem[(4 * ceil32(return_data.size)) + 760 len (7 * ceil32(return_data.size)) + 64]
                    else:
                        require return_data.size >= 32
                        if not mem[ceil32(return_data.size) + 457]:
                            revert with 0, 
