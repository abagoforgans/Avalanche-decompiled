    ...
    while idx < poolInfo.length:
        ...
        if block.timestamp > poolInfo[idx].field_512:
            ...
            if not mem[_21]:
                ...
                if not totalAllocPoint:
                    revert with 0, 18
                if mem[_21] > 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5604189374bc6a7:
                    revert with 0, 17
                if (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint > 0x119799812dea11197f27f0f6e885c8ba7eb31f476caf7411a863387:
                    revert with 0, 17
                if 10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint and sub_05ed1de4 > -1 / 10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint:
                ...
                if not 1000 * mem[_21]:
                    revert with 0, 18
                if poolInfo[idx].field_768 > !(10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint * sub_05ed1de4 / 1000 * mem[_21]):
                    revert with 0, 17
                poolInfo[idx].field_768 += 10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint * sub_05ed1de4 / 1000 * mem[_21]
                if not poolInfo[idx].field_1280:
                    poolInfo[idx].field_1536 = 0
                else:
                    if poolInfo[idx].field_1280 > 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5604189374bc6a7:
                ...
                mem[mem[64] + 32] = _22
                mem[mem[64] + 64] = poolInfo[idx].field_768
                emit UpdatePool(block.timestamp, _22, poolInfo[idx].field_768, idx);
        if idx == -1:
            revert with 0, 17
        idx = idx + 1
        continue 
    ...
    while idx < poolInfo.length:
        ...
        if block.timestamp > poolInfo[idx].field_512:
            ...
            if not mem[_19]:
                ...
                mem[mem[64] + 32] = _21
                mem[mem[64] + 64] = poolInfo[idx].field_768
                emit UpdatePool(block.timestamp, _21, poolInfo[idx].field_768, idx);
        if idx == -1:
            revert with 0, 17
        idx = idx + 1
        continue 
        ...
        while idx < poolInfo.length:
            ...
            if block.timestamp > poolInfo[idx].field_512:
                ...
                if not mem[_55]:
                    ...
                    if not totalAllocPoint:
                        revert with 0, 18
                    if mem[_55] > 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5604189374bc6a7:
                        revert with 0, 17
                    if (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint > 0x119799812dea11197f27f0f6e885c8ba7eb31f476caf7411a863387:
                        revert with 0, 17
                    if 10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint and sub_05ed1de4 > -1 / 10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint:
                    ...
                    if not 1000 * mem[_55]:
                        revert with 0, 18
                    if poolInfo[idx].field_768 > !(10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint * sub_05ed1de4 / 1000 * mem[_55]):
                        revert with 0, 17
                    poolInfo[idx].field_768 += 10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint * sub_05ed1de4 / 1000 * mem[_55]
                    if not poolInfo[idx].field_1280:
                        poolInfo[idx].field_1536 = 0
                    else:
                        if poolInfo[idx].field_1280 > 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5604189374bc6a7:
                    ...
                    mem[mem[64] + 32] = _57
                    mem[mem[64] + 64] = poolInfo[idx].field_768
                    emit UpdatePool(block.timestamp, _57, poolInfo[idx].field_768, idx);
            if idx == -1:
                revert with 0, 17
            idx = idx + 1
            continue 
        ...
        while idx < poolInfo.length:
            ...
            if block.timestamp > poolInfo[idx].field_512:
                ...
                if not mem[_56]:
                    ...
                    if not totalAllocPoint:
                        revert with 0, 18
                    if mem[_56] > 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5604189374bc6a7:
                        revert with 0, 17
                    if (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint > 0x119799812dea11197f27f0f6e885c8ba7eb31f476caf7411a863387:
                        revert with 0, 17
                    if 10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint and sub_05ed1de4 > -1 / 10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint:
                    ...
                    if not 1000 * mem[_56]:
                        revert with 0, 18
                    if poolInfo[idx].field_768 > !(10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint * sub_05ed1de4 / 1000 * mem[_56]):
                        revert with 0, 17
                    poolInfo[idx].field_768 += 10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint * sub_05ed1de4 / 1000 * mem[_56]
                    if not poolInfo[idx].field_1280:
                        poolInfo[idx].field_1536 = 0
                    else:
                        if poolInfo[idx].field_1280 > 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5604189374bc6a7:
                    ...
                    mem[mem[64] + 32] = _58
                    mem[mem[64] + 64] = poolInfo[idx].field_768
                    emit UpdatePool(block.timestamp, _58, poolInfo[idx].field_768, idx);
            if idx == -1:
                revert with 0, 17
            idx = idx + 1
            continue 
        ...
        while idx < poolInfo.length:
            ...
            if block.timestamp > poolInfo[idx].field_512:
                ...
                if not mem[_99]:
                    ...
                    if not totalAllocPoint:
                        revert with 0, 18
                    if mem[_99] > 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5604189374bc6a7:
                        revert with 0, 17
                    if (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint > 0x119799812dea11197f27f0f6e885c8ba7eb31f476caf7411a863387:
                        revert with 0, 17
                    if 10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint and sub_05ed1de4 > -1 / 10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint:
                    ...
                    if not 1000 * mem[_99]:
                        revert with 0, 18
                    if poolInfo[idx].field_768 > !(10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint * sub_05ed1de4 / 1000 * mem[_99]):
                        revert with 0, 17
                    poolInfo[idx].field_768 += 10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint * sub_05ed1de4 / 1000 * mem[_99]
                    if not poolInfo[idx].field_1280:
                        poolInfo[idx].field_1536 = 0
                    else:
                        if poolInfo[idx].field_1280 > 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5604189374bc6a7:
                    ...
                    mem[mem[64] + 32] = _133
                    mem[mem[64] + 64] = poolInfo[idx].field_768
                    emit UpdatePool(block.timestamp, _133, poolInfo[idx].field_768, idx);
            if idx == -1:
                revert with 0, 17
            idx = idx + 1
            continue 
        ...
        while idx < poolInfo.length:
            ...
            if block.timestamp > poolInfo[idx].field_512:
                ...
                if not mem[_100]:
                    ...
                    if not totalAllocPoint:
                        revert with 0, 18
                    if mem[_100] > 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5604189374bc6a7:
                        revert with 0, 17
                    if (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint > 0x119799812dea11197f27f0f6e885c8ba7eb31f476caf7411a863387:
                        revert with 0, 17
                    if 10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint and sub_05ed1de4 > -1 / 10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint:
                        revert with 0, 17
                    if not 1000 * mem[_100]:
                        revert with 0, 18
                    if poolInfo[idx].field_768 > !(10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint * sub_05ed1de4 / 1000 * mem[_100]):
                        revert with 0, 17
                    poolInfo[idx].field_768 += 10^12 * (block.timestamp * sub_9702d3e2 * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * sub_9702d3e2 * poolInfo[idx].field_256) / totalAllocPoint * sub_05ed1de4 / 1000 * mem[_100]
                    if not poolInfo[idx].field_1280:
                        poolInfo[idx].field_1536 = 0
                    else:
                        if poolInfo[idx].field_1280 > 0x4189374bc6a7ef9db22d0e5604189374bc6a7ef9db22d0e5604189374bc6a7:
                    ...
                    mem[mem[64] + 32] = _134
                    mem[mem[64] + 64] = poolInfo[idx].field_768
                    emit UpdatePool(block.timestamp, _134, poolInfo[idx].field_768, idx);
            if idx == -1:
                revert with 0, 17
            idx = idx + 1
            continue 
