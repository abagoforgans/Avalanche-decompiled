...
function swap(address arg1, uint256 arg2, uint256 arg3) payable {
    ...
    call 0x57319d41f71e81f3c65f2a47ca4e001ebafd4f33.transfer(address rg1, uint256 rg2) with:
         gas gas_remaining wei
        args 0x1fc83f75499b7620d53757f0b01e2ae626aae530, ext_call.return_data[0], mem[(10 * ceil32(return_data.size)) + 228 len 17 * ceil32(return_data.size)]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    mem[(12 * ceil32(return_data.size)) + 196] = 0x1fc83f75499b7620d53757f0b01e2ae626aae530
    ...
    call 0x1fc83f75499b7620d53757f0b01e2ae626aae530.deposit(address rg1, address rg2, address rg3, uint256 rg4, uint256 rg5) with:
         gas gas_remaining wei
        args 0x57319d41f71e81f3c65f2a47ca4e001ebafd4f33, 0x1fc83f75499b7620d53757f0b01e2ae626aae530, address(arg1), ext_call.return_data[0], 0, mem[(12 * ceil32(return_data.size)) + 324 len 20 * ceil32(return_data.size)]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 64
    require ext_call.return_data[0] == ext_call.return_data[0]
