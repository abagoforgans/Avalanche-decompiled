...
function sub_62daa9e8(?) payable {
    ...
    if not arg2:
        ...
        if mem[(32 * _71 - 1) + (2 * ceil32(return_data.size)) + 224] and stor6 > -1 / mem[(32 * _71 - 1) + (2 * ceil32(return_data.size)) + 224]:
            revert with 'NH{q', 17
        if arg1 >= mem[(32 * _71 - 1) + (2 * ceil32(return_data.size)) + 224] * stor6 / 10^16:
        ...
        if mem[_132] < mem[(32 * _71 - 1) + (2 * ceil32(return_data.size)) + 224] * stor6 / 10^16:
            revert with 0, 'problem'
        mem[mem[64] + 4] = msg.sender
        mem[mem[64] + 36] = mem[(32 * _71 - 1) + (2 * ceil32(return_data.size)) + 224] * stor6 / 10^16
        require ext_code.size(stor1)
        call stor1.0xa9059cbb with:
             gas gas_remaining wei
            args msg.sender, mem[(32 * _71 - 1) + (2 * ceil32(return_data.size)) + 224] * stor6 / 10^16
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _141 = mem[64]
        ...
        if arg1 and stor5 > -1 / arg1:
            revert with 'NH{q', 17
        if arg1 * stor5 and 100 * 10^6 > -1 / arg1 * stor5:
            revert with 'NH{q', 17
        mem[ceil32(return_data.size) + 96] = 2
        ...
        if block.timestamp > -101:
            revert with 'NH{q', 17
        mem[ceil32(return_data.size) + 192] = 0x38ed173900000000000000000000000000000000000000000000000000000000
        mem[ceil32(return_data.size) + 196] = 100 * 10^6 * arg1 * stor5
        mem[ceil32(return_data.size) + 228] = 0
        mem[ceil32(return_data.size) + 260] = 160
        mem[ceil32(return_data.size) + 356] = 2
        idx = 0
        ...
        call stor4.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
             gas gas_remaining wei
            args 100 * 10^6 * arg1 * stor5, 0, 160, address(this.address), block.timestamp + 100, 2, mem[ceil32(return_data.size) + 388 len 64]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[ceil32(return_data.size) + 192 len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = (2 * ceil32(return_data.size)) + 192
        require return_data.size >= 32
        _70 = mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, 100 * 10^6 * arg1 * stor5) >> 32
        require mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, 100 * 10^6 * arg1 * stor5) >> 32 <= test266151307()
        require ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, 100 * 10^6 * arg1 * stor5) >> 32 + 223 < ceil32(return_data.size) + return_data.size + 192
        _72 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, 100 * 10^6 * arg1 * stor5) >> 32 + 192]
        if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, 100 * 10^6 * arg1 * stor5) >> 32 + 192] > test266151307():
            revert with 'NH{q', 65
        if (2 * ceil32(return_data.size)) + floor32(mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, 100 * 10^6 * arg1 * stor5) >> 32 + 192]) + 193 > test266151307() or floor32(mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, 100 * 10^6 * arg1 * stor5) >> 32 + 192]) + 1 < 0:
            revert with 'NH{q', 65
        mem[64] = (2 * ceil32(return_data.size)) + floor32(mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, 100 * 10^6 * arg1 * stor5) >> 32 + 192]) + 193
        mem[(2 * ceil32(return_data.size)) + 192] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, 100 * 10^6 * arg1 * stor5) >> 32 + 192]
