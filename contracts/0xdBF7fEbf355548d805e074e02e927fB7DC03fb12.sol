...
function verify(address arg1, address arg2, uint256 arg3, string arg4, uint256 arg5, bytes arg6) payable {
    ...
    if arg6.length != 65:
        revert with 0, 'invalid signature length'
    signer = erecover(sha3(sha3(arg2, arg3, Mask(8 * ceil32(arg4.length), -(8 * ceil32(arg4.length)) + 256, arg4[all], Mask(8 * ceil32(arg4.length) - arg4.length, -(8 * ceil32(arg4.length) + -ceil32(ceil32(arg4.length)) + 31) + 256, arg6.length) >> -(8 * ceil32(arg4.length) + -ceil32(ceil32(arg4.length)) + 31) + 256) << (8 * ceil32(arg4.length)) - 256, Mask(8 * -ceil32(arg4.length) + arg4.length + 32, 0, arg5))), 0, mem[ceil32(ceil32(arg4.length)) + 129], mem[ceil32(ceil32(arg4.length)) + 161]) 
    if not erecover.result:
        revert with ext_call.return_data[0 len return_data.size]
