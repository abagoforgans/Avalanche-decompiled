...
const COMMUNITY_FUND_POOL_ALLOCATION = 3500 * 10^18

const VESTING_DURATION = (2160 * 24 * 3600)

const DEV_FUND_POOL_ALLOCATION = 1750 * 10^18

const FARMING_POOL_REWARD_ALLOCATION = 29750 * 10^18
...
function distributeReward(address arg1) payable {
    ...
    if totalSupply + 29750 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 29750 * 10^18
    if balanceOf[address(arg1)] + 29750 * 10^18 < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 29750 * 10^18
    emit Transfer(29750 * 10^18, 0, arg1);
}
            ...
            if block.timestamp - devFundLastClaimed:
                ...
                if (block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) > 0:
                    if sub_6dc651d9Address:
                        ...
                        emit Transfer(((block.timestamp * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate)), 0, sub_6dc651d9Address);
            ...
            if endTime - devFundLastClaimed:
                ...
                if (endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate) > 0:
                    if sub_6dc651d9Address:
                        ...
                        emit Transfer(((endTime * devFundRewardRate) - (devFundLastClaimed * devFundRewardRate)), 0, sub_6dc651d9Address);
                        devFundLastClaimed = block.timestamp
}
