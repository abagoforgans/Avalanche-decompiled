...
function retireStrat() payable {
    if address(vaultAddress) != msg.sender:
        revert with 0, '!vault'
    require ext_code.size(address(masterchefAddress))
    call address(masterchefAddress).0x5312ea8e with:
         gas gas_remaining wei
        args poolId
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function addLiquidity() payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if outputAddress != address(lpToken0Address):
        if not outputToLp0Route.length:
            ...
            call address(unirouterAddress).swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, Mask(31, 1, ext_call.return_data[0]), 0, 160, this.address, block.timestamp, outputToLp0Route.length
        else:
            mem[356] = address(outputToLp0Route.field_0)
            idx = 356
            s = 0
            while (32 * outputToLp0Route.length) + 356 > idx + 32:
            ...
            call address(unirouterAddress).swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, Mask(31, 1, ext_call.return_data[0]), 0, 160, this.address, block.timestamp, outputToLp0Route.length, mem[356 len 32 * outputToLp0Route.length]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    if outputAddress != lpToken1Address:
        if not outputToLp1Route.length:
            require ext_code.size(address(unirouterAddress))
            call address(unirouterAddress).swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, Mask(31, 1, ext_call.return_data[0]), 0, 160, this.address, block.timestamp, outputToLp1Route.length
        else:
            mem[356] = address(outputToLp1Route.field_0)
            idx = 356
            s = 0
            while (32 * outputToLp1Route.length) + 356 > idx + 32:
            ...
            call address(unirouterAddress).swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args 0, Mask(31, 1, ext_call.return_data[0]), 0, 160, this.address, block.timestamp, outputToLp1Route.length, mem[356 len 32 * outputToLp1Route.length]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    ...
    call address(unirouterAddress).addLiquidity(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint256 arg8) with:
         gas gas_remaining wei
        args 0, uint32(stor9), lpToken1Address, ext_call.return_data[0], ext_call.return_data[0], 1, 1, this.address, block.timestamp
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
}

function chargeFees() payable {
    require ext_code.size(outputAddress)
    staticcall outputAddress.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    if not ext_call.return_data[0]:
        ...
        if not outputToWrappedRoute.length:
            ...
            mem[324 len 64] = unknown_0xa9059cbb(?????), msg.sender, ext_call.return_data[0 len 28]
            call wrappedAddress with:
               funct outputToWrappedRoute.length.field_224
                 gas gas_remaining wei
                args Mask(480, -256, ext_call.return_data[0 len 28]) << 256, mem[388 len 4]
    else:
    ...
    if not return_data.size:
        ...
        if not return_data.size:
            ...
            if not ext_code.size(address(lpToken0Address)):
                revert with 0, 'Address: call to non-contract'
            mem[588 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor2), uint32(stor2), 0
            ...
            if not return_data.size:
                ...
                if not ext_code.size(lpToken1Address):
                    revert with 0, 'Address: call to non-contract'
                mem[752 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor2), uint32(stor2), 0
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                if not return_data.size:
                    ...
                    call address(masterchefAddress).0x5312ea8e with:
                         gas gas_remaining wei
                        args poolId, mem[(4 * ceil32(return_data.size)) + 792 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if not mem[ceil32(return_data.size) + 457]:
