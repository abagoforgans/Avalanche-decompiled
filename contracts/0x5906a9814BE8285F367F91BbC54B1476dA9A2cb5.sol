...
function sub_639a47f6(?) {
    return sub_639a47f6Address
}
...
function sub_bccd4345(?) {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_639a47f6Address = address(arg1)
}
...
function mintWithToken(uint256 arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require not paused
    require arg1 > 0
    ...
    mem[100] = msg.sender
    mem[132] = sub_639a47f6Address
    mem[164] = tokenPrice
    call tokenAddress.0x23b872dd with:
         gas gas_remaining wei
        args msg.sender, sub_639a47f6Address, tokenPrice
