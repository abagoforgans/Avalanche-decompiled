...
function sub_59b9021e(?) {
    ...
    staticcall 0x60ae616a2155ee3d9a68541ba4544862310933d4.getAmountsIn(uint256 arg1, address[] arg2) with:
            gas gas_remaining wei
           args arg1 * ext_call.return_data[0], Array(len=stor1.length, data=mem[ceil32(return_data.size) + 196 len 32 * stor1.length])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[ceil32(return_data.size) + 96 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = (2 * ceil32(return_data.size)) + 96
    require return_data.size >= 32
    _26 = mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, arg1 * ext_call.return_data[0]) >> 32
    require mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, arg1 * ext_call.return_data[0]) >> 32 <= test266151307()
    require ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, arg1 * ext_call.return_data[0]) >> 32 + 127 < ceil32(return_data.size) + return_data.size + 96
    _27 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, arg1 * ext_call.return_data[0]) >> 32 + 96]
    require mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, arg1 * ext_call.return_data[0]) >> 32 + 96] <= test266151307()
    require (32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, arg1 * ext_call.return_data[0]) >> 32 + 96]) + 32 >= 0 and (2 * ceil32(return_data.size)) + (32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, arg1 * ext_call.return_data[0]) >> 32 + 96]) + 128 <= test266151307()
    mem[64] = (2 * ceil32(return_data.size)) + (32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, arg1 * ext_call.return_data[0]) >> 32 + 96]) + 128
    mem[(2 * ceil32(return_data.size)) + 96] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], Mask(224, 32, arg1 * ext_call.return_data[0]) >> 32 + 96]
    ...
    mem[mem[64] + 4] = arg1 * ext_call.return_data[0]
    mem[mem[64] + 36] = 128
    ...
    while idx < stor1.length:
        ...
        t = t + 32
        continue 
    mem[_43 + 68] = tx.origin
    mem[_43 + 100] = block.timestamp
    require ext_code.size(0x60ae616a2155ee3d9a68541ba4544862310933d4)
    call 0x60ae616a2155ee3d9a68541ba4544862310933d4.mem[mem[64] len 4] with:
       value _42 wei
         gas gas_remaining wei
        args mem[mem[64] + 4 len _43 + (32 * stor1.length) + -mem[64] + 160]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _52 = mem[64]
