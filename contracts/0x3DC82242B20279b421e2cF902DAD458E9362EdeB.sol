...
address stor5;
address stor6;
uint256 bOUGHT_erc20;

function getBOUGHT_erc20() payable {
    return bOUGHT_erc20
}
...
function swapExactTokensForTokens_erc20(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) payable {
    ...
    require return_data.size >= 32
    _27 = mem[floor32(arg3.length) + 97 len 4], Mask(224, 32, arg1) >> 32
    ...
    _28 = mem[floor32(arg3.length) + mem[floor32(arg3.length) + 97 len 4], Mask(224, 32, arg1) >> 32 + 97]
    ...
    idx = floor32(arg3.length) + _27 + 129
    s = floor32(arg3.length) + ceil32(return_data.size) + 129
    while idx < floor32(arg3.length) + _27 + (32 * _28) + 129:
        require mem[idx] == mem[idx]
        mem[s] = mem[idx]
        idx = idx + 32
        s = s + 32
