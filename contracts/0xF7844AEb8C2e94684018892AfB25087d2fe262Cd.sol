...
#  - sub_d44e282b(?)
#
const getPool = 0x431290df15777d46174b83c9e01f87d7b70d3073

const sub_132e1d39(?) = 1000

const getDebt = ext_call.return_data[0]

const sub_1e5140f0(?) = 0xf81533a34a262ceaf39126eb1078066285bf8503
...
const sub_ae183737(?) = 0x957ca4a4aa7cdc866cf430bb140753f04e273bc0
...
function fund() payable {
    ...
    require ext_code.size(0x431290df15777d46174b83c9e01f87d7b70d3073)
    staticcall 0x431290df15777d46174b83c9e01f87d7b70d3073.getBorrowed(address arg1) with:
            gas gas_remaining wei
           args this.address
...
function borrow(uint256 arg1) {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0x431290df15777d46174b83c9e01f87d7b70d3073)
    call 0x431290df15777d46174b83c9e01f87d7b70d3073.0xc5ebeaec with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_6aa96162(?) {
    ...
    if eth.balance(this.address) < cd[4]:
        revert with 0, 'Not enough AVAX available'
    require ext_code.size(0xf81533a34a262ceaf39126eb1078066285bf8503)
    call 0xf81533a34a262ceaf39126eb1078066285bf8503.0x47f63dfd with:
       value cd[4] wei
         gas gas_remaining wei
        args cd[4]
    if not ext_call.success:
    ...
    mem[64] = (2 * ceil32(return_data.size)) + 96
    require return_data.size >= 32
    _16 = mem[ceil32(return_data.size) + 96]
    require mem[ceil32(return_data.size) + 96] <= test266151307()
    require ceil32(return_data.size) + mem[ceil32(return_data.size) + 96] + 127 < ceil32(return_data.size) + return_data.size + 96
    _17 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96] + 96]
    if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96] + 96] > test266151307():
        revert with 'NH{q', 65
    if (2 * ceil32(return_data.size)) + floor32(mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96] + 96]) + 97 > test266151307() or floor32(mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96] + 96]) + 1 < 0:
        revert with 'NH{q', 65
    ...
    idx = 0
    s = ceil32(return_data.size) + _16 + 128
    t = (2 * ceil32(return_data.size)) + 128
    while idx < _17:
        require mem[s] == mem[s]
        mem[t] = mem[s]
...
function sub_6b6c92d9(?) {
    ...
    if not _5:
        ...
        while idx < _5:
            ...
            staticcall address(_97).balanceOf(address arg1) with:
                    gas gas_remaining wei
    ...
    while idx < _5:
        ...
        staticcall address(_98).balanceOf(address arg1) with:
                gas gas_remaining wei
               args address(this.address)
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
...
function sub_d2b29d70(?) {
    ...
    mem[ceil32(return_data.size) + 196 len 96] = transfer(address arg1, uint256 arg2), 764359954111768367717571860, 0, cd[36], mem[ceil32(return_data.size) + 196 len 28]
