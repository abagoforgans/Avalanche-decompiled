    ...
    while idx < ('cd', 4).length:
        ...
        if sub_44fddb3c[mem[(32 * idx) + 128]]:
            ...
            if sub_44fddb3c[mem[(32 * idx) + 128]] != 2:
                ...
                s = s + 2 * 10^18
                continue 
            if s + 2 * 10^18 > -3000000000000000001:
                revert with 'NH{q', 17
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
        ...
        if sub_44fddb3c[mem[(32 * idx) + 128]] != 1:
            ...
            if sub_44fddb3c[mem[(32 * idx) + 128]] != 2:
                ...
                s = s + 10^18
                continue 
            if s + 10^18 > -3000000000000000001:
                revert with 'NH{q', 17
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
            s = s + 4 * 10^18
            continue 
        if s + 10^18 > -2000000000000000001:
            revert with 'NH{q', 17
        if idx >= ('cd', 4).length:
            revert with 'NH{q', 50
        mem[0] = mem[(32 * idx) + 128]
        ...
        if sub_44fddb3c[mem[(32 * idx) + 128]] != 2:
            ...
            s = s + 3 * 10^18
            continue 
        if s + 3 * 10^18 > -3000000000000000001:
            revert with 'NH{q', 17
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
...
function sub_e577940d(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        idx = idx + 1
        continue 
    if ('cd', 4).length > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
        revert with 'NH{q', 17
    mem[floor32(('cd', 4).length) + 133] = msg.sender
    mem[floor32(('cd', 4).length) + 165] = this.address
    mem[floor32(('cd', 4).length) + 197] = 10^18 * ('cd', 4).length
    ...
    mem[floor32(('cd', 4).length) + 293 len 128] = 0, msg.sender, address(this.address), 10^18 * ('cd', 4).length, 0
