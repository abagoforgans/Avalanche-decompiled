...
function sub_a9e56f3c(?) payable {
    return address(sub_a9e56f3cAddress)
}
...
function rewardsAvailable() payable {
    ...
    mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 437 len 64] = Mask(32, 224, sha3(mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 341 len mem[ceil32(sub_277e5cfd.length) + 192]])) >> 224, Mask(224, 0, stor15.field_32), uint32(stor15.field_0), Mask(224, 32, this.address) >> 32
...
function callReward() payable {
    ...
    mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 273 len 4] = Mask(32, 224, sha3(mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 341 len mem[ceil32(sub_277e5cfd.length) + 192]])) >> 224
    ...
    if not return_data.size:
        ...
        if not outputToNativeRoute.length:
            ...
            require return_data.size >= 32
            _1460 = mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 437 len 4], mem[128 len 28]
            ...
            _1470 = mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + _1460 + 437]
            mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469 len floor32(mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + _1460 + 437])] = mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + _1460 + 469 len floor32(mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + _1460 + 437])]
            mem[64] = (32 * _1470) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469
            ...
            if 45 * mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 437] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469] / mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 437] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469] != 45:
                revert with 0, 
                            ...
                            mem[(32 * _1470) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 570 len 31]
            ...
            if callFee * 45 * mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 437] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469] / 1000 / 45 * mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 437] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469] / 1000 != callFee:
                revert with 0, 
                            ...
                            0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                            mem[(32 * _1470) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 570 len 31]
            mem[(32 * _1470) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469] = callFee * 45 * mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 437] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469] / 1000 / 1000
            return memory
              from (32 * _1470) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469
               len 32
        mem[0] = 21
        ...
        mem[64] = ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 437
        require return_data.size >= 32
        _1664 = mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 437 len 4], mem[128 len 28]
        require mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 437 len 4], mem[128 len 28] <= 4294967296
        require mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 437 len 4], mem[128 len 28] + 32 <= return_data.size
        require mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 437 len 4], mem[128 len 28] + 437] <= 4294967296 and mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 437 len 4], mem[128 len 28] + (32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 437 len 4], mem[128 len 28] + 437]) + 32 <= return_data.size
        mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 437] = mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 437 len 4], mem[128 len 28] + 437]
        _1670 = mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + _1664 + 437]
        mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469 len floor32(mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + _1664 + 437])] = mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + _1664 + 469 len floor32(mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + _1664 + 437])]
        mem[64] = (32 * _1670) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469
        require mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 437] - 1 < mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 437]
        if not mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 437] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469]:
            return 0
        if 45 * mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 437] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469] / mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 437] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469] != 45:
            revert with 0, 
                        ...
                        33,
                        0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                        mem[(32 * _1670) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 570 len 31]
        if not 45 * mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 437] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469] / 1000:
            return 0
        if callFee * 45 * mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 437] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469] / 1000 / 45 * mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 437] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469] / 1000 != callFee:
            revert with 0, 
                        ...
                        0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                        mem[(32 * _1670) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 570 len 31]
        mem[(32 * _1670) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469] = callFee * 45 * mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 437] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469] / 1000 / 1000
        return memory
          from (32 * _1670) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 469
           len 32
    ...
    require return_data.size >= 32
    _1447 = mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 469]
    ...
    mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 442] = _1447
    ...
    if not outputToNativeRoute.length:
        ...
        staticcall address(unirouterAddress).getAmountsOut(uint256 arg1, address[] arg2) with:
                gas gas_remaining wei
               args _1447, 64, outputToNativeRoute.length
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        _1462 = mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 438 len 4], Mask(224, 32, _1447) >> 32
        require mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 438 len 4], Mask(224, 32, _1447) >> 32 <= 4294967296
        require mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 438 len 4], Mask(224, 32, _1447) >> 32 + 32 <= return_data.size
        require mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 438 len 4], Mask(224, 32, _1447) >> 32 + 438] <= 4294967296 and mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 438 len 4], Mask(224, 32, _1447) >> 32 + (32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 438 len 4], Mask(224, 32, _1447) >> 32 + 438]) + 32 <= return_data.size
        mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 438] = mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 438 len 4], Mask(224, 32, _1447) >> 32 + 438]
        _1471 = mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + _1462 + 438]
        mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470 len floor32(mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + _1462 + 438])] = mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + _1462 + 470 len floor32(mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + _1462 + 438])]
        mem[64] = (32 * _1471) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470
        ...
        if 45 * mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 438] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470] / mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 438] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470] != 45:
            revert with 0, 
                        ...
                        33,
                        0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                        mem[(32 * _1471) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 571 len 31]
        ...
        if callFee * 45 * mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 438] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470] / 1000 / 45 * mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 438] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470] / 1000 != callFee:
            revert with 0, 
                        ...
                        0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                        mem[(32 * _1471) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 571 len 31]
        mem[(32 * _1471) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470] = callFee * 45 * mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 438] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470] / 1000 / 1000
        return memory
          from (32 * _1471) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470
           len 32
    mem[0] = 21
    ...
    staticcall address(unirouterAddress).getAmountsOut(uint256 arg1, address[] arg2) with:
            gas gas_remaining wei
           args _1447, Array(len=outputToNativeRoute.length, data=mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 538 len 32 * outputToNativeRoute.length])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 438 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 438
    require return_data.size >= 32
    _1666 = mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 438 len 4], Mask(224, 32, _1447) >> 32
    require mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 438 len 4], Mask(224, 32, _1447) >> 32 <= 4294967296
    require mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 438 len 4], Mask(224, 32, _1447) >> 32 + 32 <= return_data.size
    require mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 438 len 4], Mask(224, 32, _1447) >> 32 + 438] <= 4294967296 and mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 438 len 4], Mask(224, 32, _1447) >> 32 + (32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 438 len 4], Mask(224, 32, _1447) >> 32 + 438]) + 32 <= return_data.size
    mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 438] = mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + 438 len 4], Mask(224, 32, _1447) >> 32 + 438]
    _1671 = mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + _1666 + 438]
    mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470 len floor32(mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + _1666 + 438])] = mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + _1666 + 470 len floor32(mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + _1666 + 438])]
    mem[64] = (32 * _1671) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470
    require mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 438] - 1 < mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 438]
    if not mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 438] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470]:
        return 0
    if 45 * mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 438] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470] / mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 438] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470] != 45:
        revert with 0, 
                    ...
                    33,
                    0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                    mem[(32 * _1671) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 571 len 31]
    if not 45 * mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 438] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470] / 1000:
        return 0
    if callFee * 45 * mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 438] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470] / 1000 / 45 * mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 438] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470] / 1000 != callFee:
        revert with 0, 
                    ...
                    0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                    mem[(32 * _1671) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 571 len 31]
    mem[(32 * _1671) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470] = callFee * 45 * mem[(32 * mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 438] - 1) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470] / 1000 / 1000
    return memory
      from (32 * _1671) + ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + ceil32(return_data.size) + ceil32(return_data.size) + 470
       len 32
}
        ...
        if not return_data.size:
            ...
            if not return_data.size:
                ...
                if not ext_code.size(lpToken0Address):
                    revert with 0, 'Address: call to non-contract'
                mem[588 len 64] = 0, address(sub_a9e56f3cAddress), 0
                ...
                if not return_data.size:
                    ...
                    if not ext_code.size(lpToken0Address):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 589 len 64] = 0, address(sub_a9e56f3cAddress), 0
                    call lpToken0Address with:
                       funct uint32(stor16)
                         gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if not return_data.size:
                    ...
                    if not ext_code.size(lpToken0Address):
                        revert with 0, 'Address: call to non-contract'
                    mem[(2 * ceil32(return_data.size)) + 590 len 64] = 0, address(sub_a9e56f3cAddress), 0
                    call lpToken0Address with:
                       funct uint32(stor16)
                         gas gas_remaining wei
                ...
                if not return_data.size:
                    ...
                    if not ext_code.size(lpToken0Address):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 589 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor16), uint32(stor16), 0
                    mem[ceil32(return_data.size) + 653 len 0] = 0
                    call lpToken0Address with:
                       funct uint32(stor16)
                         gas gas_remaining wei
                        args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor16), uint32(stor16), 0) << 256, mem[ceil32(return_data.size) + 653 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor14), uint32(stor14), 0
                        if not approve(address arg1, uint256 arg2), Mask(224, 0, stor14):
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(lpToken0Address):
                            revert with 0, 'Address: call to non-contract'
                        mem[(2 * ceil32(return_data.size)) + 590 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor16), uint32(stor16), 0
                        mem[(2 * ceil32(return_data.size)) + 654 len 0] = 0
                        call lpToken0Address with:
                           funct uint32(stor16)
                             gas gas_remaining wei
                            args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor16), uint32(stor16), 0) << 256, mem[(2 * ceil32(return_data.size)) + 654 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor14), uint32(stor14), 0
                            if not approve(address arg1, uint256 arg2), Mask(224, 0, stor14):
