...
function sub_e637f98f(?) {
    return sub_e637f98fAddress
}
...
function sub_f64c8af4(?) {
    return uint256(sub_f64c8af4)
}
...
function createNFT(uint256 arg1) payable {
    ...
    if uint8(stor16.field_160):
        if not uint8(stor16.field_168):
            ...
            if itemPrice and arg1 > -1 / itemPrice:
                revert with 'NH{q', 17
            if itemPrice * arg1 != msg.value:
                revert with 0, 'INSUFFICIENT_AVAX'
            if tokenByIndex.length > -arg1 - 1:
                revert with 'NH{q', 17
            if tokenByIndex.length + arg1 > 5555:
                revert with 0, 'OUT_OF_STOCK'
            if stor17[address(msg.sender)] > -arg1 - 1:
                revert with 'NH{q', 17
            if stor17[address(msg.sender)] + arg1 > 55:
                revert with 0, 'REACHED_YOUR_MAX'
            if stor17[address(msg.sender)] > -arg1 - 1:
                revert with 'NH{q', 17
            mem[0] = msg.sender
            mem[32] = 17
            stor17[address(msg.sender)] += arg1
            ...
            if not arg1:
                ...
                while uint8(idx) < arg1:
                    ...
                    if msg.sender:
                        ...
                        if ext_code.size(msg.sender) <= 0:
                            if uint256(sub_f64c8af4) > 10000:
                                revert with 0, 'ERC2981Royalties: Too high'
                            _1547 = mem[64]
                            mem[64] = mem[64] + 64
                            mem[_1547] = sub_e637f98fAddress
                            mem[_1547 + 32] = stor15 % 16777216
                        else:
                            ...
                            s = 0
                            while s < 0:
                                mem[mem[64] + s + 164] = mem[_1169 + s + 32]
                                s = s + 32
                                continue 
                            ...
                            require return_data.size >= 32
                            require mem[_2188] == Mask(32, 224, mem[_2188])
                            if Mask(32, 224, mem[_2188]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                                revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                            if uint256(sub_f64c8af4) > 10000:
                                revert with 0, 'ERC2981Royalties: Too high'
                            _2489 = mem[64]
                            mem[64] = mem[64] + 64
                            mem[_2489] = sub_e637f98fAddress
                            mem[_2489 + 32] = stor15 % 16777216
                    else:
                        if tokenByIndex.length < 1:
                            revert with 'NH{q', 17
                        if tokenByIndex.length - 1 >= tokenByIndex.length:
                        ...
                        if ext_code.size(msg.sender) <= 0:
                            ...
                            _1591 = mem[64]
                            mem[64] = mem[64] + 64
                            mem[_1591] = sub_e637f98fAddress
                            mem[_1591 + 32] = stor15 % 16777216
                        else:
                            mem[mem[64]] = 0x150b7a0200000000000000000000000000000000000000000000000000000000
                            mem[mem[64] + 4] = msg.sender
                            mem[mem[64] + 36] = 0
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_2189] == Mask(32, 224, mem[_2189])
                            if Mask(32, 224, mem[_2189]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                                revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                            if uint256(sub_f64c8af4) > 10000:
                                revert with 0, 'ERC2981Royalties: Too high'
                            _2494 = mem[64]
                            mem[64] = mem[64] + 64
                            mem[_2494] = sub_e637f98fAddress
                            mem[_2494 + 32] = stor15 % 16777216
                    mem[0] = tokenByIndex.length
                    mem[32] = 11
                    royaltyInfo[stor8.length].field_0 = sub_e637f98fAddress
                    royaltyInfo[stor8.length].field_0 = stor15 % 16777216
                    royaltyInfo[stor8.length].field_160 = 0
                    if uint8(idx) == 255:
                        revert with 'NH{q', 17
                    idx = uint8(idx) + 1
                    continue 
                ...
                emit 0x76fc7572: mem[mem[64] len _1143 + (32 * mem[96]) + -mem[64] + 96]
            else:
                ...
                while uint8(idx) < arg1:
                    ...
                    if msg.sender:
                        ...
                        if ext_code.size(msg.sender) <= 0:
                            ...
                            _1553 = mem[64]
                            mem[64] = mem[64] + 64
                            mem[_1553] = sub_e637f98fAddress
                            mem[_1553 + 32] = stor15 % 16777216
                        else:
                            mem[mem[64]] = 0x150b7a0200000000000000000000000000000000000000000000000000000000
                            mem[mem[64] + 4] = msg.sender
                            mem[mem[64] + 36] = 0
                            ...
                            s = 0
                            while s < 0:
                                mem[mem[64] + s + 164] = mem[_1170 + s + 32]
                                s = s + 32
                                continue 
                            require ext_code.size(msg.sender)
                            call msg.sender.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_2191] == Mask(32, 224, mem[_2191])
                            if Mask(32, 224, mem[_2191]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                                revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                            if uint256(sub_f64c8af4) > 10000:
                                revert with 0, 'ERC2981Royalties: Too high'
                            _2499 = mem[64]
                            mem[64] = mem[64] + 64
                            mem[_2499] = sub_e637f98fAddress
                            mem[_2499 + 32] = stor15 % 16777216
                    else:
                        if tokenByIndex.length < 1:
                            revert with 'NH{q', 17
                        if tokenByIndex.length - 1 >= tokenByIndex.length:
                        ...
                        if ext_code.size(msg.sender) <= 0:
                            ...
                            _1596 = mem[64]
                            mem[64] = mem[64] + 64
                            mem[_1596] = sub_e637f98fAddress
                            mem[_1596 + 32] = stor15 % 16777216
                        else:
                            mem[mem[64]] = 0x150b7a0200000000000000000000000000000000000000000000000000000000
                            mem[mem[64] + 4] = msg.sender
                            mem[mem[64] + 36] = 0
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_2192] == Mask(32, 224, mem[_2192])
                            if Mask(32, 224, mem[_2192]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                                revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                            if uint256(sub_f64c8af4) > 10000:
                                revert with 0, 'ERC2981Royalties: Too high'
                            _2504 = mem[64]
                            mem[64] = mem[64] + 64
                            mem[_2504] = sub_e637f98fAddress
                            mem[_2504 + 32] = stor15 % 16777216
                    mem[0] = tokenByIndex.length
                    mem[32] = 11
                    royaltyInfo[stor8.length].field_0 = sub_e637f98fAddress
                    royaltyInfo[stor8.length].field_0 = stor15 % 16777216
                ...
                mem[mem[64] + 96 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
                mem[mem[64] + 32] = msg.sender
                emit 0x76fc7572: mem[mem[64] len _1144 + (32 * mem[96]) + -mem[64] + 96]
        else:
            if stor18[address(msg.sender)] > 2:
                revert with 'NH{q', 33
            if stor18[address(msg.sender)] != 1:
                if stor19[address(msg.sender)] <= 0:
                ...
                if tokenByIndex.length + arg1 > 5555:
                    revert with 0, 'OUT_OF_STOCK'
                if arg1 > stor19[address(msg.sender)]:
                    revert with 0, 'REACHED_YOUR_MAX'
                if stor19[address(msg.sender)] < arg1:
                    revert with 'NH{q', 17
                mem[0] = msg.sender
                mem[32] = 19
                stor19[address(msg.sender)] -= arg1
                if arg1 > test266151307():
                    revert with 'NH{q', 65
                mem[96] = arg1
                mem[64] = (32 * arg1) + 128
                if not arg1:
                    ...
                    while uint8(idx) < arg1:
                        ...
                        if msg.sender:
                            ...
                            if ext_code.size(msg.sender) <= 0:
                                ...
                                _1559 = mem[64]
                                mem[64] = mem[64] + 64
                                mem[_1559] = sub_e637f98fAddress
                                mem[_1559 + 32] = stor15 % 16777216
                            else:
                                mem[mem[64]] = 0x150b7a0200000000000000000000000000000000000000000000000000000000
                                mem[mem[64] + 4] = msg.sender
                                mem[mem[64] + 36] = 0
                                ...
                                s = 0
                                while s < 0:
                                    mem[mem[64] + s + 164] = mem[_1171 + s + 32]
                                    s = s + 32
                                    continue 
                                require ext_code.size(msg.sender)
                                call msg.sender.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                                ...
                                mem[64] = mem[64] + ceil32(return_data.size)
                                require return_data.size >= 32
                                require mem[_2194] == Mask(32, 224, mem[_2194])
                                if Mask(32, 224, mem[_2194]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                                    revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                                if uint256(sub_f64c8af4) > 10000:
                                    revert with 0, 'ERC2981Royalties: Too high'
                                _2509 = mem[64]
                                mem[64] = mem[64] + 64
                                mem[_2509] = sub_e637f98fAddress
                                mem[_2509 + 32] = stor15 % 16777216
                        else:
                            if tokenByIndex.length < 1:
                                revert with 'NH{q', 17
                            if tokenByIndex.length - 1 >= tokenByIndex.length:
                            ...
                            if ext_code.size(msg.sender) <= 0:
                                ...
                                _1601 = mem[64]
                                mem[64] = mem[64] + 64
                                mem[_1601] = sub_e637f98fAddress
                                mem[_1601 + 32] = stor15 % 16777216
                            else:
                                mem[mem[64]] = 0x150b7a0200000000000000000000000000000000000000000000000000000000
                                mem[mem[64] + 4] = msg.sender
                                mem[mem[64] + 36] = 0
                                ...
                                mem[64] = mem[64] + ceil32(return_data.size)
                                require return_data.size >= 32
                                require mem[_2195] == Mask(32, 224, mem[_2195])
                                if Mask(32, 224, mem[_2195]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                                    revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                                if uint256(sub_f64c8af4) > 10000:
                                    revert with 0, 'ERC2981Royalties: Too high'
                                _2514 = mem[64]
                                mem[64] = mem[64] + 64
                                mem[_2514] = sub_e637f98fAddress
                                mem[_2514 + 32] = stor15 % 16777216
                        mem[0] = tokenByIndex.length
                        mem[32] = 11
                        royaltyInfo[stor8.length].field_0 = sub_e637f98fAddress
                        royaltyInfo[stor8.length].field_0 = stor15 % 16777216
                    ...
                    mem[mem[64] + 96 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
                    mem[mem[64] + 32] = msg.sender
                    emit 0x76fc7572: mem[mem[64] len _1145 + (32 * mem[96]) + -mem[64] + 96]
                else:
                    mem[128 len 32 * arg1] = call.data[calldata.size len 32 * arg1]
                    idx = 0
                    while uint8(idx) < arg1:
                        ...
                        if msg.sender:
                            ...
                            if ext_code.size(msg.sender) <= 0:
                                ...
                                _1565 = mem[64]
                                mem[64] = mem[64] + 64
                                mem[_1565] = sub_e637f98fAddress
                                mem[_1565 + 32] = stor15 % 16777216
                            else:
                                mem[mem[64]] = 0x150b7a0200000000000000000000000000000000000000000000000000000000
                                mem[mem[64] + 4] = msg.sender
                                mem[mem[64] + 36] = 0
                                ...
                                s = 0
                                while s < 0:
                                    mem[mem[64] + s + 164] = mem[_1172 + s + 32]
                                    s = s + 32
                                    continue 
                                require ext_code.size(msg.sender)
                                call msg.sender.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                                ...
                                mem[64] = mem[64] + ceil32(return_data.size)
                                require return_data.size >= 32
                                require mem[_2197] == Mask(32, 224, mem[_2197])
                                if Mask(32, 224, mem[_2197]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                                    revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                                if uint256(sub_f64c8af4) > 10000:
                                    revert with 0, 'ERC2981Royalties: Too high'
                                _2519 = mem[64]
                                mem[64] = mem[64] + 64
                                mem[_2519] = sub_e637f98fAddress
                                mem[_2519 + 32] = stor15 % 16777216
                        else:
                            if tokenByIndex.length < 1:
                                revert with 'NH{q', 17
                            if tokenByIndex.length - 1 >= tokenByIndex.length:
                            ...
                            if ext_code.size(msg.sender) <= 0:
                                ...
                                _1606 = mem[64]
                                mem[64] = mem[64] + 64
                                mem[_1606] = sub_e637f98fAddress
                                mem[_1606 + 32] = stor15 % 16777216
                            else:
                                mem[mem[64]] = 0x150b7a0200000000000000000000000000000000000000000000000000000000
                                mem[mem[64] + 4] = msg.sender
                                mem[mem[64] + 36] = 0
                                ...
                                mem[64] = mem[64] + ceil32(return_data.size)
                                require return_data.size >= 32
                                require mem[_2198] == Mask(32, 224, mem[_2198])
                                if Mask(32, 224, mem[_2198]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                                    revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                                if uint256(sub_f64c8af4) > 10000:
                                    revert with 0, 'ERC2981Royalties: Too high'
                                _2524 = mem[64]
                                mem[64] = mem[64] + 64
                                mem[_2524] = sub_e637f98fAddress
                                mem[_2524 + 32] = stor15 % 16777216
                        mem[0] = tokenByIndex.length
                        mem[32] = 11
                        royaltyInfo[stor8.length].field_0 = sub_e637f98fAddress
                        royaltyInfo[stor8.length].field_0 = stor15 % 16777216
                    ...
                    mem[mem[64] + 96 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
                    mem[mem[64] + 32] = msg.sender
                    emit 0x76fc7572: mem[mem[64] len _1146 + (32 * mem[96]) + -mem[64] + 96]
            else:
                stor18[address(msg.sender)] = 2
                if not msg.sender:
                    revert with 0, 'ERC721: mint to the zero address'
                if ownerOf[stor8.length]:
                    revert with 0, 'ERC721: token already minted'
        ...
        if stor18[address(msg.sender)] != 1:
            ...
            if not arg1:
                ...
                while uint8(idx) < arg1:
                    ...
                    if msg.sender:
                        ...
                        if ext_code.size(msg.sender) <= 0:
                            ...
                            _1571 = mem[64]
                            mem[64] = mem[64] + 64
                            mem[_1571] = sub_e637f98fAddress
                            mem[_1571 + 32] = stor15 % 16777216
                        else:
                            mem[mem[64]] = 0x150b7a0200000000000000000000000000000000000000000000000000000000
                            mem[mem[64] + 4] = msg.sender
                            mem[mem[64] + 36] = 0
                            ...
                            s = 0
                            while s < 0:
                                mem[mem[64] + s + 164] = mem[_1173 + s + 32]
                                s = s + 32
                                continue 
                            require ext_code.size(msg.sender)
                            call msg.sender.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_2204] == Mask(32, 224, mem[_2204])
                            if Mask(32, 224, mem[_2204]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                                revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                            if uint256(sub_f64c8af4) > 10000:
                                revert with 0, 'ERC2981Royalties: Too high'
                            _2529 = mem[64]
                            mem[64] = mem[64] + 64
                            mem[_2529] = sub_e637f98fAddress
                            mem[_2529 + 32] = stor15 % 16777216
                    else:
                        if tokenByIndex.length < 1:
                            revert with 'NH{q', 17
                        if tokenByIndex.length - 1 >= tokenByIndex.length:
                        ...
                        if ext_code.size(msg.sender) <= 0:
                            ...
                            _1611 = mem[64]
                            mem[64] = mem[64] + 64
                            mem[_1611] = sub_e637f98fAddress
                            mem[_1611 + 32] = stor15 % 16777216
                        else:
                            mem[mem[64]] = 0x150b7a0200000000000000000000000000000000000000000000000000000000
                            mem[mem[64] + 4] = msg.sender
                            mem[mem[64] + 36] = 0
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_2205] == Mask(32, 224, mem[_2205])
                            if Mask(32, 224, mem[_2205]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                                revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                            if uint256(sub_f64c8af4) > 10000:
                                revert with 0, 'ERC2981Royalties: Too high'
                            _2534 = mem[64]
                            mem[64] = mem[64] + 64
                            mem[_2534] = sub_e637f98fAddress
                            mem[_2534 + 32] = stor15 % 16777216
                    mem[0] = tokenByIndex.length
                    mem[32] = 11
                    royaltyInfo[stor8.length].field_0 = sub_e637f98fAddress
                    royaltyInfo[stor8.length].field_0 = stor15 % 16777216
                ...
                mem[mem[64] + 96 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
                mem[mem[64] + 32] = msg.sender
                emit 0x76fc7572: mem[mem[64] len _1151 + (32 * mem[96]) + -mem[64] + 96]
            else:
                mem[128 len 32 * arg1] = call.data[calldata.size len 32 * arg1]
                idx = 0
                while uint8(idx) < arg1:
                    ...
                    if msg.sender:
                        ...
                        if ext_code.size(msg.sender) <= 0:
                            ...
                            _1577 = mem[64]
                            mem[64] = mem[64] + 64
                            mem[_1577] = sub_e637f98fAddress
                            mem[_1577 + 32] = stor15 % 16777216
                        else:
                            mem[mem[64]] = 0x150b7a0200000000000000000000000000000000000000000000000000000000
                            mem[mem[64] + 4] = msg.sender
                            mem[mem[64] + 36] = 0
                            ...
                            s = 0
                            while s < 0:
                                mem[mem[64] + s + 164] = mem[_1174 + s + 32]
                                s = s + 32
                                continue 
                            require ext_code.size(msg.sender)
                            call msg.sender.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_2207] == Mask(32, 224, mem[_2207])
                            if Mask(32, 224, mem[_2207]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                                revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                            if uint256(sub_f64c8af4) > 10000:
                                revert with 0, 'ERC2981Royalties: Too high'
                            _2539 = mem[64]
                            mem[64] = mem[64] + 64
                            mem[_2539] = sub_e637f98fAddress
                            mem[_2539 + 32] = stor15 % 16777216
                    else:
                        if tokenByIndex.length < 1:
                            revert with 'NH{q', 17
                        if tokenByIndex.length - 1 >= tokenByIndex.length:
                        ...
                        if ext_code.size(msg.sender) <= 0:
                            ...
                            _1616 = mem[64]
                            mem[64] = mem[64] + 64
                            mem[_1616] = sub_e637f98fAddress
                            mem[_1616 + 32] = stor15 % 16777216
                        else:
                            mem[mem[64]] = 0x150b7a0200000000000000000000000000000000000000000000000000000000
                            mem[mem[64] + 4] = msg.sender
                            mem[mem[64] + 36] = 0
                            ...
                            mem[64] = mem[64] + ceil32(return_data.size)
                            require return_data.size >= 32
                            require mem[_2208] == Mask(32, 224, mem[_2208])
                            if Mask(32, 224, mem[_2208]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                                revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                            if uint256(sub_f64c8af4) > 10000:
                                revert with 0, 'ERC2981Royalties: Too high'
                            _2544 = mem[64]
                            mem[64] = mem[64] + 64
                            mem[_2544] = sub_e637f98fAddress
                            mem[_2544 + 32] = stor15 % 16777216
                    mem[0] = tokenByIndex.length
                    mem[32] = 11
                    royaltyInfo[stor8.length].field_0 = sub_e637f98fAddress
                    royaltyInfo[stor8.length].field_0 = stor15 % 16777216
                ...
                mem[mem[64] + 96 len 32 * mem[96]] = mem[128 len 32 * mem[96]]
                mem[mem[64] + 32] = msg.sender
                emit 0x76fc7572: mem[mem[64] len _1152 + (32 * mem[96]) + -mem[64] + 96]
        else:
            stor18[address(msg.sender)] = 2
            if not msg.sender:
                revert with 0, 'ERC721: mint to the zero address'
