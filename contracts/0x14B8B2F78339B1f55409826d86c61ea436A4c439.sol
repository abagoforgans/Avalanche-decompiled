...
function BuyToken(address arg1, address arg2, uint256 arg3) payable {
    ...
    mem[(32 * _47) + ceil32(return_data.size) + 452] = 100 * mem[ceil32(return_data.size) + 352] / 102
    ...
    call 0x60ae616a2155ee3d9a68541ba4544862310933d4.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args arg3, 100 * mem[ceil32(return_data.size) + 352] / 102, Array(len=2, data=mem[(32 * _47) + ceil32(return_data.size) + 612 len 64]), address(this.address), block.timestamp + 15
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function BuyMaxToken(address arg1, address arg2) payable {
    ...
    mem[64] = ceil32(return_data.size) + 288
    require return_data.size >= 32
    _48 = mem[288 len 4], ext_call.return_data[0 len 28]
    ...
    require 1 < mem[ceil32(return_data.size) + 288]
    mem[(32 * _51) + ceil32(return_data.size) + 384] = arg2
    mem[(32 * _51) + ceil32(return_data.size) + 416] = 0x38ed173900000000000000000000000000000000000000000000000000000000
    mem[(32 * _51) + ceil32(return_data.size) + 420] = ext_call.return_data[0]
    mem[(32 * _51) + ceil32(return_data.size) + 452] = 100 * mem[ceil32(return_data.size) + 352] / 102
    mem[(32 * _51) + ceil32(return_data.size) + 516] = this.address
    mem[(32 * _51) + ceil32(return_data.size) + 548] = block.timestamp + 15
    ...
    call 0x60ae616a2155ee3d9a68541ba4544862310933d4.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args ext_call.return_data[0], 100 * mem[ceil32(return_data.size) + 352] / 102, Array(len=2, data=mem[(32 * _51) + ceil32(return_data.size) + 612 len 64]), address(this.address), block.timestamp + 15
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    require mem[(32 * _51) + ceil32(return_data.size) + 416 len 4], ext_call.return_data[0 len 28] <= 4294967296
    require mem[(32 * _51) + ceil32(return_data.size) + 416 len 4], ext_call.return_data[0 len 28] + 32 <= return_data.size
    require mem[mem[(32 * _51) + ceil32(return_data.size) + 416 len 4], ext_call.return_data[0 len 28] + (32 * _51) + ceil32(return_data.size) + 416] <= 4294967296 and mem[(32 * _51) + ceil32(return_data.size) + 416 len 4], ext_call.return_data[0 len 28] + (32 * mem[mem[(32 * _51) + ceil32(return_data.size) + 416 len 4], ext_call.return_data[0 len 28] + (32 * _51) + ceil32(return_data.size) + 416]) + 32 <= return_data.size
    call msg.sender with:
       value eth.balance(this.address) wei
         gas gas_remaining wei
    if not ext_call.success:
