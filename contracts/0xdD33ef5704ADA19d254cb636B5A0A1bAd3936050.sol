...
function TeamRemoveLiquidity(bool arg1) {
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    call address(stor20.field_0).removeLiquidityAVAXSupportingFeeOnTransferTokens(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
         gas gas_remaining wei
...
function TeamCreateLPandBNB() {
    ...
    if uint8(stor19.field_32) > -uint8(stor19.field_40) + 255:
        revert with 0, 17
    if balanceOf[this.address] >= 5 * 10^9:
        if uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
            if uint8(stor19.field_32) > 0xdbe6fecebdedd5beb573440e5a884d1b2fbf06fcce912adcb8d8422e:
                revert with 0, 17
            if not uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
                revert with 0, 18
            if 5 * 10^9 < 5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)):
                revert with 0, 17
            if 5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) < 5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2:
                revert with 0, 17
            if (5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))) - (5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) > !(-(5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))) + 5 * 10^9):
                revert with 0, 17
            if not this.address:
                revert with 0, 'Approve from zero'
            if not address(stor20.field_0):
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][address(stor20.field_0)].field_0 = -(5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 5 * 10^9
            emit Approval((-(5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 5 * 10^9), this.address, address(stor20.field_0));
            ...
            mem[ceil32(return_data.size) + 196] = -(5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 5 * 10^9
            idx = 0
            s = 128
            ...
            call address(stor20.field_0).swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args -(5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 5 * 10^9, 0, 160, address(this.address), block.timestamp, 2, mem[ceil32(return_data.size) + 388 len 64]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if eth.balance(this.address) < eth.balance(this.address):
                revert with 0, 17
            if False and (5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))) - (5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) > 0:
                revert with 0, 17
            if not -(5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 5 * 10^9:
                revert with 0, 18
            if totalLPBNB > !(0 / -(5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 5 * 10^9):
                revert with 0, 17
            totalLPBNB += 0 / -(5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 5 * 10^9
            if not this.address:
                revert with 0, 'Approve from zero'
            if not address(stor20.field_0):
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][address(stor20.field_0)].field_0 = 5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2
            allowance[address(this.address)][address(stor20.field_0)].field_255 = 0
            emit Approval((5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2), this.address, address(stor20.field_0));
            call address(stor20.field_0).addLiquidityAVAX(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
               value 0 / -(5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32)) / 2) + 5 * 10^9 wei
                 gas gas_remaining wei
                args address(this.address), Mask(255, 1, 5 * 10^9 * uint8(stor19.field_32) / uint8(uint8(stor19.field_40) + uint8(stor19.field_32))), 0, 0, address(this.address), block.timestamp
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
    ...
    if stor12[address(msg.sender)]:
        ...
        if stor27[address(msg.sender)]:
            ...
            while idx < 2:
                ...
                continue 
            require ext_code.size(address(stor20.field_0))
            call address(stor20.field_0).swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
               value stor27[address(msg.sender)] wei
                 gas gas_remaining wei
                args 0, 128, msg.sender, block.timestamp, 2, mem[ceil32(return_data.size) + 356 len 64]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            emit 0x69e31847: stor27[address(msg.sender)], msg.sender
    else:
        ...
        if profitPerShare * balanceOf[address(msg.sender)] < stor26[address(msg.sender)]:
            ...
            if stor27[address(msg.sender)] + (Mask(192, 64, (profitPerShare * balanceOf[address(msg.sender)]) - stor26[address(msg.sender)]) >> 64):
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                emit 0x69e31847: stor27[address(msg.sender)] + (Mask(192, 64, (profitPerShare * balanceOf[address(msg.sender)]) - stor26[address(msg.sender)]) >> 64), msg.sender
