...
const getName = 'StrategyBenqiWbtc'
...
const sub_d48113cf(?) = 0xe194c4c5ac32a3c9ffdb358d9bfd523a0b6d15
...
function getSupplied() {
    require ext_code.size(0xfe000000000000000000000000e194c4c5ac32a3c9ffdb358d9bfd523a0b6d15)
...
function getSuppliedView() {
    require ext_code.size(0xfe000000000000000000000000e194c4c5ac32a3c9ffdb358d9bfd523a0b6d15)
    staticcall 0xfe000000000000000000000000e194c4c5ac32a3c9ffdb358d9bfd523a0b6d15.getAccountSnapshot(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function getSafeSyncColFactor() {
    ...
    staticcall 0x486af39519b4dc9a7fccd318217352830e8ad9b4.markets(address rg1) with:
            gas gas_remaining wei
           args 0xfe000000000000000000000000e194c4c5ac32a3c9ffdb358d9bfd523a0b6d15
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function balanceOfPool() {
    ...
    require return_data.size >= 128
    require ext_code.size(0xfe000000000000000000000000e194c4c5ac32a3c9ffdb358d9bfd523a0b6d15)
    staticcall 0xfe000000000000000000000000e194c4c5ac32a3c9ffdb358d9bfd523a0b6d15.borrowBalanceStored(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function getLeveragedSupplyTarget(uint256 arg1) {
    ...
    if not stor11:
        ...
        if 1000000000000000000 * 10^18 / -ext_call.return_data[32] + (0 / stor12) + 10^18 * arg1 / arg1 != 1000000000000000000 * 10^18 / -ext_call.return_data[32] + (0 / stor12) + 10^18:
            revert with 0, 32, 33, 0x68536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
...
function withdrawForSwap(uint256 arg1) {
    ...
    if ext_call.return_data[0] > arg1:
        revert with 0, 'SafeMath: subtraction overflow'
    require ext_code.size(0xe194c4c5ac32a3c9ffdb358d9bfd523a0b6d15)
    staticcall 0xe194c4c5ac32a3c9ffdb358d9bfd523a0b6d15.getCash() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function withdrawAll() {
    ...
    if not ext_call.return_data[96]:
        ...
        if ext_call.return_data[0] < (0 / 10^18) - ext_call.return_data[0]:
            ...
            if ext_call.return_data[0]:
                if 10^18 * ext_call.return_data[0] / ext_call.return_data[0] != 10^18:
                    revert with 0, 32, 33, 0x68536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[517 len 31]
            revert with 0, 'SafeMath: division by zero'
    else:
        if ext_call.return_data[32] * ext_call.return_data[96] / ext_call.return_data[96] == ext_call.return_data[32]:
...
function deposit() {
    ...
    if ext_call.return_data[0]:
        if not ext_code.size(wantAddress):
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = approve(address rg1, uint256 rg2), 272710849458410119388715829, 0, 0
        mem[324 len 0] = 0
        call wantAddress.0x3a0b6d15 with:
             gas gas_remaining wei
            args Mask(480, -256, approve(address rg1, uint256 rg2), 272710849458410119388715829, 0, 0) << 256, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address rg1, uint256 rg2), 272710849458410119388715829, 0, 0
            if not approve(address rg1, uint256 rg2), 272710849458410119388715829:
                revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
            if ext_call.return_data[0]:
                require ext_code.size(wantAddress)
                staticcall wantAddress.0xdd62ed3e with:
                        gas gas_remaining wei
                       args this.address, 0xe194c4c5ac32a3c9ffdb358d9bfd523a0b6d15
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                if ext_call.return_data[0]:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = 0, 0xe194c4c5ac32a3c9ffdb358d9bfd523a0b6d15, ext_call.return_data[0 len 28]
            call wantAddress.0x3a0b6d15 with:
                 gas gas_remaining wei
            ...
            require ext_code.size(0xe194c4c5ac32a3c9ffdb358d9bfd523a0b6d15)
            call 0x00e194c4c5ac32a3c9ffdb358d9bfd523a0b6d15.mint(uint256 rg1) with:
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 425 len 64] = 0, 0xe194c4c5ac32a3c9ffdb358d9bfd523a0b6d15, ext_call.return_data[0 len 28]
                call wantAddress.0x3a0b6d15 with:
                     gas gas_remaining wei
...
function getHarvestable() {
    ...
    staticcall 0x486af39519b4dc9a7fccd318217352830e8ad9b4.rewardSupplierIndex(uint8 rg1, address rg2, address rg3) with:
            gas gas_remaining wei
           args 0, 0xfe000000000000000000000000e194c4c5ac32a3c9ffdb358d9bfd523a0b6d15, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(0xe194c4c5ac32a3c9ffdb358d9bfd523a0b6d15)
    staticcall 0xe194c4c5ac32a3c9ffdb358d9bfd523a0b6d15.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if ext_call.return_data[0] >= Mask(224, 0, ext_call.return_data[0]):
        ...
        require return_data.size >= 32
        require ext_code.size(0xe194c4c5ac32a3c9ffdb358d9bfd523a0b6d15)
        staticcall 0xe194c4c5ac32a3c9ffdb358d9bfd523a0b6d15.borrowBalanceStored(address rg1) with:
                gas gas_remaining wei
               args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if ext_call.return_data[0] >= Mask(224, 0, ext_call.return_data[0]):
            ...
            staticcall 0x486af39519b4dc9a7fccd318217352830e8ad9b4.rewardSupplierIndex(uint8 rg1, address rg2, address rg3) with:
                    gas gas_remaining wei
                   args 1, 0xfe000000000000000000000000e194c4c5ac32a3c9ffdb358d9bfd523a0b6d15, this.address
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require ext_code.size(0xe194c4c5ac32a3c9ffdb358d9bfd523a0b6d15)
