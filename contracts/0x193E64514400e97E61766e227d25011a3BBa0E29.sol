...
function sub_37addf1d(?) payable {
    ...
    if not arg2.length:
        ...
        if not arg2.length:
            ...
            if not arg2.length:
                ...
                mem[(32 * _55) + (131 * arg2.length) + ceil32(return_data.size) + 320] = (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 160
                mem[(32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + (32 * _55) + (131 * arg2.length) + ceil32(return_data.size) + 416] = mem[(98 * arg2.length) + 192]
                _953 = mem[(98 * arg2.length) + 192]
                mem[(32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + (32 * _55) + (131 * arg2.length) + ceil32(return_data.size) + 448 len floor32(mem[(98 * arg2.length) + 192])] = mem[(98 * arg2.length) + 224 len floor32(mem[(98 * arg2.length) + 192])]
                return 96, 
                       mem[(32 * _55) + (131 * arg2.length) + ceil32(return_data.size) + 288 len (32 * _953) + (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 160]
            ...
            mem[(32 * _61) + (131 * arg2.length) + ceil32(return_data.size) + 320] = (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 160
            mem[(32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + (32 * _61) + (131 * arg2.length) + ceil32(return_data.size) + 416] = mem[(98 * arg2.length) + 192]
            mem[(32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + (32 * _61) + (131 * arg2.length) + ceil32(return_data.size) + 448 len floor32(mem[(98 * arg2.length) + 192])] = mem[(98 * arg2.length) + 224 len floor32(mem[(98 * arg2.length) + 192])]
            return Array(len=mem[(32 * arg2.length) + 128], data=mem[(32 * _61) + (131 * arg2.length) + ceil32(return_data.size) + 384 len (32 * mem[(98 * arg2.length) + 192]) + (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 64]), 
                   (32 * mem[(32 * arg2.length) + 128]) + 128,
                   (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 160
        ...
        if not arg2.length:
            ...
            mem[(32 * _62) + (131 * arg2.length) + ceil32(return_data.size) + 320] = (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 160
            mem[(32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + (32 * _62) + (131 * arg2.length) + ceil32(return_data.size) + 416] = mem[(98 * arg2.length) + 192]
            mem[(32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + (32 * _62) + (131 * arg2.length) + ceil32(return_data.size) + 448 len floor32(mem[(98 * arg2.length) + 192])] = mem[(98 * arg2.length) + 224 len floor32(mem[(98 * arg2.length) + 192])]
            return Array(len=mem[(32 * arg2.length) + 128], data=mem[(32 * _62) + (131 * arg2.length) + ceil32(return_data.size) + 384 len (32 * mem[(98 * arg2.length) + 192]) + (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 64]), 
                   (32 * mem[(32 * arg2.length) + 128]) + 128,
                   (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 160
        mem[(98 * arg2.length) + 224 len 32 * arg2.length] = code.data[2718 len 32 * arg2.length]
        mem[(131 * arg2.length) + 224] = 0xabfceffc00000000000000000000000000000000000000000000000000000000
        ...
        mem[(32 * _68) + (131 * arg2.length) + ceil32(return_data.size) + 320] = (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 160
        mem[(32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + (32 * _68) + (131 * arg2.length) + ceil32(return_data.size) + 416] = mem[(98 * arg2.length) + 192]
        mem[(32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + (32 * _68) + (131 * arg2.length) + ceil32(return_data.size) + 448 len floor32(mem[(98 * arg2.length) + 192])] = mem[(98 * arg2.length) + 224 len floor32(mem[(98 * arg2.length) + 192])]
        return Array(len=mem[(32 * arg2.length) + 128], data=mem[(32 * _68) + (131 * arg2.length) + ceil32(return_data.size) + 384 len (32 * mem[(98 * arg2.length) + 192]) + (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 64]), 
               (32 * mem[(32 * arg2.length) + 128]) + 128,
               (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 160
    ...
    if not arg2.length:
        ...
        if not arg2.length:
            ...
            mem[(32 * _64) + (131 * arg2.length) + ceil32(return_data.size) + 320] = (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 160
            mem[(32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + (32 * _64) + (131 * arg2.length) + ceil32(return_data.size) + 416] = mem[(98 * arg2.length) + 192]
            mem[(32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + (32 * _64) + (131 * arg2.length) + ceil32(return_data.size) + 448 len floor32(mem[(98 * arg2.length) + 192])] = mem[(98 * arg2.length) + 224 len floor32(mem[(98 * arg2.length) + 192])]
            return Array(len=mem[(32 * arg2.length) + 128], data=mem[(32 * _64) + (131 * arg2.length) + ceil32(return_data.size) + 384 len (32 * mem[(98 * arg2.length) + 192]) + (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 64]), 
                   (32 * mem[(32 * arg2.length) + 128]) + 128,
                   (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 160
        mem[(98 * arg2.length) + 224 len 32 * arg2.length] = code.data[2718 len 32 * arg2.length]
        mem[(131 * arg2.length) + 224] = 0xabfceffc00000000000000000000000000000000000000000000000000000000
        ...
        mem[(32 * _69) + (131 * arg2.length) + ceil32(return_data.size) + 320] = (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 160
        mem[(32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + (32 * _69) + (131 * arg2.length) + ceil32(return_data.size) + 416] = mem[(98 * arg2.length) + 192]
        mem[(32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + (32 * _69) + (131 * arg2.length) + ceil32(return_data.size) + 448 len floor32(mem[(98 * arg2.length) + 192])] = mem[(98 * arg2.length) + 224 len floor32(mem[(98 * arg2.length) + 192])]
        return Array(len=mem[(32 * arg2.length) + 128], data=mem[(32 * _69) + (131 * arg2.length) + ceil32(return_data.size) + 384 len (32 * mem[(98 * arg2.length) + 192]) + (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 64]), 
               (32 * mem[(32 * arg2.length) + 128]) + 128,
               (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 160
    mem[(64 * arg2.length) + 192 len 32 * arg2.length] = code.data[2718 len 32 * arg2.length]
    mem[(98 * arg2.length) + 192] = arg2.length
    if not arg2.length:
        ...
        mem[(32 * _70) + (131 * arg2.length) + ceil32(return_data.size) + 320] = (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 160
        mem[(32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + (32 * _70) + (131 * arg2.length) + ceil32(return_data.size) + 416] = mem[(98 * arg2.length) + 192]
        mem[(32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + (32 * _70) + (131 * arg2.length) + ceil32(return_data.size) + 448 len floor32(mem[(98 * arg2.length) + 192])] = mem[(98 * arg2.length) + 224 len floor32(mem[(98 * arg2.length) + 192])]
        return Array(len=mem[(32 * arg2.length) + 128], data=mem[(32 * _70) + (131 * arg2.length) + ceil32(return_data.size) + 384 len (32 * mem[(98 * arg2.length) + 192]) + (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 64]), 
               (32 * mem[(32 * arg2.length) + 128]) + 128,
               (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 160
    mem[(98 * arg2.length) + 224 len 32 * arg2.length] = code.data[2718 len 32 * arg2.length]
    mem[(131 * arg2.length) + 224] = 0xabfceffc00000000000000000000000000000000000000000000000000000000
    ...
    mem[(32 * _76) + (131 * arg2.length) + ceil32(return_data.size) + 320] = (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 160
    mem[(32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + (32 * _76) + (131 * arg2.length) + ceil32(return_data.size) + 416] = mem[(98 * arg2.length) + 192]
    mem[(32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + (32 * _76) + (131 * arg2.length) + ceil32(return_data.size) + 448 len floor32(mem[(98 * arg2.length) + 192])] = mem[(98 * arg2.length) + 224 len floor32(mem[(98 * arg2.length) + 192])]
    return Array(len=mem[(32 * arg2.length) + 128], data=mem[(32 * _76) + (131 * arg2.length) + ceil32(return_data.size) + 384 len (32 * mem[(98 * arg2.length) + 192]) + (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 64]), 
           (32 * mem[(32 * arg2.length) + 128]) + 128,
           (32 * mem[(64 * arg2.length) + 160]) + (32 * mem[(32 * arg2.length) + 128]) + 160
}
