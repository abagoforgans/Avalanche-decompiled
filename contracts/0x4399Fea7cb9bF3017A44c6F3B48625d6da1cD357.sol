...
uint8 whitelistActive; offset 160
uint8 saleActive; offset 168
uint128 stor7; offset 168
uint128 stor7; offset 160
address sub_3ca0402eAddress;
...
function sub_3ca0402e(?) {
    return sub_3ca0402eAddress
}
...
function sub_c672ccf3(?) payable {
    ...
    if not whitelistActive:
        ...
        if msg.value and sub_685cd924 > -1 / msg.value:
            revert with 'NH{q', 17
        if contributions[address(arg2)] > -msg.value - 1:
            revert with 'NH{q', 17
        require contributions[address(arg2)] + msg.value <= 10^18
        contributions[address(arg2)] += msg.value
    require ext_code.size(sub_3ca0402eAddress)
    call sub_3ca0402eAddress.0xa9059cbb with:
         gas gas_remaining wei
