...
address owner;
address stor1;
address sub_72142948Address;
address sub_ef2d7786Address;
address sub_c82c0bd7Address;

function sub_72142948(?) payable {
    return sub_72142948Address
}
...
function sub_1ddbd167(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_72142948Address = address(arg1)
    stor1 = address(arg1)
}
...
function onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) payable {
    ...
    if ext_call.return_data[0] >= 2:
        revert with 0, 'Only two cows can be minted per wallet!'
