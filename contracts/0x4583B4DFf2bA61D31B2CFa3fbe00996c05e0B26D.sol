...
function sub_f260526e(?) payable {
    ...
    require ceil32(return_data.size) + (32 * mem[mem[96 len 4], Mask(224, 32, arg2) >> 32 + 96]) + 128 <= test266151307() and (32 * mem[mem[96 len 4], Mask(224, 32, arg2) >> 32 + 96]) + 32 >= 0
    ...
    mem[mem[64]] = mem[mem[ceil32(return_data.size) + 128] + 12 len 20]
    return memory
      from mem[64]
       len 32
}

function sub_ce6fd7d5(?) payable {
    require calldata.size - 4 >= 96
    require arg1 == address(arg1)
    require arg2 == arg2
    require arg3 == arg3
    ...
    mem[160] = 0
    mem[192] = 0
    mem[224] = 0x1526fe2700000000000000000000000000000000000000000000000000000000
    mem[228] = arg2
    require ext_code.size(address(arg1))
    staticcall address(arg1).poolInfo(uint256 arg1) with:
            gas gas_remaining wei
    ...
    require return_data.size >= 32
    _5 = mem[224 len 4], Mask(224, 32, arg2) >> 32
    ...
    _6 = mem[mem[224 len 4], Mask(224, 32, arg2) >> 32 + 224]
    require mem[mem[224 len 4], Mask(224, 32, arg2) >> 32 + 224] <= test266151307()
    require ceil32(return_data.size) + (32 * mem[mem[224 len 4], Mask(224, 32, arg2) >> 32 + 224]) + 256 <= test266151307() and (32 * mem[mem[224 len 4], Mask(224, 32, arg2) >> 32 + 224]) + 32 >= 0
    mem[64] = ceil32(return_data.size) + (32 * mem[mem[224 len 4], Mask(224, 32, arg2) >> 32 + 224]) + 256
    mem[ceil32(return_data.size) + 224] = mem[mem[224 len 4], Mask(224, 32, arg2) >> 32 + 224]
    require _5 + (128 * _6) + 32 <= return_data.size
    idx = 0
    s = _5 + 256
    t = ceil32(return_data.size) + 256
    while idx < _6:
        require return_data.size + -s + 224 >= 128
        _23 = mem[64]
        require mem[64] + 128 <= test266151307() and mem[64] + 128 >= mem[64]
        mem[64] = mem[64] + 128
        require mem[s] == mem[s + 12 len 20]
        ...
        t = t + 32
        continue 
    require arg3 < mem[ceil32(return_data.size) + 224]
    _22 = mem[(32 * arg3) + ceil32(return_data.size) + 256]
    mem[mem[64]] = mem[mem[(32 * arg3) + ceil32(return_data.size) + 256] + 12 len 20]
    mem[mem[64] + 32] = mem[_22 + 32]
    mem[mem[64] + 64] = mem[_22 + 64]
    mem[mem[64] + 96] = mem[_22 + 96]
    return memory
      from mem[64]
       len 128
}
