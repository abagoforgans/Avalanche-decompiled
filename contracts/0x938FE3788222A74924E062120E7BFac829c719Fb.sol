...
#
const sub_0e0689da(?) = 0x415045494e546f6b656e50617573656400000000000000000000000000000000
...
function burn(uint256 arg1) payable {
    ...
    staticcall settingsAddress.0x370c24cf with:
            gas gas_remaining wei
           args 0x415045494e546f6b656e50617573656400000000000000000000000000000000
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0]:
        revert with 0, 'APEIN_TOKEN_PAUSED'
...
function mint(address arg1, uint256 arg2) payable {
    ...
    require arg1 == arg1
    require ext_code.size(settingsAddress)
    staticcall settingsAddress.0xa3574c5b with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    staticcall address(ext_call.return_data[0]).0xd86d744e with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).0xd5391393 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).0xa3214f7c with:
            gas gas_remaining wei
