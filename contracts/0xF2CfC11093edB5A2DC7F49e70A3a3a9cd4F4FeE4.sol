...
function getNodeNumberOf(address arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require ext_code.size(0x1c5bccb156247396b62ac6b7f05900b888d504c)
    delegate 0x1c5bccb156247396b62ac6b7f05900b888d504c.0x732a2ccf with:
...
function setJoeV2RouterAndCreatePair() {
    ...
    staticcall stor31.factory() with:
            gas gas_remaining wei
    ...
    while idx < stor10[address(msg.sender)].field_0:
        ...
        if stor10[address(msg.sender)][idx].field_0:
            ...
            if stor10[address(msg.sender)][idx].field_0:
                ...
                if Mask(256, -1, stor10[address(msg.sender)][idx].field_0):
                    if 31 >= uint255(stor10[address(msg.sender)][idx].field_0) * 0.5:
                        ...
                        mem[0] = (4 * idx) + sha3(sha3(address(msg.sender), 10))
                        ...
                        while _71 + (uint255(stor10[address(msg.sender)][idx].field_0) * 0.5) > t:
                            ...
                            continue 
                mem[_65] = _71
                mem[_65 + 32] = stor10[address(msg.sender)][idx].field_256
                mem[_65 + 64] = stor10[address(msg.sender)][idx].field_512
                mem[_65 + 96] = stor10[address(msg.sender)][idx].field_768
                mem[s] = _65
                s = s + 32
                idx = idx + 1
                continue 
            ...
            while _71 + stor10[address(msg.sender)][u].field_1 > t:
                ...
                continue 
            mem[_65] = _71
            mem[_65 + 32] = stor10[address(msg.sender)][u].field_256
            mem[_65 + 64] = stor10[address(msg.sender)][u].field_512
            mem[_65 + 96] = stor10[address(msg.sender)][u].field_768
            mem[t] = _65
            t = t + 32
            u = u + 1
            continue 
        ...
        mem[_75] = stor10[address(msg.sender)][idx].field_1
        if stor10[address(msg.sender)][idx].field_0:
            if stor10[address(msg.sender)][idx].field_0 == uint255(stor10[address(msg.sender)][idx].field_0) * 0.5 < 32:
                revert with 0, 34
            if not Mask(256, -1, stor10[address(msg.sender)][idx].field_0):
                ...
                continue 
            if 31 >= uint255(stor10[address(msg.sender)][idx].field_0) * 0.5:
                mem[_75 + 32] = 256 * stor10[address(msg.sender)][idx].field_8
                mem[_65] = _75
                mem[_65 + 32] = stor10[address(msg.sender)][idx].field_256
                mem[_65 + 64] = stor10[address(msg.sender)][idx].field_512
                mem[_65 + 96] = stor10[address(msg.sender)][idx].field_768
                ...
                continue 
            mem[0] = (4 * idx) + sha3(sha3(address(msg.sender), 10))
            mem[_75 + 32] = stor10[address(msg.sender)][idx].field_0
            t = _75 + 32
            u = sha3(mem[0])
            while _75 + (uint255(stor10[address(msg.sender)][u].field_0) * 0.5) > t:
                mem[t + 32] = allowance[u]
                t = t + 32
                u = u + 1
                continue 
        ...
        if stor10[address(msg.sender)][idx].field_1:
            if 31 >= stor10[address(msg.sender)][idx].field_1:
                ...
                t = _75 + 32
                u = sha3(mem[0])
                while _75 + stor10[address(msg.sender)][idx].field_1 > t:
                    mem[t + 32] = allowance[u]
                    t = t + 32
                    u = u + 1
                    continue 
...
function getNodesRewards() {
    ...
    while idx < stor10[address(msg.sender)].field_0:
        ...
        if stor10[address(msg.sender)][idx].field_0:
            ...
            _72 = mem[64]
            mem[64] = mem[64] + ceil32(uint255(stor10[address(msg.sender)][idx].field_0) * 0.5) + 32
            mem[_72] = uint255(stor10[address(msg.sender)][idx].field_0) * 0.5
            if stor10[address(msg.sender)][idx].field_0:
                if stor10[address(msg.sender)][idx].field_0 == uint255(stor10[address(msg.sender)][idx].field_0) * 0.5 < 32:
                    revert with 0, 34
                if Mask(256, -1, stor10[address(msg.sender)][idx].field_0):
                    if 31 >= uint255(stor10[address(msg.sender)][idx].field_0) * 0.5:
                        ...
                        t = _72 + 32
                        u = sha3(mem[0])
                        while _72 + (uint255(stor10[address(msg.sender)][idx].field_0) * 0.5) > t:
                            mem[t + 32] = allowance[u]
                            t = t + 32
                            u = u + 1
                            continue 
                mem[_67] = _72
                mem[_67 + 32] = stor10[address(msg.sender)][idx].field_256
                mem[_67 + 64] = stor10[address(msg.sender)][idx].field_512
                mem[_67 + 96] = stor10[address(msg.sender)][idx].field_768
                mem[s] = _67
                s = s + 32
                idx = idx + 1
                continue 
            ...
            t = _72 + 32
            u = sha3(mem[0])
            while _72 + stor10[address(msg.sender)][u].field_1 > t:
                mem[t + 32] = allowance[u]
                t = t + 32
                u = u + 1
                continue 
            mem[_67] = _72
            mem[_67 + 32] = stor10[address(msg.sender)][u].field_256
            mem[_67 + 64] = stor10[address(msg.sender)][u].field_512
            mem[_67 + 96] = stor10[address(msg.sender)][u].field_768
            mem[t] = _67
            t = t + 32
            u = u + 1
            continue 
        ...
        _74 = mem[64]
        mem[64] = mem[64] + ceil32(stor10[address(msg.sender)][idx].field_1) + 32
        mem[_74] = stor10[address(msg.sender)][idx].field_1
        if stor10[address(msg.sender)][idx].field_0:
            if stor10[address(msg.sender)][idx].field_0 == uint255(stor10[address(msg.sender)][idx].field_0) * 0.5 < 32:
                revert with 0, 34
            if not Mask(256, -1, stor10[address(msg.sender)][idx].field_0):
                ...
                continue 
            if 31 >= uint255(stor10[address(msg.sender)][idx].field_0) * 0.5:
                mem[_74 + 32] = 256 * stor10[address(msg.sender)][idx].field_8
                mem[_67] = _74
                mem[_67 + 32] = stor10[address(msg.sender)][idx].field_256
                mem[_67 + 64] = stor10[address(msg.sender)][idx].field_512
                mem[_67 + 96] = stor10[address(msg.sender)][idx].field_768
                ...
                continue 
            mem[0] = (4 * idx) + sha3(sha3(address(msg.sender), 10))
            mem[_74 + 32] = stor10[address(msg.sender)][idx].field_0
            t = _74 + 32
            u = sha3(mem[0])
            while _74 + (uint255(stor10[address(msg.sender)][u].field_0) * 0.5) > t:
                mem[t + 32] = allowance[u]
                t = t + 32
                u = u + 1
                continue 
        ...
        if stor10[address(msg.sender)][idx].field_1:
            if 31 >= stor10[address(msg.sender)][idx].field_1:
                ...
                t = _74 + 32
                u = sha3(mem[0])
                while _74 + stor10[address(msg.sender)][idx].field_1 > t:
                    mem[t + 32] = allowance[u]
                    t = t + 32
                    u = u + 1
                    continue 
        ...
        while idx < _64:
            ...
            if not mem[mem[(32 * idx) + (2 * ceil32(return_data.size)) + 128] + 96]:
                ...
                if ceil32(_120) <= _120:
                    ...
                    s = 0
                    while s < _217:
                        mem[s + _118 + _120 + 32] = mem[s + _73 + 32]
                        s = s + 32
                        continue 
                    if ceil32(_217) <= _217:
                        _367 = mem[_117]
            ...
            if ceil32(_366) <= _366:
                ...
                s = 0
                while s < _501:
                    mem[s + _362 + _366 + 32] = mem[s + _73 + 32]
                    s = s + 32
                    continue 
                if ceil32(_501) <= _501:
                    _711 = mem[_216]
    ...
    u = 0
    t = mem[mem[(2 * ceil32(return_data.size)) + 128] + 96]
    while t:
        if u == -1:
            revert with 0, 17
        u = u + 1
    ...
    if not u:
        ...
        while idx:
            ...
            if s - 1 >= mem[_112]:
                revert with 0, 50
            mem[s + _112 + 31 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('add', 48, ('mask_shl', 8, 0, 0, ('add', ('var', 0), ('mul', -10, ('div', ('var', 0), 10)))))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('add', 48, ('mask_shl', 8, 0, 0, ('add', ('var', 0), ('mul', -10, ('div', ('var', 0), 10)))))), 0) - 256
            s = s - 1
            idx = idx / 10
            continue 
        _214 = mem[64]
        ...
        while idx < _64:
            ...
            if not mem[mem[(32 * idx) + (2 * ceil32(return_data.size)) + 128] + 96]:
                ...
                if ceil32(_377) <= _377:
                    ...
                    t = 0
                    while t < _495:
                        mem[t + _375 + _377 + 32] = mem[t + _214 + 32]
                        t = t + 32
                        continue 
                    if ceil32(_495) <= _495:
                        _697 = mem[_372]
                ...
                continue 
            u = 0
            s = mem[mem[(32 * idx) + (2 * ceil32(return_data.size)) + 128] + 96]
            while s:
                if u == -1:
                    revert with 0, 17
                u = u + 1
            ...
            if not u:
                ...
                while s:
                    ...
                    if v - 1 >= mem[_493]:
                        revert with 0, 50
                    mem[v + _493 + 31 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('add', 48, ('mask_shl', 8, 0, 0, ('add', ('var', 1), ('mul', -10, ('div', ('var', 1), 10)))))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('add', 48, ('mask_shl', 8, 0, 0, ('add', ('var', 1), ('mul', -10, ('div', ('var', 1), 10)))))), 0) - 256
                    v = v - 1
                    s = s / 10
                    continue 
                _691 = mem[64]
        ...
        _371 = mem[t]
        mem[mem[64] + 32] = mem[t]
        mem[mem[64] + 64 len ceil32(_371)] = mem[t + 32 len ceil32(_371)]
        if ceil32(_371) > _371:
            mem[_371 + mem[64] + 64] = 0
        return 32, mem[mem[64] + 32 len ceil32(_371) + 32]
    mem[_112 + 32 len u] = call.data[calldata.size len u]
    s = u
    idx = _70
    while idx:
        if s < 1:
    ...
    while idx < _64:
        ...
        if not mem[mem[(32 * idx) + (2 * ceil32(return_data.size)) + 128] + 96]:
            ...
            if ceil32(_378) <= _378:
                ...
                t = 0
                while t < _497:
                    mem[t + _376 + _378 + 32] = mem[t + _215 + 32]
                    t = t + 32
                    continue 
                if ceil32(_497) <= _497:
                    _703 = mem[_374]
        ...
        if not u:
            ...
            while s:
                ...
                if v - 1 >= mem[_494]:
                    revert with 0, 50
                mem[v + _494 + 31 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('add', 48, ('mask_shl', 8, 0, 0, ('add', ('var', 1), ('mul', -10, ('div', ('var', 1), 10)))))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('add', 48, ('mask_shl', 8, 0, 0, ('add', ('var', 1), ('mul', -10, ('div', ('var', 1), 10)))))), 0) - 256
                v = v - 1
                s = s / 10
                continue 
            _693 = mem[64]
    ...
    _373 = mem[t]
    mem[mem[64] + 32] = mem[t]
    mem[mem[64] + 64 len ceil32(_373)] = mem[t + 32 len ceil32(_373)]
    if ceil32(_373) > _373:
...
function getNodesCreatime() {
    ...
    if not mem[mem[(2 * ceil32(return_data.size)) + 128] + 32]:
        ...
        return 32, mem[mem[64] + 32 len ceil32(_116) + 32]
    u = 0
    t = mem[mem[(2 * ceil32(return_data.size)) + 128] + 32]
    while t:
        if u == -1:
            revert with 0, 17
        u = u + 1
    ...
    if not u:
        ...
        while idx < _64:
            ...
            if not mem[mem[(32 * idx) + (2 * ceil32(return_data.size)) + 128] + 32]:
                ...
                continue 
            u = 0
            s = mem[mem[(32 * idx) + (2 * ceil32(return_data.size)) + 128] + 32]
            while s:
                if u == -1:
                    revert with 0, 17
                u = u + 1
...
function getNodesLastClaims() {
    ...
    if not mem[mem[(2 * ceil32(return_data.size)) + 128] + 64]:
        ...
        return 32, mem[mem[64] + 32 len ceil32(_116) + 32]
    u = 0
    t = mem[mem[(2 * ceil32(return_data.size)) + 128] + 64]
    while t:
        if u == -1:
            revert with 0, 17
        u = u + 1
    ...
    if not u:
        ...
        while idx < _64:
            ...
            if not mem[mem[(32 * idx) + (2 * ceil32(return_data.size)) + 128] + 64]:
                ...
                continue 
            u = 0
            s = mem[mem[(32 * idx) + (2 * ceil32(return_data.size)) + 128] + 64]
            while s:
                if u == -1:
                    revert with 0, 17
                u = u + 1
...
function cashoutAll() {
    ...
    while idx < stor10[address(msg.sender)].field_0:
        ...
        idx = idx + 1
        s = s + stor10[address(msg.sender)][idx].field_768
        t = (4 * idx) + sha3(sha3(address(msg.sender), 10))
        continue 
}
