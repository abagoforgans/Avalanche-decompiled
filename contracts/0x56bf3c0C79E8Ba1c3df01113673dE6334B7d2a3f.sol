...
function sub_1cc41bba(?) payable {
    return bool(uint8(stor20.length))
}
...
function claimJackpot() payable {
    ...
    if uint8(stor20.length):
        revert with 0, 'Jackpot already claimed'
    uint8(stor20.length) = 1
        ...
        while s < 5:
            ...
            if idx < s:
                ...
                while t > s:
                    require t - 1 < 5
                    require t < 5
                    sub_06f6a017[t] = stor25[t]
                    require t - 1 < 5
                    require t < 5
                    sub_853082a6[t] = address(stor20[t])
                    t = t - 1
                    continue 
                require s < 5
    ...
    while idx < 5:
        ...
        while s > idx:
            require s - 1 < 5
            require s < 5
            sub_06f6a017[s] = stor25[s]
            require s - 1 < 5
            require s < 5
            sub_853082a6[s] = address(stor20[s])
            s = s - 1
            continue 
        if idx < 4:
            sub_06f6a017[idx] = sub_fa3cb11f[address(stor4)].field_0
            ...
            if stor30 < sub_fa3cb11f[address(stor4)].field_0:
                require idx < 5
                sub_06f6a017[idx] = sub_fa3cb11f[address(stor4)].field_0
                sub_853082a6[idx] = address(sub_982cfe85Address)
        idx = 0
