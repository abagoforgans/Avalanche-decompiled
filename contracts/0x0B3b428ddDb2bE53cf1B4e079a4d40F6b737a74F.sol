...
function sub_72ba0ebb(?) payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0x94f4578128b3f8e8c74d7250e8f42b5de79259f9)
    call 0x94f4578128b3f8e8c74d7250e8f42b5de79259f9.forfeit() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[100] = this.address
    require ext_code.size(0x98d23024cc53cfe3a3d72106526eaf85d412fbd1)
    staticcall 0x98d23024cc53cfe3a3d72106526eaf85d412fbd1.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    mem[ceil32(return_data.size) + 100] = 0x94f4578128b3f8e8c74d7250e8f42b5de79259f9
    mem[ceil32(return_data.size) + 132] = ext_call.return_data[0]
    require ext_code.size(0x98d23024cc53cfe3a3d72106526eaf85d412fbd1)
    call 0x98d23024cc53cfe3a3d72106526eaf85d412fbd1.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 0x94f4578128b3f8e8c74d7250e8f42b5de79259f9, ext_call.return_data[0]
    ...
    require ext_code.size(0x94f4578128b3f8e8c74d7250e8f42b5de79259f9)
    call 0x94f4578128b3f8e8c74d7250e8f42b5de79259f9.unstake(uint256 arg1, bool arg2) with:
         gas gas_remaining wei
        args ext_call.return_data[0], 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(2 * ceil32(return_data.size)) + 100] = this.address
    require ext_code.size(0x19613fec180746831bdf819e0790f35741040dfd)
    staticcall 0x19613fec180746831bdf819e0790f35741040dfd.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    mem[(4 * ceil32(return_data.size)) + 128] = 0x19613fec180746831bdf819e0790f35741040dfd
    ...
    require ext_code.size(0x19613fec180746831bdf819e0790f35741040dfd)
    call 0x19613fec180746831bdf819e0790f35741040dfd.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
    ...
    require ext_code.size(0x94f4578128b3f8e8c74d7250e8f42b5de79259f9)
    call 0x94f4578128b3f8e8c74d7250e8f42b5de79259f9.epoch() with:
         gas gas_remaining wei
...
function sub_8fdadfc1(?) payable {
    require ext_code.size(0x94f4578128b3f8e8c74d7250e8f42b5de79259f9)
    staticcall 0x94f4578128b3f8e8c74d7250e8f42b5de79259f9.0xdeac361a with:
            gas gas_remaining wei
    mem[96] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if uint8(stor1.field_160):
        ...
        if block.timestamp < uint128(stor1.field_0):
            revert with 0, '1e'
        require ext_code.size(0x94f4578128b3f8e8c74d7250e8f42b5de79259f9)
        call 0x94f4578128b3f8e8c74d7250e8f42b5de79259f9.rebase() with:
             gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(0x94f4578128b3f8e8c74d7250e8f42b5de79259f9)
        call 0x94f4578128b3f8e8c74d7250e8f42b5de79259f9.claim(address arg1) with:
             gas gas_remaining wei
            args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[0]
        mem[(4 * ceil32(return_data.size)) + 100] = 0x94f4578128b3f8e8c74d7250e8f42b5de79259f9
        ...
        mem[(7 * ceil32(return_data.size)) + 128] = 0x19613fec180746831bdf819e0790f35741040dfd
        ...
        mem[(4 * ceil32(return_data.size)) + 160] = 0x19613fec180746831bdf819e0790f35741040dfd
        require ext_code.size(0xee60d85ffa7a4e223a92dbd40c6fb685ea916b7a)
        staticcall 0xee60d85ffa7a4e223a92dbd40c6fb685ea916b7a.token0() with:
                gas gas_remaining wei
        mem[(4 * ceil32(return_data.size)) + 192] = ext_call.return_data[0]
        ...
        if address(ext_call.return_data[0]) == 0x130966628846bfd36ff31a822705796e8cb8c18d:
            ...
            mem[mem[64] + 4] = 0x94f4578128b3f8e8c74d7250e8f42b5de79259f9
            mem[mem[64] + 36] = _200
            require ext_code.size(0x19613fec180746831bdf819e0790f35741040dfd)
            call 0x19613fec180746831bdf819e0790f35741040dfd.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args 0x94f4578128b3f8e8c74d7250e8f42b5de79259f9, _200
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _206 = mem[64]
            ...
            require ext_code.size(0x94f4578128b3f8e8c74d7250e8f42b5de79259f9)
            call 0x94f4578128b3f8e8c74d7250e8f42b5de79259f9.stake(uint256 arg1, address arg2) with:
                 gas gas_remaining wei
            ...
            call 0x19613fec180746831bdf819e0790f35741040dfd.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args 0x94f4578128b3f8e8c74d7250e8f42b5de79259f9, _201
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _207 = mem[64]
