...
function sub_96813fca(?) payable {
    ...
    require arg1 < stor24.length
    require arg2 < uint256(stor24[arg1])
    return address(stor[('array', ('param', 'arg1'), ('name', 'stor24', 24)) + arg2])
}
...
function sub_c6ffe619(?) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_d4546ee8Address = address(arg1)
}
...
function sub_e8d20b00(?) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_d0dd7e35Address = address(arg1)
}
...
function sub_fa5c9edd(?) payable {
    ...
    while idx < stor24.length:
        mem[0] = 24
        _12 = mem[64]
        mem[64] = mem[64] + (32 * uint256(stor24[idx])) + 32
        mem[_12] = uint256(stor24[idx])
        if uint256(stor24[idx]):
            mem[0] = idx + sha3(24)
            mem[_12 + 32] = address(stor24[idx])
            t = _12 + 32
            u = sha3(mem[0])
            while _12 + (32 * uint256(stor24[idx])) > t:
                mem[t + 32] = stor1[u]
                t = t + 32
                u = u + 1
                continue 
...
function rewardsAvailable() payable {
    ...
    require return_data.size >= 64
    _16 = mem[(2 * ceil32(return_data.size)) + 96 len 4], stor18
    require mem[(2 * ceil32(return_data.size)) + 96 len 4], stor18 <= test266151307()
    require (2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor18 + 127 < (2 * ceil32(return_data.size)) + return_data.size + 96
    _17 = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor18 + 96]
    require mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor18 + 96] <= test266151307()
    require (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor18 + 96]) + 32 >= 0 and (4 * ceil32(return_data.size)) + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor18 + 96]) + 128 <= test266151307()
    mem[64] = (4 * ceil32(return_data.size)) + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor18 + 96]) + 128
    mem[(4 * ceil32(return_data.size)) + 96] = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor18 + 96]
            ...
            if not return_data.size:
                ...
                if return_data.size:
                    ...
                    if not mem[(32 * ('cd', 4).length) + ceil32(return_data.size) + 488]:
                        revert with 0, 'SafeERC20: ERC20 operation did not succeed'
            stor24.length++
            storB13D[stor24.length] = ('cd', 4).length
            if not ('cd', 4).length:
                idx = 0
                while storB13D[stor24.length] > idx:
                    stor[idx + sha3(stor24.length - 0x4ec2d2892e0b48417cb77d1bef4c1c5750509607c9ff51db24cabc6e2dc872d2)] = 0
                    idx = idx + 1
                    continue 
            else:
                s = 0
                ...
                while (32 * ('cd', 4).length) + 128 > idx:
                    stor[s + sha3(stor24.length - 0x4ec2d2892e0b48417cb77d1bef4c1c5750509607c9ff51db24cabc6e2dc872d2)] = mem[idx + 12 len 20]
                    s = s + 1
                    idx = idx + 32
                    continue 
    ...
    if not ext_call.return_data[12 len 20]:
        ...
        if not ext_call.success:
            ...
            while idx < stor24.length:
                ...
                mem[mem[64] + 4] = _366
                mem[mem[64] + 36] = 64
                mem[mem[64] + 68] = uint256(stor24[idx])
                mem[0] = sha3(24) + idx
                t = 0
                u = sha3(mem[0])
                v = mem[64] + 100
                while t < uint256(stor24[idx]):
                    mem[v] = stor[u]
                    t = t + 1
                    u = u + 1
                    v = v + 32
                ...
                if _547 - 1 < _547:
                    ...
                    staticcall unirouterAddress.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len _684 + (32 * outputToNativeRoute.length) + -mem[64] + 96]
                    if not ext_call.success:
                        idx = idx + 1
                        s = s
                        continue 
            ...
            while idx < stor24.length:
                ...
                if _693 - 1 < _693:
                    ...
                    staticcall unirouterAddress.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len _802 + (32 * outputToNativeRoute.length) + -mem[64] + 96]
                    if not ext_call.success:
                        idx = idx + 1
                        s = s
                        continue 
        ...
        mem[64] = (4 * ceil32(return_data.size)) + 96
        require return_data.size >= 64
        _14 = mem[(2 * ceil32(return_data.size)) + 96 len 4], stor18
        require mem[(2 * ceil32(return_data.size)) + 96 len 4], stor18 <= test266151307()
        require (2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor18 + 127 < (2 * ceil32(return_data.size)) + return_data.size + 96
        _16 = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor18 + 96]
        require mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor18 + 96] <= test266151307()
        require (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor18 + 96]) + 32 >= 0 and (4 * ceil32(return_data.size)) + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor18 + 96]) + 128 <= test266151307()
        mem[64] = (4 * ceil32(return_data.size)) + (32 * mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor18 + 96]) + 128
        mem[(4 * ceil32(return_data.size)) + 96] = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 96 len 4], stor18 + 96]
        ...
        staticcall unirouterAddress.mem[mem[64] len 4] with:
                gas gas_remaining wei
               args mem[mem[64] + 4 len _372 + (32 * outputToNativeRoute.length) + -mem[64] + 96]
        if not ext_call.success:
            if not stor24.length:
                return 0
            idx = 0
            ...
            while idx < stor24.length:
                ...
                if _811 - 1 < _811:
                    ...
                    staticcall unirouterAddress.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len _880 + (32 * outputToNativeRoute.length) + -mem[64] + 96]
                    if not ext_call.success:
                        idx = idx + 1
                        s = s
                        continue 
            ...
            while idx < stor24.length:
                ...
                if _886 - 1 < _886:
                    ...
                    staticcall unirouterAddress.mem[mem[64] len 4] with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4 len _927 + (32 * outputToNativeRoute.length) + -mem[64] + 96]
                    if not ext_call.success:
                        idx = idx + 1
                        s = s
                        continue 
