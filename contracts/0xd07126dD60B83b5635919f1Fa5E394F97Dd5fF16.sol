...
const sub_5fd866df(?) = 0x16563b74c2c87d52f98867e4c181ba25cb4ea2b8

const sub_c45a1ac1(?) = 0x78ea17559b3d2cf85a7f9c2c704eda119db5e6de

const Factory = 0xefa94de7a4656d787667c749f7e1223d71e9fd88

const sub_e616d53a(?) = 0xe896cdeaac9615145c0ca09c8cd5c25bced6384c
...
function sub_8ab845cc(?) payable {
    require ext_code.size(0x16563b74c2c87d52f98867e4c181ba25cb4ea2b8)
    staticcall 0x16563b74c2c87d52f98867e4c181ba25cb4ea2b8.0x72f702f3 with:
    ...
    require return_data.size >= 32
    require ext_code.size(0x16563b74c2c87d52f98867e4c181ba25cb4ea2b8)
    staticcall 0x16563b74c2c87d52f98867e4c181ba25cb4ea2b8.0x18160ddd with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(sha3(0, 17269419903419772280, sha3(8712802085545782520, 0xe896cdeaac9615145c0ca09c8cd5c25bced6384c), 0x40231f6b438bce0797c9ada29b718a87ea0a5cea3fe9a771abdd76bd41a3e545)))
    staticcall address(sha3(0, 17269419903419772280, sha3(8712802085545782520, 0xe896cdeaac9615145c0ca09c8cd5c25bced6384c), 0x40231f6b438bce0797c9ada29b718a87ea0a5cea3fe9a771abdd76bd41a3e545)).getReserves() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
