...
uint256 stor551;
mapping of struct sub_f71520db;
uint256 sub_cc0ea2be;
uint256 sub_1270c4cc;
uint256 sub_61609054;
...
function sub_f71520db(?) payable {
    require calldata.size - 4 >= 32
    if bool(uint8(sub_f71520db[arg1].field_2304)) != 1:
        revert with 0, 'non-existent token'
    return sub_f71520db[arg1].field_256
}
...
function sub_add32574(?) payable {
    ...
    while idx < balanceOf[address(arg1)]:
        ...
        mem[32] = 552
        if bool(uint8(sub_f71520db[stor151[address(arg1)][idx]].field_2304)) != 1:
...
function sub_e52712a6(?) payable {
    ...
    if arg1.length >= 32:
        revert with 0, 'SwordNFT: Rename context invalid'
    if bool(sub_f71520db[arg2].field_512):
        if bool(sub_f71520db[arg2].field_512) == uint255(sub_f71520db[arg2].field_512) * 0.5 < 32:
            revert with 0, 34
        if arg1.length:
            sub_f71520db[arg2][2][].field_0 = Array(len=arg1.length, data=arg1[all])
        else:
            sub_f71520db[arg2].field_512 = 0
            idx = 0
            while (uint255(sub_f71520db[arg2].field_512) * 0.5) + 31 / 32 > idx:
                sub_f71520db[arg2][idx + 2].field_0 = 0
                idx = idx + 1
                continue 
    else:
        if bool(sub_f71520db[arg2].field_512) == sub_f71520db[arg2].field_513 % 128 < 32:
            revert with 0, 34
        if arg1.length:
            sub_f71520db[arg2][2][].field_0 = Array(len=arg1.length, data=arg1[all])
        else:
            sub_f71520db[arg2].field_512 = 0
            idx = 0
            while sub_f71520db[arg2].field_513 % 128 + 31 / 32 > idx:
                sub_f71520db[arg2][idx + 2].field_0 = 0
                idx = idx + 1
                continue 
    stor401 = 1
...
function sub_6bcf0441(?) payable {
    require calldata.size - 4 >= 32
    if bool(sub_f71520db[arg1].field_512):
        if bool(sub_f71520db[arg1].field_512) == uint255(sub_f71520db[arg1].field_512) * 0.5 < 32:
            revert with 0, 34
        if bool(sub_f71520db[arg1].field_512):
            if bool(sub_f71520db[arg1].field_512) == uint255(sub_f71520db[arg1].field_512) * 0.5 < 32:
                revert with 0, 34
            if Mask(256, -1, sub_f71520db[arg1].field_512):
                if 31 >= uint255(sub_f71520db[arg1].field_512) * 0.5:
                    mem[128] = 256 * Mask(248, 0, sub_f71520db[arg1].field_520)
                else:
                    mem[128] = sub_f71520db[arg1][2].field_0
                    idx = 128
                    s = 0
                    while (uint255(sub_f71520db[arg1].field_512) * 0.5) + 96 > idx:
                        mem[idx + 32] = sub_f71520db[arg1][s + 2].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
        else:
            if bool(sub_f71520db[arg1].field_512) == sub_f71520db[arg1].field_513 % 128 < 32:
                revert with 0, 34
            if sub_f71520db[arg1].field_513 % 128:
                if 31 >= sub_f71520db[arg1].field_513 % 128:
                    mem[128] = 256 * Mask(248, 0, sub_f71520db[arg1].field_520)
                else:
                    mem[128] = sub_f71520db[arg1][2].field_0
                    idx = 128
                    s = 0
                    while sub_f71520db[arg1].field_513 % 128 + 96 > idx:
                        mem[idx + 32] = sub_f71520db[arg1][s + 2].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
        return sub_f71520db[arg1].field_0, 
               sub_f71520db[arg1].field_256,
               Array(len=2 * Mask(256, -1, sub_f71520db[arg1].field_512), data=mem[128 len ceil32(uint255(sub_f71520db[arg1].field_512) * 0.5)]),
               sub_f71520db[arg1].field_768,
               sub_f71520db[arg1].field_1024,
               sub_f71520db[arg1].field_1280,
               sub_f71520db[arg1].field_1536,
               sub_f71520db[arg1].field_1792,
               sub_f71520db[arg1].field_2048,
               bool(uint8(sub_f71520db[arg1].field_2304))
    if bool(sub_f71520db[arg1].field_512) == sub_f71520db[arg1].field_513 % 128 < 32:
        revert with 0, 34
    if bool(sub_f71520db[arg1].field_512):
        if bool(sub_f71520db[arg1].field_512) == uint255(sub_f71520db[arg1].field_512) * 0.5 < 32:
    ...
    return sub_f71520db[arg1].field_0, 
           sub_f71520db[arg1].field_256,
           Array(len=sub_f71520db[arg1].field_512 % 128, data=mem[128 len ceil32(sub_f71520db[arg1].field_513 % 128)]),
           sub_f71520db[arg1].field_768,
           sub_f71520db[arg1].field_1024,
           sub_f71520db[arg1].field_1280,
           sub_f71520db[arg1].field_1536,
...
function sub_51234781(?) payable {
    ...
    require arg1 + arg1.length + 36 <= calldata.size
    if arg1.length <= 1:
        revert with 0, 'Swords: name not valid or available, low balance'
    if arg1.length >= 32:
        revert with 0, 'Swords: name not valid or available, low balance'
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] < sub_61609054:
        revert with 0, 'Swords: name not valid or available, low balance'
    stor551++
    sub_f71520db[stor551].field_0 = stor551
    sub_f71520db[stor551].field_256 = 1
    if bool(sub_f71520db[stor551].field_512):
        if bool(sub_f71520db[stor551].field_512) == uint255(sub_f71520db[stor551].field_512) * 0.5 < 32:
            revert with 0, 34
        if arg1.length:
            sub_f71520db[stor551][2][].field_0 = Array(len=arg1.length, data=arg1[all])
        else:
            sub_f71520db[stor551].field_512 = 0
            idx = 0
            while (uint255(sub_f71520db[stor551].field_512) * 0.5) + 31 / 32 > idx:
                sub_f71520db[stor551][idx + 2].field_0 = 0
                idx = idx + 1
                continue 
    else:
        if bool(sub_f71520db[stor551].field_512) == sub_f71520db[stor551].field_513 % 128 < 32:
            revert with 0, 34
        if arg1.length:
            sub_f71520db[stor551][2][].field_0 = Array(len=arg1.length, data=arg1[all])
        else:
            sub_f71520db[stor551].field_512 = 0
            idx = 0
            while sub_f71520db[stor551].field_513 % 128 + 31 / 32 > idx:
                sub_f71520db[stor551][idx + 2].field_0 = 0
                idx = idx + 1
                continue 
    sub_f71520db[stor551].field_768 = block.timestamp
    sub_f71520db[stor551].field_1024 = 0
    sub_f71520db[stor551].field_1280 = sub_61609054
    sub_f71520db[stor551].field_1536 = 0
    sub_f71520db[stor551].field_1792 = 0
    sub_f71520db[stor551].field_2048 = 0
    uint8(sub_f71520db[stor551].field_2304) = 1
    if not msg.sender:
    ...
    emit Create(sub_61609054, msg.sender, stor551);
    if sub_61609054:
        require ext_code.size(sub_4d1c3621Address)
        call sub_4d1c3621Address.0x6f6ebec8 with:
             gas gas_remaining wei
            args msg.sender, sub_61609054
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if sub_61609054:
            require ext_code.size(sub_4d1c3621Address)
            call sub_4d1c3621Address.0xb75ee283 with:
                 gas gas_remaining wei
                args sub_61609054
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
...
function sub_38c4b4da(?) payable {
    ...
    require arg1 + arg1.length + 36 <= calldata.size
    if arg1.length <= 1:
        revert with 0, 'Swords: name not valid or available, min value, low balance'
    if arg1.length >= 32:
        revert with 0, 'Swords: name not valid or available, min value, low balance'
    if arg2 < sub_cc0ea2be:
        revert with 0, 'Swords: name not valid or available, min value, low balance'
    staticcall sub_4d1c3621Address.0x70a08231 with:
            gas gas_remaining wei
           args msg.sender
    ...
    if ext_call.return_data[0] < sub_cc0ea2be:
        revert with 0, 'Swords: name not valid or available, min value, low balance'
    stor551++
    if arg2 and sub_1270c4cc > -1 / arg2:
        revert with 0, 17
    if arg2 < arg2 * sub_1270c4cc / 10000:
        revert with 0, 17
    sub_f71520db[stor551].field_0 = stor551
    sub_f71520db[stor551].field_256 = 0
    if bool(sub_f71520db[stor551].field_512):
        if bool(sub_f71520db[stor551].field_512) == uint255(sub_f71520db[stor551].field_512) * 0.5 < 32:
            revert with 0, 34
        if arg1.length:
        ...
        if arg1.length:
            ...
            while sub_f71520db[stor551].field_513 % 128 + 31 / 32 > idx:
                ...
                continue 
    sub_f71520db[stor551].field_768 = block.timestamp
    sub_f71520db[stor551].field_1024 = arg2 - (arg2 * sub_1270c4cc / 10000)
    sub_f71520db[stor551].field_1280 = 0
    sub_f71520db[stor551].field_1536 = 0
    sub_f71520db[stor551].field_1792 = 0
    sub_f71520db[stor551].field_2048 = 0
    uint8(sub_f71520db[stor551].field_2304) = 1
    ...
    ownerOf[stor551] = msg.sender
    emit Transfer(0, msg.sender, stor551);
    emit Create((arg2 - (arg2 * sub_1270c4cc / 10000)), msg.sender, stor551);
    if arg2:
        require ext_code.size(sub_4d1c3621Address)
        call sub_4d1c3621Address.0x6f6ebec8 with:
             gas gas_remaining wei
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    if arg2 * sub_1270c4cc / 10000:
        require ext_code.size(sub_4d1c3621Address)
        call sub_4d1c3621Address.0xb75ee283 with:
             gas gas_remaining wei
            args (arg2 * sub_1270c4cc / 10000)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    return stor551
}
...
function sub_12e36401(?) payable {
    ...
    if not uint8(sub_f71520db[arg2].field_2304):
            ...
            if bool(stor201[arg2].field_0):
                ...
                if 31 < stor201[arg2].field_1 % 128:
                    ...
                    while stor201[arg2].field_1 % 128 + 31 / 32 > idx:
                        ...
                        idx = idx + 1
                        continue 
    sub_f71520db[arg2].field_0 = 0
    sub_f71520db[arg2].field_256 = 0
    if bool(sub_f71520db[arg2].field_512):
        if bool(sub_f71520db[arg2].field_512) == uint255(sub_f71520db[arg2].field_512) * 0.5 < 32:
            revert with 0, 34
        sub_f71520db[arg2].field_512 = 0
        if 31 < uint255(sub_f71520db[arg2].field_512) * 0.5:
            idx = 0
            while (uint255(sub_f71520db[arg2].field_512) * 0.5) + 31 / 32 > idx:
                sub_f71520db[arg2][idx + 2].field_0 = 0
                idx = idx + 1
        ...
        if bool(sub_f71520db[arg2].field_512) == sub_f71520db[arg2].field_513 % 128 < 32:
            revert with 0, 34
        sub_f71520db[arg2].field_512 = 0
        if 31 < sub_f71520db[arg2].field_513 % 128:
            idx = 0
            while sub_f71520db[arg2].field_513 % 128 + 31 / 32 > idx:
                sub_f71520db[arg2][idx + 2].field_0 = 0
                idx = idx + 1
                continue 
    sub_f71520db[arg2].field_768 = 0
    sub_f71520db[arg2].field_1024 = 0
    sub_f71520db[arg2].field_1280 = 0
    sub_f71520db[arg2].field_1536 = 0
    sub_f71520db[arg2].field_1792 = 0
    sub_f71520db[arg2].field_2048 = 0
    uint8(sub_f71520db[arg2].field_2304) = 0
    return sub_f71520db[arg2].field_1024
}
...
function sub_622f7b6b(?) payable {
    ...
    if not ('cd', 4).length:
        ...
        while idx < ('cd', 4).length:
            ...
            _198 = mem[64]
            mem[64] = mem[64] + 320
            mem[_198] = sub_f71520db[mem[(32 * idx) + 128]].field_0
            ...
            if bool(stor2[_197].field_0):
                ...
                if bool(stor2[_197].field_0):
                    if bool(stor2[_197].field_0) == uint255(stor2[_197].field_0) * 0.5 < 32:
                        revert with 0, 34
                    if Mask(256, -1, stor2[_197].field_0):
    ...
    if not var22003 - 1:
        ...
        while idx < ('cd', 4).length:
            ...
            _412 = mem[64]
            mem[64] = mem[64] + 320
            mem[_412] = sub_f71520db[mem[(32 * idx) + 128]].field_0
            ...
            if bool(stor2[_411].field_0):
                ...
                if bool(stor2[_411].field_0):
                    if bool(stor2[_411].field_0) == uint255(stor2[_411].field_0) * 0.5 < 32:
                        revert with 0, 34
                    if Mask(256, -1, stor2[_411].field_0):
    ...
    if not var26003 - 1:
        ...
        while idx < ('cd', 4).length:
            ...
            _639 = mem[64]
            mem[64] = mem[64] + 320
            mem[_639] = sub_f71520db[mem[(32 * idx) + 128]].field_0
            ...
            if bool(stor2[_638].field_0):
                ...
                if bool(stor2[_638].field_0):
                    if bool(stor2[_638].field_0) == uint255(stor2[_638].field_0) * 0.5 < 32:
                        revert with 0, 34
                    if Mask(256, -1, stor2[_638].field_0):
    ...
    if not var30003 - 1:
        ...
        while idx < ('cd', 4).length:
            ...
            _866 = mem[64]
            mem[64] = mem[64] + 320
            mem[_866] = sub_f71520db[mem[(32 * idx) + 128]].field_0
            ...
            if bool(stor2[_865].field_0):
                ...
                if bool(stor2[_865].field_0):
                    if bool(stor2[_865].field_0) == uint255(stor2[_865].field_0) * 0.5 < 32:
                        revert with 0, 34
                    if Mask(256, -1, stor2[_865].field_0):
    ...
    if not var34003 - 1:
        ...
        while idx < ('cd', 4).length:
            ...
            _1093 = mem[64]
            mem[64] = mem[64] + 320
            mem[_1093] = sub_f71520db[mem[(32 * idx) + 128]].field_0
            ...
            if bool(stor2[_1092].field_0):
                ...
                if bool(stor2[_1092].field_0):
                    if bool(stor2[_1092].field_0) == uint255(stor2[_1092].field_0) * 0.5 < 32:
                        revert with 0, 34
                    if Mask(256, -1, stor2[_1092].field_0):
    ...
    if not var38003 - 1:
        ...
        while idx < ('cd', 4).length:
            ...
            _1320 = mem[64]
            mem[64] = mem[64] + 320
            mem[_1320] = sub_f71520db[mem[(32 * idx) + 128]].field_0
            ...
            if bool(stor2[_1319].field_0):
                ...
                if bool(stor2[_1319].field_0):
                    if bool(stor2[_1319].field_0) == uint255(stor2[_1319].field_0) * 0.5 < 32:
                        revert with 0, 34
                    if Mask(256, -1, stor2[_1319].field_0):
    ...
    if not var42003 - 1:
        ...
        while idx < ('cd', 4).length:
            ...
            _1547 = mem[64]
            mem[64] = mem[64] + 320
            mem[_1547] = sub_f71520db[mem[(32 * idx) + 128]].field_0
            ...
            if bool(stor2[_1546].field_0):
                ...
                if bool(stor2[_1546].field_0):
                    if bool(stor2[_1546].field_0) == uint255(stor2[_1546].field_0) * 0.5 < 32:
                        revert with 0, 34
                    if Mask(256, -1, stor2[_1546].field_0):
    ...
    if not var46003 - 1:
        ...
        while idx < ('cd', 4).length:
            ...
            _1774 = mem[64]
            mem[64] = mem[64] + 320
            mem[_1774] = sub_f71520db[mem[(32 * idx) + 128]].field_0
            ...
            if bool(stor2[_1773].field_0):
                ...
                if bool(stor2[_1773].field_0):
                    if bool(stor2[_1773].field_0) == uint255(stor2[_1773].field_0) * 0.5 < 32:
                        revert with 0, 34
                    if Mask(256, -1, stor2[_1773].field_0):
    ...
    if var50003 - 1:
        ...
        while idx < ('cd', 4).length:
            ...
            _2001 = mem[64]
            mem[64] = mem[64] + 320
            mem[_2001] = sub_f71520db[mem[(32 * idx) + 128]].field_0
            ...
            if bool(stor2[_2000].field_0):
                ...
                if bool(stor2[_2000].field_0):
                    if bool(stor2[_2000].field_0) == uint255(stor2[_2000].field_0) * 0.5 < 32:
                        revert with 0, 34
                    if Mask(256, -1, stor2[_2000].field_0):
