...
function tokenURI(uint256 arg1) {
    ...
    if not s:
        ...
        if bool(stor11.length):
            ...
            if not bool(stor11.length):
                ...
                if ceil32(_395) <= _395:
                    _587 = mem[64]
                    mem[64] = _359 + stor11.length.field_1 + _395 + 32
                    mem[_359 + stor11.length.field_1 + _395 + 32] = 32
                    _631 = mem[_587]
                    ...
                    return 32, mem[_359 + stor11.length.field_1 + _395 + 64 len ceil32(_631) + 32]
                mem[_359 + stor11.length.field_1 + _395 + 32] = 0
                _600 = mem[64]
                mem[64] = _359 + stor11.length.field_1 + _395 + 32
                mem[_359 + stor11.length.field_1 + _395 + 32] = 32
                _639 = mem[_600]
        ...
        if not bool(stor11.length):
            ...
            if ceil32(_400) <= _400:
                _590 = mem[64]
                mem[64] = _359 + stor11.length.field_1 + _400 + 32
                mem[_359 + stor11.length.field_1 + _400 + 32] = 32
                _633 = mem[_590]
                ...
                return 32, mem[_359 + stor11.length.field_1 + _400 + 64 len ceil32(_633) + 32]
            mem[_359 + stor11.length.field_1 + _400 + 32] = 0
            _604 = mem[64]
            mem[64] = _359 + stor11.length.field_1 + _400 + 32
            mem[_359 + stor11.length.field_1 + _400 + 32] = 32
            _641 = mem[_604]
    ...
    if bool(stor11.length):
        ...
        if not bool(stor11.length):
            ...
            if ceil32(_396) <= _396:
                _593 = mem[64]
                mem[64] = _360 + stor11.length.field_1 + _396 + 32
                mem[_360 + stor11.length.field_1 + _396 + 32] = 32
                _635 = mem[_593]
                ...
                return 32, mem[_360 + stor11.length.field_1 + _396 + 64 len ceil32(_635) + 32]
            mem[_360 + stor11.length.field_1 + _396 + 32] = 0
            _608 = mem[64]
            mem[64] = _360 + stor11.length.field_1 + _396 + 32
            mem[_360 + stor11.length.field_1 + _396 + 32] = 32
            _643 = mem[_608]
    ...
    if not bool(stor11.length):
        ...
        if ceil32(_402) <= _402:
            _596 = mem[64]
            mem[64] = _360 + stor11.length.field_1 + _402 + 32
            mem[_360 + stor11.length.field_1 + _402 + 32] = 32
            _637 = mem[_596]
            ...
            return 32, mem[_360 + stor11.length.field_1 + _402 + 64 len ceil32(_637) + 32]
        mem[_360 + stor11.length.field_1 + _402 + 32] = 0
        _612 = mem[64]
        mem[64] = _360 + stor11.length.field_1 + _402 + 32
        mem[_360 + stor11.length.field_1 + _402 + 32] = 32
        _645 = mem[_612]
