...
uint8 decimals;
address sub_e09966a8Address; offset 8
...
function decreaseAllowance(address arg1, uint256 arg2) payable {
    ...
    if arg2 > allowance[address(msg.sender)][address(arg1)]:
        revert with 0, 
                    32,
                    37,
                    0x7741524332303a2064656372656173656420616c6c6f77616e63652062656c6f77207a6572,
                    mem[165 len 27],
                    mem[219 len 5]
    if not msg.sender:
...
function leave(uint256 arg1) payable {
    ...
    if not arg1:
        ...
        require totalSupply
        if not msg.sender:
            revert with 0, 32, 33, 0x6541524332303a206275726e2066726f6d20746865207a65726f20616464726573, mem[261 len 31]
        if arg1 > balanceOf[address(msg.sender)]:
            revert with 0, 32, 34, 0x6541524332303a206275726e20616d6f756e7420657863656564732062616c616e63, mem[226 len 30], mem[286 len 2]
