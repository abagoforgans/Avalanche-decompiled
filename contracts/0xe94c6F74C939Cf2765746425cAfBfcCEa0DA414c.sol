...
function sub_3df82e4e(?) payable {
    ...
    require ext_code.size(stor[sha3(mem[ceil32(ceil32(arg1.length)) + 97 len arg1.length + 32])])
    call stor[sha3(mem[ceil32(ceil32(arg1.length)) + 97 len arg1.length + 32])].deposit() with:
       value arg2 wei
         gas gas_remaining wei
    if not ext_call.success:
...
function sub_8c70c3bd(?) {
    ...
    mem[arg1.length + ceil32(ceil32(arg1.length)) + 97] = 3
    require ext_code.size(stor[sha3(mem[ceil32(ceil32(arg1.length)) + 97 len arg1.length + 32])])
    call stor[sha3(mem[ceil32(ceil32(arg1.length)) + 97 len arg1.length + 32])].withdraw(uint256 arg1) with:
         gas gas_remaining wei
        args arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_d05429d3(?) {
    ...
    if bool(stor4.length):
        ...
        require ext_code.size(0xce397cc150e146752e0bc448bbdf98f58b1d2273)
        delegate 0xce397cc150e146752e0bc448bbdf98f58b1d2273.compare(string arg1, string arg2) with:
             gas gas_remaining wei
            ...
            if stor4.length.field_1 % 128:
                if 31 >= stor4.length.field_1 % 128:
                    ...
                    while stor4.length.field_1 % 128 + 96 > idx:
                        ...
                        s = s + 1
                        continue 
        mem[ceil32(stor4.length.field_1 % 128) + 196] = stor4.length.field_1 % 128
        mem[ceil32(stor4.length.field_1 % 128) + 228 len ceil32(stor4.length.field_1 % 128)] = mem[128 len ceil32(stor4.length.field_1 % 128)]
        if ceil32(stor4.length.field_1 % 128) > stor4.length.field_1 % 128:
            mem[stor4.length.field_1 % 128 + ceil32(stor4.length.field_1 % 128) + 228] = 0
        mem[ceil32(stor4.length.field_1 % 128) + 164] = ceil32(stor4.length.field_1 % 128) + 96
        mem[(2 * ceil32(stor4.length.field_1 % 128)) + 228] = 5
        mem[(2 * ceil32(stor4.length.field_1 % 128)) + 260] = 'oasis'
        require ext_code.size(0xce397cc150e146752e0bc448bbdf98f58b1d2273)
        delegate 0xce397cc150e146752e0bc448bbdf98f58b1d2273.compare(string arg1, string arg2) with:
             gas gas_remaining wei
            args Array(len=stor4.length % 128, data=mem[128 len ceil32(stor4.length.field_1 % 128)], 5, 'oasis'), ceil32(stor4.length.field_1 % 128) + 96
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require delegate.return_data[0] == bool(delegate.return_data[0])
        if not delegate.return_data[0]:
            revert with 0, 'withdrawYuzuswapReward: only support yuzuswap'
        mem[ceil32(stor4.length.field_1 % 128) + ceil32(return_data.size) + 164] = 0, mem[ceil32(stor4.length.field_1 % 128) + ceil32(return_data.size) + 164 len 28]
        call 0xe63bbe4ef29bffc40fa6ae337ca2e532c9a30224.mem[ceil32(stor4.length.field_1 % 128) + ceil32(return_data.size) + 164 len 4] with:
             gas gas_remaining wei
    if not ext_call.success:
