...
address sub_082583f7Address;

function sub_082583f7(?) payable {
    return sub_082583f7Address
}
...
function withdraw(address arg1) payable {
    ...
    if not uint8(stor3.field_160):
        revert with 0, 'NOT SETTLED'
    if sub_082583f7Address != msg.sender:
        revert with 0, 'ONLY SALAD VENTURE'
    require ext_code.size(sub_c9835144Address)
    staticcall sub_c9835144Address.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    emit Withdraw(address(arg1), ext_call.return_data[0]);
}
