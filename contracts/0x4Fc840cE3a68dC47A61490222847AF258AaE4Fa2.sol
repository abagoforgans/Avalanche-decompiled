...
function migrate(address arg1) {
    ...
    require arg1 == arg1
    require msg.sender == stor0
    staticcall 0xac3f978714c613e768272c502a8912bc03dcf624.balanceOf(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    call 0xac3f978714c613e768272c502a8912bc03dcf624.transfer(address arg1, uint256 arg2) with:
         gas gas_remaining wei
...
function buyAll() {
    require msg.sender == stor0
    staticcall 0xb2ac04b71888e17aa2c5102cf3d0215467d74100.balanceOf(address arg1) with:
            gas gas_remaining wei
