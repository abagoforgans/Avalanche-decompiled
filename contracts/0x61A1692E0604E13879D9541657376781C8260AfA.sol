...
function sub_e24be30d(?) {
    ...
    if not stor14:
        ...
        call stor7.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args arg1, arg2, Array(len=stor5.length, data=mem[(4 * ceil32(return_data.size)) + 292 len 32 * stor5.length]), address(stor0.field_0), stor13
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(stor12)
        staticcall stor12.0x70a08231 with:
                        ...
                        while idx <= stor4:
                            ...
                            if not mem[_387 + 31 len 1]:
                                ...
                                if mem[_445]:
                                    ...
                                    call tokenList[idx].0xa9059cbb with:
                                         gas gas_remaining wei
                                        args address(stor0.field_0), _454
                                    mem[mem[64]] = ext_call.return_data[0]
                                    if not ext_call.success:
                                        revert with ext_call.return_data[0 len return_data.size]
                                    _478 = mem[64]
                                ...
                                if bool(bool(mem[_387 + 31 len 1] < 78)) or bool(bool(mem[_387 + 31 len 1] < 32)):
                                    ...
                                    if mem[_464]:
                                        ...
                                        call tokenList[idx].0xa9059cbb with:
                                             gas gas_remaining wei
                                            args address(stor0.field_0), _476
                                        mem[mem[64]] = ext_call.return_data[0]
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        _494 = mem[64]
                                    ...
                                    if mem[_561]:
                                        ...
                                        call tokenList[idx].0xa9059cbb with:
                                             gas gas_remaining wei
                                            args address(stor0.field_0), _564
                                        mem[mem[64]] = ext_call.return_data[0]
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        _574 = mem[64]
                ...
                while idx <= stor4:
                    ...
                    if not mem[_385 + 31 len 1]:
                        ...
                        if mem[_444]:
                            ...
                            call tokenList[idx].0xa9059cbb with:
                                 gas gas_remaining wei
                                args address(stor0.field_0), _453
                            mem[mem[64]] = ext_call.return_data[0]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            _477 = mem[64]
                        ...
                        if bool(bool(mem[_385 + 31 len 1] < 78)) or bool(bool(mem[_385 + 31 len 1] < 32)):
                            ...
                            if mem[_462]:
                                ...
                                call tokenList[idx].0xa9059cbb with:
                                     gas gas_remaining wei
                                    args address(stor0.field_0), _473
                                mem[mem[64]] = ext_call.return_data[0]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _493 = mem[64]
                            ...
                            if mem[_560]:
                                ...
                                call tokenList[idx].0xa9059cbb with:
                                     gas gas_remaining wei
                                    args address(stor0.field_0), _563
                                mem[mem[64]] = ext_call.return_data[0]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _573 = mem[64]
                ...
                if unknown_0xdad69c20(?????) == uint32(call.func_hash) >> 224:
                    ...
                    if uint32(call.func_hash) >> 224 != unknown_0xe24be30d(?????):
                        ...
                        if not stor14:
                            ...
                            call stor7.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                 gas gas_remaining wei
                                args arg1, arg2, Array(len=stor5.length, data=mem[(4 * ceil32(return_data.size)) + 324 len 32 * stor5.length]), address(stor0.field_0), stor13
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require ext_code.size(stor12)
                            staticcall stor12.0x70a08231 with:
