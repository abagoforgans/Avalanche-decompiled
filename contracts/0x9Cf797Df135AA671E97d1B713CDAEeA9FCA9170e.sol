...
function sub_b89698d0(?) payable {
    require calldata.size - 4 >= 64
    if not arg2:
        return 0
    if arg2 != sub_307d3b5b[arg1].field_256:
        if not sub_307d3b5b[arg1][2][arg2].field_0:
            return 0
    if not arg2:
        revert with 0, 'R-KDNE-01'
    if arg2 != sub_307d3b5b[arg1].field_256:
        if not sub_307d3b5b[arg1][2][arg2].field_0:
            revert with 0, 'R-KDNE-01'
    if not sub_307d3b5b[arg1][arg2][0][0].field_0:
            ...
            if sub_307d3b5b[arg1][arg2][0][1].field_0 != 0:
                if not sub_307d3b5b[arg1][arg2][0][0].field_0:
                    if not sub_307d3b5b[arg1][arg2][0][1].field_0:
                        if sub_307d3b5b[arg1][arg2][0][1].field_0 != 0:
                            return arg2, 
                                   sub_307d3b5b[arg1][2][arg2].field_0,
                                   sub_307d3b5b[arg1][2][arg2].field_256,
                                   sub_307d3b5b[arg1][2][arg2].field_512,
                                   bool(uint8(sub_307d3b5b[arg1][2][arg2].field_768)),
                                   0,
                                   0
                mem[0] = 1
                mem[32] = sha3(0, sha3(arg2, sha3(arg1, 101)))
                idx = stor[sha3(mem[0 len 64])]
                s = 0
                while idx:
                    if not sub_307d3b5b[arg1][arg2][idx][0].field_0:
                        if not sub_307d3b5b[arg1][arg2][idx][1].field_0:
                            mem[0] = 1
                            mem[32] = sha3(0, sha3(arg2, sha3(arg1, 101)))
                            if idx != sub_307d3b5b[arg1][arg2][0][1].field_0:
                                if s == -1:
                                    revert with 0, 17
                                idx = 0
                                s = s + 1
                                continue 
                    mem[0] = 1
                    mem[32] = sha3(idx, sha3(arg2, sha3(arg1, 101)))
                    if s == -1:
                        revert with 0, 17
                    idx = sub_307d3b5b[arg1][arg2][idx][1].field_0
                    s = s + 1
                    continue 
                return arg2, 
                       sub_307d3b5b[arg1][2][arg2].field_0,
        ...
        if not sub_307d3b5b[arg1][arg2][0][1].field_0:
            if sub_307d3b5b[arg1][arg2][0][1].field_0 != 0:
                return arg2, 
                       ...
                       sub_307d3b5b[arg1][2][arg2].field_512,
                       bool(uint8(sub_307d3b5b[arg1][2][arg2].field_768)),
                       sub_307d3b5b[arg1][arg2][0][0].field_0,
                       0
    mem[0] = 1
    mem[32] = sha3(0, sha3(arg2, sha3(arg1, 101)))
    idx = stor[sha3(mem[0 len 64])]
