        ...
        if not uint8(arg6):
            ...
            while idx < arg4.length:
                ...
                call stor4.mem[mem[64] len 4] with:
                   value arg1 wei
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len (32 * mem[96]) + _71 + -mem[64] + 160]
                if ext_call.success:
                    if eth.balance(this.address) >= arg1:
                        idx = idx + 1
                        continue 
        ...
        if stor2:
            if not arg4:
                ...
                if arg5:
                    ...
                    require ext_code.size(stor4)
                    call stor4.swapExactAVAXForTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
                       value arg1 wei
                         gas gas_remaining wei
            ...
            staticcall mem[(32 * arg2.length - 1) + 140 len 20].0x70a08231 with:
                    gas gas_remaining wei
                   args this.address
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            if not TEST_SELL_DIVISOR:
                revert with 0, 'SafeMath: division by zero'
            require ext_code.size(mem[(32 * arg2.length - 1) + 140 len 20])
            call mem[(32 * arg2.length - 1) + 140 len 20].approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args stor4, -1
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            ...
            require ext_code.size(stor4)
            if not stor2:
                call stor4.swapExactTokensForETHSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
