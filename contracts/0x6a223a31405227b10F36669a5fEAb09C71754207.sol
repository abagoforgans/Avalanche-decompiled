                                                    ...
                                                    if not balanceOf[this.address] * rewardsFee / 100:
                                                        ...
                                                        if not balanceOf[this.address]:
                                                            ...
                                                            if ceil32(mem[128]) <= mem[128]:
                                                                ...
                                                                call nodeRewardManagerAddress.createNode(address arg1, string arg2) with:
                                                                     gas gas_remaining wei
                                                                    args msg.sender, 64, mem[mem[64] + 68 len ceil32(_5580) + 32]
                                            else:
                                                ...
                                                if not balanceOf[this.address]:
                                                    ...
                                                    if not balanceOf[this.address] * rewardsFee / 100:
                                                        ...
                                                        if balanceOf[this.address]:
                                                            ...
                                                            call nodeRewardManagerAddress.createNode(address arg1, string arg2) with:
                                                                 gas gas_remaining wei
                                                                args msg.sender, Array(len=mem[128], data=mem[_3434 + (4 * ceil32(return_data.size)) + 452 len ceil32(mem[128])])
                                                        else:
                                                            _3331 = mem[64]
                                                            mem[64] = mem[64] + 64
                                                            mem[_3331] = 26
                                                        ...
                                                        if not balanceOf[this.address]:
                                                            ...
                                                            call nodeRewardManagerAddress.createNode(address arg1, string arg2) with:
                                                                 gas gas_remaining wei
                                                                args msg.sender, Array(len=mem[128], data=mem[_3379 + (4 * ceil32(return_data.size)) + 452 len ceil32(mem[128])])
                                                        else:
                                                            if balanceOf[this.address] and liquidityPoolFee > -1 / balanceOf[this.address]:
                                                                revert with 0, 17
                                                            if not balanceOf[this.address]:
