...
function claimJackpot() payable {
    ...
    if uint256(sub_803b0f8a[address(stor2)].field_1280) > sub_2915d5db:
        revert with 0, 'SafeMath: subtraction overflow'
    if sub_2915d5db - uint256(sub_803b0f8a[address(stor2)].field_1280) + uint256(sub_803b0f8a[address(stor2)].field_1024) < uint256(sub_803b0f8a[address(stor2)].field_1024):
        revert with 0, 'SafeMath: addition overflow'
    uint256(sub_803b0f8a[address(stor2)].field_1024) = sub_2915d5db - uint256(sub_803b0f8a[address(stor2)].field_1280) + uint256(sub_803b0f8a[address(stor2)].field_1024)
    idx = 0
    while idx < 5:
