...
function sub_8556aa67(?) {
    ...
    if arg1 and 3600 > -1 / arg1:
        revert with 0, 17
    if 3600 * arg1 > 0xaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa:
        revert with 0, 17
    sub_4e616cbc = 24 * 3600 * arg1
...
function sub_7d1f22db(?) {
    ...
    staticcall stor10[arg1].field_0.decimals() with:
...
function sub_7edb1f42(?) {
    ...
    staticcall stor6.decimals() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function withdraw(bool arg1) payable {
    ...
    if arg1 == 1:
        ...
        while idx < stor10.length:
            ...
            staticcall stor10[idx].field_0.balanceOf(address arg1) with:
                    gas gas_remaining wei
                   args this.address
            ...
            mem[mem[64] + 36] = _29
            require ext_code.size(stor10[idx].field_0)
            call stor10[idx].field_0.transfer(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args msg.sender, _29
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
...
function sub_0ba74b2f(?) {
    ...
    staticcall stor10[arg2].field_0.decimals() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if not ext_call.return_data[31 len 1]:
        ...
        if arg2 >= stor10.length:
            revert with 0, 50
        require ext_code.size(stor10[arg2].field_0)
        staticcall stor10[arg2].field_0.balanceOf(address arg1) with:
                gas gas_remaining wei
               args msg.sender
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if arg2 >= stor10.length:
            revert with 0, 50
        require ext_code.size(stor10[arg2].field_0)
        call stor10[arg2].field_0.transferFrom(address arg1, address arg2, uint256 arg3) with:
             gas gas_remaining wei
...
function sub_6373a35e(?) {
    ...
    if bool(arg2) != 1:
        ...
        if not ext_call.return_data[31 len 1]:
            ...
            staticcall stor8.decimals() with:
                    gas gas_remaining wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
