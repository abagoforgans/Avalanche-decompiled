...
function flashLoan(address arg1, address arg2, uint256 arg3, bytes arg4) payable {
    ...
    if arg3 > -1:
        revert with 'NH{q', 17
    if allowance[address(arg1)][address(this.address)] < arg3:
        revert with 0, 'ERC20FlashMint: allowance does not allow refund'
    if allowance[address(arg1)][address(this.address)] - arg3 < 0:
        revert with 'NH{q', 17
    if not arg1:
        revert with 0, 'ERC20: approve from the zero address'
    if not this.address:
        revert with 0, 'ERC20: approve to the zero address'
    allowance[address(arg1)][address(this.address)] -= arg3
    emit Approval((allowance[address(arg1)][address(this.address)] - arg3), arg1, this.address);
    if arg3 > -1:
        revert with 'NH{q', 17
    if not arg1:
