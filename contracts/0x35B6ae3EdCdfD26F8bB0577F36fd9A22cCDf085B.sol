            ...
            if not return_data.size:
                ...
                if balanceOf[address(msg.sender)] + (2 * ext_call.return_data[0]) < balanceOf[address(msg.sender)]:
                    revert with 0, 
                                'SafeMath: addition overflow',
                                mem[(2 * ceil32(return_data.size)) + 558 len (2 * ceil32(return_data.size)) - (2 * ceil32(return_data.size))]
            ('ge', ('add', ('stor', ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'balanceOf', 0))), ('mask_shl', 255, 0, 1, ('ext_call.return_data', 0, 32))), ('stor', ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'balanceOf', 0))))
            balanceOf[address(msg.sender)] += 2 * ext_call.return_data[0]
            emit Transfer((2 * ext_call.return_data[0]), 0, msg.sender);
}
