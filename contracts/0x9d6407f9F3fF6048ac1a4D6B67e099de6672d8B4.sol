...
function sub_b05dba96(?) payable {
    ...
    call stor3.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 0x459f82e7345b241435730dfebf40153e149918be, -1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    ...
    call stor4.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 0x39af1eb019750adc3ea89d80080079f64d5432db, -1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
...
function sub_ad760032(?) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    mem[128] = 0xb80323c7aa915cb960b19b5cca1d88a2132f7bd1
...
function sub_f5a85a10(?) payable {
    ...
    mem[ceil32(return_data.size) + 128] = 0xb80323c7aa915cb960b19b5cca1d88a2132f7bd1
    ...
    call stor1.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args _72, 992 * _68 / 1000, 160, msg.sender, block.timestamp + 60, mem[mem[64] + 164 len (32 * _74) + 32]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _84 = mem[64]
