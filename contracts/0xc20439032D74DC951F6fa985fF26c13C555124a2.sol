...
function sub_d550dda2(?) payable {
    ...
    require ext_code.size(0x5945dddd48e073c0da850bd1badd5cd2b5f2fd1c)
    delegate 0x5945dddd48e073c0da850bd1badd5cd2b5f2fd1c.isContract(address rg1) with:
...
function sub_35cdb1f4(?) payable {
    ...
    staticcall sub_09a351a5Address.0x4b341aed with:
            gas gas_remaining wei
           args address(arg1)
    ...
    if not sub_0efc1b9c:
        revert with 0, 18
    require ext_code.size(0x5945dddd48e073c0da850bd1badd5cd2b5f2fd1c)
    delegate 0x5945dddd48e073c0da850bd1badd5cd2b5f2fd1c.today() with:
         gas gas_remaining wei
        args 
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
