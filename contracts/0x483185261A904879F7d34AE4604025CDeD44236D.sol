    ...
    while idx < stor26.length:
        ...
        if bool(stor26[idx].field_0):
            ...
            if not bool(stor26[idx].field_0):
                ...
                _572 = sha3(mem[mem[64] len _567 + (uint255(uint256(stor26[idx].field_0)) * 0.5) + -mem[64] + 32])
                _573 = mem[64]
                mem[64] = mem[64] + 96
            ...
            if bool(stor[_1194].field_0):
                ...
                if bool(stor[_1194].field_0):
                    ...
                    if not Mask(256, -1, uint256(stor[_1194].field_0)):
                        ...
                        staticcall address(stor1[_1194]).0xb8527aef with:
                                gas gas_remaining wei
                        mem[mem[64]] = ext_call.return_data[0]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
        ...
        if bool(stor[_1197].field_0):
            ...
            if bool(stor[_1197].field_0):
                ...
                if not Mask(256, -1, uint256(stor[_1197].field_0)):
                    ...
                    staticcall address(stor1[_1197]).0xb8527aef with:
                            gas gas_remaining wei
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
            ...
            if bool(stor[_1194].field_0):
                ...
                if bool(stor[_1194].field_0):
                    ...
                    if not Mask(256, -1, uint256(stor[_1194].field_0)):
                        ...
                        mem[_1195 + 64] = stor2[_1194]
                        mem[mem[64] + 4] = arg1
                        staticcall address(stor1[_1194]).0x4491a7e4 with:
                                gas gas_remaining wei
                               args address(arg1)
                        mem[mem[64]] = ext_call.return_data[0]
                        if not ext_call.success:
        ...
        if bool(stor[_1197].field_0):
            ...
            if bool(stor[_1197].field_0):
                ...
                if not Mask(256, -1, uint256(stor[_1197].field_0)):
                    ...
                    mem[_1198 + 64] = stor2[_1197]
                    mem[mem[64] + 4] = arg1
                    staticcall address(stor1[_1197]).0x4491a7e4 with:
                            gas gas_remaining wei
                           args address(arg1)
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
            ...
            if bool(stor[_1194].field_0):
                ...
                if bool(stor[_1194].field_0):
                    ...
                    if not Mask(256, -1, uint256(stor[_1194].field_0)):
                        ...
                        mem[_1195 + 64] = stor2[_1194]
                        mem[mem[64] + 4] = arg1
                        staticcall address(stor1[_1194]).0x619a635e with:
                                gas gas_remaining wei
                               args address(arg1)
                        mem[mem[64]] = ext_call.return_data[0]
                        if not ext_call.success:
        ...
        if bool(stor[_1197].field_0):
            ...
            if bool(stor[_1197].field_0):
                ...
                if not Mask(256, -1, uint256(stor[_1197].field_0)):
                    ...
                    mem[_1198 + 64] = stor2[_1197]
                    mem[mem[64] + 4] = arg1
                    staticcall address(stor1[_1197]).0x619a635e with:
                            gas gas_remaining wei
                           args address(arg1)
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
