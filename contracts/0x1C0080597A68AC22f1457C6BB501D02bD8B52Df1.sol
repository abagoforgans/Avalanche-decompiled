...
function perform() payable {
    if uint8(stor4.field_168):
        ...
        if not stor8.length:
            ...
            mem[64] = ceil32(return_data.size) + 96
            require return_data.size >= 32
            _8 = mem[96 len 4], Mask(224, 0, stor5.field_32)
            require mem[96 len 4], Mask(224, 0, stor5.field_32) <= 4294967296
            require mem[96 len 4], Mask(224, 0, stor5.field_32) + 32 <= return_data.size
            require mem[mem[96 len 4], Mask(224, 0, stor5.field_32) + 96] <= 4294967296 and mem[96 len 4], Mask(224, 0, stor5.field_32) + (32 * mem[mem[96 len 4], Mask(224, 0, stor5.field_32) + 96]) + 32 <= return_data.size
            mem[ceil32(return_data.size) + 96] = mem[mem[96 len 4], Mask(224, 0, stor5.field_32) + 96]
            _13 = mem[_8 + 96]
            ...
            if uint8(stor4.field_168):
                if not uint8(stor4.field_176):
                    ...
                    if ext_call.return_data[0] > 0:
                        ...
                        mem[(32 * _13) + ceil32(return_data.size) + 164] = sub_94ace420 * multiplier
                        ...
                        mem[(32 * _13) + ceil32(return_data.size) + 292] = stor9.length
                        if not stor9.length:
                            require ext_code.size(routerContractAddress)
                            call routerContractAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                                 gas gas_remaining wei
                                args ext_call.return_data[0], sub_94ace420 * multiplier, 160, address(this.address), block.timestamp + 300, stor9.length
                        else:
                            mem[0] = 9
                            mem[(32 * _13) + ceil32(return_data.size) + 324] = address(stor9.field_0)
                            idx = (32 * _13) + ceil32(return_data.size) + 324
                            s = 0
                            while (32 * _13) + ceil32(return_data.size) + (32 * stor9.length) + 324 > idx + 32:
                                mem[idx + 32] = stor9[s].field_256
                                idx = idx + 32
                                s = s + 1
                                continue 
                            ...
                            call routerContractAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                                 gas gas_remaining wei
                                args ext_call.return_data[0], sub_94ace420 * multiplier, Array(len=stor9.length, data=mem[(32 * _13) + ceil32(return_data.size) + 324 len 32 * stor9.length]), address(this.address), block.timestamp + 300
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
            ...
            mem[64] = ceil32(return_data.size) + 96
            require return_data.size >= 32
            _109 = mem[96 len 4], Mask(224, 0, stor5.field_32)
            require mem[96 len 4], Mask(224, 0, stor5.field_32) <= 4294967296
            require mem[96 len 4], Mask(224, 0, stor5.field_32) + 32 <= return_data.size
            require mem[mem[96 len 4], Mask(224, 0, stor5.field_32) + 96] <= 4294967296 and mem[96 len 4], Mask(224, 0, stor5.field_32) + (32 * mem[mem[96 len 4], Mask(224, 0, stor5.field_32) + 96]) + 32 <= return_data.size
            mem[ceil32(return_data.size) + 96] = mem[mem[96 len 4], Mask(224, 0, stor5.field_32) + 96]
                ...
                if not uint8(stor4.field_176):
                    ...
                    if ext_call.return_data[0] > 0:
                        if uint8(stor4.field_160):
                            ...
                            mem[(32 * _116) + ceil32(return_data.size) + 164] = sub_94ace420 * multiplier
                            ...
                            mem[(32 * _116) + ceil32(return_data.size) + 292] = stor9.length
                            if not stor9.length:
                                require ext_code.size(routerContractAddress)
                                call routerContractAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                                     gas gas_remaining wei
                                ...
                                mem[0] = 9
                                mem[(32 * _116) + ceil32(return_data.size) + 324] = address(stor9.field_0)
                                idx = (32 * _116) + ceil32(return_data.size) + 324
                                s = 0
                                while (32 * _116) + ceil32(return_data.size) + (32 * stor9.length) + 324 > idx + 32:
                                    mem[idx + 32] = stor9[s].field_256
                                    idx = idx + 32
                                    s = s + 1
                                    continue 
                                ...
                                call routerContractAddress.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                                     gas gas_remaining wei
                                    args ext_call.return_data[0], sub_94ace420 * multiplier, Array(len=stor9.length, data=mem[(32 * _116) + ceil32(return_data.size) + 324 len 32 * stor9.length]), address(this.address), block.timestamp + 300
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                mem[(32 * _116) + ceil32(return_data.size) + 128 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                mem[64] = (32 * _116) + (2 * ceil32(return_data.size)) + 128
