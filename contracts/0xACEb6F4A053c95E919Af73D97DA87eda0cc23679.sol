...
#
#  - initialize(address arg1, string arg2, string arg3, uint256 arg4)
#  - initialize(address arg1)
#
const decimals = 18

const sub_beb4a5fb(?) = 0x546f6b656e506175736564000000000000000000000000000000000000000000
...
function burn(uint256 arg1) payable {
    ...
    staticcall settingsAddress.0xd69f4d49 with:
            gas gas_remaining wei
           args address(this.address), 0x546f6b656e506175736564000000000000000000000000000000000000000000
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0]:
        revert with 0, 'TOKEN_PAUSED'
...
function mint(address arg1, uint256 arg2) payable {
    ...
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).MINTER_ROLE() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    staticcall address(ext_call.return_data[0]).requireHasRole(bytes32 arg1, address arg2, string arg3) with:
            gas gas_remaining wei
           args ext_call.return_data[0], msg.sender, 96, 18, 1397050948, 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if totalSupply > !arg2:
        revert with 0, 17
