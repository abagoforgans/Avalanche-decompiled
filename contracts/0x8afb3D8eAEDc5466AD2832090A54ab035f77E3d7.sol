...
function getSupplied() {
    require ext_code.size(0x77000000000000000000000000835866d37afb8cb8f8334dccdaf66cf01832ff)
...
function getSuppliedView() {
    require ext_code.size(0x77000000000000000000000000835866d37afb8cb8f8334dccdaf66cf01832ff)
    staticcall 0x77000000000000000000000000835866d37afb8cb8f8334dccdaf66cf01832ff.getAccountSnapshot(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function getSafeSyncColFactor() {
    ...
    staticcall 0x486af39519b4dc9a7fccd318217352830e8ad9b4.markets(address rg1) with:
            gas gas_remaining wei
           args 0x77000000000000000000000000835866d37afb8cb8f8334dccdaf66cf01832ff
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function balanceOfPool() {
    ...
    require return_data.size >= 128
    require ext_code.size(0x77000000000000000000000000835866d37afb8cb8f8334dccdaf66cf01832ff)
    staticcall 0x77000000000000000000000000835866d37afb8cb8f8334dccdaf66cf01832ff.borrowBalanceStored(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function withdraw(address arg1) {
    ...
    if not return_data.size:
        ...
        if not transfer(address rg1, uint256 rg2), Mask(224, 0, stor7):
            revert with 0, 32, 42, 0x5d5361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
    else:
        ...
        if return_data.size:
            ...
            if not mem[292]:
                revert with 0, 
                            32,
                            42,
                            0x5d5361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
...
function withdrawForSwap(uint256 arg1) {
    ...
    if ext_call.return_data[0] > arg1:
        revert with 0, 'SafeMath: subtraction overflow'
    require ext_code.size(0x835866d37afb8cb8f8334dccdaf66cf01832ff)
    staticcall 0x835866d37afb8cb8f8334dccdaf66cf01832ff.getCash() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function deposit() {
    ...
    if ext_call.return_data[0]:
        if not ext_code.size(wantAddress):
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = approve(address rg1, uint256 rg2), 158786747426673340018340685, 0, 0
        mem[324 len 0] = 0
        call wantAddress.0xf01832ff with:
             gas gas_remaining wei
            args Mask(480, -256, approve(address rg1, uint256 rg2), 158786747426673340018340685, 0, 0) << 256, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address rg1, uint256 rg2), 158786747426673340018340685, 0, 0
            if not approve(address rg1, uint256 rg2), 158786747426673340018340685:
                revert with 0, 32, 42, 0x5d5361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
            if ext_call.return_data[0]:
                require ext_code.size(wantAddress)
                staticcall wantAddress.allowance(address rg1, address rg2) with:
                        gas gas_remaining wei
                       args this.address, 0x835866d37afb8cb8f8334dccdaf66cf01832ff
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                if ext_call.return_data[0]:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = 0, 0x835866d37afb8cb8f8334dccdaf66cf01832ff, ext_call.return_data[0 len 28]
            call wantAddress.0xf01832ff with:
                 gas gas_remaining wei
            ...
            if not return_data.size:
                if not ext_call.success:
                    revert with approve(address rg1, uint256 rg2), 158786747426673340018340685, 0, 0
                if not approve(address rg1, uint256 rg2), 158786747426673340018340685:
                    revert with 0, 32, 42, 0x5d5361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[534 len 22]
            else:
            ...
            require ext_code.size(0x835866d37afb8cb8f8334dccdaf66cf01832ff)
            call 0x00835866d37afb8cb8f8334dccdaf66cf01832ff.mint(uint256 rg1) with:
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 425 len 64] = 0, 0x835866d37afb8cb8f8334dccdaf66cf01832ff, ext_call.return_data[0 len 28]
                call wantAddress.0xf01832ff with:
                     gas gas_remaining wei
...
function withdrawAll() {
    ...
    if not ext_call.return_data[96]:
        ...
        if ext_call.return_data[0] >= (0 / 10^18) - ext_call.return_data[0]:
            ...
            mem[288] = 68
            mem[320 len 4] = transfer(address rg1, uint256 rg2)
            mem[388] = 32
            ...
            if not return_data.size:
                ...
                revert with 0, 32, 42, 0x5d5361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[562 len 22]
