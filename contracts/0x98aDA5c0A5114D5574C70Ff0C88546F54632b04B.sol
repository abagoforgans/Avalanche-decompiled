...
function sub_0455d56d(?) {
    ...
    require 0 < arg1.length
    require ext_code.size(mem[140 len 20])
    call mem[140 len 20].transferFrom(address arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
    ...
    call mem[140 len 20].approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 0xf491e7b69e4244ad4002bc14e878a34207e38c29, mem[(32 * arg1.length) + (32 * arg2.length) + ceil32(return_data.size) + 192]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    staticcall mem[(32 * arg1.length) + 172 len 20].balanceOf(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
