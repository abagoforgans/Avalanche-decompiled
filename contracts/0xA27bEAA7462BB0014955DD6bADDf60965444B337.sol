    ...
    if not arg2:
        if not arg2:
            ...
            if not arg2:
                if arg1 > -arg2 - 1:
                    revert with 'NH{q', 17
                if var83002 < arg1 + arg2:
                    if var89001 >= stor302.length:
                        revert with 'NH{q', 50
                    if var95003 >= arg2:
                        revert with 'NH{q', 50
                    mem[(32 * var97001) + 128] = var97003
                    if var99003 >= arg2:
                        revert with 'NH{q', 50
                    if var97004 != var97005:
                        mem[(32 * var101001) + (64 * arg2) + 192] = 0
                        if not ownerOf[var105001]:
                            revert with 0, 'ERC721: owner query for nonexistent token', mem[(98 * arg2) + 324 len 192 * arg2]
                        # nil
                    else:
                        mem[(32 * var101001) + (64 * arg2) + 192] = 1
                        if not ownerOf[var105001]:
                            revert with 0, 'ERC721: owner query for nonexistent token', mem[(98 * arg2) + 324 len 192 * arg2]
                        # nil
                else:
                ...
                if arg1 > -arg2 - 1:
                    revert with 'NH{q', 17
                if var84002 < arg1 + arg2:
                    if var90001 >= stor302.length:
                        revert with 'NH{q', 50
                    if var96003 >= arg2:
                        revert with 'NH{q', 50
                    mem[(32 * var98001) + 128] = var98003
                    if var100003 >= arg2:
                        revert with 'NH{q', 50
                    if var98004 != var98005:
                        mem[(32 * var102001) + (64 * arg2) + 192] = 0
                        if not ownerOf[var106001]:
                            revert with 0, 'ERC721: owner query for nonexistent token', mem[(98 * arg2) + 324 len 192 * arg2]
                        # nil
                    else:
                        mem[(32 * var102001) + (64 * arg2) + 192] = 1
                        if not ownerOf[var106001]:
                            revert with 0, 'ERC721: owner query for nonexistent token', mem[(98 * arg2) + 324 len 192 * arg2]
                        # nil
                else:
            ...
            if not arg2:
                ...
                if arg1 > -arg2 - 1:
                    revert with 'NH{q', 17
                if var85002 < arg1 + arg2:
                    if var91001 >= stor302.length:
                        revert with 'NH{q', 50
                    if var97003 >= arg2:
                        revert with 'NH{q', 50
                    mem[(32 * var99001) + 128] = var99003
                    if var101003 >= arg2:
                        revert with 'NH{q', 50
                    if var99004 != var99005:
                        mem[(32 * var103001) + (64 * arg2) + 192] = 0
                        if not ownerOf[var107001]:
                            revert with 0, 'ERC721: owner query for nonexistent token', mem[(98 * arg2) + 324 len 192 * arg2]
                        # nil
                    else:
                        mem[(32 * var103001) + (64 * arg2) + 192] = 1
                        if not ownerOf[var107001]:
                            revert with 0, 'ERC721: owner query for nonexistent token', mem[(98 * arg2) + 324 len 192 * arg2]
                        # nil
                else:
        ...
        if not arg2:
            ...
            if not arg2:
                ...
                if arg1 > -arg2 - 1:
                    revert with 'NH{q', 17
                if var86002 < arg1 + arg2:
                    if var92001 >= stor302.length:
                        revert with 'NH{q', 50
                    if var98003 >= arg2:
                        revert with 'NH{q', 50
                    mem[(32 * var100001) + 128] = var100003
                    if var102003 >= arg2:
                        revert with 'NH{q', 50
                    if var100004 != var100005:
                        mem[(32 * var104001) + (64 * arg2) + 192] = 0
                        if not ownerOf[var108001]:
                            revert with 0, 'ERC721: owner query for nonexistent token', mem[(98 * arg2) + 324 len 192 * arg2]
                        # nil
                    else:
                        mem[(32 * var104001) + (64 * arg2) + 192] = 1
                        if not ownerOf[var108001]:
                            revert with 0, 'ERC721: owner query for nonexistent token', mem[(98 * arg2) + 324 len 192 * arg2]
                        # nil
                else:
