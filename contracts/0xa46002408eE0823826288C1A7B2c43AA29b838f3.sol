...
const stakedBalance = ext_call.return_data[0]

const curve = 0x58e57ca18b7a47112b877e31929798cd3d703b0f

const delegatedAssets = 0

const gauge = 0x445fe580ef8d70ff569ab36e80c647af338db351
...
function estimatedTotalAssets() payable {
    require ext_code.size(0x445fe580ef8d70ff569ab36e80c647af338db351)
    staticcall 0x445fe580ef8d70ff569ab36e80c647af338db351.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function setOptimal(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    if strategistAddress != msg.sender:
        require ext_code.size(vaultAddress)
        staticcall vaultAddress.governance() with:
        ...
        if ext_call.return_data[12 len 20] != msg.sender:
            revert with 0, '!authorized'
    if not arg1:
        targetTokenAddress = 0xd586e7f844cea2f87f50152665bcbc2c279d8d70
        optimal = 0
    else:
        if 1 == arg1:
            targetTokenAddress = 0xa7d7079b0fead91f3e65f86e8915cb59c1a4c664
            optimal = 1
        else:
            if 2 == arg1:
                targetTokenAddress = 0xc7198437980c041c805a1edcba50c1ce5db95118
                optimal = 2
            else:
                if 3 == arg1:
                    targetTokenAddress = 0x50b7545627a5162f82a992c33b87adc75187b218
                    optimal = 3
                else:
                    if arg1 != 4:
                        revert with 0, 'incorrect token'
                    targetTokenAddress = 0x49d5c2bdffac6ce2bfdb6640f4f80f226bc10bab
                    optimal = 4
}
...
function tend() payable {
    ...
    if not emergencyExit:
        ...
        if ext_call.return_data[0]:
            require ext_code.size(0x445fe580ef8d70ff569ab36e80c647af338db351)
            call 0x445fe580ef8d70ff569ab36e80c647af338db351.deposit(uint256 arg1) with:
                 gas gas_remaining wei
...
function migrate(address arg1) payable {
    ...
    if ext_call.return_data[0]:
        require ext_code.size(0x445fe580ef8d70ff569ab36e80c647af338db351)
        call 0x445fe580ef8d70ff569ab36e80c647af338db351.0x2e1a7d4d with:
             gas gas_remaining wei
            args ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
