...
function sub_1c5598bf(?) payable {
    require calldata.size - 4 >= 96
    require arg3 == uint32(arg3)
    if arg1 >= stor1.length:
        revert with 0, 50
    if uint32(arg3) >= stor1[arg1].field_256:
        revert with 0, 50
    if stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_1024 != 1:
        revert with 0, 'This contract was paused!'
    if arg1 >= stor1.length:
        revert with 0, 50
    if uint32(arg3) >= stor1[arg1].field_256:
        revert with 0, 50
    if not stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_1032:
        revert with 0, 'Not set reward maker address!'
    require ext_code.size(stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_1792)
    staticcall stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_1792.0x313ce567 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[31 len 1]
    require ext_code.size(stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_1280)
    staticcall stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_1280.getAmount(address arg1, uint256 arg2, uint256 arg3) with:
            gas gas_remaining wei
           args msg.sender, arg2, uint8(ext_call.return_data[0])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 64
    if arg2 < ext_call.return_data[32]:
        revert with 0, 17
    require ext_code.size(stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_1792)
    call stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_1792.0x23b872dd with:
         gas gas_remaining wei
        args msg.sender, stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_1024, arg2 - ext_call.return_data[32]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    require ext_code.size(stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_1280)
    call stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_1280.withdraw(address arg1) with:
         gas gas_remaining wei
        args stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_1536
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_1280)
    call stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_1280.0x7812c10c with:
         gas gas_remaining wei
        args msg.sender, ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    if not stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_3072:
        require ext_code.size(stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_256)
        call stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_256.0xa9059cbb with:
             gas gas_remaining wei
            args msg.sender, ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        stor[(4 * arg1) + ('name', 'stor1', 1) + 3][msg.sender][stor[(4 * arg1) + ('name', 'stor1', 1) + 3][msg.sender].field_0].field_768 = uint32(arg3)
        ...
        stor[(4 * arg1) + ('name', 'stor1', 1) + 3][msg.sender][stor[(4 * arg1) + ('name', 'stor1', 1) + 3][msg.sender].field_0].field_1536 = stor[sha3((4 * arg1) + ('name', 'stor1', 1) + 1) + (13 * uint32(arg3))].field_3072
        if stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_2304 == -1:
            revert with 0, 17
        stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_2304++
        if stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_2048 > !arg2:
            revert with 0, 17
        stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_2048 += arg2
        if stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_2560 > !ext_call.return_data[0]:
            revert with 0, 17
        stor[(13 * uint32(arg3)) + sha3((4 * arg1) + ('name', 'stor1', 1) + 1)].field_2560 += ext_call.return_data[0]
    emit 0x909a6c8e: arg1, arg3 << 224, arg2, msg.sender, block.timestamp
    return 1
}
