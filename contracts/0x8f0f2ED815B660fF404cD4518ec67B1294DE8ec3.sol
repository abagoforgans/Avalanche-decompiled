...
function executeProposal(bytes32 arg1, bytes arg2) payable {
    ...
    if stor4[stor1[arg1]]:
        ...
        call _resourceIDToTokenContract[arg1].bridgeMint(address arg1, uint256 arg2) with:
...
function deposit(bytes32 arg1, uint8 arg2, uint64 arg3, address arg4, bytes arg5) payable {
    ...
    if stor4[stor1[arg1]]:
        mem[cd[228] + 132] = arg4
        mem[cd[228] + 164] = this.address
        mem[cd[228] + 196] = cd[196]
        require ext_code.size(_resourceIDToTokenContract[arg1])
        call _resourceIDToTokenContract[arg1].0x23b872dd with:
             gas gas_remaining wei
            args address(arg4), address(this.address), cd[196]
        mem[cd[228] + 128] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
        require ext_code.size(_resourceIDToTokenContract[arg1])
        call _resourceIDToTokenContract[arg1].burn(uint256 arg1) with:
             gas gas_remaining wei
            args cd[196]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[cd[228] + ceil32(return_data.size) + 128] = _resourceIDToTokenContract[arg1]
        mem[cd[228] + ceil32(return_data.size) + 160] = uint8(cd[228])
        mem[cd[228] + ceil32(return_data.size) + 192] = arg2
        mem[cd[228] + ceil32(return_data.size) + 224] = arg1
        mem[cd[228] + ceil32(return_data.size) + 256] = 96
        mem[cd[228] + ceil32(return_data.size) + 288] = arg4
        mem[cd[228] + ceil32(return_data.size) + 320] = cd[196]
    else:
        mem[cd[228] + 164] = arg4
