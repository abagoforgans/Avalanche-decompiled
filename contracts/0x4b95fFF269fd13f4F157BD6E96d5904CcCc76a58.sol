                    ...
                    if not (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18:
                        ...
                        if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[mem[64] + floor32(mem[_437])] = mem[_437 + floor32(mem[_437]) + -(mem[_437] % 32) + 64 len mem[_437] % 32] or Mask(8 * -(mem[_437] % 32) + 32, -(8 * -(mem[_437] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_437])])
                            call msg.sender.mem[mem[64] len 4] with:
                               value (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 wei
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _439 + _437 + -mem[64] + 28]
                            if return_data.size:
                                _688 = mem[64]
                                mem[64] = mem[64] + ceil32(return_data.size) + 1
                                mem[_688] = return_data.size
                                mem[_688 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                        ...
                        if not (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18:
                            ...
                            if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                                ...
                                while s >= 32:
                                    ...
                                    s = s - 32
                                    continue 
                                mem[mem[64] + floor32(mem[_465])] = mem[_465 + floor32(mem[_465]) + -(mem[_465] % 32) + 64 len mem[_465] % 32] or Mask(8 * -(mem[_465] % 32) + 32, -(8 * -(mem[_465] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_465])])
                                call msg.sender.mem[mem[64] len 4] with:
                                   value (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 wei
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4 len _467 + _465 + -mem[64] + 28]
                                if return_data.size:
                                    _674 = mem[64]
                                    mem[64] = mem[64] + ceil32(return_data.size) + 1
                        ...
                        if not 0 / 10^(-uint8(ext_call.return_data[0]) + 18):
                            ...
                            if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                                ...
                                while s >= 32:
                                    ...
                                    s = s - 32
                                    continue 
                                mem[mem[64] + floor32(mem[_445])] = mem[_445 + floor32(mem[_445]) + -(mem[_445] % 32) + 64 len mem[_445] % 32] or Mask(8 * -(mem[_445] % 32) + 32, -(8 * -(mem[_445] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_445])])
                                call sub_8ef4403c[idx].mem[mem[64] len 4] with:
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4 len _448 + _444 + -mem[64] + 96]
                                if not return_data.size:
                                    if not ext_call.success:
                                        revert with 0, '!safeTransfer'
                                    if mem[96]:
                                    ...
                                    _681 = mem[64]
                                    mem[64] = mem[64] + ceil32(return_data.size) + 1
                                    mem[_681] = return_data.size
                                    mem[_681 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                    if not ext_call.success:
                                        revert with 0, '!safeTransfer'
                                    if return_data.size:
                                        require return_data.size >= 32
                        ...
                        if (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 / 10^(-uint8(ext_call.return_data[0]) + 18):
                            if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                                ...
                                while s >= 32:
                                    ...
                                    s = s - 32
                                    continue 
                                mem[mem[64] + floor32(mem[_477])] = mem[_477 + floor32(mem[_477]) + -(mem[_477] % 32) + 64 len mem[_477] % 32] or Mask(8 * -(mem[_477] % 32) + 32, -(8 * -(mem[_477] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_477])])
                                call msg.sender.mem[mem[64] len 4] with:
                                   value (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 / 10^(-uint8(ext_call.return_data[0]) + 18) wei
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4 len _479 + _477 + -mem[64] + 28]
                                if return_data.size:
                                    _678 = mem[64]
                                    mem[64] = mem[64] + ceil32(return_data.size) + 1
                                    mem[_678] = return_data.size
                                    mem[_678 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                if not ext_call.success:
                                    revert with 0, '!safeTransferETH'
                            else:
                                _472 = mem[64]
                                ...
                                while s >= 32:
                                    ...
                                    s = s - 32
                                    continue 
                                mem[mem[64] + floor32(mem[_473])] = mem[_473 + floor32(mem[_473]) + -(mem[_473] % 32) + 64 len mem[_473] % 32] or Mask(8 * -(mem[_473] % 32) + 32, -(8 * -(mem[_473] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_473])])
                                call sub_8ef4403c[idx].mem[mem[64] len 4] with:
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4 len _476 + _472 + -mem[64] + 96]
                                if not return_data.size:
                                    if not ext_call.success:
                                        revert with 0, '!safeTransfer'
                                    if mem[96]:
...
function unstake(uint256 arg1) payable {
                ...
                if (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18:
                    if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                        ...
                        while s >= 32:
                            ...
                            s = s - 32
                            continue 
                        mem[mem[64] + floor32(mem[_585])] = mem[_585 + floor32(mem[_585]) + -(mem[_585] % 32) + 64 len mem[_585] % 32] or Mask(8 * -(mem[_585] % 32) + 32, -(8 * -(mem[_585] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_585])])
                        call msg.sender.mem[mem[64] len 4] with:
                           value (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 wei
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _587 + _585 + -mem[64] + 28]
                        if return_data.size:
                            _836 = mem[64]
                            mem[64] = mem[64] + ceil32(return_data.size) + 1
                        ...
                        while s >= 32:
                            ...
                            s = s - 32
                            continue 
                        mem[mem[64] + floor32(mem[_581])] = mem[_581 + floor32(mem[_581]) + -(mem[_581] % 32) + 64 len mem[_581] % 32] or Mask(8 * -(mem[_581] % 32) + 32, -(8 * -(mem[_581] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_581])])
                        call sub_8ef4403c[idx].mem[mem[64] len 4] with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _584 + _580 + -mem[64] + 96]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0, '!safeTransfer'
                            if mem[96]:
                    ...
                    if not (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18:
                        ...
                        if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[mem[64] + floor32(mem[_609])] = mem[_609 + floor32(mem[_609]) + -(mem[_609] % 32) + 64 len mem[_609] % 32] or Mask(8 * -(mem[_609] % 32) + 32, -(8 * -(mem[_609] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_609])])
                            call sub_8ef4403c[idx].mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _612 + _608 + -mem[64] + 96]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, '!safeTransfer'
                                if mem[96]:
                                ...
                                _821 = mem[64]
                                mem[64] = mem[64] + ceil32(return_data.size) + 1
                                mem[_821] = return_data.size
                                mem[_821 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                if not ext_call.success:
                                    revert with 0, '!safeTransfer'
                                if return_data.size:
                                    require return_data.size >= 32
                    ...
                    if not 0 / 10^(-uint8(ext_call.return_data[0]) + 18):
                        ...
                        if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[mem[64] + floor32(mem[_593])] = mem[_593 + floor32(mem[_593]) + -(mem[_593] % 32) + 64 len mem[_593] % 32] or Mask(8 * -(mem[_593] % 32) + 32, -(8 * -(mem[_593] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_593])])
                            call sub_8ef4403c[idx].mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _596 + _592 + -mem[64] + 96]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, '!safeTransfer'
                                if mem[96]:
                                ...
                                _829 = mem[64]
                                mem[64] = mem[64] + ceil32(return_data.size) + 1
                                mem[_829] = return_data.size
                                mem[_829 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                if not ext_call.success:
                                    revert with 0, '!safeTransfer'
                                if return_data.size:
                                    require return_data.size >= 32
                    ...
                    if (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 / 10^(-uint8(ext_call.return_data[0]) + 18):
                        if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[mem[64] + floor32(mem[_621])] = mem[_621 + floor32(mem[_621]) + -(mem[_621] % 32) + 64 len mem[_621] % 32] or Mask(8 * -(mem[_621] % 32) + 32, -(8 * -(mem[_621] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_621])])
                            call sub_8ef4403c[idx].mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _624 + _620 + -mem[64] + 96]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, '!safeTransfer'
                                if mem[96]:
                                ...
                                _825 = mem[64]
                                mem[64] = mem[64] + ceil32(return_data.size) + 1
                                mem[_825] = return_data.size
                                mem[_825 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                if not ext_call.success:
                                    revert with 0, '!safeTransfer'
                                if return_data.size:
                                    require return_data.size >= 32
    ...
    if arg1:
        if arg1 >= stakes[msg.sender]:
            ...
            _1004 = mem[_1001]
            mem[mem[64] len floor32(mem[_1001])] = mem[_1001 + 32 len floor32(mem[_1001])]
            mem[mem[64] + floor32(mem[_1001]) + -(mem[_1001] % 32) + 32 len mem[_1001] % 32] = mem[_1001 + floor32(mem[_1001]) + -(mem[_1001] % 32) + 64 len mem[_1001] % 32]
            call stakeTokenAddress with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len _1004 + _1000 + -mem[64] + 96]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, '!safeTransfer'
                if mem[96]:
