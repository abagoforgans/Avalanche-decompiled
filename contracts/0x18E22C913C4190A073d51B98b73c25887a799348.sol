...
function payoutForERC20(address arg1) payable {
    ...
    require ext_call.return_data[0] == ext_call.return_data[0]
    require arg1
    mem[(7 * ceil32(return_data.size)) + 100] = stor4
    ...
    mem[0] = arg1
    mem[32] = 6
    mem[mem[64] + 4] = stor6[address(arg1)]
    mem[mem[64] + 36] = _110
    require ext_code.size(arg1)
    call arg1.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args stor6[address(arg1)], _110
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _114 = mem[64]
    ...
    staticcall stor6[address(arg1)].bondPrice() with:
            gas gas_remaining wei
    mem[mem[64]] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(stor6[address(arg1)])
    staticcall stor6[address(arg1)].bondInfo(address arg1) with:
            gas gas_remaining wei
           args msg.sender
    ...
    require ext_code.size(stor6[address(arg1)])
    call stor6[address(arg1)].deposit(uint256 arg1, uint256 arg2, address arg3) with:
         gas gas_remaining wei
...
function mintWithLP(address arg1, uint256 arg2) payable {
    ...
    staticcall stor5[address(arg1)].getReserves() with:
            gas gas_remaining wei
    ...
    require ext_code.size(stor5[address(arg1)])
    staticcall stor5[address(arg1)].token0() with:
            gas gas_remaining wei
    ...
    require ext_code.size(stor5[address(arg1)])
    staticcall stor5[address(arg1)].token1() with:
            gas gas_remaining wei
    ...
    if address(ext_call.return_data[0]) != arg1:
        ...
        if not 2 * Mask(112, 0, ext_call.return_data[0]) + ((ext_call.return_data[0] / 2 * ext_call.return_data[0] / 2) + (Mask(112, 0, ext_call.return_data[0]) * ext_call.return_data[0]) / 2 * Mask(112, 0, ext_call.return_data[0]) + (ext_call.return_data[0] / 2)):
            revert with 'NH{q', 18
        require arg1
        mem[(11 * ceil32(return_data.size)) + 100] = stor4
        ...
        call stor2.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args stor4, ((ext_call.return_data[0] / 2 * ext_call.return_data[0] / 2) + (Mask(112, 0, ext_call.return_data[0]) * ext_call.return_data[0]) / 2 * Mask(112, 0, ext_call.return_data[0]) + (ext_call.return_data[0] / 2) * (ext_call.return_data[0] / 2 * ext_call.return_data[0] / 2) + (Mask(112, 0, ext_call.return_data[0]) * ext_call.return_data[0]) / 2 * Mask(112, 0, ext_call.return_data[0]) + (ext_call.return_data[0] / 2)) + (Mask(112, 0, ext_call.return_data[0]) * ext_call.return_data[0]) / 2 * Mask(112, 0, ext_call.return_data[0]) + ((ext_call.return_data[0] / 2 * ext_call.return_data[0] / 2) + (Mask(112, 0, ext_call.return_data[0]) * ext_call.return_data[0]) / 2 * Mask(112, 0, ext_call.return_data[0]) + (ext_call.return_data[0] / 2))
        ...
        mem[mem[64] + 4] = this.address
        require ext_code.size(stor5[address(arg1)])
        staticcall stor5[address(arg1)].0x70a08231 with:
                gas gas_remaining wei
               args address(this.address)
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
        ...
        mem[0] = stor5[address(arg1)]
        mem[32] = 6
        mem[mem[64] + 4] = stor6[stor5[address(arg1)]]
        mem[mem[64] + 36] = _260
        require ext_code.size(stor5[address(arg1)])
        call stor5[address(arg1)].approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args stor6[stor5[address(arg1)]], _260
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _272 = mem[64]
        ...
        require ext_code.size(stor6[stor5[address(arg1)]])
        staticcall stor6[stor5[address(arg1)]].bondPrice() with:
                gas gas_remaining wei
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require ext_code.size(stor6[stor5[address(arg1)]])
        staticcall stor6[stor5[address(arg1)]].bondInfo(address arg1) with:
                gas gas_remaining wei
               args msg.sender
        mem[mem[64] len 128] = ext_call.return_data[0 len 128]
        if not ext_call.success:
        ...
        mem[mem[64] + 68] = msg.sender
        require ext_code.size(stor6[stor5[address(arg1)]])
        call stor6[stor5[address(arg1)]].deposit(uint256 arg1, uint256 arg2, address arg3) with:
             gas gas_remaining wei
        ...
        if ext_call.return_data[12 len 20] == stor2:
            ...
            call stor2.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args stor4, ((ext_call.return_data[0] / 2 * ext_call.return_data[0] / 2) + (Mask(112, 0, ext_call.return_data[32]) * ext_call.return_data[0]) / 2 * Mask(112, 0, ext_call.return_data[32]) + (ext_call.return_data[0] / 2) * (ext_call.return_data[0] / 2 * ext_call.return_data[0] / 2) + (Mask(112, 0, ext_call.return_data[32]) * ext_call.return_data[0]) / 2 * Mask(112, 0, ext_call.return_data[32]) + (ext_call.return_data[0] / 2)) + (Mask(112, 0, ext_call.return_data[32]) * ext_call.return_data[0]) / 2 * Mask(112, 0, ext_call.return_data[32]) + ((ext_call.return_data[0] / 2 * ext_call.return_data[0] / 2) + (Mask(112, 0, ext_call.return_data[32]) * ext_call.return_data[0]) / 2 * Mask(112, 0, ext_call.return_data[32]) + (ext_call.return_data[0] / 2))
            mem[(11 * ceil32(return_data.size)) + 96] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            ...
            call stor5[address(arg1)].approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args stor6[stor5[address(arg1)]], _262
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _274 = mem[64]
            ...
            call stor5[address(arg1)].approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args stor6[stor5[address(arg1)]], _261
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _273 = mem[64]
