...
function totalShares() payable {
    require ext_code.size(address(stor9))
    staticcall address(stor9).sharesTotal() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function getBuyBackRate() payable {
    require ext_code.size(address(stor9))
    staticcall address(stor9).buyBackRate() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function getPerformanceFee() payable {
    require ext_code.size(address(stor9))
    staticcall address(stor9).controllerFee() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function totalStakedWantTokens() payable {
    require ext_code.size(address(stor9))
    staticcall address(stor9).wantLockedTotal() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function getEntranceFee() payable {
    require ext_code.size(address(stor9))
    staticcall address(stor9).entranceFeeFactor() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(stor9))
    staticcall address(stor9).entranceFeeFactorMax() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function getWithdrawFee() payable {
    require ext_code.size(address(stor9))
    staticcall address(stor9).withdrawFeeFactor() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(stor9))
    staticcall address(stor9).withdrawFeeFactorMax() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function deposit(uint256 arg1) payable {
    ...
    if arg1:
        ...
        if not return_data.size:
            ...
            if not ext_code.size(stor8):
                revert with 0, 'Address: call to non-contract'
            mem[456 len 64] = 0, address(stor9), Mask(224, 32, arg1 + ext_call.return_data[0]) >> 32
            call stor8 with:
               funct uint32(stor9)
                 gas gas_remaining wei
                args arg1 + ext_call.return_data[0], mem[392 len 24], 0, mem[520 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), arg1
                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
            ...
            require ext_code.size(address(stor9))
            call address(stor9).deposit(address rg1, uint256 rg2) with:
                 gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if not ext_code.size(stor8):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 457 len 64] = 0, address(stor9), Mask(224, 32, arg1 + ext_call.return_data[0]) >> 32
                mem[ceil32(return_data.size) + 549 len 4] = 0
                call stor8 with:
                   funct uint32(stor9)
                     gas gas_remaining wei
                    args arg1 + ext_call.return_data[0], mem[ceil32(return_data.size) + 393 len 28], mem[ceil32(return_data.size) + 521 len 4]
                if not return_data.size:
                    if not ext_call.success:
                        revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), arg1
                    if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
                ...
                if ext_call.return_data[0] + balanceOf[address(msg.sender)] < balanceOf[address(msg.sender)]:
                    revert with 0, 'SafeMath: addition overflow'
        ('ge', ('add', ('ext_call.return_data', 0, 32), ('stor', ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'balanceOf', 2)))), ('stor', ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'balanceOf', 2))))
    ...
    if not userInfo[msg.sender]:
        ...
        if arg1 <= 0 / ext_call.return_data[0]:
            if not arg1:
                ...
                require ext_code.size(address(stor9))
                call address(stor9).withdraw(address rg1, uint256 rg2) with:
                     gas gas_remaining wei
                    args msg.sender, arg1
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
