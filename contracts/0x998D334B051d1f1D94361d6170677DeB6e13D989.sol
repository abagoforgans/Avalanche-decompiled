...
const NATIVE = 0xfe992e3ab19efecdcaaf898455504669e9e4d0d9
...
function getMultiplier(uint256 arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require ext_code.size(0xfe992e3ab19efecdcaaf898455504669e9e4d0d9)
    staticcall 0xfe992e3ab19efecdcaaf898455504669e9e4d0d9.0x18160ddd with:
...
function add(uint256 arg1, address arg2, address arg3) payable {
    ...
    if block.number > 4905664:
        poolInfo[poolInfo.length].field_512 = block.number
    else:
        poolInfo[poolInfo.length].field_512 = 4905664
...
function inCaseTokensGetStuck(address arg1, uint256 arg2) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 == 0xfe992e3ab19efecdcaaf898455504669e9e4d0d9:
        revert with 0, '!safe'
                ...
                if block.number - poolInfo[arg1].field_512 > 0:
                    if not block.number - poolInfo[arg1].field_512:
                        ...
                        if not 0 / totalAllocPoint:
                            require ext_code.size(0xfe992e3ab19efecdcaaf898455504669e9e4d0d9)
                            call 0xfe992e3ab19efecdcaaf898455504669e9e4d0d9.0x40c10f19 with:
                                 gas gas_remaining wei
                                args owner, 0
                        else:
