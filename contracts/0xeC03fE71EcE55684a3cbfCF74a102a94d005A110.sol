...
function aggregate(address arg1, bytes[] arg2) payable {
    ...
    while idx < (32 * arg1.length) + arg1 + 36:
        ...
        mem[_83] = cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)]
        require arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)] + 68 <= calldata.size
        mem[_83 + 32 len cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)]] = call.data[arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 68 len cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)]]
        mem[_83 + cd[(arg1 + cd[idx] + cd[(arg1 + cd[idx] + 68)] + 36)] + 32] = 0
        mem[_56 + 32] = _83
        mem[s] = _56
        s = s + 32
        idx = idx + 32
