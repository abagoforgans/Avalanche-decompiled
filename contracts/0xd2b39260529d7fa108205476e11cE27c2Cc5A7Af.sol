...
#
const name = 'BOOFI Printer', 0

const decimals = 6

const symbol = 'BOOFIP', 0
...
function setFees(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint256 arg5, uint256 arg6) {
    ...
    if arg1 + arg2 + arg3 > -arg4 - 1:
        revert with 'NH{q', 17
    if arg1 + arg2 + arg3 + arg4 > -arg6 - 1:
        revert with 'NH{q', 17
    multipliedFee = arg1 + arg2 + arg3 + arg4 + arg6
    uint256(stor21.field_0) = arg5
    require multipliedFee < Mask(254, 0, stor21.field_2)
}
