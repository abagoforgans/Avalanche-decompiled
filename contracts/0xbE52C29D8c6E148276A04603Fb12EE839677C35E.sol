    ...
    if not ('cd', 68).length:
        ...
        while idx < ('cd', 68).length:
            ...
            if not _792:
                ...
                if 0 >= mem[(32 * ('cd', 4).length) + (32 * ('cd', 68).length) + 160]:
                    revert with 'NH{q', 50
                mem[(32 * ('cd', 4).length) + (32 * ('cd', 68).length) + 192] = _1059
            else:
                ...
                if 0 >= mem[(32 * ('cd', 4).length) + (32 * ('cd', 68).length) + 160]:
                    revert with 'NH{q', 50
                mem[(32 * ('cd', 4).length) + (32 * ('cd', 68).length) + 192] = _1515
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
            continue 
        ...
        while idx < _1317:
            ...
            if not _1319:
                ...
                if 0 >= mem[(32 * ('cd', 4).length) + (32 * ('cd', 68).length) + 160]:
                    revert with 'NH{q', 50
                mem[(32 * ('cd', 4).length) + (32 * ('cd', 68).length) + 192] = _1519
            else:
                ...
                if 0 >= mem[(32 * ('cd', 4).length) + (32 * ('cd', 68).length) + 160]:
                    revert with 'NH{q', 50
                mem[(32 * ('cd', 4).length) + (32 * ('cd', 68).length) + 192] = _1763
            if idx == -1:
                revert with 'NH{q', 17
            _1317 = mem[(32 * ('cd', 4).length) + 128]
            idx = idx + 1
