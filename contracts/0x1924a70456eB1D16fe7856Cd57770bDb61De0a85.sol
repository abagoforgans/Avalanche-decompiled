...
function sub_0bc69f90(?) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, '!OWNER'
    stor25 = uint8(arg1)
    stor24 = block.timestamp + (2 * 3600)
}
...
function setIsDividendExempt(address arg1, bool arg2) {
    ...
    require ext_code.size(stor32)
    if not arg2:
        call stor32.setShare(address arg1, uint256 arg2) with:
             gas gas_remaining wei
...
function getLiquidityBacking(uint256 arg1) {
    ...
    if not totalSupply - balanceOf[stor4] - balanceOf[stor5]:
        revert with 0, 'SafeMath: division by zero'
    return (2 * balanceOf[stor31] * arg1 / totalSupply - balanceOf[stor4] - balanceOf[stor5])
}
...
function isOverLiquified(uint256 arg1, uint256 arg2) {
    ...
    if not totalSupply - balanceOf[stor4] - balanceOf[stor5]:
        revert with 0, 'SafeMath: division by zero'
    return (2 * balanceOf[stor31] * arg2 / totalSupply - balanceOf[stor4] - balanceOf[stor5] > arg1)
}
