...
function executeFlashRedeem(address arg1, address arg2, uint256 arg3) {
    ...
    if not ext_call.return_data[0]:
        ...
        if not 0 / ext_call.return_data[0]:
            ...
            if not 0 / ext_call.return_data[0] * ext_call.return_data[0] / 10^18:
                ...
                if 0 / ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * arg3 / 0 / ext_call.return_data[0] * ext_call.return_data[0] / 10^18 != arg3:
                    revert with 0, 32, 33, 0x59536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
                require ext_code.size(address(stor4))
                call address(stor4).flashRedeem(address arg1, uint256 arg2, bytes arg3) with:
                     gas gas_remaining wei
                    args address(this.address), 0 / ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * arg3 / 1000, 'x'
    else:
        require ext_call.return_data[0]
        ...
        if not ext_call.return_data[0] * ext_call.return_data[0] / 10^18:
            ...
            if ext_call.return_data[0] <= 0:
                revert with 0, 'SafeMath: division by zero'
            require ext_call.return_data[0]
            if not ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / ext_call.return_data[0]:
                require ext_code.size(address(stor4))
                call address(stor4).flashRedeem(address arg1, uint256 arg2, bytes arg3) with:
                     gas gas_remaining wei
                    args address(this.address), 0, 96, 1, uint8('x')
            else:
                require ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / ext_call.return_data[0]
                if ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] != ext_call.return_data[0]:
                    revert with 0, 32, 33, 0x59536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
                if not ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0] / 10^18:
                    require ext_code.size(address(stor4))
                    call address(stor4).flashRedeem(address arg1, uint256 arg2, bytes arg3) with:
                         gas gas_remaining wei
                        args address(this.address), 0, 96, 1, uint8('x')
                else:
                    require ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0] / 10^18
                    if ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * arg3 / ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0] / 10^18 != arg3:
                        revert with 0, 32, 33, 0x59536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[453 len 31]
                    require ext_code.size(address(stor4))
                    call address(stor4).flashRedeem(address arg1, uint256 arg2, bytes arg3) with:
                         gas gas_remaining wei
                        args address(this.address), ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * arg3 / 1000, 'x'
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(address(stor4))
    ...
    call stor1.deleverage(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint256 arg5, bytes arg6) with:
         gas gas_remaining wei
        args stor3, ext_call.return_data[0], 0, 0, block.timestamp, 192, 0, mem[644]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).underlying() with:
