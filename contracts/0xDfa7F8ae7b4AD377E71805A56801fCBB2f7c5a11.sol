...
function sub_e6cda198(?) payable {
    ...
    emit Log(string arg1, address arg2):
             64,
             address(arg1),
             51,
             'print called, token to print and',
             0x207468652055534443206265666f7265203a2000000000000000000000000000,
    ...
    emit Log(string arg1, address arg2):
             ...
             sub_0b9ec158Address,
             17,
             0x636f6c6c65637465642066726f6d203a20000000000000000000000000000000,
    emit Amount(0);
}
