...
function _getReward(address arg1) {
    ...
    while idx < rewardsCount:
        ...
        if balanceOf[address(arg1)].field_768 >= rewards[idx].field_0:
            if block.timestamp < balanceOf[address(arg1)].field_768:
                revert with 0, 17
            if block.timestamp - balanceOf[address(arg1)].field_768 / 60 and rewards[idx].field_768 > -1 / block.timestamp - balanceOf[address(arg1)].field_768 / 60:
                revert with 0, 17
            if balanceOf[address(arg1)].field_512 > 0x68db8bac710cb295e9e1b089a027525460aa64c2f837b4a2339c0ebedfa43:
                revert with 0, 17
            if not totalStaked:
                revert with 0, 18
            if 10000 * balanceOf[address(arg1)].field_512 / totalStaked and block.timestamp - balanceOf[address(arg1)].field_768 / 60 * rewards[idx].field_768 > -1 / 10000 * balanceOf[address(arg1)].field_512 / totalStaked:
                revert with 0, 17
            if s > !(10000 * balanceOf[address(arg1)].field_512 / totalStaked * block.timestamp - balanceOf[address(arg1)].field_768 / 60 * rewards[idx].field_768 / 10000):
                revert with 0, 17
            if idx == -1:
                revert with 0, 17
            idx = idx + 1
            s = s + (10000 * balanceOf[address(arg1)].field_512 / totalStaked * block.timestamp - balanceOf[address(arg1)].field_768 / 60 * rewards[idx].field_768 / 10000)
            continue 
        ...
        if not totalStaked:
            revert with 0, 18
        if 10000 * balanceOf[address(arg1)].field_512 / totalStaked and block.timestamp - rewards[idx].field_0 / 60 * rewards[idx].field_768 > -1 / 10000 * balanceOf[address(arg1)].field_512 / totalStaked:
            revert with 0, 17
        if s > !(10000 * balanceOf[address(arg1)].field_512 / totalStaked * block.timestamp - rewards[idx].field_0 / 60 * rewards[idx].field_768 / 10000):
            revert with 0, 17
        if idx == -1:
            revert with 0, 17
        idx = idx + 1
        s = s + (10000 * balanceOf[address(arg1)].field_512 / totalStaked * block.timestamp - rewards[idx].field_0 / 60 * rewards[idx].field_768 / 10000)
        continue 
    return s
}
...
function stake(uint256 arg1, address arg2) {
    ...
    while idx < stakersList.length:
        ...
        if not balanceOf[stor5[idx]].field_512:
            ...
            if balanceOf[stor5[idx]].field_1024 > -1:
                revert with 0, 17
        else:
            s = 0
            t = 0
            while s < rewardsCount:
                ...
                if balanceOf[stor5[idx]].field_768 >= rewards[s].field_0:
                    if block.timestamp < balanceOf[stor5[idx]].field_768:
                        revert with 0, 17
                    if block.timestamp - balanceOf[stor5[idx]].field_768 / 60 and rewards[s].field_768 > -1 / block.timestamp - balanceOf[stor5[idx]].field_768 / 60:
                        revert with 0, 17
                    if balanceOf[stor5[idx]].field_512 > 0x68db8bac710cb295e9e1b089a027525460aa64c2f837b4a2339c0ebedfa43:
                        revert with 0, 17
                    if not totalStaked:
                        revert with 0, 18
                    if 10000 * balanceOf[stor5[idx]].field_512 / totalStaked and block.timestamp - balanceOf[stor5[idx]].field_768 / 60 * rewards[s].field_768 > -1 / 10000 * balanceOf[stor5[idx]].field_512 / totalStaked:
                        revert with 0, 17
                    if t > !(10000 * balanceOf[stor5[idx]].field_512 / totalStaked * block.timestamp - balanceOf[stor5[idx]].field_768 / 60 * rewards[s].field_768 / 10000):
                        revert with 0, 17
                    if s == -1:
                        revert with 0, 17
                    s = s + 1
                    t = t + (10000 * balanceOf[stor5[idx]].field_512 / totalStaked * block.timestamp - balanceOf[stor5[idx]].field_768 / 60 * rewards[s].field_768 / 10000)
                    continue 
                ...
                if not totalStaked:
                    revert with 0, 18
                if 10000 * balanceOf[stor5[idx]].field_512 / totalStaked and block.timestamp - rewards[s].field_0 / 60 * rewards[s].field_768 > -1 / 10000 * balanceOf[stor5[idx]].field_512 / totalStaked:
                    revert with 0, 17
                if t > !(10000 * balanceOf[stor5[idx]].field_512 / totalStaked * block.timestamp - rewards[s].field_0 / 60 * rewards[s].field_768 / 10000):
                    revert with 0, 17
                if s == -1:
                    revert with 0, 17
                s = s + 1
                t = t + (10000 * balanceOf[stor5[idx]].field_512 / totalStaked * block.timestamp - rewards[s].field_0 / 60 * rewards[s].field_768 / 10000)
                continue 
            balanceOf[stor5[idx]].field_768 = block.timestamp
            if balanceOf[stor5[idx]].field_1024 > !t:
                revert with 0, 17
    ...
    if balanceOf[address(arg2)].field_512 > -2:
        revert with 0, 17
...
function withdraw() {
    if not balanceOf[address(msg.sender)].field_512:
        ...
        if balanceOf[address(msg.sender)].field_1024 > -1:
            revert with 0, 17
    else:
        idx = 0
        s = 0
        while idx < rewardsCount:
            ...
            if balanceOf[address(msg.sender)].field_768 >= rewards[idx].field_0:
                if block.timestamp < balanceOf[address(msg.sender)].field_768:
                    revert with 0, 17
                if block.timestamp - balanceOf[address(msg.sender)].field_768 / 60 and rewards[idx].field_768 > -1 / block.timestamp - balanceOf[address(msg.sender)].field_768 / 60:
                    revert with 0, 17
                if balanceOf[address(msg.sender)].field_512 > 0x68db8bac710cb295e9e1b089a027525460aa64c2f837b4a2339c0ebedfa43:
                    revert with 0, 17
                if not totalStaked:
                    revert with 0, 18
                if 10000 * balanceOf[address(msg.sender)].field_512 / totalStaked and block.timestamp - balanceOf[address(msg.sender)].field_768 / 60 * rewards[idx].field_768 > -1 / 10000 * balanceOf[address(msg.sender)].field_512 / totalStaked:
                    revert with 0, 17
                if s > !(10000 * balanceOf[address(msg.sender)].field_512 / totalStaked * block.timestamp - balanceOf[address(msg.sender)].field_768 / 60 * rewards[idx].field_768 / 10000):
                    revert with 0, 17
                if idx == -1:
                    revert with 0, 17
                idx = idx + 1
                s = s + (10000 * balanceOf[address(msg.sender)].field_512 / totalStaked * block.timestamp - balanceOf[address(msg.sender)].field_768 / 60 * rewards[idx].field_768 / 10000)
                continue 
            if block.timestamp < rewards[idx].field_0:
                revert with 0, 17
            if block.timestamp - rewards[idx].field_0 / 60 and rewards[idx].field_768 > -1 / block.timestamp - rewards[idx].field_0 / 60:
            ...
            if not totalStaked:
                revert with 0, 18
            if 10000 * balanceOf[address(msg.sender)].field_512 / totalStaked and block.timestamp - rewards[idx].field_0 / 60 * rewards[idx].field_768 > -1 / 10000 * balanceOf[address(msg.sender)].field_512 / totalStaked:
                revert with 0, 17
            if s > !(10000 * balanceOf[address(msg.sender)].field_512 / totalStaked * block.timestamp - rewards[idx].field_0 / 60 * rewards[idx].field_768 / 10000):
                revert with 0, 17
            if idx == -1:
                revert with 0, 17
            idx = idx + 1
            s = s + (10000 * balanceOf[address(msg.sender)].field_512 / totalStaked * block.timestamp - rewards[idx].field_0 / 60 * rewards[idx].field_768 / 10000)
            continue 
        balanceOf[address(msg.sender)].field_768 = block.timestamp
        if balanceOf[address(msg.sender)].field_1024 > !s:
            revert with 0, 17
        balanceOf[address(msg.sender)].field_1024 += s
    if balanceOf[msg.sender].field_1024 < balanceOf[msg.sender].field_1280:
        revert with 0, 17
    ...
    if balanceOf[msg.sender].field_1280 > !(balanceOf[msg.sender].field_1024 - balanceOf[msg.sender].field_1280):
        revert with 0, 17
...
function unstake(uint256 arg1) {
    ...
    idx = 0
    while idx < arg1:
        if balanceOf[msg.sender].field_512 < 1:
            revert with 0, 17
        balanceOf[msg.sender].field_512--
        if balanceOf[msg.sender].field_0 < 1:
            revert with 0, 17
