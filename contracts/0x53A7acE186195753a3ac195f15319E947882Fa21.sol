...
function emergencyWithdraw() {
    ...
    call 0x1495b7e8d7e9700bd0726f1705e864265724f6e2.emergencyWithdraw(uint256 rg1) with:
...
function withdraw() {
    require msg.sender == owner
    require ext_code.size(0x1495b7e8d7e9700bd0726f1705e864265724f6e2)
    staticcall 0x1495b7e8d7e9700bd0726f1705e864265724f6e2.userInfo(uint256 rg1, address rg2) with:
            gas gas_remaining wei
           args 0, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(0x1495b7e8d7e9700bd0726f1705e864265724f6e2)
    call 0x1495b7e8d7e9700bd0726f1705e864265724f6e2.withdraw(uint256 rg1, uint256 rg2) with:
         gas gas_remaining wei
...
function deposit(uint256 arg1) {
    ...
    if ext_call.return_data[0] < ext_call.return_data[0]:
        require ext_code.size(0x7b7617c7b2236d7871741783cae8bcc222c2e05d)
        call 0x7b7617c7b2236d7871741783cae8bcc222c2e05d.approve(address rg1, uint256 rg2) with:
             gas gas_remaining wei
        ...
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
    require ext_code.size(0x1495b7e8d7e9700bd0726f1705e864265724f6e2)
    call 0x1495b7e8d7e9700bd0726f1705e864265724f6e2.deposit(uint256 rg1, uint256 rg2) with:
         gas gas_remaining wei
        args 0, ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function reserve() {
    ...
    if ext_call.return_data[0] >= ext_call.return_data[0]:
        ...
        require ext_code.size(0x6d923f688c7ff287dc3a5943caeefc994f97b290)
        call 0x6d923f688c7ff287dc3a5943caeefc994f97b290.approve(address rg1, uint256 rg2) with:
             gas gas_remaining wei
...
function pendingTokens() {
    ...
    require ext_code.size(0x1495b7e8d7e9700bd0726f1705e864265724f6e2)
    staticcall 0x1495b7e8d7e9700bd0726f1705e864265724f6e2.pendingTokens(uint256 rg1, address rg2) with:
            gas gas_remaining wei
           args 0, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
