...
function withdraw(uint256 arg1) payable {
    ...
    if ext_call.return_data[0] <= arg1:
        if tx.origin == owner:
            ...
            mem[324 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), ext_call.return_data[0 len 28]
            ...
            if paused:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, ext_call.return_data[0] - (0 / WITHDRAWAL_MAX)) >> 32
                    mem[516 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor3)
                         gas gas_remaining wei
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] * WITHDRAW_FEE / WITHDRAWAL_MAX)) >> 32
                    mem[516 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor3)
                         gas gas_remaining wei
        ...
        if tx.origin == owner:
            if ext_code.size(wantAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[324 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, arg1) >> 32
            call wantAddress with:
               funct uint32(stor3)
                 gas gas_remaining wei
            ...
            if paused:
                ...
                if not arg1:
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, arg1 - (0 / WITHDRAWAL_MAX)) >> 32
                    call wantAddress with:
                       funct uint32(stor3)
                         gas gas_remaining wei
                    ...
                    if ext_code.size(wantAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[452 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor3), uint32(stor3), Mask(224, 32, arg1 - (arg1 * WITHDRAW_FEE / WITHDRAWAL_MAX)) >> 32
                    mem[516 len 0] = 0
                    call wantAddress with:
                       funct uint32(stor3)
                         gas gas_remaining wei
...
function makeCustomTxn(address arg1, address arg2, address arg3, uint256 arg4) payable {
    ...
    if ext_call.return_data[0] >= arg4:
        ...
        if ext_code.size(arg1) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = approve(address rg1, uint256 rg2), address(arg3) << 64, 0, 0
        mem[352 len 4] = 0
        call arg1 with:
             gas gas_remaining wei
        ...
        if return_data.size:
            ...
            if ext_code.size(arg1) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 425 len 64] = approve(address rg1, uint256 rg2), address(arg3) << 64, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            mem[ceil32(return_data.size) + 517 len 4] = 0
            mem[ceil32(return_data.size) + 489 len 0] = 0
            call arg1 with:
                 gas gas_remaining wei
                args Mask(480, -256, approve(address rg1, uint256 rg2), address(arg3) << 64, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[ceil32(return_data.size) + 489 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with approve(address rg1, uint256 rg2), address(arg3) << 64, 0, 0
                if not approve(address rg1, uint256 rg2), address(arg3) << 64:
                    revert with 0, 
                                32,
                                42,
                                0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                ...
                if not stor18.length:
                    ...
                    call arg3.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                         gas gas_remaining wei
                        args arg4, 0, 160, address(this.address), block.timestamp + 600, stor18.length, mem[(2 * ceil32(return_data.size)) + 686 len 32 * stor18.length]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            ...
            mem[292 len 4] = approve(address rg1, uint256 rg2)
            mem[360] = 32
            mem[392] = 'SafeERC20: low-level call failed'
            if ext_code.size(arg1) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = approve(address rg1, uint256 rg2), address(arg3) << 64, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
            mem[516 len 4] = 0
            mem[488 len 0] = 0
            call arg1 with:
                 gas gas_remaining wei
                args Mask(480, -256, approve(address rg1, uint256 rg2), address(arg3) << 64, 0, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff) << 256, mem[488 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with approve(address rg1, uint256 rg2), address(arg3) << 64, 0, 0
                if not approve(address rg1, uint256 rg2), address(arg3) << 64:
