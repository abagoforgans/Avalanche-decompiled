...
function _getNodeNumberOf(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    delegate 0x335a5e76596fb579c0daaa235e44c0b64dedfa9a.0x732a2ccf with:
...
function createNode(address arg1, string arg2) payable {
    ...
    require ext_code.size(0x335a5e76596fb579c0daaa235e44c0b64dedfa9a)
    delegate 0x335a5e76596fb579c0daaa235e44c0b64dedfa9a.0xbc2b405c with:
         gas gas_remaining wei
