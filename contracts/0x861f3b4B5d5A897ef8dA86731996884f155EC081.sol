...
function sub_792e9e61(?) payable {
    ...
    require ext_code.size(0x9e8f4f93533109b81fff92247ae74723c1438a33)
    staticcall 0x9e8f4f93533109b81fff92247ae74723c1438a33.token0() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    require ext_code.size(0x9e8f4f93533109b81fff92247ae74723c1438a33)
    staticcall 0x9e8f4f93533109b81fff92247ae74723c1438a33.getReserves() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
...
function sub_72ba0ebb(?) payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0xc58cd958d35e380ab891b7f001a03117a3f80f08)
    call 0xc58cd958d35e380ab891b7f001a03117a3f80f08.forfeit() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[100] = this.address
    require ext_code.size(0xa6772f1efedef231a3d92851470bd73316ddeaa9)
    staticcall 0xa6772f1efedef231a3d92851470bd73316ddeaa9.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    mem[ceil32(return_data.size) + 100] = 0xc58cd958d35e380ab891b7f001a03117a3f80f08
    mem[ceil32(return_data.size) + 132] = ext_call.return_data[0]
    require ext_code.size(0xa6772f1efedef231a3d92851470bd73316ddeaa9)
    call 0xa6772f1efedef231a3d92851470bd73316ddeaa9.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 0xc58cd958d35e380ab891b7f001a03117a3f80f08, ext_call.return_data[0]
    ...
    require ext_code.size(0xc58cd958d35e380ab891b7f001a03117a3f80f08)
    call 0xc58cd958d35e380ab891b7f001a03117a3f80f08.unstake(uint256 arg1, bool arg2) with:
         gas gas_remaining wei
        args ext_call.return_data[0], 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(2 * ceil32(return_data.size)) + 100] = this.address
    require ext_code.size(0x350b3ff32ab1b6beabec41abcebff682e0f37a3b)
    staticcall 0x350b3ff32ab1b6beabec41abcebff682e0f37a3b.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    mem[(4 * ceil32(return_data.size)) + 128] = 0x350b3ff32ab1b6beabec41abcebff682e0f37a3b
    ...
    require ext_code.size(0x350b3ff32ab1b6beabec41abcebff682e0f37a3b)
    call 0x350b3ff32ab1b6beabec41abcebff682e0f37a3b.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
    ...
    require ext_code.size(0xc58cd958d35e380ab891b7f001a03117a3f80f08)
    call 0xc58cd958d35e380ab891b7f001a03117a3f80f08.0x900cf0cf with:
         gas gas_remaining wei
...
function sub_8fdadfc1(?) payable {
    require ext_code.size(0xc58cd958d35e380ab891b7f001a03117a3f80f08)
    staticcall 0xc58cd958d35e380ab891b7f001a03117a3f80f08.0xdeac361a with:
            gas gas_remaining wei
    mem[96] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if uint8(stor1.field_160):
        ...
        if block.timestamp < uint128(stor1.field_0):
            revert with 0, '1e'
        require ext_code.size(0xc58cd958d35e380ab891b7f001a03117a3f80f08)
        call 0xc58cd958d35e380ab891b7f001a03117a3f80f08.rebase() with:
             gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(0xc58cd958d35e380ab891b7f001a03117a3f80f08)
        call 0xc58cd958d35e380ab891b7f001a03117a3f80f08.claim(address arg1) with:
             gas gas_remaining wei
            args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[0]
        mem[(4 * ceil32(return_data.size)) + 100] = 0xc58cd958d35e380ab891b7f001a03117a3f80f08
        ...
        mem[(7 * ceil32(return_data.size)) + 128] = 0x350b3ff32ab1b6beabec41abcebff682e0f37a3b
        ...
        mem[(4 * ceil32(return_data.size)) + 160] = 0x350b3ff32ab1b6beabec41abcebff682e0f37a3b
        require ext_code.size(0x9e8f4f93533109b81fff92247ae74723c1438a33)
        staticcall 0x9e8f4f93533109b81fff92247ae74723c1438a33.token0() with:
                gas gas_remaining wei
        mem[(4 * ceil32(return_data.size)) + 192] = ext_call.return_data[0]
        ...
        if address(ext_call.return_data[0]) == 0x130966628846bfd36ff31a822705796e8cb8c18d:
            ...
            mem[mem[64] + 4] = 0xc58cd958d35e380ab891b7f001a03117a3f80f08
            mem[mem[64] + 36] = _200
            require ext_code.size(0x350b3ff32ab1b6beabec41abcebff682e0f37a3b)
            call 0x350b3ff32ab1b6beabec41abcebff682e0f37a3b.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args 0xc58cd958d35e380ab891b7f001a03117a3f80f08, _200
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _206 = mem[64]
            ...
            require ext_code.size(0xc58cd958d35e380ab891b7f001a03117a3f80f08)
            call 0xc58cd958d35e380ab891b7f001a03117a3f80f08.stake(uint256 arg1, address arg2) with:
                 gas gas_remaining wei
            ...
            call 0x350b3ff32ab1b6beabec41abcebff682e0f37a3b.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args 0xc58cd958d35e380ab891b7f001a03117a3f80f08, _201
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _207 = mem[64]
