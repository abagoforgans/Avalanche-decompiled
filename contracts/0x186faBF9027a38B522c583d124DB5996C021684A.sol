...
function sweep(address arg1) payable {
    ...
    if not ext_code.hash(arg1):
        revert with 0, 'Address: call to non-contract'
    mem[(4 * ceil32(return_data.size)) + 388 len floor32((5 * ceil32(return_data.size)) + 99)] = transfer(address arg1, uint256 arg2), address(ext_call.return_data[0]) << 64, 0, ext_call.return_data[0], mem[(4 * ceil32(return_data.size)) + 324 len floor32((5 * ceil32(return_data.size)) + 99) - 68]
...
function harvester() payable {
    ...
    call gaugeAddress.deposit(uint256 arg1, uint256 arg2) with:
         gas gas_remaining wei
        args uint16(stor16.field_160) - 1 << 240, 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
                ...
                if 0 < stor19:
                    if 0 >= stor17:
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require ext_code.size(poolAddress)
                        staticcall poolAddress.balanceOf(address arg1) with:
                                gas gas_remaining wei
                               args this.address
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        ...
                        require return_data.size >= 32
                        require ext_call.return_data[0] == bool(ext_call.return_data[0])
                        if not uint16(stor16.field_160):
                            revert with 0, 'Invalid PID'
                        require ext_code.size(gaugeAddress)
                        call gaugeAddress.deposit(uint256 arg1, uint256 arg2) with:
                             gas gas_remaining wei
                            args uint16(stor16.field_160) - 1 << 240, ext_call.return_data[0]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                else:
                    if stor19 >= stor17:
                ...
                if 0 >= stor17:
                    ...
                    if ext_call.return_data[0]:
                        ...
                        call gaugeAddress.withdraw(uint256 arg1, uint256 arg2) with:
                             gas gas_remaining wei
                            args uint16(stor16.field_160) - 1 << 240, 0 / ext_call.return_data[0]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require ext_code.size(poolAddress)
                        staticcall poolAddress.balanceOf(address arg1) with:
                        ...
                        call poolAddress.approve(address arg1, uint256 arg2) with:
                             gas gas_remaining wei
                            args sub_e956dcd7Address, ext_call.return_data[0]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        require ext_call.return_data[0] == bool(ext_call.return_data[0])
                        ...
                        call sub_e956dcd7Address.0xc4de93a5 with:
                             gas gas_remaining wei
                            args uint16(stor16.field_0), ext_call.return_data[0], this.address
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
}
    ...
    if arg1 <= 2 * ext_call.return_data[0]:
        if not arg1:
            ...
            if 2 * ext_call.return_data[0] > arg1:
                revert with 0, 'SafeMath: subtraction overflow', 0
            mem[(6 * ceil32(return_data.size)) + 196] = msg.sender
            mem[(6 * ceil32(return_data.size)) + 228] = ext_call.return_data[0]
            mem[(6 * ceil32(return_data.size)) + 160] = 68
            mem[(6 * ceil32(return_data.size)) + 196 len 28] = Mask(224, 32, msg.sender) >> 32
            mem[(6 * ceil32(return_data.size)) + 192 len 4] = transfer(address arg1, uint256 arg2)
            ...
            if not ext_code.hash(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[(6 * ceil32(return_data.size)) + 324 len 96] = transfer(address arg1, uint256 arg2), msg.sender, ext_call.return_data[0], 0
            ...
            if arg1 < stor17:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if ext_call.return_data[0] == arg1:
                        ...
                        mem[(8 * ceil32(return_data.size)) + 128 len 4] = transfer(address arg1, uint256 arg2)
                        ...
                        if not ext_code.hash(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(8 * ceil32(return_data.size)) + 260 len 96] = transfer(address arg1, uint256 arg2), msg.sender, ext_call.return_data[0], 0
                        ...
                        if not return_data.size:
                            ...
                            if return_data.size:
                                ...
                                if not mem[(8 * ceil32(return_data.size)) + 292]:
                                    revert with 0, 'SafeERC20: ERC20 operation did not succeed'
                        return 0
                    mem[(8 * ceil32(return_data.size)) + 96] = 30
                    mem[(8 * ceil32(return_data.size)) + 128] = 'SafeMath: subtraction overflow'
                    if 2 * ext_call.return_data[0] > arg1:
                        revert with 0, 'SafeMath: subtraction overflow', 0
                    ...
                    mem[(8 * ceil32(return_data.size)) + 196 len 28] = Mask(224, 32, msg.sender) >> 32
                    mem[(8 * ceil32(return_data.size)) + 192 len 4] = transfer(address arg1, uint256 arg2)
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(8 * ceil32(return_data.size)) + 324 len 96] = transfer(address arg1, uint256 arg2), msg.sender, ext_call.return_data[0], 0
                    ...
                    mem[(7 * ceil32(return_data.size)) + 100] = 10^6
                    require ext_code.size(poolAddress)
                    staticcall poolAddress.0xf6cd35ee with:
                            gas gas_remaining wei
                           args 10^6
                    ...
                    call gaugeAddress.withdraw(uint256 arg1, uint256 arg2) with:
                         gas gas_remaining wei
                        args uint16(stor16.field_160) - 1 << 240, arg1 / ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[(10 * ceil32(return_data.size)) + 164] = sub_e956dcd7Address
                    ...
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    mem[(11 * ceil32(return_data.size)) + 164] = uint16(stor16.field_160)
                    ...
                    require return_data.size >= 32
                    if ext_call.return_data[0] == arg1:
                        mem[(13 * ceil32(return_data.size)) + 196] = msg.sender
                        mem[(13 * ceil32(return_data.size)) + 228] = ext_call.return_data[0]
                        mem[(13 * ceil32(return_data.size)) + 160] = 68
                        mem[(13 * ceil32(return_data.size)) + 196 len 28] = Mask(224, 32, msg.sender) >> 32
                        mem[(13 * ceil32(return_data.size)) + 192 len 4] = transfer(address arg1, uint256 arg2)
                        mem[(13 * ceil32(return_data.size)) + 260] = 32
                        mem[(13 * ceil32(return_data.size)) + 292] = 'SafeERC20: low-level call failed'
                        if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        if not ext_code.hash(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(13 * ceil32(return_data.size)) + 324 len 96] = transfer(address arg1, uint256 arg2), msg.sender, ext_call.return_data[0], 0
                        mem[(13 * ceil32(return_data.size)) + 392] = 0
                        call wantAddress with:
                           funct Mask(32, 224, transfer(address arg1, uint256 arg2), msg.sender, ext_call.return_data[0], 0) >> 224
                             gas gas_remaining wei
                            args (Mask(512, -288, transfer(address arg1, uint256 arg2), msg.sender, ext_call.return_data[0], 0) << 288)
                        if not return_data.size:
                            ...
                            mem[(13 * ceil32(return_data.size)) + 356 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                if return_data.size:
                                    revert with ext_call.return_data[0 len return_data.size]
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                require mem[(13 * ceil32(return_data.size)) + 356] == bool(mem[(13 * ceil32(return_data.size)) + 356])
                                if not mem[(13 * ceil32(return_data.size)) + 356]:
                                    revert with 0, 'SafeERC20: ERC20 operation did not succeed'
                        return 0
                    mem[(13 * ceil32(return_data.size)) + 160] = 30
                    mem[(13 * ceil32(return_data.size)) + 192] = 'SafeMath: subtraction overflow'
                    if 2 * ext_call.return_data[0] > arg1:
                        revert with 0, 'SafeMath: subtraction overflow', 0
                    mem[(13 * ceil32(return_data.size)) + 260] = msg.sender
                    mem[(13 * ceil32(return_data.size)) + 292] = ext_call.return_data[0]
                    mem[(13 * ceil32(return_data.size)) + 224] = 68
                    mem[(13 * ceil32(return_data.size)) + 260 len 28] = Mask(224, 32, msg.sender) >> 32
                    mem[(13 * ceil32(return_data.size)) + 256 len 4] = transfer(address arg1, uint256 arg2)
                    ...
                    if not ext_code.hash(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[(13 * ceil32(return_data.size)) + 388 len 96] = transfer(address arg1, uint256 arg2), msg.sender, ext_call.return_data[0], 0
        ...
        if not arg1:
            ...
            if ext_call.return_data[0] == arg1:
                ...
                mem[(6 * ceil32(return_data.size)) + 256 len 4] = transfer(address arg1, uint256 arg2)
                ...
                if not ext_code.hash(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[(6 * ceil32(return_data.size)) + 388 len 96] = transfer(address arg1, uint256 arg2), msg.sender, ext_call.return_data[0], 0
            ...
            if arg1 < stor17:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if ext_call.return_data[0] == arg1:
                        ...
                        mem[(8 * ceil32(return_data.size)) + 160] = 30
                        mem[(8 * ceil32(return_data.size)) + 192] = 'SafeMath: subtraction overflow'
                        if 2 * ext_call.return_data[0] > arg1:
                            revert with 0, 'SafeMath: subtraction overflow', 0
                        mem[(8 * ceil32(return_data.size)) + 260] = msg.sender
                        mem[(8 * ceil32(return_data.size)) + 292] = ext_call.return_data[0]
                        mem[(8 * ceil32(return_data.size)) + 224] = 68
                        mem[(8 * ceil32(return_data.size)) + 260 len 28] = Mask(224, 32, msg.sender) >> 32
                        mem[(8 * ceil32(return_data.size)) + 256 len 4] = transfer(address arg1, uint256 arg2)
                        ...
                        if not ext_code.hash(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(8 * ceil32(return_data.size)) + 388 len 96] = transfer(address arg1, uint256 arg2), msg.sender, ext_call.return_data[0], 0
                    ...
                    mem[(7 * ceil32(return_data.size)) + 164] = 10^6
                    require ext_code.size(poolAddress)
                    staticcall poolAddress.0xf6cd35ee with:
                            gas gas_remaining wei
                           args 10^6
                    ...
                    if not ext_call.return_data[0]:
                        revert with 0, 'SafeMath: division by zero', 0
                    mem[(8 * ceil32(return_data.size)) + 260] = arg1 / ext_call.return_data[0]
                    require ext_code.size(gaugeAddress)
                    call gaugeAddress.withdraw(uint256 arg1, uint256 arg2) with:
                         gas gas_remaining wei
                        args uint16(stor16.field_160) - 1 << 240, arg1 / ext_call.return_data[0]
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[(10 * ceil32(return_data.size)) + 228] = sub_e956dcd7Address
                    ...
                    require return_data.size >= 32
                    require ext_call.return_data[0] == bool(ext_call.return_data[0])
                    mem[(11 * ceil32(return_data.size)) + 228] = uint16(stor16.field_160)
                    ...
                    if ext_call.return_data[0] == arg1:
                        ...
                        mem[(13 * ceil32(return_data.size)) + 224] = 30
                        mem[(13 * ceil32(return_data.size)) + 256] = 'SafeMath: subtraction overflow'
                        if 2 * ext_call.return_data[0] > arg1:
                            revert with 0, 'SafeMath: subtraction overflow', 0
                        mem[(13 * ceil32(return_data.size)) + 324] = msg.sender
                        mem[(13 * ceil32(return_data.size)) + 356] = ext_call.return_data[0]
                        mem[(13 * ceil32(return_data.size)) + 288] = 68
                        mem[(13 * ceil32(return_data.size)) + 324 len 28] = Mask(224, 32, msg.sender) >> 32
                        mem[(13 * ceil32(return_data.size)) + 320 len 4] = transfer(address arg1, uint256 arg2)
                        mem[(13 * ceil32(return_data.size)) + 388] = 32
                        mem[(13 * ceil32(return_data.size)) + 420] = 'SafeERC20: low-level call failed'
                        if 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470 == ext_code.hash(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        if not ext_code.hash(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[(13 * ceil32(return_data.size)) + 452 len 96] = transfer(address arg1, uint256 arg2), msg.sender, ext_call.return_data[0], 0
                        mem[(13 * ceil32(return_data.size)) + 520] = 0
                        call wantAddress with:
                           funct Mask(32, 224, transfer(address arg1, uint256 arg2), msg.sender, ext_call.return_data[0], 0) >> 224
                             gas gas_remaining wei
                            args (Mask(512, -288, transfer(address arg1, uint256 arg2), msg.sender, ext_call.return_data[0], 0) << 288)
                        if not return_data.size:
                            ...
                            if return_data.size:
                                require return_data.size >= 32
                                require mem[(13 * ceil32(return_data.size)) + 484] == bool(mem[(13 * ceil32(return_data.size)) + 484])
                                if not mem[(13 * ceil32(return_data.size)) + 484]:
                                    revert with 0, 'SafeERC20: ERC20 operation did not succeed'
