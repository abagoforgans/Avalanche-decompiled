...
function estimateDeployedBalance() payable {
    ...
    staticcall stakingContractAddress.0x93f1a40b with:
           ...
           args uint256(stor24.field_0), this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
            ...
            if not arg1:
                ...
                if 0 / totalSupply > 0:
                    ...
                    call stakingContractAddress.0x441a3e70 with:
                         gas gas_remaining wei
                        args uint256(stor24.field_0), 0 / totalSupply
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require ext_code.size(depositTokenAddress)
                ...
                if arg1 * totalDeposits / totalSupply > 0:
                    ...
                    call stakingContractAddress.0x441a3e70 with:
                         gas gas_remaining wei
                        args uint256(stor24.field_0), arg1 * totalDeposits / totalSupply
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require ext_code.size(depositTokenAddress)
                    call depositTokenAddress.0xa9059cbb with:
...
function checkReward() payable {
    ...
    mem[100] = uint256(stor24.field_0)
    mem[132] = this.address
    require ext_code.size(stakingContractAddress)
    staticcall stakingContractAddress.pendingTokens(uint256 rg1, address rg2) with:
            gas gas_remaining wei
           args uint256(stor24.field_0), this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    _4 = mem[96 len 4], Mask(224, 0, stor24.field_32)
    _6 = 0, mem[164 len 28]
    ...
    require return_data.size >= 32
    if this.address:
        require ext_code.size(address(this.address) << 64)
        staticcall address(this.address) << 64.0x70a08231 with:
                gas gas_remaining wei
               args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] + _4 < ext_call.return_data[0]:
        revert with 0, 'SafeMath: addition overflow'
    require ext_code.size(stor19)
    staticcall stor19.getReserves() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
    if not _9 % 32:
        if stor23 < 0x7186befe49e38952eb4505ba3449d704e0677606:
            if stor23 == stor23:
                if not ext_call.return_data[0] + _4:
                    ...
                    if 1000 * ext_call.return_data[18 len 14] < 1000 * ext_call.return_data[18 len 14]:
                        revert with 0, 'SafeMath: addition overflow'
                    if 1000 * Mask(112, 0, ext_call.return_data[0]) <= 0:
                        revert with 0, 'SafeMath: division by zero'
                    require 1000 * Mask(112, 0, ext_call.return_data[0])
                    if ext_call.return_data[0] + (0 / 1000 * Mask(112, 0, ext_call.return_data[0])) < ext_call.return_data[0]:
                        revert with 0, 'SafeMath: addition overflow'
                    return (ext_call.return_data[0] + (0 / 1000 * Mask(112, 0, ext_call.return_data[0])))
                require ext_call.return_data[0] + _4
                if (997 * ext_call.return_data[0]) + (997 * _4) / ext_call.return_data[0] + _4 != 997:
                    revert with 0, 
                                32,
                                33,
                                0x79536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                mem[_9 + ceil32(return_data.size) + 229 len 31]
                if not (997 * ext_call.return_data[0]) + (997 * _4):
                    if not ext_call.return_data[18 len 14]:
                        if (997 * ext_call.return_data[0]) + (997 * _4) < 0:
                            revert with 0, 'SafeMath: addition overflow'
                        if (997 * ext_call.return_data[0]) + (997 * _4) <= 0:
                            revert with 0, 'SafeMath: division by zero'
                        require (997 * ext_call.return_data[0]) + (997 * _4)
                        if ext_call.return_data[0] + (0 / (997 * ext_call.return_data[0]) + (997 * _4)) < ext_call.return_data[0]:
                            revert with 0, 'SafeMath: addition overflow'
                        return (ext_call.return_data[0] + (0 / (997 * ext_call.return_data[0]) + (997 * _4)))
                    require ext_call.return_data[18 len 14]
                    if 1000 * ext_call.return_data[18 len 14] / ext_call.return_data[18 len 14] != 1000:
                        revert with 0, 
                                    32,
                                    ...
                                    0x79536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                    mem[_9 + ceil32(return_data.size) + 229 len 31]
                    if (1000 * ext_call.return_data[18 len 14]) + (997 * ext_call.return_data[0]) + (997 * _4) < 1000 * ext_call.return_data[18 len 14]:
                        revert with 0, 'SafeMath: addition overflow'
                    if (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * ext_call.return_data[0]) + (997 * _4) <= 0:
                        revert with 0, 'SafeMath: division by zero'
                    require (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * ext_call.return_data[0]) + (997 * _4)
                    if ext_call.return_data[0] + (0 / (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * ext_call.return_data[0]) + (997 * _4)) < ext_call.return_data[0]:
                        revert with 0, 'SafeMath: addition overflow'
                    return (ext_call.return_data[0] + (0 / (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * ext_call.return_data[0]) + (997 * _4)))
                require (997 * ext_call.return_data[0]) + (997 * _4)
                if (997 * ext_call.return_data[0] * ext_call.return_data[50 len 14]) + (997 * _4 * ext_call.return_data[50 len 14]) / (997 * ext_call.return_data[0]) + (997 * _4) != ext_call.return_data[50 len 14]:
                    revert with 0, 
                                32,
                                33,
                                0x79536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                ...
                if not ext_call.return_data[18 len 14]:
                    ...
                    if (997 * ext_call.return_data[0]) + (997 * _4) <= 0:
                        revert with 0, 'SafeMath: division by zero'
                    require (997 * ext_call.return_data[0]) + (997 * _4)
                    if ext_call.return_data[0] + ((997 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32])) + (997 * _4 * Mask(112, 0, ext_call.return_data[32])) / (997 * ext_call.return_data[0]) + (997 * _4)) < ext_call.return_data[0]:
                        revert with 0, 'SafeMath: addition overflow'
                    return (ext_call.return_data[0] + ((997 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32])) + (997 * _4 * Mask(112, 0, ext_call.return_data[32])) / (997 * ext_call.return_data[0]) + (997 * _4)))
                require ext_call.return_data[18 len 14]
                if 1000 * ext_call.return_data[18 len 14] / ext_call.return_data[18 len 14] != 1000:
                    revert with 0, 
                                32,
                ...
                if (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * ext_call.return_data[0]) + (997 * _4) <= 0:
                    revert with 0, 'SafeMath: division by zero'
                require (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * ext_call.return_data[0]) + (997 * _4)
                if ext_call.return_data[0] + ((997 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32])) + (997 * _4 * Mask(112, 0, ext_call.return_data[32])) / (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * ext_call.return_data[0]) + (997 * _4)) < ext_call.return_data[0]:
                    revert with 0, 'SafeMath: addition overflow'
                return (ext_call.return_data[0] + ((997 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32])) + (997 * _4 * Mask(112, 0, ext_call.return_data[32])) / (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * ext_call.return_data[0]) + (997 * _4)))
        else:
            if 0x7186befe49e38952eb4505ba3449d704e0677606 == stor23:
                if not ext_call.return_data[0] + _4:
                    if not ext_call.return_data[18 len 14]:
                        revert with 0, 'SafeMath: division by zero'
                    require ext_call.return_data[18 len 14]
        ...
        if not ext_call.return_data[0] + _4:
            ...
            if 1000 * ext_call.return_data[50 len 14] < 1000 * ext_call.return_data[50 len 14]:
                revert with 0, 'SafeMath: addition overflow'
            if 1000 * Mask(112, 0, ext_call.return_data[32]) <= 0:
                revert with 0, 'SafeMath: division by zero'
            require 1000 * Mask(112, 0, ext_call.return_data[32])
            if ext_call.return_data[0] + (0 / 1000 * Mask(112, 0, ext_call.return_data[32])) < ext_call.return_data[0]:
                revert with 0, 'SafeMath: addition overflow'
            return (ext_call.return_data[0] + (0 / 1000 * Mask(112, 0, ext_call.return_data[32])))
        require ext_call.return_data[0] + _4
        if (997 * ext_call.return_data[0]) + (997 * _4) / ext_call.return_data[0] + _4 != 997:
            revert with 0, 
                        32,
        ...
        if not (997 * ext_call.return_data[0]) + (997 * _4):
            ...
            if 1000 * ext_call.return_data[50 len 14] / ext_call.return_data[50 len 14] != 1000:
                revert with 0, 
                            ...
                            0x79536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                            mem[_9 + ceil32(return_data.size) + 229 len 31]
            if (1000 * ext_call.return_data[50 len 14]) + (997 * ext_call.return_data[0]) + (997 * _4) < 1000 * ext_call.return_data[50 len 14]:
                revert with 0, 'SafeMath: addition overflow'
            if (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * ext_call.return_data[0]) + (997 * _4) <= 0:
                revert with 0, 'SafeMath: division by zero'
            require (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * ext_call.return_data[0]) + (997 * _4)
            if ext_call.return_data[0] + (0 / (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * ext_call.return_data[0]) + (997 * _4)) < ext_call.return_data[0]:
                revert with 0, 'SafeMath: addition overflow'
            return (ext_call.return_data[0] + (0 / (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * ext_call.return_data[0]) + (997 * _4)))
        require (997 * ext_call.return_data[0]) + (997 * _4)
        if (997 * ext_call.return_data[0] * ext_call.return_data[18 len 14]) + (997 * _4 * ext_call.return_data[18 len 14]) / (997 * ext_call.return_data[0]) + (997 * _4) != ext_call.return_data[18 len 14]:
            revert with 0, 
                        32,
                        33,
                        0x79536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
        ...
        if not ext_call.return_data[50 len 14]:
            ...
            if (997 * ext_call.return_data[0]) + (997 * _4) <= 0:
                revert with 0, 'SafeMath: division by zero'
            require (997 * ext_call.return_data[0]) + (997 * _4)
            if ext_call.return_data[0] + ((997 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0])) + (997 * _4 * Mask(112, 0, ext_call.return_data[0])) / (997 * ext_call.return_data[0]) + (997 * _4)) < ext_call.return_data[0]:
                revert with 0, 'SafeMath: addition overflow'
            return (ext_call.return_data[0] + ((997 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0])) + (997 * _4 * Mask(112, 0, ext_call.return_data[0])) / (997 * ext_call.return_data[0]) + (997 * _4)))
        require ext_call.return_data[50 len 14]
        if 1000 * ext_call.return_data[50 len 14] / ext_call.return_data[50 len 14] != 1000:
            revert with 0, 
                        32,
        ...
        if 1000 * ext_call.return_data[50 len 14] / ext_call.return_data[50 len 14] != 1000:
            revert with 0, 
                        ...
                        0x79536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                        mem[floor32(_9) + ceil32(return_data.size) + 261 len 31]
    ('eq', ('div', ('mul', 1000, ('ext_call.return_data', 50, 14)), ('ext_call.return_data', 50, 14)), 1000)
    if (1000 * ext_call.return_data[50 len 14]) + (997 * ext_call.return_data[0]) + (997 * _4) < 1000 * ext_call.return_data[50 len 14]:
        revert with 0, 'SafeMath: addition overflow'
    if (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * ext_call.return_data[0]) + (997 * _4) <= 0:
        revert with 0, 'SafeMath: division by zero'
    require (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * ext_call.return_data[0]) + (997 * _4)
    if ext_call.return_data[0] + ((997 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0])) + (997 * _4 * Mask(112, 0, ext_call.return_data[0])) / (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * ext_call.return_data[0]) + (997 * _4)) < ext_call.return_data[0]:
        revert with 0, 'SafeMath: addition overflow'
    return (ext_call.return_data[0] + ((997 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0])) + (997 * _4 * Mask(112, 0, ext_call.return_data[0])) / (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * ext_call.return_data[0]) + (997 * _4)))
}
