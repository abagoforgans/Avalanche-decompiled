...
uint256 stor309;
uint256 stor310;
uint8 maxTokenPerWalletPercent; offset 160
address stor311;
...
function sub_5432d665(?) payable {
    return sub_5432d665Address
}
...
function sub_162a8be3(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    stor311 = address(arg1)
}
...
function sub_b7ee9716(?) payable {
    ...
    sub_5432d665Address = address(arg1)
    emit 0xffba5056: sub_5432d665Address, address(arg1)
}
...
function totalSupply() payable {
    ...
    staticcall universeImplementationAddress.0x70a08231 with:
            gas gas_remaining wei
           args 0x3defe318367922e6cb9f348e67dee9c19a58e605
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function sub_d5c7b5d0(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
    require arg2 == address(arg2)
    if 0x9df0151c381473c8adfd451b9ffd1ae4e98adba4 == address(arg1):
        if 0x9df0151c381473c8adfd451b9ffd1ae4e98adba4 == address(arg2):
            return 1
