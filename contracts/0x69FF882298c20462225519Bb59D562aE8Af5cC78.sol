...
function initialize(address arg1, address arg2, address arg3, uint256 arg4) {
    ...
    if not msg.sender:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply > !(10^18 * arg4):
        revert with 0, 17
    totalSupply += 10^18 * arg4
    if balanceOf[address(msg.sender)] > !(10^18 * arg4):
        revert with 0, 17
    balanceOf[address(msg.sender)] += 10^18 * arg4
    emit Transfer((10^18 * arg4), 0, msg.sender);
    if not uint8(stor0.field_8):
...
function transfer(address arg1, uint256 arg2) {
    ...
    if not isTradingEnabled:
        revert with 0, 'Cannot trade yet!'
