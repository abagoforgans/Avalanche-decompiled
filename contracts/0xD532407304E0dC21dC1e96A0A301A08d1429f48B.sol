...
const OLD_CONTRACT_ADDRESS = 0xf347d5b8d7ea13ba76a8aa90510295ac1e9b4753
...
function sub_ac162625(?) payable {
    return sub_ac162625Address
}
...
function sub_97b7b51f(?) payable {
    ...
    if invested[address(msg.sender)] > 0:
        require ext_code.size(sub_ac162625Address)
        call sub_ac162625Address.0xa9059cbb with:
             gas gas_remaining wei
...
function sub_75f6e6d8(?) payable {
    ...
    if arg1 > -invested[address(msg.sender)] - 1:
        revert with 'NH{q', 17
    if arg1 + invested[address(msg.sender)] < 5 * 10^10:
