                    ...
                    if (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18:
                        if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[mem[64] + floor32(mem[_435])] = mem[_435 + floor32(mem[_435]) + -(mem[_435] % 32) + 64 len mem[_435] % 32] or Mask(8 * -(mem[_435] % 32) + 32, -(8 * -(mem[_435] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_435])])
                            call msg.sender.mem[mem[64] len 4] with:
                               value (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 wei
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _437 + _435 + -mem[64] + 28]
                            if return_data.size:
                                _686 = mem[64]
                                mem[64] = mem[64] + ceil32(return_data.size) + 1
                                mem[_686] = return_data.size
                                mem[_686 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[mem[64] + floor32(mem[_431])] = mem[_431 + floor32(mem[_431]) + -(mem[_431] % 32) + 64 len mem[_431] % 32] or Mask(8 * -(mem[_431] % 32) + 32, -(8 * -(mem[_431] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_431])])
                            call sub_8ef4403c[idx].mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _434 + _430 + -mem[64] + 96]
                        ...
                        if not (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 / 10^(-uint8(ext_call.return_data[0]) + 18):
                            ...
                            if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                                ...
                                while s >= 32:
                                    ...
                                    s = s - 32
                                    continue 
                                mem[mem[64] + floor32(mem[_475])] = mem[_475 + floor32(mem[_475]) + -(mem[_475] % 32) + 64 len mem[_475] % 32] or Mask(8 * -(mem[_475] % 32) + 32, -(8 * -(mem[_475] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_475])])
                                call msg.sender.mem[mem[64] len 4] with:
                                   value (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 / 10^(-uint8(ext_call.return_data[0]) + 18) wei
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4 len _477 + _475 + -mem[64] + 28]
                                if return_data.size:
                                    _676 = mem[64]
                                    mem[64] = mem[64] + ceil32(return_data.size) + 1
                                    mem[_676] = return_data.size
                                    mem[_676 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                if not ext_call.success:
                                    revert with 0, '!safeTransferETH'
                                mem[mem[64]] = (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 / 10^(-uint8(ext_call.return_data[0]) + 18)
                            else:
                        ...
                        if not 0 / 10^(-uint8(ext_call.return_data[0]) + 18):
                            ...
                            if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                                ...
                                while s >= 32:
                                    ...
                                    s = s - 32
                                    continue 
                                mem[_447 + floor32(mem[_447]) + 32] = mem[_447 + -(mem[_447] % 32) + floor32(mem[_447]) + 64 len mem[_447] % 32] or Mask(8 * -(mem[_447] % 32) + 32, -(8 * -(mem[_447] % 32) + 32) + 256, mem[_447 + floor32(mem[_447]) + 32])
                                call msg.sender.mem[_447 + 32 len 4] with:
                                   value 0 / 10^(-uint8(ext_call.return_data[0]) + 18) wei
                                     gas gas_remaining wei
                                    args mem[_447 + 36 len _449 - 4]
                                if not return_data.size:
                                    if not ext_call.success:
                                        revert with 0, '!safeTransferETH'
                                    mem[_447 + 32] = 0 / 10^(-uint8(ext_call.return_data[0]) + 18)
                                else:
                                    mem[64] = _447 + ceil32(return_data.size) + 33
                                    mem[_447 + 32] = return_data.size
                                    mem[_447 + 64 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                    if not ext_call.success:
                                        revert with 0, '!safeTransferETH'
                                    mem[_447 + ceil32(return_data.size) + 33] = 0 / 10^(-uint8(ext_call.return_data[0]) + 18)
                            else:
                                _442 = mem[64]
                                mem[mem[64] + 36] = msg.sender
                                ...
                                while s >= 32:
                                    ...
                                    s = s - 32
                                    continue 
                                mem[mem[64] + floor32(mem[_443])] = mem[_443 + floor32(mem[_443]) + -(mem[_443] % 32) + 64 len mem[_443] % 32] or Mask(8 * -(mem[_443] % 32) + 32, -(8 * -(mem[_443] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_443])])
                                call sub_8ef4403c[idx].mem[mem[64] len 4] with:
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4 len _446 + _442 + -mem[64] + 96]
                                if not return_data.size:
                                    if not ext_call.success:
                                        revert with 0, '!safeTransfer'
                                    if mem[96]:
                                    ...
                                    _679 = mem[64]
                                    mem[64] = mem[64] + ceil32(return_data.size) + 1
                                    mem[_679] = return_data.size
                                    mem[_679 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                    if not ext_call.success:
                                        revert with 0, '!safeTransfer'
                                    if return_data.size:
                                        require return_data.size >= 32
...
function unstake(uint256 arg1) payable {
                ...
                if not (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18:
                    ...
                    if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                        ...
                        while s >= 32:
                            ...
                            s = s - 32
                            continue 
                        mem[mem[64] + floor32(mem[_579])] = mem[_579 + floor32(mem[_579]) + -(mem[_579] % 32) + 64 len mem[_579] % 32] or Mask(8 * -(mem[_579] % 32) + 32, -(8 * -(mem[_579] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_579])])
                        call sub_8ef4403c[idx].mem[mem[64] len 4] with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _582 + _578 + -mem[64] + 96]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0, '!safeTransfer'
                            if mem[96]:
                    ...
                    if not (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18:
                        ...
                        if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[_606 + floor32(mem[_607]) + 100] = mem[_607 + -(mem[_607] % 32) + floor32(mem[_607]) + 64 len mem[_607] % 32] or Mask(8 * -(mem[_607] % 32) + 32, -(8 * -(mem[_607] % 32) + 32) + 256, mem[_606 + floor32(mem[_607]) + 100])
                            call sub_8ef4403c[idx].mem[_606 + 100 len 4] with:
                                 gas gas_remaining wei
                                args mem[_606 + 104 len _610 - 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, '!safeTransfer'
                                if mem[96]:
                                    ...
                                    if not mem[128]:
                                        revert with 0, '!safeTransfer'
                                mem[_606 + 100] = (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18
                            else:
                                mem[64] = _606 + ceil32(return_data.size) + 101
                                mem[_606 + 100] = return_data.size
                                mem[_606 + 132 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                if not ext_call.success:
                                    revert with 0, '!safeTransfer'
                                if return_data.size:
                                    require return_data.size >= 32
                                    if not mem[_606 + 132]:
                                        revert with 0, '!safeTransfer'
                                mem[_606 + ceil32(return_data.size) + 101] = (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18
                    emit StakingGainsWithdrawn(((sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18), msg.sender, sub_8ef4403c[idx]);
            else:
                _416 = mem[64]
                mem[64] = mem[64] + 64
                ...
                if not stakes[address(msg.sender)]:
                    ...
                    if 0 / 10^(-uint8(ext_call.return_data[0]) + 18):
                        if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[mem[64] + floor32(mem[_595])] = mem[_595 + floor32(mem[_595]) + -(mem[_595] % 32) + 64 len mem[_595] % 32] or Mask(8 * -(mem[_595] % 32) + 32, -(8 * -(mem[_595] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_595])])
                            call msg.sender.mem[mem[64] len 4] with:
                               value 0 / 10^(-uint8(ext_call.return_data[0]) + 18) wei
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _597 + _595 + -mem[64] + 28]
                            if return_data.size:
                                _828 = mem[64]
                                mem[64] = mem[64] + ceil32(return_data.size) + 1
                                mem[_828] = return_data.size
                                mem[_828 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                revert with 0, '!safeTransferETH'
                        else:
                            _590 = mem[64]
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[mem[64] + floor32(mem[_591])] = mem[_591 + floor32(mem[_591]) + -(mem[_591] % 32) + 64 len mem[_591] % 32] or Mask(8 * -(mem[_591] % 32) + 32, -(8 * -(mem[_591] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_591])])
                            call sub_8ef4403c[idx].mem[mem[64] len 4] with:
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _594 + _590 + -mem[64] + 96]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, '!safeTransfer'
                                if mem[96]:
                                ...
                                _827 = mem[64]
                                mem[64] = mem[64] + ceil32(return_data.size) + 1
                                mem[_827] = return_data.size
                                mem[_827 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                if not ext_call.success:
                                    revert with 0, '!safeTransfer'
                                if return_data.size:
                                    require return_data.size >= 32
                    ...
                    if not 10^(-uint8(ext_call.return_data[0]) + 18):
                        ...
                        while idx < 26:
                            ...
                            continue 
                        revert with 0, 'SafeMath: division by zero'
                    if (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 / 10^(-uint8(ext_call.return_data[0]) + 18):
                        if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                            _623 = mem[64]
                            mem[mem[64]] = 0
                            mem[64] = mem[64] + 32
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[mem[64] + floor32(mem[_623])] = mem[_623 + floor32(mem[_623]) + -(mem[_623] % 32) + 64 len mem[_623] % 32] or Mask(8 * -(mem[_623] % 32) + 32, -(8 * -(mem[_623] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_623])])
                            call msg.sender.mem[mem[64] len 4] with:
                               value (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 / 10^(-uint8(ext_call.return_data[0]) + 18) wei
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _625 + _623 + -mem[64] + 28]
                            if return_data.size:
                                _824 = mem[64]
                                mem[64] = mem[64] + ceil32(return_data.size) + 1
                                mem[_824] = return_data.size
                                mem[_824 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                revert with 0, '!safeTransferETH'
                        else:
                            _618 = mem[64]
    ...
    if arg1:
        if arg1 >= stakes[msg.sender]:
            ...
            _1008 = mem[_1005]
            mem[_1004 + 100 len floor32(mem[_1005])] = mem[_1005 + 32 len floor32(mem[_1005])]
            mem[_1004 + floor32(mem[_1005]) + -(mem[_1005] % 32) + 132 len mem[_1005] % 32] = mem[_1005 + -(mem[_1005] % 32) + floor32(mem[_1005]) + 64 len mem[_1005] % 32]
            call stakeTokenAddress.mem[_1004 + 100 len 4] with:
                 gas gas_remaining wei
            ...
            _1002 = mem[_999]
            mem[mem[64] len floor32(mem[_999])] = mem[_999 + 32 len floor32(mem[_999])]
            mem[mem[64] + floor32(mem[_999]) + -(mem[_999] % 32) + 32 len mem[_999] % 32] = mem[_999 + floor32(mem[_999]) + -(mem[_999] % 32) + 64 len mem[_999] % 32]
            call stakeTokenAddress with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len _1002 + _998 + -mem[64] + 96]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, '!safeTransfer'
                if mem[96]:
