...
function isWhitelisted(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    return bool(stor116[address(arg1)])
}
...
function initialize(address arg1, address arg2, address arg3) payable {
    ...
    if uint8(stor0.field_8):
        ...
        sub_bacaba55Address = arg1
        sub_3eac8dacAddress = arg2
        multisigAddress = arg3
        divider = 4
        tokenPrice = 100000
        minimumPurchase = 10^6
        maximumPurchase = 5 * 10^9
        sub_6782b5a7Address = arg2
        isStarted = 0
    else:
...
function buyTokens(uint256 arg1) payable {
    ...
    mem[(2 * ceil32(return_data.size)) + 292 len 128] = unknown_0x23b872dd(?????), msg.sender, multisigAddress, arg1, 0
    mem[(2 * ceil32(return_data.size)) + 392] = 0
    call sub_6782b5a7Address with:
       funct Mask(32, 224, unknown_0x23b872dd(?????), msg.sender, multisigAddress, arg1, 0) >> 224
         gas gas_remaining wei
        args (Mask(768, -544, unknown_0x23b872dd(?????), msg.sender, multisigAddress, arg1, 0) << 544)
