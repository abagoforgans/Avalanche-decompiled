...
address stor0;
mapping of struct averagePrice;

function sub_25e853bd(?) payable {
    require calldata.size - 4 >= 32
    require block.timestamp >= arg1
    return averagePrice[arg1].field_256
}
...
function sub_5c5f3904(?) payable {
    ...
    if not averagePrice[arg1].field_0:
        averagePrice[arg1].field_256 = ext_call.return_data[32]
        averagePrice[arg1].field_0 = ext_call.return_data[64]
    else:
        if ext_call.return_data[64] >= averagePrice[arg1].field_0:
            averagePrice[arg1].field_256 = ext_call.return_data[32]
            averagePrice[arg1].field_0 = ext_call.return_data[64]
}
