...
const sub_0a48ec4f(?) = 0x47afa96cdc9fab46904a55a6ad4bf6660b53c38a

const sub_14f69b4e(?) = 0x1d83fe6a10d2f2b7af17034343746188272cac9

const getName = 'Aave Auto-Compounding Rewards'

const isTendable = 0

const rewards = 0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7

const baseStrategyVersion = ''

const LENDING_POOL = 0x4f01aed16d97e3ab5ab2b501154dc9bb0f1a5a2c
...
function sub_2ac08115(?) payable {
    return sub_2ac08115Address
}
...
function balanceOfPool() payable {
    require ext_code.size(sub_2ac08115Address)
    staticcall sub_2ac08115Address.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function earn() payable {
    ...
    if ext_call.return_data[0]:
        ...
        call 0x4f01aed16d97e3ab5ab2b501154dc9bb0f1a5a2c.deposit(address arg1, uint256 arg2, address arg3, uint16 arg4) with:
             gas gas_remaining wei
            args 0, uint32(stor154.field_0), ext_call.return_data[0], this.address, 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
}
...
function withdrawOther(address arg1) payable {
    ...
    if not return_data.size:
        ...
        revert with uint8(stor154.field_152)
...
function harvest() payable {
    ...
    if ext_call.return_data[0]:
        ...
        call 0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args swapRouterAddress, 0, ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        ...
        call swapRouterAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args ext_call.return_data[0], 0, 1, 160, this.address, block.timestamp, 2, mem[452 len 64]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        mem[256 len return_data.size] = ext_call.return_data[0 len return_data.size]
        mem[64] = ceil32(return_data.size) + 256
        require return_data.size >= 32
        require mem[256 len 4], ext_call.return_data[0 len 28] <= 4294967296
        require mem[256 len 4], ext_call.return_data[0 len 28] + 32 <= return_data.size
        require mem[mem[256 len 4], ext_call.return_data[0 len 28] + 256] <= 4294967296 and mem[256 len 4], ext_call.return_data[0 len 28] + (32 * mem[mem[256 len 4], ext_call.return_data[0 len 28] + 256]) + 32 <= return_data.size
        mem[ceil32(return_data.size) + 256] = mem[mem[256 len 4], ext_call.return_data[0 len 28] + 256]
        ...
        call 0x4f01aed16d97e3ab5ab2b501154dc9bb0f1a5a2c.deposit(address arg1, uint256 arg2, address arg3, uint16 arg4) with:
             gas gas_remaining wei
            args wantAddress, ext_call.return_data[0], this.address, 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        else:
            return 0
...
function initialize(address arg1, address arg2, address arg3, address arg4, address arg5, address[2] arg6, uint256[3] arg7) payable {
    ...
    sub_2ac08115Address = address(call.data[196])
        ...
        if 0 == withdrawalFee:
            ...
            if not arg1:
                ...
                if not return_data.size:
                    ...
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[424 len 64] = 0, address(vaultAddress), Mask(224, 32, arg1 - (withdrawalFee * arg1 / 10000)) >> 32
                    call wantAddress with:
                       funct uint32(stor159)
                         gas gas_remaining wei
                        args arg1 - (withdrawalFee * arg1 / 10000), mem[360 len 28], mem[488 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            revert with 0, ext_call.return_data[12 len 20], withdrawalFee * arg1 / 10000
                        if not 0, mem[132 len 28]:
                    ...
                    if not return_data.size:
                        ...
                        if not ext_code.size(wantAddress):
                            revert with 0, 'Address: call to non-contract'
                        mem[ceil32(return_data.size) + 425 len 64] = 0, address(vaultAddress), Mask(224, 32, arg1 - (withdrawalFee * arg1 / 10000)) >> 32
                        call wantAddress with:
                           funct uint32(stor159)
                             gas gas_remaining wei
                            args arg1 - (withdrawalFee * arg1 / 10000), mem[ceil32(return_data.size) + 361 len 28], mem[ceil32(return_data.size) + 489 len 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0, ext_call.return_data[12 len 20], withdrawalFee * arg1 / 10000
                            if not 0, mem[132 len 28]:
                ...
                if 0 == withdrawalFee:
                    ...
                    if not ext_call.return_data[0]:
                        ...
                        if not return_data.size:
                            ...
                            if not ext_code.size(wantAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[424 len 64] = 0, address(vaultAddress), Mask(224, 32, ext_call.return_data[0] - (withdrawalFee * ext_call.return_data[0] / 10000)) >> 32
                            call wantAddress with:
                               funct uint32(stor159)
                                 gas gas_remaining wei
                                args ext_call.return_data[0] - (withdrawalFee * ext_call.return_data[0] / 10000), mem[360 len 28], mem[488 len 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, ext_call.return_data[12 len 20], withdrawalFee * ext_call.return_data[0] / 10000
                                if not 0, mem[132 len 28]:
                            ...
                            if not return_data.size:
                                ...
                                if not ext_code.size(wantAddress):
                                    revert with 0, 'Address: call to non-contract'
                                mem[ceil32(return_data.size) + 425 len 64] = 0, address(vaultAddress), Mask(224, 32, ext_call.return_data[0] - (withdrawalFee * ext_call.return_data[0] / 10000)) >> 32
                                call wantAddress with:
                                   funct uint32(stor159)
                                     gas gas_remaining wei
                                    args ext_call.return_data[0] - (withdrawalFee * ext_call.return_data[0] / 10000), mem[ceil32(return_data.size) + 361 len 28], mem[ceil32(return_data.size) + 489 len 4]
                                if not return_data.size:
                                    if not ext_call.success:
                                        revert with 0, ext_call.return_data[12 len 20], withdrawalFee * ext_call.return_data[0] / 10000
                                    if not 0, mem[132 len 28]:
                ...
                if 0 == withdrawalFee:
                    ...
                    if not arg1:
                        ...
                        if not return_data.size:
                            ...
                            if not ext_code.size(wantAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[424 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor159), uint32(stor159), Mask(224, 32, arg1 - (withdrawalFee * arg1 / 10000)) >> 32
                            call wantAddress with:
                               funct uint32(stor159)
                                 gas gas_remaining wei
                                args Mask(224, 32, arg1 - (withdrawalFee * arg1 / 10000)) << 224, mem[488 len 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, ext_call.return_data[12 len 20], withdrawalFee * arg1 / 10000
                                if not 0, mem[132 len 28]:
                            ...
                            if not return_data.size:
                                ...
                                if not ext_code.size(wantAddress):
                                    revert with 0, 'Address: call to non-contract'
                                mem[ceil32(return_data.size) + 425 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor159), uint32(stor159), Mask(224, 32, arg1 - (withdrawalFee * arg1 / 10000)) >> 32
                                call wantAddress with:
                                   funct uint32(stor159)
                                     gas gas_remaining wei
