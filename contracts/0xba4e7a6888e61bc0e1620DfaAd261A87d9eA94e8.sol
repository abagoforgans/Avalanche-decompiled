...
function sub_d2f7dccd(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == address(arg1)
    if sub_8d773203Address != address(arg1):
        if sub_837184feAddress != address(arg1):
            if collateral_tokenAddress != address(arg1):
                revert with 0, 'Invalid canonical token'
    if owner != msg.sender:
        if timelock_address != msg.sender:
            revert with 0, 'Not owner or timelock'
    if sub_eb33e4a9Address == address(arg1):
        require ext_code.size(sub_8d773203Address)
        call sub_8d773203Address.approve(address rg1, uint256 rg2) with:
             gas gas_remaining wei
            args sub_8d773203Address, arg2
        ...
        require return_data.size >= 32
        require ext_code.size(sub_eb33e4a9Address)
        if not sub_b703ac27Address:
            call sub_eb33e4a9Address.Swapout(uint256 rg1, address rg2) with:
                 gas gas_remaining wei
                args arg2, this.address
        else:
            call sub_eb33e4a9Address.Swapout(uint256 rg1, address rg2) with:
                 gas gas_remaining wei
                args arg2, sub_b703ac27Address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_call.return_data[0] == bool(ext_call.return_data[0])
        if arg2 >= sub_3001f398[address(this.address)]:
            sub_3001f398[address(this.address)] = 0
        else:
            if sub_3001f398[address(this.address)] < arg2:
                revert with 'NH{q', 17
            sub_3001f398[address(this.address)] -= arg2
        if arg2 >= sub_4e8a0f67:
            sub_4e8a0f67 = 0
        else:
            if sub_4e8a0f67 < arg2:
                revert with 'NH{q', 17
            sub_4e8a0f67 -= arg2
        if sub_3452ae2a > !arg2:
            revert with 'NH{q', 17
        sub_3452ae2a += arg2
    else:
        if sub_8d773203Address == address(arg1):
            ...
            if sub_477a3bd1Address == address(arg1):
                require ext_code.size(sub_837184feAddress)
                call sub_837184feAddress.approve(address rg1, uint256 rg2) with:
                     gas gas_remaining wei
                    args sub_837184feAddress, arg2
                ...
                require ext_code.size(sub_477a3bd1Address)
                if not sub_b703ac27Address:
                    call sub_477a3bd1Address.Swapout(uint256 rg1, address rg2) with:
                         gas gas_remaining wei
                        args arg2, this.address
                else:
                    call sub_477a3bd1Address.Swapout(uint256 rg1, address rg2) with:
                ...
                require return_data.size >= 32
                require ext_call.return_data[0] == bool(ext_call.return_data[0])
                if arg2 >= sub_3906f181[address(this.address)]:
                    sub_3906f181[address(this.address)] = 0
                else:
                    if sub_3906f181[address(this.address)] < arg2:
                        revert with 'NH{q', 17
                    sub_3906f181[address(this.address)] -= arg2
                if arg2 >= sub_8872e567:
                    sub_8872e567 = 0
                else:
                    if sub_8872e567 < arg2:
                        revert with 'NH{q', 17
                    sub_8872e567 -= arg2
                if sub_033716bc > !arg2:
                    revert with 'NH{q', 17
                sub_033716bc += arg2
            else:
                if sub_837184feAddress != address(arg1):
                    if collateral_tokenAddress != address(arg1):
                        revert with 0, 'getTokenType: Invalid token'
                    require ext_code.size(collateral_tokenAddress)
                    call collateral_tokenAddress.'n(fq' with:
                         gas gas_remaining wei
                        args arg2, 0
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    if arg2 >= sub_5242e71d[address(this.address)]:
                        sub_5242e71d[address(this.address)] = 0
                    else:
                        if sub_5242e71d[address(this.address)] < arg2:
                            revert with 'NH{q', 17
                        sub_5242e71d[address(this.address)] -= arg2
                    if arg2 >= sub_33f8486f:
                        sub_33f8486f = 0
                    else:
                        if sub_33f8486f < arg2:
                            revert with 'NH{q', 17
                        sub_33f8486f -= arg2
                    if sub_e697af7f > !arg2:
                        revert with 'NH{q', 17
                    sub_e697af7f += arg2
                else:
                    require ext_code.size(sub_837184feAddress)
