...
function uri(uint256 arg1) payable {
    ...
    staticcall address(ext_call.return_data[0]).getTokenURI(uint256 arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function renderTokenURI(uint256 arg1, address arg2) payable {
    ...
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).getRenderTokenURI(uint256 arg1, address arg2) with:
            gas gas_remaining wei
           args arg1, arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
