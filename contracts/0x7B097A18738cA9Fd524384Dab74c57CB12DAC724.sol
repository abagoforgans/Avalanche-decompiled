...
function addressMintAvailable(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    return (stor9[address(arg1)] < 1)
}
    ...
    if bool(stor10.length):
        ...
        if stor6[stor8].field_0:
            if stor6[stor8].field_0 == stor6[stor8].field_1 < 32:
                revert with 'NH{q', 34
            if stor10.length.field_1:
                stor6[stor8][].field_0 = Array(len=stor10.length.field_1, data=mem[128 len stor10.length.field_1])
            else:
...
function claim(address arg1) payable {
    ...
    staticcall governanceAddress.getVote(uint256 rg1, address rg2) with:
            gas gas_remaining wei
           args 1, msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if bool(stor10.length):
        ...
        if bool(stor10.length):
            ...
            if stor10.length.field_1:
                if 31 >= stor10.length.field_1:
                    mem[(2 * ceil32(return_data.size)) + 128] = 256 * stor10.length.field_8
                else:
                    mem[(2 * ceil32(return_data.size)) + 128] = uint256(stor10.field_0)
                    idx = (2 * ceil32(return_data.size)) + 128
                    s = 0
                    while (2 * ceil32(return_data.size)) + stor10.length.field_1 + 96 > idx:
                        mem[idx + 32] = stor10[s].field_256
                        idx = idx + 32
                        s = s + 1
                        continue 
        ...
        if stor6[stor8].field_0:
            if stor6[stor8].field_0 == stor6[stor8].field_1 < 32:
                revert with 'NH{q', 34
            if stor10.length.field_1:
                stor6[stor8][].field_0 = Array(len=stor10.length.field_1, data=mem[(2 * ceil32(return_data.size)) + 128 len stor10.length.field_1])
            else:
                stor6[stor8].field_0 = 0
                idx = 0
                while stor6[stor8].field_1 + 31 / 32 > idx:
