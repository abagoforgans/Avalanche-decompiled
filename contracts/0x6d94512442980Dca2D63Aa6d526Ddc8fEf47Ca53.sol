...
address sub_adb266cbAddress;
address sub_9a1f0282Address;
...
function sub_9a1f0282(?) {
    return sub_9a1f0282Address
}
...
function sub_adb266cb(?) {
    return sub_adb266cbAddress
}
...
function deposit() {
    ...
    if ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor14), uint32(stor14), ext_call.return_data[0 len 28]
            mem[488 len 0] = 0
            call wantAddress with:
               funct uint32(stor14)
                 gas gas_remaining wei
            ...
            if not return_data.size:
                if not ext_call.return_data[0]:
                    if not ext_code.size(wantAddress):
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 425 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor14), uint32(stor14), ext_call.return_data[0 len 28]
