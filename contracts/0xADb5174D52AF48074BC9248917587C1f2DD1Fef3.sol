...
function sub_2b8820d8(?) {
    ...
    if address(cd[((32 * cd[(cd[36] + ('cd', 36)[1] + 4)] - 1) + cd[36] + ('cd', 36)[1] + 36)]) != pngAddress:
        revert with 0, '!png'
    require ('cd', 36)[1] < calldata.size + -cd[36] - 35
    require cd[(cd[36] + ('cd', 36)[1] + 4)] <= test266151307()
    require cd[36] + ('cd', 36)[1] + 36 <= calldata.size - (32 * cd[(cd[36] + ('cd', 36)[1] + 4)])
    ...
    if mem[_49]:
        ...
        if not mem[_49]:
            revert with 0, 18
        if sub_1c5e3ae3 > !((10^18 * _46) - (10^18 * ext_call.return_data[0]) / mem[_49]):
            revert with 0, 17
        sub_1c5e3ae3 += (10^18 * _46) - (10^18 * ext_call.return_data[0]) / mem[_49]
}
...
function sub_2ebafe83(?) {
    ...
    if ext_call.return_data[0]:
        ...
        mem[(4 * ceil32(return_data.size)) + 96] = _272
        ...
        if mem[_531]:
            ...
            if not mem[_531]:
                revert with 0, 18
            if sub_1c5e3ae3 > !((10^18 * _520) - (10^18 * ext_call.return_data[0]) / mem[_531]):
                revert with 0, 17
            sub_1c5e3ae3 += (10^18 * _520) - (10^18 * ext_call.return_data[0]) / mem[_531]
    else:
        ...
        if not return_data.size:
            ...
            if not ext_call.return_data[0]:
                ...
                mem[(6 * ceil32(return_data.size)) + 260] = _536
                ...
                if mem[_690]:
                    ...
                    if not mem[_690]:
                        revert with 0, 18
                    if sub_1c5e3ae3 > !((10^18 * _666) - (10^18 * ext_call.return_data[0]) / mem[_690]):
                        revert with 0, 17
                    sub_1c5e3ae3 += (10^18 * _666) - (10^18 * ext_call.return_data[0]) / mem[_690]
            else:
                ...
                if ceil32(32 * mem[(4 * ceil32(return_data.size)) + mem[(4 * ceil32(return_data.size)) + 260 len 4], Mask(224, 32, ('cd', 36).length) >> 32 + 260]) + 1 < 0 or (6 * ceil32(return_data.size)) + ceil32(32 * mem[(4 * ceil32(return_data.size)) + mem[(4 * ceil32(return_data.size)) + 260 len 4], Mask(224, 32, ('cd', 36).length) >> 32 + 260]) + 261 > test266151307():
                    revert with 0, 65
                mem[64] = (6 * ceil32(return_data.size)) + ceil32(32 * mem[(4 * ceil32(return_data.size)) + mem[(4 * ceil32(return_data.size)) + 260 len 4], Mask(224, 32, ('cd', 36).length) >> 32 + 260]) + 261
                mem[(6 * ceil32(return_data.size)) + 260] = _537
                ...
                if mem[_691]:
                    ...
                    if not mem[_691]:
                        revert with 0, 18
                    if sub_1c5e3ae3 > !((10^18 * _667) - (10^18 * ext_call.return_data[0]) / mem[_691]):
                        revert with 0, 17
                    sub_1c5e3ae3 += (10^18 * _667) - (10^18 * ext_call.return_data[0]) / mem[_691]
        else:
            ...
            if not return_data.size:
                ...
                mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 261] = _538
                ...
                if mem[_692]:
                    ...
                    if not mem[_692]:
                        revert with 0, 18
                    if sub_1c5e3ae3 > !((10^18 * _668) - (10^18 * ext_call.return_data[0]) / mem[_692]):
                        revert with 0, 17
                    sub_1c5e3ae3 += (10^18 * _668) - (10^18 * ext_call.return_data[0]) / mem[_692]
            else:
                require return_data.size >= 32
                ...
                if ceil32(32 * mem[(4 * ceil32(return_data.size)) + ceil32(return_data.size) + mem[(4 * ceil32(return_data.size)) + ceil32(return_data.size) + 261 len 4], Mask(224, 32, ('cd', 36).length) >> 32 + 261]) + 1 < 0 or (6 * ceil32(return_data.size)) + ceil32(return_data.size) + ceil32(32 * mem[(4 * ceil32(return_data.size)) + ceil32(return_data.size) + mem[(4 * ceil32(return_data.size)) + ceil32(return_data.size) + 261 len 4], Mask(224, 32, ('cd', 36).length) >> 32 + 261]) + 262 > test266151307():
                    revert with 0, 65
                mem[64] = (6 * ceil32(return_data.size)) + ceil32(return_data.size) + ceil32(32 * mem[(4 * ceil32(return_data.size)) + ceil32(return_data.size) + mem[(4 * ceil32(return_data.size)) + ceil32(return_data.size) + 261 len 4], Mask(224, 32, ('cd', 36).length) >> 32 + 261]) + 262
                mem[(6 * ceil32(return_data.size)) + ceil32(return_data.size) + 261] = _539
                ...
                if mem[_693]:
                    ...
                    if not mem[_693]:
                        revert with 0, 18
                    if sub_1c5e3ae3 > !((10^18 * _669) - (10^18 * ext_call.return_data[0]) / mem[_693]):
                        revert with 0, 17
                    sub_1c5e3ae3 += (10^18 * _669) - (10^18 * ext_call.return_data[0]) / mem[_693]
}
