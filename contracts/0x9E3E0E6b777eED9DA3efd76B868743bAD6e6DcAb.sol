...
const FARMING_POOL_REWARD_ALLOCATION = 40000 * 10^18
...
function distributeReward(address arg1) payable {
    ...
    stor15 = 1
    if totalSupply + 40000 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 40000 * 10^18
    if balanceOf[address(arg1)] + 40000 * 10^18 < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 40000 * 10^18
    emit Transfer(40000 * 10^18, 0, arg1);
}
