...
function sub_2a3263ae(?) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(BNBAddress)
    call BNBAddress.0xa9059cbb with:
         gas gas_remaining wei
    ...
    require ext_code.size(address(arg1))
    if ext_call.return_data[12 len 20] == BNBAddress:
        staticcall address(arg1).token0() with:
                gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
...
function sub_835dd5c6(?) {
    ...
    if ext_call.return_data[12 len 20] == BNBAddress:
        ...
        require ext_code.size(BNBAddress)
        call BNBAddress.0x2e1a7d4d with:
             gas gas_remaining wei
        ...
        require ext_call.return_data[0] == ext_call.return_data[0]
        if owner != msg.sender:
            revert with 0, 'Ownable: caller is not the owner', mem[(18 * ceil32(return_data.size)) + 324 len 9 * ceil32(return_data.size)]
        if ext_call.return_data[0] <= 0:
            revert with 0, 'W1-R1', mem[(18 * ceil32(return_data.size)) + 324 len 9 * ceil32(return_data.size)]
        if eth.balance(this.address) <= 0:
            revert with 0, 'W1-R2', mem[(18 * ceil32(return_data.size)) + 324 len 9 * ceil32(return_data.size)]
        call owner with:
           value eth.balance(this.address) wei
             gas 2300 * is_zero(value) wei
        if not ext_call.success:
        ...
        staticcall BNBAddress.0x70a08231 with:
                gas gas_remaining wei
               args address(this.address), mem[(18 * ceil32(return_data.size)) + 260 len 9 * ceil32(return_data.size)]
    else:
        staticcall address(arg1).token1() with:
                gas gas_remaining wei
        if not ext_call.success:
        ...
        require ext_call.return_data[0] == ext_call.return_data[0]
        if owner != msg.sender:
            revert with 0, 'Ownable: caller is not the owner', mem[(19 * ceil32(return_data.size)) + 324 len 9 * ceil32(return_data.size)]
        if ext_call.return_data[0] <= 0:
            revert with 0, 'W1-R1', mem[(19 * ceil32(return_data.size)) + 324 len 9 * ceil32(return_data.size)]
        if eth.balance(this.address) <= 0:
            revert with 0, 'W1-R2', mem[(19 * ceil32(return_data.size)) + 324 len 9 * ceil32(return_data.size)]
        call owner with:
           value eth.balance(this.address) wei
             gas 2300 * is_zero(value) wei
        if not ext_call.success:
        ...
        staticcall BNBAddress.0x70a08231 with:
                gas gas_remaining wei
               args address(this.address), mem[(19 * ceil32(return_data.size)) + 260 len 9 * ceil32(return_data.size)]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
