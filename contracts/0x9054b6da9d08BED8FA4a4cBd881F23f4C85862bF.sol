...
function sub_0513ec06(?) payable {
    ...
    while idx < ('cd', 68).length:
        ...
        call address(cd[4]).0x23b872dd with:
             gas gas_remaining wei
            args msg.sender, address(cd[36]), cd[((32 * idx) + cd[68] + 36)]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if idx == -1:
            revert with 0, 17
...
function sub_5f081fb0(?) payable {
    ...
    idx = 0
    while idx < arg3:
        if ext_call.return_data[0] - 1 < idx:
            revert with 0, 17
        mem[mem[64] + 4] = msg.sender
        ...
        staticcall address(arg1).tokenOfOwnerByIndex(address arg1, uint256 arg2) with:
                gas gas_remaining wei
               args msg.sender, ext_call.return_data[0] + -idx - 1
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _13 = mem[64]
        ...
        call address(arg1).0x23b872dd with:
             gas gas_remaining wei
            args msg.sender, address(arg2), _14
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if idx == -1:
            revert with 0, 17
