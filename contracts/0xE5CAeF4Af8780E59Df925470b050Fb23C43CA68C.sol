...
function setLocker(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
...
function sub_cc640f8d(?) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if cd[4] != 0x64742617c0aa6b3831acf1f3ee50863e43760bca8a8f03d043da5be46d4cfe03:
        revert with 0, 'TD: bad action'
    ...
    if totalSupply > !('cd', 36)[1]:
        revert with 0, 17
    totalSupply += ('cd', 36)[1]
    if balanceOf[address(('cd', 36)[0])] > !('cd', 36)[1]:
        revert with 0, 17
    balanceOf[address(('cd', 36)[0])] += ('cd', 36)[1]
    emit Transfer(('cd', 36)[1], 0, address(('cd', 36)[0]));
}
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if not lockerAddress:
        ...
        call lockerAddress.lockOrGetPenalty(address arg1, address arg2) with:
