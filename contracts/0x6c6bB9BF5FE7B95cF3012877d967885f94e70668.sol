...
function onFlashLoan(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes arg5) payable {
    ...
    if not cd[(arg5 + 36)]:
        ...
        mem[(11 * ceil32(return_data.size)) + 132] = arg3 + arg4
        require ext_code.size(0xd586e7f844cea2f87f50152665bcbc2c279d8d70)
        call 0xd586e7f844cea2f87f50152665bcbc2c279d8d70.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
        ...
        mem[(12 * ceil32(return_data.size)) + 164] = ext_call.return_data[0] - arg3 - arg4
        ...
        mem[(12 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), 0x585845b853f6a37b159bd8dc, 0, ext_call.return_data[0] - arg3 - arg4, 0
        mem[(12 * ceil32(return_data.size)) + 328] = 0
        call 0xd586e7f844cea2f87f50152665bcbc2c279d8d70 with:
           funct Mask(32, 224, unknown_0xa9059cbb(?????), 0x585845b853f6a37b159bd8dc, 0, ext_call.return_data[0] - arg3 - arg4, 0) >> 224
             gas gas_remaining wei
            args (Mask(512, -288, unknown_0xa9059cbb(?????), 0x585845b853f6a37b159bd8dc, 0, ext_call.return_data[0] - arg3 - arg4, 0) << 288)
        ...
        mem[(12 * ceil32(return_data.size)) + 132] = arg3 + arg4
        require ext_code.size(0xd586e7f844cea2f87f50152665bcbc2c279d8d70)
        call 0xd586e7f844cea2f87f50152665bcbc2c279d8d70.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args msg.sender, arg3 + arg4
        ...
        mem[(13 * ceil32(return_data.size)) + 164] = ext_call.return_data[0] - arg3 - arg4
        ...
        if not ext_code.size(0xd586e7f844cea2f87f50152665bcbc2c279d8d70):
            revert with 0, 'Address: call to non-contract'
        mem[(13 * ceil32(return_data.size)) + 260 len 96] = unknown_0xa9059cbb(?????), 0x585845b853f6a37b159bd8dc, 0, ext_call.return_data[0] - arg3 - arg4, 0
