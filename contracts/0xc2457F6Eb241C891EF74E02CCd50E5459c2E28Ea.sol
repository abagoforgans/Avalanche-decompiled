...
function sub_37f7e53e(?) {
    return bool(sub_37f7e53e)
}
...
function calculateFee() {
    if bool(sub_37f7e53e) != 1:
        revert with 0, 'Sale hasn't started'
    if tokenByIndex.length >= 68:
        return 10000 * 10^18
    if tokenByIndex.length >= 60:
        return 1000 * 10^18
    if tokenByIndex.length >= 48:
        return 500 * 10^18
    if tokenByIndex.length >= 24:
        return 100 * 10^18
    if tokenByIndex.length >= 12:
        return 50 * 10^18
    if tokenByIndex.length < 4:
        return 10^18
    return 2 * 10^18
}
