...
function sub_987b22be(?) payable {
    ...
    emit 0x2c26753f: sub_5e39986fAddress, stor7, tx.origin, 448, arg4, 0, 0, arg5, arg2 << 192, arg6 << 192, arg7, arg8 << 248, uint8(arg9), block.timestamp, arg3.length, arg3[all], Mask(8 * ceil32(arg3.length) - arg3.length, -(8 * ceil32(arg3.length) + -ceil32(ceil32(arg3.length)) + 31) + 256, 0) >> -(8 * ceil32(arg3.length) + -ceil32(ceil32(arg3.length)) + 31) + 256, msg.sender, address(arg1), address(arg2)
    return stor7
}
