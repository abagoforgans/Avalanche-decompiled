    ...
    if sub_48996015Address == WAVAXAddress:
        ...
        if sub_48996015Address == WAVAXAddress:
            ...
            call routerAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args _815, _1364, 160, address(this.address), block.timestamp, mem[mem[64] + 164 len (32 * _1382) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _1544 = mem[64]
            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if assetAddress == WAVAXAddress:
                ...
                call routerAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args _815, _1368, 160, address(this.address), block.timestamp, mem[mem[64] + 164 len (32 * _1384) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _1546 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        if assetAddress == WAVAXAddress:
            ...
            if sub_48996015Address == WAVAXAddress:
                ...
                if assetAddress == WAVAXAddress:
                    ...
                    call routerAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args _817, _1378, 160, address(this.address), block.timestamp, mem[mem[64] + 164 len (32 * _1389) + 32]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1551 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            mem[(2 * ceil32(return_data.size)) + 224] = _498
            ...
            if sub_48996015Address == WAVAXAddress:
                ...
                if assetAddress == WAVAXAddress:
                    ...
                    call routerAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args _816, _1374, 160, address(this.address), block.timestamp, mem[mem[64] + 164 len (32 * _1387) + 32]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1549 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                    ...
                    call routerAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args _816, _1372, 160, address(this.address), block.timestamp, mem[mem[64] + 164 len (32 * _1386) + 32]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1548 = mem[64]
                    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
