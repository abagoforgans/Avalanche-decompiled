...
function sub_792e9e61(?) payable {
    ...
    require ext_code.size(0x5087706dd31962938c57a0fb3a3107ed3794c996)
    staticcall 0x5087706dd31962938c57a0fb3a3107ed3794c996.token0() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    require ext_code.size(0x5087706dd31962938c57a0fb3a3107ed3794c996)
    staticcall 0x5087706dd31962938c57a0fb3a3107ed3794c996.getReserves() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 96
...
function sub_72ba0ebb(?) payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0x910f038c9e74df8baed886a22f75c69fae8a6792)
    call 0x910f038c9e74df8baed886a22f75c69fae8a6792.forfeit() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[100] = this.address
    require ext_code.size(0xa0998e0eae80ab5425071d3f669c858e26e34352)
    staticcall 0xa0998e0eae80ab5425071d3f669c858e26e34352.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    mem[ceil32(return_data.size) + 100] = 0x910f038c9e74df8baed886a22f75c69fae8a6792
    mem[ceil32(return_data.size) + 132] = ext_call.return_data[0]
    require ext_code.size(0xa0998e0eae80ab5425071d3f669c858e26e34352)
    call 0xa0998e0eae80ab5425071d3f669c858e26e34352.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args 0x910f038c9e74df8baed886a22f75c69fae8a6792, ext_call.return_data[0]
    ...
    require ext_code.size(0x910f038c9e74df8baed886a22f75c69fae8a6792)
    call 0x910f038c9e74df8baed886a22f75c69fae8a6792.unstake(uint256 arg1, bool arg2) with:
         gas gas_remaining wei
        args ext_call.return_data[0], 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[(2 * ceil32(return_data.size)) + 100] = this.address
    require ext_code.size(0x353af195c0d82820c59427bfbd318a49971aae1a)
    staticcall 0x353af195c0d82820c59427bfbd318a49971aae1a.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    mem[(4 * ceil32(return_data.size)) + 128] = 0x353af195c0d82820c59427bfbd318a49971aae1a
    mem[(4 * ceil32(return_data.size)) + 160] = 0x130966628846bfd36ff31a822705796e8cb8c18d
    ...
    require ext_code.size(0x353af195c0d82820c59427bfbd318a49971aae1a)
    call 0x353af195c0d82820c59427bfbd318a49971aae1a.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
    ...
    require ext_code.size(0x910f038c9e74df8baed886a22f75c69fae8a6792)
    call 0x910f038c9e74df8baed886a22f75c69fae8a6792.epoch() with:
         gas gas_remaining wei
...
function sub_8fdadfc1(?) payable {
    require ext_code.size(0x910f038c9e74df8baed886a22f75c69fae8a6792)
    staticcall 0x910f038c9e74df8baed886a22f75c69fae8a6792.0xdeac361a with:
            gas gas_remaining wei
    mem[96] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if uint8(stor1.field_160):
        ...
        if block.timestamp < uint128(stor1.field_0):
            revert with 0, '1e'
        require ext_code.size(0x910f038c9e74df8baed886a22f75c69fae8a6792)
        call 0x910f038c9e74df8baed886a22f75c69fae8a6792.rebase() with:
             gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(0x910f038c9e74df8baed886a22f75c69fae8a6792)
        call 0x910f038c9e74df8baed886a22f75c69fae8a6792.claim(address arg1) with:
             gas gas_remaining wei
            args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[0]
        mem[(4 * ceil32(return_data.size)) + 100] = 0x910f038c9e74df8baed886a22f75c69fae8a6792
        ...
        mem[(7 * ceil32(return_data.size)) + 128] = 0x353af195c0d82820c59427bfbd318a49971aae1a
        mem[(7 * ceil32(return_data.size)) + 160] = 0x130966628846bfd36ff31a822705796e8cb8c18d
        ...
        call 0x60ae616a2155ee3d9a68541ba4544862310933d4.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args ext_call.return_data[0], 0, 160, address(this.address), 3 * 10^10, mem[(8 * ceil32(return_data.size)) + 356 len (32 * mem[(7 * ceil32(return_data.size)) + 96]) + 32]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        require return_data.size >= 32
        _79 = mem[(8 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[0 len 28]
        ...
        _80 = mem[(8 * ceil32(return_data.size)) + mem[(8 * ceil32(return_data.size)) + 192 len 4], ext_call.return_data[0 len 28] + 192]
        ...
        idx = 0
        s = (8 * ceil32(return_data.size)) + _79 + 224
        ...
        require ext_call.return_data[0] == ext_call.return_data[0]
        mem[(4 * ceil32(return_data.size)) + 96] = 2
        mem[(4 * ceil32(return_data.size)) + 128] = 0x130966628846bfd36ff31a822705796e8cb8c18d
        mem[(4 * ceil32(return_data.size)) + 160] = 0x353af195c0d82820c59427bfbd318a49971aae1a
        require ext_code.size(0x5087706dd31962938c57a0fb3a3107ed3794c996)
        staticcall 0x5087706dd31962938c57a0fb3a3107ed3794c996.token0() with:
                gas gas_remaining wei
        mem[(4 * ceil32(return_data.size)) + 192] = ext_call.return_data[0]
        ...
        if address(ext_call.return_data[0]) == 0x130966628846bfd36ff31a822705796e8cb8c18d:
            ...
            if Mask(192, 0, ext_call.return_data[18 len 14] + Mask(192, 0, ext_call.return_data[0])) and Mask(192, 0, ext_call.return_data[50 len 14] - Mask(192, 0, Mask(192, 0, Mask(192, 0, uint32(-stor0 + 10000) * Mask(192, 0, ext_call.return_data[0])) * ext_call.return_data[50 len 14]) / Mask(192, 0, Mask(112, 0, 10000 * ext_call.return_data[18 len 14]) + Mask(192, 0, uint32(-stor0 + 10000) * Mask(192, 0, ext_call.return_data[0]))))) > 0xffffffffffffffffffffffffffffffffffffffffffffffff / Mask(192, 0, ext_call.return_data[18 len 14] + Mask(192, 0, ext_call.return_data[0])):
                revert with 'NH{q', 17
            mem[(8 * ceil32(return_data.size)) + 196] = 0x60ae616a2155ee3d9a68541ba4544862310933d4
            ...
            mem[mem[64] + 4] = 0x910f038c9e74df8baed886a22f75c69fae8a6792
            mem[mem[64] + 36] = _200
            require ext_code.size(0x353af195c0d82820c59427bfbd318a49971aae1a)
            call 0x353af195c0d82820c59427bfbd318a49971aae1a.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args 0x910f038c9e74df8baed886a22f75c69fae8a6792, _200
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _206 = mem[64]
            ...
            require ext_code.size(0x910f038c9e74df8baed886a22f75c69fae8a6792)
            call 0x910f038c9e74df8baed886a22f75c69fae8a6792.stake(uint256 arg1, address arg2) with:
                 gas gas_remaining wei
            ...
            call 0x353af195c0d82820c59427bfbd318a49971aae1a.approve(address arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args 0x910f038c9e74df8baed886a22f75c69fae8a6792, _201
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _207 = mem[64]
