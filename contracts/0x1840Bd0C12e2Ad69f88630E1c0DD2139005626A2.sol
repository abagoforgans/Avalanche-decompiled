    ...
    if not return_data.size:
        if not stor0[ext_call.return_data[12 len 20]]:
            ...
            if not stor2[address(ext_call.return_data[0])]:
                return 0
            if ext_call.return_data[0] * stor2[address(ext_call.return_data[0])] / stor2[address(ext_call.return_data[0])] != ext_call.return_data[0]:
                revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[233 len 31]
    ...
    if not arg1.length:
        ...
        while idx < arg1.length:
            if cEtherAddress == address(cd[((32 * idx) + arg1 + 36)]):
                ...
                mem[mem[64]] = 4
                mem[64] = mem[64] + 36
                mem[_214 + 32] = 0x182df0f500000000000000000000000000000000000000000000000000000000 or mem[_214 + 36 len 28]
                _217 = mem[_214]
                t = _214 + 32
                u = mem[64]
                s = mem[_214]
                while s >= 32:
                    ...
                    s = s - 32
                    continue 
                mem[mem[64] + floor32(mem[_214])] = mem[_214 + floor32(mem[_214]) + -(mem[_214] % 32) + 64 len mem[_214] % 32] or Mask(8 * -(mem[_214] % 32) + 32, -(8 * -(mem[_214] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_214])])
                staticcall address(cd[((32 * idx) + arg1 + 36)]).mem[mem[64] len 4] with:
                        gas gas_remaining wei
                       args mem[mem[64] + 4 len _217 + _214 + -mem[64] + 32]
                if return_data.size:
                    _422 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size) + 1
                    mem[_422] = return_data.size
                    mem[_422 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                if not ext_call.success:
        ...
        while idx < arg1.length:
            if cEtherAddress == address(cd[((32 * idx) + arg1 + 36)]):
                ...
                mem[mem[64]] = 4
                mem[64] = mem[64] + 36
                mem[_220 + 32] = 0x182df0f500000000000000000000000000000000000000000000000000000000 or mem[_220 + 36 len 28]
                t = _220 + 32
                u = _220 + 36
                s = mem[_220]
                while s >= 32:
                    ...
                    s = s - 32
                    continue 
                mem[_220 + floor32(mem[_220]) + 36] = mem[_220 + -(mem[_220] % 32) + floor32(mem[_220]) + 64 len mem[_220] % 32] or Mask(8 * -(mem[_220] % 32) + 32, -(8 * -(mem[_220] % 32) + 32) + 256, mem[_220 + floor32(mem[_220]) + 36])
                staticcall address(cd[((32 * idx) + arg1 + 36)]).mem[_220 + 36 len 4] with:
                        gas gas_remaining wei
                       args mem[_220 + 40 len mem[_220] - 4]
                if not return_data.size:
                    if not ext_call.success:
                        mem[32] = 0
                        if not stor0[address(cd[((32 * idx) + arg1 + 36)])]:
                            ...
                            staticcall stor0[address(cd[((32 * idx) + arg1 + 36)])].latestRoundData() with:
                                    gas gas_remaining wei
                            mem[_220 + 36 len 160] = ext_call.return_data[0 len 160]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 160
                            mem[0] = address(cd[((32 * idx) + arg1 + 36)])
                        ...
                        staticcall address(cd[((32 * idx) + arg1 + 36)]).underlying() with:
                                gas gas_remaining wei
                        mem[_220 + 36] = ext_call.return_data[0]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        mem[32] = 0
                        if not stor0[ext_call.return_data[12 len 20]]:
                            ...
                            if not stor2[address(ext_call.return_data[0])]:
                                ...
                                if not stor2[address(ext_call.return_data[0])]:
                                    ...
                                    if ext_call.return_data[0] * stor2[address(ext_call.return_data[0])] / stor2[address(ext_call.return_data[0])] != ext_call.return_data[0]:
                                        revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[_220 + 137 len 31]
                                    require idx < mem[96]
                                    mem[(32 * idx) + 128] = ext_call.return_data[0] * stor2[address(ext_call.return_data[0])] / 10^18
                        else:
                            require ext_code.size(stor0[ext_call.return_data[12 len 20]])
                    ...
                    mem[64] = _220 + ceil32(return_data.size) + 37
                    mem[_220 + 36] = return_data.size
                    mem[_220 + 68 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    if not ext_call.success:
                        mem[32] = 0
                        if not stor0[address(cd[((32 * idx) + arg1 + 36)])]:
                            mem[0] = address(cd[((32 * idx) + arg1 + 36)])
                            ...
                            staticcall stor0[address(cd[((32 * idx) + arg1 + 36)])].latestRoundData() with:
                                    gas gas_remaining wei
                            mem[_220 + ceil32(return_data.size) + 37 len 160] = ext_call.return_data[0 len 160]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 160
                            mem[0] = address(cd[((32 * idx) + arg1 + 36)])
                        ...
                        staticcall address(cd[((32 * idx) + arg1 + 36)]).underlying() with:
                                gas gas_remaining wei
                        mem[_220 + ceil32(return_data.size) + 37] = ext_call.return_data[0]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        mem[32] = 0
                                ...
                                if not stor2[address(ext_call.return_data[0])]:
                                    ...
                                    if ext_call.return_data[0] * stor2[address(ext_call.return_data[0])] / stor2[address(ext_call.return_data[0])] != ext_call.return_data[0]:
                                        revert with 0, 
                                                    ...
                                                    33,
                                                    0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                                    mem[_220 + ceil32(return_data.size) + 138 len 31]
                                    require idx < mem[96]
                                    mem[(32 * idx) + 128] = ext_call.return_data[0] * stor2[address(ext_call.return_data[0])] / 10^18
                        else:
                            require ext_code.size(stor0[ext_call.return_data[12 len 20]])
