...
function reinvest() payable {
    ...
    if sub_48996015Address == WAVAXAddress:
        ...
        mem[(2 * ceil32(return_data.size)) + 192] = _497
        ...
        if sub_48996015Address == WAVAXAddress:
            ...
            while idx < _1148:
                ...
                continue 
            require 1 < _1148
            _1364 = mem[_1130 + ceil32(return_data.size) + 64]
            _1365 = mem[64]
            ...
            while idx < _1562:
                ...
                t = t + 32
                continue 
            require 1 < mem[(2 * ceil32(return_data.size)) + 192]
            _1679 = mem[(2 * ceil32(return_data.size)) + 256]
            ...
            if assetAddress == WAVAXAddress:
                ...
                while idx < _1150:
                    ...
                    continue 
                require 1 < _1150
                _1368 = mem[_1132 + ceil32(return_data.size) + 64]
                _1369 = mem[64]
                mem[mem[64]] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                mem[mem[64] + 4] = _815
                mem[mem[64] + 36] = _1368
                ...
                while idx < _1564:
                    ...
                    continue 
                require 1 < mem[(2 * ceil32(return_data.size)) + 192]
                _1681 = mem[(2 * ceil32(return_data.size)) + 256]
                mem[mem[64] + 4] = lendingPoolAddress
                mem[mem[64] + 36] = _1681
                require ext_code.size(assetAddress)
                call assetAddress.approve(address arg1, uint256 arg2) with:
                ...
                while idx < _1149:
                    ...
                    continue 
                require 1 < _1149
                _1366 = mem[_1131 + ceil32(return_data.size) + 64]
                _1367 = mem[64]
                mem[mem[64]] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                mem[mem[64] + 4] = _815
                mem[mem[64] + 36] = _1366
                ...
                while idx < _1563:
                    ...
                    continue 
                require 1 < mem[(2 * ceil32(return_data.size)) + 192]
                _1680 = mem[(2 * ceil32(return_data.size)) + 256]
                mem[mem[64] + 4] = lendingPoolAddress
                mem[mem[64] + 36] = _1680
                require ext_code.size(assetAddress)
                call assetAddress.approve(address arg1, uint256 arg2) with:
        ...
        if assetAddress == WAVAXAddress:
            ...
            require (2 * ceil32(return_data.size)) + (32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], ext_call.return_data[0 len 28] + 192]) + 224 <= test266151307() and (32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], ext_call.return_data[0 len 28] + 192]) + 32 >= 0
            mem[64] = (2 * ceil32(return_data.size)) + (32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], ext_call.return_data[0 len 28] + 192]) + 224
            mem[(2 * ceil32(return_data.size)) + 192] = _499
            ...
            if sub_48996015Address == WAVAXAddress:
                ...
                while idx < _1154:
                    ...
                    continue 
                require 1 < _1154
                _1376 = mem[_1136 + ceil32(return_data.size) + 64]
                _1377 = mem[64]
                mem[mem[64]] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                mem[mem[64] + 4] = _817
                mem[mem[64] + 36] = _1376
                ...
                while idx < _1568:
                    ...
                    continue 
                require 1 < mem[(2 * ceil32(return_data.size)) + 192]
                _1685 = mem[(2 * ceil32(return_data.size)) + 256]
                mem[mem[64] + 4] = lendingPoolAddress
                mem[mem[64] + 36] = _1685
                require ext_code.size(assetAddress)
                call assetAddress.approve(address arg1, uint256 arg2) with:
                ...
                if assetAddress == WAVAXAddress:
                    ...
                    while idx < _1156:
                        ...
                        continue 
                    require 1 < _1156
                    _1380 = mem[_1138 + ceil32(return_data.size) + 64]
                    _1381 = mem[64]
                    mem[mem[64]] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                    mem[mem[64] + 4] = _817
                    mem[mem[64] + 36] = _1380
                    ...
                    while idx < _1570:
                        ...
                        continue 
                    require 1 < mem[(2 * ceil32(return_data.size)) + 192]
                    _1687 = mem[(2 * ceil32(return_data.size)) + 256]
                    mem[mem[64] + 4] = lendingPoolAddress
                    mem[mem[64] + 36] = _1687
                    require ext_code.size(assetAddress)
                    call assetAddress.approve(address arg1, uint256 arg2) with:
                    ...
                    while idx < _1155:
                        ...
                        continue 
                    require 1 < _1155
                    _1378 = mem[_1137 + ceil32(return_data.size) + 64]
                    _1379 = mem[64]
                    mem[mem[64]] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                    mem[mem[64] + 4] = _817
                    mem[mem[64] + 36] = _1378
                    ...
                    while idx < _1569:
                        ...
                        continue 
                    require 1 < mem[(2 * ceil32(return_data.size)) + 192]
                    _1686 = mem[(2 * ceil32(return_data.size)) + 256]
                    mem[mem[64] + 4] = lendingPoolAddress
                    mem[mem[64] + 36] = _1686
                    require ext_code.size(assetAddress)
                    call assetAddress.approve(address arg1, uint256 arg2) with:
            ...
            if sub_48996015Address == WAVAXAddress:
                ...
                while idx < _1151:
                    ...
                    continue 
                require 1 < _1151
                _1370 = mem[_1133 + ceil32(return_data.size) + 64]
                _1371 = mem[64]
                mem[mem[64]] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                mem[mem[64] + 4] = _816
                mem[mem[64] + 36] = _1370
                ...
                while idx < _1565:
                    ...
                    t = t + 32
                    continue 
                require 1 < mem[(2 * ceil32(return_data.size)) + 224]
                _1682 = mem[(2 * ceil32(return_data.size)) + 288]
                mem[mem[64] + 4] = lendingPoolAddress
                mem[mem[64] + 36] = _1682
                require ext_code.size(assetAddress)
                call assetAddress.approve(address arg1, uint256 arg2) with:
                ...
                if assetAddress == WAVAXAddress:
                    ...
                    while idx < _1153:
                        ...
                        continue 
                    require 1 < _1153
                    _1374 = mem[_1135 + ceil32(return_data.size) + 64]
                    _1375 = mem[64]
                    mem[mem[64]] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                    mem[mem[64] + 4] = _816
                    mem[mem[64] + 36] = _1374
                    ...
                    while idx < _1567:
                        ...
                        continue 
                    require 1 < mem[(2 * ceil32(return_data.size)) + 224]
                    _1684 = mem[(2 * ceil32(return_data.size)) + 288]
                    mem[mem[64] + 4] = lendingPoolAddress
                    mem[mem[64] + 36] = _1684
                    require ext_code.size(assetAddress)
                    call assetAddress.approve(address arg1, uint256 arg2) with:
                    ...
                    while idx < _1152:
                        ...
                        continue 
                    require 1 < _1152
                    _1372 = mem[_1134 + ceil32(return_data.size) + 64]
                    _1373 = mem[64]
                    mem[mem[64]] = 0x38ed173900000000000000000000000000000000000000000000000000000000
                    mem[mem[64] + 4] = _816
                    mem[mem[64] + 36] = _1372
                    ...
                    while idx < _1566:
                        ...
                        continue 
                    require 1 < mem[(2 * ceil32(return_data.size)) + 224]
                    _1683 = mem[(2 * ceil32(return_data.size)) + 288]
                    mem[mem[64] + 4] = lendingPoolAddress
                    mem[mem[64] + 36] = _1683
                    require ext_code.size(assetAddress)
                    call assetAddress.approve(address arg1, uint256 arg2) with:
