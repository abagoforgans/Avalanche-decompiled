...
function earn() {
    ...
    if not ext_code.size(earnedAddress):
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor8), uint32(stor8), ext_call.return_data[0 len 28]
    mem[324 len 0] = 0
    ...
    if not return_data.size:
        if not ext_call.success:
            revert with transfer(address rg1, uint256 rg2), Mask(224, 0, stor8), uint32(stor8), ext_call.return_data[0]
        if not transfer(address rg1, uint256 rg2), Mask(224, 0, stor8):
            revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
    else:
        mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
        if not ext_call.success:
...
function withdraw(uint256 arg1) {
    ...
    if arg1 <= ext_call.return_data[0]:
        if wantLockedTotal >= arg1:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[260 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), Mask(224, 32, arg1) >> 32
            mem[324 len 0] = 0
            call wantAddress with:
               funct uint32(stor6)
                 gas gas_remaining wei
            ...
            if not return_data.size:
                if not ext_call.success:
                    revert with transfer(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), arg1
                if not transfer(address rg1, uint256 rg2), Mask(224, 0, stor6):
                    revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                if isCompound:
                    if not isCompound:
                        revert with 0, '!isCompound'
        ...
        if wantLockedTotal >= ext_call.return_data[0]:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[260 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), ext_call.return_data[0 len 28]
            mem[324 len 0] = 0
            call wantAddress with:
               funct uint32(stor6)
                 gas gas_remaining wei
            ...
            if not return_data.size:
                if not ext_call.success:
                    revert with transfer(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), ext_call.return_data[0]
                if not transfer(address rg1, uint256 rg2), Mask(224, 0, stor6):
                    revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
                if isCompound:
                    if not isCompound:
    ...
    if not ext_code.size(wantAddress):
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = transfer(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), Mask(224, 0, stor10.field_32)
    mem[324 len 0] = 0
    call wantAddress with:
       funct uint32(stor6)
         gas gas_remaining wei
    ...
    if not return_data.size:
        if not ext_call.success:
            revert with transfer(address rg1, uint256 rg2), Mask(224, 0, stor6), uint32(stor6), wantLockedTotal
        if not transfer(address rg1, uint256 rg2), Mask(224, 0, stor6):
            revert with 0, 32, 42, 0x725361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
        if isCompound:
            if not isCompound:
