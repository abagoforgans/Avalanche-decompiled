...
function sub_92e9b038(?) payable {
    ...
    call address(create.new_address).0xa30b519e with:
         gas gas_remaining wei
        args address(arg1), 0xa3d8f38cd14fdb3a2c82eb1100ef0f29da8ef356
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(address(create.new_address))
    call address(create.new_address).0x8d2d6e98 with:
    ...
    call address(create.new_address).0xa30b519e with:
         gas gas_remaining wei
        args address(arg1), 0x5f5c954d6dbcf85655363fefe473942b5a9be9a0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(address(create.new_address))
    call address(create.new_address).0x8d2d6e98 with:
    ...
    call address(create.new_address).0xa30b519e with:
         gas gas_remaining wei
        args address(arg1), 0x151701be0aeabf865e9ff7e80ea0dbe1eb859354
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(address(create.new_address))
    call address(create.new_address).0x8d2d6e98 with:
    ...
    call address(create.new_address).0xa30b519e with:
         gas gas_remaining wei
        args address(arg1), 0x8825e1f926abe93d3d1f30dc6ccc426b8a04d876
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(address(create.new_address))
    call address(create.new_address).0x8d2d6e98 with:
    ...
    call address(create.new_address).0xa30b519e with:
         gas gas_remaining wei
        args address(arg1), 0xd73d63427414f9fa4f0232b5c464bb5561f55012
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(address(create.new_address))
    call address(create.new_address).0x8d2d6e98 with:
    ...
    call address(create.new_address).0xa30b519e with:
         gas gas_remaining wei
        args address(arg1), 0xaf9a2b64a51b814a55ac75b08c21a667d43e5b37
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(address(create.new_address))
    call address(create.new_address).0x8d2d6e98 with:
    ...
    call address(create.new_address).0xa30b519e with:
         gas gas_remaining wei
        args address(arg1), 0x6282339fa1c30e7461e3a11b8371889d54dceb00
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(address(create.new_address))
    call address(create.new_address).0x8d2d6e98 with:
    ...
    call address(create.new_address).0xa30b519e with:
         gas gas_remaining wei
        args address(arg1), 0xc682a319f46bf29f761bce41f7f8cd6e9771a32e
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(address(create.new_address))
    call address(create.new_address).0x8d2d6e98 with:
