...
function getA() payable {
    require ext_code.size(0xf7e37fad39be7e3233c55a76d12797614d67dca9)
    delegate 0xf7e37fad39be7e3233c55a76d12797614d67dca9.0xb0a14cfc with:
...
function getAPrecise() payable {
    require ext_code.size(0xf7e37fad39be7e3233c55a76d12797614d67dca9)
    delegate 0xf7e37fad39be7e3233c55a76d12797614d67dca9.0xc9b64dcb with:
         gas gas_remaining wei
        args 201
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function getVirtualPrice() payable {
    require ext_code.size(0xe055523549492b0564e28737d5188fc46f73f966)
    delegate 0xe055523549492b0564e28737d5188fc46f73f966.0x71906c2c with:
         gas gas_remaining wei
        args 201
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function stopRampA() payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0xf7e37fad39be7e3233c55a76d12797614d67dca9)
    delegate 0xf7e37fad39be7e3233c55a76d12797614d67dca9.0xf14e211e with:
         gas gas_remaining wei
        args 201
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function withdrawAdminFees() payable {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0xe055523549492b0564e28737d5188fc46f73f966)
    delegate 0xe055523549492b0564e28737d5188fc46f73f966.0x24c5c751 with:
         gas gas_remaining wei
        args 201, owner
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function getAdminBalance(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(0xe055523549492b0564e28737d5188fc46f73f966)
    delegate 0xe055523549492b0564e28737d5188fc46f73f966.0x7d048160 with:
         gas gas_remaining wei
        args 201, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function setAdminFee(uint256 arg1) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0xe055523549492b0564e28737d5188fc46f73f966)
    delegate 0xe055523549492b0564e28737d5188fc46f73f966.'pFrv' with:
         gas gas_remaining wei
        args 201, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function setSwapFee(uint256 arg1) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0xe055523549492b0564e28737d5188fc46f73f966)
    delegate 0xe055523549492b0564e28737d5188fc46f73f966.0x467e186c with:
         gas gas_remaining wei
        args 201, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function rampA(uint256 arg1, uint256 arg2) payable {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    require ext_code.size(0xf7e37fad39be7e3233c55a76d12797614d67dca9)
    delegate 0xf7e37fad39be7e3233c55a76d12797614d67dca9.0x58fdd79b with:
         gas gas_remaining wei
        args 201, arg1, arg2
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function calculateRemoveLiquidityOneToken(uint256 arg1, uint8 arg2) payable {
    require calldata.size - 4 >= 64
    require ext_code.size(0xe055523549492b0564e28737d5188fc46f73f966)
    delegate 0xe055523549492b0564e28737d5188fc46f73f966.0xe0692742 with:
         gas gas_remaining wei
        args 201, arg1, arg2
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function calculateSwap(uint8 arg1, uint8 arg2, uint256 arg3) payable {
    ...
    require ext_code.size(0xe055523549492b0564e28737d5188fc46f73f966)
    delegate 0xe055523549492b0564e28737d5188fc46f73f966.'K#`<' with:
         gas gas_remaining wei
...
function calculateTokenAmount(uint256[] arg1, bool arg2) payable {
    ...
    require ext_code.size(0xe055523549492b0564e28737d5188fc46f73f966)
    delegate 0xe055523549492b0564e28737d5188fc46f73f966.0x834b4910 with:
         gas gas_remaining wei
...
function removeLiquidityOneToken(uint256 arg1, uint8 arg2, uint256 arg3, uint256 arg4) payable {
    ...
    require ext_code.size(0xe055523549492b0564e28737d5188fc46f73f966)
    delegate 0xe055523549492b0564e28737d5188fc46f73f966.0xe7a4db81 with:
         gas gas_remaining wei
...
function swap(uint8 arg1, uint8 arg2, uint256 arg3, uint256 arg4, uint256 arg5) payable {
    ...
    if block.timestamp > arg5:
        revert with 0, 'Deadline not met'
    require ext_code.size(0xe055523549492b0564e28737d5188fc46f73f966)
    delegate 0xe055523549492b0564e28737d5188fc46f73f966.0xa5397b22 with:
         gas gas_remaining wei
...
function addLiquidity(uint256[] arg1, uint256 arg2, uint256 arg3) payable {
    ...
    if block.timestamp > arg3:
        revert with 0, 'Deadline not met'
    require ext_code.size(0xe055523549492b0564e28737d5188fc46f73f966)
    delegate 0xe055523549492b0564e28737d5188fc46f73f966.0x40370edf with:
         gas gas_remaining wei
        args 0, 201, 96, arg2, arg1.length, call.data[arg1 + 36 len floor32(arg1.length)]
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function removeLiquidityImbalance(uint256[] arg1, uint256 arg2, uint256 arg3) payable {
    ...
    if block.timestamp > arg3:
        revert with 0, 'Deadline not met'
    require ext_code.size(0xe055523549492b0564e28737d5188fc46f73f966)
    delegate 0xe055523549492b0564e28737d5188fc46f73f966.0x41b91c26 with:
         gas gas_remaining wei
        args 0, 201, 96, arg2, arg1.length, call.data[arg1 + 36 len floor32(arg1.length)]
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function calculateRemoveLiquidity(uint256 arg1) payable {
    ...
    mem[132] = arg1
    require ext_code.size(0xe055523549492b0564e28737d5188fc46f73f966)
    delegate 0xe055523549492b0564e28737d5188fc46f73f966.0x70703e4a with:
         gas gas_remaining wei
        args 201, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function removeLiquidity(uint256 arg1, uint256[] arg2, uint256 arg3) payable {
    ...
    require ext_code.size(0xe055523549492b0564e28737d5188fc46f73f966)
    delegate 0xe055523549492b0564e28737d5188fc46f73f966.0x73fd6b3e with:
         gas gas_remaining wei
