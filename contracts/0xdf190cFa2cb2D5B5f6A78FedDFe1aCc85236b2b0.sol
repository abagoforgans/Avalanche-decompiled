...
function sub_e574973b(?) payable {
    ...
    while idx < ('cd', 4).length:
        ...
        while cd[68] + cd[(cd[68] + (32 * idx) + 36)] + cd[(cd[68] + cd[(cd[68] + (32 * idx) + 36)] + 36)] + 68 > t:
            ...
            continue 
        t = s
        while sha3(sha3(cd[((32 * t) + cd[36] + 36)], sha3(cd[((32 * t) + cd[4] + 36)], 4))) + (stor4[cd[((32 * t) + cd[4] + 36)]][cd[((32 * t) + cd[36] + 36)]].field_1 % 128 + 31 / 32) > t:
            stor[t] = 0
            t = t + 1
            continue 
        if sha3(sha3(cd[((32 * t) + cd[36] + 36)], sha3(cd[((32 * t) + cd[4] + 36)], 4))) + (stor4[cd[((32 * t) + cd[4] + 36)]][cd[((32 * t) + cd[36] + 36)]].field_1 % 128 + 31 / 32) == -1:
            revert with 0, 17
        t = sha3(sha3(cd[((32 * t) + cd[36] + 36)], sha3(cd[((32 * t) + cd[4] + 36)], 4))) + (stor4[cd[((32 * t) + cd[4] + 36)]][cd[((32 * t) + cd[36] + 36)]].field_1 % 128 + 31 / 32) + 1
        continue 
}
