...
function sub_dd6aa4cf(?) payable {
    ...
    if arg4 == 1:
        ...
        if arg4 != 2:
            ...
            staticcall address(arg7).0x41669cfa with:
                    gas gas_remaining wei
            ...
            if not ext_call.return_data[0]:
                require ext_code.size(address(arg7))
                staticcall address(arg7).0xfae160a3 with:
                        gas gas_remaining wei
                       args address(arg5), address(arg6)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if ext_call.return_data[0]:
                    require ext_code.size(address(arg7))
                    call address(arg7).0x3f91c3a5 with:
                         gas gas_remaining wei
                        args address(arg5), address(arg6)
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
...
function getLockMaturity(uint256 arg1) payable {
    ...
    if locks[stor6[arg1]].field_160 == 2:
        ...
        staticcall locks[stor6[arg1]].field_768.0x56167a55 with:
                gas gas_remaining wei
    ...
    staticcall locks[stor6[arg1]].field_0.0x175cec23 with:
            gas gas_remaining wei
