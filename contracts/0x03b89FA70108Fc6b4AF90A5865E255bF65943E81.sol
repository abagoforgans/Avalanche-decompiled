...
function tokenURI(uint256 arg1) {
                ...
                if 31 >= uint255(stor25.length) * 0.5:
                    ...
                    if bool(stor26[arg1].field_0):
                        ...
                        if not arg1:
                            ...
                            return 32, mem[ceil32(stor25.length.field_1 % 128) + stor25.length.field_1 % 128 + 257 len ceil32(mem[ceil32(stor25.length.field_1 % 128) + 192]) + 32], 
                        s = 0
                        idx = arg1
                        while idx:
                            if s == -1:
    ...
    if bool(stor25.length) == stor25.length.field_1 % 128 < 32:
        revert with 0, 34
    if not stor25.length.field_1 % 128:
        if not bool(stor26[arg1].field_0):
            if bool(stor26[arg1].field_0) == stor26[arg1].field_1 % 128 < 32:
                revert with 0, 34
            if stor26[arg1].field_1 % 128 > 0:
                if bool(stor26[arg1].field_0):
