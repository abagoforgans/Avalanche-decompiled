...
function includeInFee(address arg1) payable {
    require calldata.size - 4 >= 32
    if marketingAddress != msg.sender:
        revert with 0, 'incorrect ownership'
...
function sub_cd368261(?) payable {
    require calldata.size - 4 >= 32
    if marketingAddress != msg.sender:
        revert with 0, 'incorrect marketing owner'
    if arg1 > 800:
        revert with 0, 'too large fee'
    marketingFee = arg1
}

function changeMarketingAddress(address arg1) payable {
    require calldata.size - 4 >= 32
    if marketingAddress != msg.sender:
        revert with 0, 'incorrect marketing owner'
    if not arg1:
        revert with 0, 'incorrect marketing addresss'
...
function burnFrom(address arg1, uint256 arg2) payable {
    ...
    if arg2 > allowance[address(arg1)][address(msg.sender)]:
        revert with 0, 32, 36, 0xe045524332303a206275726e20616d6f756e74206578636565647320616c6c6f77616e63, mem[164 len 28], mem[220 len 4]
    if not arg1:
        revert with 0, 32, 36, 0x7345524332303a20617070726f76652066726f6d20746865207a65726f20616464726573, mem[296 len 28]
    if not msg.sender:
        revert with 0, 32, 34, 0x7345524332303a20617070726f766520746f20746865207a65726f20616464726573, mem[294 len 30]
            ...
            if not arg2:
                ...
                if arg2 > balanceOf[address(msg.sender)]:
                    revert with 0, 
                                ...
                                mem[346 len 6]
                balanceOf[address(msg.sender)] -= arg2
                if (marketingFee * arg2 / 10000) + balanceOf[stor7] < balanceOf[stor7]:
                    revert with 0, 'SafeMath: addition overflow'
                balanceOf[stor7] += marketingFee * arg2 / 10000
            ...
            if not arg3:
                ...
                if arg3 > balanceOf[address(arg1)]:
                    revert with 0, 
                                ...
                                mem[346 len 6]
                balanceOf[address(arg1)] -= arg3
                if (marketingFee * arg3 / 10000) + balanceOf[stor7] < balanceOf[stor7]:
                    revert with 0, 'SafeMath: addition overflow'
                balanceOf[stor7] += marketingFee * arg3 / 10000
