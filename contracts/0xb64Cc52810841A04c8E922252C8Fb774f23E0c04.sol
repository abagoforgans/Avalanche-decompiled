...
function sub_cb586244(?) payable {
    ...
    _33 = mem[(32 * arg2.length) + 128 len 4], Mask(224, 32, msg.value) >> 32
    ...
    _36 = mem[(32 * arg2.length) + _33 + 128]
    mem[(32 * arg2.length) + ceil32(return_data.size) + 160 len floor32(mem[(32 * arg2.length) + _33 + 128])] = mem[(32 * arg2.length) + _33 + 160 len floor32(mem[(32 * arg2.length) + _33 + 128])]
    require 1 < mem[(32 * arg2.length) + ceil32(return_data.size) + 128]
    require 1 < arg2.length
    mem[(32 * _36) + (32 * arg2.length) + ceil32(return_data.size) + 324 len floor32(arg2.length)] = call.data[arg2 + 36 len floor32(arg2.length)]
    require ext_code.size(arg1)
    call arg1.swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
       value msg.value wei
         gas gas_remaining wei
        args 0, 128, address(this.address), block.timestamp + 15, arg2.length, call.data[arg2 + 36 len floor32(arg2.length)], mem[(32 * _36) + (32 * arg2.length) + ceil32(return_data.size) + floor32(arg2.length) + 324 len (32 * arg2.length) - floor32(arg2.length)]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return mem[(32 * arg2.length) + ceil32(return_data.size) + 192], ext_call.return_data[0]
}
...
function checkHPAndTaxes(address arg1, address[] arg2) payable {
    ...
    require ext_code.size(arg1)
    call arg1.swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
