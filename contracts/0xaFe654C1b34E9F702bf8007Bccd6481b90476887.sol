...
function swap(uint256 arg1) payable {
    ...
    if arg1 > ext_call.return_data[0]:
        revert with 0, 'You need more SB'
    if arg1 <= 0:
        revert with 0, 'amount is 0'
    require ext_code.size(0x7d1232b90d3f809a54eeaeebc639c62df8a8942f)
    staticcall 0x7d1232b90d3f809a54eeaeebc639c62df8a8942f.0xdd62ed3e with:
            gas gas_remaining wei
    ...
    if ext_call.return_data[0] < arg1:
        revert with 0, 'You need to approve this contract to spend your SB'
    require ext_code.size(0x7d1232b90d3f809a54eeaeebc639c62df8a8942f)
    call 0x7d1232b90d3f809a54eeaeebc639c62df8a8942f.0x23b872dd with:
         gas gas_remaining wei
    ...
    if not arg1:
        ...
        if 0 > ext_call.return_data[0]:
            revert with 0, 'Please wait or contact Snowbank team'
        require ext_code.size(0xa7d7079b0fead91f3e65f86e8915cb59c1a4c664)
