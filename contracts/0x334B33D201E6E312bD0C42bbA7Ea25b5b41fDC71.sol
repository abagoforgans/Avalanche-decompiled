...
function buyEggs(address arg1) payable {
    ...
    if msg.value > 5 * 10^18:
        revert with 0, 'Max investment is 5 AVAX'
        ...
        if not stor2:
            ...
            if not 0 / stor2 + (0 / msg.value):
                ...
                if not msg.value:
                    ...
                    call ceoAddress with:
                       value (14 * msg.value / 100) - (14 * msg.value / 100 / 13) wei
                         gas 2300 * is_zero(value) wei
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    call ceoAddress2 with:
                       value 14 * msg.value / 100 / 13 wei
                         gas 2300 * is_zero(value) wei
                ...
                require 14 * 0 / stor2 + (0 / msg.value) / 0 / stor2 + (0 / msg.value) == 14
                require 14 * 0 / stor2 + (0 / msg.value) / 100 <= 0 / stor2 + (0 / msg.value)
                if not msg.value:
                    call ceoAddress with:
                         gas 2300 wei
                    if not ext_call.success:
                    ...
                    call ceoAddress2 with:
                       value 14 * msg.value / 100 / 13 wei
                         gas 2300 * is_zero(value) wei
                require claimedEggs[address(msg.sender)] + (0 / stor2 + (0 / msg.value)) - (14 * 0 / stor2 + (0 / msg.value) / 100) >= claimedEggs[address(msg.sender)]
                claimedEggs[address(msg.sender)] = claimedEggs[address(msg.sender)] + (0 / stor2 + (0 / msg.value)) - (14 * 0 / stor2 + (0 / msg.value) / 100)
        else:
            require stor2
            ...
            if not 0 / stor2 + (stor2 * msg.value / msg.value):
                ...
                require 14 * 0 / stor2 + (stor2 * msg.value / msg.value) / 0 / stor2 + (stor2 * msg.value / msg.value) == 14
                require 14 * 0 / stor2 + (stor2 * msg.value / msg.value) / 100 <= 0 / stor2 + (stor2 * msg.value / msg.value)
                if not msg.value:
                    call ceoAddress with:
                         gas 2300 wei
                    if not ext_call.success:
                    ...
                    call ceoAddress2 with:
                       value 14 * msg.value / 100 / 13 wei
                         gas 2300 * is_zero(value) wei
                require claimedEggs[address(msg.sender)] + (0 / stor2 + (stor2 * msg.value / msg.value)) - (14 * 0 / stor2 + (stor2 * msg.value / msg.value) / 100) >= claimedEggs[address(msg.sender)]
                claimedEggs[address(msg.sender)] = claimedEggs[address(msg.sender)] + (0 / stor2 + (stor2 * msg.value / msg.value)) - (14 * 0 / stor2 + (stor2 * msg.value / msg.value) / 100)
    else:
        require stor1
        ...
        if not stor1:
            if not stor2:
                ...
                if not stor1 * marketEggs / stor2 + (0 / msg.value):
                    ...
                    require 14 * stor1 * marketEggs / stor2 + (0 / msg.value) / stor1 * marketEggs / stor2 + (0 / msg.value) == 14
                    require 14 * stor1 * marketEggs / stor2 + (0 / msg.value) / 100 <= stor1 * marketEggs / stor2 + (0 / msg.value)
                    if not msg.value:
                        call ceoAddress with:
                             gas 2300 wei
                        if not ext_call.success:
                        ...
                        call ceoAddress2 with:
                           value 14 * msg.value / 100 / 13 wei
                             gas 2300 * is_zero(value) wei
                    require claimedEggs[address(msg.sender)] + (stor1 * marketEggs / stor2 + (0 / msg.value)) - (14 * stor1 * marketEggs / stor2 + (0 / msg.value) / 100) >= claimedEggs[address(msg.sender)]
                    claimedEggs[address(msg.sender)] = claimedEggs[address(msg.sender)] + (stor1 * marketEggs / stor2 + (0 / msg.value)) - (14 * stor1 * marketEggs / stor2 + (0 / msg.value) / 100)
            else:
                require stor2
                require stor2 * msg.value / stor2 == msg.value
                require stor2 * msg.value >= 0
                ...
                if not stor1 * marketEggs / stor2 + (stor2 * msg.value / msg.value):
                    ...
                    require 14 * stor1 * marketEggs / stor2 + (stor2 * msg.value / msg.value) / stor1 * marketEggs / stor2 + (stor2 * msg.value / msg.value) == 14
                    require 14 * stor1 * marketEggs / stor2 + (stor2 * msg.value / msg.value) / 100 <= stor1 * marketEggs / stor2 + (stor2 * msg.value / msg.value)
                    if not msg.value:
                        call ceoAddress with:
                             gas 2300 wei
                        if not ext_call.success:
                        ...
                        call ceoAddress2 with:
                           value 14 * msg.value / 100 / 13 wei
                             gas 2300 * is_zero(value) wei
                    require claimedEggs[address(msg.sender)] + (stor1 * marketEggs / stor2 + (stor2 * msg.value / msg.value)) - (14 * stor1 * marketEggs / stor2 + (stor2 * msg.value / msg.value) / 100) >= claimedEggs[address(msg.sender)]
                    claimedEggs[address(msg.sender)] = claimedEggs[address(msg.sender)] + (stor1 * marketEggs / stor2 + (stor2 * msg.value / msg.value)) - (14 * stor1 * marketEggs / stor2 + (stor2 * msg.value / msg.value) / 100)
        else:
            require stor1
            ...
            if not stor2:
                ...
                if not stor1 * marketEggs / stor2 + ((eth.balance(this.address) * stor1) - (msg.value * stor1) / msg.value):
                    ...
                    require 14 * stor1 * marketEggs / stor2 + ((eth.balance(this.address) * stor1) - (msg.value * stor1) / msg.value) / stor1 * marketEggs / stor2 + ((eth.balance(this.address) * stor1) - (msg.value * stor1) / msg.value) == 14
                    require 14 * stor1 * marketEggs / stor2 + ((eth.balance(this.address) * stor1) - (msg.value * stor1) / msg.value) / 100 <= stor1 * marketEggs / stor2 + ((eth.balance(this.address) * stor1) - (msg.value * stor1) / msg.value)
                    if not msg.value:
                        call ceoAddress with:
                             gas 2300 wei
                        if not ext_call.success:
                        ...
                        call ceoAddress2 with:
                           value 14 * msg.value / 100 / 13 wei
                             gas 2300 * is_zero(value) wei
                    require claimedEggs[address(msg.sender)] + (stor1 * marketEggs / stor2 + ((eth.balance(this.address) * stor1) - (msg.value * stor1) / msg.value)) - (14 * stor1 * marketEggs / stor2 + ((eth.balance(this.address) * stor1) - (msg.value * stor1) / msg.value) / 100) >= claimedEggs[address(msg.sender)]
                    claimedEggs[address(msg.sender)] = claimedEggs[address(msg.sender)] + (stor1 * marketEggs / stor2 + ((eth.balance(this.address) * stor1) - (msg.value * stor1) / msg.value)) - (14 * stor1 * marketEggs / stor2 + ((eth.balance(this.address) * stor1) - (msg.value * stor1) / msg.value) / 100)
            else:
                require stor2
                require stor2 * msg.value / stor2 == msg.value
                require stor2 * msg.value >= 0
                ...
                if not stor1 * marketEggs / stor2 + ((eth.balance(this.address) * stor1) - (msg.value * stor1) + (stor2 * msg.value) / msg.value):
                    ...
                    require 14 * stor1 * marketEggs / stor2 + ((eth.balance(this.address) * stor1) - (msg.value * stor1) + (stor2 * msg.value) / msg.value) / stor1 * marketEggs / stor2 + ((eth.balance(this.address) * stor1) - (msg.value * stor1) + (stor2 * msg.value) / msg.value) == 14
                    require 14 * stor1 * marketEggs / stor2 + ((eth.balance(this.address) * stor1) - (msg.value * stor1) + (stor2 * msg.value) / msg.value) / 100 <= stor1 * marketEggs / stor2 + ((eth.balance(this.address) * stor1) - (msg.value * stor1) + (stor2 * msg.value) / msg.value)
                    if not msg.value:
                        call ceoAddress with:
                             gas 2300 wei
                        if not ext_call.success:
                        ...
                        call ceoAddress2 with:
                           value 14 * msg.value / 100 / 13 wei
                             gas 2300 * is_zero(value) wei
                    require claimedEggs[address(msg.sender)] + (stor1 * marketEggs / stor2 + ((eth.balance(this.address) * stor1) - (msg.value * stor1) + (stor2 * msg.value) / msg.value)) - (14 * stor1 * marketEggs / stor2 + ((eth.balance(this.address) * stor1) - (msg.value * stor1) + (stor2 * msg.value) / msg.value) / 100) >= claimedEggs[address(msg.sender)]
                    claimedEggs[address(msg.sender)] = claimedEggs[address(msg.sender)] + (stor1 * marketEggs / stor2 + ((eth.balance(this.address) * stor1) - (msg.value * stor1) + (stor2 * msg.value) / msg.value)) - (14 * stor1 * marketEggs / stor2 + ((eth.balance(this.address) * stor1) - (msg.value * stor1) + (stor2 * msg.value) / msg.value) / 100)
    require stor3
    if arg1 != msg.sender:
        if not referrals[address(msg.sender)]:
            if referrals[address(msg.sender)] != msg.sender:
            ...
            if not stor1:
                if not stor2:
                    ...
                    if not 0 / stor2 + (0 / claimedEggs[address(msg.sender)]):
                        ...
                        require 14 * 0 / stor2 + (0 / claimedEggs[address(msg.sender)]) / 0 / stor2 + (0 / claimedEggs[address(msg.sender)]) == 14
                        claimedEggs[address(msg.sender)] = 0
                        lastHatch[address(msg.sender)] = block.timestamp
                        require marketEggs + claimedEggs[address(msg.sender)] >= marketEggs
                        marketEggs += claimedEggs[address(msg.sender)]
                        call ceoAddress with:
                           value (14 * 0 / stor2 + (0 / claimedEggs[address(msg.sender)]) / 100) - (14 * 0 / stor2 + (0 / claimedEggs[address(msg.sender)]) / 100 / 13) wei
                             gas 2300 * is_zero(value) wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        call ceoAddress2 with:
                           value 14 * 0 / stor2 + (0 / claimedEggs[address(msg.sender)]) / 100 / 13 wei
                             gas 2300 * is_zero(value) wei
                        require 14 * 0 / stor2 + (0 / claimedEggs[address(msg.sender)]) / 100 <= 0 / stor2 + (0 / claimedEggs[address(msg.sender)])
                        call msg.sender with:
                           value (0 / stor2 + (0 / claimedEggs[address(msg.sender)])) - (14 * 0 / stor2 + (0 / claimedEggs[address(msg.sender)]) / 100) wei
                             gas 2300 * is_zero(value) wei
                else:
                    require stor2
                    ...
                    if not 0 / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)]):
                        ...
                        require 14 * 0 / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)]) / 0 / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)]) == 14
                        claimedEggs[address(msg.sender)] = 0
                        lastHatch[address(msg.sender)] = block.timestamp
                        require marketEggs + claimedEggs[address(msg.sender)] >= marketEggs
                        marketEggs += claimedEggs[address(msg.sender)]
                        call ceoAddress with:
                           value (14 * 0 / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)]) / 100) - (14 * 0 / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)]) / 100 / 13) wei
                             gas 2300 * is_zero(value) wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        call ceoAddress2 with:
                           value 14 * 0 / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)]) / 100 / 13 wei
                             gas 2300 * is_zero(value) wei
                        require 14 * 0 / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)]) / 100 <= 0 / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)])
                        call msg.sender with:
                           value (0 / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)])) - (14 * 0 / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)]) / 100) wei
                             gas 2300 * is_zero(value) wei
            else:
                require stor1
                ...
                if not stor1:
                    if not stor2:
                        ...
                        if not stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)]):
                            ...
                            require 14 * stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)]) / stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)]) == 14
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] >= marketEggs
                            marketEggs += claimedEggs[address(msg.sender)]
                            call ceoAddress with:
                               value (14 * stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)]) / 100) - (14 * stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)]) / 100 / 13) wei
                                 gas 2300 * is_zero(value) wei
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            call ceoAddress2 with:
                               value 14 * stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)]) / 100 / 13 wei
                                 gas 2300 * is_zero(value) wei
                            require 14 * stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)]) / 100 <= stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)])
                            call msg.sender with:
                               value (stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)])) - (14 * stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)]) / 100) wei
                                 gas 2300 * is_zero(value) wei
                    else:
                        require stor2
                        require stor2 * claimedEggs[address(msg.sender)] / stor2 == claimedEggs[address(msg.sender)]
                        ...
                        if not stor1 * eth.balance(this.address) / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)]):
                            ...
                            require 14 * stor1 * eth.balance(this.address) / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)]) / stor1 * eth.balance(this.address) / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)]) == 14
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] >= marketEggs
                            marketEggs += claimedEggs[address(msg.sender)]
                            call ceoAddress with:
                               value (14 * stor1 * eth.balance(this.address) / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)]) / 100) - (14 * stor1 * eth.balance(this.address) / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)]) / 100 / 13) wei
                                 gas 2300 * is_zero(value) wei
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            call ceoAddress2 with:
                               value 14 * stor1 * eth.balance(this.address) / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)]) / 100 / 13 wei
                                 gas 2300 * is_zero(value) wei
                            require 14 * stor1 * eth.balance(this.address) / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)]) / 100 <= stor1 * eth.balance(this.address) / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)])
                            call msg.sender with:
                               value (stor1 * eth.balance(this.address) / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)])) - (14 * stor1 * eth.balance(this.address) / stor2 + (stor2 * claimedEggs[address(msg.sender)] / claimedEggs[address(msg.sender)]) / 100) wei
                                 gas 2300 * is_zero(value) wei
                else:
                    require stor1
                    require stor1 * marketEggs / stor1 == marketEggs
                    if not stor2:
                        ...
                        if not stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)]):
                            ...
                            require 14 * stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)]) / stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)]) == 14
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] >= marketEggs
                            marketEggs += claimedEggs[address(msg.sender)]
                            call ceoAddress with:
                               value (14 * stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)]) / 100) - (14 * stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)]) / 100 / 13) wei
                                 gas 2300 * is_zero(value) wei
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            call ceoAddress2 with:
                               value 14 * stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)]) / 100 / 13 wei
                                 gas 2300 * is_zero(value) wei
                            require 14 * stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)]) / 100 <= stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)])
                            call msg.sender with:
                               value (stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)])) - (14 * stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)]) / 100) wei
                                 gas 2300 * is_zero(value) wei
                    else:
                        require stor2
                        require stor2 * claimedEggs[address(msg.sender)] / stor2 == claimedEggs[address(msg.sender)]
                        ...
                        if not stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (stor2 * claimedEggs[address(msg.sender)]) / claimedEggs[address(msg.sender)]):
                            ...
                            require 14 * stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (stor2 * claimedEggs[address(msg.sender)]) / claimedEggs[address(msg.sender)]) / stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (stor2 * claimedEggs[address(msg.sender)]) / claimedEggs[address(msg.sender)]) == 14
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] >= marketEggs
                            marketEggs += claimedEggs[address(msg.sender)]
                            call ceoAddress with:
                               value (14 * stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (stor2 * claimedEggs[address(msg.sender)]) / claimedEggs[address(msg.sender)]) / 100) - (14 * stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (stor2 * claimedEggs[address(msg.sender)]) / claimedEggs[address(msg.sender)]) / 100 / 13) wei
                                 gas 2300 * is_zero(value) wei
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            call ceoAddress2 with:
                               value 14 * stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (stor2 * claimedEggs[address(msg.sender)]) / claimedEggs[address(msg.sender)]) / 100 / 13 wei
                                 gas 2300 * is_zero(value) wei
                            require 14 * stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (stor2 * claimedEggs[address(msg.sender)]) / claimedEggs[address(msg.sender)]) / 100 <= stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (stor2 * claimedEggs[address(msg.sender)]) / claimedEggs[address(msg.sender)])
                            call msg.sender with:
                               value (stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (stor2 * claimedEggs[address(msg.sender)]) / claimedEggs[address(msg.sender)])) - (14 * stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (stor2 * claimedEggs[address(msg.sender)]) / claimedEggs[address(msg.sender)]) / 100) wei
                                 gas 2300 * is_zero(value) wei
        else:
            require EGGS_TO_HATCH_1MINERS
            require EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] / EGGS_TO_HATCH_1MINERS == myMiners[address(msg.sender)]
            ...
            if not stor1:
                if not stor2:
                    ...
                    if not 0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])):
                        ...
                        require 14 * 0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) == 14
                        claimedEggs[address(msg.sender)] = 0
                        lastHatch[address(msg.sender)] = block.timestamp
                        require marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)]) >= marketEggs
                        marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])
                        call ceoAddress with:
                           value (14 * 0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100) - (14 * 0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100 / 13) wei
                             gas 2300 * is_zero(value) wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        call ceoAddress2 with:
                           value 14 * 0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100 / 13 wei
                             gas 2300 * is_zero(value) wei
                        require 14 * 0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100 <= 0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)]))
                        call msg.sender with:
                           value (0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)]))) - (14 * 0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100) wei
                             gas 2300 * is_zero(value) wei
                else:
                    require stor2
                    ...
                    if not 0 / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])):
                        ...
                        require 14 * 0 / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 0 / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) == 14
                        claimedEggs[address(msg.sender)] = 0
                        lastHatch[address(msg.sender)] = block.timestamp
                        require marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)]) >= marketEggs
                        marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])
                        call ceoAddress with:
                           value (14 * 0 / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100) - (14 * 0 / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100 / 13) wei
                             gas 2300 * is_zero(value) wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        call ceoAddress2 with:
                           value 14 * 0 / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100 / 13 wei
                             gas 2300 * is_zero(value) wei
                        require 14 * 0 / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100 <= 0 / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)]))
                        call msg.sender with:
                           value (0 / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)]))) - (14 * 0 / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100) wei
                             gas 2300 * is_zero(value) wei
            else:
                require stor1
                require stor1 * eth.balance(this.address) / stor1 == eth.balance(this.address)
                if not stor1:
                    if not stor2:
                        ...
                        if not stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])):
                            ...
                            require 14 * stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) == 14
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])
                            call ceoAddress with:
                               value (14 * stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100) - (14 * stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100 / 13) wei
                                 gas 2300 * is_zero(value) wei
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            call ceoAddress2 with:
                               value 14 * stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100 / 13 wei
                                 gas 2300 * is_zero(value) wei
                            require 14 * stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100 <= stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)]))
                            call msg.sender with:
                               value (stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)]))) - (14 * stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100) wei
                                 gas 2300 * is_zero(value) wei
                    else:
                        require stor2
                        require (claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / stor2 == claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])
                        ...
                        if not stor1 * eth.balance(this.address) / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])):
                            ...
                            require 14 * stor1 * eth.balance(this.address) / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / stor1 * eth.balance(this.address) / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) == 14
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])
                            call ceoAddress with:
                               value (14 * stor1 * eth.balance(this.address) / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100) - (14 * stor1 * eth.balance(this.address) / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100 / 13) wei
                                 gas 2300 * is_zero(value) wei
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            call ceoAddress2 with:
                               value 14 * stor1 * eth.balance(this.address) / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100 / 13 wei
                                 gas 2300 * is_zero(value) wei
                            require 14 * stor1 * eth.balance(this.address) / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100 <= stor1 * eth.balance(this.address) / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)]))
                            call msg.sender with:
                               value (stor1 * eth.balance(this.address) / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)]))) - (14 * stor1 * eth.balance(this.address) / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100) wei
                                 gas 2300 * is_zero(value) wei
                else:
                    require stor1
                    require stor1 * marketEggs / stor1 == marketEggs
                    if not stor2:
                        ...
                        if not stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])):
                            ...
                            require 14 * stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) == 14
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])
                            call ceoAddress with:
                               value (14 * stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100) - (14 * stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100 / 13) wei
                                 gas 2300 * is_zero(value) wei
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            call ceoAddress2 with:
                               value 14 * stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100 / 13 wei
                                 gas 2300 * is_zero(value) wei
                            require 14 * stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100 <= stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)]))
                            call msg.sender with:
                               value (stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)]))) - (14 * stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100) wei
                                 gas 2300 * is_zero(value) wei
                    else:
                        require stor2
                        require (claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / stor2 == claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])
                        ...
                        if not stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])):
                            ...
                            require 14 * stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) == 14
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])
                            call ceoAddress with:
                               value (14 * stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100) - (14 * stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100 / 13) wei
                                 gas 2300 * is_zero(value) wei
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            call ceoAddress2 with:
                               value 14 * stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100 / 13 wei
                                 gas 2300 * is_zero(value) wei
                            require 14 * stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100 <= stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)]))
                            call msg.sender with:
                               value (stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)]))) - (14 * stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (claimedEggs[address(msg.sender)] * stor2) + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1MINERS * myMiners[address(msg.sender)])) / 100) wei
                                 gas 2300 * is_zero(value) wei
    else:
        if not block.timestamp - lastHatch[address(msg.sender)]:
            require claimedEggs[address(msg.sender)] >= claimedEggs[address(msg.sender)]
            ...
            if not stor1:
                if not stor2:
                    ...
                    if not 0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])):
                        ...
                        require 14 * 0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) == 14
                        claimedEggs[address(msg.sender)] = 0
                        lastHatch[address(msg.sender)] = block.timestamp
                        require marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) >= marketEggs
                        marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])
                        call ceoAddress with:
                           value (14 * 0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100) - (14 * 0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100 / 13) wei
                             gas 2300 * is_zero(value) wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        call ceoAddress2 with:
                           value 14 * 0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100 / 13 wei
                             gas 2300 * is_zero(value) wei
                        require 14 * 0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100 <= 0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]))
                        call msg.sender with:
                           value (0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]))) - (14 * 0 / stor2 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100) wei
                             gas 2300 * is_zero(value) wei
                else:
                    require stor2
                    ...
                    if not 0 / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])):
                        ...
                        require 14 * 0 / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 0 / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) == 14
                        claimedEggs[address(msg.sender)] = 0
                        lastHatch[address(msg.sender)] = block.timestamp
                        require marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) >= marketEggs
                        marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])
                        call ceoAddress with:
                           value (14 * 0 / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100) - (14 * 0 / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100 / 13) wei
                             gas 2300 * is_zero(value) wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        call ceoAddress2 with:
                ...
                if not stor1:
                    if not stor2:
                        ...
                        if not stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])):
                            ...
                            require 14 * stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) == 14
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])
                            call ceoAddress with:
                               value (14 * stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100) - (14 * stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100 / 13) wei
                                 gas 2300 * is_zero(value) wei
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            call ceoAddress2 with:
                               value 14 * stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100 / 13 wei
                                 gas 2300 * is_zero(value) wei
                            ...
                            call msg.sender with:
                               value (stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]))) - (14 * stor1 * eth.balance(this.address) / stor2 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100) wei
                                 gas 2300 * is_zero(value) wei
                    else:
                        require stor2
                        require (claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / stor2 == claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])
                        ...
                        if not stor1 * eth.balance(this.address) / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])):
                            ...
                            require 14 * stor1 * eth.balance(this.address) / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / stor1 * eth.balance(this.address) / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) == 14
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])
                            call ceoAddress with:
                               value (14 * stor1 * eth.balance(this.address) / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100) - (14 * stor1 * eth.balance(this.address) / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100 / 13) wei
                                 gas 2300 * is_zero(value) wei
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            call ceoAddress2 with:
                            ...
                            call msg.sender with:
                               value (stor1 * eth.balance(this.address) / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]))) - (14 * stor1 * eth.balance(this.address) / stor2 + ((claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100) wei
                                 gas 2300 * is_zero(value) wei
                else:
                    require stor1
                    require stor1 * marketEggs / stor1 == marketEggs
                    if not stor2:
                        ...
                        if not stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])):
                            ...
                            require 14 * stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) == 14
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])
                            call ceoAddress with:
                               value (14 * stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100) - (14 * stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100 / 13) wei
                                 gas 2300 * is_zero(value) wei
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            call ceoAddress2 with:
                               value 14 * stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100 / 13 wei
                                 gas 2300 * is_zero(value) wei
                            ...
                            call msg.sender with:
                               value (stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]))) - (14 * stor1 * eth.balance(this.address) / stor2 + (stor1 * marketEggs / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100) wei
                                 gas 2300 * is_zero(value) wei
                    else:
                        require stor2
                        require (claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / stor2 == claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])
                        ...
                        if not stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])):
                            ...
                            require 14 * stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) == 14
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])
                            call ceoAddress with:
                               value (14 * stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100) - (14 * stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100 / 13) wei
                                 gas 2300 * is_zero(value) wei
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            call ceoAddress2 with:
                            ...
                            call msg.sender with:
                               value (stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)]))) - (14 * stor1 * eth.balance(this.address) / stor2 + ((stor1 * marketEggs) + (claimedEggs[address(msg.sender)] * stor2) + (block.timestamp * myMiners[address(msg.sender)] * stor2) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)] * stor2) / claimedEggs[address(msg.sender)] + (block.timestamp * myMiners[address(msg.sender)]) - (lastHatch[address(msg.sender)] * myMiners[address(msg.sender)])) / 100) wei
                                 gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
