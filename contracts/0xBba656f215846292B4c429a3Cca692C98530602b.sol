...
function priceOf(address arg1) payable {
    ...
    require ext_code.size(uniV2factoryAddress)
    ...
    require ext_code.size(sub_529eef2cAddress)
    ...
    if stor3[ext_call.return_data[12 len 20]]:
        ...
        if bool(bool(ext_call.return_data[31 len 1] < 78)) or bool(bool(ext_call.return_data[31 len 1] < 32)):
            ...
            if ext_call.return_data[0] and 1000000000000000000 * 10^18 / 10^ext_call.return_data[31 len 1] > -1 / ext_call.return_data[0]:
                revert with 'NH{q', 17
            return (ext_call.return_data[0] * 1000000000000000000 * 10^18 / 10^ext_call.return_data[31 len 1] / 10^18)
        s = 10
        t = 1
        idx = ext_call.return_data[31 len 1]
        while idx > 1:
    ...
    if stor3[ext_call.return_data[12 len 20]]:
        ...
        if not ext_call.return_data[31 len 1]:
            ...
            return 1000000000000000000 * 10^18 * ext_call.return_data[0] / 10^18, 
                   ...
                   8760 * 24 * 3600 * ext_call.return_data[0] / 10^14 * 10000 * ext_call.return_data[0] / ext_call.return_data[0] / 10000
        if bool(bool(ext_call.return_data[31 len 1] < 78)) or bool(bool(ext_call.return_data[31 len 1] < 32)):
            if 10^ext_call.return_data[31 len 1] > -1:
                revert with 'NH{q', 17
            if not 10^ext_call.return_data[31 len 1]:
