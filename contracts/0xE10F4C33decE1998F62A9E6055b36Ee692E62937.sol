...
function initialize() payable {
    ...
    if bool(stor54.length):
        ...
        stor54.length.field_1 = 22
        stor54.length.field_8 = 'Imperium Empires Token' / 256
        idx = 0
    ...
    if totalSupply > 0xffffffffffffffffffffffffffffffffffffffffdfb031a1c1dafd9eefffffff:
        revert with 'NH{q', 17
    totalSupply += 10000000000 * 10^18
    if balanceOf[address(msg.sender)] > 0xffffffffffffffffffffffffffffffffffffffffdfb031a1c1dafd9eefffffff:
        revert with 'NH{q', 17
    balanceOf[address(msg.sender)] += 10000000000 * 10^18
    emit Transfer(10000000000 * 10^18, 0, msg.sender);
    if not uint8(stor0.field_8):
