...
function adminMintGiveaways(address arg1) {
    ...
    if totalItems > -2:
        revert with 'NH{q', 17
    emit MintNFT(totalItems + 1, 1, arg1);
    if totalItems == -1:
        revert with 'NH{q', 17
    totalItems++
    if 1 > -totalItems - 1:
    ...
    emit Transfer(0, arg1, totalItems + 1);
}
...
function adminMint(uint256 arg1) {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 <= 0:
        revert with 0, 'mint wrong number'
    if arg1 > maxBatch:
        revert with 0, 'mint wrong number'
    if totalItems > -arg1 - 1:
        revert with 'NH{q', 17
    if totalItems + arg1 > totalCount:
        revert with 0, 'too much'
    if totalItems > -2:
        revert with 'NH{q', 17
    emit MintNFT(totalItems + 1, arg1, msg.sender);
    idx = 0
    while idx < arg1:
        if totalItems == -1:
            revert with 'NH{q', 17
        ...
        emit Transfer(0, msg.sender, totalItems + 1);
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
