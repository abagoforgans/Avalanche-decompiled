...
uint256 source; offset 8
uint256 sourceAddress;
uint8 stor7;
address sub_2e7baaa3Address; offset 8
...
function sub_2e7baaa3(?) payable {
    return sub_2e7baaa3Address
}
...
function sourceAddress() payable {
...
function changeAuthority(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if sub_2e7baaa3Address != msg.sender:
        revert with 0, 'ERC20: !authority'
    if not arg1:
        revert with 0, 'ERC20: zero address authority'
    sub_2e7baaa3Address = arg1
}
...
function sub_e41e7c1f(?) payable {
    ...
    stor5 = 0
    sourceAddress = cd[36]
    sub_2e7baaa3Address = msg.sender
    stor7 = 1
    if bool(stor3.length):
        if bool(stor3.length) == stor3.length.field_1 < 32:
            revert with 'NH{q', 34
        if not ('cd', 100).length:
            ...
            stor3.length = (2 * ('cd', 100).length) + 1
            s = 0
            idx = cd[100] + 36
    ...
    if bool(stor4.length):
        ...
        if not ('cd', 132).length:
            ...
            stor4.length = (2 * ('cd', 132).length) + 1
            s = 0
            idx = cd[132] + 36
