...
const sub_4e20a02c(?) = 78000 * 10^18

const sub_ffa8226e(?) = 10000 * 10^18
...
function sub_2cf6b1fc(?) payable {
    return sub_2cf6b1fcAddress
}
...
function distributeReward(address arg1, address arg2) payable {
    ...
    if not arg1:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply + 78000 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 78000 * 10^18
    if balanceOf[address(arg1)] + 78000 * 10^18 < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 78000 * 10^18
    emit Transfer(78000 * 10^18, 0, arg1);
    if not arg2:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply + 10000 * 10^18 < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 10000 * 10^18
    if balanceOf[address(arg2)] + 10000 * 10^18 < balanceOf[address(arg2)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg2)] += 10000 * 10^18
    emit Transfer(10000 * 10^18, 0, arg2);
}
