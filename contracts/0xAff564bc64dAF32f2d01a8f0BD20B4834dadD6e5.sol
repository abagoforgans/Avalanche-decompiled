...
function sub_ae85e61a(?) payable {
    ...
    if not arg1.length:
        ...
        while idx < arg1.length:
            ...
            if ext_call.success:
                ...
                mem[(32 * idx) + (32 * arg1.length) + (32 * arg2.length) + 192] = mem[_97 + ceil32(return_data.size) + 64]
            idx = idx + 1
            s = _52
            continue 
        mem[mem[64]] = 32
    ...
    while idx < arg1.length:
        ...
        if ext_call.success:
            ...
            require idx < mem[(32 * arg1.length) + (32 * arg2.length) + 160]
            mem[(32 * idx) + (32 * arg1.length) + (32 * arg2.length) + 192] = mem[_98 + ceil32(return_data.size) + 64]
        idx = idx + 1
        s = _59
        continue 
    mem[mem[64]] = 32
