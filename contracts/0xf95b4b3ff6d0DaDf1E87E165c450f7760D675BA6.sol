...
function sub_803b0f8a(?) payable {
    return uint256(sub_803b0f8a[stor2][0 len sub_803b0f8a[stor2].length].field_0)
}
...
function claimJackpot() payable {
    ...
    if uint256(sub_803b0f8a[stor2].field_1024) > sub_2915d5db:
        revert with 0, 'SafeMath: subtraction overflow'
    if sub_2915d5db - uint256(sub_803b0f8a[stor2].field_1024) + uint256(sub_803b0f8a[stor2].field_768) < uint256(sub_803b0f8a[stor2].field_768):
        revert with 0, 'SafeMath: addition overflow'
    uint256(sub_803b0f8a[stor2].field_768) = sub_2915d5db - uint256(sub_803b0f8a[stor2].field_1024) + uint256(sub_803b0f8a[stor2].field_768)
    idx = 0
    while idx < 5:
        ...
        s = 0
        while s < 5:
            if sub_06f6a017[s] >= uint256(sub_803b0f8a[stor2].field_768):
                s = s + 1
                continue 
            t = idx
            while t > s:
                ...
                continue 
            require s < 5
            sub_06f6a017[s] = uint256(sub_803b0f8a[stor2].field_768)
    ...
    idx = 0
    while idx < 5:
        if sub_06f6a017[idx] >= uint256(sub_803b0f8a[stor2].field_768):
            idx = idx + 1
            continue 
        s = 4
        while s > idx:
            ...
            continue 
        if idx < 4:
            sub_06f6a017[idx] = uint256(sub_803b0f8a[stor2].field_768)
            sub_853082a6[idx] = sub_982cfe85Address
        else:
            if uint256(sub_803b0f8a[stor2].field_768) > stor20:
                require idx < 5
                sub_06f6a017[idx] = uint256(sub_803b0f8a[stor2].field_768)
                sub_853082a6[idx] = sub_982cfe85Address
        if not jackpot:
