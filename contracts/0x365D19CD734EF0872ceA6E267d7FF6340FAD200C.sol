...
address devAddress;
uint8 sub_97c7edde; offset 168
uint8 tradingEnabled; offset 176
uint8 sub_ffdc0833; offset 184
...
function sub_f0cb19ff(?) {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if bool(arg1) == bool(sub_ffdc0833):
...
function sub_786ac6dc(?) {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if bool(arg1) == bool(sub_97c7edde):
