            ...
            while idx <= arg1:
                ...
                if msg.sender:
                    ...
                    if ext_code.size(msg.sender) > 0:
                        ...
                        s = 0
                        while s < 0:
                            mem[mem[64] + s + 164] = mem[_680 + s + 32]
                            s = s + 32
                            continue 
                        ...
                        require return_data.size >= 32
                        require mem[_917] == Mask(32, 224, mem[_917])
                        if Mask(32, 224, mem[_917]) != 0x150b7a0200000000000000000000000000000000000000000000000000000000:
                            revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
                else:
                    if tokenByIndex.length < 1:
                        revert with 'NH{q', 17
                ...
                if tokenByIndex.length > -idx - 1:
                    revert with 'NH{q', 17
                emit 0xe9a265eb: tokenByIndex.length + idx
                if idx == -1:
                    revert with 'NH{q', 17
                idx = idx + 1
                continue 
