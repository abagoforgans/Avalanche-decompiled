...
function deploy(address arg1, uint256 arg2, uint256 arg3, address[] arg4, uint256[] arg5, address arg6, uint256 arg7, uint256 arg8) payable {
    ...
    while idx < arg4.length:
        ...
        if not cd[((32 * idx) + arg5 + 36)]:
            ...
            call address(cd[((32 * idx) + arg4 + 36)]).mem[_99 + 100 len 4] with:
                 gas gas_remaining wei
                args mem[_99 + 104 len _106 - 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 'SafeERC20: low-level call failed'
                if mem[96]:
                    require mem[96] >= 32
                    if not mem[128]:
                        revert with 0, 32, 42, code.data[22231 len 42], mem[_99 + 210 len 22]
            else:
                ...
                if return_data.size:
                    require return_data.size >= 32
                    if not mem[_99 + 132]:
                        revert with 0, 32, 42, code.data[22231 len 42], mem[_99 + ceil32(return_data.size) + 211 len 22]
        else:
...
function extendRewardPool(uint256 arg1, uint256[] arg2, address arg3) payable {
    ...
    if not arg2.length:
        ...
        if not arg2.length:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if (arg1 * cd[((32 * idx) + arg2 + 36)]) - (block.number * cd[((32 * idx) + arg2 + 36)]) > 0:
                        ...
                        while s >= 32:
                            ...
                            s = s - 32
                            continue 
                        mem[_1247 + floor32(mem[_1248]) + 100] = mem[_1248 + -(mem[_1248] % 32) + floor32(mem[_1248]) + 64 len mem[_1248] % 32] or Mask(8 * -(mem[_1248] % 32) + 32, -(8 * -(mem[_1248] % 32) + 32) + 256, mem[_1247 + floor32(mem[_1248]) + 100])
                        call address(ext_call.return_data[0]).mem[_1247 + 100 len 4] with:
                             gas gas_remaining wei
                            args mem[_1247 + 104 len _1311 - 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0, 'SafeERC20: low-level call failed'
                            if mem[96]:
                                require mem[96] >= 32
                                if not mem[128]:
                                    revert with 0, 32, 42, code.data[22231 len 42], mem[_1247 + 210 len 22]
                        else:
                            mem[64] = _1247 + ceil32(return_data.size) + 101
                            mem[_1247 + 100] = return_data.size
                            mem[_1247 + 132 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[_1247 + 132]:
                                    revert with 0, 32, 42, code.data[22231 len 42], mem[_1247 + ceil32(return_data.size) + 211 len 22]
                else:
                    ...
                    if not cd[((32 * idx) + arg2 + 36)]:
                        ...
                        if 0 > (ext_call.return_data[0] * ext_call.return_data[0]) - (block.number * ext_call.return_data[0]):
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[_1244 + floor32(mem[_1245]) + 100] = mem[_1245 + -(mem[_1245] % 32) + floor32(mem[_1245]) + 64 len mem[_1245] % 32] or Mask(8 * -(mem[_1245] % 32) + 32, -(8 * -(mem[_1245] % 32) + 32) + 256, mem[_1244 + floor32(mem[_1245]) + 100])
                            call address(ext_call.return_data[0]).mem[_1244 + 100 len 4] with:
                                 gas gas_remaining wei
                                args mem[_1244 + 104 len _1307 - 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, 'SafeERC20: low-level call failed'
                                if mem[96]:
                                    require mem[96] >= 32
                                    if not mem[128]:
                                        revert with 0, 32, 42, code.data[22231 len 42], mem[_1244 + 210 len 22]
                            else:
                                mem[64] = _1244 + ceil32(return_data.size) + 101
                                mem[_1244 + 100] = return_data.size
                                mem[_1244 + 132 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                if not ext_call.success:
                                    revert with 0, 'SafeERC20: low-level call failed'
                                if return_data.size:
                                    require return_data.size >= 32
                                    if not mem[_1244 + 132]:
                                        revert with 0, 32, 42, code.data[22231 len 42], mem[_1244 + ceil32(return_data.size) + 211 len 22]
                    else:
                        if (arg1 * cd[((32 * idx) + arg2 + 36)]) - (block.number * cd[((32 * idx) + arg2 + 36)]) / cd[((32 * idx) + arg2 + 36)] != arg1 - block.number:
                            revert with 0, 32, 33, code.data[21965 len 33], mem[mem[64] + 101 len 31]
                        require idx < mem[(32 * arg2.length) + 128]
                        ...
                        if (arg1 * cd[((32 * idx) + arg2 + 36)]) - (block.number * cd[((32 * idx) + arg2 + 36)]) > (ext_call.return_data[0] * ext_call.return_data[0]) - (block.number * ext_call.return_data[0]):
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[_1278 + floor32(mem[_1279]) + 100] = mem[_1279 + -(mem[_1279] % 32) + floor32(mem[_1279]) + 64 len mem[_1279] % 32] or Mask(8 * -(mem[_1279] % 32) + 32, -(8 * -(mem[_1279] % 32) + 32) + 256, mem[_1278 + floor32(mem[_1279]) + 100])
                            call address(ext_call.return_data[0]).mem[_1278 + 100 len 4] with:
                                 gas gas_remaining wei
                                args mem[_1278 + 104 len _1359 - 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, 'SafeERC20: low-level call failed'
                                if mem[96]:
                                    require mem[96] >= 32
                                    if not mem[128]:
                                        revert with 0, 32, 42, code.data[22231 len 42], mem[_1278 + 210 len 22]
                            else:
                                mem[64] = _1278 + ceil32(return_data.size) + 101
                                mem[_1278 + 100] = return_data.size
                                mem[_1278 + 132 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                if not ext_call.success:
                                    revert with 0, 'SafeERC20: low-level call failed'
                                if return_data.size:
                                    require return_data.size >= 32
                                    if not mem[_1278 + 132]:
                                        revert with 0, 32, 42, code.data[22231 len 42], mem[_1278 + ceil32(return_data.size) + 211 len 22]
                idx = idx + 1
                continue 
            ...
            mem[mem[64] + floor32(arg2.length) + 164] = mem[96]
            mem[mem[64] + floor32(arg2.length) + 196 len floor32(mem[96])] = mem[128 len floor32(mem[96])]
            mem[mem[64] + 100] = (32 * mem[96]) + floor32(arg2.length) + 192
            mem[(32 * mem[96]) + mem[64] + floor32(arg2.length) + 196] = mem[(32 * arg2.length) + 128]
            _1659 = mem[(32 * arg2.length) + 128]
            mem[(32 * mem[96]) + mem[64] + floor32(arg2.length) + 228 len floor32(mem[(32 * arg2.length) + 128])] = mem[(32 * arg2.length) + 160 len floor32(mem[(32 * arg2.length) + 128])]
            require ext_code.size(arg3)
            call arg3.0x20e67c76 with:
                 gas gas_remaining wei
                args arg1, Array(len=arg2.length, data=mem[mem[64] + 164 len (32 * _1659) + (32 * mem[96]) + floor32(arg2.length) + 64]), floor32(arg2.length) + 160, (32 * mem[96]) + floor32(arg2.length) + 192
        else:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if (arg1 * cd[((32 * idx) + arg2 + 36)]) - (block.number * cd[((32 * idx) + arg2 + 36)]) > 0:
                        ...
                        while s >= 32:
                            ...
                            s = s - 32
                            continue 
                        mem[_1255 + floor32(mem[_1256]) + 100] = mem[_1256 + -(mem[_1256] % 32) + floor32(mem[_1256]) + 64 len mem[_1256] % 32] or Mask(8 * -(mem[_1256] % 32) + 32, -(8 * -(mem[_1256] % 32) + 32) + 256, mem[_1255 + floor32(mem[_1256]) + 100])
                        call address(ext_call.return_data[0]).mem[_1255 + 100 len 4] with:
                             gas gas_remaining wei
                            args mem[_1255 + 104 len _1323 - 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0, 'SafeERC20: low-level call failed'
                            if mem[96]:
                                require mem[96] >= 32
                                if not mem[128]:
                                    revert with 0, 32, 42, code.data[22231 len 42], mem[_1255 + 210 len 22]
                        else:
                            mem[64] = _1255 + ceil32(return_data.size) + 101
                            mem[_1255 + 100] = return_data.size
                            mem[_1255 + 132 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[_1255 + 132]:
                                    revert with 0, 32, 42, code.data[22231 len 42], mem[_1255 + ceil32(return_data.size) + 211 len 22]
                else:
                    if (ext_call.return_data[0] * ext_call.return_data[0]) - (block.number * ext_call.return_data[0]) / ext_call.return_data[0] != ext_call.return_data[0] - block.number:
                        revert with 0, 32, 33, code.data[21965 len 33], mem[mem[64] + 101 len 31]
                    require idx < mem[96]
                    ...
                    if not cd[((32 * idx) + arg2 + 36)]:
                        ...
                        if (arg1 * cd[((32 * idx) + arg2 + 36)]) - (block.number * cd[((32 * idx) + arg2 + 36)]) > (ext_call.return_data[0] * ext_call.return_data[0]) - (block.number * ext_call.return_data[0]):
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[_1285 + floor32(mem[_1286]) + 100] = mem[_1286 + -(mem[_1286] % 32) + floor32(mem[_1286]) + 64 len mem[_1286] % 32] or Mask(8 * -(mem[_1286] % 32) + 32, -(8 * -(mem[_1286] % 32) + 32) + 256, mem[_1285 + floor32(mem[_1286]) + 100])
                            call address(ext_call.return_data[0]).mem[_1285 + 100 len 4] with:
                                 gas gas_remaining wei
                                args mem[_1285 + 104 len _1371 - 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, 'SafeERC20: low-level call failed'
                                if mem[96]:
                                    require mem[96] >= 32
                                    if not mem[128]:
                                        revert with 0, 32, 42, code.data[22231 len 42], mem[_1285 + 210 len 22]
                            else:
                                mem[64] = _1285 + ceil32(return_data.size) + 101
                                mem[_1285 + 100] = return_data.size
                                mem[_1285 + 132 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                if not ext_call.success:
                                    revert with 0, 'SafeERC20: low-level call failed'
                                if return_data.size:
                                    require return_data.size >= 32
                                    if not mem[_1285 + 132]:
                                        revert with 0, 32, 42, code.data[22231 len 42], mem[_1285 + ceil32(return_data.size) + 211 len 22]
                idx = idx + 1
                continue 
            mem[mem[64]] = 0x20e67c7600000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = arg1
            ...
            call arg3.0x20e67c76 with:
                 gas gas_remaining wei
                args arg1, Array(len=arg2.length, data=mem[mem[64] + 164 len (32 * _1681) + (32 * mem[96]) + floor32(arg2.length) + 64]), floor32(arg2.length) + 160, (32 * mem[96]) + floor32(arg2.length) + 192
    else:
        ...
        if not arg2.length:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if (arg1 * cd[((32 * idx) + arg2 + 36)]) - (block.number * cd[((32 * idx) + arg2 + 36)]) > 0:
                        ...
                        while s >= 32:
                            ...
                            s = s - 32
                            continue 
                        mem[_1263 + floor32(mem[_1264]) + 100] = mem[_1264 + -(mem[_1264] % 32) + floor32(mem[_1264]) + 64 len mem[_1264] % 32] or Mask(8 * -(mem[_1264] % 32) + 32, -(8 * -(mem[_1264] % 32) + 32) + 256, mem[_1263 + floor32(mem[_1264]) + 100])
                        call address(ext_call.return_data[0]).mem[_1263 + 100 len 4] with:
                             gas gas_remaining wei
                            args mem[_1263 + 104 len _1335 - 4]
                        if not return_data.size:
                            if not ext_call.success:
                                revert with 0, 'SafeERC20: low-level call failed'
                            if mem[96]:
                                require mem[96] >= 32
                                if not mem[128]:
                                    revert with 0, 32, 42, code.data[22231 len 42], mem[_1263 + 210 len 22]
                        else:
                            mem[64] = _1263 + ceil32(return_data.size) + 101
                            mem[_1263 + 100] = return_data.size
                            mem[_1263 + 132 len return_data.size] = ext_call.return_data[0 len return_data.size]
                            if not ext_call.success:
                                revert with 0, 'SafeERC20: low-level call failed'
                            if return_data.size:
                                require return_data.size >= 32
                                if not mem[_1263 + 132]:
                                    revert with 0, 32, 42, code.data[22231 len 42], mem[_1263 + ceil32(return_data.size) + 211 len 22]
                else:
                    if (ext_call.return_data[0] * ext_call.return_data[0]) - (block.number * ext_call.return_data[0]) / ext_call.return_data[0] != ext_call.return_data[0] - block.number:
                        revert with 0, 32, 33, code.data[21965 len 33], mem[mem[64] + 101 len 31]
                    require idx < mem[96]
                    ...
                    if not cd[((32 * idx) + arg2 + 36)]:
                        ...
                        if (arg1 * cd[((32 * idx) + arg2 + 36)]) - (block.number * cd[((32 * idx) + arg2 + 36)]) > (ext_call.return_data[0] * ext_call.return_data[0]) - (block.number * ext_call.return_data[0]):
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[_1292 + floor32(mem[_1293]) + 100] = mem[_1293 + -(mem[_1293] % 32) + floor32(mem[_1293]) + 64 len mem[_1293] % 32] or Mask(8 * -(mem[_1293] % 32) + 32, -(8 * -(mem[_1293] % 32) + 32) + 256, mem[_1292 + floor32(mem[_1293]) + 100])
                            call address(ext_call.return_data[0]).mem[_1292 + 100 len 4] with:
                                 gas gas_remaining wei
                                args mem[_1292 + 104 len _1383 - 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, 'SafeERC20: low-level call failed'
                                if mem[96]:
                                    require mem[96] >= 32
                                    if not mem[128]:
                                        revert with 0, 32, 42, code.data[22231 len 42], mem[_1292 + 210 len 22]
                            else:
                                mem[64] = _1292 + ceil32(return_data.size) + 101
                                mem[_1292 + 100] = return_data.size
                                mem[_1292 + 132 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                if not ext_call.success:
                                    revert with 0, 'SafeERC20: low-level call failed'
                                if return_data.size:
                                    require return_data.size >= 32
                                    if not mem[_1292 + 132]:
                                        revert with 0, 32, 42, code.data[22231 len 42], mem[_1292 + ceil32(return_data.size) + 211 len 22]
                idx = idx + 1
                continue 
            mem[mem[64]] = 0x20e67c7600000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = arg1
            ...
            call arg3.0x20e67c76 with:
                 gas gas_remaining wei
                args arg1, Array(len=arg2.length, data=mem[mem[64] + 164 len (32 * _1703) + (32 * mem[96]) + floor32(arg2.length) + 64]), floor32(arg2.length) + 160, (32 * mem[96]) + floor32(arg2.length) + 192
        else:
            mem[(32 * arg2.length) + 160 len 32 * arg2.length] = call.data[calldata.size len 32 * arg2.length]
            idx = 0
            while idx < arg2.length:
                    ...
                    if not cd[((32 * idx) + arg2 + 36)]:
                        ...
                        if (arg1 * cd[((32 * idx) + arg2 + 36)]) - (block.number * cd[((32 * idx) + arg2 + 36)]) > (ext_call.return_data[0] * ext_call.return_data[0]) - (block.number * ext_call.return_data[0]):
                            ...
                            while s >= 32:
                                ...
                                s = s - 32
                                continue 
                            mem[_1299 + floor32(mem[_1300]) + 100] = mem[_1300 + -(mem[_1300] % 32) + floor32(mem[_1300]) + 64 len mem[_1300] % 32] or Mask(8 * -(mem[_1300] % 32) + 32, -(8 * -(mem[_1300] % 32) + 32) + 256, mem[_1299 + floor32(mem[_1300]) + 100])
                            call address(ext_call.return_data[0]).mem[_1299 + 100 len 4] with:
                                 gas gas_remaining wei
                                args mem[_1299 + 104 len _1395 - 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with 0, 'SafeERC20: low-level call failed'
                                if mem[96]:
                                    require mem[96] >= 32
                                    if not mem[128]:
                                        revert with 0, 32, 42, code.data[22231 len 42], mem[_1299 + 210 len 22]
                            else:
                                mem[64] = _1299 + ceil32(return_data.size) + 101
                                mem[_1299 + 100] = return_data.size
                                mem[_1299 + 132 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                if not ext_call.success:
                                    revert with 0, 'SafeERC20: low-level call failed'
                                if return_data.size:
                                    require return_data.size >= 32
                                    if not mem[_1299 + 132]:
                                        revert with 0, 32, 42, code.data[22231 len 42], mem[_1299 + ceil32(return_data.size) + 211 len 22]
                idx = idx + 1
                continue 
            mem[mem[64]] = 0x20e67c7600000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = arg1
            ...
            call arg3.0x20e67c76 with:
                 gas gas_remaining wei
                args arg1, Array(len=arg2.length, data=mem[mem[64] + 164 len (32 * _1725) + (32 * mem[96]) + floor32(arg2.length) + 64]), floor32(arg2.length) + 160, (32 * mem[96]) + floor32(arg2.length) + 192
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
