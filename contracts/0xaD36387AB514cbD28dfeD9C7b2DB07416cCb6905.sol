    ...
    if msg.sender == stor6:
        ...
        while idx < stor11:
            ...
            if mem[_65] > 0:
                ...
                call stor9[idx].field_0.0xe1853af6 with:
                     gas gas_remaining wei
                    args 96, _67, stor9[idx].field_0, mem[mem[64] + 100 len (32 * mem[96]) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            if idx == -1:
                revert with 'NH{q', 17
    ...
    if msg.sender == stor6:
        ...
        if address(arg1) == stor4:
            ...
            if not arg7:
                        ...
                        if mem[_817 + ceil32(return_data.size) + 32] < arg6:
                            ...
                            call stor9[idx].field_0.0x6023e966 with:
                               value _1237 * arg4 wei
                                 gas gas_remaining wei
                                args 128, arg4, _1254, stor9[idx].field_0, mem[mem[64] + 132 len (32 * mem[96]) + 32]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                    if idx == -1:
                        revert with 'NH{q', 17
                ...
                staticcall stor2.getAmountsOut(uint256 arg1, address[] arg2) with:
                        gas gas_remaining wei
                       args _1275, Array(len=2, data=mem[mem[64] + 100 len 64])
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _1583 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                ...
                call stor2.swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args _1275, 0, 160, stor8, block.timestamp + 15, mem[mem[64] + 164 len (32 * _2043) + 32]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                        ...
                        if mem[_816 + ceil32(return_data.size) + 32] < arg6:
                            ...
                            call stor9[idx].field_0.0x6023e966 with:
                               value _1236 * arg4 wei
                                 gas gas_remaining wei
                                args 128, arg4, _1252, stor9[idx].field_0, mem[mem[64] + 132 len (32 * mem[96]) + 32]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                    if idx == -1:
                        revert with 'NH{q', 17
                        ...
                        if mem[_2705 + ceil32(return_data.size) + 32] < arg6:
                            ...
                            call stor9[idx].field_0.0x6023e966 with:
                               value _2889 * arg4 wei
                                 gas gas_remaining wei
                                args 128, arg4, _2906, stor9[idx].field_0, mem[mem[64] + 132 len (32 * mem[96]) + 32]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                    if idx == -1:
                        revert with 'NH{q', 17
                        ...
                        if mem[_819 + ceil32(return_data.size) + 32] < arg6:
                            ...
                            call stor9[idx].field_0.0x6023e966 with:
                               value _1239 * arg4 wei
                                 gas gas_remaining wei
                                args 128, arg4, _1258, stor9[idx].field_0, mem[mem[64] + 132 len (32 * mem[96]) + 32]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                    if idx == -1:
                        revert with 'NH{q', 17
                        ...
                        if mem[_2711 + ceil32(return_data.size) + 32] < arg6:
                            ...
                            call stor9[idx].field_0.0x6023e966 with:
                               value _2895 * arg4 wei
                                 gas gas_remaining wei
                                args 128, arg4, _2918, stor9[idx].field_0, mem[mem[64] + 132 len (32 * mem[96]) + 32]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                    if idx == -1:
                        revert with 'NH{q', 17
