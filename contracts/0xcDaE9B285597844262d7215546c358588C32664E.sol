...
function sub_1940e0a2(?) {
        ...
        if address(call.data[100]) == address(call.data[100]):
            if not ext_call.return_data[50 len 14]:
                ...
                call stor3.0x68205ba0 with:
                     gas gas_remaining wei
                    args address(this.address), 'USDC.e', 0 / (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * arg1)
            else:
                ...
                call stor3.0x68205ba0 with:
                     gas gas_remaining wei
                    args address(this.address), 'USDC.e', 997 * arg1 * Mask(112, 0, ext_call.return_data[32]) / (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * arg1)
        else:
            if not ext_call.return_data[18 len 14]:
                ...
                call stor3.0x68205ba0 with:
                     gas gas_remaining wei
                    args address(this.address), 'USDC.e', 0 / (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * arg1)
            else:
                ...
                call stor3.0x68205ba0 with:
                     gas gas_remaining wei
                    args address(this.address), 'USDC.e', 997 * arg1 * Mask(112, 0, ext_call.return_data[0]) / (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * arg1)
    else:
    ...
    call stor4.0x45cd989b with:
         gas gas_remaining wei
        args 'AVAX/USDC.e', arg6, arg7, 0, 1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(stor3)
