...
function emergencyWithdraw() payable {
    ...
    mem[(6 * ceil32(return_data.size)) + 192] = _193
...
function collectProfitAndUpdateWatermark() payable {
    ...
    if not ext_call.return_data[0]:
        ...
        if not ext_call.return_data[0]:
            ...
            if not ext_call.return_data[0]:
                ...
                if 0 / 100 * 10^6 <= watermark:
                    ...
                    emit CollectProfitAndUpdateWatermark(uint256 arg1, uint256 arg2, uint256 arg3):
                                                         0,
                                                         watermark,
                                                         0,
                                                         mem[(6 * ceil32(return_data.size)) + 320 len 9 * ceil32(return_data.size)],
                    return 0, 0, mem[(6 * ceil32(return_data.size)) + 288 len 9 * ceil32(return_data.size)]
                if 0 / 100 * 10^6 < watermark:
                    revert with 0, 17
                ...
                emit CollectProfitAndUpdateWatermark(uint256 arg1, uint256 arg2, uint256 arg3):
                                                     ...
                                                     mem[(6 * ceil32(return_data.size)) + 320 len 9 * ceil32(return_data.size)],
                return -1 * watermark * profitFeePerc / 10000, 0, mem[(6 * ceil32(return_data.size)) + 288 len 9 * ceil32(return_data.size)]
            mem[(6 * ceil32(return_data.size)) + 224] = 0x18160ddd00000000000000000000000000000000000000000000000000000000
            require ext_code.size(sub_d56271daAddress)
            staticcall sub_d56271daAddress.0x18160ddd with:
                    gas gas_remaining wei
            ...
            mem[(8 * ceil32(return_data.size)) + 256] = ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0] / 100 * 10^6
            return memory
              from (8 * ceil32(return_data.size)) + 224
        ...
        if (ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0]) + (ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0]) / 100 * 10^6 <= watermark:
            ...
            return 0, 
                   (ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0]) + (ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0]) / 100 * 10^6
        if (ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0]) + (ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0]) / 100 * 10^6 < watermark:
            revert with 0, 17
    ...
    if (ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0]) + (ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0]) + (ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0]) / 100 * 10^6 <= watermark:
        ...
        return 0, 
               (ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0]) + (ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0]) + (ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0]) / 100 * 10^6
    if (ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0]) + (ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0]) + (ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] * ext_call.return_data[0]) / 100 * 10^6 < watermark:
        revert with 0, 17
