...
address owner;
address sub_dfdfd76fAddress;
address sub_1cb9e262Address;
mapping of struct sub_78f6a94c;
mapping of uint256 sub_f10d9101;
...
function sub_dfdfd76f(?) payable {
    return sub_dfdfd76fAddress
}

function sub_f10d9101(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    return sub_f10d9101[arg1]
}
...
function sub_3cd8e38c(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_dfdfd76fAddress = address(arg1)
}
...
function sub_cd4187e1(?) payable {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_f10d9101[arg1] = arg2
}
...
function sub_728e218f(?) payable {
    ...
    call 0x4f01aed16d97e3ab5ab2b501154dc9bb0f1a5a2c.withdraw(address arg1, uint256 arg2, address arg3) with:
        ...
        args sub_a7a3fb40[stor9[arg1]], arg3, sub_1cb9e262Address
    ...
    call _bridgeAddress.0x8ece6f27 with:
         gas gas_remaining wei
        args 0x574c4131000000000000000000000000000000000000000000000000, sub_f10d9101[arg1], ext_call.return_data[0], address(arg2)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    emit 0x4145427a: ext_call.return_data[0], address(arg2), arg1
}
