...
function stake(uint256 arg1) {
    ...
    staticcall 0x1337bedc9d22ecbe766df105c9623922a27963ec.balanceOf(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(0x5b5cfe992adac0c9d48e05854b2d91c73a003858)
    staticcall 0x5b5cfe992adac0c9d48e05854b2d91c73a003858.balanceOf(address arg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
