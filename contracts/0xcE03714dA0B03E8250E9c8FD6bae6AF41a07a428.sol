...
function stake(uint256 arg1) payable {
    ...
    call stor2.stake(uint256 arg1, address arg2) with:
         gas gas_remaining wei
...
function unstake(uint256 arg1) payable {
    ...
    call sub_13b8beb7Address.0x23b872dd with:
         gas gas_remaining wei
        args this.address, 0xa3e4200ca1ac92331d529327e82d89c149ccd81c, arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(CAKEAddress)
    call CAKEAddress.0x23b872dd with:
         gas gas_remaining wei
        args 0xa3e4200ca1ac92331d529327e82d89c149ccd81c, this.address, arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
}
