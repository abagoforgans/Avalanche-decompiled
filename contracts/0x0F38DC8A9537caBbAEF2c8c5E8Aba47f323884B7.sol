...
function sub_2de5f588(?) {
    ...
    staticcall oracleAddress.0x8edbf436 with:
            gas gas_remaining wei
            ...
            if arg3:
                if not arg4:
                    ...
                    call arg4 with:
                       funct uint32(stor14)
                         gas gas_remaining wei
                        args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor14), uint32(stor14), 0) << 256, mem[calldata.size + 428 len 4]
                    if not return_data.size:
                        if not ext_call.success:
                            if calldata.size + 72:
                                revert with msg.sender, this.address, msg.value, call.data[0 len calldata.size]
