        ...
        if unknown_0xc311d049(?????) == uint32(call.func_hash) >> 224:
            ...
            while idx < ('cd', 36).length:
                ...
                if mem[_1130]:
                    if idx >= mem[128]:
                        revert with 0, 50
                    _1146 = mem[(32 * idx) + 160]
                    mem[mem[64] + 4] = address(cd[4])
                    mem[mem[64] + 36] = _1137
                    call address(_1146).0xa9059cbb with:
                         gas gas_remaining wei
                        args address(cd[4]), _1137
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1152 = mem[64]
                ...
                idx = idx + 1
                continue 
            _1161 = mem[ceil32(32 * ('cd', 36).length) + 129]
            idx = 0
            while idx < _1161:
                if idx >= mem[ceil32(32 * ('cd', 36).length) + 129]:
                    revert with 0, 50
                _1166 = mem[(32 * idx) + ceil32(32 * ('cd', 36).length) + 161]
                mem[mem[64] + 4] = this.address
                ...
                if mem[_1169]:
                    if idx >= mem[ceil32(32 * ('cd', 36).length) + 129]:
                        revert with 0, 50
                    _1176 = mem[(32 * idx) + ceil32(32 * ('cd', 36).length) + 161]
                    mem[mem[64] + 4] = address(cd[4])
                    mem[mem[64] + 36] = _1174
                    call address(_1176).0xa9059cbb with:
                         gas gas_remaining wei
                        args address(cd[4]), _1174
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1179 = mem[64]
        ...
        if uint32(call.func_hash) >> 224 != unknown_0x5aeda7c1(?????):
            if unknown_0xbd5dec98(?????) == uint32(call.func_hash) >> 224:
                ...
                while idx < ('cd', 4).length:
                    if idx >= mem[128]:
                        revert with 0, 50
                    _1119 = mem[(32 * idx) + 160]
                    mem[mem[64] + 4] = this.address
                    staticcall address(_1119).0x70a08231 with:
                            gas gas_remaining wei
                           args this.address
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                    ...
                    if mem[_1126]:
                        if idx >= mem[128]:
                            revert with 0, 50
                        _1145 = mem[(32 * idx) + 160]
                        mem[mem[64] + 4] = msg.sender
                        mem[mem[64] + 36] = _1135
                        call address(_1145).0xa9059cbb with:
                             gas gas_remaining wei
                            args msg.sender, _1135
                        mem[mem[64]] = ext_call.return_data[0]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        _1153 = mem[64]
