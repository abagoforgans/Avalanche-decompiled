...
address owner;
uint256 sub_71998f2d;
uint256 sub_854aaa46;
mapping of address sub_2218f119;
...
function sub_2218f119(?) {
    require calldata.size - 4 >= 32
    return sub_2218f119[arg1]
}
...
function sub_71998f2d(?) {
    return sub_71998f2d
}

function sub_854aaa46(?) {
    return sub_854aaa46
}
...
function info(uint256 arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
    if arg2 and sub_854aaa46 > -1 / arg2:
        revert with 0, 17
    return sub_2218f119[arg1], arg2 * sub_854aaa46 / 100
}
