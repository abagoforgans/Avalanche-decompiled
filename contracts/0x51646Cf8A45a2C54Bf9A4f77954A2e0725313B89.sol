    ...
    if stor1 == address(ext_call.return_data[0]):
        ...
        if not stor3[address(ext_call.return_data[0])][address(arg2)]:
            ...
            if stor3[address(ext_call.return_data[0])][address(arg2)]:
                ...
                if _3792 - 1 >= _3792:
                    revert with 0, 50
                if stor1 != address(ext_call.return_data[0]):
                    return mem[(32 * _3792 - 1) + (4 * ceil32(return_data.size)) + 288], Mask(255, 1, arg3)
            ...
            if stor1 == stor1:
                ...
                if _3789 - 1 >= _3789:
                    revert with 0, 50
                if stor1 != address(ext_call.return_data[0]):
                    return mem[(32 * _3789 - 1) + (4 * ceil32(return_data.size)) + 224], Mask(255, 1, arg3)
        ...
        if stor3[stor1][address(arg2)] == stor3[address(ext_call.return_data[0])][address(arg2)]:
            ...
            if _3795 - 1 >= _3795:
                revert with 0, 50
            if stor1 != address(ext_call.return_data[0]):
                return mem[(32 * _3795 - 1) + (4 * ceil32(return_data.size)) + 256], Mask(255, 1, arg3)
        ...
        if stor1 == address(ext_call.return_data[0]):
            if not stor3[stor1][address(arg2)]:
                ...
                if not stor3[address(ext_call.return_data[0])][address(arg2)]:
                    ...
                    if _3815 - 1 >= _3815:
                        revert with 0, 50
                    if stor1 != address(ext_call.return_data[0]):
                        return mem[(32 * _3815 - 1) + (4 * ceil32(return_data.size)) + 224], Mask(255, 1, arg3)
            ...
            if not stor3[stor1][address(arg2)]:
                ...
                if _3822 - 1 >= _3822:
                    revert with 0, 50
                if stor1 != address(ext_call.return_data[0]):
                    return mem[(32 * _3822 - 1) + (4 * ceil32(return_data.size)) + 256], Mask(255, 1, arg3)
