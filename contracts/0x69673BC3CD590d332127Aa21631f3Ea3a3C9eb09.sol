...
function viewUserInfoForLotteryId(address arg1, uint256 arg2, uint256 arg3, uint256 arg4) payable {
    ...
    if not stor16[address(arg1)][arg2] - arg3:
        ...
        if not stor16[address(arg1)][arg2] - arg3:
            ...
            if not stor16[address(arg1)][arg2] - arg3:
                ...
                return memory
                  from mem[64]
                   len (98 * stor16[address(arg1)][arg2]) + (-98 * arg3) + (32 * stor16[address(arg1)][arg2] - arg3) + (32 * _713) + (32 * _809) + -mem[64] + 416
        ...
        return memory
          from mem[64]
           len (98 * stor16[address(arg1)][arg2]) + (-98 * arg3) + (32 * stor16[address(arg1)][arg2] - arg3) + (32 * _716) + (32 * _812) + -mem[64] + 416
    ...
    if not stor16[address(arg1)][arg2] - arg3:
        ...
        if not stor16[address(arg1)][arg2] - arg3:
            ...
            return memory
              from mem[64]
               len (98 * stor16[address(arg1)][arg2]) + (-98 * arg3) + (32 * stor16[address(arg1)][arg2] - arg3) + (32 * _717) + (32 * _813) + -mem[64] + 416
        mem[(64 * stor16[address(arg1)][arg2] - arg3) + 192 len 32 * stor16[address(arg1)][arg2] - arg3] = call.data[calldata.size len 32 * stor16[address(arg1)][arg2] - arg3]
        idx = 0
        while idx < stor16[address(arg1)][arg2] - arg3:
            if idx > !arg3:
