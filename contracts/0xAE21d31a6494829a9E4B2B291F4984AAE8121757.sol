...
const sub_4e20a02c(?) = 10000 * 10^18

const sub_9cf78a14(?) = 0
...
function sub_d9374a61(?) payable {
    return sub_d9374a61Address
}
...
function sub_a892c827(?) payable {
    ...
    sub_d9374a61Address = address(arg1)
}
...
function distributeReward(address arg1, address arg2, address arg3) payable {
    ...
    emit Transfer(10000 * 10^18, 0, arg1);
    if not arg2:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply > -1:
        revert with 'NH{q', 17
    if balanceOf[address(arg2)] > -1:
        revert with 'NH{q', 17
    emit Transfer(0, 0, arg2);
    if not arg3:
        revert with 0, 'ERC20: mint to the zero address'
    if totalSupply > 0xffffffffffffffffffffffffffffffffffffffffffffffc9ca36523a215fffff:
        revert with 'NH{q', 17
    totalSupply += 1000 * 10^18
    if balanceOf[address(arg3)] > 0xffffffffffffffffffffffffffffffffffffffffffffffc9ca36523a215fffff:
        revert with 'NH{q', 17
