...
function sub_cb1d2b51(?) payable {
    ...
    mem[ceil32(sub_803b0f8a[arg1].length) + ceil32(sub_803b0f8a[arg1][1].length) + 160] = 160
    mem[ceil32(sub_803b0f8a[arg1].length) + ceil32(sub_803b0f8a[arg1][1].length) + 320] = sub_803b0f8a[arg1].length
    mem[ceil32(sub_803b0f8a[arg1].length) + ceil32(sub_803b0f8a[arg1][1].length) + 352 len ceil32(sub_803b0f8a[arg1].length)] = mem[128 len ceil32(sub_803b0f8a[arg1].length)]
    mem[ceil32(sub_803b0f8a[arg1].length) + ceil32(sub_803b0f8a[arg1][1].length) + 192] = sub_803b0f8a[arg1].length + 192
    mem[sub_803b0f8a[arg1].length + ceil32(sub_803b0f8a[arg1].length) + ceil32(sub_803b0f8a[arg1][1].length) + 352] = sub_803b0f8a[arg1][1].length
    mem[sub_803b0f8a[arg1].length + ceil32(sub_803b0f8a[arg1].length) + ceil32(sub_803b0f8a[arg1][1].length) + 384 len ceil32(sub_803b0f8a[arg1][1].length)] = mem[ceil32(sub_803b0f8a[arg1].length) + 160 len ceil32(sub_803b0f8a[arg1][1].length)]
    if not sub_803b0f8a[arg1][1].length % 32:
        return Array(len=sub_803b0f8a[arg1].length, data=mem[128 len ceil32(sub_803b0f8a[arg1].length)], mem[(2 * ceil32(sub_803b0f8a[arg1].length)) + ceil32(sub_803b0f8a[arg1][1].length) + 352 len sub_803b0f8a[arg1][1].length + sub_803b0f8a[arg1].length + -ceil32(sub_803b0f8a[arg1].length) + 32]), 
               sub_803b0f8a[arg1].length + 192,
               bool(sub_803b0f8a[arg1].field_512),
               uint256(sub_803b0f8a[arg1].field_768),
               uint256(sub_803b0f8a[arg1].field_1024)
    mem[floor32(sub_803b0f8a[arg1][1].length) + sub_803b0f8a[arg1].length + ceil32(sub_803b0f8a[arg1].length) + ceil32(sub_803b0f8a[arg1][1].length) + 384] = mem[floor32(sub_803b0f8a[arg1][1].length) + sub_803b0f8a[arg1].length + ceil32(sub_803b0f8a[arg1].length) + ceil32(sub_803b0f8a[arg1][1].length) + -sub_803b0f8a[arg1][1].length % 32 + 416 len sub_803b0f8a[arg1][1].length % 32]
    return Array(len=sub_803b0f8a[arg1].length, data=mem[128 len ceil32(sub_803b0f8a[arg1].length)], mem[(2 * ceil32(sub_803b0f8a[arg1].length)) + ceil32(sub_803b0f8a[arg1][1].length) + 352 len floor32(sub_803b0f8a[arg1][1].length) + sub_803b0f8a[arg1].length + -ceil32(sub_803b0f8a[arg1].length) + 64]), 
           sub_803b0f8a[arg1].length + 192,
           bool(sub_803b0f8a[arg1].field_512),
           uint256(sub_803b0f8a[arg1].field_768),
           uint256(sub_803b0f8a[arg1].field_1024)
...
function claimJackpot() payable {
    ...
    if uint8(stor10.length):
        revert with 0, 'Jackpot already claimed'
    uint8(stor10.length) = 1
    if uint256(sub_803b0f8a[address(stor2)].field_1024) > sub_2915d5db:
        revert with 0, 'SafeMath: subtraction overflow'
    if sub_2915d5db - uint256(sub_803b0f8a[address(stor2)].field_1024) + uint256(sub_803b0f8a[address(stor2)].field_768) < uint256(sub_803b0f8a[address(stor2)].field_768):
        revert with 0, 'SafeMath: addition overflow'
    uint256(sub_803b0f8a[address(stor2)].field_768) = sub_2915d5db - uint256(sub_803b0f8a[address(stor2)].field_1024) + uint256(sub_803b0f8a[address(stor2)].field_768)
    idx = 0
    while idx < 5:
        ...
        s = 0
        while s < 5:
            if sub_06f6a017[s] >= uint256(sub_803b0f8a[address(stor2)].field_768):
                s = s + 1
                continue 
            t = idx
            while t > s:
                ...
                continue 
            require s < 5
            sub_06f6a017[s] = uint256(sub_803b0f8a[address(stor2)].field_768)
            ...
            if not jackpot:
                ...
                if 3000 * jackpot / 10000 <= ext_call.return_data[0]:
                    call nestAddress.0xa9059cbb with:
                         gas gas_remaining wei
                        args stor12, 3000 * jackpot / 10000
                else:
                    call nestAddress.0xa9059cbb with:
                         gas gas_remaining wei
                        args stor12, ext_call.return_data[0]
            ...
            if not jackpot:
                ...
                if 1000 * jackpot / 10000 <= ext_call.return_data[0]:
                    call nestAddress.0xa9059cbb with:
                         gas gas_remaining wei
                        args stor13, 1000 * jackpot / 10000
                else:
                    call nestAddress.0xa9059cbb with:
                         gas gas_remaining wei
                        args stor13, ext_call.return_data[0]
    ...
    idx = 0
    while idx < 5:
        if sub_06f6a017[idx] >= uint256(sub_803b0f8a[address(stor2)].field_768):
            idx = idx + 1
            continue 
        s = 4
        while s > idx:
            ...
            continue 
        if idx < 4:
            sub_06f6a017[idx] = uint256(sub_803b0f8a[address(stor2)].field_768)
            sub_853082a6[idx] = address(sub_982cfe85Address)
        else:
            if uint256(sub_803b0f8a[address(stor2)].field_768) > stor20:
                require idx < 5
                sub_06f6a017[idx] = uint256(sub_803b0f8a[address(stor2)].field_768)
                sub_853082a6[idx] = address(sub_982cfe85Address)
        if not jackpot:
...
function sub_f40a3685(?) payable {
    ...
    if not sub_2f366d6f:
        if not sub_2f366d6f:
            if not sub_2f366d6f:
                if uint256(sub_803b0f8a[address(stor2)].field_1024) > block.timestamp:
                    revert with 0, 'SafeMath: subtraction overflow'
                if block.timestamp - uint256(sub_803b0f8a[address(stor2)].field_1024) + uint256(sub_803b0f8a[address(stor2)].field_768) < uint256(sub_803b0f8a[address(stor2)].field_768):
                    revert with 0, 'SafeMath: addition overflow'
                uint256(sub_803b0f8a[address(stor2)].field_768) = block.timestamp - uint256(sub_803b0f8a[address(stor2)].field_1024) + uint256(sub_803b0f8a[address(stor2)].field_768)
                uint256(sub_803b0f8a[msg.sender].field_1024) = block.timestamp
                idx = 0
                while idx < 5:
                    if sub_853082a6[idx] != address(sub_982cfe85Address):
                        idx = idx + 1
