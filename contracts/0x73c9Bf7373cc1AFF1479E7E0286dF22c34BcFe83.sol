...
function emergencyWithdraw() payable {
    ...
    if userInfo[address(msg.sender)].field_0 > 0:
        ...
        if ext_code.size(stakedTokenAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = transfer(address rg1, uint256 rg2), msg.sender, userInfo[address(msg.sender)].field_32
        ...
        if not return_data.size:
            if not ext_call.success:
                revert with transfer(address rg1, uint256 rg2), msg.sender, userInfo[address(msg.sender)].field_0
            if not transfer(address rg1, uint256 rg2), Mask(224, 32, msg.sender) >> 32:
                revert with 0, 32, 42, 0xfe5361666542455032303a204245503230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
        else:
            mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
    ...
    if not userInfo[address(msg.sender)].field_0:
        ...
        if arg1 <= 0:
            if (0 / PRECISION_FACTOR) - userInfo[address(msg.sender)].field_256 <= 0:
                ...
                if ext_code.size(rewardTokenAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[260 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, (0 / PRECISION_FACTOR) - userInfo[address(msg.sender)].field_256) >> 32
                call rewardTokenAddress with:
                   funct uint32(msg.sender)
                     gas gas_remaining wei
                ...
                if not return_data.size:
                    if not ext_call.success:
                        revert with transfer(address rg1, uint256 rg2), msg.sender, (0 / PRECISION_FACTOR) - userInfo[address(msg.sender)].field_256
                    if not transfer(address rg1, uint256 rg2), Mask(224, 32, msg.sender) >> 32:
                        revert with 0, 32, 42, 0xfe5361666542455032303a204245503230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
            ...
            if not return_data.size:
                ...
                if (0 / PRECISION_FACTOR) - userInfo[address(msg.sender)].field_256 <= 0:
                    ...
                    if ext_code.size(rewardTokenAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[424 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, (0 / PRECISION_FACTOR) - userInfo[address(msg.sender)].field_256) >> 32
                    call rewardTokenAddress with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                ...
                if (0 / PRECISION_FACTOR) - userInfo[address(msg.sender)].field_256 <= 0:
                    ...
                    if ext_code.size(rewardTokenAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 425 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, (0 / PRECISION_FACTOR) - userInfo[address(msg.sender)].field_256) >> 32
        ...
        if arg1 <= 0:
            if (userInfo[address(msg.sender)].field_0 * accTokenPerShare / PRECISION_FACTOR) - userInfo[address(msg.sender)].field_256 <= 0:
                ...
                if ext_code.size(rewardTokenAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[260 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, (userInfo[address(msg.sender)].field_0 * accTokenPerShare / PRECISION_FACTOR) - userInfo[address(msg.sender)].field_256) >> 32
                call rewardTokenAddress with:
                   funct uint32(msg.sender)
                     gas gas_remaining wei
            ...
            if not return_data.size:
                ...
                if (userInfo[address(msg.sender)].field_0 * accTokenPerShare / PRECISION_FACTOR) - userInfo[address(msg.sender)].field_256 <= 0:
                    ...
                    if ext_code.size(rewardTokenAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[424 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, (userInfo[address(msg.sender)].field_0 * accTokenPerShare / PRECISION_FACTOR) - userInfo[address(msg.sender)].field_256) >> 32
                    call rewardTokenAddress with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
                ...
                if (userInfo[address(msg.sender)].field_0 * accTokenPerShare / PRECISION_FACTOR) - userInfo[address(msg.sender)].field_256 <= 0:
                    ...
                    if ext_code.size(rewardTokenAddress) <= 0:
                        revert with 0, 'Address: call to non-contract'
                    mem[ceil32(return_data.size) + 425 len 64] = transfer(address rg1, uint256 rg2), msg.sender, Mask(224, 32, (userInfo[address(msg.sender)].field_0 * accTokenPerShare / PRECISION_FACTOR) - userInfo[address(msg.sender)].field_256) >> 32
                    mem[ceil32(return_data.size) + 517 len 4] = 0
                    call rewardTokenAddress with:
                       funct uint32(msg.sender)
                         gas gas_remaining wei
