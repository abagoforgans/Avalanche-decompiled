...
function getThreshold() {
    if stor19 > 0x5c3bd5191b525a2484df7f5cfd6a43e17fc6f80abedcc69ba7:
        revert with 'NH{q', 17
    if 10^15 > !(2 * 10^17 * stor19):
        revert with 'NH{q', 17
    if (2 * 10^17 * stor19) + 10^15 >= 10 * 10^18:
        return 10 * 10^18
    if stor19 > 0x2d09370d42573603d4e1213067bce3251b64271d3f31ccfa00fe0:
        revert with 'NH{q', 17
    if 10^15 > !(10^14 * stor19):
        revert with 'NH{q', 17
    return ((10^14 * stor19) + 10^15)
}
...
function addLP() payable {
    call stor20.addLiquidityAVAX(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
       value msg.value wei
         gas gas_remaining wei
...
function swapBack() {
    ...
    call stor20.swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
    ...
    if 5 * 10^17 < sub_1e64971b:
        ...
        emit Transfer(5 * 10^18, 0, msg.sender);
                        ...
                        if stor10 != msg.sender:
                            if stor13 != msg.sender:
                                if not uint8(stor15.field_160):
                                    if balanceOf[this.address] >= totalSupply / 1000:
                        ...
                        if not arg1 - stor10:
                            ...
                            if (2 * 10^17 * stor19) + 10^15 >= 10 * 10^18:
                                ...
                                if 10^15 > !(10^14 * stor19):
                                    revert with 'NH{q', 17
                                if stor18:
                                    if wethBalance >= (10^14 * stor19) + 10^15:
                                        if sub_1e64971b > !stor4:
                                            revert with 'NH{q', 17
                                        sub_1e64971b += stor4
                                        call stor11.0xa9059cbb with:
...
function _fallback() payable {
    ...
    if unknown_0x70a08231(?????) <= uint32(call.func_hash) >> 224:
        if unknown_0xa0189905(?????) > uint32(call.func_hash) >> 224:
            ...
            if unknown_0x70a08231(?????) == uint32(call.func_hash) >> 224:
                ...
                require arg1 == address(arg1)
                return balanceOf[address(arg1)]
            if uint32(call.func_hash) >> 224 != unknown_0x76012729(?????):
                require unknown_0x8866eaec(?????) == uint32(call.func_hash) >> 224
                require not msg.value
                return bool(uint8(stor15.field_168))
            require not msg.value
            require msg.sender == stor14
            ...
            require return_data.size >= 32
            require ext_call.return_data[0] == bool(ext_call.return_data[0])
        if unknown_0xba0607c3(?????) <= uint32(call.func_hash) >> 224:
            if unknown_0xba0607c3(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
                return sub_ba0607c3
            if uint32(call.func_hash) >> 224 != unknown_0xbc37e1a3(?????):
        ...
        if unknown_0x29b2b366(?????) <= uint32(call.func_hash) >> 224:
            ...
            if uint32(call.func_hash) >> 224 != unknown_0x6ac5eeee(?????):
                require unknown_0x6bd3d45b(?????) == uint32(call.func_hash) >> 224
                require not msg.value
                return sub_6bd3d45bAddress
            require not msg.value
            uint8(stor15.field_160) = 1
