...
function sub_c9f72bfa(?) {
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    mem[(6 * ceil32(return_data.size)) + 256] = ext_call.return_data[12 len 20]
    mem[(6 * ceil32(return_data.size)) + 224] = loveAddress
    ...
    if 1 >= _57:
        revert with 'NH{q', 50
    _73 = mem[_55 + ceil32(return_data.size) + 64]
    ...
    while idx < _75:
        ...
        t = t + 32
        continue 
    mem[mem[64] + 100] = 0x219007c0e048989df4aac4838cdcacb86b7e03c8
    mem[mem[64] + 132] = block.timestamp
    require ext_code.size(stor2)
    call stor2.swapExactTokensForAVAX(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args arg1, _73, 160, 0x219007c0e048989df4aac4838cdcacb86b7e03c8, block.timestamp, mem[mem[64] + 164 len (32 * _75) + 32]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _85 = mem[64]
    mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
    ...
    idx = 0
    s = _85 + _86 + 32
    t = _85 + ceil32(return_data.size) + 32
    while idx < _87:
        require mem[s] == mem[s]
        mem[t] = mem[s]
        idx = idx + 1
