...
const getName = 'StrategyPngAvaxTundraLp'
...
uint256 keepPNG;
address sub_1104f94aAddress;
address sub_4fcbad1cAddress;
address sub_3c0ef0b9Address;

function sub_1104f94a(?) {
    return sub_1104f94aAddress
}
...
function sub_3c0ef0b9(?) {
    return sub_3c0ef0b9Address
}

function sub_4fcbad1c(?) {
    return sub_4fcbad1cAddress
}
