...
function swapAndStake(uint256 arg1) payable {
    ...
    _66 = mem[ceil32(return_data.size) + 256]
    mem[(32 * _43) + ceil32(return_data.size) + 224] = 0x38ed173900000000000000000000000000000000000000000000000000000000
    mem[(32 * _43) + ceil32(return_data.size) + 228] = arg1
    mem[(32 * _43) + ceil32(return_data.size) + 260] = 99 * _66 / 100
    ...
    call traderJoeRouterAddress.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args arg1, 99 * _66 / 100, Array(len=2, data=mem[(32 * _43) + ceil32(return_data.size) + 420 len 64]), address(this.address), block.timestamp + 60
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require return_data.size >= 32
    require mem[(32 * _43) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32 <= 4294967296
    require mem[(32 * _43) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32 + 32 <= return_data.size
    require mem[(32 * _43) + ceil32(return_data.size) + mem[(32 * _43) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32 + 224] <= 4294967296 and mem[(32 * _43) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32 + (32 * mem[(32 * _43) + ceil32(return_data.size) + mem[(32 * _43) + ceil32(return_data.size) + 224 len 4], Mask(224, 32, arg1) >> 32 + 224]) + 32 <= return_data.size
