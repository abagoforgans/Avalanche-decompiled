...
function sub_fd17d1cf(?) payable {
    ...
    mem[_101 + ceil32(return_data.size) + 32 len ceil32(32 * _103)] = mem[_101 + _102 + 32 len ceil32(32 * _103)]
...
function sub_79514b03(?) payable {
    ...
    if mem[_149 + mem[_149]] > test266151307():
        revert with 'NH{q', 65
    if _149 + ceil32(return_data.size) + ceil32(32 * mem[_149 + mem[_149]]) + 1 > test266151307() or ceil32(32 * mem[_149 + mem[_149]]) + 1 < 0:
        revert with 'NH{q', 65
    mem[64] = _149 + ceil32(return_data.size) + ceil32(32 * mem[_149 + mem[_149]]) + 1
    mem[_149 + ceil32(return_data.size)] = _151
    require (32 * _151) + _150 + 32 <= return_data.size
    mem[_149 + ceil32(return_data.size) + 32 len ceil32(32 * _151)] = mem[_149 + _150 + 32 len ceil32(32 * _151)]
    mem[mem[64] + 4] = this.address
    staticcall stor1.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    if not arg2:
        ...
        call stor10.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args _499, 0, 160, address(this.address), block.timestamp + 1, mem[mem[64] + 164 len (32 * _503) + 32]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _531 = mem[64]
        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        call stor6.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args _330, 0, 160, address(this.address), block.timestamp + 1, mem[mem[64] + 164 len (32 * _334) + 32]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _408 = mem[64]
        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
        ...
        call stor10.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
             gas gas_remaining wei
            args _500, arg1, 160, address(this.address), block.timestamp + 1, mem[mem[64] + 164 len (32 * _504) + 32]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        _532 = mem[64]
        mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
