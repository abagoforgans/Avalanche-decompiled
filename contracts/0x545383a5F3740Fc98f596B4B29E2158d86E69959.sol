...
function a() payable {
    ...
    call stor1.mint(uint256 arg1) with:
       value eth.balance(this.address) wei
    ...
    if not stor2[ext_call.return_data[0]]:
        revert with 0, 'Not we want'
    require ext_code.size(stor1)
    call stor1.safeTransferFrom(address arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
        args address(this.address), 0xed8e67b65207575ba31f8cb9f3fd476e0396ec8f, ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
