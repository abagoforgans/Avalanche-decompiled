...
const contractURI = 32, 53, 0x6e697066733a2f2f516d5765637763703971703638636661354e61727a4150626b6a6a386d323977653176334d4e69597942667847, mem[181 len 11] >> 168, 0
...
function mint(address arg1) payable {
    ...
    mem[ceil32(return_data.size) + 128 len 62] = 0xfe697066733a2f2f516d5665354846424e63466857555145677361376f5271724b577646344e795268765934515961543932666a5a312f3131312e6a736f
...
function sub_3771aaa1(?) payable {
    ...
    if not ('cd', 4).length:
        ...
        while idx < ('cd', 4).length:
            ...
            mem[64] = mem[64] + 96
            mem[_292] = 62
            mem[_292 + 32 len 62] = 0xfe697066733a2f2f516d5665354846424e63466857555145677361376f5271724b577646344e795268765934515961543932666a5a312f3131312e6a736f
            if not ownerOf[stor8]:
                revert with 0, 'ERC721URIStorage: URI set of nonexistent token'
            mem[32] = 6
            if bool(stor6[stor8].field_0):
    ...
    while idx < ('cd', 4).length:
        ...
        mem[64] = mem[64] + 96
        mem[_293] = 62
        mem[_293 + 32 len 62] = 0xfe697066733a2f2f516d5665354846424e63466857555145677361376f5271724b577646344e795268765934515961543932666a5a312f3131312e6a736f
        if not ownerOf[stor8]:
            revert with 0, 'ERC721URIStorage: URI set of nonexistent token'
        mem[32] = 6
        if bool(stor6[stor8].field_0):
