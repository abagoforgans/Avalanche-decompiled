...
function getPrice() {
    if tokenByIndex.length / 100 > -2:
        revert with 'NH{q', 17
    if (tokenByIndex.length / 100) + 1 and 5 * 10^17 > -1 / (tokenByIndex.length / 100) + 1:
        revert with 'NH{q', 17
    return ((5 * 10^17 * tokenByIndex.length / 100) + 5 * 10^17)
}
...
function mint() payable {
    if tokenByIndex.length >= MAX_PUBLIC_SUPPLY:
        revert with 0, 'All NFTs have been minted'
    if tokenByIndex.length / 100 > -2:
        revert with 'NH{q', 17
    if (tokenByIndex.length / 100) + 1 and 5 * 10^17 > -1 / (tokenByIndex.length / 100) + 1:
        revert with 'NH{q', 17
    if (5 * 10^17 * tokenByIndex.length / 100) + 5 * 10^17 != msg.value:
        revert with 0, 'Payment incorrect'
...
function tokenURI(uint256 arg1) {
    ...
    if not bool(stor12.length):
        ...
        if not arg1:
            ...
            if ceil32(mem[ceil32(stor12.length.field_1) + 192]) > mem[ceil32(stor12.length.field_1) + 192]:
                mem[ceil32(stor12.length.field_1) + stor12.length.field_1 + mem[ceil32(stor12.length.field_1) + 192] + 289] = 0
        ...
        mem[ceil32(stor12.length.field_1) + ceil32(s) + stor12.length.field_1 + mem[ceil32(stor12.length.field_1) + 128] + 192] = 32
        mem[ceil32(stor12.length.field_1) + ceil32(s) + stor12.length.field_1 + mem[ceil32(stor12.length.field_1) + 128] + 224] = mem[ceil32(stor12.length.field_1) + ceil32(s) + 160]
        mem[ceil32(stor12.length.field_1) + ceil32(s) + stor12.length.field_1 + mem[ceil32(stor12.length.field_1) + 128] + 256 len ceil32(mem[ceil32(stor12.length.field_1) + ceil32(s) + 160])] = mem[ceil32(stor12.length.field_1) + ceil32(s) + 192 len ceil32(mem[ceil32(stor12.length.field_1) + ceil32(s) + 160])]
        if ceil32(mem[ceil32(stor12.length.field_1) + ceil32(s) + 160]) > mem[ceil32(stor12.length.field_1) + ceil32(s) + 160]:
            mem[ceil32(stor12.length.field_1) + ceil32(s) + stor12.length.field_1 + mem[ceil32(stor12.length.field_1) + 128] + mem[ceil32(stor12.length.field_1) + ceil32(s) + 160] + 256] = 0
        return Array(len=mem[ceil32(stor12.length.field_1) + ceil32(s) + 160], data=mem[ceil32(stor12.length.field_1) + ceil32(s) + stor12.length.field_1 + mem[ceil32(stor12.length.field_1) + 128] + 256 len ceil32(mem[ceil32(stor12.length.field_1) + ceil32(s) + 160])]), 
    if bool(stor12.length) == stor12.length.field_1 < 32:
        revert with 'NH{q', 34
    ...
    if bool(stor12.length):
        ...
        if not stor12.length.field_1:
            ...
            if ceil32(stor12.length.field_1) > stor12.length.field_1:
                mem[ceil32(stor12.length.field_1) + ceil32(s) + stor12.length.field_1 + 192] = 0
            mem[ceil32(stor12.length.field_1) + ceil32(s) + stor12.length.field_1 + 192 len ceil32(mem[ceil32(stor12.length.field_1) + 128])] = mem[ceil32(stor12.length.field_1) + 160 len ceil32(mem[ceil32(stor12.length.field_1) + 128])]
            mem[64] = ceil32(stor12.length.field_1) + ceil32(s) + stor12.length.field_1 + mem[ceil32(stor12.length.field_1) + 128] + 192
        else:
            if 31 >= stor12.length.field_1:
                mem[128] = 256 * stor12.length.field_8
            else:
    ...
    if ceil32(mem[ceil32(stor12.length.field_1) + ceil32(s) + 160]) <= mem[ceil32(stor12.length.field_1) + ceil32(s) + 160]:
        return Array(len=mem[ceil32(stor12.length.field_1) + ceil32(s) + 160], data=mem[ceil32(stor12.length.field_1) + ceil32(s) + stor12.length.field_1 + mem[ceil32(stor12.length.field_1) + 128] + 256 len ceil32(mem[ceil32(stor12.length.field_1) + ceil32(s) + 160])]), 
    mem[ceil32(stor12.length.field_1) + ceil32(s) + stor12.length.field_1 + mem[ceil32(stor12.length.field_1) + 128] + mem[ceil32(stor12.length.field_1) + ceil32(s) + 160] + 256] = 0
    return 32, mem[ceil32(stor12.length.field_1) + ceil32(s) + stor12.length.field_1 + mem[ceil32(stor12.length.field_1) + 128] + 224 len ceil32(mem[ceil32(stor12.length.field_1) + ceil32(s) + 160]) + 32], 
}
