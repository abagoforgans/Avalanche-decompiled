...
function initialize(address arg1, address arg2) {
    ...
    if owner != msg.sender:
        revert with 0, 'dOwnable: caller is not the owne'
    stor103[0xb31f66aa3c1e785363f0875a1b74e27b85fd66000000000000000000000000] = 1
    if not stor103[0xb31f66aa3c1e785363f0875a1b74e27b85fd66000000000000000000000000]:
        tokens.length++
        stor7FB4[stor105.length] = 0xb31f66aa3c1e785363f0875a1b74e27b85fd66
    if owner != msg.sender:
        revert with 0, 'dOwnable: caller is not the owne'
    stor103[0xde3a24028580884448a5397872046a019649b084] = 1
    if not stor103[0xde3a24028580884448a5397872046a019649b084]:
        tokens.length++
        stor7FB4[stor105.length] = 0xde3a24028580884448a5397872046a019649b084
    if owner != msg.sender:
        revert with 0, 'dOwnable: caller is not the owne'
    stor103[stor101] = 1
    if not stor103[stor101]:
        tokens.length++
        stor7FB4[stor105.length] = JOEAddress
    if owner != msg.sender:
        revert with 0, 'dOwnable: caller is not the owne'
    stor103[0xba7deebbfc5fa1100fb055a87773e1e99cd3507a] = 1
    if not stor103[0xba7deebbfc5fa1100fb055a87773e1e99cd3507a]:
        tokens.length++
        stor7FB4[stor105.length] = 0xba7deebbfc5fa1100fb055a87773e1e99cd3507a
...
function sweep() payable {
    ...
    while idx < tokens.length:
        ...
        if not ext_call.return_data[0]:
            ...
            continue 
        mem[0] = 105
        if 0x72000000000000000000000000b31f66aa3c1e785363f0875a1b74e27b85fd66 == tokens[idx]:
        ...
        if not routePair[stor105[idx]]:
            ...
            if 0 < mem[_69]:
                ...
                mem[0] = tokens[idx]
                if 1 < mem[_69]:
                    mem[_69 + 64] = 0xb31f66aa3c1e785363f0875a1b74e27b85fd66
            ...
            if 0 < mem[_71]:
                ...
                if 1 < mem[_71]:
                    ...
                    mem[0] = tokens[idx]
                    if 2 < mem[_71]:
                        mem[_71 + 96] = 0xb31f66aa3c1e785363f0875a1b74e27b85fd66
...
function zapIn(address arg1) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if 0x72000000000000000000000000b31f66aa3c1e785363f0875a1b74e27b85fd66 == address(ext_call.return_data[0]):
        mem[32] = 104
        if 0x72000000000000000000000000b31f66aa3c1e785363f0875a1b74e27b85fd66 == address(ext_call.return_data[0]):
        ...
        if 0x72000000000000000000000000b31f66aa3c1e785363f0875a1b74e27b85fd66 == address(ext_call.return_data[0]):
            ...
            if not routePair[address(ext_call.return_data[0])]:
                ...
                if not routePair[address(ext_call.return_data[0])]:
                    ...
                    mem[0] = address(ext_call.return_data[0])
                    mem[(32 * _2622) + ceil32(return_data.size) + 256] = 0xb31f66aa3c1e785363f0875a1b74e27b85fd66
                        ...
                        if ext_call.return_data[0]:
                            ...
                            if return_data.size:
                                ...
                                if not mem[(32 * _7434) + (32 * _2622) + (2 * ceil32(return_data.size)) + ceil32(return_data.size) + 713]:
                                    ...
                                    mem[(32 * _7434) + (32 * _2622) + (4 * ceil32(return_data.size)) + 750 len 42] = 0xc75361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565
                                    revert with memory
                                      from (32 * _7434) + (32 * _2622) + (4 * ceil32(return_data.size)) + 682
                        ...
                        if ext_call.return_data[0]:
                            ...
                            if return_data.size:
                                ...
                                if not mem[(32 * _7435) + (32 * _2622) + (2 * ceil32(return_data.size)) + ceil32(return_data.size) + 745]:
                                    ...
                                    mem[(32 * _7435) + (32 * _2622) + (4 * ceil32(return_data.size)) + 782 len 42] = 0xc75361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565
                                    revert with memory
                                      from (32 * _7435) + (32 * _2622) + (4 * ceil32(return_data.size)) + 714
                                       len (6 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 132
                ...
                if not routePair[address(ext_call.return_data[0])]:
                    ...
                    mem[0] = address(ext_call.return_data[0])
                    mem[(32 * _2623) + ceil32(return_data.size) + 288] = 0xb31f66aa3c1e785363f0875a1b74e27b85fd66
                        ...
                        if ext_call.return_data[0]:
                            ...
                            if return_data.size:
                                ...
                                if not mem[(32 * _7436) + (32 * _2623) + (2 * ceil32(return_data.size)) + ceil32(return_data.size) + 745]:
                                    ...
                                    mem[(32 * _7436) + (32 * _2623) + (4 * ceil32(return_data.size)) + 782 len 42] = 0xc75361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565
                                    revert with memory
                                      from (32 * _7436) + (32 * _2623) + (4 * ceil32(return_data.size)) + 714
                                       len (6 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 132
                        ...
                        if ext_call.return_data[0]:
                            ...
                            if return_data.size:
                                ...
                                if not mem[(32 * _7437) + (32 * _2623) + (2 * ceil32(return_data.size)) + ceil32(return_data.size) + 777]:
                                    ...
                                    mem[(32 * _7437) + (32 * _2623) + (4 * ceil32(return_data.size)) + 814 len 42] = 0xc75361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565
                                    revert with memory
                                      from (32 * _7437) + (32 * _2623) + (4 * ceil32(return_data.size)) + 746
                                       len (6 * ceil32(return_data.size)) + (-2 * ceil32(return_data.size)) + 132
