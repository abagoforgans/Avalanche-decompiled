...
function sub_9c4d7ad8(?) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    if arg1 >= sub_9c4d7ad8.length:
        revert with 'NH{q', 50
    return sub_9c4d7ad8[arg1].field_256
}

function items(uint256 arg1) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    require arg1 < sub_9c4d7ad8.length
    return sub_9c4d7ad8[arg1].field_0, sub_9c4d7ad8[arg1].field_256
}
...
function burnItem(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
...
function createItem(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    require ext_code.size(0x7273a2b25b506ced8b60eb3aa1eae661a888b412)
    ...
    if address(ext_call.return_data[0]) != msg.sender:
        if address(ext_call.return_data[0]) != msg.sender:
            require msg.sender == ext_call.return_data[12 len 20]
    sub_9c4d7ad8.length++
    sub_9c4d7ad8[sub_9c4d7ad8.length].field_0 = sub_9c4d7ad8.length
    sub_9c4d7ad8[sub_9c4d7ad8.length].field_256 = arg2
    if not arg1:
        revert with 0, 'ERC721: mint to the zero address'
    if ownerOf[stor10.length]:
        revert with 0, 'ERC721: token already minted'
    stor9[stor10.length] = tokenByIndex.length
    tokenByIndex.length++
    tokenByIndex[tokenByIndex.length] = sub_9c4d7ad8.length
    if arg1:
        tokenOfOwnerByIndex[address(arg1)][stor3[address(arg1)]] = sub_9c4d7ad8.length
        stor7[stor10.length] = balanceOf[address(arg1)]
    else:
        if tokenByIndex.length < 1:
            revert with 'NH{q', 17
        if tokenByIndex.length - 1 >= tokenByIndex.length:
            revert with 'NH{q', 50
        if stor9[stor10.length] >= tokenByIndex.length:
            revert with 'NH{q', 50
        tokenByIndex[stor9[stor10.length]] = tokenByIndex[tokenByIndex.length]
        stor9[stor8[stor8.length]] = stor9[stor10.length]
    ...
    emit Transfer(0, arg1, sub_9c4d7ad8.length);
    return sub_9c4d7ad8.length
}
