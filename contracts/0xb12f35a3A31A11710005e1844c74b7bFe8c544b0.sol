...
function setPriceFeed(address arg1) {
    ...
    create contract with 0 wei
                    code: code.data[13355 len 914], address(arg1)
...
function sub_5b6c3924(?) {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    staticcall stor2.0x8e15f473 with:
...
function sub_1a5df9c2(?) payable {
    ...
    while idx < mem[ceil32(return_data.size) + 96]:
        ...
        t = t + 32
        continue 
    mem[(2 * ceil32(return_data.size)) + 260] = fundAddress
    mem[(2 * ceil32(return_data.size)) + 292] = block.timestamp + 60
    call address(stor3.field_0).mem[mem[64] len 4] with:
       value msg.value wei
         gas gas_remaining wei
    ...
    idx = _37 + _38 + 32
    s = _37 + ceil32(return_data.size) + 32
    while idx < _37 + _38 + (32 * _39) + 32:
