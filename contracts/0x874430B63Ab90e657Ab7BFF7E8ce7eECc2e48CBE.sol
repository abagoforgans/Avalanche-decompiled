...
function adminMintGiveaways(address arg1) {
    ...
    if sub_206efc7e > -2:
        revert with 'NH{q', 17
    emit 0x27ad918f: sub_206efc7e + 1, 1, arg1
    if sub_206efc7e == -1:
        revert with 'NH{q', 17
    sub_206efc7e++
    if 1 > -sub_206efc7e - 1:
    ...
    emit Transfer(0, arg1, sub_206efc7e + 1);
}
...
function adminMint(uint256 arg1) {
    ...
    if sub_206efc7e > -2:
        revert with 'NH{q', 17
    emit 0x27ad918f: sub_206efc7e + 1, arg1, msg.sender
    idx = 0
    while idx < arg1:
        if sub_206efc7e == -1:
            revert with 'NH{q', 17
        ...
        mem[0] = sub_206efc7e + 1
        mem[32] = 2
        ownerOf[stor8 + 1] = msg.sender
        emit Transfer(0, msg.sender, sub_206efc7e + 1);
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
...
function sub_2bde06b9(?) payable {
    ...
    if arg1 > maxBatch:
        revert with 0, 'Incorrect mint count'
    if sub_206efc7e > -arg1 - 1:
        revert with 'NH{q', 17
    if sub_206efc7e + arg1 > totalCount:
