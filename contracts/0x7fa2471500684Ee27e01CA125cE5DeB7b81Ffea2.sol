...
function _getNodeNumberOf(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    delegate 0x5755874262175fa7e524995a8e3aa73f34378af6.0x732a2ccf with:
...
function finalizeMigration() payable {
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[12 len 20]
    if ext_call.return_data[12 len 20] != 0x506117ee4975fa921d99d7dace973ac7075c5d04:
...
function createNode(address arg1, string arg2) payable {
    ...
    require ext_code.size(0x5755874262175fa7e524995a8e3aa73f34378af6)
    delegate 0x5755874262175fa7e524995a8e3aa73f34378af6.0xbc2b405c with:
         gas gas_remaining wei
