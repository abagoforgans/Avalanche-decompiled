...
function sub_841d4573(?) payable {
    ...
    if arg1 >= sub_0e31c2e3.length:
        revert with 'NH{q', 50
    if sub_0e31c2e3[arg1] and sub_ba0dcc87[arg1] > -1 / sub_0e31c2e3[arg1]:
        revert with 'NH{q', 17
    require ext_code.size(sub_bb189cca[arg1])
    call sub_bb189cca[arg1].transfer(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args sub_99c6acf2Address, sub_0e31c2e3[arg1] * sub_ba0dcc87[arg1] / 10000
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    ...
    call sub_bb189cca[arg1].transfer(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args devAddress, sub_0e31c2e3[arg1] * sub_ba0dcc87[arg1] / 10000
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    if sub_0e31c2e3[arg1] * sub_ba0dcc87[arg1] / 10000 and 2 > -1 / sub_0e31c2e3[arg1] * sub_ba0dcc87[arg1] / 10000:
        revert with 'NH{q', 17
    if arg1 >= sub_0e31c2e3.length:
        revert with 'NH{q', 50
    if sub_0e31c2e3[arg1] < 2 * sub_0e31c2e3[arg1] * sub_ba0dcc87[arg1] / 10000:
        revert with 'NH{q', 17
    if sub_0e31c2e3[arg1] - (2 * sub_0e31c2e3[arg1] * sub_ba0dcc87[arg1] / 10000) < sub_0e31c2e3[arg1] * sub_41e3956a[arg1] / 10000:
        revert with 'NH{q', 17
    if sub_0e31c2e3[arg1] - (2 * sub_0e31c2e3[arg1] * sub_ba0dcc87[arg1] / 10000) - (sub_0e31c2e3[arg1] * sub_41e3956a[arg1] / 10000) < sub_0e31c2e3[arg1] * burnRate[arg1] / 10000:
        revert with 'NH{q', 17
    require ext_code.size(sub_bb189cca[arg1])
    call sub_bb189cca[arg1].transfer(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args sub_835591aeAddress, sub_0e31c2e3[arg1] - (2 * sub_0e31c2e3[arg1] * sub_ba0dcc87[arg1] / 10000) - (sub_0e31c2e3[arg1] * sub_41e3956a[arg1] / 10000) - (sub_0e31c2e3[arg1] * burnRate[arg1] / 10000)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
