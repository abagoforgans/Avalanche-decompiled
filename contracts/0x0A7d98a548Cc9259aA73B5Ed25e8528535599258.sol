...
function sub_c1a3ea87(?) payable {
    ...
    address(stor2.field_8) = address(arg1)
}
...
function getPendingRewards() payable {
    ...
    staticcall address(stor2.field_8).0x31d7a262 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function getCurrentRewardsPerLP() payable {
    ...
    if rewardTokenAddress != stakingTokenAddress:
        if ext_call.return_data[0] > -ext_call.return_data[0] - 1:
            revert with 'NH{q', 17
        if 2 * ext_call.return_data[0] <= lastContractBalance:
            return cumulativeRewardsPerLP
        if not totalStaked:
            return cumulativeRewardsPerLP
        if 2 * ext_call.return_data[0] < lastContractBalance:
            revert with 'NH{q', 17
        if (2 * ext_call.return_data[0]) - lastContractBalance and accuracyFactor > -1 / (2 * ext_call.return_data[0]) - lastContractBalance:
            revert with 'NH{q', 17
        if not totalStaked:
            revert with 'NH{q', 18
        if cumulativeRewardsPerLP > -((ext_call.return_data[0] * accuracyFactor) + (ext_call.return_data[0] * accuracyFactor) - (lastContractBalance * accuracyFactor) / totalStaked) - 1:
            revert with 'NH{q', 17
        return (cumulativeRewardsPerLP + ((ext_call.return_data[0] * accuracyFactor) + (ext_call.return_data[0] * accuracyFactor) - (lastContractBalance * accuracyFactor) / totalStaked))
    if ext_call.return_data[0] < totalStaked:
        revert with 'NH{q', 17
    if ext_call.return_data[0] - totalStaked > -ext_call.return_data[0] - 1:
        revert with 'NH{q', 17
    if (2 * ext_call.return_data[0]) - totalStaked <= lastContractBalance:
        return cumulativeRewardsPerLP
    if not totalStaked:
        return cumulativeRewardsPerLP
    if (2 * ext_call.return_data[0]) - totalStaked < lastContractBalance:
        revert with 'NH{q', 17
    if (2 * ext_call.return_data[0]) - totalStaked - lastContractBalance and accuracyFactor > -1 / (2 * ext_call.return_data[0]) - totalStaked - lastContractBalance:
        revert with 'NH{q', 17
    if not totalStaked:
        revert with 'NH{q', 18
    if cumulativeRewardsPerLP > -((ext_call.return_data[0] * accuracyFactor) - (totalStaked * accuracyFactor) + (ext_call.return_data[0] * accuracyFactor) - (lastContractBalance * accuracyFactor) / totalStaked) - 1:
        revert with 'NH{q', 17
    return (cumulativeRewardsPerLP + ((ext_call.return_data[0] * accuracyFactor) - (totalStaked * accuracyFactor) + (ext_call.return_data[0] * accuracyFactor) - (lastContractBalance * accuracyFactor) / totalStaked))
}
...
function getUnrealisedEarnings(address arg1) payable {
    ...
    if rewardTokenAddress != stakingTokenAddress:
        ...
        if cumulativeRewardsPerLP > -((ext_call.return_data[0] * accuracyFactor) + (ext_call.return_data[0] * accuracyFactor) - (lastContractBalance * accuracyFactor) / totalStaked) - 1:
            revert with 'NH{q', 17
        if stakes[address(arg1)].field_256 and cumulativeRewardsPerLP + ((ext_call.return_data[0] * accuracyFactor) + (ext_call.return_data[0] * accuracyFactor) - (lastContractBalance * accuracyFactor) / totalStaked) > -1 / stakes[address(arg1)].field_256:
            revert with 'NH{q', 17
        if not accuracyFactor:
            revert with 'NH{q', 18
        if (cumulativeRewardsPerLP * stakes[address(arg1)].field_256) + ((ext_call.return_data[0] * accuracyFactor) + (ext_call.return_data[0] * accuracyFactor) - (lastContractBalance * accuracyFactor) / totalStaked * stakes[address(arg1)].field_256) / accuracyFactor <= stakes[address(arg1)].field_512:
            return 0
        if (cumulativeRewardsPerLP * stakes[address(arg1)].field_256) + ((ext_call.return_data[0] * accuracyFactor) + (ext_call.return_data[0] * accuracyFactor) - (lastContractBalance * accuracyFactor) / totalStaked * stakes[address(arg1)].field_256) / accuracyFactor < stakes[address(arg1)].field_512:
            revert with 'NH{q', 17
        return (((cumulativeRewardsPerLP * stakes[address(arg1)].field_256) + ((ext_call.return_data[0] * accuracyFactor) + (ext_call.return_data[0] * accuracyFactor) - (lastContractBalance * accuracyFactor) / totalStaked * stakes[address(arg1)].field_256) / accuracyFactor) - stakes[address(arg1)].field_512)
    if ext_call.return_data[0] < totalStaked:
        revert with 'NH{q', 17
    if ext_call.return_data[0] - totalStaked > -ext_call.return_data[0] - 1:
        revert with 'NH{q', 17
    ...
    if cumulativeRewardsPerLP > -((ext_call.return_data[0] * accuracyFactor) - (totalStaked * accuracyFactor) + (ext_call.return_data[0] * accuracyFactor) - (lastContractBalance * accuracyFactor) / totalStaked) - 1:
        revert with 'NH{q', 17
    if stakes[address(arg1)].field_256 and cumulativeRewardsPerLP + ((ext_call.return_data[0] * accuracyFactor) - (totalStaked * accuracyFactor) + (ext_call.return_data[0] * accuracyFactor) - (lastContractBalance * accuracyFactor) / totalStaked) > -1 / stakes[address(arg1)].field_256:
        revert with 'NH{q', 17
    if not accuracyFactor:
        revert with 'NH{q', 18
    if (cumulativeRewardsPerLP * stakes[address(arg1)].field_256) + ((ext_call.return_data[0] * accuracyFactor) - (totalStaked * accuracyFactor) + (ext_call.return_data[0] * accuracyFactor) - (lastContractBalance * accuracyFactor) / totalStaked * stakes[address(arg1)].field_256) / accuracyFactor <= stakes[address(arg1)].field_512:
        return 0
    if (cumulativeRewardsPerLP * stakes[address(arg1)].field_256) + ((ext_call.return_data[0] * accuracyFactor) - (totalStaked * accuracyFactor) + (ext_call.return_data[0] * accuracyFactor) - (lastContractBalance * accuracyFactor) / totalStaked * stakes[address(arg1)].field_256) / accuracyFactor < stakes[address(arg1)].field_512:
        revert with 'NH{q', 17
    return (((cumulativeRewardsPerLP * stakes[address(arg1)].field_256) + ((ext_call.return_data[0] * accuracyFactor) - (totalStaked * accuracyFactor) + (ext_call.return_data[0] * accuracyFactor) - (lastContractBalance * accuracyFactor) / totalStaked * stakes[address(arg1)].field_256) / accuracyFactor) - stakes[address(arg1)].field_512)
}
...
function realise() payable {
    if uint8(stor2.field_0):
        require stor1[address(msg.sender)]
    require ext_code.size(address(stor2.field_8))
    call address(stor2.field_8).0xe4fc6b6d with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(rewardTokenAddress)
