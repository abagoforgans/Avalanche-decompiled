...
uint256 poolId;
uint256 sub_e4a8d38c;
address sub_b4d9fe2fAddress;
...
function sub_b4d9fe2f(?) {
    return sub_b4d9fe2fAddress
}
...
function balanceOfPool() {
    ...
    staticcall 0x188bed1968b795d5c9022f6a0bb5931ac4c18f00.0x93f1a40b with:
            gas gas_remaining wei
...
function withdrawForSwap(uint256 arg1) {
    ...
    if address(controllerAddress) != msg.sender:
        revert with 0, '!controller'
    require ext_code.size(0x188bed1968b795d5c9022f6a0bb5931ac4c18f00)
    call 0x188bed1968b795d5c9022f6a0bb5931ac4c18f00.0x441a3e70 with:
         gas gas_remaining wei
        args poolId, arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
