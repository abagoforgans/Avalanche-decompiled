...
function sub_62784cd7(?) payable {
    require ext_code.size(rewardsTokenAddress)
    staticcall rewardsTokenAddress._maxSupply() with:
...
function stake(uint256 arg1) payable {
    ...
    if not totalSupply:
        ...
        if not msg.sender:
            ...
            if ext_code.hash(stakingTokenAddress) == 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470:
                revert with 0, 'SafeERC20: call to non-contract'
