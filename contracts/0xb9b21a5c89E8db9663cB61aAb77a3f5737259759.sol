...
function claim() payable {
    ...
    if not users[msg.sender].field_256:
        if 0 == users[msg.sender].field_256:
        ...
        if mem[(32 * users[msg.sender].field_256 - 1) + 192] != currentRound:
            if users[msg.sender].field_256 - users[msg.sender].field_0 <= 50:
                ...
                if users[msg.sender].field_0 > !(users[msg.sender].field_256 - users[msg.sender].field_0):
                    revert with 0, 17
                if var45002 >= users[msg.sender].field_256:
                    require ext_code.size(stor202)
                    call stor202.0xb4767398 with:
                         gas gas_remaining wei
                        args msg.sender, var45004
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    stor151 = 1
                if var47001 >= users[msg.sender].field_256:
                    revert with 0, 50
                if var51001 and var51002 > -1 / var51001:
                    revert with 0, 17
                ...
                if users[msg.sender].field_0 > -51:
                    revert with 0, 17
                if var45002 >= users[msg.sender].field_0 + 50:
                    require ext_code.size(stor202)
                    call stor202.0xb4767398 with:
                         gas gas_remaining wei
                        args msg.sender, var45004
            ...
            if users[msg.sender].field_256 + -users[msg.sender].field_0 - 1 <= 50:
                ...
                if users[msg.sender].field_0 > !(users[msg.sender].field_256 + -users[msg.sender].field_0 - 1):
                    revert with 0, 17
                if var49002 >= users[msg.sender].field_256 - 1:
                    require ext_code.size(stor202)
                    call stor202.0xb4767398 with:
                         gas gas_remaining wei
                        args msg.sender, var49004
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    stor151 = 1
                if var51001 >= users[msg.sender].field_256:
                    revert with 0, 50
                if var55001 and var55002 > -1 / var55001:
                    revert with 0, 17
                ...
                if users[msg.sender].field_0 > -51:
                    revert with 0, 17
                if var49002 >= users[msg.sender].field_0 + 50:
                    require ext_code.size(stor202)
                    call stor202.0xb4767398 with:
                         gas gas_remaining wei
                        args msg.sender, var49004
        ...
        if mem[(32 * users[msg.sender].field_256 - 1) + 192] != currentRound:
            if users[msg.sender].field_256 - users[msg.sender].field_0 <= 50:
                ...
                if users[msg.sender].field_0 > !(users[msg.sender].field_256 - users[msg.sender].field_0):
                    revert with 0, 17
                if var49002 >= users[msg.sender].field_256:
                    require ext_code.size(stor202)
                    call stor202.0xb4767398 with:
                         gas gas_remaining wei
                        args msg.sender, var49004
            ...
            if users[msg.sender].field_256 + -users[msg.sender].field_0 - 1 <= 50:
                ...
                if users[msg.sender].field_0 > !(users[msg.sender].field_256 + -users[msg.sender].field_0 - 1):
                    revert with 0, 17
                if var53002 >= users[msg.sender].field_256 - 1:
                    require ext_code.size(stor202)
                    call stor202.0xb4767398 with:
                         gas gas_remaining wei
                        args msg.sender, var53004
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    stor151 = 1
                if var55001 >= users[msg.sender].field_256:
                    revert with 0, 50
                if var59001 and var59002 > -1 / var59001:
                    revert with 0, 17
                ...
                if users[msg.sender].field_0 > -51:
                    revert with 0, 17
                if var53002 >= users[msg.sender].field_0 + 50:
                    require ext_code.size(stor202)
                    call stor202.0xb4767398 with:
                         gas gas_remaining wei
                        args msg.sender, var53004
