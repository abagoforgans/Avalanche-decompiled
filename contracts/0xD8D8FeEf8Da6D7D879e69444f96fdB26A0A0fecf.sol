...
function setDistribution(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    require arg2 == arg2
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_d08648fdAddress = arg1
    sub_fed0a1f8 = arg2
}
...
function claimable(address arg1) payable {
    ...
    while idx < balanceOf[address(arg1)]:
        ...
        mem[32] = 22
        if stor22[stor6[address(arg1)][idx]]:
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
            s = s
...
function claim() payable {
    ...
    while idx < balanceOf[address(msg.sender)]:
        ...
        mem[32] = 22
        if stor22[stor6[address(msg.sender)][idx]]:
            if idx == -1:
                revert with 'NH{q', 17
            idx = idx + 1
            s = s
        ...
        mem[0] = tokenOfOwnerByIndex[address(msg.sender)][idx]
        mem[32] = 22
        stor22[stor6[address(msg.sender)][idx]] = 1
        if s > -sub_fed0a1f8 - 1:
            revert with 'NH{q', 17
        if idx == -1:
            revert with 'NH{q', 17
...
function mintTo(address arg1) payable {
    ...
    require arg1 == arg1
    if owner != msg.sender:
        if stor18[address(msg.sender)] >= MAX_MINTS_PER_ADDRESS:
...
function tokenURI(uint256 arg1) payable {
    ...
    if not s:
        ...
        if bool(stor14.length):
            ...
            if not bool(stor14.length):
                ...
                if ceil32(mem[96]) <= mem[96]:
                    _587 = mem[64]
                    mem[64] = mem[64] + stor14.length.field_1 + mem[96] + 32
                    mem[_359 + stor14.length.field_1 + mem[96] + 32] = 32
                    _631 = mem[_587]
                    ...
                    return memory
                      from mem[64]
                       len _359 + stor14.length.field_1 + _395 + ceil32(_631) + -mem[64] + 96
                mem[mem[64] + stor14.length.field_1 + mem[96] + 32] = 0
                _600 = mem[64]
                mem[64] = mem[64] + stor14.length.field_1 + mem[96] + 32
                mem[_359 + stor14.length.field_1 + mem[96] + 32] = 32
                _639 = mem[_600]
        ...
        if not bool(stor14.length):
            ...
            if ceil32(mem[96]) <= mem[96]:
                ...
                return memory
                  from mem[64]
                   len _359 + stor14.length.field_1 + _400 + ceil32(_633) + -mem[64] + 96
            mem[mem[64] + stor14.length.field_1 + mem[96] + 32] = 0
            _604 = mem[64]
            mem[64] = mem[64] + stor14.length.field_1 + mem[96] + 32
            mem[_359 + stor14.length.field_1 + mem[96] + 32] = 32
    ...
    if bool(stor14.length):
        ...
        if not bool(stor14.length):
            ...
            if ceil32(mem[96]) <= mem[96]:
                _593 = mem[64]
                mem[64] = mem[64] + stor14.length.field_1 + mem[96] + 32
                mem[_360 + stor14.length.field_1 + mem[96] + 32] = 32
                _635 = mem[_593]
                ...
                return memory
                  from mem[64]
                   len _360 + stor14.length.field_1 + _396 + ceil32(_635) + -mem[64] + 96
            mem[mem[64] + stor14.length.field_1 + mem[96] + 32] = 0
            _608 = mem[64]
            mem[64] = mem[64] + stor14.length.field_1 + mem[96] + 32
            mem[_360 + stor14.length.field_1 + mem[96] + 32] = 32
    ...
    if not bool(stor14.length):
        ...
        if ceil32(mem[96]) <= mem[96]:
            ...
            return memory
              from mem[64]
               len _360 + stor14.length.field_1 + _402 + ceil32(_637) + -mem[64] + 96
        mem[mem[64] + stor14.length.field_1 + mem[96] + 32] = 0
        _612 = mem[64]
        mem[64] = mem[64] + stor14.length.field_1 + mem[96] + 32
        mem[_360 + stor14.length.field_1 + mem[96] + 32] = 32
