...
function sushi() {
    ...
    if chainid != 137:
        ...
        uniswapAddress = 0x1b02da8cb0d097eb8d57a175b88c7d8b47997506
        factoryAddress = 0xc35dadb65012ec5796536bd9864ed8773abc74c4
        require ext_code.size(wethAddress)
        call wethAddress.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args 0x1b02da8cb0d097eb8d57a175b88c7d8b47997506, -1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
...
function sub_80b52e8f(?) {
    if not uint8(stor7.field_160):
        ...
        if not ext_call.return_data[12 len 20]:
            ...
            mem[ceil32(return_data.size) + 132] = sub_9d3c8cc4Address
            require ext_code.size(factoryAddress)
            staticcall factoryAddress.getPair(address arg1, address arg2) with:
                    gas gas_remaining wei
                   args tokenAddress, sub_9d3c8cc4Address
            ...
            if not ext_call.success:
                ...
                call uniswapAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                     gas gas_remaining wei
                    args eth_buy_amt, 10^18 * eth_buy_amt / max_price, Array(len=3, data=mem[(4 * ceil32(return_data.size)) + 420 len 96]), sellerAddress, block.timestamp
            else:
                require return_data.size >= 32
                require ext_call.return_data[0] == ext_call.return_data[31 len 1]
                if not ext_call.return_data[31 len 1]:
                    ...
                    mem[(6 * ceil32(return_data.size)) + 160] = sub_9d3c8cc4Address
                    mem[(6 * ceil32(return_data.size)) + 192] = tokenAddress
                    mem[(6 * ceil32(return_data.size)) + 224] = 0x5c11d79500000000000000000000000000000000000000000000000000000000
                    mem[(6 * ceil32(return_data.size)) + 228] = eth_buy_amt
                    idx = 0
                    ...
                    call uniswapAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args eth_buy_amt, eth_buy_amt / max_price, Array(len=3, data=mem[(6 * ceil32(return_data.size)) + 420 len 96]), sellerAddress, block.timestamp
                else:
                    if bool(bool(ext_call.return_data[31 len 1] < 78)) or bool(bool(ext_call.return_data[31 len 1] < 32)):
                        if 10^ext_call.return_data[31 len 1] and eth_buy_amt > -1 / 10^ext_call.return_data[31 len 1]:
                            revert with 0, 17
                        ...
                        call uniswapAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args eth_buy_amt, 10^uint8(ext_call.return_data[0]) * eth_buy_amt / max_price, Array(len=3, data=mem[(6 * ceil32(return_data.size)) + 420 len 96]), sellerAddress, block.timestamp
                    else:
                        s = 10
                        t = 1
                        idx = ext_call.return_data[31 len 1]
                        ...
                        v = (6 * ceil32(return_data.size)) + 420
                        while idx < 3:
                            mem[v] = mem[u + 12 len 20]
                            idx = idx + 1
                            u = u + 32
                        ...
                        call uniswapAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args eth_buy_amt, s * t * eth_buy_amt / max_price, Array(len=3, data=mem[(6 * ceil32(return_data.size)) + 420 len 96]), sellerAddress, block.timestamp
        else:
            mem[ceil32(return_data.size) + 100] = address(ext_call.return_data[0])
            require ext_code.size(tokenAddress)
            staticcall tokenAddress.0x70a08231 with:
            ...
            if ext_call.return_data[0]:
                ...
                if not ext_call.success:
                    ...
                    if not max_price:
                        revert with 0, 18
                    mem[(2 * ceil32(return_data.size)) + 128] = wethAddress
                    mem[(2 * ceil32(return_data.size)) + 160] = usdtAddress
                    mem[(2 * ceil32(return_data.size)) + 192] = tokenAddress
                    mem[(2 * ceil32(return_data.size)) + 224] = 0x5c11d79500000000000000000000000000000000000000000000000000000000
                    mem[(2 * ceil32(return_data.size)) + 228] = eth_buy_amt
                    idx = 0
                    ...
                    if not ext_call.return_data[31 len 1]:
                        ...
                        if not max_price:
                            revert with 0, 18
                        mem[(4 * ceil32(return_data.size)) + 128] = wethAddress
                        mem[(4 * ceil32(return_data.size)) + 160] = usdtAddress
                        mem[(4 * ceil32(return_data.size)) + 192] = tokenAddress
                        mem[(4 * ceil32(return_data.size)) + 224] = 0x5c11d79500000000000000000000000000000000000000000000000000000000
                        mem[(4 * ceil32(return_data.size)) + 228] = eth_buy_amt
                        idx = 0
                ...
                if not uint8(stor7.field_168):
                    revert with 0, '2'
                mem[(2 * ceil32(return_data.size)) + 100] = tokenAddress
                mem[(2 * ceil32(return_data.size)) + 132] = sub_9d3c8cc4Address
                require ext_code.size(factoryAddress)
                staticcall factoryAddress.getPair(address arg1, address arg2) with:
                        gas gas_remaining wei
                       args tokenAddress, sub_9d3c8cc4Address
                ...
                if not ext_call.success:
                    ...
                    call uniswapAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                         gas gas_remaining wei
                        args eth_buy_amt, 10^18 * eth_buy_amt / max_price, Array(len=3, data=mem[(6 * ceil32(return_data.size)) + 420 len 96]), sellerAddress, block.timestamp
                else:
                    require return_data.size >= 32
                    require ext_call.return_data[0] == ext_call.return_data[31 len 1]
                    if not ext_call.return_data[31 len 1]:
                        ...
                        mem[(7 * ceil32(return_data.size)) + 160] = sub_9d3c8cc4Address
                        mem[(7 * ceil32(return_data.size)) + 192] = tokenAddress
                        mem[(7 * ceil32(return_data.size)) + 224] = 0x5c11d79500000000000000000000000000000000000000000000000000000000
                        mem[(7 * ceil32(return_data.size)) + 228] = eth_buy_amt
                        idx = 0
                        ...
                        call uniswapAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                             gas gas_remaining wei
                            args eth_buy_amt, eth_buy_amt / max_price, Array(len=3, data=mem[(7 * ceil32(return_data.size)) + 420 len 96]), sellerAddress, block.timestamp
                    else:
                        if bool(bool(ext_call.return_data[31 len 1] < 78)) or bool(bool(ext_call.return_data[31 len 1] < 32)):
                            if 10^ext_call.return_data[31 len 1] and eth_buy_amt > -1 / 10^ext_call.return_data[31 len 1]:
                                revert with 0, 17
                            ...
                            call uniswapAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                 gas gas_remaining wei
                                args eth_buy_amt, 10^uint8(ext_call.return_data[0]) * eth_buy_amt / max_price, Array(len=3, data=mem[(7 * ceil32(return_data.size)) + 420 len 96]), sellerAddress, block.timestamp
                        else:
                            s = 10
                            t = 1
                            idx = ext_call.return_data[31 len 1]
                            ...
                            v = (7 * ceil32(return_data.size)) + 420
                            while idx < 3:
                                mem[v] = mem[u + 12 len 20]
                                idx = idx + 1
                                u = u + 32
                            ...
                            call uniswapAddress.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                                 gas gas_remaining wei
                                args eth_buy_amt, s * t * eth_buy_amt / max_price, Array(len=3, data=mem[(7 * ceil32(return_data.size)) + 420 len 96]), sellerAddress, block.timestamp
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
