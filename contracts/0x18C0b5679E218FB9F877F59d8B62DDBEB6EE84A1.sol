...
function sub_99d47339(?) payable {
    ...
    staticcall settingsAddress.0x808a5457 with:
...
function purchaseWithUSDC(uint256 arg1) payable {
    ...
    staticcall address(ext_call.return_data[0]).mem[mem[64] len 4] with:
            gas gas_remaining wei
           args mem[mem[64] + 4 len (11 * ceil32(return_data.size)) + -mem[64] + 352]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _298 = mem[64]
    ...
    _300 = mem[_298 + mem[_298]]
    if mem[_298 + mem[_298]] > test266151307():
        revert with 0, 65
    if ceil32(32 * mem[_298 + mem[_298]]) + 1 < 0 or _298 + ceil32(return_data.size) + ceil32(32 * mem[_298 + mem[_298]]) + 1 > test266151307():
        revert with 0, 65
    mem[64] = _298 + ceil32(return_data.size) + ceil32(32 * mem[_298 + mem[_298]]) + 1
    mem[_298 + ceil32(return_data.size)] = _300
    require return_data.size >= _299 + (32 * _300) + 32
    mem[_298 + ceil32(return_data.size) + 32 len 32 * _300] = mem[_298 + _299 + 32 len 32 * _300]
    if 0 >= _300:
        revert with 0, 50
    _554 = mem[_298 + ceil32(return_data.size) + 32]
    if arg1 and mem[_298 + ceil32(return_data.size) + 32] > -1 / arg1:
        revert with 0, 17
    if arg1 * mem[_298 + ceil32(return_data.size) + 32] and ext_call.return_data[0] - sub_e808bee6 > -1 / arg1 * mem[_298 + ceil32(return_data.size) + 32]:
        revert with 0, 17
    if not ext_call.return_data[0]:
        revert with 0, 18
    require ext_code.size(settingsAddress)
