...
function deposit() payable {
    ...
    require ext_call.return_data[0] == ext_call.return_data[0]
    if ext_call.return_data[0] <= 0:
    mem[ceil32(return_data.size) + 132] = 0xd6a4f121ca35509af06a0be99093d08462f53052
    mem[ceil32(return_data.size) + 164] = 0
    mem[ceil32(return_data.size) + 96] = 68
    mem[ceil32(return_data.size) + 132 len 28] = 0xd6a4f121ca35509af06a0be99093d084
    ...
    if ext_code.size(wantAddress) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[ceil32(return_data.size) + 260 len 96] = approve(address rg1, uint256 rg2), 0xd6a4f121ca35509af06a0be9, 0, 0, 0
    mem[ceil32(return_data.size) + 328] = 0
    call wantAddress with:
       funct Mask(32, 224, approve(address rg1, uint256 rg2), 0xd6a4f121ca35509af06a0be9, 0, 0, 0) >> 224
         gas gas_remaining wei
        args (Mask(512, -288, approve(address rg1, uint256 rg2), 0xd6a4f121ca35509af06a0be9, 0, 0, 0) << 288)
    if not return_data.size:
        if not ext_call.success:
            if ext_call.return_data[0] > 0:
                revert with memory
        ...
        if not ext_call.return_data[0]:
            mem[ceil32(return_data.size) + 296] = 0xd6a4f121ca35509af06a0be99093d08462f53052
            mem[ceil32(return_data.size) + 328] = ext_call.return_data[0]
            mem[ceil32(return_data.size) + 260] = 68
            mem[ceil32(return_data.size) + 292 len 4] = approve(address rg1, uint256 rg2)
            ...
            if ext_code.size(wantAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[ceil32(return_data.size) + 424 len 96] = 0, 0xd6a4f121ca35509af06a0be99093d08462f53052, ext_call.return_data[0], 0
            mem[ceil32(return_data.size) + 492] = 0
            call wantAddress with:
               funct Mask(32, 224, 0, 0xd6a4f121ca35509af06a0be99093d08462f53052, ext_call.return_data[0], 0) >> 224
                 gas gas_remaining wei
                args (Mask(512, -288, 0, 0xd6a4f121ca35509af06a0be99093d08462f53052, ext_call.return_data[0], 0) << 288)
            if not return_data.size:
                if not ext_call.success:
                    if ext_call.return_data[0] > 0:
                        revert with memory
            ...
            mem[(2 * ceil32(return_data.size)) + 296] = 0xd6a4f121ca35509af06a0be99093d08462f53052
            ...
            if ext_code.size(wantAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[(2 * ceil32(return_data.size)) + 424 len 96] = 0, 0xd6a4f121ca35509af06a0be99093d08462f53052, ext_call.return_data[0], 0
    ...
    if return_data.size > 0:
        ...
        if not mem[ceil32(return_data.size) + 292]:
            revert with 0, 'SafeERC20: ERC20 operation did not succeed'
    if not ext_call.return_data[0]:
        mem[ceil32(return_data.size) + ceil32(return_data.size) + 297] = 0xd6a4f121ca35509af06a0be99093d08462f53052
        ...
        mem[ceil32(return_data.size) + ceil32(return_data.size) + 293 len 4] = approve(address rg1, uint256 rg2)
        ...
        if ext_code.size(wantAddress) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + ceil32(return_data.size) + 425 len 96] = 0, 0xd6a4f121ca35509af06a0be99093d08462f53052, ext_call.return_data[0], 0
        ...
        if return_data.size <= 0:
            mem[(4 * ceil32(return_data.size)) + 430] = stor8
    ...
    if ext_call.return_data[0]:
        revert with 0, 'SafeERC20: approve from non-zero to non-zero allowance'
    mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 297] = 0xd6a4f121ca35509af06a0be99093d08462f53052
    ...
    if ext_code.size(wantAddress) <= 0:
        revert with 0, 'Address: call to non-contract'
    mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + 425 len 96] = 0, 0xd6a4f121ca35509af06a0be99093d08462f53052, ext_call.return_data[0], 0
