...
function buyNode(uint256 arg1) payable {
    ...
    require (32 * _154) + mem[_123 + ceil32(return_data.size) + 96 len 4], Mask(224, 0, stor4.field_32) + 32 <= return_data.size
    mem[_123 + (2 * ceil32(return_data.size)) + 128 len ceil32(32 * _154)] = mem[_123 + ceil32(return_data.size) + mem[_123 + ceil32(return_data.size) + 96 len 4], Mask(224, 0, stor4.field_32) + 128 len ceil32(32 * _154)]
    if 1 >= _154:
        revert with 0, 50
