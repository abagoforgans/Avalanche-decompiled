...
function earn() payable {
    ...
    if not ext_call.return_data[0]:
        ...
        if not return_data.size:
            ...
            if not uint255(ext_call.return_data[0]):
                ...
                if totalSupply <= 0:
                    revert with 0, 'SafeMath: division by zero'
                require totalSupply
                emit PPS((2 * 10^18 * ext_call.return_data[0] / totalSupply));
        else:
            mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
            if not ext_call.success:
                if return_data.size > 0:
        ...
        if not return_data.size:
            if not ext_call.success:
                revert with unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), ext_call.return_data[0] * min / 10000
            if not unknown_0xa9059cbb(?????), Mask(224, 0, stor8):
                revert with 0, 32, 42, 0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
            require ext_code.size(address(strategyAddress))
            call address(strategyAddress).0xd0e30db0 with:
...
function depositAll() payable {
    ...
    if not return_data.size:
        ...
        if ext_call.return_data[0] > ext_call.return_data[0]:
            revert with 0, 'SafeMath: subtraction overflow'
        require ext_code.size(address(strategyAddress))
        staticcall address(strategyAddress).0x21c3b917 with:
                gas gas_remaining wei
               args 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if totalSupply:
            if not ext_call.return_data[0]:
                ...
                require ext_call.return_data[0]
                if ext_call.return_data[0] * totalSupply / ext_call.return_data[0] != totalSupply:
                ...
                if not msg.sender:
                    revert with 0, 'ERC20: mint to the zero address'
                if totalSupply + (ext_call.return_data[0] * totalSupply / 2 * ext_call.return_data[0]) < totalSupply:
                    revert with 0, 'SafeMath: addition overflow'
                totalSupply += ext_call.return_data[0] * totalSupply / 2 * ext_call.return_data[0]
                if balanceOf[address(msg.sender)] + (ext_call.return_data[0] * totalSupply / 2 * ext_call.return_data[0]) < balanceOf[address(msg.sender)]:
                    revert with 0, 'SafeMath: addition overflow'
            ...
            if not msg.sender:
                revert with 0, 'ERC20: mint to the zero address'
            if totalSupply + (2 * ext_call.return_data[0]) < totalSupply:
                revert with 0, 'SafeMath: addition overflow'
            totalSupply += 2 * ext_call.return_data[0]
            if balanceOf[address(msg.sender)] + (2 * ext_call.return_data[0]) < balanceOf[address(msg.sender)]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[address(msg.sender)] += 2 * ext_call.return_data[0]
            emit Transfer((2 * ext_call.return_data[0]), 0, msg.sender);
    else:
...
function deposit(uint256 arg1) payable {
    ...
    if not return_data.size:
        ...
        if totalSupply:
            ...
            if ext_code.size(tokenAddress) <= 0:
                revert with 0, 'Address: call to non-contract'
            mem[456 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), ext_call.return_data[0 len 28]
            call tokenAddress with:
               funct uint32(stor8)
                 gas gas_remaining wei
        ...
        if return_data.size <= 0:
            ...
            if totalSupply:
                ...
                if ext_code.size(tokenAddress) <= 0:
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 457 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor8), uint32(stor8), ext_call.return_data[0 len 28]
