                ...
                if return_data.size > 0:
                    ...
                    if not mem[388]:
                        revert with 0, 
                                    ...
                                    0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                    mem[ceil32(return_data.size) + 467 len 22]
            emit Withdraw((ext_call.return_data[0] * arg1 / totalSupply), msg.sender);
    stor6 = 1
}
    ...
    if not eth.balance(this.address):
        ...
        if return_data.size:
            ...
            if sub_24cc0766.length:
                ...
                mem[(32 * _1146) + ceil32(return_data.size) + ceil32(return_data.size) + 357 len 0] = 0
                call 0x81440c939f2c1e34fc7048e518a637205a632a74.0xd49d9101 with:
                     gas gas_remaining wei
                    ...
                    if return_data.size > 0:
                        ...
                        if not mem[(32 * _1146) + ceil32(return_data.size) + ceil32(return_data.size) + 325]:
                            revert with 0, 
                                        ...
                                        42,
                                        0x735361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565,
                                        mem[(32 * _1146) + (4 * ceil32(return_data.size)) + 404 len 22]
                    require ext_code.size(0x6140d3ed2426cbb24f07d884106d9018d49d9101)
                    call 0x6140d3ed2426cbb24f07d884106d9018d49d9101.stake(uint256 rg1) with:
                         gas gas_remaining wei
                        args ext_call.return_data[0]
                        ...
                        if not ext_call.return_data[0]:
                            ...
                            if 10^18 * ext_call.return_data[0] / ext_call.return_data[0] != 10^18:
                                revert with 0, 
                                            ...
                                            33,
                                            0x6c536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f,
                                            mem[(32 * _1146) + (4 * ceil32(return_data.size)) + 395 len 31]
                            if totalSupply <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require totalSupply
                            emit Reinvest(10^18 * ext_call.return_data[0] / totalSupply, block.timestamp);
            ...
            if not sub_24cc0766.length:
                ...
                mem[(32 * _49) + ceil32(return_data.size) + 356 len 0] = 0
                call 0x81440c939f2c1e34fc7048e518a637205a632a74.0xd49d9101 with:
                     gas gas_remaining wei
