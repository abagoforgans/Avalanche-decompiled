...
function _fallback() payable {
    ...
    if unknown_0x70a08231(?????) <= uint32(call.func_hash) >> 224:
        if unknown_0xa9059cbb(?????) <= uint32(call.func_hash) >> 224:
            ...
            if unknown_0xe8e33700(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
                require calldata.size - 4 >= 256
                require cd[4] == address(cd[4])
                require cd[36] == address(cd[36])
    ...
    if unknown_0x18160ddd(?????) > uint32(call.func_hash) >> 224:
        if removeLiquidityETH(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) == uint32(call.func_hash) >> 224:
            require not msg.value
            require calldata.size - 4 >= 192
            require cd[4] == address(cd[4])
    ...
    if unknown_0x18160ddd(?????) == uint32(call.func_hash) >> 224:
        require not msg.value
        return totalSupply
    if unknown_0x18cbafe5(?????) == uint32(call.func_hash) >> 224:
        require not msg.value
        require calldata.size - 4 >= 160
