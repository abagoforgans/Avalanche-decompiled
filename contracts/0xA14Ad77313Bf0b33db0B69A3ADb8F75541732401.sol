    ...
    if address(cd[36]) == address(cd[68]):
        ...
        while idx < ('cd', 132).length:
            ...
            while s < _89:
                ...
                u = u + 32
                continue 
            mem[mem[64] + 132] = address(_86)
            mem[mem[64] + 164] = block.timestamp + 30
            _115 = mem[64]
            mem[mem[64]] = (32 * _89) + 196
            mem[64] = mem[64] + (32 * _89) + 228
            mem[_115 + 32] = mem[_115 + 36 len 28] or 0x38ed173900000000000000000000000000000000000000000000000000000000
            _119 = mem[_115]
            s = 0
            while s < _119:
            ...
            if ceil32(_119) <= _119:
                call address(cd[4]).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _87 + (32 * _89) + _119 + -mem[64] + 224]
                if return_data.size:
                    _136 = mem[64]
        ...
        while idx < ('cd', 132).length:
            ...
            mem[_112 + 32] = mem[_112 + 36 len 28] or 0x38ed173900000000000000000000000000000000000000000000000000000000
            _118 = mem[_112]
            s = 0
            while s < _118:
