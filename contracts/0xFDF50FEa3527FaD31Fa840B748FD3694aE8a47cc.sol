...
function sub_54781336(?) payable {
    ...
    if uint8(arg1):
        if 1 == uint8(arg1):
            ...
            call address(arg2).claimReward(uint8 rg1, address rg2) with:
...
function sub_d9ca3c9c(?) payable {
    ...
    mem[(7 * ceil32(return_data.size)) + 1504] = mem[(6 * ceil32(return_data.size)) + mem[(6 * ceil32(return_data.size)) + 1504] + 1504]
    ...
    if ceil32(_25) <= _25:
        ...
        if ceil32(sub_7fedad55.length) <= sub_7fedad55.length:
                ...
                if ext_call.return_data[64] <= 2:
                    ...
                    if ext_call.return_data[64] != 1:
                        ...
                        if ext_call.return_data[64] <= 2:
                            ...
                            require ext_call.return_data[0] == ext_call.return_data[0]
                            require ext_code.size(address(ext_call.return_data[0]))
                            staticcall address(ext_call.return_data[0]).mintGuardianPaused(address rg1) with:
                                    gas gas_remaining wei
                                   args address(arg1)
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            ...
                            require ext_call.return_data[0] == bool(ext_call.return_data[0])
                            require ext_code.size(address(ext_call.return_data[0]))
                            staticcall address(ext_call.return_data[0]).borrowGuardianPaused(address rg1) with:
                                    gas gas_remaining wei
                                   args address(arg1)
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            ...
                            require ext_call.return_data[0] == bool(ext_call.return_data[0])
                            require ext_code.size(address(ext_call.return_data[0]))
                            staticcall address(ext_call.return_data[0]).supplyCaps(address rg1) with:
                                    gas gas_remaining wei
                                   args address(arg1)
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            ...
                            require ext_call.return_data[0] == ext_call.return_data[0]
                            require ext_code.size(address(ext_call.return_data[0]))
                            staticcall address(ext_call.return_data[0]).borrowCaps(address rg1) with:
                                    gas gas_remaining wei
                                   args address(arg1)
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
            ...
            _10965 = mem[64]
            mem[mem[64]] = sub_7fedad55.length + _6117 - mem[64]
            mem[64] = sub_7fedad55.length + _6117 + 32
        ...
        if ceil32(sub_7fedad55.length) <= sub_7fedad55.length:
            ...
            mem[sub_7fedad55.length + mem[64] + 32] = 0
            _10997 = mem[64]
            mem[mem[64]] = sub_7fedad55.length + _6118 - mem[64]
            mem[64] = sub_7fedad55.length + _6118 + 32
