...
function hatchEggs(address arg1) {
    ...
    if stor1 < block.timestamp - stor8[address(msg.sender)]:
        ...
        if stor7[stor9[msg.sender]] > !(stor7[address(msg.sender)] + (stor1 * sub_4b634b06[address(msg.sender)]) / 10):
            revert with 0, 17
        stor7[stor9[msg.sender]] += stor7[address(msg.sender)] + (stor1 * sub_4b634b06[address(msg.sender)]) / 10
        ...
        stor7[msg.sender] = 0
        stor8[msg.sender] = block.timestamp
        if stor7[stor9[msg.sender]] > !(stor7[address(msg.sender)] + (block.timestamp * sub_4b634b06[address(msg.sender)]) - (stor8[address(msg.sender)] * sub_4b634b06[address(msg.sender)]) / 10):
            revert with 0, 17
        stor7[stor9[msg.sender]] += stor7[address(msg.sender)] + (block.timestamp * sub_4b634b06[address(msg.sender)]) - (stor8[address(msg.sender)] * sub_4b634b06[address(msg.sender)]) / 10
