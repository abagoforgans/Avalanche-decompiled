...
#  - _fallback()
#
const sub_20df4359(?) = 0xbf233dd2aafeb4d50879c4aa5c81e96d92f6e6945c906a58f9f2d1c1631b4b26
...
function sub_c63cfd3e(?) payable {
    ...
    require arg3.length <= test266151307()
    require arg3 + arg3.length + 36 <= calldata.size
    if roleAdmin[0xbf233dd2aafeb4d50879c4aa5c81e96d92f6e6945c906a58f9f2d1c1631b4b26][address(msg.sender)].field_0:
        ...
        emit CallExecuted(bytes32 arg1, uint256 arg2, address arg3, uint256 arg4, bytes arg5):
                          address(arg1),
                          arg2,
                          Array(len=arg3.length, data=arg3[all]),
        emit 0x0: address(arg1), arg2, Array(len=arg3.length, data=arg3[all])
        emit 0x0: address(arg1), arg2, Array(len=arg3.length, data=arg3[all])
    mem[128 len 42] = call.data[calldata.size len 42]
    idx = 41
    s = address(msg.sender)
    ...
    mem[224 len 66] = call.data[calldata.size len 66]
    idx = 65
    s = 0xbf233dd2aafeb4d50879c4aa5c81e96d92f6e6945c906a58f9f2d1c1631b4b26
    while idx > 1:
        if s % 16 >= 16:
            revert with 'NH{q', 50
        if idx >= 66:
...
function schedule(address arg1, uint256 arg2, bytes arg3, bytes32 arg4, bytes32 arg5, uint256 arg6) {
    ...
    require arg3.length <= test266151307()
    require arg3 + arg3.length + 36 <= calldata.size
    if not roleAdmin[0xb09aa5aeb3702cfd50b6b62bc4532604938f21248a27a1d5ca736082b6819cc1][address(msg.sender)].field_0:
        mem[128 len 42] = call.data[calldata.size len 42]
        idx = 41
        s = address(msg.sender)
        while idx > 1:
...
function scheduleBatch(address[] arg1, uint256[] arg2, bytes[] arg3, bytes32 arg4, bytes32 arg5, uint256 arg6) {
    ...
    _45 = sha3(Array(len=arg1.length, data=mem[320 len (32 * arg1.length) + 32], call.data[arg2 + 36 len 32 * arg2.length], arg3.length, mem[(32 * arg1.length) + (32 * arg2.length) + 384 len (32 * arg3.length) + (32 * arg3.length)]), (32 * arg1.length) + 192, (32 * arg1.length) + (32 * arg2.length) + 224, arg4, arg5)
    ...
    while idx < arg1.length:
        ...
        mem[mem[64] + 96] = arg4
        mem[mem[64] + 128] = arg6
        emit CallScheduled(address(cd[((32 * idx) + arg1 + 36)]), cd[((32 * idx) + arg2 + 36)], Array(len=cd[(arg3 + cd[(arg3 + (32 * idx) + 36)] + 36)], data=call.data[arg3 + cd[(arg3 + (32 * idx) + 36)] + 68 len cd[(arg3 + cd[(arg3 + (32 * idx) + 36)] + 36)]]), arg4, arg6, _45, idx);
        if idx == -1:
            revert with 'NH{q', 17
        idx = idx + 1
        continue 
...
function executeBatch(address[] arg1, uint256[] arg2, bytes[] arg3, bytes32 arg4, bytes32 arg5) payable {
    ...
    if stor5BA6:
        ...
        while idx < arg3.length:
            ...
            continue 
        mem[64] = (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg3.length) + 384
        _208 = sha3(Array(len=arg1.length, data=mem[320 len (32 * arg1.length) + 32], call.data[arg2 + 36 len 32 * arg2.length], arg3.length, mem[(32 * arg1.length) + (32 * arg2.length) + 384 len (32 * arg3.length) + (32 * arg3.length)]), (32 * arg1.length) + 192, (32 * arg1.length) + (32 * arg2.length) + 224, arg4, arg5)
        ...
        if not arg4:
            ...
            while idx < arg1.length:
                ...
                emit CallExecuted(address(cd[((32 * idx) + arg1 + 36)]), cd[((32 * idx) + arg2 + 36)], Array(len=cd[(arg3 + cd[(arg3 + (32 * idx) + 36)] + 36)], data=call.data[arg3 + cd[(arg3 + (32 * idx) + 36)] + 68 len cd[(arg3 + cd[(arg3 + (32 * idx) + 36)] + 36)]]), _208, idx);
                if idx == -1:
                    revert with 'NH{q', 17
                idx = idx + 1
                continue 
        ...
        if timestamp[_208] <= 1:
            revert with 0, 'TimelockController: operation is not ready'
        if timestamp[_208] > block.timestamp:
            revert with 0, 'TimelockController: operation is not ready'
        timestamp[_208] = 1
    else:
        if not roleAdmin[0xd8aa0f3194971a2a116679f7c2090f6939c8d4e01a2a8d7e41d55e5351469e63][address(msg.sender)].field_0:
        ...
        mem[64] = (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg3.length) + 384
        _211 = sha3(Array(len=arg1.length, data=mem[320 len (32 * arg1.length) + 32], call.data[arg2 + 36 len 32 * arg2.length], arg3.length, mem[(32 * arg1.length) + (32 * arg2.length) + 384 len (32 * arg3.length) + (32 * arg3.length)]), (32 * arg1.length) + 192, (32 * arg1.length) + (32 * arg2.length) + 224, arg4, arg5)
        if timestamp[Array(len=arg1.length, data=mem[320 len (32 * arg1.length) + 32], call.data[arg2 + 36 len 32 * arg2.length], arg3.length, mem[(32 * arg1.length) + (32 * arg2.length) + 384 len (32 * arg3.length) + (32 * arg3.length)])][(32 * arg1.length) + 192][(32 * arg1.length) + (32 * arg2.length) + 224][arg4][arg5] <= 1:
            revert with 0, 'TimelockController: operation is not ready'
        if timestamp[Array(len=arg1.length, data=mem[320 len (32 * arg1.length) + 32], call.data[arg2 + 36 len 32 * arg2.length], arg3.length, mem[(32 * arg1.length) + (32 * arg2.length) + 384 len (32 * arg3.length) + (32 * arg3.length)])][(32 * arg1.length) + 192][(32 * arg1.length) + (32 * arg2.length) + 224][arg4][arg5] > block.timestamp:
            revert with 0, 'TimelockController: operation is not ready'
        if not arg4:
            ...
            while idx < arg1.length:
                ...
                mem[mem[64] + 128 len cd[(arg3 + cd[(arg3 + (32 * idx) + 36)] + 36)]] = call.data[arg3 + cd[(arg3 + (32 * idx) + 36)] + 68 len cd[(arg3 + cd[(arg3 + (32 * idx) + 36)] + 36)]]
                mem[mem[64] + cd[(arg3 + cd[(arg3 + (32 * idx) + 36)] + 36)] + 128] = 0
                emit CallExecuted(address(cd[((32 * idx) + arg1 + 36)]), cd[((32 * idx) + arg2 + 36)], Array(len=cd[(arg3 + cd[(arg3 + (32 * idx) + 36)] + 36)], data=call.data[arg3 + cd[(arg3 + (32 * idx) + 36)] + 68 len cd[(arg3 + cd[(arg3 + (32 * idx) + 36)] + 36)]]), _211, idx);
                if idx == -1:
                    revert with 'NH{q', 17
                idx = idx + 1
                continue 
        ...
        if timestamp[_211] <= 1:
            revert with 0, 'TimelockController: operation is not ready'
        if timestamp[_211] > block.timestamp:
            revert with 0, 'TimelockController: operation is not ready'
        timestamp[_211] = 1
}
