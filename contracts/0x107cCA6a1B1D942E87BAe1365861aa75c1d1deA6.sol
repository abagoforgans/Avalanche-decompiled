...
function sub_ec933a15(?) payable {
    ...
    if ceil32(_9) <= _9:
        ...
        if mem[_426 + 16 len 16] and uint64(_371) > test266151307() / mem[_426 + 16 len 16]:
            revert with 0, 17
        if uint128(uint64(_371) * mem[_426 + 16 len 16]) > 0x29cbc14e5e0a72f05397829cbc14e5e:
            revert with 0, 17
        if uint128(_380) < uint128(uint128(uint128(98 * uint128(uint64(_371) * mem[_426 + 16 len 16])) / 100) / 100):
            _546 = mem[64]
            mem[mem[64] + 36] = 0
            mem[mem[64] + 68] = 1
            mem[mem[64] + 100] = -1
            ...
            mem[_546 + 164] = uint128(_380) < uint128(uint128(uint128(98 * uint128(uint64(_371) * uint128(_453))) / 100) / 100)
            mem[_546 + 196] = 64
            _565 = mem[_547]
            ...
            if ceil32(_565) > _565:
                mem[_546 + _565 + 260] = 0
            return uint128(_380) < uint128(uint128(uint128(98 * uint128(uint64(_371) * uint128(_453))) / 100) / 100), 
                   64,
                   mem[_546 + 228 len ceil32(_565) + 32]
        if mem[_426 + 16 len 16] and uint64(_371) > test266151307() / mem[_426 + 16 len 16]:
            revert with 0, 17
        if uint128(uint64(_371) * mem[_426 + 16 len 16]) > 0x2828282828282828282828282828282:
            revert with 0, 17
        _572 = mem[64]
        mem[mem[64] + 36] = 0
        mem[mem[64] + 68] = 1
        ...
        mem[_572 + 164] = uint128(_380) > uint128(uint128(uint128(102 * uint128(uint64(_371) * uint128(_453))) / 100) / 100)
        mem[_572 + 196] = 64
        _581 = mem[_573]
        ...
        if ceil32(_581) > _581:
            mem[_572 + _581 + 260] = 0
        return uint128(_380) > uint128(uint128(uint128(102 * uint128(uint64(_371) * uint128(_453))) / 100) / 100), 
               64,
    ...
    if mem[_440 + 16 len 16] and uint64(_376) > test266151307() / mem[_440 + 16 len 16]:
        revert with 0, 17
    if uint128(uint64(_376) * mem[_440 + 16 len 16]) > 0x29cbc14e5e0a72f05397829cbc14e5e:
        revert with 0, 17
    if uint128(_383) < uint128(uint128(uint128(98 * uint128(uint64(_376) * mem[_440 + 16 len 16])) / 100) / 100):
        _556 = mem[64]
        mem[mem[64] + 36] = 0
        mem[mem[64] + 68] = 1
        mem[mem[64] + 100] = -1
        ...
        mem[_556 + 164] = uint128(_383) < uint128(uint128(uint128(98 * uint128(uint64(_376) * uint128(_460))) / 100) / 100)
        mem[_556 + 196] = 64
        _566 = mem[_557]
        ...
        if ceil32(_566) > _566:
            mem[_556 + _566 + 260] = 0
        return uint128(_383) < uint128(uint128(uint128(98 * uint128(uint64(_376) * uint128(_460))) / 100) / 100), 
               64,
               mem[_556 + 228 len ceil32(_566) + 32]
    if mem[_440 + 16 len 16] and uint64(_376) > test266151307() / mem[_440 + 16 len 16]:
        revert with 0, 17
    if uint128(uint64(_376) * mem[_440 + 16 len 16]) > 0x2828282828282828282828282828282:
        revert with 0, 17
    _576 = mem[64]
    mem[mem[64] + 36] = 0
    mem[mem[64] + 68] = 1
    ...
    mem[_576 + 164] = uint128(_383) > uint128(uint128(uint128(102 * uint128(uint64(_376) * uint128(_460))) / 100) / 100)
    mem[_576 + 196] = 64
    _582 = mem[_577]
    ...
    if ceil32(_582) > _582:
        mem[_576 + _582 + 260] = 0
    return uint128(_383) > uint128(uint128(uint128(102 * uint128(uint64(_376) * uint128(_460))) / 100) / 100), 
           64,
