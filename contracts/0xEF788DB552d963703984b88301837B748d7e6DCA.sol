...
function accrueAll(address[] arg1) {
    ...
    while idx < arg1.length:
        ...
        mem[32] = 142
        _85 = sha3(mem[(32 * idx) + 140 len 20], 142)
        ...
        if ext_call.return_data[0] <= banks[mem[0]].field_512:
            ...
            if not ext_call.return_data[0] - banks[mem[0]].field_512:
                ...
                mem[0] = address(_84)
                mem[32] = 142
                if wethAddress == address(_84):
                    mem[(32 * arg1.length) + 132] = 0
                    require ext_code.size(banks[address(_84)].field_16)
                    call banks[address(_84)].field_16.borrow(uint256 rg1) with:
                         gas gas_remaining wei
                        args 0
                    mem[(32 * arg1.length) + 128] = ext_call.return_data[0]
                    if not ext_call.success:
                    ...
                    if ext_call.return_data[0]:
                        revert with 0, '!borrow'
                    if banks[address(_84)].field_512 < banks[address(_84)].field_512:
                        revert with 0, 'SafeMath: addition overflow'
                    if eth.balance(this.address) > eth.balance(this.address):
                        revert with 0, 'SafeMath: subtraction overflow'
                else:
                    require ext_code.size(address(_84))
                    staticcall address(_84).0x70a08231 with:
                            gas gas_remaining wei
                           args this.address
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                ...
                mem[32] = 142
                if wethAddress == address(_84):
                    mem[(32 * arg1.length) + 132] = (ext_call.return_data[0] * feeBps) - (stor2[_85] * feeBps) / 10000
                    require ext_code.size(banks[address(_84)].field_16)
                    call banks[address(_84)].field_16.borrow(uint256 rg1) with:
                         gas gas_remaining wei
                        args ((ext_call.return_data[0] * feeBps) - (stor2[_85] * feeBps) / 10000)
                    mem[(32 * arg1.length) + 128] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    if ext_call.return_data[0]:
                        revert with 0, '!borrow'
                    if ((ext_call.return_data[0] * feeBps) - (stor2[_85] * feeBps) / 10000) + banks[address(_84)].field_512 < banks[address(_84)].field_512:
                        revert with 0, 'SafeMath: addition overflow'
                    banks[address(_84)].field_512 += (ext_call.return_data[0] * feeBps) - (stor2[_85] * feeBps) / 10000
                    if eth.balance(this.address) > eth.balance(this.address):
                        revert with 0, 'SafeMath: subtraction overflow'
                else:
                    require ext_code.size(address(_84))
                    ...
                    if ext_call.return_data[0] > ext_call.return_data[0]:
                        revert with 0, 'SafeMath: subtraction overflow'
            if uint256(stor1[_85]) < uint256(stor1[_85]):
                revert with 0, 'SafeMath: addition overflow'
        idx = idx + 1
        continue 
}
