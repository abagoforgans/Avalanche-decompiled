...
uint256 stor4;
address sub_d0dd7e35Address;
address sub_d4546ee8Address;
uint256 withdrawalFee;
uint256 callFee;
uint256 sub_2443c887;
uint256 sub_439cc14a;
uint8 sub_9f8b5da1;
...
function sub_d0dd7e35(?) payable {
    return sub_d0dd7e35Address
}

function sub_d4546ee8(?) payable {
    return sub_d4546ee8Address
}
...
function sub_c6ffe619(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'wOwnable: caller is not the owne'
    sub_d4546ee8Address = arg1
}

function sub_e8d20b00(?) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'wOwnable: caller is not the owne'
    sub_d0dd7e35Address = arg1
}
...
function rewardsAvailable() payable {
    ...
    mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 437 len 64] = Mask(32, 224, sha3(mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 341 len mem[ceil32(sub_277e5cfd.length) + 192]])) >> 224, poolId, Mask(224, 32, this.address) >> 32
...
function callReward() payable {
    ...
    if not ext_code.size(chefAddress):
        revert with 0, 
                    ...
                    0x72416464726573733a207374617469632063616c6c20746f206e6f6e2d636f6e74726163,
                    mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 541 len 28]
    mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 437 len 64] = mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 273 len 4], poolId, Mask(224, 32, this.address) >> 32
    mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 529 len 4] = 0
    staticcall chefAddress.mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 273 len 4] with:
            gas gas_remaining wei
           args Mask(224, 32, this.address) << 224, mem[ceil32(sub_277e5cfd.length) + sub_277e5cfd.length + 501 len 4]
