...
function sub_a404a335(?) {
    require ext_code.size(stor3)
    staticcall stor3.currentOrderId() with:
...
function sub_1b646bc4(?) {
    require calldata.size - 4 >= 32
    require ext_code.size(stor3)
    staticcall stor3.sellOrders(uint256 arg1) with:
            gas gas_remaining wei
           args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_545e7048(?) {
    ...
    while idx < ext_call.return_data[0]:
        ...
        if _25 == arg1:
            if mem[_29 + 64] == arg2:
                mem[mem[64]] = 0xc70f5eaa00000000000000000000000000000000000000000000000000000000
                mem[mem[64] + 4] = idx
                require ext_code.size(stor3)
                call stor3.buyCard(uint256 arg1) with:
                     gas gas_remaining wei
                    args idx
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
...
function _fallback() payable {
    if calldata.size < 4:
        ...
        if unknown_0xa404a335(?????) <= uint32(call.func_hash) >> 224:
            if unknown_0xbe4b1772(?????) <= uint32(call.func_hash) >> 224:
                if unknown_0xbe4b1772(?????) == uint32(call.func_hash) >> 224:
                    ...
                    if unknown_0xbe74a88e(?????) == uint32(call.func_hash) >> 224:
                        require not msg.value
                        require calldata.size - 4 >= 32
                        require ext_code.size(stor3)
                        staticcall stor3.sellOrders(uint256 arg1) with:
            ...
            if unknown_0x150b7a02(?????) == uint32(call.func_hash) >> 224:
                ...
                require arg4 + arg4.length + 36 <= calldata.size
                return 0x150b7a0200000000000000000000000000000000000000000000000000000000
            if unknown_0x1b646bc4(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
                require calldata.size - 4 >= 32
                require ext_code.size(stor3)
                staticcall stor3.sellOrders(uint256 arg1) with:
                ...
                require ext_call.return_data[0] == ext_call.return_data[12 len 20]
                return ext_call.return_data[32]
            if unknown_0x545e7048(?????) == uint32(call.func_hash) >> 224:
                require not msg.value
                require calldata.size - 4 >= 64
                if owner != msg.sender:
                    revert with 0, 'Ownable: caller is not the owner'
