...
function sub_4dabdcc6(?) {
    ...
    if (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg2) >> 32 + 192]) + 193 > test266151307() or ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg2) >> 32 + 192]) + 1 < 0:
        revert with 0, 65
    require (32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg2) >> 32 + 192]) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg2) >> 32 + 32 <= return_data.size
    mem[(2 * ceil32(return_data.size)) + 224 len ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg2) >> 32 + 192])] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg2) >> 32 + 224 len ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], Mask(224, 32, arg2) >> 32 + 192])]
    if 1 >= _36:
        revert with 0, 50
    if mem[(2 * ceil32(return_data.size)) + 256] < 30000 * 10^18:
        revert with 0, 'Jackpot hard value limit for the big bang needs to be between 30K and 250K USD'
    if mem[(2 * ceil32(return_data.size)) + 256] > 250000 * 10^18:
        revert with 0, 'Jackpot hard value limit for the big bang needs to be between 30K and 250K USD'
    sub_5e213fd8 = arg2
