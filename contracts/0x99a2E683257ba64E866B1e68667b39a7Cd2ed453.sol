...
#  - uri(uint256 arg1)
#
const contractURI = Array(len=44, data=0x6568747470733a2f2f6e66746170692e6a676e6e66742e636f6d2f61706931302f636f6e74726163742f6a67, mem[172 len 20], mem[212 len 12])
...
function balanceOfBatch(address[] arg1, uint256[] arg2) payable {
    ...
    if arg1.length:
        mem[(32 * arg1.length) + (32 * arg2.length) + 192 len 32 * arg1.length] = code.data[15906 len 32 * arg1.length]
    idx = 0
...
function create(uint256 arg1, uint256 arg2, string arg3, bytes arg4) payable {
    ...
    mem[128 len arg4.length] = arg4[all]
    mem[arg4.length + 128] = 0
    if balanceOf[address(msg.sender)][stor6 + 1] + arg2 < balanceOf[address(msg.sender)][stor6 + 1]:
        revert with 0, 'SafeMath#add: OVERFLOW'
...
function safeBatchTransferFrom(address arg1, address arg2, uint256[] arg3, uint256[] arg4, bytes arg5) payable {
    ...
    if not arg2:
        revert with 0, 
                    32,
                    48,
                    0x6e45524331313535237361666542617463685472616e7366657246726f6d3a20494e56414c49445f524543495049454e,
