...
function _fallback() payable {
    ...
    if sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) < 10^9 * sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) / 10^9:
        revert with 'NH{q', 17
    if sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) - (10^9 * sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) / 10^9) < 15 * 10^6:
        ...
        if sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) < 10^9 * sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) / 10^9:
            revert with 'NH{q', 17
        if sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) - (10^9 * sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) / 10^9) < 150 * 10^6:
            ...
            if sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) < 10^9 * sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) / 10^9:
                revert with 'NH{q', 17
            if sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) - (10^9 * sha3(block.timestamp + block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty, sha3(block.coinbase) + block.gas_limit, sha3(msg.sender) + block.number, sha3(stor0), sha3(block.coinbase) + block.number, block.difficulty + sha3(block.coinbase) + block.gas_limit, block.timestamp + block.difficulty) / 10^9) < 330 * 10^6:
