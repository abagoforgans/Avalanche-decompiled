...
const INIT_CODE_PAIR_HASH = sha3(code.data[1734 len 9120], mem[18432 len 6], Mask(160, 48, code.data[10860 len 20]) >> 48)
...
function createPair(address arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    if arg1 == arg2:
        revert with 0, 'Mumu: IDENTICAL_ADDRESSES'
    if arg1 < arg2:
        if not arg1:
            revert with 0, 'Mumu: ZERO_ADDRESS'
        if pair[address(arg1)][address(arg2)]:
            revert with 0, 'Mumu: PAIR_EXISTS'
        create2 contract with 0 wei
                        salt: sha3(arg1, arg2)
                        code: code.data[1734 len 9146]
