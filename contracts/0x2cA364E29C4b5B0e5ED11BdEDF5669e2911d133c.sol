...
#  - _fallback()
#
const name = 'NANOMACHINES', 0

const SellLimitDivider = 50

const InitialSupply = 250000000 * 10^18
...
function isTaxExempt(address arg1) {
...
function getBurnedTokens() {
    if 250000000 * 10^18 < totalSupply:
        revert with 0, 17
    return (-totalSupply + 250000000 * 10^18 / 10^18)
}
...
function sub_828d5160(?) {
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    Mask(248, 0, stor35.field_8) = Mask(248, 0, not tradingEnabled)
}
...
function TeamReleaseLiquidity() {
    ...
    if block.timestamp < stor36:
        revert with 0, 'Not yet unlocked'
    staticcall address(stor35.field_16).0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    call address(stor35.field_16).0xa9059cbb with:
         gas gas_remaining wei
...
function TeamRemoveLiquidity(bool arg1) {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    call address(stor35.field_16).approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
...
function TeamCreateLPandBNB() {
    ...
    if uint8(stor21.field_32) > -uint8(stor21.field_40) + 255:
        revert with 0, 17
    if sub_a54fe533 and 10^18 > -1 / sub_a54fe533:
        revert with 0, 17
    if balanceOf[this.address] >= 10^18 * sub_a54fe533:
        if uint8(uint8(stor21.field_40) + uint8(stor21.field_32)):
            if 10^18 * sub_a54fe533 and uint8(stor21.field_32) > -1 / 10^18 * sub_a54fe533:
                revert with 0, 17
            if not uint8(uint8(stor21.field_40) + uint8(stor21.field_32)):
                revert with 0, 18
            if 10^18 * sub_a54fe533 < 10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32)):
                revert with 0, 17
            if 10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32)) < 10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32)) / 2:
                revert with 0, 17
            if (10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32))) - (10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32)) / 2) > !((10^18 * sub_a54fe533) - (10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32)))):
                revert with 0, 17
            if not this.address:
                revert with 0, 'Approve from zero'
            if not address(stor22.field_0):
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][address(stor22.field_0)].field_0 = -(10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32)) / 2) + (10^18 * sub_a54fe533)
            emit Approval((-(10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32)) / 2) + (10^18 * sub_a54fe533)), this.address, address(stor22.field_0));
            ...
            mem[ceil32(return_data.size) + 196] = -(10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32)) / 2) + (10^18 * sub_a54fe533)
            idx = 0
            s = 128
            ...
            call address(stor22.field_0).swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
                args -(10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32)) / 2) + (10^18 * sub_a54fe533), 0, 160, address(this.address), block.timestamp, 2, mem[ceil32(return_data.size) + 388 len 64]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if eth.balance(this.address) < eth.balance(this.address):
                revert with 0, 17
            if False and (10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32))) - (10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32)) / 2) > 0:
                revert with 0, 17
            if not -(10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32)) / 2) + (10^18 * sub_a54fe533):
                revert with 0, 18
            if totalLPBNB > !(0 / -(10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32)) / 2) + (10^18 * sub_a54fe533)):
                revert with 0, 17
            totalLPBNB += 0 / -(10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32)) / 2) + (10^18 * sub_a54fe533)
            if not this.address:
                revert with 0, 'Approve from zero'
            if not address(stor22.field_0):
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][address(stor22.field_0)].field_0 = 10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32)) / 2
            allowance[address(this.address)][address(stor22.field_0)].field_255 = 0
            emit Approval((10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32)) / 2), this.address, address(stor22.field_0));
            call address(stor22.field_0).addLiquidityAVAX(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
               value 0 / -(10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32)) / 2) + (10^18 * sub_a54fe533) wei
                 gas gas_remaining wei
                args address(this.address), Mask(255, 1, 10^18 * sub_a54fe533 * uint8(stor21.field_32) / uint8(uint8(stor21.field_40) + uint8(stor21.field_32))), 0, 0, address(this.address), block.timestamp
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
