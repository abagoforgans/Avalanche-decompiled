...
function closeStableCoin() payable {
...
function mint(address arg1, uint256 arg2) payable {
    ...
    if ext_call.return_data[0] > 201:
        revert with 0, 'SecurityToken: Cannot send tokens outside Tokenism'
...
function getAllInvestor() payable {
    mem[100] = msg.sender
    require ext_code.size(whitelistAddress)
    staticcall whitelistAddress.isAdmin(address arg1) with:
            gas gas_remaining wei
    ...
    if stor9.length > test266151307():
        revert with 0, 65
    mem[ceil32(return_data.size) + 96] = stor9.length
    if stor9.length:
        mem[ceil32(return_data.size) + 128 len 32 * stor9.length] = call.data[calldata.size len 32 * stor9.length]
    idx = 0
    while idx < stor9.length:
        ...
        if idx >= stor9.length:
            revert with 0, 50
        mem[(32 * idx) + ceil32(return_data.size) + 128] = balanceOf[stor9[idx].field_0]
        if idx == -1:
            revert with 0, 17
        idx = idx + 1
        continue 
    mem[64] = ceil32(return_data.size) + (64 * stor9.length) + 160
    mem[ceil32(return_data.size) + (32 * stor9.length) + 128] = stor9.length
    if stor9.length:
        mem[ceil32(return_data.size) + (32 * stor9.length) + 160] = address(stor9.field_0)
        idx = ceil32(return_data.size) + (32 * stor9.length) + 160
        s = 0
        while ceil32(return_data.size) + (64 * stor9.length) + 128 > idx:
            mem[idx + 32] = stor9[s].field_256
            idx = idx + 32
            s = s + 1
            continue 
    mem[ceil32(return_data.size) + (64 * stor9.length) + 160] = 64
    mem[ceil32(return_data.size) + (64 * stor9.length) + 224] = stor9.length
    idx = 0
    s = ceil32(return_data.size) + (32 * stor9.length) + 160
    t = mem[64] + 96
    while idx < stor9.length:
        ...
        t = t + 32
        continue 
    mem[ceil32(return_data.size) + (64 * stor9.length) + 192] = (32 * stor9.length) + 96
    mem[ceil32(return_data.size) + (98 * stor9.length) + 256] = mem[ceil32(return_data.size) + 96]
    mem[ceil32(return_data.size) + (98 * stor9.length) + 288 len 32 * mem[ceil32(return_data.size) + 96]] = mem[ceil32(return_data.size) + 128 len 32 * mem[ceil32(return_data.size) + 96]]
    return memory
      from mem[64]
       len ceil32(return_data.size) + (98 * stor9.length) + (32 * mem[ceil32(return_data.size) + 96]) + -mem[64] + 288
}
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if not ext_code.size(msg.sender):
        if not ext_code.size(arg1):
            if ext_call.return_data[0] >= 141:
                if ext_call.return_data[0] >= 141:
                    revert with 0, 'StableCoin: Cannot send tokens outside Tokenism'
        else:
            if ext_call.return_data[0] > 201:
                if ext_call.return_data[0] >= 141:
                    if ext_call.return_data[0] >= 141:
    ...
    if not ext_code.size(arg1):
        ...
        call arg1.tokenFallback(address arg1, uint256 arg2, bytes arg3) with:
             gas gas_remaining wei
            args msg.sender, arg2, 96, 4, 0, 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    return 1
}

function transferWithData(address arg1, uint256 arg2, bytes arg3) payable {
    require calldata.size - 4 >= 96
    require arg1 == arg1
    ...
    if not ext_code.size(msg.sender):
        if not ext_code.size(arg1):
            if 0, ext_call.return_data[4 len 28] >= 141:
                if ext_call.return_data[0] >= 141:
                    revert with 0, 'StableCoin: Cannot send tokens outside Tokenism'
        else:
            if ext_call.return_data[0] > 201:
        ...
        if 0, ext_call.return_data[4 len 28] > 201:
            if not ext_code.size(arg1):
                if 0, ext_call.return_data[4 len 28] >= 141:
                    if ext_call.return_data[0] >= 141:
                        revert with 0, 'StableCoin: Cannot send tokens outside Tokenism'
