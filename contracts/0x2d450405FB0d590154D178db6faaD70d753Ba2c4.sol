...
function swap(address arg1, address arg2, uint256 arg3, uint256 arg4, address arg5) payable {
    ...
    require return_data.size >= 32
    _24 = mem[(2 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg3) >> 32
    ...
    _25 = mem[(2 * ceil32(return_data.size)) + mem[(2 * ceil32(return_data.size)) + 192 len 4], Mask(224, 32, arg3) >> 32 + 192]
