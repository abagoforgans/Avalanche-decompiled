                        ...
                        if unknown_0x4743d906(?????) == uint32(call.func_hash) >> 224:
                            ...
                            while idx < arg4:
                                ...
                                while s < _41:
                                    ...
                                    u = u + 32
                                    continue 
                                mem[_40 + 68] = address(stor3.field_0)
                                mem[_40 + 100] = block.timestamp
                                require ext_code.size(address(arg1))
                                call address(arg1).mem[mem[64] len 4] with:
                                   value arg6 wei
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4 len _40 + (32 * _41) + -mem[64] + 160]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _65 = mem[64]
                                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
                                ...
                                mem[_65 + ceil32(return_data.size)] = _68
                    ...
                    if unknown_0xb4bc7d7b(?????) == uint32(call.func_hash) >> 224:
                        ...
                        while idx < arg4:
                            ...
                            while s < _52:
                                ...
                                u = u + 32
                                continue 
                            mem[_50 + 68] = address(stor3.field_0)
                            mem[_50 + 100] = block.timestamp
                            require ext_code.size(address(arg1))
                            call address(arg1).mem[mem[64] len 4] with:
                               value arg6 / arg4 wei
                                 gas gas_remaining wei
                                args mem[mem[64] + 4 len _50 + (32 * _52) + -mem[64] + 160]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if idx == -1:
                                revert with 0, 17
