...
function deposit(uint256 arg1) payable {
    ...
    if 1 >= _41:
        revert with 'NH{q', 50
    _71 = mem[(2 * ceil32(return_data.size)) + 256]
    ...
    mem[mem[64] + 4] = arg1
    mem[mem[64] + 36] = 99 * _71 / 100
    mem[mem[64] + 68] = 160
    _73 = mem[ceil32(return_data.size) + 96]
    ...
    mem[_72 + 132] = block.timestamp + 60
    require ext_code.size(traderJoeRouterAddress)
    call traderJoeRouterAddress.mem[mem[64] len 4] with:
         gas gas_remaining wei
        args mem[mem[64] + 4 len _72 + (32 * _73) + -mem[64] + 192]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _97 = mem[64]
    ...
    if 1 >= _99:
        revert with 'NH{q', 50
    mem[mem[64] + 4] = mem[_97 + ceil32(return_data.size) + 64]
