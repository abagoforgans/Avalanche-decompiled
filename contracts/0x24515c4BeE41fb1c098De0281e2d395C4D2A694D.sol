...
function _getNodeNumberOf(address arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 == arg1
    delegate 0x266c8d90002b948255e6612e6f3a87746674979e.0x732a2ccf with:
...
function createNode(address arg1, string arg2) payable {
    ...
    require ext_code.size(0x266c8d90002b948255e6612e6f3a87746674979e)
    delegate 0x266c8d90002b948255e6612e6f3a87746674979e.0xbc2b405c with:
         gas gas_remaining wei
