...
function sub_4528ec2f(?) payable {
    ...
    call address(arg4).burn(uint256 rg1) with:
       value arg3 wei
         gas gas_remaining wei
...
function sub_835dd5c6(?) {
    ...
    if ext_call.return_data[12 len 20] != WAVAXAddress:
        ...
        if ext_call.return_data[12 len 20] == WAVAXAddress:
            ...
            if ext_call.return_data[12 len 20] == WAVAXAddress:
                ...
                mem[(12 * ceil32(return_data.size)) + 260] = 997 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0]) / (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * ext_call.return_data[0])
                mem[(12 * ceil32(return_data.size)) + 292] = this.address
                mem[(12 * ceil32(return_data.size)) + 324] = 128
                mem[(12 * ceil32(return_data.size)) + 356] = 0
                mem[(12 * ceil32(return_data.size)) + 388 len 0] = None
            ...
            if ext_call.return_data[12 len 20] == WAVAXAddress:
                ...
                mem[(12 * ceil32(return_data.size)) + 260] = 997 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) / (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * ext_call.return_data[0])
                mem[(12 * ceil32(return_data.size)) + 292] = this.address
                mem[(12 * ceil32(return_data.size)) + 324] = 128
                mem[(12 * ceil32(return_data.size)) + 356] = 0
                mem[(12 * ceil32(return_data.size)) + 388 len 0] = None
        ...
        call WAVAXAddress.0x2e1a7d4d with:
             gas gas_remaining wei
            args ext_call.return_data[0], mem[(15 * ceil32(return_data.size)) + 260 len 5 * ceil32(return_data.size)]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(WAVAXAddress)
        staticcall WAVAXAddress.0x70a08231 with:
                gas gas_remaining wei
               args address(this.address), mem[(15 * ceil32(return_data.size)) + 260 len 5 * ceil32(return_data.size)]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_call.return_data[0] == ext_call.return_data[0]
        if owner != msg.sender:
            revert with 0, 'Ownable: caller is not the owner', mem[(17 * ceil32(return_data.size)) + 324 len 9 * ceil32(return_data.size)]
        if ext_call.return_data[0] <= 0:
            revert with 0, 'W1-R1', mem[(17 * ceil32(return_data.size)) + 324 len 9 * ceil32(return_data.size)]
        if eth.balance(this.address) <= 0:
            revert with 0, 'W1-R2', mem[(17 * ceil32(return_data.size)) + 324 len 9 * ceil32(return_data.size)]
        call owner with:
           value eth.balance(this.address) wei
             gas 2300 * is_zero(value) wei
        if not ext_call.success:
        ...
        if ext_call.return_data[12 len 20] == WAVAXAddress:
            ...
            if ext_call.return_data[12 len 20] == WAVAXAddress:
                ...
                mem[(11 * ceil32(return_data.size)) + 260] = 997 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0]) / (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * ext_call.return_data[0])
                mem[(11 * ceil32(return_data.size)) + 292] = this.address
                mem[(11 * ceil32(return_data.size)) + 324] = 128
                mem[(11 * ceil32(return_data.size)) + 356] = 0
                mem[(11 * ceil32(return_data.size)) + 388 len 0] = None
            ...
            if ext_call.return_data[12 len 20] == WAVAXAddress:
                ...
                mem[(11 * ceil32(return_data.size)) + 260] = 997 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) / (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * ext_call.return_data[0])
                mem[(11 * ceil32(return_data.size)) + 292] = this.address
                mem[(11 * ceil32(return_data.size)) + 324] = 128
                mem[(11 * ceil32(return_data.size)) + 356] = 0
                mem[(11 * ceil32(return_data.size)) + 388 len 0] = None
        ...
        call WAVAXAddress.0x2e1a7d4d with:
             gas gas_remaining wei
            args ext_call.return_data[0], mem[(14 * ceil32(return_data.size)) + 260 len 5 * ceil32(return_data.size)]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        staticcall WAVAXAddress.0x70a08231 with:
                gas gas_remaining wei
               args address(this.address), mem[(14 * ceil32(return_data.size)) + 260 len 5 * ceil32(return_data.size)]
        mem[(14 * ceil32(return_data.size)) + 224] = ext_call.return_data[0]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        ...
        if eth.balance(this.address) <= 0:
            ...
            mem[(16 * ceil32(return_data.size)) + 228] = 32
            mem[(16 * ceil32(return_data.size)) + 260] = 5
            mem[(16 * ceil32(return_data.size)) + 292] = 'W1-R2'
            revert with memory
              from (16 * ceil32(return_data.size)) + 224
               len (9 * ceil32(return_data.size)) + 100
        call owner with:
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    emit 0xbabe4e98: ext_call.return_data[0]
}
