...
function _fallback() payable {
    ...
    mem[ceil32(return_data.size) + 228 len 128] = withdrawETH(address arg1, uint256 arg2, address arg3), 0x70bbe4a294878a14cb3cdd93, 238313827, ext_call.return_data[0], address(this.address), mem[ceil32(return_data.size) + 228 len 28]
    call 0x56d0fed06d2e0b5ac80d7a9ed0387694bdf90c33.mem[ceil32(return_data.size) + 228 len 4] with:
         gas gas_remaining wei
