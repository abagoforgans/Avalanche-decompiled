...
mapping of uint8 stor1016;
mapping of struct stor1017;
...
function characterBids(uint256 arg1) {
    require calldata.size - 4 >= 32
    return bool(stor3FA[arg1].field_0), stor3FA[arg1].field_256, stor3FA[arg1].field_512, stor3FA[arg1].field_768
}
...
function charactersOfferedForSale(uint256 arg1) {
    require calldata.size - 4 >= 32
    return bool(stor3F9[arg1].field_0), 
           stor3F9[arg1].field_256,
           stor3F9[arg1].field_512,
           stor3F9[arg1].field_768,
           stor3F9[arg1].field_1024
}
...
function characterNoLongerForSale(uint256 arg1) {
    ...
    stor3F9[arg1].field_0 = 0
    stor3F9[arg1].field_256 = arg1
    stor3F9[arg1].field_512 = msg.sender
    stor3F9[arg1].field_768 = 0
    stor3F9[arg1].field_1024 = 0
    stor3F9[arg1].field_1280 = 0
...
function offercharacterForSaleToAddress(uint256 arg1, uint256 arg2, address arg3) {
    ...
    if ownerOf[arg1] != msg.sender:
        revert with 0, 'Incorrect owner.'
    stor3F9[arg1].field_0 = 1
    stor3F9[arg1].field_256 = arg1
    stor3F9[arg1].field_512 = msg.sender
    stor3F9[arg1].field_768 = arg2
    stor3F9[arg1].field_1024 = arg3
...
function withdrawBidForcharacter(uint256 arg1) {
    ...
    if stor3FA[arg1].field_512 != msg.sender:
        revert with 0, 'Only bidder can withdraw'
    emit 0x96bf05db: stor3FA[arg1].field_768, arg1, msg.sender
    stor3FA[arg1].field_0 = 0
    stor3FA[arg1].field_256 = arg1
    stor3FA[arg1].field_512 = 0
    stor3FA[arg1].field_768 = 0
    stor3FA[arg1].field_768 = 0
    call msg.sender with:
       value stor3FA[arg1].field_768 wei
         gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    stor1 = 1
...
function enterBidForcharacter(uint256 arg1) payable {
    ...
    if msg.value <= stor3FA[arg1].field_768:
        revert with 0, 32, 35, 0x2f796f752063616e206e6f7420626964206c6f776572207468616e206c617374206269, mem[327 len 29]
    if stor3FA[arg1].field_768 > 0:
        pendingWithdrawals[stor3FA[arg1].field_512] += stor3FA[arg1].field_768
    stor3FA[arg1].field_0 = 1
    stor3FA[arg1].field_256 = arg1
    stor3FA[arg1].field_512 = msg.sender
    stor3FA[arg1].field_768 = msg.value
...
function acceptBidForcharacter(uint256 arg1, uint256 arg2) {
    ...
    if stor3FA[arg1].field_768 < arg2:
    ...
    if ownerOf[arg1] != msg.sender:
        revert with 0, 'Incorrect owner.'
    require stor3FA[arg1].field_512
    if approved[arg1]:
        approved[arg1] = 0
    ...
    if ownerOf[arg1]:
        revert with 0, 'Cannot add, already owned.'
    ownerOf[arg1] = stor3FA[arg1].field_512
    tokenOfOwnerByIndex[stor3FA[arg1].field_512]++
    tokenOfOwnerByIndex[stor3FA[arg1].field_512][tokenOfOwnerByIndex[stor3FA[arg1].field_512]] = arg1
    if 1 > tokenOfOwnerByIndex[stor3FA[arg1].field_512]:
        revert with 0, 'SafeMath: subtraction overflow'
    stor7[arg1] = tokenOfOwnerByIndex[stor3FA[arg1].field_512] - 1
    emit Transfer(ownerOf[arg1], stor3FA[arg1].field_512, arg1);
    if ext_code.size(stor3FA[arg1].field_512) > 0:
        require ext_code.size(stor3FA[arg1].field_512)
        call stor3FA[arg1].field_512.onERC721Received(address rg1, address rg2, uint256 rg3, bytes rg4) with:
             gas gas_remaining wei
    ...
    stor3FA[arg1].field_768 = 0
    stor3FA[arg1].field_768 = 0
    pendingWithdrawals[address(msg.sender)] += stor3FA[arg1].field_768
    emit 0x276b0447: stor3FA[arg1].field_768, arg1, msg.sender, stor3FA[arg1].field_512
    stor1 = 1
}
...
function tokenURI(uint256 arg1) {
    ...
    if not ownerOf[arg1]:
        revert with 0, 'Invalid token.'
    if not arg1:
        mem[192 len 45] = 0x72687474703a2f2f6170692e66726f737466696e616e63652e6661726d2f6e66742f74756e6472612f626f6f6b
        mem[237 len 0] = None
        mem[238] = 32
        mem[270] = mem[160]
        mem[302 len ceil32(mem[160])] = mem[192 len ceil32(mem[160])]
        if not mem[160] % 32:
            return 32, mem[270 len mem[160] + 32]
        mem[floor32(mem[160]) + 302] = mem[floor32(mem[160]) + -(mem[160] % 32) + 334 len mem[160] % 32]
        return Array(len=mem[160], data=mem[302 len floor32(mem[160]) + 32])
    s = 0
    idx = arg1
    while idx:
        s = s + 1
    ...
    if not s:
        ...
        while idx:
            ...
            continue 
        _63 = mem[64]
        mem[mem[64] + 32 len 45] = 0x72687474703a2f2f6170692e66726f737466696e616e63652e6661726d2f6e66742f74756e6472612f626f6f6b
        _64 = mem[96]
        mem[mem[64] + 77 len floor32(mem[96])] = mem[128 len floor32(mem[96])]
        mem[mem[64] + floor32(mem[96]) + -(mem[96] % 32) + 109 len mem[96] % 32] = mem[floor32(mem[96]) + -(mem[96] % 32) + 160 len mem[96] % 32]
        _92 = mem[64]
        mem[64] = _64 + _63 + 77
        mem[_64 + _63 + 77] = 32
        mem[_64 + _63 + 109] = mem[_92]
        _100 = mem[_92]
        mem[_64 + _63 + 141 len ceil32(mem[_92])] = mem[_92 + 32 len ceil32(mem[_92])]
        if not _100 % 32:
            return 32, mem[_64 + _63 + 109 len _100 + 32]
        mem[floor32(_100) + _64 + _63 + 141] = mem[floor32(_100) + _64 + _63 + -(_100 % 32) + 173 len _100 % 32]
        return 32, mem[_64 + _63 + 109 len floor32(_100) + 64]
    ...
    mem[64] = _66 + _65 + 77
    mem[_66 + _65 + 77] = 32
    mem[_66 + _65 + 109] = mem[_96]
    _103 = mem[_96]
    mem[_66 + _65 + 141 len ceil32(mem[_96])] = mem[_96 + 32 len ceil32(mem[_96])]
    if not _103 % 32:
        return 32, mem[_66 + _65 + 109 len _103 + 32]
    mem[floor32(_103) + _66 + _65 + 141] = mem[floor32(_103) + _66 + _65 + -(_103 % 32) + 173 len _103 % 32]
    return 32, mem[_66 + _65 + 109 len floor32(_103) + 64]
}
...
function buycharacter(uint256 arg1) payable {
    ...
    if arg1 >= 999:
        revert with 0, 'character number is wrong'
    if not stor3F9[arg1].field_0:
        revert with 0, 'character not actually for sale'
    if stor3F9[arg1].field_1024:
        if stor3F9[arg1].field_1024 != msg.sender:
            revert with 0, 
                        32,
                        46,
                        0x72636861726163746572206e6f7420737570706f73656420746f20626520736f6c6420746f207468697320757365,
                        mem[370 len 18]
    if msg.value < stor3F9[arg1].field_768:
        revert with 0, 'Didn't send enough amount'
    require ownerOf[arg1]
    if ownerOf[arg1] != stor3F9[arg1].field_512:
        revert with 0, 32, 35, 0x7353656c6c6572206e6f206c6f6e676572206f776e6572206f66206368617261637465, mem[359 len 29]
    if not ownerOf[arg1]:
        revert with 0, 'Invalid token.'
    if ownerOf[arg1] != stor3F9[arg1].field_512:
        revert with 0, 'Incorrect owner.'
    ...
    if ext_code.size(msg.sender) > 0:
        ...
        call msg.sender.onERC721Received(address rg1, address rg2, uint256 rg3, bytes rg4) with:
             gas gas_remaining wei
            args msg.sender, stor3F9[arg1].field_512, arg1, 128, 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require Mask(32, 224, ext_call.return_data[0]) == 0x150b7a0200000000000000000000000000000000000000000000000000000000
    ...
    stor3F9[arg1].field_1280 = 0
    emit 0xdc5e8312: arg1
    pendingWithdrawals[stor3F9[arg1].field_512] += msg.value
    emit 0x276b0447: msg.value, arg1, stor3F9[arg1].field_512, msg.sender
    if stor3FA[arg1].field_512 == msg.sender:
        pendingWithdrawals[address(msg.sender)] += stor3FA[arg1].field_768
        stor3FA[arg1].field_0 = 0
        stor3FA[arg1].field_256 = arg1
