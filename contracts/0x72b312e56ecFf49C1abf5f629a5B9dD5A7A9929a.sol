...
function canExecuteOrder(address arg1, address arg2, address arg3, address arg4, bytes arg5, bytes arg6) {
    ...
    if arg2 == 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee:
        ...
        staticcall arg1.0xfd516dab with:
...
function encodeTokenOrder(address arg1, address arg2, address arg3, address arg4, bytes arg5, bytes32 arg6, uint256 arg7) {
    ...
    if not arg5.length % 32:
        ...
        if not ceil32(arg5.length) + 224 % 32:
            ...
            return Array(len=(2 * ceil32(arg5.length)) + 356, data=Mask(8 * floor32((2 * ceil32(arg5.length)) + 356), -(8 * floor32((2 * ceil32(arg5.length)) + 356)) + 256, mem[arg5.length + (2 * ceil32(arg5.length)) + ceil32(ceil32(arg5.length)) + 896 len floor32((2 * ceil32(arg5.length)) + 387) + -ceil32(ceil32(arg5.length)) - 139]) << (8 * floor32((2 * ceil32(arg5.length)) + 356)) - 256, Mask(8 * floor32((2 * ceil32(arg5.length)) + 387) + -floor32((2 * ceil32(arg5.length)) + 356) + ((2 * ceil32(arg5.length)) + 356 % 32) - 32, -(8 * floor32((2 * ceil32(arg5.length)) + 387)) + 256, mem[arg5.length + (2 * ceil32(arg5.length)) + ceil32(ceil32(arg5.length)) + 896 len floor32((2 * ceil32(arg5.length)) + 387) + -ceil32(ceil32(arg5.length)) - 139]) << (8 * floor32((2 * ceil32(arg5.length)) + 387)) - 256, mem[(4 * ceil32(arg5.length)) + arg5.length + floor32((2 * ceil32(arg5.length)) + 387) + 1177 len floor32((2 * ceil32(arg5.length)) + 356) + -floor32((2 * ceil32(arg5.length)) + 387) + 32]), 
        ...
        if not floor32(ceil32(arg5.length) + 224) + ceil32(arg5.length) + 164 % 32:
            return memory
              from floor32(ceil32(arg5.length) + 224) + arg5.length + (2 * ceil32(arg5.length)) + 921
               len (6 * ceil32(arg5.length)) + floor32(ceil32(arg5.length) + 224) + 228
