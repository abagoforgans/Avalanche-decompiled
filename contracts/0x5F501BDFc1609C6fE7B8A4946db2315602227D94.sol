    ...
    while idx < _730:
        ...
        if ceil32(_760) <= _760:
            ...
            if ceil32(_988) <= _988:
                ...
                staticcall address(_735).0x313ce567 with:
                        gas gas_remaining wei
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                mem[mem[64] + 4] = address(arg2)
                mem[mem[64] + 36] = address(arg3)
                staticcall address(_735).0xdd62ed3e with:
                        gas gas_remaining wei
                       args address(arg2), address(arg3)
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
        ...
        while idx < ('cd', 4).length:
            ...
            if ceil32(_441) <= _441:
                ...
                if ceil32(_652) <= _652:
                    ...
                    staticcall address(_424).0x313ce567 with:
                            gas gas_remaining wei
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    ...
                    staticcall address(_424).0xdd62ed3e with:
                            gas gas_remaining wei
        ...
        while idx < _821:
            ...
            if ceil32(_855) <= _855:
                ...
                if ceil32(_1021) <= _1021:
                    ...
                    staticcall address(_827).0x313ce567 with:
                            gas gas_remaining wei
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    ...
                    mem[mem[64] + 4] = address(cd[36])
                    mem[mem[64] + 36] = address(cd[68])
                    staticcall address(_827).0xdd62ed3e with:
                            gas gas_remaining wei
                           args address(cd[36]), address(cd[68])
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
        ...
        while idx < ('cd', 4).length:
            ...
            if ceil32(_574) <= _574:
                ...
                if ceil32(_848) <= _848:
                    ...
                    staticcall address(_551).0x313ce567 with:
                            gas gas_remaining wei
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    ...
                    mem[mem[64] + 4] = address(cd[36])
                    mem[mem[64] + 36] = address(cd[68])
                    staticcall address(_551).0xdd62ed3e with:
                            gas gas_remaining wei
                           args address(cd[36]), address(cd[68])
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
        ...
        while idx < _1048:
            ...
            if ceil32(_1087) <= _1087:
                ...
                if ceil32(_1281) <= _1281:
                    ...
                    staticcall address(_1053).0x313ce567 with:
                            gas gas_remaining wei
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    ...
                    mem[mem[64] + 4] = address(cd[36])
                    mem[mem[64] + 36] = address(cd[68])
                    staticcall address(_1053).0xdd62ed3e with:
                            gas gas_remaining wei
                           args address(cd[36]), address(cd[68])
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
