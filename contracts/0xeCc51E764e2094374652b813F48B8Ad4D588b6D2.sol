...
mapping of uint256 sub_d185ca90;
...
function _hasVotedOnProposal(uint72 arg1, bytes32 arg2, address arg3) {
    ...
    require arg2 == arg2
    require arg3 == arg3
    return bool(stor13[arg1][arg2][arg3])
}
...
function sub_d185ca90(?) {
    require calldata.size - 4 >= 32
    require arg1 == uint8(arg1)
    return sub_d185ca90[arg1]
}
...
function sub_74bc43bb(?) {
    require calldata.size - 4 >= 64
    require arg1 == uint8(arg1)
    require arg2 == arg2
    if not roleAdmin[0][1][address(msg.sender)].field_0:
        revert with 0, 'sender doesn't have admin role'
    if sub_d185ca90[arg1 << 248] == arg2:
        revert with 0, 'Current fee is equal to new fee'
    sub_d185ca90[arg1 << 248] = arg2
}
...
function deposit(uint8 arg1, bytes32 arg2, bytes arg3) payable {
    ...
    if stor0:
        revert with 0, 'Pausable: paused'
    if sub_d185ca90[arg1 << 248]:
        if sub_d185ca90[arg1 << 248] != msg.value:
...
function executeProposal(uint8 arg1, uint64 arg2, bytes arg3, bytes32 arg4) {
    ...
    if stor0:
        revert with 0, 'Pausable: paused'
    require _proposals[uint64(arg2) << 8 or arg1][('map', ('stor', ('map', ('param', 'arg4'), ('name', 'stor10', 10))), ('call.data', ('add', 36, ('param', 'arg3')), ('cd', ('add', 4, ('param', 'arg3')))))].field_1024 <= 4
    if not _proposals[uint64(arg2) << 8 or arg1][('map', ('stor', ('map', ('param', 'arg4'), ('name', 'stor10', 10))), ('call.data', ('add', 36, ('param', 'arg3')), ('cd', ('add', 4, ('param', 'arg3')))))].field_1024:
        revert with 0, 'proposal is not active'
    require _proposals[uint64(arg2) << 8 or arg1][('map', ('stor', ('map', ('param', 'arg4'), ('name', 'stor10', 10))), ('call.data', ('add', 36, ('param', 'arg3')), ('cd', ('add', 4, ('param', 'arg3')))))].field_1024 <= 4
    if _proposals[uint64(arg2) << 8 or arg1][('map', ('stor', ('map', ('param', 'arg4'), ('name', 'stor10', 10))), ('call.data', ('add', 36, ('param', 'arg3')), ('cd', ('add', 4, ('param', 'arg3')))))].field_1024 != 2:
        revert with 0, 'proposal already transferred'
    if sha3(_resourceIDToHandler[arg4], arg3[all]) != _proposals[uint64(arg2) << 8 or arg1][('map', ('stor', ('map', ('param', 'arg4'), ('name', 'stor10', 10))), ('call.data', ('add', 36, ('param', 'arg3')), ('cd', ('add', 4, ('param', 'arg3')))))].field_256:
        revert with 0, 'data doesn't match datahash'
    _proposals[uint64(arg2) << 8 or arg1][('map', ('stor', ('map', ('param', 'arg4'), ('name', 'stor10', 10))), ('call.data', ('add', 36, ('param', 'arg3')), ('cd', ('add', 4, ('param', 'arg3')))))].field_1024 = 3
    require ext_code.size(_resourceIDToHandler[stor12[uint64(arg2) << 8 or arg1][('map', ('stor', ('map', ('param', 'arg4'), ('name', '_resourceIDToHandler', 10))), ('call.data', ('add', 36, ('param', 'arg3')), ('cd', ('add', 4, ('param', 'arg3')))))].field_0])
    call _resourceIDToHandler[stor12[uint64(arg2) << 8 or arg1][('map', ('stor', ('map', ('param', 'arg4'), ('name', '_resourceIDToHandler', 10))), ('call.data', ('add', 36, ('param', 'arg3')), ('cd', ('add', 4, ('param', 'arg3')))))].field_0].executeProposal(bytes32 arg1, bytes arg2) with:
         gas gas_remaining wei
        args _proposals[uint64(arg2) << 8 or arg1][('map', ('stor', ('map', ('param', 'arg4'), ('name', 'stor10', 10))), ('call.data', ('add', 36, ('param', 'arg3')), ('cd', ('add', 4, ('param', 'arg3')))))].field_0, Array(len=arg3.length, data=arg3[all])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require _proposals[uint64(arg2) << 8 or arg1][('map', ('stor', ('map', ('param', 'arg4'), ('name', 'stor10', 10))), ('call.data', ('add', 36, ('param', 'arg3')), ('cd', ('add', 4, ('param', 'arg3')))))].field_1024 <= 4
    emit ProposalEvent(_proposals[uint64(arg2) << 8 or arg1][('map', ('stor', ('map', ('param', 'arg4'), ('name', 'stor10', 10))), ('call.data', ('add', 36, ('param', 'arg3')), ('cd', ('add', 4, ('param', 'arg3')))))].field_0, _proposals[uint64(arg2) << 8 or arg1][('map', ('stor', ('map', ('param', 'arg4'), ('name', 'stor10', 10))), ('call.data', ('add', 36, ('param', 'arg3')), ('cd', ('add', 4, ('param', 'arg3')))))].field_256, arg1, arg2, _proposals[uint64(arg2) << 8 or arg1][('map', ('stor', ('map', ('param', 'arg4'), ('name', 'stor10', 10))), ('call.data', ('add', 36, ('param', 'arg3')), ('cd', ('add', 4, ('param', 'arg3')))))].field_1024);
}
...
function voteProposal(uint8 arg1, uint64 arg2, bytes32 arg3, bytes32 arg4) {
    ...
    if stor13[uint64(arg2) << 8 or arg1][arg4][address(msg.sender)]:
    ...
    if _proposals[uint64(arg2) << 8 or arg1][arg4].field_1024:
        ...
        if block.number - _proposals[uint64(arg2) << 8 or arg1][arg4].field_1280 > _expiry:
            ...
            stor[('array', 2, ('map', ('param', 'arg4'), ('map', ('or', ('mask_shl', 64, 0, 8, ('param', 'arg2')), ('param', 'arg1')), ('name', '_proposals', 12)))) + _proposals[uint64(arg2) << 8 or arg1][arg4].field_512].field_0 = msg.sender
    else:
        _totalProposals++
    ...
    if _proposals[uint64(arg2) << 8 or arg1][arg4].field_1024 != 4:
        stor13[uint64(arg2) << 8 or arg1][arg4][address(msg.sender)] = 1
        require _proposals[uint64(arg2) << 8 or arg1][arg4].field_1024 <= 4
