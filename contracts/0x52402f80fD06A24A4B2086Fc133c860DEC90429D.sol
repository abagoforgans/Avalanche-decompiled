...
function createPool(address arg1, address arg2, uint256 arg3) {
    ...
    if ext_call.return_data[0] >= -1:
        ...
        if ext_call.return_data[0] < -1:
            ...
            mem[(6 * ceil32(return_data.size)) + 132] = address(stor4)
            require ext_code.size(arg2)
            staticcall arg2.allowance(address arg1, address arg2) with:
                    gas gas_remaining wei
                   args address(this.address), address(stor4)
            ...
            if ext_call.return_data[0]:
                revert with 0, 'SafeERC20: approve from non-zero to non-zero allowance'
            mem[(7 * ceil32(return_data.size)) + 132] = address(stor4)
            mem[(7 * ceil32(return_data.size)) + 164] = -1
            mem[(7 * ceil32(return_data.size)) + 96] = 68
            mem[(7 * ceil32(return_data.size)) + 132 len 28] = Mask(224, 0, stor4)
            ...
            if not ext_code.size(arg2):
                revert with 0, 'Address: call to non-contract'
            mem[(7 * ceil32(return_data.size)) + 260 len 96] = approve(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), -1, 0
        ...
        mem[(6 * ceil32(return_data.size)) + 132 len 28] = Mask(224, 0, stor4)
        ...
        if not ext_code.size(arg1):
            revert with 0, 'Address: call to non-contract'
        mem[(6 * ceil32(return_data.size)) + 260 len 96] = approve(address arg1, uint256 arg2), Mask(224, 0, stor4), uint32(stor4), -1, 0
        ...
        if not return_data.size:
            ...
            if ext_call.return_data[0] < -1:
                ...
                if ext_call.return_data[0]:
                    revert with 0, 'SafeERC20: approve from non-zero to non-zero allowance'
                mem[(8 * ceil32(return_data.size)) + 296] = address(stor4)
                ...
                if not ext_code.size(arg2):
                    revert with 0, 'Address: call to non-contract'
                mem[(8 * ceil32(return_data.size)) + 424 len 96] = 0, address(stor4), -1, 0
            ...
            if ext_call.return_data[0] < -1:
                ...
                if ext_call.return_data[0]:
                    revert with 0, 'SafeERC20: approve from non-zero to non-zero allowance'
                mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 297] = address(stor4)
                mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 329] = -1
                ...
                if not ext_code.size(arg2):
                    revert with 0, 'Address: call to non-contract'
                mem[(8 * ceil32(return_data.size)) + ceil32(return_data.size) + 425 len 96] = 0, address(stor4), -1, 0
