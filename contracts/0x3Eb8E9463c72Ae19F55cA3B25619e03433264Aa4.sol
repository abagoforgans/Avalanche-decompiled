...
function sub_c3a2cede(?) {
    ...
    call BNBAddress.0xd0e30db0 with:
       value arg3 wei
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if ext_call.return_data[12 len 20] == BNBAddress:
        ...
        if not (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * arg3):
            revert with 'NH{q', 18
        if 997 * arg3 * Mask(112, 0, ext_call.return_data[32]) / (1000 * Mask(112, 0, ext_call.return_data[0])) + (997 * arg3) < arg2:
            revert with 0, 'S4-R1'
        require ext_code.size(address(arg1))
        staticcall address(arg1).token0() with:
                gas gas_remaining wei
        ...
        if not (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * arg3):
            revert with 'NH{q', 18
        if 997 * arg3 * Mask(112, 0, ext_call.return_data[0]) / (1000 * Mask(112, 0, ext_call.return_data[32])) + (997 * arg3) < arg2:
            revert with 0, 'S4-R1'
        require ext_code.size(address(arg1))
        staticcall address(arg1).token0() with:
                gas gas_remaining wei
...
function sub_4528ec2f(?) payable {
    ...
    call address(arg4).burn(address arg1, uint256 arg2) with:
       value arg3 wei
         gas gas_remaining wei
