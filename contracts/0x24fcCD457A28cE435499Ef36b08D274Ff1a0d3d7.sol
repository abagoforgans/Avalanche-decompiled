...
function sub_3bec4821(?) payable {
    ...
    staticcall PRESALE_SETTINGSAddress.0xe38ef7a3 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    staticcall PRESALE_SETTINGSAddress.0x24785172 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if not address(cd[100]):
        ...
        staticcall PRESALE_SETTINGSAddress.0x120ac7e6 with:
                gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        ...
        if mem[256] > 1000:
            revert with 0, 'MIN LIQUIDITY'
        staticcall PRESALE_SETTINGSAddress.0x35546850 with:
                gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        ...
        create contract with 0 wei
                        code: code.data[5005 len 17903], address(this.address), PRESALE_SETTINGSAddress, TOKEN_VESTINGAddress, WETHAddress
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    staticcall PRESALE_SETTINGSAddress.0x15e812ad with:
            gas gas_remaining wei
    require return_data.size >= 32
    staticcall PRESALE_SETTINGSAddress.0x35546850 with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    staticcall PRESALE_SETTINGSAddress.0xf6c0812f with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
