...
function bondLp(address arg1, uint256 arg2, uint256 arg3, address arg4, bytes arg5, uint256 arg6) payable {
    ...
    require ext_call.return_data[0] == ext_call.return_data[0]
    require ext_call.return_data[0] == arg2
    mem[(4 * ceil32(return_data.size)) + 420 len arg5.length] = arg5[all]
    mem[(4 * ceil32(return_data.size)) + arg5.length + 420] = 0
    require ext_code.size(0xc669dc61af974fdf50758d95306e4083d36f1430)
    call 0xc669dc61af974fdf50758d95306e4083d36f1430.ZapInLp(address arg1, address arg2, uint256 arg3, uint256 arg4, address arg5, bytes arg6, bool arg7, uint256 arg8, address arg9) with:
         gas gas_remaining wei
        args 0xb54f16fb19478766a268f172c9480f8da1a7c9c3, address(arg1), arg2, arg3, address(arg4), 288, 0, arg6, this.address, arg5.length, arg5[all], mem[(4 * ceil32(return_data.size)) + arg5.length + 420 len ceil32(arg5.length) - arg5.length]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
...
function withdraw(address arg1, uint256 arg2) payable {
    ...
    mem[(2 * ceil32(return_data.size)) + 164] = stor0
    ...
    mem[(2 * ceil32(return_data.size)) + 292 len 128] = unknown_0x23b872dd(?????), address(this.address) << 64, 0, stor0, arg2, 0
