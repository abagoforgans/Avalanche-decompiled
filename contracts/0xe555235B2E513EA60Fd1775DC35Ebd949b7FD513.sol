...
function sub_292ca975(?) {
    ...
    while idx < uint8(_2):
        ...
        s = 32 * idx + 1
        continue 
    _634 = mem[(22 * uint8(_2)) + 111]
    _636 = mem[(22 * uint8(_2)) + 143]
    _638 = mem[64]
    mem[64] = mem[64] + (32 * arg2.length) + 32
    mem[_638] = arg2.length
    mem[_638 + 32 len 32 * arg2.length] = call.data[arg2 + 36 len 32 * arg2.length]
    mem[_638 + (32 * arg2.length) + 32] = 0
    _640 = mem[ceil32(arg1.length) + 128]
    require mem[ceil32(arg1.length) + 128] + 1 <= test266151307()
    _641 = mem[64]
    mem[mem[64]] = mem[ceil32(arg1.length) + 128] + 1
    mem[64] = mem[64] + (32 * _640 + 1) + 32
    if not _640 + 1:
        require 0 < mem[_641]
        mem[_641 + 32] = Mask(112, 0, _634)
        _1262 = mem[ceil32(arg1.length) + 128]
        idx = 0
        s = 15
        while uint8(idx) < _1262:
            require uint8(idx) < mem[_4]
            if mem[(32 * uint8(idx)) + _4 + 63 len 1] < 2:
                require uint8(idx) < mem[_5]
                _1282 = mem[(32 * uint8(idx)) + _5 + 32]
                require uint8(idx) < mem[ceil32(arg1.length) + 128]
                _1294 = mem[(32 * uint8(idx)) + ceil32(arg1.length) + 160]
                mem[2816] = 0x902f1ac00000000000000000000000000000000000000000000000000000000
                staticcall _1294.getReserves() with:
                        gas gas_remaining wei
                mem[3072 len 64] = ext_call.return_data[0 len 64]
                require uint8(idx) < mem[_4]
                if Mask(1, 7, _1282):
                    if mem[(32 * uint8(idx)) + _4 + 63 len 1]:
                        require uint8(idx) < mem[_638]
                        require uint8(idx) < mem[_641]
                        require uint8(idx + 1) < mem[_641]
                        mem[(32 * uint8(idx + 1)) + _641 + 32] = (10000 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000 * ext_call.return_data[32]) - (5 * _1282 % 128 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000 * ext_call.return_data[32]) / (10000 * ext_call.return_data[0]) + (10000 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000) - (5 * _1282 % 128 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000)
                        _1262 = mem[ceil32(arg1.length) + 128]
                        idx = idx + 1
                        s = s
                        continue 
                    if s != 15:
                        if uint8(idx) != mem[ceil32(arg1.length) + 128] - 1:
                            ...
                            s = s
                            continue 
                    require uint8(idx + 1) < mem[_638]
                    require uint8(idx) < mem[_638]
                    require uint8(idx) < mem[_641]
                    require uint8(idx + 1) < mem[_641]
                    mem[(32 * uint8(idx + 1)) + _641 + 32] = (10000 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000 * ext_call.return_data[32]) - (5 * _1282 % 128 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000 * ext_call.return_data[32]) / (10000 * ext_call.return_data[0]) + (10000 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000) - (5 * _1282 % 128 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000)
                    if mem[(32 * uint8(idx + 1)) + _638 + 32]:
                        _1262 = mem[ceil32(arg1.length) + 128]
                        idx = idx + 1
                        s = s
                        continue 
                    ...
                    if mem[(32 * uint8(idx)) + _4 + 63 len 1]:
                        ...
                        require uint8(idx) < mem[_641]
                        require uint8(idx + 1) < mem[_641]
                        mem[(32 * uint8(idx + 1)) + _641 + 32] = (10000 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000 * ext_call.return_data[0]) - (5 * _1282 % 128 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000 * ext_call.return_data[0]) / (10000 * ext_call.return_data[32]) + (10000 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000) - (5 * _1282 % 128 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000)
                        _1262 = mem[ceil32(arg1.length) + 128]
                        idx = idx + 1
                        s = s
                        continue 
            ...
            if mem[(32 * uint8(idx)) + _4 + 63 len 1] == 2:
                require uint8(idx) < mem[_5]
                _1289 = mem[(32 * uint8(idx)) + _5 + 32]
                require uint8(idx) < mem[ceil32(arg1.length) + 128]
                _1301 = mem[(32 * uint8(idx)) + ceil32(arg1.length) + 160]
                require uint8(idx) < mem[_641]
                _1315 = mem[(32 * uint8(idx)) + _641 + 32]
                mem[mem[64] + 4] = ('signextend', 15, ('mask_shl', 3, 3, -3, ('mem', ('range', ('add', 32, ('mask_shl', 8, 0, 5, ('var', 0)), ('var', '_5')), 32))))
                mem[mem[64] + 36] = ('signextend', 15, ('mask_shl', 3, 0, 0, ('var', '_1289')))
                mem[mem[64] + 68] = _1315
                require ext_code.size(address(_1301))
                if not Mask(1, 6, mem[(32 * uint8(idx)) + _5 + 32]):
                    staticcall address(_1301).get_dy(int128 arg1, int128 arg2, uint256 arg3) with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4], ('signextend', 15, ('mask_shl', 3, 0, 0, ('var', '_1289'))), _1315
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require uint8(idx + 1) < mem[_641]
                    mem[(32 * uint8(idx + 1)) + _641 + 32] = ext_call.return_data[0]
                else:
                    staticcall address(_1301).get_dy_underlying(int128 arg1, int128 arg2, uint256 arg3) with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4], ('signextend', 15, ('mask_shl', 3, 0, 0, ('var', '_1289'))), _1315
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                    ...
                    if 9999 * ext_call.return_data[0] / 9999 != ext_call.return_data[0]:
                        revert with 0, 'ds-math-mul-overflow'
                    require uint8(idx + 1) < mem[_641]
                    mem[(32 * uint8(idx + 1)) + _641 + 32] = 9999 * ext_call.return_data[0] / 10000
            _1262 = mem[ceil32(arg1.length) + 128]
            idx = idx + 1
            s = s
            continue 
        require mem[_641] - 1 < mem[_641]
        require 0 < mem[_641]
        if mem[_641 + 32] < mem[(32 * mem[_641] - 1) + _641 + 32]:
            mem[0] = msg.sender
            mem[32] = 1
            require stor1[address(msg.sender)]
            require 0 < mem[_4]
            if mem[_4 + 63 len 1] >= 2:
                _1952 = mem[ceil32(arg1.length) + 128]
                idx = 0
                s = 0
                t = 0
                while idx < _1952:
                    require idx < mem[_4]
                    _1960 = mem[(32 * idx) + _4 + 32]
                    require idx + 1 < mem[_641]
                    _1968 = mem[(32 * idx + 1) + _641 + 32]
                    if idx >= mem[ceil32(arg1.length) + 128] - 1:
                        if mem[(32 * idx) + _4 + 63 len 1] >= 2:
                            if mem[(32 * idx) + _4 + 63 len 1] != 2:
                                _1952 = mem[ceil32(arg1.length) + 128]
                                ...
                                t = mem[(32 * idx) + _4 + 32]
                                continue 
                            require idx < mem[_641]
                            require idx + 1 < mem[_641]
                            _1952 = mem[ceil32(arg1.length) + 128]
                            idx = idx + 1
                            s = mem[(32 * idx) + _641 + 32]
                            t = mem[(32 * idx) + _4 + 32]
                            continue 
                        require idx < mem[_5]
                        if Mask(1, 7, mem[(32 * idx) + _5 + 32]):
                            if mem[(32 * idx) + _4 + 63 len 1]:
                                if mem[(32 * idx) + _4 + 63 len 1] != 1:
                                    ...
                                    continue 
                                require idx < mem[ceil32(arg1.length) + 128]
                                _2088 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                mem[mem[64]] = 0x6d9a640a00000000000000000000000000000000000000000000000000000000
                                mem[mem[64] + 4] = 0
                                mem[mem[64] + 36] = _1968
                                mem[mem[64] + 68] = this.address
                                require ext_code.size(address(_2088))
                                call address(_2088).swap(uint256 arg1, uint256 arg2, address arg3) with:
                                     gas gas_remaining wei
                                    args 0, _1968, this.address
                            else:
                                require idx < mem[ceil32(arg1.length) + 128]
                                _2073 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                _2091 = mem[64]
                                mem[64] = mem[64] + 32
                                mem[_2091 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                                mem[_2091 + 36] = 0
                                mem[_2091 + 68] = _1968
                                mem[_2091 + 100] = this.address
                                mem[_2091 + 132] = 128
                                mem[_2091 + 164] = mem[_2091]
                                s = 0
                                while s < mem[_2091]:
                                    mem[_2091 + s + 196] = mem[_2091 + s + 32]
                                    _1952 = mem[ceil32(arg1.length) + 128]
                                    s = s + 32
                                    continue 
                                if not mem[_2091] % 32:
                                    ...
                                    call address(_2073).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args 0, _1968, address(this.address), 128, mem[_2091 + 164 len mem[_2091] + 32]
                                else:
                                    mem[floor32(mem[_2091]) + _2091 + 196] = mem[floor32(mem[_2091]) + _2091 + -(mem[_2091] % 32) + 228 len mem[_2091] % 32]
                                    require ext_code.size(address(_2073))
                                    call address(_2073).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args 0, _1968, address(this.address), 128, mem[_2091], mem[_2091 + 196 len floor32(mem[_2091]) + 32]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            _1952 = mem[ceil32(arg1.length) + 128]
                            idx = idx + 1
                        ...
                        if mem[(32 * idx) + _4 + 63 len 1]:
                            if mem[(32 * idx) + _4 + 63 len 1] != 1:
                                _1952 = mem[ceil32(arg1.length) + 128]
                                idx = idx + 1
                                s = mem[(32 * idx + 1) + _641 + 32]
                                t = mem[(32 * idx) + _4 + 32]
                                continue 
                            require idx < mem[ceil32(arg1.length) + 128]
                            _2092 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                            mem[mem[64]] = 0x6d9a640a00000000000000000000000000000000000000000000000000000000
                            mem[mem[64] + 4] = _1968
                            mem[mem[64] + 36] = 0
                            mem[mem[64] + 68] = this.address
                            require ext_code.size(address(_2092))
                            call address(_2092).swap(uint256 arg1, uint256 arg2, address arg3) with:
                                 gas gas_remaining wei
                                args _1968, 0, this.address
                        else:
                            require idx < mem[ceil32(arg1.length) + 128]
                            _2075 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                            _2095 = mem[64]
                            mem[64] = mem[64] + 32
                            mem[_2095 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                            mem[_2095 + 36] = _1968
                            mem[_2095 + 68] = 0
                            mem[_2095 + 100] = this.address
                            mem[_2095 + 132] = 128
                            mem[_2095 + 164] = mem[_2095]
                            s = 0
                            while s < mem[_2095]:
                                mem[_2095 + s + 196] = mem[_2095 + s + 32]
                                _1952 = mem[ceil32(arg1.length) + 128]
                                s = s + 32
                                continue 
                            if not mem[_2095] % 32:
                                ...
                                call address(_2075).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                     gas gas_remaining wei
                                    args _1968, 0, address(this.address), 128, mem[_2095 + 164 len mem[_2095] + 32]
                            else:
                                mem[floor32(mem[_2095]) + _2095 + 196] = mem[floor32(mem[_2095]) + _2095 + -(mem[_2095] % 32) + 228 len mem[_2095] % 32]
                                require ext_code.size(address(_2075))
                                call address(_2075).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                     gas gas_remaining wei
                                    args _1968, 0, address(this.address), 128, mem[_2095], mem[_2095 + 196 len floor32(mem[_2095]) + 32]
                    else:
                        require idx + 1 < mem[_4]
                        if mem[(32 * idx + 1) + _4 + 63 len 1] >= 2:
                            if mem[(32 * idx) + _4 + 63 len 1] >= 2:
                                ...
                                if mem[(32 * idx) + _4 + 63 len 1]:
                                    ...
                                    if not mem[_2183] % 32:
                                        ...
                                        call address(_2137).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                             gas gas_remaining wei
                                            args 0, _1968, address(this.address), 128, mem[_2183 + 164 len mem[_2183] + 32]
                                    else:
                                        mem[floor32(mem[_2183]) + _2183 + 196] = mem[floor32(mem[_2183]) + _2183 + -(mem[_2183] % 32) + 228 len mem[_2183] % 32]
                                        require ext_code.size(address(_2137))
                                        call address(_2137).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                             gas gas_remaining wei
                                            args 0, _1968, address(this.address), 128, mem[_2183], mem[_2183 + 196 len floor32(mem[_2183]) + 32]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _1952 = mem[ceil32(arg1.length) + 128]
                                idx = idx + 1
                            ...
                            if mem[(32 * idx) + _4 + 63 len 1]:
                                ...
                                if not mem[_2187] % 32:
                                    ...
                                    call address(_2139).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args _1968, 0, address(this.address), 128, mem[_2187 + 164 len mem[_2187] + 32]
                                else:
                                    mem[floor32(mem[_2187]) + _2187 + 196] = mem[floor32(mem[_2187]) + _2187 + -(mem[_2187] % 32) + 228 len mem[_2187] % 32]
                                    require ext_code.size(address(_2139))
                                    call address(_2139).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args _1968, 0, address(this.address), 128, mem[_2187], mem[_2187 + 196 len floor32(mem[_2187]) + 32]
                        else:
                            require idx + 1 < mem[ceil32(arg1.length) + 128]
                            _1994 = mem[(32 * idx + 1) + ceil32(arg1.length) + 160]
                            if mem[(32 * idx) + _4 + 63 len 1] >= 2:
                                if mem[(32 * idx) + _4 + 63 len 1] != 2:
                                    _1952 = mem[ceil32(arg1.length) + 128]
                                    idx = idx + 1
                            ...
                            if Mask(1, 7, mem[(32 * idx) + _5 + 32]):
                                if mem[(32 * idx) + _4 + 63 len 1]:
                                    if mem[(32 * idx) + _4 + 63 len 1] != 1:
                                        ...
                                        continue 
                                    require idx < mem[ceil32(arg1.length) + 128]
                                    _2226 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                    mem[mem[64]] = 0x6d9a640a00000000000000000000000000000000000000000000000000000000
                                    mem[mem[64] + 4] = 0
                                    mem[mem[64] + 36] = _1968
                                    mem[mem[64] + 68] = address(_1994)
                                    require ext_code.size(address(_2226))
                                    call address(_2226).swap(uint256 arg1, uint256 arg2, address arg3) with:
                                         gas gas_remaining wei
                                        args 0, _1968, address(_1994)
                                else:
                                    require idx < mem[ceil32(arg1.length) + 128]
                                    _2177 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                    _2229 = mem[64]
                                    mem[64] = mem[64] + 32
                                    mem[_2229 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                                    mem[_2229 + 36] = 0
                                    mem[_2229 + 68] = _1968
                                    mem[_2229 + 100] = address(_1994)
                                    mem[_2229 + 132] = 128
                                    mem[_2229 + 164] = mem[_2229]
                                    s = 0
                                    while s < mem[_2229]:
                                        mem[_2229 + s + 196] = mem[_2229 + s + 32]
                                        _1952 = mem[ceil32(arg1.length) + 128]
                                        s = s + 32
                                        continue 
                                    if not mem[_2229] % 32:
                                        ...
                                        call address(_2177).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                             gas gas_remaining wei
                                            args 0, _1968, address(_1994), 128, mem[_2229 + 164 len mem[_2229] + 32]
                                    else:
                                        mem[floor32(mem[_2229]) + _2229 + 196] = mem[floor32(mem[_2229]) + _2229 + -(mem[_2229] % 32) + 228 len mem[_2229] % 32]
                                        require ext_code.size(address(_2177))
                                        call address(_2177).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                             gas gas_remaining wei
                                            args 0, _1968, address(_1994), 128, mem[_2229], mem[_2229 + 196 len floor32(mem[_2229]) + 32]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _1952 = mem[ceil32(arg1.length) + 128]
                                idx = idx + 1
                            ...
                            if mem[(32 * idx) + _4 + 63 len 1]:
                                ...
                                if not mem[_2233] % 32:
                                    ...
                                    call address(_2179).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args _1968, 0, address(_1994), 128, mem[_2233 + 164 len mem[_2233] + 32]
                                else:
                                    mem[floor32(mem[_2233]) + _2233 + 196] = mem[floor32(mem[_2233]) + _2233 + -(mem[_2233] % 32) + 228 len mem[_2233] % 32]
                                    require ext_code.size(address(_2179))
                                    call address(_2179).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args _1968, 0, address(_1994), 128, mem[_2233], mem[_2233 + 196 len floor32(mem[_2233]) + 32]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1952 = mem[ceil32(arg1.length) + 128]
                    idx = idx + 1
                ...
                mem[mem[64] + 4] = mem[ceil32(arg1.length) + 172 len 20]
                mem[mem[64] + 36] = _1327
                require ext_code.size(Mask(160, 96, _636) >> 96)
                call Mask(160, 96, _636) >> 96.0xa9059cbb with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4], _1327
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                _1953 = mem[ceil32(arg1.length) + 128]
                idx = 0
                s = 0
                t = 0
                while idx < _1953:
                    require idx < mem[_4]
                    _1962 = mem[(32 * idx) + _4 + 32]
                    require idx + 1 < mem[_641]
                    _1970 = mem[(32 * idx + 1) + _641 + 32]
                    if idx >= mem[ceil32(arg1.length) + 128] - 1:
                        if mem[(32 * idx) + _4 + 63 len 1] >= 2:
                            if mem[(32 * idx) + _4 + 63 len 1] != 2:
                                _1953 = mem[ceil32(arg1.length) + 128]
                        ...
                        if Mask(1, 7, mem[(32 * idx) + _5 + 32]):
                            if mem[(32 * idx) + _4 + 63 len 1]:
                                if mem[(32 * idx) + _4 + 63 len 1] != 1:
                                    ...
                                    continue 
                                require idx < mem[ceil32(arg1.length) + 128]
                                _2098 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                mem[mem[64]] = 0x6d9a640a00000000000000000000000000000000000000000000000000000000
                                mem[mem[64] + 4] = 0
                                mem[mem[64] + 36] = _1970
                                mem[mem[64] + 68] = this.address
                                require ext_code.size(address(_2098))
                                call address(_2098).swap(uint256 arg1, uint256 arg2, address arg3) with:
                                     gas gas_remaining wei
                                    args 0, _1970, this.address
                            else:
                                require idx < mem[ceil32(arg1.length) + 128]
                                _2077 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                _2101 = mem[64]
                                mem[64] = mem[64] + 32
                                mem[_2101 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                                mem[_2101 + 36] = 0
                                mem[_2101 + 68] = _1970
                                mem[_2101 + 100] = this.address
                                mem[_2101 + 132] = 128
                                mem[_2101 + 164] = mem[_2101]
                                s = 0
                                while s < mem[_2101]:
                                    mem[_2101 + s + 196] = mem[_2101 + s + 32]
                                    _1953 = mem[ceil32(arg1.length) + 128]
                                    s = s + 32
                                    continue 
                                if not mem[_2101] % 32:
                                    require ext_code.size(address(_2077))
                                    call address(_2077).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args 0, _1970, address(this.address), 128, mem[_2101 + 164 len mem[_2101] + 32]
                                else:
                                    mem[floor32(mem[_2101]) + _2101 + 196] = mem[floor32(mem[_2101]) + _2101 + -(mem[_2101] % 32) + 228 len mem[_2101] % 32]
                                    require ext_code.size(address(_2077))
                                    call address(_2077).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args 0, _1970, address(this.address), 128, mem[_2101], mem[_2101 + 196 len floor32(mem[_2101]) + 32]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            _1953 = mem[ceil32(arg1.length) + 128]
                            idx = idx + 1
                        ...
                        if mem[(32 * idx) + _4 + 63 len 1]:
                            if mem[(32 * idx) + _4 + 63 len 1] != 1:
                                ...
                                continue 
                            require idx < mem[ceil32(arg1.length) + 128]
                            _2102 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                            mem[mem[64]] = 0x6d9a640a00000000000000000000000000000000000000000000000000000000
                            mem[mem[64] + 4] = _1970
                            mem[mem[64] + 36] = 0
                            mem[mem[64] + 68] = this.address
                            require ext_code.size(address(_2102))
                            call address(_2102).swap(uint256 arg1, uint256 arg2, address arg3) with:
                                 gas gas_remaining wei
                                args _1970, 0, this.address
                        else:
                            require idx < mem[ceil32(arg1.length) + 128]
                            _2079 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                            _2105 = mem[64]
                            mem[64] = mem[64] + 32
                            mem[_2105 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                            mem[_2105 + 36] = _1970
                            mem[_2105 + 68] = 0
                            mem[_2105 + 100] = this.address
                            mem[_2105 + 132] = 128
                            mem[_2105 + 164] = mem[_2105]
                            s = 0
                            while s < mem[_2105]:
                                mem[_2105 + s + 196] = mem[_2105 + s + 32]
                                _1953 = mem[ceil32(arg1.length) + 128]
                                s = s + 32
                                continue 
                            if not mem[_2105] % 32:
                                require ext_code.size(address(_2079))
                                call address(_2079).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                     gas gas_remaining wei
                                    args _1970, 0, address(this.address), 128, mem[_2105 + 164 len mem[_2105] + 32]
                            else:
                                mem[floor32(mem[_2105]) + _2105 + 196] = mem[floor32(mem[_2105]) + _2105 + -(mem[_2105] % 32) + 228 len mem[_2105] % 32]
                                require ext_code.size(address(_2079))
                                call address(_2079).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                     gas gas_remaining wei
                                    args _1970, 0, address(this.address), 128, mem[_2105], mem[_2105 + 196 len floor32(mem[_2105]) + 32]
                    else:
                        require idx + 1 < mem[_4]
                        if mem[(32 * idx + 1) + _4 + 63 len 1] >= 2:
                            if mem[(32 * idx) + _4 + 63 len 1] >= 2:
                                ...
                                if mem[(32 * idx) + _4 + 63 len 1]:
                                    ...
                                    if not mem[_2195] % 32:
                                        ...
                                        call address(_2149).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                             gas gas_remaining wei
                                            args 0, _1970, address(this.address), 128, mem[_2195 + 164 len mem[_2195] + 32]
                                    else:
                                        mem[floor32(mem[_2195]) + _2195 + 196] = mem[floor32(mem[_2195]) + _2195 + -(mem[_2195] % 32) + 228 len mem[_2195] % 32]
                                        require ext_code.size(address(_2149))
                                        call address(_2149).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                             gas gas_remaining wei
                                            args 0, _1970, address(this.address), 128, mem[_2195], mem[_2195 + 196 len floor32(mem[_2195]) + 32]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _1953 = mem[ceil32(arg1.length) + 128]
                                idx = idx + 1
                            ...
                            if mem[(32 * idx) + _4 + 63 len 1]:
                                ...
                                if not mem[_2199] % 32:
                                    ...
                                    call address(_2151).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args _1970, 0, address(this.address), 128, mem[_2199 + 164 len mem[_2199] + 32]
                                else:
                                    mem[floor32(mem[_2199]) + _2199 + 196] = mem[floor32(mem[_2199]) + _2199 + -(mem[_2199] % 32) + 228 len mem[_2199] % 32]
                                    require ext_code.size(address(_2151))
                                    call address(_2151).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args _1970, 0, address(this.address), 128, mem[_2199], mem[_2199 + 196 len floor32(mem[_2199]) + 32]
                        else:
                            require idx + 1 < mem[ceil32(arg1.length) + 128]
                            _1997 = mem[(32 * idx + 1) + ceil32(arg1.length) + 160]
                            if mem[(32 * idx) + _4 + 63 len 1] >= 2:
                                if mem[(32 * idx) + _4 + 63 len 1] != 2:
                                    _1953 = mem[ceil32(arg1.length) + 128]
                                    idx = idx + 1
                            ...
                            if Mask(1, 7, mem[(32 * idx) + _5 + 32]):
                                if mem[(32 * idx) + _4 + 63 len 1]:
                                    if mem[(32 * idx) + _4 + 63 len 1] != 1:
                                        ...
                                        continue 
                                    require idx < mem[ceil32(arg1.length) + 128]
                                    _2242 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                    mem[mem[64]] = 0x6d9a640a00000000000000000000000000000000000000000000000000000000
                                    mem[mem[64] + 4] = 0
                                    mem[mem[64] + 36] = _1970
                                    mem[mem[64] + 68] = address(_1997)
                                    require ext_code.size(address(_2242))
                                    call address(_2242).swap(uint256 arg1, uint256 arg2, address arg3) with:
                                         gas gas_remaining wei
                                        args 0, _1970, address(_1997)
                                else:
                                    require idx < mem[ceil32(arg1.length) + 128]
                                    _2189 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                    _2245 = mem[64]
                                    mem[64] = mem[64] + 32
                                    mem[_2245 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                                    mem[_2245 + 36] = 0
                                    mem[_2245 + 68] = _1970
                                    mem[_2245 + 100] = address(_1997)
                                    mem[_2245 + 132] = 128
                                    mem[_2245 + 164] = mem[_2245]
                                    s = 0
                                    while s < mem[_2245]:
                                        mem[_2245 + s + 196] = mem[_2245 + s + 32]
                                        _1953 = mem[ceil32(arg1.length) + 128]
                                        s = s + 32
                                        continue 
                                    if not mem[_2245] % 32:
                                        ...
                                        call address(_2189).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                             gas gas_remaining wei
                                            args 0, _1970, address(_1997), 128, mem[_2245 + 164 len mem[_2245] + 32]
                                    else:
                                        mem[floor32(mem[_2245]) + _2245 + 196] = mem[floor32(mem[_2245]) + _2245 + -(mem[_2245] % 32) + 228 len mem[_2245] % 32]
                                        require ext_code.size(address(_2189))
                                        call address(_2189).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                             gas gas_remaining wei
                                            args 0, _1970, address(_1997), 128, mem[_2245], mem[_2245 + 196 len floor32(mem[_2245]) + 32]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _1953 = mem[ceil32(arg1.length) + 128]
                                idx = idx + 1
                            ...
                            if mem[(32 * idx) + _4 + 63 len 1]:
                                ...
                                if not mem[_2249] % 32:
                                    ...
                                    call address(_2191).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args _1970, 0, address(_1997), 128, mem[_2249 + 164 len mem[_2249] + 32]
                                else:
                                    mem[floor32(mem[_2249]) + _2249 + 196] = mem[floor32(mem[_2249]) + _2249 + -(mem[_2249] % 32) + 228 len mem[_2249] % 32]
                                    require ext_code.size(address(_2191))
                                    call address(_2191).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args _1970, 0, address(_1997), 128, mem[_2249], mem[_2249 + 196 len floor32(mem[_2249]) + 32]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1953 = mem[ceil32(arg1.length) + 128]
                    idx = idx + 1
        ...
        mem[_641 + 32 len 32 * _640 + 1] = call.data[calldata.size len 32 * _640 + 1]
        require 0 < mem[_641]
        mem[_641 + 32] = Mask(112, 0, _634)
        _1263 = mem[ceil32(arg1.length) + 128]
        idx = 0
        s = 15
        while uint8(idx) < _1263:
            require uint8(idx) < mem[_4]
            if mem[(32 * uint8(idx)) + _4 + 63 len 1] < 2:
                require uint8(idx) < mem[_5]
                _1285 = mem[(32 * uint8(idx)) + _5 + 32]
                require uint8(idx) < mem[ceil32(arg1.length) + 128]
                _1295 = mem[(32 * uint8(idx)) + ceil32(arg1.length) + 160]
                mem[2816] = 0x902f1ac00000000000000000000000000000000000000000000000000000000
                staticcall _1295.getReserves() with:
                        gas gas_remaining wei
                mem[3072 len 64] = ext_call.return_data[0 len 64]
                require uint8(idx) < mem[_4]
                if Mask(1, 7, _1285):
                    if mem[(32 * uint8(idx)) + _4 + 63 len 1]:
                        ...
                        require uint8(idx) < mem[_641]
                        require uint8(idx + 1) < mem[_641]
                        mem[(32 * uint8(idx + 1)) + _641 + 32] = (10000 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000 * ext_call.return_data[32]) - (5 * _1285 % 128 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000 * ext_call.return_data[32]) / (10000 * ext_call.return_data[0]) + (10000 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000) - (5 * _1285 % 128 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000)
                        _1263 = mem[ceil32(arg1.length) + 128]
                        idx = idx + 1
                        s = s
                        continue 
                    ...
                    if mem[(32 * uint8(idx)) + _4 + 63 len 1]:
                        ...
                        require uint8(idx) < mem[_641]
                        require uint8(idx + 1) < mem[_641]
                        mem[(32 * uint8(idx + 1)) + _641 + 32] = (10000 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000 * ext_call.return_data[0]) - (5 * _1285 % 128 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000 * ext_call.return_data[0]) / (10000 * ext_call.return_data[32]) + (10000 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000) - (5 * _1285 % 128 * (10000 * mem[(32 * uint8(idx)) + _641 + 32]) - (mem[(32 * uint8(idx)) + _638 + 32] * mem[(32 * uint8(idx)) + _641 + 32]) / 10000)
                        _1263 = mem[ceil32(arg1.length) + 128]
                        idx = idx + 1
                        s = s
                        continue 
            ...
            if mem[(32 * uint8(idx)) + _4 + 63 len 1] == 2:
                require uint8(idx) < mem[_5]
                _1292 = mem[(32 * uint8(idx)) + _5 + 32]
                require uint8(idx) < mem[ceil32(arg1.length) + 128]
                _1308 = mem[(32 * uint8(idx)) + ceil32(arg1.length) + 160]
                require uint8(idx) < mem[_641]
                _1317 = mem[(32 * uint8(idx)) + _641 + 32]
                mem[mem[64] + 4] = ('signextend', 15, ('mask_shl', 3, 3, -3, ('mem', ('range', ('add', 32, ('mask_shl', 8, 0, 5, ('var', 0)), ('var', '_5')), 32))))
                mem[mem[64] + 36] = ('signextend', 15, ('mask_shl', 3, 0, 0, ('var', '_1292')))
                mem[mem[64] + 68] = _1317
                require ext_code.size(address(_1308))
                if not Mask(1, 6, mem[(32 * uint8(idx)) + _5 + 32]):
                    staticcall address(_1308).get_dy(int128 arg1, int128 arg2, uint256 arg3) with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4], ('signextend', 15, ('mask_shl', 3, 0, 0, ('var', '_1292'))), _1317
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    ...
                    staticcall address(_1308).get_dy_underlying(int128 arg1, int128 arg2, uint256 arg3) with:
                            gas gas_remaining wei
                           args mem[mem[64] + 4], ('signextend', 15, ('mask_shl', 3, 0, 0, ('var', '_1292'))), _1317
                    mem[mem[64]] = ext_call.return_data[0]
                    if not ext_call.success:
        ...
        if mem[_641 + 32] < mem[(32 * mem[_641] - 1) + _641 + 32]:
            ...
            require 0 < mem[_4]
            if mem[_4 + 63 len 1] >= 2:
                _1954 = mem[ceil32(arg1.length) + 128]
                idx = 0
                s = 0
                t = 0
                while idx < _1954:
                    require idx < mem[_4]
                    _1964 = mem[(32 * idx) + _4 + 32]
                    require idx + 1 < mem[_641]
                    _1972 = mem[(32 * idx + 1) + _641 + 32]
                    if idx >= mem[ceil32(arg1.length) + 128] - 1:
                        if mem[(32 * idx) + _4 + 63 len 1] >= 2:
                            if mem[(32 * idx) + _4 + 63 len 1] != 2:
                                _1954 = mem[ceil32(arg1.length) + 128]
                        ...
                        if Mask(1, 7, mem[(32 * idx) + _5 + 32]):
                            if mem[(32 * idx) + _4 + 63 len 1]:
                                if mem[(32 * idx) + _4 + 63 len 1] != 1:
                                    ...
                                    continue 
                                require idx < mem[ceil32(arg1.length) + 128]
                                _2108 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                mem[mem[64]] = 0x6d9a640a00000000000000000000000000000000000000000000000000000000
                                mem[mem[64] + 4] = 0
                                mem[mem[64] + 36] = _1972
                                mem[mem[64] + 68] = this.address
                                require ext_code.size(address(_2108))
                                call address(_2108).swap(uint256 arg1, uint256 arg2, address arg3) with:
                                     gas gas_remaining wei
                                    args 0, _1972, this.address
                            else:
                                require idx < mem[ceil32(arg1.length) + 128]
                                _2081 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                _2111 = mem[64]
                                mem[64] = mem[64] + 32
                                mem[_2111 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                                mem[_2111 + 36] = 0
                                mem[_2111 + 68] = _1972
                                ...
                                s = 0
                                while s < mem[_2111]:
                                    mem[_2111 + s + 196] = mem[_2111 + s + 32]
                                    _1954 = mem[ceil32(arg1.length) + 128]
                                    s = s + 32
                                    continue 
                                if not mem[_2111] % 32:
                                    require ext_code.size(address(_2081))
                                    call address(_2081).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args 0, _1972, address(this.address), 128, mem[_2111 + 164 len mem[_2111] + 32]
                                else:
                                    mem[floor32(mem[_2111]) + _2111 + 196] = mem[floor32(mem[_2111]) + _2111 + -(mem[_2111] % 32) + 228 len mem[_2111] % 32]
                                    require ext_code.size(address(_2081))
                                    call address(_2081).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args 0, _1972, address(this.address), 128, mem[_2111], mem[_2111 + 196 len floor32(mem[_2111]) + 32]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            _1954 = mem[ceil32(arg1.length) + 128]
                            idx = idx + 1
                        ...
                        if mem[(32 * idx) + _4 + 63 len 1]:
                            if mem[(32 * idx) + _4 + 63 len 1] != 1:
                                ...
                                continue 
                            require idx < mem[ceil32(arg1.length) + 128]
                            _2112 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                            mem[mem[64]] = 0x6d9a640a00000000000000000000000000000000000000000000000000000000
                            mem[mem[64] + 4] = _1972
                            mem[mem[64] + 36] = 0
                            mem[mem[64] + 68] = this.address
                            require ext_code.size(address(_2112))
                            call address(_2112).swap(uint256 arg1, uint256 arg2, address arg3) with:
                                 gas gas_remaining wei
                                args _1972, 0, this.address
                        else:
                            require idx < mem[ceil32(arg1.length) + 128]
                            _2083 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                            _2115 = mem[64]
                            mem[64] = mem[64] + 32
                            mem[_2115 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                            mem[_2115 + 36] = _1972
                            mem[_2115 + 68] = 0
                            mem[_2115 + 100] = this.address
                            mem[_2115 + 132] = 128
                            mem[_2115 + 164] = mem[_2115]
                            s = 0
                            while s < mem[_2115]:
                                mem[_2115 + s + 196] = mem[_2115 + s + 32]
                                _1954 = mem[ceil32(arg1.length) + 128]
                                s = s + 32
                                continue 
                            if not mem[_2115] % 32:
                                require ext_code.size(address(_2083))
                                call address(_2083).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                     gas gas_remaining wei
                                    args _1972, 0, address(this.address), 128, mem[_2115 + 164 len mem[_2115] + 32]
                            else:
                                mem[floor32(mem[_2115]) + _2115 + 196] = mem[floor32(mem[_2115]) + _2115 + -(mem[_2115] % 32) + 228 len mem[_2115] % 32]
                                require ext_code.size(address(_2083))
                                call address(_2083).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                     gas gas_remaining wei
                                    args _1972, 0, address(this.address), 128, mem[_2115], mem[_2115 + 196 len floor32(mem[_2115]) + 32]
                    else:
                        require idx + 1 < mem[_4]
                        if mem[(32 * idx + 1) + _4 + 63 len 1] >= 2:
                            if mem[(32 * idx) + _4 + 63 len 1] >= 2:
                                ...
                                if mem[(32 * idx) + _4 + 63 len 1]:
                                    ...
                                    if not mem[_2207] % 32:
                                        ...
                                        call address(_2161).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                             gas gas_remaining wei
                                            args 0, _1972, address(this.address), 128, mem[_2207 + 164 len mem[_2207] + 32]
                                    else:
                                        mem[floor32(mem[_2207]) + _2207 + 196] = mem[floor32(mem[_2207]) + _2207 + -(mem[_2207] % 32) + 228 len mem[_2207] % 32]
                                        require ext_code.size(address(_2161))
                                        call address(_2161).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                             gas gas_remaining wei
                                            args 0, _1972, address(this.address), 128, mem[_2207], mem[_2207 + 196 len floor32(mem[_2207]) + 32]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _1954 = mem[ceil32(arg1.length) + 128]
                                idx = idx + 1
                            ...
                            if mem[(32 * idx) + _4 + 63 len 1]:
                                ...
                                if not mem[_2211] % 32:
                                    ...
                                    call address(_2163).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args _1972, 0, address(this.address), 128, mem[_2211 + 164 len mem[_2211] + 32]
                                else:
                                    mem[floor32(mem[_2211]) + _2211 + 196] = mem[floor32(mem[_2211]) + _2211 + -(mem[_2211] % 32) + 228 len mem[_2211] % 32]
                                    require ext_code.size(address(_2163))
                                    call address(_2163).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args _1972, 0, address(this.address), 128, mem[_2211], mem[_2211 + 196 len floor32(mem[_2211]) + 32]
                        else:
                            require idx + 1 < mem[ceil32(arg1.length) + 128]
                            _2000 = mem[(32 * idx + 1) + ceil32(arg1.length) + 160]
                            if mem[(32 * idx) + _4 + 63 len 1] >= 2:
                                if mem[(32 * idx) + _4 + 63 len 1] != 2:
                                    _1954 = mem[ceil32(arg1.length) + 128]
                                    idx = idx + 1
                            ...
                            if Mask(1, 7, mem[(32 * idx) + _5 + 32]):
                                if mem[(32 * idx) + _4 + 63 len 1]:
                                    if mem[(32 * idx) + _4 + 63 len 1] != 1:
                                        ...
                                        continue 
                                    require idx < mem[ceil32(arg1.length) + 128]
                                    _2258 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                    mem[mem[64]] = 0x6d9a640a00000000000000000000000000000000000000000000000000000000
                                    mem[mem[64] + 4] = 0
                                    mem[mem[64] + 36] = _1972
                                    mem[mem[64] + 68] = address(_2000)
                                    require ext_code.size(address(_2258))
                                    call address(_2258).swap(uint256 arg1, uint256 arg2, address arg3) with:
                                         gas gas_remaining wei
                                        args 0, _1972, address(_2000)
                                else:
                                    require idx < mem[ceil32(arg1.length) + 128]
                                    _2201 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                    _2261 = mem[64]
                                    mem[64] = mem[64] + 32
                                    mem[_2261 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                                    mem[_2261 + 36] = 0
                                    mem[_2261 + 68] = _1972
                                    mem[_2261 + 100] = address(_2000)
                                    mem[_2261 + 132] = 128
                                    mem[_2261 + 164] = mem[_2261]
                                    s = 0
                                    while s < mem[_2261]:
                                        mem[_2261 + s + 196] = mem[_2261 + s + 32]
                                        _1954 = mem[ceil32(arg1.length) + 128]
                                        s = s + 32
                                        continue 
                                    if not mem[_2261] % 32:
                                        ...
                                        call address(_2201).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                             gas gas_remaining wei
                                            args 0, _1972, address(_2000), 128, mem[_2261 + 164 len mem[_2261] + 32]
                                    else:
                                        mem[floor32(mem[_2261]) + _2261 + 196] = mem[floor32(mem[_2261]) + _2261 + -(mem[_2261] % 32) + 228 len mem[_2261] % 32]
                                        require ext_code.size(address(_2201))
                                        call address(_2201).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                             gas gas_remaining wei
                                            args 0, _1972, address(_2000), 128, mem[_2261], mem[_2261 + 196 len floor32(mem[_2261]) + 32]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _1954 = mem[ceil32(arg1.length) + 128]
                                idx = idx + 1
                            ...
                            if mem[(32 * idx) + _4 + 63 len 1]:
                                ...
                                if not mem[_2265] % 32:
                                    ...
                                    call address(_2203).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args _1972, 0, address(_2000), 128, mem[_2265 + 164 len mem[_2265] + 32]
                                else:
                                    mem[floor32(mem[_2265]) + _2265 + 196] = mem[floor32(mem[_2265]) + _2265 + -(mem[_2265] % 32) + 228 len mem[_2265] % 32]
                                    require ext_code.size(address(_2203))
                                    call address(_2203).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args _1972, 0, address(_2000), 128, mem[_2265], mem[_2265 + 196 len floor32(mem[_2265]) + 32]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1954 = mem[ceil32(arg1.length) + 128]
                    idx = idx + 1
                ...
                call Mask(160, 96, _636) >> 96.0xa9059cbb with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4], _1337
                mem[mem[64]] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                _1955 = mem[ceil32(arg1.length) + 128]
                idx = 0
                s = 0
                t = 0
                while idx < _1955:
                    require idx < mem[_4]
                    _1966 = mem[(32 * idx) + _4 + 32]
                    require idx + 1 < mem[_641]
                    _1974 = mem[(32 * idx + 1) + _641 + 32]
                    if idx >= mem[ceil32(arg1.length) + 128] - 1:
                        if mem[(32 * idx) + _4 + 63 len 1] >= 2:
                            if mem[(32 * idx) + _4 + 63 len 1] != 2:
                                _1955 = mem[ceil32(arg1.length) + 128]
                        ...
                        if Mask(1, 7, mem[(32 * idx) + _5 + 32]):
                            if mem[(32 * idx) + _4 + 63 len 1]:
                                if mem[(32 * idx) + _4 + 63 len 1] != 1:
                                    ...
                                    continue 
                                require idx < mem[ceil32(arg1.length) + 128]
                                _2118 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                mem[mem[64]] = 0x6d9a640a00000000000000000000000000000000000000000000000000000000
                                mem[mem[64] + 4] = 0
                                mem[mem[64] + 36] = _1974
                                mem[mem[64] + 68] = this.address
                                require ext_code.size(address(_2118))
                                call address(_2118).swap(uint256 arg1, uint256 arg2, address arg3) with:
                                     gas gas_remaining wei
                                    args 0, _1974, this.address
                            else:
                                require idx < mem[ceil32(arg1.length) + 128]
                                _2085 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                _2121 = mem[64]
                                mem[64] = mem[64] + 32
                                mem[_2121 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                                mem[_2121 + 36] = 0
                                mem[_2121 + 68] = _1974
                                mem[_2121 + 100] = this.address
                                mem[_2121 + 132] = 128
                                mem[_2121 + 164] = mem[_2121]
                                s = 0
                                while s < mem[_2121]:
                                    mem[_2121 + s + 196] = mem[_2121 + s + 32]
                                    _1955 = mem[ceil32(arg1.length) + 128]
                                    s = s + 32
                                    continue 
                                if not mem[_2121] % 32:
                                    require ext_code.size(address(_2085))
                                    call address(_2085).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args 0, _1974, address(this.address), 128, mem[_2121 + 164 len mem[_2121] + 32]
                                else:
                                    mem[floor32(mem[_2121]) + _2121 + 196] = mem[floor32(mem[_2121]) + _2121 + -(mem[_2121] % 32) + 228 len mem[_2121] % 32]
                                    require ext_code.size(address(_2085))
                                    call address(_2085).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args 0, _1974, address(this.address), 128, mem[_2121], mem[_2121 + 196 len floor32(mem[_2121]) + 32]
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            _1955 = mem[ceil32(arg1.length) + 128]
                            idx = idx + 1
                        ...
                        if mem[(32 * idx) + _4 + 63 len 1]:
                            if mem[(32 * idx) + _4 + 63 len 1] != 1:
                                ...
                                continue 
                            require idx < mem[ceil32(arg1.length) + 128]
                            _2122 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                            mem[mem[64]] = 0x6d9a640a00000000000000000000000000000000000000000000000000000000
                            mem[mem[64] + 4] = _1974
                            mem[mem[64] + 36] = 0
                            mem[mem[64] + 68] = this.address
                            require ext_code.size(address(_2122))
                            call address(_2122).swap(uint256 arg1, uint256 arg2, address arg3) with:
                                 gas gas_remaining wei
                                args _1974, 0, this.address
                        else:
                            require idx < mem[ceil32(arg1.length) + 128]
                            _2087 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                            _2125 = mem[64]
                            mem[64] = mem[64] + 32
                            mem[_2125 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                            mem[_2125 + 36] = _1974
                            mem[_2125 + 68] = 0
                            mem[_2125 + 100] = this.address
                            mem[_2125 + 132] = 128
                            mem[_2125 + 164] = mem[_2125]
                            s = 0
                            while s < mem[_2125]:
                                mem[_2125 + s + 196] = mem[_2125 + s + 32]
                                _1955 = mem[ceil32(arg1.length) + 128]
                                s = s + 32
                                continue 
                            if not mem[_2125] % 32:
                                require ext_code.size(address(_2087))
                                call address(_2087).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                     gas gas_remaining wei
                                    args _1974, 0, address(this.address), 128, mem[_2125 + 164 len mem[_2125] + 32]
                            else:
                                mem[floor32(mem[_2125]) + _2125 + 196] = mem[floor32(mem[_2125]) + _2125 + -(mem[_2125] % 32) + 228 len mem[_2125] % 32]
                                require ext_code.size(address(_2087))
                                call address(_2087).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                     gas gas_remaining wei
                                    args _1974, 0, address(this.address), 128, mem[_2125], mem[_2125 + 196 len floor32(mem[_2125]) + 32]
                    else:
                        require idx + 1 < mem[_4]
                        if mem[(32 * idx + 1) + _4 + 63 len 1] >= 2:
                            if mem[(32 * idx) + _4 + 63 len 1] >= 2:
                            ...
                            if Mask(1, 7, mem[(32 * idx) + _5 + 32]):
                                if mem[(32 * idx) + _4 + 63 len 1]:
                                    if mem[(32 * idx) + _4 + 63 len 1] != 1:
                                        ...
                                        continue 
                                    require idx < mem[ceil32(arg1.length) + 128]
                                    _2216 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                    mem[mem[64]] = 0x6d9a640a00000000000000000000000000000000000000000000000000000000
                                    mem[mem[64] + 4] = 0
                                    mem[mem[64] + 36] = _1974
                                    mem[mem[64] + 68] = this.address
                                    require ext_code.size(address(_2216))
                                    call address(_2216).swap(uint256 arg1, uint256 arg2, address arg3) with:
                                         gas gas_remaining wei
                                        args 0, _1974, this.address
                                else:
                                    require idx < mem[ceil32(arg1.length) + 128]
                                    _2173 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                    _2219 = mem[64]
                                    mem[64] = mem[64] + 32
                                    mem[_2219 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                                    mem[_2219 + 36] = 0
                                    mem[_2219 + 68] = _1974
                                    mem[_2219 + 100] = this.address
                                    mem[_2219 + 132] = 128
                                    mem[_2219 + 164] = mem[_2219]
                                    s = 0
                                    while s < mem[_2219]:
                                        mem[_2219 + s + 196] = mem[_2219 + s + 32]
                                        _1955 = mem[ceil32(arg1.length) + 128]
                                        s = s + 32
                                        continue 
                                    if not mem[_2219] % 32:
                                        require ext_code.size(address(_2173))
                                        call address(_2173).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                             gas gas_remaining wei
                                            args 0, _1974, address(this.address), 128, mem[_2219 + 164 len mem[_2219] + 32]
                                    else:
                                        mem[floor32(mem[_2219]) + _2219 + 196] = mem[floor32(mem[_2219]) + _2219 + -(mem[_2219] % 32) + 228 len mem[_2219] % 32]
                                        require ext_code.size(address(_2173))
                                        call address(_2173).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                             gas gas_remaining wei
                                            args 0, _1974, address(this.address), 128, mem[_2219], mem[_2219 + 196 len floor32(mem[_2219]) + 32]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _1955 = mem[ceil32(arg1.length) + 128]
                                idx = idx + 1
                            ...
                            if mem[(32 * idx) + _4 + 63 len 1]:
                                if mem[(32 * idx) + _4 + 63 len 1] != 1:
                                    ...
                                    continue 
                                require idx < mem[ceil32(arg1.length) + 128]
                                _2220 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                mem[mem[64]] = 0x6d9a640a00000000000000000000000000000000000000000000000000000000
                                mem[mem[64] + 4] = _1974
                                mem[mem[64] + 36] = 0
                                mem[mem[64] + 68] = this.address
                                require ext_code.size(address(_2220))
                                call address(_2220).swap(uint256 arg1, uint256 arg2, address arg3) with:
                                     gas gas_remaining wei
                                    args _1974, 0, this.address
                            else:
                                require idx < mem[ceil32(arg1.length) + 128]
                                _2175 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                _2223 = mem[64]
                                mem[64] = mem[64] + 32
                                mem[_2223 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                                mem[_2223 + 36] = _1974
                                mem[_2223 + 68] = 0
                                mem[_2223 + 100] = this.address
                                mem[_2223 + 132] = 128
                                mem[_2223 + 164] = mem[_2223]
                                s = 0
                                while s < mem[_2223]:
                                    mem[_2223 + s + 196] = mem[_2223 + s + 32]
                                    _1955 = mem[ceil32(arg1.length) + 128]
                                    s = s + 32
                                    continue 
                                if not mem[_2223] % 32:
                                    require ext_code.size(address(_2175))
                                    call address(_2175).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args _1974, 0, address(this.address), 128, mem[_2223 + 164 len mem[_2223] + 32]
                                else:
                                    mem[floor32(mem[_2223]) + _2223 + 196] = mem[floor32(mem[_2223]) + _2223 + -(mem[_2223] % 32) + 228 len mem[_2223] % 32]
                                    require ext_code.size(address(_2175))
                                    call address(_2175).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args _1974, 0, address(this.address), 128, mem[_2223], mem[_2223 + 196 len floor32(mem[_2223]) + 32]
                        else:
                            require idx + 1 < mem[ceil32(arg1.length) + 128]
                            _2003 = mem[(32 * idx + 1) + ceil32(arg1.length) + 160]
                            if mem[(32 * idx) + _4 + 63 len 1] >= 2:
                                if mem[(32 * idx) + _4 + 63 len 1] != 2:
                                    _1955 = mem[ceil32(arg1.length) + 128]
                                    idx = idx + 1
                            ...
                            if Mask(1, 7, mem[(32 * idx) + _5 + 32]):
                                if mem[(32 * idx) + _4 + 63 len 1]:
                                    if mem[(32 * idx) + _4 + 63 len 1] != 1:
                                        ...
                                        continue 
                                    require idx < mem[ceil32(arg1.length) + 128]
                                    _2274 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                    mem[mem[64]] = 0x6d9a640a00000000000000000000000000000000000000000000000000000000
                                    mem[mem[64] + 4] = 0
                                    mem[mem[64] + 36] = _1974
                                    mem[mem[64] + 68] = address(_2003)
                                    require ext_code.size(address(_2274))
                                    call address(_2274).swap(uint256 arg1, uint256 arg2, address arg3) with:
                                         gas gas_remaining wei
                                        args 0, _1974, address(_2003)
                                else:
                                    require idx < mem[ceil32(arg1.length) + 128]
                                    _2213 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                    _2277 = mem[64]
                                    mem[64] = mem[64] + 32
                                    mem[_2277 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                                    mem[_2277 + 36] = 0
                                    mem[_2277 + 68] = _1974
                                    mem[_2277 + 100] = address(_2003)
                                    mem[_2277 + 132] = 128
                                    mem[_2277 + 164] = mem[_2277]
                                    s = 0
                                    while s < mem[_2277]:
                                        mem[_2277 + s + 196] = mem[_2277 + s + 32]
                                        _1955 = mem[ceil32(arg1.length) + 128]
                                        s = s + 32
                                        continue 
                                    if not mem[_2277] % 32:
                                        require ext_code.size(address(_2213))
                                        call address(_2213).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                             gas gas_remaining wei
                                            args 0, _1974, address(_2003), 128, mem[_2277 + 164 len mem[_2277] + 32]
                                    else:
                                        mem[floor32(mem[_2277]) + _2277 + 196] = mem[floor32(mem[_2277]) + _2277 + -(mem[_2277] % 32) + 228 len mem[_2277] % 32]
                                        require ext_code.size(address(_2213))
                                        call address(_2213).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                             gas gas_remaining wei
                                            args 0, _1974, address(_2003), 128, mem[_2277], mem[_2277 + 196 len floor32(mem[_2277]) + 32]
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                _1955 = mem[ceil32(arg1.length) + 128]
                                idx = idx + 1
                            ...
                            if mem[(32 * idx) + _4 + 63 len 1]:
                                if mem[(32 * idx) + _4 + 63 len 1] != 1:
                                    ...
                                    continue 
                                require idx < mem[ceil32(arg1.length) + 128]
                                _2278 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                mem[mem[64]] = 0x6d9a640a00000000000000000000000000000000000000000000000000000000
                                mem[mem[64] + 4] = _1974
                                mem[mem[64] + 36] = 0
                                mem[mem[64] + 68] = address(_2003)
                                require ext_code.size(address(_2278))
                                call address(_2278).swap(uint256 arg1, uint256 arg2, address arg3) with:
                                     gas gas_remaining wei
                                    args _1974, 0, address(_2003)
                            else:
                                require idx < mem[ceil32(arg1.length) + 128]
                                _2215 = mem[(32 * idx) + ceil32(arg1.length) + 160]
                                _2281 = mem[64]
                                mem[64] = mem[64] + 32
                                mem[_2281 + 32] = 0x22c0d9f00000000000000000000000000000000000000000000000000000000
                                mem[_2281 + 36] = _1974
                                mem[_2281 + 68] = 0
                                mem[_2281 + 100] = address(_2003)
                                mem[_2281 + 132] = 128
                                mem[_2281 + 164] = mem[_2281]
                                s = 0
                                while s < mem[_2281]:
                                    mem[_2281 + s + 196] = mem[_2281 + s + 32]
                                    _1955 = mem[ceil32(arg1.length) + 128]
                                    s = s + 32
                                    continue 
                                if not mem[_2281] % 32:
                                    require ext_code.size(address(_2215))
                                    call address(_2215).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args _1974, 0, address(_2003), 128, mem[_2281 + 164 len mem[_2281] + 32]
                                else:
                                    mem[floor32(mem[_2281]) + _2281 + 196] = mem[floor32(mem[_2281]) + _2281 + -(mem[_2281] % 32) + 228 len mem[_2281] % 32]
                                    require ext_code.size(address(_2215))
                                    call address(_2215).swap(uint256 arg1, uint256 arg2, address arg3, bytes arg4) with:
                                         gas gas_remaining wei
                                        args _1974, 0, address(_2003), 128, mem[_2281], mem[_2281 + 196 len floor32(mem[_2281]) + 32]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    _1955 = mem[ceil32(arg1.length) + 128]
                    idx = idx + 1
