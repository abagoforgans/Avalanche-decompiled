...
function TeamRemoveLiquidity(bool arg1) {
    ...
    call stor38.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args address(stor25.field_0), ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0] == bool(ext_call.return_data[0])
    call address(stor25.field_0).removeLiquidityAVAXSupportingFeeOnTransferTokens(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
         gas gas_remaining wei
...
function TeamCreateLPandAVAX() {
    ...
    if balanceOf[this.address] >= 5 * 10^14:
        if uint8(uint8(stor24.field_40) + uint8(stor24.field_32)):
            ...
            if not this.address:
                revert with 0, 'Approve from zero'
            if not address(stor25.field_0):
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][address(stor25.field_0)].field_0 = -(5 * 10^14 * uint8(stor24.field_32) / uint8(uint8(stor24.field_40) + uint8(stor24.field_32)) / 2) + 5 * 10^14
            emit Approval((-(5 * 10^14 * uint8(stor24.field_32) / uint8(uint8(stor24.field_40) + uint8(stor24.field_32)) / 2) + 5 * 10^14), this.address, address(stor25.field_0));
            mem[128] = this.address
            staticcall address(stor25.field_0).0x73b295c2 with:
                    gas gas_remaining wei
            ...
            while idx < 2:
                ...
                t = t + 32
                continue 
            require ext_code.size(address(stor25.field_0))
            call address(stor25.field_0).swapExactTokensForAVAXSupportingFeeOnTransferTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
                 gas gas_remaining wei
            ...
            if not -(5 * 10^14 * uint8(stor24.field_32) / uint8(uint8(stor24.field_40) + uint8(stor24.field_32)) / 2) + 5 * 10^14:
                revert with 0, 18
            if totalLPAVAX > !(0 / -(5 * 10^14 * uint8(stor24.field_32) / uint8(uint8(stor24.field_40) + uint8(stor24.field_32)) / 2) + 5 * 10^14):
                revert with 0, 17
            totalLPAVAX += 0 / -(5 * 10^14 * uint8(stor24.field_32) / uint8(uint8(stor24.field_40) + uint8(stor24.field_32)) / 2) + 5 * 10^14
            if not this.address:
                revert with 0, 'Approve from zero'
            if not address(stor25.field_0):
                revert with 0, 'Approve to zero'
            allowance[address(this.address)][address(stor25.field_0)].field_0 = 5 * 10^14 * uint8(stor24.field_32) / uint8(uint8(stor24.field_40) + uint8(stor24.field_32)) / 2
            allowance[address(this.address)][address(stor25.field_0)].field_255 = 0
            emit Approval((5 * 10^14 * uint8(stor24.field_32) / uint8(uint8(stor24.field_40) + uint8(stor24.field_32)) / 2), this.address, address(stor25.field_0));
            call address(stor25.field_0).addLiquidityAVAX(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6) with:
...
function Rewards() {
    require not uint8(stor25.field_160)
    ...
    if stor12[address(msg.sender)]:
        ...
        if -stor32[address(msg.sender)]:
            ...
            mem[160] = 0x19860ccb0a68fd4213ab9d8266f7bbf05a8dde98
            ...
            while idx < 2:
                ...
                continue 
            require ext_code.size(address(stor25.field_0))
            call address(stor25.field_0).swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
               value stor32[address(msg.sender)] wei
                 gas gas_remaining wei
                args 0, 128, msg.sender, block.timestamp, 2, mem[ceil32(return_data.size) + 356 len 64]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            emit OnWithdrawAVAX(stor32[address(msg.sender)], msg.sender);
    else:
        if profitPerShare and balanceOf[address(msg.sender)] > -1 / profitPerShare:
            revert with 0, 17
        if profitPerShare * balanceOf[address(msg.sender)] < stor31[address(msg.sender)]:
            if profitPerShare and balanceOf[address(msg.sender)] > -1 / profitPerShare:
                revert with 0, 17
            stor31[address(msg.sender)] = profitPerShare * balanceOf[address(msg.sender)]
            ...
            if profitPerShare and balanceOf[address(msg.sender)] > -1 / profitPerShare:
                revert with 0, 17
            stor31[address(msg.sender)] = profitPerShare * balanceOf[address(msg.sender)]
            if stor32[address(msg.sender)] > !(Mask(192, 64, (profitPerShare * balanceOf[address(msg.sender)]) - stor31[address(msg.sender)]) >> 64):
                revert with 0, 17
            stor32[address(msg.sender)] = 0
            if -stor32[address(msg.sender)] - (Mask(192, 64, (profitPerShare * balanceOf[address(msg.sender)]) - stor31[address(msg.sender)]) >> 64):
                if totalPayouts > !(stor32[address(msg.sender)] + (Mask(192, 64, (profitPerShare * balanceOf[address(msg.sender)]) - stor31[address(msg.sender)]) >> 64)):
                    revert with 0, 17
                totalPayouts = totalPayouts + stor32[address(msg.sender)] + (Mask(192, 64, (profitPerShare * balanceOf[address(msg.sender)]) - stor31[address(msg.sender)]) >> 64)
                staticcall address(stor25.field_0).0x73b295c2 with:
                        gas gas_remaining wei
                mem[192] = ext_call.return_data[0]
                if not ext_call.success:
                ...
                require ext_code.size(address(stor25.field_0))
                call address(stor25.field_0).swapExactAVAXForTokensSupportingFeeOnTransferTokens(uint256 arg1, address[] arg2, address arg3, uint256 arg4) with:
                   value stor32[address(msg.sender)] + (Mask(192, 64, (profitPerShare * balanceOf[address(msg.sender)]) - stor31[address(msg.sender)]) >> 64) wei
                     gas gas_remaining wei
                    args 0, 128, msg.sender, block.timestamp, 2, mem[ceil32(return_data.size) + 356 len 64]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                emit OnWithdrawAVAX(stor32[address(msg.sender)] + (Mask(192, 64, (profitPerShare * balanceOf[address(msg.sender)]) - stor31[address(msg.sender)]) >> 64), msg.sender);
    uint8(stor25.field_160) = 0
}
