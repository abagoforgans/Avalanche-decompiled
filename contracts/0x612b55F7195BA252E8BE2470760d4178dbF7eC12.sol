...
function sub_509f2a42(?) payable {
    ...
    call 0xd036414fa2bcbb802691491e323bff1348c5f4ba.0x23b872dd with:
        ...
        args msg.sender, 0x79aee3e23b525997fd582d0987717ac9cbd610a7, 24000
...
function sub_3a08e6a3(?) payable {
    require ext_code.size(0xd036414fa2bcbb802691491e323bff1348c5f4ba)
    staticcall 0xd036414fa2bcbb802691491e323bff1348c5f4ba.0x70a08231 with:
            gas gas_remaining wei
           args msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(0xd036414fa2bcbb802691491e323bff1348c5f4ba)
    call 0xd036414fa2bcbb802691491e323bff1348c5f4ba.approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
