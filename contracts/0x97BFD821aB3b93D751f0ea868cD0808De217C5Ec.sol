...
address sub_6927810dAddress;
uint8 stor216; offset 160
...
function dividendManagerAddress() payable {
    return dividendManagerAddress
}
...
function sub_6927810d(?) payable {
    return sub_6927810dAddress
}
...
function setSellTax(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sellTax = arg1
...
function sub_b9ee0164(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_6927810dAddress = address(arg1)
}

function sub_3649c135(?) payable {
    require calldata.size - 4 >= 32
    require arg1 == address(arg1)
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    dividendManagerAddress = address(arg1)
}
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if stor205[address(msg.sender)]:
        if sub_40c397daAddress != arg1:
            ...
            emit Transfer(arg2, msg.sender, arg1);
            return 1
        if not stor207[address(msg.sender)]:
            stor216 = 1
            # nil
        else:
            if not msg.sender:
