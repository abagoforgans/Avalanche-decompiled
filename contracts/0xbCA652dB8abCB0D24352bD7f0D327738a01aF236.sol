...
function sub_8572f6a9(?) {
    ...
    mem[ceil32(return_data.size) + 196] = 10^17
    ...
    staticcall sub_8a14c2fdAddress.getAmountsOut(uint256 arg1, address[] arg2) with:
            gas gas_remaining wei
           args 10^17, 64, 2, mem[ceil32(return_data.size) + 292 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[ceil32(return_data.size) + 192 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = (2 * ceil32(return_data.size)) + 192
    require return_data.size >= 32
    _24 = mem[ceil32(return_data.size) + 192 len 4], 23283064
    require mem[ceil32(return_data.size) + 192 len 4], 23283064 <= test266151307()
    require ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 223 < ceil32(return_data.size) + return_data.size + 192
    _25 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]
    if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192] > test266151307():
        revert with 0, 65
    if (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]) + 193 > test266151307() or ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]) + 1 < 0:
        revert with 0, 65
    mem[64] = (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]) + 193
    mem[(2 * ceil32(return_data.size)) + 192] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]
...
function sub_cd8ee10e(?) {
    ...
    require ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 223 < ceil32(return_data.size) + return_data.size + 192
    ...
    if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 192] > test266151307():
        revert with 0, 65
    if (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 192]) + 193 > test266151307() or ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 192]) + 1 < 0:
        revert with 0, 65
    ...
    mem[(2 * ceil32(return_data.size)) + 192] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 192]
    require return_data.size >= _24 + (32 * _25) + 32
    mem[(2 * ceil32(return_data.size)) + 224 len 32 * _25] = mem[ceil32(return_data.size) + _24 + 224 len 32 * _25]
    if 1 >= _25:
        revert with 0, 50
...
function buyNode(uint256 arg1) payable {
    ...
    if mem[_123 + (2 * ceil32(return_data.size)) + 160] and arg1 > -1 / mem[_123 + (2 * ceil32(return_data.size)) + 160]:
        revert with 0, 17
    if msg.value > !(mem[_123 + (2 * ceil32(return_data.size)) + 160] * arg1 / 5):
        revert with 0, 17
    if msg.value + (mem[_123 + (2 * ceil32(return_data.size)) + 160] * arg1 / 5) < mem[_123 + (2 * ceil32(return_data.size)) + 160] * arg1:
...
function sub_717aa7d8(?) payable {
    ...
    idx = 0
    s = 0
    while idx < stor11[address(msg.sender)].field_0:
        mem[0] = sha3(address(msg.sender), 11)
        if stor11[address(msg.sender)][idx].field_0 > block.timestamp:
            if idx == -1:
                revert with 0, 17
            idx = idx + 1
            s = s
            continue 
        if idx >= stor11[address(msg.sender)].field_0:
            revert with 0, 50
        mem[0] = sha3(address(msg.sender), 11)
        if block.timestamp > stor11[address(msg.sender)][idx].field_256:
            if idx == -1:
                revert with 0, 17
            idx = idx + 1
            s = s
        ...
        s = s + 1
        continue 
    if stor12[address(msg.sender)].field_0 == 11:
        if s < 100:
            revert with 0, 17
        if arg1 > 1:
            revert with 0, 33
        if stor12[address(msg.sender)].field_0 == 11:
            ...
            require mem[ceil32(return_data.size) + 192 len 4], 23283064 <= test266151307()
            require ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 223 < ceil32(return_data.size) + return_data.size + 192
            _275 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]
            if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192] > test266151307():
                revert with 0, 65
            if (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]) + 193 > test266151307() or ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]) + 1 < 0:
                revert with 0, 65
            mem[64] = (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]) + 193
            require return_data.size >= mem[ceil32(return_data.size) + 192 len 4], 23283064 + (32 * _275) + 32
            mem[(2 * ceil32(return_data.size)) + 224 len 32 * _275] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 224 len 32 * _275]
            if 1 >= _275:
                revert with 0, 50
        else:
            if arg1 == 1:
                ...
                require mem[ceil32(return_data.size) + 192 len 4], 232830643 <= test266151307()
                require ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 223 < ceil32(return_data.size) + return_data.size + 192
                _277 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 192]
                if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 192] > test266151307():
                    revert with 0, 65
                if (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 192]) + 193 > test266151307() or ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 192]) + 1 < 0:
                    revert with 0, 65
                mem[64] = (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 192]) + 193
                require return_data.size >= mem[ceil32(return_data.size) + 192 len 4], 232830643 + (32 * _277) + 32
                mem[(2 * ceil32(return_data.size)) + 224 len 32 * _277] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 224 len 32 * _277]
                if 1 >= _277:
                    revert with 0, 50
            else:
                if s < 100:
                ...
                require mem[ceil32(return_data.size) + 192 len 4], 23283064 <= test266151307()
                require ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 223 < ceil32(return_data.size) + return_data.size + 192
                _276 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]
                if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192] > test266151307():
                    revert with 0, 65
                if (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]) + 193 > test266151307() or ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]) + 1 < 0:
                    revert with 0, 65
                mem[64] = (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]) + 193
                require return_data.size >= mem[ceil32(return_data.size) + 192 len 4], 23283064 + (32 * _276) + 32
                mem[(2 * ceil32(return_data.size)) + 224 len 32 * _276] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 224 len 32 * _276]
                if 1 >= _276:
                    revert with 0, 50
    else:
        if stor12[address(msg.sender)].field_0 and 10 > -1 / stor12[address(msg.sender)].field_0:
            revert with 0, 17
        if s < 10 * stor12[address(msg.sender)].field_0:
            revert with 0, 17
        if arg1 > 1:
            revert with 0, 33
        if stor12[address(msg.sender)].field_0 == 11:
            ...
            if s < 10 * stor12[address(msg.sender)].field_0:
                revert with 0, 'no need so many master'
            if s - (10 * stor12[address(msg.sender)].field_0) / 10 < arg2:
                revert with 0, 'no need so many master nft'
            if stor12[address(msg.sender)].field_0 > !arg2:
                revert with 0, 17
            if stor12[address(msg.sender)].field_0 + arg2 > 10:
                revert with 0, 'no need more than 10 master nft'
            mem[96] = 2
            mem[128] = _tokenContractAddress
            require ext_code.size(sub_8a14c2fdAddress)
            ...
            require mem[ceil32(return_data.size) + 192 len 4], 23283064 <= test266151307()
            require ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 223 < ceil32(return_data.size) + return_data.size + 192
            _278 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]
            if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192] > test266151307():
                revert with 0, 65
            if (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]) + 193 > test266151307() or ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]) + 1 < 0:
                revert with 0, 65
            mem[64] = (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]) + 193
            require return_data.size >= mem[ceil32(return_data.size) + 192 len 4], 23283064 + (32 * _278) + 32
            mem[(2 * ceil32(return_data.size)) + 224 len 32 * _278] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 224 len 32 * _278]
            if 1 >= _278:
                revert with 0, 50
        else:
            if arg1 == 1:
                if arg2 != 1:
                    revert with 0, 'buy only 1 grand nft'
                if stor12[address(msg.sender)].field_0 != 10:
                ...
                require mem[ceil32(return_data.size) + 192 len 4], 232830643 <= test266151307()
                require ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 223 < ceil32(return_data.size) + return_data.size + 192
                _280 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 192]
                if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 192] > test266151307():
                    revert with 0, 65
                if (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 192]) + 193 > test266151307() or ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 192]) + 1 < 0:
                    revert with 0, 65
                mem[64] = (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 192]) + 193
                require return_data.size >= mem[ceil32(return_data.size) + 192 len 4], 232830643 + (32 * _280) + 32
                mem[(2 * ceil32(return_data.size)) + 224 len 32 * _280] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 232830643 + 224 len 32 * _280]
                if 1 >= _280:
                    revert with 0, 50
            else:
                if stor12[address(msg.sender)].field_0 and 10 > -1 / stor12[address(msg.sender)].field_0:
                ...
                require mem[ceil32(return_data.size) + 192 len 4], 23283064 <= test266151307()
                require ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 223 < ceil32(return_data.size) + return_data.size + 192
                _279 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]
                if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192] > test266151307():
                    revert with 0, 65
                if (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]) + 193 > test266151307() or ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]) + 1 < 0:
                    revert with 0, 65
                mem[64] = (2 * ceil32(return_data.size)) + ceil32(32 * mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 192]) + 193
                require return_data.size >= mem[ceil32(return_data.size) + 192 len 4], 23283064 + (32 * _279) + 32
                mem[(2 * ceil32(return_data.size)) + 224 len 32 * _279] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 192 len 4], 23283064 + 224 len 32 * _279]
                if 1 >= _279:
                    revert with 0, 50
    if mem[(2 * ceil32(return_data.size)) + 256] and arg2 > -1 / mem[(2 * ceil32(return_data.size)) + 256]:
        revert with 0, 17
    if msg.value > !(mem[(2 * ceil32(return_data.size)) + 256] * arg2 / 5):
        revert with 0, 17
    if msg.value + (mem[(2 * ceil32(return_data.size)) + 256] * arg2 / 5) < mem[(2 * ceil32(return_data.size)) + 256] * arg2:
