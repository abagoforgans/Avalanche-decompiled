...
function harvest() payable {
    ...
    call 0x58e57ca18b7a47112b877e31929798cd3d703b0f.add_liquidity(uint256[2] rg1, uint256 rg2) with:
         gas gas_remaining wei
...
function setGauge(address arg1) payable {
    ...
    if not return_data.size:
        ...
        if ext_code.size(0x1dab6560494b04473a0be3e7d83cf3fdf3a51828) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[424 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor1), uint32(stor1), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        call 0x1dab6560494b04473a0be3e7d83cf3fdf3a51828 with:
           funct uint32(stor1)
             gas gas_remaining wei
        ...
        if ext_code.size(0x1dab6560494b04473a0be3e7d83cf3fdf3a51828) <= 0:
            revert with 0, 'Address: call to non-contract'
        mem[ceil32(return_data.size) + 425 len 64] = approve(address rg1, uint256 rg2), Mask(224, 0, stor1), uint32(stor1), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffff
