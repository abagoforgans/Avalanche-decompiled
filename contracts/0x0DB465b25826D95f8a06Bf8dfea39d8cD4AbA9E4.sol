    ...
    if calldata.size < 4:
        ...
        if unknown_0x7b770392(?????) > uint32(call.func_hash) >> 224:
            if unknown_0x48b75044(?????) > uint32(call.func_hash) >> 224:
                ...
                _490 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 128]
                ...
                require _447 + _490 + 32 <= return_data.size
                mem[(2 * ceil32(return_data.size)) + 160 len ceil32(_490)] = mem[ceil32(return_data.size) + _447 + 160 len ceil32(_490)]
                if ceil32(_490) > _490:
                    mem[_490 + (2 * ceil32(return_data.size)) + 160] = 0
                mem[mem[64]] = 32
                mem[mem[64] + 32] = _490
                mem[mem[64] + 64 len ceil32(_490)] = mem[(2 * ceil32(return_data.size)) + 160 len ceil32(_490)]
                if ceil32(_490) > _490:
                    mem[_490 + mem[64] + 64] = 0
                return Array(len=_490, data=mem[mem[64] + 64 len ceil32(_490)])
            if unknown_0x65b8dbc0(?????) <= uint32(call.func_hash) >> 224:
                if unknown_0x6d9ae0be(?????) <= uint32(call.func_hash) >> 224:
                    ...
                    if unknown_0x65b8dbc0(?????) == uint32(call.func_hash) >> 224:
                        ...
                        if uint32(call.func_hash) >> 224 != unknown_0x65bfe430(?????):
                            ...
                            mem[64] = (2 * ceil32(return_data.size)) + 128
                            require return_data.size >= 32
                            _498 = mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32
                            require mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 <= test266151307()
                            require ceil32(return_data.size) + return_data.size + 128 > ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 159
                            _545 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 128]
                            if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 128] > test266151307():
                                revert with 0, 65
                            if ceil32(ceil32(mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 128])) + 1 < 0 or (2 * ceil32(return_data.size)) + ceil32(ceil32(mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 128])) + 129 > test266151307():
                                revert with 0, 65
                            mem[64] = (2 * ceil32(return_data.size)) + ceil32(ceil32(mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 128])) + 129
                            mem[(2 * ceil32(return_data.size)) + 128] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 128]
                            require _498 + _545 + 32 <= return_data.size
                            mem[(2 * ceil32(return_data.size)) + 160 len ceil32(_545)] = mem[ceil32(return_data.size) + _498 + 160 len ceil32(_545)]
                            if ceil32(_545) <= _545:
                                _1685 = mem[64]
                                mem[mem[64]] = 32
                                mem[mem[64] + 32] = _545
                                mem[mem[64] + 64 len ceil32(_545)] = mem[(2 * ceil32(return_data.size)) + 160 len ceil32(_545)]
                                if ceil32(_545) <= _545:
                                    return Array(len=_545, data=mem[mem[64] + 64 len ceil32(_545)])
                                mem[_545 + mem[64] + 64] = 0
                                return memory
                                  from mem[64]
                                   len ceil32(_545) + _1685 + -mem[64] + 64
                            mem[_545 + (2 * ceil32(return_data.size)) + 160] = 0
                            _1686 = mem[64]
                            mem[mem[64]] = 32
                            mem[mem[64] + 32] = _545
                            mem[mem[64] + 64 len ceil32(_545)] = mem[(2 * ceil32(return_data.size)) + 160 len ceil32(_545)]
                            ...
                            return memory
                              from mem[64]
                               len ceil32(_545) + _1686 + -mem[64] + 64
                        require not msg.value
                        require calldata.size - 4 >= 32
                        if not msg.sender:
                ...
                if unknown_0x54f12f1f(?????) <= uint32(call.func_hash) >> 224:
                    ...
                    require mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 <= test266151307()
                    require ceil32(return_data.size) + return_data.size + 128 > ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 159
                    _522 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 128]
                    if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 128] > test266151307():
                        revert with 0, 65
                    if ceil32(ceil32(mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 128])) + 1 < 0 or (2 * ceil32(return_data.size)) + ceil32(ceil32(mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 128])) + 129 > test266151307():
                        revert with 0, 65
                    mem[64] = (2 * ceil32(return_data.size)) + ceil32(ceil32(mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 128])) + 129
                    mem[(2 * ceil32(return_data.size)) + 128] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 128]
                    require _472 + _522 + 32 <= return_data.size
                    mem[(2 * ceil32(return_data.size)) + 160 len ceil32(_522)] = mem[ceil32(return_data.size) + _472 + 160 len ceil32(_522)]
                    if ceil32(_522) <= _522:
                        _1679 = mem[64]
                        mem[mem[64]] = 32
                        mem[mem[64] + 32] = _522
                        mem[mem[64] + 64 len ceil32(_522)] = mem[(2 * ceil32(return_data.size)) + 160 len ceil32(_522)]
                        if ceil32(_522) <= _522:
                            return Array(len=_522, data=mem[mem[64] + 64 len ceil32(_522)])
                        mem[_522 + mem[64] + 64] = 0
                        return memory
                          from mem[64]
                           len ceil32(_522) + _1679 + -mem[64] + 64
                    mem[_522 + (2 * ceil32(return_data.size)) + 160] = 0
                    _1680 = mem[64]
                    mem[mem[64]] = 32
                    mem[mem[64] + 32] = _522
                    mem[mem[64] + 64 len ceil32(_522)] = mem[(2 * ceil32(return_data.size)) + 160 len ceil32(_522)]
                    ...
                    return memory
                      from mem[64]
                       len ceil32(_522) + _1680 + -mem[64] + 64
                if unknown_0x48b75044(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    require calldata.size - 4 >= 64
                    require arg1 == address(arg1)
            ...
            if unknown_0xab574761(?????) <= uint32(call.func_hash) >> 224:
                if unknown_0xdb3ad6b5(?????) <= uint32(call.func_hash) >> 224:
                    ...
                    mem[64] = (2 * ceil32(return_data.size)) + ceil32(ceil32(mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 128])) + 129
                    mem[(2 * ceil32(return_data.size)) + 128] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 128]
                    require _484 + _535 + 32 <= return_data.size
                    mem[(2 * ceil32(return_data.size)) + 160 len ceil32(_535)] = mem[ceil32(return_data.size) + _484 + 160 len ceil32(_535)]
                    if ceil32(_535) > _535:
                ...
                mem[64] = (2 * ceil32(return_data.size)) + ceil32(ceil32(mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 128])) + 129
                mem[(2 * ceil32(return_data.size)) + 128] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 128 len 4], Mask(224, 32, msg.sender) >> 32 + 128]
                require _483 + _534 + 32 <= return_data.size
                mem[(2 * ceil32(return_data.size)) + 160 len ceil32(_534)] = mem[ceil32(return_data.size) + _483 + 160 len ceil32(_534)]
                if ceil32(_534) <= _534:
                    _1731 = mem[64]
                    mem[mem[64]] = 32
                    mem[mem[64] + 32] = _534
                    ...
                    return memory
                      from mem[64]
                       len ceil32(_534) + _1731 + -mem[64] + 64
                ...
                return memory
                  from mem[64]
                   len ceil32(_534) + _1732 + -mem[64] + 64
