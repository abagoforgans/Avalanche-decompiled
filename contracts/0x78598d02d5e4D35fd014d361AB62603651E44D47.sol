...
const COMMUNITY_FUND_POOL_ALLOCATION = (25 * 10^17 * 3600)

const VESTING_DURATION = (2 * 3600 * 24 * 3600)

const DEV_FUND_POOL_ALLOCATION = (25 * 10^17 * 3600)

const FARMING_POOL_REWARD_ALLOCATION = (35 * 10^18 * 3600)
...
function distributeReward(address arg1) payable {
    ...
    stor15 = 1
    if totalSupply + (35 * 10^18 * 3600) < totalSupply:
        revert with 0, 'SafeMath: addition overflow'
    totalSupply += 35 * 10^18 * 3600
    if balanceOf[address(arg1)] + (35 * 10^18 * 3600) < balanceOf[address(arg1)]:
        revert with 0, 'SafeMath: addition overflow'
    balanceOf[address(arg1)] += 35 * 10^18 * 3600
    emit Transfer((35 * 10^18 * 3600), 0, arg1);
}
