...
function panic() payable {
    ...
    if not return_data.size:
        if not ext_code.size(lpToken0Address):
            revert with 0, 'Address: call to non-contract'
        mem[(2 * ceil32(return_data.size)) + 590 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor2), uint32(stor2), 0
        mem[(2 * ceil32(return_data.size)) + 654 len 0] = 0
        call lpToken0Address with:
           funct uint32(stor2)
             gas gas_remaining wei
            args Mask(480, -256, approve(address arg1, uint256 arg2), Mask(224, 0, stor2), uint32(stor2), 0) << 256, mem[(2 * ceil32(return_data.size)) + 654 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address arg1, uint256 arg2), Mask(224, 0, stor15), uint32(stor15), 0
            if not approve(address arg1, uint256 arg2), Mask(224, 0, stor15):
