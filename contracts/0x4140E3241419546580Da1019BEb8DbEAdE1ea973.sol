...
function _fallback() payable {
    if calldata.size < 4:
        ...
        if unknown_0x654a79c1(?????) > uint32(call.func_hash) >> 224:
            ...
            if uint32(call.func_hash) >> 224 != unknown_0x1ec8c9e3(?????):
                require unknown_0x4f1646cd(?????) == uint32(call.func_hash) >> 224
                require not msg.value
            ...
            if unknown_0x654a79c1(?????) == uint32(call.func_hash) >> 224:
                ...
                if uint32(call.func_hash) >> 224 != unknown_0x869991b8(?????):
