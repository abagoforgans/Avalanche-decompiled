...
function sub_c674267e(?) payable {
    ...
    if not arg1:
        ...
        if arg1 == 1:
            mem[ceil32(ceil32(arg2.length)) + 97 len ceil32(arg2.length)] = arg2[all], mem[arg2.length + 128 len ceil32(arg2.length) - arg2.length]
            mem[ceil32(ceil32(arg2.length)) + arg2.length + 97] = 1
        else:
            if arg1 != 2:
                return 0
            mem[ceil32(ceil32(arg2.length)) + 97 len ceil32(arg2.length)] = arg2[all], mem[arg2.length + 128 len ceil32(arg2.length) - arg2.length]
            mem[ceil32(ceil32(arg2.length)) + arg2.length + 97] = 2
...
function sub_cf66260d(?) payable {
    ...
    if arg1 == 1:
        ...
        if block.timestamp - ext_call.return_data[0] and ext_call.return_data[0] > -1 / block.timestamp - ext_call.return_data[0]:
            revert with 'NH{q', 17
        if (block.timestamp * ext_call.return_data[0]) - (ext_call.return_data[0] * ext_call.return_data[0]) and 4 * 10^15 > -1 / (block.timestamp * ext_call.return_data[0]) - (ext_call.return_data[0] * ext_call.return_data[0]):
            revert with 'NH{q', 17
        if ext_call.return_data[0] > (-4 * 10^15 * block.timestamp * ext_call.return_data[0]) + (4 * 10^15 * ext_call.return_data[0] * ext_call.return_data[0]) - 1:
            revert with 'NH{q', 17
        return (ext_call.return_data[0] + (4 * 10^15 * block.timestamp * ext_call.return_data[0]) - (4 * 10^15 * ext_call.return_data[0] * ext_call.return_data[0]))
    if arg1 != 2:
        return 0
    require ext_code.size(0xc3b29321611736341609022c23e981ac56e7f96)
    staticcall 0xc3b29321611736341609022c23e981ac56e7f96.0x4994abe1 with:
    ...
    if block.timestamp - ext_call.return_data[0] and ext_call.return_data[0] > -1 / block.timestamp - ext_call.return_data[0]:
        revert with 'NH{q', 17
    if (block.timestamp * ext_call.return_data[0]) - (ext_call.return_data[0] * ext_call.return_data[0]) and 2 * 10^14 > -1 / (block.timestamp * ext_call.return_data[0]) - (ext_call.return_data[0] * ext_call.return_data[0]):
        revert with 'NH{q', 17
    if ext_call.return_data[0] > (-2 * 10^14 * block.timestamp * ext_call.return_data[0]) + (2 * 10^14 * ext_call.return_data[0] * ext_call.return_data[0]) - 1:
        revert with 'NH{q', 17
    return (ext_call.return_data[0] + (2 * 10^14 * block.timestamp * ext_call.return_data[0]) - (2 * 10^14 * ext_call.return_data[0] * ext_call.return_data[0]))
}
