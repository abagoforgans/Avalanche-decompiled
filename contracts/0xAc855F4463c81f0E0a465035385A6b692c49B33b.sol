...
const sub_5fd866df(?) = 0xe47fd6583b4a7d3db1e0f0a5c0ccb5a2bdfa7f53
...
function sub_b3ffb22f(?) payable {
    require ext_code.size(0xe47fd6583b4a7d3db1e0f0a5c0ccb5a2bdfa7f53)
    staticcall 0xe47fd6583b4a7d3db1e0f0a5c0ccb5a2bdfa7f53.0x72f702f3 with:
    ...
    require return_data.size >= 32
    require ext_code.size(0xe47fd6583b4a7d3db1e0f0a5c0ccb5a2bdfa7f53)
    staticcall 0xe47fd6583b4a7d3db1e0f0a5c0ccb5a2bdfa7f53.0x18160ddd with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(sha3(0, 17269419903419772280, sha3(6431504414704282352, 0x78ea17559b3d2cf85a7f9c2c704eda119db5e6de), 0x40231f6b438bce0797c9ada29b718a87ea0a5cea3fe9a771abdd76bd41a3e545)))
    staticcall address(sha3(0, 17269419903419772280, sha3(6431504414704282352, 0x78ea17559b3d2cf85a7f9c2c704eda119db5e6de), 0x40231f6b438bce0797c9ada29b718a87ea0a5cea3fe9a771abdd76bd41a3e545)).getReserves() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
