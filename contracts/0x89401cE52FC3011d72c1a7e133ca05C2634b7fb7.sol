...
function random(uint256 arg1, uint256 arg2, address arg3) {
    ...
    if arg1 <= arg2 - 5000:
        ...
        if block.timestamp + block.difficulty + (sha3(block.coinbase) / block.timestamp + 2) + block.gas_limit + (sha3(stor2) / block.timestamp) > -block.number - 1:
            revert with 'NH{q', 17
        if block.timestamp + block.difficulty + (sha3(block.coinbase) / block.timestamp + 2) + block.gas_limit + (sha3(stor2) / block.timestamp) + block.number > -arg2 - 1:
            revert with 'NH{q', 17
        if block.timestamp + block.difficulty + (sha3(block.coinbase) / block.timestamp + 2) + block.gas_limit + (sha3(stor2) / block.timestamp) + block.number + arg2 < 1:
            revert with 'NH{q', 17
        return (sha3(block.timestamp + block.difficulty + (sha3(block.coinbase) / block.timestamp + 2) + block.gas_limit + (sha3(stor2) / block.timestamp) + block.number + arg2 - 1) % test266151307())
    if arg2 > -5001:
        revert with 'NH{q', 17
    if not block.timestamp:
        revert with 'NH{q', 18
    ...
    if block.timestamp + block.difficulty + (sha3(block.coinbase) / block.timestamp + 2) + block.gas_limit + (sha3(stor2) / block.timestamp) + block.number > -arg1 - 1:
        revert with 'NH{q', 17
    if block.timestamp + block.difficulty + (sha3(block.coinbase) / block.timestamp + 2) + block.gas_limit + (sha3(stor2) / block.timestamp) + block.number + arg1 > -eth.balance(arg3) - 1:
        revert with 'NH{q', 17
    if block.timestamp + block.difficulty + (sha3(block.coinbase) / block.timestamp + 2) + block.gas_limit + (sha3(stor2) / block.timestamp) + block.number + arg1 + eth.balance(arg3) < 1:
        revert with 'NH{q', 17
    return (sha3(block.timestamp + block.difficulty + (sha3(block.coinbase) / block.timestamp + 2) + block.gas_limit + (sha3(stor2) / block.timestamp) + block.number + arg1 + eth.balance(arg3) - 1) % test266151307())
}
    ...
    if arg3 <= -5000:
        ...
        if arg3 <= -5000:
            ...
            if ext_call.return_data[0] <= 10000:
                ...
                if sha3(block.timestamp + block.difficulty + (sha3(block.coinbase) / block.timestamp + 2) + block.gas_limit + (sha3(stor2) / block.timestamp) + block.number + ext_call.return_data[0] - 1) % test266151307() % 100 >= 90:
                    return 0
        else:
            ...
            if arg3 >= 5000:
                ...
                if ext_call.return_data[0] <= 10000:
                    ...
                    if sha3(block.timestamp + block.difficulty + (sha3(block.coinbase) / block.timestamp + 2) + block.gas_limit + (sha3(stor2) / block.timestamp) + block.number + arg3 + ext_call.return_data[0] + eth.balance(arg4) - 1) % test266151307() % 100 >= 90:
                        return 0
