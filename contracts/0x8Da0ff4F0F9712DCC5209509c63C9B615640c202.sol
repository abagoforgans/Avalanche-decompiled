...
function sub_13c9c43e(?) {
    return bool(uint8(stor19.field_160))
}
...
function sub_47ffd897(?) {
    ...
    if sub_60b663bb.length <= 0:
        ...
        mem[192] = owner
        mem[224] = bool(uint8(stor19.field_160))
        mem[256] = bool(sub_9442f71e)
        mem[288 len 15201] = code.data[7871 len 15201]
        idx = 0
        s = 96
        t = 15649
        while idx < 4:
        ...
        create contract with 0 wei
                        code: code.data[7871 len 15201], sub_acab85ae, sub_eead113b, arg1, sub_2716a509, sub_af6bf70c, mem[15649 len 128], 704, mem[15809 len 352], sub_16520ded, sub_1f5cb64b.length, mem[16225 len 32 * sub_1f5cb64b.length]
    else:
        if sub_60b663bb.length < 1:
            revert with 0, 17
        if sub_60b663bb.length - 1 >= sub_60b663bb.length:
        ...
        mem[ceil32(return_data.size) + 224] = bool(uint8(stor19.field_160))
        mem[ceil32(return_data.size) + 256] = bool(sub_9442f71e)
        mem[ceil32(return_data.size) + 288 len 15201] = code.data[7871 len 15201]
        idx = 0
        ...
        while idx < 2:
            ...
            continue 
        create contract with 0 wei
                        code: code.data[7871 len 15201], sub_acab85ae, sub_eead113b, arg1, sub_2716a509, sub_af6bf70c, mem[ceil32(return_data.size) + 15649 len 128], 704, mem[ceil32(return_data.size) + 15809 len 352], sub_16520ded, sub_1f5cb64b.length, mem[ceil32(return_data.size) + 16225 len 32 * sub_1f5cb64b.length]
...
function _fallback() payable {
    ...
    if sub_60b663bb.length <= 0:
        ...
        mem[224] = owner
        mem[256] = bool(uint8(stor19.field_160))
        mem[288] = bool(sub_9442f71e)
        mem[320 len 15201] = code.data[7871 len 15201]
        idx = 0
        s = 128
        t = 15681
        while idx < 4:
        ...
        while idx < 2:
            ...
            continue 
        create contract with 0 wei
                        code: code.data[7871 len 15201], sub_acab85ae, sub_eead113b, cd[4], sub_2716a509, sub_af6bf70c, mem[15681 len 128], 704, mem[15841 len 352], sub_16520ded, sub_1f5cb64b.length, mem[16257 len 32 * sub_1f5cb64b.length]
    else:
        if sub_60b663bb.length < 1:
            revert with 0, 17
        if sub_60b663bb.length - 1 >= sub_60b663bb.length:
        ...
        mem[ceil32(return_data.size) + 224] = owner
        mem[ceil32(return_data.size) + 256] = bool(uint8(stor19.field_160))
        mem[ceil32(return_data.size) + 288] = bool(sub_9442f71e)
        mem[ceil32(return_data.size) + 320 len 15201] = code.data[7871 len 15201]
        idx = 0
        ...
        while idx < 2:
            ...
            continue 
        create contract with 0 wei
                        code: code.data[7871 len 15201], sub_acab85ae, sub_eead113b, cd[4], sub_2716a509, sub_af6bf70c, mem[ceil32(return_data.size) + 15681 len 128], 704, mem[ceil32(return_data.size) + 15841 len 352], sub_16520ded, sub_1f5cb64b.length, mem[ceil32(return_data.size) + 16257 len 32 * sub_1f5cb64b.length]
    if not create.new_address:
        revert with ext_call.return_data[0 len return_data.size]
    sub_60b663bb.length++
    sub_60b663bb[sub_60b663bb.length] = address(create.new_address)
