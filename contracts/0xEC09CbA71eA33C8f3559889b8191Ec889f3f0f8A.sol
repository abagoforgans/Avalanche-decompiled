...
function getSuppliedView() {
    require ext_code.size(0xfe00000000000000000000000035bd6aeda81a7e5fc7a7832490e71f757b0cd9)
    staticcall 0xfe00000000000000000000000035bd6aeda81a7e5fc7a7832490e71f757b0cd9.getAccountSnapshot(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function balanceOfPool() {
    ...
    require return_data.size >= 128
    require ext_code.size(0xfe00000000000000000000000035bd6aeda81a7e5fc7a7832490e71f757b0cd9)
    staticcall 0xfe00000000000000000000000035bd6aeda81a7e5fc7a7832490e71f757b0cd9.borrowBalanceStored(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function deposit() {
    ...
    if ext_call.return_data[0]:
        if not ext_code.size(wantAddress):
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = approve(address rg1, uint256 rg2), 64967568184676235568719747, 0, 0
        mem[324 len 0] = 0
        call wantAddress.0x757b0cd9 with:
             gas gas_remaining wei
            args Mask(480, -256, approve(address rg1, uint256 rg2), 64967568184676235568719747, 0, 0) << 256, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address rg1, uint256 rg2), 64967568184676235568719747, 0, 0
            if not approve(address rg1, uint256 rg2), 64967568184676235568719747:
                revert with 0, 32, 42, 0x775361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
            if ext_call.return_data[0]:
                require ext_code.size(wantAddress)
            ...
            require ext_code.size(0x35bd6aeda81a7e5fc7a7832490e71f757b0cd9)
            call 0x0035bd6aeda81a7e5fc7a7832490e71f757b0cd9.mint(uint256 rg1) with:
                 gas gas_remaining wei
...
function getHarvestable() {
    ...
    if ext_call.return_data[0] >= Mask(224, 0, ext_call.return_data[0]):
        ...
        require return_data.size >= 32
        require ext_code.size(0x35bd6aeda81a7e5fc7a7832490e71f757b0cd9)
        staticcall 0x35bd6aeda81a7e5fc7a7832490e71f757b0cd9.borrowBalanceStored(address rg1) with:
                gas gas_remaining wei
               args this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
