            ...
            if poolInfo[arg1].field_256:
                ...
                if not block.number - poolInfo[arg1].field_512:
                    ...
                    if not (block.number * givePerBlock) - (poolInfo[arg1].field_512 * givePerBlock):
                        ...
                        require (block.number * givePerBlock) - (poolInfo[arg1].field_512 * givePerBlock)
                        ...
                        call giveAddress.0x40c10f19 with:
                             gas gas_remaining wei
                            args address(this.address), (block.number * givePerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * givePerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        if not (block.number * givePerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * givePerBlock * poolInfo[arg1].field_256) / totalAllocPoint:
                            ...
                            require (block.number * givePerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * givePerBlock * poolInfo[arg1].field_256) / totalAllocPoint
                            ...
                            if ext_call.return_data[0] <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require ext_call.return_data[0]
                            if poolInfo[arg1].field_768 + (10^18 * (block.number * givePerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * givePerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[arg1].field_768:
                                revert with 0, 'SafeMath: addition overflow'
...
function pendingGive(uint256 arg1, address arg2) payable {
    ...
    if not userInfo[arg1][address(arg2)].field_0:
        ...
        return -userInfo[arg1][address(arg2)].field_256
    require userInfo[arg1][address(arg2)].field_0
    if (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^18 * (block.number * givePerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * givePerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / userInfo[arg1][address(arg2)].field_0 != poolInfo[arg1].field_768 + (10^18 * (block.number * givePerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * givePerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0]):
        revert with 0, 32, 33, 0x64536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[389 len 31]
    if userInfo[arg1][address(arg2)].field_256 > (poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^18 * (block.number * givePerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * givePerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^18:
        revert with 0, 'SafeMath: subtraction overflow'
    return (((poolInfo[arg1].field_768 * userInfo[arg1][address(arg2)].field_0) + (10^18 * (block.number * givePerBlock * poolInfo[arg1].field_256) - (poolInfo[arg1].field_512 * givePerBlock * poolInfo[arg1].field_256) / totalAllocPoint / ext_call.return_data[0] * userInfo[arg1][address(arg2)].field_0) / 10^18) - userInfo[arg1][address(arg2)].field_256)
}
    ...
    while idx < poolInfo.length:
        ...
        if not (block.number * givePerBlock) - (poolInfo[idx].field_512 * givePerBlock):
            ...
            revert with memory
              from mem[64]
               len _206 + -mem[64] + 100
        require (block.number * givePerBlock) - (poolInfo[idx].field_512 * givePerBlock)
        ...
        mem[mem[64]] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
        mem[mem[64] + 4] = this.address
        mem[mem[64] + 36] = (block.number * givePerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * givePerBlock * poolInfo[idx].field_256) / totalAllocPoint
        require ext_code.size(giveAddress)
        call giveAddress.0x40c10f19 with:
             gas gas_remaining wei
            args address(this.address), (block.number * givePerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * givePerBlock * poolInfo[idx].field_256) / totalAllocPoint
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        if not (block.number * givePerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * givePerBlock * poolInfo[idx].field_256) / totalAllocPoint:
            ...
            revert with memory
              from mem[64]
               len _203 + -mem[64] + 100
        require (block.number * givePerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * givePerBlock * poolInfo[idx].field_256) / totalAllocPoint
        ...
        if ext_call.return_data[0] > 0:
            require ext_call.return_data[0]
            if poolInfo[idx].field_768 + (10^18 * (block.number * givePerBlock * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * givePerBlock * poolInfo[idx].field_256) / totalAllocPoint / ext_call.return_data[0]) < poolInfo[idx].field_768:
                revert with 0, 'SafeMath: addition overflow'
