...
function withdrawFees(address arg1, address arg2) {
    ...
    if feeBalance[address(arg1)].field_0:
        ...
        if not ext_code.size(arg1):
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = transfer(address arg1, uint256 arg2), address(arg2) << 64, 0, feeBalance[address(arg1)].field_32
        call arg1 with:
             gas gas_remaining wei
            args feeBalance[address(arg1)].field_0, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with transfer(address arg1, uint256 arg2), address(arg2) << 64, 0, feeBalance[address(arg1)].field_0
...
function mint(address arg1, address arg2, uint256 arg3, uint256 arg4, bytes32 arg5) {
    ...
    call arg2.mint(address arg1, uint256 arg2) with:
         gas gas_remaining wei
    ...
    if not ext_code.size(arg2):
        revert with 0, 'Address: call to non-contract'
    mem[260 len 64] = transfer(address arg1, uint256 arg2), address(arg1) << 64, 0, Mask(224, 32, arg3 - arg4) >> 32
    call arg2 with:
         gas gas_remaining wei
        args Mask(224, 32, arg3 - arg4) << 224, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with transfer(address arg1, uint256 arg2), address(arg1) << 64, 0, arg3 - arg4
    ...
    if ext_call.return_data[0] < arg7:
        ...
        if not return_data.size:
            ...
            if not ext_call.success:
                ...
                if not ext_code.size(arg2):
                    revert with 0, 'Address: call to non-contract'
                mem[424 len 64] = transfer(address arg1, uint256 arg2), address(arg1) << 64, 0, Mask(224, 32, arg3 - arg4) >> 32
                call arg2 with:
                     gas gas_remaining wei
                ...
                if not ext_code.size(address(ext_call.return_data[0])):
                    revert with 0, 'Address: call to non-contract'
                mem[424 len 64] = transfer(address arg1, uint256 arg2), address(arg1) << 64, 0, ext_call.return_data[0 len 28]
            ...
            if not ext_call.success:
                ...
                if not ext_code.size(arg2):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 425 len 64] = transfer(address arg1, uint256 arg2), address(arg1) << 64, 0, Mask(224, 32, arg3 - arg4) >> 32
                call arg2 with:
                     gas gas_remaining wei
                ...
                if not ext_code.size(address(ext_call.return_data[0])):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 425 len 64] = transfer(address arg1, uint256 arg2), address(arg1) << 64, 0, ext_call.return_data[0 len 28]
                call address(ext_call.return_data[0]) with:
                     gas gas_remaining wei
    ...
    if not return_data.size:
        ...
        if not return_data.size:
            if ext_call.success:
                ...
                if not return_data.size:
                    ...
                    emit 0x7b9a2613: address(arg2), arg3 - arg4, arg4, 160, 0, arg5.length, arg5[all], mem[arg5.length + 616 len ceil32(arg5.length) - arg5.length], arg1, arg6
                else:
                    mem[456 len return_data.size] = ext_call.return_data[0 len return_data.size]
                    if not ext_call.success:
                        if return_data.size:
                    ...
                    emit 0x7b9a2613: address(arg2), arg3 - arg4, arg4, 160, 0, arg5.length, arg5[all], mem[ceil32(return_data.size) + arg5.length + 617 len ceil32(arg5.length) - arg5.length], arg1, arg6
        else:
            if ext_call.success:
                emit 0x7b9a2613: address(arg2), arg3 - arg4, arg4, Array(len=arg5.length, data=arg5[all]), 1, arg1, arg6
            else:
                ...
                if not return_data.size:
                    ...
                    emit 0x7b9a2613: address(arg2), arg3 - arg4, arg4, 160, 0, arg5.length, mem[(2 * ceil32(return_data.size)) + 618 len (2 * ceil32(return_data.size)) + ceil32(arg5.length) - (2 * ceil32(return_data.size))], arg1, arg6
    else:
        mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
        if not ext_call.success:
            if return_data.size:
        ...
        if not return_data.size:
            ...
            if ext_call.success:
                ...
                if not ext_code.size(arg2):
                    revert with 0, 'Address: call to non-contract'
                mem[(2 * ceil32(return_data.size)) + 426 len 64] = transfer(address arg1, uint256 arg2), address(arg1) << 64, 0, Mask(224, 32, arg3 - arg4) >> 32
                call arg2 with:
                     gas gas_remaining wei
                ...
                if not return_data.size:
                    ...
                    mem[(2 * ceil32(return_data.size)) + 618 len arg5.length] = arg5[all]
                    mem[arg5.length + (2 * ceil32(return_data.size)) + 618] = 0
                    emit 0x7b9a2613: address(arg2), arg3 - arg4, arg4, 160, 0, arg5.length, arg5[all], mem[(2 * ceil32(return_data.size)) + arg5.length + 618 len ceil32(arg5.length) - arg5.length], arg1, arg6
                else:
                    ...
                    emit 0x7b9a2613: address(arg2), arg3 - arg4, arg4, 160, 0, arg5.length, arg5[all], mem[(2 * ceil32(return_data.size)) + ceil32(return_data.size) + arg5.length + 619 len ceil32(arg5.length) - arg5.length], arg1, arg6
    stor101 = 1
}
...
function mintAndSwap(address arg1, address arg2, uint256 arg3, uint256 arg4, address arg5, uint8 arg6, uint8 arg7, uint256 arg8, uint256 arg9, bytes32 arg10) {
    ...
    if arg4 > arg3:
        revert with 0, 'SafeMath: subtraction overflow'
    require ext_code.size(arg5)
    staticcall arg5.calculateSwap(uint8 arg1, uint8 arg2, uint256 arg3) with:
            gas gas_remaining wei
    ...
    if ext_call.return_data[0] < arg8:
        ...
        if not ext_code.size(arg2):
            revert with 0, 'Address: call to non-contract'
        mem[260 len 64] = approve(address arg1, uint256 arg2), address(arg5) << 64, 0, Mask(224, 32, arg3 + ext_call.return_data[0]) >> 32
        call arg2 with:
             gas gas_remaining wei
            args Mask(224, 32, arg3 + ext_call.return_data[0]) << 224, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
                revert with approve(address arg1, uint256 arg2), address(arg5) << 64, 0, arg3 + ext_call.return_data[0]
            if not approve(address arg1, uint256 arg2), address(arg5) << 64:
                revert with 0, 32, 42, 0x645361666545524332303a204552433230206f7065726174696f6e20646964206e6f7420737563636565, mem[370 len 22]
            if arg4 > arg3:
                revert with 0, 'SafeMath: subtraction overflow'
            require ext_code.size(arg5)
            call arg5.swap(uint8 arg1, uint8 arg2, uint256 arg3, uint256 arg4, uint256 arg5) with:
                 gas gas_remaining wei
            ...
            if not ext_call.success:
                ...
                require return_data.size >= 32
                require ext_code.size(arg5)
                staticcall arg5.getToken(uint256 arg1) with:
                        gas gas_remaining wei
                       args arg7
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
