...
#
const name = 'PizzaHavaxii', 0

const decimals = 6

const symbol = 'Havaxii', 0
...
function sub_3f56358b(?) {
    require calldata.size - 4 >= 32
    require arg1 == bool(arg1)
    if owner != msg.sender:
        revert with 0, '!OWNER'
    uint8(stor43.field_0) = uint8(bool(arg1))
}
...
function getLiquidityBacking(uint256 arg1) {
    ...
    if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
        revert with 0, 18
    return (arg1 * 2 * balanceOf[stor26] / totalSupply - balanceOf[stor3] - balanceOf[stor4])
}
...
function isOverLiquified(uint256 arg1, uint256 arg2) {
    ...
    if not totalSupply - balanceOf[stor3] - balanceOf[stor4]:
        revert with 0, 18
    return (arg2 * 2 * balanceOf[stor26] / totalSupply - balanceOf[stor3] - balanceOf[stor4] > arg1)
}
