...
#
#  - sub_0f343c8d(?)
#  - getTokenPrice(address arg1, address arg2)
#
address stor0;
address stor1;
address stor2;
...
function sub_72ac8f9f(?) payable {
    ...
    mem[ceil32(return_data.size) + 100] = 10^18
    ...
    staticcall stor0.getAmountsOut(uint256 arg1, address[] arg2) with:
            gas gas_remaining wei
           args 10^18, 64, ext_call.return_data[0], mem[ceil32(return_data.size) + 196 len 32 * ext_call.return_data[0]]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[ceil32(return_data.size) + 96 len return_data.size] = ext_call.return_data[0 len return_data.size]
    mem[64] = (2 * ceil32(return_data.size)) + 96
    require return_data.size >= 32
    _31 = mem[ceil32(return_data.size) + 96 len 4], 232830643
    require mem[ceil32(return_data.size) + 96 len 4], 232830643 <= test266151307()
    require ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], 232830643 + 127 < ceil32(return_data.size) + return_data.size + 96
    _32 = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], 232830643 + 96]
    if mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], 232830643 + 96] > test266151307():
        revert with 'NH{q', 65
    if (2 * ceil32(return_data.size)) + floor32(mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], 232830643 + 96]) + 97 > test266151307() or floor32(mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], 232830643 + 96]) + 1 < 0:
        revert with 'NH{q', 65
    mem[64] = (2 * ceil32(return_data.size)) + floor32(mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 96 len 4], 232830643 + 96]) + 97
    mem[(2 * ceil32(return_data.size)) + 96] = _32
    require _31 + (32 * _32) + 32 <= return_data.size
    idx = ceil32(return_data.size) + _31 + 128
    s = (2 * ceil32(return_data.size)) + 128
    while idx < ceil32(return_data.size) + _31 + (32 * _32) + 128:
    ...
    if not uint8(ext_call.return_data[0]):
        if 1 >= _32:
            revert with 'NH{q', 50
        mem[mem[64]] = mem[(2 * ceil32(return_data.size)) + 160]
    else:
        if bool(bool(uint8(ext_call.return_data[0]) < 78)) or bool(bool(uint8(ext_call.return_data[0]) < 32)):
            ...
            if not 10^uint8(ext_call.return_data[0]):
                revert with 'NH{q', 18
            mem[mem[64]] = mem[(2 * ceil32(return_data.size)) + 160] / 10^uint8(ext_call.return_data[0])
        else:
            s = 10
            t = 1
            ...
            if not t * s:
                revert with 'NH{q', 18
            mem[mem[64]] = mem[(2 * ceil32(return_data.size)) + 160] / t * s
    return memory
      from mem[64]
       len 32
}
