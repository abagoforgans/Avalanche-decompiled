...
function test(address arg1) payable {
    ...
    if not ext_call.return_data[18 len 14]:
        revert with 'NH{q', 18
    if not Mask(112, 0, ext_call.return_data[50 len 14] / ext_call.return_data[18 len 14]):
        revert with 0, '0', 0
    s = 0
    idx = Mask(112, 0, ext_call.return_data[50 len 14] / ext_call.return_data[18 len 14])
    while idx:
        if s == -1:
            revert with 'NH{q', 17
        s = s + 1
