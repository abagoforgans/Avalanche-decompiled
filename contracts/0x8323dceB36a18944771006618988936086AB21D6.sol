...
#
#  - mintMulti(uint16 arg1, uint16 arg2, string arg3)
...
function mintSingle(uint16 arg1, string arg2) {
    require calldata.size - 4 >= 64
    require arg1 == arg1
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    if arg1 <= 0:
        revert with 0, 'ERC721: token ID not valid (out of bounds)'
    if arg1 > 30:
        revert with 0, 'ERC721: token ID not valid (out of bounds)'
    if arg1 >= 30:
        revert with 'NH{q', 50
    if bool(stor11[arg1].field_0):
        if bool(stor11[arg1].field_0) == uint255(stor11[arg1].field_1) < 32:
            revert with 'NH{q', 34
        if arg2.length:
            stor[sha3(arg1 + 11)][] = Array(len=arg2.length, data=arg2[all])
        else:
            stor11[arg1].field_0 = 0
            idx = 0
            while uint255(stor11[arg1].field_1) + 31 / 32 > idx:
                stor[idx + sha3(arg1 + 11)] = 0
                idx = idx + 1
                continue 
    else:
    ...
    stor9[arg1 << 240] = tokenByIndex.length
    tokenByIndex.length++
    uint16(tokenByIndex[tokenByIndex.length].field_0) = arg1
    Mask(240, 0, tokenByIndex[tokenByIndex.length].field_16) = 0
    if msg.sender:
        uint16(tokenOfOwnerByIndex[address(msg.sender)][stor3[address(msg.sender)]].field_0) = arg1
        Mask(240, 0, tokenOfOwnerByIndex[address(msg.sender)][stor3[address(msg.sender)]].field_16) = 0
        stor7[arg1 << 240] = balanceOf[address(msg.sender)]
    else:
        if tokenByIndex.length < 1:
            revert with 'NH{q', 17
        if tokenByIndex.length - 1 >= tokenByIndex.length:
            revert with 'NH{q', 50
        if stor9[arg1 << 240] >= tokenByIndex.length:
            revert with 'NH{q', 50
        tokenByIndex[stor9[arg1 << 240]].field_0 = tokenByIndex[tokenByIndex.length].field_0
        stor9[stor8[stor8.length].field_0] = stor9[arg1 << 240]
        stor9[arg1 << 240] = 0
        if not tokenByIndex.length:
            revert with 'NH{q', 49
        tokenByIndex[tokenByIndex.length].field_0 = 0
    ...
    ownerOf[arg1 << 240] = msg.sender
    emit Transfer(0, msg.sender, arg1);
    if ext_code.size(msg.sender) > 0:
        require ext_code.size(msg.sender)
        call msg.sender.onERC721Received(address arg1, address arg2, uint256 arg3, bytes arg4) with:
             gas gas_remaining wei
            args msg.sender, 0, arg1 << 240, 128, 0
        if not ext_call.success:
            if not return_data.size:
                if not arg2.length:
                    revert with 0, 'ERC721: transfer to non ERC721Receiver implementer'
        ...
        if bool(stor11[arg1].field_0):
            ...
            if uint255(stor11[arg1].field_1):
                if 31 < uint255(stor11[arg1].field_1):
                    mem[128] = stor[sha3(arg1 + 11)]
                    idx = 128
                    s = 0
                    while uint255(stor11[arg1].field_1) + 96 > idx:
                        mem[idx + 32] = stor[s + sha3(arg1 + 11) + 1]
                        idx = idx + 32
                        s = s + 1
                        continue 
