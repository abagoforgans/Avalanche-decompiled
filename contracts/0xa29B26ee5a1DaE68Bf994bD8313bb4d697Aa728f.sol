...
uint256 poolId;
uint256 sub_06c6b41d;
address sub_d8818a91Address;
address mimAddress;

function sub_06c6b41d(?) {
    return sub_06c6b41d
}
...
function sub_d8818a91(?) {
    return sub_d8818a91Address
}
...
function deposit() {
    ...
    if ext_call.return_data[0]:
        ...
        call wantAddress.0x62f53052 with:
             gas gas_remaining wei
            args Mask(480, -256, approve(address arg1, uint256 arg2), 0xd6a4f121ca35509af06a0be9, 0, 0) << 256, mem[324 len 4]
        if not return_data.size:
            if not ext_call.success:
