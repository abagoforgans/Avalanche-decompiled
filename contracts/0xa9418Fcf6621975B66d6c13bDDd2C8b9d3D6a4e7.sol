...
function hasOpenPosition() payable {
    ...
    staticcall stor6.hasOpenPosition(address rg1, address rg2) with:
...
function getPositionTokensCount(address arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(stor6)
    staticcall stor6.getTokenListCount(address rg1, address rg2) with:
            gas gas_remaining wei
...
function getPositionDetails(address arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(stor6)
    staticcall stor6.getPositionDetails(address rg1, address rg2) with:
            gas gas_remaining wei
           args this.address, arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function getPositionTokensById(address arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    require ext_code.size(stor6)
    staticcall stor6.getTokenById(address rg1, address rg2, uint256 rg3) with:
            gas gas_remaining wei
...
function allowTokenForTrading(address arg1, address arg2) payable {
    ...
    call stor7.addPriceFeed(address rg1, address rg2, address rg3) with:
         gas gas_remaining wei
...
function calcPositionBalance(address arg1) payable {
    ...
    while idx < ext_call.return_data[0]:
        ...
        mem[132] = stor1
        require ext_code.size(stor7)
        staticcall stor7.getLastPrice(address rg1, address rg2) with:
                gas gas_remaining wei
...
function openPosition(uint256 arg1) payable {
    ...
    if not arg1:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require ext_code.size(stor6)
        call stor6.openPosition(address rg1, address rg2, uint256 rg3, uint256 rg4, uint256 rg5) with:
             gas gas_remaining wei
...
function sub_4fbdff9d(?) payable {
    ...
    require return_data.size >= 32
    require ext_code.size(vaultServiceAddress)
    call vaultServiceAddress.0x4fbdff9d with:
         gas gas_remaining wei
        args 0, uint32(cd[4]), cd[36], 128, cd[100], ('cd', 68).length, call.data[cd[68] + 36 len floor32(('cd', 68).length)]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(vaultServiceAddress)
    staticcall vaultServiceAddress.0xf8b2cb4f with:
    ...
    if ext_call.return_data[0] > ext_call.return_data[0]:
        revert with 0, 'SafeMath: subtraction overflow'
    require ext_code.size(stor6)
    call stor6.swapAssets(address rg1, address rg2, uint256 rg3, address rg4, uint256 rg5) with:
         gas gas_remaining wei
...
function closePosition() payable {
    ...
    while idx < ext_call.return_data[0]:
        ...
        if stor1 != address(ext_call.return_data[0]):
            ...
            mem[64] = mem[64] + 96
            require 0 < mem[_828]
            mem[_828 + 32] = address(ext_call.return_data[0])
            require 1 < mem[_828]
            mem[_828 + 64] = stor1
            mem[_828 + 96] = 0x1f263f5900000000000000000000000000000000000000000000000000000000
            mem[_828 + 100] = ext_call.return_data[32]
            mem[_828 + 132] = 0
            mem[_828 + 196] = block.timestamp + 1
            mem[_828 + 164] = 128
            mem[_828 + 228] = mem[_828]
            s = 0
            while s < 32 * mem[_828]:
                mem[s + _828 + 260] = mem[s + _828 + 32]
                s = s + 32
                continue 
            require ext_code.size(vaultServiceAddress)
            call vaultServiceAddress.0x1f263f59 with:
                 gas gas_remaining wei
                args ext_call.return_data[32], 0, 128, block.timestamp + 1, mem[_828 + 228 len (32 * mem[_828]) + 32]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        idx = idx + 1
        continue 
    ...
    mem[mem[64]] = 36
    mem[64] = mem[64] + 68
    mem[_817 + 32 len 4] = 4122065833
    staticcall 'console.log'.0xf5b1bba9 with:
            gas gas_remaining wei
           args mem[_817 + 36 len mem[_817] - 4]
    require ext_code.size(stor6)
    staticcall stor6.getPositionDetails(address rg1, address rg2) with:
            gas gas_remaining wei
           args this.address, msg.sender
    ...
    if not ext_call.return_data[32] - ext_call.return_data[0]:
        ...
        if (ext_call.return_data[32] * ext_call.return_data[0]) - (ext_call.return_data[0] * ext_call.return_data[0]) / ext_call.return_data[32] - ext_call.return_data[0] != ext_call.return_data[0]:
            revert with 0, 32, 33, 0x6e536166654d6174683a206d756c7469706c69636174696f6e206f766572666c6f, mem[_816 + 373 len 31]
        if ext_call.return_data[64] <= 0:
            revert with 0, 'SafeMath: division by zero'
        require ext_call.return_data[64]
        staticcall 'console.log'.0xf5b1bba9 with:
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(stor6)
    call stor6.closePosition(address rg1) with:
         gas gas_remaining wei
        args msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
