...
function green(address arg1) {
    require calldata.size - 4 >= 32
    return green[arg1]
}

function sumOfOutputETH() {
...
function sellSideDivs(address arg1) {
    require calldata.size - 4 >= 32
    return sellSideDivs[arg1]
}

function earningsPerResolve() {
...
function average_buyInTimeSum(address arg1) {
    require calldata.size - 4 >= 32
    return average_buyInTimeSum[arg1]
}

function average_ethSpent(address arg1) {
    require calldata.size - 4 >= 32
    return average_ethSpent[arg1]
}

function red(address arg1) {
    require calldata.size - 4 >= 32
    return red[arg1]
}
...
function sumOfInputTime() {
    return sumOfInputTime
}

function blue(address arg1) {
    require calldata.size - 4 >= 32
    return blue[arg1]
}
...
function resolveWeight(address arg1) {
    require calldata.size - 4 >= 32
    return resolveWeight[arg1]
}

function sumOfOutputTime() {
    return sumOfOutputTime
}

function sumOfInputETH() {
...
function resolveEarnings(address arg1) {
    require calldata.size - 4 >= 32
...
function RGB_Ratio(address arg1) {
    require calldata.size - 4 >= 32
...
function getReturnsForBonds(address arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
...
function colorTransfer(address arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
...
function clockTransfer(address arg1, uint256 arg2) {
    require calldata.size - 4 >= 64
...
function buy(address arg1, uint256 arg2, uint256 arg3, uint256 arg4) payable {
    ...
    require return_data.size >= 32
    require not dissolvingResolves
    average_ethSpent[address(arg1)] += msg.value
    average_buyInTimeSum[address(arg1)] += msg.value * block.timestamp << 64
    sumOfInputETH += msg.value
    sumOfInputTime += msg.value * block.timestamp << 64
    s = (2000000000000000000000 * 10^18 * _totalSupply) + (100 * 10^18 * _totalSupply^2) + (0x380d4bd8a8678c1bb542c80deb4800000000000 * msg.value) + 0x197d4df19d605767337e9f14d3eec8920e400000000000001 / 2
    t = (2000000000000000000000 * 10^18 * _totalSupply) + (100 * 10^18 * _totalSupply^2) + (0x380d4bd8a8678c1bb542c80deb4800000000000 * msg.value) + 0x197d4df19d605767337e9f14d3eec8920e400000000000000
    while s < t:
        require s
        s = ((2000000000000000000000 * 10^18 * _totalSupply) + (100 * 10^18 * _totalSupply^2) + (0x380d4bd8a8678c1bb542c80deb4800000000000 * msg.value) + 0x197d4df19d605767337e9f14d3eec8920e400000000000000 / s) + s / 2
        t = s
        continue 
    ...
    emit Buy(msg.value, (t - 100000000000 * 10^18 / 10^10) - _totalSupply, 0, arg1);
    return ((t - 100000000000 * 10^18 / 10^10) - _totalSupply)
}
...
function fund() payable {
    ...
    require return_data.size >= 32
    require not dissolvingResolves
    average_ethSpent[address(msg.sender)] += msg.value
    average_buyInTimeSum[address(msg.sender)] += msg.value * block.timestamp << 64
    sumOfInputETH += msg.value
    sumOfInputTime += msg.value * block.timestamp << 64
    s = (2000000000000000000000 * 10^18 * _totalSupply) + (100 * 10^18 * _totalSupply^2) + (0x380d4bd8a8678c1bb542c80deb4800000000000 * msg.value) + 0x197d4df19d605767337e9f14d3eec8920e400000000000001 / 2
    t = (2000000000000000000000 * 10^18 * _totalSupply) + (100 * 10^18 * _totalSupply^2) + (0x380d4bd8a8678c1bb542c80deb4800000000000 * msg.value) + 0x197d4df19d605767337e9f14d3eec8920e400000000000000
    ...
    if not balances[address(msg.sender)]:
        ...
        if red[address(msg.sender)] / balances[address(msg.sender)] <= 10^18:
            ...
            if green[address(msg.sender)] / balances[address(msg.sender)] <= 10^18:
                ...
                if blue[address(msg.sender)] / balances[address(msg.sender)] <= 10^18:
                    ...
                    blue[address(msg.sender)] = (10^18 * t - 100000000000 * 10^18 / 10^10) - (10^18 * _totalSupply) + blue[address(msg.sender)]
            else:
                green[address(msg.sender)] = green[address(msg.sender)] + (10^18 * t - 100000000000 * 10^18 / 10^10) - (10^18 * _totalSupply)
                if blue[address(msg.sender)] / balances[address(msg.sender)] <= 10^18:
                    blue[address(msg.sender)] = (t - 100000000000 * 10^18 / 10^10 * blue[address(msg.sender)] / balances[address(msg.sender)]) - (_totalSupply * blue[address(msg.sender)] / balances[address(msg.sender)]) + blue[address(msg.sender)]
                else:
                    blue[address(msg.sender)] = (10^18 * t - 100000000000 * 10^18 / 10^10) - (10^18 * _totalSupply) + blue[address(msg.sender)]
        else:
            red[address(msg.sender)] = red[address(msg.sender)] + (10^18 * t - 100000000000 * 10^18 / 10^10) - (10^18 * _totalSupply)
            if green[address(msg.sender)] / balances[address(msg.sender)] <= 10^18:
                green[address(msg.sender)] = green[address(msg.sender)] + (t - 100000000000 * 10^18 / 10^10 * green[address(msg.sender)] / balances[address(msg.sender)]) - (_totalSupply * green[address(msg.sender)] / balances[address(msg.sender)])
                if blue[address(msg.sender)] / balances[address(msg.sender)] <= 10^18:
                    blue[address(msg.sender)] = (t - 100000000000 * 10^18 / 10^10 * blue[address(msg.sender)] / balances[address(msg.sender)]) - (_totalSupply * blue[address(msg.sender)] / balances[address(msg.sender)]) + blue[address(msg.sender)]
    ...
    if dissolvingResolves:
        require dissolvingResolves
        earningsPerResolve += 0 / dissolvingResolves
    emit 0x73ddf252: ((t - 100000000000 * 10^18 / 10^10) - _totalSupply), 0, msg.sender
    emit Buy(msg.value, (t - 100000000000 * 10^18 / 10^10) - _totalSupply, 0, msg.sender);
    return ((t - 100000000000 * 10^18 / 10^10) - _totalSupply)
}
...
function sellBonds(uint256 arg1) {
    require calldata.size - 4 >= 32
    ...
    call msg.sender with:
       value (25 * 10^6 * 3600 * arg1) + (10^10 * _totalSupply + 10^18 / 10^18 * arg1) - (10^10 * (arg1 + 10^18)^2 + -arg1 - 10^18 / 10^18 / 2) / 10^18 wei
         gas gas_remaining wei
    if not ext_call.success:
        revert with 0, 'Transfer failed.'
...
function reinvestEarnings(uint256 arg1) {
    require calldata.size - 4 >= 32
...
function sellAllBonds() {
    ...
    call msg.sender with:
       value (25 * 10^6 * 3600 * balances[address(msg.sender)]) + (10^10 * _totalSupply + 10^18 / 10^18 * balances[address(msg.sender)]) - (10^10 * (balances[address(msg.sender)] + 10^18)^2 + -balances[address(msg.sender)] - 10^18 / 10^18 / 2) / 10^18 wei
         gas gas_remaining wei
    if not ext_call.success:
        revert with 0, 'Transfer failed.'
...
function getMeOutOfHere() {
    ...
    call msg.sender with:
       value Mask(192, 64, (resolveWeight[address(msg.sender)] * earningsPerResolve) - payouts[address(msg.sender)]) >> 64 wei
         gas gas_remaining wei
    if not ext_call.success:
        revert with 0, 'Transfer failed.'
