...
function sub_f3fae403(?) {
    ...
    call 0xbaf9a6f8a8afd4be0d85ca40f025bf364fa27324.0x2e1a7d4d with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
                            ...
                            if unknown_0xf3fae403(?????) == uint32(call.func_hash) >> 224:
                                ...
                                if unknown_0xffe209c6(?????) == uint32(call.func_hash) >> 224:
                                    ...
                                    while idx < ('cd', 4).length:
                                        ...
                                        mem[ceil32(32 * ('cd', 4).length) + 197] = _179
                                        require ext_code.size(stor2)
                                        call stor2.0x42842e0e with:
                                             gas gas_remaining wei
                                            args msg.sender, address(this.address), _179
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        if idx == -1:
                                            revert with 0, 17
                ...
                if unknown_0x7f3988a3(?????) == uint32(call.func_hash) >> 224:
                    ...
                    while idx < ('cd', 4).length:
                        ...
                        while s < uint64(cd[36]):
                            ...
                            mem[ceil32(32 * ('cd', 4).length) + 133] = _188
                            mem[ceil32(32 * ('cd', 4).length) + 165] = bool(cd[100])
                            require ext_code.size(address(cd[68]))
                            call address(cd[68]).0xc679fa0 with:
                                 gas gas_remaining wei
                                args _188, bool(cd[100])
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            if s == -1:
                                revert with 0, 17
                            ...
                            if unknown_0x868e2925(?????) == uint32(call.func_hash) >> 224:
                                ...
                                if unknown_0x877b71dd(?????) == uint32(call.func_hash) >> 224:
                                    ...
                                    while idx < ('cd', 4).length:
                                        ...
                                        mem[ceil32(32 * ('cd', 4).length) + 197] = _174
                                        require ext_code.size(stor2)
                                        call stor2.0x42842e0e with:
                                             gas gas_remaining wei
                                            args address(this.address), msg.sender, _174
                                        if not ext_call.success:
                                            revert with ext_call.return_data[0 len return_data.size]
                                        if idx == -1:
                                            revert with 0, 17
