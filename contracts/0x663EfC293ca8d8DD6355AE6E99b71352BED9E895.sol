...
#
#  - initialize(address arg1, address arg2, address arg3, address arg4, address arg5, bool arg6, string arg7, string arg8)
...
function harvest(address arg1, uint256 arg2) payable {
    ...
    mem[260 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor257), uint32(stor257), Mask(224, 32, arg2) >> 32
    call arg1 with:
       funct uint32(stor257)
         gas gas_remaining wei
        args Mask(224, 32, arg2) << 224, mem[324 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with unknown_0xa9059cbb(?????), Mask(224, 0, stor257), uint32(stor257), arg2
        if not unknown_0xa9059cbb(?????), Mask(224, 0, stor257):
...
function earn() payable {
    ...
    if not ext_call.return_data[0]:
        if not ext_code.size(tokenAddress):
            revert with 0, 'Address: call to non-contract'
        mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor257), uint32(stor257), 0
        ...
        if not ext_code.size(tokenAddress):
            revert with 0, 'Address: call to non-contract'
        mem[324 len 64] = unknown_0xa9059cbb(?????), Mask(224, 0, stor257), uint32(stor257), Mask(224, 32, min * ext_call.return_data[0] / 10000) >> 32
        call tokenAddress with:
           funct uint32(stor257)
             gas gas_remaining wei
            args Mask(224, 32, min * ext_call.return_data[0] / 10000) << 224, mem[388 len 4]
        if not return_data.size:
            require not ext_call.success
            revert with 'SafeMath: division by zero'
        mem[356 len return_data.size] = ext_call.return_data[0 len return_data.size]
...
function depositAll() payable {
    ...
    if guestListAddress:
        ...
        staticcall guestListAddress.authorized(address rg1, uint256 rg2, bytes32[] rg3) with:
                gas gas_remaining wei
               args msg.sender, ext_call.return_data[0], 96, 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if not ext_call.return_data[0]:
    ...
    if not ext_code.size(tokenAddress):
        revert with 0, 'Address: call to non-contract'
    mem[324 len 96] = unknown_0x23b872dd(?????), msg.sender, address(this.address), ext_call.return_data[0 len 28]
    mem[448 len 4] = 0
    call tokenAddress with:
         gas gas_remaining wei
        args Mask(736, -512, ext_call.return_data[0 len 28]) << 512, mem[420 len 4]
    if not return_data.size:
        if not ext_call.success:
            revert with 0, 'SafeERC20: low-level call failed'
    else:
...
function deposit(uint256 arg1, bytes32[] arg2) payable {
    require calldata.size - 4 >= 64
    ...
    if guestListAddress:
        ...
        staticcall guestListAddress.authorized(address rg1, uint256 rg2, bytes32[] rg3) with:
                gas gas_remaining wei
               args msg.sender, arg1, Array(len=arg2.length, data=call.data[arg2 + 36 len floor32(arg2.length)], mem[(32 * arg2.length) + floor32(arg2.length) + 260 len (32 * arg2.length) - floor32(arg2.length)])
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if not ext_call.return_data[0]:
    ...
    if not ext_code.size(tokenAddress):
        revert with 0, 'Address: call to non-contract'
    mem[(32 * arg2.length) + 324 len 96] = unknown_0x23b872dd(?????), msg.sender, address(this.address), Mask(224, 32, arg1) >> 32
    mem[(32 * arg2.length) + 448 len 4] = 0
    call tokenAddress with:
         gas gas_remaining wei
        args Mask(224, 32, arg1) << 480, mem[(32 * arg2.length) + 420 len 4]
    if not return_data.size:
        if not ext_call.success:
            if arg2.length:
                revert with memory
