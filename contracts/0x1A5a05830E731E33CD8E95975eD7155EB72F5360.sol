...
function licencePriceChange(uint256 arg1) {
    require calldata.size - 4 >= 32
    if owner != msg.sender:
        revert with 0, 'You is not owner'
    stor1 = arg1
...
function exchange(address[] arg1, uint256 arg2, uint256 arg3, address arg4, bool arg5) payable {
    ...
    if ext_call.return_data[0] < stor1:
        revert with 0, 'insufficient balance UNDB'
    ...
    mem[(32 * arg1.length) + 160 len 4] = unknown_0x23b872dd(?????)
    mem[(32 * arg1.length) + 260 len 96] = unknown_0x23b872dd(?????), addresses[address(msg.sender)].field_0, addresses[address(msg.sender)].field_0, address(this.address), Mask(224, 32, arg2) >> 32
    ...
    if not return_data.size:
        ...
        call address(_8).0xdd62ed3e with:
             gas gas_remaining wei
        ...
        if ext_call.return_data[0] >= arg2:
            ...
            mem[(32 * arg1.length) + 360 len 64] = 0, address(arg4), Mask(224, 32, 100 * arg2) >> 32
            mem[(32 * arg1.length) + 452 len 4] = Mask(32, 64, 100 * arg2) >> 64
            call mem[140 len 20] with:
                 gas gas_remaining wei
                args 100 * arg2, Mask(224, 32, address(arg4), Mask(224, 32, 100 * arg2) >> 32) >> 32, mem[(32 * arg1.length) + 424 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 
                                32,
        ...
        if ext_call.return_data[0] >= arg2:
            ...
            mem[(32 * arg1.length) + ceil32(return_data.size) + 361 len 64] = 0, address(arg4), Mask(224, 32, 100 * arg2) >> 32
            mem[(32 * arg1.length) + ceil32(return_data.size) + 453 len 4] = Mask(32, 64, 100 * arg2) >> 64
            call mem[140 len 20] with:
                 gas gas_remaining wei
                args 100 * arg2, Mask(224, 32, address(arg4), Mask(224, 32, 100 * arg2) >> 32) >> 32, mem[(32 * arg1.length) + ceil32(return_data.size) + 425 len 4]
            if not return_data.size:
                if not ext_call.success:
                    revert with 0, 
                                32,
                ...
                if not ext_call.success:
                    revert with 0, 
                                ...
                                47,
                                0x645472616e7366657248656c706572554e44423a3a73616665417070726f76653a20617070726f7665206661696c65,
                                mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + 477 len 17]
                if return_data.size:
                    require return_data.size >= 32
                ...
                if arg5:
                    ...
                    call arg4.swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                         gas gas_remaining wei
                        args ext_call.return_data[0], arg3, Array(len=arg1.length, data=call.data[arg1 + 36 len floor32(arg1.length)], mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + floor32(arg1.length) + 558 len (32 * arg1.length) - floor32(arg1.length)]), addresses[address(msg.sender)].field_0, block.timestamp + 120
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                else:
                    ...
                    call arg4.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                         gas gas_remaining wei
                        args arg2, arg3, Array(len=arg1.length, data=call.data[arg1 + 36 len floor32(arg1.length)], mem[(32 * arg1.length) + (2 * ceil32(return_data.size)) + floor32(arg1.length) + 558 len (32 * arg1.length) - floor32(arg1.length)]), addresses[address(msg.sender)].field_0, block.timestamp + 120
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
