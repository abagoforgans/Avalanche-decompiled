                        ...
                        if (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18:
                            if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                                ...
                                while s >= 32:
                                    ...
                                    s = s - 32
                                    continue 
                                mem[mem[64] + floor32(mem[_459])] = mem[_459 + floor32(mem[_459]) + -(mem[_459] % 32) + 64 len mem[_459] % 32] or Mask(8 * -(mem[_459] % 32) + 32, -(8 * -(mem[_459] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_459])])
                                call sub_8ef4403c[idx].mem[mem[64] len 4] with:
                                     gas gas_remaining wei
                                    args mem[mem[64] + 4 len _462 + _458 + -mem[64] + 96]
                                if not return_data.size:
                                    if not ext_call.success:
                                        revert with 0, '!safeTransfer'
                                    if mem[96]:
                                    ...
                                    _671 = mem[64]
                                    mem[64] = mem[64] + ceil32(return_data.size) + 1
                                    mem[_671] = return_data.size
                                    mem[_671 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                    if not ext_call.success:
                                        revert with 0, '!safeTransfer'
                                    if return_data.size:
                                        require return_data.size >= 32
                        ...
                        if not (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 / 10^(-uint8(ext_call.return_data[0]) + 18):
                            ...
                            if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                                ...
                                if not return_data.size:
                                    ...
                                    _675 = mem[64]
                                    mem[64] = mem[64] + ceil32(return_data.size) + 1
                                    mem[_675] = return_data.size
                                    mem[_675 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                                    if not ext_call.success:
                                        revert with 0, '!safeTransfer'
                                    if return_data.size:
                                        require return_data.size >= 32
                ...
                if (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18:
                    if 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee == sub_8ef4403c[idx]:
                        ...
                        while s >= 32:
                            ...
                            s = s - 32
                            continue 
                        mem[mem[64] + floor32(mem[_583])] = mem[_583 + floor32(mem[_583]) + -(mem[_583] % 32) + 64 len mem[_583] % 32] or Mask(8 * -(mem[_583] % 32) + 32, -(8 * -(mem[_583] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_583])])
                        call msg.sender.mem[mem[64] len 4] with:
                           value (sub_420480b8[stor103[idx]] * stakes[address(msg.sender)]) - (sub_7ec475a8[address(msg.sender)][stor103[idx]] * stakes[address(msg.sender)]) / 10^18 wei
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _585 + _583 + -mem[64] + 28]
                        if return_data.size:
                            _834 = mem[64]
                            mem[64] = mem[64] + ceil32(return_data.size) + 1
                            mem[_834] = return_data.size
                            mem[_834 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                        if not ext_call.success:
                            revert with 0, '!safeTransferETH'
                    else:
                        _578 = mem[64]
