...
function sub_3d67cebb(?) payable {
    ...
    if 3 * 100 * sub_1051acde / 100000 * 10^18 <= 100:
        if (block.number * voter[address(arg1)].field_0) - (voter[address(msg.sender)].field_128 * voter[address(arg1)].field_0) and 186 * 10^14 * 100 * sub_1051acde / 100000 * 10^18 / 100 > -1 / (block.number * voter[address(arg1)].field_0) - (voter[address(msg.sender)].field_128 * voter[address(arg1)].field_0):
            revert with 'NH{q', 17
        if not sub_1051acde:
            revert with 'NH{q', 18
        return ((block.number * voter[address(arg1)].field_0 * 186 * 10^14 * 100 * sub_1051acde / 100000 * 10^18 / 100) - (voter[address(msg.sender)].field_128 * voter[address(arg1)].field_0 * 186 * 10^14 * 100 * sub_1051acde / 100000 * 10^18 / 100) / sub_1051acde)
...
function sub_ce189c9c(?) payable {
    ...
    if block.number - voter[address(msg.sender)].field_128 and voter[address(msg.sender)].field_0 > -1 / block.number - voter[address(msg.sender)].field_128:
        revert with 'NH{q', 17
    if 3 * 100 * sub_1051acde / 100000 * 10^18 <= 100:
        if (block.number * voter[address(msg.sender)].field_0) - (voter[address(msg.sender)].field_128 * voter[address(msg.sender)].field_0) and 186 * 10^14 * 100 * sub_1051acde / 100000 * 10^18 / 100 > -1 / (block.number * voter[address(msg.sender)].field_0) - (voter[address(msg.sender)].field_128 * voter[address(msg.sender)].field_0):
            revert with 'NH{q', 17
        if not sub_1051acde:
            revert with 'NH{q', 18
        ...
        call _treasuryAddress.0x7387f44d with:
            ...
            args msg.sender, (block.number * voter[address(msg.sender)].field_0 * 186 * 10^14 * 100 * sub_1051acde / 100000 * 10^18 / 100) - (voter[address(msg.sender)].field_128 * voter[address(msg.sender)].field_0 * 186 * 10^14 * 100 * sub_1051acde / 100000 * 10^18 / 100) / sub_1051acde
        ...
        voter[address(msg.sender)].field_128 = uint32(block.number)
        return ((block.number * voter[address(msg.sender)].field_0 * 186 * 10^14 * 100 * sub_1051acde / 100000 * 10^18 / 100) - (voter[address(msg.sender)].field_128 * voter[address(msg.sender)].field_0 * 186 * 10^14 * 100 * sub_1051acde / 100000 * 10^18 / 100) / sub_1051acde)
