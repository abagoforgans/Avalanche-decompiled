                ...
                if not block.timestamp - poolInfo[idx].field_512:
                    ...
                    if not 0 / totalAllocPoint:
                        ...
                        if not 0 / mem[_3069]:
                            ...
                            mem[mem[64] + 32] = _3070
                            mem[mem[64] + 64] = poolInfo[idx].field_768
                            emit UpdatePool(block.timestamp, _3070, poolInfo[idx].field_768, idx);
                        else:
                            if (1000 * 0 / mem[_3069]) - (devPercent * 0 / mem[_3069]) - (treasuryPercent * 0 / mem[_3069]) - (investorPercent * 0 / mem[_3069]) / 0 / mem[_3069] != -devPercent + -treasuryPercent + -investorPercent + 1000:
                                revert with 0, 'SafeMath: multiplication overflow'
                            if ((1000 * 0 / mem[_3069]) - (devPercent * 0 / mem[_3069]) - (treasuryPercent * 0 / mem[_3069]) - (investorPercent * 0 / mem[_3069]) / 1000) + poolInfo[idx].field_768 < poolInfo[idx].field_768:
                                revert with 0, 'SafeMath: addition overflow'
                            poolInfo[idx].field_768 += (1000 * 0 / mem[_3069]) - (devPercent * 0 / mem[_3069]) - (treasuryPercent * 0 / mem[_3069]) - (investorPercent * 0 / mem[_3069]) / 1000
                            poolInfo[idx].field_512 = block.timestamp
                            mem[mem[64]] = block.timestamp
                            mem[mem[64] + 32] = _3070
                            mem[mem[64] + 64] = ((1000 * 0 / _3070) - (devPercent * 0 / _3070) - (treasuryPercent * 0 / _3070) - (investorPercent * 0 / _3070) / 1000) + poolInfo[idx].field_768
                            emit UpdatePool(block.timestamp, _3070, ((1000 * 0 / _3070) - (devPercent * 0 / _3070) - (treasuryPercent * 0 / _3070) - (investorPercent * 0 / _3070) / 1000) + poolInfo[idx].field_768, idx);
                    else:
                        if 10^12 * 0 / totalAllocPoint / 0 / totalAllocPoint != 10^12:
                            revert with 0, 'SafeMath: multiplication overflow'
                        if mem[_3069] <= 0:
                            revert with 0, 'SafeMath: division by zero'
                        require mem[_3069]
                        if not 10^12 * 0 / totalAllocPoint / mem[_3069]:
                            if poolInfo[idx].field_768 < poolInfo[idx].field_768:
                                revert with 0, 'SafeMath: addition overflow'
                            poolInfo[idx].field_512 = block.timestamp
                            mem[mem[64]] = block.timestamp
                            ...
                            if (1000 * 10^12 * 0 / totalAllocPoint / mem[_3069]) - (devPercent * 10^12 * 0 / totalAllocPoint / mem[_3069]) - (treasuryPercent * 10^12 * 0 / totalAllocPoint / mem[_3069]) - (investorPercent * 10^12 * 0 / totalAllocPoint / mem[_3069]) / 10^12 * 0 / totalAllocPoint / mem[_3069] != -devPercent + -treasuryPercent + -investorPercent + 1000:
                                revert with 0, 'SafeMath: multiplication overflow'
                            if ((1000 * 10^12 * 0 / totalAllocPoint / mem[_3069]) - (devPercent * 10^12 * 0 / totalAllocPoint / mem[_3069]) - (treasuryPercent * 10^12 * 0 / totalAllocPoint / mem[_3069]) - (investorPercent * 10^12 * 0 / totalAllocPoint / mem[_3069]) / 1000) + poolInfo[idx].field_768 < poolInfo[idx].field_768:
                                revert with 0, 'SafeMath: addition overflow'
                            poolInfo[idx].field_768 += (1000 * 10^12 * 0 / totalAllocPoint / mem[_3069]) - (devPercent * 10^12 * 0 / totalAllocPoint / mem[_3069]) - (treasuryPercent * 10^12 * 0 / totalAllocPoint / mem[_3069]) - (investorPercent * 10^12 * 0 / totalAllocPoint / mem[_3069]) / 1000
                            poolInfo[idx].field_512 = block.timestamp
                            mem[mem[64]] = block.timestamp
                            mem[mem[64] + 32] = _3070
                            mem[mem[64] + 64] = ((1000 * 10^12 * 0 / totalAllocPoint / _3070) - (devPercent * 10^12 * 0 / totalAllocPoint / _3070) - (treasuryPercent * 10^12 * 0 / totalAllocPoint / _3070) - (investorPercent * 10^12 * 0 / totalAllocPoint / _3070) / 1000) + poolInfo[idx].field_768
                            emit UpdatePool(block.timestamp, _3070, ((1000 * 10^12 * 0 / totalAllocPoint / _3070) - (devPercent * 10^12 * 0 / totalAllocPoint / _3070) - (treasuryPercent * 10^12 * 0 / totalAllocPoint / _3070) - (investorPercent * 10^12 * 0 / totalAllocPoint / _3070) / 1000) + poolInfo[idx].field_768, idx);
                else:
                    if (block.timestamp * joePerSec) - (poolInfo[idx].field_512 * joePerSec) / block.timestamp - poolInfo[idx].field_512 != joePerSec:
                        revert with 0, 'SafeMath: multiplication overflow'
                    if not (block.timestamp * joePerSec) - (poolInfo[idx].field_512 * joePerSec):
                        ...
                        if not (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint:
                            ...
                            if mem[_3069] <= 0:
                                revert with 0, 'SafeMath: division by zero'
                            require mem[_3069]
                            if not 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / mem[_3069]:
                                if poolInfo[idx].field_768 < poolInfo[idx].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                poolInfo[idx].field_512 = block.timestamp
                                mem[mem[64]] = block.timestamp
                                ...
                                if (1000 * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / mem[_3069]) - (devPercent * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / mem[_3069]) - (treasuryPercent * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / mem[_3069]) - (investorPercent * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / mem[_3069]) / 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / mem[_3069] != -devPercent + -treasuryPercent + -investorPercent + 1000:
                                    revert with 0, 'SafeMath: multiplication overflow'
                                if ((1000 * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / mem[_3069]) - (devPercent * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / mem[_3069]) - (treasuryPercent * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / mem[_3069]) - (investorPercent * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / mem[_3069]) / 1000) + poolInfo[idx].field_768 < poolInfo[idx].field_768:
                                    revert with 0, 'SafeMath: addition overflow'
                                poolInfo[idx].field_768 += (1000 * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / mem[_3069]) - (devPercent * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / mem[_3069]) - (treasuryPercent * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / mem[_3069]) - (investorPercent * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / mem[_3069]) / 1000
                                poolInfo[idx].field_512 = block.timestamp
                                mem[mem[64]] = block.timestamp
                                mem[mem[64] + 32] = _3070
                                mem[mem[64] + 64] = ((1000 * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / _3070) - (devPercent * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / _3070) - (treasuryPercent * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / _3070) - (investorPercent * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / _3070) / 1000) + poolInfo[idx].field_768
                                emit UpdatePool(block.timestamp, _3070, ((1000 * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / _3070) - (devPercent * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / _3070) - (treasuryPercent * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / _3070) - (investorPercent * 10^12 * (block.timestamp * joePerSec * poolInfo[idx].field_256) - (poolInfo[idx].field_512 * joePerSec * poolInfo[idx].field_256) / totalAllocPoint / _3070) / 1000) + poolInfo[idx].field_768, idx);
        idx = idx + 1
        continue 
    joePerSec = arg1
