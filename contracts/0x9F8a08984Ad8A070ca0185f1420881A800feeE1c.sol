...
function recoverAVAX(uint256 arg1) {
    ...
    if owner != msg.sender:
        revert with 0, 'Ownable: Caller is not the owner'
    if arg1 <= 0:
        revert with 0, 'YakRouter: Nothing to recover'
...
function queryAdapter(uint256 arg1, address arg2, address arg3, uint8 arg4) {
    ...
    staticcall aDAPTERS[arg4].query(uint256 rg1, address rg2, address rg3) with:
...
function queryNoSplit(uint256 arg1, address arg2, address arg3) {
    ...
    while uint8(idx) < aDAPTERS.length:
        ...
        staticcall aDAPTERS[uint8(idx)].query(uint256 rg1, address rg2, address rg3) with:
                gas gas_remaining wei
               args arg1, address(arg2), arg3
...
function queryNoSplit(uint256 arg1, address arg2, address arg3, uint8[] arg4) {
    ...
    while arg4.length > uint8(idx):
        ...
        mem[mem[64] + 36] = arg2
        mem[mem[64] + 68] = arg3
        require ext_code.size(aDAPTERS[uint8(cd[((32 * uint8(idx)) + arg4 + 36)])])
        staticcall aDAPTERS[uint8(cd[((32 * uint8(idx)) + arg4 + 36)])].query(uint256 rg1, address rg2, address rg3) with:
                gas gas_remaining wei
               args arg1, address(arg2), arg3
        mem[mem[64]] = ext_call.return_data[0]
        if not ext_call.success:
        ...
        if not uint8(idx):
            _27 = mem[64]
            mem[64] = mem[64] + 128
            mem[_27] = aDAPTERS[uint8(cd[((32 * uint8(idx)) + arg4 + 36)])]
            mem[_27 + 32] = arg2
            mem[_27 + 64] = arg3
            mem[_27 + 96] = _25
            idx = idx + 1
        ...
        _28 = mem[64]
        mem[64] = mem[64] + 128
        mem[_28] = aDAPTERS[uint8(cd[((32 * uint8(idx)) + arg4 + 36)])]
        mem[_28 + 32] = arg2
        mem[_28 + 64] = arg3
        mem[_28 + 96] = _25
        idx = idx + 1
