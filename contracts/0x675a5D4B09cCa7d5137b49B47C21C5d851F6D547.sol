...
mapping of uint8 stor517;
mapping of struct charactersOfferedForSale;
mapping of struct characterBids;
...
function charactersOfferedForSale(uint256 arg1) {
    require calldata.size - 4 >= 32
    return bool(charactersOfferedForSale[arg1].field_0), 
           charactersOfferedForSale[arg1].field_256,
           charactersOfferedForSale[arg1].field_512,
           charactersOfferedForSale[arg1].field_768,
           charactersOfferedForSale[arg1].field_1024
}
...
function characterBids(uint256 arg1) {
    require calldata.size - 4 >= 32
    return bool(characterBids[arg1].field_0), 
           characterBids[arg1].field_256,
           characterBids[arg1].field_512,
           characterBids[arg1].field_768
}
...
function characterNoLongerForSale(uint256 arg1) {
    ...
    charactersOfferedForSale[arg1].field_0 = 0
    charactersOfferedForSale[arg1].field_256 = arg1
    charactersOfferedForSale[arg1].field_512 = msg.sender
    charactersOfferedForSale[arg1].field_768 = 0
    charactersOfferedForSale[arg1].field_1024 = 0
    charactersOfferedForSale[arg1].field_1280 = 0
...
function offercharacterForSaleToAddress(uint256 arg1, uint256 arg2, address arg3) {
    ...
    if ownerOf[arg1] != msg.sender:
        revert with 0, 'Incorrect owner.'
    charactersOfferedForSale[arg1].field_0 = 1
    charactersOfferedForSale[arg1].field_256 = arg1
    charactersOfferedForSale[arg1].field_512 = msg.sender
    charactersOfferedForSale[arg1].field_768 = arg2
    charactersOfferedForSale[arg1].field_1024 = arg3
...
function withdrawBidForcharacter(uint256 arg1) {
    ...
    if characterBids[arg1].field_512 != msg.sender:
        revert with 0, 'Only bidder can withdraw'
    emit 0x96bf05db: characterBids[arg1].field_768, arg1, msg.sender
    characterBids[arg1].field_0 = 0
    characterBids[arg1].field_256 = arg1
    characterBids[arg1].field_512 = 0
    characterBids[arg1].field_768 = 0
    characterBids[arg1].field_768 = 0
    call msg.sender with:
       value characterBids[arg1].field_768 wei
         gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    stor1 = 1
...
function enterBidForcharacter(uint256 arg1) payable {
    ...
    if msg.value <= characterBids[arg1].field_768:
        revert with 0, 32, 35, 0x72796f752063616e206e6f7420626964206c6f776572207468616e206c617374206269, mem[327 len 29]
    if characterBids[arg1].field_768 > 0:
        pendingWithdrawals[stor519[arg1].field_512] += characterBids[arg1].field_768
    characterBids[arg1].field_0 = 1
    characterBids[arg1].field_256 = arg1
    characterBids[arg1].field_512 = msg.sender
    characterBids[arg1].field_768 = msg.value
    emit 0xdf69ca1a: msg.value, arg1, msg.sender
    stor1 = 1
}

function purchaseCharacter(uint256 arg1) {
    require calldata.size - 4 >= 32
    if stor1 == 2:
        revert with 0, 'ReentrancyGuard: reentrant call'
    stor1 = 2
    if arg1 <= 0:
        revert with 0, 'Mint more than 0'
    if totalSupply > 500:
...
function acceptBidForcharacter(uint256 arg1, uint256 arg2) {
    ...
    if characterBids[arg1].field_768 < arg2:
    ...
    if ownerOf[arg1] != msg.sender:
        revert with 0, 'Incorrect owner.'
    require characterBids[arg1].field_512
    if approved[arg1]:
        approved[arg1] = 0
    ...
    if ownerOf[arg1]:
        revert with 0, 'Cannot add, already owned.'
    ownerOf[arg1] = characterBids[arg1].field_512
    tokenOfOwnerByIndex[stor519[arg1].field_512]++
    tokenOfOwnerByIndex[stor519[arg1].field_512][tokenOfOwnerByIndex[stor519[arg1].field_512]] = arg1
    if 1 > tokenOfOwnerByIndex[stor519[arg1].field_512]:
        revert with 0, 'SafeMath: subtraction overflow'
    stor7[arg1] = tokenOfOwnerByIndex[stor519[arg1].field_512] - 1
    emit Transfer(ownerOf[arg1], characterBids[arg1].field_512, arg1);
    if ext_code.size(characterBids[arg1].field_512) > 0:
        require ext_code.size(characterBids[arg1].field_512)
        call characterBids[arg1].field_512.onERC721Received(address rg1, address rg2, uint256 rg3, bytes rg4) with:
             gas gas_remaining wei
    ...
    characterBids[arg1].field_768 = 0
    characterBids[arg1].field_768 = 0
    pendingWithdrawals[address(msg.sender)] += characterBids[arg1].field_768
    emit 0x276b0447: characterBids[arg1].field_768, arg1, msg.sender, characterBids[arg1].field_512
    stor1 = 1
}
...
function buycharacter(uint256 arg1) payable {
    ...
    if arg1 >= 500:
        revert with 0, 'character number is wrong'
    if not charactersOfferedForSale[arg1].field_0:
        revert with 0, 'character not actually for sale'
    if charactersOfferedForSale[arg1].field_1024:
        if charactersOfferedForSale[arg1].field_1024 != msg.sender:
            revert with 0, 
                        32,
                        46,
                        0x72636861726163746572206e6f7420737570706f73656420746f20626520736f6c6420746f207468697320757365,
                        mem[370 len 18]
    if msg.value < charactersOfferedForSale[arg1].field_768:
        revert with 0, 'Didn't send enough amount'
    require ownerOf[arg1]
    if ownerOf[arg1] != charactersOfferedForSale[arg1].field_512:
    ...
    if ext_code.size(msg.sender) > 0:
        ...
        call msg.sender.onERC721Received(address rg1, address rg2, uint256 rg3, bytes rg4) with:
             gas gas_remaining wei
            args msg.sender, charactersOfferedForSale[arg1].field_512, arg1, 128, 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require Mask(32, 224, ext_call.return_data[0]) == 0x150b7a0200000000000000000000000000000000000000000000000000000000
    ...
    charactersOfferedForSale[arg1].field_1280 = 0
    emit 0xdc5e8312: arg1
    pendingWithdrawals[stor518[arg1].field_512] += msg.value
    emit 0x276b0447: msg.value, arg1, charactersOfferedForSale[arg1].field_512, msg.sender
    if characterBids[arg1].field_512 == msg.sender:
        pendingWithdrawals[address(msg.sender)] += characterBids[arg1].field_768
        characterBids[arg1].field_0 = 0
        characterBids[arg1].field_256 = arg1
