...
function sub_20d9931f(?) payable {
    ...
    if address(owner) != msg.sender:
        revert with 0, 'Ownable: caller is not the owner'
    sub_0ff8b0abAddress = address(arg1)
    emit 0x9e24714b: address(arg1), sub_0ff8b0abAddress
}
...
function sub_7b56b40a(?) payable {
    ...
    staticcall 0xd69de4d5ff6778b59ff504d7d09327b73344ff10.balanceOf(address rg1) with:
    ...
    if not ext_call.return_data[0]:
        ...
        mem[ceil32(return_data.size) + 132] = 0xda959f3464fe2375f0b1f8a872404181931978b2
        require ext_code.size(0xd69de4d5ff6778b59ff504d7d09327b73344ff10)
        staticcall 0xd69de4d5ff6778b59ff504d7d09327b73344ff10.allowance(address rg1, address rg2) with:
                gas gas_remaining wei
...
function sub_c06d638e(?) payable {
    ...
    staticcall veeAddress.balanceOf(address rg1) with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
