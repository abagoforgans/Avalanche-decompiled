...
function asdasd() payable {
    ...
    mem[(4 * ceil32(return_data.size)) + 320] = stor1
    ...
    require return_data.size >= 32
    require ext_call.return_data[0] == ext_call.return_data[0]
    mem[(6 * ceil32(return_data.size)) + 384] = 0x5c11d79500000000000000000000000000000000000000000000000000000000
    ...
    if mem[_93] < ext_call.return_data[0]:
