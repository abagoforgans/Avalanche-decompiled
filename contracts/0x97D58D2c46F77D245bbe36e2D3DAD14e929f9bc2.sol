...
function sendValueToSubInt(int64 arg1, uint256 arg2, bytes32 arg3) {
    ...
    while idx < oracles.length:
        mem[0] = 13
        if oracles[idx].field_0 != msg.sender:
            idx = idx + 1
            continue 
        if stor20[arg2][arg3]:
    ...
    revert with 0, 'caller is not one of the oracles'
}
...
function sendValueToSubString(string arg1, uint256 arg2, bytes32 arg3) {
    ...
    while idx < oracles.length:
        ...
        if stor20[arg2][arg3]:
            revert with 0, 'sub sent'
        stor20[arg2][arg3] = 1
        mem[ceil32(arg1.length) + 128] = 0xbb32782300000000000000000000000000000000000000000000000000000000
        mem[ceil32(arg1.length) + 132] = 32
        idx = 0
        while idx < arg1.length:
            mem[idx + ceil32(arg1.length) + 196] = mem[idx + 128]
            idx = idx + 32
            continue 
        require ext_code.size(subscriptions[arg3].field_256)
...
function subscribe(address arg1, uint8 arg2, uint256 arg3) {
    ...
    require ext_code.size(0x331e19d0a2b710b706c71277868bdfea9d6c35d6)
    delegate 0x331e19d0a2b710b706c71277868bdfea9d6c35d6.0xa506d954 with:
         gas gas_remaining wei
