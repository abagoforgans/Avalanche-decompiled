...
function aggregate(address arg1, bytes[] arg2) payable {
    ...
    if not _70:
        _138 = mem[96]
        s = 0
        while arg1.length < _138:
            require arg1.length < mem[96]
            _142 = mem[mem[(32 * arg1.length) + 128]]
            require arg1.length < mem[96]
            _145 = mem[mem[(32 * arg1.length) + 128] + 32]
            _146 = mem[64]
            _153 = mem[mem[mem[(32 * arg1.length) + 128] + 32]]
            idx = 0
            while idx < _153:
                mem[_146 + idx] = mem[_145 + idx + 32]
                _138 = mem[96]
                idx = idx + 32
                continue 
            if ceil32(_153) <= _153:
                ...
                if not return_data.size:
                    ...
                    require arg1.length < mem[_72]
                    mem[(32 * arg1.length) + _72 + 32] = 96
                else:
                    _216 = mem[64]
                    ...
                    if not ext_call.success:
                        revert with 0, 'Multicall aggregate: call failed'
                    require arg1.length < mem[_72]
                    mem[(32 * arg1.length) + _72 + 32] = _216
            else:
                mem[_146 + _153] = 0
                call address(_142).mem[mem[64] len 4] with:
                     gas gas_remaining wei
                ...
                if not return_data.size:
                    ...
                    if not ext_call.success:
                        revert with 0, 'Multicall aggregate: call failed'
                    require arg1.length < mem[_72]
                    mem[(32 * arg1.length) + _72 + 32] = _219
            _138 = mem[96]
            s = arg1.length + 1
            continue 
        _140 = mem[64]
...
function blockAndAggregate(address arg1, bytes[] arg2) payable {
    ...
    while idx < arg1.length:
        ...
        mem[_108 + cd[(arg1 + cd[s] + cd[(arg1 + cd[s] + 68)] + 36)] + 32] = 0
        mem[_83 + 32] = _108
        mem[t] = _83
        idx = idx + 1
        s = s + 32
...
function tryAggregate(bool arg1, address arg2, bytes[] arg3) payable {
    ...
    while idx < arg2.length:
        ...
        _129 = mem[64]
        require mem[64] + ceil32(cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)]) + 32 <= test266151307() and mem[64] + ceil32(cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)]) + 32 >= mem[64]
...
function tryBlockAndAggregate(bool arg1, address arg2, bytes[] arg3) payable {
    ...
    while idx < arg2.length:
        ...
        mem[_125 + cd[(arg2 + cd[s] + cd[(arg2 + cd[s] + 68)] + 36)] + 32] = 0
        mem[_99 + 32] = _125
        mem[t] = _99
        idx = idx + 1
        s = s + 32
    ...
    if not _100:
        ...
        while idx < _371:
            ...
            s = 0
            while arg2.length < _381:
                mem[_380 + arg2.length] = mem[_379 + arg2.length + 32]
                _371 = mem[96]
                s = arg2.length + 32
                continue 
            if arg2.length <= _381:
