...
function sub_ab4e731d(?) {
    ...
    if owner == msg.sender:
        ...
        mem[(32 * ('cd', 4).length) + (4 * ceil32(return_data.size)) + 128] = mem[(32 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + mem[(32 * ('cd', 4).length) + (2 * ceil32(return_data.size)) + 128 len 4], Mask(224, 32, cd[36]) >> 32 + 128]
        ...
        if mem[_744] >= cd[36]:
            ...
            mem[mem[64] + 4] = cd[36]
            mem[mem[64] + 36] = mem[(32 * _512 - 1) + (32 * ('cd', 4).length) + (4 * ceil32(return_data.size)) + 160]
            mem[mem[64] + 68] = 160
            ...
            call stor2.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                 gas gas_remaining wei
                args cd[36], mem[(32 * _512 - 1) + (32 * ('cd', 4).length) + (4 * ceil32(return_data.size)) + 160], Array(len=('cd', 4).length, data=mem[mem[64] + 196 len 32 * ('cd', 4).length]), address(this.address), block.timestamp + 300
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _948 = mem[64]
            ...
            if not address(cd[164]):
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require ('cd', 4).length - 1 < ('cd', 4).length
                emit 0xb238e86b: mem[(32 * ('cd', 4).length - 1) + 140 len 20], cd[36], _734, address(cd[164]), cd[196], address(cd[100])
            else:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require ('cd', 4).length - 1 < ('cd', 4).length
                emit 0xb238e86b: mem[(32 * ('cd', 4).length - 1) + 140 len 20], cd[36], _734 - cd[196], address(cd[164]), cd[196], address(cd[100])
        else:
            mem[mem[64] + 4] = stor2
            mem[mem[64] + 36] = -1
            require ext_code.size(address(_738))
        ...
        if mem[_745] >= cd[36]:
            mem[mem[64]] = 0x38ed173900000000000000000000000000000000000000000000000000000000
            mem[mem[64] + 4] = cd[36]
            mem[mem[64] + 36] = mem[(32 * _513 - 1) + (32 * ('cd', 4).length) + (4 * ceil32(return_data.size)) + 160]
            mem[mem[64] + 68] = 160
            mem[mem[64] + 164] = ('cd', 4).length
            idx = 0
            s = 128
            ...
            call stor2.swapExactTokensForTokens(uint256 rg1, uint256 rg2, address[] rg3, address rg4, uint256 rg5) with:
                 gas gas_remaining wei
                args cd[36], mem[(32 * _513 - 1) + (32 * ('cd', 4).length) + (4 * ceil32(return_data.size)) + 160], Array(len=('cd', 4).length, data=mem[mem[64] + 196 len 32 * ('cd', 4).length]), address(this.address), block.timestamp + 300
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            _950 = mem[64]
            mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if not address(cd[164]):
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require ('cd', 4).length - 1 < ('cd', 4).length
                emit 0xb238e86b: mem[(32 * ('cd', 4).length - 1) + 140 len 20], cd[36], _735, address(cd[164]), cd[196], address(cd[100])
            else:
                mem[mem[64] + 4] = address(cd[164])
                mem[mem[64] + 36] = cd[196]
                require ext_code.size(mem[(32 * ('cd', 4).length - 1) + 140 len 20])
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require ('cd', 4).length - 1 < ('cd', 4).length
                emit 0xb238e86b: mem[(32 * ('cd', 4).length - 1) + 140 len 20], cd[36], _735 - cd[196], address(cd[164]), cd[196], address(cd[100])
        else:
            mem[mem[64] + 4] = stor2
            mem[mem[64] + 36] = -1
            require ext_code.size(address(_739))
