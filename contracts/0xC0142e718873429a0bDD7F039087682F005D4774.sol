...
const sub_cea3895b(?) = 0x929ec64c34a17401f460460d4b9390518e5b473e
                ...
                if arg1:
                    ...
                    if ext_call.return_data[32] * arg1 / 10^18:
                        ...
                        if sub_0bb52153 * ext_call.return_data[32] * arg1 / 10^18 / 10^18:
                            ...
                            if not ext_code.size(meltAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[488 len 96] = unknown_0x23b872dd(?????), msg.sender, 1, Mask(224, 32, sub_0bb52153 * ext_call.return_data[32] * arg1 / 10^18 / 10^18) >> 32
                            mem[612 len 4] = 0
                            call meltAddress.0x1 with:
                                 gas gas_remaining wei
                                args Mask(224, 32, sub_0bb52153 * ext_call.return_data[32] * arg1 / 10^18 / 10^18) << 480, mem[584 len 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), arg1
                                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
                ...
                if arg1:
                    ...
                    if ext_call.return_data[32] * arg1 / 10^18:
                        ...
                        if sub_0bb52153 * ext_call.return_data[32] * arg1 / 10^18 / 10^18:
                            ...
                            if not ext_code.size(meltAddress):
                                revert with 0, 'Address: call to non-contract'
                            mem[ceil32(return_data.size) + 489 len 96] = unknown_0x23b872dd(?????), msg.sender, 1, Mask(224, 32, sub_0bb52153 * ext_call.return_data[32] * arg1 / 10^18 / 10^18) >> 32
                            mem[ceil32(return_data.size) + 613 len 4] = 0
                            call meltAddress.0x1 with:
                                 gas gas_remaining wei
                                args Mask(224, 32, sub_0bb52153 * ext_call.return_data[32] * arg1 / 10^18 / 10^18) << 480, mem[ceil32(return_data.size) + 585 len 4]
                            if not return_data.size:
                                if not ext_call.success:
                                    revert with unknown_0x23b872dd(?????), msg.sender, address(this.address), arg1
                                if not unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32:
                        ...
                        if arg1:
                            ...
                            if ext_call.return_data[32] * arg1 / 10^18:
                                ...
                                if sub_0bb52153 * ext_call.return_data[32] * arg1 / 10^18 / 10^18:
                                    ...
                                    if not ext_code.size(meltAddress):
                                        revert with 0, 'Address: call to non-contract'
                                    mem[ceil32(return_data.size) + 553 len 96] = unknown_0x23b872dd(?????), msg.sender, 1, Mask(224, 32, sub_0bb52153 * ext_call.return_data[32] * arg1 / 10^18 / 10^18) >> 32
                                    mem[ceil32(return_data.size) + 677 len 4] = 0
                                    mem[ceil32(return_data.size) + 649 len 0] = 0
                                    call meltAddress.0x1 with:
                                         gas gas_remaining wei
                                        args Mask(224, 32, sub_0bb52153 * ext_call.return_data[32] * arg1 / 10^18 / 10^18) << 480, mem[ceil32(return_data.size) + 649 len 4]
                                    if not return_data.size:
                                        require not ext_call.success
                                        revert with 'SafeMath: division by zero'
                        ...
                        if arg1:
                            ...
                            if ext_call.return_data[32] * arg1 / 10^18:
                                ...
                                if sub_0bb52153 * ext_call.return_data[32] * arg1 / 10^18 / 10^18:
                                    ...
                                    if not ext_code.size(meltAddress):
                                        revert with 0, 'Address: call to non-contract'
                                    mem[ceil32(return_data.size) + 553 len 96] = 0, msg.sender, 1, Mask(224, 32, sub_0bb52153 * ext_call.return_data[32] * arg1 / 10^18 / 10^18) >> 32
                                    mem[ceil32(return_data.size) + 677 len 4] = 0
                                    call meltAddress.0x1 with:
                                         gas gas_remaining wei
                                        args sub_0bb52153 * ext_call.return_data[32] * arg1 / 10^18 / 10^18, mem[ceil32(return_data.size) + 489 len 60], mem[ceil32(return_data.size) + 649 len 4]
                                    if not return_data.size:
                                        require not ext_call.success
                                        revert with 'SafeMath: division by zero'
                                    mem[ceil32(return_data.size) + 585 len return_data.size] = ext_call.return_data[0 len return_data.size]
