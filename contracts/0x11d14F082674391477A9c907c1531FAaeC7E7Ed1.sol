...
function tvl(uint256 arg1) payable {
    ...
    if not arg1:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        return ((10^12 * ext_call.return_data[0] * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) / ext_call.return_data[0] / 10^18) + (10^12 * 10^12 * ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0] / 10^18))
            ...
            if ext_call.return_data[0]:
                ...
                if ext_call.return_data[0]:
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    if (10^12 * ext_call.return_data[0] * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) / ext_call.return_data[0] / 10^18) + (10^12 * 10^12 * ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0] / 10^18) + 1:
                        return (100 * 17520000 * ext_call.return_data[0] * 10^12 * ext_call.return_data[0] * ext_call.return_data[0] / 10^18 / (10^12 * ext_call.return_data[0] * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) / ext_call.return_data[0] / 10^18) + (10^12 * 10^12 * ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0] / 10^18) + 1 / 10^18)
        else:
                    ...
                    if not _2739 % 32:
                        ...
                        if ext_call.return_data[0]:
                            ...
                            if (10^12 * 10^12 * ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0] / 10^18) + (10^12 * ext_call.return_data[0] / 10^12 * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) / ext_call.return_data[0] / 10^18) + 1:
                                return (100 * 17520000 * ext_call.return_data[0] * 10^12 * ext_call.return_data[0] * ext_call.return_data[0] / 10^18 / (10^12 * 10^12 * ext_call.return_data[0] * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[0]) / ext_call.return_data[0] / 10^18) + (10^12 * ext_call.return_data[0] / 10^12 * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] * Mask(112, 0, ext_call.return_data[32]) / ext_call.return_data[0] / 10^18) + 1 / 10^18)
                    else:
