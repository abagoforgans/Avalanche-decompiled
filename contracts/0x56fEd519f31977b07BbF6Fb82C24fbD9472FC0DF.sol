        ...
        while s < _274:
            ...
            if mem[ceil32(32 * ('cd', 36).length) + ceil32(32 * ('cd', 68).length) + 142 len 20] == WETHAddress:
                ...
                while idx < _292:
                    ...
                    u = u + 32
                    continue 
                mem[_290 + 68] = address(_289)
                mem[_290 + 100] = block.timestamp
                require ext_code.size(sub_2b738e92Address)
                call sub_2b738e92Address.mem[mem[64] len 4] with:
                   value _281 wei
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _290 + (32 * _292) + -mem[64] + 160]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _312 = mem[64]
                ...
                while idx < _291:
                    ...
                    u = u + 32
                    continue 
                mem[_288 + 100] = address(_287)
                mem[_288 + 132] = block.timestamp
                require ext_code.size(sub_2b738e92Address)
                call sub_2b738e92Address.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _288 + (32 * _291) + -mem[64] + 192]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                _311 = mem[64]
                mem[mem[64] len return_data.size] = ext_call.return_data[0 len return_data.size]
