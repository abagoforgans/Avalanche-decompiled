...
function _fallback() payable {
    if calldata.size < 4:
        ...
        if unknown_0x6431bf5a(?????) > uint32(call.func_hash) >> 224:
            ...
            if uint32(call.func_hash) >> 224 != unknown_0x0a993d8e(?????):
                ...
                if unknown_0x1ec8c9e3(?????) == uint32(call.func_hash) >> 224:
                    ...
                    if unknown_0x29fc1f73(?????) == uint32(call.func_hash) >> 224:
                        require calldata.size - 4 >= 32
                        require arg1 == address(arg1)
                        call address(arg1).approve(address arg1, uint256 arg2) with:
                             gas gas_remaining wei
                            args 0x975a1a706f49c465ba4b55ecf859c6c04f2263a0, -1
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
            ...
            if uint32(call.func_hash) >> 224 != unknown_0x85fb708a(?????):
                if unknown_0xc0336fc1(?????) == uint32(call.func_hash) >> 224:
                    require not msg.value
                    require calldata.size - 4 >= 96
                    require ext_code.size(stor1)
                    call stor1.0xb33c690c with:
