...
function sub_d6a0d2ee(?) {
    require ext_code.size(0xa8bf94b8a6c30a485d0d02fb2d36beb8d459959a)
    delegate 0xa8bf94b8a6c30a485d0d02fb2d36beb8d459959a.0x7e923cd8 with:
...
function sub_02007d1c(?) {
    ...
    require ext_code.size(0xa8bf94b8a6c30a485d0d02fb2d36beb8d459959a)
    delegate 0xa8bf94b8a6c30a485d0d02fb2d36beb8d459959a.0x0 with:
         gas gas_remaining wei
    ...
    if 0, delegate.return_data[4 len 28] < 0:
        return 0
    require ext_code.size(0xa8bf94b8a6c30a485d0d02fb2d36beb8d459959a)
    delegate 0xa8bf94b8a6c30a485d0d02fb2d36beb8d459959a.0x5bce6b3b with:
         gas gas_remaining wei
        args 7, Array(len=arg1.length, data=arg1[all])
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_4c7f490e(?) payable {
    ...
    mem[var80001] = 7
    require ext_code.size(0xa8bf94b8a6c30a485d0d02fb2d36beb8d459959a)
    delegate 0xa8bf94b8a6c30a485d0d02fb2d36beb8d459959a.mem[var84003 len 4] with:
         gas gas_remaining wei
    ...
    require ext_code.size(0xa8bf94b8a6c30a485d0d02fb2d36beb8d459959a)
    delegate 0xa8bf94b8a6c30a485d0d02fb2d36beb8d459959a.mem[var102003 len 4] with:
         gas gas_remaining wei
...
function getTotalCreatedNodes() payable {
    ...
    mem[var49001] = 7
    require ext_code.size(0xa8bf94b8a6c30a485d0d02fb2d36beb8d459959a)
    delegate 0xa8bf94b8a6c30a485d0d02fb2d36beb8d459959a.mem[var53003 len 4] with:
         gas gas_remaining wei
    ...
    require ext_code.size(0xa8bf94b8a6c30a485d0d02fb2d36beb8d459959a)
    delegate 0xa8bf94b8a6c30a485d0d02fb2d36beb8d459959a.mem[var69003 len 4] with:
         gas gas_remaining wei
...
function sub_d8a911d9(?) {
    ...
    mem[ceil32(arg1.length) + ceil32(return_data.size) + 128] = stor[sha3(mem[ceil32(arg1.length) + ceil32(return_data.size) + 128 len arg1.length + 32])][address(arg2)]
    return memory
...
function sub_9f3b0abe(?) {
    ...
    mem[132] = arg1
    require ext_code.size(0xa8bf94b8a6c30a485d0d02fb2d36beb8d459959a)
    delegate 0xa8bf94b8a6c30a485d0d02fb2d36beb8d459959a.0x38466299 with:
         gas gas_remaining wei
        args 7, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_035f722b(?) {
    ...
    require ext_code.size(0xa8bf94b8a6c30a485d0d02fb2d36beb8d459959a)
    delegate 0xa8bf94b8a6c30a485d0d02fb2d36beb8d459959a.0xdf616720 with:
         gas gas_remaining wei
    ...
    if 0 >= Mask(8 * -ceil32(('cd', 4).length) + ('cd', 4).length + 32, 0, 0), mem[('cd', 4).length + 160 len -('cd', 4).length + ceil32(('cd', 4).length)]:
        revert with 0, 50
    if mem[ceil32(('cd', 4).length) + 160] > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
        revert with 0, 17
    mem[ceil32(('cd', 4).length) + (32 * ('cd', 36).length) + ceil32(return_data.size) + 192] = 10^18 * mem[ceil32(('cd', 4).length) + 160]
    ...
    if 2 >= Mask(8 * -ceil32(('cd', 4).length) + ('cd', 4).length + 32, 0, 0), mem[('cd', 4).length + 160 len -('cd', 4).length + ceil32(('cd', 4).length)]:
        revert with 0, 50
    if mem[ceil32(('cd', 4).length) + 224] > 0x12725dd1d243aba0e75fe645cc4873f9e65afe688c928e1f21:
        revert with 0, 17
    mem[ceil32(('cd', 4).length) + (32 * ('cd', 36).length) + ceil32(return_data.size) + 256] = 10^18 * mem[ceil32(('cd', 4).length) + 224]
    ...
    mem[(2 * ceil32(('cd', 4).length)) + (32 * ('cd', 36).length) + ceil32(return_data.size) + 708] = 10^18 * mem[ceil32(('cd', 4).length) + 160]
    mem[(2 * ceil32(('cd', 4).length)) + (32 * ('cd', 36).length) + ceil32(return_data.size) + 740] = mem[ceil32(('cd', 4).length) + 192]
    mem[(2 * ceil32(('cd', 4).length)) + (32 * ('cd', 36).length) + ceil32(return_data.size) + 772] = 10^18 * mem[ceil32(('cd', 4).length) + 224]
