...
function getA() payable {
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0xb0a14cfc with:
...
function getAPrecise() payable {
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0xc9b64dcb with:
         gas gas_remaining wei
        args 201
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function getVirtualPrice() payable {
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0x71906c2c with:
         gas gas_remaining wei
        args 201
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function stopRampA() payable {
    if owner != msg.sender:
        revert with 0, 32, 32, code.data[21471 len 32]
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0xf14e211e with:
         gas gas_remaining wei
        args 201
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function withdrawAdminFees() payable {
    if owner != msg.sender:
        revert with 0, 32, 32, code.data[21471 len 32]
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0x24c5c751 with:
         gas gas_remaining wei
        args 201, owner
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function getAdminBalance(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0x7d048160 with:
         gas gas_remaining wei
        args 201, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function getDepositTimestamp(address arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0xe8c47a54 with:
         gas gas_remaining wei
        args 201, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function setSwapFee(uint256 arg1) payable {
    ...
    if owner != msg.sender:
        revert with 0, 32, 32, code.data[21471 len 32]
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0x467e186c with:
         gas gas_remaining wei
        args 201, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function setAdminFee(uint256 arg1) payable {
    ...
    if owner != msg.sender:
        revert with 0, 32, 32, code.data[21471 len 32]
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0x70467276 with:
         gas gas_remaining wei
        args 201, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function calculateCurrentWithdrawFee(address arg1) payable {
    require calldata.size - 4 >= 32
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0x968e5594 with:
         gas gas_remaining wei
        args 201, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function setDefaultWithdrawFee(uint256 arg1) payable {
    ...
    if owner != msg.sender:
        revert with 0, 32, 32, code.data[21471 len 32]
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0x8ab7697e with:
         gas gas_remaining wei
        args 201, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function rampA(uint256 arg1, uint256 arg2) payable {
    ...
    if owner != msg.sender:
        revert with 0, 32, 32, code.data[21471 len 32]
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0x58fdd79b with:
         gas gas_remaining wei
        args 201, arg1, arg2
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function updateUserWithdrawFee(address arg1, uint256 arg2) payable {
    ...
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0xe9252d46 with:
         gas gas_remaining wei
...
function calculateSwap(uint8 arg1, uint8 arg2, uint256 arg3) payable {
    ...
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0x4b23603c with:
         gas gas_remaining wei
...
function calculateRemoveLiquidityOneToken(address arg1, uint256 arg2, uint8 arg3) payable {
    require calldata.size - 4 >= 96
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0xe4a9a0da with:
         gas gas_remaining wei
...
function calculateTokenAmount(address arg1, uint256[] arg2, bool arg3) payable {
    ...
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0x5e58579c with:
         gas gas_remaining wei
...
function removeLiquidityOneToken(uint256 arg1, uint8 arg2, uint256 arg3, uint256 arg4) payable {
    ...
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0xe7a4db81 with:
         gas gas_remaining wei
...
function swap(uint8 arg1, uint8 arg2, uint256 arg3, uint256 arg4, uint256 arg5) payable {
    ...
    if block.timestamp > arg5:
        revert with 0, 'Deadline not met'
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0xa5397b22 with:
         gas gas_remaining wei
...
function addLiquidity(uint256[] arg1, uint256 arg2, uint256 arg3) payable {
    ...
    if block.timestamp > arg3:
        revert with 0, 'Deadline not met'
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0x40370edf with:
         gas gas_remaining wei
...
function removeLiquidityImbalance(uint256[] arg1, uint256 arg2, uint256 arg3) payable {
    ...
    if block.timestamp > arg3:
        revert with 0, 'Deadline not met'
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0x41b91c26 with:
         gas gas_remaining wei
        args 0, 201, 96, arg2, arg1.length, call.data[arg1 + 36 len floor32(arg1.length)]
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function calculateRemoveLiquidity(address arg1, uint256 arg2) payable {
    ...
    mem[164] = arg2
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0xf967a81f with:
         gas gas_remaining wei
        args 201, address(arg1), arg2
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function removeLiquidity(uint256 arg1, uint256[] arg2, uint256 arg3) payable {
    ...
    require ext_code.size(0x56d35a040ca2c92772e0857b4a6b99476ebf865e)
    delegate 0x56d35a040ca2c92772e0857b4a6b99476ebf865e.0x73fd6b3e with:
         gas gas_remaining wei
