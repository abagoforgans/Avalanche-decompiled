...
const getName = 'StrategyPngAavePngLp'
...
uint256 keepPNG;
address sub_cd25facfAddress;
address sub_bee5794bAddress;
address aaveAddress;
...
function sub_bee5794b(?) {
    return sub_bee5794bAddress
}

function sub_cd25facf(?) {
    return sub_cd25facfAddress
}
