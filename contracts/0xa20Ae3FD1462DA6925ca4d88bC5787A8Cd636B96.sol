...
function spellNameAndSymbol(address arg1, address arg2, uint256 arg3, uint256 arg4) payable {
    ...
    return 64, 
           160,
           39,
           0x65416e74694d61747465722e46696e616e63652050657270657475616c204265617220546f6b65, mem[167 len 25] >> 56,
           0,
           4,
           0,
           0
...
function decreaseAllowance(address arg1, uint256 arg2) payable {
    ...
    if arg2 > allowance[address(msg.sender)][address(arg1)]:
        revert with 0, 32, 37, 0x6e45524332303a2064656372656173656420616c6c6f77616e63652062656c6f77207a6572, mem[165 len 27] >> 40, 0
    if not msg.sender:
...
function __Put_init(address arg1, address arg2, uint256 arg3, uint256 arg4) payable {
    require calldata.size - 4 >= 128
    require arg1 == arg1
    require arg2 == arg2
    if uint8(stor0.field_8):
        mem[128 len 39] = 0x65416e74694d61747465722e46696e616e63652050657270657475616c204265617220546f6b65
        mem[192] = 4
    else:
    ...
    symbol.length.field_224 = 1113940338
    idx = 0
    while symbol.length + 31 / 32 > idx:
        ...
        continue 
    decimals = 18
    DOMAIN_SEPARATOR = sha3(0x8cad95687ba82c2ce50e74f7b754645e5117c3a5bec8151c0726d5857980a866, sha3(0x65416e74694d61747465722e46696e616e63652050657270657475616c204265617220546f6b65), chainid, this.address)
    if not uint8(stor0.field_8):
        uint8(stor0.field_8) = 0
        uint8(stor0.field_8) = 0
