    ...
    while idx < stor11:
        ...
        if ext_call.return_data[0] > sub_6c3a28e1 * 10^uint8(ext_call.return_data[0]):
            ...
            call t1Address.0x23b872dd with:
                 gas gas_remaining wei
                args sub_e4b70e5a[idx].field_0, treasuryAddress, ext_call.return_data[0] - (sub_6c3a28e1 * 10^uint8(ext_call.return_data[0]))
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
        mem[0] = 10
    ...
    while idx < stor11:
        ...
        if ext_call.return_data[0] <= 0:
            if ext_call.return_data[0] <= 0:
                ...
                require idx < sub_e4b70e5a.length
                mem[0] = 10
                mem[mem[64] + 4] = sub_e4b70e5a[idx].field_0
                require ext_code.size(t2Address)
                call t2Address.0x70a08231 with:
                     gas gas_remaining wei
                    args sub_e4b70e5a[idx].field_0
        ...
        while u < stor11:
            ...
            if ext_call.return_data[0] > sub_6c3a28e1 * 10^uint8(ext_call.return_data[0]):
                ...
                call t1Address.0x23b872dd with:
                     gas gas_remaining wei
                    args sub_e4b70e5a[u].field_0, treasuryAddress, ext_call.return_data[0] - (sub_6c3a28e1 * 10^uint8(ext_call.return_data[0]))
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
            mem[0] = 10
            mem[mem[64] + 4] = sub_e4b70e5a[u].field_0
            mem[mem[64] + 36] = treasuryAddress
            mem[mem[64] + 68] = ext_call.return_data[0]
            require ext_code.size(t2Address)
            call t2Address.0x23b872dd with:
                 gas gas_remaining wei
                args sub_e4b70e5a[u].field_0, treasuryAddress, ext_call.return_data[0]
            mem[mem[64]] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
