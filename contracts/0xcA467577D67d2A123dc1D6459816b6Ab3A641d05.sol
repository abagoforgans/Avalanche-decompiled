...
function execute() payable {
    ...
    require return_data.size >= 32
    _36 = mem[96 len 4], Mask(224, 0, stor1.field_32)
    ...
    _37 = mem[mem[96 len 4], Mask(224, 0, stor1.field_32) + 96]
    ...
    if _37 - 1 >= _37:
        revert with 'NH{q', 50
    if mem[(32 * _37 - 1) + ceil32(return_data.size) + 128] < stor2:
    ...
    mem[mem[64] + 36] = mem[(32 * _37 - 1) + ceil32(return_data.size) + 128]
    mem[mem[64] + 68] = 160
    ...
    call 0x1b02da8cb0d097eb8d57a175b88c7d8b47997506.swapExactTokensForTokens(uint256 arg1, uint256 arg2, address[] arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
        args uint256(stor1.field_0), mem[mem[64] + 36], 160, owner, block.timestamp, mem[mem[64] + 164 len (32 * mem[96]) + 32]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    _85 = mem[64]
