...
function tokenFromReflection() payable {
    require address(stor9.field_8) == msg.sender
    totalSupply += stor3
    balanceOf[address(stor9.field_0)] += stor3
    emit Transfer(stor3, 0, address(stor9.field_8));
}
        ...
        if not arg2:
            ...
            if arg2 > balanceOf[address(msg.sender)]:
                revert with 0, 
                            ...
                            mem[346 len 6]
            balanceOf[address(msg.sender)] -= arg2
            if balanceOf[address(stor9.field_0)] + (10 * arg2 / 100) < balanceOf[address(stor9.field_0)]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[address(stor9.field_0)] += 10 * arg2 / 100
        ...
        if not arg3:
            ...
            if arg3 > balanceOf[address(arg1)]:
                revert with 0, 
                            ...
                            mem[346 len 6]
            balanceOf[address(arg1)] -= arg3
            if balanceOf[address(stor9.field_0)] + (10 * arg3 / 100) < balanceOf[address(stor9.field_0)]:
                revert with 0, 'SafeMath: addition overflow'
            balanceOf[address(stor9.field_0)] += 10 * arg3 / 100
