...
const getName = 'StrategyJoeAvaxWbtcE'
...
uint32 stor13;
address sub_92a44cc0Address;
uint256 stor13;
uint256 stor14; offset 32
uint256 poolId;
address sub_8a7ce563Address;
address sub_5cdec3f8Address;
uint256 sub_fba7ae9d;
...
function sub_5cdec3f8(?) {
    return sub_5cdec3f8Address
}
...
function sub_8a7ce563(?) {
    return sub_8a7ce563Address
}
...
function sub_92a44cc0(?) {
    return address(sub_92a44cc0Address)
}
...
function balanceOfPool() {
    require ext_code.size(address(sub_92a44cc0Address))
    staticcall address(sub_92a44cc0Address).userInfo(uint256 arg1, address arg2) with:
            gas gas_remaining wei
...
function getHarvestable() {
    ...
    require ext_code.size(address(sub_92a44cc0Address))
    staticcall address(sub_92a44cc0Address).pendingTokens(uint256 arg1, address arg2) with:
            gas gas_remaining wei
           args poolId, this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function withdrawForSwap(uint256 arg1) {
    ...
    if address(controllerAddress) != msg.sender:
        revert with 0, '!controller'
    require ext_code.size(address(sub_92a44cc0Address))
    call address(sub_92a44cc0Address).withdraw(uint256 arg1, uint256 arg2) with:
         gas gas_remaining wei
        args poolId, arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
        ...
        if not return_data.size:
            ...
            if ext_call.return_data[0]:
                ...
                staticcall wantAddress.0xdd62ed3e with:
                        gas gas_remaining wei
                       args this.address, address(sub_92a44cc0Address)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                if ext_call.return_data[0]:
            ...
            if not ext_code.size(wantAddress):
                revert with 0, 'Address: call to non-contract'
            mem[424 len 64] = 0, address(sub_92a44cc0Address), ext_call.return_data[0 len 28]
            call wantAddress with:
               funct uint32(stor13)
                 gas gas_remaining wei
            ...
            require ext_code.size(address(sub_92a44cc0Address))
            call address(sub_92a44cc0Address).deposit(uint256 arg1, uint256 arg2) with:
                 gas gas_remaining wei
                args poolId, ext_call.return_data[0]
        else:
            mem[292 len return_data.size] = ext_call.return_data[0 len return_data.size]
            ...
            if not return_data.size:
                ...
                if not ext_code.size(wantAddress):
                    revert with 0, 'Address: call to non-contract'
                mem[ceil32(return_data.size) + 425 len 64] = 0, address(sub_92a44cc0Address), ext_call.return_data[0 len 28]
