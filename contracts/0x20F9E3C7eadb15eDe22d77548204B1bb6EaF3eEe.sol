...
function sub_3537e402(?) payable {
    ...
    mem[ceil32(arg1.length) + ceil32(arg2.length) + 256 len ceil32(arg2.length)] = arg2[all], mem[ceil32(arg1.length) + arg2.length + 160 len ceil32(arg2.length) - arg2.length]
    if not arg2.length % 32:
        mem[arg2.length + ceil32(arg1.length) + ceil32(arg2.length) + 256] = arg1.length
        mem[arg2.length + ceil32(arg1.length) + ceil32(arg2.length) + 288 len ceil32(arg1.length)] = arg1[all], mem[arg1.length + 128 len ceil32(arg1.length) - arg1.length]
        if not arg1.length % 32:
            emit 0x5927a284: 0, 64, arg2.length + 96, arg2.length, Mask(8 * ceil32(arg2.length), -(8 * ceil32(arg2.length)) + 256, arg2[all], mem[ceil32(arg1.length) + arg2.length + 160 len ceil32(arg2.length) - arg2.length]) << (8 * ceil32(arg2.length)) - 256, mem[ceil32(arg1.length) + (2 * ceil32(arg2.length)) + 256 len arg1.length + arg2.length + -ceil32(arg2.length) + 32]
        else:
            mem[floor32(arg1.length) + arg2.length + ceil32(arg1.length) + ceil32(arg2.length) + 288] = mem[floor32(arg1.length) + arg2.length + ceil32(arg1.length) + ceil32(arg2.length) + -(arg1.length % 32) + 320 len arg1.length % 32]
            emit 0x5927a284: 0, 64, arg2.length + 96, arg2.length, Mask(8 * ceil32(arg2.length), -(8 * ceil32(arg2.length)) + 256, arg2[all], mem[ceil32(arg1.length) + arg2.length + 160 len ceil32(arg2.length) - arg2.length]) << (8 * ceil32(arg2.length)) - 256, mem[ceil32(arg1.length) + (2 * ceil32(arg2.length)) + 256 len floor32(arg1.length) + arg2.length + -ceil32(arg2.length) + 64]
    else:
        mem[floor32(arg2.length) + ceil32(arg1.length) + ceil32(arg2.length) + 256] = mem[floor32(arg2.length) + ceil32(arg1.length) + ceil32(arg2.length) + -(arg2.length % 32) + 288 len arg2.length % 32]
        mem[floor32(arg2.length) + ceil32(arg1.length) + ceil32(arg2.length) + 288] = arg1.length
        mem[floor32(arg2.length) + ceil32(arg1.length) + ceil32(arg2.length) + 320 len ceil32(arg1.length)] = arg1[all], mem[arg1.length + 128 len ceil32(arg1.length) - arg1.length]
        if not arg1.length % 32:
            emit 0x5927a284: 0, 64, floor32(arg2.length) + 128, arg2.length, Mask(8 * ceil32(arg2.length), -(8 * ceil32(arg2.length)) + 256, arg2[all], mem[ceil32(arg1.length) + arg2.length + 160 len ceil32(arg2.length) - arg2.length]) << (8 * ceil32(arg2.length)) - 256, mem[ceil32(arg1.length) + (2 * ceil32(arg2.length)) + 256 len arg1.length + floor32(arg2.length) + -ceil32(arg2.length) + 64]
        else:
            mem[floor32(arg1.length) + floor32(arg2.length) + ceil32(arg1.length) + ceil32(arg2.length) + 320] = mem[floor32(arg1.length) + floor32(arg2.length) + ceil32(arg1.length) + ceil32(arg2.length) + -(arg1.length % 32) + 352 len arg1.length % 32]
            emit 0x5927a284: 0, 64, floor32(arg2.length) + 128, arg2.length, Mask(8 * ceil32(arg2.length), -(8 * ceil32(arg2.length)) + 256, arg2[all], mem[ceil32(arg1.length) + arg2.length + 160 len ceil32(arg2.length) - arg2.length]) << (8 * ceil32(arg2.length)) - 256, mem[ceil32(arg1.length) + (2 * ceil32(arg2.length)) + 256 len floor32(arg1.length) + floor32(arg2.length) + -ceil32(arg2.length) + 96]
}

function sub_5b988d71(?) payable {
    require calldata.size - 4 >= 64
    require arg1 <= 4294967296
    require arg1 + 36 <= calldata.size
    require arg1.length <= 4294967296 and arg1 + arg1.length + 36 <= calldata.size
    ...
    if not Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[arg1.length + 160 len -arg1.length + ceil32(arg1.length)] % 32:
        emit 0x6ccf37df: mem[ceil32(arg1.length) + ceil32(arg2.length) + 160 len Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[arg1.length + 160 len -arg1.length + ceil32(arg1.length)] + 64]
    else:
        ...
        emit 0x6ccf37df: mem[ceil32(arg1.length) + ceil32(arg2.length) + 160 len floor32(Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[arg1.length + 160 len -arg1.length + ceil32(arg1.length)]) + 96]
}
